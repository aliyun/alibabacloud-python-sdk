...
class GetLindormV2InstanceDetailsRequest(TeaModel):
    def __init__(
        self,
        instance_id: str = None,
        owner_account: str = None,
...
class GetLindormV2InstanceDetailsResponseBodyEngineListConnectAddressList(TeaModel):
    def __init__(
        self,
        address: str = None,
        port: str = None,
...
class GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup(TeaModel):
    def __init__(
        self,
        category: str = None,
        cpu_core_count: int = None,
...
class GetLindormV2InstanceDetailsResponseBodyEngineList(TeaModel):
    def __init__(
        self,
        connect_address_list: List[GetLindormV2InstanceDetailsResponseBodyEngineListConnectAddressList] = None,
        engine: str = None,
        is_last_version: bool = None,
        latest_version: str = None,
        node_group: List[GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup] = None,
        version: str = None,
    ):
        self.connect_address_list = connect_address_list
        self.engine = engine
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConnectAddressList') is not None:
            for k in m.get('ConnectAddressList'):
                temp_model = GetLindormV2InstanceDetailsResponseBodyEngineListConnectAddressList()
                self.connect_address_list.append(temp_model.from_map(k))
        if m.get('Engine') is not None:
            self.engine = m.get('Engine')
        if m.get('IsLastVersion') is not None:
        ...
        if m.get('NodeGroup') is not None:
            for k in m.get('NodeGroup'):
                temp_model = GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup()
                self.node_group.append(temp_model.from_map(k))
        if m.get('Version') is not None:
            self.version = m.get('Version')
        return self
...
class GetLindormV2InstanceDetailsResponseBodyStorageUsage(TeaModel):
    def __init__(
        self,
        capacity_by_disk_category: List[Dict[str, Any]] = None,
        engine_usage: Dict[str, Any] = None,
...
class GetLindormV2InstanceDetailsResponseBodyWhiteIpList(TeaModel):
    def __init__(
        self,
        group_name: str = None,
        ip_list: str = None,
...
class GetLindormV2InstanceDetailsResponseBody(TeaModel):
    def __init__(
        self,
        ali_uid: int = None,
        arbiter_vswitch_id: str = None,
        ...
        disk_usage: str = None,
        enable_compute: bool = None,
        engine_list: List[GetLindormV2InstanceDetailsResponseBodyEngineList] = None,
        expired_milliseconds: int = None,
        initial_root_password: str = None,
        instance_alias: str = None,
        instance_id: str = None,
        ...
        standby_vswitch_id: str = None,
        standby_zone_id: str = None,
        storage_usage: GetLindormV2InstanceDetailsResponseBodyStorageUsage = None,
        vpc_id: str = None,
        vswitch_id: str = None,
        white_ip_list: List[GetLindormV2InstanceDetailsResponseBodyWhiteIpList] = None,
        zone_engine_info_map: Dict[str, Any] = None,
        zone_id: str = None,
    ):
        self.ali_uid = ali_uid
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EngineList') is not None:
            for k in m.get('EngineList'):
                temp_model = GetLindormV2InstanceDetailsResponseBodyEngineList()
                self.engine_list.append(temp_model.from_map(k))
        if m.get('ExpiredMilliseconds') is not None:
            self.expired_milliseconds = m.get('ExpiredMilliseconds')
        if m.get('InitialRootPassword') is not None:
        ...
        if m.get('StandbyZoneId') is not None:
            self.standby_zone_id = m.get('StandbyZoneId')
        if m.get('StorageUsage') is not None:
            temp_model = GetLindormV2InstanceDetailsResponseBodyStorageUsage()
            self.storage_usage = temp_model.from_map(m['StorageUsage'])
        if m.get('VpcId') is not None:
            self.vpc_id = m.get('VpcId')
        if m.get('VswitchId') is not None:
        ...
        if m.get('WhiteIpList') is not None:
            for k in m.get('WhiteIpList'):
                temp_model = GetLindormV2InstanceDetailsResponseBodyWhiteIpList()
                self.white_ip_list.append(temp_model.from_map(k))
        if m.get('ZoneEngineInfoMap') is not None:
            self.zone_engine_info_map = m.get('ZoneEngineInfoMap')
        if m.get('ZoneId') is not None:
...
class GetLindormV2InstanceDetailsResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetLindormV2InstanceDetailsResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetLindormV2InstanceDetailsResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class GetLindormV2InstanceForTerraformRequest(TeaModel):
    def __init__(
        self,
        instance_id: str = None,
        owner_account: str = None,
...
class GetLindormV2InstanceForTerraformResponseBodyEngineListConnectAddressList(TeaModel):
    def __init__(
        self,
        address: str = None,
        port: str = None,
...
class GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup(TeaModel):
    def __init__(
        self,
        category: str = None,
        cpu_core_count: int = None,
...
class GetLindormV2InstanceForTerraformResponseBodyEngineList(TeaModel):
    def __init__(
        self,
        connect_address_list: List[GetLindormV2InstanceForTerraformResponseBodyEngineListConnectAddressList] = None,
        engine: str = None,
        is_last_version: bool = None,
        latest_version: str = None,
        node_group: List[GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup] = None,
        version: str = None,
    ):
        self.connect_address_list = connect_address_list
        self.engine = engine
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConnectAddressList') is not None:
            for k in m.get('ConnectAddressList'):
                temp_model = GetLindormV2InstanceForTerraformResponseBodyEngineListConnectAddressList()
                self.connect_address_list.append(temp_model.from_map(k))
        if m.get('Engine') is not None:
            self.engine = m.get('Engine')
        if m.get('IsLastVersion') is not None:
        ...
        if m.get('NodeGroup') is not None:
            for k in m.get('NodeGroup'):
                temp_model = GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup()
                self.node_group.append(temp_model.from_map(k))
        if m.get('Version') is not None:
            self.version = m.get('Version')
        return self
...
class GetLindormV2InstanceForTerraformResponseBodyStorageUsage(TeaModel):
    def __init__(
        self,
        capacity_by_disk_category: List[Dict[str, Any]] = None,
        engine_usage: Dict[str, Any] = None,
...
class GetLindormV2InstanceForTerraformResponseBodyWhiteIpList(TeaModel):
    def __init__(
        self,
        group_name: str = None,
        ip_list: str = None,
...
class GetLindormV2InstanceForTerraformResponseBody(TeaModel):
    def __init__(
        self,
        ali_uid: int = None,
        arbiter_vswitch_id: str = None,
        ...
        disk_usage: str = None,
        enable_compute: bool = None,
        engine_list: List[GetLindormV2InstanceForTerraformResponseBodyEngineList] = None,
        expired_milliseconds: int = None,
        initial_root_password: str = None,
        instance_alias: str = None,
        instance_id: str = None,
        ...
        standby_vswitch_id: str = None,
        standby_zone_id: str = None,
        storage_usage: GetLindormV2InstanceForTerraformResponseBodyStorageUsage = None,
        vpc_id: str = None,
        vswitch_id: str = None,
        white_ip_list: List[GetLindormV2InstanceForTerraformResponseBodyWhiteIpList] = None,
        zone_engine_info_map: Dict[str, Any] = None,
        zone_id: str = None,
    ):
        self.ali_uid = ali_uid
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EngineList') is not None:
            for k in m.get('EngineList'):
                temp_model = GetLindormV2InstanceForTerraformResponseBodyEngineList()
                self.engine_list.append(temp_model.from_map(k))
        if m.get('ExpiredMilliseconds') is not None:
            self.expired_milliseconds = m.get('ExpiredMilliseconds')
        if m.get('InitialRootPassword') is not None:
        ...
        if m.get('StandbyZoneId') is not None:
            self.standby_zone_id = m.get('StandbyZoneId')
        if m.get('StorageUsage') is not None:
            temp_model = GetLindormV2InstanceForTerraformResponseBodyStorageUsage()
            self.storage_usage = temp_model.from_map(m['StorageUsage'])
        if m.get('VpcId') is not None:
            self.vpc_id = m.get('VpcId')
        if m.get('VswitchId') is not None:
        ...
        if m.get('WhiteIpList') is not None:
            for k in m.get('WhiteIpList'):
                temp_model = GetLindormV2InstanceForTerraformResponseBodyWhiteIpList()
                self.white_ip_list.append(temp_model.from_map(k))
        if m.get('ZoneEngineInfoMap') is not None:
            self.zone_engine_info_map = m.get('ZoneEngineInfoMap')
        if m.get('ZoneId') is not None:
...
class GetLindormV2InstanceForTerraformResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetLindormV2InstanceForTerraformResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetLindormV2InstanceForTerraformResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class GetLindormV2InstanceSecurityGroupsRequest(TeaModel):
    def __init__(
        self,
        instance_id: str = None,
        owner_account: str = None,
...
class GetLindormV2InstanceSecurityGroupsResponseBodySgList(TeaModel):
    def __init__(
        self,
...
class GetLindormV2InstanceSecurityGroupsResponseBody(TeaModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        instance_id: str = None,
        request_id: str = None,
        sg_list: List[GetLindormV2InstanceSecurityGroupsResponseBodySgList] = None,
    ):
        self.access_denied_detail = access_denied_detail
        self.instance_id = instance_id
        self.request_id = request_id
    ...
    def to_map(self):
        ...
        if self.sg_list is not None:
            for k in self.sg_list:
                result['SgList'].append(k.to_map() if k else None)
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SgList') is not None:
            for k in m.get('SgList'):
                temp_model = GetLindormV2InstanceSecurityGroupsResponseBodySgList()
                self.sg_list.append(temp_model.from_map(k))
        return self


class GetLindormV2InstanceSecurityGroupsResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetLindormV2InstanceSecurityGroupsResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetLindormV2InstanceSecurityGroupsResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class GetLindormV2StreamEngineInfoRequest(TeaModel):
    def __init__(
        self,
        instance_id: str = None,
        owner_account: str = None,
...
class GetLindormV2StreamEngineInfoResponseBodyResourceGroupList(TeaModel):
    def __init__(
        self,
...
class GetLindormV2StreamEngineInfoResponseBody(TeaModel):
    def __init__(
        self,
        instance_id: str = None,
        request_id: str = None,
        resource_group_list: List[GetLindormV2StreamEngineInfoResponseBodyResourceGroupList] = None,
    ):
        self.instance_id = instance_id
        self.request_id = request_id
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceGroupList') is not None:
            for k in m.get('ResourceGroupList'):
                temp_model = GetLindormV2StreamEngineInfoResponseBodyResourceGroupList()
                self.resource_group_list.append(temp_model.from_map(k))
        return self


class GetLindormV2StreamEngineInfoResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetLindormV2StreamEngineInfoResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetLindormV2StreamEngineInfoResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class ModifyLindormV2InstanceSecurityGroupsRequest(TeaModel):
    def __init__(
        self,
        instance_id: str = None,
        owner_account: str = None,
...
class ModifyLindormV2InstanceSecurityGroupsResponseBody(TeaModel):
    def __init__(
        self,
        request_id: str = None,
    ):
...
class ModifyLindormV2InstanceSecurityGroupsResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ModifyLindormV2InstanceSecurityGroupsResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = ModifyLindormV2InstanceSecurityGroupsResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class OpenLdpsColumnarIndexRequest(TeaModel):
    def __init__(
        self,
        instance_id: str = None,
        owner_account: str = None,
...
class OpenLdpsColumnarIndexResponseBody(TeaModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        request_id: str = None,
...
class OpenLdpsColumnarIndexResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: OpenLdpsColumnarIndexResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = OpenLdpsColumnarIndexResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class UpdateLindormInstanceAttributeRequest(TeaModel):
    def __init__(
        self,
...
class UpdateLindormInstanceAttributeResponseBody(TeaModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        request_id: str = None,
...
class UpdateLindormInstanceAttributeResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: UpdateLindormInstanceAttributeResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = UpdateLindormInstanceAttributeResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class UpdateLindormV2InstanceRequestEngineListNodeGroupList(TeaModel):
    def __init__(
        self,
        group_id: str = None,
        node_count: int = None,
...
class UpdateLindormV2InstanceRequestEngineList(TeaModel):
    def __init__(
        self,
        engine_type: str = None,
        node_group_list: List[UpdateLindormV2InstanceRequestEngineListNodeGroupList] = None,
    ):
        # This parameter is required.
        self.engine_type = engine_type
        self.node_group_list = node_group_list
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NodeGroupList') is not None:
            for k in m.get('NodeGroupList'):
                temp_model = UpdateLindormV2InstanceRequestEngineListNodeGroupList()
                self.node_group_list.append(temp_model.from_map(k))
        return self


class UpdateLindormV2InstanceRequest(TeaModel):
    def __init__(
        self,
        capacity_storage_size: int = None,
        cloud_storage_size: int = None,
        cloud_storage_type: str = None,
        enable_capacity_storage: bool = None,
        engine_list: List[UpdateLindormV2InstanceRequestEngineList] = None,
        instance_id: str = None,
        owner_account: str = None,
        owner_id: int = None,
        region_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EngineList') is not None:
            for k in m.get('EngineList'):
                temp_model = UpdateLindormV2InstanceRequestEngineList()
                self.engine_list.append(temp_model.from_map(k))
        if m.get('InstanceId') is not None:
            self.instance_id = m.get('InstanceId')
        if m.get('OwnerAccount') is not None:
...
class UpdateLindormV2InstanceResponseBody(TeaModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        instance_id: str = None,
...
class UpdateLindormV2InstanceResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: UpdateLindormV2InstanceResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = UpdateLindormV2InstanceResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

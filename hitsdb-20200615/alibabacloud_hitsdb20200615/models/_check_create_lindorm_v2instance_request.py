...
class CheckCreateLindormV2InstanceRequest(DaraModel):
    def __init__(
        self,
        ...
        engine_list: List[main_models.CheckCreateLindormV2InstanceRequestEngineList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EngineList') is not None:
            for k1 in m.get('EngineList'):
                temp_model = main_models.CheckCreateLindormV2InstanceRequestEngineList()
...
class CheckCreateLindormV2InstanceRequestEngineList(DaraModel):
    def __init__(
        self,
        engine_type: str = None,
        node_group_list: List[main_models.CheckCreateLindormV2InstanceRequestEngineListNodeGroupList] = None,
    ):
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NodeGroupList') is not None:
            for k1 in m.get('NodeGroupList'):
                temp_model = main_models.CheckCreateLindormV2InstanceRequestEngineListNodeGroupList()
...
class CheckCreateLindormV2InstanceRequestEngineListNodeGroupList(DaraModel):
    def __init__(
        self,
        node_count: int = None,

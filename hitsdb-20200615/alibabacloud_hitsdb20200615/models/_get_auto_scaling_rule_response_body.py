...
class GetAutoScalingRuleResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: str = None,
        data: main_models.GetAutoScalingRuleResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetAutoScalingRuleResponseBodyData()
...
class GetAutoScalingRuleResponseBodyData(DaraModel):
    def __init__(
        self,
        config_id: str = None,
        enabled: bool = None,

...
class GetAutoScalingConfigResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: str = None,
        data: main_models.GetAutoScalingConfigResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetAutoScalingConfigResponseBodyData()
...
class GetAutoScalingConfigResponseBodyData(DaraModel):
    def __init__(
        self,
        config_id: str = None,
        ...
        nodes_max: int = None,
        nodes_min: int = None,
        scale_rule_list: List[main_models.GetAutoScalingConfigResponseBodyDataScaleRuleList] = None,
        scale_type: str = None,
        spec_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ScaleRuleList') is not None:
            for k1 in m.get('ScaleRuleList'):
                temp_model = main_models.GetAutoScalingConfigResponseBodyDataScaleRuleList()
...
class GetAutoScalingConfigResponseBodyDataScaleRuleList(DaraModel):
    def __init__(
        self,
        config_id: str = None,
        enabled: bool = None,

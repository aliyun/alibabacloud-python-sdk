...
class ModifyAutoScalingConfigRequest(DaraModel):
    def __init__(
        ...
        scale_rule_list: List[main_models.ModifyAutoScalingConfigRequestScaleRuleList] = None,
        scale_type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ScaleRuleList') is not None:
            for k1 in m.get('ScaleRuleList'):
                temp_model = main_models.ModifyAutoScalingConfigRequestScaleRuleList()
...
class ModifyAutoScalingConfigRequestScaleRuleList(DaraModel):
    def __init__(
        self,
        config_id: str = None,
        enabled: bool = None,

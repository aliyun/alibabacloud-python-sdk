...
class GetLindormV2InstanceForTerraformResponseBody(DaraModel):
    def __init__(
        self,
        ali_uid: int = None,
        ...
        engine_list: List[main_models.GetLindormV2InstanceForTerraformResponseBodyEngineList] = None,
        ...
        storage_usage: main_models.GetLindormV2InstanceForTerraformResponseBodyStorageUsage = None,
        vpc_id: str = None,
        vswitch_id: str = None,
        white_ip_list: List[main_models.GetLindormV2InstanceForTerraformResponseBodyWhiteIpList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EngineList') is not None:
            for k1 in m.get('EngineList'):
                temp_model = main_models.GetLindormV2InstanceForTerraformResponseBodyEngineList()
        ...
        if m.get('StorageUsage') is not None:
            temp_model = main_models.GetLindormV2InstanceForTerraformResponseBodyStorageUsage()
        ...
        if m.get('WhiteIpList') is not None:
            for k1 in m.get('WhiteIpList'):
                temp_model = main_models.GetLindormV2InstanceForTerraformResponseBodyWhiteIpList()
...
class GetLindormV2InstanceForTerraformResponseBodyWhiteIpList(DaraModel):
    def __init__(
        self,
        group_name: str = None,
        ip_list: str = None,
...
class GetLindormV2InstanceForTerraformResponseBodyStorageUsage(DaraModel):
    def __init__(
        self,
...
class GetLindormV2InstanceForTerraformResponseBodyEngineList(DaraModel):
    def __init__(
        self,
        connect_address_list: List[main_models.GetLindormV2InstanceForTerraformResponseBodyEngineListConnectAddressList] = None,
        engine: str = None,
        is_last_version: bool = None,
        latest_version: str = None,
        node_group: List[main_models.GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup] = None,
        version: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConnectAddressList') is not None:
            for k1 in m.get('ConnectAddressList'):
                temp_model = main_models.GetLindormV2InstanceForTerraformResponseBodyEngineListConnectAddressList()
        ...
        if m.get('NodeGroup') is not None:
            for k1 in m.get('NodeGroup'):
                temp_model = main_models.GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup()
...
class GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup(DaraModel):
    def __init__(
        self,
        category: str = None,
...
class GetLindormV2InstanceForTerraformResponseBodyEngineListConnectAddressList(DaraModel):
    def __init__(
        self,
        address: str = None,
        port: str = None,

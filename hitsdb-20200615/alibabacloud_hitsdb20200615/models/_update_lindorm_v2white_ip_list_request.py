...
class UpdateLindormV2WhiteIpListRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('WhiteIpGroupList') is not None:
            for k1 in m.get('WhiteIpGroupList'):
                temp_model = main_models.UpdateLindormV2WhiteIpListRequestWhiteIpGroupList()
                self.white_ip_group_list.append(temp_model.from_map(k1))

        return self

class UpdateLindormV2WhiteIpListRequestWhiteIpGroupList(DaraModel):
    def __init__(
        self,
        group_name: str = None,

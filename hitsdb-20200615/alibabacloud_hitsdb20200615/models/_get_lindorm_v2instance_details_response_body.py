...
class GetLindormV2InstanceDetailsResponseBody(DaraModel):
    def __init__(
        self,
        ali_uid: int = None,
        ...
        enable_fs: str = None,
        enable_store_tde: str = None,
        engine_list: List[main_models.GetLindormV2InstanceDetailsResponseBodyEngineList] = None,
        ...
        storage_usage: main_models.GetLindormV2InstanceDetailsResponseBodyStorageUsage = None,
        vpc_id: str = None,
        vswitch_id: str = None,
        white_ip_list: List[main_models.GetLindormV2InstanceDetailsResponseBodyWhiteIpList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EngineList') is not None:
            for k1 in m.get('EngineList'):
                temp_model = main_models.GetLindormV2InstanceDetailsResponseBodyEngineList()
        ...
        if m.get('StorageUsage') is not None:
            temp_model = main_models.GetLindormV2InstanceDetailsResponseBodyStorageUsage()
        ...
        if m.get('WhiteIpList') is not None:
            for k1 in m.get('WhiteIpList'):
                temp_model = main_models.GetLindormV2InstanceDetailsResponseBodyWhiteIpList()
...
class GetLindormV2InstanceDetailsResponseBodyWhiteIpList(DaraModel):
    def __init__(
        self,
        group_name: str = None,
        ip_list: str = None,
...
class GetLindormV2InstanceDetailsResponseBodyStorageUsage(DaraModel):
    def __init__(
        self,
...
class GetLindormV2InstanceDetailsResponseBodyEngineList(DaraModel):
    def __init__(
        self,
        connect_address_list: List[main_models.GetLindormV2InstanceDetailsResponseBodyEngineListConnectAddressList] = None,
        engine: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConnectAddressList') is not None:
            for k1 in m.get('ConnectAddressList'):
                temp_model = main_models.GetLindormV2InstanceDetailsResponseBodyEngineListConnectAddressList()
        ...
        if m.get('NodeGroup') is not None:
            for k1 in m.get('NodeGroup'):
                temp_model = main_models.GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup()
...
class GetLindormV2InstanceDetailsResponseBodyEngineListNodeGroup(DaraModel):
    def __init__(
        self,
        category: str = None,
...
class GetLindormV2InstanceDetailsResponseBodyEngineListConnectAddressList(DaraModel):
    def __init__(
        self,
        address: str = None,
        port: str = None,

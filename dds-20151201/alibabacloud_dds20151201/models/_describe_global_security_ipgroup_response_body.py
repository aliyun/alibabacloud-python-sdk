...
class DescribeGlobalSecurityIPGroupResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('GlobalSecurityIPGroup') is not None:
            for k1 in m.get('GlobalSecurityIPGroup'):
                temp_model = main_models.DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup()
...
class DescribeGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup(DaraModel):
    def __init__(
        self,

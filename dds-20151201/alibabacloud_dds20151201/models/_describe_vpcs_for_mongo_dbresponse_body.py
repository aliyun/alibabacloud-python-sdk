...
class DescribeVpcsForMongoDBResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Vpcs') is not None:
            for k1 in m.get('Vpcs'):
                temp_model = main_models.DescribeVpcsForMongoDBResponseBodyVpcs()
                self.vpcs.append(temp_model.from_map(k1))

        return self

class DescribeVpcsForMongoDBResponseBodyVpcs(DaraModel):
    def __init__(
        self,
        ali_uid: str = None,
        bid: str = None,
        ...
        region_no: str = None,
        status: str = None,
        v_switchs: List[main_models.DescribeVpcsForMongoDBResponseBodyVpcsVSwitchs] = None,
        vpc_id: str = None,
        vpc_name: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VSwitchs') is not None:
            for k1 in m.get('VSwitchs'):
                temp_model = main_models.DescribeVpcsForMongoDBResponseBodyVpcsVSwitchs()
...
class DescribeVpcsForMongoDBResponseBodyVpcsVSwitchs(DaraModel):
    def __init__(
        self,
        cidr_block: str = None,
        gmt_create: str = None,

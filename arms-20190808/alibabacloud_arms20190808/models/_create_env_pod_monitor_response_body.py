...
class CreateEnvPodMonitorResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.CreateEnvPodMonitorResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CreateEnvPodMonitorResponseBodyData()
...
class CreateEnvPodMonitorResponseBodyData(DaraModel):
    def __init__(
        self,

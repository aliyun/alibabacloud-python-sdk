...
class UpdatePrometheusAlertRuleRequest(DaraModel):
    def __init__(
        ...
        region_id: str = None,
        tags: List[main_models.UpdatePrometheusAlertRuleRequestTags] = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.UpdatePrometheusAlertRuleRequestTags()
...
class UpdatePrometheusAlertRuleRequestTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

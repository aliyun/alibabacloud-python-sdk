...
class ListAddonsResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: List[main_models.ListAddonsResponseBodyData] = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListAddonsResponseBodyData()
...
class ListAddonsResponseBodyData(DaraModel):
    def __init__(
        self,
        alias: str = None,
        categories: List[str] = None,
        dashboards: List[main_models.ListAddonsResponseBodyDataDashboards] = None,
        description: str = None,
        environments: List[main_models.ListAddonsResponseBodyDataEnvironments] = None,
        icon: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Dashboards') is not None:
            for k1 in m.get('Dashboards'):
                temp_model = main_models.ListAddonsResponseBodyDataDashboards()
        ...
        if m.get('Environments') is not None:
            for k1 in m.get('Environments'):
                temp_model = main_models.ListAddonsResponseBodyDataEnvironments()
...
class ListAddonsResponseBodyDataEnvironments(DaraModel):
    def __init__(
        self,
        dependencies: main_models.ListAddonsResponseBodyDataEnvironmentsDependencies = None,
        description: str = None,
        enable: bool = None,
        label: str = None,
        name: str = None,
        policies: main_models.ListAddonsResponseBodyDataEnvironmentsPolicies = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Dependencies') is not None:
            temp_model = main_models.ListAddonsResponseBodyDataEnvironmentsDependencies()
        ...
        if m.get('Policies') is not None:
            temp_model = main_models.ListAddonsResponseBodyDataEnvironmentsPolicies()
            self.policies = temp_model.from_map(m.get('Policies'))

        return self

class ListAddonsResponseBodyDataEnvironmentsPolicies(DaraModel):
    def __init__(
        self,
        alert_default_status: str = None,
        default_install: bool = None,
        enable_service_account: bool = None,
        metric_check_rule: main_models.ListAddonsResponseBodyDataEnvironmentsPoliciesMetricCheckRule = None,
        need_restart_after_integration: bool = None,
        protocols: List[main_models.ListAddonsResponseBodyDataEnvironmentsPoliciesProtocols] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MetricCheckRule') is not None:
            temp_model = main_models.ListAddonsResponseBodyDataEnvironmentsPoliciesMetricCheckRule()
        ...
        if m.get('Protocols') is not None:
            for k1 in m.get('Protocols'):
                temp_model = main_models.ListAddonsResponseBodyDataEnvironmentsPoliciesProtocols()
...
class ListAddonsResponseBodyDataEnvironmentsPoliciesProtocols(DaraModel):
    def __init__(
        self,
        description: str = None,
        icon: str = None,
...
class ListAddonsResponseBodyDataEnvironmentsPoliciesMetricCheckRule(DaraModel):
    def __init__(
        self,
...
class ListAddonsResponseBodyDataEnvironmentsDependencies(DaraModel):
    def __init__(
        self,
...
class ListAddonsResponseBodyDataDashboards(DaraModel):
    def __init__(
        self,
        description: str = None,
        name: str = None,

...
class GetMultipleTraceResponseBody(DaraModel):
    def __init__(
        self,
        multi_call_chain_infos: List[main_models.GetMultipleTraceResponseBodyMultiCallChainInfos] = None,
        request_id: str = None,
    ):
    ...
    def validate(self):
        if self.multi_call_chain_infos:
            for v1 in self.multi_call_chain_infos:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.multi_call_chain_infos is not None:
            for k1 in self.multi_call_chain_infos:
                result['MultiCallChainInfos'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MultiCallChainInfos') is not None:
            for k1 in m.get('MultiCallChainInfos'):
                temp_model = main_models.GetMultipleTraceResponseBodyMultiCallChainInfos()
                self.multi_call_chain_infos.append(temp_model.from_map(k1))
...
class GetMultipleTraceResponseBodyMultiCallChainInfos(DaraModel):
    def __init__(
        self,
        spans: List[main_models.GetMultipleTraceResponseBodyMultiCallChainInfosSpans] = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Spans') is not None:
            for k1 in m.get('Spans'):
                temp_model = main_models.GetMultipleTraceResponseBodyMultiCallChainInfosSpans()
...
class GetMultipleTraceResponseBodyMultiCallChainInfosSpans(DaraModel):
    def __init__(
        self,
        duration: int = None,
        have_stack: bool = None,
        log_event_list: List[main_models.GetMultipleTraceResponseBodyMultiCallChainInfosSpansLogEventList] = None,
        ...
        span_id: str = None,
        tag_entry_list: List[main_models.GetMultipleTraceResponseBodyMultiCallChainInfosSpansTagEntryList] = None,
        timestamp: int = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LogEventList') is not None:
            for k1 in m.get('LogEventList'):
                temp_model = main_models.GetMultipleTraceResponseBodyMultiCallChainInfosSpansLogEventList()
        ...
        if m.get('TagEntryList') is not None:
            for k1 in m.get('TagEntryList'):
                temp_model = main_models.GetMultipleTraceResponseBodyMultiCallChainInfosSpansTagEntryList()
...
class GetMultipleTraceResponseBodyMultiCallChainInfosSpansTagEntryList(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class GetMultipleTraceResponseBodyMultiCallChainInfosSpansLogEventList(DaraModel):
    def __init__(
        self,
        tag_entry_list: List[main_models.GetMultipleTraceResponseBodyMultiCallChainInfosSpansLogEventListTagEntryList] = None,
        timestamp: int = None,
    ):
        # The tags of the trace.
        self.tag_entry_list = tag_entry_list
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TagEntryList') is not None:
            for k1 in m.get('TagEntryList'):
                temp_model = main_models.GetMultipleTraceResponseBodyMultiCallChainInfosSpansLogEventListTagEntryList()
                self.tag_entry_list.append(temp_model.from_map(k1))
...
class GetMultipleTraceResponseBodyMultiCallChainInfosSpansLogEventListTagEntryList(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

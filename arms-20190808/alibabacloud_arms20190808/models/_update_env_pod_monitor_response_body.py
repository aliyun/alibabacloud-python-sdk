...
class UpdateEnvPodMonitorResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.UpdateEnvPodMonitorResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
        # The response code.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.UpdateEnvPodMonitorResponseBodyData()
...
class UpdateEnvPodMonitorResponseBodyData(DaraModel):
    def __init__(
        self,

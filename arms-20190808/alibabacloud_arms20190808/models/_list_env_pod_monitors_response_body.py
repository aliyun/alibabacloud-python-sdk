...
class ListEnvPodMonitorsResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: List[main_models.ListEnvPodMonitorsResponseBodyData] = None,
        message: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListEnvPodMonitorsResponseBodyData()
...
class ListEnvPodMonitorsResponseBodyData(DaraModel):
    def __init__(
        self,
        addon_name: str = None,
        ...
        endpoints: List[main_models.ListEnvPodMonitorsResponseBodyDataEndpoints] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Endpoints') is not None:
            for k1 in m.get('Endpoints'):
                temp_model = main_models.ListEnvPodMonitorsResponseBodyDataEndpoints()
...
class ListEnvPodMonitorsResponseBodyDataEndpoints(DaraModel):
    def __init__(
        self,
        interval: str = None,

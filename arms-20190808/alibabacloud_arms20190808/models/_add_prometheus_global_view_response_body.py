...
class AddPrometheusGlobalViewResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.AddPrometheusGlobalViewResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
        # 状态码。说明 200表示成功。
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.AddPrometheusGlobalViewResponseBodyData()
...
class AddPrometheusGlobalViewResponseBodyData(DaraModel):
    def __init__(
        self,
        info: main_models.AddPrometheusGlobalViewResponseBodyDataInfo = None,
        msg: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Info') is not None:
            temp_model = main_models.AddPrometheusGlobalViewResponseBodyDataInfo()
...
class AddPrometheusGlobalViewResponseBodyDataInfo(DaraModel):
    def __init__(
        self,

...
class ListIntegrationResponseBody(DaraModel):
    def __init__(
        self,
        page_info: main_models.ListIntegrationResponseBodyPageInfo = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PageInfo') is not None:
            temp_model = main_models.ListIntegrationResponseBodyPageInfo()
...
class ListIntegrationResponseBodyPageInfo(DaraModel):
    def __init__(
        self,
        integrations: List[main_models.ListIntegrationResponseBodyPageInfoIntegrations] = None,
        page: int = None,
        size: int = None,
        total: int = None,
    ):
    ...
    def to_map(self):
        ...
        if self.integrations is not None:
            for k1 in self.integrations:
                result['Integrations'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Integrations') is not None:
            for k1 in m.get('Integrations'):
                temp_model = main_models.ListIntegrationResponseBodyPageInfoIntegrations()
                self.integrations.append(temp_model.from_map(k1))
...
class ListIntegrationResponseBodyPageInfoIntegrations(DaraModel):
    def __init__(
        self,
        api_endpoint: str = None,
        create_time: str = None,
        integration_detail: main_models.ListIntegrationResponseBodyPageInfoIntegrationsIntegrationDetail = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IntegrationDetail') is not None:
            temp_model = main_models.ListIntegrationResponseBodyPageInfoIntegrationsIntegrationDetail()
            self.integration_detail = temp_model.from_map(m.get('IntegrationDetail'))
...
class ListIntegrationResponseBodyPageInfoIntegrationsIntegrationDetail(DaraModel):
    def __init__(
        self,

...
class UpdateTimingSyntheticTaskRequest(DaraModel):
    def __init__(
        self,
        available_assertions: List[main_models.UpdateTimingSyntheticTaskRequestAvailableAssertions] = None,
        common_setting: main_models.UpdateTimingSyntheticTaskRequestCommonSetting = None,
        custom_period: main_models.UpdateTimingSyntheticTaskRequestCustomPeriod = None,
        frequency: str = None,
        monitor_conf: main_models.UpdateTimingSyntheticTaskRequestMonitorConf = None,
        monitors: List[main_models.UpdateTimingSyntheticTaskRequestMonitors] = None,
        name: str = None,
        region_id: str = None,
        resource_group_id: str = None,
        tags: List[main_models.UpdateTimingSyntheticTaskRequestTags] = None,
        task_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AvailableAssertions') is not None:
            for k1 in m.get('AvailableAssertions'):
                temp_model = main_models.UpdateTimingSyntheticTaskRequestAvailableAssertions()
                self.available_assertions.append(temp_model.from_map(k1))

        if m.get('CommonSetting') is not None:
            temp_model = main_models.UpdateTimingSyntheticTaskRequestCommonSetting()
            self.common_setting = temp_model.from_map(m.get('CommonSetting'))

        if m.get('CustomPeriod') is not None:
            temp_model = main_models.UpdateTimingSyntheticTaskRequestCustomPeriod()
        ...
        if m.get('MonitorConf') is not None:
            temp_model = main_models.UpdateTimingSyntheticTaskRequestMonitorConf()
            self.monitor_conf = temp_model.from_map(m.get('MonitorConf'))

        self.monitors = []
        if m.get('Monitors') is not None:
            for k1 in m.get('Monitors'):
                temp_model = main_models.UpdateTimingSyntheticTaskRequestMonitors()
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.UpdateTimingSyntheticTaskRequestTags()
...
class UpdateTimingSyntheticTaskRequestTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class UpdateTimingSyntheticTaskRequestMonitors(DaraModel):
    def __init__(
        self,
        city_code: str = None,
...
class UpdateTimingSyntheticTaskRequestMonitorConf(DaraModel):
    def __init__(
        self,
        api_http: main_models.UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP = None,
        file_download: main_models.UpdateTimingSyntheticTaskRequestMonitorConfFileDownload = None,
        net_dns: main_models.UpdateTimingSyntheticTaskRequestMonitorConfNetDNS = None,
        net_icmp: main_models.UpdateTimingSyntheticTaskRequestMonitorConfNetICMP = None,
        net_tcp: main_models.UpdateTimingSyntheticTaskRequestMonitorConfNetTCP = None,
        stream: main_models.UpdateTimingSyntheticTaskRequestMonitorConfStream = None,
        website: main_models.UpdateTimingSyntheticTaskRequestMonitorConfWebsite = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApiHTTP') is not None:
            temp_model = main_models.UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP()
            self.api_http = temp_model.from_map(m.get('ApiHTTP'))

        if m.get('FileDownload') is not None:
            temp_model = main_models.UpdateTimingSyntheticTaskRequestMonitorConfFileDownload()
            self.file_download = temp_model.from_map(m.get('FileDownload'))

        if m.get('NetDNS') is not None:
            temp_model = main_models.UpdateTimingSyntheticTaskRequestMonitorConfNetDNS()
            self.net_dns = temp_model.from_map(m.get('NetDNS'))

        if m.get('NetICMP') is not None:
            temp_model = main_models.UpdateTimingSyntheticTaskRequestMonitorConfNetICMP()
            self.net_icmp = temp_model.from_map(m.get('NetICMP'))

        if m.get('NetTCP') is not None:
            temp_model = main_models.UpdateTimingSyntheticTaskRequestMonitorConfNetTCP()
            self.net_tcp = temp_model.from_map(m.get('NetTCP'))

        if m.get('Stream') is not None:
            temp_model = main_models.UpdateTimingSyntheticTaskRequestMonitorConfStream()
            self.stream = temp_model.from_map(m.get('Stream'))

        if m.get('Website') is not None:
            temp_model = main_models.UpdateTimingSyntheticTaskRequestMonitorConfWebsite()
            self.website = temp_model.from_map(m.get('Website'))

        return self

class UpdateTimingSyntheticTaskRequestMonitorConfWebsite(DaraModel):
    def __init__(
        self,
...
class UpdateTimingSyntheticTaskRequestMonitorConfStream(DaraModel):
    def __init__(
        self,
        custom_header_content: Dict[str, str] = None,
...
class UpdateTimingSyntheticTaskRequestMonitorConfNetTCP(DaraModel):
    def __init__(
        self,
...
class UpdateTimingSyntheticTaskRequestMonitorConfNetICMP(DaraModel):
    def __init__(
        self,
        interval: int = None,
...
class UpdateTimingSyntheticTaskRequestMonitorConfNetDNS(DaraModel):
    def __init__(
        self,
        dig: int = None,
...
class UpdateTimingSyntheticTaskRequestMonitorConfFileDownload(DaraModel):
    def __init__(
        self,
...
class UpdateTimingSyntheticTaskRequestMonitorConfApiHTTP(DaraModel):
    def __init__(
        self,
        ...
        request_body: main_models.UpdateTimingSyntheticTaskRequestMonitorConfApiHTTPRequestBody = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RequestBody') is not None:
            temp_model = main_models.UpdateTimingSyntheticTaskRequestMonitorConfApiHTTPRequestBody()
...
class UpdateTimingSyntheticTaskRequestMonitorConfApiHTTPRequestBody(DaraModel):
    def __init__(
        self,
        content: str = None,
        type: str = None,
...
class UpdateTimingSyntheticTaskRequestCustomPeriod(DaraModel):
    def __init__(
        self,
        end_hour: int = None,
        start_hour: int = None,
...
class UpdateTimingSyntheticTaskRequestCommonSetting(DaraModel):
    def __init__(
        self,
        custom_host: main_models.UpdateTimingSyntheticTaskRequestCommonSettingCustomHost = None,
        custom_prometheus_setting: main_models.UpdateTimingSyntheticTaskRequestCommonSettingCustomPrometheusSetting = None,
        custom_vpcsetting: main_models.UpdateTimingSyntheticTaskRequestCommonSettingCustomVPCSetting = None,
        ip_type: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CustomHost') is not None:
            temp_model = main_models.UpdateTimingSyntheticTaskRequestCommonSettingCustomHost()
            self.custom_host = temp_model.from_map(m.get('CustomHost'))

        if m.get('CustomPrometheusSetting') is not None:
            temp_model = main_models.UpdateTimingSyntheticTaskRequestCommonSettingCustomPrometheusSetting()
            self.custom_prometheus_setting = temp_model.from_map(m.get('CustomPrometheusSetting'))

        if m.get('CustomVPCSetting') is not None:
            temp_model = main_models.UpdateTimingSyntheticTaskRequestCommonSettingCustomVPCSetting()
...
class UpdateTimingSyntheticTaskRequestCommonSettingCustomVPCSetting(DaraModel):
    def __init__(
        self,
        region_id: str = None,
...
class UpdateTimingSyntheticTaskRequestCommonSettingCustomPrometheusSetting(DaraModel):
    def __init__(
        self,
...
class UpdateTimingSyntheticTaskRequestCommonSettingCustomHost(DaraModel):
    def __init__(
        self,
        hosts: List[main_models.UpdateTimingSyntheticTaskRequestCommonSettingCustomHostHosts] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Hosts') is not None:
            for k1 in m.get('Hosts'):
                temp_model = main_models.UpdateTimingSyntheticTaskRequestCommonSettingCustomHostHosts()
...
class UpdateTimingSyntheticTaskRequestCommonSettingCustomHostHosts(DaraModel):
    def __init__(
        self,
        domain: str = None,
        ip_type: int = None,
...
class UpdateTimingSyntheticTaskRequestAvailableAssertions(DaraModel):
    def __init__(
        self,
        expect: str = None,
        operator: str = None,

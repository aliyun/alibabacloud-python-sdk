...
class InstallAddonResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.InstallAddonResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.InstallAddonResponseBodyData()
...
class InstallAddonResponseBodyData(DaraModel):
    def __init__(
        self,
        addon_name: str = None,
        alert_rule_count: int = None,
        conditions: List[main_models.InstallAddonResponseBodyDataConditions] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Conditions') is not None:
            for k1 in m.get('Conditions'):
                temp_model = main_models.InstallAddonResponseBodyDataConditions()
...
class InstallAddonResponseBodyDataConditions(DaraModel):
    def __init__(
        self,

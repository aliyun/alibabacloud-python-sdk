...
class GetRetcodeAppByPidRequest(DaraModel):
    def __init__(
        self,
        pid: str = None,
        region_id: str = None,
        tags: List[main_models.GetRetcodeAppByPidRequestTags] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.GetRetcodeAppByPidRequestTags()
                self.tags.append(temp_model.from_map(k1))

        return self

class GetRetcodeAppByPidRequestTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

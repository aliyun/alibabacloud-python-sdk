...
class AccountContactEditResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.AccountContactEditResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.AccountContactEditResponseBodyData()
...
class AccountContactEditResponseBodyData(DaraModel):
    def __init__(
        self,
        contact_id: int = None,
        error_list: List[main_models.AccountContactEditResponseBodyDataErrorList] = None,
        result: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ErrorList') is not None:
            for k1 in m.get('ErrorList'):
                temp_model = main_models.AccountContactEditResponseBodyDataErrorList()
...
class AccountContactEditResponseBodyDataErrorList(DaraModel):
    def __init__(
        self,
        error_code: str = None,
        error_desc: str = None,

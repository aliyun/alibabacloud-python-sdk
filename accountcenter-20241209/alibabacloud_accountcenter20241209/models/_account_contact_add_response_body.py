...
class AccountContactAddResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.AccountContactAddResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.AccountContactAddResponseBodyData()
...
class AccountContactAddResponseBodyData(DaraModel):
    def __init__(
        self,
        contact_id: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ErrorList') is not None:
            for k1 in m.get('ErrorList'):
                temp_model = main_models.AccountContactAddResponseBodyDataErrorList()
...
class AccountContactAddResponseBodyDataErrorList(DaraModel):
    def __init__(
        self,
        error_code: str = None,
        error_desc: str = None,

...
class EnterpriseTodoQueryAccountTodoListByApplicantResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyData()
...
class EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyData(DaraModel):
    def __init__(
        self,
        count: int = None,
        todo_list: List[main_models.EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoList] = None,
    ):
        self.count = count
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TodoList') is not None:
            for k1 in m.get('TodoList'):
                temp_model = main_models.EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoList()
                self.todo_list.append(temp_model.from_map(k1))

        return self

class EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoList(DaraModel):
    def __init__(
        self,
        aliyun_id: str = None,
        ...
        from_le: main_models.EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoListFromLe = None,
        pk: str = None,
        process_list: List[main_models.EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoListProcessList] = None,
        status: str = None,
        timeout_time: int = None,
        to_le: main_models.EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoListToLe = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FromLe') is not None:
            temp_model = main_models.EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoListFromLe()
        ...
        if m.get('ProcessList') is not None:
            for k1 in m.get('ProcessList'):
                temp_model = main_models.EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoListProcessList()
        ...
        if m.get('ToLe') is not None:
            temp_model = main_models.EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoListToLe()
...
class EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoListToLe(DaraModel):
    def __init__(
        self,
        ec_id: str = None,
        le_id: str = None,
        ...
        manager_list: List[main_models.EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoListToLeManagerList] = None,
        nb_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ManagerList') is not None:
            for k1 in m.get('ManagerList'):
                temp_model = main_models.EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoListToLeManagerList()
...
class EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoListToLeManagerList(DaraModel):
    def __init__(
        self,
        aliyun_id: str = None,
        pk: str = None,
...
class EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoListProcessList(DaraModel):
    def __init__(
        self,
        aliyun_id: str = None,
        audit_time: int = None,
...
class EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoListFromLe(DaraModel):
    def __init__(
        self,
        ec_id: str = None,
        le_id: str = None,
        ...
        manageable_account_count: int = None,
        managed_account_count: int = None,
        manager_list: List[main_models.EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoListFromLeManagerList] = None,
        nb_id: str = None,
        subject_name: str = None,
        subject_type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ManagerList') is not None:
            for k1 in m.get('ManagerList'):
                temp_model = main_models.EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoListFromLeManagerList()
                self.manager_list.append(temp_model.from_map(k1))
...
class EnterpriseTodoQueryAccountTodoListByApplicantResponseBodyDataTodoListFromLeManagerList(DaraModel):
    def __init__(
        self,
        aliyun_id: str = None,
        pk: str = None,

...
class AccountContactQueryPageListResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: List[main_models.AccountContactQueryPageListResponseBodyData] = None,
        message: str = None,
        page_no: int = None,
        page_size: int = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.AccountContactQueryPageListResponseBodyData()
...
class AccountContactQueryPageListResponseBodyData(DaraModel):
    def __init__(
        self,

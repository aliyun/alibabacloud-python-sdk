...
class CreateServerIdeInstanceShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        self.user_command_shrink = user_command_shrink
    ...
    def to_map(self):
        ...
        if self.user_command_shrink is not None:
            result['UserCommand'] = self.user_command_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserCommand') is not None:
            self.user_command_shrink = m.get('UserCommand')

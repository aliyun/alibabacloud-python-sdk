...
class GetAgentSessionTokenUsageRequest(DaraModel):
    def __init__(
        self,
        id: str = None,
        jsonrpc: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Params') is not None:
            temp_model = main_models.GetAgentSessionTokenUsageRequestParams()
            self.params = temp_model.from_map(m.get('Params'))

        return self

class GetAgentSessionTokenUsageRequestParams(DaraModel):
    def __init__(
        self,
        session_id: str = None,
    ):

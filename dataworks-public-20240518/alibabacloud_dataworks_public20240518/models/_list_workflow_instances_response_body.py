...
class ListWorkflowInstancesResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PagingInfo') is not None:
            temp_model = main_models.ListWorkflowInstancesResponseBodyPagingInfo()
...
class ListWorkflowInstancesResponseBodyPagingInfo(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        total_count: int = None,
        workflow_instances: List[main_models.ListWorkflowInstancesResponseBodyPagingInfoWorkflowInstances] = None,
    ):
        # The page number.
    ...
    def validate(self):
        if self.workflow_instances:
            for v1 in self.workflow_instances:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.workflow_instances is not None:
            for k1 in self.workflow_instances:
                result['WorkflowInstances'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('WorkflowInstances') is not None:
            for k1 in m.get('WorkflowInstances'):
                temp_model = main_models.ListWorkflowInstancesResponseBodyPagingInfoWorkflowInstances()
                self.workflow_instances.append(temp_model.from_map(k1))

        return self

class ListWorkflowInstancesResponseBodyPagingInfoWorkflowInstances(DaraModel):
    def __init__(
        self,
        biz_date: int = None,
        ...
        status: str = None,
        tags: List[main_models.ListWorkflowInstancesResponseBodyPagingInfoWorkflowInstancesTags] = None,
        type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.ListWorkflowInstancesResponseBodyPagingInfoWorkflowInstancesTags()
...
class ListWorkflowInstancesResponseBodyPagingInfoWorkflowInstancesTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

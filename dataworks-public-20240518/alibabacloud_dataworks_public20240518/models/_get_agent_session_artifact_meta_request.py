...
class GetAgentSessionArtifactMetaRequest(DaraModel):
    def __init__(
        self,
        id: str = None,
        jsonrpc: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Params') is not None:
            temp_model = main_models.GetAgentSessionArtifactMetaRequestParams()
            self.params = temp_model.from_map(m.get('Params'))

        return self

class GetAgentSessionArtifactMetaRequestParams(DaraModel):
    def __init__(
        self,

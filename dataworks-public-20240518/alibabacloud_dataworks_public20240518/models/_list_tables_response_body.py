...
class ListTablesResponseBody(DaraModel):
    def __init__(
        self,
        paging_info: main_models.ListTablesResponseBodyPagingInfo = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PagingInfo') is not None:
            temp_model = main_models.ListTablesResponseBodyPagingInfo()
...
class ListTablesResponseBodyPagingInfo(DaraModel):
    def __init__(
        self,

...
class GetImageResponseBodyImage(DaraModel):
    def __init__(
        ...
        build_config: main_models.GetImageResponseBodyImageBuildConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BuildConfig') is not None:
            temp_model = main_models.GetImageResponseBodyImageBuildConfig()
        ...
        if m.get('Supported') is not None:
            temp_model = main_models.GetImageResponseBodyImageSupported()
...
class GetImageResponseBodyImageSupported(DaraModel):
    def __init__(
        self,
        module: str = None,
...
class GetImageResponseBodyImageBuildConfig(DaraModel):
    def __init__(
        self,
        build_type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PackageInstallationScripts') is not None:
            for k1 in m.get('PackageInstallationScripts'):
                temp_model = main_models.GetImageResponseBodyImageBuildConfigPackageInstallationScripts()
                self.package_installation_scripts.append(temp_model.from_map(k1))

        return self

class GetImageResponseBodyImageBuildConfigPackageInstallationScripts(DaraModel):
    def __init__(
        self,
        content: str = None,
        type: str = None,

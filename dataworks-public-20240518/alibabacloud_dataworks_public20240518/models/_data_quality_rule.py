...
class DataQualityRule(DaraModel):
    def __init__(
        self,
        checking_config: main_models.DataQualityRuleCheckingConfig = None,
        description: str = None,
        enabled: bool = None,
        error_handlers: List[main_models.DataQualityRuleErrorHandlers] = None,
        id: int = None,
        name: str = None,
        project_id: int = None,
        sampling_config: main_models.DataQualityRuleSamplingConfig = None,
        severity: str = None,
        target: main_models.DataQualityRuleTarget = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CheckingConfig') is not None:
            temp_model = main_models.DataQualityRuleCheckingConfig()
        ...
        if m.get('ErrorHandlers') is not None:
            for k1 in m.get('ErrorHandlers'):
                temp_model = main_models.DataQualityRuleErrorHandlers()
        ...
        if m.get('SamplingConfig') is not None:
            temp_model = main_models.DataQualityRuleSamplingConfig()
        ...
        if m.get('Target') is not None:
            temp_model = main_models.DataQualityRuleTarget()
...
class DataQualityRuleTarget(DaraModel):
    def __init__(
        self,
...
class DataQualityRuleSamplingConfig(DaraModel):
    def __init__(
        self,
        metric: str = None,
...
class DataQualityRuleErrorHandlers(DaraModel):
    def __init__(
        self,
...
class DataQualityRuleCheckingConfig(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Thresholds') is not None:
            temp_model = main_models.DataQualityRuleCheckingConfigThresholds()
...
class DataQualityRuleCheckingConfigThresholds(DaraModel):
    def __init__(
        self,
        critical: main_models.DataQualityRuleCheckingConfigThresholdsCritical = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Critical') is not None:
            temp_model = main_models.DataQualityRuleCheckingConfigThresholdsCritical()
            self.critical = temp_model.from_map(m.get('Critical'))

        if m.get('Expected') is not None:
            temp_model = main_models.DataQualityRuleCheckingConfigThresholdsExpected()
            self.expected = temp_model.from_map(m.get('Expected'))

        if m.get('Warned') is not None:
            temp_model = main_models.DataQualityRuleCheckingConfigThresholdsWarned()
            self.warned = temp_model.from_map(m.get('Warned'))

        return self

class DataQualityRuleCheckingConfigThresholdsWarned(DaraModel):
    def __init__(
        self,
        expression: str = None,
        operator: str = None,
...
class DataQualityRuleCheckingConfigThresholdsExpected(DaraModel):
    def __init__(
        self,
        expression: str = None,
        operator: str = None,
...
class DataQualityRuleCheckingConfigThresholdsCritical(DaraModel):
    def __init__(
        self,
        expression: str = None,
        operator: str = None,

...
class ListColumnsResponseBody(DaraModel):
    def __init__(
        self,
        paging_info: main_models.ListColumnsResponseBodyPagingInfo = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PagingInfo') is not None:
            temp_model = main_models.ListColumnsResponseBodyPagingInfo()
...
class ListColumnsResponseBodyPagingInfo(DaraModel):
    def __init__(
        self,

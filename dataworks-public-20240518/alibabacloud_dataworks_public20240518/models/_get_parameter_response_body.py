...
class GetParameterResponseBodyParameter(DaraModel):
    def __init__(
        ...
        owner: str = None,
        project_id: int = None,
        properties: List[main_models.GetParameterResponseBodyParameterProperties] = None,
        scope: str = None,
        type: str = None,
        version: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Properties') is not None:
            for k1 in m.get('Properties'):
                temp_model = main_models.GetParameterResponseBodyParameterProperties()
...
class GetParameterResponseBodyParameterProperties(DaraModel):
    def __init__(
        self,
        env_type: str = None,
        value: str = None,

...
class ListTaskInstancesResponseBody(DaraModel):
    def __init__(
        self,
        paging_info: main_models.ListTaskInstancesResponseBodyPagingInfo = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PagingInfo') is not None:
            temp_model = main_models.ListTaskInstancesResponseBodyPagingInfo()
...
class ListTaskInstancesResponseBodyPagingInfo(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        task_instances: List[main_models.ListTaskInstancesResponseBodyPagingInfoTaskInstances] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TaskInstances') is not None:
            for k1 in m.get('TaskInstances'):
                temp_model = main_models.ListTaskInstancesResponseBodyPagingInfoTaskInstances()
...
class ListTaskInstancesResponseBodyPagingInfoTaskInstances(DaraModel):
    def __init__(
        self,
        ...
        data_source: main_models.ListTaskInstancesResponseBodyPagingInfoTaskInstancesDataSource = None,
        ...
        rerun_mode: str = None,
        run_number: int = None,
        runtime: main_models.ListTaskInstancesResponseBodyPagingInfoTaskInstancesRuntime = None,
        runtime_resource: main_models.ListTaskInstancesResponseBodyPagingInfoTaskInstancesRuntimeResource = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataSource') is not None:
            temp_model = main_models.ListTaskInstancesResponseBodyPagingInfoTaskInstancesDataSource()
        ...
        if m.get('Runtime') is not None:
            temp_model = main_models.ListTaskInstancesResponseBodyPagingInfoTaskInstancesRuntime()
            self.runtime = temp_model.from_map(m.get('Runtime'))

        if m.get('RuntimeResource') is not None:
            temp_model = main_models.ListTaskInstancesResponseBodyPagingInfoTaskInstancesRuntimeResource()
...
class ListTaskInstancesResponseBodyPagingInfoTaskInstancesRuntimeResource(DaraModel):
    def __init__(
        self,
        cu: str = None,
        image: str = None,
...
class ListTaskInstancesResponseBodyPagingInfoTaskInstancesRuntime(DaraModel):
    def __init__(
        self,
        gateway: str = None,
        process_id: str = None,
...
class ListTaskInstancesResponseBodyPagingInfoTaskInstancesDataSource(DaraModel):
    def __init__(
        self,
        name: str = None,
    ):

...
class GetSecurityStrategyResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SecurityStrategy') is not None:
            temp_model = main_models.GetSecurityStrategyResponseBodySecurityStrategy()
            self.security_strategy = temp_model.from_map(m.get('SecurityStrategy'))

        return self

class GetSecurityStrategyResponseBodySecurityStrategy(DaraModel):
    def __init__(
        self,
        content: main_models.GetSecurityStrategyResponseBodySecurityStrategyContent = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Content') is not None:
            temp_model = main_models.GetSecurityStrategyResponseBodySecurityStrategyContent()
...
class GetSecurityStrategyResponseBodySecurityStrategyContent(DaraModel):
    def __init__(
        self,
        control_dw_scope: str = None,
        control_module: str = None,
        control_sub_module: str = None,
        controllers: List[main_models.GetSecurityStrategyResponseBodySecurityStrategyContentControllers] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Controllers') is not None:
            for k1 in m.get('Controllers'):
                temp_model = main_models.GetSecurityStrategyResponseBodySecurityStrategyContentControllers()
...
class GetSecurityStrategyResponseBodySecurityStrategyContentControllers(DaraModel):
    def __init__(
        self,

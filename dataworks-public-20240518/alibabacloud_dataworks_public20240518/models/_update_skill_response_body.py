...
class UpdateSkillResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        skill: main_models.UpdateSkillResponseBodySkill = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Skill') is not None:
            temp_model = main_models.UpdateSkillResponseBodySkill()
            self.skill = temp_model.from_map(m.get('Skill'))

        return self

class UpdateSkillResponseBodySkill(DaraModel):
    def __init__(
        self,
        body: str = None,
        creator_id: str = None,
        ...
        name: str = None,
        visibility: str = None,
        visibility_scope: main_models.UpdateSkillResponseBodySkillVisibilityScope = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VisibilityScope') is not None:
            temp_model = main_models.UpdateSkillResponseBodySkillVisibilityScope()
            self.visibility_scope = temp_model.from_map(m.get('VisibilityScope'))

        return self

class UpdateSkillResponseBodySkillVisibilityScope(DaraModel):
    def __init__(
        self,

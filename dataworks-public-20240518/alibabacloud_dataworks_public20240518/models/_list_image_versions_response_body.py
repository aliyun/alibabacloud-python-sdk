...
class ListImageVersionsResponseBody(DaraModel):
    def __init__(
        self,
        paging_info: main_models.ListImageVersionsResponseBodyPagingInfo = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PagingInfo') is not None:
            temp_model = main_models.ListImageVersionsResponseBodyPagingInfo()
...
class ListImageVersionsResponseBodyPagingInfo(DaraModel):
    def __init__(
        self,
        image_versions: List[main_models.ListImageVersionsResponseBodyPagingInfoImageVersions] = None,
    ...
    def to_map(self):
        ...
        if self.image_versions is not None:
            for k1 in self.image_versions:
                result['ImageVersions'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        self.image_versions = []
        if m.get('ImageVersions') is not None:
            for k1 in m.get('ImageVersions'):
                temp_model = main_models.ListImageVersionsResponseBodyPagingInfoImageVersions()
                self.image_versions.append(temp_model.from_map(k1))
...
class ListImageVersionsResponseBodyPagingInfoImageVersions(DaraModel):
    def __init__(
        self,
        ...
        build_config: main_models.ListImageVersionsResponseBodyPagingInfoImageVersionsBuildConfig = None,
        ...
        size: str = None,
        status: str = None,
        supported: main_models.ListImageVersionsResponseBodyPagingInfoImageVersionsSupported = None,
        version: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BuildConfig') is not None:
            temp_model = main_models.ListImageVersionsResponseBodyPagingInfoImageVersionsBuildConfig()
        ...
        if m.get('Supported') is not None:
            temp_model = main_models.ListImageVersionsResponseBodyPagingInfoImageVersionsSupported()
...
class ListImageVersionsResponseBodyPagingInfoImageVersionsSupported(DaraModel):
    def __init__(
        self,
        module: str = None,
...
class ListImageVersionsResponseBodyPagingInfoImageVersionsBuildConfig(DaraModel):
    def __init__(
        self,
        build_type: str = None,
        package_installation_scripts: List[main_models.ListImageVersionsResponseBodyPagingInfoImageVersionsBuildConfigPackageInstallationScripts] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PackageInstallationScripts') is not None:
            for k1 in m.get('PackageInstallationScripts'):
                temp_model = main_models.ListImageVersionsResponseBodyPagingInfoImageVersionsBuildConfigPackageInstallationScripts()
                self.package_installation_scripts.append(temp_model.from_map(k1))

        return self

class ListImageVersionsResponseBodyPagingInfoImageVersionsBuildConfigPackageInstallationScripts(DaraModel):
    def __init__(
        self,
        content: str = None,
        type: str = None,

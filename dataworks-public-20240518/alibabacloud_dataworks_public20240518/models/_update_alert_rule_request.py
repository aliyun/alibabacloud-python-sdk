...
class UpdateAlertRuleRequest(DaraModel):
    def __init__(
        ...
        id: int = None,
        name: str = None,
        notification: main_models.UpdateAlertRuleRequestNotification = None,
        owner: str = None,
        trigger_condition: main_models.UpdateAlertRuleRequestTriggerCondition = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Notification') is not None:
            temp_model = main_models.UpdateAlertRuleRequestNotification()
        ...
        if m.get('TriggerCondition') is not None:
            temp_model = main_models.UpdateAlertRuleRequestTriggerCondition()
            self.trigger_condition = temp_model.from_map(m.get('TriggerCondition'))

        return self

class UpdateAlertRuleRequestTriggerCondition(DaraModel):
    def __init__(
        self,
        extension: main_models.UpdateAlertRuleRequestTriggerConditionExtension = None,
        target: main_models.UpdateAlertRuleRequestTriggerConditionTarget = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Extension') is not None:
            temp_model = main_models.UpdateAlertRuleRequestTriggerConditionExtension()
            self.extension = temp_model.from_map(m.get('Extension'))

        if m.get('Target') is not None:
            temp_model = main_models.UpdateAlertRuleRequestTriggerConditionTarget()
...
class UpdateAlertRuleRequestTriggerConditionTarget(DaraModel):
    def __init__(
        self,
...
class UpdateAlertRuleRequestTriggerConditionExtension(DaraModel):
    def __init__(
        self,
        cycle_unfinished: main_models.UpdateAlertRuleRequestTriggerConditionExtensionCycleUnfinished = None,
        error: main_models.UpdateAlertRuleRequestTriggerConditionExtensionError = None,
        instance_error_count: main_models.UpdateAlertRuleRequestTriggerConditionExtensionInstanceErrorCount = None,
        instance_error_percentage: main_models.UpdateAlertRuleRequestTriggerConditionExtensionInstanceErrorPercentage = None,
        instance_transfer_fluctuate: main_models.UpdateAlertRuleRequestTriggerConditionExtensionInstanceTransferFluctuate = None,
        timeout: main_models.UpdateAlertRuleRequestTriggerConditionExtensionTimeout = None,
        un_finished: main_models.UpdateAlertRuleRequestTriggerConditionExtensionUnFinished = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CycleUnfinished') is not None:
            temp_model = main_models.UpdateAlertRuleRequestTriggerConditionExtensionCycleUnfinished()
            self.cycle_unfinished = temp_model.from_map(m.get('CycleUnfinished'))

        if m.get('Error') is not None:
            temp_model = main_models.UpdateAlertRuleRequestTriggerConditionExtensionError()
            self.error = temp_model.from_map(m.get('Error'))

        if m.get('InstanceErrorCount') is not None:
            temp_model = main_models.UpdateAlertRuleRequestTriggerConditionExtensionInstanceErrorCount()
            self.instance_error_count = temp_model.from_map(m.get('InstanceErrorCount'))

        if m.get('InstanceErrorPercentage') is not None:
            temp_model = main_models.UpdateAlertRuleRequestTriggerConditionExtensionInstanceErrorPercentage()
        ...
        if m.get('InstanceTransferFluctuate') is not None:
            temp_model = main_models.UpdateAlertRuleRequestTriggerConditionExtensionInstanceTransferFluctuate()
            self.instance_transfer_fluctuate = temp_model.from_map(m.get('InstanceTransferFluctuate'))

        if m.get('Timeout') is not None:
            temp_model = main_models.UpdateAlertRuleRequestTriggerConditionExtensionTimeout()
            self.timeout = temp_model.from_map(m.get('Timeout'))

        if m.get('UnFinished') is not None:
            temp_model = main_models.UpdateAlertRuleRequestTriggerConditionExtensionUnFinished()
            self.un_finished = temp_model.from_map(m.get('UnFinished'))

        return self

class UpdateAlertRuleRequestTriggerConditionExtensionUnFinished(DaraModel):
    def __init__(
        self,
...
class UpdateAlertRuleRequestTriggerConditionExtensionTimeout(DaraModel):
    def __init__(
        self,
...
class UpdateAlertRuleRequestTriggerConditionExtensionInstanceTransferFluctuate(DaraModel):
    def __init__(
        self,
        percentage: int = None,
        trend: str = None,
...
class UpdateAlertRuleRequestTriggerConditionExtensionInstanceErrorPercentage(DaraModel):
    def __init__(
        self,
        percentage: int = None,
    ):
...
class UpdateAlertRuleRequestTriggerConditionExtensionInstanceErrorCount(DaraModel):
    def __init__(
        self,
        count: int = None,
    ):
...
class UpdateAlertRuleRequestTriggerConditionExtensionError(DaraModel):
    def __init__(
        self,
...
class UpdateAlertRuleRequestTriggerConditionExtensionCycleUnfinished(DaraModel):
    def __init__(
        self,
        cycle_and_time: List[main_models.UpdateAlertRuleRequestTriggerConditionExtensionCycleUnfinishedCycleAndTime] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CycleAndTime') is not None:
            for k1 in m.get('CycleAndTime'):
                temp_model = main_models.UpdateAlertRuleRequestTriggerConditionExtensionCycleUnfinishedCycleAndTime()
                self.cycle_and_time.append(temp_model.from_map(k1))

        return self

class UpdateAlertRuleRequestTriggerConditionExtensionCycleUnfinishedCycleAndTime(DaraModel):
    def __init__(
        self,
        cycle_id: int = None,
        time: str = None,
...
class UpdateAlertRuleRequestNotification(DaraModel):
    def __init__(
        self,
        channels: List[str] = None,
        interval_in_minutes: int = None,
        maximum: int = None,
        receivers: List[main_models.UpdateAlertRuleRequestNotificationReceivers] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Receivers') is not None:
            for k1 in m.get('Receivers'):
                temp_model = main_models.UpdateAlertRuleRequestNotificationReceivers()
...
class UpdateAlertRuleRequestNotificationReceivers(DaraModel):
    def __init__(
        self,
        extension: str = None,

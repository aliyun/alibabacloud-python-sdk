...
class ListCertificatesResponseBody(DaraModel):
    def __init__(
        self,
        paging_info: main_models.ListCertificatesResponseBodyPagingInfo = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PagingInfo') is not None:
            temp_model = main_models.ListCertificatesResponseBodyPagingInfo()
...
class ListCertificatesResponseBodyPagingInfo(DaraModel):
    def __init__(
        self,
        certificates: List[main_models.ListCertificatesResponseBodyPagingInfoCertificates] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Certificates') is not None:
            for k1 in m.get('Certificates'):
                temp_model = main_models.ListCertificatesResponseBodyPagingInfoCertificates()
...
class ListCertificatesResponseBodyPagingInfoCertificates(DaraModel):
    def __init__(
        self,

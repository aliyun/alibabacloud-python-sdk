...
class UnTagDataAssetsRequest(DaraModel):
    def __init__(
        self,
        ...
        env_type: str = None,
        project_id: int = None,
        tags: List[main_models.UnTagDataAssetsRequestTags] = None,
    ):
        # The data asset IDs.
        # 
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.UnTagDataAssetsRequestTags()
                self.tags.append(temp_model.from_map(k1))

        return self

class UnTagDataAssetsRequestTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

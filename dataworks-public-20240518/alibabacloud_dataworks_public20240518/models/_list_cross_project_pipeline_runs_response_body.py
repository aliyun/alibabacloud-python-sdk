...
class ListCrossProjectPipelineRunsResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.ListCrossProjectPipelineRunsResponseBodyData = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListCrossProjectPipelineRunsResponseBodyData()
...
class ListCrossProjectPipelineRunsResponseBodyData(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        pipeline_runs: List[main_models.ListCrossProjectPipelineRunsResponseBodyDataPipelineRuns] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PipelineRuns') is not None:
            for k1 in m.get('PipelineRuns'):
                temp_model = main_models.ListCrossProjectPipelineRunsResponseBodyDataPipelineRuns()
...
class ListCrossProjectPipelineRunsResponseBodyDataPipelineRuns(DaraModel):
    def __init__(
        self,

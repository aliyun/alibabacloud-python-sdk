...
class ListUpstreamTasksResponseBody(DaraModel):
    def __init__(
        self,
        paging_info: main_models.ListUpstreamTasksResponseBodyPagingInfo = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PagingInfo') is not None:
            temp_model = main_models.ListUpstreamTasksResponseBodyPagingInfo()
...
class ListUpstreamTasksResponseBodyPagingInfo(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        tasks: List[main_models.ListUpstreamTasksResponseBodyPagingInfoTasks] = None,
        total_count: int = None,
        upstream_tasks: List[main_models.ListUpstreamTasksResponseBodyPagingInfoUpstreamTasks] = None,
    ):
        # The page number.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tasks') is not None:
            for k1 in m.get('Tasks'):
                temp_model = main_models.ListUpstreamTasksResponseBodyPagingInfoTasks()
        ...
        if m.get('UpstreamTasks') is not None:
            for k1 in m.get('UpstreamTasks'):
                temp_model = main_models.ListUpstreamTasksResponseBodyPagingInfoUpstreamTasks()
                self.upstream_tasks.append(temp_model.from_map(k1))

        return self

class ListUpstreamTasksResponseBodyPagingInfoUpstreamTasks(DaraModel):
    def __init__(
        self,
        dependency_type: str = None,
        task: main_models.ListUpstreamTasksResponseBodyPagingInfoUpstreamTasksTask = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Task') is not None:
            temp_model = main_models.ListUpstreamTasksResponseBodyPagingInfoUpstreamTasksTask()
            self.task = temp_model.from_map(m.get('Task'))

        return self

class ListUpstreamTasksResponseBodyPagingInfoUpstreamTasksTask(DaraModel):
    def __init__(
        self,
        baseline_id: int = None,
        create_time: int = None,
        create_user: str = None,
        data_source: main_models.ListUpstreamTasksResponseBodyPagingInfoUpstreamTasksTaskDataSource = None,
        ...
        runtime_resource: main_models.ListUpstreamTasksResponseBodyPagingInfoUpstreamTasksTaskRuntimeResource = None,
        timeout: int = None,
        trigger: main_models.ListUpstreamTasksResponseBodyPagingInfoUpstreamTasksTaskTrigger = None,
        type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataSource') is not None:
            temp_model = main_models.ListUpstreamTasksResponseBodyPagingInfoUpstreamTasksTaskDataSource()
        ...
        if m.get('RuntimeResource') is not None:
            temp_model = main_models.ListUpstreamTasksResponseBodyPagingInfoUpstreamTasksTaskRuntimeResource()
        ...
        if m.get('Trigger') is not None:
            temp_model = main_models.ListUpstreamTasksResponseBodyPagingInfoUpstreamTasksTaskTrigger()
...
class ListUpstreamTasksResponseBodyPagingInfoUpstreamTasksTaskTrigger(DaraModel):
    def __init__(
        self,
        cron: str = None,
        end_time: str = None,
...
class ListUpstreamTasksResponseBodyPagingInfoUpstreamTasksTaskRuntimeResource(DaraModel):
    def __init__(
        self,
        cu: str = None,
        image: str = None,
...
class ListUpstreamTasksResponseBodyPagingInfoUpstreamTasksTaskDataSource(DaraModel):
    def __init__(
        self,
        name: str = None,
    ):
...
class ListUpstreamTasksResponseBodyPagingInfoTasks(DaraModel):
    def __init__(
        self,
        baseline_id: int = None,
        create_time: int = None,
        create_user: str = None,
        data_source: main_models.ListUpstreamTasksResponseBodyPagingInfoTasksDataSource = None,
        description: str = None,
        env_type: str = None,
        id: int = None,
        instance_mode: str = None,
        ...
        rerun_mode: str = None,
        rerun_times: int = None,
        runtime_resource: main_models.ListUpstreamTasksResponseBodyPagingInfoTasksRuntimeResource = None,
        step_type: str = None,
        timeout: int = None,
        trigger: main_models.ListUpstreamTasksResponseBodyPagingInfoTasksTrigger = None,
        type: str = None,
        workflow_id: int = None,
    ):
        # The baseline ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataSource') is not None:
            temp_model = main_models.ListUpstreamTasksResponseBodyPagingInfoTasksDataSource()
            self.data_source = temp_model.from_map(m.get('DataSource'))
        ...
        if m.get('RuntimeResource') is not None:
            temp_model = main_models.ListUpstreamTasksResponseBodyPagingInfoTasksRuntimeResource()
            self.runtime_resource = temp_model.from_map(m.get('RuntimeResource'))
        ...
        if m.get('Trigger') is not None:
            temp_model = main_models.ListUpstreamTasksResponseBodyPagingInfoTasksTrigger()
            self.trigger = temp_model.from_map(m.get('Trigger'))
...
class ListUpstreamTasksResponseBodyPagingInfoTasksTrigger(DaraModel):
    def __init__(
        self,
        cron: str = None,
        end_time: str = None,
...
class ListUpstreamTasksResponseBodyPagingInfoTasksRuntimeResource(DaraModel):
    def __init__(
        self,
        cu: str = None,
        image: str = None,
...
class ListUpstreamTasksResponseBodyPagingInfoTasksDataSource(DaraModel):
    def __init__(
        self,
        name: str = None,
    ):

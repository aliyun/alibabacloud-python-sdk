...
class UpdateTaskAsyncRequest(DaraModel):
    def __init__(
        self,
        client_unique_code: str = None,
        data_source: main_models.UpdateTaskAsyncRequestDataSource = None,
        dependencies: List[main_models.UpdateTaskAsyncRequestDependencies] = None,
        description: str = None,
        env_type: str = None,
        id: int = None,
        inputs: main_models.UpdateTaskAsyncRequestInputs = None,
        instance_mode: str = None,
        name: str = None,
        outputs: main_models.UpdateTaskAsyncRequestOutputs = None,
        owner: str = None,
        rerun_interval: int = None,
        rerun_mode: str = None,
        rerun_times: int = None,
        runtime_resource: main_models.UpdateTaskAsyncRequestRuntimeResource = None,
        script: main_models.UpdateTaskAsyncRequestScript = None,
        tags: List[main_models.UpdateTaskAsyncRequestTags] = None,
        timeout: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataSource') is not None:
            temp_model = main_models.UpdateTaskAsyncRequestDataSource()
            self.data_source = temp_model.from_map(m.get('DataSource'))

        self.dependencies = []
        if m.get('Dependencies') is not None:
            for k1 in m.get('Dependencies'):
                temp_model = main_models.UpdateTaskAsyncRequestDependencies()
        ...
        if m.get('Inputs') is not None:
            temp_model = main_models.UpdateTaskAsyncRequestInputs()
        ...
        if m.get('Outputs') is not None:
            temp_model = main_models.UpdateTaskAsyncRequestOutputs()
        ...
        if m.get('RuntimeResource') is not None:
            temp_model = main_models.UpdateTaskAsyncRequestRuntimeResource()
            self.runtime_resource = temp_model.from_map(m.get('RuntimeResource'))

        if m.get('Script') is not None:
            temp_model = main_models.UpdateTaskAsyncRequestScript()
            self.script = temp_model.from_map(m.get('Script'))

        self.tags = []
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.UpdateTaskAsyncRequestTags()
        ...
        if m.get('Trigger') is not None:
            temp_model = main_models.UpdateTaskAsyncRequestTrigger()
            self.trigger = temp_model.from_map(m.get('Trigger'))

        return self

class UpdateTaskAsyncRequestTrigger(DaraModel):
    def __init__(
        self,
        cron: str = None,
        cycle_type: str = None,
...
class UpdateTaskAsyncRequestTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class UpdateTaskAsyncRequestScript(DaraModel):
    def __init__(
        self,
        content: str = None,
        parameters: str = None,
...
class UpdateTaskAsyncRequestRuntimeResource(DaraModel):
    def __init__(
        self,
        cu: str = None,
        image: str = None,
...
class UpdateTaskAsyncRequestOutputs(DaraModel):
    def __init__(
        self,
        task_outputs: List[main_models.UpdateTaskAsyncRequestOutputsTaskOutputs] = None,
        variables: List[main_models.UpdateTaskAsyncRequestOutputsVariables] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TaskOutputs') is not None:
            for k1 in m.get('TaskOutputs'):
                temp_model = main_models.UpdateTaskAsyncRequestOutputsTaskOutputs()
                self.task_outputs.append(temp_model.from_map(k1))

        self.variables = []
        if m.get('Variables') is not None:
            for k1 in m.get('Variables'):
                temp_model = main_models.UpdateTaskAsyncRequestOutputsVariables()
                self.variables.append(temp_model.from_map(k1))

        return self

class UpdateTaskAsyncRequestOutputsVariables(DaraModel):
    def __init__(
        self,
        name: str = None,
        type: str = None,
...
class UpdateTaskAsyncRequestOutputsTaskOutputs(DaraModel):
    def __init__(
        self,
        output: str = None,
    ):
...
class UpdateTaskAsyncRequestInputs(DaraModel):
    def __init__(
        self,
        variables: List[main_models.UpdateTaskAsyncRequestInputsVariables] = None,
    ):
        # The list of variable definitions.
        self.variables = variables
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Variables') is not None:
            for k1 in m.get('Variables'):
                temp_model = main_models.UpdateTaskAsyncRequestInputsVariables()
                self.variables.append(temp_model.from_map(k1))

        return self

class UpdateTaskAsyncRequestInputsVariables(DaraModel):
    def __init__(
        self,
        name: str = None,
        type: str = None,
...
class UpdateTaskAsyncRequestDependencies(DaraModel):
    def __init__(
        self,
        type: str = None,
...
class UpdateTaskAsyncRequestDataSource(DaraModel):
    def __init__(
        self,
        name: str = None,
    ):

...
class GetDataQualityAlertRuleResponseBody(DaraModel):
    def __init__(
        self,
        data_quality_alert_rule: main_models.GetDataQualityAlertRuleResponseBodyDataQualityAlertRule = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataQualityAlertRule') is not None:
            temp_model = main_models.GetDataQualityAlertRuleResponseBodyDataQualityAlertRule()
            self.data_quality_alert_rule = temp_model.from_map(m.get('DataQualityAlertRule'))
...
class GetDataQualityAlertRuleResponseBodyDataQualityAlertRule(DaraModel):
    def __init__(
        self,
        condition: str = None,
        id: int = None,
        notification: main_models.GetDataQualityAlertRuleResponseBodyDataQualityAlertRuleNotification = None,
        project_id: int = None,
        target: main_models.GetDataQualityAlertRuleResponseBodyDataQualityAlertRuleTarget = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Notification') is not None:
            temp_model = main_models.GetDataQualityAlertRuleResponseBodyDataQualityAlertRuleNotification()
        ...
        if m.get('Target') is not None:
            temp_model = main_models.GetDataQualityAlertRuleResponseBodyDataQualityAlertRuleTarget()
            self.target = temp_model.from_map(m.get('Target'))

        return self

class GetDataQualityAlertRuleResponseBodyDataQualityAlertRuleTarget(DaraModel):
    def __init__(
        self,
        ids: List[int] = None,
        type: str = None,
...
class GetDataQualityAlertRuleResponseBodyDataQualityAlertRuleNotification(DaraModel):
    def __init__(
        self,
        channels: List[str] = None,
        receivers: List[main_models.GetDataQualityAlertRuleResponseBodyDataQualityAlertRuleNotificationReceivers] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Receivers') is not None:
            for k1 in m.get('Receivers'):
                temp_model = main_models.GetDataQualityAlertRuleResponseBodyDataQualityAlertRuleNotificationReceivers()
                self.receivers.append(temp_model.from_map(k1))

        return self

class GetDataQualityAlertRuleResponseBodyDataQualityAlertRuleNotificationReceivers(DaraModel):
    def __init__(
        self,
        extension: str = None,

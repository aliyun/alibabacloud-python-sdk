...
class GetUpdateTaskResultResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.GetUpdateTaskResultResponseBodyResult = None,
    ):
        # Id of the request
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.GetUpdateTaskResultResponseBodyResult()
            self.result = temp_model.from_map(m.get('Result'))

        return self

class GetUpdateTaskResultResponseBodyResult(DaraModel):
    def __init__(
        self,

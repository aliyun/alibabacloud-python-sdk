...
class SubmitBatchChangeTableOwnerShrinkRequest(DaraModel):
    def __init__(
        self,
    ...
    def to_map(self):
        ...
        if self.table_meta_entity_ids_shrink is not None:
            result['TableMetaEntityIds'] = self.table_meta_entity_ids_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TableMetaEntityIds') is not None:
            self.table_meta_entity_ids_shrink = m.get('TableMetaEntityIds')

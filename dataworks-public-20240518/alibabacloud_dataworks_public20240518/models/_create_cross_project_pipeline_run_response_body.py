...
class CreateCrossProjectPipelineRunResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.CreateCrossProjectPipelineRunResponseBodyData = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CreateCrossProjectPipelineRunResponseBodyData()
...
class CreateCrossProjectPipelineRunResponseBodyData(DaraModel):
    def __init__(
        self,

...
```bash
# 安装 alibabacloud_schedulerx220190430
pip install alibabacloud_schedulerx220190430
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/schedulerx2-20190430/ChangeLog.md)中。

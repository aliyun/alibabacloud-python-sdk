...
class ReadSchedulerxDesignateDetailResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: main_models.ReadSchedulerxDesignateDetailResponseBodyAccessDeniedDetail = None,
        code: int = None,
        data: main_models.ReadSchedulerxDesignateDetailResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AccessDeniedDetail') is not None:
            temp_model = main_models.ReadSchedulerxDesignateDetailResponseBodyAccessDeniedDetail()
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ReadSchedulerxDesignateDetailResponseBodyData()
...
class ReadSchedulerxDesignateDetailResponseBodyData(DaraModel):
    def __init__(
        self,
        designate_detail_vos: List[main_models.ReadSchedulerxDesignateDetailResponseBodyDataDesignateDetailVos] = None,
    ):
        # *
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DesignateDetailVos') is not None:
            for k1 in m.get('DesignateDetailVos'):
                temp_model = main_models.ReadSchedulerxDesignateDetailResponseBodyDataDesignateDetailVos()
                self.designate_detail_vos.append(temp_model.from_map(k1))

        return self

class ReadSchedulerxDesignateDetailResponseBodyDataDesignateDetailVos(DaraModel):
    def __init__(
        self,
        busy: str = None,
        checked: bool = None,
        key: str = None,
        metrics: main_models.ReadSchedulerxDesignateDetailResponseBodyDataDesignateDetailVosMetrics = None,
        offline: bool = None,
        size: int = None,
        starter: str = None,
        version: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Metrics') is not None:
            temp_model = main_models.ReadSchedulerxDesignateDetailResponseBodyDataDesignateDetailVosMetrics()
...
class ReadSchedulerxDesignateDetailResponseBodyDataDesignateDetailVosMetrics(DaraModel):
    def __init__(
        self,
...
class ReadSchedulerxDesignateDetailResponseBodyAccessDeniedDetail(DaraModel):
    def __init__(
        self,

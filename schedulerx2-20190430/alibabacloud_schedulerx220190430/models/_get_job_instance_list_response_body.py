...
class GetJobInstanceListResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.GetJobInstanceListResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetJobInstanceListResponseBodyData()
...
class GetJobInstanceListResponseBodyData(DaraModel):
    def __init__(
        self,
        job_instance_details: List[main_models.GetJobInstanceListResponseBodyDataJobInstanceDetails] = None,
    ):
    ...
    def validate(self):
        if self.job_instance_details:
            for v1 in self.job_instance_details:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.job_instance_details is not None:
            for k1 in self.job_instance_details:
                result['JobInstanceDetails'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('JobInstanceDetails') is not None:
            for k1 in m.get('JobInstanceDetails'):
                temp_model = main_models.GetJobInstanceListResponseBodyDataJobInstanceDetails()
                self.job_instance_details.append(temp_model.from_map(k1))

        return self

class GetJobInstanceListResponseBodyDataJobInstanceDetails(DaraModel):
    def __init__(
        self,
        data_time: str = None,
        end_time: str = None,

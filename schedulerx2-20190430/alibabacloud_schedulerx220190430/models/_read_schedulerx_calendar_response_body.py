...
class ReadSchedulerxCalendarResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: main_models.ReadSchedulerxCalendarResponseBodyAccessDeniedDetail = None,
        code: int = None,
        data: main_models.ReadSchedulerxCalendarResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AccessDeniedDetail') is not None:
            temp_model = main_models.ReadSchedulerxCalendarResponseBodyAccessDeniedDetail()
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ReadSchedulerxCalendarResponseBodyData()
...
class ReadSchedulerxCalendarResponseBodyData(DaraModel):
    def __init__(
        self,
        max_results: int = None,
        next_token: str = None,
        records: List[main_models.ReadSchedulerxCalendarResponseBodyDataRecords] = None,
        total: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Records') is not None:
            for k1 in m.get('Records'):
                temp_model = main_models.ReadSchedulerxCalendarResponseBodyDataRecords()
...
class ReadSchedulerxCalendarResponseBodyDataRecords(DaraModel):
    def __init__(
        self,
...
class ReadSchedulerxCalendarResponseBodyAccessDeniedDetail(DaraModel):
    def __init__(
        self,

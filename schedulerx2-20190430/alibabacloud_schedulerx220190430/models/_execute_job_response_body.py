...
class ExecuteJobResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.ExecuteJobResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ExecuteJobResponseBodyData()
...
class ExecuteJobResponseBodyData(DaraModel):
    def __init__(
        self,

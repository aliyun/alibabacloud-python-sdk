...
## Alibaba Cloud MPServerless SDK for Python
...
```bash
# 安装 alibabacloud_mpserverless20190615
pip install alibabacloud_mpserverless20190615
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/mpserverless-20190615/ChangeLog.md)中。

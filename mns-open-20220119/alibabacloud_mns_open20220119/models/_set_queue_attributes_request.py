...
class SetQueueAttributesRequest(DaraModel):
    def __init__(
        self,
        delay_seconds: int = None,
        dlq_policy: main_models.SetQueueAttributesRequestDlqPolicy = None,
        ...
        sse_type: str = None,
        tenant_rate_limit_policy: main_models.SetQueueAttributesRequestTenantRateLimitPolicy = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DlqPolicy') is not None:
            temp_model = main_models.SetQueueAttributesRequestDlqPolicy()
        ...
        if m.get('TenantRateLimitPolicy') is not None:
            temp_model = main_models.SetQueueAttributesRequestTenantRateLimitPolicy()
...
class SetQueueAttributesRequestTenantRateLimitPolicy(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
...
class SetQueueAttributesRequestDlqPolicy(DaraModel):
    def __init__(
        self,

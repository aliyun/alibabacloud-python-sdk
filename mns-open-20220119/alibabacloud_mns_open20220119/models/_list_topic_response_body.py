...
class ListTopicResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.ListTopicResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        status: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListTopicResponseBodyData()
...
class ListTopicResponseBodyData(DaraModel):
    def __init__(
        self,
        page_data: List[main_models.ListTopicResponseBodyDataPageData] = None,
        page_num: int = None,
        page_size: int = None,
        total: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PageData') is not None:
            for k1 in m.get('PageData'):
                temp_model = main_models.ListTopicResponseBodyDataPageData()
...
class ListTopicResponseBodyDataPageData(DaraModel):
    def __init__(
        self,
        ...
        sse_type: str = None,
        tags: List[main_models.ListTopicResponseBodyDataPageDataTags] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.ListTopicResponseBodyDataPageDataTags()
...
class ListTopicResponseBodyDataPageDataTags(DaraModel):
    def __init__(
        self,
        tag_key: str = None,
        tag_value: str = None,

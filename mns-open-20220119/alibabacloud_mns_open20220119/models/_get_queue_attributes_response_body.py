...
class GetQueueAttributesResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.GetQueueAttributesResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        status: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetQueueAttributesResponseBodyData()
...
class GetQueueAttributesResponseBodyData(DaraModel):
    def __init__(
        self,
        ...
        dlq_policy: main_models.GetQueueAttributesResponseBodyDataDlqPolicy = None,
        ...
        sse_type: str = None,
        tags: List[main_models.GetQueueAttributesResponseBodyDataTags] = None,
        tenant_rate_limit_policy: main_models.GetQueueAttributesResponseBodyDataTenantRateLimitPolicy = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DlqPolicy') is not None:
            temp_model = main_models.GetQueueAttributesResponseBodyDataDlqPolicy()
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.GetQueueAttributesResponseBodyDataTags()
                self.tags.append(temp_model.from_map(k1))

        if m.get('TenantRateLimitPolicy') is not None:
            temp_model = main_models.GetQueueAttributesResponseBodyDataTenantRateLimitPolicy()
...
class GetQueueAttributesResponseBodyDataTenantRateLimitPolicy(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
...
class GetQueueAttributesResponseBodyDataTags(DaraModel):
    def __init__(
        self,
        tag_key: str = None,
        tag_value: str = None,
...
class GetQueueAttributesResponseBodyDataDlqPolicy(DaraModel):
    def __init__(
        self,

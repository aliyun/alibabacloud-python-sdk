...
```bash
# 安装 alibabacloud_appstream_center20210220
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/appstream-center-20210220/ChangeLog.md)中。

...
```bash
# 安装 alibabacloud_resourcecenter20221201
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/resourcecenter-20221201/ChangeLog.md)中。

...
class GetDeliveryChannelResponseBody(DaraModel):
    def __init__(
        self,
        delivery_channel_description: str = None,
        delivery_channel_filter: main_models.GetDeliveryChannelResponseBodyDeliveryChannelFilter = None,
        delivery_channel_id: str = None,
        delivery_channel_name: str = None,
        request_id: str = None,
        resource_change_delivery: main_models.GetDeliveryChannelResponseBodyResourceChangeDelivery = None,
        resource_snapshot_delivery: main_models.GetDeliveryChannelResponseBodyResourceSnapshotDelivery = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DeliveryChannelFilter') is not None:
            temp_model = main_models.GetDeliveryChannelResponseBodyDeliveryChannelFilter()
        ...
        if m.get('ResourceChangeDelivery') is not None:
            temp_model = main_models.GetDeliveryChannelResponseBodyResourceChangeDelivery()
        ...
        if m.get('ResourceSnapshotDelivery') is not None:
            temp_model = main_models.GetDeliveryChannelResponseBodyResourceSnapshotDelivery()
            self.resource_snapshot_delivery = temp_model.from_map(m.get('ResourceSnapshotDelivery'))

        return self

class GetDeliveryChannelResponseBodyResourceSnapshotDelivery(DaraModel):
    def __init__(
        self,
        custom_expression: str = None,
        delivery_time: str = None,
        enabled: str = None,
        sls_properties: main_models.GetDeliveryChannelResponseBodyResourceSnapshotDeliverySlsProperties = None,
        target_arn: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SlsProperties') is not None:
            temp_model = main_models.GetDeliveryChannelResponseBodyResourceSnapshotDeliverySlsProperties()
...
class GetDeliveryChannelResponseBodyResourceSnapshotDeliverySlsProperties(DaraModel):
    def __init__(
        self,
...
class GetDeliveryChannelResponseBodyResourceChangeDelivery(DaraModel):
    def __init__(
        self,
        enabled: str = None,
        sls_properties: main_models.GetDeliveryChannelResponseBodyResourceChangeDeliverySlsProperties = None,
        target_arn: str = None,
        target_type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SlsProperties') is not None:
            temp_model = main_models.GetDeliveryChannelResponseBodyResourceChangeDeliverySlsProperties()
            self.sls_properties = temp_model.from_map(m.get('SlsProperties'))
...
class GetDeliveryChannelResponseBodyResourceChangeDeliverySlsProperties(DaraModel):
    def __init__(
        self,
        oversized_data_oss_target_arn: str = None,
    ):
...
class GetDeliveryChannelResponseBodyDeliveryChannelFilter(DaraModel):
    def __init__(
        self,

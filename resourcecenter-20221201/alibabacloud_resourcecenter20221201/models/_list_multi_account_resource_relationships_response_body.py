...
class ListMultiAccountResourceRelationshipsResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceRelationships') is not None:
            for k1 in m.get('ResourceRelationships'):
                temp_model = main_models.ListMultiAccountResourceRelationshipsResponseBodyResourceRelationships()
...
class ListMultiAccountResourceRelationshipsResponseBodyResourceRelationships(DaraModel):
    def __init__(
        self,
        account_id: str = None,
        region_id: str = None,

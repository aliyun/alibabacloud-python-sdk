...
class UpdateMultiAccountDeliveryChannelRequest(DaraModel):
    def __init__(
        self,
        delivery_channel_description: str = None,
        delivery_channel_filter: main_models.UpdateMultiAccountDeliveryChannelRequestDeliveryChannelFilter = None,
        delivery_channel_id: str = None,
        delivery_channel_name: str = None,
        resource_change_delivery: main_models.UpdateMultiAccountDeliveryChannelRequestResourceChangeDelivery = None,
        resource_snapshot_delivery: main_models.UpdateMultiAccountDeliveryChannelRequestResourceSnapshotDelivery = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DeliveryChannelFilter') is not None:
            temp_model = main_models.UpdateMultiAccountDeliveryChannelRequestDeliveryChannelFilter()
        ...
        if m.get('ResourceChangeDelivery') is not None:
            temp_model = main_models.UpdateMultiAccountDeliveryChannelRequestResourceChangeDelivery()
        ...
        if m.get('ResourceSnapshotDelivery') is not None:
            temp_model = main_models.UpdateMultiAccountDeliveryChannelRequestResourceSnapshotDelivery()
            self.resource_snapshot_delivery = temp_model.from_map(m.get('ResourceSnapshotDelivery'))

        return self

class UpdateMultiAccountDeliveryChannelRequestResourceSnapshotDelivery(DaraModel):
    def __init__(
        self,
        custom_expression: str = None,
        delivery_time: str = None,
        enabled: str = None,
        sls_properties: main_models.UpdateMultiAccountDeliveryChannelRequestResourceSnapshotDeliverySlsProperties = None,
        target_arn: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SlsProperties') is not None:
            temp_model = main_models.UpdateMultiAccountDeliveryChannelRequestResourceSnapshotDeliverySlsProperties()
...
class UpdateMultiAccountDeliveryChannelRequestResourceSnapshotDeliverySlsProperties(DaraModel):
    def __init__(
        self,
...
class UpdateMultiAccountDeliveryChannelRequestResourceChangeDelivery(DaraModel):
    def __init__(
        self,
        enabled: str = None,
        sls_properties: main_models.UpdateMultiAccountDeliveryChannelRequestResourceChangeDeliverySlsProperties = None,
        target_arn: str = None,
        target_type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SlsProperties') is not None:
            temp_model = main_models.UpdateMultiAccountDeliveryChannelRequestResourceChangeDeliverySlsProperties()
            self.sls_properties = temp_model.from_map(m.get('SlsProperties'))
...
class UpdateMultiAccountDeliveryChannelRequestResourceChangeDeliverySlsProperties(DaraModel):
    def __init__(
        self,
        oversized_data_oss_target_arn: str = None,
    ):
...
class UpdateMultiAccountDeliveryChannelRequestDeliveryChannelFilter(DaraModel):
    def __init__(
        self,

...
class SearchResourcesResponseBody(DaraModel):
    def __init__(
        self,
        filters: List[main_models.SearchResourcesResponseBodyFilters] = None,
        max_results: int = None,
        next_token: str = None,
        request_id: str = None,
        resources: List[main_models.SearchResourcesResponseBodyResources] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Filters') is not None:
            for k1 in m.get('Filters'):
                temp_model = main_models.SearchResourcesResponseBodyFilters()
        ...
        if m.get('Resources') is not None:
            for k1 in m.get('Resources'):
                temp_model = main_models.SearchResourcesResponseBodyResources()
                self.resources.append(temp_model.from_map(k1))

        return self

class SearchResourcesResponseBodyResources(DaraModel):
    def __init__(
        self,
        account_id: str = None,
        ...
        ip_address_attributes: List[main_models.SearchResourcesResponseBodyResourcesIpAddressAttributes] = None,
        ...
        tags: List[main_models.SearchResourcesResponseBodyResourcesTags] = None,
        zone_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IpAddressAttributes') is not None:
            for k1 in m.get('IpAddressAttributes'):
                temp_model = main_models.SearchResourcesResponseBodyResourcesIpAddressAttributes()
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.SearchResourcesResponseBodyResourcesTags()
...
class SearchResourcesResponseBodyResourcesTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class SearchResourcesResponseBodyResourcesIpAddressAttributes(DaraModel):
    def __init__(
        self,
        ip_address: str = None,
...
class SearchResourcesResponseBodyFilters(DaraModel):
    def __init__(
        self,
        key: str = None,
        match_type: str = None,

...
class SearchMultiAccountResourcesResponseBody(DaraModel):
    def __init__(
        self,
        filters: List[main_models.SearchMultiAccountResourcesResponseBodyFilters] = None,
        max_results: int = None,
        next_token: str = None,
        request_id: str = None,
        resources: List[main_models.SearchMultiAccountResourcesResponseBodyResources] = None,
        scope: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Filters') is not None:
            for k1 in m.get('Filters'):
                temp_model = main_models.SearchMultiAccountResourcesResponseBodyFilters()
        ...
        if m.get('Resources') is not None:
            for k1 in m.get('Resources'):
                temp_model = main_models.SearchMultiAccountResourcesResponseBodyResources()
...
class SearchMultiAccountResourcesResponseBodyResources(DaraModel):
    def __init__(
        self,
        account_id: str = None,
        create_time: str = None,
        expire_time: str = None,
        ip_address_attributes: List[main_models.SearchMultiAccountResourcesResponseBodyResourcesIpAddressAttributes] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IpAddressAttributes') is not None:
            for k1 in m.get('IpAddressAttributes'):
                temp_model = main_models.SearchMultiAccountResourcesResponseBodyResourcesIpAddressAttributes()
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.SearchMultiAccountResourcesResponseBodyResourcesTags()
...
class SearchMultiAccountResourcesResponseBodyResourcesTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class SearchMultiAccountResourcesResponseBodyResourcesIpAddressAttributes(DaraModel):
    def __init__(
        self,
        ip_address: str = None,
...
class SearchMultiAccountResourcesResponseBodyFilters(DaraModel):
    def __init__(
        self,
        key: str = None,
        match_type: str = None,

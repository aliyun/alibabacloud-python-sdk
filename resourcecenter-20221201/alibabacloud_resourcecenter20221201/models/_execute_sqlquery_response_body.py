...
class ExecuteSQLQueryResponseBody(DaraModel):
    def __init__(
        self,
        columns: List[main_models.ExecuteSQLQueryResponseBodyColumns] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Columns') is not None:
            for k1 in m.get('Columns'):
                temp_model = main_models.ExecuteSQLQueryResponseBodyColumns()
...
class ExecuteSQLQueryResponseBodyColumns(DaraModel):
    def __init__(
        self,
        name: str = None,
        type: str = None,

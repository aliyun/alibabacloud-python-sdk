...
class ListResourceRelationshipsRequest(DaraModel):
    def __init__(
        self,
        max_results: int = None,
        next_token: str = None,
        region_id: str = None,
        related_resource_filter: List[main_models.ListResourceRelationshipsRequestRelatedResourceFilter] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RelatedResourceFilter') is not None:
            for k1 in m.get('RelatedResourceFilter'):
                temp_model = main_models.ListResourceRelationshipsRequestRelatedResourceFilter()
...
class ListResourceRelationshipsRequestRelatedResourceFilter(DaraModel):
    def __init__(
        self,
        key: str = None,
        match_type: str = None,

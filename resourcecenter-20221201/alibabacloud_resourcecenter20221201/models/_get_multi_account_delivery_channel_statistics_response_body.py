...
class GetMultiAccountDeliveryChannelStatisticsResponseBody(DaraModel):
    def __init__(
        self,
        delivery_channel_statistics: main_models.GetMultiAccountDeliveryChannelStatisticsResponseBodyDeliveryChannelStatistics = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DeliveryChannelStatistics') is not None:
            temp_model = main_models.GetMultiAccountDeliveryChannelStatisticsResponseBodyDeliveryChannelStatistics()
...
class GetMultiAccountDeliveryChannelStatisticsResponseBodyDeliveryChannelStatistics(DaraModel):
    def __init__(
        self,

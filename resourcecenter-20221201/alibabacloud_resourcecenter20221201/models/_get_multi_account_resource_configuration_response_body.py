...
class GetMultiAccountResourceConfigurationResponseBody(DaraModel):
    def __init__(
        self,
        account_id: str = None,
        ...
        ip_address_attributes: List[main_models.GetMultiAccountResourceConfigurationResponseBodyIpAddressAttributes] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IpAddressAttributes') is not None:
            for k1 in m.get('IpAddressAttributes'):
                temp_model = main_models.GetMultiAccountResourceConfigurationResponseBodyIpAddressAttributes()
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.GetMultiAccountResourceConfigurationResponseBodyTags()
...
class GetMultiAccountResourceConfigurationResponseBodyTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class GetMultiAccountResourceConfigurationResponseBodyIpAddressAttributes(DaraModel):
    def __init__(
        self,
        ip_address: str = None,

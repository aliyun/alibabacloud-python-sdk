...
class ListMultiAccountDeliveryChannelsResponseBody(DaraModel):
    def __init__(
        self,
        delivery_channels: List[main_models.ListMultiAccountDeliveryChannelsResponseBodyDeliveryChannels] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DeliveryChannels') is not None:
            for k1 in m.get('DeliveryChannels'):
                temp_model = main_models.ListMultiAccountDeliveryChannelsResponseBodyDeliveryChannels()
...
class ListMultiAccountDeliveryChannelsResponseBodyDeliveryChannels(DaraModel):
    def __init__(
        self,

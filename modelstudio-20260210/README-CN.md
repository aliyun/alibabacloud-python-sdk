...
## Alibaba Cloud ModelStudio SDK for Python
...
```bash
# 安装 alibabacloud_modelstudio20260210
pip install alibabacloud_modelstudio20260210
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/modelstudio-20260210/ChangeLog.md)中。

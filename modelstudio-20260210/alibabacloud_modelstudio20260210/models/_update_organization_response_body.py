...
class UpdateOrganizationResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.UpdateOrganizationResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.UpdateOrganizationResponseBodyData()
...
class UpdateOrganizationResponseBodyData(DaraModel):
    def __init__(
        self,

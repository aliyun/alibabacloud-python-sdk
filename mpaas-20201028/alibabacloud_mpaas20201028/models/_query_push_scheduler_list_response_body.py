...
class QueryPushSchedulerListResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result_code: str = None,
        result_content: main_models.QueryPushSchedulerListResponseBodyResultContent = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResultContent') is not None:
            temp_model = main_models.QueryPushSchedulerListResponseBodyResultContent()
...
class QueryPushSchedulerListResponseBodyResultContent(DaraModel):
    def __init__(
        self,
        data: main_models.QueryPushSchedulerListResponseBodyResultContentData = None,
    ):
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.QueryPushSchedulerListResponseBodyResultContentData()
            self.data = temp_model.from_map(m.get('Data'))

        return self

class QueryPushSchedulerListResponseBodyResultContentData(DaraModel):
    def __init__(
        self,
        list: List[main_models.QueryPushSchedulerListResponseBodyResultContentDataList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            for k1 in m.get('List'):
                temp_model = main_models.QueryPushSchedulerListResponseBodyResultContentDataList()
...
class QueryPushSchedulerListResponseBodyResultContentDataList(DaraModel):
    def __init__(
        self,

...
class ListMgsApiResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result_code: str = None,
        result_content: main_models.ListMgsApiResponseBodyResultContent = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResultContent') is not None:
            temp_model = main_models.ListMgsApiResponseBodyResultContent()
...
class ListMgsApiResponseBodyResultContent(DaraModel):
    def __init__(
        self,
        error_message: str = None,
        success: bool = None,
        value: List[main_models.ListMgsApiResponseBodyResultContentValue] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Value') is not None:
            for k1 in m.get('Value'):
                temp_model = main_models.ListMgsApiResponseBodyResultContentValue()
                self.value.append(temp_model.from_map(k1))

        return self

class ListMgsApiResponseBodyResultContentValue(DaraModel):
    def __init__(
        self,
        api_invoker: main_models.ListMgsApiResponseBodyResultContentValueApiInvoker = None,
        api_name: str = None,
        api_status: str = None,
        api_type: str = None,
        app_id: str = None,
        auth_rule_name: str = None,
        cache_rule: main_models.ListMgsApiResponseBodyResultContentValueCacheRule = None,
        charset: str = None,
        circuit_breaker_rule: main_models.ListMgsApiResponseBodyResultContentValueCircuitBreakerRule = None,
        content_type: str = None,
        description: str = None,
        gmt_create: str = None,
        gmt_modified: str = None,
        header_rule: List[main_models.ListMgsApiResponseBodyResultContentValueHeaderRule] = None,
        header_rules: List[main_models.ListMgsApiResponseBodyResultContentValueHeaderRules] = None,
        host: str = None,
        id: int = None,
        interface_type: str = None,
        limit_rule: main_models.ListMgsApiResponseBodyResultContentValueLimitRule = None,
        method: str = None,
        method_name: str = None,
        migrate_rule: main_models.ListMgsApiResponseBodyResultContentValueMigrateRule = None,
        mock_rule: main_models.ListMgsApiResponseBodyResultContentValueMockRule = None,
        need_etag: str = None,
        ...
        request_params: List[main_models.ListMgsApiResponseBodyResultContentValueRequestParams] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApiInvoker') is not None:
            temp_model = main_models.ListMgsApiResponseBodyResultContentValueApiInvoker()
        ...
        if m.get('CacheRule') is not None:
            temp_model = main_models.ListMgsApiResponseBodyResultContentValueCacheRule()
        ...
        if m.get('CircuitBreakerRule') is not None:
            temp_model = main_models.ListMgsApiResponseBodyResultContentValueCircuitBreakerRule()
        ...
        if m.get('HeaderRule') is not None:
            for k1 in m.get('HeaderRule'):
                temp_model = main_models.ListMgsApiResponseBodyResultContentValueHeaderRule()
                self.header_rule.append(temp_model.from_map(k1))

        self.header_rules = []
        if m.get('HeaderRules') is not None:
            for k1 in m.get('HeaderRules'):
                temp_model = main_models.ListMgsApiResponseBodyResultContentValueHeaderRules()
        ...
        if m.get('LimitRule') is not None:
            temp_model = main_models.ListMgsApiResponseBodyResultContentValueLimitRule()
        ...
        if m.get('MigrateRule') is not None:
            temp_model = main_models.ListMgsApiResponseBodyResultContentValueMigrateRule()
            self.migrate_rule = temp_model.from_map(m.get('MigrateRule'))

        if m.get('MockRule') is not None:
            temp_model = main_models.ListMgsApiResponseBodyResultContentValueMockRule()
        ...
        if m.get('RequestParams') is not None:
            for k1 in m.get('RequestParams'):
                temp_model = main_models.ListMgsApiResponseBodyResultContentValueRequestParams()
...
class ListMgsApiResponseBodyResultContentValueRequestParams(DaraModel):
    def __init__(
        self,
        api_id: str = None,
        app_id: str = None,
...
class ListMgsApiResponseBodyResultContentValueMockRule(DaraModel):
    def __init__(
        self,
        mock_data: str = None,
        need_mock: bool = None,
...
class ListMgsApiResponseBodyResultContentValueMigrateRule(DaraModel):
    def __init__(
        self,
...
class ListMgsApiResponseBodyResultContentValueLimitRule(DaraModel):
    def __init__(
        self,
...
class ListMgsApiResponseBodyResultContentValueHeaderRules(DaraModel):
    def __init__(
        self,
        header_key: str = None,
        location: str = None,
...
class ListMgsApiResponseBodyResultContentValueHeaderRule(DaraModel):
    def __init__(
        self,
        header_key: str = None,
        location: str = None,
...
class ListMgsApiResponseBodyResultContentValueCircuitBreakerRule(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        default_response: str = None,
...
class ListMgsApiResponseBodyResultContentValueCacheRule(DaraModel):
    def __init__(
        self,
        cache_key: str = None,
...
class ListMgsApiResponseBodyResultContentValueApiInvoker(DaraModel):
    def __init__(
        self,
        http_invoker: main_models.ListMgsApiResponseBodyResultContentValueApiInvokerHttpInvoker = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HttpInvoker') is not None:
            temp_model = main_models.ListMgsApiResponseBodyResultContentValueApiInvokerHttpInvoker()
...
class ListMgsApiResponseBodyResultContentValueApiInvokerHttpInvoker(DaraModel):
    def __init__(
        self,
        charset: str = None,
        content_type: str = None,

...
class GetUserAppUploadProcessInMsaResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result_code: str = None,
        result_content: main_models.GetUserAppUploadProcessInMsaResponseBodyResultContent = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResultContent') is not None:
            temp_model = main_models.GetUserAppUploadProcessInMsaResponseBodyResultContent()
...
class GetUserAppUploadProcessInMsaResponseBodyResultContent(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetUserAppUploadProcessInMsaResponseBodyResultContentData = None,
        message: str = None,
        success: bool = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetUserAppUploadProcessInMsaResponseBodyResultContentData()
...
class GetUserAppUploadProcessInMsaResponseBodyResultContentData(DaraModel):
    def __init__(
        self,
        apk_info: main_models.GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApkInfo') is not None:
            temp_model = main_models.GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo()
...
class GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfo(DaraModel):
    def __init__(
        self,
        after_md_5: str = None,
        after_size: int = None,
        ...
        enhance_mapping: List[main_models.GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfoEnhanceMapping] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EnhanceMapping') is not None:
            for k1 in m.get('EnhanceMapping'):
                temp_model = main_models.GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfoEnhanceMapping()
...
class GetUserAppUploadProcessInMsaResponseBodyResultContentDataApkInfoEnhanceMapping(DaraModel):
    def __init__(
        self,
        info: str = None,
        reason: str = None,

...
class CreateMcdpGroupResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result_code: str = None,
        result_content: main_models.CreateMcdpGroupResponseBodyResultContent = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResultContent') is not None:
            temp_model = main_models.CreateMcdpGroupResponseBodyResultContent()
...
class CreateMcdpGroupResponseBodyResultContent(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: str = None,

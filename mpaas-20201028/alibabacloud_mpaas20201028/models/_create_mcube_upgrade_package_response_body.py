...
class CreateMcubeUpgradePackageResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result_code: str = None,
        result_content: main_models.CreateMcubeUpgradePackageResponseBodyResultContent = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResultContent') is not None:
            temp_model = main_models.CreateMcubeUpgradePackageResponseBodyResultContent()
...
class CreateMcubeUpgradePackageResponseBodyResultContent(DaraModel):
    def __init__(
        self,
        data: str = None,
        error_code: str = None,

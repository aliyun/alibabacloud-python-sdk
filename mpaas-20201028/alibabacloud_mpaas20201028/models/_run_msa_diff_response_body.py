...
class RunMsaDiffResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result_code: str = None,
        result_content: main_models.RunMsaDiffResponseBodyResultContent = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResultContent') is not None:
            temp_model = main_models.RunMsaDiffResponseBodyResultContent()
...
class RunMsaDiffResponseBodyResultContent(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: str = None,

...
class ListMcubeMiniTasksResponseBody(DaraModel):
    def __init__(
        self,
        list_mini_task_result: main_models.ListMcubeMiniTasksResponseBodyListMiniTaskResult = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ListMiniTaskResult') is not None:
            temp_model = main_models.ListMcubeMiniTasksResponseBodyListMiniTaskResult()
            self.list_mini_task_result = temp_model.from_map(m.get('ListMiniTaskResult'))
...
class ListMcubeMiniTasksResponseBodyListMiniTaskResult(DaraModel):
    def __init__(
        self,
        mini_task_list: List[main_models.ListMcubeMiniTasksResponseBodyListMiniTaskResultMiniTaskList] = None,
        result_msg: str = None,
        success: bool = None,
    ):
    ...
    def to_map(self):
        ...
        if self.mini_task_list is not None:
            for k1 in self.mini_task_list:
                result['MiniTaskList'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MiniTaskList') is not None:
            for k1 in m.get('MiniTaskList'):
                temp_model = main_models.ListMcubeMiniTasksResponseBodyListMiniTaskResultMiniTaskList()
                self.mini_task_list.append(temp_model.from_map(k1))
...
class ListMcubeMiniTasksResponseBodyListMiniTaskResultMiniTaskList(DaraModel):
    def __init__(
        self,
        app_code: str = None,
        gmt_create: str = None,

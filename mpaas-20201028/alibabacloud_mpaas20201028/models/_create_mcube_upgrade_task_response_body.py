...
class CreateMcubeUpgradeTaskResponseBody(DaraModel):
    def __init__(
        self,
        create_task_result: main_models.CreateMcubeUpgradeTaskResponseBodyCreateTaskResult = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CreateTaskResult') is not None:
            temp_model = main_models.CreateMcubeUpgradeTaskResponseBodyCreateTaskResult()
            self.create_task_result = temp_model.from_map(m.get('CreateTaskResult'))
...
class CreateMcubeUpgradeTaskResponseBodyCreateTaskResult(DaraModel):
    def __init__(
        self,
        error_code: str = None,
        request_id: str = None,

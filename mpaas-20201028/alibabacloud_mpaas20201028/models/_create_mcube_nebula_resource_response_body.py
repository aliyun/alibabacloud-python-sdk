...
class CreateMcubeNebulaResourceResponseBody(DaraModel):
    def __init__(
        self,
        create_mcube_nebula_resource_reslult: main_models.CreateMcubeNebulaResourceResponseBodyCreateMcubeNebulaResourceReslult = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CreateMcubeNebulaResourceReslult') is not None:
            temp_model = main_models.CreateMcubeNebulaResourceResponseBodyCreateMcubeNebulaResourceReslult()
            self.create_mcube_nebula_resource_reslult = temp_model.from_map(m.get('CreateMcubeNebulaResourceReslult'))
...
class CreateMcubeNebulaResourceResponseBodyCreateMcubeNebulaResourceReslult(DaraModel):
    def __init__(
        self,
        error_code: str = None,

...
class CreateMcubeNebulaTaskResponseBody(DaraModel):
    def __init__(
        self,
        create_mcube_nebula_task_result: main_models.CreateMcubeNebulaTaskResponseBodyCreateMcubeNebulaTaskResult = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CreateMcubeNebulaTaskResult') is not None:
            temp_model = main_models.CreateMcubeNebulaTaskResponseBodyCreateMcubeNebulaTaskResult()
            self.create_mcube_nebula_task_result = temp_model.from_map(m.get('CreateMcubeNebulaTaskResult'))
...
class CreateMcubeNebulaTaskResponseBodyCreateMcubeNebulaTaskResult(DaraModel):
    def __init__(
        self,
        error_code: str = None,

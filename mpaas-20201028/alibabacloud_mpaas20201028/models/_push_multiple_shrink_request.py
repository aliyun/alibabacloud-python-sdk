...
class PushMultipleShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        target_msg: List[main_models.PushMultipleShrinkRequestTargetMsg] = None,
        task_name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TargetMsg') is not None:
            for k1 in m.get('TargetMsg'):
                temp_model = main_models.PushMultipleShrinkRequestTargetMsg()
...
class PushMultipleShrinkRequestTargetMsg(DaraModel):
    def __init__(
        self,
        extended_params: str = None,
        msg_key: str = None,

...
class CreateMcubeWhitelistForIdeResponseBody(DaraModel):
    def __init__(
        self,
        create_whitelist_for_ide_result: main_models.CreateMcubeWhitelistForIdeResponseBodyCreateWhitelistForIdeResult = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CreateWhitelistForIdeResult') is not None:
            temp_model = main_models.CreateMcubeWhitelistForIdeResponseBodyCreateWhitelistForIdeResult()
            self.create_whitelist_for_ide_result = temp_model.from_map(m.get('CreateWhitelistForIdeResult'))
...
class CreateMcubeWhitelistForIdeResponseBodyCreateWhitelistForIdeResult(DaraModel):
    def __init__(
        self,
        result_msg: str = None,
        success: bool = None,

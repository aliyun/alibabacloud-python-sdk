...
class QueryMcubeMiniPackageResponseBody(DaraModel):
    def __init__(
        self,
        query_mini_package_result: main_models.QueryMcubeMiniPackageResponseBodyQueryMiniPackageResult = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('QueryMiniPackageResult') is not None:
            temp_model = main_models.QueryMcubeMiniPackageResponseBodyQueryMiniPackageResult()
            self.query_mini_package_result = temp_model.from_map(m.get('QueryMiniPackageResult'))
...
class QueryMcubeMiniPackageResponseBodyQueryMiniPackageResult(DaraModel):
    def __init__(
        self,
        mini_package_info: main_models.QueryMcubeMiniPackageResponseBodyQueryMiniPackageResultMiniPackageInfo = None,
        result_msg: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MiniPackageInfo') is not None:
            temp_model = main_models.QueryMcubeMiniPackageResponseBodyQueryMiniPackageResultMiniPackageInfo()
            self.mini_package_info = temp_model.from_map(m.get('MiniPackageInfo'))
...
class QueryMcubeMiniPackageResponseBodyQueryMiniPackageResultMiniPackageInfo(DaraModel):
    def __init__(
        self,
        app_code: str = None,

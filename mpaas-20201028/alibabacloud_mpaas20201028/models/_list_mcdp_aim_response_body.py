...
class ListMcdpAimResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result_code: str = None,
        result_content: main_models.ListMcdpAimResponseBodyResultContent = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResultContent') is not None:
            temp_model = main_models.ListMcdpAimResponseBodyResultContent()
...
class ListMcdpAimResponseBodyResultContent(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: str = None,

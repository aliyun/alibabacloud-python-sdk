...
class GetUserAppEnhanceProcessInMsaResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result_code: str = None,
        result_content: main_models.GetUserAppEnhanceProcessInMsaResponseBodyResultContent = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResultContent') is not None:
            temp_model = main_models.GetUserAppEnhanceProcessInMsaResponseBodyResultContent()
...
class GetUserAppEnhanceProcessInMsaResponseBodyResultContent(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetUserAppEnhanceProcessInMsaResponseBodyResultContentData = None,
        message: str = None,
        success: bool = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetUserAppEnhanceProcessInMsaResponseBodyResultContentData()
...
class GetUserAppEnhanceProcessInMsaResponseBodyResultContentData(DaraModel):
    def __init__(
        self,
        after_md_5: str = None,
        after_size: int = None,
        ...
        enhance_mapping: List[main_models.GetUserAppEnhanceProcessInMsaResponseBodyResultContentDataEnhanceMapping] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EnhanceMapping') is not None:
            for k1 in m.get('EnhanceMapping'):
                temp_model = main_models.GetUserAppEnhanceProcessInMsaResponseBodyResultContentDataEnhanceMapping()
...
class GetUserAppEnhanceProcessInMsaResponseBodyResultContentDataEnhanceMapping(DaraModel):
    def __init__(
        self,
        info: str = None,
        reason: str = None,

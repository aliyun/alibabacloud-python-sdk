...
class ChatWithKnowledgeBaseStreamResponseBody(DaraModel):
    def __init__(
        self,
        chat_completion: main_models.ChatWithKnowledgeBaseStreamResponseBodyChatCompletion = None,
        message: str = None,
        multi_collection_recall_result: main_models.ChatWithKnowledgeBaseStreamResponseBodyMultiCollectionRecallResult = None,
        request_id: str = None,
        status: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ChatCompletion') is not None:
            temp_model = main_models.ChatWithKnowledgeBaseStreamResponseBodyChatCompletion()
        ...
        if m.get('MultiCollectionRecallResult') is not None:
            temp_model = main_models.ChatWithKnowledgeBaseStreamResponseBodyMultiCollectionRecallResult()
...
class ChatWithKnowledgeBaseStreamResponseBodyMultiCollectionRecallResult(DaraModel):
    def __init__(
        self,
        entities: List[str] = None,
        matches: List[main_models.ChatWithKnowledgeBaseStreamResponseBodyMultiCollectionRecallResultMatches] = None,
        relations: List[str] = None,
        request_id: str = None,
        status: str = None,
        tokens: int = None,
        usage: main_models.ChatWithKnowledgeBaseStreamResponseBodyMultiCollectionRecallResultUsage = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Matches') is not None:
            for k1 in m.get('Matches'):
                temp_model = main_models.ChatWithKnowledgeBaseStreamResponseBodyMultiCollectionRecallResultMatches()
        ...
        if m.get('Usage') is not None:
            temp_model = main_models.ChatWithKnowledgeBaseStreamResponseBodyMultiCollectionRecallResultUsage()
            self.usage = temp_model.from_map(m.get('Usage'))

        return self

class ChatWithKnowledgeBaseStreamResponseBodyMultiCollectionRecallResultUsage(DaraModel):
    def __init__(
        self,
...
class ChatWithKnowledgeBaseStreamResponseBodyMultiCollectionRecallResultMatches(DaraModel):
    def __init__(
        self,
        content: str = None,
        file_name: str = None,
        ...
        metadata: main_models.ChatWithKnowledgeBaseStreamResponseBodyMultiCollectionRecallResultMatchesMetadata = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Metadata') is not None:
            temp_model = main_models.ChatWithKnowledgeBaseStreamResponseBodyMultiCollectionRecallResultMatchesMetadata()
...
class ChatWithKnowledgeBaseStreamResponseBodyMultiCollectionRecallResultMatchesMetadata(DaraModel):
    def __init__(
        self,
        source: int = None,
    ):
...
class ChatWithKnowledgeBaseStreamResponseBodyChatCompletion(DaraModel):
    def __init__(
        self,
        choices: List[main_models.ChatWithKnowledgeBaseStreamResponseBodyChatCompletionChoices] = None,
        created: int = None,
        id: str = None,
        model: str = None,
        usage: main_models.ChatWithKnowledgeBaseStreamResponseBodyChatCompletionUsage = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Choices') is not None:
            for k1 in m.get('Choices'):
                temp_model = main_models.ChatWithKnowledgeBaseStreamResponseBodyChatCompletionChoices()
        ...
        if m.get('Usage') is not None:
            temp_model = main_models.ChatWithKnowledgeBaseStreamResponseBodyChatCompletionUsage()
            self.usage = temp_model.from_map(m.get('Usage'))

        return self

class ChatWithKnowledgeBaseStreamResponseBodyChatCompletionUsage(DaraModel):
    def __init__(
        self,
        completion_tokens: int = None,
        prompt_tokens: int = None,
        prompt_tokens_details: main_models.ChatWithKnowledgeBaseStreamResponseBodyChatCompletionUsagePromptTokensDetails = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PromptTokensDetails') is not None:
            temp_model = main_models.ChatWithKnowledgeBaseStreamResponseBodyChatCompletionUsagePromptTokensDetails()
...
class ChatWithKnowledgeBaseStreamResponseBodyChatCompletionUsagePromptTokensDetails(DaraModel):
    def __init__(
        self,
...
class ChatWithKnowledgeBaseStreamResponseBodyChatCompletionChoices(DaraModel):
    def __init__(
        self,
        finish_reason: str = None,
        index: int = None,
        message: main_models.ChatWithKnowledgeBaseStreamResponseBodyChatCompletionChoicesMessage = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Message') is not None:
            temp_model = main_models.ChatWithKnowledgeBaseStreamResponseBodyChatCompletionChoicesMessage()
            self.message = temp_model.from_map(m.get('Message'))

        return self

class ChatWithKnowledgeBaseStreamResponseBodyChatCompletionChoicesMessage(DaraModel):
    def __init__(
        self,
        content: str = None,
        reasoning_content: str = None,
        role: str = None,
        tool_calls: List[main_models.ChatWithKnowledgeBaseStreamResponseBodyChatCompletionChoicesMessageToolCalls] = None,
    ):
        self.content = content
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ToolCalls') is not None:
            for k1 in m.get('ToolCalls'):
                temp_model = main_models.ChatWithKnowledgeBaseStreamResponseBodyChatCompletionChoicesMessageToolCalls()
                self.tool_calls.append(temp_model.from_map(k1))

        return self

class ChatWithKnowledgeBaseStreamResponseBodyChatCompletionChoicesMessageToolCalls(DaraModel):
    def __init__(
        self,
        function: main_models.ChatWithKnowledgeBaseStreamResponseBodyChatCompletionChoicesMessageToolCallsFunction = None,
        id: str = None,
        index: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Function') is not None:
            temp_model = main_models.ChatWithKnowledgeBaseStreamResponseBodyChatCompletionChoicesMessageToolCallsFunction()
...
class ChatWithKnowledgeBaseStreamResponseBodyChatCompletionChoicesMessageToolCallsFunction(DaraModel):
    def __init__(
        self,
        arguments: str = None,
        name: str = None,

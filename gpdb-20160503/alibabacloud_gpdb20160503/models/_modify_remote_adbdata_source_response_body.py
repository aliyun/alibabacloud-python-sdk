...
class ModifyRemoteADBDataSourceResponseBody(DaraModel):
    def __init__(
        self,
        data_source_item: main_models.ModifyRemoteADBDataSourceResponseBodyDataSourceItem = None,
        request_id: str = None,
        task_id: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataSourceItem') is not None:
            temp_model = main_models.ModifyRemoteADBDataSourceResponseBodyDataSourceItem()
...
class ModifyRemoteADBDataSourceResponseBodyDataSourceItem(DaraModel):
    def __init__(
        self,

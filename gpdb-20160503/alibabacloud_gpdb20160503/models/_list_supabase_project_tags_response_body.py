...
class ListSupabaseProjectTagsResponseBody(DaraModel):
    def __init__(
        self,
        next_token: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TagResources') is not None:
            for k1 in m.get('TagResources'):
                temp_model = main_models.ListSupabaseProjectTagsResponseBodyTagResources()
                self.tag_resources.append(temp_model.from_map(k1))

        return self

class ListSupabaseProjectTagsResponseBodyTagResources(DaraModel):
    def __init__(
        self,

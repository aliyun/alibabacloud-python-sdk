...
class CreateRemoteADBDataSourceResponseBody(DaraModel):
    def __init__(
        self,
        data_source_item: main_models.CreateRemoteADBDataSourceResponseBodyDataSourceItem = None,
        request_id: str = None,
        task_id: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataSourceItem') is not None:
            temp_model = main_models.CreateRemoteADBDataSourceResponseBodyDataSourceItem()
            self.data_source_item = temp_model.from_map(m.get('DataSourceItem'))
...
class CreateRemoteADBDataSourceResponseBodyDataSourceItem(DaraModel):
    def __init__(
        self,

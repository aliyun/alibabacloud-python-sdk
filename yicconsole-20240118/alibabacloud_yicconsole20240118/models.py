...
class BillingProcessMessageRequest(TeaModel):
    def __init__(
        self,
        body: LxPopCmd = None,
    ):
...
class BillingProcessMessageResponseBody(TeaModel):
    def __init__(
        self,
        message: str = None,
        synchro: bool = None,
...
class BillingProcessMessageResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: BillingProcessMessageResponseBody = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('body') is not None:
            temp_model = BillingProcessMessageResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

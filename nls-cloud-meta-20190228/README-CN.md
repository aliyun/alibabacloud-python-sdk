...
## Alibaba Cloud nls-cloud-meta SDK for Python
...
```bash
# 安装 alibabacloud_nls_cloud_meta20190228
pip install alibabacloud_nls_cloud_meta20190228
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/nls-cloud-meta-20190228/ChangeLog.md)中。

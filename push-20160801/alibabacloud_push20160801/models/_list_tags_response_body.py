...
class ListTagsResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        tag_infos: main_models.ListTagsResponseBodyTagInfos = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TagInfos') is not None:
            temp_model = main_models.ListTagsResponseBodyTagInfos()
            self.tag_infos = temp_model.from_map(m.get('TagInfos'))

        return self

class ListTagsResponseBodyTagInfos(DaraModel):
    def __init__(
        self,
        tag_info: List[main_models.ListTagsResponseBodyTagInfosTagInfo] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TagInfo') is not None:
            for k1 in m.get('TagInfo'):
                temp_model = main_models.ListTagsResponseBodyTagInfosTagInfo()
                self.tag_info.append(temp_model.from_map(k1))

        return self

class ListTagsResponseBodyTagInfosTagInfo(DaraModel):
    def __init__(
        self,
        tag_name: str = None,
    ):

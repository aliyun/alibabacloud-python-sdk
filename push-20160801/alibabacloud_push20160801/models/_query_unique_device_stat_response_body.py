...
class QueryUniqueDeviceStatResponseBody(DaraModel):
    def __init__(
        self,
        app_device_stats: main_models.QueryUniqueDeviceStatResponseBodyAppDeviceStats = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AppDeviceStats') is not None:
            temp_model = main_models.QueryUniqueDeviceStatResponseBodyAppDeviceStats()
...
class QueryUniqueDeviceStatResponseBodyAppDeviceStats(DaraModel):
    def __init__(
        self,
        app_device_stat: List[main_models.QueryUniqueDeviceStatResponseBodyAppDeviceStatsAppDeviceStat] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AppDeviceStat') is not None:
            for k1 in m.get('AppDeviceStat'):
                temp_model = main_models.QueryUniqueDeviceStatResponseBodyAppDeviceStatsAppDeviceStat()
                self.app_device_stat.append(temp_model.from_map(k1))

        return self

class QueryUniqueDeviceStatResponseBodyAppDeviceStatsAppDeviceStat(DaraModel):
    def __init__(
        self,
        count: int = None,
        time: str = None,

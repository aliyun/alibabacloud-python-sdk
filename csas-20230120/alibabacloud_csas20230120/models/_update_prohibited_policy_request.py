...
class UpdateProhibitedPolicyRequest(DaraModel):
    def __init__(
        self,
        ...
        prompt_ch: str = None,
        prompt_en: str = None,
        software_ids: List[main_models.UpdateProhibitedPolicyRequestSoftwareIds] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SoftwareIds') is not None:
            for k1 in m.get('SoftwareIds'):
                temp_model = main_models.UpdateProhibitedPolicyRequestSoftwareIds()
...
class UpdateProhibitedPolicyRequestSoftwareIds(DaraModel):
    def __init__(
        self,

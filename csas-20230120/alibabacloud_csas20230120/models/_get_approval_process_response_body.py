...
class GetApprovalProcessResponseBody(DaraModel):
    def __init__(
        self,
        process: main_models.GetApprovalProcessResponseBodyProcess = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Process') is not None:
            temp_model = main_models.GetApprovalProcessResponseBodyProcess()
...
class GetApprovalProcessResponseBodyProcess(DaraModel):
    def __init__(
        self,
        app_uninstall_policies: main_models.GetApprovalProcessResponseBodyProcessAppUninstallPolicies = None,
        approval_type: int = None,
        create_time: str = None,
        description: str = None,
        device_registration_policies: main_models.GetApprovalProcessResponseBodyProcessDeviceRegistrationPolicies = None,
        dlp_send_policies: main_models.GetApprovalProcessResponseBodyProcessDlpSendPolicies = None,
        domain_blacklist_policies: main_models.GetApprovalProcessResponseBodyProcessDomainBlacklistPolicies = None,
        domain_whitelist_policies: main_models.GetApprovalProcessResponseBodyProcessDomainWhitelistPolicies = None,
        endpoint_hardening_policies: main_models.GetApprovalProcessResponseBodyProcessEndpointHardeningPolicies = None,
        event_label: str = None,
        external_config: str = None,
        peripheral_block_policies: main_models.GetApprovalProcessResponseBodyProcessPeripheralBlockPolicies = None,
        private_access_block_policies: main_models.GetApprovalProcessResponseBodyProcessPrivateAccessBlockPolicies = None,
        process_id: str = None,
        process_name: str = None,
        process_nodes: List[List[main_models.GetApprovalProcessResponseBodyProcessProcessNodes]] = None,
        software_block_policies: main_models.GetApprovalProcessResponseBodyProcessSoftwareBlockPolicies = None,
        software_hardening_policies: main_models.GetApprovalProcessResponseBodyProcessSoftwareHardeningPolicies = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AppUninstallPolicies') is not None:
            temp_model = main_models.GetApprovalProcessResponseBodyProcessAppUninstallPolicies()
        ...
        if m.get('DeviceRegistrationPolicies') is not None:
            temp_model = main_models.GetApprovalProcessResponseBodyProcessDeviceRegistrationPolicies()
        ...
        if m.get('DlpSendPolicies') is not None:
            temp_model = main_models.GetApprovalProcessResponseBodyProcessDlpSendPolicies()
            self.dlp_send_policies = temp_model.from_map(m.get('DlpSendPolicies'))

        if m.get('DomainBlacklistPolicies') is not None:
            temp_model = main_models.GetApprovalProcessResponseBodyProcessDomainBlacklistPolicies()
        ...
        if m.get('DomainWhitelistPolicies') is not None:
            temp_model = main_models.GetApprovalProcessResponseBodyProcessDomainWhitelistPolicies()
        ...
        if m.get('EndpointHardeningPolicies') is not None:
            temp_model = main_models.GetApprovalProcessResponseBodyProcessEndpointHardeningPolicies()
        ...
        if m.get('PeripheralBlockPolicies') is not None:
            temp_model = main_models.GetApprovalProcessResponseBodyProcessPeripheralBlockPolicies()
        ...
        if m.get('PrivateAccessBlockPolicies') is not None:
            temp_model = main_models.GetApprovalProcessResponseBodyProcessPrivateAccessBlockPolicies()
        ...
        if m.get('ProcessNodes') is not None:
            for k1 in m.get('ProcessNodes'):
                l1 = []
                for k2 in k1:
                    temp_model = main_models.GetApprovalProcessResponseBodyProcessProcessNodes()
                    l1.append(temp_model.from_map(k2))
                self.process_nodes.append(l1)

        if m.get('SoftwareBlockPolicies') is not None:
            temp_model = main_models.GetApprovalProcessResponseBodyProcessSoftwareBlockPolicies()
        ...
        if m.get('SoftwareHardeningPolicies') is not None:
            temp_model = main_models.GetApprovalProcessResponseBodyProcessSoftwareHardeningPolicies()
            self.software_hardening_policies = temp_model.from_map(m.get('SoftwareHardeningPolicies'))

        return self

class GetApprovalProcessResponseBodyProcessSoftwareHardeningPolicies(DaraModel):
    def __init__(
        self,
        external_process_id: str = None,
        field_map: List[main_models.GetApprovalProcessResponseBodyProcessSoftwareHardeningPoliciesFieldMap] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FieldMap') is not None:
            for k1 in m.get('FieldMap'):
                temp_model = main_models.GetApprovalProcessResponseBodyProcessSoftwareHardeningPoliciesFieldMap()
...
class GetApprovalProcessResponseBodyProcessSoftwareHardeningPoliciesFieldMap(DaraModel):
    def __init__(
        self,
...
class GetApprovalProcessResponseBodyProcessSoftwareBlockPolicies(DaraModel):
    def __init__(
        self,
        external_process_id: str = None,
        field_map: List[main_models.GetApprovalProcessResponseBodyProcessSoftwareBlockPoliciesFieldMap] = None,
        policy_ids: List[str] = None,
        schema_id: str = None,
    ):
        # The external process ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FieldMap') is not None:
            for k1 in m.get('FieldMap'):
                temp_model = main_models.GetApprovalProcessResponseBodyProcessSoftwareBlockPoliciesFieldMap()
                self.field_map.append(temp_model.from_map(k1))
...
class GetApprovalProcessResponseBodyProcessSoftwareBlockPoliciesFieldMap(DaraModel):
    def __init__(
        self,
        display_field: str = None,
        display_field_value: str = None,
...
class GetApprovalProcessResponseBodyProcessProcessNodes(DaraModel):
    def __init__(
        self,
...
class GetApprovalProcessResponseBodyProcessPrivateAccessBlockPolicies(DaraModel):
    def __init__(
        self,
        external_process_id: str = None,
        field_map: List[main_models.GetApprovalProcessResponseBodyProcessPrivateAccessBlockPoliciesFieldMap] = None,
        policy_ids: List[str] = None,
        schema_id: str = None,
    ):
        # The external process ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FieldMap') is not None:
            for k1 in m.get('FieldMap'):
                temp_model = main_models.GetApprovalProcessResponseBodyProcessPrivateAccessBlockPoliciesFieldMap()
                self.field_map.append(temp_model.from_map(k1))
...
class GetApprovalProcessResponseBodyProcessPrivateAccessBlockPoliciesFieldMap(DaraModel):
    def __init__(
        self,
        display_field: str = None,
        display_field_value: str = None,
...
class GetApprovalProcessResponseBodyProcessPeripheralBlockPolicies(DaraModel):
    def __init__(
        self,
        external_process_id: str = None,
        field_map: List[main_models.GetApprovalProcessResponseBodyProcessPeripheralBlockPoliciesFieldMap] = None,
        policy_ids: List[str] = None,
        schema_id: str = None,
    ):
        # The external process ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FieldMap') is not None:
            for k1 in m.get('FieldMap'):
                temp_model = main_models.GetApprovalProcessResponseBodyProcessPeripheralBlockPoliciesFieldMap()
                self.field_map.append(temp_model.from_map(k1))
...
class GetApprovalProcessResponseBodyProcessPeripheralBlockPoliciesFieldMap(DaraModel):
    def __init__(
        self,
        display_field: str = None,
        display_field_value: str = None,
...
class GetApprovalProcessResponseBodyProcessEndpointHardeningPolicies(DaraModel):
    def __init__(
        self,
        external_process_id: str = None,
        field_map: List[main_models.GetApprovalProcessResponseBodyProcessEndpointHardeningPoliciesFieldMap] = None,
        policy_ids: List[str] = None,
        schema_id: str = None,
    ):
        # The external process ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FieldMap') is not None:
            for k1 in m.get('FieldMap'):
                temp_model = main_models.GetApprovalProcessResponseBodyProcessEndpointHardeningPoliciesFieldMap()
                self.field_map.append(temp_model.from_map(k1))
...
class GetApprovalProcessResponseBodyProcessEndpointHardeningPoliciesFieldMap(DaraModel):
    def __init__(
        self,
        display_field: str = None,
        display_field_value: str = None,
...
class GetApprovalProcessResponseBodyProcessDomainWhitelistPolicies(DaraModel):
    def __init__(
        self,
        external_process_id: str = None,
        field_map: List[main_models.GetApprovalProcessResponseBodyProcessDomainWhitelistPoliciesFieldMap] = None,
        policy_ids: List[str] = None,
        schema_id: str = None,
    ):
        # The external process ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FieldMap') is not None:
            for k1 in m.get('FieldMap'):
                temp_model = main_models.GetApprovalProcessResponseBodyProcessDomainWhitelistPoliciesFieldMap()
                self.field_map.append(temp_model.from_map(k1))
...
class GetApprovalProcessResponseBodyProcessDomainWhitelistPoliciesFieldMap(DaraModel):
    def __init__(
        self,
        display_field: str = None,
        display_field_value: str = None,
...
class GetApprovalProcessResponseBodyProcessDomainBlacklistPolicies(DaraModel):
    def __init__(
        self,
        external_process_id: str = None,
        field_map: List[main_models.GetApprovalProcessResponseBodyProcessDomainBlacklistPoliciesFieldMap] = None,
        policy_ids: List[str] = None,
        schema_id: str = None,
    ):
        # The external process ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FieldMap') is not None:
            for k1 in m.get('FieldMap'):
                temp_model = main_models.GetApprovalProcessResponseBodyProcessDomainBlacklistPoliciesFieldMap()
                self.field_map.append(temp_model.from_map(k1))
...
class GetApprovalProcessResponseBodyProcessDomainBlacklistPoliciesFieldMap(DaraModel):
    def __init__(
        self,
        display_field: str = None,
        display_field_value: str = None,
...
class GetApprovalProcessResponseBodyProcessDlpSendPolicies(DaraModel):
    def __init__(
        self,
        external_process_id: str = None,
        field_map: List[main_models.GetApprovalProcessResponseBodyProcessDlpSendPoliciesFieldMap] = None,
        policy_ids: List[str] = None,
        schema_id: str = None,
    ):
        # The external process ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FieldMap') is not None:
            for k1 in m.get('FieldMap'):
                temp_model = main_models.GetApprovalProcessResponseBodyProcessDlpSendPoliciesFieldMap()
                self.field_map.append(temp_model.from_map(k1))
...
class GetApprovalProcessResponseBodyProcessDlpSendPoliciesFieldMap(DaraModel):
    def __init__(
        self,
        display_field: str = None,
        display_field_value: str = None,
...
class GetApprovalProcessResponseBodyProcessDeviceRegistrationPolicies(DaraModel):
    def __init__(
        self,
        external_process_id: str = None,
        field_map: List[main_models.GetApprovalProcessResponseBodyProcessDeviceRegistrationPoliciesFieldMap] = None,
        policy_ids: List[str] = None,
        schema_id: str = None,
    ):
        # The external process ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FieldMap') is not None:
            for k1 in m.get('FieldMap'):
                temp_model = main_models.GetApprovalProcessResponseBodyProcessDeviceRegistrationPoliciesFieldMap()
                self.field_map.append(temp_model.from_map(k1))
...
class GetApprovalProcessResponseBodyProcessDeviceRegistrationPoliciesFieldMap(DaraModel):
    def __init__(
        self,
        display_field: str = None,
        display_field_value: str = None,
...
class GetApprovalProcessResponseBodyProcessAppUninstallPolicies(DaraModel):
    def __init__(
        self,
        external_process_id: str = None,
        field_map: List[main_models.GetApprovalProcessResponseBodyProcessAppUninstallPoliciesFieldMap] = None,
        policy_ids: List[str] = None,
        schema_id: str = None,
    ):
        # The external process ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FieldMap') is not None:
            for k1 in m.get('FieldMap'):
                temp_model = main_models.GetApprovalProcessResponseBodyProcessAppUninstallPoliciesFieldMap()
                self.field_map.append(temp_model.from_map(k1))
...
class GetApprovalProcessResponseBodyProcessAppUninstallPoliciesFieldMap(DaraModel):
    def __init__(
        self,
        display_field: str = None,
        display_field_value: str = None,

...
class ListVirusScanScheduledStrategiesResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        strategies: List[main_models.ListVirusScanScheduledStrategiesResponseBodyStrategies] = None,
        total_num: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Strategies') is not None:
            for k1 in m.get('Strategies'):
                temp_model = main_models.ListVirusScanScheduledStrategiesResponseBodyStrategies()
...
class ListVirusScanScheduledStrategiesResponseBodyStrategies(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        custom_match_group: List[main_models.ListVirusScanScheduledStrategiesResponseBodyStrategiesCustomMatchGroup] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CustomMatchGroup') is not None:
            for k1 in m.get('CustomMatchGroup'):
                temp_model = main_models.ListVirusScanScheduledStrategiesResponseBodyStrategiesCustomMatchGroup()
...
class ListVirusScanScheduledStrategiesResponseBodyStrategiesCustomMatchGroup(DaraModel):
    def __init__(
        self,
        group: List[str] = None,
        idp_id: str = None,

...
class CreateVulScanScheduledStrategyResponseBody(DaraModel):
    def __init__(
        self,
        create_time: int = None,
        custom_match_group: List[main_models.CreateVulScanScheduledStrategyResponseBodyCustomMatchGroup] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CustomMatchGroup') is not None:
            for k1 in m.get('CustomMatchGroup'):
                temp_model = main_models.CreateVulScanScheduledStrategyResponseBodyCustomMatchGroup()
...
class CreateVulScanScheduledStrategyResponseBodyCustomMatchGroup(DaraModel):
    def __init__(
        self,
        group: List[str] = None,
        idp_id: str = None,

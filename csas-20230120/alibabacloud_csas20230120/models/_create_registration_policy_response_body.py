...
class CreateRegistrationPolicyResponseBody(DaraModel):
    def __init__(
        self,
        policy: main_models.CreateRegistrationPolicyResponseBodyPolicy = None,
        request_id: str = None,
    ):
        self.policy = policy
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Policy') is not None:
            temp_model = main_models.CreateRegistrationPolicyResponseBodyPolicy()
...
class CreateRegistrationPolicyResponseBodyPolicy(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        description: str = None,
        limit_detail: List[main_models.CreateRegistrationPolicyResponseBodyPolicyLimitDetail] = None,
        match_mode: str = None,
        name: str = None,
        policy_id: str = None,
        priority: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LimitDetail') is not None:
            for k1 in m.get('LimitDetail'):
                temp_model = main_models.CreateRegistrationPolicyResponseBodyPolicyLimitDetail()
...
class CreateRegistrationPolicyResponseBodyPolicyLimitDetail(DaraModel):
    def __init__(
        self,
        device_belong: str = None,
        limit_count: main_models.CreateRegistrationPolicyResponseBodyPolicyLimitDetailLimitCount = None,
        limit_type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LimitCount') is not None:
            temp_model = main_models.CreateRegistrationPolicyResponseBodyPolicyLimitDetailLimitCount()
...
class CreateRegistrationPolicyResponseBodyPolicyLimitDetailLimitCount(DaraModel):
    def __init__(
        self,
        all: int = None,
        mobile: int = None,

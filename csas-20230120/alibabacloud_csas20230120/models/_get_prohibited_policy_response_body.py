...
class GetProhibitedPolicyResponseBody(DaraModel):
    def __init__(
        self,
        policy: main_models.GetProhibitedPolicyResponseBodyPolicy = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Policy') is not None:
            temp_model = main_models.GetProhibitedPolicyResponseBodyPolicy()
...
class GetProhibitedPolicyResponseBodyPolicy(DaraModel):
    def __init__(
        self,
        ...
        software_ids: List[main_models.GetProhibitedPolicyResponseBodyPolicySoftwareIds] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SoftwareIds') is not None:
            for k1 in m.get('SoftwareIds'):
                temp_model = main_models.GetProhibitedPolicyResponseBodyPolicySoftwareIds()
...
class GetProhibitedPolicyResponseBodyPolicySoftwareIds(DaraModel):
    def __init__(
        self,

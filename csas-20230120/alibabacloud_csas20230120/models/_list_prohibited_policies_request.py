...
class ListProhibitedPoliciesRequest(DaraModel):
    def __init__(
        self,
        ...
        software_id: main_models.ListProhibitedPoliciesRequestSoftwareId = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SoftwareId') is not None:
            temp_model = main_models.ListProhibitedPoliciesRequestSoftwareId()
...
class ListProhibitedPoliciesRequestSoftwareId(DaraModel):
    def __init__(
        self,

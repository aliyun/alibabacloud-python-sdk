...
class GetProhibitedSoftwareResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        software: main_models.GetProhibitedSoftwareResponseBodySoftware = None,
    ):
        # Id of the request
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Software') is not None:
            temp_model = main_models.GetProhibitedSoftwareResponseBodySoftware()
            self.software = temp_model.from_map(m.get('Software'))

        return self

class GetProhibitedSoftwareResponseBodySoftware(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        description: str = None,
        is_default: bool = None,
        linux_processes: List[main_models.GetProhibitedSoftwareResponseBodySoftwareLinuxProcesses] = None,
        mac_osprocesses: List[main_models.GetProhibitedSoftwareResponseBodySoftwareMacOSProcesses] = None,
        name: str = None,
        policy_ids: List[str] = None,
        software_id: str = None,
        tag_ids: List[str] = None,
        windows_processes: List[main_models.GetProhibitedSoftwareResponseBodySoftwareWindowsProcesses] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LinuxProcesses') is not None:
            for k1 in m.get('LinuxProcesses'):
                temp_model = main_models.GetProhibitedSoftwareResponseBodySoftwareLinuxProcesses()
        ...
        if m.get('MacOSProcesses') is not None:
            for k1 in m.get('MacOSProcesses'):
                temp_model = main_models.GetProhibitedSoftwareResponseBodySoftwareMacOSProcesses()
        ...
        if m.get('WindowsProcesses') is not None:
            for k1 in m.get('WindowsProcesses'):
                temp_model = main_models.GetProhibitedSoftwareResponseBodySoftwareWindowsProcesses()
                self.windows_processes.append(temp_model.from_map(k1))

        return self

class GetProhibitedSoftwareResponseBodySoftwareWindowsProcesses(DaraModel):
    def __init__(
        self,
        bundle_id: str = None,
        cmdline: str = None,
...
class GetProhibitedSoftwareResponseBodySoftwareMacOSProcesses(DaraModel):
    def __init__(
        self,
        bundle_id: str = None,
        cmdline: str = None,
...
class GetProhibitedSoftwareResponseBodySoftwareLinuxProcesses(DaraModel):
    def __init__(
        self,
        bundle_id: str = None,
        cmdline: str = None,

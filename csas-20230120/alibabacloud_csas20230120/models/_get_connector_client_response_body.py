...
class GetConnectorClientResponseBody(DaraModel):
    def __init__(
        self,
        connector_client: main_models.GetConnectorClientResponseBodyConnectorClient = None,
        request_id: str = None,
    ):
        # ConnectorClient。
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConnectorClient') is not None:
            temp_model = main_models.GetConnectorClientResponseBodyConnectorClient()
...
class GetConnectorClientResponseBodyConnectorClient(DaraModel):
    def __init__(
        self,
        cpusize: str = None,

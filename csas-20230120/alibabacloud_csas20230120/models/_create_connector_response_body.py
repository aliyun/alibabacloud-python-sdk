...
class CreateConnectorResponseBody(DaraModel):
    def __init__(
        self,
        connector: main_models.CreateConnectorResponseBodyConnector = None,
        request_id: str = None,
    ):
        # Connector。
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Connector') is not None:
            temp_model = main_models.CreateConnectorResponseBodyConnector()
...
class CreateConnectorResponseBodyConnector(DaraModel):
    def __init__(
        self,
        ...
        upgrade_time: main_models.CreateConnectorResponseBodyConnectorUpgradeTime = None,
    ):
        # ConnectorID。
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UpgradeTime') is not None:
            temp_model = main_models.CreateConnectorResponseBodyConnectorUpgradeTime()
            self.upgrade_time = temp_model.from_map(m.get('UpgradeTime'))

        return self

class CreateConnectorResponseBodyConnectorUpgradeTime(DaraModel):
    def __init__(
        self,
        end: str = None,
        start: str = None,

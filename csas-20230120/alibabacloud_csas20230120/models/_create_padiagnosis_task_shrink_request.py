...
class CreatePADiagnosisTaskShrinkRequest(DaraModel):
    def __init__(
        self,
        dev_tag: str = None,
        ...
        port: str = None,
        protocol: str = None,
        udp_extra_configs_shrink: str = None,
    ...
    def to_map(self):
        ...
        if self.udp_extra_configs_shrink is not None:
            result['UdpExtraConfigs'] = self.udp_extra_configs_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UdpExtraConfigs') is not None:
            self.udp_extra_configs_shrink = m.get('UdpExtraConfigs')

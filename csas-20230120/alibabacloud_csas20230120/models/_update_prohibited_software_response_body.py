...
class UpdateProhibitedSoftwareResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        software: main_models.UpdateProhibitedSoftwareResponseBodySoftware = None,
    ):
        # Id of the request
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Software') is not None:
            temp_model = main_models.UpdateProhibitedSoftwareResponseBodySoftware()
            self.software = temp_model.from_map(m.get('Software'))

        return self

class UpdateProhibitedSoftwareResponseBodySoftware(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        description: str = None,
        linux_processes: List[main_models.UpdateProhibitedSoftwareResponseBodySoftwareLinuxProcesses] = None,
        mac_osprocesses: List[main_models.UpdateProhibitedSoftwareResponseBodySoftwareMacOSProcesses] = None,
        name: str = None,
        policy_ids: List[str] = None,
        software_id: str = None,
        tag_ids: List[str] = None,
        windows_processes: List[main_models.UpdateProhibitedSoftwareResponseBodySoftwareWindowsProcesses] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LinuxProcesses') is not None:
            for k1 in m.get('LinuxProcesses'):
                temp_model = main_models.UpdateProhibitedSoftwareResponseBodySoftwareLinuxProcesses()
        ...
        if m.get('MacOSProcesses') is not None:
            for k1 in m.get('MacOSProcesses'):
                temp_model = main_models.UpdateProhibitedSoftwareResponseBodySoftwareMacOSProcesses()
        ...
        if m.get('WindowsProcesses') is not None:
            for k1 in m.get('WindowsProcesses'):
                temp_model = main_models.UpdateProhibitedSoftwareResponseBodySoftwareWindowsProcesses()
                self.windows_processes.append(temp_model.from_map(k1))

        return self

class UpdateProhibitedSoftwareResponseBodySoftwareWindowsProcesses(DaraModel):
    def __init__(
        self,
        bundle_id: str = None,
        cmdline: str = None,
...
class UpdateProhibitedSoftwareResponseBodySoftwareMacOSProcesses(DaraModel):
    def __init__(
        self,
        bundle_id: str = None,
        cmdline: str = None,
...
class UpdateProhibitedSoftwareResponseBodySoftwareLinuxProcesses(DaraModel):
    def __init__(
        self,
        bundle_id: str = None,
        cmdline: str = None,

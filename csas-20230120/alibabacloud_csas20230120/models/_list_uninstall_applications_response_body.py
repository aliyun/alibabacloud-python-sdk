...
class ListUninstallApplicationsResponseBody(DaraModel):
    def __init__(
        self,
        applications: List[main_models.ListUninstallApplicationsResponseBodyApplications] = None,
        request_id: str = None,
        total_num: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Applications') is not None:
            for k1 in m.get('Applications'):
                temp_model = main_models.ListUninstallApplicationsResponseBodyApplications()
...
class ListUninstallApplicationsResponseBodyApplications(DaraModel):
    def __init__(
        self,

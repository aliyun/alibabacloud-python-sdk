...
class CreateProhibitedSoftwareRequest(DaraModel):
    def __init__(
        self,
        description: str = None,
        linux_processes: List[main_models.CreateProhibitedSoftwareRequestLinuxProcesses] = None,
        mac_osprocesses: List[main_models.CreateProhibitedSoftwareRequestMacOSProcesses] = None,
        name: str = None,
        tag_ids: List[str] = None,
        windows_processes: List[main_models.CreateProhibitedSoftwareRequestWindowsProcesses] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LinuxProcesses') is not None:
            for k1 in m.get('LinuxProcesses'):
                temp_model = main_models.CreateProhibitedSoftwareRequestLinuxProcesses()
        ...
        if m.get('MacOSProcesses') is not None:
            for k1 in m.get('MacOSProcesses'):
                temp_model = main_models.CreateProhibitedSoftwareRequestMacOSProcesses()
        ...
        if m.get('WindowsProcesses') is not None:
            for k1 in m.get('WindowsProcesses'):
                temp_model = main_models.CreateProhibitedSoftwareRequestWindowsProcesses()
                self.windows_processes.append(temp_model.from_map(k1))

        return self

class CreateProhibitedSoftwareRequestWindowsProcesses(DaraModel):
    def __init__(
        self,
        bundle_id: str = None,
        cmdline: str = None,
...
class CreateProhibitedSoftwareRequestMacOSProcesses(DaraModel):
    def __init__(
        self,
        bundle_id: str = None,
        cmdline: str = None,
...
class CreateProhibitedSoftwareRequestLinuxProcesses(DaraModel):
    def __init__(
        self,
        bundle_id: str = None,
        cmdline: str = None,

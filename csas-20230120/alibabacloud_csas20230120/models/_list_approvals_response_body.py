...
class ListApprovalsResponseBody(DaraModel):
    def __init__(
        self,
        approvals: List[main_models.ListApprovalsResponseBodyApprovals] = None,
        request_id: str = None,
        total_num: str = None,
    ):
    ...
    def to_map(self):
        ...
        if self.approvals is not None:
            for k1 in self.approvals:
                result['Approvals'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Approvals') is not None:
            for k1 in m.get('Approvals'):
                temp_model = main_models.ListApprovalsResponseBodyApprovals()
                self.approvals.append(temp_model.from_map(k1))
...
class ListApprovalsResponseBodyApprovals(DaraModel):
    def __init__(
        self,
        approval_detail: str = None,
        approval_id: str = None,
        approval_progresses: List[main_models.ListApprovalsResponseBodyApprovalsApprovalProgresses] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApprovalProgresses') is not None:
            for k1 in m.get('ApprovalProgresses'):
                temp_model = main_models.ListApprovalsResponseBodyApprovalsApprovalProgresses()
...
class ListApprovalsResponseBodyApprovalsApprovalProgresses(DaraModel):
    def __init__(
        self,
        action: str = None,
        comment: str = None,
        executor: str = None,
        operators: List[main_models.ListApprovalsResponseBodyApprovalsApprovalProgressesOperators] = None,
        status: str = None,
        timestamp: int = None,
    ):
        self.action = action
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Operators') is not None:
            for k1 in m.get('Operators'):
                temp_model = main_models.ListApprovalsResponseBodyApprovalsApprovalProgressesOperators()
...
class ListApprovalsResponseBodyApprovalsApprovalProgressesOperators(DaraModel):
    def __init__(
        self,

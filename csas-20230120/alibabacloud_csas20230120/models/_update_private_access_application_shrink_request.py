...
class UpdatePrivateAccessApplicationShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        name: str = None,
        port_ranges: List[main_models.UpdatePrivateAccessApplicationShrinkRequestPortRanges] = None,
        protocol: str = None,
        status: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PortRanges') is not None:
            for k1 in m.get('PortRanges'):
                temp_model = main_models.UpdatePrivateAccessApplicationShrinkRequestPortRanges()
...
class UpdatePrivateAccessApplicationShrinkRequestPortRanges(DaraModel):
    def __init__(
        self,
        begin: int = None,
        end: int = None,

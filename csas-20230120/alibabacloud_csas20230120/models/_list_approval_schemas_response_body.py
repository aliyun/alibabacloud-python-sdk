...
class ListApprovalSchemasResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Schemas') is not None:
            for k1 in m.get('Schemas'):
                temp_model = main_models.ListApprovalSchemasResponseBodySchemas()
...
class ListApprovalSchemasResponseBodySchemas(DaraModel):
    def __init__(
        self,

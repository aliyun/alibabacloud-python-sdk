...
class UpdatePrivateAccessApplicationL7SwitchRequest(DaraModel):
    def __init__(
        self,
        application_id: str = None,
        dev_tag_mark_status: str = None,
        download_audit_status: str = None,
        port_ranges: List[main_models.UpdatePrivateAccessApplicationL7SwitchRequestPortRanges] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PortRanges') is not None:
            for k1 in m.get('PortRanges'):
                temp_model = main_models.UpdatePrivateAccessApplicationL7SwitchRequestPortRanges()
...
class UpdatePrivateAccessApplicationL7SwitchRequestPortRanges(DaraModel):
    def __init__(
        self,
        begin: int = None,
        end: int = None,

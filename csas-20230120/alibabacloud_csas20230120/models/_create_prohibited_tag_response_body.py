...
class CreateProhibitedTagResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        tag: main_models.CreateProhibitedTagResponseBodyTag = None,
    ):
        # Id of the request
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tag') is not None:
            temp_model = main_models.CreateProhibitedTagResponseBodyTag()
            self.tag = temp_model.from_map(m.get('Tag'))

        return self

class CreateProhibitedTagResponseBodyTag(DaraModel):
    def __init__(
        self,

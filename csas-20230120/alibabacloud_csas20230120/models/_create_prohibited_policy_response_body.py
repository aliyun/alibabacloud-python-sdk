...
class CreateProhibitedPolicyResponseBody(DaraModel):
    def __init__(
        self,
        policy: main_models.CreateProhibitedPolicyResponseBodyPolicy = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Policy') is not None:
            temp_model = main_models.CreateProhibitedPolicyResponseBodyPolicy()
...
class CreateProhibitedPolicyResponseBodyPolicy(DaraModel):
    def __init__(
        self,
        ...
        prompt_ch: str = None,
        prompt_en: str = None,
        software_ids: List[main_models.CreateProhibitedPolicyResponseBodyPolicySoftwareIds] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SoftwareIds') is not None:
            for k1 in m.get('SoftwareIds'):
                temp_model = main_models.CreateProhibitedPolicyResponseBodyPolicySoftwareIds()
...
class CreateProhibitedPolicyResponseBodyPolicySoftwareIds(DaraModel):
    def __init__(
        self,

...
class CreateProhibitedSoftwareResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        software: main_models.CreateProhibitedSoftwareResponseBodySoftware = None,
    ):
        # Id of the request
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Software') is not None:
            temp_model = main_models.CreateProhibitedSoftwareResponseBodySoftware()
            self.software = temp_model.from_map(m.get('Software'))

        return self

class CreateProhibitedSoftwareResponseBodySoftware(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        description: str = None,
        linux_processes: List[main_models.CreateProhibitedSoftwareResponseBodySoftwareLinuxProcesses] = None,
        mac_osprocesses: List[main_models.CreateProhibitedSoftwareResponseBodySoftwareMacOSProcesses] = None,
        name: str = None,
        software_id: str = None,
        tag_ids: List[str] = None,
        windows_processes: List[main_models.CreateProhibitedSoftwareResponseBodySoftwareWindowsProcesses] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LinuxProcesses') is not None:
            for k1 in m.get('LinuxProcesses'):
                temp_model = main_models.CreateProhibitedSoftwareResponseBodySoftwareLinuxProcesses()
        ...
        if m.get('MacOSProcesses') is not None:
            for k1 in m.get('MacOSProcesses'):
                temp_model = main_models.CreateProhibitedSoftwareResponseBodySoftwareMacOSProcesses()
        ...
        if m.get('WindowsProcesses') is not None:
            for k1 in m.get('WindowsProcesses'):
                temp_model = main_models.CreateProhibitedSoftwareResponseBodySoftwareWindowsProcesses()
                self.windows_processes.append(temp_model.from_map(k1))

        return self

class CreateProhibitedSoftwareResponseBodySoftwareWindowsProcesses(DaraModel):
    def __init__(
        self,
        bundle_id: str = None,
        cmdline: str = None,
...
class CreateProhibitedSoftwareResponseBodySoftwareMacOSProcesses(DaraModel):
    def __init__(
        self,
        bundle_id: str = None,
        cmdline: str = None,
...
class CreateProhibitedSoftwareResponseBodySoftwareLinuxProcesses(DaraModel):
    def __init__(
        self,
        bundle_id: str = None,
        cmdline: str = None,

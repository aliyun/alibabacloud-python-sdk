...
class ListProhibitedSoftwareRequest(DaraModel):
    def __init__(
        self,
        ...
        software_ids: List[main_models.ListProhibitedSoftwareRequestSoftwareIds] = None,
        tag_id: main_models.ListProhibitedSoftwareRequestTagId = None,
    ):
    ...
    def to_map(self):
        ...
        if self.tag_id is not None:
            result['TagId'] = self.tag_id.to_map()
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SoftwareIds') is not None:
            for k1 in m.get('SoftwareIds'):
                temp_model = main_models.ListProhibitedSoftwareRequestSoftwareIds()
                self.software_ids.append(temp_model.from_map(k1))

        if m.get('TagId') is not None:
            temp_model = main_models.ListProhibitedSoftwareRequestTagId()
            self.tag_id = temp_model.from_map(m.get('TagId'))

        return self

class ListProhibitedSoftwareRequestTagId(DaraModel):
    def __init__(
        self,
...
class ListProhibitedSoftwareRequestSoftwareIds(DaraModel):
    def __init__(
        self,
        is_default: bool = None,

...
class DescribeDefenseResourceResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        resource: main_models.DescribeDefenseResourceResponseBodyResource = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Resource') is not None:
            temp_model = main_models.DescribeDefenseResourceResponseBodyResource()
            self.resource = temp_model.from_map(m.get('Resource'))

        return self

class DescribeDefenseResourceResponseBodyResource(DaraModel):
    def __init__(
        self,
        ...
        response_headers: List[main_models.DescribeDefenseResourceResponseBodyResourceResponseHeaders] = None,
        xff_status: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResponseHeaders') is not None:
            for k1 in m.get('ResponseHeaders'):
                temp_model = main_models.DescribeDefenseResourceResponseBodyResourceResponseHeaders()
...
class DescribeDefenseResourceResponseBodyResourceResponseHeaders(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

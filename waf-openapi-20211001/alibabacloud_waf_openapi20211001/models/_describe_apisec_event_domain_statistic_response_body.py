...
class DescribeApisecEventDomainStatisticResponseBody(DaraModel):
    def __init__(
        self,
        data: List[main_models.DescribeApisecEventDomainStatisticResponseBodyData] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.DescribeApisecEventDomainStatisticResponseBodyData()
...
class DescribeApisecEventDomainStatisticResponseBodyData(DaraModel):
    def __init__(
        self,
        api_count: int = None,
        domain: str = None,

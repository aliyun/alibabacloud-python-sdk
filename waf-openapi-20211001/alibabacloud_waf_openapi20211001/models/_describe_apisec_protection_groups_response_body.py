...
class DescribeApisecProtectionGroupsResponseBody(DaraModel):
    def __init__(
        self,
        data: List[main_models.DescribeApisecProtectionGroupsResponseBodyData] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.DescribeApisecProtectionGroupsResponseBodyData()
...
class DescribeApisecProtectionGroupsResponseBodyData(DaraModel):
    def __init__(
        self,

...
class CreateEciScalingConfigurationRequest(DaraModel):
    def __init__(
        self,
        acr_registry_infos: List[main_models.CreateEciScalingConfigurationRequestAcrRegistryInfos] = None,
        active_deadline_seconds: int = None,
        auto_create_eip: bool = None,
        auto_match_image_cache: bool = None,
        container_group_name: str = None,
        containers: List[main_models.CreateEciScalingConfigurationRequestContainers] = None,
        ...
        dns_config_options: List[main_models.CreateEciScalingConfigurationRequestDnsConfigOptions] = None,
        ...
        host_aliases: List[main_models.CreateEciScalingConfigurationRequestHostAliases] = None,
        host_name: str = None,
        image_registry_credentials: List[main_models.CreateEciScalingConfigurationRequestImageRegistryCredentials] = None,
        image_snapshot_id: str = None,
        ingress_bandwidth: int = None,
        init_containers: List[main_models.CreateEciScalingConfigurationRequestInitContainers] = None,
        ...
        security_context_sysctls: List[main_models.CreateEciScalingConfigurationRequestSecurityContextSysctls] = None,
        security_group_id: str = None,
        spot_price_limit: float = None,
        spot_strategy: str = None,
        tags: List[main_models.CreateEciScalingConfigurationRequestTags] = None,
        termination_grace_period_seconds: int = None,
        volumes: List[main_models.CreateEciScalingConfigurationRequestVolumes] = None,
    ):
    ...
    def validate(self):
        ...
        if self.security_context_sysctls:
            for v1 in self.security_context_sysctls:
                 if v1:
                    v1.validate()
        if self.tags:
            for v1 in self.tags:
    ...
    def to_map(self):
        ...
        if self.security_context_sysctls is not None:
            for k1 in self.security_context_sysctls:
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AcrRegistryInfos') is not None:
            for k1 in m.get('AcrRegistryInfos'):
                temp_model = main_models.CreateEciScalingConfigurationRequestAcrRegistryInfos()
        ...
        if m.get('Containers') is not None:
            for k1 in m.get('Containers'):
                temp_model = main_models.CreateEciScalingConfigurationRequestContainers()
        ...
        if m.get('DnsConfigOptions') is not None:
            for k1 in m.get('DnsConfigOptions'):
                temp_model = main_models.CreateEciScalingConfigurationRequestDnsConfigOptions()
        ...
        if m.get('HostAliases') is not None:
            for k1 in m.get('HostAliases'):
                temp_model = main_models.CreateEciScalingConfigurationRequestHostAliases()
        ...
        if m.get('ImageRegistryCredentials') is not None:
            for k1 in m.get('ImageRegistryCredentials'):
                temp_model = main_models.CreateEciScalingConfigurationRequestImageRegistryCredentials()
        ...
        if m.get('InitContainers') is not None:
            for k1 in m.get('InitContainers'):
                temp_model = main_models.CreateEciScalingConfigurationRequestInitContainers()
        ...
        if m.get('SecurityContextSysctls') is not None:
            for k1 in m.get('SecurityContextSysctls'):
                temp_model = main_models.CreateEciScalingConfigurationRequestSecurityContextSysctls()
                self.security_context_sysctls.append(temp_model.from_map(k1))
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.CreateEciScalingConfigurationRequestTags()
        ...
        if m.get('Volumes') is not None:
            for k1 in m.get('Volumes'):
                temp_model = main_models.CreateEciScalingConfigurationRequestVolumes()
                self.volumes.append(temp_model.from_map(k1))

        return self

class CreateEciScalingConfigurationRequestVolumes(DaraModel):
    def __init__(
        self,
        disk_volume: main_models.CreateEciScalingConfigurationRequestVolumesDiskVolume = None,
        empty_dir_volume: main_models.CreateEciScalingConfigurationRequestVolumesEmptyDirVolume = None,
        flex_volume: main_models.CreateEciScalingConfigurationRequestVolumesFlexVolume = None,
        host_path_volume: main_models.CreateEciScalingConfigurationRequestVolumesHostPathVolume = None,
        nfsvolume: main_models.CreateEciScalingConfigurationRequestVolumesNFSVolume = None,
        config_file_volume_config_file_to_paths: List[main_models.CreateEciScalingConfigurationRequestVolumesConfigFileVolumeConfigFileToPaths] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DiskVolume') is not None:
            temp_model = main_models.CreateEciScalingConfigurationRequestVolumesDiskVolume()
            self.disk_volume = temp_model.from_map(m.get('DiskVolume'))

        if m.get('EmptyDirVolume') is not None:
            temp_model = main_models.CreateEciScalingConfigurationRequestVolumesEmptyDirVolume()
            self.empty_dir_volume = temp_model.from_map(m.get('EmptyDirVolume'))

        if m.get('FlexVolume') is not None:
            temp_model = main_models.CreateEciScalingConfigurationRequestVolumesFlexVolume()
            self.flex_volume = temp_model.from_map(m.get('FlexVolume'))

        if m.get('HostPathVolume') is not None:
            temp_model = main_models.CreateEciScalingConfigurationRequestVolumesHostPathVolume()
            self.host_path_volume = temp_model.from_map(m.get('HostPathVolume'))

        if m.get('NFSVolume') is not None:
            temp_model = main_models.CreateEciScalingConfigurationRequestVolumesNFSVolume()
        ...
        if m.get('ConfigFileVolumeConfigFileToPaths') is not None:
            for k1 in m.get('ConfigFileVolumeConfigFileToPaths'):
                temp_model = main_models.CreateEciScalingConfigurationRequestVolumesConfigFileVolumeConfigFileToPaths()
...
class CreateEciScalingConfigurationRequestVolumesConfigFileVolumeConfigFileToPaths(DaraModel):
    def __init__(
        self,
        content: str = None,
        mode: int = None,
...
class CreateEciScalingConfigurationRequestVolumesNFSVolume(DaraModel):
    def __init__(
        self,
        path: str = None,
        read_only: bool = None,
...
class CreateEciScalingConfigurationRequestVolumesHostPathVolume(DaraModel):
    def __init__(
        self,
        path: str = None,
        type: str = None,
...
class CreateEciScalingConfigurationRequestVolumesFlexVolume(DaraModel):
    def __init__(
        self,
        driver: str = None,
        fs_type: str = None,
...
class CreateEciScalingConfigurationRequestVolumesEmptyDirVolume(DaraModel):
    def __init__(
        self,
        medium: str = None,
        size_limit: str = None,
...
class CreateEciScalingConfigurationRequestVolumesDiskVolume(DaraModel):
    def __init__(
        self,
        disk_id: str = None,
        disk_size: int = None,
...
class CreateEciScalingConfigurationRequestTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class CreateEciScalingConfigurationRequestSecurityContextSysctls(DaraModel):
    def __init__(
        self,
        name: str = None,
        value: str = None,
...
class CreateEciScalingConfigurationRequestInitContainers(DaraModel):
    def __init__(
        self,
        security_context: main_models.CreateEciScalingConfigurationRequestInitContainersSecurityContext = None,
        args: List[str] = None,
        ...
        init_container_environment_vars: List[main_models.CreateEciScalingConfigurationRequestInitContainersInitContainerEnvironmentVars] = None,
        init_container_ports: List[main_models.CreateEciScalingConfigurationRequestInitContainersInitContainerPorts] = None,
        init_container_volume_mounts: List[main_models.CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts] = None,
        memory: float = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SecurityContext') is not None:
            temp_model = main_models.CreateEciScalingConfigurationRequestInitContainersSecurityContext()
        ...
        if m.get('InitContainerEnvironmentVars') is not None:
            for k1 in m.get('InitContainerEnvironmentVars'):
                temp_model = main_models.CreateEciScalingConfigurationRequestInitContainersInitContainerEnvironmentVars()
        ...
        if m.get('InitContainerPorts') is not None:
            for k1 in m.get('InitContainerPorts'):
                temp_model = main_models.CreateEciScalingConfigurationRequestInitContainersInitContainerPorts()
        ...
        if m.get('InitContainerVolumeMounts') is not None:
            for k1 in m.get('InitContainerVolumeMounts'):
                temp_model = main_models.CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts()
...
class CreateEciScalingConfigurationRequestInitContainersInitContainerVolumeMounts(DaraModel):
    def __init__(
        self,
        mount_path: str = None,
...
class CreateEciScalingConfigurationRequestInitContainersInitContainerPorts(DaraModel):
    def __init__(
        self,
        port: int = None,
        protocol: str = None,
...
class CreateEciScalingConfigurationRequestInitContainersInitContainerEnvironmentVars(DaraModel):
    def __init__(
        self,
...
class CreateEciScalingConfigurationRequestInitContainersSecurityContext(DaraModel):
    def __init__(
        self,
        capability: main_models.CreateEciScalingConfigurationRequestInitContainersSecurityContextCapability = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Capability') is not None:
            temp_model = main_models.CreateEciScalingConfigurationRequestInitContainersSecurityContextCapability()
...
class CreateEciScalingConfigurationRequestInitContainersSecurityContextCapability(DaraModel):
    def __init__(
        self,
        adds: List[str] = None,
    ):
...
class CreateEciScalingConfigurationRequestImageRegistryCredentials(DaraModel):
    def __init__(
        self,
        password: str = None,
        server: str = None,
...
class CreateEciScalingConfigurationRequestHostAliases(DaraModel):
    def __init__(
        self,
...
class CreateEciScalingConfigurationRequestDnsConfigOptions(DaraModel):
    def __init__(
        self,
        name: str = None,
        value: str = None,
...
class CreateEciScalingConfigurationRequestContainers(DaraModel):
    def __init__(
        self,
        liveness_probe: main_models.CreateEciScalingConfigurationRequestContainersLivenessProbe = None,
        readiness_probe: main_models.CreateEciScalingConfigurationRequestContainersReadinessProbe = None,
        security_context: main_models.CreateEciScalingConfigurationRequestContainersSecurityContext = None,
        args: List[str] = None,
        commands: List[str] = None,
        cpu: float = None,
        environment_vars: List[main_models.CreateEciScalingConfigurationRequestContainersEnvironmentVars] = None,
        gpu: int = None,
        image: str = None,
        image_pull_policy: str = None,
        ...
        memory: float = None,
        name: str = None,
        ports: List[main_models.CreateEciScalingConfigurationRequestContainersPorts] = None,
        stdin: bool = None,
        stdin_once: bool = None,
        tty: bool = None,
        volume_mounts: List[main_models.CreateEciScalingConfigurationRequestContainersVolumeMounts] = None,
        working_dir: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LivenessProbe') is not None:
            temp_model = main_models.CreateEciScalingConfigurationRequestContainersLivenessProbe()
            self.liveness_probe = temp_model.from_map(m.get('LivenessProbe'))

        if m.get('ReadinessProbe') is not None:
            temp_model = main_models.CreateEciScalingConfigurationRequestContainersReadinessProbe()
            self.readiness_probe = temp_model.from_map(m.get('ReadinessProbe'))

        if m.get('SecurityContext') is not None:
            temp_model = main_models.CreateEciScalingConfigurationRequestContainersSecurityContext()
            self.security_context = temp_model.from_map(m.get('SecurityContext'))
        ...
        if m.get('EnvironmentVars') is not None:
            for k1 in m.get('EnvironmentVars'):
                temp_model = main_models.CreateEciScalingConfigurationRequestContainersEnvironmentVars()
        ...
        if m.get('Ports') is not None:
            for k1 in m.get('Ports'):
                temp_model = main_models.CreateEciScalingConfigurationRequestContainersPorts()
        ...
        if m.get('VolumeMounts') is not None:
            for k1 in m.get('VolumeMounts'):
                temp_model = main_models.CreateEciScalingConfigurationRequestContainersVolumeMounts()
...
class CreateEciScalingConfigurationRequestContainersVolumeMounts(DaraModel):
    def __init__(
        self,
        mount_path: str = None,
        mount_propagation: str = None,
...
class CreateEciScalingConfigurationRequestContainersPorts(DaraModel):
    def __init__(
        self,
        port: int = None,
        protocol: str = None,
...
class CreateEciScalingConfigurationRequestContainersEnvironmentVars(DaraModel):
    def __init__(
        self,
        field_ref_field_path: str = None,
        key: str = None,
...
class CreateEciScalingConfigurationRequestContainersSecurityContext(DaraModel):
    def __init__(
        self,
        capability: main_models.CreateEciScalingConfigurationRequestContainersSecurityContextCapability = None,
        read_only_root_filesystem: bool = None,
        run_as_user: int = None,
    ):
        self.capability = capability
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('Capability') is not None:
            temp_model = main_models.CreateEciScalingConfigurationRequestContainersSecurityContextCapability()
            self.capability = temp_model.from_map(m.get('Capability'))
...
class CreateEciScalingConfigurationRequestContainersSecurityContextCapability(DaraModel):
    def __init__(
        self,
        add: List[str] = None,
    ):
...
class CreateEciScalingConfigurationRequestContainersReadinessProbe(DaraModel):
    def __init__(
        self,
        exec: main_models.CreateEciScalingConfigurationRequestContainersReadinessProbeExec = None,
        failure_threshold: int = None,
        http_get: main_models.CreateEciScalingConfigurationRequestContainersReadinessProbeHttpGet = None,
        initial_delay_seconds: int = None,
        period_seconds: int = None,
        success_threshold: int = None,
        tcp_socket: main_models.CreateEciScalingConfigurationRequestContainersReadinessProbeTcpSocket = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Exec') is not None:
            temp_model = main_models.CreateEciScalingConfigurationRequestContainersReadinessProbeExec()
        ...
        if m.get('HttpGet') is not None:
            temp_model = main_models.CreateEciScalingConfigurationRequestContainersReadinessProbeHttpGet()
        ...
        if m.get('TcpSocket') is not None:
            temp_model = main_models.CreateEciScalingConfigurationRequestContainersReadinessProbeTcpSocket()
...
class CreateEciScalingConfigurationRequestContainersReadinessProbeTcpSocket(DaraModel):
    def __init__(
        self,
        port: int = None,
    ):
...
class CreateEciScalingConfigurationRequestContainersReadinessProbeHttpGet(DaraModel):
    def __init__(
        self,
        path: str = None,
        port: int = None,
...
class CreateEciScalingConfigurationRequestContainersReadinessProbeExec(DaraModel):
    def __init__(
        self,
        commands: List[str] = None,
    ):
...
class CreateEciScalingConfigurationRequestContainersLivenessProbe(DaraModel):
    def __init__(
        self,
        exec: main_models.CreateEciScalingConfigurationRequestContainersLivenessProbeExec = None,
        failure_threshold: int = None,
        http_get: main_models.CreateEciScalingConfigurationRequestContainersLivenessProbeHttpGet = None,
        initial_delay_seconds: int = None,
        period_seconds: int = None,
        success_threshold: int = None,
        tcp_socket: main_models.CreateEciScalingConfigurationRequestContainersLivenessProbeTcpSocket = None,
        timeout_seconds: int = None,
    ):
        self.exec = exec
        self.failure_threshold = failure_threshold
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('Exec') is not None:
            temp_model = main_models.CreateEciScalingConfigurationRequestContainersLivenessProbeExec()
            self.exec = temp_model.from_map(m.get('Exec'))
        ...
        if m.get('HttpGet') is not None:
            temp_model = main_models.CreateEciScalingConfigurationRequestContainersLivenessProbeHttpGet()
            self.http_get = temp_model.from_map(m.get('HttpGet'))
        ...
        if m.get('TcpSocket') is not None:
            temp_model = main_models.CreateEciScalingConfigurationRequestContainersLivenessProbeTcpSocket()
            self.tcp_socket = temp_model.from_map(m.get('TcpSocket'))
...
class CreateEciScalingConfigurationRequestContainersLivenessProbeTcpSocket(DaraModel):
    def __init__(
        self,
        port: int = None,
    ):
...
class CreateEciScalingConfigurationRequestContainersLivenessProbeHttpGet(DaraModel):
    def __init__(
        self,
        path: str = None,
        port: int = None,
...
class CreateEciScalingConfigurationRequestContainersLivenessProbeExec(DaraModel):
    def __init__(
        self,
        commands: List[str] = None,
    ):
...
class CreateEciScalingConfigurationRequestAcrRegistryInfos(DaraModel):
    def __init__(
        self,

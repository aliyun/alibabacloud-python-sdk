...
class ModifyScalingConfigurationShrinkRequest(DaraModel):
    def __init__(
        self,
        image_options: main_models.ModifyScalingConfigurationShrinkRequestImageOptions = None,
        private_pool_options: main_models.ModifyScalingConfigurationShrinkRequestPrivatePoolOptions = None,
        system_disk: main_models.ModifyScalingConfigurationShrinkRequestSystemDisk = None,
        affinity: str = None,
        cpu: int = None,
        credit_specification: str = None,
        custom_priorities: List[main_models.ModifyScalingConfigurationShrinkRequestCustomPriorities] = None,
        data_disks: List[main_models.ModifyScalingConfigurationShrinkRequestDataDisks] = None,
        ...
        memory: int = None,
        network_interfaces: List[main_models.ModifyScalingConfigurationShrinkRequestNetworkInterfaces] = None,
        override: bool = None,
        ...
        resource_pool_options: main_models.ModifyScalingConfigurationShrinkRequestResourcePoolOptions = None,
        scaling_configuration_id: str = None,
        scaling_configuration_name: str = None,
        scheduler_options_shrink: str = None,
        security_group_id: str = None,
        security_group_ids: List[str] = None,
        security_options: main_models.ModifyScalingConfigurationShrinkRequestSecurityOptions = None,
        spot_duration: int = None,
        spot_interruption_behavior: str = None,
        spot_price_limits: List[main_models.ModifyScalingConfigurationShrinkRequestSpotPriceLimits] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ImageOptions') is not None:
            temp_model = main_models.ModifyScalingConfigurationShrinkRequestImageOptions()
            self.image_options = temp_model.from_map(m.get('ImageOptions'))

        if m.get('PrivatePoolOptions') is not None:
            temp_model = main_models.ModifyScalingConfigurationShrinkRequestPrivatePoolOptions()
            self.private_pool_options = temp_model.from_map(m.get('PrivatePoolOptions'))

        if m.get('SystemDisk') is not None:
            temp_model = main_models.ModifyScalingConfigurationShrinkRequestSystemDisk()
        ...
        if m.get('CustomPriorities') is not None:
            for k1 in m.get('CustomPriorities'):
                temp_model = main_models.ModifyScalingConfigurationShrinkRequestCustomPriorities()
                self.custom_priorities.append(temp_model.from_map(k1))

        self.data_disks = []
        if m.get('DataDisks') is not None:
            for k1 in m.get('DataDisks'):
                temp_model = main_models.ModifyScalingConfigurationShrinkRequestDataDisks()
        ...
        if m.get('InstanceTypeOverrides') is not None:
            for k1 in m.get('InstanceTypeOverrides'):
                temp_model = main_models.ModifyScalingConfigurationShrinkRequestInstanceTypeOverrides()
        ...
        if m.get('NetworkInterfaces') is not None:
            for k1 in m.get('NetworkInterfaces'):
                temp_model = main_models.ModifyScalingConfigurationShrinkRequestNetworkInterfaces()
        ...
        if m.get('ResourcePoolOptions') is not None:
            temp_model = main_models.ModifyScalingConfigurationShrinkRequestResourcePoolOptions()
        ...
        if m.get('SecurityOptions') is not None:
            temp_model = main_models.ModifyScalingConfigurationShrinkRequestSecurityOptions()
        ...
        if m.get('SpotPriceLimits') is not None:
            for k1 in m.get('SpotPriceLimits'):
                temp_model = main_models.ModifyScalingConfigurationShrinkRequestSpotPriceLimits()
...
class ModifyScalingConfigurationShrinkRequestSpotPriceLimits(DaraModel):
    def __init__(
        self,
...
class ModifyScalingConfigurationShrinkRequestSecurityOptions(DaraModel):
    def __init__(
        self,
...
class ModifyScalingConfigurationShrinkRequestResourcePoolOptions(DaraModel):
    def __init__(
        self,
        private_pool_ids: List[str] = None,
        private_pool_tags: List[main_models.ModifyScalingConfigurationShrinkRequestResourcePoolOptionsPrivatePoolTags] = None,
        strategy: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PrivatePoolTags') is not None:
            for k1 in m.get('PrivatePoolTags'):
                temp_model = main_models.ModifyScalingConfigurationShrinkRequestResourcePoolOptionsPrivatePoolTags()
...
class ModifyScalingConfigurationShrinkRequestResourcePoolOptionsPrivatePoolTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class ModifyScalingConfigurationShrinkRequestNetworkInterfaces(DaraModel):
    def __init__(
        self,
        instance_type: str = None,
        ipv_6address_count: int = None,
...
class ModifyScalingConfigurationShrinkRequestInstanceTypeOverrides(DaraModel):
    def __init__(
        self,
        instance_type: str = None,
...
class ModifyScalingConfigurationShrinkRequestInstancePatternInfos(DaraModel):
    def __init__(
        self,
...
class ModifyScalingConfigurationShrinkRequestDataDisks(DaraModel):
    def __init__(
        self,
...
class ModifyScalingConfigurationShrinkRequestCustomPriorities(DaraModel):
    def __init__(
        self,
        instance_type: str = None,
        vswitch_id: str = None,
...
class ModifyScalingConfigurationShrinkRequestSystemDisk(DaraModel):
    def __init__(
        self,
        auto_snapshot_policy_id: str = None,
        bursting_enabled: bool = None,
...
class ModifyScalingConfigurationShrinkRequestPrivatePoolOptions(DaraModel):
    def __init__(
        self,
        id: str = None,
...
class ModifyScalingConfigurationShrinkRequestImageOptions(DaraModel):
    def __init__(
        self,

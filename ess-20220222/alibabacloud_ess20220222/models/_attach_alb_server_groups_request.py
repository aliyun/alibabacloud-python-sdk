...
class AttachAlbServerGroupsRequest(DaraModel):
    def __init__(
        self,
        alb_server_groups: List[main_models.AttachAlbServerGroupsRequestAlbServerGroups] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AlbServerGroups') is not None:
            for k1 in m.get('AlbServerGroups'):
                temp_model = main_models.AttachAlbServerGroupsRequestAlbServerGroups()
...
class AttachAlbServerGroupsRequestAlbServerGroups(DaraModel):
    def __init__(
        self,

...
class DetachServerGroupsRequest(DaraModel):
    def __init__(
        self,
        ...
        server_groups: List[main_models.DetachServerGroupsRequestServerGroups] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ServerGroups') is not None:
            for k1 in m.get('ServerGroups'):
                temp_model = main_models.DetachServerGroupsRequestServerGroups()
                self.server_groups.append(temp_model.from_map(k1))

        return self

class DetachServerGroupsRequestServerGroups(DaraModel):
    def __init__(
        self,
        port: int = None,

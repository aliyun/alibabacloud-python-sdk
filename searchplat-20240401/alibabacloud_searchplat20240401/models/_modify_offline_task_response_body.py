...
class ModifyOfflineTaskResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.ModifyOfflineTaskResponseBodyResult = None,
    ):
        # Id of the request
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.ModifyOfflineTaskResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class ModifyOfflineTaskResponseBodyResult(DaraModel):
    def __init__(
        self,
        meta: main_models.ModifyOfflineTaskResponseBodyResultMeta = None,
        parameters: Dict[str, Any] = None,
        processors: List[main_models.ModifyOfflineTaskResponseBodyResultProcessors] = None,
        sink: List[main_models.ModifyOfflineTaskResponseBodyResultSink] = None,
        source: List[main_models.ModifyOfflineTaskResponseBodyResultSource] = None,
        status: main_models.ModifyOfflineTaskResponseBodyResultStatus = None,
    ):
        # The metadata.
        self.meta = meta
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('meta') is not None:
            temp_model = main_models.ModifyOfflineTaskResponseBodyResultMeta()
        ...
        if m.get('processors') is not None:
            for k1 in m.get('processors'):
                temp_model = main_models.ModifyOfflineTaskResponseBodyResultProcessors()
                self.processors.append(temp_model.from_map(k1))

        self.sink = []
        if m.get('sink') is not None:
            for k1 in m.get('sink'):
                temp_model = main_models.ModifyOfflineTaskResponseBodyResultSink()
                self.sink.append(temp_model.from_map(k1))

        self.source = []
        if m.get('source') is not None:
            for k1 in m.get('source'):
                temp_model = main_models.ModifyOfflineTaskResponseBodyResultSource()
                self.source.append(temp_model.from_map(k1))

        if m.get('status') is not None:
            temp_model = main_models.ModifyOfflineTaskResponseBodyResultStatus()
            self.status = temp_model.from_map(m.get('status'))

        return self

class ModifyOfflineTaskResponseBodyResultStatus(DaraModel):
    def __init__(
        self,
...
class ModifyOfflineTaskResponseBodyResultSource(DaraModel):
    def __init__(
        self,
        name: str = None,
...
class ModifyOfflineTaskResponseBodyResultSink(DaraModel):
    def __init__(
        self,
        name: str = None,
        parameters: Dict[str, str] = None,
...
class ModifyOfflineTaskResponseBodyResultProcessors(DaraModel):
    def __init__(
        self,
...
class ModifyOfflineTaskResponseBodyResultMeta(DaraModel):
    def __init__(
        self,

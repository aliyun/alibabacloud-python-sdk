...
class CreateCredentialsResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.CreateCredentialsResponseBodyResult = None,
    ):
        # Id of the request
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.CreateCredentialsResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class CreateCredentialsResponseBodyResult(DaraModel):
    def __init__(
        self,

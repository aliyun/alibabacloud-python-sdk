...
class CreateOfflineTaskResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.CreateOfflineTaskResponseBodyResult = None,
    ):
        # Id of the request
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.CreateOfflineTaskResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class CreateOfflineTaskResponseBodyResult(DaraModel):
    def __init__(
        self,
        meta: main_models.CreateOfflineTaskResponseBodyResultMeta = None,
        parameters: Dict[str, Any] = None,
        processors: List[main_models.CreateOfflineTaskResponseBodyResultProcessors] = None,
        sink: List[main_models.CreateOfflineTaskResponseBodyResultSink] = None,
        source: List[main_models.CreateOfflineTaskResponseBodyResultSource] = None,
        status: main_models.CreateOfflineTaskResponseBodyResultStatus = None,
    ):
        # The task metadata.
        self.meta = meta
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('meta') is not None:
            temp_model = main_models.CreateOfflineTaskResponseBodyResultMeta()
        ...
        if m.get('processors') is not None:
            for k1 in m.get('processors'):
                temp_model = main_models.CreateOfflineTaskResponseBodyResultProcessors()
                self.processors.append(temp_model.from_map(k1))

        self.sink = []
        if m.get('sink') is not None:
            for k1 in m.get('sink'):
                temp_model = main_models.CreateOfflineTaskResponseBodyResultSink()
                self.sink.append(temp_model.from_map(k1))

        self.source = []
        if m.get('source') is not None:
            for k1 in m.get('source'):
                temp_model = main_models.CreateOfflineTaskResponseBodyResultSource()
                self.source.append(temp_model.from_map(k1))

        if m.get('status') is not None:
            temp_model = main_models.CreateOfflineTaskResponseBodyResultStatus()
            self.status = temp_model.from_map(m.get('status'))

        return self

class CreateOfflineTaskResponseBodyResultStatus(DaraModel):
    def __init__(
        self,
...
class CreateOfflineTaskResponseBodyResultSource(DaraModel):
    def __init__(
        self,
        name: str = None,
...
class CreateOfflineTaskResponseBodyResultSink(DaraModel):
    def __init__(
        self,
        name: str = None,
        parameters: Dict[str, str] = None,
...
class CreateOfflineTaskResponseBodyResultProcessors(DaraModel):
    def __init__(
        self,
...
class CreateOfflineTaskResponseBodyResultMeta(DaraModel):
    def __init__(
        self,

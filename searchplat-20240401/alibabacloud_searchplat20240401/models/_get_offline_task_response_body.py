...
class GetOfflineTaskResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.GetOfflineTaskResponseBodyResult = None,
    ):
        # Id of the request
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.GetOfflineTaskResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class GetOfflineTaskResponseBodyResult(DaraModel):
    def __init__(
        self,
        meta: main_models.GetOfflineTaskResponseBodyResultMeta = None,
        parameters: Dict[str, Any] = None,
        processors: List[main_models.GetOfflineTaskResponseBodyResultProcessors] = None,
        sink: List[main_models.GetOfflineTaskResponseBodyResultSink] = None,
        source: List[main_models.GetOfflineTaskResponseBodyResultSource] = None,
        status: main_models.GetOfflineTaskResponseBodyResultStatus = None,
    ):
        # The node metadata.
        self.meta = meta
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('meta') is not None:
            temp_model = main_models.GetOfflineTaskResponseBodyResultMeta()
        ...
        if m.get('processors') is not None:
            for k1 in m.get('processors'):
                temp_model = main_models.GetOfflineTaskResponseBodyResultProcessors()
                self.processors.append(temp_model.from_map(k1))

        self.sink = []
        if m.get('sink') is not None:
            for k1 in m.get('sink'):
                temp_model = main_models.GetOfflineTaskResponseBodyResultSink()
                self.sink.append(temp_model.from_map(k1))

        self.source = []
        if m.get('source') is not None:
            for k1 in m.get('source'):
                temp_model = main_models.GetOfflineTaskResponseBodyResultSource()
                self.source.append(temp_model.from_map(k1))

        if m.get('status') is not None:
            temp_model = main_models.GetOfflineTaskResponseBodyResultStatus()
            self.status = temp_model.from_map(m.get('status'))

        return self

class GetOfflineTaskResponseBodyResultStatus(DaraModel):
    def __init__(
        self,
...
class GetOfflineTaskResponseBodyResultSource(DaraModel):
    def __init__(
        self,
        name: str = None,
...
class GetOfflineTaskResponseBodyResultSink(DaraModel):
    def __init__(
        self,
        name: str = None,
        parameters: Dict[str, str] = None,
...
class GetOfflineTaskResponseBodyResultProcessors(DaraModel):
    def __init__(
        self,
...
class GetOfflineTaskResponseBodyResultMeta(DaraModel):
    def __init__(
        self,

...
class ModifyOfflineTaskRequest(DaraModel):
    def __init__(
        self,
        meta: main_models.ModifyOfflineTaskRequestMeta = None,
        parameters: Dict[str, Any] = None,
        processors: List[main_models.ModifyOfflineTaskRequestProcessors] = None,
        sink: List[main_models.ModifyOfflineTaskRequestSink] = None,
        source: List[main_models.ModifyOfflineTaskRequestSource] = None,
        status: main_models.ModifyOfflineTaskRequestStatus = None,
        dry_run: bool = None,
        region_id: str = None,
    ):
        # The task metadata.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('meta') is not None:
            temp_model = main_models.ModifyOfflineTaskRequestMeta()
        ...
        if m.get('processors') is not None:
            for k1 in m.get('processors'):
                temp_model = main_models.ModifyOfflineTaskRequestProcessors()
                self.processors.append(temp_model.from_map(k1))

        self.sink = []
        if m.get('sink') is not None:
            for k1 in m.get('sink'):
                temp_model = main_models.ModifyOfflineTaskRequestSink()
                self.sink.append(temp_model.from_map(k1))

        self.source = []
        if m.get('source') is not None:
            for k1 in m.get('source'):
                temp_model = main_models.ModifyOfflineTaskRequestSource()
                self.source.append(temp_model.from_map(k1))

        if m.get('status') is not None:
            temp_model = main_models.ModifyOfflineTaskRequestStatus()
...
class ModifyOfflineTaskRequestStatus(DaraModel):
    def __init__(
        self,
...
class ModifyOfflineTaskRequestSource(DaraModel):
    def __init__(
        self,
        name: str = None,
...
class ModifyOfflineTaskRequestSink(DaraModel):
    def __init__(
        self,
        name: str = None,
        parameters: Dict[str, str] = None,
...
class ModifyOfflineTaskRequestProcessors(DaraModel):
    def __init__(
        self,
...
class ModifyOfflineTaskRequestMeta(DaraModel):
    def __init__(
        self,
        api_key: str = None,

...
class GetExperienceDataResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.GetExperienceDataResponseBodyResult = None,
    ):
        # Id of the request
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.GetExperienceDataResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class GetExperienceDataResponseBodyResult(DaraModel):
    def __init__(
        self,

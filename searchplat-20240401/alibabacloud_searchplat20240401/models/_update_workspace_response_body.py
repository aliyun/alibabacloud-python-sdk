...
class UpdateWorkspaceResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.UpdateWorkspaceResponseBodyResult = None,
    ):
        # Id of the request
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.UpdateWorkspaceResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class UpdateWorkspaceResponseBodyResult(DaraModel):
    def __init__(
        self,
        ...
        name: str = None,
        produced: int = None,
        quota: main_models.UpdateWorkspaceResponseBodyResultQuota = None,
        resource_group_id: str = None,
        tags: List[main_models.UpdateWorkspaceResponseBodyResultTags] = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('quota') is not None:
            temp_model = main_models.UpdateWorkspaceResponseBodyResultQuota()
        ...
        if m.get('tags') is not None:
            for k1 in m.get('tags'):
                temp_model = main_models.UpdateWorkspaceResponseBodyResultTags()
...
class UpdateWorkspaceResponseBodyResultTags(DaraModel):
    def __init__(
        self,
        tag_key: str = None,
        tag_value: str = None,
...
class UpdateWorkspaceResponseBodyResultQuota(DaraModel):
    def __init__(
        self,

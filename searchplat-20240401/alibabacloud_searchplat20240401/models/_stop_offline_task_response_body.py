...
class StopOfflineTaskResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.StopOfflineTaskResponseBodyResult = None,
    ):
        # Id of the request
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.StopOfflineTaskResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class StopOfflineTaskResponseBodyResult(DaraModel):
    def __init__(
        self,
        meta: main_models.StopOfflineTaskResponseBodyResultMeta = None,
        parameters: Dict[str, Any] = None,
        processors: List[main_models.StopOfflineTaskResponseBodyResultProcessors] = None,
        sink: List[main_models.StopOfflineTaskResponseBodyResultSink] = None,
        source: List[main_models.StopOfflineTaskResponseBodyResultSource] = None,
        status: main_models.StopOfflineTaskResponseBodyResultStatus = None,
    ):
        # The metadata.
        self.meta = meta
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('meta') is not None:
            temp_model = main_models.StopOfflineTaskResponseBodyResultMeta()
        ...
        if m.get('processors') is not None:
            for k1 in m.get('processors'):
                temp_model = main_models.StopOfflineTaskResponseBodyResultProcessors()
                self.processors.append(temp_model.from_map(k1))

        self.sink = []
        if m.get('sink') is not None:
            for k1 in m.get('sink'):
                temp_model = main_models.StopOfflineTaskResponseBodyResultSink()
                self.sink.append(temp_model.from_map(k1))

        self.source = []
        if m.get('source') is not None:
            for k1 in m.get('source'):
                temp_model = main_models.StopOfflineTaskResponseBodyResultSource()
                self.source.append(temp_model.from_map(k1))

        if m.get('status') is not None:
            temp_model = main_models.StopOfflineTaskResponseBodyResultStatus()
            self.status = temp_model.from_map(m.get('status'))

        return self

class StopOfflineTaskResponseBodyResultStatus(DaraModel):
    def __init__(
        self,
...
class StopOfflineTaskResponseBodyResultSource(DaraModel):
    def __init__(
        self,
        name: str = None,
...
class StopOfflineTaskResponseBodyResultSink(DaraModel):
    def __init__(
        self,
        name: str = None,
        parameters: Dict[str, str] = None,
...
class StopOfflineTaskResponseBodyResultProcessors(DaraModel):
    def __init__(
        self,
...
class StopOfflineTaskResponseBodyResultMeta(DaraModel):
    def __init__(
        self,

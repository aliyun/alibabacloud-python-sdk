...
class CreateMessengerPageRequest(DaraModel):
    def __init__(
        self,
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        if self.ad_account_ids is not None:
            result['AdAccountIds'] = self.ad_account_ids
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AdAccountIds') is not None:
            self.ad_account_ids = m.get('AdAccountIds')

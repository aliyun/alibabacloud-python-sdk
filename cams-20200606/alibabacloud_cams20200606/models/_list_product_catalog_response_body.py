...
class ListProductCatalogResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: str = None,
        message: str = None,
        model: main_models.ListProductCatalogResponseBodyModel = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Model') is not None:
            temp_model = main_models.ListProductCatalogResponseBodyModel()
...
class ListProductCatalogResponseBodyModel(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Paging') is not None:
            temp_model = main_models.ListProductCatalogResponseBodyModelPaging()
            self.paging = temp_model.from_map(m.get('Paging'))

        return self

class ListProductCatalogResponseBodyModelPaging(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Cursors') is not None:
            temp_model = main_models.ListProductCatalogResponseBodyModelPagingCursors()
            self.cursors = temp_model.from_map(m.get('Cursors'))

        return self

class ListProductCatalogResponseBodyModelPagingCursors(DaraModel):
    def __init__(
        self,
        after: str = None,
        before: str = None,

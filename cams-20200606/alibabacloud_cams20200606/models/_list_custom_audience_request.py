...
class ListCustomAudienceRequest(DaraModel):
    def __init__(
        self,
        ...
        owner_id: int = None,
        page: main_models.ListCustomAudienceRequestPage = None,
        page_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Page') is not None:
            temp_model = main_models.ListCustomAudienceRequestPage()
...
class ListCustomAudienceRequestPage(DaraModel):
    def __init__(
        self,
        index: int = None,
        size: int = None,

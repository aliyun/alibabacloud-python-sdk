...
class GetChatFlowTemplateResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: str = None,
        data: main_models.GetChatFlowTemplateResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetChatFlowTemplateResponseBodyData()
...
class GetChatFlowTemplateResponseBodyData(DaraModel):
    def __init__(
        self,

...
class UpdateAuditRequestRequest(DaraModel):
    def __init__(
        self,
        audit_record: main_models.UpdateAuditRequestRequestAuditRecord = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AuditRecord') is not None:
            temp_model = main_models.UpdateAuditRequestRequestAuditRecord()
...
class UpdateAuditRequestRequestAuditRecord(DaraModel):
    def __init__(
        self,
        age_limit: str = None,
        ...
        company_address: List[main_models.UpdateAuditRequestRequestAuditRecordCompanyAddress] = None,
        ...
        company_tel: List[main_models.UpdateAuditRequestRequestAuditRecordCompanyTel] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CompanyAddress') is not None:
            for k1 in m.get('CompanyAddress'):
                temp_model = main_models.UpdateAuditRequestRequestAuditRecordCompanyAddress()
        ...
        if m.get('CompanyTel') is not None:
            for k1 in m.get('CompanyTel'):
                temp_model = main_models.UpdateAuditRequestRequestAuditRecordCompanyTel()
...
class UpdateAuditRequestRequestAuditRecordCompanyTel(DaraModel):
    def __init__(
        self,
...
class UpdateAuditRequestRequestAuditRecordCompanyAddress(DaraModel):
    def __init__(
        self,

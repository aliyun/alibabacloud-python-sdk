...
class ListChatappTemplateRequest(DaraModel):
    def __init__(
        self,
        ...
        name: str = None,
        owner_id: int = None,
        page: main_models.ListChatappTemplateRequestPage = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Page') is not None:
            temp_model = main_models.ListChatappTemplateRequestPage()
...
class ListChatappTemplateRequestPage(DaraModel):
    def __init__(
        self,
        index: int = None,
        size: int = None,

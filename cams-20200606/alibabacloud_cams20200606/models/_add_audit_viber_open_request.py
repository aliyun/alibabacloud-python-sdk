...
class AddAuditViberOpenRequest(DaraModel):
    def __init__(
        self,
        audit_record: main_models.AddAuditViberOpenRequestAuditRecord = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AuditRecord') is not None:
            temp_model = main_models.AddAuditViberOpenRequestAuditRecord()
...
class AddAuditViberOpenRequestAuditRecord(DaraModel):
    def __init__(
        self,
        age_limit: str = None,
        business_account_name: str = None,
        business_license_registration_number: str = None,
        company_address: List[main_models.AddAuditViberOpenRequestAuditRecordCompanyAddress] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CompanyAddress') is not None:
            for k1 in m.get('CompanyAddress'):
                temp_model = main_models.AddAuditViberOpenRequestAuditRecordCompanyAddress()
        ...
        if m.get('CompanyTel') is not None:
            for k1 in m.get('CompanyTel'):
                temp_model = main_models.AddAuditViberOpenRequestAuditRecordCompanyTel()
...
class AddAuditViberOpenRequestAuditRecordCompanyTel(DaraModel):
    def __init__(
        self,
...
class AddAuditViberOpenRequestAuditRecordCompanyAddress(DaraModel):
    def __init__(
        self,

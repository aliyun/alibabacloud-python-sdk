...
class ChatappSyncPhoneNumberResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: str = None,
        message: str = None,
        phone_numbers: List[main_models.ChatappSyncPhoneNumberResponseBodyPhoneNumbers] = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PhoneNumbers') is not None:
            for k1 in m.get('PhoneNumbers'):
                temp_model = main_models.ChatappSyncPhoneNumberResponseBodyPhoneNumbers()

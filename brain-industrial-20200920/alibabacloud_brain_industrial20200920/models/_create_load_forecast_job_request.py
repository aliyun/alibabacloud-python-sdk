...
class CreateLoadForecastJobRequest(DaraModel):
    def __init__(
        self,
        ...
        freq: str = None,
        history_data: List[main_models.CreateLoadForecastJobRequestHistoryData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HistoryData') is not None:
            for k1 in m.get('HistoryData'):
                temp_model = main_models.CreateLoadForecastJobRequestHistoryData()
...
class CreateLoadForecastJobRequestHistoryData(DaraModel):
    def __init__(
        self,
        run_time: str = None,
        value: float = None,

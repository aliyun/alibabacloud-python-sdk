...
class ActivateLicenseResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: str = None,
        data: main_models.ActivateLicenseResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ActivateLicenseResponseBodyData()
...
class ActivateLicenseResponseBodyData(DaraModel):
    def __init__(
        self,
        activate_record: List[main_models.ActivateLicenseResponseBodyDataActivateRecord] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ActivateRecord') is not None:
            for k1 in m.get('ActivateRecord'):
                temp_model = main_models.ActivateLicenseResponseBodyDataActivateRecord()
...
class ActivateLicenseResponseBodyDataActivateRecord(DaraModel):
    def __init__(
        self,
        activate_time: str = None,
        buy_time: str = None,

...
class Client(OpenApiClient):
    ...
    *\
    ...
    def open_api_invoke_with_options(
        self,
        request: brain_industrial_20200920_models.OpenApiInvokeRequest,
        runtime: util_models.RuntimeOptions,
    ) -> brain_industrial_20200920_models.OpenApiInvokeResponse:
        """
    ...
    def open_api_invoke(
        ...
        """
        runtime = util_models.RuntimeOptions()
        return self.open_api_invoke_with_options(request, runtime)
    ...
    async def open_api_invoke_async(
        ...
        """
        runtime = util_models.RuntimeOptions()
        return await self.open_api_invoke_with_options_async(request, runtime)

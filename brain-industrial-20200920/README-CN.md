...
```bash
# 安装 alibabacloud_brain_industrial20200920
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/brain-industrial-20200920/ChangeLog.md)中。

...
class AddIpamMembersRequest(DaraModel):
    def __init__(
        self,
        client_token: str = None,
        dry_run: bool = None,
        members: List[main_models.AddIpamMembersRequestMembers] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Members') is not None:
            for k1 in m.get('Members'):
                temp_model = main_models.AddIpamMembersRequestMembers()
...
class AddIpamMembersRequestMembers(DaraModel):
    def __init__(
        self,
        member_id: str = None,

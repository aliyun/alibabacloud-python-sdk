...
class AuthorizeAppProxyOpsResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.AuthorizeAppProxyOpsResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.AuthorizeAppProxyOpsResponseBodyModule()
...
class AuthorizeAppProxyOpsResponseBodyModule(DaraModel):
    def __init__(
        self,
        authorized: bool = None,
        ram_auth_link: str = None,
        tmp_ticket: str = None,
    ):
    ...
    def to_map(self):
        ...
        if self.ram_auth_link is not None:
            result['RamAuthLink'] = self.ram_auth_link

        if self.tmp_ticket is not None:
            result['TmpTicket'] = self.tmp_ticket
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RamAuthLink') is not None:
            self.ram_auth_link = m.get('RamAuthLink')

        if m.get('TmpTicket') is not None:
            self.tmp_ticket = m.get('TmpTicket')

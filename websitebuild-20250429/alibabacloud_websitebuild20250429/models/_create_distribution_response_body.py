...
class CreateDistributionResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.CreateDistributionResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.CreateDistributionResponseBodyModule()
...
class CreateDistributionResponseBodyModule(DaraModel):
    def __init__(
        self,
        article_id: str = None,
        batch_id: str = None,
        create_time: int = None,
        drafts: List[main_models.CreateDistributionResponseBodyModuleDrafts] = None,
    ):
        # The article ID.
    ...
    def to_map(self):
        ...
        if self.drafts is not None:
            for k1 in self.drafts:
                result['Drafts'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        self.drafts = []
        if m.get('Drafts') is not None:
            for k1 in m.get('Drafts'):
                temp_model = main_models.CreateDistributionResponseBodyModuleDrafts()
                self.drafts.append(temp_model.from_map(k1))

        return self

class CreateDistributionResponseBodyModuleDrafts(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CoverImages') is not None:
            for k1 in m.get('CoverImages'):
                temp_model = main_models.CreateDistributionResponseBodyModuleDraftsCoverImages()
...
class CreateDistributionResponseBodyModuleDraftsCoverImages(DaraModel):
    def __init__(
        self,

...
class ListAppAssistantAgentsResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: List[main_models.ListAppAssistantAgentsResponseBodyModule] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            for k1 in m.get('Module'):
                temp_model = main_models.ListAppAssistantAgentsResponseBodyModule()
...
class ListAppAssistantAgentsResponseBodyModule(DaraModel):
    def __init__(
        self,
        agent_id: str = None,
        agent_name: str = None,
        biz_id: str = None,
        credential: main_models.ListAppAssistantAgentsResponseBodyModuleCredential = None,
        embed_config: main_models.ListAppAssistantAgentsResponseBodyModuleEmbedConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Credential') is not None:
            temp_model = main_models.ListAppAssistantAgentsResponseBodyModuleCredential()
            self.credential = temp_model.from_map(m.get('Credential'))

        if m.get('EmbedConfig') is not None:
            temp_model = main_models.ListAppAssistantAgentsResponseBodyModuleEmbedConfig()
...
class ListAppAssistantAgentsResponseBodyModuleEmbedConfig(DaraModel):
    def __init__(
        self,
...
class ListAppAssistantAgentsResponseBodyModuleCredential(DaraModel):
    def __init__(
        self,
        api_key: str = None,
        api_secret: str = None,

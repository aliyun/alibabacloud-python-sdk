...
class RewriteChannelTitleResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.RewriteChannelTitleResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.RewriteChannelTitleResponseBodyModule()
...
class RewriteChannelTitleResponseBodyModule(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CoverImages') is not None:
            for k1 in m.get('CoverImages'):
                temp_model = main_models.RewriteChannelTitleResponseBodyModuleCoverImages()
...
class RewriteChannelTitleResponseBodyModuleCoverImages(DaraModel):
    def __init__(
        self,

...
class ListRbacRolesResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.ListRbacRolesResponseBodyModule = None,
        next_token: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.ListRbacRolesResponseBodyModule()
...
class ListRbacRolesResponseBodyModule(DaraModel):
    def __init__(
        self,
        current_page_num: int = None,
        data: List[main_models.ListRbacRolesResponseBodyModuleData] = None,
        next: main_models.ListRbacRolesResponseBodyModuleNext = None,
        next_page: bool = None,
        page_size: int = None,
        pre_page: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListRbacRolesResponseBodyModuleData()
                self.data.append(temp_model.from_map(k1))

        if m.get('Next') is not None:
            temp_model = main_models.ListRbacRolesResponseBodyModuleNext()
...
class ListRbacRolesResponseBodyModuleNext(DaraModel):
    def __init__(
        self,
        created_at: str = None,
        id: str = None,
...
class ListRbacRolesResponseBodyModuleData(DaraModel):
    def __init__(
        self,
        created_at: str = None,
        id: str = None,

...
class ListAppPluginConfigsResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: List[main_models.ListAppPluginConfigsResponseBodyModule] = None,
        next_token: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            for k1 in m.get('Module'):
                temp_model = main_models.ListAppPluginConfigsResponseBodyModule()
...
class ListAppPluginConfigsResponseBodyModule(DaraModel):
    def __init__(
        self,
        biz_id: str = None,
        display: int = None,

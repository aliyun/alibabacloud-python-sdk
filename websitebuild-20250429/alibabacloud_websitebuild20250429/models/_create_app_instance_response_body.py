...
class CreateAppInstanceResponseBody(DaraModel):
    def __init__(
        ...
        module: main_models.CreateAppInstanceResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.CreateAppInstanceResponseBodyModule()
...
class CreateAppInstanceResponseBodyModule(DaraModel):
    def __init__(
        self,
        biz_id: str = None,

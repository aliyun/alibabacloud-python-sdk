...
class RenewAppSandboxResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.RenewAppSandboxResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.RenewAppSandboxResponseBodyModule()
...
class RenewAppSandboxResponseBodyModule(DaraModel):
    def __init__(
        self,
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        if self.preview_urls is not None:
            result['PreviewUrls'] = self.preview_urls

        return result

    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('PreviewUrls') is not None:
            self.preview_urls = m.get('PreviewUrls')

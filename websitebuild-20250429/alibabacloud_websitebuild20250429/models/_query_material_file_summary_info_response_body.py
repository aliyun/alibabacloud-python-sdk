...
class QueryMaterialFileSummaryInfoResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.QueryMaterialFileSummaryInfoResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.QueryMaterialFileSummaryInfoResponseBodyModule()
...
class QueryMaterialFileSummaryInfoResponseBodyModule(DaraModel):
    def __init__(
        self,
        file_num: int = None,

...
class CreateAppTokenServiceResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.CreateAppTokenServiceResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.CreateAppTokenServiceResponseBodyModule()
...
class CreateAppTokenServiceResponseBodyModule(DaraModel):
    def __init__(
        self,
        ext_info: str = None,
    ):

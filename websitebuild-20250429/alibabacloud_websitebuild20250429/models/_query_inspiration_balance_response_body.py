...
class QueryInspirationBalanceResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.QueryInspirationBalanceResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.QueryInspirationBalanceResponseBodyModule()
...
class QueryInspirationBalanceResponseBodyModule(DaraModel):
    def __init__(
        self,
        remaining: int = None,

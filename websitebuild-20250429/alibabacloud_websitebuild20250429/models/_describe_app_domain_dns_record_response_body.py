...
class DescribeAppDomainDnsRecordResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.DescribeAppDomainDnsRecordResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.DescribeAppDomainDnsRecordResponseBodyModule()
...
class DescribeAppDomainDnsRecordResponseBodyModule(DaraModel):
    def __init__(
        self,
        host: str = None,

...
class GetAppSupabaseSecretsResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.GetAppSupabaseSecretsResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.GetAppSupabaseSecretsResponseBodyModule()
...
class GetAppSupabaseSecretsResponseBodyModule(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Secrets') is not None:
            for k1 in m.get('Secrets'):
                temp_model = main_models.GetAppSupabaseSecretsResponseBodyModuleSecrets()
                self.secrets.append(temp_model.from_map(k1))

        return self

class GetAppSupabaseSecretsResponseBodyModuleSecrets(DaraModel):
    def __init__(
        self,
        key: str = None,
        name: str = None,

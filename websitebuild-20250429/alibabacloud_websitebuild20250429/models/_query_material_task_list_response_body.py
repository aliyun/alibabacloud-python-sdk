...
class QueryMaterialTaskListResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.QueryMaterialTaskListResponseBodyModule = None,
        next_token: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.QueryMaterialTaskListResponseBodyModule()
...
class QueryMaterialTaskListResponseBodyModule(DaraModel):
    def __init__(
        self,
        current_page_num: int = None,
        data: List[main_models.AppMaterialTask] = None,
        next_page: bool = None,
        page_size: int = None,
        pre_page: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.AppMaterialTask()

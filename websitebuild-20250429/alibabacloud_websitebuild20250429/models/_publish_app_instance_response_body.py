...
class PublishAppInstanceResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.PublishAppInstanceResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.PublishAppInstanceResponseBodyModule()
...
class PublishAppInstanceResponseBodyModule(DaraModel):
    def __init__(
        self,

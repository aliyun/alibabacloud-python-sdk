...
class QueryRbacRoleResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.QueryRbacRoleResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.QueryRbacRoleResponseBodyModule()
...
class QueryRbacRoleResponseBodyModule(DaraModel):
    def __init__(
        self,
        created_at: str = None,
        id: str = None,

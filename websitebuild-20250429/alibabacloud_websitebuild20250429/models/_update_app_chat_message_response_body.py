...
class UpdateAppChatMessageResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.UpdateAppChatMessageResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.UpdateAppChatMessageResponseBodyModule()
...
class UpdateAppChatMessageResponseBodyModule(DaraModel):
    def __init__(
        self,
        bot_id: str = None,
        chat_id: str = None,

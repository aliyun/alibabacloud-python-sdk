...
class ListAppChatMessagesResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: List[main_models.ListAppChatMessagesResponseBodyModule] = None,
        next_token: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            for k1 in m.get('Module'):
                temp_model = main_models.ListAppChatMessagesResponseBodyModule()
...
class ListAppChatMessagesResponseBodyModule(DaraModel):
    def __init__(
        self,
        bot_id: str = None,
        chat_id: str = None,

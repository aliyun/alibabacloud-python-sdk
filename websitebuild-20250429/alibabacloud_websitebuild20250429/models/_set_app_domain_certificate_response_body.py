...
class SetAppDomainCertificateResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.SetAppDomainCertificateResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.SetAppDomainCertificateResponseBodyModule()
...
class SetAppDomainCertificateResponseBodyModule(DaraModel):
    def __init__(
        self,
        success: bool = None,
    ):

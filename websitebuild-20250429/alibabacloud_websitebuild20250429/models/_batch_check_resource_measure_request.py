...
class BatchCheckResourceMeasureRequest(DaraModel):
    def __init__(
        self,
        belong_id: str = None,
    ...
    def to_map(self):
        ...
        if self.resource_check_items is not None:
            result['ResourceCheckItems'] = self.resource_check_items
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceCheckItems') is not None:
            self.resource_check_items = m.get('ResourceCheckItems')

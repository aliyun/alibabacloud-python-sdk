...
class DeleteAppPluginResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.DeleteAppPluginResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.DeleteAppPluginResponseBodyModule()
...
class DeleteAppPluginResponseBodyModule(DaraModel):
    def __init__(
        self,
        status: str = None,
        success: bool = None,

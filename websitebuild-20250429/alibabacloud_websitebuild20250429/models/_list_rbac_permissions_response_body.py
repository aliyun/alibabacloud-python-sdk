...
class ListRbacPermissionsResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.ListRbacPermissionsResponseBodyModule = None,
        next_token: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.ListRbacPermissionsResponseBodyModule()
...
class ListRbacPermissionsResponseBodyModule(DaraModel):
    def __init__(
        self,
        current_page_num: int = None,
        data: List[main_models.ListRbacPermissionsResponseBodyModuleData] = None,
        next: main_models.ListRbacPermissionsResponseBodyModuleNext = None,
        next_page: bool = None,
        page_size: int = None,
        pre_page: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListRbacPermissionsResponseBodyModuleData()
                self.data.append(temp_model.from_map(k1))

        if m.get('Next') is not None:
            temp_model = main_models.ListRbacPermissionsResponseBodyModuleNext()
...
class ListRbacPermissionsResponseBodyModuleNext(DaraModel):
    def __init__(
        self,
        action: str = None,
...
class ListRbacPermissionsResponseBodyModuleData(DaraModel):
    def __init__(
        self,
        action: str = None,
        description: str = None,

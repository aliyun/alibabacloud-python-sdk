...
class QueryMaterialDirectoryTreeResponseBody(DaraModel):
    def __init__(
        self,
        ...
        error_code: str = None,
        error_msg: str = None,
        module: main_models.QueryMaterialDirectoryTreeResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.QueryMaterialDirectoryTreeResponseBodyModule()
...
class QueryMaterialDirectoryTreeResponseBodyModule(DaraModel):
    def __init__(
        self,

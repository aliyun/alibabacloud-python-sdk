...
class RenewAppInstanceResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.RenewAppInstanceResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.RenewAppInstanceResponseBodyModule()
...
class RenewAppInstanceResponseBodyModule(DaraModel):
    def __init__(
        self,
        order_id: str = None,
    ):

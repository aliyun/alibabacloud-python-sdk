...
class ExportMaterialFileResponseBody(DaraModel):
    def __init__(
        self,
        ...
        error_code: str = None,
        error_msg: str = None,
        module: main_models.ExportMaterialFileResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.ExportMaterialFileResponseBodyModule()
...
class ExportMaterialFileResponseBodyModule(DaraModel):
    def __init__(
        self,
        file_url: str = None,
    ):

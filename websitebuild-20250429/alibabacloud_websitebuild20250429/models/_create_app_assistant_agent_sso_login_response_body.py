...
class CreateAppAssistantAgentSsoLoginResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.CreateAppAssistantAgentSsoLoginResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.CreateAppAssistantAgentSsoLoginResponseBodyModule()
...
class CreateAppAssistantAgentSsoLoginResponseBodyModule(DaraModel):
    def __init__(
        self,

...
class ConfirmAppInstanceRequest(DaraModel):
    def __init__(
        self,
    ...
    def to_map(self):
        ...
        if self.trial_biz_id is not None:
            result['TrialBizId'] = self.trial_biz_id
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TrialBizId') is not None:
            self.trial_biz_id = m.get('TrialBizId')

...
class RefundAppInstanceForPartnerResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.RefundAppInstanceForPartnerResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.RefundAppInstanceForPartnerResponseBodyModule()
...
class RefundAppInstanceForPartnerResponseBodyModule(DaraModel):
    def __init__(
        self,
        order_id: str = None,
    ):

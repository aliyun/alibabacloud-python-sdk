...
class CheckUserResourceMeasureResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.CheckUserResourceMeasureResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.CheckUserResourceMeasureResponseBodyModule()
...
class CheckUserResourceMeasureResponseBodyModule(DaraModel):
    def __init__(
        self,
        error_code: str = None,

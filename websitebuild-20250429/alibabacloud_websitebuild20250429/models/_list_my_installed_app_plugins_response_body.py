...
class ListMyInstalledAppPluginsResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.ListMyInstalledAppPluginsResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.ListMyInstalledAppPluginsResponseBodyModule()
...
class ListMyInstalledAppPluginsResponseBodyModule(DaraModel):
    def __init__(
        self,
        current_page_num: int = None,
        data: List[main_models.ListMyInstalledAppPluginsResponseBodyModuleData] = None,
        next: main_models.ListMyInstalledAppPluginsResponseBodyModuleNext = None,
        next_page: bool = None,
        page_size: int = None,
        pre_page: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListMyInstalledAppPluginsResponseBodyModuleData()
                self.data.append(temp_model.from_map(k1))

        if m.get('Next') is not None:
            temp_model = main_models.ListMyInstalledAppPluginsResponseBodyModuleNext()
...
class ListMyInstalledAppPluginsResponseBodyModuleNext(DaraModel):
    def __init__(
        self,
        category: str = None,
...
class ListMyInstalledAppPluginsResponseBodyModuleData(DaraModel):
    def __init__(
        self,
        category: str = None,
        description: str = None,

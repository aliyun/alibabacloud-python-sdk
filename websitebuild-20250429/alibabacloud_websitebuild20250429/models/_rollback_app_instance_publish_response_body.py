...
class RollbackAppInstancePublishResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.RollbackAppInstancePublishResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.RollbackAppInstancePublishResponseBodyModule()
...
class RollbackAppInstancePublishResponseBodyModule(DaraModel):
    def __init__(
        self,

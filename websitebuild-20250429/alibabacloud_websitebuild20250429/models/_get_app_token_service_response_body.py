...
class GetAppTokenServiceResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.GetAppTokenServiceResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.GetAppTokenServiceResponseBodyModule()
...
class GetAppTokenServiceResponseBodyModule(DaraModel):
    def __init__(
        self,
        extend: str = None,
        status: str = None,

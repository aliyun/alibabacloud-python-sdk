...
class CreateMaterialDirectoryResponseBody(DaraModel):
    def __init__(
        self,
        ...
        error_code: str = None,
        module: main_models.CreateMaterialDirectoryResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.CreateMaterialDirectoryResponseBodyModule()
...
class CreateMaterialDirectoryResponseBodyModule(DaraModel):
    def __init__(
        self,

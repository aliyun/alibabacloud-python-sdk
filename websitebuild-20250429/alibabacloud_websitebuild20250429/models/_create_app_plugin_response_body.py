...
class CreateAppPluginResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.CreateAppPluginResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.CreateAppPluginResponseBodyModule()
...
class CreateAppPluginResponseBodyModule(DaraModel):
    def __init__(
        self,
        plugin_id: str = None,
        status: str = None,

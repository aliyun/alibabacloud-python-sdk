...
class UnbindAppDomainResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.UnbindAppDomainResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.UnbindAppDomainResponseBodyModule()
...
class UnbindAppDomainResponseBodyModule(DaraModel):
    def __init__(
        self,
        success: bool = None,
    ):

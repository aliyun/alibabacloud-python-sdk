...
class CreateAppNotificationSceneResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.CreateAppNotificationSceneResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.CreateAppNotificationSceneResponseBodyModule()
...
class CreateAppNotificationSceneResponseBodyModule(DaraModel):
    def __init__(
        self,
        id: str = None,
    ):

...
class UpdateAppInstanceResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.UpdateAppInstanceResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.UpdateAppInstanceResponseBodyModule()
...
class UpdateAppInstanceResponseBodyModule(DaraModel):
    def __init__(
        self,
        biz_id: str = None,
        icon_url: str = None,

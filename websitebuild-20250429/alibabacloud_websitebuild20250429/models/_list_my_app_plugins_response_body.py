...
class ListMyAppPluginsResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.ListMyAppPluginsResponseBodyModule = None,
        request_id: str = None,
        ...
        # The application name. The name must start with a letter and can contain digits, letters, underscores (_), and hyphens (-). The name can be up to 36 characters in length.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.ListMyAppPluginsResponseBodyModule()
...
class ListMyAppPluginsResponseBodyModule(DaraModel):
    def __init__(
        self,
        current_page_num: int = None,
        data: List[main_models.ListMyAppPluginsResponseBodyModuleData] = None,
        next: main_models.ListMyAppPluginsResponseBodyModuleNext = None,
        next_page: bool = None,
        page_size: int = None,
        pre_page: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListMyAppPluginsResponseBodyModuleData()
                self.data.append(temp_model.from_map(k1))

        if m.get('Next') is not None:
            temp_model = main_models.ListMyAppPluginsResponseBodyModuleNext()
...
class ListMyAppPluginsResponseBodyModuleNext(DaraModel):
    def __init__(
        self,
        category: str = None,
        ...
        # Converts controlType based on the associated public category.
...
class ListMyAppPluginsResponseBodyModuleData(DaraModel):
    def __init__(
        self,
        category: str = None,
        description: str = None,

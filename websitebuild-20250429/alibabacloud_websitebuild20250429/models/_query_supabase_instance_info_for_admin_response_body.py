...
class QuerySupabaseInstanceInfoForAdminResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.QuerySupabaseInstanceInfoForAdminResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.QuerySupabaseInstanceInfoForAdminResponseBodyModule()
...
class QuerySupabaseInstanceInfoForAdminResponseBodyModule(DaraModel):
    def __init__(
        self,
        anon_key: str = None,
        biz_id: str = None,

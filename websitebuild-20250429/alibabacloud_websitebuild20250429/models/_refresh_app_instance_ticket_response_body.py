...
class RefreshAppInstanceTicketResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.RefreshAppInstanceTicketResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.RefreshAppInstanceTicketResponseBodyModule()
...
class RefreshAppInstanceTicketResponseBodyModule(DaraModel):
    def __init__(
        self,

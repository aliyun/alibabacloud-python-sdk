...
class GetAppFileContentResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.GetAppFileContentResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.GetAppFileContentResponseBodyModule()
...
class GetAppFileContentResponseBodyModule(DaraModel):
    def __init__(
        self,
        content: str = None,

...
class ConfirmAppInstanceResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.ConfirmAppInstanceResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.ConfirmAppInstanceResponseBodyModule()
...
class ConfirmAppInstanceResponseBodyModule(DaraModel):
    def __init__(
        self,
        biz_id: str = None,

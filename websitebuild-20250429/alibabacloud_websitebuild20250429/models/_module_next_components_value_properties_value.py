...
class ModuleNextComponentsValuePropertiesValue(DaraModel):
    def __init__(
        self,
        code: str = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Values') is not None:
            for k1 in m.get('Values'):
                temp_model = main_models.ModuleNextComponentsValuePropertiesValueValues()
                self.values.append(temp_model.from_map(k1))

        return self

class ModuleNextComponentsValuePropertiesValueValues(DaraModel):
    def __init__(
        self,
        code: str = None,
        value: str = None,

...
class GetAppRequirementResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.GetAppRequirementResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.GetAppRequirementResponseBodyModule()
...
class GetAppRequirementResponseBodyModule(DaraModel):
    def __init__(
        self,
        prd: str = None,
    ):

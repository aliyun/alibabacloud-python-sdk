...
class GetAppSupabaseInstanceResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.GetAppSupabaseInstanceResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.GetAppSupabaseInstanceResponseBodyModule()
...
class GetAppSupabaseInstanceResponseBodyModule(DaraModel):
    def __init__(
        self,
        anon_key: str = None,
        biz_id: str = None,

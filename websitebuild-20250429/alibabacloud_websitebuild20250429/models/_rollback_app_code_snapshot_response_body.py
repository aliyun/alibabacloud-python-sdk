...
class RollbackAppCodeSnapshotResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.RollbackAppCodeSnapshotResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.RollbackAppCodeSnapshotResponseBodyModule()
...
class RollbackAppCodeSnapshotResponseBodyModule(DaraModel):
    def __init__(
        self,
        change_log: str = None,
        gmt_create: str = None,

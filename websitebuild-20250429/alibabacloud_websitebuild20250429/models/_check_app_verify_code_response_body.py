...
class CheckAppVerifyCodeResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.CheckAppVerifyCodeResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.CheckAppVerifyCodeResponseBodyModule()
...
class CheckAppVerifyCodeResponseBodyModule(DaraModel):
    def __init__(
        self,
        masked_target: str = None,
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        if self.masked_target is not None:
            result['MaskedTarget'] = self.masked_target
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('MaskedTarget') is not None:
            self.masked_target = m.get('MaskedTarget')

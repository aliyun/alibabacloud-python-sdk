...
class GetAppConversationResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.GetAppConversationResponseBodyModule = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.GetAppConversationResponseBodyModule()
...
class GetAppConversationResponseBodyModule(DaraModel):
    def __init__(
        self,
        aliyun_pk: str = None,
        bot_id: str = None,

...
class ListAppConversationsResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.ListAppConversationsResponseBodyModule = None,
        next_token: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.ListAppConversationsResponseBodyModule()
...
class ListAppConversationsResponseBodyModule(DaraModel):
    def __init__(
        self,
        data: List[main_models.ListAppConversationsResponseBodyModuleData] = None,
        page_num: int = None,
        page_size: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListAppConversationsResponseBodyModuleData()
...
class ListAppConversationsResponseBodyModuleData(DaraModel):
    def __init__(
        self,
        aliyun_pk: str = None,
        bot_id: str = None,

...
class ExecuteMigrationOperationRequestOperationParam(TeaModel):
    def __init__(
        self,
        param_data: Any = None,
    ):
...
class ExecuteMigrationOperationRequest(TeaModel):
    def __init__(
        self,
        operation_param: ExecuteMigrationOperationRequestOperationParam = None,
        instance_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('operationParam') is not None:
            temp_model = ExecuteMigrationOperationRequestOperationParam()
            self.operation_param = temp_model.from_map(m['operationParam'])
        if m.get('instanceId') is not None:
            self.instance_id = m.get('instanceId')
        return self


class ExecuteMigrationOperationResponseBodyDataOperationParam(TeaModel):
    def __init__(
        self,
        param_data: Any = None,
    ):
...
class ExecuteMigrationOperationResponseBodyDataOperationResult(TeaModel):
    def __init__(
        self,
...
class ExecuteMigrationOperationResponseBodyData(TeaModel):
    def __init__(
        self,
        ...
        operation_param: ExecuteMigrationOperationResponseBodyDataOperationParam = None,
        operation_result: ExecuteMigrationOperationResponseBodyDataOperationResult = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('operationParam') is not None:
            temp_model = ExecuteMigrationOperationResponseBodyDataOperationParam()
            self.operation_param = temp_model.from_map(m['operationParam'])
        if m.get('operationResult') is not None:
            temp_model = ExecuteMigrationOperationResponseBodyDataOperationResult()
            self.operation_result = temp_model.from_map(m['operationResult'])
...
class ExecuteMigrationOperationResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        data: ExecuteMigrationOperationResponseBodyData = None,
        dynamic_code: str = None,
        dynamic_message: str = None,
        http_status_code: int = None,
        message: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('code') is not None:
            self.code = m.get('code')
        if m.get('data') is not None:
            temp_model = ExecuteMigrationOperationResponseBodyData()
...
class ExecuteMigrationOperationResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ExecuteMigrationOperationResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = ExecuteMigrationOperationResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class FinishMigrationStageRequest(TeaModel):
    def __init__(
        self,
        instance_id: str = None,
    ):
...
class FinishMigrationStageResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        data: bool = None,
...
class FinishMigrationStageResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: FinishMigrationStageResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = FinishMigrationStageResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class ListMigrationOperationsRequest(TeaModel):
    def __init__(
        self,
        filter: str = None,
        instance_id: str = None,
...
class ListMigrationOperationsResponseBodyDataListOperationParam(TeaModel):
    def __init__(
        self,
        param_data: Any = None,
    ):
...
class ListMigrationOperationsResponseBodyDataListOperationResult(TeaModel):
    def __init__(
        self,
        result_data: Any = None,
    ):
...
class ListMigrationOperationsResponseBodyDataList(TeaModel):
    def __init__(
        self,
        business_status: str = None,
        create_time: str = None,
        ...
        operation_id: int = None,
        operation_key: str = None,
        operation_param: ListMigrationOperationsResponseBodyDataListOperationParam = None,
        operation_result: ListMigrationOperationsResponseBodyDataListOperationResult = None,
        operation_status: str = None,
        operation_type: str = None,
        stage_type: str = None,
        update_time: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('operationKey') is not None:
            self.operation_key = m.get('operationKey')
        if m.get('operationParam') is not None:
            temp_model = ListMigrationOperationsResponseBodyDataListOperationParam()
            self.operation_param = temp_model.from_map(m['operationParam'])
        if m.get('operationResult') is not None:
            temp_model = ListMigrationOperationsResponseBodyDataListOperationResult()
            self.operation_result = temp_model.from_map(m['operationResult'])
        if m.get('operationStatus') is not None:
            self.operation_status = m.get('operationStatus')
        if m.get('operationType') is not None:
...
class ListMigrationOperationsResponseBodyData(TeaModel):
    def __init__(
        self,
        list: List[ListMigrationOperationsResponseBodyDataList] = None,
        page_number: int = None,
        page_size: int = None,
        total_count: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('list') is not None:
            for k in m.get('list'):
                temp_model = ListMigrationOperationsResponseBodyDataList()
                self.list.append(temp_model.from_map(k))
        if m.get('pageNumber') is not None:
            self.page_number = m.get('pageNumber')
        if m.get('pageSize') is not None:
...
class ListMigrationOperationsResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        data: ListMigrationOperationsResponseBodyData = None,
        dynamic_code: str = None,
        dynamic_message: str = None,
        http_status_code: int = None,
        message: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('code') is not None:
            self.code = m.get('code')
        if m.get('data') is not None:
            temp_model = ListMigrationOperationsResponseBodyData()
            self.data = temp_model.from_map(m['data'])
        if m.get('dynamicCode') is not None:
            self.dynamic_code = m.get('dynamicCode')
        if m.get('dynamicMessage') is not None:
...
class ListMigrationOperationsResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ListMigrationOperationsResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body

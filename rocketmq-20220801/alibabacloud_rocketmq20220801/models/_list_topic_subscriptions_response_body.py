...
class ListTopicSubscriptionsResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: List[main_models.ListTopicSubscriptionsResponseBodyData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            for k1 in m.get('data'):
                temp_model = main_models.ListTopicSubscriptionsResponseBodyData()
...
class ListTopicSubscriptionsResponseBodyData(DaraModel):
    def __init__(
        self,

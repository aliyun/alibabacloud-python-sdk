...
class ListTopicsResponseBodyData(DaraModel):
    def __init__(
        self,
        list: List[main_models.ListTopicsResponseBodyDataList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('list') is not None:
            for k1 in m.get('list'):
                temp_model = main_models.ListTopicsResponseBodyDataList()
...
class ListTopicsResponseBodyDataList(DaraModel):
    def __init__(
        self,

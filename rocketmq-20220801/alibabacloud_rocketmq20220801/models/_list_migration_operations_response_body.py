...
class ListMigrationOperationsResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ListMigrationOperationsResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.ListMigrationOperationsResponseBodyData()
...
class ListMigrationOperationsResponseBodyData(DaraModel):
    def __init__(
        self,
        list: List[main_models.ListMigrationOperationsResponseBodyDataList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('list') is not None:
            for k1 in m.get('list'):
                temp_model = main_models.ListMigrationOperationsResponseBodyDataList()
...
class ListMigrationOperationsResponseBodyDataList(DaraModel):
    def __init__(
        self,
        ...
        operation_param: main_models.ListMigrationOperationsResponseBodyDataListOperationParam = None,
        operation_result: main_models.ListMigrationOperationsResponseBodyDataListOperationResult = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('operationParam') is not None:
            temp_model = main_models.ListMigrationOperationsResponseBodyDataListOperationParam()
            self.operation_param = temp_model.from_map(m.get('operationParam'))

        if m.get('operationResult') is not None:
            temp_model = main_models.ListMigrationOperationsResponseBodyDataListOperationResult()
...
class ListMigrationOperationsResponseBodyDataListOperationResult(DaraModel):
    def __init__(
        self,
...
class ListMigrationOperationsResponseBodyDataListOperationParam(DaraModel):
    def __init__(
        self,
        param_data: Any = None,
    ):

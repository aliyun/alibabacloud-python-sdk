...
class ListConsumerGroupsResponseBodyData(DaraModel):
    def __init__(
        self,
        list: List[main_models.ListConsumerGroupsResponseBodyDataList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('list') is not None:
            for k1 in m.get('list'):
                temp_model = main_models.ListConsumerGroupsResponseBodyDataList()
...
class ListConsumerGroupsResponseBodyDataList(DaraModel):
    def __init__(
        self,

...
class CreateDisasterRecoveryPlanRequest(DaraModel):
    def __init__(
        self,
        auto_sync_checkpoint: bool = None,
        instances: List[main_models.CreateDisasterRecoveryPlanRequestInstances] = None,
        plan_desc: str = None,
        plan_name: str = None,
        plan_type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('instances') is not None:
            for k1 in m.get('instances'):
                temp_model = main_models.CreateDisasterRecoveryPlanRequestInstances()
...
class CreateDisasterRecoveryPlanRequestInstances(DaraModel):
    def __init__(
        self,
        auth_type: str = None,
        ...
        message_property: main_models.CreateDisasterRecoveryPlanRequestInstancesMessageProperty = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('messageProperty') is not None:
            temp_model = main_models.CreateDisasterRecoveryPlanRequestInstancesMessageProperty()
...
class CreateDisasterRecoveryPlanRequestInstancesMessageProperty(DaraModel):
    def __init__(
        self,

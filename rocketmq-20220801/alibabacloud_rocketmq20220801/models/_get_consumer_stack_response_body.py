...
class GetConsumerStackResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetConsumerStackResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.GetConsumerStackResponseBodyData()
...
class GetConsumerStackResponseBodyData(DaraModel):
    def __init__(
        self,
        consumer_group_id: str = None,
        instance_id: str = None,
        region_id: str = None,
        stacks: List[main_models.GetConsumerStackResponseBodyDataStacks] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('stacks') is not None:
            for k1 in m.get('stacks'):
                temp_model = main_models.GetConsumerStackResponseBodyDataStacks()
                self.stacks.append(temp_model.from_map(k1))

        return self

class GetConsumerStackResponseBodyDataStacks(DaraModel):
    def __init__(
        self,
        thread: str = None,

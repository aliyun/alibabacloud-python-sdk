...
class ListPlayHistoryResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        message: str = None,
        result: List[main_models.ListPlayHistoryResponseBodyResult] = None,
        request_id: str = None,
    ):
        # Code encoding
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k1 in m.get('Result'):
                temp_model = main_models.ListPlayHistoryResponseBodyResult()
...
class ListPlayHistoryResponseBodyResult(DaraModel):
    def __init__(
        self,
        alias: List[str] = None,
        audition: bool = None,
        authors: List[main_models.ListPlayHistoryResponseBodyResultAuthors] = None,
        category: str = None,
        charge: bool = None,
        comm_cate_id: int = None,
        cover: main_models.ListPlayHistoryResponseBodyResultCover = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Authors') is not None:
            for k1 in m.get('Authors'):
                temp_model = main_models.ListPlayHistoryResponseBodyResultAuthors()
        ...
        if m.get('Cover') is not None:
            temp_model = main_models.ListPlayHistoryResponseBodyResultCover()
...
class ListPlayHistoryResponseBodyResultCover(DaraModel):
    def __init__(
        self,
...
class ListPlayHistoryResponseBodyResultAuthors(DaraModel):
    def __init__(
        self,
        author_types: List[str] = None,
        cover: main_models.ListPlayHistoryResponseBodyResultAuthorsCover = None,
        description: str = None,
        gender: str = None,
        id: int = None,
        online: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Cover') is not None:
            temp_model = main_models.ListPlayHistoryResponseBodyResultAuthorsCover()
            self.cover = temp_model.from_map(m.get('Cover'))
...
class ListPlayHistoryResponseBodyResultAuthorsCover(DaraModel):
    def __init__(
        self,
        can_resize: bool = None,
        img: str = None,

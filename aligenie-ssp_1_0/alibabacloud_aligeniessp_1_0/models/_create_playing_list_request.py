...
class CreatePlayingListRequest(DaraModel):
    def __init__(
        self,
        device_info: main_models.CreatePlayingListRequestDeviceInfo = None,
        open_create_playing_list_request: main_models.CreatePlayingListRequestOpenCreatePlayingListRequest = None,
        user_info: main_models.CreatePlayingListRequestUserInfo = None,
    ):
...
class CreatePlayingListRequestOpenCreatePlayingListRequest(DaraModel):
    def __init__(
        self,
        content_list: List[main_models.CreatePlayingListRequestOpenCreatePlayingListRequestContentList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ContentList') is not None:
            for k1 in m.get('ContentList'):
                temp_model = main_models.CreatePlayingListRequestOpenCreatePlayingListRequestContentList()
...
class CreatePlayingListRequestOpenCreatePlayingListRequestContentList(DaraModel):
    def __init__(
        self,
        raw_id: str = None,
        source: str = None,
...
class CreatePlayingListRequestDeviceInfo(DaraModel):
    def __init__(
        self,
        encode_key: str = None,
        encode_type: str = None,

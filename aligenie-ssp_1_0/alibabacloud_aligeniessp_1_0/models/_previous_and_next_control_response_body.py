...
class PreviousAndNextControlResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        message: str = None,
        request_id: str = None,
        result: main_models.PreviousAndNextControlResponseBodyResult = None,
        success: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.PreviousAndNextControlResponseBodyResult()
...
class PreviousAndNextControlResponseBodyResult(DaraModel):
    def __init__(
        self,
        album_name: str = None,
        ...
        copyright: int = None,
        cover: main_models.PreviousAndNextControlResponseBodyResultCover = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Cover') is not None:
            temp_model = main_models.PreviousAndNextControlResponseBodyResultCover()
...
class PreviousAndNextControlResponseBodyResultCover(DaraModel):
    def __init__(
        self,

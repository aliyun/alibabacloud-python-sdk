...
class GetDeviceStatusDetailRequest(DaraModel):
    def __init__(
        self,
        device_info: main_models.GetDeviceStatusDetailRequestDeviceInfo = None,
        keys: List[str] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DeviceInfo') is not None:
            temp_model = main_models.GetDeviceStatusDetailRequestDeviceInfo()
...
class GetDeviceStatusDetailRequestDeviceInfo(DaraModel):
    def __init__(
        self,
        encode_key: str = None,

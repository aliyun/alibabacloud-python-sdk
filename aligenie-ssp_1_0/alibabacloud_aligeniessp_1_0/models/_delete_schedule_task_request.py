...
class DeleteScheduleTaskRequest(DaraModel):
    def __init__(
        self,
        device_info: main_models.DeleteScheduleTaskRequestDeviceInfo = None,
        payload: main_models.DeleteScheduleTaskRequestPayload = None,
        user_info: main_models.DeleteScheduleTaskRequestUserInfo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DeviceInfo') is not None:
            temp_model = main_models.DeleteScheduleTaskRequestDeviceInfo()
            self.device_info = temp_model.from_map(m.get('DeviceInfo'))

        if m.get('Payload') is not None:
            temp_model = main_models.DeleteScheduleTaskRequestPayload()
            self.payload = temp_model.from_map(m.get('Payload'))

        if m.get('UserInfo') is not None:
            temp_model = main_models.DeleteScheduleTaskRequestUserInfo()
            self.user_info = temp_model.from_map(m.get('UserInfo'))

        return self

class DeleteScheduleTaskRequestUserInfo(DaraModel):
    def __init__(
        self,
        encode_key: str = None,
...
class DeleteScheduleTaskRequestPayload(DaraModel):
    def __init__(
        self,
        id: int = None,
    ):
...
class DeleteScheduleTaskRequestDeviceInfo(DaraModel):
    def __init__(
        self,
        encode_key: str = None,
        encode_type: str = None,

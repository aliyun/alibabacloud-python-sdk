...
class GetAlarmRequest(DaraModel):
    def __init__(
        self,
        device_info: main_models.GetAlarmRequestDeviceInfo = None,
        payload: main_models.GetAlarmRequestPayload = None,
        user_info: main_models.GetAlarmRequestUserInfo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DeviceInfo') is not None:
            temp_model = main_models.GetAlarmRequestDeviceInfo()
            self.device_info = temp_model.from_map(m.get('DeviceInfo'))

        if m.get('Payload') is not None:
            temp_model = main_models.GetAlarmRequestPayload()
            self.payload = temp_model.from_map(m.get('Payload'))

        if m.get('UserInfo') is not None:
            temp_model = main_models.GetAlarmRequestUserInfo()
            self.user_info = temp_model.from_map(m.get('UserInfo'))

        return self

class GetAlarmRequestUserInfo(DaraModel):
    def __init__(
        self,
        encode_key: str = None,
...
class GetAlarmRequestPayload(DaraModel):
    def __init__(
        self,
        alarm_id: int = None,
    ):
...
class GetAlarmRequestDeviceInfo(DaraModel):
    def __init__(
        self,
        encode_key: str = None,
        encode_type: str = None,

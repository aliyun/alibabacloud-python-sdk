...
class ListDeviceByUserIdResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        message: str = None,
        request_id: str = None,
        result: List[main_models.ListDeviceByUserIdResponseBodyResult] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k1 in m.get('Result'):
                temp_model = main_models.ListDeviceByUserIdResponseBodyResult()
                self.result.append(temp_model.from_map(k1))

        return self

class ListDeviceByUserIdResponseBodyResult(DaraModel):
    def __init__(
        self,
        device_open_id: str = None,
        device_union_ids: List[main_models.ListDeviceByUserIdResponseBodyResultDeviceUnionIds] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DeviceUnionIds') is not None:
            for k1 in m.get('DeviceUnionIds'):
                temp_model = main_models.ListDeviceByUserIdResponseBodyResultDeviceUnionIds()
                self.device_union_ids.append(temp_model.from_map(k1))

        return self

class ListDeviceByUserIdResponseBodyResultDeviceUnionIds(DaraModel):
    def __init__(
        self,

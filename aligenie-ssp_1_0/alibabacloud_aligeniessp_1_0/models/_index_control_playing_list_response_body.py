...
class IndexControlPlayingListResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        message: str = None,
        request_id: str = None,
        result: main_models.IndexControlPlayingListResponseBodyResult = None,
        success: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.IndexControlPlayingListResponseBodyResult()
...
class IndexControlPlayingListResponseBodyResult(DaraModel):
    def __init__(
        self,
        album_name: str = None,
        ...
        copyright: int = None,
        cover: main_models.IndexControlPlayingListResponseBodyResultCover = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Cover') is not None:
            temp_model = main_models.IndexControlPlayingListResponseBodyResultCover()
...
class IndexControlPlayingListResponseBodyResultCover(DaraModel):
    def __init__(
        self,

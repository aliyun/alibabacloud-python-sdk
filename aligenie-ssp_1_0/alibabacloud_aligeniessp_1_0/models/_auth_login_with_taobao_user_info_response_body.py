...
class AuthLoginWithTaobaoUserInfoResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        message: str = None,
        request_id: str = None,
        result: main_models.AuthLoginWithTaobaoUserInfoResponseBodyResult = None,
        success: bool = None,
    ):
        # Response code
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.AuthLoginWithTaobaoUserInfoResponseBodyResult()
...
class AuthLoginWithTaobaoUserInfoResponseBodyResult(DaraModel):
    def __init__(
        self,

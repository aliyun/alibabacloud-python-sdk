...
class ListRecommendContentResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        message: str = None,
        request_id: str = None,
        result: List[main_models.ListRecommendContentResponseBodyResult] = None,
    ):
        # Code encoding
        self.code = code
        # Message information
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k1 in m.get('Result'):
                temp_model = main_models.ListRecommendContentResponseBodyResult()
                self.result.append(temp_model.from_map(k1))

        return self

class ListRecommendContentResponseBodyResult(DaraModel):
    def __init__(
        self,
        alias: List[str] = None,
        audition: bool = None,
        authors: List[main_models.ListRecommendContentResponseBodyResultAuthors] = None,
        category: str = None,
        charge: bool = None,
        comm_cate_id: int = None,
        cover: main_models.ListRecommendContentResponseBodyResultCover = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Authors') is not None:
            for k1 in m.get('Authors'):
                temp_model = main_models.ListRecommendContentResponseBodyResultAuthors()
        ...
        if m.get('Cover') is not None:
            temp_model = main_models.ListRecommendContentResponseBodyResultCover()
...
class ListRecommendContentResponseBodyResultCover(DaraModel):
    def __init__(
        self,
...
class ListRecommendContentResponseBodyResultAuthors(DaraModel):
    def __init__(
        self,
        author_types: List[str] = None,
        cover: main_models.ListRecommendContentResponseBodyResultAuthorsCover = None,
        description: str = None,
        gender: str = None,
        id: int = None,
        online: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Cover') is not None:
            temp_model = main_models.ListRecommendContentResponseBodyResultAuthorsCover()
            self.cover = temp_model.from_map(m.get('Cover'))
...
class ListRecommendContentResponseBodyResultAuthorsCover(DaraModel):
    def __init__(
        self,
        can_resize: bool = None,
        img: str = None,

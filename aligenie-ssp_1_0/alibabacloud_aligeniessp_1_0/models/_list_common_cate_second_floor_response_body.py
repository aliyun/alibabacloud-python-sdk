...
class ListCommonCateSecondFloorResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        message: str = None,
        request_id: str = None,
        result: List[main_models.ListCommonCateSecondFloorResponseBodyResult] = None,
    ):
        # Code encoding
        self.code = code
        # Message information
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k1 in m.get('Result'):
                temp_model = main_models.ListCommonCateSecondFloorResponseBodyResult()
                self.result.append(temp_model.from_map(k1))

        return self

class ListCommonCateSecondFloorResponseBodyResult(DaraModel):
    def __init__(
        self,
        cate_id: int = None,
        cate_name: str = None,

...
class GetCurrentPlayingItemResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        message: str = None,
        request_id: str = None,
        result: main_models.GetCurrentPlayingItemResponseBodyResult = None,
        success: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.GetCurrentPlayingItemResponseBodyResult()
...
class GetCurrentPlayingItemResponseBodyResult(DaraModel):
    def __init__(
        self,
        album_name: str = None,
        ...
        copyright: int = None,
        cover: main_models.GetCurrentPlayingItemResponseBodyResultCover = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Cover') is not None:
            temp_model = main_models.GetCurrentPlayingItemResponseBodyResultCover()
...
class GetCurrentPlayingItemResponseBodyResultCover(DaraModel):
    def __init__(
        self,

...
class CreatePlayingListOAuth2ResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        message: str = None,
        request_id: str = None,
        result: main_models.CreatePlayingListOAuth2ResponseBodyResult = None,
        success: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.CreatePlayingListOAuth2ResponseBodyResult()
...
class CreatePlayingListOAuth2ResponseBodyResult(DaraModel):
    def __init__(
        self,
        album_name: str = None,
        ...
        copyright: int = None,
        cover: main_models.CreatePlayingListOAuth2ResponseBodyResultCover = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Cover') is not None:
            temp_model = main_models.CreatePlayingListOAuth2ResponseBodyResultCover()
...
class CreatePlayingListOAuth2ResponseBodyResultCover(DaraModel):
    def __init__(
        self,

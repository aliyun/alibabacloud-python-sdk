...
class GetUnreadMessageCountRequest(DaraModel):
    def __init__(
        self,
        user_info: main_models.GetUnreadMessageCountRequestUserInfo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserInfo') is not None:
            temp_model = main_models.GetUnreadMessageCountRequestUserInfo()
            self.user_info = temp_model.from_map(m.get('UserInfo'))

        return self

class GetUnreadMessageCountRequestUserInfo(DaraModel):
    def __init__(
        self,
        encode_key: str = None,

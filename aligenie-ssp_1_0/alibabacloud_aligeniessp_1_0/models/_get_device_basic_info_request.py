...
class GetDeviceBasicInfoRequest(DaraModel):
    def __init__(
        self,
        device_info: main_models.GetDeviceBasicInfoRequestDeviceInfo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DeviceInfo') is not None:
            temp_model = main_models.GetDeviceBasicInfoRequestDeviceInfo()
            self.device_info = temp_model.from_map(m.get('DeviceInfo'))

        return self

class GetDeviceBasicInfoRequestDeviceInfo(DaraModel):
    def __init__(
        self,
        encode_key: str = None,

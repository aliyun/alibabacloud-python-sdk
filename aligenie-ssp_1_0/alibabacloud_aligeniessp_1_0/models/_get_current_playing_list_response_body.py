...
class GetCurrentPlayingListResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        message: str = None,
        request_id: str = None,
        result: List[main_models.GetCurrentPlayingListResponseBodyResult] = None,
        success: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k1 in m.get('Result'):
                temp_model = main_models.GetCurrentPlayingListResponseBodyResult()
...
class GetCurrentPlayingListResponseBodyResult(DaraModel):
    def __init__(
        self,
        album_name: str = None,
        ...
        copyright: int = None,
        cover: main_models.GetCurrentPlayingListResponseBodyResultCover = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Cover') is not None:
            temp_model = main_models.GetCurrentPlayingListResponseBodyResultCover()
...
class GetCurrentPlayingListResponseBodyResultCover(DaraModel):
    def __init__(
        self,

...
class UpgradeAgentWithTypeRequest(DaraModel):
    def __init__(
        self,
        x_debug_id: str = None,
        agent_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('instances') is not None:
            for k1 in m.get('instances'):
                temp_model = main_models.UpgradeAgentWithTypeRequestInstances()
...
class UpgradeAgentWithTypeRequestInstances(DaraModel):
    def __init__(
        self,
        instance: str = None,
        region: str = None,

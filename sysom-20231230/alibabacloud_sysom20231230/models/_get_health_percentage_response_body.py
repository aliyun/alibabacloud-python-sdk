...
class GetHealthPercentageResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            for k1 in m.get('data'):
                temp_model = main_models.GetHealthPercentageResponseBodyData()
...
class GetHealthPercentageResponseBodyData(DaraModel):
    def __init__(
        self,
        type: str = None,
        value: int = None,

...
class ListInstancesWithEcsInfoRequest(DaraModel):
    def __init__(
        ...
        instance_tag: main_models.ListInstancesWithEcsInfoRequestInstanceTag = None,
        is_managed: int = None,
        os_name: str = None,
        page_size: int = None,
        private_ip: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('instance_tag') is not None:
            temp_model = main_models.ListInstancesWithEcsInfoRequestInstanceTag()
            self.instance_tag = temp_model.from_map(m.get('instance_tag'))
...
class ListInstancesWithEcsInfoRequestInstanceTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

...
```bash
# 安装 alibabacloud_dataworks_public20180601
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/dataworks-public-20180601/ChangeLog.md)中。

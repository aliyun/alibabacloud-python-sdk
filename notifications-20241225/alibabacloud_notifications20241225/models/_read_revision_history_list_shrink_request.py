...
class ReadRevisionHistoryListShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        self.page_info_shrink = page_info_shrink
    ...
    def to_map(self):
        ...
        if self.page_info_shrink is not None:
            result['PageInfo'] = self.page_info_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PageInfo') is not None:
            self.page_info_shrink = m.get('PageInfo')

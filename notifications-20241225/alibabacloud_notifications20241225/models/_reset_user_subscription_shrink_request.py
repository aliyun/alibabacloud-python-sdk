...
class ResetUserSubscriptionShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        category_codes_shrink: str = None,
        ...
        self.category_codes_shrink = category_codes_shrink
    ...
    def to_map(self):
        ...
        if self.category_codes_shrink is not None:
            result['CategoryCodes'] = self.category_codes_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CategoryCodes') is not None:
            self.category_codes_shrink = m.get('CategoryCodes')

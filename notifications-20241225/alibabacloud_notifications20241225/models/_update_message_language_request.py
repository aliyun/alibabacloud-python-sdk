...
class UpdateMessageLanguageRequest(DaraModel):
    def __init__(
        self,
    ...
    def to_map(self):
        ...
        if self.prefer_lang is not None:
            result['PreferLang'] = self.prefer_lang
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PreferLang') is not None:
            self.prefer_lang = m.get('PreferLang')

...
class ReadWebhookContactResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ReadWebhookContactResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ReadWebhookContactResponseBodyData()
...
class ReadWebhookContactResponseBodyData(DaraModel):
    def __init__(
        self,

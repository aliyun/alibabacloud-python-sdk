...
```bash
# 安装 alibabacloud_notifications20241225
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/notifications-20241225/ChangeLog.md)中。

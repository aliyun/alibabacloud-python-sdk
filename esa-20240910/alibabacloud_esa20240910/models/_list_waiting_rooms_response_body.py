...
class ListWaitingRoomsResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def to_map(self):
        ...
        if self.waiting_rooms is not None:
            for k1 in self.waiting_rooms:
                result['WaitingRooms'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('WaitingRooms') is not None:
            for k1 in m.get('WaitingRooms'):
                temp_model = main_models.ListWaitingRoomsResponseBodyWaitingRooms()
                self.waiting_rooms.append(temp_model.from_map(k1))

        return self

class ListWaitingRoomsResponseBodyWaitingRooms(DaraModel):
    def __init__(
        self,
        ...
        enable: str = None,
        host_name_and_path: List[main_models.ListWaitingRoomsResponseBodyWaitingRoomsHostNameAndPath] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HostNameAndPath') is not None:
            for k1 in m.get('HostNameAndPath'):
                temp_model = main_models.ListWaitingRoomsResponseBodyWaitingRoomsHostNameAndPath()
...
class ListWaitingRoomsResponseBodyWaitingRoomsHostNameAndPath(DaraModel):
    def __init__(
        self,
        domain: str = None,
        path: str = None,

...
class UpdateWaitingRoomRequest(DaraModel):
    def __init__(
        self,
        ...
        enable: str = None,
        host_name_and_path: List[main_models.UpdateWaitingRoomRequestHostNameAndPath] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HostNameAndPath') is not None:
            for k1 in m.get('HostNameAndPath'):
                temp_model = main_models.UpdateWaitingRoomRequestHostNameAndPath()
...
class UpdateWaitingRoomRequestHostNameAndPath(DaraModel):
    def __init__(
        self,
        domain: str = None,
        path: str = None,

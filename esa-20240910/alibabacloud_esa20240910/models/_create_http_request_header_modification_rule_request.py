...
class CreateHttpRequestHeaderModificationRuleRequest(DaraModel):
    def __init__(
        self,
        request_header_modification: List[main_models.CreateHttpRequestHeaderModificationRuleRequestRequestHeaderModification] = None,
        rule: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RequestHeaderModification') is not None:
            for k1 in m.get('RequestHeaderModification'):
                temp_model = main_models.CreateHttpRequestHeaderModificationRuleRequestRequestHeaderModification()
...
class CreateHttpRequestHeaderModificationRuleRequestRequestHeaderModification(DaraModel):
    def __init__(
        self,
        name: str = None,
        operation: str = None,

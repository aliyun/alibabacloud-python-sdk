...
class DescribeCacheReservePriceGapResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PriceModel') is not None:
            temp_model = main_models.DescribeCacheReservePriceGapResponseBodyPriceModel()
...
class DescribeCacheReservePriceGapResponseBodyPriceModel(DaraModel):
    def __init__(
        self,
        currency: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Rule') is not None:
            temp_model = main_models.DescribeCacheReservePriceGapResponseBodyPriceModelRule()
...
class DescribeCacheReservePriceGapResponseBodyPriceModelRule(DaraModel):
    def __init__(
        self,
        rule_list: List[main_models.DescribeCacheReservePriceGapResponseBodyPriceModelRuleRuleList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RuleList') is not None:
            for k1 in m.get('RuleList'):
                temp_model = main_models.DescribeCacheReservePriceGapResponseBodyPriceModelRuleRuleList()
                self.rule_list.append(temp_model.from_map(k1))

        return self

class DescribeCacheReservePriceGapResponseBodyPriceModelRuleRuleList(DaraModel):
    def __init__(
        self,
        name: str = None,

...
class ListHttpResponseHeaderModificationRulesResponseBody(DaraModel):
    def __init__(
        self,
        configs: List[main_models.ListHttpResponseHeaderModificationRulesResponseBodyConfigs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Configs') is not None:
            for k1 in m.get('Configs'):
                temp_model = main_models.ListHttpResponseHeaderModificationRulesResponseBodyConfigs()
...
class ListHttpResponseHeaderModificationRulesResponseBodyConfigs(DaraModel):
    def __init__(
        self,
        config_id: int = None,
        config_type: str = None,
        response_header_modification: List[main_models.ListHttpResponseHeaderModificationRulesResponseBodyConfigsResponseHeaderModification] = None,
        rule: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResponseHeaderModification') is not None:
            for k1 in m.get('ResponseHeaderModification'):
                temp_model = main_models.ListHttpResponseHeaderModificationRulesResponseBodyConfigsResponseHeaderModification()
...
class ListHttpResponseHeaderModificationRulesResponseBodyConfigsResponseHeaderModification(DaraModel):
    def __init__(
        self,
        name: str = None,
        operation: str = None,

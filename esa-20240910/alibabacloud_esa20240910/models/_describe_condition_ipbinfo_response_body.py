...
class DescribeConditionIPBInfoResponseBody(DaraModel):
    def __init__(
        self,
        datas: List[main_models.DescribeConditionIPBInfoResponseBodyDatas] = None,
        request_id: str = None,
    ):
        # The data details.
        self.datas = datas
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Datas') is not None:
            for k1 in m.get('Datas'):
                temp_model = main_models.DescribeConditionIPBInfoResponseBodyDatas()
...
class DescribeConditionIPBInfoResponseBodyDatas(DaraModel):
    def __init__(
        self,
        value: str = None,
    ):

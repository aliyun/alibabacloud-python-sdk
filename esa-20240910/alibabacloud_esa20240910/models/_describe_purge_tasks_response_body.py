...
class DescribePurgeTasksResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tasks') is not None:
            for k1 in m.get('Tasks'):
                temp_model = main_models.DescribePurgeTasksResponseBodyTasks()
...
class DescribePurgeTasksResponseBodyTasks(DaraModel):
    def __init__(
        self,
        content: str = None,

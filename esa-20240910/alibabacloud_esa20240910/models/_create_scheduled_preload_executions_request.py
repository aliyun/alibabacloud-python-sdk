...
class CreateScheduledPreloadExecutionsRequest(DaraModel):
    def __init__(
        ...
        # The list of execution plans to be added for the scheduled prefetch task.
        # 
        # This parameter is required.
        self.executions = executions
        # The prefetch task ID, generated by calling the [CreateScheduledPreloadJob](https://help.aliyun.com/document_detail/2850459.html) operation.
        self.id = id

...
class ListLoadBalancersResponseBodyLoadBalancers(DaraModel):
    def __init__(
        self,
        adaptive_routing: main_models.ListLoadBalancersResponseBodyLoadBalancersAdaptiveRouting = None,
        default_pools: List[int] = None,
        description: str = None,
        enabled: bool = None,
        fallback_pool: int = None,
        id: int = None,
        monitor: main_models.ListLoadBalancersResponseBodyLoadBalancersMonitor = None,
        name: str = None,
        random_steering: main_models.ListLoadBalancersResponseBodyLoadBalancersRandomSteering = None,
        region_pools: Any = None,
        rules: List[main_models.ListLoadBalancersResponseBodyLoadBalancersRules] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AdaptiveRouting') is not None:
            temp_model = main_models.ListLoadBalancersResponseBodyLoadBalancersAdaptiveRouting()
        ...
        if m.get('Monitor') is not None:
            temp_model = main_models.ListLoadBalancersResponseBodyLoadBalancersMonitor()
        ...
        if m.get('RandomSteering') is not None:
            temp_model = main_models.ListLoadBalancersResponseBodyLoadBalancersRandomSteering()
        ...
        if m.get('Rules') is not None:
            for k1 in m.get('Rules'):
                temp_model = main_models.ListLoadBalancersResponseBodyLoadBalancersRules()
...
class ListLoadBalancersResponseBodyLoadBalancersRules(DaraModel):
    def __init__(
        self,
        fixed_response: main_models.ListLoadBalancersResponseBodyLoadBalancersRulesFixedResponse = None,
        overrides: Any = None,
        rule: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FixedResponse') is not None:
            temp_model = main_models.ListLoadBalancersResponseBodyLoadBalancersRulesFixedResponse()
...
class ListLoadBalancersResponseBodyLoadBalancersRulesFixedResponse(DaraModel):
    def __init__(
        self,
...
class ListLoadBalancersResponseBodyLoadBalancersRandomSteering(DaraModel):
    def __init__(
        self,
...
class ListLoadBalancersResponseBodyLoadBalancersMonitor(DaraModel):
    def __init__(
        self,
...
class ListLoadBalancersResponseBodyLoadBalancersAdaptiveRouting(DaraModel):
    def __init__(
        self,

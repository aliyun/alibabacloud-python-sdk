...
class DescribeSiteWafTopDataResponseBody(DaraModel):
    def __init__(
        self,
        data: List[main_models.DescribeSiteWafTopDataResponseBodyData] = None,
        end_time: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.DescribeSiteWafTopDataResponseBodyData()
...
class DescribeSiteWafTopDataResponseBodyData(DaraModel):
    def __init__(
        self,
        detail_data: List[main_models.DescribeSiteWafTopDataResponseBodyDataDetailData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DetailData') is not None:
            for k1 in m.get('DetailData'):
                temp_model = main_models.DescribeSiteWafTopDataResponseBodyDataDetailData()
...
class DescribeSiteWafTopDataResponseBodyDataDetailData(DaraModel):
    def __init__(
        self,

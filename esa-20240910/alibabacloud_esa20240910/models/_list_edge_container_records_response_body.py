...
class ListEdgeContainerRecordsResponseBody(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        records: List[main_models.ListEdgeContainerRecordsResponseBodyRecords] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Records') is not None:
            for k1 in m.get('Records'):
                temp_model = main_models.ListEdgeContainerRecordsResponseBodyRecords()
...
class ListEdgeContainerRecordsResponseBodyRecords(DaraModel):
    def __init__(
        self,

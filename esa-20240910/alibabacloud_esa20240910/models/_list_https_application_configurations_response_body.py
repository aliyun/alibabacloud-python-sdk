...
class ListHttpsApplicationConfigurationsResponseBody(DaraModel):
    def __init__(
        self,
        configs: List[main_models.ListHttpsApplicationConfigurationsResponseBodyConfigs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Configs') is not None:
            for k1 in m.get('Configs'):
                temp_model = main_models.ListHttpsApplicationConfigurationsResponseBodyConfigs()
...
class ListHttpsApplicationConfigurationsResponseBodyConfigs(DaraModel):
    def __init__(
        self,
        alt_svc: str = None,

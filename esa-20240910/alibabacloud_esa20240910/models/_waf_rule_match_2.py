...
class WafRuleMatch2(DaraModel):
    def __init__(
        self,
        convert_to_lower: bool = None,
        criteria: List[main_models.WafRuleMatch2Criteria] = None,
        logic: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Criteria') is not None:
            for k1 in m.get('Criteria'):
                temp_model = main_models.WafRuleMatch2Criteria()
...
class WafRuleMatch2Criteria(DaraModel):
    def __init__(
        self,
        convert_to_lower: bool = None,
        criteria: List[main_models.WafRuleMatch2CriteriaCriteria] = None,
        logic: str = None,
        match_operator: str = None,
        match_type: str = None,
        match_value: Any = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Criteria') is not None:
            for k1 in m.get('Criteria'):
                temp_model = main_models.WafRuleMatch2CriteriaCriteria()
                self.criteria.append(temp_model.from_map(k1))
...
class WafRuleMatch2CriteriaCriteria(DaraModel):
    def __init__(
        self,
        convert_to_lower: bool = None,
        criteria: List[main_models.WafRuleMatch2CriteriaCriteriaCriteria] = None,
        logic: str = None,
        match_operator: str = None,
        match_type: str = None,
        match_value: Any = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Criteria') is not None:
            for k1 in m.get('Criteria'):
                temp_model = main_models.WafRuleMatch2CriteriaCriteriaCriteria()
                self.criteria.append(temp_model.from_map(k1))
...
class WafRuleMatch2CriteriaCriteriaCriteria(DaraModel):
    def __init__(
        self,
        convert_to_lower: bool = None,
        match_operator: str = None,

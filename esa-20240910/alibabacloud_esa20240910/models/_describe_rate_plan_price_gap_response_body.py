...
class DescribeRatePlanPriceGapResponseBody(DaraModel):
    def __init__(
        self,
        price_model: main_models.DescribeRatePlanPriceGapResponseBodyPriceModel = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PriceModel') is not None:
            temp_model = main_models.DescribeRatePlanPriceGapResponseBodyPriceModel()
...
class DescribeRatePlanPriceGapResponseBodyPriceModel(DaraModel):
    def __init__(
        self,
        currency: str = None,
        ...
        price: float = None,
        rule: main_models.DescribeRatePlanPriceGapResponseBodyPriceModelRule = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Rule') is not None:
            temp_model = main_models.DescribeRatePlanPriceGapResponseBodyPriceModelRule()
...
class DescribeRatePlanPriceGapResponseBodyPriceModelRule(DaraModel):
    def __init__(
        self,
        rule_list: List[main_models.DescribeRatePlanPriceGapResponseBodyPriceModelRuleRuleList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RuleList') is not None:
            for k1 in m.get('RuleList'):
                temp_model = main_models.DescribeRatePlanPriceGapResponseBodyPriceModelRuleRuleList()
                self.rule_list.append(temp_model.from_map(k1))

        return self

class DescribeRatePlanPriceGapResponseBodyPriceModelRuleRuleList(DaraModel):
    def __init__(
        self,
        name: str = None,

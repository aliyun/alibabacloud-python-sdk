...
class DescribeDDoSPriceResponseBody(DaraModel):
    def __init__(
        self,
        price_model: main_models.DescribeDDoSPriceResponseBodyPriceModel = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PriceModel') is not None:
            temp_model = main_models.DescribeDDoSPriceResponseBodyPriceModel()
...
class DescribeDDoSPriceResponseBodyPriceModel(DaraModel):
    def __init__(
        self,
        currency: str = None,
        discount_price: float = None,
        price: float = None,
        rule: main_models.DescribeDDoSPriceResponseBodyPriceModelRule = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Rule') is not None:
            temp_model = main_models.DescribeDDoSPriceResponseBodyPriceModelRule()
...
class DescribeDDoSPriceResponseBodyPriceModelRule(DaraModel):
    def __init__(
        self,
        rule_list: List[main_models.DescribeDDoSPriceResponseBodyPriceModelRuleRuleList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RuleList') is not None:
            for k1 in m.get('RuleList'):
                temp_model = main_models.DescribeDDoSPriceResponseBodyPriceModelRuleRuleList()
                self.rule_list.append(temp_model.from_map(k1))

        return self

class DescribeDDoSPriceResponseBodyPriceModelRuleRuleList(DaraModel):
    def __init__(
        self,
        name: str = None,

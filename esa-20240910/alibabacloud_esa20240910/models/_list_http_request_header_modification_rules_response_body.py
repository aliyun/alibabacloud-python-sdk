...
class ListHttpRequestHeaderModificationRulesResponseBody(DaraModel):
    def __init__(
        self,
        configs: List[main_models.ListHttpRequestHeaderModificationRulesResponseBodyConfigs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Configs') is not None:
            for k1 in m.get('Configs'):
                temp_model = main_models.ListHttpRequestHeaderModificationRulesResponseBodyConfigs()
...
class ListHttpRequestHeaderModificationRulesResponseBodyConfigs(DaraModel):
    def __init__(
        self,
        config_id: int = None,
        config_type: str = None,
        request_header_modification: List[main_models.ListHttpRequestHeaderModificationRulesResponseBodyConfigsRequestHeaderModification] = None,
        rule: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RequestHeaderModification') is not None:
            for k1 in m.get('RequestHeaderModification'):
                temp_model = main_models.ListHttpRequestHeaderModificationRulesResponseBodyConfigsRequestHeaderModification()
...
class ListHttpRequestHeaderModificationRulesResponseBodyConfigsRequestHeaderModification(DaraModel):
    def __init__(
        self,
        name: str = None,
        operation: str = None,

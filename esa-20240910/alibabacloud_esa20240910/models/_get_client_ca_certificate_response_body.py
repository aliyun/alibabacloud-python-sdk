...
class GetClientCaCertificateResponseBody(DaraModel):
    def __init__(
        self,
        certificate: str = None,
        request_id: str = None,
        result: main_models.GetClientCaCertificateResponseBodyResult = None,
        site_id: int = None,
        site_name: str = None,
        status: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.GetClientCaCertificateResponseBodyResult()
...
class GetClientCaCertificateResponseBodyResult(DaraModel):
    def __init__(
        self,

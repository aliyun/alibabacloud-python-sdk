...
class CreateUserDeliveryTaskRequest(DaraModel):
    def __init__(
        self,
        ...
        field_name: str = None,
        filter_ver: str = None,
        http_delivery: main_models.CreateUserDeliveryTaskRequestHttpDelivery = None,
        kafka_delivery: main_models.CreateUserDeliveryTaskRequestKafkaDelivery = None,
        oss_delivery: main_models.CreateUserDeliveryTaskRequestOssDelivery = None,
        s_3delivery: main_models.CreateUserDeliveryTaskRequestS3Delivery = None,
        sls_delivery: main_models.CreateUserDeliveryTaskRequestSlsDelivery = None,
        task_name: str = None,
    ):
...
class CreateUserDeliveryTaskRequestSlsDelivery(DaraModel):
    def __init__(
        self,
...
class CreateUserDeliveryTaskRequestS3Delivery(DaraModel):
    def __init__(
        self,
        access_key: str = None,
...
class CreateUserDeliveryTaskRequestOssDelivery(DaraModel):
    def __init__(
        self,
        aliuid: str = None,
...
class CreateUserDeliveryTaskRequestKafkaDelivery(DaraModel):
    def __init__(
        self,
        balancer: str = None,
...
class CreateUserDeliveryTaskRequestHttpDelivery(DaraModel):
    def __init__(
        self,
        compress: str = None,
        dest_url: str = None,
        ...
        standard_auth_param: main_models.CreateUserDeliveryTaskRequestHttpDeliveryStandardAuthParam = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('StandardAuthParam') is not None:
            temp_model = main_models.CreateUserDeliveryTaskRequestHttpDeliveryStandardAuthParam()
...
class CreateUserDeliveryTaskRequestHttpDeliveryStandardAuthParam(DaraModel):
    def __init__(
        self,

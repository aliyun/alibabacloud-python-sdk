...
class ListHttpIncomingResponseHeaderModificationRulesResponseBody(DaraModel):
    def __init__(
        self,
        configs: List[main_models.ListHttpIncomingResponseHeaderModificationRulesResponseBodyConfigs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Configs') is not None:
            for k1 in m.get('Configs'):
                temp_model = main_models.ListHttpIncomingResponseHeaderModificationRulesResponseBodyConfigs()
...
class ListHttpIncomingResponseHeaderModificationRulesResponseBodyConfigs(DaraModel):
    def __init__(
        self,
        config_id: int = None,
        config_type: str = None,
        response_header_modification: List[main_models.ListHttpIncomingResponseHeaderModificationRulesResponseBodyConfigsResponseHeaderModification] = None,
        rule: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResponseHeaderModification') is not None:
            for k1 in m.get('ResponseHeaderModification'):
                temp_model = main_models.ListHttpIncomingResponseHeaderModificationRulesResponseBodyConfigsResponseHeaderModification()
...
class ListHttpIncomingResponseHeaderModificationRulesResponseBodyConfigsResponseHeaderModification(DaraModel):
    def __init__(
        self,
        name: str = None,
        operation: str = None,

...
class DescribeSiteWafTimeSeriesDataResponseBody(DaraModel):
    def __init__(
        self,
        data: List[main_models.DescribeSiteWafTimeSeriesDataResponseBodyData] = None,
        end_time: str = None,
        interval: int = None,
        request_id: str = None,
        sampling_rate: float = None,
        start_time: str = None,
        summarized_data: List[main_models.DescribeSiteWafTimeSeriesDataResponseBodySummarizedData] = None,
    ):
        # The returned data.
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.DescribeSiteWafTimeSeriesDataResponseBodyData()
        ...
        if m.get('SummarizedData') is not None:
            for k1 in m.get('SummarizedData'):
                temp_model = main_models.DescribeSiteWafTimeSeriesDataResponseBodySummarizedData()
                self.summarized_data.append(temp_model.from_map(k1))

        return self

class DescribeSiteWafTimeSeriesDataResponseBodySummarizedData(DaraModel):
    def __init__(
        self,
        agg_method: str = None,
...
class DescribeSiteWafTimeSeriesDataResponseBodyData(DaraModel):
    def __init__(
        self,
        detail_data: List[main_models.DescribeSiteWafTimeSeriesDataResponseBodyDataDetailData] = None,
        dimension_name: str = None,
        dimension_value: str = None,
        field_name: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DetailData') is not None:
            for k1 in m.get('DetailData'):
                temp_model = main_models.DescribeSiteWafTimeSeriesDataResponseBodyDataDetailData()
...
class DescribeSiteWafTimeSeriesDataResponseBodyDataDetailData(DaraModel):
    def __init__(
        self,
        time_stamp: str = None,
        value: Any = None,

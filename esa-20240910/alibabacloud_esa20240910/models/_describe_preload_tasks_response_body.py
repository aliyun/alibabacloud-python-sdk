...
class DescribePreloadTasksResponseBody(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        request_id: str = None,
        tasks: List[main_models.DescribePreloadTasksResponseBodyTasks] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tasks') is not None:
            for k1 in m.get('Tasks'):
                temp_model = main_models.DescribePreloadTasksResponseBodyTasks()
...
class DescribePreloadTasksResponseBodyTasks(DaraModel):
    def __init__(
        self,
        content: str = None,

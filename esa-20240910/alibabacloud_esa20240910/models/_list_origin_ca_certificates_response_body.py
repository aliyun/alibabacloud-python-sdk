...
class ListOriginCaCertificatesResponseBody(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        request_id: str = None,
        result: List[main_models.ListOriginCaCertificatesResponseBodyResult] = None,
        site_id: int = None,
        site_name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k1 in m.get('Result'):
                temp_model = main_models.ListOriginCaCertificatesResponseBodyResult()
...
class ListOriginCaCertificatesResponseBodyResult(DaraModel):
    def __init__(
        self,

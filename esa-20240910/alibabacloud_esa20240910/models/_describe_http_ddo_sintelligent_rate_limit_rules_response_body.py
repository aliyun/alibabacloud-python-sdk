...
class DescribeHttpDDoSIntelligentRateLimitRulesResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RuleInfos') is not None:
            for k1 in m.get('RuleInfos'):
                temp_model = main_models.DescribeHttpDDoSIntelligentRateLimitRulesResponseBodyRuleInfos()
...
class DescribeHttpDDoSIntelligentRateLimitRulesResponseBodyRuleInfos(DaraModel):
    def __init__(
        self,
        action: str = None,
        condition: str = None,

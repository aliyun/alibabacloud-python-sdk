...
class ListClientCaCertificatesResponseBody(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        request_id: str = None,
        result: List[main_models.ListClientCaCertificatesResponseBodyResult] = None,
        site_id: int = None,
        site_name: str = None,
        ...
        # A list of client CA certificates.
        self.result = result
        # The site ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k1 in m.get('Result'):
                temp_model = main_models.ListClientCaCertificatesResponseBodyResult()
...
class ListClientCaCertificatesResponseBodyResult(DaraModel):
    def __init__(
        self,
        ...
        self.san = san
        # The unique serial number assigned by the issuer.

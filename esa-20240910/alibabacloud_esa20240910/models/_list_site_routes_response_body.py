...
class ListSiteRoutesResponseBody(DaraModel):
    def __init__(
        self,
        configs: List[main_models.ListSiteRoutesResponseBodyConfigs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Configs') is not None:
            for k1 in m.get('Configs'):
                temp_model = main_models.ListSiteRoutesResponseBodyConfigs()
...
class ListSiteRoutesResponseBodyConfigs(DaraModel):
    def __init__(
        self,
        bypass: str = None,
        config_id: int = None,

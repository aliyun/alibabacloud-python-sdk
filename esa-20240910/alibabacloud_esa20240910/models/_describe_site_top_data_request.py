...
class DescribeSiteTopDataRequest(DaraModel):
    def __init__(
        self,
        end_time: str = None,
        fields: List[main_models.DescribeSiteTopDataRequestFields] = None,
        interval: str = None,
        limit: str = None,
        site_id: str = None,
        start_time: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Fields') is not None:
            for k1 in m.get('Fields'):
                temp_model = main_models.DescribeSiteTopDataRequestFields()
...
class DescribeSiteTopDataRequestFields(DaraModel):
    def __init__(
        self,

...
```bash
# 安装 alibabacloud_umeng_finplus20211125
pip install alibabacloud_umeng_finplus20211125
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/umeng-finplus-20211125/ChangeLog.md)中。

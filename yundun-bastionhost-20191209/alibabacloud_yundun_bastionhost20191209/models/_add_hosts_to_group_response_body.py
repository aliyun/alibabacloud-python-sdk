...
class AddHostsToGroupResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        results: List[main_models.AddHostsToGroupResponseBodyResults] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Results') is not None:
            for k1 in m.get('Results'):
                temp_model = main_models.AddHostsToGroupResponseBodyResults()
                self.results.append(temp_model.from_map(k1))

        return self

class AddHostsToGroupResponseBodyResults(DaraModel):
    def __init__(
        self,
        code: str = None,

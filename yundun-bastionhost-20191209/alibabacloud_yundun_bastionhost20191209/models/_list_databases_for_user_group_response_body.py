...
class ListDatabasesForUserGroupResponseBody(DaraModel):
    def __init__(
        self,
        databases: List[main_models.ListDatabasesForUserGroupResponseBodyDatabases] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Databases') is not None:
            for k1 in m.get('Databases'):
                temp_model = main_models.ListDatabasesForUserGroupResponseBodyDatabases()
...
class ListDatabasesForUserGroupResponseBodyDatabases(DaraModel):
    def __init__(
        self,

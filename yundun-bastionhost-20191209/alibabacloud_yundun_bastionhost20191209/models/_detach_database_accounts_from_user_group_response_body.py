...
class DetachDatabaseAccountsFromUserGroupResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        results: List[main_models.DetachDatabaseAccountsFromUserGroupResponseBodyResults] = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Results') is not None:
            for k1 in m.get('Results'):
                temp_model = main_models.DetachDatabaseAccountsFromUserGroupResponseBodyResults()
                self.results.append(temp_model.from_map(k1))

        return self

class DetachDatabaseAccountsFromUserGroupResponseBodyResults(DaraModel):
    def __init__(
        self,
        code: str = None,
        database_accounts: List[main_models.DetachDatabaseAccountsFromUserGroupResponseBodyResultsDatabaseAccounts] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DatabaseAccounts') is not None:
            for k1 in m.get('DatabaseAccounts'):
                temp_model = main_models.DetachDatabaseAccountsFromUserGroupResponseBodyResultsDatabaseAccounts()
...
class DetachDatabaseAccountsFromUserGroupResponseBodyResultsDatabaseAccounts(DaraModel):
    def __init__(
        self,
        code: str = None,

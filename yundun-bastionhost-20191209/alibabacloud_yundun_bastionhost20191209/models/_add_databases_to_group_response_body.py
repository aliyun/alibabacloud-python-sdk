...
class AddDatabasesToGroupResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        results: List[main_models.AddDatabasesToGroupResponseBodyResults] = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Results') is not None:
            for k1 in m.get('Results'):
                temp_model = main_models.AddDatabasesToGroupResponseBodyResults()
...
class AddDatabasesToGroupResponseBodyResults(DaraModel):
    def __init__(
        self,
        code: str = None,

...
class ListDatabasesForUserResponseBody(DaraModel):
    def __init__(
        self,
        databases: List[main_models.ListDatabasesForUserResponseBodyDatabases] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Databases') is not None:
            for k1 in m.get('Databases'):
                temp_model = main_models.ListDatabasesForUserResponseBodyDatabases()
...
class ListDatabasesForUserResponseBodyDatabases(DaraModel):
    def __init__(
        self,

...
class ListDatabaseAccountsForUserResponseBody(DaraModel):
    def __init__(
        self,
        database_accounts: List[main_models.ListDatabaseAccountsForUserResponseBodyDatabaseAccounts] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DatabaseAccounts') is not None:
            for k1 in m.get('DatabaseAccounts'):
                temp_model = main_models.ListDatabaseAccountsForUserResponseBodyDatabaseAccounts()
...
class ListDatabaseAccountsForUserResponseBodyDatabaseAccounts(DaraModel):
    def __init__(
        self,

...
class ListHostGroupsForUserResponseBody(DaraModel):
    def __init__(
        self,
        host_groups: List[main_models.ListHostGroupsForUserResponseBodyHostGroups] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HostGroups') is not None:
            for k1 in m.get('HostGroups'):
                temp_model = main_models.ListHostGroupsForUserResponseBodyHostGroups()
...
class ListHostGroupsForUserResponseBodyHostGroups(DaraModel):
    def __init__(
        self,
        comment: str = None,

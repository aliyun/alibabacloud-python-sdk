...
class DetachHostGroupAccountsFromUserResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        results: List[main_models.DetachHostGroupAccountsFromUserResponseBodyResults] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Results') is not None:
            for k1 in m.get('Results'):
                temp_model = main_models.DetachHostGroupAccountsFromUserResponseBodyResults()
                self.results.append(temp_model.from_map(k1))

        return self

class DetachHostGroupAccountsFromUserResponseBodyResults(DaraModel):
    def __init__(
        self,
        code: str = None,
        host_account_names: List[main_models.DetachHostGroupAccountsFromUserResponseBodyResultsHostAccountNames] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HostAccountNames') is not None:
            for k1 in m.get('HostAccountNames'):
                temp_model = main_models.DetachHostGroupAccountsFromUserResponseBodyResultsHostAccountNames()
...
class DetachHostGroupAccountsFromUserResponseBodyResultsHostAccountNames(DaraModel):
    def __init__(
        self,
        code: str = None,

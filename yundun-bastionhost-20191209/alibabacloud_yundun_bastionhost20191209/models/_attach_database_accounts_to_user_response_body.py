...
class AttachDatabaseAccountsToUserResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        results: List[main_models.AttachDatabaseAccountsToUserResponseBodyResults] = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Results') is not None:
            for k1 in m.get('Results'):
                temp_model = main_models.AttachDatabaseAccountsToUserResponseBodyResults()
                self.results.append(temp_model.from_map(k1))

        return self

class AttachDatabaseAccountsToUserResponseBodyResults(DaraModel):
    def __init__(
        self,
        code: str = None,
        database_accounts: List[main_models.AttachDatabaseAccountsToUserResponseBodyResultsDatabaseAccounts] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DatabaseAccounts') is not None:
            for k1 in m.get('DatabaseAccounts'):
                temp_model = main_models.AttachDatabaseAccountsToUserResponseBodyResultsDatabaseAccounts()
...
class AttachDatabaseAccountsToUserResponseBodyResultsDatabaseAccounts(DaraModel):
    def __init__(
        self,
        code: str = None,

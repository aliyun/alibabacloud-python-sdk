...
class ListHostsResponseBody(DaraModel):
    def __init__(
        self,
        hosts: List[main_models.ListHostsResponseBodyHosts] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Hosts') is not None:
            for k1 in m.get('Hosts'):
                temp_model = main_models.ListHostsResponseBodyHosts()
...
class ListHostsResponseBodyHosts(DaraModel):
    def __init__(
        self,

...
class DetachHostAccountsFromUserResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        results: List[main_models.DetachHostAccountsFromUserResponseBodyResults] = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Results') is not None:
            for k1 in m.get('Results'):
                temp_model = main_models.DetachHostAccountsFromUserResponseBodyResults()
                self.results.append(temp_model.from_map(k1))

        return self

class DetachHostAccountsFromUserResponseBodyResults(DaraModel):
    def __init__(
        self,
        code: str = None,
        host_accounts: List[main_models.DetachHostAccountsFromUserResponseBodyResultsHostAccounts] = None,
        host_id: str = None,
        message: str = None,
        user_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HostAccounts') is not None:
            for k1 in m.get('HostAccounts'):
                temp_model = main_models.DetachHostAccountsFromUserResponseBodyResultsHostAccounts()
...
class DetachHostAccountsFromUserResponseBodyResultsHostAccounts(DaraModel):
    def __init__(
        self,
        code: str = None,

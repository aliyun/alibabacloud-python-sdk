...
class DetachDatabaseAccountsFromUserResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        results: List[main_models.DetachDatabaseAccountsFromUserResponseBodyResults] = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Results') is not None:
            for k1 in m.get('Results'):
                temp_model = main_models.DetachDatabaseAccountsFromUserResponseBodyResults()
                self.results.append(temp_model.from_map(k1))

        return self

class DetachDatabaseAccountsFromUserResponseBodyResults(DaraModel):
    def __init__(
        self,
        code: str = None,
        database_accounts: List[main_models.DetachDatabaseAccountsFromUserResponseBodyResultsDatabaseAccounts] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DatabaseAccounts') is not None:
            for k1 in m.get('DatabaseAccounts'):
                temp_model = main_models.DetachDatabaseAccountsFromUserResponseBodyResultsDatabaseAccounts()
...
class DetachDatabaseAccountsFromUserResponseBodyResultsDatabaseAccounts(DaraModel):
    def __init__(
        self,
        code: str = None,

...
class ListHostAccountsForUserResponseBody(DaraModel):
    def __init__(
        self,
        host_accounts: List[main_models.ListHostAccountsForUserResponseBodyHostAccounts] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HostAccounts') is not None:
            for k1 in m.get('HostAccounts'):
                temp_model = main_models.ListHostAccountsForUserResponseBodyHostAccounts()
...
class ListHostAccountsForUserResponseBodyHostAccounts(DaraModel):
    def __init__(
        self,

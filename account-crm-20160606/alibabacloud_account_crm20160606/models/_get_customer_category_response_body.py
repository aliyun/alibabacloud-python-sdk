...
class GetCustomerCategoryResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetCustomerCategoryResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetCustomerCategoryResponseBodyData()
...
class GetCustomerCategoryResponseBodyData(DaraModel):
    def __init__(
        self,
        biz_category: List[main_models.GetCustomerCategoryResponseBodyDataBizCategory] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BizCategory') is not None:
            for k1 in m.get('BizCategory'):
                temp_model = main_models.GetCustomerCategoryResponseBodyDataBizCategory()
                self.biz_category.append(temp_model.from_map(k1))

        return self

class GetCustomerCategoryResponseBodyDataBizCategory(DaraModel):
    def __init__(
        self,
        code: str = None,
        is_check: bool = None,
        ...
        name: str = None,
        other: str = None,
        sub_configs: main_models.GetCustomerCategoryResponseBodyDataBizCategorySubConfigs = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SubConfigs') is not None:
            temp_model = main_models.GetCustomerCategoryResponseBodyDataBizCategorySubConfigs()
            self.sub_configs = temp_model.from_map(m.get('SubConfigs'))

        return self

class GetCustomerCategoryResponseBodyDataBizCategorySubConfigs(DaraModel):
    def __init__(
        self,
        biz_sub_category: List[main_models.GetCustomerCategoryResponseBodyDataBizCategorySubConfigsBizSubCategory] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BizSubCategory') is not None:
            for k1 in m.get('BizSubCategory'):
                temp_model = main_models.GetCustomerCategoryResponseBodyDataBizCategorySubConfigsBizSubCategory()
                self.biz_sub_category.append(temp_model.from_map(k1))

        return self

class GetCustomerCategoryResponseBodyDataBizCategorySubConfigsBizSubCategory(DaraModel):
    def __init__(
        self,
        code: str = None,
        is_check: bool = None,

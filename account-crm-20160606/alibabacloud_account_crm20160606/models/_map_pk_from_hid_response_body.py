...
class MapPkFromHidResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.MapPkFromHidResponseBodyData = None,
        http_code: str = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.MapPkFromHidResponseBodyData()
...
class MapPkFromHidResponseBodyData(DaraModel):
    def __init__(
        self,
        hid: str = None,

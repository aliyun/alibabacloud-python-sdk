...
class QueryAccountAddressInfoWithoutHavanaResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        profile_info: main_models.QueryAccountAddressInfoWithoutHavanaResponseBodyProfileInfo = None,
        request_id: str = None,
        success: bool = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ProfileInfo') is not None:
            temp_model = main_models.QueryAccountAddressInfoWithoutHavanaResponseBodyProfileInfo()
...
class QueryAccountAddressInfoWithoutHavanaResponseBodyProfileInfo(DaraModel):
    def __init__(
        self,
        ...
        address_5: str = None,
        address_6: str = None,
        city: main_models.QueryAccountAddressInfoWithoutHavanaResponseBodyProfileInfoCity = None,
        havana_id: str = None,
        post_code: str = None,
        province: main_models.QueryAccountAddressInfoWithoutHavanaResponseBodyProfileInfoProvince = None,
        true_name: str = None,
        version: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('City') is not None:
            temp_model = main_models.QueryAccountAddressInfoWithoutHavanaResponseBodyProfileInfoCity()
        ...
        if m.get('Province') is not None:
            temp_model = main_models.QueryAccountAddressInfoWithoutHavanaResponseBodyProfileInfoProvince()
...
class QueryAccountAddressInfoWithoutHavanaResponseBodyProfileInfoProvince(DaraModel):
    def __init__(
        self,
        id: str = None,
        name: str = None,
...
class QueryAccountAddressInfoWithoutHavanaResponseBodyProfileInfoCity(DaraModel):
    def __init__(
        self,
        id: str = None,
        name: str = None,

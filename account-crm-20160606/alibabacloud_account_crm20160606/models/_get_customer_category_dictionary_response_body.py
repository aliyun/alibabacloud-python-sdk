...
class GetCustomerCategoryDictionaryResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetCustomerCategoryDictionaryResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetCustomerCategoryDictionaryResponseBodyData()
...
class GetCustomerCategoryDictionaryResponseBodyData(DaraModel):
    def __init__(
        self,
        enum_config: List[main_models.GetCustomerCategoryDictionaryResponseBodyDataEnumConfig] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EnumConfig') is not None:
            for k1 in m.get('EnumConfig'):
                temp_model = main_models.GetCustomerCategoryDictionaryResponseBodyDataEnumConfig()
                self.enum_config.append(temp_model.from_map(k1))

        return self

class GetCustomerCategoryDictionaryResponseBodyDataEnumConfig(DaraModel):
    def __init__(
        self,
        enum_name: str = None,
        enum_value: str = None,

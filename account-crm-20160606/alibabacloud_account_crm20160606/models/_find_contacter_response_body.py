...
class FindContacterResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.FindContacterResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.FindContacterResponseBodyData()
...
class FindContacterResponseBodyData(DaraModel):
    def __init__(
        self,

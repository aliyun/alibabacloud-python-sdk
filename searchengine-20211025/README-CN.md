...
## Alibaba Cloud searchengine SDK for Python
...
```bash
# 安装 alibabacloud_searchengine20211025
pip install alibabacloud_searchengine20211025
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/searchengine-20211025/ChangeLog.md)中。

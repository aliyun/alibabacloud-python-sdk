...
class UpdateRecordTaskRequest(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        channel_id: str = None,
        ...
        user_panes: List[main_models.UpdateRecordTaskRequestUserPanes] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserPanes') is not None:
            for k1 in m.get('UserPanes'):
                temp_model = main_models.UpdateRecordTaskRequestUserPanes()
                self.user_panes.append(temp_model.from_map(k1))

        return self

class UpdateRecordTaskRequestUserPanes(DaraModel):
    def __init__(
        self,
        images: List[main_models.UpdateRecordTaskRequestUserPanesImages] = None,
        pane_id: int = None,
        source_type: str = None,
        texts: List[main_models.UpdateRecordTaskRequestUserPanesTexts] = None,
        user_id: str = None,
    ):
        self.images = images
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Images') is not None:
            for k1 in m.get('Images'):
                temp_model = main_models.UpdateRecordTaskRequestUserPanesImages()
        ...
        if m.get('Texts') is not None:
            for k1 in m.get('Texts'):
                temp_model = main_models.UpdateRecordTaskRequestUserPanesTexts()
...
class UpdateRecordTaskRequestUserPanesTexts(DaraModel):
    def __init__(
        self,
        font_color: int = None,
        font_size: int = None,
...
class UpdateRecordTaskRequestUserPanesImages(DaraModel):
    def __init__(
        self,
        display: int = None,
        height: float = None,

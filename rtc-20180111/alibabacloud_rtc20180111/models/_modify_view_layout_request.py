...
class ModifyViewLayoutRequest(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        backgrounds: List[main_models.ModifyViewLayoutRequestBackgrounds] = None,
        channel_id: str = None,
        clock_widgets: List[main_models.ModifyViewLayoutRequestClockWidgets] = None,
        images: List[main_models.ModifyViewLayoutRequestImages] = None,
        layout_specified_users: main_models.ModifyViewLayoutRequestLayoutSpecifiedUsers = None,
        panes: List[main_models.ModifyViewLayoutRequestPanes] = None,
        task_id: str = None,
        template_id: str = None,
        texts: List[main_models.ModifyViewLayoutRequestTexts] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Backgrounds') is not None:
            for k1 in m.get('Backgrounds'):
                temp_model = main_models.ModifyViewLayoutRequestBackgrounds()
        ...
        if m.get('ClockWidgets') is not None:
            for k1 in m.get('ClockWidgets'):
                temp_model = main_models.ModifyViewLayoutRequestClockWidgets()
                self.clock_widgets.append(temp_model.from_map(k1))

        self.images = []
        if m.get('Images') is not None:
            for k1 in m.get('Images'):
                temp_model = main_models.ModifyViewLayoutRequestImages()
                self.images.append(temp_model.from_map(k1))

        if m.get('LayoutSpecifiedUsers') is not None:
            temp_model = main_models.ModifyViewLayoutRequestLayoutSpecifiedUsers()
        ...
        if m.get('Panes') is not None:
            for k1 in m.get('Panes'):
                temp_model = main_models.ModifyViewLayoutRequestPanes()
        ...
        if m.get('Texts') is not None:
            for k1 in m.get('Texts'):
                temp_model = main_models.ModifyViewLayoutRequestTexts()
                self.texts.append(temp_model.from_map(k1))

        return self

class ModifyViewLayoutRequestTexts(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        box_alpha: float = None,
        box_borderw: int = None,
        box_color: main_models.ModifyViewLayoutRequestTextsBoxColor = None,
        font: int = None,
        font_color: main_models.ModifyViewLayoutRequestTextsFontColor = None,
        font_size: int = None,
        has_box: bool = None,
        layer: int = None,
        texture: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BoxColor') is not None:
            temp_model = main_models.ModifyViewLayoutRequestTextsBoxColor()
        ...
        if m.get('FontColor') is not None:
            temp_model = main_models.ModifyViewLayoutRequestTextsFontColor()
...
class ModifyViewLayoutRequestTextsFontColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class ModifyViewLayoutRequestTextsBoxColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class ModifyViewLayoutRequestPanes(DaraModel):
    def __init__(
        self,
        images: List[main_models.ModifyViewLayoutRequestPanesImages] = None,
        pane_crop_mode: int = None,
        pane_id: str = None,
        source: str = None,
        source_type: str = None,
        texts: List[main_models.ModifyViewLayoutRequestPanesTexts] = None,
    ):
        self.images = images
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Images') is not None:
            for k1 in m.get('Images'):
                temp_model = main_models.ModifyViewLayoutRequestPanesImages()
                self.images.append(temp_model.from_map(k1))
        ...
        if m.get('Texts') is not None:
            for k1 in m.get('Texts'):
                temp_model = main_models.ModifyViewLayoutRequestPanesTexts()
                self.texts.append(temp_model.from_map(k1))

        return self

class ModifyViewLayoutRequestPanesTexts(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        box_alpha: float = None,
        box_borderw: int = None,
        box_color: main_models.ModifyViewLayoutRequestPanesTextsBoxColor = None,
        font: int = None,
        font_color: main_models.ModifyViewLayoutRequestPanesTextsFontColor = None,
        font_size: int = None,
        has_box: bool = None,
        layer: int = None,
        texture: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BoxColor') is not None:
            temp_model = main_models.ModifyViewLayoutRequestPanesTextsBoxColor()
            self.box_color = temp_model.from_map(m.get('BoxColor'))
        ...
        if m.get('FontColor') is not None:
            temp_model = main_models.ModifyViewLayoutRequestPanesTextsFontColor()
            self.font_color = temp_model.from_map(m.get('FontColor'))
...
class ModifyViewLayoutRequestPanesTextsFontColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class ModifyViewLayoutRequestPanesTextsBoxColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class ModifyViewLayoutRequestPanesImages(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        height: float = None,
...
class ModifyViewLayoutRequestLayoutSpecifiedUsers(DaraModel):
    def __init__(
        self,
        ids: List[str] = None,
        type: str = None,
...
class ModifyViewLayoutRequestImages(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        height: float = None,
...
class ModifyViewLayoutRequestClockWidgets(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        box_alpha: float = None,
        box_borderw: int = None,
        box_color: main_models.ModifyViewLayoutRequestClockWidgetsBoxColor = None,
        font: int = None,
        font_color: main_models.ModifyViewLayoutRequestClockWidgetsFontColor = None,
        font_size: int = None,
        has_box: bool = None,
        layer: int = None,
        x: float = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BoxColor') is not None:
            temp_model = main_models.ModifyViewLayoutRequestClockWidgetsBoxColor()
            self.box_color = temp_model.from_map(m.get('BoxColor'))
        ...
        if m.get('FontColor') is not None:
            temp_model = main_models.ModifyViewLayoutRequestClockWidgetsFontColor()
            self.font_color = temp_model.from_map(m.get('FontColor'))
...
class ModifyViewLayoutRequestClockWidgetsFontColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class ModifyViewLayoutRequestClockWidgetsBoxColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class ModifyViewLayoutRequestBackgrounds(DaraModel):
    def __init__(
        self,
        alpha: float = None,

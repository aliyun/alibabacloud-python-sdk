...
class StartStreamingOutRequest(DaraModel):
    def __init__(
        self,
        annotation: str = None,
        app_id: str = None,
        backgrounds: List[main_models.StartStreamingOutRequestBackgrounds] = None,
        bg_color: main_models.StartStreamingOutRequestBgColor = None,
        channel_id: str = None,
        clock_widgets: List[main_models.StartStreamingOutRequestClockWidgets] = None,
        crop_mode: int = None,
        images: List[main_models.StartStreamingOutRequestImages] = None,
        layout_specified_users: main_models.StartStreamingOutRequestLayoutSpecifiedUsers = None,
        panes: List[main_models.StartStreamingOutRequestPanes] = None,
        region_color: main_models.StartStreamingOutRequestRegionColor = None,
        ...
        texts: List[main_models.StartStreamingOutRequestTexts] = None,
        url: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Backgrounds') is not None:
            for k1 in m.get('Backgrounds'):
                temp_model = main_models.StartStreamingOutRequestBackgrounds()
                self.backgrounds.append(temp_model.from_map(k1))

        if m.get('BgColor') is not None:
            temp_model = main_models.StartStreamingOutRequestBgColor()
        ...
        if m.get('ClockWidgets') is not None:
            for k1 in m.get('ClockWidgets'):
                temp_model = main_models.StartStreamingOutRequestClockWidgets()
        ...
        if m.get('Images') is not None:
            for k1 in m.get('Images'):
                temp_model = main_models.StartStreamingOutRequestImages()
                self.images.append(temp_model.from_map(k1))

        if m.get('LayoutSpecifiedUsers') is not None:
            temp_model = main_models.StartStreamingOutRequestLayoutSpecifiedUsers()
        ...
        if m.get('Panes') is not None:
            for k1 in m.get('Panes'):
                temp_model = main_models.StartStreamingOutRequestPanes()
                self.panes.append(temp_model.from_map(k1))

        if m.get('RegionColor') is not None:
            temp_model = main_models.StartStreamingOutRequestRegionColor()
        ...
        if m.get('Texts') is not None:
            for k1 in m.get('Texts'):
                temp_model = main_models.StartStreamingOutRequestTexts()
...
class StartStreamingOutRequestTexts(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        box_alpha: float = None,
        box_borderw: int = None,
        box_color: main_models.StartStreamingOutRequestTextsBoxColor = None,
        font: int = None,
        font_color: main_models.StartStreamingOutRequestTextsFontColor = None,
        font_size: int = None,
        has_box: bool = None,
        layer: int = None,
        texture: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BoxColor') is not None:
            temp_model = main_models.StartStreamingOutRequestTextsBoxColor()
        ...
        if m.get('FontColor') is not None:
            temp_model = main_models.StartStreamingOutRequestTextsFontColor()
...
class StartStreamingOutRequestTextsFontColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class StartStreamingOutRequestTextsBoxColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class StartStreamingOutRequestRegionColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class StartStreamingOutRequestPanes(DaraModel):
    def __init__(
        self,
        backgrounds: List[main_models.StartStreamingOutRequestPanesBackgrounds] = None,
        images: List[main_models.StartStreamingOutRequestPanesImages] = None,
        pane_crop_mode: int = None,
        pane_id: str = None,
        reserve_pane_for_offline_user: bool = None,
        source: str = None,
        source_type: str = None,
        texts: List[main_models.StartStreamingOutRequestPanesTexts] = None,
        video_order: str = None,
        whiteboard: main_models.StartStreamingOutRequestPanesWhiteboard = None,
    ):
        self.backgrounds = backgrounds
        self.images = images
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Backgrounds') is not None:
            for k1 in m.get('Backgrounds'):
                temp_model = main_models.StartStreamingOutRequestPanesBackgrounds()
                self.backgrounds.append(temp_model.from_map(k1))

        self.images = []
        if m.get('Images') is not None:
            for k1 in m.get('Images'):
                temp_model = main_models.StartStreamingOutRequestPanesImages()
                self.images.append(temp_model.from_map(k1))
        ...
        if m.get('Texts') is not None:
            for k1 in m.get('Texts'):
                temp_model = main_models.StartStreamingOutRequestPanesTexts()
                self.texts.append(temp_model.from_map(k1))
        ...
        if m.get('Whiteboard') is not None:
            temp_model = main_models.StartStreamingOutRequestPanesWhiteboard()
            self.whiteboard = temp_model.from_map(m.get('Whiteboard'))

        return self

class StartStreamingOutRequestPanesWhiteboard(DaraModel):
    def __init__(
        self,
...
class StartStreamingOutRequestPanesTexts(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        box_alpha: float = None,
        box_borderw: int = None,
        box_color: main_models.StartStreamingOutRequestPanesTextsBoxColor = None,
        display: str = None,
        font: int = None,
        font_color: main_models.StartStreamingOutRequestPanesTextsFontColor = None,
        font_size: int = None,
        has_box: bool = None,
        layer: int = None,
        texture: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BoxColor') is not None:
            temp_model = main_models.StartStreamingOutRequestPanesTextsBoxColor()
            self.box_color = temp_model.from_map(m.get('BoxColor'))
        ...
        if m.get('FontColor') is not None:
            temp_model = main_models.StartStreamingOutRequestPanesTextsFontColor()
            self.font_color = temp_model.from_map(m.get('FontColor'))
...
class StartStreamingOutRequestPanesTextsFontColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class StartStreamingOutRequestPanesTextsBoxColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class StartStreamingOutRequestPanesImages(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        display: str = None,
...
class StartStreamingOutRequestPanesBackgrounds(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        display: str = None,
...
class StartStreamingOutRequestLayoutSpecifiedUsers(DaraModel):
    def __init__(
        self,
        ids: List[str] = None,
        type: str = None,
...
class StartStreamingOutRequestImages(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        height: float = None,
...
class StartStreamingOutRequestClockWidgets(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        box_alpha: float = None,
        box_borderw: int = None,
        box_color: main_models.StartStreamingOutRequestClockWidgetsBoxColor = None,
        font: int = None,
        font_color: main_models.StartStreamingOutRequestClockWidgetsFontColor = None,
        font_size: int = None,
        has_box: bool = None,
        layer: int = None,
        x: float = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BoxColor') is not None:
            temp_model = main_models.StartStreamingOutRequestClockWidgetsBoxColor()
            self.box_color = temp_model.from_map(m.get('BoxColor'))
        ...
        if m.get('FontColor') is not None:
            temp_model = main_models.StartStreamingOutRequestClockWidgetsFontColor()
            self.font_color = temp_model.from_map(m.get('FontColor'))
...
class StartStreamingOutRequestClockWidgetsFontColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class StartStreamingOutRequestClockWidgetsBoxColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class StartStreamingOutRequestBgColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class StartStreamingOutRequestBackgrounds(DaraModel):
    def __init__(
        self,
        alpha: float = None,

...
class DescribeAppViewTemplatesResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        templates: List[main_models.DescribeAppViewTemplatesResponseBodyTemplates] = None,
        total_num: int = None,
        total_page: int = None,
    ):
        # Id of the request
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Templates') is not None:
            for k1 in m.get('Templates'):
                temp_model = main_models.DescribeAppViewTemplatesResponseBodyTemplates()
...
class DescribeAppViewTemplatesResponseBodyTemplates(DaraModel):
    def __init__(
        self,

...
class AddRecordTemplateRequest(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        background_color: int = None,
        backgrounds: List[main_models.AddRecordTemplateRequestBackgrounds] = None,
        clock_widgets: List[main_models.AddRecordTemplateRequestClockWidgets] = None,
        ...
        watermarks: List[main_models.AddRecordTemplateRequestWatermarks] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Backgrounds') is not None:
            for k1 in m.get('Backgrounds'):
                temp_model = main_models.AddRecordTemplateRequestBackgrounds()
                self.backgrounds.append(temp_model.from_map(k1))

        self.clock_widgets = []
        if m.get('ClockWidgets') is not None:
            for k1 in m.get('ClockWidgets'):
                temp_model = main_models.AddRecordTemplateRequestClockWidgets()
        ...
        if m.get('Watermarks') is not None:
            for k1 in m.get('Watermarks'):
                temp_model = main_models.AddRecordTemplateRequestWatermarks()
                self.watermarks.append(temp_model.from_map(k1))

        return self

class AddRecordTemplateRequestWatermarks(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        display: int = None,
...
class AddRecordTemplateRequestClockWidgets(DaraModel):
    def __init__(
        self,
        font_color: int = None,
        font_size: int = None,
...
class AddRecordTemplateRequestBackgrounds(DaraModel):
    def __init__(
        self,
        display: int = None,
        height: float = None,

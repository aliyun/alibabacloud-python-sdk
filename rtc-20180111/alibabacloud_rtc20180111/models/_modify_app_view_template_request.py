...
class ModifyAppViewTemplateRequest(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        template: main_models.ModifyAppViewTemplateRequestTemplate = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Template') is not None:
            temp_model = main_models.ModifyAppViewTemplateRequestTemplate()
            self.template = temp_model.from_map(m.get('Template'))

        return self

class ModifyAppViewTemplateRequestTemplate(DaraModel):
    def __init__(
        self,

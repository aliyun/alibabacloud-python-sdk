...
class DescribeMPULayoutInfoListResponseBody(DaraModel):
    def __init__(
        self,
        layouts: main_models.DescribeMPULayoutInfoListResponseBodyLayouts = None,
        request_id: str = None,
        total_num: int = None,
        total_page: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Layouts') is not None:
            temp_model = main_models.DescribeMPULayoutInfoListResponseBodyLayouts()
...
class DescribeMPULayoutInfoListResponseBodyLayouts(DaraModel):
    def __init__(
        self,
        layout: List[main_models.DescribeMPULayoutInfoListResponseBodyLayoutsLayout] = None,
    ):
        self.layout = layout
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Layout') is not None:
            for k1 in m.get('Layout'):
                temp_model = main_models.DescribeMPULayoutInfoListResponseBodyLayoutsLayout()
                self.layout.append(temp_model.from_map(k1))

        return self

class DescribeMPULayoutInfoListResponseBodyLayoutsLayout(DaraModel):
    def __init__(
        self,
        audio_mix_count: int = None,
        layout_id: int = None,
        name: str = None,
        panes: main_models.DescribeMPULayoutInfoListResponseBodyLayoutsLayoutPanes = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Panes') is not None:
            temp_model = main_models.DescribeMPULayoutInfoListResponseBodyLayoutsLayoutPanes()
            self.panes = temp_model.from_map(m.get('Panes'))

        return self

class DescribeMPULayoutInfoListResponseBodyLayoutsLayoutPanes(DaraModel):
    def __init__(
        self,
        panes: List[main_models.DescribeMPULayoutInfoListResponseBodyLayoutsLayoutPanesPanes] = None,
    ):
        self.panes = panes
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Panes') is not None:
            for k1 in m.get('Panes'):
                temp_model = main_models.DescribeMPULayoutInfoListResponseBodyLayoutsLayoutPanesPanes()
                self.panes.append(temp_model.from_map(k1))

        return self

class DescribeMPULayoutInfoListResponseBodyLayoutsLayoutPanesPanes(DaraModel):
    def __init__(
        self,
        height: float = None,
        major_pane: int = None,

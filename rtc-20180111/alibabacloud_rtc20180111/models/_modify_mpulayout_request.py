...
class ModifyMPULayoutRequest(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        ...
        name: str = None,
        owner_id: int = None,
        panes: List[main_models.ModifyMPULayoutRequestPanes] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Panes') is not None:
            for k1 in m.get('Panes'):
                temp_model = main_models.ModifyMPULayoutRequestPanes()
                self.panes.append(temp_model.from_map(k1))

        return self

class ModifyMPULayoutRequestPanes(DaraModel):
    def __init__(
        self,
        height: float = None,
        major_pane: int = None,

...
class UpdateStreamingOutRequest(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        backgrounds: List[main_models.UpdateStreamingOutRequestBackgrounds] = None,
        bg_color: main_models.UpdateStreamingOutRequestBgColor = None,
        channel_id: str = None,
        clock_widgets: List[main_models.UpdateStreamingOutRequestClockWidgets] = None,
        crop_mode: int = None,
        images: List[main_models.UpdateStreamingOutRequestImages] = None,
        layout_specified_users: main_models.UpdateStreamingOutRequestLayoutSpecifiedUsers = None,
        panes: List[main_models.UpdateStreamingOutRequestPanes] = None,
        region_color: main_models.UpdateStreamingOutRequestRegionColor = None,
        spec_mixed_user_list: List[str] = None,
        task_id: str = None,
        template_id: str = None,
        texts: List[main_models.UpdateStreamingOutRequestTexts] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Backgrounds') is not None:
            for k1 in m.get('Backgrounds'):
                temp_model = main_models.UpdateStreamingOutRequestBackgrounds()
                self.backgrounds.append(temp_model.from_map(k1))

        if m.get('BgColor') is not None:
            temp_model = main_models.UpdateStreamingOutRequestBgColor()
        ...
        if m.get('ClockWidgets') is not None:
            for k1 in m.get('ClockWidgets'):
                temp_model = main_models.UpdateStreamingOutRequestClockWidgets()
        ...
        if m.get('Images') is not None:
            for k1 in m.get('Images'):
                temp_model = main_models.UpdateStreamingOutRequestImages()
                self.images.append(temp_model.from_map(k1))

        if m.get('LayoutSpecifiedUsers') is not None:
            temp_model = main_models.UpdateStreamingOutRequestLayoutSpecifiedUsers()
        ...
        if m.get('Panes') is not None:
            for k1 in m.get('Panes'):
                temp_model = main_models.UpdateStreamingOutRequestPanes()
                self.panes.append(temp_model.from_map(k1))

        if m.get('RegionColor') is not None:
            temp_model = main_models.UpdateStreamingOutRequestRegionColor()
        ...
        if m.get('Texts') is not None:
            for k1 in m.get('Texts'):
                temp_model = main_models.UpdateStreamingOutRequestTexts()
                self.texts.append(temp_model.from_map(k1))

        return self

class UpdateStreamingOutRequestTexts(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        box_alpha: float = None,
        box_borderw: int = None,
        box_color: main_models.UpdateStreamingOutRequestTextsBoxColor = None,
        font: int = None,
        font_color: main_models.UpdateStreamingOutRequestTextsFontColor = None,
        font_size: int = None,
        has_box: bool = None,
        layer: int = None,
        texture: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BoxColor') is not None:
            temp_model = main_models.UpdateStreamingOutRequestTextsBoxColor()
        ...
        if m.get('FontColor') is not None:
            temp_model = main_models.UpdateStreamingOutRequestTextsFontColor()
...
class UpdateStreamingOutRequestTextsFontColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class UpdateStreamingOutRequestTextsBoxColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class UpdateStreamingOutRequestRegionColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class UpdateStreamingOutRequestPanes(DaraModel):
    def __init__(
        self,
        backgrounds: List[main_models.UpdateStreamingOutRequestPanesBackgrounds] = None,
        images: List[main_models.UpdateStreamingOutRequestPanesImages] = None,
        pane_crop_mode: int = None,
        pane_id: int = None,
        reserve_pane_for_offline_user: bool = None,
        source: str = None,
        source_type: str = None,
        texts: List[main_models.UpdateStreamingOutRequestPanesTexts] = None,
        video_order: str = None,
        whiteboard: main_models.UpdateStreamingOutRequestPanesWhiteboard = None,
    ):
        self.backgrounds = backgrounds
        self.images = images
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Backgrounds') is not None:
            for k1 in m.get('Backgrounds'):
                temp_model = main_models.UpdateStreamingOutRequestPanesBackgrounds()
                self.backgrounds.append(temp_model.from_map(k1))

        self.images = []
        if m.get('Images') is not None:
            for k1 in m.get('Images'):
                temp_model = main_models.UpdateStreamingOutRequestPanesImages()
                self.images.append(temp_model.from_map(k1))
        ...
        if m.get('Texts') is not None:
            for k1 in m.get('Texts'):
                temp_model = main_models.UpdateStreamingOutRequestPanesTexts()
                self.texts.append(temp_model.from_map(k1))
        ...
        if m.get('Whiteboard') is not None:
            temp_model = main_models.UpdateStreamingOutRequestPanesWhiteboard()
            self.whiteboard = temp_model.from_map(m.get('Whiteboard'))

        return self

class UpdateStreamingOutRequestPanesWhiteboard(DaraModel):
    def __init__(
        self,
...
class UpdateStreamingOutRequestPanesTexts(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        box_alpha: float = None,
        box_borderw: int = None,
        box_color: main_models.UpdateStreamingOutRequestPanesTextsBoxColor = None,
        display: str = None,
        font: int = None,
        font_color: main_models.UpdateStreamingOutRequestPanesTextsFontColor = None,
        font_size: int = None,
        has_box: bool = None,
        layer: int = None,
        texture: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BoxColor') is not None:
            temp_model = main_models.UpdateStreamingOutRequestPanesTextsBoxColor()
            self.box_color = temp_model.from_map(m.get('BoxColor'))
        ...
        if m.get('FontColor') is not None:
            temp_model = main_models.UpdateStreamingOutRequestPanesTextsFontColor()
            self.font_color = temp_model.from_map(m.get('FontColor'))
...
class UpdateStreamingOutRequestPanesTextsFontColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class UpdateStreamingOutRequestPanesTextsBoxColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class UpdateStreamingOutRequestPanesImages(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        display: str = None,
...
class UpdateStreamingOutRequestPanesBackgrounds(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        display: str = None,
...
class UpdateStreamingOutRequestLayoutSpecifiedUsers(DaraModel):
    def __init__(
        self,
        ids: List[str] = None,
        type: str = None,
...
class UpdateStreamingOutRequestImages(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        height: float = None,
...
class UpdateStreamingOutRequestClockWidgets(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        box_alpha: float = None,
        box_borderw: int = None,
        box_color: main_models.UpdateStreamingOutRequestClockWidgetsBoxColor = None,
        font: int = None,
        font_color: main_models.UpdateStreamingOutRequestClockWidgetsFontColor = None,
        font_size: int = None,
        has_box: bool = None,
        layer: int = None,
        x: float = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BoxColor') is not None:
            temp_model = main_models.UpdateStreamingOutRequestClockWidgetsBoxColor()
            self.box_color = temp_model.from_map(m.get('BoxColor'))
        ...
        if m.get('FontColor') is not None:
            temp_model = main_models.UpdateStreamingOutRequestClockWidgetsFontColor()
            self.font_color = temp_model.from_map(m.get('FontColor'))
...
class UpdateStreamingOutRequestClockWidgetsFontColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class UpdateStreamingOutRequestClockWidgetsBoxColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class UpdateStreamingOutRequestBgColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class UpdateStreamingOutRequestBackgrounds(DaraModel):
    def __init__(
        self,
        alpha: float = None,

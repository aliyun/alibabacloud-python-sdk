...
class DescribeQualityOsSdkVersionDistributionStatDataResponseBody(DaraModel):
    def __init__(
        self,
        quality_os_sdk_version_stat_data_list: List[main_models.DescribeQualityOsSdkVersionDistributionStatDataResponseBodyQualityOsSdkVersionStatDataList] = None,
        request_id: str = None,
    ):
    ...
    def validate(self):
        if self.quality_os_sdk_version_stat_data_list:
            for v1 in self.quality_os_sdk_version_stat_data_list:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.quality_os_sdk_version_stat_data_list is not None:
            for k1 in self.quality_os_sdk_version_stat_data_list:
                result['QualityOsSdkVersionStatDataList'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('QualityOsSdkVersionStatDataList') is not None:
            for k1 in m.get('QualityOsSdkVersionStatDataList'):
                temp_model = main_models.DescribeQualityOsSdkVersionDistributionStatDataResponseBodyQualityOsSdkVersionStatDataList()
                self.quality_os_sdk_version_stat_data_list.append(temp_model.from_map(k1))
...
class DescribeQualityOsSdkVersionDistributionStatDataResponseBodyQualityOsSdkVersionStatDataList(DaraModel):
    def __init__(
        self,

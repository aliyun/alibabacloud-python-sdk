...
class StartViewRequest(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        bg_color: main_models.StartViewRequestBgColor = None,
        channel_id: str = None,
        crop_mode: int = None,
        region_color: main_models.StartViewRequestRegionColor = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BgColor') is not None:
            temp_model = main_models.StartViewRequestBgColor()
        ...
        if m.get('RegionColor') is not None:
            temp_model = main_models.StartViewRequestRegionColor()
...
class StartViewRequestRegionColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class StartViewRequestBgColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,

...
class UpdateCloudRecordShrinkRequest(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        backgrounds: List[main_models.UpdateCloudRecordShrinkRequestBackgrounds] = None,
        channel_id: str = None,
        clock_widgets: List[main_models.UpdateCloudRecordShrinkRequestClockWidgets] = None,
        images: List[main_models.UpdateCloudRecordShrinkRequestImages] = None,
        layout_specified_users_shrink: str = None,
        panes: List[main_models.UpdateCloudRecordShrinkRequestPanes] = None,
        task_id: str = None,
        template_id: str = None,
        texts: List[main_models.UpdateCloudRecordShrinkRequestTexts] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Backgrounds') is not None:
            for k1 in m.get('Backgrounds'):
                temp_model = main_models.UpdateCloudRecordShrinkRequestBackgrounds()
        ...
        if m.get('ClockWidgets') is not None:
            for k1 in m.get('ClockWidgets'):
                temp_model = main_models.UpdateCloudRecordShrinkRequestClockWidgets()
                self.clock_widgets.append(temp_model.from_map(k1))

        self.images = []
        if m.get('Images') is not None:
            for k1 in m.get('Images'):
                temp_model = main_models.UpdateCloudRecordShrinkRequestImages()
        ...
        if m.get('Panes') is not None:
            for k1 in m.get('Panes'):
                temp_model = main_models.UpdateCloudRecordShrinkRequestPanes()
        ...
        if m.get('Texts') is not None:
            for k1 in m.get('Texts'):
                temp_model = main_models.UpdateCloudRecordShrinkRequestTexts()
                self.texts.append(temp_model.from_map(k1))

        return self

class UpdateCloudRecordShrinkRequestTexts(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        box_alpha: float = None,
        box_borderw: int = None,
        box_color: main_models.UpdateCloudRecordShrinkRequestTextsBoxColor = None,
        font: int = None,
        font_color: main_models.UpdateCloudRecordShrinkRequestTextsFontColor = None,
        font_size: int = None,
        has_box: bool = None,
        layer: int = None,
        texture: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BoxColor') is not None:
            temp_model = main_models.UpdateCloudRecordShrinkRequestTextsBoxColor()
        ...
        if m.get('FontColor') is not None:
            temp_model = main_models.UpdateCloudRecordShrinkRequestTextsFontColor()
...
class UpdateCloudRecordShrinkRequestTextsFontColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class UpdateCloudRecordShrinkRequestTextsBoxColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class UpdateCloudRecordShrinkRequestPanes(DaraModel):
    def __init__(
        self,
        backgrounds: List[main_models.UpdateCloudRecordShrinkRequestPanesBackgrounds] = None,
        images: List[main_models.UpdateCloudRecordShrinkRequestPanesImages] = None,
        pane_crop_mode: int = None,
        pane_id: int = None,
        reserve_pane_for_offline_user: bool = None,
        source: str = None,
        source_type: str = None,
        texts: List[main_models.UpdateCloudRecordShrinkRequestPanesTexts] = None,
        video_order: str = None,
        whiteboard: main_models.UpdateCloudRecordShrinkRequestPanesWhiteboard = None,
    ):
        self.backgrounds = backgrounds
        self.images = images
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Backgrounds') is not None:
            for k1 in m.get('Backgrounds'):
                temp_model = main_models.UpdateCloudRecordShrinkRequestPanesBackgrounds()
                self.backgrounds.append(temp_model.from_map(k1))

        self.images = []
        if m.get('Images') is not None:
            for k1 in m.get('Images'):
                temp_model = main_models.UpdateCloudRecordShrinkRequestPanesImages()
                self.images.append(temp_model.from_map(k1))
        ...
        if m.get('Texts') is not None:
            for k1 in m.get('Texts'):
                temp_model = main_models.UpdateCloudRecordShrinkRequestPanesTexts()
                self.texts.append(temp_model.from_map(k1))
        ...
        if m.get('Whiteboard') is not None:
            temp_model = main_models.UpdateCloudRecordShrinkRequestPanesWhiteboard()
            self.whiteboard = temp_model.from_map(m.get('Whiteboard'))

        return self

class UpdateCloudRecordShrinkRequestPanesWhiteboard(DaraModel):
    def __init__(
        self,
...
class UpdateCloudRecordShrinkRequestPanesTexts(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        box_alpha: float = None,
        box_borderw: int = None,
        box_color: main_models.UpdateCloudRecordShrinkRequestPanesTextsBoxColor = None,
        display: str = None,
        font: int = None,
        font_color: main_models.UpdateCloudRecordShrinkRequestPanesTextsFontColor = None,
        font_size: int = None,
        has_box: bool = None,
        layer: int = None,
        texture: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BoxColor') is not None:
            temp_model = main_models.UpdateCloudRecordShrinkRequestPanesTextsBoxColor()
            self.box_color = temp_model.from_map(m.get('BoxColor'))
        ...
        if m.get('FontColor') is not None:
            temp_model = main_models.UpdateCloudRecordShrinkRequestPanesTextsFontColor()
            self.font_color = temp_model.from_map(m.get('FontColor'))
...
class UpdateCloudRecordShrinkRequestPanesTextsFontColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class UpdateCloudRecordShrinkRequestPanesTextsBoxColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class UpdateCloudRecordShrinkRequestPanesImages(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        display: str = None,
...
class UpdateCloudRecordShrinkRequestPanesBackgrounds(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        display: str = None,
...
class UpdateCloudRecordShrinkRequestImages(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        height: float = None,
...
class UpdateCloudRecordShrinkRequestClockWidgets(DaraModel):
    def __init__(
        self,
        alpha: float = None,
        box_alpha: float = None,
        box_borderw: int = None,
        box_color: main_models.UpdateCloudRecordShrinkRequestClockWidgetsBoxColor = None,
        font: int = None,
        font_color: main_models.UpdateCloudRecordShrinkRequestClockWidgetsFontColor = None,
        font_size: int = None,
        has_box: bool = None,
        layer: int = None,
        x: float = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BoxColor') is not None:
            temp_model = main_models.UpdateCloudRecordShrinkRequestClockWidgetsBoxColor()
            self.box_color = temp_model.from_map(m.get('BoxColor'))
        ...
        if m.get('FontColor') is not None:
            temp_model = main_models.UpdateCloudRecordShrinkRequestClockWidgetsFontColor()
            self.font_color = temp_model.from_map(m.get('FontColor'))
...
class UpdateCloudRecordShrinkRequestClockWidgetsFontColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class UpdateCloudRecordShrinkRequestClockWidgetsBoxColor(DaraModel):
    def __init__(
        self,
        b: int = None,
        g: int = None,
...
class UpdateCloudRecordShrinkRequestBackgrounds(DaraModel):
    def __init__(
        self,
        alpha: float = None,

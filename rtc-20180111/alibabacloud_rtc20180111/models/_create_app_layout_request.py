...
class CreateAppLayoutRequest(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        client_token: str = None,
        layout: main_models.CreateAppLayoutRequestLayout = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Layout') is not None:
            temp_model = main_models.CreateAppLayoutRequestLayout()
            self.layout = temp_model.from_map(m.get('Layout'))

        return self

class CreateAppLayoutRequestLayout(DaraModel):
    def __init__(
        self,
        name: str = None,
        panes: List[main_models.CreateAppLayoutRequestLayoutPanes] = None,
    ):
        # This parameter is required.
        self.name = name
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Panes') is not None:
            for k1 in m.get('Panes'):
                temp_model = main_models.CreateAppLayoutRequestLayoutPanes()
                self.panes.append(temp_model.from_map(k1))

        return self

class CreateAppLayoutRequestLayoutPanes(DaraModel):
    def __init__(
        self,
        height: float = None,
        pane_id: int = None,

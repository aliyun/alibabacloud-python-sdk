...
class CreateAppAgentTemplateRequest(DaraModel):
    def __init__(
        self,
        agent_silence_config: main_models.CreateAppAgentTemplateRequestAgentSilenceConfig = None,
        ambient_sound_config: main_models.CreateAppAgentTemplateRequestAmbientSoundConfig = None,
        app_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AgentSilenceConfig') is not None:
            temp_model = main_models.CreateAppAgentTemplateRequestAgentSilenceConfig()
            self.agent_silence_config = temp_model.from_map(m.get('AgentSilenceConfig'))

        if m.get('AmbientSoundConfig') is not None:
            temp_model = main_models.CreateAppAgentTemplateRequestAmbientSoundConfig()
        ...
        if m.get('AsrConfig') is not None:
            temp_model = main_models.CreateAppAgentTemplateRequestAsrConfig()
            self.asr_config = temp_model.from_map(m.get('AsrConfig'))

        if m.get('BackChannelConfig') is not None:
            temp_model = main_models.CreateAppAgentTemplateRequestBackChannelConfig()
        ...
        if m.get('InterruptConfig') is not None:
            temp_model = main_models.CreateAppAgentTemplateRequestInterruptConfig()
        ...
        if m.get('LlmConfig') is not None:
            temp_model = main_models.CreateAppAgentTemplateRequestLlmConfig()
...
class CreateAppAgentTemplateRequestTtsConfig(DaraModel):
    def __init__(
        self,
        api_key: str = None,
...
class CreateAppAgentTemplateRequestLlmConfig(DaraModel):
    def __init__(
        self,
...
class CreateAppAgentTemplateRequestInterruptConfig(DaraModel):
    def __init__(
        self,
...
class CreateAppAgentTemplateRequestBackChannelConfig(DaraModel):
    def __init__(
        self,
...
class CreateAppAgentTemplateRequestAsrConfig(DaraModel):
    def __init__(
        self,
        max_sentence_silence: int = None,
        name: str = None,
        vad_config: main_models.CreateAppAgentTemplateRequestAsrConfigVadConfig = None,
        word_weights: List[main_models.CreateAppAgentTemplateRequestAsrConfigWordWeights] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VadConfig') is not None:
            temp_model = main_models.CreateAppAgentTemplateRequestAsrConfigVadConfig()
            self.vad_config = temp_model.from_map(m.get('VadConfig'))

        self.word_weights = []
        if m.get('WordWeights') is not None:
            for k1 in m.get('WordWeights'):
                temp_model = main_models.CreateAppAgentTemplateRequestAsrConfigWordWeights()
                self.word_weights.append(temp_model.from_map(k1))

        return self

class CreateAppAgentTemplateRequestAsrConfigWordWeights(DaraModel):
    def __init__(
        self,
        lang: str = None,
        weight: int = None,
...
class CreateAppAgentTemplateRequestAsrConfigVadConfig(DaraModel):
    def __init__(
        self,
...
class CreateAppAgentTemplateRequestAmbientSoundConfig(DaraModel):
    def __init__(
        self,
        sound_id: str = None,
        volume: int = None,
...
class CreateAppAgentTemplateRequestAgentSilenceConfig(DaraModel):
    def __init__(
        self,

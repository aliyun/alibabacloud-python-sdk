...
class DescribeQualityAreaDistributionStatDataResponseBody(DaraModel):
    def __init__(
        self,
        quality_stat_data_list: List[main_models.DescribeQualityAreaDistributionStatDataResponseBodyQualityStatDataList] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('QualityStatDataList') is not None:
            for k1 in m.get('QualityStatDataList'):
                temp_model = main_models.DescribeQualityAreaDistributionStatDataResponseBodyQualityStatDataList()
...
class DescribeQualityAreaDistributionStatDataResponseBodyQualityStatDataList(DaraModel):
    def __init__(
        self,

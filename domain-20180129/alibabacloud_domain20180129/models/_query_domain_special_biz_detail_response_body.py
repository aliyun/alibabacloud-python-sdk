...
class QueryDomainSpecialBizDetailResponseBody(DaraModel):
    def __init__(
        self,
        ...
        module: main_models.QueryDomainSpecialBizDetailResponseBodyModule = None,
        request_id: str = None,
        success: bool = None,
        synchro: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.QueryDomainSpecialBizDetailResponseBodyModule()
...
class QueryDomainSpecialBizDetailResponseBodyModule(DaraModel):
    def __init__(
        self,
        audit_msg: str = None,
        biz_name: str = None,
        ...
        domain_special_biz_contact: main_models.QueryDomainSpecialBizDetailResponseBodyModuleDomainSpecialBizContact = None,
        domain_special_biz_credentials: List[main_models.QueryDomainSpecialBizDetailResponseBodyModuleDomainSpecialBizCredentials] = None,
        domain_special_order_result: main_models.QueryDomainSpecialBizDetailResponseBodyModuleDomainSpecialOrderResult = None,
        gmt_create: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DomainSpecialBizContact') is not None:
            temp_model = main_models.QueryDomainSpecialBizDetailResponseBodyModuleDomainSpecialBizContact()
        ...
        if m.get('DomainSpecialBizCredentials') is not None:
            for k1 in m.get('DomainSpecialBizCredentials'):
                temp_model = main_models.QueryDomainSpecialBizDetailResponseBodyModuleDomainSpecialBizCredentials()
                self.domain_special_biz_credentials.append(temp_model.from_map(k1))

        if m.get('DomainSpecialOrderResult') is not None:
            temp_model = main_models.QueryDomainSpecialBizDetailResponseBodyModuleDomainSpecialOrderResult()
            self.domain_special_order_result = temp_model.from_map(m.get('DomainSpecialOrderResult'))
...
class QueryDomainSpecialBizDetailResponseBodyModuleDomainSpecialOrderResult(DaraModel):
    def __init__(
        self,
...
class QueryDomainSpecialBizDetailResponseBodyModuleDomainSpecialBizCredentials(DaraModel):
    def __init__(
        self,
        biz_id: int = None,
...
class QueryDomainSpecialBizDetailResponseBodyModuleDomainSpecialBizContact(DaraModel):
    def __init__(
        self,
        biz_id: int = None,
        ccity: str = None,

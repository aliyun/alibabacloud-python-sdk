...
class QueryFailReasonForDomainRealNameVerificationResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.QueryFailReasonForDomainRealNameVerificationResponseBodyData()
...
class QueryFailReasonForDomainRealNameVerificationResponseBodyData(DaraModel):
    def __init__(
        self,
        date: str = None,

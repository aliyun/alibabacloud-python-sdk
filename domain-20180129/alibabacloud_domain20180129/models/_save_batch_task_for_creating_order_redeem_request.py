...
class SaveBatchTaskForCreatingOrderRedeemRequest(DaraModel):
    def __init__(
        self,
        coupon_no: str = None,
        lang: str = None,
        order_redeem_param: List[main_models.SaveBatchTaskForCreatingOrderRedeemRequestOrderRedeemParam] = None,
    ...
    def validate(self):
        if self.order_redeem_param:
            for v1 in self.order_redeem_param:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.order_redeem_param is not None:
            for k1 in self.order_redeem_param:
                result['OrderRedeemParam'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OrderRedeemParam') is not None:
            for k1 in m.get('OrderRedeemParam'):
                temp_model = main_models.SaveBatchTaskForCreatingOrderRedeemRequestOrderRedeemParam()
                self.order_redeem_param.append(temp_model.from_map(k1))
...
class SaveBatchTaskForCreatingOrderRedeemRequestOrderRedeemParam(DaraModel):
    def __init__(
        self,

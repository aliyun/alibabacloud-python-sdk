...
class DeleteEmailVerificationResponseBody(DaraModel):
    def __init__(
        self,
        fail_list: List[main_models.DeleteEmailVerificationResponseBodyFailList] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FailList') is not None:
            for k1 in m.get('FailList'):
                temp_model = main_models.DeleteEmailVerificationResponseBodyFailList()
        ...
        if m.get('SuccessList') is not None:
            for k1 in m.get('SuccessList'):
                temp_model = main_models.DeleteEmailVerificationResponseBodySuccessList()
                self.success_list.append(temp_model.from_map(k1))

        return self

class DeleteEmailVerificationResponseBodySuccessList(DaraModel):
    def __init__(
        self,
        code: str = None,
        email: str = None,
...
class DeleteEmailVerificationResponseBodyFailList(DaraModel):
    def __init__(
        self,
        code: str = None,
        email: str = None,

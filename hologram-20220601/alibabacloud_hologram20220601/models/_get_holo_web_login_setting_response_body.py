...
class GetHoloWebLoginSettingResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.GetHoloWebLoginSettingResponseBodyData = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetHoloWebLoginSettingResponseBodyData()
...
class GetHoloWebLoginSettingResponseBodyData(DaraModel):
    def __init__(
        self,

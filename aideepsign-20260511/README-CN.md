...
## Alibaba Cloud AIDeepSign SDK for Python
...
```bash
# 安装 alibabacloud_aideepsign20260511
pip install alibabacloud_aideepsign20260511
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/aideepsign-20260511/ChangeLog.md)中。

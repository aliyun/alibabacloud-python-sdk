...
class CreateSchemeConfigResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        model: main_models.CreateSchemeConfigResponseBodyModel = None,
        request_id: str = None,
        success: bool = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Model') is not None:
            temp_model = main_models.CreateSchemeConfigResponseBodyModel()
...
class CreateSchemeConfigResponseBodyModel(DaraModel):
    def __init__(
        self,

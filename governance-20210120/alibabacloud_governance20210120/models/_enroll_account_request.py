...
class EnrollAccountRequest(DaraModel):
    def __init__(
        self,
        account_name_prefix: str = None,
        account_uid: int = None,
        baseline_id: str = None,
        baseline_items: List[main_models.EnrollAccountRequestBaselineItems] = None,
        display_name: str = None,
        folder_id: str = None,
        payer_account_uid: int = None,
        region_id: str = None,
        resell_account_type: str = None,
        tag: List[main_models.EnrollAccountRequestTag] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BaselineItems') is not None:
            for k1 in m.get('BaselineItems'):
                temp_model = main_models.EnrollAccountRequestBaselineItems()
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.EnrollAccountRequestTag()
                self.tag.append(temp_model.from_map(k1))

        return self

class EnrollAccountRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class EnrollAccountRequestBaselineItems(DaraModel):
    def __init__(
        self,
        config: str = None,
        name: str = None,

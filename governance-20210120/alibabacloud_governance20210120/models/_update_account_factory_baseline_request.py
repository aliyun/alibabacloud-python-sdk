...
class UpdateAccountFactoryBaselineRequest(DaraModel):
    def __init__(
        self,
        baseline_id: str = None,
        baseline_items: List[main_models.UpdateAccountFactoryBaselineRequestBaselineItems] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BaselineItems') is not None:
            for k1 in m.get('BaselineItems'):
                temp_model = main_models.UpdateAccountFactoryBaselineRequestBaselineItems()
...
class UpdateAccountFactoryBaselineRequestBaselineItems(DaraModel):
    def __init__(
        self,
        config: str = None,
        name: str = None,

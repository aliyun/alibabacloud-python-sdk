...
## Alibaba Cloud Dyvmsapi-intl SDK for Python
...
```bash
# 安装 alibabacloud_dyvmsapi_intl20211015
pip install alibabacloud_dyvmsapi_intl20211015
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/dyvmsapi-intl-20211015/ChangeLog.md)中。

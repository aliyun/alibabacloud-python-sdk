...
## Alibaba Cloud Eci SDK for Python
...
```bash
# 安装 alibabacloud_eci20180808
pip install alibabacloud_eci20180808
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/eci-20180808/ChangeLog.md)中。

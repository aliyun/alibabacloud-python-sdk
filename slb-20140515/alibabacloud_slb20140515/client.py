...
class Client(OpenApiClient):
    ...
    *\
    ...
    def describe_health_status_ex_with_options(
        self,
        request: slb_20140515_models.DescribeHealthStatusExRequest,
        runtime: util_models.RuntimeOptions,
    ) -> slb_20140515_models.DescribeHealthStatusExResponse:
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.listener_port):
            query['ListenerPort'] = request.listener_port
    ...
    async def describe_health_status_ex_with_options_async(
        self,
        request: slb_20140515_models.DescribeHealthStatusExRequest,
        runtime: util_models.RuntimeOptions,
    ) -> slb_20140515_models.DescribeHealthStatusExResponse:
    ...
    def describe_health_status_ex(
        self,
        request: slb_20140515_models.DescribeHealthStatusExRequest,
    ) -> slb_20140515_models.DescribeHealthStatusExResponse:
        runtime = util_models.RuntimeOptions()
        return self.describe_health_status_ex_with_options(request, runtime)

    async def describe_health_status_ex_async(
        self,
        request: slb_20140515_models.DescribeHealthStatusExRequest,
    ) -> slb_20140515_models.DescribeHealthStatusExResponse:
        runtime = util_models.RuntimeOptions()
        return await self.describe_health_status_ex_with_options_async(request, runtime)

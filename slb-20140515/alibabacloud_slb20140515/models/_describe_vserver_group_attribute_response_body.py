...
class DescribeVServerGroupAttributeResponseBody(DaraModel):
    def __init__(
        self,
        backend_servers: main_models.DescribeVServerGroupAttributeResponseBodyBackendServers = None,
        create_time: str = None,
        load_balancer_id: str = None,
        request_id: str = None,
        tags: main_models.DescribeVServerGroupAttributeResponseBodyTags = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BackendServers') is not None:
            temp_model = main_models.DescribeVServerGroupAttributeResponseBodyBackendServers()
        ...
        if m.get('Tags') is not None:
            temp_model = main_models.DescribeVServerGroupAttributeResponseBodyTags()
...
class DescribeVServerGroupAttributeResponseBodyTags(DaraModel):
    def __init__(
        self,
        tag: List[main_models.DescribeVServerGroupAttributeResponseBodyTagsTag] = None,
    ):
        self.tag = tag
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.DescribeVServerGroupAttributeResponseBodyTagsTag()
                self.tag.append(temp_model.from_map(k1))

        return self

class DescribeVServerGroupAttributeResponseBodyTagsTag(DaraModel):
    def __init__(
        self,
        tag_key: str = None,
        tag_value: str = None,
...
class DescribeVServerGroupAttributeResponseBodyBackendServers(DaraModel):
    def __init__(
        self,
        backend_server: List[main_models.DescribeVServerGroupAttributeResponseBodyBackendServersBackendServer] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BackendServer') is not None:
            for k1 in m.get('BackendServer'):
                temp_model = main_models.DescribeVServerGroupAttributeResponseBodyBackendServersBackendServer()
                self.backend_server.append(temp_model.from_map(k1))

        return self

class DescribeVServerGroupAttributeResponseBodyBackendServersBackendServer(DaraModel):
    def __init__(
        self,

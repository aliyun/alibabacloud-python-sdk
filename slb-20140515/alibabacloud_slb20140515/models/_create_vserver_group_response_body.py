...
class CreateVServerGroupResponseBody(DaraModel):
    def __init__(
        self,
        backend_servers: main_models.CreateVServerGroupResponseBodyBackendServers = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BackendServers') is not None:
            temp_model = main_models.CreateVServerGroupResponseBodyBackendServers()
...
class CreateVServerGroupResponseBodyBackendServers(DaraModel):
    def __init__(
        self,
        backend_server: List[main_models.CreateVServerGroupResponseBodyBackendServersBackendServer] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BackendServer') is not None:
            for k1 in m.get('BackendServer'):
                temp_model = main_models.CreateVServerGroupResponseBodyBackendServersBackendServer()
                self.backend_server.append(temp_model.from_map(k1))

        return self

class CreateVServerGroupResponseBodyBackendServersBackendServer(DaraModel):
    def __init__(
        self,

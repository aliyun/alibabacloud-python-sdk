...
class SetBackendServersResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BackendServers') is not None:
            temp_model = main_models.SetBackendServersResponseBodyBackendServers()
...
class SetBackendServersResponseBodyBackendServers(DaraModel):
    def __init__(
        self,
        backend_server: List[main_models.SetBackendServersResponseBodyBackendServersBackendServer] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BackendServer') is not None:
            for k1 in m.get('BackendServer'):
                temp_model = main_models.SetBackendServersResponseBodyBackendServersBackendServer()
                self.backend_server.append(temp_model.from_map(k1))

        return self

class SetBackendServersResponseBodyBackendServersBackendServer(DaraModel):
    def __init__(
        self,

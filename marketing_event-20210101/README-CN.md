...
```bash
# 安装 alibabacloud_marketing_event20210101
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/marketing_event-20210101/ChangeLog.md)中。

...
class QueryAllActivityInfoResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: str = None,
        data: List[main_models.QueryAllActivityInfoResponseBodyData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.QueryAllActivityInfoResponseBodyData()
...
class QueryAllActivityInfoResponseBodyData(DaraModel):
    def __init__(
        self,

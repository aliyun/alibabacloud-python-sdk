...
class QueryOrderSessionListPopResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        data: List[main_models.QueryOrderSessionListPopResponseBodyData] = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.QueryOrderSessionListPopResponseBodyData()
...
class QueryOrderSessionListPopResponseBodyData(DaraModel):
    def __init__(
        self,
        session_id: int = None,

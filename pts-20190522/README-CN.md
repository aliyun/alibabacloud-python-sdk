...
```bash
# 安装 alibabacloud_pts20190522
pip install alibabacloud_pts20190522
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/pts-20190522/ChangeLog.md)中。

...
class ListExchangeDownstreamBindingsResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.ListExchangeDownstreamBindingsResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListExchangeDownstreamBindingsResponseBodyData()
...
class ListExchangeDownstreamBindingsResponseBodyData(DaraModel):
    def __init__(
        self,
        current_page: int = None,
        page_size: int = None,
        vo_list: main_models.ListExchangeDownstreamBindingsResponseBodyDataVoList = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VoList') is not None:
            temp_model = main_models.ListExchangeDownstreamBindingsResponseBodyDataVoList()
            self.vo_list = temp_model.from_map(m.get('VoList'))

        return self

class ListExchangeDownstreamBindingsResponseBodyDataVoList(DaraModel):
    def __init__(
        self,
        binding_vo: List[main_models.ListExchangeDownstreamBindingsResponseBodyDataVoListBindingVO] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BindingVO') is not None:
            for k1 in m.get('BindingVO'):
                temp_model = main_models.ListExchangeDownstreamBindingsResponseBodyDataVoListBindingVO()
                self.binding_vo.append(temp_model.from_map(k1))

        return self

class ListExchangeDownstreamBindingsResponseBodyDataVoListBindingVO(DaraModel):
    def __init__(
        self,
        argument: str = None,

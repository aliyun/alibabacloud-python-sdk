...
class QueryMessageByMessageIdResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.QueryMessageByMessageIdResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.QueryMessageByMessageIdResponseBodyData()
...
class QueryMessageByMessageIdResponseBodyData(DaraModel):
    def __init__(
        self,
        ...
        vo_list: List[main_models.QueryMessageByMessageIdResponseBodyDataVoList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VoList') is not None:
            for k1 in m.get('VoList'):
                temp_model = main_models.QueryMessageByMessageIdResponseBodyDataVoList()
                self.vo_list.append(temp_model.from_map(k1))

        return self

class QueryMessageByMessageIdResponseBodyDataVoList(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        body: str = None,

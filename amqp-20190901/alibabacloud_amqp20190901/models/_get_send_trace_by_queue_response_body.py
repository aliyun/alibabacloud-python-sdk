...
class GetSendTraceByQueueResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.GetSendTraceByQueueResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetSendTraceByQueueResponseBodyData()
...
class GetSendTraceByQueueResponseBodyData(DaraModel):
    def __init__(
        self,
        current_page: int = None,
        page_size: int = None,
        total_count: int = None,
        vo_list: List[main_models.GetSendTraceByQueueResponseBodyDataVoList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VoList') is not None:
            for k1 in m.get('VoList'):
                temp_model = main_models.GetSendTraceByQueueResponseBodyDataVoList()
                self.vo_list.append(temp_model.from_map(k1))

        return self

class GetSendTraceByQueueResponseBodyDataVoList(DaraModel):
    def __init__(
        self,
        code: str = None,
        exchange: str = None,

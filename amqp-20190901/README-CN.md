...
```bash
# 安装 alibabacloud_amqp20190901
pip install alibabacloud_amqp20190901
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/amqp-20190901/ChangeLog.md)中。

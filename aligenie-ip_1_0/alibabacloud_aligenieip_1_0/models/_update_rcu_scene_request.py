...
class UpdateRcuSceneRequest(DaraModel):
    def __init__(
        self,
        hotel_id: str = None,
        scene_id: str = None,
        scene_relation_ext_dto: main_models.UpdateRcuSceneRequestSceneRelationExtDTO = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SceneRelationExtDTO') is not None:
            temp_model = main_models.UpdateRcuSceneRequestSceneRelationExtDTO()
            self.scene_relation_ext_dto = temp_model.from_map(m.get('SceneRelationExtDTO'))

        return self

class UpdateRcuSceneRequestSceneRelationExtDTO(DaraModel):
    def __init__(
        self,

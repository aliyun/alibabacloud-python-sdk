...
class GetTrackListByMailFromAndTagNameResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TrackList') is not None:
            temp_model = main_models.GetTrackListByMailFromAndTagNameResponseBodyTrackList()
            self.track_list = temp_model.from_map(m.get('TrackList'))

        return self

class GetTrackListByMailFromAndTagNameResponseBodyTrackList(DaraModel):
    def __init__(
        self,
        stat: List[main_models.GetTrackListByMailFromAndTagNameResponseBodyTrackListStat] = None,
    ):
        self.stat = stat
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Stat') is not None:
            for k1 in m.get('Stat'):
                temp_model = main_models.GetTrackListByMailFromAndTagNameResponseBodyTrackListStat()
                self.stat.append(temp_model.from_map(k1))

        return self

class GetTrackListByMailFromAndTagNameResponseBodyTrackListStat(DaraModel):
    def __init__(
        self,

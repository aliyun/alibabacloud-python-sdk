...
class ListValidateFileRequest(TeaModel):
    def __init__(
        self,
        end_time: str = None,
...
class ListValidateFileResponseBodyFiles(TeaModel):
    def __init__(
        self,
        catch_all_num: str = None,
        complete_time: str = None,
...
class ListValidateFileResponseBody(TeaModel):
    def __init__(
        self,
        files: List[ListValidateFileResponseBodyFiles] = None,
        has_next: bool = None,
        page: int = None,
        page_size: int = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Files') is not None:
            for k in m.get('Files'):
                temp_model = ListValidateFileResponseBodyFiles()
...
class ListValidateFileResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ListValidateFileResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = ListValidateFileResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

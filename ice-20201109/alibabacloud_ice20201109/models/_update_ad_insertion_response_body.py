...
class UpdateAdInsertionResponseBody(DaraModel):
    def __init__(
        self,
        config: main_models.UpdateAdInsertionResponseBodyConfig = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Config') is not None:
            temp_model = main_models.UpdateAdInsertionResponseBodyConfig()
...
class UpdateAdInsertionResponseBodyConfig(DaraModel):
    def __init__(
        self,
        ad_marker_passthrough: str = None,
        ads_url: str = None,
        cdn_config: main_models.UpdateAdInsertionResponseBodyConfigCdnConfig = None,
        config_aliases: str = None,
        content_url_prefix: str = None,
        create_time: str = None,
        last_modified: str = None,
        manifest_endpoint_config: main_models.UpdateAdInsertionResponseBodyConfigManifestEndpointConfig = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CdnConfig') is not None:
            temp_model = main_models.UpdateAdInsertionResponseBodyConfigCdnConfig()
        ...
        if m.get('ManifestEndpointConfig') is not None:
            temp_model = main_models.UpdateAdInsertionResponseBodyConfigManifestEndpointConfig()
...
class UpdateAdInsertionResponseBodyConfigManifestEndpointConfig(DaraModel):
    def __init__(
        self,
...
class UpdateAdInsertionResponseBodyConfigCdnConfig(DaraModel):
    def __init__(
        self,

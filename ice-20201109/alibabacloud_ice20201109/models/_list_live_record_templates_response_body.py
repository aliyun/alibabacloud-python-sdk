...
class ListLiveRecordTemplatesResponseBody(DaraModel):
    def __init__(
        self,
        page_no: int = None,
        page_size: int = None,
        record_template_list: List[main_models.ListLiveRecordTemplatesResponseBodyRecordTemplateList] = None,
        request_id: str = None,
        sort_by: str = None,
    ...
    def validate(self):
        if self.record_template_list:
            for v1 in self.record_template_list:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.record_template_list is not None:
            for k1 in self.record_template_list:
                result['RecordTemplateList'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RecordTemplateList') is not None:
            for k1 in m.get('RecordTemplateList'):
                temp_model = main_models.ListLiveRecordTemplatesResponseBodyRecordTemplateList()
                self.record_template_list.append(temp_model.from_map(k1))
...
class ListLiveRecordTemplatesResponseBodyRecordTemplateList(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        last_modified: str = None,
        name: str = None,
        record_format_list: List[main_models.ListLiveRecordTemplatesResponseBodyRecordTemplateListRecordFormatList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RecordFormatList') is not None:
            for k1 in m.get('RecordFormatList'):
                temp_model = main_models.ListLiveRecordTemplatesResponseBodyRecordTemplateListRecordFormatList()
...
class ListLiveRecordTemplatesResponseBodyRecordTemplateListRecordFormatList(DaraModel):
    def __init__(
        self,

...
class CreateMediaLiveChannelRequest(DaraModel):
    def __init__(
        self,
        audio_settings: List[main_models.CreateMediaLiveChannelRequestAudioSettings] = None,
        input_attachments: List[main_models.CreateMediaLiveChannelRequestInputAttachments] = None,
        name: str = None,
        output_groups: List[main_models.CreateMediaLiveChannelRequestOutputGroups] = None,
        video_settings: List[main_models.CreateMediaLiveChannelRequestVideoSettings] = None,
    ):
        # The audio settings.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioSettings') is not None:
            for k1 in m.get('AudioSettings'):
                temp_model = main_models.CreateMediaLiveChannelRequestAudioSettings()
        ...
        if m.get('InputAttachments') is not None:
            for k1 in m.get('InputAttachments'):
                temp_model = main_models.CreateMediaLiveChannelRequestInputAttachments()
        ...
        if m.get('OutputGroups') is not None:
            for k1 in m.get('OutputGroups'):
                temp_model = main_models.CreateMediaLiveChannelRequestOutputGroups()
                self.output_groups.append(temp_model.from_map(k1))

        self.video_settings = []
        if m.get('VideoSettings') is not None:
            for k1 in m.get('VideoSettings'):
                temp_model = main_models.CreateMediaLiveChannelRequestVideoSettings()
                self.video_settings.append(temp_model.from_map(k1))

        return self

class CreateMediaLiveChannelRequestVideoSettings(DaraModel):
    def __init__(
        self,
        height: int = None,
        name: str = None,
        video_codec: str = None,
        video_codec_setting: main_models.CreateMediaLiveChannelRequestVideoSettingsVideoCodecSetting = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VideoCodecSetting') is not None:
            temp_model = main_models.CreateMediaLiveChannelRequestVideoSettingsVideoCodecSetting()
...
class CreateMediaLiveChannelRequestVideoSettingsVideoCodecSetting(DaraModel):
    def __init__(
        self,
        codec_detail: main_models.CreateMediaLiveChannelRequestVideoSettingsVideoCodecSettingCodecDetail = None,
        framerate: main_models.CreateMediaLiveChannelRequestVideoSettingsVideoCodecSettingFramerate = None,
        gop: main_models.CreateMediaLiveChannelRequestVideoSettingsVideoCodecSettingGop = None,
        rate: main_models.CreateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate = None,
    ):
        # The video encoding settings.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CodecDetail') is not None:
            temp_model = main_models.CreateMediaLiveChannelRequestVideoSettingsVideoCodecSettingCodecDetail()
            self.codec_detail = temp_model.from_map(m.get('CodecDetail'))

        if m.get('Framerate') is not None:
            temp_model = main_models.CreateMediaLiveChannelRequestVideoSettingsVideoCodecSettingFramerate()
            self.framerate = temp_model.from_map(m.get('Framerate'))

        if m.get('Gop') is not None:
            temp_model = main_models.CreateMediaLiveChannelRequestVideoSettingsVideoCodecSettingGop()
            self.gop = temp_model.from_map(m.get('Gop'))

        if m.get('Rate') is not None:
            temp_model = main_models.CreateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate()
            self.rate = temp_model.from_map(m.get('Rate'))

        return self

class CreateMediaLiveChannelRequestVideoSettingsVideoCodecSettingRate(DaraModel):
    def __init__(
        self,
        bitrate: int = None,
...
class CreateMediaLiveChannelRequestVideoSettingsVideoCodecSettingGop(DaraModel):
    def __init__(
        self,
...
class CreateMediaLiveChannelRequestVideoSettingsVideoCodecSettingFramerate(DaraModel):
    def __init__(
        self,
...
class CreateMediaLiveChannelRequestVideoSettingsVideoCodecSettingCodecDetail(DaraModel):
    def __init__(
        self,
        level: str = None,
        profile: str = None,
...
class CreateMediaLiveChannelRequestOutputGroups(DaraModel):
    def __init__(
        self,
        media_package_group_setting: main_models.CreateMediaLiveChannelRequestOutputGroupsMediaPackageGroupSetting = None,
        name: str = None,
        outputs: List[main_models.CreateMediaLiveChannelRequestOutputGroupsOutputs] = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MediaPackageGroupSetting') is not None:
            temp_model = main_models.CreateMediaLiveChannelRequestOutputGroupsMediaPackageGroupSetting()
        ...
        if m.get('Outputs') is not None:
            for k1 in m.get('Outputs'):
                temp_model = main_models.CreateMediaLiveChannelRequestOutputGroupsOutputs()
...
class CreateMediaLiveChannelRequestOutputGroupsOutputs(DaraModel):
    def __init__(
        self,
        audio_setting_names: List[str] = None,
        media_package_output_setting: main_models.CreateMediaLiveChannelRequestOutputGroupsOutputsMediaPackageOutputSetting = None,
        media_type: int = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MediaPackageOutputSetting') is not None:
            temp_model = main_models.CreateMediaLiveChannelRequestOutputGroupsOutputsMediaPackageOutputSetting()
...
class CreateMediaLiveChannelRequestOutputGroupsOutputsMediaPackageOutputSetting(DaraModel):
    def __init__(
        self,
...
class CreateMediaLiveChannelRequestOutputGroupsMediaPackageGroupSetting(DaraModel):
    def __init__(
        self,
...
class CreateMediaLiveChannelRequestInputAttachments(DaraModel):
    def __init__(
        self,
        audio_selectors: List[main_models.CreateMediaLiveChannelRequestInputAttachmentsAudioSelectors] = None,
        input_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioSelectors') is not None:
            for k1 in m.get('AudioSelectors'):
                temp_model = main_models.CreateMediaLiveChannelRequestInputAttachmentsAudioSelectors()
...
class CreateMediaLiveChannelRequestInputAttachmentsAudioSelectors(DaraModel):
    def __init__(
        self,
        audio_language_selection: main_models.CreateMediaLiveChannelRequestInputAttachmentsAudioSelectorsAudioLanguageSelection = None,
        audio_pid_selection: main_models.CreateMediaLiveChannelRequestInputAttachmentsAudioSelectorsAudioPidSelection = None,
        audio_track_selection: List[main_models.CreateMediaLiveChannelRequestInputAttachmentsAudioSelectorsAudioTrackSelection] = None,
        name: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioLanguageSelection') is not None:
            temp_model = main_models.CreateMediaLiveChannelRequestInputAttachmentsAudioSelectorsAudioLanguageSelection()
            self.audio_language_selection = temp_model.from_map(m.get('AudioLanguageSelection'))

        if m.get('AudioPidSelection') is not None:
            temp_model = main_models.CreateMediaLiveChannelRequestInputAttachmentsAudioSelectorsAudioPidSelection()
        ...
        if m.get('AudioTrackSelection') is not None:
            for k1 in m.get('AudioTrackSelection'):
                temp_model = main_models.CreateMediaLiveChannelRequestInputAttachmentsAudioSelectorsAudioTrackSelection()
...
class CreateMediaLiveChannelRequestInputAttachmentsAudioSelectorsAudioTrackSelection(DaraModel):
    def __init__(
        self,
        track_id: int = None,
    ):
...
class CreateMediaLiveChannelRequestInputAttachmentsAudioSelectorsAudioPidSelection(DaraModel):
    def __init__(
        self,
        pid: int = None,
    ):
...
class CreateMediaLiveChannelRequestInputAttachmentsAudioSelectorsAudioLanguageSelection(DaraModel):
    def __init__(
        self,
...
class CreateMediaLiveChannelRequestAudioSettings(DaraModel):
    def __init__(
        self,
        audio_codec: str = None,
        audio_codec_setting: main_models.CreateMediaLiveChannelRequestAudioSettingsAudioCodecSetting = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioCodecSetting') is not None:
            temp_model = main_models.CreateMediaLiveChannelRequestAudioSettingsAudioCodecSetting()
...
class CreateMediaLiveChannelRequestAudioSettingsAudioCodecSetting(DaraModel):
    def __init__(
        self,
        bitrate: int = None,
        profile: str = None,

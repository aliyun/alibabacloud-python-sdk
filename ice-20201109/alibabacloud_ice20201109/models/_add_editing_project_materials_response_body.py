...
class AddEditingProjectMaterialsResponseBody(DaraModel):
    def __init__(
        self,
        live_materials: List[main_models.AddEditingProjectMaterialsResponseBodyLiveMaterials] = None,
        media_infos: List[main_models.AddEditingProjectMaterialsResponseBodyMediaInfos] = None,
        project_id: str = None,
    ...
    def to_map(self):
        ...
        if self.live_materials is not None:
            for k1 in self.live_materials:
                result['LiveMaterials'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LiveMaterials') is not None:
            for k1 in m.get('LiveMaterials'):
                temp_model = main_models.AddEditingProjectMaterialsResponseBodyLiveMaterials()
                self.live_materials.append(temp_model.from_map(k1))

        self.media_infos = []
        if m.get('MediaInfos') is not None:
            for k1 in m.get('MediaInfos'):
                temp_model = main_models.AddEditingProjectMaterialsResponseBodyMediaInfos()
...
class AddEditingProjectMaterialsResponseBodyMediaInfos(DaraModel):
    def __init__(
        self,
        file_info_list: List[main_models.AddEditingProjectMaterialsResponseBodyMediaInfosFileInfoList] = None,
        media_basic_info: main_models.AddEditingProjectMaterialsResponseBodyMediaInfosMediaBasicInfo = None,
        media_id: str = None,
    ):
        # FileInfos
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FileInfoList') is not None:
            for k1 in m.get('FileInfoList'):
                temp_model = main_models.AddEditingProjectMaterialsResponseBodyMediaInfosFileInfoList()
                self.file_info_list.append(temp_model.from_map(k1))

        if m.get('MediaBasicInfo') is not None:
            temp_model = main_models.AddEditingProjectMaterialsResponseBodyMediaInfosMediaBasicInfo()
...
class AddEditingProjectMaterialsResponseBodyMediaInfosMediaBasicInfo(DaraModel):
    def __init__(
        self,
...
class AddEditingProjectMaterialsResponseBodyMediaInfosFileInfoList(DaraModel):
    def __init__(
        self,
        file_basic_info: main_models.AddEditingProjectMaterialsResponseBodyMediaInfosFileInfoListFileBasicInfo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FileBasicInfo') is not None:
            temp_model = main_models.AddEditingProjectMaterialsResponseBodyMediaInfosFileInfoListFileBasicInfo()
            self.file_basic_info = temp_model.from_map(m.get('FileBasicInfo'))

        return self

class AddEditingProjectMaterialsResponseBodyMediaInfosFileInfoListFileBasicInfo(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        duration: str = None,
...
class AddEditingProjectMaterialsResponseBodyLiveMaterials(DaraModel):
    def __init__(
        self,
        app_name: str = None,

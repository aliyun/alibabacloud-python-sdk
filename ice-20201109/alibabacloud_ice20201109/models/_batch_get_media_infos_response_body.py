...
class BatchGetMediaInfosResponseBodyMediaInfosFileInfoList(DaraModel):
    def __init__(
        self,
        audio_stream_info_list: List[main_models.BatchGetMediaInfosResponseBodyMediaInfosFileInfoListAudioStreamInfoList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioStreamInfoList') is not None:
            for k1 in m.get('AudioStreamInfoList'):
                temp_model = main_models.BatchGetMediaInfosResponseBodyMediaInfosFileInfoListAudioStreamInfoList()
        ...
        if m.get('SubtitleStreamInfoList') is not None:
            for k1 in m.get('SubtitleStreamInfoList'):
                temp_model = main_models.BatchGetMediaInfosResponseBodyMediaInfosFileInfoListSubtitleStreamInfoList()
        ...
        if m.get('VideoStreamInfoList') is not None:
            for k1 in m.get('VideoStreamInfoList'):
                temp_model = main_models.BatchGetMediaInfosResponseBodyMediaInfosFileInfoListVideoStreamInfoList()
                self.video_stream_info_list.append(temp_model.from_map(k1))

        return self

class BatchGetMediaInfosResponseBodyMediaInfosFileInfoListVideoStreamInfoList(DaraModel):
    def __init__(
        self,
        avg_fps: str = None,
        bitrate: str = None,
...
class BatchGetMediaInfosResponseBodyMediaInfosFileInfoListSubtitleStreamInfoList(DaraModel):
    def __init__(
        self,
        codec_long_name: str = None,
        codec_name: str = None,
...
class BatchGetMediaInfosResponseBodyMediaInfosFileInfoListAudioStreamInfoList(DaraModel):
    def __init__(
        self,
        bitrate: str = None,

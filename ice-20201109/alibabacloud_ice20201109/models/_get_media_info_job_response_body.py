...
class GetMediaInfoJobResponseBody(DaraModel):
    def __init__(
        self,
        media_info_job: main_models.GetMediaInfoJobResponseBodyMediaInfoJob = None,
        request_id: str = None,
    ):
        # MediaInfoJobDTO
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MediaInfoJob') is not None:
            temp_model = main_models.GetMediaInfoJobResponseBodyMediaInfoJob()
...
class GetMediaInfoJobResponseBodyMediaInfoJob(DaraModel):
    def __init__(
        self,
        async_: bool = None,
        finish_time: str = None,
        input: main_models.GetMediaInfoJobResponseBodyMediaInfoJobInput = None,
        job_id: str = None,
        media_info_property: main_models.GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoProperty = None,
        name: str = None,
        request_id: str = None,
        schedule_config: main_models.GetMediaInfoJobResponseBodyMediaInfoJobScheduleConfig = None,
        status: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Input') is not None:
            temp_model = main_models.GetMediaInfoJobResponseBodyMediaInfoJobInput()
        ...
        if m.get('MediaInfoProperty') is not None:
            temp_model = main_models.GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoProperty()
        ...
        if m.get('ScheduleConfig') is not None:
            temp_model = main_models.GetMediaInfoJobResponseBodyMediaInfoJobScheduleConfig()
...
class GetMediaInfoJobResponseBodyMediaInfoJobScheduleConfig(DaraModel):
    def __init__(
        self,
...
class GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoProperty(DaraModel):
    def __init__(
        self,
        audio_stream_info_list: List[main_models.GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList] = None,
        file_basic_info: main_models.GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyFileBasicInfo = None,
        video_stream_info_list: List[main_models.GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyVideoStreamInfoList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioStreamInfoList') is not None:
            for k1 in m.get('AudioStreamInfoList'):
                temp_model = main_models.GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList()
                self.audio_stream_info_list.append(temp_model.from_map(k1))

        if m.get('FileBasicInfo') is not None:
            temp_model = main_models.GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyFileBasicInfo()
        ...
        if m.get('VideoStreamInfoList') is not None:
            for k1 in m.get('VideoStreamInfoList'):
                temp_model = main_models.GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyVideoStreamInfoList()
                self.video_stream_info_list.append(temp_model.from_map(k1))

        return self

class GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyVideoStreamInfoList(DaraModel):
    def __init__(
        self,
        avg_fps: str = None,
        bit_rate: str = None,
...
class GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyFileBasicInfo(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        duration: str = None,
...
class GetMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
...
class GetMediaInfoJobResponseBodyMediaInfoJobInput(DaraModel):
    def __init__(
        self,
        media: str = None,
        type: str = None,

...
class SubmitLiveTranscodeJobRequest(DaraModel):
    def __init__(
        self,
        name: str = None,
        start_mode: int = None,
        stream_input: main_models.SubmitLiveTranscodeJobRequestStreamInput = None,
        template_id: str = None,
        timed_config: main_models.SubmitLiveTranscodeJobRequestTimedConfig = None,
        transcode_output: main_models.SubmitLiveTranscodeJobRequestTranscodeOutput = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('StreamInput') is not None:
            temp_model = main_models.SubmitLiveTranscodeJobRequestStreamInput()
        ...
        if m.get('TimedConfig') is not None:
            temp_model = main_models.SubmitLiveTranscodeJobRequestTimedConfig()
            self.timed_config = temp_model.from_map(m.get('TimedConfig'))

        if m.get('TranscodeOutput') is not None:
            temp_model = main_models.SubmitLiveTranscodeJobRequestTranscodeOutput()
            self.transcode_output = temp_model.from_map(m.get('TranscodeOutput'))

        return self

class SubmitLiveTranscodeJobRequestTranscodeOutput(DaraModel):
    def __init__(
        self,
...
class SubmitLiveTranscodeJobRequestTimedConfig(DaraModel):
    def __init__(
        self,
        end_time: str = None,
        start_time: str = None,
...
class SubmitLiveTranscodeJobRequestStreamInput(DaraModel):
    def __init__(
        self,
        input_url: str = None,
        type: str = None,

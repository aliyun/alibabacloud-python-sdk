...
class GetSystemTemplateResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        system_template: main_models.GetSystemTemplateResponseBodySystemTemplate = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SystemTemplate') is not None:
            temp_model = main_models.GetSystemTemplateResponseBodySystemTemplate()
            self.system_template = temp_model.from_map(m.get('SystemTemplate'))

        return self

class GetSystemTemplateResponseBodySystemTemplate(DaraModel):
    def __init__(
        self,
        status: str = None,
        subtype: int = None,

...
class GetEditingProjectMaterialsResponseBody(DaraModel):
    def __init__(
        self,
        live_materials: List[main_models.GetEditingProjectMaterialsResponseBodyLiveMaterials] = None,
        media_infos: List[main_models.GetEditingProjectMaterialsResponseBodyMediaInfos] = None,
        project_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LiveMaterials') is not None:
            for k1 in m.get('LiveMaterials'):
                temp_model = main_models.GetEditingProjectMaterialsResponseBodyLiveMaterials()
                self.live_materials.append(temp_model.from_map(k1))

        self.media_infos = []
        if m.get('MediaInfos') is not None:
            for k1 in m.get('MediaInfos'):
                temp_model = main_models.GetEditingProjectMaterialsResponseBodyMediaInfos()
...
class GetEditingProjectMaterialsResponseBodyMediaInfos(DaraModel):
    def __init__(
        self,
        file_info_list: List[main_models.GetEditingProjectMaterialsResponseBodyMediaInfosFileInfoList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FileInfoList') is not None:
            for k1 in m.get('FileInfoList'):
                temp_model = main_models.GetEditingProjectMaterialsResponseBodyMediaInfosFileInfoList()
                self.file_info_list.append(temp_model.from_map(k1))

        if m.get('MediaBasicInfo') is not None:
            temp_model = main_models.GetEditingProjectMaterialsResponseBodyMediaInfosMediaBasicInfo()
...
class GetEditingProjectMaterialsResponseBodyMediaInfosMediaBasicInfo(DaraModel):
    def __init__(
        self,
...
class GetEditingProjectMaterialsResponseBodyMediaInfosFileInfoList(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FileBasicInfo') is not None:
            temp_model = main_models.GetEditingProjectMaterialsResponseBodyMediaInfosFileInfoListFileBasicInfo()
            self.file_basic_info = temp_model.from_map(m.get('FileBasicInfo'))

        return self

class GetEditingProjectMaterialsResponseBodyMediaInfosFileInfoListFileBasicInfo(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        duration: str = None,
...
class GetEditingProjectMaterialsResponseBodyLiveMaterials(DaraModel):
    def __init__(
        self,
        app_name: str = None,

...
class GetMediaLiveInputResponseBody(DaraModel):
    def __init__(
        self,
        input: main_models.GetMediaLiveInputResponseBodyInput = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Input') is not None:
            temp_model = main_models.GetMediaLiveInputResponseBodyInput()
...
class GetMediaLiveInputResponseBodyInput(DaraModel):
    def __init__(
        self,
        channel_ids: List[str] = None,
        create_time: str = None,
        input_id: str = None,
        input_infos: List[main_models.GetMediaLiveInputResponseBodyInputInputInfos] = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InputInfos') is not None:
            for k1 in m.get('InputInfos'):
                temp_model = main_models.GetMediaLiveInputResponseBodyInputInputInfos()
...
class GetMediaLiveInputResponseBodyInputInputInfos(DaraModel):
    def __init__(
        self,
        dest_host: str = None,
        flow_id: str = None,

...
class GetCustomTemplateResponseBody(DaraModel):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CustomTemplate') is not None:
            temp_model = main_models.GetCustomTemplateResponseBodyCustomTemplate()
...
class GetCustomTemplateResponseBodyCustomTemplate(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        frontend_hint: main_models.GetCustomTemplateResponseBodyCustomTemplateFrontendHint = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FrontendHint') is not None:
            temp_model = main_models.GetCustomTemplateResponseBodyCustomTemplateFrontendHint()
...
class GetCustomTemplateResponseBodyCustomTemplateFrontendHint(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TranscodeTemplateHint') is not None:
            temp_model = main_models.GetCustomTemplateResponseBodyCustomTemplateFrontendHintTranscodeTemplateHint()
            self.transcode_template_hint = temp_model.from_map(m.get('TranscodeTemplateHint'))

        return self

class GetCustomTemplateResponseBodyCustomTemplateFrontendHintTranscodeTemplateHint(DaraModel):
    def __init__(
        self,

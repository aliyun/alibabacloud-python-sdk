...
class SubmitTraceAbJobResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.SubmitTraceAbJobResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.SubmitTraceAbJobResponseBodyData()
...
class SubmitTraceAbJobResponseBodyData(DaraModel):
    def __init__(
        self,
        job_id: str = None,

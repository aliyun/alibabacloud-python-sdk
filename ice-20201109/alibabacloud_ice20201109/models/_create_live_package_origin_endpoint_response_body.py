...
class CreateLivePackageOriginEndpointResponseBody(DaraModel):
    def __init__(
        self,
        live_package_origin_endpoint: main_models.CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LivePackageOriginEndpoint') is not None:
            temp_model = main_models.CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint()
...
class CreateLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint(DaraModel):
    def __init__(
        self,

...
class CreateMediaLiveInputRequest(DaraModel):
    def __init__(
        self,
        input_settings: List[main_models.CreateMediaLiveInputRequestInputSettings] = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InputSettings') is not None:
            for k1 in m.get('InputSettings'):
                temp_model = main_models.CreateMediaLiveInputRequestInputSettings()
...
class CreateMediaLiveInputRequestInputSettings(DaraModel):
    def __init__(
        self,
        flow_id: str = None,

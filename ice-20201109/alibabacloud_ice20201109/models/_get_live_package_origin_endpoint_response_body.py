...
class GetLivePackageOriginEndpointResponseBody(DaraModel):
    def __init__(
        self,
        live_package_origin_endpoint: main_models.GetLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LivePackageOriginEndpoint') is not None:
            temp_model = main_models.GetLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint()
...
class GetLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint(DaraModel):
    def __init__(
        self,

...
class ListMediaInfoJobsResponseBody(DaraModel):
    def __init__(
        self,
        jobs: List[main_models.ListMediaInfoJobsResponseBodyJobs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Jobs') is not None:
            for k1 in m.get('Jobs'):
                temp_model = main_models.ListMediaInfoJobsResponseBodyJobs()
...
class ListMediaInfoJobsResponseBodyJobs(DaraModel):
    def __init__(
        self,
        async_: bool = None,
        finish_time: str = None,
        input: main_models.ListMediaInfoJobsResponseBodyJobsInput = None,
        job_id: str = None,
        media_info_property: main_models.ListMediaInfoJobsResponseBodyJobsMediaInfoProperty = None,
        name: str = None,
        request_id: str = None,
        schedule_config: main_models.ListMediaInfoJobsResponseBodyJobsScheduleConfig = None,
        status: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Input') is not None:
            temp_model = main_models.ListMediaInfoJobsResponseBodyJobsInput()
        ...
        if m.get('MediaInfoProperty') is not None:
            temp_model = main_models.ListMediaInfoJobsResponseBodyJobsMediaInfoProperty()
        ...
        if m.get('ScheduleConfig') is not None:
            temp_model = main_models.ListMediaInfoJobsResponseBodyJobsScheduleConfig()
...
class ListMediaInfoJobsResponseBodyJobsScheduleConfig(DaraModel):
    def __init__(
        self,
...
class ListMediaInfoJobsResponseBodyJobsMediaInfoProperty(DaraModel):
    def __init__(
        self,
        audio_stream_info_list: List[main_models.ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList] = None,
        file_basic_info: main_models.ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyFileBasicInfo = None,
        video_stream_info_list: List[main_models.ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioStreamInfoList') is not None:
            for k1 in m.get('AudioStreamInfoList'):
                temp_model = main_models.ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList()
                self.audio_stream_info_list.append(temp_model.from_map(k1))

        if m.get('FileBasicInfo') is not None:
            temp_model = main_models.ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyFileBasicInfo()
        ...
        if m.get('VideoStreamInfoList') is not None:
            for k1 in m.get('VideoStreamInfoList'):
                temp_model = main_models.ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList()
                self.video_stream_info_list.append(temp_model.from_map(k1))

        return self

class ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyVideoStreamInfoList(DaraModel):
    def __init__(
        self,
        avg_fps: str = None,
        bit_rate: str = None,
...
class ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyFileBasicInfo(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        duration: str = None,
...
class ListMediaInfoJobsResponseBodyJobsMediaInfoPropertyAudioStreamInfoList(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
...
class ListMediaInfoJobsResponseBodyJobsInput(DaraModel):
    def __init__(
        self,
        media: str = None,
        type: str = None,

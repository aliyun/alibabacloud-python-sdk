...
class UpdateLivePackageChannelGroupResponseBody(DaraModel):
    def __init__(
        self,
        live_package_channel_group: main_models.UpdateLivePackageChannelGroupResponseBodyLivePackageChannelGroup = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LivePackageChannelGroup') is not None:
            temp_model = main_models.UpdateLivePackageChannelGroupResponseBodyLivePackageChannelGroup()
...
class UpdateLivePackageChannelGroupResponseBodyLivePackageChannelGroup(DaraModel):
    def __init__(
        self,

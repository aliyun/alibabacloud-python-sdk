...
class ListMediaProducingJobsResponseBody(DaraModel):
    def __init__(
        self,
        max_results: str = None,
        media_producing_job_list: List[main_models.ListMediaProducingJobsResponseBodyMediaProducingJobList] = None,
        next_token: str = None,
        request_id: str = None,
    ):
    ...
    def validate(self):
        if self.media_producing_job_list:
            for v1 in self.media_producing_job_list:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.media_producing_job_list is not None:
            for k1 in self.media_producing_job_list:
                result['MediaProducingJobList'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MediaProducingJobList') is not None:
            for k1 in m.get('MediaProducingJobList'):
                temp_model = main_models.ListMediaProducingJobsResponseBodyMediaProducingJobList()
                self.media_producing_job_list.append(temp_model.from_map(k1))
...
class ListMediaProducingJobsResponseBodyMediaProducingJobList(DaraModel):
    def __init__(
        self,

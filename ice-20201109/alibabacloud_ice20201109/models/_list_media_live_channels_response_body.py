...
class ListMediaLiveChannelsResponseBody(DaraModel):
    def __init__(
        self,
        channels: List[main_models.ListMediaLiveChannelsResponseBodyChannels] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Channels') is not None:
            for k1 in m.get('Channels'):
                temp_model = main_models.ListMediaLiveChannelsResponseBodyChannels()
...
class ListMediaLiveChannelsResponseBodyChannels(DaraModel):
    def __init__(
        self,
        audio_settings: List[main_models.ListMediaLiveChannelsResponseBodyChannelsAudioSettings] = None,
        channel_id: str = None,
        create_time: str = None,
        input_attachments: List[main_models.ListMediaLiveChannelsResponseBodyChannelsInputAttachments] = None,
        last_start_time: str = None,
        last_stop_time: str = None,
        name: str = None,
        output_groups: List[main_models.ListMediaLiveChannelsResponseBodyChannelsOutputGroups] = None,
        state: str = None,
        video_settings: List[main_models.ListMediaLiveChannelsResponseBodyChannelsVideoSettings] = None,
    ):
        # The audio settings.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioSettings') is not None:
            for k1 in m.get('AudioSettings'):
                temp_model = main_models.ListMediaLiveChannelsResponseBodyChannelsAudioSettings()
        ...
        if m.get('InputAttachments') is not None:
            for k1 in m.get('InputAttachments'):
                temp_model = main_models.ListMediaLiveChannelsResponseBodyChannelsInputAttachments()
        ...
        if m.get('OutputGroups') is not None:
            for k1 in m.get('OutputGroups'):
                temp_model = main_models.ListMediaLiveChannelsResponseBodyChannelsOutputGroups()
        ...
        if m.get('VideoSettings') is not None:
            for k1 in m.get('VideoSettings'):
                temp_model = main_models.ListMediaLiveChannelsResponseBodyChannelsVideoSettings()
                self.video_settings.append(temp_model.from_map(k1))

        return self

class ListMediaLiveChannelsResponseBodyChannelsVideoSettings(DaraModel):
    def __init__(
        self,
        height: int = None,
        name: str = None,
        video_codec: str = None,
        video_codec_setting: main_models.ListMediaLiveChannelsResponseBodyChannelsVideoSettingsVideoCodecSetting = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VideoCodecSetting') is not None:
            temp_model = main_models.ListMediaLiveChannelsResponseBodyChannelsVideoSettingsVideoCodecSetting()
...
class ListMediaLiveChannelsResponseBodyChannelsVideoSettingsVideoCodecSetting(DaraModel):
    def __init__(
        self,
        codec_detail: main_models.ListMediaLiveChannelsResponseBodyChannelsVideoSettingsVideoCodecSettingCodecDetail = None,
        framerate: main_models.ListMediaLiveChannelsResponseBodyChannelsVideoSettingsVideoCodecSettingFramerate = None,
        gop: main_models.ListMediaLiveChannelsResponseBodyChannelsVideoSettingsVideoCodecSettingGop = None,
        rate: main_models.ListMediaLiveChannelsResponseBodyChannelsVideoSettingsVideoCodecSettingRate = None,
    ):
        # The video encoding settings.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CodecDetail') is not None:
            temp_model = main_models.ListMediaLiveChannelsResponseBodyChannelsVideoSettingsVideoCodecSettingCodecDetail()
            self.codec_detail = temp_model.from_map(m.get('CodecDetail'))

        if m.get('Framerate') is not None:
            temp_model = main_models.ListMediaLiveChannelsResponseBodyChannelsVideoSettingsVideoCodecSettingFramerate()
            self.framerate = temp_model.from_map(m.get('Framerate'))

        if m.get('Gop') is not None:
            temp_model = main_models.ListMediaLiveChannelsResponseBodyChannelsVideoSettingsVideoCodecSettingGop()
            self.gop = temp_model.from_map(m.get('Gop'))

        if m.get('Rate') is not None:
            temp_model = main_models.ListMediaLiveChannelsResponseBodyChannelsVideoSettingsVideoCodecSettingRate()
            self.rate = temp_model.from_map(m.get('Rate'))

        return self

class ListMediaLiveChannelsResponseBodyChannelsVideoSettingsVideoCodecSettingRate(DaraModel):
    def __init__(
        self,
        bitrate: int = None,
...
class ListMediaLiveChannelsResponseBodyChannelsVideoSettingsVideoCodecSettingGop(DaraModel):
    def __init__(
        self,
...
class ListMediaLiveChannelsResponseBodyChannelsVideoSettingsVideoCodecSettingFramerate(DaraModel):
    def __init__(
        self,
...
class ListMediaLiveChannelsResponseBodyChannelsVideoSettingsVideoCodecSettingCodecDetail(DaraModel):
    def __init__(
        self,
        level: str = None,
        profile: str = None,
...
class ListMediaLiveChannelsResponseBodyChannelsOutputGroups(DaraModel):
    def __init__(
        self,
        media_package_group_setting: main_models.ListMediaLiveChannelsResponseBodyChannelsOutputGroupsMediaPackageGroupSetting = None,
        monitor_url: str = None,
        name: str = None,
        outputs: List[main_models.ListMediaLiveChannelsResponseBodyChannelsOutputGroupsOutputs] = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MediaPackageGroupSetting') is not None:
            temp_model = main_models.ListMediaLiveChannelsResponseBodyChannelsOutputGroupsMediaPackageGroupSetting()
        ...
        if m.get('Outputs') is not None:
            for k1 in m.get('Outputs'):
                temp_model = main_models.ListMediaLiveChannelsResponseBodyChannelsOutputGroupsOutputs()
...
class ListMediaLiveChannelsResponseBodyChannelsOutputGroupsOutputs(DaraModel):
    def __init__(
        self,
        audio_setting_names: List[str] = None,
        media_package_output_setting: main_models.ListMediaLiveChannelsResponseBodyChannelsOutputGroupsOutputsMediaPackageOutputSetting = None,
        media_type: int = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MediaPackageOutputSetting') is not None:
            temp_model = main_models.ListMediaLiveChannelsResponseBodyChannelsOutputGroupsOutputsMediaPackageOutputSetting()
...
class ListMediaLiveChannelsResponseBodyChannelsOutputGroupsOutputsMediaPackageOutputSetting(DaraModel):
    def __init__(
        self,
...
class ListMediaLiveChannelsResponseBodyChannelsOutputGroupsMediaPackageGroupSetting(DaraModel):
    def __init__(
        self,
...
class ListMediaLiveChannelsResponseBodyChannelsInputAttachments(DaraModel):
    def __init__(
        self,
        audio_selectors: List[main_models.ListMediaLiveChannelsResponseBodyChannelsInputAttachmentsAudioSelectors] = None,
        input_id: str = None,
        input_name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioSelectors') is not None:
            for k1 in m.get('AudioSelectors'):
                temp_model = main_models.ListMediaLiveChannelsResponseBodyChannelsInputAttachmentsAudioSelectors()
...
class ListMediaLiveChannelsResponseBodyChannelsInputAttachmentsAudioSelectors(DaraModel):
    def __init__(
        self,
        audio_language_selection: main_models.ListMediaLiveChannelsResponseBodyChannelsInputAttachmentsAudioSelectorsAudioLanguageSelection = None,
        audio_pid_selection: main_models.ListMediaLiveChannelsResponseBodyChannelsInputAttachmentsAudioSelectorsAudioPidSelection = None,
        audio_track_selection: List[main_models.ListMediaLiveChannelsResponseBodyChannelsInputAttachmentsAudioSelectorsAudioTrackSelection] = None,
        name: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioLanguageSelection') is not None:
            temp_model = main_models.ListMediaLiveChannelsResponseBodyChannelsInputAttachmentsAudioSelectorsAudioLanguageSelection()
            self.audio_language_selection = temp_model.from_map(m.get('AudioLanguageSelection'))

        if m.get('AudioPidSelection') is not None:
            temp_model = main_models.ListMediaLiveChannelsResponseBodyChannelsInputAttachmentsAudioSelectorsAudioPidSelection()
        ...
        if m.get('AudioTrackSelection') is not None:
            for k1 in m.get('AudioTrackSelection'):
                temp_model = main_models.ListMediaLiveChannelsResponseBodyChannelsInputAttachmentsAudioSelectorsAudioTrackSelection()
...
class ListMediaLiveChannelsResponseBodyChannelsInputAttachmentsAudioSelectorsAudioTrackSelection(DaraModel):
    def __init__(
        self,
        track_id: int = None,
    ):
...
class ListMediaLiveChannelsResponseBodyChannelsInputAttachmentsAudioSelectorsAudioPidSelection(DaraModel):
    def __init__(
        self,
        pid: int = None,
    ):
...
class ListMediaLiveChannelsResponseBodyChannelsInputAttachmentsAudioSelectorsAudioLanguageSelection(DaraModel):
    def __init__(
        self,
...
class ListMediaLiveChannelsResponseBodyChannelsAudioSettings(DaraModel):
    def __init__(
        self,
        audio_codec: str = None,
        audio_codec_setting: main_models.ListMediaLiveChannelsResponseBodyChannelsAudioSettingsAudioCodecSetting = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioCodecSetting') is not None:
            temp_model = main_models.ListMediaLiveChannelsResponseBodyChannelsAudioSettingsAudioCodecSetting()
...
class ListMediaLiveChannelsResponseBodyChannelsAudioSettingsAudioCodecSetting(DaraModel):
    def __init__(
        self,
        bitrate: int = None,
        profile: str = None,

...
class ChannelAssemblyChannel(DaraModel):
    def __init__(
        self,
        ...
        out_put_config_list: List[main_models.ChannelAssemblyChannelOutPutConfigList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OutPutConfigList') is not None:
            for k1 in m.get('OutPutConfigList'):
                temp_model = main_models.ChannelAssemblyChannelOutPutConfigList()
...
class ChannelAssemblyChannelOutPutConfigList(DaraModel):
    def __init__(
        self,
        channel_name: str = None,
        format: str = None,

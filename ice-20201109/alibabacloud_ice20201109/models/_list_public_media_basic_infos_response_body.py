...
class ListPublicMediaBasicInfosResponseBody(DaraModel):
    def __init__(
        self,
        max_results: int = None,
        media_infos: List[main_models.ListPublicMediaBasicInfosResponseBodyMediaInfos] = None,
        next_token: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MediaInfos') is not None:
            for k1 in m.get('MediaInfos'):
                temp_model = main_models.ListPublicMediaBasicInfosResponseBodyMediaInfos()
...
class ListPublicMediaBasicInfosResponseBodyMediaInfos(DaraModel):
    def __init__(
        self,
        file_info_list: List[main_models.ListPublicMediaBasicInfosResponseBodyMediaInfosFileInfoList] = None,
        media_basic_info: main_models.ListPublicMediaBasicInfosResponseBodyMediaInfosMediaBasicInfo = None,
        media_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FileInfoList') is not None:
            for k1 in m.get('FileInfoList'):
                temp_model = main_models.ListPublicMediaBasicInfosResponseBodyMediaInfosFileInfoList()
                self.file_info_list.append(temp_model.from_map(k1))

        if m.get('MediaBasicInfo') is not None:
            temp_model = main_models.ListPublicMediaBasicInfosResponseBodyMediaInfosMediaBasicInfo()
...
class ListPublicMediaBasicInfosResponseBodyMediaInfosMediaBasicInfo(DaraModel):
    def __init__(
        self,
...
class ListPublicMediaBasicInfosResponseBodyMediaInfosFileInfoList(DaraModel):
    def __init__(
        self,
        file_basic_info: main_models.ListPublicMediaBasicInfosResponseBodyMediaInfosFileInfoListFileBasicInfo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FileBasicInfo') is not None:
            temp_model = main_models.ListPublicMediaBasicInfosResponseBodyMediaInfosFileInfoListFileBasicInfo()
            self.file_basic_info = temp_model.from_map(m.get('FileBasicInfo'))

        return self

class ListPublicMediaBasicInfosResponseBodyMediaInfosFileInfoListFileBasicInfo(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        duration: str = None,

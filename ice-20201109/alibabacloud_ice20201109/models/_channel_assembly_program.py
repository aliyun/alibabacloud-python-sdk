...
class ChannelAssemblyProgram(DaraModel):
    def __init__(
        self,
        ad_breaks: List[main_models.ChannelAssemblyProgramAdBreaks] = None,
        arn: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AdBreaks') is not None:
            for k1 in m.get('AdBreaks'):
                temp_model = main_models.ChannelAssemblyProgramAdBreaks()
...
class ChannelAssemblyProgramAdBreaks(DaraModel):
    def __init__(
        self,
        channel_name: str = None,

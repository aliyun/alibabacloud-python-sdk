...
class UpdateLiveTranscodeTemplateRequest(DaraModel):
    def __init__(
        self,
        name: str = None,
        template_config: main_models.UpdateLiveTranscodeTemplateRequestTemplateConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TemplateConfig') is not None:
            temp_model = main_models.UpdateLiveTranscodeTemplateRequestTemplateConfig()
...
class UpdateLiveTranscodeTemplateRequestTemplateConfig(DaraModel):
    def __init__(
        self,
        audio_params: main_models.UpdateLiveTranscodeTemplateRequestTemplateConfigAudioParams = None,
        video_params: main_models.UpdateLiveTranscodeTemplateRequestTemplateConfigVideoParams = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioParams') is not None:
            temp_model = main_models.UpdateLiveTranscodeTemplateRequestTemplateConfigAudioParams()
            self.audio_params = temp_model.from_map(m.get('AudioParams'))

        if m.get('VideoParams') is not None:
            temp_model = main_models.UpdateLiveTranscodeTemplateRequestTemplateConfigVideoParams()
            self.video_params = temp_model.from_map(m.get('VideoParams'))

        return self

class UpdateLiveTranscodeTemplateRequestTemplateConfigVideoParams(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        codec: str = None,
...
class UpdateLiveTranscodeTemplateRequestTemplateConfigAudioParams(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        channels: str = None,

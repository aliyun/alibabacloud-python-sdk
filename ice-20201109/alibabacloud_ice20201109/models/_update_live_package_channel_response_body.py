...
class UpdateLivePackageChannelResponseBody(DaraModel):
    def __init__(
        self,
        live_package_channel: main_models.UpdateLivePackageChannelResponseBodyLivePackageChannel = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LivePackageChannel') is not None:
            temp_model = main_models.UpdateLivePackageChannelResponseBodyLivePackageChannel()
...
class UpdateLivePackageChannelResponseBodyLivePackageChannel(DaraModel):
    def __init__(
        self,
        ...
        group_name: str = None,
        ingest_endpoints: List[main_models.UpdateLivePackageChannelResponseBodyLivePackageChannelIngestEndpoints] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IngestEndpoints') is not None:
            for k1 in m.get('IngestEndpoints'):
                temp_model = main_models.UpdateLivePackageChannelResponseBodyLivePackageChannelIngestEndpoints()
...
class UpdateLivePackageChannelResponseBodyLivePackageChannelIngestEndpoints(DaraModel):
    def __init__(
        self,
        id: str = None,
        password: str = None,

...
class AddAdInsertionResponseBody(DaraModel):
    def __init__(
        self,
        config: main_models.AddAdInsertionResponseBodyConfig = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Config') is not None:
            temp_model = main_models.AddAdInsertionResponseBodyConfig()
...
class AddAdInsertionResponseBodyConfig(DaraModel):
    def __init__(
        self,
        ad_marker_passthrough: str = None,
        ads_url: str = None,
        cdn_config: main_models.AddAdInsertionResponseBodyConfigCdnConfig = None,
        config_aliases: str = None,
        content_url_prefix: str = None,
        create_time: str = None,
        last_modified: str = None,
        manifest_endpoint_config: main_models.AddAdInsertionResponseBodyConfigManifestEndpointConfig = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CdnConfig') is not None:
            temp_model = main_models.AddAdInsertionResponseBodyConfigCdnConfig()
        ...
        if m.get('ManifestEndpointConfig') is not None:
            temp_model = main_models.AddAdInsertionResponseBodyConfigManifestEndpointConfig()
...
class AddAdInsertionResponseBodyConfigManifestEndpointConfig(DaraModel):
    def __init__(
        self,
...
class AddAdInsertionResponseBodyConfigCdnConfig(DaraModel):
    def __init__(
        self,

...
class SearchMediaByMultimodalResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        media_list: List[main_models.SearchMediaByMultimodalResponseBodyMediaList] = None,
        request_id: str = None,
        success: str = None,
        total: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MediaList') is not None:
            for k1 in m.get('MediaList'):
                temp_model = main_models.SearchMediaByMultimodalResponseBodyMediaList()
...
class SearchMediaByMultimodalResponseBodyMediaList(DaraModel):
    def __init__(
        self,
        clip_info: List[main_models.SearchMediaByMultimodalResponseBodyMediaListClipInfo] = None,
        media_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ClipInfo') is not None:
            for k1 in m.get('ClipInfo'):
                temp_model = main_models.SearchMediaByMultimodalResponseBodyMediaListClipInfo()
...
class SearchMediaByMultimodalResponseBodyMediaListClipInfo(DaraModel):
    def __init__(
        self,
        from_: float = None,
        score: float = None,

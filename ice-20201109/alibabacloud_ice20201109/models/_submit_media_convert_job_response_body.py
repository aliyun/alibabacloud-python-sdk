...
class SubmitMediaConvertJobResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Job') is not None:
            temp_model = main_models.SubmitMediaConvertJobResponseBodyJob()
...
class SubmitMediaConvertJobResponseBodyJob(DaraModel):
    def __init__(
        self,
        client_token: str = None,
        code: str = None,
        config: main_models.SubmitMediaConvertJobResponseBodyJobConfig = None,
        job_id: str = None,
        message: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Config') is not None:
            temp_model = main_models.SubmitMediaConvertJobResponseBodyJobConfig()
...
class SubmitMediaConvertJobResponseBodyJobConfig(DaraModel):
    def __init__(
        self,

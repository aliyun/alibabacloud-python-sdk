...
class SubmitSyncMediaInfoJobResponseBody(DaraModel):
    def __init__(
        self,
        media_info_job: main_models.SubmitSyncMediaInfoJobResponseBodyMediaInfoJob = None,
        request_id: str = None,
    ):
        # MediaInfoJobDTO
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MediaInfoJob') is not None:
            temp_model = main_models.SubmitSyncMediaInfoJobResponseBodyMediaInfoJob()
...
class SubmitSyncMediaInfoJobResponseBodyMediaInfoJob(DaraModel):
    def __init__(
        self,
        async_: bool = None,
        finish_time: str = None,
        input: main_models.SubmitSyncMediaInfoJobResponseBodyMediaInfoJobInput = None,
        job_id: str = None,
        media_info_property: main_models.SubmitSyncMediaInfoJobResponseBodyMediaInfoJobMediaInfoProperty = None,
        name: str = None,
        request_id: str = None,
        schedule_config: main_models.SubmitSyncMediaInfoJobResponseBodyMediaInfoJobScheduleConfig = None,
        status: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Input') is not None:
            temp_model = main_models.SubmitSyncMediaInfoJobResponseBodyMediaInfoJobInput()
        ...
        if m.get('MediaInfoProperty') is not None:
            temp_model = main_models.SubmitSyncMediaInfoJobResponseBodyMediaInfoJobMediaInfoProperty()
        ...
        if m.get('ScheduleConfig') is not None:
            temp_model = main_models.SubmitSyncMediaInfoJobResponseBodyMediaInfoJobScheduleConfig()
...
class SubmitSyncMediaInfoJobResponseBodyMediaInfoJobScheduleConfig(DaraModel):
    def __init__(
        self,
...
class SubmitSyncMediaInfoJobResponseBodyMediaInfoJobMediaInfoProperty(DaraModel):
    def __init__(
        self,
        audio_stream_info_list: List[main_models.SubmitSyncMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList] = None,
        file_basic_info: main_models.SubmitSyncMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyFileBasicInfo = None,
        video_stream_info_list: List[main_models.SubmitSyncMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyVideoStreamInfoList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioStreamInfoList') is not None:
            for k1 in m.get('AudioStreamInfoList'):
                temp_model = main_models.SubmitSyncMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList()
                self.audio_stream_info_list.append(temp_model.from_map(k1))

        if m.get('FileBasicInfo') is not None:
            temp_model = main_models.SubmitSyncMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyFileBasicInfo()
        ...
        if m.get('VideoStreamInfoList') is not None:
            for k1 in m.get('VideoStreamInfoList'):
                temp_model = main_models.SubmitSyncMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyVideoStreamInfoList()
                self.video_stream_info_list.append(temp_model.from_map(k1))

        return self

class SubmitSyncMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyVideoStreamInfoList(DaraModel):
    def __init__(
        self,
        avg_fps: str = None,
        bit_rate: str = None,
...
class SubmitSyncMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyFileBasicInfo(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        duration: str = None,
...
class SubmitSyncMediaInfoJobResponseBodyMediaInfoJobMediaInfoPropertyAudioStreamInfoList(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
...
class SubmitSyncMediaInfoJobResponseBodyMediaInfoJobInput(DaraModel):
    def __init__(
        self,
        media: str = None,
        type: str = None,

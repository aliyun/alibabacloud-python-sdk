...
class ScheduleData(DaraModel):
    def __init__(
        self,
        ad_breaks: List[main_models.ScheduleDataAdBreaks] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AdBreaks') is not None:
            for k1 in m.get('AdBreaks'):
                temp_model = main_models.ScheduleDataAdBreaks()
...
class ScheduleDataAdBreaks(DaraModel):
    def __init__(
        self,

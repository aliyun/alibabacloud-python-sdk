...
class ListDynamicImageJobsResponseBody(DaraModel):
    def __init__(
        self,
        jobs: List[main_models.ListDynamicImageJobsResponseBodyJobs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Jobs') is not None:
            for k1 in m.get('Jobs'):
                temp_model = main_models.ListDynamicImageJobsResponseBodyJobs()
...
class ListDynamicImageJobsResponseBodyJobs(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        finish_time: str = None,
        input: main_models.ListDynamicImageJobsResponseBodyJobsInput = None,
        job_id: str = None,
        modified_time: str = None,
        name: str = None,
        output: main_models.ListDynamicImageJobsResponseBodyJobsOutput = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Input') is not None:
            temp_model = main_models.ListDynamicImageJobsResponseBodyJobsInput()
        ...
        if m.get('Output') is not None:
            temp_model = main_models.ListDynamicImageJobsResponseBodyJobsOutput()
...
class ListDynamicImageJobsResponseBodyJobsOutput(DaraModel):
    def __init__(
        self,
        media: str = None,
        type: str = None,
...
class ListDynamicImageJobsResponseBodyJobsInput(DaraModel):
    def __init__(
        self,
        media: str = None,
        type: str = None,

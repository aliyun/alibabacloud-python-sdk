...
## Alibaba Cloud PaiLLMTrace SDK for Python
...
```bash
# 安装 alibabacloud_paillmtrace20240311
pip install alibabacloud_paillmtrace20240311
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/paillmtrace-20240311/ChangeLog.md)中。

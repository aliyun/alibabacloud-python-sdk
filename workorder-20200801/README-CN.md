...
```bash
# 安装 alibabacloud_workorder20200801
pip install alibabacloud_workorder20200801
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/workorder-20200801/ChangeLog.md)中。

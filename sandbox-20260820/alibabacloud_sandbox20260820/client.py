...
class Client(OpenApiClient):
    ...
    def create_api_key_with_options(
        ...
        params = open_api_util_models.Params(
            ...
            version = '2026-08-20',
            protocol = 'HTTPS',
            pathname = f'/pop/2026-08-20/api-keys',
            method = 'POST',
            auth_type = 'AK',
            style = 'ROA',
            req_body_type = 'json',
    ...
    def create_team_with_options(
        ...
        params = open_api_util_models.Params(
            ...
            version = '2026-08-20',
            protocol = 'HTTPS',
            pathname = f'/pop/2026-08-20/teams',
            method = 'POST',
            auth_type = 'AK',
            style = 'ROA',
            req_body_type = 'json',
    ...
    def create_volume_with_options(
        ...
        params = open_api_util_models.Params(
            ...
            version = '2026-08-20',
            protocol = 'HTTPS',
            pathname = f'/pop/2026-08-20/volumes',
            method = 'POST',
            auth_type = 'AK',
            style = 'ROA',
            req_body_type = 'json',
    ...
    def delete_api_key_with_options(
        ...
        params = open_api_util_models.Params(
            ...
            version = '2026-08-20',
            protocol = 'HTTPS',
            pathname = f'/pop/2026-08-20/api-keys/{DaraURL.percent_encode(api_key_id)}',
            method = 'DELETE',
            auth_type = 'AK',
            style = 'ROA',
            req_body_type = 'json',
    ...
    def delete_quota_with_options(
        ...
        params = open_api_util_models.Params(
            ...
            version = '2026-08-20',
            protocol = 'HTTPS',
            pathname = f'/pop/2026-08-20/quotas/tag',
            method = 'DELETE',
            auth_type = 'AK',
            style = 'ROA',
            req_body_type = 'json',
    ...
    def delete_team_with_options(
        ...
        params = open_api_util_models.Params(
            ...
            version = '2026-08-20',
            protocol = 'HTTPS',
            pathname = f'/pop/2026-08-20/teams/{DaraURL.percent_encode(team_id)}',
            method = 'DELETE',
            auth_type = 'AK',
            style = 'ROA',
            req_body_type = 'json',
    ...
    def delete_volume_with_options(
        ...
        params = open_api_util_models.Params(
            ...
            version = '2026-08-20',
            protocol = 'HTTPS',
            pathname = f'/pop/2026-08-20/volumes/{DaraURL.percent_encode(volume_id)}',
            method = 'DELETE',
            auth_type = 'AK',
            style = 'ROA',
            req_body_type = 'json',
    ...
    def list_quota_with_options(
        ...
        params = open_api_util_models.Params(
            ...
            version = '2026-08-20',
            protocol = 'HTTPS',
            pathname = f'/pop/2026-08-20/quotas',
            method = 'GET',
            auth_type = 'AK',
            style = 'ROA',
            req_body_type = 'json',
    ...
    def reset_api_key_with_options(
        ...
        params = open_api_util_models.Params(
            ...
            version = '2026-08-20',
            protocol = 'HTTPS',
            pathname = f'/pop/2026-08-20/api-keys/{DaraURL.percent_encode(api_key_id)}/reset',
            method = 'PUT',
            auth_type = 'AK',
            style = 'ROA',
            req_body_type = 'json',

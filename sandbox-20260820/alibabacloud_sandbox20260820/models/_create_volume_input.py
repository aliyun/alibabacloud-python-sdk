...
class CreateVolumeInput(DaraModel):
    def __init__(
        ...
        agentic_fsvolume_config: main_models.CreateVolumeInputAgenticFSVolumeConfig = None,
        juice_fsvolume_config: main_models.JuiceFSVolumeConfig = None,
    ...
    def validate(self):
        ...
        if self.juice_fsvolume_config:
            self.juice_fsvolume_config.validate()
    ...
    def to_map(self):
        ...
        if self.juice_fsvolume_config is not None:
            result['juiceFSVolumeConfig'] = self.juice_fsvolume_config.to_map()
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('agenticFSVolumeConfig') is not None:
            temp_model = main_models.CreateVolumeInputAgenticFSVolumeConfig()
            self.agentic_fsvolume_config = temp_model.from_map(m.get('agenticFSVolumeConfig'))

        if m.get('juiceFSVolumeConfig') is not None:
            temp_model = main_models.JuiceFSVolumeConfig()
            self.juice_fsvolume_config = temp_model.from_map(m.get('juiceFSVolumeConfig'))
...
class CreateVolumeInputAgenticFSVolumeConfig(DaraModel):
    def __init__(
        self,
        group_id: int = None,

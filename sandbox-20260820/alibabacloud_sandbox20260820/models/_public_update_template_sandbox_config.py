...
class PublicUpdateTemplateSandboxConfig(DaraModel):
    def __init__(
        self,
        ...
        registry_config: main_models.PublicUpdateTemplateRegistryConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('registryConfig') is not None:
            temp_model = main_models.PublicUpdateTemplateRegistryConfig()

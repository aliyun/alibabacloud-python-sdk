...
class UpdateMmAppAndBindingShrinkRequest(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        app_name: str = None,
        ...
        self.memory_config_shrink = memory_config_shrink
    ...
    def to_map(self):
        ...
        if self.memory_config_shrink is not None:
            result['MemoryConfig'] = self.memory_config_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MemoryConfig') is not None:
            self.memory_config_shrink = m.get('MemoryConfig')

...
class QueryMemoryConfigResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.QueryMemoryConfigResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.QueryMemoryConfigResponseBodyData()
...
class QueryMemoryConfigResponseBodyData(DaraModel):
    def __init__(
        self,
        app_id: str = None,

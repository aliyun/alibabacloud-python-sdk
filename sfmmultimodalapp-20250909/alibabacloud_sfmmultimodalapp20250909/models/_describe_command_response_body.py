...
class DescribeCommandResponseBody(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        ...
        request_id: str = None,
        tool_examples: List[main_models.DescribeCommandResponseBodyToolExamples] = None,
        tool_id: str = None,
        tool_name: str = None,
        tool_params: List[main_models.DescribeCommandResponseBodyToolParams] = None,
    ):
        self.app_id = app_id
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ToolExamples') is not None:
            for k1 in m.get('ToolExamples'):
                temp_model = main_models.DescribeCommandResponseBodyToolExamples()
        ...
        if m.get('ToolParams') is not None:
            for k1 in m.get('ToolParams'):
                temp_model = main_models.DescribeCommandResponseBodyToolParams()
                self.tool_params.append(temp_model.from_map(k1))

        return self

class DescribeCommandResponseBodyToolParams(DaraModel):
    def __init__(
        self,
        param_desc: str = None,
...
class DescribeCommandResponseBodyToolExamples(DaraModel):
    def __init__(
        self,
        query: str = None,
    ):

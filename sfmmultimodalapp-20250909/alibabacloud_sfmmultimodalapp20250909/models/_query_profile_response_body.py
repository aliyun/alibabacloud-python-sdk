...
class QueryProfileResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.QueryProfileResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.QueryProfileResponseBodyData()
...
class QueryProfileResponseBodyData(DaraModel):
    def __init__(
        self,
        attributes: List[main_models.QueryProfileResponseBodyDataAttributes] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Attributes') is not None:
            for k1 in m.get('Attributes'):
                temp_model = main_models.QueryProfileResponseBodyDataAttributes()
...
class QueryProfileResponseBodyDataAttributes(DaraModel):
    def __init__(
        self,

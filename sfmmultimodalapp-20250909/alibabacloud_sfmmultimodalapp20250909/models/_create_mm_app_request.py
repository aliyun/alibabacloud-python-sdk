...
class CreateMmAppRequest(DaraModel):
    def __init__(
        self,
        app_name: str = None,
        binding_config: main_models.CreateMmAppRequestBindingConfig = None,
        conversation_config: main_models.CreateMmAppRequestConversationConfig = None,
        model_config: main_models.CreateMmAppRequestModelConfig = None,
        prompt: str = None,
...
class CreateMmAppRequestConversationConfig(DaraModel):
    def __init__(
        self,
        asr_model: str = None,
        open_asr: bool = None,
...
class CreateMmAppRequestBindingConfig(DaraModel):
    def __init__(
        self,
        commands: List[main_models.CreateMmAppRequestBindingConfigCommands] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Commands') is not None:
            for k1 in m.get('Commands'):
                temp_model = main_models.CreateMmAppRequestBindingConfigCommands()
                self.commands.append(temp_model.from_map(k1))

        return self

class CreateMmAppRequestBindingConfigCommands(DaraModel):
    def __init__(
        self,
        domain_code: str = None,
        tools: List[main_models.CreateMmAppRequestBindingConfigCommandsTools] = None,
        type: str = None,
    ):
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tools') is not None:
            for k1 in m.get('Tools'):
                temp_model = main_models.CreateMmAppRequestBindingConfigCommandsTools()
...
class CreateMmAppRequestBindingConfigCommandsTools(DaraModel):
    def __init__(
        self,
        tool_id: str = None,
    ):

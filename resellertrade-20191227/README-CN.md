...
```bash
# 安装 alibabacloud_resellertrade20191227
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/resellertrade-20191227/ChangeLog.md)中。

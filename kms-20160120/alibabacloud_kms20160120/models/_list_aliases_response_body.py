...
class ListAliasesResponseBody(DaraModel):
    def __init__(
        self,
        aliases: main_models.ListAliasesResponseBodyAliases = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Aliases') is not None:
            temp_model = main_models.ListAliasesResponseBodyAliases()
...
class ListAliasesResponseBodyAliases(DaraModel):
    def __init__(
        self,
        alias: List[main_models.ListAliasesResponseBodyAliasesAlias] = None,
    ):
        self.alias = alias
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Alias') is not None:
            for k1 in m.get('Alias'):
                temp_model = main_models.ListAliasesResponseBodyAliasesAlias()
                self.alias.append(temp_model.from_map(k1))

        return self

class ListAliasesResponseBodyAliasesAlias(DaraModel):
    def __init__(
        self,
        alias_arn: str = None,
        alias_name: str = None,

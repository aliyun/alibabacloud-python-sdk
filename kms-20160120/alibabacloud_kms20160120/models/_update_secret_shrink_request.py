...
class UpdateSecretShrinkRequest(DaraModel):
    def __init__(
        self,
        extended_config: main_models.UpdateSecretShrinkRequestExtendedConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ExtendedConfig') is not None:
            temp_model = main_models.UpdateSecretShrinkRequestExtendedConfig()
...
class UpdateSecretShrinkRequestExtendedConfig(DaraModel):
    def __init__(
        self,

...
class DescribeKeyVersionResponseBody(DaraModel):
    def __init__(
        self,
        key_version: main_models.DescribeKeyVersionResponseBodyKeyVersion = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('KeyVersion') is not None:
            temp_model = main_models.DescribeKeyVersionResponseBodyKeyVersion()
...
class DescribeKeyVersionResponseBodyKeyVersion(DaraModel):
    def __init__(
        self,

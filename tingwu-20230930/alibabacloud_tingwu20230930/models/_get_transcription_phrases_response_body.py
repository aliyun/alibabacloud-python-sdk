...
class GetTranscriptionPhrasesResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetTranscriptionPhrasesResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetTranscriptionPhrasesResponseBodyData()
...
class GetTranscriptionPhrasesResponseBodyData(DaraModel):
    def __init__(
        self,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Phrases') is not None:
            for k1 in m.get('Phrases'):
                temp_model = main_models.GetTranscriptionPhrasesResponseBodyDataPhrases()
...
class GetTranscriptionPhrasesResponseBodyDataPhrases(DaraModel):
    def __init__(
        self,

...
class GetVccGrantRuleResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: int = None,
        content: main_models.GetVccGrantRuleResponseBodyContent = None,
        message: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Content') is not None:
            temp_model = main_models.GetVccGrantRuleResponseBodyContent()
...
class GetVccGrantRuleResponseBodyContent(DaraModel):
    def __init__(
        self,

...
class ListVpdRouteEntriesResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: int = None,
        content: main_models.ListVpdRouteEntriesResponseBodyContent = None,
        message: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Content') is not None:
            temp_model = main_models.ListVpdRouteEntriesResponseBodyContent()
...
class ListVpdRouteEntriesResponseBodyContent(DaraModel):
    def __init__(
        self,
        data: List[main_models.ListVpdRouteEntriesResponseBodyContentData] = None,
        total: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListVpdRouteEntriesResponseBodyContentData()
...
class ListVpdRouteEntriesResponseBodyContentData(DaraModel):
    def __init__(
        self,

...
class GetErRouteMapResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: int = None,
        content: main_models.GetErRouteMapResponseBodyContent = None,
        message: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Content') is not None:
            temp_model = main_models.GetErRouteMapResponseBodyContent()
...
class GetErRouteMapResponseBodyContent(DaraModel):
    def __init__(
        self,
        action: str = None,

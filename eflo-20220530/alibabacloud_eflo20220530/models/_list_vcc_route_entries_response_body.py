...
class ListVccRouteEntriesResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: int = None,
        content: main_models.ListVccRouteEntriesResponseBodyContent = None,
        message: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Content') is not None:
            temp_model = main_models.ListVccRouteEntriesResponseBodyContent()
...
class ListVccRouteEntriesResponseBodyContent(DaraModel):
    def __init__(
        self,
        data: List[main_models.ListVccRouteEntriesResponseBodyContentData] = None,
        total: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListVccRouteEntriesResponseBodyContentData()
...
class ListVccRouteEntriesResponseBodyContentData(DaraModel):
    def __init__(
        self,

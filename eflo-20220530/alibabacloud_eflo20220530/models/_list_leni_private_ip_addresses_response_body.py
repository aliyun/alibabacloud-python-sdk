...
class ListLeniPrivateIpAddressesResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: int = None,
        content: main_models.ListLeniPrivateIpAddressesResponseBodyContent = None,
        message: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Content') is not None:
            temp_model = main_models.ListLeniPrivateIpAddressesResponseBodyContent()
...
class ListLeniPrivateIpAddressesResponseBodyContent(DaraModel):
    def __init__(
        self,
        data: List[main_models.ListLeniPrivateIpAddressesResponseBodyContentData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListLeniPrivateIpAddressesResponseBodyContentData()
...
class ListLeniPrivateIpAddressesResponseBodyContentData(DaraModel):
    def __init__(
        self,

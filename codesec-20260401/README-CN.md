...
## Alibaba Cloud CodeSec SDK for Python
...
```bash
# 安装 alibabacloud_codesec20260401
pip install alibabacloud_codesec20260401
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/codesec-20260401/ChangeLog.md)中。

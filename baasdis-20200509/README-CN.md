...
## Alibaba Cloud BaasDis SDK for Python
...
```bash
# 安装 alibabacloud_baasdis20200509
pip install alibabacloud_baasdis20200509
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/baasdis-20200509/ChangeLog.md)中。

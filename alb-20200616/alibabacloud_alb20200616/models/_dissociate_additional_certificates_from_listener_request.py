...
class DissociateAdditionalCertificatesFromListenerRequest(DaraModel):
    def __init__(
        self,
        certificates: List[main_models.DissociateAdditionalCertificatesFromListenerRequestCertificates] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Certificates') is not None:
            for k1 in m.get('Certificates'):
                temp_model = main_models.DissociateAdditionalCertificatesFromListenerRequestCertificates()
...
class DissociateAdditionalCertificatesFromListenerRequestCertificates(DaraModel):
    def __init__(
        self,

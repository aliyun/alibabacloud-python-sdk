...
## Alibaba Cloud BailianControl SDK for Python
...
```bash
# 安装 alibabacloud_bailiancontrol20240816
pip install alibabacloud_bailiancontrol20240816
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/bailiancontrol-20240816/ChangeLog.md)中。

...
class CreateAsyncTranslateResponseBody(TeaModel):
    def __init__(
        self,
        code: int = None,
        data: CreateAsyncTranslateResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
        self.code = code
...
class CreateAsyncTranslateResponse(TeaModel):
    def __init__(
        ...
        body: CreateAsyncTranslateResponseBody = None,
    ):
...
class GetAsyncTranslateResponseBody(TeaModel):
    def __init__(
        self,
        code: int = None,
        data: GetAsyncTranslateResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
        self.code = code
...
class GetAsyncTranslateResponse(TeaModel):
    def __init__(
        ...
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetAsyncTranslateResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
...
class GetBatchTranslateByVPCRequest(TeaModel):
    def __init__(
        self,
        api_type: str = None,
        format_type: str = None,
...
class GetBatchTranslateByVPCResponseBody(TeaModel):
    def __init__(
        self,
        code: int = None,
        message: str = None,
...
class GetBatchTranslateByVPCResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetBatchTranslateByVPCResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetBatchTranslateByVPCResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class GetDetectLanguageVpcRequest(TeaModel):
    def __init__(
        self,
        source_text: str = None,
    ):
...
class GetDetectLanguageVpcResponseBody(TeaModel):
    def __init__(
        self,
        detected_language: str = None,
        language_probabilities: str = None,
...
class GetDetectLanguageVpcResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetDetectLanguageVpcResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetDetectLanguageVpcResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class TranslateGeneralVpcRequest(TeaModel):
    def __init__(
        self,
        context: str = None,
        format_type: str = None,
...
class TranslateGeneralVpcResponseBodyData(TeaModel):
    def __init__(
        self,
        detected_language: str = None,
        translated: str = None,
...
class TranslateGeneralVpcResponseBody(TeaModel):
    def __init__(
        self,
        code: int = None,
        data: TranslateGeneralVpcResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Code') is not None:
            self.code = m.get('Code')
        if m.get('Data') is not None:
            temp_model = TranslateGeneralVpcResponseBodyData()
            self.data = temp_model.from_map(m['Data'])
        if m.get('Message') is not None:
            self.message = m.get('Message')
        if m.get('RequestId') is not None:
...
class TranslateGeneralVpcResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: TranslateGeneralVpcResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = TranslateGeneralVpcResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class TranslateSearchRequest(TeaModel):
    def __init__(
        self,
        format_type: str = None,
        scene: str = None,
...
class TranslateSearchResponseBodyData(TeaModel):
    def __init__(
        self,
        translated: str = None,
    ):
...
class TranslateSearchResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        data: TranslateSearchResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Code') is not None:
            self.code = m.get('Code')
        if m.get('Data') is not None:
            temp_model = TranslateSearchResponseBodyData()
            self.data = temp_model.from_map(m['Data'])
        if m.get('Message') is not None:
            self.message = m.get('Message')
        if m.get('RequestId') is not None:
...
class TranslateSearchResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: TranslateSearchResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = TranslateSearchResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

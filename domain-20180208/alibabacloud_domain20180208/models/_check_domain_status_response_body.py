...
class CheckDomainStatusResponseBody(DaraModel):
    def __init__(
        self,
        error_code: str = None,
        http_status_code: int = None,
        module: main_models.CheckDomainStatusResponseBodyModule = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.CheckDomainStatusResponseBodyModule()
...
class CheckDomainStatusResponseBodyModule(DaraModel):
    def __init__(
        self,
        dead_date: int = None,
        domain: str = None,

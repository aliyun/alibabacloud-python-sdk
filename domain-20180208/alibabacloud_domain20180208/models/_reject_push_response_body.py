...
class RejectPushResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        allow_retry: bool = None,
        http_status_code: int = None,
        module: main_models.RejectPushResponseBodyModule = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.RejectPushResponseBodyModule()
...
class RejectPushResponseBodyModule(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,

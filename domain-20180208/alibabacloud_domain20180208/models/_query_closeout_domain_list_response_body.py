...
class QueryCloseoutDomainListResponseBody(DaraModel):
    def __init__(
        self,
        data: List[main_models.QueryCloseoutDomainListResponseBodyData] = None,
        request_id: str = None,
    ):
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.QueryCloseoutDomainListResponseBodyData()
...
class QueryCloseoutDomainListResponseBodyData(DaraModel):
    def __init__(
        self,

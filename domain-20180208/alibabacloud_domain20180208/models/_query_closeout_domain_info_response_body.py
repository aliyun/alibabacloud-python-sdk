...
class QueryCloseoutDomainInfoResponseBody(DaraModel):
    def __init__(
        self,
        module: main_models.QueryCloseoutDomainInfoResponseBodyModule = None,
        request_id: str = None,
    ):
        self.module = module
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Module') is not None:
            temp_model = main_models.QueryCloseoutDomainInfoResponseBodyModule()
...
class QueryCloseoutDomainInfoResponseBodyModule(DaraModel):
    def __init__(
        self,

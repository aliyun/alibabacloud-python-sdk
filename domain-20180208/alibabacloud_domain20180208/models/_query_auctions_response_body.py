...
class QueryAuctionsResponseBody(DaraModel):
    def __init__(
        self,
        current_page_num: int = None,
        data: List[main_models.QueryAuctionsResponseBodyData] = None,
        page_size: int = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.QueryAuctionsResponseBodyData()
...
class QueryAuctionsResponseBodyData(DaraModel):
    def __init__(
        self,

...
```bash
# 安装 alibabacloud_domain20180208
pip install alibabacloud_domain20180208
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/domain-20180208/ChangeLog.md)中。

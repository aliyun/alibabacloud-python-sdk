...
class UpdateDirectoryResponseBody(DaraModel):
    def __init__(
        self,
        directory: main_models.UpdateDirectoryResponseBodyDirectory = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Directory') is not None:
            temp_model = main_models.UpdateDirectoryResponseBodyDirectory()
...
class UpdateDirectoryResponseBodyDirectory(DaraModel):
    def __init__(
        self,

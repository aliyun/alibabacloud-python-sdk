...
class GetUserProvisioningRdAccountStatisticsResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        user_provisioning_statistics: main_models.GetUserProvisioningRdAccountStatisticsResponseBodyUserProvisioningStatistics = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserProvisioningStatistics') is not None:
            temp_model = main_models.GetUserProvisioningRdAccountStatisticsResponseBodyUserProvisioningStatistics()
            self.user_provisioning_statistics = temp_model.from_map(m.get('UserProvisioningStatistics'))

        return self

class GetUserProvisioningRdAccountStatisticsResponseBodyUserProvisioningStatistics(DaraModel):
    def __init__(
        self,

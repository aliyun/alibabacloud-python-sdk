...
class CreateDirectoryResponseBody(DaraModel):
    def __init__(
        self,
        directory: main_models.CreateDirectoryResponseBodyDirectory = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Directory') is not None:
            temp_model = main_models.CreateDirectoryResponseBodyDirectory()
...
class CreateDirectoryResponseBodyDirectory(DaraModel):
    def __init__(
        self,

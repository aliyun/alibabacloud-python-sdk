...
class ProvisionAccessConfigurationResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        tasks: List[main_models.ProvisionAccessConfigurationResponseBodyTasks] = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tasks') is not None:
            for k1 in m.get('Tasks'):
                temp_model = main_models.ProvisionAccessConfigurationResponseBodyTasks()
                self.tasks.append(temp_model.from_map(k1))

        return self

class ProvisionAccessConfigurationResponseBodyTasks(DaraModel):
    def __init__(
        self,

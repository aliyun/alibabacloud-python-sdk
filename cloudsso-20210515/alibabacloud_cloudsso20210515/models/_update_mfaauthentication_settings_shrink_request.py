...
class UpdateMFAAuthenticationSettingsShrinkRequest(DaraModel):
    def __init__(
        self,
        allowed_verification_types_shrink: str = None,
        directory_id: str = None,
        mfaauthentication_settings: str = None,
        operation_for_risk_login: str = None,
    ):
        self.allowed_verification_types_shrink = allowed_verification_types_shrink
        # The directory ID.
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        if self.allowed_verification_types_shrink is not None:
            result['AllowedVerificationTypes'] = self.allowed_verification_types_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AllowedVerificationTypes') is not None:
            self.allowed_verification_types_shrink = m.get('AllowedVerificationTypes')

...
class GetAccessConfigurationResponseBody(DaraModel):
    def __init__(
        self,
        access_configuration: main_models.GetAccessConfigurationResponseBodyAccessConfiguration = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AccessConfiguration') is not None:
            temp_model = main_models.GetAccessConfigurationResponseBodyAccessConfiguration()
...
class GetAccessConfigurationResponseBodyAccessConfiguration(DaraModel):
    def __init__(
        self,
        ...
        tags: List[main_models.GetAccessConfigurationResponseBodyAccessConfigurationTags] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.GetAccessConfigurationResponseBodyAccessConfigurationTags()
...
class GetAccessConfigurationResponseBodyAccessConfigurationTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

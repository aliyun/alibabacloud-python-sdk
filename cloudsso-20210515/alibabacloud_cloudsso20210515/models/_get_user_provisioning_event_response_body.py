...
class GetUserProvisioningEventResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        user_provisioning_event: main_models.GetUserProvisioningEventResponseBodyUserProvisioningEvent = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserProvisioningEvent') is not None:
            temp_model = main_models.GetUserProvisioningEventResponseBodyUserProvisioningEvent()
            self.user_provisioning_event = temp_model.from_map(m.get('UserProvisioningEvent'))

        return self

class GetUserProvisioningEventResponseBodyUserProvisioningEvent(DaraModel):
    def __init__(
        self,

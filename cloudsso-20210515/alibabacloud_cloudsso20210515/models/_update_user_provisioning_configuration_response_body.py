...
class UpdateUserProvisioningConfigurationResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        user_provisioning_configuration: main_models.UpdateUserProvisioningConfigurationResponseBodyUserProvisioningConfiguration = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserProvisioningConfiguration') is not None:
            temp_model = main_models.UpdateUserProvisioningConfigurationResponseBodyUserProvisioningConfiguration()
            self.user_provisioning_configuration = temp_model.from_map(m.get('UserProvisioningConfiguration'))

        return self

class UpdateUserProvisioningConfigurationResponseBodyUserProvisioningConfiguration(DaraModel):
    def __init__(
        self,

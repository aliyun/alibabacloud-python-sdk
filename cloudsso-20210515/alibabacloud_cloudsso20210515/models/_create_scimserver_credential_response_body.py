...
class CreateSCIMServerCredentialResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        scimserver_credential: main_models.CreateSCIMServerCredentialResponseBodySCIMServerCredential = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SCIMServerCredential') is not None:
            temp_model = main_models.CreateSCIMServerCredentialResponseBodySCIMServerCredential()
            self.scimserver_credential = temp_model.from_map(m.get('SCIMServerCredential'))

        return self

class CreateSCIMServerCredentialResponseBodySCIMServerCredential(DaraModel):
    def __init__(
        self,

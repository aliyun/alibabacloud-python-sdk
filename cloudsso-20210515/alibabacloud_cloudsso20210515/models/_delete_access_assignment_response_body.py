...
class DeleteAccessAssignmentResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        task: main_models.DeleteAccessAssignmentResponseBodyTask = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Task') is not None:
            temp_model = main_models.DeleteAccessAssignmentResponseBodyTask()
            self.task = temp_model.from_map(m.get('Task'))

        return self

class DeleteAccessAssignmentResponseBodyTask(DaraModel):
    def __init__(
        self,

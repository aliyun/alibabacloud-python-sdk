...
class GetExternalSAMLIdentityProviderResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        samlidentity_provider_configuration: main_models.GetExternalSAMLIdentityProviderResponseBodySAMLIdentityProviderConfiguration = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SAMLIdentityProviderConfiguration') is not None:
            temp_model = main_models.GetExternalSAMLIdentityProviderResponseBodySAMLIdentityProviderConfiguration()
            self.samlidentity_provider_configuration = temp_model.from_map(m.get('SAMLIdentityProviderConfiguration'))

        return self

class GetExternalSAMLIdentityProviderResponseBodySAMLIdentityProviderConfiguration(DaraModel):
    def __init__(
        self,

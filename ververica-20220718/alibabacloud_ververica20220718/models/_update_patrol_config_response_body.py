...
class UpdatePatrolConfigResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.UpdatePatrolConfigResponseBodyData = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.UpdatePatrolConfigResponseBodyData()
...
class UpdatePatrolConfigResponseBodyData(DaraModel):
    def __init__(
        self,
        ...
        scope_config: main_models.UpdatePatrolConfigResponseBodyDataScopeConfig = None,
        scope_type: str = None,
        timezone: str = None,
        workspace: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('scopeConfig') is not None:
            temp_model = main_models.UpdatePatrolConfigResponseBodyDataScopeConfig()
...
class UpdatePatrolConfigResponseBodyDataScopeConfig(DaraModel):
    def __init__(
        self,

...
class GetAITemplateResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        template_info: main_models.GetAITemplateResponseBodyTemplateInfo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TemplateInfo') is not None:
            temp_model = main_models.GetAITemplateResponseBodyTemplateInfo()
            self.template_info = temp_model.from_map(m.get('TemplateInfo'))

        return self

class GetAITemplateResponseBodyTemplateInfo(DaraModel):
    def __init__(
        self,

...
class ListAppInfoResponseBody(DaraModel):
    def __init__(
        self,
        app_info_list: List[main_models.ListAppInfoResponseBodyAppInfoList] = None,
        request_id: str = None,
        total: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AppInfoList') is not None:
            for k1 in m.get('AppInfoList'):
                temp_model = main_models.ListAppInfoResponseBodyAppInfoList()
...
class ListAppInfoResponseBodyAppInfoList(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        app_name: str = None,

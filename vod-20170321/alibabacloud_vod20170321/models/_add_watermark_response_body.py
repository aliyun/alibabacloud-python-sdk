...
class AddWatermarkResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('WatermarkInfo') is not None:
            temp_model = main_models.AddWatermarkResponseBodyWatermarkInfo()
            self.watermark_info = temp_model.from_map(m.get('WatermarkInfo'))

        return self

class AddWatermarkResponseBodyWatermarkInfo(DaraModel):
    def __init__(
        self,

...
class ListWatermarkResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        watermark_infos: List[main_models.ListWatermarkResponseBodyWatermarkInfos] = None,
    ):
        # The request ID.
    ...
    def validate(self):
        if self.watermark_infos:
            for v1 in self.watermark_infos:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.watermark_infos is not None:
            for k1 in self.watermark_infos:
                result['WatermarkInfos'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('WatermarkInfos') is not None:
            for k1 in m.get('WatermarkInfos'):
                temp_model = main_models.ListWatermarkResponseBodyWatermarkInfos()
                self.watermark_infos.append(temp_model.from_map(k1))

        return self

class ListWatermarkResponseBodyWatermarkInfos(DaraModel):
    def __init__(
        self,
        app_id: str = None,

...
class DescribeVodUserVipsByDomainResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Vips') is not None:
            temp_model = main_models.DescribeVodUserVipsByDomainResponseBodyVips()
            self.vips = temp_model.from_map(m.get('Vips'))

        return self

class DescribeVodUserVipsByDomainResponseBodyVips(DaraModel):
    def __init__(
        self,
        vip: List[str] = None,
    ):

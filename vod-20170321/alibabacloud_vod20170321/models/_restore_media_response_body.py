...
class RestoreMediaResponseBody(DaraModel):
    def __init__(
        self,
        forbidden_list: main_models.RestoreMediaResponseBodyForbiddenList = None,
        ignored_list: main_models.RestoreMediaResponseBodyIgnoredList = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ForbiddenList') is not None:
            temp_model = main_models.RestoreMediaResponseBodyForbiddenList()
            self.forbidden_list = temp_model.from_map(m.get('ForbiddenList'))

        if m.get('IgnoredList') is not None:
            temp_model = main_models.RestoreMediaResponseBodyIgnoredList()
...
class RestoreMediaResponseBodyIgnoredList(DaraModel):
    def __init__(
        self,
...
class RestoreMediaResponseBodyForbiddenList(DaraModel):
    def __init__(
        self,
        media_forbidden_reason_dto: List[main_models.RestoreMediaResponseBodyForbiddenListMediaForbiddenReasonDTO] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MediaForbiddenReasonDTO') is not None:
            for k1 in m.get('MediaForbiddenReasonDTO'):
                temp_model = main_models.RestoreMediaResponseBodyForbiddenListMediaForbiddenReasonDTO()
                self.media_forbidden_reason_dto.append(temp_model.from_map(k1))

        return self

class RestoreMediaResponseBodyForbiddenListMediaForbiddenReasonDTO(DaraModel):
    def __init__(
        self,
        media_id: str = None,
        reason: str = None,

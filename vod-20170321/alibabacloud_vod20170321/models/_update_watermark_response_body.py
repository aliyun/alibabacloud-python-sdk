...
class UpdateWatermarkResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        watermark_info: main_models.UpdateWatermarkResponseBodyWatermarkInfo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('WatermarkInfo') is not None:
            temp_model = main_models.UpdateWatermarkResponseBodyWatermarkInfo()
            self.watermark_info = temp_model.from_map(m.get('WatermarkInfo'))

        return self

class UpdateWatermarkResponseBodyWatermarkInfo(DaraModel):
    def __init__(
        self,

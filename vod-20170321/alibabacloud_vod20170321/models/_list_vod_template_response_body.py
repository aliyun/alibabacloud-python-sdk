...
class ListVodTemplateResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def validate(self):
        if self.vod_template_info_list:
            for v1 in self.vod_template_info_list:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.vod_template_info_list is not None:
            for k1 in self.vod_template_info_list:
                result['VodTemplateInfoList'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VodTemplateInfoList') is not None:
            for k1 in m.get('VodTemplateInfoList'):
                temp_model = main_models.ListVodTemplateResponseBodyVodTemplateInfoList()
                self.vod_template_info_list.append(temp_model.from_map(k1))

        return self

class ListVodTemplateResponseBodyVodTemplateInfoList(DaraModel):
    def __init__(
        self,
        app_id: str = None,

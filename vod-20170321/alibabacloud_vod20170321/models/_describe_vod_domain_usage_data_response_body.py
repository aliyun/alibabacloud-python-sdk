...
class DescribeVodDomainUsageDataResponseBody(DaraModel):
    def __init__(
        self,
        area: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UsageDataPerInterval') is not None:
            temp_model = main_models.DescribeVodDomainUsageDataResponseBodyUsageDataPerInterval()
            self.usage_data_per_interval = temp_model.from_map(m.get('UsageDataPerInterval'))

        return self

class DescribeVodDomainUsageDataResponseBodyUsageDataPerInterval(DaraModel):
    def __init__(
        self,
        data_module: List[main_models.DescribeVodDomainUsageDataResponseBodyUsageDataPerIntervalDataModule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataModule') is not None:
            for k1 in m.get('DataModule'):
                temp_model = main_models.DescribeVodDomainUsageDataResponseBodyUsageDataPerIntervalDataModule()
                self.data_module.append(temp_model.from_map(k1))

        return self

class DescribeVodDomainUsageDataResponseBodyUsageDataPerIntervalDataModule(DaraModel):
    def __init__(
        self,
        time_stamp: str = None,
        value: str = None,

...
class DescribeABTestGroupResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.DescribeABTestGroupResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class DescribeABTestGroupResponseBodyResult(DaraModel):
    def __init__(
        self,
        created: int = None,
        id: str = None,

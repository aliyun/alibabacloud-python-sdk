...
class CreateQueryProcessorResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.CreateQueryProcessorResponseBodyResult = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.CreateQueryProcessorResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class CreateQueryProcessorResponseBodyResult(DaraModel):
    def __init__(
        self,
        active: bool = None,
        created: int = None,

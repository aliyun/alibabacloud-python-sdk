...
class ModifyFirstRankResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.ModifyFirstRankResponseBodyResult = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.ModifyFirstRankResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class ModifyFirstRankResponseBodyResult(DaraModel):
    def __init__(
        self,
        active: bool = None,
        description: str = None,
        meta: List[main_models.ModifyFirstRankResponseBodyResultMeta] = None,
        name: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('meta') is not None:
            for k1 in m.get('meta'):
                temp_model = main_models.ModifyFirstRankResponseBodyResultMeta()
...
class ModifyFirstRankResponseBodyResultMeta(DaraModel):
    def __init__(
        self,
        arg: str = None,
        attribute: str = None,

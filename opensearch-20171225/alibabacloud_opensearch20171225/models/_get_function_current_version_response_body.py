...
class GetFunctionCurrentVersionResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        http_code: int = None,
        ...
        message: str = None,
        request_id: str = None,
        result: main_models.GetFunctionCurrentVersionResponseBodyResult = None,
        status: str = None,
    ):
        # The error code.
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.GetFunctionCurrentVersionResponseBodyResult()
...
class GetFunctionCurrentVersionResponseBodyResult(DaraModel):
    def __init__(
        self,
        function_name: str = None,
        function_type: str = None,
        model_type: str = None,
        version_config: main_models.GetFunctionCurrentVersionResponseBodyResultVersionConfig = None,
        version_id: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VersionConfig') is not None:
            temp_model = main_models.GetFunctionCurrentVersionResponseBodyResultVersionConfig()
...
class GetFunctionCurrentVersionResponseBodyResultVersionConfig(DaraModel):
    def __init__(
        self,
        create_parameters: List[main_models.GetFunctionCurrentVersionResponseBodyResultVersionConfigCreateParameters] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CreateParameters') is not None:
            for k1 in m.get('CreateParameters'):
                temp_model = main_models.GetFunctionCurrentVersionResponseBodyResultVersionConfigCreateParameters()
                self.create_parameters.append(temp_model.from_map(k1))

        self.depends = []
        if m.get('Depends') is not None:
            for k1 in m.get('Depends'):
                temp_model = main_models.GetFunctionCurrentVersionResponseBodyResultVersionConfigDepends()
        ...
        if m.get('UsageParameters') is not None:
            for k1 in m.get('UsageParameters'):
                temp_model = main_models.GetFunctionCurrentVersionResponseBodyResultVersionConfigUsageParameters()
                self.usage_parameters.append(temp_model.from_map(k1))

        return self

class GetFunctionCurrentVersionResponseBodyResultVersionConfigUsageParameters(DaraModel):
    def __init__(
        self,
        name: str = None,
        required: str = None,
...
class GetFunctionCurrentVersionResponseBodyResultVersionConfigDepends(DaraModel):
    def __init__(
        self,
        condition: str = None,
        dependency: str = None,
...
class GetFunctionCurrentVersionResponseBodyResultVersionConfigCreateParameters(DaraModel):
    def __init__(
        self,
        name: str = None,
        required: str = None,

...
class ModifyAppGroupQuotaResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.ModifyAppGroupQuotaResponseBodyResult = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.ModifyAppGroupQuotaResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class ModifyAppGroupQuotaResponseBodyResult(DaraModel):
    def __init__(
        self,
        ...
        produced: int = None,
        project_id: str = None,
        quota: main_models.ModifyAppGroupQuotaResponseBodyResultQuota = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('quota') is not None:
            temp_model = main_models.ModifyAppGroupQuotaResponseBodyResultQuota()
...
class ModifyAppGroupQuotaResponseBodyResultQuota(DaraModel):
    def __init__(
        self,

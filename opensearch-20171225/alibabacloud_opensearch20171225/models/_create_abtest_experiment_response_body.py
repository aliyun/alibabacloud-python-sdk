...
class CreateABTestExperimentResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.CreateABTestExperimentResponseBodyResult = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.CreateABTestExperimentResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class CreateABTestExperimentResponseBodyResult(DaraModel):
    def __init__(
        self,
        created: int = None,
        id: str = None,

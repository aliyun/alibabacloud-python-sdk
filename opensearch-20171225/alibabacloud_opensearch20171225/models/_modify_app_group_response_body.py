...
class ModifyAppGroupResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.ModifyAppGroupResponseBodyResult = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.ModifyAppGroupResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class ModifyAppGroupResponseBodyResult(DaraModel):
    def __init__(
        self,
        ...
        produced: int = None,
        project_id: str = None,
        quota: main_models.ModifyAppGroupResponseBodyResultQuota = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('quota') is not None:
            temp_model = main_models.ModifyAppGroupResponseBodyResultQuota()
...
class ModifyAppGroupResponseBodyResultQuota(DaraModel):
    def __init__(
        self,

...
class ListElasticPlansResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        http_code: int = None,
        ...
        next_token: str = None,
        request_id: str = None,
        result: List[main_models.ListElasticPlansResponseBodyResult] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            for k1 in m.get('result'):
                temp_model = main_models.ListElasticPlansResponseBodyResult()
...
class ListElasticPlansResponseBodyResult(DaraModel):
    def __init__(
        self,

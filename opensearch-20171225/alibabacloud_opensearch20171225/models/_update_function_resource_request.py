...
class UpdateFunctionResourceRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.UpdateFunctionResourceRequestData()
...
class UpdateFunctionResourceRequestData(DaraModel):
    def __init__(
        self,
        content: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Generators') is not None:
            for k1 in m.get('Generators'):
                temp_model = main_models.UpdateFunctionResourceRequestDataGenerators()
                self.generators.append(temp_model.from_map(k1))

        return self

class UpdateFunctionResourceRequestDataGenerators(DaraModel):
    def __init__(
        self,
        generator: str = None,
        input: main_models.UpdateFunctionResourceRequestDataGeneratorsInput = None,
        output: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Input') is not None:
            temp_model = main_models.UpdateFunctionResourceRequestDataGeneratorsInput()
...
class UpdateFunctionResourceRequestDataGeneratorsInput(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Features') is not None:
            for k1 in m.get('Features'):
                temp_model = main_models.UpdateFunctionResourceRequestDataGeneratorsInputFeatures()
                self.features.append(temp_model.from_map(k1))

        return self

class UpdateFunctionResourceRequestDataGeneratorsInputFeatures(DaraModel):
    def __init__(
        self,
        name: str = None,
        type: str = None,

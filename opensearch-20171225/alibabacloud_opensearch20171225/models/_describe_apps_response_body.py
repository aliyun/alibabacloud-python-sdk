...
class DescribeAppsResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: List[main_models.DescribeAppsResponseBodyResult] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            for k1 in m.get('result'):
                temp_model = main_models.DescribeAppsResponseBodyResult()
                self.result.append(temp_model.from_map(k1))

        return self

class DescribeAppsResponseBodyResult(DaraModel):
    def __init__(
        self,
        auto_switch: bool = None,
        cluster: main_models.DescribeAppsResponseBodyResultCluster = None,
        cluster_name: str = None,
        data_sources: List[main_models.DescribeAppsResponseBodyResultDataSources] = None,
        description: str = None,
        domain: main_models.DescribeAppsResponseBodyResultDomain = None,
        fetch_fields: List[str] = None,
        first_ranks: List[main_models.DescribeAppsResponseBodyResultFirstRanks] = None,
        id: str = None,
        interpretations: Dict[str, Any] = None,
        is_current: bool = None,
        progress_percent: int = None,
        prompts: List[Dict[str, Any]] = None,
        query_processors: List[main_models.DescribeAppsResponseBodyResultQueryProcessors] = None,
        quota: main_models.DescribeAppsResponseBodyResultQuota = None,
        schema: main_models.DescribeAppsResponseBodyResultSchema = None,
        schemas: List[main_models.DescribeAppsResponseBodyResultSchemas] = None,
        second_ranks: List[main_models.DescribeAppsResponseBodyResultSecondRanks] = None,
        status: str = None,
        summaries: List[main_models.DescribeAppsResponseBodyResultSummaries] = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cluster') is not None:
            temp_model = main_models.DescribeAppsResponseBodyResultCluster()
        ...
        if m.get('dataSources') is not None:
            for k1 in m.get('dataSources'):
                temp_model = main_models.DescribeAppsResponseBodyResultDataSources()
        ...
        if m.get('domain') is not None:
            temp_model = main_models.DescribeAppsResponseBodyResultDomain()
        ...
        if m.get('firstRanks') is not None:
            for k1 in m.get('firstRanks'):
                temp_model = main_models.DescribeAppsResponseBodyResultFirstRanks()
        ...
        if m.get('queryProcessors') is not None:
            for k1 in m.get('queryProcessors'):
                temp_model = main_models.DescribeAppsResponseBodyResultQueryProcessors()
                self.query_processors.append(temp_model.from_map(k1))

        if m.get('quota') is not None:
            temp_model = main_models.DescribeAppsResponseBodyResultQuota()
            self.quota = temp_model.from_map(m.get('quota'))

        if m.get('schema') is not None:
            temp_model = main_models.DescribeAppsResponseBodyResultSchema()
            self.schema = temp_model.from_map(m.get('schema'))

        self.schemas = []
        if m.get('schemas') is not None:
            for k1 in m.get('schemas'):
                temp_model = main_models.DescribeAppsResponseBodyResultSchemas()
                self.schemas.append(temp_model.from_map(k1))

        self.second_ranks = []
        if m.get('secondRanks') is not None:
            for k1 in m.get('secondRanks'):
                temp_model = main_models.DescribeAppsResponseBodyResultSecondRanks()
        ...
        if m.get('summaries') is not None:
            for k1 in m.get('summaries'):
                temp_model = main_models.DescribeAppsResponseBodyResultSummaries()
...
class DescribeAppsResponseBodyResultSummaries(DaraModel):
    def __init__(
        self,
        meta: List[main_models.DescribeAppsResponseBodyResultSummariesMeta] = None,
        name: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('meta') is not None:
            for k1 in m.get('meta'):
                temp_model = main_models.DescribeAppsResponseBodyResultSummariesMeta()
...
class DescribeAppsResponseBodyResultSummariesMeta(DaraModel):
    def __init__(
        self,
        element: str = None,
        ellipsis: str = None,
...
class DescribeAppsResponseBodyResultSecondRanks(DaraModel):
    def __init__(
        self,
        active: bool = None,
        description: str = None,
...
class DescribeAppsResponseBodyResultSchemas(DaraModel):
    def __init__(
        self,
        index_sort_config: List[main_models.DescribeAppsResponseBodyResultSchemasIndexSortConfig] = None,
        indexes: main_models.DescribeAppsResponseBodyResultSchemasIndexes = None,
        name: str = None,
        route_field: str = None,
        route_field_values: List[str] = None,
        second_route_field: str = None,
        tables: Dict[str, Any] = None,
        ttl_field: main_models.DescribeAppsResponseBodyResultSchemasTtlField = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('indexSortConfig') is not None:
            for k1 in m.get('indexSortConfig'):
                temp_model = main_models.DescribeAppsResponseBodyResultSchemasIndexSortConfig()
                self.index_sort_config.append(temp_model.from_map(k1))

        if m.get('indexes') is not None:
            temp_model = main_models.DescribeAppsResponseBodyResultSchemasIndexes()
        ...
        if m.get('ttlField') is not None:
            temp_model = main_models.DescribeAppsResponseBodyResultSchemasTtlField()
            self.ttl_field = temp_model.from_map(m.get('ttlField'))

        return self

class DescribeAppsResponseBodyResultSchemasTtlField(DaraModel):
    def __init__(
        self,
        name: str = None,
        ttl: int = None,
...
class DescribeAppsResponseBodyResultSchemasIndexes(DaraModel):
    def __init__(
        self,
...
class DescribeAppsResponseBodyResultSchemasIndexSortConfig(DaraModel):
    def __init__(
        self,
        direction: str = None,
        field: str = None,
...
class DescribeAppsResponseBodyResultSchema(DaraModel):
    def __init__(
        self,
        index_sort_config: List[main_models.DescribeAppsResponseBodyResultSchemaIndexSortConfig] = None,
        indexes: main_models.DescribeAppsResponseBodyResultSchemaIndexes = None,
        name: str = None,
        route_field: str = None,
        route_field_values: List[str] = None,
        second_route_field: str = None,
        tables: Dict[str, Any] = None,
        ttl_field: main_models.DescribeAppsResponseBodyResultSchemaTtlField = None,
    ):
        # The sort configurations.
        self.index_sort_config = index_sort_config
        # The index schema.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('indexSortConfig') is not None:
            for k1 in m.get('indexSortConfig'):
                temp_model = main_models.DescribeAppsResponseBodyResultSchemaIndexSortConfig()
                self.index_sort_config.append(temp_model.from_map(k1))

        if m.get('indexes') is not None:
            temp_model = main_models.DescribeAppsResponseBodyResultSchemaIndexes()
            self.indexes = temp_model.from_map(m.get('indexes'))
        ...
        if m.get('ttlField') is not None:
            temp_model = main_models.DescribeAppsResponseBodyResultSchemaTtlField()
            self.ttl_field = temp_model.from_map(m.get('ttlField'))

        return self

class DescribeAppsResponseBodyResultSchemaTtlField(DaraModel):
    def __init__(
        self,
        name: str = None,
        ttl: int = None,
...
class DescribeAppsResponseBodyResultSchemaIndexes(DaraModel):
    def __init__(
        self,
        filter_fields: List[str] = None,
        search_fields: Dict[str, Any] = None,
...
class DescribeAppsResponseBodyResultSchemaIndexSortConfig(DaraModel):
    def __init__(
        self,
        direction: str = None,
        field: str = None,
...
class DescribeAppsResponseBodyResultQuota(DaraModel):
    def __init__(
        self,
...
class DescribeAppsResponseBodyResultQueryProcessors(DaraModel):
    def __init__(
        self,
        active: bool = None,
        category: str = None,
...
class DescribeAppsResponseBodyResultFirstRanks(DaraModel):
    def __init__(
        self,
        active: bool = None,
        description: str = None,
...
class DescribeAppsResponseBodyResultDomain(DaraModel):
    def __init__(
        self,
        category: str = None,
        functions: main_models.DescribeAppsResponseBodyResultDomainFunctions = None,
        name: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('functions') is not None:
            temp_model = main_models.DescribeAppsResponseBodyResultDomainFunctions()
...
class DescribeAppsResponseBodyResultDomainFunctions(DaraModel):
    def __init__(
        self,
        algo: List[str] = None,
        qp: List[str] = None,
...
class DescribeAppsResponseBodyResultDataSources(DaraModel):
    def __init__(
        self,
...
class DescribeAppsResponseBodyResultCluster(DaraModel):
    def __init__(
        self,

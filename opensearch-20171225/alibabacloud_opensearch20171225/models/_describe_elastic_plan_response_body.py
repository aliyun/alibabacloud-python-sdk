...
class DescribeElasticPlanResponseBody(DaraModel):
    def __init__(
        ...
        message: str = None,
        request_id: str = None,
        result: main_models.DescribeElasticPlanResponseBodyResult = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.DescribeElasticPlanResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class DescribeElasticPlanResponseBodyResult(DaraModel):
    def __init__(
        self,

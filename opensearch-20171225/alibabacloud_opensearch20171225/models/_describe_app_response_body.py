...
class DescribeAppResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.DescribeAppResponseBodyResult = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.DescribeAppResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class DescribeAppResponseBodyResult(DaraModel):
    def __init__(
        self,
        auto_switch: bool = None,
        cluster: main_models.DescribeAppResponseBodyResultCluster = None,
        cluster_name: str = None,
        data_sources: List[main_models.DescribeAppResponseBodyResultDataSources] = None,
        description: str = None,
        domain: main_models.DescribeAppResponseBodyResultDomain = None,
        fetch_fields: List[str] = None,
        first_ranks: List[main_models.DescribeAppResponseBodyResultFirstRanks] = None,
        id: str = None,
        ...
        status: str = None,
        summaries: List[main_models.DescribeAppResponseBodyResultSummaries] = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cluster') is not None:
            temp_model = main_models.DescribeAppResponseBodyResultCluster()
        ...
        if m.get('dataSources') is not None:
            for k1 in m.get('dataSources'):
                temp_model = main_models.DescribeAppResponseBodyResultDataSources()
        ...
        if m.get('domain') is not None:
            temp_model = main_models.DescribeAppResponseBodyResultDomain()
        ...
        if m.get('firstRanks') is not None:
            for k1 in m.get('firstRanks'):
                temp_model = main_models.DescribeAppResponseBodyResultFirstRanks()
        ...
        if m.get('queryProcessors') is not None:
            for k1 in m.get('queryProcessors'):
                temp_model = main_models.DescribeAppResponseBodyResultQueryProcessors()
        ...
        if m.get('schemas') is not None:
            for k1 in m.get('schemas'):
                temp_model = main_models.DescribeAppResponseBodyResultSchemas()
                self.schemas.append(temp_model.from_map(k1))

        self.second_ranks = []
        if m.get('secondRanks') is not None:
            for k1 in m.get('secondRanks'):
                temp_model = main_models.DescribeAppResponseBodyResultSecondRanks()
        ...
        if m.get('summaries') is not None:
            for k1 in m.get('summaries'):
                temp_model = main_models.DescribeAppResponseBodyResultSummaries()
...
class DescribeAppResponseBodyResultSummaries(DaraModel):
    def __init__(
        self,
        meta: List[main_models.DescribeAppResponseBodyResultSummariesMeta] = None,
        name: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('meta') is not None:
            for k1 in m.get('meta'):
                temp_model = main_models.DescribeAppResponseBodyResultSummariesMeta()
...
class DescribeAppResponseBodyResultSummariesMeta(DaraModel):
    def __init__(
        self,
        element: str = None,
        ellipsis: str = None,
...
class DescribeAppResponseBodyResultSecondRanks(DaraModel):
    def __init__(
        self,
        active: bool = None,
        description: str = None,
...
class DescribeAppResponseBodyResultSchemas(DaraModel):
    def __init__(
        self,
        index_sort_config: List[main_models.DescribeAppResponseBodyResultSchemasIndexSortConfig] = None,
        indexes: main_models.DescribeAppResponseBodyResultSchemasIndexes = None,
        name: str = None,
        route_field: str = None,
        route_field_values: List[str] = None,
        second_route_field: str = None,
        tables: Dict[str, Any] = None,
        ttl_field: main_models.DescribeAppResponseBodyResultSchemasTtlField = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('indexSortConfig') is not None:
            for k1 in m.get('indexSortConfig'):
                temp_model = main_models.DescribeAppResponseBodyResultSchemasIndexSortConfig()
                self.index_sort_config.append(temp_model.from_map(k1))

        if m.get('indexes') is not None:
            temp_model = main_models.DescribeAppResponseBodyResultSchemasIndexes()
        ...
        if m.get('ttlField') is not None:
            temp_model = main_models.DescribeAppResponseBodyResultSchemasTtlField()
            self.ttl_field = temp_model.from_map(m.get('ttlField'))

        return self

class DescribeAppResponseBodyResultSchemasTtlField(DaraModel):
    def __init__(
        self,
        name: str = None,
        ttl: int = None,
...
class DescribeAppResponseBodyResultSchemasIndexes(DaraModel):
    def __init__(
        self,
...
class DescribeAppResponseBodyResultSchemasIndexSortConfig(DaraModel):
    def __init__(
        self,
        direction: str = None,
        field: str = None,
...
class DescribeAppResponseBodyResultSchema(DaraModel):
    def __init__(
        self,
        index_sort_config: List[main_models.DescribeAppResponseBodyResultSchemaIndexSortConfig] = None,
        indexes: main_models.DescribeAppResponseBodyResultSchemaIndexes = None,
        name: str = None,
        route_field: str = None,
        route_field_values: List[str] = None,
        second_route_field: str = None,
        tables: Dict[str, Any] = None,
        ttl_field: main_models.DescribeAppResponseBodyResultSchemaTtlField = None,
    ):
        # The sort configurations.
        self.index_sort_config = index_sort_config
        # The index schema.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('indexSortConfig') is not None:
            for k1 in m.get('indexSortConfig'):
                temp_model = main_models.DescribeAppResponseBodyResultSchemaIndexSortConfig()
                self.index_sort_config.append(temp_model.from_map(k1))

        if m.get('indexes') is not None:
            temp_model = main_models.DescribeAppResponseBodyResultSchemaIndexes()
            self.indexes = temp_model.from_map(m.get('indexes'))
        ...
        if m.get('ttlField') is not None:
            temp_model = main_models.DescribeAppResponseBodyResultSchemaTtlField()
            self.ttl_field = temp_model.from_map(m.get('ttlField'))

        return self

class DescribeAppResponseBodyResultSchemaTtlField(DaraModel):
    def __init__(
        self,
        name: str = None,
        ttl: int = None,
...
class DescribeAppResponseBodyResultSchemaIndexes(DaraModel):
    def __init__(
        self,
        filter_fields: List[str] = None,
        search_fields: Dict[str, Any] = None,
...
class DescribeAppResponseBodyResultSchemaIndexSortConfig(DaraModel):
    def __init__(
        self,
        direction: str = None,
        field: str = None,
...
class DescribeAppResponseBodyResultQuota(DaraModel):
    def __init__(
        self,
...
class DescribeAppResponseBodyResultQueryProcessors(DaraModel):
    def __init__(
        self,
        active: bool = None,
        category: str = None,
...
class DescribeAppResponseBodyResultFirstRanks(DaraModel):
    def __init__(
        self,
        active: bool = None,
        description: str = None,
...
class DescribeAppResponseBodyResultDomain(DaraModel):
    def __init__(
        self,
        category: str = None,
        functions: main_models.DescribeAppResponseBodyResultDomainFunctions = None,
        name: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('functions') is not None:
            temp_model = main_models.DescribeAppResponseBodyResultDomainFunctions()
...
class DescribeAppResponseBodyResultDomainFunctions(DaraModel):
    def __init__(
        self,
        algo: List[str] = None,
        qp: List[str] = None,
...
class DescribeAppResponseBodyResultDataSources(DaraModel):
    def __init__(
        self,
...
class DescribeAppResponseBodyResultCluster(DaraModel):
    def __init__(
        self,

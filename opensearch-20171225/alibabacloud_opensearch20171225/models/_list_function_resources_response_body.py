...
class ListFunctionResourcesResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        http_code: int = None,
        ...
        message: str = None,
        request_id: str = None,
        result: List[main_models.ListFunctionResourcesResponseBodyResult] = None,
        status: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k1 in m.get('Result'):
                temp_model = main_models.ListFunctionResourcesResponseBodyResult()
...
class ListFunctionResourcesResponseBodyResult(DaraModel):
    def __init__(
        self,
        create_time: int = None,
        data: main_models.ListFunctionResourcesResponseBodyResultData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListFunctionResourcesResponseBodyResultData()
...
class ListFunctionResourcesResponseBodyResultData(DaraModel):
    def __init__(
        self,
        content: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Generators') is not None:
            for k1 in m.get('Generators'):
                temp_model = main_models.ListFunctionResourcesResponseBodyResultDataGenerators()
                self.generators.append(temp_model.from_map(k1))

        return self

class ListFunctionResourcesResponseBodyResultDataGenerators(DaraModel):
    def __init__(
        self,
        generator: str = None,
        input: main_models.ListFunctionResourcesResponseBodyResultDataGeneratorsInput = None,
        output: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Input') is not None:
            temp_model = main_models.ListFunctionResourcesResponseBodyResultDataGeneratorsInput()
...
class ListFunctionResourcesResponseBodyResultDataGeneratorsInput(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Features') is not None:
            for k1 in m.get('Features'):
                temp_model = main_models.ListFunctionResourcesResponseBodyResultDataGeneratorsInputFeatures()
                self.features.append(temp_model.from_map(k1))

        return self

class ListFunctionResourcesResponseBodyResultDataGeneratorsInputFeatures(DaraModel):
    def __init__(
        self,
        name: str = None,
        type: str = None,

...
class ModifyElasticPlanResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        http_code: int = None,
        message: str = None,
        request_id: str = None,
        result: main_models.ModifyElasticPlanResponseBodyResult = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.ModifyElasticPlanResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class ModifyElasticPlanResponseBodyResult(DaraModel):
    def __init__(
        self,

...
class CreateInterventionDictionaryResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.CreateInterventionDictionaryResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class CreateInterventionDictionaryResponseBodyResult(DaraModel):
    def __init__(
        self,
        analyzer: str = None,
        created: str = None,

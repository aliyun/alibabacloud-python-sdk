...
class DescribeInterventionDictionaryResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.DescribeInterventionDictionaryResponseBodyResult = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.DescribeInterventionDictionaryResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class DescribeInterventionDictionaryResponseBodyResult(DaraModel):
    def __init__(
        self,
        analyzer: str = None,
        created: str = None,

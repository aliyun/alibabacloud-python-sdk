...
class DescribeAppGroupResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.DescribeAppGroupResponseBodyResult = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.DescribeAppGroupResponseBodyResult()
            self.result = temp_model.from_map(m.get('result'))

        return self

class DescribeAppGroupResponseBodyResult(DaraModel):
    def __init__(
        self,
        ...
        produced: int = None,
        project_id: str = None,
        quota: main_models.DescribeAppGroupResponseBodyResultQuota = None,
        resource_group_id: str = None,
        second_rank_algo_deployment_id: int = None,
        status: str = None,
        switched_time: int = None,
        tags: List[main_models.DescribeAppGroupResponseBodyResultTags] = None,
        type: str = None,
        updated: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('quota') is not None:
            temp_model = main_models.DescribeAppGroupResponseBodyResultQuota()
        ...
        if m.get('tags') is not None:
            for k1 in m.get('tags'):
                temp_model = main_models.DescribeAppGroupResponseBodyResultTags()
...
class DescribeAppGroupResponseBodyResultTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class DescribeAppGroupResponseBodyResultQuota(DaraModel):
    def __init__(
        self,

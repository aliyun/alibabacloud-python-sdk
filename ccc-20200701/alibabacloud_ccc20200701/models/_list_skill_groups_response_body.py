...
class ListSkillGroupsResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ListSkillGroupsResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListSkillGroupsResponseBodyData()
...
class ListSkillGroupsResponseBodyData(DaraModel):
    def __init__(
        self,
        list: List[main_models.ListSkillGroupsResponseBodyDataList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            for k1 in m.get('List'):
                temp_model = main_models.ListSkillGroupsResponseBodyDataList()
...
class ListSkillGroupsResponseBodyDataList(DaraModel):
    def __init__(
        self,

...
class ListGroupChatMessagesResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ListGroupChatMessagesResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListGroupChatMessagesResponseBodyData()
...
class ListGroupChatMessagesResponseBodyData(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Messages') is not None:
            for k1 in m.get('Messages'):
                temp_model = main_models.ListGroupChatMessagesResponseBodyDataMessages()
...
class ListGroupChatMessagesResponseBodyDataMessages(DaraModel):
    def __init__(
        self,
        content: str = None,
        job_id: str = None,

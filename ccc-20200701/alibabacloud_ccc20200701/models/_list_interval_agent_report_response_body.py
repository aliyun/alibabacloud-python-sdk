...
class ListIntervalAgentReportResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: List[main_models.ListIntervalAgentReportResponseBodyData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListIntervalAgentReportResponseBodyData()
...
class ListIntervalAgentReportResponseBodyData(DaraModel):
    def __init__(
        self,
        back_2back: main_models.ListIntervalAgentReportResponseBodyDataBack2Back = None,
        inbound: main_models.ListIntervalAgentReportResponseBodyDataInbound = None,
        internal: main_models.ListIntervalAgentReportResponseBodyDataInternal = None,
        outbound: main_models.ListIntervalAgentReportResponseBodyDataOutbound = None,
        overall: main_models.ListIntervalAgentReportResponseBodyDataOverall = None,
        stats_time: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Back2Back') is not None:
            temp_model = main_models.ListIntervalAgentReportResponseBodyDataBack2Back()
            self.back_2back = temp_model.from_map(m.get('Back2Back'))

        if m.get('Inbound') is not None:
            temp_model = main_models.ListIntervalAgentReportResponseBodyDataInbound()
            self.inbound = temp_model.from_map(m.get('Inbound'))

        if m.get('Internal') is not None:
            temp_model = main_models.ListIntervalAgentReportResponseBodyDataInternal()
            self.internal = temp_model.from_map(m.get('Internal'))

        if m.get('Outbound') is not None:
            temp_model = main_models.ListIntervalAgentReportResponseBodyDataOutbound()
            self.outbound = temp_model.from_map(m.get('Outbound'))

        if m.get('Overall') is not None:
            temp_model = main_models.ListIntervalAgentReportResponseBodyDataOverall()
...
class ListIntervalAgentReportResponseBodyDataOverall(DaraModel):
    def __init__(
        self,
        ...
        break_code_detail_list: List[main_models.ListIntervalAgentReportResponseBodyDataOverallBreakCodeDetailList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BreakCodeDetailList') is not None:
            for k1 in m.get('BreakCodeDetailList'):
                temp_model = main_models.ListIntervalAgentReportResponseBodyDataOverallBreakCodeDetailList()
...
class ListIntervalAgentReportResponseBodyDataOverallBreakCodeDetailList(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        count: int = None,
...
class ListIntervalAgentReportResponseBodyDataOutbound(DaraModel):
    def __init__(
        self,
...
class ListIntervalAgentReportResponseBodyDataInternal(DaraModel):
    def __init__(
        self,
        average_talk_time: float = None,
        calls_answered: int = None,
...
class ListIntervalAgentReportResponseBodyDataInbound(DaraModel):
    def __init__(
        self,
        access_channel_type_details: List[main_models.ListIntervalAgentReportResponseBodyDataInboundAccessChannelTypeDetails] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AccessChannelTypeDetails') is not None:
            for k1 in m.get('AccessChannelTypeDetails'):
                temp_model = main_models.ListIntervalAgentReportResponseBodyDataInboundAccessChannelTypeDetails()
...
class ListIntervalAgentReportResponseBodyDataInboundAccessChannelTypeDetails(DaraModel):
    def __init__(
        self,
...
class ListIntervalAgentReportResponseBodyDataBack2Back(DaraModel):
    def __init__(
        self,

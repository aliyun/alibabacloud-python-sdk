...
class TakeBreakResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.TakeBreakResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.TakeBreakResponseBodyData()
...
class TakeBreakResponseBodyData(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        device_id: str = None,

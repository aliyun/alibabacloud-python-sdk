...
class ChangeVisibilityResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ChangeVisibilityResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ChangeVisibilityResponseBodyData()
...
class ChangeVisibilityResponseBodyData(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        device_id: str = None,

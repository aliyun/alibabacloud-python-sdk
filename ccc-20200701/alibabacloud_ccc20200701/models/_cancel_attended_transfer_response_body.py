...
class CancelAttendedTransferResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.CancelAttendedTransferResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CancelAttendedTransferResponseBodyData()
...
class CancelAttendedTransferResponseBodyData(DaraModel):
    def __init__(
        self,
        call_context: main_models.CancelAttendedTransferResponseBodyDataCallContext = None,
        context_id: int = None,
        user_context: main_models.CancelAttendedTransferResponseBodyDataUserContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallContext') is not None:
            temp_model = main_models.CancelAttendedTransferResponseBodyDataCallContext()
        ...
        if m.get('UserContext') is not None:
            temp_model = main_models.CancelAttendedTransferResponseBodyDataUserContext()
            self.user_context = temp_model.from_map(m.get('UserContext'))

        return self

class CancelAttendedTransferResponseBodyDataUserContext(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        device_id: str = None,
...
class CancelAttendedTransferResponseBodyDataCallContext(DaraModel):
    def __init__(
        self,
        call_type: str = None,
        channel_contexts: List[main_models.CancelAttendedTransferResponseBodyDataCallContextChannelContexts] = None,
        instance_id: str = None,
        job_id: str = None,
    ):
        # Call type.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ChannelContexts') is not None:
            for k1 in m.get('ChannelContexts'):
                temp_model = main_models.CancelAttendedTransferResponseBodyDataCallContextChannelContexts()
...
class CancelAttendedTransferResponseBodyDataCallContextChannelContexts(DaraModel):
    def __init__(
        self,
        call_type: str = None,

...
class GetUploadAudioDataParamsResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetUploadAudioDataParamsResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetUploadAudioDataParamsResponseBodyData()
...
class GetUploadAudioDataParamsResponseBodyData(DaraModel):
    def __init__(
        self,
        params_str: str = None,
    ):

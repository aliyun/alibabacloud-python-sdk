...
class BlindTransferResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.BlindTransferResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.BlindTransferResponseBodyData()
...
class BlindTransferResponseBodyData(DaraModel):
    def __init__(
        self,
        call_context: main_models.BlindTransferResponseBodyDataCallContext = None,
        context_id: int = None,
        user_context: main_models.BlindTransferResponseBodyDataUserContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallContext') is not None:
            temp_model = main_models.BlindTransferResponseBodyDataCallContext()
        ...
        if m.get('UserContext') is not None:
            temp_model = main_models.BlindTransferResponseBodyDataUserContext()
            self.user_context = temp_model.from_map(m.get('UserContext'))

        return self

class BlindTransferResponseBodyDataUserContext(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        device_id: str = None,
...
class BlindTransferResponseBodyDataCallContext(DaraModel):
    def __init__(
        self,
        call_type: str = None,
        channel_contexts: List[main_models.BlindTransferResponseBodyDataCallContextChannelContexts] = None,
        instance_id: str = None,
        job_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ChannelContexts') is not None:
            for k1 in m.get('ChannelContexts'):
                temp_model = main_models.BlindTransferResponseBodyDataCallContextChannelContexts()
...
class BlindTransferResponseBodyDataCallContextChannelContexts(DaraModel):
    def __init__(
        self,
        call_type: str = None,

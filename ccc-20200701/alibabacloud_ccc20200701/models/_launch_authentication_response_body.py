...
class LaunchAuthenticationResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.LaunchAuthenticationResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.LaunchAuthenticationResponseBodyData()
...
class LaunchAuthenticationResponseBodyData(DaraModel):
    def __init__(
        self,
        call_context: main_models.LaunchAuthenticationResponseBodyDataCallContext = None,
        user_context: main_models.LaunchAuthenticationResponseBodyDataUserContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallContext') is not None:
            temp_model = main_models.LaunchAuthenticationResponseBodyDataCallContext()
            self.call_context = temp_model.from_map(m.get('CallContext'))

        if m.get('UserContext') is not None:
            temp_model = main_models.LaunchAuthenticationResponseBodyDataUserContext()
            self.user_context = temp_model.from_map(m.get('UserContext'))

        return self

class LaunchAuthenticationResponseBodyDataUserContext(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        device_id: str = None,
...
class LaunchAuthenticationResponseBodyDataCallContext(DaraModel):
    def __init__(
        self,
        call_type: str = None,
        channel_contexts: List[main_models.LaunchAuthenticationResponseBodyDataCallContextChannelContexts] = None,
        instance_id: str = None,
        job_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ChannelContexts') is not None:
            for k1 in m.get('ChannelContexts'):
                temp_model = main_models.LaunchAuthenticationResponseBodyDataCallContextChannelContexts()
...
class LaunchAuthenticationResponseBodyDataCallContextChannelContexts(DaraModel):
    def __init__(
        self,
        call_type: str = None,

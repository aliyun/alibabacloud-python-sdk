...
class ClaimCallResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ClaimCallResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ClaimCallResponseBodyData()
...
class ClaimCallResponseBodyData(DaraModel):
    def __init__(
        self,
        call_context: main_models.ClaimCallResponseBodyDataCallContext = None,
        context_id: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallContext') is not None:
            temp_model = main_models.ClaimCallResponseBodyDataCallContext()
        ...
        if m.get('UserContext') is not None:
            temp_model = main_models.ClaimCallResponseBodyDataUserContext()
            self.user_context = temp_model.from_map(m.get('UserContext'))

        return self

class ClaimCallResponseBodyDataUserContext(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        device_id: str = None,
...
class ClaimCallResponseBodyDataCallContext(DaraModel):
    def __init__(
        self,
        channel_contexts: List[main_models.ClaimCallResponseBodyDataCallContextChannelContexts] = None,
        instance_id: str = None,
        job_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ChannelContexts') is not None:
            for k1 in m.get('ChannelContexts'):
                temp_model = main_models.ClaimCallResponseBodyDataCallContextChannelContexts()
...
class ClaimCallResponseBodyDataCallContextChannelContexts(DaraModel):
    def __init__(
        self,
        call_type: str = None,
        channel_id: str = None,

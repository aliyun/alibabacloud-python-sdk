...
class AnswerCallResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.AnswerCallResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.AnswerCallResponseBodyData()
...
class AnswerCallResponseBodyData(DaraModel):
    def __init__(
        self,
        call_context: main_models.AnswerCallResponseBodyDataCallContext = None,
        context_id: int = None,
        user_context: main_models.AnswerCallResponseBodyDataUserContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallContext') is not None:
            temp_model = main_models.AnswerCallResponseBodyDataCallContext()
        ...
        if m.get('UserContext') is not None:
            temp_model = main_models.AnswerCallResponseBodyDataUserContext()
            self.user_context = temp_model.from_map(m.get('UserContext'))

        return self

class AnswerCallResponseBodyDataUserContext(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        device_id: str = None,
...
class AnswerCallResponseBodyDataCallContext(DaraModel):
    def __init__(
        self,
        call_type: str = None,
        channel_contexts: List[main_models.AnswerCallResponseBodyDataCallContextChannelContexts] = None,
        instance_id: str = None,
        job_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ChannelContexts') is not None:
            for k1 in m.get('ChannelContexts'):
                temp_model = main_models.AnswerCallResponseBodyDataCallContextChannelContexts()
...
class AnswerCallResponseBodyDataCallContextChannelContexts(DaraModel):
    def __init__(
        self,
        call_type: str = None,
        channel_id: str = None,

...
class ResetAgentStateResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ResetAgentStateResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ResetAgentStateResponseBodyData()
...
class ResetAgentStateResponseBodyData(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        device_id: str = None,

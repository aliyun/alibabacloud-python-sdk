...
class SwitchToConferenceResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.SwitchToConferenceResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.SwitchToConferenceResponseBodyData()
...
class SwitchToConferenceResponseBodyData(DaraModel):
    def __init__(
        self,
        call_context: main_models.SwitchToConferenceResponseBodyDataCallContext = None,
        user_context: main_models.SwitchToConferenceResponseBodyDataUserContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallContext') is not None:
            temp_model = main_models.SwitchToConferenceResponseBodyDataCallContext()
            self.call_context = temp_model.from_map(m.get('CallContext'))

        if m.get('UserContext') is not None:
            temp_model = main_models.SwitchToConferenceResponseBodyDataUserContext()
            self.user_context = temp_model.from_map(m.get('UserContext'))

        return self

class SwitchToConferenceResponseBodyDataUserContext(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        device_id: str = None,
...
class SwitchToConferenceResponseBodyDataCallContext(DaraModel):
    def __init__(
        self,
        call_type: str = None,
        channel_contexts: List[main_models.SwitchToConferenceResponseBodyDataCallContextChannelContexts] = None,
        instance_id: str = None,
        job_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ChannelContexts') is not None:
            for k1 in m.get('ChannelContexts'):
                temp_model = main_models.SwitchToConferenceResponseBodyDataCallContextChannelContexts()
...
class SwitchToConferenceResponseBodyDataCallContextChannelContexts(DaraModel):
    def __init__(
        self,
        call_type: str = None,

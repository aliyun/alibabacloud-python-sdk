...
class SignInGroupResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.SignInGroupResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.SignInGroupResponseBodyData()
...
class SignInGroupResponseBodyData(DaraModel):
    def __init__(
        self,
        break_code: str = None,

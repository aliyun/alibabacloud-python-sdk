...
class MakeCallResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.MakeCallResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.MakeCallResponseBodyData()
...
class MakeCallResponseBodyData(DaraModel):
    def __init__(
        self,
        call_context: main_models.MakeCallResponseBodyDataCallContext = None,
        context_id: int = None,
        user_context: main_models.MakeCallResponseBodyDataUserContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallContext') is not None:
            temp_model = main_models.MakeCallResponseBodyDataCallContext()
        ...
        if m.get('UserContext') is not None:
            temp_model = main_models.MakeCallResponseBodyDataUserContext()
            self.user_context = temp_model.from_map(m.get('UserContext'))

        return self

class MakeCallResponseBodyDataUserContext(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        device_id: str = None,
...
class MakeCallResponseBodyDataCallContext(DaraModel):
    def __init__(
        self,
        call_type: str = None,
        call_variables: str = None,
        channel_contexts: List[main_models.MakeCallResponseBodyDataCallContextChannelContexts] = None,
        instance_id: str = None,
        job_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ChannelContexts') is not None:
            for k1 in m.get('ChannelContexts'):
                temp_model = main_models.MakeCallResponseBodyDataCallContextChannelContexts()
...
class MakeCallResponseBodyDataCallContextChannelContexts(DaraModel):
    def __init__(
        self,
        call_type: str = None,

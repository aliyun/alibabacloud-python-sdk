...
class ListSkillGroupStatesResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ListSkillGroupStatesResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListSkillGroupStatesResponseBodyData()
...
class ListSkillGroupStatesResponseBodyData(DaraModel):
    def __init__(
        self,
        list: List[main_models.ListSkillGroupStatesResponseBodyDataList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            for k1 in m.get('List'):
                temp_model = main_models.ListSkillGroupStatesResponseBodyDataList()
...
class ListSkillGroupStatesResponseBodyDataList(DaraModel):
    def __init__(
        self,

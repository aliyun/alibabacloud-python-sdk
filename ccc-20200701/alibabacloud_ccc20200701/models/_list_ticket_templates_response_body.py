...
class ListTicketTemplatesResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ListTicketTemplatesResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListTicketTemplatesResponseBodyData()
...
class ListTicketTemplatesResponseBodyData(DaraModel):
    def __init__(
        self,
        list: List[main_models.ListTicketTemplatesResponseBodyDataList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            for k1 in m.get('List'):
                temp_model = main_models.ListTicketTemplatesResponseBodyDataList()
...
class ListTicketTemplatesResponseBodyDataList(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TicketFields') is not None:
            for k1 in m.get('TicketFields'):
                temp_model = main_models.ListTicketTemplatesResponseBodyDataListTicketFields()
...
class ListTicketTemplatesResponseBodyDataListTicketFields(DaraModel):
    def __init__(
        self,
        array: bool = None,
        attribute: str = None,

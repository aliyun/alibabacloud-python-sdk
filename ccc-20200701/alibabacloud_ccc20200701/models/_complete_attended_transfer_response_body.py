...
class CompleteAttendedTransferResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.CompleteAttendedTransferResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CompleteAttendedTransferResponseBodyData()
...
class CompleteAttendedTransferResponseBodyData(DaraModel):
    def __init__(
        self,
        call_context: main_models.CompleteAttendedTransferResponseBodyDataCallContext = None,
        context_id: int = None,
        user_context: main_models.CompleteAttendedTransferResponseBodyDataUserContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallContext') is not None:
            temp_model = main_models.CompleteAttendedTransferResponseBodyDataCallContext()
        ...
        if m.get('UserContext') is not None:
            temp_model = main_models.CompleteAttendedTransferResponseBodyDataUserContext()
            self.user_context = temp_model.from_map(m.get('UserContext'))

        return self

class CompleteAttendedTransferResponseBodyDataUserContext(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        device_id: str = None,
...
class CompleteAttendedTransferResponseBodyDataCallContext(DaraModel):
    def __init__(
        self,
        call_type: str = None,
        channel_contexts: List[main_models.CompleteAttendedTransferResponseBodyDataCallContextChannelContexts] = None,
        instance_id: str = None,
        job_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ChannelContexts') is not None:
            for k1 in m.get('ChannelContexts'):
                temp_model = main_models.CompleteAttendedTransferResponseBodyDataCallContextChannelContexts()
...
class CompleteAttendedTransferResponseBodyDataCallContextChannelContexts(DaraModel):
    def __init__(
        self,
        call_type: str = None,

...
class StartPredictiveCallResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.StartPredictiveCallResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.StartPredictiveCallResponseBodyData()
...
class StartPredictiveCallResponseBodyData(DaraModel):
    def __init__(
        self,
        call_context: main_models.StartPredictiveCallResponseBodyDataCallContext = None,
        user_context: main_models.StartPredictiveCallResponseBodyDataUserContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallContext') is not None:
            temp_model = main_models.StartPredictiveCallResponseBodyDataCallContext()
            self.call_context = temp_model.from_map(m.get('CallContext'))

        if m.get('UserContext') is not None:
            temp_model = main_models.StartPredictiveCallResponseBodyDataUserContext()
            self.user_context = temp_model.from_map(m.get('UserContext'))

        return self

class StartPredictiveCallResponseBodyDataUserContext(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        device_id: str = None,
...
class StartPredictiveCallResponseBodyDataCallContext(DaraModel):
    def __init__(
        self,
        call_type: str = None,
        channel_contexts: List[main_models.StartPredictiveCallResponseBodyDataCallContextChannelContexts] = None,
        instance_id: str = None,
        job_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ChannelContexts') is not None:
            for k1 in m.get('ChannelContexts'):
                temp_model = main_models.StartPredictiveCallResponseBodyDataCallContextChannelContexts()
...
class StartPredictiveCallResponseBodyDataCallContextChannelContexts(DaraModel):
    def __init__(
        self,
        call_type: str = None,

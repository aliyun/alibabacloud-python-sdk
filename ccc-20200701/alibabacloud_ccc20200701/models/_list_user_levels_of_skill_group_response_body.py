...
class ListUserLevelsOfSkillGroupResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ListUserLevelsOfSkillGroupResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListUserLevelsOfSkillGroupResponseBodyData()
...
class ListUserLevelsOfSkillGroupResponseBodyData(DaraModel):
    def __init__(
        self,
        list: List[main_models.ListUserLevelsOfSkillGroupResponseBodyDataList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            for k1 in m.get('List'):
                temp_model = main_models.ListUserLevelsOfSkillGroupResponseBodyDataList()
...
class ListUserLevelsOfSkillGroupResponseBodyDataList(DaraModel):
    def __init__(
        self,

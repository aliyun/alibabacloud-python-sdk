...
class GetSummaryTemplateResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetSummaryTemplateResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetSummaryTemplateResponseBodyData()
...
class GetSummaryTemplateResponseBodyData(DaraModel):
    def __init__(
        self,
        ...
        name: str = None,
        property_list: List[main_models.GetSummaryTemplateResponseBodyDataPropertyList] = None,
        state: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PropertyList') is not None:
            for k1 in m.get('PropertyList'):
                temp_model = main_models.GetSummaryTemplateResponseBodyDataPropertyList()
...
class GetSummaryTemplateResponseBodyDataPropertyList(DaraModel):
    def __init__(
        self,
        array: bool = None,
        attributes: str = None,

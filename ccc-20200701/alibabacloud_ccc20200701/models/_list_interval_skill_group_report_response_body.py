...
class ListIntervalSkillGroupReportResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: List[main_models.ListIntervalSkillGroupReportResponseBodyData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListIntervalSkillGroupReportResponseBodyData()
...
class ListIntervalSkillGroupReportResponseBodyData(DaraModel):
    def __init__(
        self,
        back_2back: main_models.ListIntervalSkillGroupReportResponseBodyDataBack2Back = None,
        inbound: main_models.ListIntervalSkillGroupReportResponseBodyDataInbound = None,
        outbound: main_models.ListIntervalSkillGroupReportResponseBodyDataOutbound = None,
        overall: main_models.ListIntervalSkillGroupReportResponseBodyDataOverall = None,
        stats_time: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Back2Back') is not None:
            temp_model = main_models.ListIntervalSkillGroupReportResponseBodyDataBack2Back()
            self.back_2back = temp_model.from_map(m.get('Back2Back'))

        if m.get('Inbound') is not None:
            temp_model = main_models.ListIntervalSkillGroupReportResponseBodyDataInbound()
            self.inbound = temp_model.from_map(m.get('Inbound'))

        if m.get('Outbound') is not None:
            temp_model = main_models.ListIntervalSkillGroupReportResponseBodyDataOutbound()
            self.outbound = temp_model.from_map(m.get('Outbound'))

        if m.get('Overall') is not None:
            temp_model = main_models.ListIntervalSkillGroupReportResponseBodyDataOverall()
...
class ListIntervalSkillGroupReportResponseBodyDataOverall(DaraModel):
    def __init__(
        self,
        ...
        break_code_detail_list: List[main_models.ListIntervalSkillGroupReportResponseBodyDataOverallBreakCodeDetailList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BreakCodeDetailList') is not None:
            for k1 in m.get('BreakCodeDetailList'):
                temp_model = main_models.ListIntervalSkillGroupReportResponseBodyDataOverallBreakCodeDetailList()
...
class ListIntervalSkillGroupReportResponseBodyDataOverallBreakCodeDetailList(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        count: int = None,
...
class ListIntervalSkillGroupReportResponseBodyDataOutbound(DaraModel):
    def __init__(
        self,
...
class ListIntervalSkillGroupReportResponseBodyDataInbound(DaraModel):
    def __init__(
        self,
...
class ListIntervalSkillGroupReportResponseBodyDataBack2Back(DaraModel):
    def __init__(
        self,

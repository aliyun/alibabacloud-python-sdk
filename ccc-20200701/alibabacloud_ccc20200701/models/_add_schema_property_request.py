...
class AddSchemaPropertyRequest(DaraModel):
    def __init__(
        self,
        instance_id: str = None,
        property: main_models.AddSchemaPropertyRequestProperty = None,
        request_id: str = None,
        schema_id: str = None,
    ):
        # Instance ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Property') is not None:
            temp_model = main_models.AddSchemaPropertyRequestProperty()
...
class AddSchemaPropertyRequestProperty(DaraModel):
    def __init__(
        self,
        array: bool = None,
        attributes: str = None,

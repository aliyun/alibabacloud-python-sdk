...
class ListVoicemailsResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ListVoicemailsResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListVoicemailsResponseBodyData()
...
class ListVoicemailsResponseBodyData(DaraModel):
    def __init__(
        self,
        list: List[main_models.ListVoicemailsResponseBodyDataList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            for k1 in m.get('List'):
                temp_model = main_models.ListVoicemailsResponseBodyDataList()
...
class ListVoicemailsResponseBodyDataList(DaraModel):
    def __init__(
        self,
        callee: str = None,
        caller: str = None,

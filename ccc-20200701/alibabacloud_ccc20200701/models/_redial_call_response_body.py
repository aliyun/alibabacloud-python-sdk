...
class RedialCallResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.RedialCallResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.RedialCallResponseBodyData()
...
class RedialCallResponseBodyData(DaraModel):
    def __init__(
        self,
        call_context: main_models.RedialCallResponseBodyDataCallContext = None,
        context_id: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallContext') is not None:
            temp_model = main_models.RedialCallResponseBodyDataCallContext()
        ...
        if m.get('UserContext') is not None:
            temp_model = main_models.RedialCallResponseBodyDataUserContext()
            self.user_context = temp_model.from_map(m.get('UserContext'))

        return self

class RedialCallResponseBodyDataUserContext(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        device_id: str = None,
...
class RedialCallResponseBodyDataCallContext(DaraModel):
    def __init__(
        self,
        call_type: str = None,
        channel_contexts: List[main_models.RedialCallResponseBodyDataCallContextChannelContexts] = None,
        instance_id: str = None,
        job_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ChannelContexts') is not None:
            for k1 in m.get('ChannelContexts'):
                temp_model = main_models.RedialCallResponseBodyDataCallContextChannelContexts()
...
class RedialCallResponseBodyDataCallContextChannelContexts(DaraModel):
    def __init__(
        self,
        call_type: str = None,

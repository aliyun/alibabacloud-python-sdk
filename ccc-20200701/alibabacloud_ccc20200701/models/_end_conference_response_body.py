...
class EndConferenceResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.EndConferenceResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.EndConferenceResponseBodyData()
...
class EndConferenceResponseBodyData(DaraModel):
    def __init__(
        self,
        call_context: main_models.EndConferenceResponseBodyDataCallContext = None,
        context_id: int = None,
        user_context: main_models.EndConferenceResponseBodyDataUserContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallContext') is not None:
            temp_model = main_models.EndConferenceResponseBodyDataCallContext()
        ...
        if m.get('UserContext') is not None:
            temp_model = main_models.EndConferenceResponseBodyDataUserContext()
            self.user_context = temp_model.from_map(m.get('UserContext'))

        return self

class EndConferenceResponseBodyDataUserContext(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        device_id: str = None,
...
class EndConferenceResponseBodyDataCallContext(DaraModel):
    def __init__(
        self,
        channel_contexts: List[main_models.EndConferenceResponseBodyDataCallContextChannelContexts] = None,
        instance_id: str = None,
        job_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ChannelContexts') is not None:
            for k1 in m.get('ChannelContexts'):
                temp_model = main_models.EndConferenceResponseBodyDataCallContextChannelContexts()
...
class EndConferenceResponseBodyDataCallContextChannelContexts(DaraModel):
    def __init__(
        self,
        call_type: str = None,
        channel_id: str = None,

...
class StartBack2BackCallResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.StartBack2BackCallResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.StartBack2BackCallResponseBodyData()
...
class StartBack2BackCallResponseBodyData(DaraModel):
    def __init__(
        self,
        call_context: main_models.StartBack2BackCallResponseBodyDataCallContext = None,
        user_context: main_models.StartBack2BackCallResponseBodyDataUserContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallContext') is not None:
            temp_model = main_models.StartBack2BackCallResponseBodyDataCallContext()
            self.call_context = temp_model.from_map(m.get('CallContext'))

        if m.get('UserContext') is not None:
            temp_model = main_models.StartBack2BackCallResponseBodyDataUserContext()
            self.user_context = temp_model.from_map(m.get('UserContext'))

        return self

class StartBack2BackCallResponseBodyDataUserContext(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        device_id: str = None,
...
class StartBack2BackCallResponseBodyDataCallContext(DaraModel):
    def __init__(
        self,
        call_type: str = None,
        channel_contexts: List[main_models.StartBack2BackCallResponseBodyDataCallContextChannelContexts] = None,
        instance_id: str = None,
        job_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ChannelContexts') is not None:
            for k1 in m.get('ChannelContexts'):
                temp_model = main_models.StartBack2BackCallResponseBodyDataCallContextChannelContexts()
...
class StartBack2BackCallResponseBodyDataCallContextChannelContexts(DaraModel):
    def __init__(
        self,
        call_type: str = None,

...
class ListFeedbacksResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: List[main_models.ListFeedbacksResponseBodyData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListFeedbacksResponseBodyData()
...
class ListFeedbacksResponseBodyData(DaraModel):
    def __init__(
        self,
        contact_id: str = None,

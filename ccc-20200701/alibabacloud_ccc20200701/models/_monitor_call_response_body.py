...
class MonitorCallResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.MonitorCallResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.MonitorCallResponseBodyData()
...
class MonitorCallResponseBodyData(DaraModel):
    def __init__(
        self,
        call_context: main_models.MonitorCallResponseBodyDataCallContext = None,
        user_context: main_models.MonitorCallResponseBodyDataUserContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallContext') is not None:
            temp_model = main_models.MonitorCallResponseBodyDataCallContext()
            self.call_context = temp_model.from_map(m.get('CallContext'))

        if m.get('UserContext') is not None:
            temp_model = main_models.MonitorCallResponseBodyDataUserContext()
            self.user_context = temp_model.from_map(m.get('UserContext'))

        return self

class MonitorCallResponseBodyDataUserContext(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        device_id: str = None,
...
class MonitorCallResponseBodyDataCallContext(DaraModel):
    def __init__(
        self,
        call_type: str = None,
        channel_contexts: List[main_models.MonitorCallResponseBodyDataCallContextChannelContexts] = None,
        instance_id: str = None,
        job_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ChannelContexts') is not None:
            for k1 in m.get('ChannelContexts'):
                temp_model = main_models.MonitorCallResponseBodyDataCallContextChannelContexts()
...
class MonitorCallResponseBodyDataCallContextChannelContexts(DaraModel):
    def __init__(
        self,
        call_type: str = None,

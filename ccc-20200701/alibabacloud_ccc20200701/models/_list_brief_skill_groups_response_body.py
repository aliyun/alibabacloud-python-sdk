...
class ListBriefSkillGroupsResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ListBriefSkillGroupsResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListBriefSkillGroupsResponseBodyData()
...
class ListBriefSkillGroupsResponseBodyData(DaraModel):
    def __init__(
        self,
        list: List[main_models.ListBriefSkillGroupsResponseBodyDataList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            for k1 in m.get('List'):
                temp_model = main_models.ListBriefSkillGroupsResponseBodyDataList()
...
class ListBriefSkillGroupsResponseBodyDataList(DaraModel):
    def __init__(
        self,

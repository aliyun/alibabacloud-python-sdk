...
class ModuleFlightItemListItemListSubItemsShoppingItemMapValue(DaraModel):
    def __init__(
        self,
        id: str = None,
        cabin_quantity: Dict[str, main_models.ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue] = None,
        search_price: main_models.ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice = None,
        segment_price: Dict[str, main_models.ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue] = None,
    ):
        # id
        self.id = id
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cabin_quantity') is not None:
            for k1, v1 in m.get('cabin_quantity').items():
                temp_model = main_models.ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue()
                self.cabin_quantity[k1] = temp_model.from_map(v1)

        if m.get('search_price') is not None:
            temp_model = main_models.ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice()
        ...
        if m.get('segment_price') is not None:
            for k1, v1 in m.get('segment_price').items():
                temp_model = main_models.ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue()
                self.segment_price[k1] = temp_model.from_map(v1)

        return self

class ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPrice(DaraModel):
    def __init__(
        self,
        ...
        price_show_info: main_models.ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('price_show_info') is not None:
            temp_model = main_models.ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo()
            self.price_show_info = temp_model.from_map(m.get('price_show_info'))

        return self

class ModuleFlightItemListItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo(DaraModel):
    def __init__(
        self,

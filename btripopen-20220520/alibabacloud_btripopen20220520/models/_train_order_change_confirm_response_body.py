...
class TrainOrderChangeConfirmResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        module: main_models.TrainOrderChangeConfirmResponseBodyModule = None,
        request_id: str = None,
        success: bool = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('module') is not None:
            temp_model = main_models.TrainOrderChangeConfirmResponseBodyModule()
...
class TrainOrderChangeConfirmResponseBodyModule(DaraModel):
    def __init__(
        self,

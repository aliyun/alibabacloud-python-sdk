...
class ModuleReShopItemListSubItemsShoppingItemMapValue(DaraModel):
    def __init__(
        self,
        cabin_quantity_list: List[main_models.ModuleReShopItemListSubItemsShoppingItemMapValueCabinQuantityList] = None,
        search_price: main_models.ModuleReShopItemListSubItemsShoppingItemMapValueSearchPrice = None,
        segment_price_list: List[main_models.ModuleReShopItemListSubItemsShoppingItemMapValueSegmentPriceList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cabin_quantity_list') is not None:
            for k1 in m.get('cabin_quantity_list'):
                temp_model = main_models.ModuleReShopItemListSubItemsShoppingItemMapValueCabinQuantityList()
                self.cabin_quantity_list.append(temp_model.from_map(k1))

        if m.get('search_price') is not None:
            temp_model = main_models.ModuleReShopItemListSubItemsShoppingItemMapValueSearchPrice()
        ...
        if m.get('segment_price_list') is not None:
            for k1 in m.get('segment_price_list'):
                temp_model = main_models.ModuleReShopItemListSubItemsShoppingItemMapValueSegmentPriceList()
                self.segment_price_list.append(temp_model.from_map(k1))

        return self

class ModuleReShopItemListSubItemsShoppingItemMapValueSegmentPriceList(DaraModel):
    def __init__(
        self,
        segment_position: main_models.ModuleReShopItemListSubItemsShoppingItemMapValueSegmentPriceListSegmentPosition = None,
        search_price: main_models.ModuleReShopItemListSubItemsShoppingItemMapValueSegmentPriceListSearchPrice = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('segment_position') is not None:
            temp_model = main_models.ModuleReShopItemListSubItemsShoppingItemMapValueSegmentPriceListSegmentPosition()
            self.segment_position = temp_model.from_map(m.get('segment_position'))

        if m.get('search_price') is not None:
            temp_model = main_models.ModuleReShopItemListSubItemsShoppingItemMapValueSegmentPriceListSearchPrice()
            self.search_price = temp_model.from_map(m.get('search_price'))

        return self

class ModuleReShopItemListSubItemsShoppingItemMapValueSegmentPriceListSearchPrice(DaraModel):
    def __init__(
        self,
...
class ModuleReShopItemListSubItemsShoppingItemMapValueSegmentPriceListSegmentPosition(DaraModel):
    def __init__(
        self,
...
class ModuleReShopItemListSubItemsShoppingItemMapValueSearchPrice(DaraModel):
    def __init__(
        self,
        total_amount: int = None,
        handling_amount: int = None,
...
class ModuleReShopItemListSubItemsShoppingItemMapValueCabinQuantityList(DaraModel):
    def __init__(
        self,
        segment_position: main_models.ModuleReShopItemListSubItemsShoppingItemMapValueCabinQuantityListSegmentPosition = None,
        cabin_info: main_models.ModuleReShopItemListSubItemsShoppingItemMapValueCabinQuantityListCabinInfo = None,
    ):
        self.segment_position = segment_position
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('segment_position') is not None:
            temp_model = main_models.ModuleReShopItemListSubItemsShoppingItemMapValueCabinQuantityListSegmentPosition()
            self.segment_position = temp_model.from_map(m.get('segment_position'))

        if m.get('cabin_info') is not None:
            temp_model = main_models.ModuleReShopItemListSubItemsShoppingItemMapValueCabinQuantityListCabinInfo()
            self.cabin_info = temp_model.from_map(m.get('cabin_info'))

        return self

class ModuleReShopItemListSubItemsShoppingItemMapValueCabinQuantityListCabinInfo(DaraModel):
    def __init__(
        self,
        cabin: str = None,
...
class ModuleReShopItemListSubItemsShoppingItemMapValueCabinQuantityListSegmentPosition(DaraModel):
    def __init__(
        self,
        journey_index: int = None,
        segment_index: int = None,

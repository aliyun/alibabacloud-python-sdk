...
class CooperatorFlightBillSettlementQueryResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        module: main_models.CooperatorFlightBillSettlementQueryResponseBodyModule = None,
        request_id: str = None,
        success: bool = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('module') is not None:
            temp_model = main_models.CooperatorFlightBillSettlementQueryResponseBodyModule()
...
class CooperatorFlightBillSettlementQueryResponseBodyModule(DaraModel):
    def __init__(
        self,
        category: int = None,
        corp_id: str = None,
        items: List[main_models.CooperatorFlightBillSettlementQueryResponseBodyModuleItems] = None,
        period_end: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('items') is not None:
            for k1 in m.get('items'):
                temp_model = main_models.CooperatorFlightBillSettlementQueryResponseBodyModuleItems()
...
class CooperatorFlightBillSettlementQueryResponseBodyModuleItems(DaraModel):
    def __init__(
        self,

...
class AddEmployeeRequest(DaraModel):
    def __init__(
        self,
        ...
        base_location_list: List[main_models.AddEmployeeRequestBaseLocationList] = None,
        birthday: str = None,
        cert_list: List[main_models.AddEmployeeRequestCertList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('base_location_list') is not None:
            for k1 in m.get('base_location_list'):
                temp_model = main_models.AddEmployeeRequestBaseLocationList()
        ...
        if m.get('cert_list') is not None:
            for k1 in m.get('cert_list'):
                temp_model = main_models.AddEmployeeRequestCertList()
...
class AddEmployeeRequestCertList(DaraModel):
    def __init__(
        self,
        birthday: str = None,
...
class AddEmployeeRequestBaseLocationList(DaraModel):
    def __init__(
        self,
        code: str = None,
        level: str = None,

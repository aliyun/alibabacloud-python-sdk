...
class IeCarBillSettlementQueryResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        module: main_models.IeCarBillSettlementQueryResponseBodyModule = None,
        request_id: str = None,
        success: bool = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('module') is not None:
            temp_model = main_models.IeCarBillSettlementQueryResponseBodyModule()
...
class IeCarBillSettlementQueryResponseBodyModule(DaraModel):
    def __init__(
        self,
        category: int = None,
        corp_id: str = None,
        items: List[main_models.IeCarBillSettlementQueryResponseBodyModuleItems] = None,
        period_end: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('items') is not None:
            for k1 in m.get('items'):
                temp_model = main_models.IeCarBillSettlementQueryResponseBodyModuleItems()
...
class IeCarBillSettlementQueryResponseBodyModuleItems(DaraModel):
    def __init__(
        self,
        account_month: str = None,
        ...
        self.dep_date_local = dep_date_local
        ...
        self.financial_subject = financial_subject
        ...
        self.origin_apply_id = origin_apply_id
        ...
        self.traveler_use_id = traveler_use_id
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        if self.account_month is not None:
            result['account_month'] = self.account_month
        ...
        if self.arr_date_local is not None:
            result['arr_date_local'] = self.arr_date_local
        ...
        if self.bill_record_time_str is not None:
            result['bill_record_time_str'] = self.bill_record_time_str
        ...
        if self.book_time_local is not None:
            result['book_time_local'] = self.book_time_local
        ...
        if self.booker_use_id is not None:
            result['booker_use_id'] = self.booker_use_id
        ...
        if self.dep_date_local is not None:
            result['dep_date_local'] = self.dep_date_local
        ...
        if self.financial_subject is not None:
            result['financial_subject'] = self.financial_subject
        ...
        if self.last_department is not None:
            result['last_department'] = self.last_department
        ...
        if self.origin_apply_id is not None:
            result['origin_apply_id'] = self.origin_apply_id
        ...
        if self.traveler_use_id is not None:
            result['traveler_use_id'] = self.traveler_use_id
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('account_month') is not None:
            self.account_month = m.get('account_month')
        ...
        if m.get('arr_date_local') is not None:
            self.arr_date_local = m.get('arr_date_local')
        ...
        if m.get('bill_record_time_str') is not None:
            self.bill_record_time_str = m.get('bill_record_time_str')
        ...
        if m.get('book_time_local') is not None:
            self.book_time_local = m.get('book_time_local')
        ...
        if m.get('booker_use_id') is not None:
            self.booker_use_id = m.get('booker_use_id')
        ...
        if m.get('dep_date_local') is not None:
            self.dep_date_local = m.get('dep_date_local')
        ...
        if m.get('financial_subject') is not None:
            self.financial_subject = m.get('financial_subject')
        ...
        if m.get('last_department') is not None:
            self.last_department = m.get('last_department')
        ...
        if m.get('origin_apply_id') is not None:
            self.origin_apply_id = m.get('origin_apply_id')
        ...
        if m.get('record_status') is not None:
            self.record_status = m.get('record_status')
        ...
        if m.get('traveler_use_id') is not None:
            self.traveler_use_id = m.get('traveler_use_id')

...
class ModuleItemListShoppingItemMapValue(DaraModel):
    def __init__(
        self,
        cabin_quantity_list: List[main_models.ModuleItemListShoppingItemMapValueCabinQuantityList] = None,
        search_price: main_models.ModuleItemListShoppingItemMapValueSearchPrice = None,
        segment_price_list: List[main_models.ModuleItemListShoppingItemMapValueSegmentPriceList] = None,
        id: str = None,
        cabin_quantity: Dict[str, main_models.ModuleItemListShoppingItemMapValueCabinQuantityValue] = None,
        segment_price: Dict[str, main_models.ModuleItemListShoppingItemMapValueSegmentPriceValue] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cabin_quantity_list') is not None:
            for k1 in m.get('cabin_quantity_list'):
                temp_model = main_models.ModuleItemListShoppingItemMapValueCabinQuantityList()
                self.cabin_quantity_list.append(temp_model.from_map(k1))

        if m.get('search_price') is not None:
            temp_model = main_models.ModuleItemListShoppingItemMapValueSearchPrice()
        ...
        if m.get('segment_price_list') is not None:
            for k1 in m.get('segment_price_list'):
                temp_model = main_models.ModuleItemListShoppingItemMapValueSegmentPriceList()
        ...
        if m.get('cabin_quantity') is not None:
            for k1, v1 in m.get('cabin_quantity').items():
                temp_model = main_models.ModuleItemListShoppingItemMapValueCabinQuantityValue()
                self.cabin_quantity[k1] = temp_model.from_map(v1)

        self.segment_price = {}
        if m.get('segment_price') is not None:
            for k1, v1 in m.get('segment_price').items():
                temp_model = main_models.ModuleItemListShoppingItemMapValueSegmentPriceValue()
                self.segment_price[k1] = temp_model.from_map(v1)

        return self

class ModuleItemListShoppingItemMapValueSegmentPriceList(DaraModel):
    def __init__(
        self,
        segment_position: main_models.ModuleItemListShoppingItemMapValueSegmentPriceListSegmentPosition = None,
        search_price: main_models.ModuleItemListShoppingItemMapValueSegmentPriceListSearchPrice = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('segment_position') is not None:
            temp_model = main_models.ModuleItemListShoppingItemMapValueSegmentPriceListSegmentPosition()
            self.segment_position = temp_model.from_map(m.get('segment_position'))

        if m.get('search_price') is not None:
            temp_model = main_models.ModuleItemListShoppingItemMapValueSegmentPriceListSearchPrice()
            self.search_price = temp_model.from_map(m.get('search_price'))

        return self

class ModuleItemListShoppingItemMapValueSegmentPriceListSearchPrice(DaraModel):
    def __init__(
        self,
        sell_price: int = None,
...
class ModuleItemListShoppingItemMapValueSegmentPriceListSegmentPosition(DaraModel):
    def __init__(
        self,
...
class ModuleItemListShoppingItemMapValueSearchPrice(DaraModel):
    def __init__(
        self,
        ...
        price_show_info: main_models.ModuleItemListShoppingItemMapValueSearchPricePriceShowInfo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('price_show_info') is not None:
            temp_model = main_models.ModuleItemListShoppingItemMapValueSearchPricePriceShowInfo()
            self.price_show_info = temp_model.from_map(m.get('price_show_info'))

        return self

class ModuleItemListShoppingItemMapValueSearchPricePriceShowInfo(DaraModel):
    def __init__(
        self,
...
class ModuleItemListShoppingItemMapValueCabinQuantityList(DaraModel):
    def __init__(
        self,
        segment_position: main_models.ModuleItemListShoppingItemMapValueCabinQuantityListSegmentPosition = None,
        cabin_info: main_models.ModuleItemListShoppingItemMapValueCabinQuantityListCabinInfo = None,
    ):
        self.segment_position = segment_position
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('segment_position') is not None:
            temp_model = main_models.ModuleItemListShoppingItemMapValueCabinQuantityListSegmentPosition()
            self.segment_position = temp_model.from_map(m.get('segment_position'))

        if m.get('cabin_info') is not None:
            temp_model = main_models.ModuleItemListShoppingItemMapValueCabinQuantityListCabinInfo()
            self.cabin_info = temp_model.from_map(m.get('cabin_info'))

        return self

class ModuleItemListShoppingItemMapValueCabinQuantityListCabinInfo(DaraModel):
    def __init__(
        self,
        cabin: str = None,
...
class ModuleItemListShoppingItemMapValueCabinQuantityListSegmentPosition(DaraModel):
    def __init__(
        self,
        journey_index: int = None,
        segment_index: int = None,

...
class UpdateEmployeeRequest(DaraModel):
    def __init__(
        self,
        ...
        base_location_list: List[main_models.UpdateEmployeeRequestBaseLocationList] = None,
        birthday: str = None,
        cert_list: List[main_models.UpdateEmployeeRequestCertList] = None,
    ...
    def validate(self):
        if self.base_location_list:
            for v1 in self.base_location_list:
                 if v1:
                    v1.validate()
        if self.cert_list:
    ...
    def to_map(self):
        ...
        if self.base_location_list is not None:
            for k1 in self.base_location_list:
                result['base_location_list'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('base_location_list') is not None:
            for k1 in m.get('base_location_list'):
                temp_model = main_models.UpdateEmployeeRequestBaseLocationList()
                self.base_location_list.append(temp_model.from_map(k1))
        ...
        if m.get('cert_list') is not None:
            for k1 in m.get('cert_list'):
                temp_model = main_models.UpdateEmployeeRequestCertList()
...
class UpdateEmployeeRequestCertList(DaraModel):
    def __init__(
        self,
        birthday: str = None,
...
class UpdateEmployeeRequestBaseLocationList(DaraModel):
    def __init__(
        self,
        code: str = None,
        level: str = None,

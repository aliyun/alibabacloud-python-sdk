...
class ModuleFlightItemListItemListShoppingItemMapValue(DaraModel):
    def __init__(
        self,
        id: str = None,
        cabin_quantity: Dict[str, main_models.ModuleFlightItemListItemListShoppingItemMapValueCabinQuantityValue] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cabin_quantity') is not None:
            for k1, v1 in m.get('cabin_quantity').items():
                temp_model = main_models.ModuleFlightItemListItemListShoppingItemMapValueCabinQuantityValue()
                self.cabin_quantity[k1] = temp_model.from_map(v1)

        if m.get('search_price') is not None:
            temp_model = main_models.ModuleFlightItemListItemListShoppingItemMapValueSearchPrice()
        ...
        if m.get('segment_price') is not None:
            for k1, v1 in m.get('segment_price').items():
                temp_model = main_models.ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue()
                self.segment_price[k1] = temp_model.from_map(v1)

        return self

class ModuleFlightItemListItemListShoppingItemMapValueSearchPrice(DaraModel):
    def __init__(
        self,
        ...
        price_show_info: main_models.ModuleFlightItemListItemListShoppingItemMapValueSearchPricePriceShowInfo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('price_show_info') is not None:
            temp_model = main_models.ModuleFlightItemListItemListShoppingItemMapValueSearchPricePriceShowInfo()
            self.price_show_info = temp_model.from_map(m.get('price_show_info'))

        return self

class ModuleFlightItemListItemListShoppingItemMapValueSearchPricePriceShowInfo(DaraModel):
    def __init__(
        self,

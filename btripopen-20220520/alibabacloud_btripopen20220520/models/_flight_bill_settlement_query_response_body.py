...
class FlightBillSettlementQueryResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        module: main_models.FlightBillSettlementQueryResponseBodyModule = None,
        request_id: str = None,
        success: bool = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('module') is not None:
            temp_model = main_models.FlightBillSettlementQueryResponseBodyModule()
...
class FlightBillSettlementQueryResponseBodyModule(DaraModel):
    def __init__(
        self,
        category: int = None,
        corp_id: str = None,
        data_list: List[main_models.FlightBillSettlementQueryResponseBodyModuleDataList] = None,
        period_end: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data_list') is not None:
            for k1 in m.get('data_list'):
                temp_model = main_models.FlightBillSettlementQueryResponseBodyModuleDataList()
...
class FlightBillSettlementQueryResponseBodyModuleDataList(DaraModel):
    def __init__(
        self,
        ...
        self.before_ticket_no = before_ticket_no
        ...
        self.change_reason_code = change_reason_code
    ...
    def to_map(self):
        ...
        if self.before_ticket_no is not None:
            result['before_ticket_no'] = self.before_ticket_no
        ...
        if self.change_reason_code is not None:
            result['change_reason_code'] = self.change_reason_code
        ...
        if self.offline_status is not None:
            result['offline_status'] = self.offline_status
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('before_ticket_no') is not None:
            self.before_ticket_no = m.get('before_ticket_no')
        ...
        if m.get('change_reason_code') is not None:
            self.change_reason_code = m.get('change_reason_code')
        ...
        if m.get('offline_status') is not None:
            self.offline_status = m.get('offline_status')

...
class IntlFlightReShopOtaSearchRequest(DaraModel):
    def __init__(
        self,
        order_id: str = None,
        ...
        search_journeys: List[main_models.IntlFlightReShopOtaSearchRequestSearchJourneys] = None,
        selected_passengers: List[main_models.IntlFlightReShopOtaSearchRequestSelectedPassengers] = None,
        token: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('search_journeys') is not None:
            for k1 in m.get('search_journeys'):
                temp_model = main_models.IntlFlightReShopOtaSearchRequestSearchJourneys()
        ...
        if m.get('selected_passengers') is not None:
            for k1 in m.get('selected_passengers'):
                temp_model = main_models.IntlFlightReShopOtaSearchRequestSelectedPassengers()
...
class IntlFlightReShopOtaSearchRequestSelectedPassengers(DaraModel):
    def __init__(
        self,
        full_name: str = None,
...
class IntlFlightReShopOtaSearchRequestSearchJourneys(DaraModel):
    def __init__(
        self,
        arr_city_code: str = None,
        dep_city_code: str = None,
        dep_date: str = None,
        selected_flights: List[main_models.IntlFlightReShopOtaSearchRequestSearchJourneysSelectedFlights] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('selected_flights') is not None:
            for k1 in m.get('selected_flights'):
                temp_model = main_models.IntlFlightReShopOtaSearchRequestSearchJourneysSelectedFlights()
                self.selected_flights.append(temp_model.from_map(k1))

        return self

class IntlFlightReShopOtaSearchRequestSearchJourneysSelectedFlights(DaraModel):
    def __init__(
        self,
        arr_city_code: str = None,
        dep_city_code: str = None,

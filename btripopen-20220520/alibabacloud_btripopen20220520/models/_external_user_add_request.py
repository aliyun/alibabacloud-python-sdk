...
class ExternalUserAddRequest(DaraModel):
    def __init__(
        self,
        birthday: str = None,
        cert_request_list: List[main_models.ExternalUserAddRequestCertRequestList] = None,
        email: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cert_request_list') is not None:
            for k1 in m.get('cert_request_list'):
                temp_model = main_models.ExternalUserAddRequestCertRequestList()
...
class ExternalUserAddRequestCertRequestList(DaraModel):
    def __init__(
        self,

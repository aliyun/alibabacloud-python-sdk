...
class MealApplyModifyRequest(DaraModel):
    def __init__(
        self,
        apply_user: main_models.MealApplyModifyRequestApplyUser = None,
        cost_center_id: int = None,
        extend_field: str = None,
        invoice_id: int = None,
        itinerary_list: List[main_models.MealApplyModifyRequestItineraryList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('apply_user') is not None:
            temp_model = main_models.MealApplyModifyRequestApplyUser()
        ...
        if m.get('itinerary_list') is not None:
            for k1 in m.get('itinerary_list'):
                temp_model = main_models.MealApplyModifyRequestItineraryList()
...
class MealApplyModifyRequestItineraryList(DaraModel):
    def __init__(
        self,
        cities: List[main_models.MealApplyModifyRequestItineraryListCities] = None,
        end_date: str = None,
        start_date: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cities') is not None:
            for k1 in m.get('cities'):
                temp_model = main_models.MealApplyModifyRequestItineraryListCities()
...
class MealApplyModifyRequestItineraryListCities(DaraModel):
    def __init__(
        self,
        city_code: str = None,
        city_name: str = None,
...
class MealApplyModifyRequestApplyUser(DaraModel):
    def __init__(
        self,
        user_id: str = None,
    ):

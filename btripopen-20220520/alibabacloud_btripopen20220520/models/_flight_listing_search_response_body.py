...
class FlightListingSearchResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        module: main_models.FlightListingSearchResponseBodyModule = None,
        request_id: str = None,
        success: bool = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('module') is not None:
            temp_model = main_models.FlightListingSearchResponseBodyModule()
...
class FlightListingSearchResponseBodyModule(DaraModel):
    def __init__(
        self,
        flight_list: List[main_models.FlightListingSearchResponseBodyModuleFlightList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('flight_list') is not None:
            for k1 in m.get('flight_list'):
                temp_model = main_models.FlightListingSearchResponseBodyModuleFlightList()
                self.flight_list.append(temp_model.from_map(k1))

        return self

class FlightListingSearchResponseBodyModuleFlightList(DaraModel):
    def __init__(
        self,
        airline_info: main_models.FlightListingSearchResponseBodyModuleFlightListAirlineInfo = None,
        arr_airport_info: main_models.FlightListingSearchResponseBodyModuleFlightListArrAirportInfo = None,
        arr_date: str = None,
        ...
        carrier_no: str = None,
        dep_airport_info: main_models.FlightListingSearchResponseBodyModuleFlightListDepAirportInfo = None,
        dep_city_code: str = None,
        dep_date: str = None,
        discount: int = None,
        flight_no: str = None,
        flight_rule_list: List[main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('airline_info') is not None:
            temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListAirlineInfo()
            self.airline_info = temp_model.from_map(m.get('airline_info'))

        if m.get('arr_airport_info') is not None:
            temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListArrAirportInfo()
        ...
        if m.get('dep_airport_info') is not None:
            temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListDepAirportInfo()
        ...
        if m.get('flight_rule_list') is not None:
            for k1 in m.get('flight_rule_list'):
                temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleList()
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleList(DaraModel):
    def __init__(
        self,
        baggage_info: str = None,
        baggage_item: main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItem = None,
        change_rule: main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListChangeRule = None,
        change_rule_item: main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListChangeRuleItem = None,
        extra: str = None,
        refund_rule: main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRule = None,
        refund_rule_item: main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRuleItem = None,
        sign_rule: main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListSignRule = None,
        tuigaiqian_info: str = None,
        upgrade_rule: main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListUpgradeRule = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('baggage_item') is not None:
            temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItem()
            self.baggage_item = temp_model.from_map(m.get('baggage_item'))

        if m.get('change_rule') is not None:
            temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListChangeRule()
            self.change_rule = temp_model.from_map(m.get('change_rule'))

        if m.get('change_rule_item') is not None:
            temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListChangeRuleItem()
        ...
        if m.get('refund_rule') is not None:
            temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRule()
            self.refund_rule = temp_model.from_map(m.get('refund_rule'))

        if m.get('refund_rule_item') is not None:
            temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRuleItem()
            self.refund_rule_item = temp_model.from_map(m.get('refund_rule_item'))

        if m.get('sign_rule') is not None:
            temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListSignRule()
        ...
        if m.get('upgrade_rule') is not None:
            temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListUpgradeRule()
            self.upgrade_rule = temp_model.from_map(m.get('upgrade_rule'))

        return self

class FlightListingSearchResponseBodyModuleFlightListFlightRuleListUpgradeRule(DaraModel):
    def __init__(
        self,
        able: bool = None,
        info: List[main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListUpgradeRuleInfo] = None,
    ):
        self.able = able
        self.info = info
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('info') is not None:
            for k1 in m.get('info'):
                temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListUpgradeRuleInfo()
                self.info.append(temp_model.from_map(k1))

        return self

class FlightListingSearchResponseBodyModuleFlightListFlightRuleListUpgradeRuleInfo(DaraModel):
    def __init__(
        self,
        content: str = None,
        cost: int = None,
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleListSignRule(DaraModel):
    def __init__(
        self,
        able: bool = None,
        info: List[main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListSignRuleInfo] = None,
    ):
        self.able = able
        self.info = info
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('info') is not None:
            for k1 in m.get('info'):
                temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListSignRuleInfo()
                self.info.append(temp_model.from_map(k1))

        return self

class FlightListingSearchResponseBodyModuleFlightListFlightRuleListSignRuleInfo(DaraModel):
    def __init__(
        self,
        content: str = None,
        cost: int = None,
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRuleItem(DaraModel):
    def __init__(
        self,
        extra_contents: List[main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRuleItemExtraContents] = None,
        index: int = None,
        refund_sub_items: List[main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRuleItemRefundSubItems] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('extra_contents') is not None:
            for k1 in m.get('extra_contents'):
                temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRuleItemExtraContents()
        ...
        if m.get('refund_sub_items') is not None:
            for k1 in m.get('refund_sub_items'):
                temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRuleItemRefundSubItems()
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRuleItemRefundSubItems(DaraModel):
    def __init__(
        self,
        is_struct: bool = None,
        ptc: str = None,
        refund_sub_contents: List[main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRuleItemRefundSubItemsRefundSubContents] = None,
        title: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('refund_sub_contents') is not None:
            for k1 in m.get('refund_sub_contents'):
                temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRuleItemRefundSubItemsRefundSubContents()
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRuleItemRefundSubItemsRefundSubContents(DaraModel):
    def __init__(
        self,
        fee_desc: str = None,
        fee_range: str = None,
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRuleItemExtraContents(DaraModel):
    def __init__(
        self,
        content: str = None,
        title: str = None,
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRule(DaraModel):
    def __init__(
        self,
        able: bool = None,
        info: List[main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRuleInfo] = None,
    ):
        self.able = able
        self.info = info
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('info') is not None:
            for k1 in m.get('info'):
                temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRuleInfo()
                self.info.append(temp_model.from_map(k1))

        return self

class FlightListingSearchResponseBodyModuleFlightListFlightRuleListRefundRuleInfo(DaraModel):
    def __init__(
        self,
        content: str = None,
        cost: int = None,
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleListChangeRuleItem(DaraModel):
    def __init__(
        self,
        extra_contents: List[main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListChangeRuleItemExtraContents] = None,
        index: int = None,
        refund_sub_items: List[main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListChangeRuleItemRefundSubItems] = None,
        sub_table_head: List[str] = None,
        table_head: str = None,
        title: str = None,
        type: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('extra_contents') is not None:
            for k1 in m.get('extra_contents'):
                temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListChangeRuleItemExtraContents()
                self.extra_contents.append(temp_model.from_map(k1))
        ...
        if m.get('refund_sub_items') is not None:
            for k1 in m.get('refund_sub_items'):
                temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListChangeRuleItemRefundSubItems()
                self.refund_sub_items.append(temp_model.from_map(k1))
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleListChangeRuleItemRefundSubItems(DaraModel):
    def __init__(
        self,
        is_struct: bool = None,
        ptc: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('refund_sub_contents') is not None:
            for k1 in m.get('refund_sub_contents'):
                temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListChangeRuleItemRefundSubItemsRefundSubContents()
                self.refund_sub_contents.append(temp_model.from_map(k1))
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleListChangeRuleItemRefundSubItemsRefundSubContents(DaraModel):
    def __init__(
        self,
        fee_desc: str = None,
        fee_range: str = None,
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleListChangeRuleItemExtraContents(DaraModel):
    def __init__(
        self,
        content: str = None,
        title: str = None,
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleListChangeRule(DaraModel):
    def __init__(
        self,
        able: bool = None,
        info: List[main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListChangeRuleInfo] = None,
    ):
        self.able = able
        self.info = info
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('info') is not None:
            for k1 in m.get('info'):
                temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListChangeRuleInfo()
                self.info.append(temp_model.from_map(k1))

        return self

class FlightListingSearchResponseBodyModuleFlightListFlightRuleListChangeRuleInfo(DaraModel):
    def __init__(
        self,
        content: str = None,
        cost: int = None,
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItem(DaraModel):
    def __init__(
        self,
        baggage_sub_items: List[main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItemBaggageSubItems] = None,
        index: int = None,
        table_head: str = None,
        tips: main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItemTips = None,
        title: str = None,
        type: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('baggage_sub_items') is not None:
            for k1 in m.get('baggage_sub_items'):
                temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItemBaggageSubItems()
        ...
        if m.get('tips') is not None:
            temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItemTips()
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItemTips(DaraModel):
    def __init__(
        self,
        logo: str = None,
        tips_desc: str = None,
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItemBaggageSubItems(DaraModel):
    def __init__(
        self,
        baggage_sub_content_visualizes: List[main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItemBaggageSubItemsBaggageSubContentVisualizes] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('baggage_sub_content_visualizes') is not None:
            for k1 in m.get('baggage_sub_content_visualizes'):
                temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItemBaggageSubItemsBaggageSubContentVisualizes()
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItemBaggageSubItemsBaggageSubContentVisualizes(DaraModel):
    def __init__(
        self,
        baggage_desc: List[str] = None,
        baggage_sub_content_type: int = None,
        description: main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItemBaggageSubItemsBaggageSubContentVisualizesDescription = None,
        image_do: main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItemBaggageSubItemsBaggageSubContentVisualizesImageDO = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('description') is not None:
            temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItemBaggageSubItemsBaggageSubContentVisualizesDescription()
            self.description = temp_model.from_map(m.get('description'))

        if m.get('image_d_o') is not None:
            temp_model = main_models.FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItemBaggageSubItemsBaggageSubContentVisualizesImageDO()
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItemBaggageSubItemsBaggageSubContentVisualizesImageDO(DaraModel):
    def __init__(
        self,
        image: str = None,
        largest: str = None,
...
class FlightListingSearchResponseBodyModuleFlightListFlightRuleListBaggageItemBaggageSubItemsBaggageSubContentVisualizesDescription(DaraModel):
    def __init__(
        self,
        desc: str = None,
        icon: str = None,
...
class FlightListingSearchResponseBodyModuleFlightListDepAirportInfo(DaraModel):
    def __init__(
        self,
...
class FlightListingSearchResponseBodyModuleFlightListArrAirportInfo(DaraModel):
    def __init__(
        self,
        airport_code: str = None,
        airport_name: str = None,
...
class FlightListingSearchResponseBodyModuleFlightListAirlineInfo(DaraModel):
    def __init__(
        self,

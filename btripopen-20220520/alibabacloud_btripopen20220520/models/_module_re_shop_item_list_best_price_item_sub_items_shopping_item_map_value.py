...
class ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue(DaraModel):
    def __init__(
        self,
        cabin_quantity_list: List[main_models.ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityList] = None,
        search_price: main_models.ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueSearchPrice = None,
        segment_price_list: List[main_models.ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueSegmentPriceList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cabin_quantity_list') is not None:
            for k1 in m.get('cabin_quantity_list'):
                temp_model = main_models.ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityList()
                self.cabin_quantity_list.append(temp_model.from_map(k1))

        if m.get('search_price') is not None:
            temp_model = main_models.ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueSearchPrice()
        ...
        if m.get('segment_price_list') is not None:
            for k1 in m.get('segment_price_list'):
                temp_model = main_models.ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueSegmentPriceList()
                self.segment_price_list.append(temp_model.from_map(k1))

        return self

class ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueSegmentPriceList(DaraModel):
    def __init__(
        self,
        segment_position: main_models.ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueSegmentPriceListSegmentPosition = None,
        search_price: main_models.ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueSegmentPriceListSearchPrice = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('segment_position') is not None:
            temp_model = main_models.ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueSegmentPriceListSegmentPosition()
            self.segment_position = temp_model.from_map(m.get('segment_position'))

        if m.get('search_price') is not None:
            temp_model = main_models.ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueSegmentPriceListSearchPrice()
            self.search_price = temp_model.from_map(m.get('search_price'))

        return self

class ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueSegmentPriceListSearchPrice(DaraModel):
    def __init__(
        self,
...
class ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueSegmentPriceListSegmentPosition(DaraModel):
    def __init__(
        self,
...
class ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueSearchPrice(DaraModel):
    def __init__(
        self,
        total_amount: int = None,
        handling_amount: int = None,
...
class ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityList(DaraModel):
    def __init__(
        self,
        segment_position: main_models.ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityListSegmentPosition = None,
        cabin_info: main_models.ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityListCabinInfo = None,
    ):
        self.segment_position = segment_position
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('segment_position') is not None:
            temp_model = main_models.ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityListSegmentPosition()
            self.segment_position = temp_model.from_map(m.get('segment_position'))

        if m.get('cabin_info') is not None:
            temp_model = main_models.ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityListCabinInfo()
            self.cabin_info = temp_model.from_map(m.get('cabin_info'))

        return self

class ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityListCabinInfo(DaraModel):
    def __init__(
        self,
        cabin: str = None,
...
class ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityListSegmentPosition(DaraModel):
    def __init__(
        self,
        journey_index: int = None,
        segment_index: int = None,

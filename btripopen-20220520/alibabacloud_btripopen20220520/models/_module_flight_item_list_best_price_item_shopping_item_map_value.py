...
class ModuleFlightItemListBestPriceItemShoppingItemMapValue(DaraModel):
    def __init__(
        self,
        cabin_quantity_list: List[main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityList] = None,
        search_price: main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice = None,
        segment_price_list: List[main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceList] = None,
        id: str = None,
        cabin_quantity: Dict[str, main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue] = None,
        segment_price: Dict[str, main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cabin_quantity_list') is not None:
            for k1 in m.get('cabin_quantity_list'):
                temp_model = main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityList()
                self.cabin_quantity_list.append(temp_model.from_map(k1))

        if m.get('search_price') is not None:
            temp_model = main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice()
        ...
        if m.get('segment_price_list') is not None:
            for k1 in m.get('segment_price_list'):
                temp_model = main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceList()
        ...
        if m.get('cabin_quantity') is not None:
            for k1, v1 in m.get('cabin_quantity').items():
                temp_model = main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue()
                self.cabin_quantity[k1] = temp_model.from_map(v1)

        self.segment_price = {}
        if m.get('segment_price') is not None:
            for k1, v1 in m.get('segment_price').items():
                temp_model = main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue()
                self.segment_price[k1] = temp_model.from_map(v1)

        return self

class ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceList(DaraModel):
    def __init__(
        self,
        segment_position: main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceListSegmentPosition = None,
        search_price: main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceListSearchPrice = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('segment_position') is not None:
            temp_model = main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceListSegmentPosition()
            self.segment_position = temp_model.from_map(m.get('segment_position'))

        if m.get('search_price') is not None:
            temp_model = main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceListSearchPrice()
            self.search_price = temp_model.from_map(m.get('search_price'))

        return self

class ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceListSearchPrice(DaraModel):
    def __init__(
        self,
        sell_price: int = None,
...
class ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceListSegmentPosition(DaraModel):
    def __init__(
        self,
...
class ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPrice(DaraModel):
    def __init__(
        self,
        ...
        price_show_info: main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPricePriceShowInfo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('price_show_info') is not None:
            temp_model = main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPricePriceShowInfo()
            self.price_show_info = temp_model.from_map(m.get('price_show_info'))

        return self

class ModuleFlightItemListBestPriceItemShoppingItemMapValueSearchPricePriceShowInfo(DaraModel):
    def __init__(
        self,
...
class ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityList(DaraModel):
    def __init__(
        self,
        segment_position: main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityListSegmentPosition = None,
        cabin_info: main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityListCabinInfo = None,
    ):
        self.segment_position = segment_position
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('segment_position') is not None:
            temp_model = main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityListSegmentPosition()
            self.segment_position = temp_model.from_map(m.get('segment_position'))

        if m.get('cabin_info') is not None:
            temp_model = main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityListCabinInfo()
            self.cabin_info = temp_model.from_map(m.get('cabin_info'))

        return self

class ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityListCabinInfo(DaraModel):
    def __init__(
        self,
        cabin: str = None,
...
class ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityListSegmentPosition(DaraModel):
    def __init__(
        self,
        journey_index: int = None,
        segment_index: int = None,

...
class ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue(DaraModel):
    def __init__(
        self,
        ...
        price_show_info: main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValuePriceShowInfo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('price_show_info') is not None:
            temp_model = main_models.ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValuePriceShowInfo()
            self.price_show_info = temp_model.from_map(m.get('price_show_info'))

        return self

class ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValuePriceShowInfo(DaraModel):
    def __init__(
        self,

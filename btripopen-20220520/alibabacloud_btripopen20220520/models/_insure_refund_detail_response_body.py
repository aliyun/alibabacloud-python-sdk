...
class InsureRefundDetailResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        module: main_models.InsureRefundDetailResponseBodyModule = None,
        request_id: str = None,
        success: bool = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('module') is not None:
            temp_model = main_models.InsureRefundDetailResponseBodyModule()
...
class InsureRefundDetailResponseBodyModule(DaraModel):
    def __init__(
        self,
        apply_id: str = None,
        gmt_create: str = None,
        ...
        insure_order: main_models.InsureRefundDetailResponseBodyModuleInsureOrder = None,
        out_apply_id: str = None,
        sub_order_refund_list: List[main_models.InsureRefundDetailResponseBodyModuleSubOrderRefundList] = None,
    ):
    ...
    def validate(self):
        ...
        if self.sub_order_refund_list:
            for v1 in self.sub_order_refund_list:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.sub_order_refund_list is not None:
            for k1 in self.sub_order_refund_list:
                result['sub_order_refund_list'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('insure_order') is not None:
            temp_model = main_models.InsureRefundDetailResponseBodyModuleInsureOrder()
            self.insure_order = temp_model.from_map(m.get('insure_order'))
        ...
        if m.get('sub_order_refund_list') is not None:
            for k1 in m.get('sub_order_refund_list'):
                temp_model = main_models.InsureRefundDetailResponseBodyModuleSubOrderRefundList()
                self.sub_order_refund_list.append(temp_model.from_map(k1))

        return self

class InsureRefundDetailResponseBodyModuleSubOrderRefundList(DaraModel):
    def __init__(
        self,
        effective_end_time: str = None,
        effective_start_time: str = None,
        insure_segment: main_models.InsureRefundDetailResponseBodyModuleSubOrderRefundListInsureSegment = None,
        insure_time: str = None,
        insured: main_models.InsureRefundDetailResponseBodyModuleSubOrderRefundListInsured = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('insure_segment') is not None:
            temp_model = main_models.InsureRefundDetailResponseBodyModuleSubOrderRefundListInsureSegment()
        ...
        if m.get('insured') is not None:
            temp_model = main_models.InsureRefundDetailResponseBodyModuleSubOrderRefundListInsured()
...
class InsureRefundDetailResponseBodyModuleSubOrderRefundListInsured(DaraModel):
    def __init__(
        self,
        birthday: str = None,
...
class InsureRefundDetailResponseBodyModuleSubOrderRefundListInsureSegment(DaraModel):
    def __init__(
        self,
...
class InsureRefundDetailResponseBodyModuleInsureOrder(DaraModel):
    def __init__(
        self,
        applicant: main_models.InsureRefundDetailResponseBodyModuleInsureOrderApplicant = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('applicant') is not None:
            temp_model = main_models.InsureRefundDetailResponseBodyModuleInsureOrderApplicant()
...
class InsureRefundDetailResponseBodyModuleInsureOrderApplicant(DaraModel):
    def __init__(
        self,
        cert_name: str = None,
        cert_no: str = None,

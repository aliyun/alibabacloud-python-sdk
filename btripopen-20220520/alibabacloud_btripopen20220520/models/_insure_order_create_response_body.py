...
class InsureOrderCreateResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        module: main_models.InsureOrderCreateResponseBodyModule = None,
        request_id: str = None,
        success: bool = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('module') is not None:
            temp_model = main_models.InsureOrderCreateResponseBodyModule()
...
class InsureOrderCreateResponseBodyModule(DaraModel):
    def __init__(
        self,
        copies: int = None,
        insure_order_detail_list: List[main_models.InsureOrderCreateResponseBodyModuleInsureOrderDetailList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('insure_order_detail_list') is not None:
            for k1 in m.get('insure_order_detail_list'):
                temp_model = main_models.InsureOrderCreateResponseBodyModuleInsureOrderDetailList()
...
class InsureOrderCreateResponseBodyModuleInsureOrderDetailList(DaraModel):
    def __init__(
        self,

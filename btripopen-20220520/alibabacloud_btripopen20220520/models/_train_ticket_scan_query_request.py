...
class TrainTicketScanQueryRequest(DaraModel):
    def __init__(
        self,
        bill_date: str = None,
        bill_id: int = None,
        invoice_date_end: str = None,
        invoice_date_start: str = None,
        ...
        self.invoice_date_end = invoice_date_end
        self.invoice_date_start = invoice_date_start
    ...
    def to_map(self):
        ...
        if self.invoice_date_end is not None:
            result['invoice_date_end'] = self.invoice_date_end

        if self.invoice_date_start is not None:
            result['invoice_date_start'] = self.invoice_date_start
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('invoice_date_end') is not None:
            self.invoice_date_end = m.get('invoice_date_end')

        if m.get('invoice_date_start') is not None:
            self.invoice_date_start = m.get('invoice_date_start')

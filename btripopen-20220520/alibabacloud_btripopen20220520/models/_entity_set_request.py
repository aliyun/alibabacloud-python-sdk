...
class EntitySetRequest(DaraModel):
    def __init__(
        self,
        entity_dolist: List[main_models.EntitySetRequestEntityDOList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('entity_d_o_list') is not None:
            for k1 in m.get('entity_d_o_list'):
                temp_model = main_models.EntitySetRequestEntityDOList()
...
class EntitySetRequestEntityDOList(DaraModel):
    def __init__(
        self,
        entity_id: str = None,

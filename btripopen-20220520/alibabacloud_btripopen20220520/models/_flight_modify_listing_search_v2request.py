...
class FlightModifyListingSearchV2Request(DaraModel):
    def __init__(
        self,
        ...
        passenger_segment_relations: List[main_models.FlightModifyListingSearchV2RequestPassengerSegmentRelations] = None,
        search_mode: int = None,
        search_retry_token: str = None,
        selected_segments: List[main_models.FlightModifyListingSearchV2RequestSelectedSegments] = None,
        session_id: str = None,
        voluntary: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('passenger_segment_relations') is not None:
            for k1 in m.get('passenger_segment_relations'):
                temp_model = main_models.FlightModifyListingSearchV2RequestPassengerSegmentRelations()
        ...
        if m.get('selected_segments') is not None:
            for k1 in m.get('selected_segments'):
                temp_model = main_models.FlightModifyListingSearchV2RequestSelectedSegments()
...
class FlightModifyListingSearchV2RequestSelectedSegments(DaraModel):
    def __init__(
        self,
...
class FlightModifyListingSearchV2RequestPassengerSegmentRelations(DaraModel):
    def __init__(
        self,

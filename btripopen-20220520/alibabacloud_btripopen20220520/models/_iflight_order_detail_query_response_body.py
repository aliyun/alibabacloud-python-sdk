...
class IFlightOrderDetailQueryResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        module: main_models.IFlightOrderDetailQueryResponseBodyModule = None,
        request_id: str = None,
        success: bool = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('module') is not None:
            temp_model = main_models.IFlightOrderDetailQueryResponseBodyModule()
...
class IFlightOrderDetailQueryResponseBodyModule(DaraModel):
    def __init__(
        self,
        flight_modify_order_list: List[main_models.IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderList] = None,
        flight_refund_order_list: List[main_models.IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderList] = None,
        flight_sale_order: main_models.IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrder = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('flight_modify_order_list') is not None:
            for k1 in m.get('flight_modify_order_list'):
                temp_model = main_models.IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderList()
        ...
        if m.get('flight_refund_order_list') is not None:
            for k1 in m.get('flight_refund_order_list'):
                temp_model = main_models.IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderList()
                self.flight_refund_order_list.append(temp_model.from_map(k1))

        if m.get('flight_sale_order') is not None:
            temp_model = main_models.IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrder()
            self.flight_sale_order = temp_model.from_map(m.get('flight_sale_order'))

        return self

class IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrder(DaraModel):
    def __init__(
        self,
        apply_id: int = None,
        book_type: int = None,
        booker_info: main_models.IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderBookerInfo = None,
        ...
        order_type: int = None,
        passenger_list: List[main_models.IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList] = None,
        pay_type: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('booker_info') is not None:
            temp_model = main_models.IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderBookerInfo()
        ...
        if m.get('flight_order_insure_list') is not None:
            for k1 in m.get('flight_order_insure_list'):
                temp_model = main_models.IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightOrderInsureList()
        ...
        if m.get('flight_order_ticket_list') is not None:
            for k1 in m.get('flight_order_ticket_list'):
                temp_model = main_models.IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightOrderTicketList()
        ...
        if m.get('passenger_list') is not None:
            for k1 in m.get('passenger_list'):
                temp_model = main_models.IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList()
...
class IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderPassengerList(DaraModel):
    def __init__(
        self,
...
class IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightSegmentList(DaraModel):
    def __init__(
        self,
...
class IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightOrderTicketList(DaraModel):
    def __init__(
        self,
        cabin_class: List[main_models.IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightOrderTicketListCabinClass] = None,
        tax: int = None,
        ticket_no: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cabin_class') is not None:
            for k1 in m.get('cabin_class'):
                temp_model = main_models.IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightOrderTicketListCabinClass()
...
class IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightOrderTicketListCabinClass(DaraModel):
    def __init__(
        self,
        cabin: str = None,
...
class IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderFlightOrderInsureList(DaraModel):
    def __init__(
        self,
...
class IFlightOrderDetailQueryResponseBodyModuleFlightSaleOrderBookerInfo(DaraModel):
    def __init__(
        self,
        user_id: str = None,
        user_name: str = None,
...
class IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderList(DaraModel):
    def __init__(
        self,
        corp_refund_amount: int = None,
        flight_order_refund_ticket_list: List[main_models.IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightOrderRefundTicketList] = None,
        flight_passenger_fee: List[main_models.IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightPassengerFee] = None,
        flight_refund_segment_list: List[main_models.IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList] = None,
        ...
        refund_total_amount: int = None,
        relate_modify_apply_id: List[int] = None,
        relate_refund_apply_id: int = None,
        repeat_refund: bool = None,
        submit_refund_time: str = None,
        voluntary: bool = None,
    ):
        self.corp_refund_amount = corp_refund_amount
        self.flight_order_refund_ticket_list = flight_order_refund_ticket_list
        self.flight_passenger_fee = flight_passenger_fee
        ...
        self.submit_refund_time = submit_refund_time
    ...
    def validate(self):
        if self.flight_order_refund_ticket_list:
            for v1 in self.flight_order_refund_ticket_list:
                 if v1:
                    v1.validate()
        if self.flight_passenger_fee:
            for v1 in self.flight_passenger_fee:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        result['flight_passenger_fee'] = []
        if self.flight_passenger_fee is not None:
            for k1 in self.flight_passenger_fee:
                result['flight_passenger_fee'].append(k1.to_map() if k1 else None)
        ...
        if self.submit_refund_time is not None:
            result['submit_refund_time'] = self.submit_refund_time
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('flight_order_refund_ticket_list') is not None:
            for k1 in m.get('flight_order_refund_ticket_list'):
                temp_model = main_models.IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightOrderRefundTicketList()
                self.flight_order_refund_ticket_list.append(temp_model.from_map(k1))

        self.flight_passenger_fee = []
        if m.get('flight_passenger_fee') is not None:
            for k1 in m.get('flight_passenger_fee'):
                temp_model = main_models.IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightPassengerFee()
                self.flight_passenger_fee.append(temp_model.from_map(k1))

        self.flight_refund_segment_list = []
        if m.get('flight_refund_segment_list') is not None:
            for k1 in m.get('flight_refund_segment_list'):
                temp_model = main_models.IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList()
        ...
        if m.get('submit_refund_time') is not None:
            self.submit_refund_time = m.get('submit_refund_time')
...
class IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightRefundSegmentList(DaraModel):
    def __init__(
        self,
        airline_code: str = None,
        airline_name: str = None,
...
class IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightPassengerFee(DaraModel):
    def __init__(
        self,
...
class IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightOrderRefundTicketList(DaraModel):
    def __init__(
        self,
        cabin_class: List[main_models.IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightOrderRefundTicketListCabinClass] = None,
        flight_no: str = None,
        ticket_no: str = None,
        user_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cabin_class') is not None:
            for k1 in m.get('cabin_class'):
                temp_model = main_models.IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightOrderRefundTicketListCabinClass()
                self.cabin_class.append(temp_model.from_map(k1))
...
class IFlightOrderDetailQueryResponseBodyModuleFlightRefundOrderListFlightOrderRefundTicketListCabinClass(DaraModel):
    def __init__(
        self,
        cabin: str = None,
        cabin_class: str = None,
...
class IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderList(DaraModel):
    def __init__(
        self,
        corp_pay_price: int = None,
        flight_modify_segment_list: List[main_models.IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList] = None,
        flight_order_modify_ticket_list: List[main_models.IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightOrderModifyTicketList] = None,
        modify_apply_id: int = None,
        modify_fee: List[main_models.IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListModifyFee] = None,
        modify_order_status: int = None,
        modify_total_fee: int = None,
        passenger_list: List[str] = None,
        person_pay_price: int = None,
        relate_modify_apply_id: int = None,
        service_fee: int = None,
        submit_modify_time: str = None,
        voluntary: bool = None,
    ):
        self.corp_pay_price = corp_pay_price
        ...
        self.modify_order_status = modify_order_status
        self.modify_total_fee = modify_total_fee
        self.passenger_list = passenger_list
        self.person_pay_price = person_pay_price
        self.relate_modify_apply_id = relate_modify_apply_id
        self.service_fee = service_fee
        self.submit_modify_time = submit_modify_time
        self.voluntary = voluntary
    ...
    def to_map(self):
        ...
        if self.modify_fee is not None:
            for k1 in self.modify_fee:
                result['modify_fee'].append(k1.to_map() if k1 else None)

        if self.modify_order_status is not None:
            result['modify_order_status'] = self.modify_order_status

        if self.modify_total_fee is not None:
            result['modify_total_fee'] = self.modify_total_fee
        ...
        if self.submit_modify_time is not None:
            result['submit_modify_time'] = self.submit_modify_time
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('flight_modify_segment_list') is not None:
            for k1 in m.get('flight_modify_segment_list'):
                temp_model = main_models.IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList()
        ...
        if m.get('flight_order_modify_ticket_list') is not None:
            for k1 in m.get('flight_order_modify_ticket_list'):
                temp_model = main_models.IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightOrderModifyTicketList()
        ...
        if m.get('modify_fee') is not None:
            for k1 in m.get('modify_fee'):
                temp_model = main_models.IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListModifyFee()
                self.modify_fee.append(temp_model.from_map(k1))

        if m.get('modify_order_status') is not None:
            self.modify_order_status = m.get('modify_order_status')

        if m.get('modify_total_fee') is not None:
            self.modify_total_fee = m.get('modify_total_fee')
        ...
        if m.get('submit_modify_time') is not None:
            self.submit_modify_time = m.get('submit_modify_time')
...
class IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListModifyFee(DaraModel):
    def __init__(
        self,
...
class IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightOrderModifyTicketList(DaraModel):
    def __init__(
        self,
        cabin_class: List[main_models.IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightOrderModifyTicketListCabinClass] = None,
        flight_no: str = None,
        ticket_no: str = None,
        user_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cabin_class') is not None:
            for k1 in m.get('cabin_class'):
                temp_model = main_models.IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightOrderModifyTicketListCabinClass()
                self.cabin_class.append(temp_model.from_map(k1))
...
class IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightOrderModifyTicketListCabinClass(DaraModel):
    def __init__(
        self,
        cabin: str = None,
        cabin_class: str = None,
...
class IFlightOrderDetailQueryResponseBodyModuleFlightModifyOrderListFlightModifySegmentList(DaraModel):
    def __init__(
        self,
        airline_code: str = None,
        airline_name: str = None,

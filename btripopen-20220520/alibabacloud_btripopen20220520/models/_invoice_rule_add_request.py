...
class InvoiceRuleAddRequest(DaraModel):
    def __init__(
        self,
        entities: List[main_models.InvoiceRuleAddRequestEntities] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('entities') is not None:
            for k1 in m.get('entities'):
                temp_model = main_models.InvoiceRuleAddRequestEntities()
...
class InvoiceRuleAddRequestEntities(DaraModel):
    def __init__(
        self,
        entity_id: str = None,

...
class IntlFlightReShopListSearchResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        module: main_models.IntlFlightReShopListSearchResponseBodyModule = None,
        request_id: str = None,
        success: bool = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('module') is not None:
            temp_model = main_models.IntlFlightReShopListSearchResponseBodyModule()
...
class IntlFlightReShopListSearchResponseBodyModule(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('re_shop_item_list') is not None:
            for k1 in m.get('re_shop_item_list'):
                temp_model = main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemList()
...
class IntlFlightReShopListSearchResponseBodyModuleReShopItemList(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('best_price_item') is not None:
            temp_model = main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListBestPriceItem()
        ...
        if m.get('flight_journey_infos') is not None:
            for k1 in m.get('flight_journey_infos'):
                temp_model = main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfos()
                self.flight_journey_infos.append(temp_model.from_map(k1))

        return self

class IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfos(DaraModel):
    def __init__(
        self,
        ...
        dep_time: str = None,
        duration: int = None,
        flight_segment_infos: List[main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfos] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('flight_segment_infos') is not None:
            for k1 in m.get('flight_segment_infos'):
                temp_model = main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfos()
...
class IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfos(DaraModel):
    def __init__(
        self,
        airline_info: main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosAirlineInfo = None,
        arr_airport_info: main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosArrAirportInfo = None,
        arr_city_code: str = None,
        arr_city_name: str = None,
        arr_time: str = None,
        arr_time_utc: str = None,
        dep_airport_info: main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosDepAirportInfo = None,
        dep_city_code: str = None,
        dep_city_name: str = None,
        dep_time: str = None,
        ...
        duration: int = None,
        flight_no: str = None,
        flight_share_info: main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosFlightShareInfo = None,
        flight_size: str = None,
        flight_stop_info_list: List[main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosFlightStopInfoList] = None,
        flight_type: str = None,
        journey_index: int = None,
        luggage_direct_info: main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosLuggageDirectInfo = None,
        ...
        other_info: main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosOtherInfo = None,
        segment_index: int = None,
        segment_key: str = None,
        segment_visa_remark: main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosSegmentVisaRemark = None,
        share: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('airline_info') is not None:
            temp_model = main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosAirlineInfo()
            self.airline_info = temp_model.from_map(m.get('airline_info'))

        if m.get('arr_airport_info') is not None:
            temp_model = main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosArrAirportInfo()
        ...
        if m.get('dep_airport_info') is not None:
            temp_model = main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosDepAirportInfo()
        ...
        if m.get('flight_share_info') is not None:
            temp_model = main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosFlightShareInfo()
        ...
        if m.get('flight_stop_info_list') is not None:
            for k1 in m.get('flight_stop_info_list'):
                temp_model = main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosFlightStopInfoList()
        ...
        if m.get('luggage_direct_info') is not None:
            temp_model = main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosLuggageDirectInfo()
        ...
        if m.get('other_info') is not None:
            temp_model = main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosOtherInfo()
        ...
        if m.get('segment_visa_remark') is not None:
            temp_model = main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosSegmentVisaRemark()
        ...
        if m.get('ticketing_airline_info') is not None:
            temp_model = main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosTicketingAirlineInfo()
...
class IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosTicketingAirlineInfo(DaraModel):
    def __init__(
        self,
...
class IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosSegmentVisaRemark(DaraModel):
    def __init__(
        self,
...
class IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosOtherInfo(DaraModel):
    def __init__(
        self,
...
class IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosLuggageDirectInfo(DaraModel):
    def __init__(
        self,
...
class IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosFlightStopInfoList(DaraModel):
    def __init__(
        self,
        stop_airport: str = None,
        stop_airport_county_info: main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosFlightStopInfoListStopAirportCountyInfo = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('stop_airport_county_info') is not None:
            temp_model = main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosFlightStopInfoListStopAirportCountyInfo()
...
class IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosFlightStopInfoListStopAirportCountyInfo(DaraModel):
    def __init__(
        self,
        adcode: str = None,
...
class IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosFlightShareInfo(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('operating_airline_info') is not None:
            temp_model = main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosFlightShareInfoOperatingAirlineInfo()
...
class IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosFlightShareInfoOperatingAirlineInfo(DaraModel):
    def __init__(
        self,
        airline_code: str = None,
        airline_name: str = None,
...
class IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosDepAirportInfo(DaraModel):
    def __init__(
        self,
        airport_code: str = None,
        airport_name: str = None,
...
class IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosArrAirportInfo(DaraModel):
    def __init__(
        self,
        airport_code: str = None,
        airport_name: str = None,
...
class IntlFlightReShopListSearchResponseBodyModuleReShopItemListFlightJourneyInfosFlightSegmentInfosAirlineInfo(DaraModel):
    def __init__(
        self,
        airline_code: str = None,
        airline_name: str = None,
...
class IntlFlightReShopListSearchResponseBodyModuleReShopItemListBestPriceItem(DaraModel):
    def __init__(
        self,
        item_id: str = None,
        item_type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('shopping_item_map') is not None:
            for k1, v1 in m.get('shopping_item_map').items():
                temp_model = main_models.ModuleReShopItemListBestPriceItemShoppingItemMapValue()
                self.shopping_item_map[k1] = temp_model.from_map(v1)

        self.sub_items = []
        if m.get('sub_items') is not None:
            for k1 in m.get('sub_items'):
                temp_model = main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListBestPriceItemSubItems()
                self.sub_items.append(temp_model.from_map(k1))

        return self

class IntlFlightReShopListSearchResponseBodyModuleReShopItemListBestPriceItemSubItems(DaraModel):
    def __init__(
        self,
        discount_num: float = None,
        segment_keys: List[str] = None,
        segment_position_list: List[main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListBestPriceItemSubItemsSegmentPositionList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('segment_position_list') is not None:
            for k1 in m.get('segment_position_list'):
                temp_model = main_models.IntlFlightReShopListSearchResponseBodyModuleReShopItemListBestPriceItemSubItemsSegmentPositionList()
                self.segment_position_list.append(temp_model.from_map(k1))

        self.shopping_item_map = {}
        if m.get('shopping_item_map') is not None:
            for k1, v1 in m.get('shopping_item_map').items():
                temp_model = main_models.ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue()
                self.shopping_item_map[k1] = temp_model.from_map(v1)
...
class IntlFlightReShopListSearchResponseBodyModuleReShopItemListBestPriceItemSubItemsSegmentPositionList(DaraModel):
    def __init__(
        self,
        journey_index: int = None,
        segment_index: int = None,

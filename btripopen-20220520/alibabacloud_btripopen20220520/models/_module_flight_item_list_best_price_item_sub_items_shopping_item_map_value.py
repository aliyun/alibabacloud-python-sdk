...
class ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue(DaraModel):
    def __init__(
        self,
        id: str = None,
        cabin_quantity: Dict[str, main_models.ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityValue] = None,
        search_price: main_models.ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSearchPrice = None,
        segment_price: Dict[str, main_models.ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSegmentPriceValue] = None,
    ):
        # id
        self.id = id
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cabin_quantity') is not None:
            for k1, v1 in m.get('cabin_quantity').items():
                temp_model = main_models.ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityValue()
                self.cabin_quantity[k1] = temp_model.from_map(v1)

        if m.get('search_price') is not None:
            temp_model = main_models.ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSearchPrice()
        ...
        if m.get('segment_price') is not None:
            for k1, v1 in m.get('segment_price').items():
                temp_model = main_models.ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSegmentPriceValue()
                self.segment_price[k1] = temp_model.from_map(v1)

        return self

class ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSearchPrice(DaraModel):
    def __init__(
        self,
        ...
        price_show_info: main_models.ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSearchPricePriceShowInfo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('price_show_info') is not None:
            temp_model = main_models.ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSearchPricePriceShowInfo()
            self.price_show_info = temp_model.from_map(m.get('price_show_info'))

        return self

class ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSearchPricePriceShowInfo(DaraModel):
    def __init__(
        self,

...
class FlightOtaSearchV2ResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        module: main_models.FlightOtaSearchV2ResponseBodyModule = None,
        request_id: str = None,
        success: bool = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('module') is not None:
            temp_model = main_models.FlightOtaSearchV2ResponseBodyModule()
...
class FlightOtaSearchV2ResponseBodyModule(DaraModel):
    def __init__(
        self,
        flight_journey_infos: List[main_models.FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfos] = None,
        item_list: List[main_models.FlightOtaSearchV2ResponseBodyModuleItemList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('flight_journey_infos') is not None:
            for k1 in m.get('flight_journey_infos'):
                temp_model = main_models.FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfos()
                self.flight_journey_infos.append(temp_model.from_map(k1))

        self.item_list = []
        if m.get('item_list') is not None:
            for k1 in m.get('item_list'):
                temp_model = main_models.FlightOtaSearchV2ResponseBodyModuleItemList()
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('flight_rule_infos') is not None:
            for k1, v1 in m.get('flight_rule_infos').items():
                temp_model = main_models.ModuleItemListFlightRuleInfosValue()
        ...
        if m.get('sub_item_position_map') is not None:
            for k1, v1 in m.get('sub_item_position_map').items():
                l1 = []
                for k2 in v1:
                    temp_model = main_models.ModuleItemListSubItemPositionMapValue()
        ...
        if m.get('sub_items') is not None:
            for k1 in m.get('sub_items'):
                temp_model = main_models.FlightOtaSearchV2ResponseBodyModuleItemListSubItems()
                self.sub_items.append(temp_model.from_map(k1))

        return self

class FlightOtaSearchV2ResponseBodyModuleItemListSubItems(DaraModel):
    def __init__(
        self,
...
class FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfos(DaraModel):
    def __init__(
        self,
        ...
        flight_segment_infos: List[main_models.FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfos] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('flight_segment_infos') is not None:
            for k1 in m.get('flight_segment_infos'):
                temp_model = main_models.FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfos()
...
class FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfos(DaraModel):
    def __init__(
        self,
        airline_info: main_models.FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosAirlineInfo = None,
        arr_airport_info: main_models.FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosArrAirportInfo = None,
        arr_city_code: str = None,
        arr_city_name: str = None,
        arr_time: str = None,
        baggage_desc: str = None,
        dep_airport_info: main_models.FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosDepAirportInfo = None,
        dep_city_code: str = None,
        dep_city_name: str = None,
        dep_time: str = None,
        duration: int = None,
        ...
        flight_no: str = None,
        flight_share_info: main_models.FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosFlightShareInfo = None,
        flight_size: str = None,
        flight_stop_info: main_models.FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosFlightStopInfo = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('airline_info') is not None:
            temp_model = main_models.FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosAirlineInfo()
            self.airline_info = temp_model.from_map(m.get('airline_info'))

        if m.get('arr_airport_info') is not None:
            temp_model = main_models.FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosArrAirportInfo()
        ...
        if m.get('dep_airport_info') is not None:
            temp_model = main_models.FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosDepAirportInfo()
        ...
        if m.get('flight_share_info') is not None:
            temp_model = main_models.FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosFlightShareInfo()
        ...
        if m.get('flight_stop_info') is not None:
            temp_model = main_models.FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosFlightStopInfo()
...
class FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosFlightStopInfo(DaraModel):
    def __init__(
        self,
...
class FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosFlightShareInfo(DaraModel):
    def __init__(
        self,
        operating_airline_info: main_models.FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosFlightShareInfoOperatingAirlineInfo = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('operating_airline_info') is not None:
            temp_model = main_models.FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosFlightShareInfoOperatingAirlineInfo()
...
class FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosFlightShareInfoOperatingAirlineInfo(DaraModel):
    def __init__(
        self,
...
class FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosDepAirportInfo(DaraModel):
    def __init__(
        self,
...
class FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosArrAirportInfo(DaraModel):
    def __init__(
        self,
        airport_code: str = None,
        airport_name: str = None,
...
class FlightOtaSearchV2ResponseBodyModuleFlightJourneyInfosFlightSegmentInfosAirlineInfo(DaraModel):
    def __init__(
        self,
        airline_chinese_name: str = None,
        airline_chinese_short_name: str = None,

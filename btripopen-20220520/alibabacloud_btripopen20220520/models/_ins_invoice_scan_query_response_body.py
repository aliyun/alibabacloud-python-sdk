...
class InsInvoiceScanQueryResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        module: main_models.InsInvoiceScanQueryResponseBodyModule = None,
        request_id: str = None,
        success: bool = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('module') is not None:
            temp_model = main_models.InsInvoiceScanQueryResponseBodyModule()
...
class InsInvoiceScanQueryResponseBodyModule(DaraModel):
    def __init__(
        self,
        items: List[main_models.InsInvoiceScanQueryResponseBodyModuleItems] = None,
        page_no: int = None,
        page_size: int = None,
        total_page: int = None,
        total_size: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('items') is not None:
            for k1 in m.get('items'):
                temp_model = main_models.InsInvoiceScanQueryResponseBodyModuleItems()
...
class InsInvoiceScanQueryResponseBodyModuleItems(DaraModel):
    def __init__(
        self,
        ...
        invoice_details: List[main_models.InsInvoiceScanQueryResponseBodyModuleItemsInvoiceDetails] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('invoice_details') is not None:
            for k1 in m.get('invoice_details'):
                temp_model = main_models.InsInvoiceScanQueryResponseBodyModuleItemsInvoiceDetails()
...
class InsInvoiceScanQueryResponseBodyModuleItemsInvoiceDetails(DaraModel):
    def __init__(
        self,
        amount: str = None,
        index: str = None,

...
class FlightOrderDetailInfoResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        module: main_models.FlightOrderDetailInfoResponseBodyModule = None,
        request_id: str = None,
        success: bool = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('module') is not None:
            temp_model = main_models.FlightOrderDetailInfoResponseBodyModule()
...
class FlightOrderDetailInfoResponseBodyModule(DaraModel):
    def __init__(
        self,
        ...
        extra: str = None,
        flight_info_list: List[main_models.FlightOrderDetailInfoResponseBodyModuleFlightInfoList] = None,
        ...
        status: int = None,
        ticket_info_list: List[main_models.FlightOrderDetailInfoResponseBodyModuleTicketInfoList] = None,
        total_build_price: int = None,
        total_oil_price: int = None,
        total_order_price: int = None,
        traveler_info_list: List[main_models.FlightOrderDetailInfoResponseBodyModuleTravelerInfoList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('flight_info_list') is not None:
            for k1 in m.get('flight_info_list'):
                temp_model = main_models.FlightOrderDetailInfoResponseBodyModuleFlightInfoList()
        ...
        if m.get('ticket_info_list') is not None:
            for k1 in m.get('ticket_info_list'):
                temp_model = main_models.FlightOrderDetailInfoResponseBodyModuleTicketInfoList()
        ...
        if m.get('traveler_info_list') is not None:
            for k1 in m.get('traveler_info_list'):
                temp_model = main_models.FlightOrderDetailInfoResponseBodyModuleTravelerInfoList()
                self.traveler_info_list.append(temp_model.from_map(k1))

        return self

class FlightOrderDetailInfoResponseBodyModuleTravelerInfoList(DaraModel):
    def __init__(
        self,
        birth_date: str = None,
        cert_no: str = None,
...
class FlightOrderDetailInfoResponseBodyModuleTicketInfoList(DaraModel):
    def __init__(
        self,
...
class FlightOrderDetailInfoResponseBodyModuleFlightInfoList(DaraModel):
    def __init__(
        self,

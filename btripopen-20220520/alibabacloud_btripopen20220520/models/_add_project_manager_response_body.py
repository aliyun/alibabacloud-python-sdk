...
class AddProjectManagerResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        http_status_code: int = None,
        message: str = None,
        module: main_models.AddProjectManagerResponseBodyModule = None,
        request_id: str = None,
        success: bool = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('module') is not None:
            temp_model = main_models.AddProjectManagerResponseBodyModule()
...
class AddProjectManagerResponseBodyModule(DaraModel):
    def __init__(
        self,
        add_num: int = None,
        remove_num: int = None,

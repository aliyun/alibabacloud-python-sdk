...
class ModuleItemListSubItemsShoppingItemMapValue(DaraModel):
    def __init__(
        self,
        cabin_quantity_list: List[main_models.ModuleItemListSubItemsShoppingItemMapValueCabinQuantityList] = None,
        search_price: main_models.ModuleItemListSubItemsShoppingItemMapValueSearchPrice = None,
        segment_price_list: List[main_models.ModuleItemListSubItemsShoppingItemMapValueSegmentPriceList] = None,
        id: str = None,
        cabin_quantity: Dict[str, main_models.ModuleItemListSubItemsShoppingItemMapValueCabinQuantityValue] = None,
        segment_price: Dict[str, main_models.ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue] = None,
    ):
    ...
    def validate(self):
        ...
        if self.cabin_quantity:
            for v1 in self.cabin_quantity.values():
                 if v1:
                    v1.validate()
        if self.segment_price:
            for v1 in self.segment_price.values():
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.cabin_quantity is not None:
            for k1, v1 in self.cabin_quantity.items():
                result['cabin_quantity'][k1] = v1.to_map() if v1 else None

        result['segment_price'] = {}
        if self.segment_price is not None:
            for k1, v1 in self.segment_price.items():
                result['segment_price'][k1] = v1.to_map() if v1 else None
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cabin_quantity_list') is not None:
            for k1 in m.get('cabin_quantity_list'):
                temp_model = main_models.ModuleItemListSubItemsShoppingItemMapValueCabinQuantityList()
                self.cabin_quantity_list.append(temp_model.from_map(k1))

        if m.get('search_price') is not None:
            temp_model = main_models.ModuleItemListSubItemsShoppingItemMapValueSearchPrice()
        ...
        if m.get('segment_price_list') is not None:
            for k1 in m.get('segment_price_list'):
                temp_model = main_models.ModuleItemListSubItemsShoppingItemMapValueSegmentPriceList()
        ...
        if m.get('cabin_quantity') is not None:
            for k1, v1 in m.get('cabin_quantity').items():
                temp_model = main_models.ModuleItemListSubItemsShoppingItemMapValueCabinQuantityValue()
                self.cabin_quantity[k1] = temp_model.from_map(v1)

        self.segment_price = {}
        if m.get('segment_price') is not None:
            for k1, v1 in m.get('segment_price').items():
                temp_model = main_models.ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue()
                self.segment_price[k1] = temp_model.from_map(v1)

        return self

class ModuleItemListSubItemsShoppingItemMapValueSegmentPriceList(DaraModel):
    def __init__(
        self,
        segment_position: main_models.ModuleItemListSubItemsShoppingItemMapValueSegmentPriceListSegmentPosition = None,
        search_price: main_models.ModuleItemListSubItemsShoppingItemMapValueSegmentPriceListSearchPrice = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('segment_position') is not None:
            temp_model = main_models.ModuleItemListSubItemsShoppingItemMapValueSegmentPriceListSegmentPosition()
            self.segment_position = temp_model.from_map(m.get('segment_position'))

        if m.get('search_price') is not None:
            temp_model = main_models.ModuleItemListSubItemsShoppingItemMapValueSegmentPriceListSearchPrice()
            self.search_price = temp_model.from_map(m.get('search_price'))

        return self

class ModuleItemListSubItemsShoppingItemMapValueSegmentPriceListSearchPrice(DaraModel):
    def __init__(
        self,
        sell_price: int = None,
...
class ModuleItemListSubItemsShoppingItemMapValueSegmentPriceListSegmentPosition(DaraModel):
    def __init__(
        self,
...
class ModuleItemListSubItemsShoppingItemMapValueSearchPrice(DaraModel):
    def __init__(
        self,
        ...
        price_show_info: main_models.ModuleItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('price_show_info') is not None:
            temp_model = main_models.ModuleItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo()
            self.price_show_info = temp_model.from_map(m.get('price_show_info'))

        return self

class ModuleItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo(DaraModel):
    def __init__(
        self,
...
class ModuleItemListSubItemsShoppingItemMapValueCabinQuantityList(DaraModel):
    def __init__(
        self,
        segment_position: main_models.ModuleItemListSubItemsShoppingItemMapValueCabinQuantityListSegmentPosition = None,
        cabin_info: main_models.ModuleItemListSubItemsShoppingItemMapValueCabinQuantityListCabinInfo = None,
    ):
        self.segment_position = segment_position
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('segment_position') is not None:
            temp_model = main_models.ModuleItemListSubItemsShoppingItemMapValueCabinQuantityListSegmentPosition()
            self.segment_position = temp_model.from_map(m.get('segment_position'))

        if m.get('cabin_info') is not None:
            temp_model = main_models.ModuleItemListSubItemsShoppingItemMapValueCabinQuantityListCabinInfo()
            self.cabin_info = temp_model.from_map(m.get('cabin_info'))

        return self

class ModuleItemListSubItemsShoppingItemMapValueCabinQuantityListCabinInfo(DaraModel):
    def __init__(
        self,
        cabin: str = None,
...
class ModuleItemListSubItemsShoppingItemMapValueCabinQuantityListSegmentPosition(DaraModel):
    def __init__(
        self,
        journey_index: int = None,
        segment_index: int = None,

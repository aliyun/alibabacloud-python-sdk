...
class MonthPreBillGetResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        module: List[main_models.MonthPreBillGetResponseBodyModule] = None,
        request_id: str = None,
        success: bool = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('module') is not None:
            for k1 in m.get('module'):
                temp_model = main_models.MonthPreBillGetResponseBodyModule()
...
class MonthPreBillGetResponseBodyModule(DaraModel):
    def __init__(
        self,
        end_date: str = None,
        month_account_bill_detail: main_models.MonthPreBillGetResponseBodyModuleMonthAccountBillDetail = None,
        start_date: str = None,
        url: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('monthAccountBillDetail') is not None:
            temp_model = main_models.MonthPreBillGetResponseBodyModuleMonthAccountBillDetail()
...
class MonthPreBillGetResponseBodyModuleMonthAccountBillDetail(DaraModel):
    def __init__(
        self,

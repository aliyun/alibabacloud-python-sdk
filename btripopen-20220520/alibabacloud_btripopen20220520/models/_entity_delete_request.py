...
class EntityDeleteRequest(DaraModel):
    def __init__(
        self,
        del_all: bool = None,
        entity_dolist: List[main_models.EntityDeleteRequestEntityDOList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('entity_d_o_list') is not None:
            for k1 in m.get('entity_d_o_list'):
                temp_model = main_models.EntityDeleteRequestEntityDOList()
...
class EntityDeleteRequestEntityDOList(DaraModel):
    def __init__(
        self,
        entity_id: str = None,

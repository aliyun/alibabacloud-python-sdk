...
class AddProjectManagerRequest(DaraModel):
    def __init__(
        self,
        org_entities: List[main_models.AddProjectManagerRequestOrgEntities] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('org_entities') is not None:
            for k1 in m.get('org_entities'):
                temp_model = main_models.AddProjectManagerRequestOrgEntities()
...
class AddProjectManagerRequestOrgEntities(DaraModel):
    def __init__(
        self,
        entity_id: str = None,

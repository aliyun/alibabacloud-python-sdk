...
class BatchSubmitPreBillResponseBody(DaraModel):
    def __init__(
        self,
        module: main_models.BatchSubmitPreBillResponseBodyModule = None,
        more_page: bool = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('module') is not None:
            temp_model = main_models.BatchSubmitPreBillResponseBodyModule()
...
class BatchSubmitPreBillResponseBodyModule(DaraModel):
    def __init__(
        self,
        batch_id: int = None,
        forbid_update_bill_count: int = None,
        forbid_update_detail: List[main_models.BatchSubmitPreBillResponseBodyModuleForbidUpdateDetail] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('forbid_update_detail') is not None:
            for k1 in m.get('forbid_update_detail'):
                temp_model = main_models.BatchSubmitPreBillResponseBodyModuleForbidUpdateDetail()
...
class BatchSubmitPreBillResponseBodyModuleForbidUpdateDetail(DaraModel):
    def __init__(
        self,

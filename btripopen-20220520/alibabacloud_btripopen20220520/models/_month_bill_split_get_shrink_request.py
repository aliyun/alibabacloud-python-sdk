...
class MonthBillSplitGetShrinkRequest(DaraModel):
    def __init__(
        self,
        bill_batch: str = None,
        bill_month: str = None,
        bill_split_key_list_shrink: str = None,
        bill_split_mode: str = None,
    ):
        self.bill_batch = bill_batch
        self.bill_month = bill_month
        self.bill_split_key_list_shrink = bill_split_key_list_shrink
    ...
    def to_map(self):
        ...
        if self.bill_split_key_list_shrink is not None:
            result['bill_split_key_list'] = self.bill_split_key_list_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('bill_split_key_list') is not None:
            self.bill_split_key_list_shrink = m.get('bill_split_key_list')

...
class ApplyModifyResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        module: main_models.ApplyModifyResponseBodyModule = None,
        request_id: str = None,
        success: bool = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('module') is not None:
            temp_model = main_models.ApplyModifyResponseBodyModule()
...
class ApplyModifyResponseBodyModule(DaraModel):
    def __init__(
        self,
        apply_id: int = None,

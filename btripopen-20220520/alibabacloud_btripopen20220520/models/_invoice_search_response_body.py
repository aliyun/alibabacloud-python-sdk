...
class InvoiceSearchResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        module: List[main_models.InvoiceSearchResponseBodyModule] = None,
        request_id: str = None,
        success: bool = None,
        trace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('module') is not None:
            for k1 in m.get('module'):
                temp_model = main_models.InvoiceSearchResponseBodyModule()
...
class InvoiceSearchResponseBodyModule(DaraModel):
    def __init__(
        self,
        id: int = None,

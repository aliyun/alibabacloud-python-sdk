...
class DescribePairDrillsResponseBody(DaraModel):
    def __init__(
        self,
        drills: List[main_models.DescribePairDrillsResponseBodyDrills] = None,
        next_token: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Drills') is not None:
            for k1 in m.get('Drills'):
                temp_model = main_models.DescribePairDrillsResponseBodyDrills()
...
class DescribePairDrillsResponseBodyDrills(DaraModel):
    def __init__(
        self,

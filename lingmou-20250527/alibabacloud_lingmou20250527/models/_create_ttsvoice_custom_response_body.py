...
class CreateTTSVoiceCustomResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.CreateTTSVoiceCustomResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.CreateTTSVoiceCustomResponseBodyData()
...
class CreateTTSVoiceCustomResponseBodyData(DaraModel):
    def __init__(
        self,
        audio_url: str = None,

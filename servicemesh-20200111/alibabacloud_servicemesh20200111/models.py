...
class CreateServiceMeshRequest(TeaModel):
    def __init__(
        ...
        cadisable_secret_auto_generation: bool = None,
        calistened_namespaces: str = None,
        app_namespaces: str = None,
        ...
        self.cadisable_secret_auto_generation = cadisable_secret_auto_generation
        self.calistened_namespaces = calistened_namespaces

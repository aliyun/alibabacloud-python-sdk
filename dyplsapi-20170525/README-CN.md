...
## Alibaba Cloud Dyplsapi SDK for Python
...
```bash
# 安装 alibabacloud_dyplsapi20170525
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/dyplsapi-20170525/ChangeLog.md)中。

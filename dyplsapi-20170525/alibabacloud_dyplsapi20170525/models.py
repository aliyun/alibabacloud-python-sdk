...
class BindAxb700Request(TeaModel):
    def __init__(
        self,
...
class BindAxb700ResponseBodyData(TeaModel):
    def __init__(
        self,
        secret_no: str = None,
        subs_id: int = None,
...
class BindAxb700ResponseBody(TeaModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: str = None,
        data: BindAxb700ResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Code') is not None:
            self.code = m.get('Code')
        if m.get('Data') is not None:
            temp_model = BindAxb700ResponseBodyData()
            self.data = temp_model.from_map(m['Data'])
        if m.get('Message') is not None:
            self.message = m.get('Message')
        if m.get('RequestId') is not None:
...
class BindAxb700Response(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: BindAxb700ResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = BindAxb700ResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class BindGxb700Request(TeaModel):
    def __init__(
        self,
        asr_model_id: str = None,
        audio: str = None,
    ...
    def to_map(self):
        ...
        if self.default_a is not None:
            result['DefaultA'] = self.default_a
        if self.dtmf_config is not None:
            result['DtmfConfig'] = self.dtmf_config
        if self.expiration is not None:
            result['Expiration'] = self.expiration
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallTimeout') is not None:
            self.call_timeout = m.get('CallTimeout')
        if m.get('DefaultA') is not None:
            self.default_a = m.get('DefaultA')
        if m.get('DtmfConfig') is not None:
            self.dtmf_config = m.get('DtmfConfig')
        if m.get('Expiration') is not None:
            self.expiration = m.get('Expiration')
...
class BindGxb700ResponseBodyData(TeaModel):
    def __init__(
        self,
        secret_no: str = None,
        subs_id: int = None,
...
class BindGxb700ResponseBody(TeaModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: str = None,
        data: BindGxb700ResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Code') is not None:
            self.code = m.get('Code')
        if m.get('Data') is not None:
            temp_model = BindGxb700ResponseBodyData()
            self.data = temp_model.from_map(m['Data'])
        if m.get('Message') is not None:
            self.message = m.get('Message')
        if m.get('RequestId') is not None:
...
class BindGxb700Response(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: BindGxb700ResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = BindGxb700ResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class CreatePhoneNoAReportResponseBodyData(TeaModel):
    def __init__(
        self,
        create_result: bool = None,
        fail_type: int = None,
...
class CreatePhoneNoAReportResponseBody(TeaModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: str = None,
        data: CreatePhoneNoAReportResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Code') is not None:
            self.code = m.get('Code')
        if m.get('Data') is not None:
            temp_model = CreatePhoneNoAReportResponseBodyData()
            self.data = temp_model.from_map(m['Data'])
        if m.get('Message') is not None:
            self.message = m.get('Message')
        if m.get('RequestId') is not None:
...
class CreatePhoneNoAReportResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CreatePhoneNoAReportResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CreatePhoneNoAReportResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class GetDyplsOSSInfoForUploadFileRequest(TeaModel):
    def __init__(
        self,
        biz_type: str = None,
        owner_id: int = None,
...
class GetDyplsOSSInfoForUploadFileResponseBodyData(TeaModel):
    def __init__(
        self,
...
class GetDyplsOSSInfoForUploadFileResponseBody(TeaModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: str = None,
        data: GetDyplsOSSInfoForUploadFileResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Code') is not None:
            self.code = m.get('Code')
        if m.get('Data') is not None:
            temp_model = GetDyplsOSSInfoForUploadFileResponseBodyData()
            self.data = temp_model.from_map(m['Data'])
        if m.get('Message') is not None:
            self.message = m.get('Message')
        if m.get('RequestId') is not None:
...
class GetDyplsOSSInfoForUploadFileResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetDyplsOSSInfoForUploadFileResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetDyplsOSSInfoForUploadFileResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class UnbindSubs700ResponseBody(TeaModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: str = None,
...
class UnbindSubs700Response(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: UnbindSubs700ResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = UnbindSubs700ResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class UpdateSubs700Request(TeaModel):
    def __init__(
        self,
        asr_model_id: str = None,
        audio: str = None,
...
class UpdateSubs700ResponseBody(TeaModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: str = None,
...
class UpdateSubs700Response(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: UpdateSubs700ResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = UpdateSubs700ResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

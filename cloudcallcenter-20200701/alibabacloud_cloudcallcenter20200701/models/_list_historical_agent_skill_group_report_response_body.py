...
class ListHistoricalAgentSkillGroupReportResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ListHistoricalAgentSkillGroupReportResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListHistoricalAgentSkillGroupReportResponseBodyData()
...
class ListHistoricalAgentSkillGroupReportResponseBodyData(DaraModel):
    def __init__(
        self,
        list: List[main_models.ListHistoricalAgentSkillGroupReportResponseBodyDataList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            for k1 in m.get('List'):
                temp_model = main_models.ListHistoricalAgentSkillGroupReportResponseBodyDataList()
...
class ListHistoricalAgentSkillGroupReportResponseBodyDataList(DaraModel):
    def __init__(
        self,
        agent_id: str = None,
        agent_name: str = None,
        back_2back: main_models.ListHistoricalAgentSkillGroupReportResponseBodyDataListBack2Back = None,
        display_id: str = None,
        inbound: main_models.ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound = None,
        internal: main_models.ListHistoricalAgentSkillGroupReportResponseBodyDataListInternal = None,
        outbound: main_models.ListHistoricalAgentSkillGroupReportResponseBodyDataListOutbound = None,
        overall: main_models.ListHistoricalAgentSkillGroupReportResponseBodyDataListOverall = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Back2Back') is not None:
            temp_model = main_models.ListHistoricalAgentSkillGroupReportResponseBodyDataListBack2Back()
        ...
        if m.get('Inbound') is not None:
            temp_model = main_models.ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound()
            self.inbound = temp_model.from_map(m.get('Inbound'))

        if m.get('Internal') is not None:
            temp_model = main_models.ListHistoricalAgentSkillGroupReportResponseBodyDataListInternal()
            self.internal = temp_model.from_map(m.get('Internal'))

        if m.get('Outbound') is not None:
            temp_model = main_models.ListHistoricalAgentSkillGroupReportResponseBodyDataListOutbound()
            self.outbound = temp_model.from_map(m.get('Outbound'))

        if m.get('Overall') is not None:
            temp_model = main_models.ListHistoricalAgentSkillGroupReportResponseBodyDataListOverall()
...
class ListHistoricalAgentSkillGroupReportResponseBodyDataListOverall(DaraModel):
    def __init__(
        self,
        ...
        break_code_detail_list: List[main_models.ListHistoricalAgentSkillGroupReportResponseBodyDataListOverallBreakCodeDetailList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BreakCodeDetailList') is not None:
            for k1 in m.get('BreakCodeDetailList'):
                temp_model = main_models.ListHistoricalAgentSkillGroupReportResponseBodyDataListOverallBreakCodeDetailList()
...
class ListHistoricalAgentSkillGroupReportResponseBodyDataListOverallBreakCodeDetailList(DaraModel):
    def __init__(
        self,
        break_code: str = None,
        count: int = None,
...
class ListHistoricalAgentSkillGroupReportResponseBodyDataListOutbound(DaraModel):
    def __init__(
        self,
...
class ListHistoricalAgentSkillGroupReportResponseBodyDataListInternal(DaraModel):
    def __init__(
        self,
...
class ListHistoricalAgentSkillGroupReportResponseBodyDataListInbound(DaraModel):
    def __init__(
        self,
...
class ListHistoricalAgentSkillGroupReportResponseBodyDataListBack2Back(DaraModel):
    def __init__(
        self,

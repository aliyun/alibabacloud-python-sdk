...
## Alibaba Cloud CloudCallCenter SDK for Python
...
```bash
# 安装 alibabacloud_cloudcallcenter20200701
pip install alibabacloud_cloudcallcenter20200701
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/cloudcallcenter-20200701/ChangeLog.md)中。

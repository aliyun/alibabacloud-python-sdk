...
## Alibaba Cloud AliyunAuth SDK for Python
...
```bash
# 安装 alibabacloud_aliyunauth20181222
pip install alibabacloud_aliyunauth20181222
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/aliyunauth-20181222/ChangeLog.md)中。

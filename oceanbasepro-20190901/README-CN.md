...
```bash
# 安装 alibabacloud_oceanbasepro20190901
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/oceanbasepro-20190901/ChangeLog.md)中。

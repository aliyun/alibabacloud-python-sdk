...
```bash
# 安装 alibabacloud_alikafka20190916
pip install alibabacloud_alikafka20190916
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/alikafka-20190916/ChangeLog.md)中。

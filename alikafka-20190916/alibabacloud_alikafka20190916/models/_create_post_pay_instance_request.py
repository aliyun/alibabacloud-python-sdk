...
class CreatePostPayInstanceRequest(DaraModel):
    def __init__(
        self,
        ...
        serverless_config: main_models.CreatePostPayInstanceRequestServerlessConfig = None,
        spec_type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ServerlessConfig') is not None:
            temp_model = main_models.CreatePostPayInstanceRequestServerlessConfig()
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.CreatePostPayInstanceRequestTag()
                self.tag.append(temp_model.from_map(k1))

        return self

class CreatePostPayInstanceRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class CreatePostPayInstanceRequestServerlessConfig(DaraModel):
    def __init__(
        self,

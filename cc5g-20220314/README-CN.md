...
## Alibaba Cloud CC5G SDK for Python
...
```bash
# 安装 alibabacloud_cc5g20220314
pip install alibabacloud_cc5g20220314
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/cc5g-20220314/ChangeLog.md)中。

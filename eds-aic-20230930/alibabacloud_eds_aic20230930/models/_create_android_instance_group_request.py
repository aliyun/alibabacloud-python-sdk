...
class CreateAndroidInstanceGroupRequest(DaraModel):
    def __init__(
        self,
        amount: int = None,
        auto_pay: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NetworkInfo') is not None:
            temp_model = main_models.CreateAndroidInstanceGroupRequestNetworkInfo()
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.CreateAndroidInstanceGroupRequestTag()
...
class CreateAndroidInstanceGroupRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class CreateAndroidInstanceGroupRequestNetworkInfo(DaraModel):
    def __init__(
        self,
        auto_pay: bool = None,
        auto_renew: bool = None,

...
class BackupAndroidInstanceResponseBody(DaraModel):
    def __init__(
        self,
        count: int = None,
        data: List[main_models.BackupAndroidInstanceResponseBodyData] = None,
        request_id: str = None,
        task_id: str = None,
    ):
        self.count = count
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.BackupAndroidInstanceResponseBodyData()
...
class BackupAndroidInstanceResponseBodyData(DaraModel):
    def __init__(
        self,

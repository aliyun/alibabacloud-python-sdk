...
class CreatePolicyGroupRequest(DaraModel):
    def __init__(
        ...
        net_redirect_policy: main_models.CreatePolicyGroupRequestNetRedirectPolicy = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NetRedirectPolicy') is not None:
            temp_model = main_models.CreatePolicyGroupRequestNetRedirectPolicy()
        ...
        if m.get('Watermark') is not None:
            temp_model = main_models.CreatePolicyGroupRequestWatermark()
            self.watermark = temp_model.from_map(m.get('Watermark'))

        return self

class CreatePolicyGroupRequestWatermark(DaraModel):
    def __init__(
        self,
...
class CreatePolicyGroupRequestNetRedirectPolicy(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Rules') is not None:
            for k1 in m.get('Rules'):
                temp_model = main_models.CreatePolicyGroupRequestNetRedirectPolicyRules()
                self.rules.append(temp_model.from_map(k1))

        return self

class CreatePolicyGroupRequestNetRedirectPolicyRules(DaraModel):
    def __init__(
        self,
        rule_type: str = None,
        target: str = None,

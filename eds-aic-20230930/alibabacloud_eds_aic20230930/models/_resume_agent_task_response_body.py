...
class ResumeAgentTaskResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tasks') is not None:
            for k1 in m.get('Tasks'):
                temp_model = main_models.ResumeAgentTaskResponseBodyTasks()
                self.tasks.append(temp_model.from_map(k1))

        return self

class ResumeAgentTaskResponseBodyTasks(DaraModel):
    def __init__(
        self,
    ...
    def to_map(self):
        ...
        if self.resuming_at is not None:
            result['ResumingAt'] = self.resuming_at
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResumingAt') is not None:
            self.resuming_at = m.get('ResumingAt')

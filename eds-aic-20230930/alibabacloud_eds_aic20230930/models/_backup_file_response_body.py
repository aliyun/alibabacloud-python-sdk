...
class BackupFileResponseBody(DaraModel):
    def __init__(
        self,
        count: int = None,
        data: List[main_models.BackupFileResponseBodyData] = None,
        request_id: str = None,
        task_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.BackupFileResponseBodyData()
...
class BackupFileResponseBodyData(DaraModel):
    def __init__(
        self,

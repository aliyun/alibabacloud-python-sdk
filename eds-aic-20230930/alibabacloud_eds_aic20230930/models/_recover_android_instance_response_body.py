...
class RecoverAndroidInstanceResponseBody(DaraModel):
    def __init__(
        self,
        count: int = None,
        data: List[main_models.RecoverAndroidInstanceResponseBodyData] = None,
        request_id: str = None,
        task_id: str = None,
    ):
        self.count = count
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.RecoverAndroidInstanceResponseBodyData()
...
class RecoverAndroidInstanceResponseBodyData(DaraModel):
    def __init__(
        self,

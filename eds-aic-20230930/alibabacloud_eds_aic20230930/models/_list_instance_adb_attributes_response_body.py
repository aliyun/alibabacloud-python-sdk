...
class ListInstanceAdbAttributesResponseBody(DaraModel):
    def __init__(
        self,
        data: List[main_models.ListInstanceAdbAttributesResponseBodyData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListInstanceAdbAttributesResponseBodyData()
...
class ListInstanceAdbAttributesResponseBodyData(DaraModel):
    def __init__(
        self,

...
class GetLogEventResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.GetLogEventResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetLogEventResponseBodyData()
...
class GetLogEventResponseBodyData(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Records') is not None:
            for k1 in m.get('Records'):
                temp_model = main_models.GetLogEventResponseBodyDataRecords()
...
class GetLogEventResponseBodyDataRecords(DaraModel):
    def __init__(
        self,
        app_name: str = None,
        content: str = None,

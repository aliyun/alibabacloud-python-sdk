...
class GetWorkflowDAGResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.GetWorkflowDAGResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetWorkflowDAGResponseBodyData()
...
class GetWorkflowDAGResponseBodyData(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Edges') is not None:
            for k1 in m.get('Edges'):
                temp_model = main_models.GetWorkflowDAGResponseBodyDataEdges()
                self.edges.append(temp_model.from_map(k1))

        self.nodes = []
        if m.get('Nodes') is not None:
            for k1 in m.get('Nodes'):
                temp_model = main_models.GetWorkflowDAGResponseBodyDataNodes()
                self.nodes.append(temp_model.from_map(k1))

        return self

class GetWorkflowDAGResponseBodyDataNodes(DaraModel):
    def __init__(
        self,
        app_name: str = None,
        coordinate: main_models.GetWorkflowDAGResponseBodyDataNodesCoordinate = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Coordinate') is not None:
            temp_model = main_models.GetWorkflowDAGResponseBodyDataNodesCoordinate()
...
class GetWorkflowDAGResponseBodyDataNodesCoordinate(DaraModel):
    def __init__(
        self,
        height: float = None,
        width: float = None,
...
class GetWorkflowDAGResponseBodyDataEdges(DaraModel):
    def __init__(
        self,
        source: int = None,
        target: int = None,

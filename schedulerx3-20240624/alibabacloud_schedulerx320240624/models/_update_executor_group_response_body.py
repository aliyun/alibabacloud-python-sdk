...
class UpdateExecutorGroupResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.UpdateExecutorGroupResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.UpdateExecutorGroupResponseBodyData()
...
class UpdateExecutorGroupResponseBodyData(DaraModel):
    def __init__(
        self,
        auth_type: str = None,

...
class GetWorkflowDAGPreviewResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.GetWorkflowDAGPreviewResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetWorkflowDAGPreviewResponseBodyData()
...
class GetWorkflowDAGPreviewResponseBodyData(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Edges') is not None:
            for k1 in m.get('Edges'):
                temp_model = main_models.GetWorkflowDAGPreviewResponseBodyDataEdges()
                self.edges.append(temp_model.from_map(k1))

        self.nodes = []
        if m.get('Nodes') is not None:
            for k1 in m.get('Nodes'):
                temp_model = main_models.GetWorkflowDAGPreviewResponseBodyDataNodes()
                self.nodes.append(temp_model.from_map(k1))

        return self

class GetWorkflowDAGPreviewResponseBodyDataNodes(DaraModel):
    def __init__(
        self,
        app_name: str = None,
        coordinate: main_models.GetWorkflowDAGPreviewResponseBodyDataNodesCoordinate = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Coordinate') is not None:
            temp_model = main_models.GetWorkflowDAGPreviewResponseBodyDataNodesCoordinate()
...
class GetWorkflowDAGPreviewResponseBodyDataNodesCoordinate(DaraModel):
    def __init__(
        self,
        height: float = None,
        width: float = None,
...
class GetWorkflowDAGPreviewResponseBodyDataEdges(DaraModel):
    def __init__(
        self,
        source: int = None,
        target: int = None,

...
class OperateRetryWorkflowExecutionRequest(DaraModel):
    def __init__(
        self,
        app_name: str = None,
        cluster_id: str = None,
    ...
    def to_map(self):
        ...
        if self.only_failed is not None:
            result['OnlyFailed'] = self.only_failed
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OnlyFailed') is not None:
            self.only_failed = m.get('OnlyFailed')

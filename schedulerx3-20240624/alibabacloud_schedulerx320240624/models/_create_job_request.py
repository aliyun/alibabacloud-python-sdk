...
class CreateJobRequest(DaraModel):
    def __init__(
        ...
        cluster_id: str = None,
        coordinate: main_models.CreateJobRequestCoordinate = None,
        ...
        name: str = None,
        notice_config: main_models.CreateJobRequestNoticeConfig = None,
        notice_contacts: List[main_models.CreateJobRequestNoticeContacts] = None,
        parameters: str = None,
        priority: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Coordinate') is not None:
            temp_model = main_models.CreateJobRequestCoordinate()
        ...
        if m.get('NoticeConfig') is not None:
            temp_model = main_models.CreateJobRequestNoticeConfig()
        ...
        if m.get('NoticeContacts') is not None:
            for k1 in m.get('NoticeContacts'):
                temp_model = main_models.CreateJobRequestNoticeContacts()
...
class CreateJobRequestNoticeContacts(DaraModel):
    def __init__(
        self,
...
class CreateJobRequestNoticeConfig(DaraModel):
    def __init__(
        self,
        end_early: int = None,
...
class CreateJobRequestCoordinate(DaraModel):
    def __init__(
        self,
        height: float = None,
        width: float = None,

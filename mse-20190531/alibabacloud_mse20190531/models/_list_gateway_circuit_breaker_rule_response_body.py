...
class ListGatewayCircuitBreakerRuleResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.ListGatewayCircuitBreakerRuleResponseBodyData = None,
        request_id: str = None,
    ):
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListGatewayCircuitBreakerRuleResponseBodyData()
...
class ListGatewayCircuitBreakerRuleResponseBodyData(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        result: List[main_models.ListGatewayCircuitBreakerRuleResponseBodyDataResult] = None,
        results: List[main_models.ListGatewayCircuitBreakerRuleResponseBodyDataResults] = None,
        total_size: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k1 in m.get('Result'):
                temp_model = main_models.ListGatewayCircuitBreakerRuleResponseBodyDataResult()
                self.result.append(temp_model.from_map(k1))

        self.results = []
        if m.get('Results') is not None:
            for k1 in m.get('Results'):
                temp_model = main_models.ListGatewayCircuitBreakerRuleResponseBodyDataResults()
...
class ListGatewayCircuitBreakerRuleResponseBodyDataResults(DaraModel):
    def __init__(
        self,
...
class ListGatewayCircuitBreakerRuleResponseBodyDataResult(DaraModel):
    def __init__(
        self,
        behavior_type: int = None,
        body_encoding: int = None,

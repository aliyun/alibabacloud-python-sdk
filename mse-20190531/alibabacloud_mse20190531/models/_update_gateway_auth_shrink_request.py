...
class UpdateGatewayAuthShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        delete_resource_id_list_shrink: str = None,
        ...
        self.delete_resource_id_list_shrink = delete_resource_id_list_shrink
    ...
    def to_map(self):
        ...
        if self.delete_resource_id_list_shrink is not None:
            result['DeleteResourceIdList'] = self.delete_resource_id_list_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DeleteResourceIdList') is not None:
            self.delete_resource_id_list_shrink = m.get('DeleteResourceIdList')

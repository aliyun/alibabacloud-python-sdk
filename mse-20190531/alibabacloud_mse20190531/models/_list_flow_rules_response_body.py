...
class ListFlowRulesResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.ListFlowRulesResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListFlowRulesResponseBodyData()
...
class ListFlowRulesResponseBodyData(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        result: List[main_models.ListFlowRulesResponseBodyDataResult] = None,
        total_size: int = None,
    ):
        # The page number.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k1 in m.get('Result'):
                temp_model = main_models.ListFlowRulesResponseBodyDataResult()
...
class ListFlowRulesResponseBodyDataResult(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        app_name: str = None,

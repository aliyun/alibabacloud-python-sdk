...
class CreateEngineNamespaceResponseBody(DaraModel):
    def __init__(
        self,
        cluster_id: str = None,
        data: main_models.CreateEngineNamespaceResponseBodyData = None,
        error_code: str = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CreateEngineNamespaceResponseBodyData()
...
class CreateEngineNamespaceResponseBodyData(DaraModel):
    def __init__(
        self,

...
class UpdateGatewayDomainRequest(DaraModel):
    def __init__(
        self,
        ...
        protocol: str = None,
        tls_cipher_suites_config_json: main_models.UpdateGatewayDomainRequestTlsCipherSuitesConfigJSON = None,
        tls_max: str = None,
        tls_min: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TlsCipherSuitesConfigJSON') is not None:
            temp_model = main_models.UpdateGatewayDomainRequestTlsCipherSuitesConfigJSON()
...
class UpdateGatewayDomainRequestTlsCipherSuitesConfigJSON(DaraModel):
    def __init__(
        self,

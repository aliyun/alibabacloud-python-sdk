...
class AddGatewayRouteRequest(DaraModel):
    def __init__(
        self,
        accept_language: str = None,
        description: str = None,
        destination_type: str = None,
        direct_response_json: main_models.AddGatewayRouteRequestDirectResponseJSON = None,
        domain_id: int = None,
        domain_id_list_json: str = None,
        enable_waf: bool = None,
        fallback: bool = None,
        fallback_services: List[main_models.AddGatewayRouteRequestFallbackServices] = None,
        gateway_id: int = None,
        gateway_unique_id: str = None,
        name: str = None,
        policies: str = None,
        predicates: main_models.AddGatewayRouteRequestPredicates = None,
        redirect_json: main_models.AddGatewayRouteRequestRedirectJSON = None,
        route_order: int = None,
        route_type: str = None,
        services: List[main_models.AddGatewayRouteRequestServices] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DirectResponseJSON') is not None:
            temp_model = main_models.AddGatewayRouteRequestDirectResponseJSON()
        ...
        if m.get('FallbackServices') is not None:
            for k1 in m.get('FallbackServices'):
                temp_model = main_models.AddGatewayRouteRequestFallbackServices()
        ...
        if m.get('Predicates') is not None:
            temp_model = main_models.AddGatewayRouteRequestPredicates()
            self.predicates = temp_model.from_map(m.get('Predicates'))

        if m.get('RedirectJSON') is not None:
            temp_model = main_models.AddGatewayRouteRequestRedirectJSON()
        ...
        if m.get('Services') is not None:
            for k1 in m.get('Services'):
                temp_model = main_models.AddGatewayRouteRequestServices()
                self.services.append(temp_model.from_map(k1))

        return self

class AddGatewayRouteRequestServices(DaraModel):
    def __init__(
        self,
        agreement_type: str = None,
        group_name: str = None,
        http_dubbo_transcoder: main_models.AddGatewayRouteRequestServicesHttpDubboTranscoder = None,
        name: str = None,
        namespace: str = None,
        percent: int = None,
        service_id: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HttpDubboTranscoder') is not None:
            temp_model = main_models.AddGatewayRouteRequestServicesHttpDubboTranscoder()
...
class AddGatewayRouteRequestServicesHttpDubboTranscoder(DaraModel):
    def __init__(
        self,
        dubbo_service_group: str = None,
        dubbo_service_name: str = None,
        dubbo_service_version: str = None,
        mothed_map_list: List[main_models.AddGatewayRouteRequestServicesHttpDubboTranscoderMothedMapList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MothedMapList') is not None:
            for k1 in m.get('MothedMapList'):
                temp_model = main_models.AddGatewayRouteRequestServicesHttpDubboTranscoderMothedMapList()
                self.mothed_map_list.append(temp_model.from_map(k1))

        return self

class AddGatewayRouteRequestServicesHttpDubboTranscoderMothedMapList(DaraModel):
    def __init__(
        self,
        dubbo_mothed_name: str = None,
        http_mothed: str = None,
        mothedpath: str = None,
        param_maps_list: List[main_models.AddGatewayRouteRequestServicesHttpDubboTranscoderMothedMapListParamMapsList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ParamMapsList') is not None:
            for k1 in m.get('ParamMapsList'):
                temp_model = main_models.AddGatewayRouteRequestServicesHttpDubboTranscoderMothedMapListParamMapsList()
...
class AddGatewayRouteRequestServicesHttpDubboTranscoderMothedMapListParamMapsList(DaraModel):
    def __init__(
        self,
...
class AddGatewayRouteRequestRedirectJSON(DaraModel):
    def __init__(
        self,
        code: int = None,
        host: str = None,
...
class AddGatewayRouteRequestPredicates(DaraModel):
    def __init__(
        self,
        header_predicates: List[main_models.AddGatewayRouteRequestPredicatesHeaderPredicates] = None,
        method_predicates: List[str] = None,
        path_predicates: main_models.AddGatewayRouteRequestPredicatesPathPredicates = None,
        query_predicates: List[main_models.AddGatewayRouteRequestPredicatesQueryPredicates] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HeaderPredicates') is not None:
            for k1 in m.get('HeaderPredicates'):
                temp_model = main_models.AddGatewayRouteRequestPredicatesHeaderPredicates()
        ...
        if m.get('PathPredicates') is not None:
            temp_model = main_models.AddGatewayRouteRequestPredicatesPathPredicates()
        ...
        if m.get('QueryPredicates') is not None:
            for k1 in m.get('QueryPredicates'):
                temp_model = main_models.AddGatewayRouteRequestPredicatesQueryPredicates()
                self.query_predicates.append(temp_model.from_map(k1))

        return self

class AddGatewayRouteRequestPredicatesQueryPredicates(DaraModel):
    def __init__(
        self,
        key: str = None,
        type: str = None,
...
class AddGatewayRouteRequestPredicatesPathPredicates(DaraModel):
    def __init__(
        self,
...
class AddGatewayRouteRequestPredicatesHeaderPredicates(DaraModel):
    def __init__(
        self,
        key: str = None,
        type: str = None,
...
class AddGatewayRouteRequestFallbackServices(DaraModel):
    def __init__(
        self,
        agreement_type: str = None,
        group_name: str = None,
...
class AddGatewayRouteRequestDirectResponseJSON(DaraModel):
    def __init__(
        self,
        body: str = None,
        code: int = None,

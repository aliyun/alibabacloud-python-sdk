...
class UpdateGatewayFlowRuleResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.UpdateGatewayFlowRuleResponseBodyData = None,
        request_id: str = None,
    ):
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.UpdateGatewayFlowRuleResponseBodyData()
...
class UpdateGatewayFlowRuleResponseBodyData(DaraModel):
    def __init__(
        self,

...
class UpdateGatewayIsolationRuleResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.UpdateGatewayIsolationRuleResponseBodyData = None,
        request_id: str = None,
    ):
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.UpdateGatewayIsolationRuleResponseBodyData()
...
class UpdateGatewayIsolationRuleResponseBodyData(DaraModel):
    def __init__(
        self,

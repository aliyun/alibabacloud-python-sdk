...
class DeleteSecurityGroupRuleResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.DeleteSecurityGroupRuleResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DeleteSecurityGroupRuleResponseBodyData()
...
class DeleteSecurityGroupRuleResponseBodyData(DaraModel):
    def __init__(
        self,

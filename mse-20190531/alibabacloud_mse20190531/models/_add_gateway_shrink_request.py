...
class AddGatewayShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        slb_spec: str = None,
        spec: str = None,
        tag: List[main_models.AddGatewayShrinkRequestTag] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.AddGatewayShrinkRequestTag()
...
class AddGatewayShrinkRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

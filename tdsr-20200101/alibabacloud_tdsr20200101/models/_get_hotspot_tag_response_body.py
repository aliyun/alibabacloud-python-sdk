...
class GetHotspotTagResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: main_models.GetHotspotTagResponseBodyAccessDeniedDetail = None,
        data: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AccessDeniedDetail') is not None:
            temp_model = main_models.GetHotspotTagResponseBodyAccessDeniedDetail()
...
class GetHotspotTagResponseBodyAccessDeniedDetail(DaraModel):
    def __init__(
        self,

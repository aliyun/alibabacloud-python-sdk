...
class GetHotspotSceneDataResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: main_models.GetHotspotSceneDataResponseBodyAccessDeniedDetail = None,
        code: int = None,
        data: main_models.GetHotspotSceneDataResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AccessDeniedDetail') is not None:
            temp_model = main_models.GetHotspotSceneDataResponseBodyAccessDeniedDetail()
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetHotspotSceneDataResponseBodyData()
...
class GetHotspotSceneDataResponseBodyData(DaraModel):
    def __init__(
        self,
...
class GetHotspotSceneDataResponseBodyAccessDeniedDetail(DaraModel):
    def __init__(
        self,

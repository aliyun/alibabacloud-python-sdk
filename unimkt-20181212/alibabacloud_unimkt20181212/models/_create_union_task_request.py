...
class CreateUnionTaskRequest(DaraModel):
    def __init__(
        self,
        anchor_id: str = None,
        ...
        media_id_black_list: List[str] = None,
        media_id_white_list: List[str] = None,
        ...
        self.media_id_black_list = media_id_black_list
        self.media_id_white_list = media_id_white_list
    ...
    def to_map(self):
        ...
        if self.media_id_black_list is not None:
            result['MediaIdBlackList'] = self.media_id_black_list

        if self.media_id_white_list is not None:
            result['MediaIdWhiteList'] = self.media_id_white_list
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MediaIdBlackList') is not None:
            self.media_id_black_list = m.get('MediaIdBlackList')

        if m.get('MediaIdWhiteList') is not None:
            self.media_id_white_list = m.get('MediaIdWhiteList')

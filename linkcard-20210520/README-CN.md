...
## Alibaba Cloud Linkcard SDK for Python
...
```bash
# 安装 alibabacloud_linkcard20210520
pip install alibabacloud_linkcard20210520
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/linkcard-20210520/ChangeLog.md)中。

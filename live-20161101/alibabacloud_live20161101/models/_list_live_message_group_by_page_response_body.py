...
class ListLiveMessageGroupByPageResponseBody(DaraModel):
    def __init__(
        self,
        group_list: List[main_models.ListLiveMessageGroupByPageResponseBodyGroupList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('GroupList') is not None:
            for k1 in m.get('GroupList'):
                temp_model = main_models.ListLiveMessageGroupByPageResponseBodyGroupList()
...
class ListLiveMessageGroupByPageResponseBodyGroupList(DaraModel):
    def __init__(
        self,

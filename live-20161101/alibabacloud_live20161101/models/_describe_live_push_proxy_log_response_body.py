...
class DescribeLivePushProxyLogResponseBody(DaraModel):
    def __init__(
        self,
        domain_log_details: main_models.DescribeLivePushProxyLogResponseBodyDomainLogDetails = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DomainLogDetails') is not None:
            temp_model = main_models.DescribeLivePushProxyLogResponseBodyDomainLogDetails()
...
class DescribeLivePushProxyLogResponseBodyDomainLogDetails(DaraModel):
    def __init__(
        self,
        domain_log_detail: List[main_models.DescribeLivePushProxyLogResponseBodyDomainLogDetailsDomainLogDetail] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DomainLogDetail') is not None:
            for k1 in m.get('DomainLogDetail'):
                temp_model = main_models.DescribeLivePushProxyLogResponseBodyDomainLogDetailsDomainLogDetail()
                self.domain_log_detail.append(temp_model.from_map(k1))

        return self

class DescribeLivePushProxyLogResponseBodyDomainLogDetailsDomainLogDetail(DaraModel):
    def __init__(
        self,
        log_count: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LogInfos') is not None:
            temp_model = main_models.DescribeLivePushProxyLogResponseBodyDomainLogDetailsDomainLogDetailLogInfos()
            self.log_infos = temp_model.from_map(m.get('LogInfos'))

        if m.get('PageInfos') is not None:
            temp_model = main_models.DescribeLivePushProxyLogResponseBodyDomainLogDetailsDomainLogDetailPageInfos()
            self.page_infos = temp_model.from_map(m.get('PageInfos'))

        return self

class DescribeLivePushProxyLogResponseBodyDomainLogDetailsDomainLogDetailPageInfos(DaraModel):
    def __init__(
        self,
        page_index: int = None,
        page_size: int = None,
...
class DescribeLivePushProxyLogResponseBodyDomainLogDetailsDomainLogDetailLogInfos(DaraModel):
    def __init__(
        self,
        log_info_detail: List[main_models.DescribeLivePushProxyLogResponseBodyDomainLogDetailsDomainLogDetailLogInfosLogInfoDetail] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LogInfoDetail') is not None:
            for k1 in m.get('LogInfoDetail'):
                temp_model = main_models.DescribeLivePushProxyLogResponseBodyDomainLogDetailsDomainLogDetailLogInfosLogInfoDetail()
                self.log_info_detail.append(temp_model.from_map(k1))

        return self

class DescribeLivePushProxyLogResponseBodyDomainLogDetailsDomainLogDetailLogInfosLogInfoDetail(DaraModel):
    def __init__(
        self,
        end_time: str = None,
        log_name: str = None,

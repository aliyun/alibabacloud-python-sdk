...
class DeleteMessageAppResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.DeleteMessageAppResponseBodyResult()
            self.result = temp_model.from_map(m.get('Result'))

        return self

class DeleteMessageAppResponseBodyResult(DaraModel):
    def __init__(
        self,
        success: bool = None,
    ):

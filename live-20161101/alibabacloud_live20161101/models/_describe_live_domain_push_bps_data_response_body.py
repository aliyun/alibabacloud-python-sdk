...
class DescribeLiveDomainPushBpsDataResponseBody(DaraModel):
    def __init__(
        self,
        bps_data_per_interval: main_models.DescribeLiveDomainPushBpsDataResponseBodyBpsDataPerInterval = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BpsDataPerInterval') is not None:
            temp_model = main_models.DescribeLiveDomainPushBpsDataResponseBodyBpsDataPerInterval()
...
class DescribeLiveDomainPushBpsDataResponseBodyBpsDataPerInterval(DaraModel):
    def __init__(
        self,
        data_module: List[main_models.DescribeLiveDomainPushBpsDataResponseBodyBpsDataPerIntervalDataModule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataModule') is not None:
            for k1 in m.get('DataModule'):
                temp_model = main_models.DescribeLiveDomainPushBpsDataResponseBodyBpsDataPerIntervalDataModule()
                self.data_module.append(temp_model.from_map(k1))

        return self

class DescribeLiveDomainPushBpsDataResponseBodyBpsDataPerIntervalDataModule(DaraModel):
    def __init__(
        self,
        bps_value: str = None,
        time_stamp: str = None,

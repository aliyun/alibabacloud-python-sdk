...
class DescribeLiveDomainFrameRateAndBitRateDataResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FrameRateAndBitRateInfos') is not None:
            temp_model = main_models.DescribeLiveDomainFrameRateAndBitRateDataResponseBodyFrameRateAndBitRateInfos()
...
class DescribeLiveDomainFrameRateAndBitRateDataResponseBodyFrameRateAndBitRateInfos(DaraModel):
    def __init__(
        self,
        frame_rate_and_bit_rate_info: List[main_models.DescribeLiveDomainFrameRateAndBitRateDataResponseBodyFrameRateAndBitRateInfosFrameRateAndBitRateInfo] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FrameRateAndBitRateInfo') is not None:
            for k1 in m.get('FrameRateAndBitRateInfo'):
                temp_model = main_models.DescribeLiveDomainFrameRateAndBitRateDataResponseBodyFrameRateAndBitRateInfosFrameRateAndBitRateInfo()
                self.frame_rate_and_bit_rate_info.append(temp_model.from_map(k1))

        return self

class DescribeLiveDomainFrameRateAndBitRateDataResponseBodyFrameRateAndBitRateInfosFrameRateAndBitRateInfo(DaraModel):
    def __init__(
        self,

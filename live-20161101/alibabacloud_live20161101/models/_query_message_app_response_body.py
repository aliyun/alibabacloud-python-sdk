...
class QueryMessageAppResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k1 in m.get('Result'):
                temp_model = main_models.QueryMessageAppResponseBodyResult()
                self.result.append(temp_model.from_map(k1))

        return self

class QueryMessageAppResponseBodyResult(DaraModel):
    def __init__(
        self,
        app_list: List[main_models.QueryMessageAppResponseBodyResultAppList] = None,
        has_more: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AppList') is not None:
            for k1 in m.get('AppList'):
                temp_model = main_models.QueryMessageAppResponseBodyResultAppList()
...
class QueryMessageAppResponseBodyResultAppList(DaraModel):
    def __init__(
        self,

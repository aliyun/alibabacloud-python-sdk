...
class AddCasterEpisodeGroupContentResponseBody(DaraModel):
    def __init__(
        self,
        item_ids: main_models.AddCasterEpisodeGroupContentResponseBodyItemIds = None,
        program_id: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ItemIds') is not None:
            temp_model = main_models.AddCasterEpisodeGroupContentResponseBodyItemIds()
...
class AddCasterEpisodeGroupContentResponseBodyItemIds(DaraModel):
    def __init__(
        self,

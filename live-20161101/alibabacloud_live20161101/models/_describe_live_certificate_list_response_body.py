...
class DescribeLiveCertificateListResponseBody(DaraModel):
    def __init__(
        self,
        certificate_list_model: main_models.DescribeLiveCertificateListResponseBodyCertificateListModel = None,
        request_id: str = None,
    ):
        # The details.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CertificateListModel') is not None:
            temp_model = main_models.DescribeLiveCertificateListResponseBodyCertificateListModel()
...
class DescribeLiveCertificateListResponseBodyCertificateListModel(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CertList') is not None:
            temp_model = main_models.DescribeLiveCertificateListResponseBodyCertificateListModelCertList()
...
class DescribeLiveCertificateListResponseBodyCertificateListModelCertList(DaraModel):
    def __init__(
        self,
        cert: List[main_models.DescribeLiveCertificateListResponseBodyCertificateListModelCertListCert] = None,
    ):
        self.cert = cert
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Cert') is not None:
            for k1 in m.get('Cert'):
                temp_model = main_models.DescribeLiveCertificateListResponseBodyCertificateListModelCertListCert()
                self.cert.append(temp_model.from_map(k1))

        return self

class DescribeLiveCertificateListResponseBodyCertificateListModelCertListCert(DaraModel):
    def __init__(
        self,
        cert_id: int = None,
        cert_name: str = None,

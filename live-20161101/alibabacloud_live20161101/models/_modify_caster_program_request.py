...
class ModifyCasterProgramRequest(DaraModel):
    def __init__(
        self,
        caster_id: str = None,
        episode: List[main_models.ModifyCasterProgramRequestEpisode] = None,
        owner_id: int = None,
        region_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Episode') is not None:
            for k1 in m.get('Episode'):
                temp_model = main_models.ModifyCasterProgramRequestEpisode()
...
class ModifyCasterProgramRequestEpisode(DaraModel):
    def __init__(
        self,

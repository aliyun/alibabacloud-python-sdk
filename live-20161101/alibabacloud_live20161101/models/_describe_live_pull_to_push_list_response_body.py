...
class DescribeLivePullToPushListResponseBody(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        request_id: str = None,
        task_list: List[main_models.DescribeLivePullToPushListResponseBodyTaskList] = None,
        total: int = None,
    ):
        # The page number.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TaskList') is not None:
            for k1 in m.get('TaskList'):
                temp_model = main_models.DescribeLivePullToPushListResponseBodyTaskList()
...
class DescribeLivePullToPushListResponseBodyTaskList(DaraModel):
    def __init__(
        self,
        ...
        task_id: str = None,
        task_info: main_models.DescribeLivePullToPushListResponseBodyTaskListTaskInfo = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TaskInfo') is not None:
            temp_model = main_models.DescribeLivePullToPushListResponseBodyTaskListTaskInfo()

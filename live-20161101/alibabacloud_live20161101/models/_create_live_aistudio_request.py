...
class CreateLiveAIStudioRequest(DaraModel):
    def __init__(
        self,
        ...
        height: int = None,
        matting_layout: main_models.CreateLiveAIStudioRequestMattingLayout = None,
        matting_type: str = None,
        media_layout: main_models.CreateLiveAIStudioRequestMediaLayout = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MattingLayout') is not None:
            temp_model = main_models.CreateLiveAIStudioRequestMattingLayout()
        ...
        if m.get('MediaLayout') is not None:
            temp_model = main_models.CreateLiveAIStudioRequestMediaLayout()
...
class CreateLiveAIStudioRequestMediaLayout(DaraModel):
    def __init__(
        self,
...
class CreateLiveAIStudioRequestMattingLayout(DaraModel):
    def __init__(
        self,
        height_normalized: float = None,
        position_x: float = None,

...
class UpdateLiveMPUTaskRequest(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        channel_id: str = None,
        mix_mode: str = None,
        multi_stream_url: List[main_models.UpdateLiveMPUTaskRequestMultiStreamURL] = None,
        sei_params: main_models.UpdateLiveMPUTaskRequestSeiParams = None,
        single_sub_params: main_models.UpdateLiveMPUTaskRequestSingleSubParams = None,
        stream_url: str = None,
        task_id: str = None,
        transcode_params: main_models.UpdateLiveMPUTaskRequestTranscodeParams = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MultiStreamURL') is not None:
            for k1 in m.get('MultiStreamURL'):
                temp_model = main_models.UpdateLiveMPUTaskRequestMultiStreamURL()
                self.multi_stream_url.append(temp_model.from_map(k1))

        if m.get('SeiParams') is not None:
            temp_model = main_models.UpdateLiveMPUTaskRequestSeiParams()
            self.sei_params = temp_model.from_map(m.get('SeiParams'))

        if m.get('SingleSubParams') is not None:
            temp_model = main_models.UpdateLiveMPUTaskRequestSingleSubParams()
        ...
        if m.get('TranscodeParams') is not None:
            temp_model = main_models.UpdateLiveMPUTaskRequestTranscodeParams()
            self.transcode_params = temp_model.from_map(m.get('TranscodeParams'))

        return self

class UpdateLiveMPUTaskRequestTranscodeParams(DaraModel):
    def __init__(
        self,
        background: main_models.UpdateLiveMPUTaskRequestTranscodeParamsBackground = None,
        encode_params: main_models.UpdateLiveMPUTaskRequestTranscodeParamsEncodeParams = None,
        layout: main_models.UpdateLiveMPUTaskRequestTranscodeParamsLayout = None,
        user_infos: List[main_models.UpdateLiveMPUTaskRequestTranscodeParamsUserInfos] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Background') is not None:
            temp_model = main_models.UpdateLiveMPUTaskRequestTranscodeParamsBackground()
            self.background = temp_model.from_map(m.get('Background'))

        if m.get('EncodeParams') is not None:
            temp_model = main_models.UpdateLiveMPUTaskRequestTranscodeParamsEncodeParams()
            self.encode_params = temp_model.from_map(m.get('EncodeParams'))

        if m.get('Layout') is not None:
            temp_model = main_models.UpdateLiveMPUTaskRequestTranscodeParamsLayout()
            self.layout = temp_model.from_map(m.get('Layout'))

        self.user_infos = []
        if m.get('UserInfos') is not None:
            for k1 in m.get('UserInfos'):
                temp_model = main_models.UpdateLiveMPUTaskRequestTranscodeParamsUserInfos()
                self.user_infos.append(temp_model.from_map(k1))

        return self

class UpdateLiveMPUTaskRequestTranscodeParamsUserInfos(DaraModel):
    def __init__(
        self,
        channel_id: str = None,
...
class UpdateLiveMPUTaskRequestTranscodeParamsLayout(DaraModel):
    def __init__(
        self,
        user_panes: List[main_models.UpdateLiveMPUTaskRequestTranscodeParamsLayoutUserPanes] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserPanes') is not None:
            for k1 in m.get('UserPanes'):
                temp_model = main_models.UpdateLiveMPUTaskRequestTranscodeParamsLayoutUserPanes()
                self.user_panes.append(temp_model.from_map(k1))

        return self

class UpdateLiveMPUTaskRequestTranscodeParamsLayoutUserPanes(DaraModel):
    def __init__(
        self,
        background_image_url: str = None,
        height: str = None,
        render_mode: str = None,
        user_info: main_models.UpdateLiveMPUTaskRequestTranscodeParamsLayoutUserPanesUserInfo = None,
        width: str = None,
        x: str = None,
        y: str = None,
        zorder: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserInfo') is not None:
            temp_model = main_models.UpdateLiveMPUTaskRequestTranscodeParamsLayoutUserPanesUserInfo()
...
class UpdateLiveMPUTaskRequestTranscodeParamsLayoutUserPanesUserInfo(DaraModel):
    def __init__(
        self,
        channel_id: str = None,
        source_type: str = None,
...
class UpdateLiveMPUTaskRequestTranscodeParamsEncodeParams(DaraModel):
    def __init__(
        self,
...
class UpdateLiveMPUTaskRequestTranscodeParamsBackground(DaraModel):
    def __init__(
        self,
        render_mode: str = None,
        url: str = None,
...
class UpdateLiveMPUTaskRequestSingleSubParams(DaraModel):
    def __init__(
        self,
        source_type: str = None,
        stream_type: str = None,
...
class UpdateLiveMPUTaskRequestSeiParams(DaraModel):
    def __init__(
        self,
        layout_volume: main_models.UpdateLiveMPUTaskRequestSeiParamsLayoutVolume = None,
        pass_through: main_models.UpdateLiveMPUTaskRequestSeiParamsPassThrough = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LayoutVolume') is not None:
            temp_model = main_models.UpdateLiveMPUTaskRequestSeiParamsLayoutVolume()
            self.layout_volume = temp_model.from_map(m.get('LayoutVolume'))

        if m.get('PassThrough') is not None:
            temp_model = main_models.UpdateLiveMPUTaskRequestSeiParamsPassThrough()
            self.pass_through = temp_model.from_map(m.get('PassThrough'))

        return self

class UpdateLiveMPUTaskRequestSeiParamsPassThrough(DaraModel):
    def __init__(
        self,
        follow_idr: str = None,
        interval: str = None,
...
class UpdateLiveMPUTaskRequestSeiParamsLayoutVolume(DaraModel):
    def __init__(
        self,
        follow_idr: str = None,
        interval: str = None,
...
class UpdateLiveMPUTaskRequestMultiStreamURL(DaraModel):
    def __init__(
        self,

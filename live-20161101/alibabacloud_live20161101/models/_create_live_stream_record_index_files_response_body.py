...
class CreateLiveStreamRecordIndexFilesResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RecordInfo') is not None:
            temp_model = main_models.CreateLiveStreamRecordIndexFilesResponseBodyRecordInfo()
            self.record_info = temp_model.from_map(m.get('RecordInfo'))
...
class CreateLiveStreamRecordIndexFilesResponseBodyRecordInfo(DaraModel):
    def __init__(
        self,
        app_name: str = None,

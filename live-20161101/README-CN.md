...
## Alibaba Cloud live SDK for Python
...
```bash
# 安装 alibabacloud_live20161101
pip install alibabacloud_live20161101
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/live-20161101/ChangeLog.md)中。

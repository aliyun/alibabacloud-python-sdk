...
class CreateTemplateResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        template: main_models.CreateTemplateResponseBodyTemplate = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Template') is not None:
            temp_model = main_models.CreateTemplateResponseBodyTemplate()
...
class CreateTemplateResponseBodyTemplate(DaraModel):
    def __init__(
        self,
        created_by: str = None,

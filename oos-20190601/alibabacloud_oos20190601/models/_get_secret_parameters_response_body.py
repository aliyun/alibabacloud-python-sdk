...
class GetSecretParametersResponseBody(DaraModel):
    def __init__(
        self,
        invalid_parameters: List[str] = None,
        parameters: List[main_models.GetSecretParametersResponseBodyParameters] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Parameters') is not None:
            for k1 in m.get('Parameters'):
                temp_model = main_models.GetSecretParametersResponseBodyParameters()
...
class GetSecretParametersResponseBodyParameters(DaraModel):
    def __init__(
        self,

...
class ListStateConfigurationsResponseBody(DaraModel):
    def __init__(
        self,
        next_token: str = None,
        request_id: str = None,
        state_configurations: List[main_models.ListStateConfigurationsResponseBodyStateConfigurations] = None,
    ):
    ...
    def validate(self):
        if self.state_configurations:
            for v1 in self.state_configurations:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.state_configurations is not None:
            for k1 in self.state_configurations:
                result['StateConfigurations'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('StateConfigurations') is not None:
            for k1 in m.get('StateConfigurations'):
                temp_model = main_models.ListStateConfigurationsResponseBodyStateConfigurations()
                self.state_configurations.append(temp_model.from_map(k1))

        return self

class ListStateConfigurationsResponseBodyStateConfigurations(DaraModel):
    def __init__(
        self,

...
class GetApplicationGroupResponseBody(DaraModel):
    def __init__(
        self,
        application_group: main_models.GetApplicationGroupResponseBodyApplicationGroup = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApplicationGroup') is not None:
            temp_model = main_models.GetApplicationGroupResponseBodyApplicationGroup()
...
class GetApplicationGroupResponseBodyApplicationGroup(DaraModel):
    def __init__(
        self,

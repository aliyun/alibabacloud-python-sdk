...
class ListParametersResponseBody(DaraModel):
    def __init__(
        ...
        next_token: str = None,
        parameters: List[main_models.ListParametersResponseBodyParameters] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Parameters') is not None:
            for k1 in m.get('Parameters'):
                temp_model = main_models.ListParametersResponseBodyParameters()
...
class ListParametersResponseBodyParameters(DaraModel):
    def __init__(
        self,
        created_by: str = None,

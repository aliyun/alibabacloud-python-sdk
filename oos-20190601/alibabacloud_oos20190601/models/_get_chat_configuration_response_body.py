...
class GetChatConfigurationResponseBody(DaraModel):
    def __init__(
        self,
        chat_configuration: main_models.GetChatConfigurationResponseBodyChatConfiguration = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ChatConfiguration') is not None:
            temp_model = main_models.GetChatConfigurationResponseBodyChatConfiguration()
...
class GetChatConfigurationResponseBodyChatConfiguration(DaraModel):
    def __init__(
        self,

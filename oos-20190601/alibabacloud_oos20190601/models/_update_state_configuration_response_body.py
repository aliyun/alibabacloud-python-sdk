...
class UpdateStateConfigurationResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        state_configuration: List[main_models.UpdateStateConfigurationResponseBodyStateConfiguration] = None,
    ):
        # The request ID.
    ...
    def validate(self):
        if self.state_configuration:
            for v1 in self.state_configuration:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.state_configuration is not None:
            for k1 in self.state_configuration:
                result['StateConfiguration'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('StateConfiguration') is not None:
            for k1 in m.get('StateConfiguration'):
                temp_model = main_models.UpdateStateConfigurationResponseBodyStateConfiguration()
                self.state_configuration.append(temp_model.from_map(k1))

        return self

class UpdateStateConfigurationResponseBodyStateConfiguration(DaraModel):
    def __init__(
        self,

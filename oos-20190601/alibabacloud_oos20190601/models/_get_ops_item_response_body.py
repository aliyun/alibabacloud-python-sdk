...
class GetOpsItemResponseBody(DaraModel):
    def __init__(
        self,
        ops_item: main_models.GetOpsItemResponseBodyOpsItem = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OpsItem') is not None:
            temp_model = main_models.GetOpsItemResponseBodyOpsItem()
...
class GetOpsItemResponseBodyOpsItem(DaraModel):
    def __init__(
        self,

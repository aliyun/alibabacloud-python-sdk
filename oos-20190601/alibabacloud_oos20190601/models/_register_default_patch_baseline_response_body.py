...
class RegisterDefaultPatchBaselineResponseBody(DaraModel):
    def __init__(
        self,
        patch_baseline: main_models.RegisterDefaultPatchBaselineResponseBodyPatchBaseline = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PatchBaseline') is not None:
            temp_model = main_models.RegisterDefaultPatchBaselineResponseBodyPatchBaseline()
...
class RegisterDefaultPatchBaselineResponseBodyPatchBaseline(DaraModel):
    def __init__(
        self,

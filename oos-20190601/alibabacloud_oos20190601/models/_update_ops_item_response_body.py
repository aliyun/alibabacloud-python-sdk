...
class UpdateOpsItemResponseBody(DaraModel):
    def __init__(
        self,
        ops_item: main_models.UpdateOpsItemResponseBodyOpsItem = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OpsItem') is not None:
            temp_model = main_models.UpdateOpsItemResponseBodyOpsItem()
...
class UpdateOpsItemResponseBodyOpsItem(DaraModel):
    def __init__(
        self,
        attributes: str = None,
        category: str = None,

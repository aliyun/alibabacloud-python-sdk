...
class ListParameterVersionsResponseBody(DaraModel):
    def __init__(
        ...
        name: str = None,
        next_token: str = None,
        parameter_versions: List[main_models.ListParameterVersionsResponseBodyParameterVersions] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ParameterVersions') is not None:
            for k1 in m.get('ParameterVersions'):
                temp_model = main_models.ListParameterVersionsResponseBodyParameterVersions()
...
class ListParameterVersionsResponseBodyParameterVersions(DaraModel):
    def __init__(
        self,

...
class CreatePatchBaselineResponseBody(DaraModel):
    def __init__(
        self,
        patch_baseline: main_models.CreatePatchBaselineResponseBodyPatchBaseline = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PatchBaseline') is not None:
            temp_model = main_models.CreatePatchBaselineResponseBodyPatchBaseline()
...
class CreatePatchBaselineResponseBodyPatchBaseline(DaraModel):
    def __init__(
        self,
        ...
        tags: List[main_models.CreatePatchBaselineResponseBodyPatchBaselineTags] = None,
        updated_by: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.CreatePatchBaselineResponseBodyPatchBaselineTags()
...
class CreatePatchBaselineResponseBodyPatchBaselineTags(DaraModel):
    def __init__(
        self,
        tag_key: str = None,
        tag_value: str = None,

...
class GetParametersByPathResponseBody(DaraModel):
    def __init__(
        self,
        max_results: int = None,
        next_token: str = None,
        parameters: List[main_models.GetParametersByPathResponseBodyParameters] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Parameters') is not None:
            for k1 in m.get('Parameters'):
                temp_model = main_models.GetParametersByPathResponseBodyParameters()
...
class GetParametersByPathResponseBodyParameters(DaraModel):
    def __init__(
        self,

...
class GetSecretParameterResponseBody(DaraModel):
    def __init__(
        self,
        parameter: main_models.GetSecretParameterResponseBodyParameter = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Parameter') is not None:
            temp_model = main_models.GetSecretParameterResponseBodyParameter()
...
class GetSecretParameterResponseBodyParameter(DaraModel):
    def __init__(
        self,

...
class UpdateChatConfigurationResponseBody(DaraModel):
    def __init__(
        self,
        chat_configuration: main_models.UpdateChatConfigurationResponseBodyChatConfiguration = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ChatConfiguration') is not None:
            temp_model = main_models.UpdateChatConfigurationResponseBodyChatConfiguration()
...
class UpdateChatConfigurationResponseBodyChatConfiguration(DaraModel):
    def __init__(
        self,

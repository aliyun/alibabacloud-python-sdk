...
class CreateParameterResponseBody(DaraModel):
    def __init__(
        self,
        parameter: main_models.CreateParameterResponseBodyParameter = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Parameter') is not None:
            temp_model = main_models.CreateParameterResponseBodyParameter()
...
class CreateParameterResponseBodyParameter(DaraModel):
    def __init__(
        self,

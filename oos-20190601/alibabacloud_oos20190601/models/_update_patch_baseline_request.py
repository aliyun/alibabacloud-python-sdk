...
class UpdatePatchBaselineRequest(DaraModel):
    def __init__(
        self,
        ...
        tags: List[main_models.UpdatePatchBaselineRequestTags] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.UpdatePatchBaselineRequestTags()
                self.tags.append(temp_model.from_map(k1))

        return self

class UpdatePatchBaselineRequestTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

...
```bash
# 安装 alibabacloud_riskmanagement20260424
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/riskmanagement-20260424/ChangeLog.md)中。

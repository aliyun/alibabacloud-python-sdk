...
class DescribeSuspEventsResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.DescribeSuspEventsResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DescribeSuspEventsResponseBodyData()
...
class DescribeSuspEventsResponseBodyData(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Body') is not None:
            temp_model = main_models.DescribeSuspEventsResponseBodyDataBody()
            self.body = temp_model.from_map(m.get('Body'))

        return self

class DescribeSuspEventsResponseBodyDataBody(DaraModel):
    def __init__(
        self,
        count: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SuspEvents') is not None:
            for k1 in m.get('SuspEvents'):
                temp_model = main_models.DescribeSuspEventsResponseBodyDataBodySuspEvents()
...
class DescribeSuspEventsResponseBodyDataBodySuspEvents(DaraModel):
    def __init__(
        self,
        advanced: bool = None,
        ...
        desc: str = None,
        details: List[main_models.DescribeSuspEventsResponseBodyDataBodySuspEventsDetails] = None,
        detect_source: str = None,
        display_sandbox_result: bool = None,
        event_notes: List[main_models.DescribeSuspEventsResponseBodyDataBodySuspEventsEventNotes] = None,
        ...
        tactic_items: List[main_models.DescribeSuspEventsResponseBodyDataBodySuspEventsTacticItems] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Details') is not None:
            for k1 in m.get('Details'):
                temp_model = main_models.DescribeSuspEventsResponseBodyDataBodySuspEventsDetails()
        ...
        if m.get('EventNotes') is not None:
            for k1 in m.get('EventNotes'):
                temp_model = main_models.DescribeSuspEventsResponseBodyDataBodySuspEventsEventNotes()
        ...
        if m.get('TacticItems') is not None:
            for k1 in m.get('TacticItems'):
                temp_model = main_models.DescribeSuspEventsResponseBodyDataBodySuspEventsTacticItems()
...
class DescribeSuspEventsResponseBodyDataBodySuspEventsTacticItems(DaraModel):
    def __init__(
        self,
...
class DescribeSuspEventsResponseBodyDataBodySuspEventsEventNotes(DaraModel):
    def __init__(
        self,
        note: str = None,
        note_id: int = None,
...
class DescribeSuspEventsResponseBodyDataBodySuspEventsDetails(DaraModel):
    def __init__(
        self,

...
```bash
# 安装 alibabacloud_idaas_doraemon20210520
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/idaas-doraemon-20210520/ChangeLog.md)中。

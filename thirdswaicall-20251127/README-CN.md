...
## Alibaba Cloud ThirdswAicall SDK for Python
...
```bash
# 安装 alibabacloud_thirdswaicall20251127
pip install alibabacloud_thirdswaicall20251127
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/thirdswaicall-20251127/ChangeLog.md)中。

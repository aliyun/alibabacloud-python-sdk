...
class AbbrevMonitorAlert(DaraModel):
    def __init__(
        self,
        abbrev_monitor_alert_rules: List[main_models.AbbrevMonitorAlertRule] = None,
        condition: str = None,
        env: str = None,
        gmt_create: str = None,
        ...
        self.abbrev_monitor_alert_rules = abbrev_monitor_alert_rules
    ...
    def validate(self):
        if self.abbrev_monitor_alert_rules:
            for v1 in self.abbrev_monitor_alert_rules:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        result['abbrevMonitorAlertRules'] = []
        if self.abbrev_monitor_alert_rules is not None:
            for k1 in self.abbrev_monitor_alert_rules:
                result['abbrevMonitorAlertRules'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        self.abbrev_monitor_alert_rules = []
        if m.get('abbrevMonitorAlertRules') is not None:
            for k1 in m.get('abbrevMonitorAlertRules'):
                temp_model = main_models.AbbrevMonitorAlertRule()
                self.abbrev_monitor_alert_rules.append(temp_model.from_map(k1))

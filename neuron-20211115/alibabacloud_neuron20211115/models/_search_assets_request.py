...
class SearchAssetsRequest(DaraModel):
    def __init__(
        self,
        asset_industrys: List[str] = None,
        asset_name: str = None,
        ...
        self.asset_industrys = asset_industrys
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        if self.asset_industrys is not None:
            result['assetIndustrys'] = self.asset_industrys

        if self.asset_name is not None:
            result['assetName'] = self.asset_name

        if self.asset_types is not None:
            result['assetTypes'] = self.asset_types

...
class ListPdpLanesForServiceGroupShrinkRequest(DaraModel):
    def __init__(
        self,
        company_id: int = None,
        env: str = None,
        keyword: str = None,
        lane_ids_shrink: str = None,
        operator: str = None,
        order_by: str = None,
        ...
        self.lane_ids_shrink = lane_ids_shrink
    ...
    def to_map(self):
        ...
        if self.lane_ids_shrink is not None:
            result['laneIds'] = self.lane_ids_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('laneIds') is not None:
            self.lane_ids_shrink = m.get('laneIds')

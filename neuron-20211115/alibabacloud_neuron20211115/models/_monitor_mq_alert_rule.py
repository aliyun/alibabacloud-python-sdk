...
class MonitorMqAlertRule(DaraModel):
    def __init__(
        self,
        id: int = None,
        metric_dimension: str = None,
        metric_key: str = None,
    ...
    def to_map(self):
        ...
        if self.metric_dimension is not None:
            result['metricDimension'] = self.metric_dimension
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('metricDimension') is not None:
            self.metric_dimension = m.get('metricDimension')

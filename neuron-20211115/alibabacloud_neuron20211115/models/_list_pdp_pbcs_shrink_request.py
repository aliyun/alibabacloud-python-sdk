...
class ListPdpPbcsShrinkRequest(DaraModel):
    def __init__(
        self,
        company_id: int = None,
        ...
        self.pbc_ids_shrink = pbc_ids_shrink
    ...
    def to_map(self):
        ...
        if self.pbc_ids_shrink is not None:
            result['pbcIds'] = self.pbc_ids_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('pbcIds') is not None:
            self.pbc_ids_shrink = m.get('pbcIds')

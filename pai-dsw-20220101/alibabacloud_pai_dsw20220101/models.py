...
class CreateSanityCheckTaskRequest(TeaModel):
    def __init__(
        self,
        instance_id: str = None,
    ):
...
class CreateSanityCheckTaskResponseBody(TeaModel):
    def __init__(
        self,
        request_id: str = None,
        task_id: str = None,
...
class CreateSanityCheckTaskResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CreateSanityCheckTaskResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CreateSanityCheckTaskResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class GetSanityCheckTaskRequest(TeaModel):
    def __init__(
        self,
        verbose: bool = None,
    ):
...
class GetSanityCheckTaskResponseBodyCheckDetails(TeaModel):
    def __init__(
        self,
...
class GetSanityCheckTaskResponseBody(TeaModel):
    def __init__(
        self,
        check_details: List[GetSanityCheckTaskResponseBodyCheckDetails] = None,
        check_type: str = None,
        end_time: str = None,
        instance_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CheckDetails') is not None:
            for k in m.get('CheckDetails'):
                temp_model = GetSanityCheckTaskResponseBodyCheckDetails()
...
class GetSanityCheckTaskResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetSanityCheckTaskResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetSanityCheckTaskResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

...
class DescribeClientCertificateStatusForSerialNumberResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CertificateStatus') is not None:
            for k1 in m.get('CertificateStatus'):
                temp_model = main_models.DescribeClientCertificateStatusForSerialNumberResponseBodyCertificateStatus()
...
class DescribeClientCertificateStatusForSerialNumberResponseBodyCertificateStatus(DaraModel):
    def __init__(
        self,

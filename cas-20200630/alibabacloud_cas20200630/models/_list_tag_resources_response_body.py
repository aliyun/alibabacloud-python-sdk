...
class ListTagResourcesResponseBodyDataTagResources(DaraModel):
    def __init__(
        self,
        tag_resources: List[main_models.ListTagResourcesResponseBodyDataTagResourcesTagResources] = None,
    ):
        self.tag_resources = tag_resources
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TagResources') is not None:
            for k1 in m.get('TagResources'):
                temp_model = main_models.ListTagResourcesResponseBodyDataTagResourcesTagResources()
                self.tag_resources.append(temp_model.from_map(k1))

        return self

class ListTagResourcesResponseBodyDataTagResourcesTagResources(DaraModel):
    def __init__(
        self,

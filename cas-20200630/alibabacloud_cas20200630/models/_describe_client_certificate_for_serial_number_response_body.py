...
class DescribeClientCertificateForSerialNumberResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CertificateList') is not None:
            for k1 in m.get('CertificateList'):
                temp_model = main_models.DescribeClientCertificateForSerialNumberResponseBodyCertificateList()
...
class DescribeClientCertificateForSerialNumberResponseBodyCertificateList(DaraModel):
    def __init__(
        self,
        after_date: str = None,
        algorithm: str = None,

...
class DescribePcaAndExternalCACertificateListRequest(TeaModel):
    def __init__(
        self,
        current_page: int = None,
        show_size: int = None,
...
class DescribePcaAndExternalCACertificateListResponseBodyCertificateList(TeaModel):
    def __init__(
        self,
        after_date: int = None,
        algorithm: str = None,
...
class DescribePcaAndExternalCACertificateListResponseBody(TeaModel):
    def __init__(
        self,
        certificate_list: List[DescribePcaAndExternalCACertificateListResponseBodyCertificateList] = None,
        current_page: int = None,
        page_count: int = None,
        request_id: str = None,
        show_size: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CertificateList') is not None:
            for k in m.get('CertificateList'):
                temp_model = DescribePcaAndExternalCACertificateListResponseBodyCertificateList()
                self.certificate_list.append(temp_model.from_map(k))
        if m.get('CurrentPage') is not None:
            self.current_page = m.get('CurrentPage')
        if m.get('PageCount') is not None:
...
class DescribePcaAndExternalCACertificateListResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: DescribePcaAndExternalCACertificateListResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = DescribePcaAndExternalCACertificateListResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class ListTagResourcesResponseBodyDataTagResourcesTagResources(TeaModel):
    def __init__(
        self,
...
class ListTagResourcesResponseBodyDataTagResources(TeaModel):
    def __init__(
        self,
        tag_resources: List[ListTagResourcesResponseBodyDataTagResourcesTagResources] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TagResources') is not None:
            for k in m.get('TagResources'):
                temp_model = ListTagResourcesResponseBodyDataTagResourcesTagResources()
...
class ListTagResourcesResponseBodyData(TeaModel):
    def __init__(
        ...
        max_results: int = None,
        next_token: str = None,
        tag_resources: ListTagResourcesResponseBodyDataTagResources = None,
    ):
        self.max_results = max_results
        self.next_token = next_token
        self.tag_resources = tag_resources

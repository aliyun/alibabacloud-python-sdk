...
```bash
# 安装 alibabacloud_cas20200630
pip install alibabacloud_cas20200630
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/cas-20200630/ChangeLog.md)中。

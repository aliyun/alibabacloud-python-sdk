...
class Client(OpenApiClient):
    ...
    *
    ...
    def attach_instances_with_options(self, cluster_id, request, headers, runtime):
        ...
        return cs20151215_models.AttachInstancesResponse().from_map(self.do_roarequest("AttachInstances", "2015-12-15", "HTTPS", "POST", "AK", "/clusters/" + str(cluster_id) + "/attach", "json", req, runtime))
    ...
    def create_cluster_node_pool_with_options(self, cluster_id, request, headers, runtime):
        ...
        return cs20151215_models.CreateClusterNodePoolResponse().from_map(self.do_roarequest("CreateClusterNodePool", "2015-12-15", "HTTPS", "POST", "AK", "/clusters/" + str(cluster_id) + "/nodepools", "json", req, runtime))
    ...
    def delete_cluster_nodepool_with_options(self, cluster_id, nodepool_id, headers, runtime):
        ...
        return cs20151215_models.DeleteClusterNodepoolResponse().from_map(self.do_roarequest("DeleteClusterNodepool", "2015-12-15", "HTTPS", "DELETE", "AK", "/clusters/" + str(cluster_id) + "/nodepools/{NodepoolId}", "none", req, runtime))
    ...
    def describe_cluster_attach_scripts_with_options(self, cluster_id, request, headers, runtime):
        ...
        return cs20151215_models.DescribeClusterAttachScriptsResponse().from_map(self.do_roarequest("DescribeClusterAttachScripts", "2015-12-15", "HTTPS", "POST", "AK", "/clusters/" + str(cluster_id) + "/attachscript", "string", req, runtime))
    ...
    def describe_cluster_logs_with_options(self, cluster_id, headers, runtime):
        ...
        return cs20151215_models.DescribeClusterLogsResponse().from_map(self.do_roarequest("DescribeClusterLogs", "2015-12-15", "HTTPS", "GET", "AK", "/clusters/" + str(cluster_id) + "/logs", "array", req, runtime))
    ...
    def modify_cluster_with_options(self, cluster_id, request, headers, runtime):
        ...
        return cs20151215_models.ModifyClusterResponse().from_map(self.do_roarequest("ModifyCluster", "2015-12-15", "HTTPS", "PUT", "AK", "/api/v2/clusters/" + str(cluster_id) + "", "json", req, runtime))
    ...
    def modify_cluster_configuration_with_options(self, cluster_id, request, headers, runtime):
        ...
        return cs20151215_models.ModifyClusterConfigurationResponse().from_map(self.do_roarequest("ModifyClusterConfiguration", "2015-12-15", "HTTPS", "PUT", "AK", "/clusters/" + str(cluster_id) + "/configuration", "none", req, runtime))
    ...
    def modify_cluster_node_pool_with_options(self, cluster_id, nodepool_id, request, headers, runtime):
        ...
        return cs20151215_models.ModifyClusterNodePoolResponse().from_map(self.do_roarequest("ModifyClusterNodePool", "2015-12-15", "HTTPS", "PUT", "AK", "/clusters/" + str(cluster_id) + "/nodepools/{NodepoolId}", "none", req, runtime))
    ...
    def pause_cluster_upgrade_with_options(self, cluster_id, headers, runtime):
        ...
        return cs20151215_models.PauseClusterUpgradeResponse().from_map(self.do_roarequest("PauseClusterUpgrade", "2015-12-15", "HTTPS", "POST", "AK", "/api/v2/clusters/" + str(cluster_id) + "/upgrade/pause", "none", req, runtime))
    ...
    def remove_cluster_nodes_with_options(self, cluster_id, request, headers, runtime):
        ...
        return cs20151215_models.RemoveClusterNodesResponse().from_map(self.do_roarequest("RemoveClusterNodes", "2015-12-15", "HTTPS", "POST", "AK", "/api/v2/clusters/" + str(cluster_id) + "/nodes/remove", "none", req, runtime))
    ...
    def resume_upgrade_cluster_with_options(self, cluster_id, headers, runtime):
        ...
        return cs20151215_models.ResumeUpgradeClusterResponse().from_map(self.do_roarequest("ResumeUpgradeCluster", "2015-12-15", "HTTPS", "POST", "AK", "/api/v2/clusters/" + str(cluster_id) + "/upgrade/resume", "none", req, runtime))
    ...
    def scale_cluster_with_options(self, cluster_id, request, headers, runtime):
        ...
        return cs20151215_models.ScaleClusterResponse().from_map(self.do_roarequest("ScaleCluster", "2015-12-15", "HTTPS", "PUT", "AK", "/clusters/" + str(cluster_id) + "", "json", req, runtime))
    ...
    def scale_cluster_node_pool_with_options(self, cluster_id, nodepool_id, request, headers, runtime):
        ...
        return cs20151215_models.ScaleClusterNodePoolResponse().from_map(self.do_roarequest("ScaleClusterNodePool", "2015-12-15", "HTTPS", "POST", "AK", "/clusters/" + str(cluster_id) + "/nodepools/{NodepoolId}", "none", req, runtime))
    ...
    def scale_out_cluster_with_options(self, cluster_id, request, headers, runtime):
        ...
        return cs20151215_models.ScaleOutClusterResponse().from_map(self.do_roarequest("ScaleOutCluster", "2015-12-15", "HTTPS", "POST", "AK", "/api/v2/clusters/" + str(cluster_id) + "", "json", req, runtime))
    ...
    def un_install_cluster_addons_with_options(self, cluster_id, request, headers, runtime):
        ...
        return cs20151215_models.UnInstallClusterAddonsResponse().from_map(self.do_roarequest("UnInstallClusterAddons", "2015-12-15", "HTTPS", "POST", "AK", "/clusters/" + str(cluster_id) + "/components/uninstall", "none", req, runtime))
    ...
    def update_template_with_options(self, template_id, request, headers, runtime):
        ...
        return cs20151215_models.UpdateTemplateResponse().from_map(self.do_roarequest("UpdateTemplate", "2015-12-15", "HTTPS", "PUT", "AK", "/templates/" + str(template_id) + "", "none", req, runtime))
    ...
    def upgrade_cluster_with_options(self, cluster_id, request, headers, runtime):
        ...
        return cs20151215_models.UpgradeClusterResponse().from_map(self.do_roarequest("UpgradeCluster", "2015-12-15", "HTTPS", "POST", "AK", "/api/v2/clusters/" + str(cluster_id) + "/upgrade", "none", req, runtime))

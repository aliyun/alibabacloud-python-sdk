...
class Client(OpenApiClient):
    ...
    *\
    ...
    def delete_cluster_with_options(self, cluster_id, request, headers, runtime):
        ...
        return cs20151215_models.DeleteClusterResponse().from_map(self.do_roarequest('DeleteCluster', '2015-12-15', 'HTTPS', 'DELETE', 'AK', '/clusters/%s' % cluster_id, 'none', req, runtime))
    ...
    def modify_cluster_node_pool_with_options(self, cluster_id, nodepool_id, request, headers, runtime):
        ...
        return cs20151215_models.ModifyClusterNodePoolResponse().from_map(self.do_roarequest('ModifyClusterNodePool', '2015-12-15', 'HTTPS', 'PUT', 'AK', '/clusters/%s/nodepools/{NodepoolId}' % cluster_id, 'none', req, runtime))
    ...
    def remove_cluster_nodes_with_options(self, cluster_id, request, headers, runtime):
        ...
        return cs20151215_models.RemoveClusterNodesResponse().from_map(self.do_roarequest('RemoveClusterNodes', '2015-12-15', 'HTTPS', 'POST', 'AK', '/api/v2/clusters/%s/nodes/remove' % cluster_id, 'none', req, runtime))
    ...
    def scale_cluster_node_pool_with_options(self, cluster_id, nodepool_id, request, headers, runtime):
        ...
        return cs20151215_models.ScaleClusterNodePoolResponse().from_map(self.do_roarequest('ScaleClusterNodePool', '2015-12-15', 'HTTPS', 'POST', 'AK', '/clusters/%s/nodepools/{NodepoolId}' % cluster_id, 'none', req, runtime))

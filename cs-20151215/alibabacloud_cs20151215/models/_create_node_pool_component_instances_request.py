...
class CreateNodePoolComponentInstancesRequestComponentsConfig(DaraModel):
    def __init__(
        ...
        envs: List[main_models.CreateNodePoolComponentInstancesRequestComponentsConfigEnvs] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('envs') is not None:
            for k1 in m.get('envs'):
                temp_model = main_models.CreateNodePoolComponentInstancesRequestComponentsConfigEnvs()
                self.envs.append(temp_model.from_map(k1))

        return self

class CreateNodePoolComponentInstancesRequestComponentsConfigEnvs(DaraModel):
    def __init__(
        self,
        name: str = None,
        value: str = None,

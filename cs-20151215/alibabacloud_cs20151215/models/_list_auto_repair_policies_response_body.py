...
class ListAutoRepairPoliciesResponseBodyItemsRulesIncidents(DaraModel):
    def __init__(
        self,
        conditions: List[main_models.ListAutoRepairPoliciesResponseBodyItemsRulesIncidentsConditions] = None,
        events: List[main_models.ListAutoRepairPoliciesResponseBodyItemsRulesIncidentsEvents] = None,
        name: str = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('conditions') is not None:
            for k1 in m.get('conditions'):
                temp_model = main_models.ListAutoRepairPoliciesResponseBodyItemsRulesIncidentsConditions()
                self.conditions.append(temp_model.from_map(k1))

        self.events = []
        if m.get('events') is not None:
            for k1 in m.get('events'):
                temp_model = main_models.ListAutoRepairPoliciesResponseBodyItemsRulesIncidentsEvents()
...
class ListAutoRepairPoliciesResponseBodyItemsRulesIncidentsEvents(DaraModel):
    def __init__(
        self,
        reason: str = None,
        type: str = None,
...
class ListAutoRepairPoliciesResponseBodyItemsRulesIncidentsConditions(DaraModel):
    def __init__(
        self,
        reason: str = None,
        status: str = None,

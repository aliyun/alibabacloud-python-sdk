...
```bash
# 安装 alibabacloud_arms20210422
pip install alibabacloud_arms20210422
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/arms-20210422/ChangeLog.md)中。

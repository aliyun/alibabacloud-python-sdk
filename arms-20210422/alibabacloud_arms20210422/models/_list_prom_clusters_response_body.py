...
class ListPromClustersResponseBody(DaraModel):
    def __init__(
        self,
        prom_cluster_list: List[main_models.ListPromClustersResponseBodyPromClusterList] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PromClusterList') is not None:
            for k1 in m.get('PromClusterList'):
                temp_model = main_models.ListPromClustersResponseBodyPromClusterList()
...
class ListPromClustersResponseBodyPromClusterList(DaraModel):
    def __init__(
        self,

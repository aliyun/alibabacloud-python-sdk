...
class QueryMetricRequest(DaraModel):
    def __init__(
        self,
        ...
        end_time: int = None,
        filters: List[main_models.QueryMetricRequestFilters] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Filters') is not None:
            for k1 in m.get('Filters'):
                temp_model = main_models.QueryMetricRequestFilters()
...
class QueryMetricRequestFilters(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

...
class ListAlertTemplatesResponseBody(DaraModel):
    def __init__(
        self,
        alert_templates: List[main_models.ListAlertTemplatesResponseBodyAlertTemplates] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AlertTemplates') is not None:
            for k1 in m.get('AlertTemplates'):
                temp_model = main_models.ListAlertTemplatesResponseBodyAlertTemplates()
...
class ListAlertTemplatesResponseBodyAlertTemplates(DaraModel):
    def __init__(
        self,
        alert_provider: str = None,
        annotations: Dict[str, Any] = None,
        id: int = None,
        label_match_expression_grid: main_models.ListAlertTemplatesResponseBodyAlertTemplatesLabelMatchExpressionGrid = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LabelMatchExpressionGrid') is not None:
            temp_model = main_models.ListAlertTemplatesResponseBodyAlertTemplatesLabelMatchExpressionGrid()
...
class ListAlertTemplatesResponseBodyAlertTemplatesLabelMatchExpressionGrid(DaraModel):
    def __init__(
        self,
        label_match_expression_groups: List[main_models.ListAlertTemplatesResponseBodyAlertTemplatesLabelMatchExpressionGridLabelMatchExpressionGroups] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LabelMatchExpressionGroups') is not None:
            for k1 in m.get('LabelMatchExpressionGroups'):
                temp_model = main_models.ListAlertTemplatesResponseBodyAlertTemplatesLabelMatchExpressionGridLabelMatchExpressionGroups()
                self.label_match_expression_groups.append(temp_model.from_map(k1))

        return self

class ListAlertTemplatesResponseBodyAlertTemplatesLabelMatchExpressionGridLabelMatchExpressionGroups(DaraModel):
    def __init__(
        self,
        label_match_expressions: List[main_models.ListAlertTemplatesResponseBodyAlertTemplatesLabelMatchExpressionGridLabelMatchExpressionGroupsLabelMatchExpressions] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LabelMatchExpressions') is not None:
            for k1 in m.get('LabelMatchExpressions'):
                temp_model = main_models.ListAlertTemplatesResponseBodyAlertTemplatesLabelMatchExpressionGridLabelMatchExpressionGroupsLabelMatchExpressions()
                self.label_match_expressions.append(temp_model.from_map(k1))

        return self

class ListAlertTemplatesResponseBodyAlertTemplatesLabelMatchExpressionGridLabelMatchExpressionGroupsLabelMatchExpressions(DaraModel):
    def __init__(
        self,
        key: str = None,
        operator: str = None,

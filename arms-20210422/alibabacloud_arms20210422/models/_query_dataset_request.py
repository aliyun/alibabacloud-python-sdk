...
class QueryDatasetRequest(DaraModel):
    def __init__(
        self,
        dataset_id: int = None,
        date_str: str = None,
        dimensions: List[main_models.QueryDatasetRequestDimensions] = None,
        ...
        min_time: int = None,
        optional_dims: List[main_models.QueryDatasetRequestOptionalDims] = None,
        order_by_key: str = None,
        proxy_user_id: str = None,
        reduce_tail: bool = None,
        required_dims: List[main_models.QueryDatasetRequestRequiredDims] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Dimensions') is not None:
            for k1 in m.get('Dimensions'):
                temp_model = main_models.QueryDatasetRequestDimensions()
        ...
        if m.get('OptionalDims') is not None:
            for k1 in m.get('OptionalDims'):
                temp_model = main_models.QueryDatasetRequestOptionalDims()
        ...
        if m.get('RequiredDims') is not None:
            for k1 in m.get('RequiredDims'):
                temp_model = main_models.QueryDatasetRequestRequiredDims()
                self.required_dims.append(temp_model.from_map(k1))

        return self

class QueryDatasetRequestRequiredDims(DaraModel):
    def __init__(
        self,
        key: str = None,
        type: str = None,
...
class QueryDatasetRequestOptionalDims(DaraModel):
    def __init__(
        self,
        key: str = None,
        type: str = None,
...
class QueryDatasetRequestDimensions(DaraModel):
    def __init__(
        self,
        key: str = None,
        type: str = None,

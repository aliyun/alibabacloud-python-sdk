...
class EnableMultiAzRequest(DaraModel):
    def __init__(
        self,
        instance_id: str = None,
        observers: List[main_models.EnableMultiAzRequestObservers] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('observers') is not None:
            for k1 in m.get('observers'):
                temp_model = main_models.EnableMultiAzRequestObservers()
...
class EnableMultiAzRequestObservers(DaraModel):
    def __init__(
        self,
        vsw_id: str = None,
        zone_id: str = None,

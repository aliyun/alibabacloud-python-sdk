...
class QueryModifyChargeTypePriceResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        data: main_models.QueryModifyChargeTypePriceResponseBodyData = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.QueryModifyChargeTypePriceResponseBodyData()
...
class QueryModifyChargeTypePriceResponseBodyData(DaraModel):
    def __init__(
        self,
        component_prices: List[main_models.QueryModifyChargeTypePriceResponseBodyDataComponentPrices] = None,
        currency: str = None,
        depreciate_info: main_models.QueryModifyChargeTypePriceResponseBodyDataDepreciateInfo = None,
        discount_amount: float = None,
        module_instance: List[main_models.QueryModifyChargeTypePriceResponseBodyDataModuleInstance] = None,
        optional_promotions: List[main_models.QueryModifyChargeTypePriceResponseBodyDataOptionalPromotions] = None,
        original_amount: float = None,
        rules: List[main_models.QueryModifyChargeTypePriceResponseBodyDataRules] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ComponentPrices') is not None:
            for k1 in m.get('ComponentPrices'):
                temp_model = main_models.QueryModifyChargeTypePriceResponseBodyDataComponentPrices()
        ...
        if m.get('DepreciateInfo') is not None:
            temp_model = main_models.QueryModifyChargeTypePriceResponseBodyDataDepreciateInfo()
        ...
        if m.get('ModuleInstance') is not None:
            for k1 in m.get('ModuleInstance'):
                temp_model = main_models.QueryModifyChargeTypePriceResponseBodyDataModuleInstance()
        ...
        if m.get('OptionalPromotions') is not None:
            for k1 in m.get('OptionalPromotions'):
                temp_model = main_models.QueryModifyChargeTypePriceResponseBodyDataOptionalPromotions()
        ...
        if m.get('Rules') is not None:
            for k1 in m.get('Rules'):
                temp_model = main_models.QueryModifyChargeTypePriceResponseBodyDataRules()
...
class QueryModifyChargeTypePriceResponseBodyDataRules(DaraModel):
    def __init__(
        self,
        amount: float = None,
        name: str = None,
...
class QueryModifyChargeTypePriceResponseBodyDataOptionalPromotions(DaraModel):
    def __init__(
        self,
...
class QueryModifyChargeTypePriceResponseBodyDataModuleInstance(DaraModel):
    def __init__(
        self,
...
class QueryModifyChargeTypePriceResponseBodyDataDepreciateInfo(DaraModel):
    def __init__(
        self,
...
class QueryModifyChargeTypePriceResponseBodyDataComponentPrices(DaraModel):
    def __init__(
        self,

...
class QueryModifySpecTypePriceResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        data: main_models.QueryModifySpecTypePriceResponseBodyData = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.QueryModifySpecTypePriceResponseBodyData()
...
class QueryModifySpecTypePriceResponseBodyData(DaraModel):
    def __init__(
        self,
        component_prices: List[main_models.QueryModifySpecTypePriceResponseBodyDataComponentPrices] = None,
        currency: str = None,
        depreciate_info: main_models.QueryModifySpecTypePriceResponseBodyDataDepreciateInfo = None,
        discount_amount: float = None,
        optional_promotions: List[main_models.QueryModifySpecTypePriceResponseBodyDataOptionalPromotions] = None,
        original_amount: float = None,
        rules: List[main_models.QueryModifySpecTypePriceResponseBodyDataRules] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ComponentPrices') is not None:
            for k1 in m.get('ComponentPrices'):
                temp_model = main_models.QueryModifySpecTypePriceResponseBodyDataComponentPrices()
        ...
        if m.get('DepreciateInfo') is not None:
            temp_model = main_models.QueryModifySpecTypePriceResponseBodyDataDepreciateInfo()
        ...
        if m.get('OptionalPromotions') is not None:
            for k1 in m.get('OptionalPromotions'):
                temp_model = main_models.QueryModifySpecTypePriceResponseBodyDataOptionalPromotions()
        ...
        if m.get('Rules') is not None:
            for k1 in m.get('Rules'):
                temp_model = main_models.QueryModifySpecTypePriceResponseBodyDataRules()
...
class QueryModifySpecTypePriceResponseBodyDataRules(DaraModel):
    def __init__(
        self,
        amount: float = None,
        name: str = None,
...
class QueryModifySpecTypePriceResponseBodyDataOptionalPromotions(DaraModel):
    def __init__(
        self,
...
class QueryModifySpecTypePriceResponseBodyDataDepreciateInfo(DaraModel):
    def __init__(
        self,
...
class QueryModifySpecTypePriceResponseBodyDataComponentPrices(DaraModel):
    def __init__(
        self,

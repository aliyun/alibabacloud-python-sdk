...
class QueryModifyDiskTypePriceResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        data: main_models.QueryModifyDiskTypePriceResponseBodyData = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.QueryModifyDiskTypePriceResponseBodyData()
...
class QueryModifyDiskTypePriceResponseBodyData(DaraModel):
    def __init__(
        self,
        component_prices: List[main_models.QueryModifyDiskTypePriceResponseBodyDataComponentPrices] = None,
        currency: str = None,
        depreciate_info: main_models.QueryModifyDiskTypePriceResponseBodyDataDepreciateInfo = None,
        discount_amount: float = None,
        optional_promotions: List[main_models.QueryModifyDiskTypePriceResponseBodyDataOptionalPromotions] = None,
        original_amount: float = None,
        rules: List[main_models.QueryModifyDiskTypePriceResponseBodyDataRules] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ComponentPrices') is not None:
            for k1 in m.get('ComponentPrices'):
                temp_model = main_models.QueryModifyDiskTypePriceResponseBodyDataComponentPrices()
        ...
        if m.get('DepreciateInfo') is not None:
            temp_model = main_models.QueryModifyDiskTypePriceResponseBodyDataDepreciateInfo()
        ...
        if m.get('OptionalPromotions') is not None:
            for k1 in m.get('OptionalPromotions'):
                temp_model = main_models.QueryModifyDiskTypePriceResponseBodyDataOptionalPromotions()
        ...
        if m.get('Rules') is not None:
            for k1 in m.get('Rules'):
                temp_model = main_models.QueryModifyDiskTypePriceResponseBodyDataRules()
...
class QueryModifyDiskTypePriceResponseBodyDataRules(DaraModel):
    def __init__(
        self,
        amount: float = None,
        name: str = None,
...
class QueryModifyDiskTypePriceResponseBodyDataOptionalPromotions(DaraModel):
    def __init__(
        self,
...
class QueryModifyDiskTypePriceResponseBodyDataDepreciateInfo(DaraModel):
    def __init__(
        self,
...
class QueryModifyDiskTypePriceResponseBodyDataComponentPrices(DaraModel):
    def __init__(
        self,

...
class QueryEnableMultiAzPriceResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        data: main_models.QueryEnableMultiAzPriceResponseBodyData = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.QueryEnableMultiAzPriceResponseBodyData()
...
class QueryEnableMultiAzPriceResponseBodyData(DaraModel):
    def __init__(
        self,
        component_prices: List[main_models.QueryEnableMultiAzPriceResponseBodyDataComponentPrices] = None,
        currency: str = None,
        depreciate_info: main_models.QueryEnableMultiAzPriceResponseBodyDataDepreciateInfo = None,
        discount_amount: float = None,
        module_instance: List[main_models.QueryEnableMultiAzPriceResponseBodyDataModuleInstance] = None,
        optional_promotions: List[main_models.QueryEnableMultiAzPriceResponseBodyDataOptionalPromotions] = None,
        original_amount: float = None,
        rules: List[main_models.QueryEnableMultiAzPriceResponseBodyDataRules] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ComponentPrices') is not None:
            for k1 in m.get('ComponentPrices'):
                temp_model = main_models.QueryEnableMultiAzPriceResponseBodyDataComponentPrices()
        ...
        if m.get('DepreciateInfo') is not None:
            temp_model = main_models.QueryEnableMultiAzPriceResponseBodyDataDepreciateInfo()
        ...
        if m.get('ModuleInstance') is not None:
            for k1 in m.get('ModuleInstance'):
                temp_model = main_models.QueryEnableMultiAzPriceResponseBodyDataModuleInstance()
        ...
        if m.get('OptionalPromotions') is not None:
            for k1 in m.get('OptionalPromotions'):
                temp_model = main_models.QueryEnableMultiAzPriceResponseBodyDataOptionalPromotions()
        ...
        if m.get('Rules') is not None:
            for k1 in m.get('Rules'):
                temp_model = main_models.QueryEnableMultiAzPriceResponseBodyDataRules()
...
class QueryEnableMultiAzPriceResponseBodyDataRules(DaraModel):
    def __init__(
        self,
        amount: float = None,
        name: str = None,
...
class QueryEnableMultiAzPriceResponseBodyDataOptionalPromotions(DaraModel):
    def __init__(
        self,
...
class QueryEnableMultiAzPriceResponseBodyDataModuleInstance(DaraModel):
    def __init__(
        self,
...
class QueryEnableMultiAzPriceResponseBodyDataDepreciateInfo(DaraModel):
    def __init__(
        self,
...
class QueryEnableMultiAzPriceResponseBodyDataComponentPrices(DaraModel):
    def __init__(
        self,

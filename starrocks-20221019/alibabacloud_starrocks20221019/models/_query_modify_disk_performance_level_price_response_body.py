...
class QueryModifyDiskPerformanceLevelPriceResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        data: main_models.QueryModifyDiskPerformanceLevelPriceResponseBodyData = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.QueryModifyDiskPerformanceLevelPriceResponseBodyData()
...
class QueryModifyDiskPerformanceLevelPriceResponseBodyData(DaraModel):
    def __init__(
        self,
        component_prices: List[main_models.QueryModifyDiskPerformanceLevelPriceResponseBodyDataComponentPrices] = None,
        currency: str = None,
        depreciate_info: main_models.QueryModifyDiskPerformanceLevelPriceResponseBodyDataDepreciateInfo = None,
        discount_amount: float = None,
        optional_promotions: List[main_models.QueryModifyDiskPerformanceLevelPriceResponseBodyDataOptionalPromotions] = None,
        original_amount: float = None,
        rules: List[main_models.QueryModifyDiskPerformanceLevelPriceResponseBodyDataRules] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ComponentPrices') is not None:
            for k1 in m.get('ComponentPrices'):
                temp_model = main_models.QueryModifyDiskPerformanceLevelPriceResponseBodyDataComponentPrices()
        ...
        if m.get('DepreciateInfo') is not None:
            temp_model = main_models.QueryModifyDiskPerformanceLevelPriceResponseBodyDataDepreciateInfo()
        ...
        if m.get('OptionalPromotions') is not None:
            for k1 in m.get('OptionalPromotions'):
                temp_model = main_models.QueryModifyDiskPerformanceLevelPriceResponseBodyDataOptionalPromotions()
        ...
        if m.get('Rules') is not None:
            for k1 in m.get('Rules'):
                temp_model = main_models.QueryModifyDiskPerformanceLevelPriceResponseBodyDataRules()
...
class QueryModifyDiskPerformanceLevelPriceResponseBodyDataRules(DaraModel):
    def __init__(
        self,
        amount: float = None,
        name: str = None,
...
class QueryModifyDiskPerformanceLevelPriceResponseBodyDataOptionalPromotions(DaraModel):
    def __init__(
        self,
...
class QueryModifyDiskPerformanceLevelPriceResponseBodyDataDepreciateInfo(DaraModel):
    def __init__(
        self,
...
class QueryModifyDiskPerformanceLevelPriceResponseBodyDataComponentPrices(DaraModel):
    def __init__(
        self,

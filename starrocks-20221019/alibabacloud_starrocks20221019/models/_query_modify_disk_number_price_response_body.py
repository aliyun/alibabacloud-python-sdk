...
class QueryModifyDiskNumberPriceResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        data: main_models.QueryModifyDiskNumberPriceResponseBodyData = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.QueryModifyDiskNumberPriceResponseBodyData()
...
class QueryModifyDiskNumberPriceResponseBodyData(DaraModel):
    def __init__(
        self,
        component_prices: List[main_models.QueryModifyDiskNumberPriceResponseBodyDataComponentPrices] = None,
        currency: str = None,
        depreciate_info: main_models.QueryModifyDiskNumberPriceResponseBodyDataDepreciateInfo = None,
        discount_amount: float = None,
        optional_promotions: List[main_models.QueryModifyDiskNumberPriceResponseBodyDataOptionalPromotions] = None,
        original_amount: float = None,
        rules: List[main_models.QueryModifyDiskNumberPriceResponseBodyDataRules] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ComponentPrices') is not None:
            for k1 in m.get('ComponentPrices'):
                temp_model = main_models.QueryModifyDiskNumberPriceResponseBodyDataComponentPrices()
        ...
        if m.get('DepreciateInfo') is not None:
            temp_model = main_models.QueryModifyDiskNumberPriceResponseBodyDataDepreciateInfo()
        ...
        if m.get('OptionalPromotions') is not None:
            for k1 in m.get('OptionalPromotions'):
                temp_model = main_models.QueryModifyDiskNumberPriceResponseBodyDataOptionalPromotions()
        ...
        if m.get('Rules') is not None:
            for k1 in m.get('Rules'):
                temp_model = main_models.QueryModifyDiskNumberPriceResponseBodyDataRules()
...
class QueryModifyDiskNumberPriceResponseBodyDataRules(DaraModel):
    def __init__(
        self,
        amount: float = None,
        name: str = None,
...
class QueryModifyDiskNumberPriceResponseBodyDataOptionalPromotions(DaraModel):
    def __init__(
        self,
...
class QueryModifyDiskNumberPriceResponseBodyDataDepreciateInfo(DaraModel):
    def __init__(
        self,
...
class QueryModifyDiskNumberPriceResponseBodyDataComponentPrices(DaraModel):
    def __init__(
        self,

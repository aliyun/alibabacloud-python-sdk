...
class ResponsePlanDetail(DaraModel):
    def __init__(
        self,
        auto_recover_seconds: int = None,
        escalation_id: List[str] = None,
        pushing_setting: main_models.ResponsePlanDetailPushingSetting = None,
        repeat_notify_setting: main_models.ResponsePlanDetailRepeatNotifySetting = None,
    ):
...
class ResponsePlanDetailPushingSetting(DaraModel):
    def __init__(
        self,

...
class GetAddonReleaseResponseBody(DaraModel):
    def __init__(
        self,
        config: str = None,
        release: main_models.GetAddonReleaseResponseBodyRelease = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('release') is not None:
            temp_model = main_models.GetAddonReleaseResponseBodyRelease()
...
class GetAddonReleaseResponseBodyRelease(DaraModel):
    def __init__(
        self,
        addon_name: str = None,
        alert_rule_count: int = None,
        conditions: List[main_models.GetAddonReleaseResponseBodyReleaseConditions] = None,
        config: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('conditions') is not None:
            for k1 in m.get('conditions'):
                temp_model = main_models.GetAddonReleaseResponseBodyReleaseConditions()
...
class GetAddonReleaseResponseBodyReleaseConditions(DaraModel):
    def __init__(
        self,

...
class GetAddonResponseBody(DaraModel):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.GetAddonResponseBodyData()
...
class GetAddonResponseBodyData(DaraModel):
    def __init__(
        self,
        alias: str = None,
        categories: List[str] = None,
        dashboards: List[main_models.GetAddonResponseBodyDataDashboards] = None,
        description: str = None,
        environments: List[main_models.GetAddonResponseBodyDataEnvironments] = None,
        icon: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dashboards') is not None:
            for k1 in m.get('dashboards'):
                temp_model = main_models.GetAddonResponseBodyDataDashboards()
        ...
        if m.get('environments') is not None:
            for k1 in m.get('environments'):
                temp_model = main_models.GetAddonResponseBodyDataEnvironments()
...
class GetAddonResponseBodyDataEnvironments(DaraModel):
    def __init__(
        self,
        common_schema_refs: List[main_models.GetAddonResponseBodyDataEnvironmentsCommonSchemaRefs] = None,
        dependencies: main_models.GetAddonResponseBodyDataEnvironmentsDependencies = None,
        description: str = None,
        enable: bool = None,
        label: str = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('commonSchemaRefs') is not None:
            for k1 in m.get('commonSchemaRefs'):
                temp_model = main_models.GetAddonResponseBodyDataEnvironmentsCommonSchemaRefs()
                self.common_schema_refs.append(temp_model.from_map(k1))

        if m.get('dependencies') is not None:
            temp_model = main_models.GetAddonResponseBodyDataEnvironmentsDependencies()
        ...
        if m.get('policies') is not None:
            temp_model = main_models.GetAddonResponseBodyDataEnvironmentsPolicies()
...
class GetAddonResponseBodyDataEnvironmentsPolicies(DaraModel):
    def __init__(
        self,
        alert_default_status: str = None,
        default_install: bool = None,
        enable_service_account: bool = None,
        metric_check_rule: main_models.GetAddonResponseBodyDataEnvironmentsPoliciesMetricCheckRule = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('metricCheckRule') is not None:
            temp_model = main_models.GetAddonResponseBodyDataEnvironmentsPoliciesMetricCheckRule()
        ...
        if m.get('protocols') is not None:
            for k1 in m.get('protocols'):
                temp_model = main_models.GetAddonResponseBodyDataEnvironmentsPoliciesProtocols()
...
class GetAddonResponseBodyDataEnvironmentsPoliciesProtocols(DaraModel):
    def __init__(
        self,
        description: str = None,
        icon: str = None,
...
class GetAddonResponseBodyDataEnvironmentsPoliciesMetricCheckRule(DaraModel):
    def __init__(
        self,
...
class GetAddonResponseBodyDataEnvironmentsDependencies(DaraModel):
    def __init__(
        self,
...
class GetAddonResponseBodyDataEnvironmentsCommonSchemaRefs(DaraModel):
    def __init__(
        self,
        group: str = None,
        version: str = None,
...
class GetAddonResponseBodyDataDashboards(DaraModel):
    def __init__(
        self,
        description: str = None,
        name: str = None,

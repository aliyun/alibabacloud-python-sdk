...
class ListDeliveryTasksResponseBody(DaraModel):
    def __init__(
        self,
        delivery_tasks: List[main_models.ListDeliveryTasksResponseBodyDeliveryTasks] = None,
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        result['deliveryTasks'] = []
        if self.delivery_tasks is not None:
            for k1 in self.delivery_tasks:
                result['deliveryTasks'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        self.delivery_tasks = []
        if m.get('deliveryTasks') is not None:
            for k1 in m.get('deliveryTasks'):
                temp_model = main_models.ListDeliveryTasksResponseBodyDeliveryTasks()
                self.delivery_tasks.append(temp_model.from_map(k1))
...
class ListDeliveryTasksResponseBodyDeliveryTasks(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        data_source_id: str = None,
        external_labels: Dict[str, str] = None,
        extra_info: main_models.ListDeliveryTasksResponseBodyDeliveryTasksExtraInfo = None,
        label_filters: Dict[str, str] = None,
        label_filters_type: str = None,
        resource_group_id: str = None,
        sink_list: List[main_models.ListDeliveryTasksResponseBodyDeliveryTasksSinkList] = None,
        status: str = None,
        tags: List[main_models.ListDeliveryTasksResponseBodyDeliveryTasksTags] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('extraInfo') is not None:
            temp_model = main_models.ListDeliveryTasksResponseBodyDeliveryTasksExtraInfo()
        ...
        if m.get('sinkList') is not None:
            for k1 in m.get('sinkList'):
                temp_model = main_models.ListDeliveryTasksResponseBodyDeliveryTasksSinkList()
        ...
        if m.get('tags') is not None:
            for k1 in m.get('tags'):
                temp_model = main_models.ListDeliveryTasksResponseBodyDeliveryTasksTags()
...
class ListDeliveryTasksResponseBodyDeliveryTasksTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class ListDeliveryTasksResponseBodyDeliveryTasksSinkList(DaraModel):
    def __init__(
        self,
...
class ListDeliveryTasksResponseBodyDeliveryTasksExtraInfo(DaraModel):
    def __init__(
        self,

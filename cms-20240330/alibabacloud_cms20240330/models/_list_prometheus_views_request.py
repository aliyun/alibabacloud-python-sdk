...
class ListPrometheusViewsRequest(DaraModel):
    def __init__(
        self,
        ...
        tag: List[main_models.ListPrometheusViewsRequestTag] = None,
        version: str = None,
        workspace: str = None,
    ):
        # Filter by RegionID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('tag') is not None:
            for k1 in m.get('tag'):
                temp_model = main_models.ListPrometheusViewsRequestTag()
...
class ListPrometheusViewsRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

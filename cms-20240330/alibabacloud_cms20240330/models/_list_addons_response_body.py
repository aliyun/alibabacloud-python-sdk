...
class ListAddonsResponseBodyAddons(DaraModel):
    def __init__(
        ...
        dashboards: List[main_models.ListAddonsResponseBodyAddonsDashboards] = None,
        description: str = None,
        environments: List[main_models.ListAddonsResponseBodyAddonsEnvironments] = None,
        icon: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dashboards') is not None:
            for k1 in m.get('dashboards'):
                temp_model = main_models.ListAddonsResponseBodyAddonsDashboards()
        ...
        if m.get('environments') is not None:
            for k1 in m.get('environments'):
                temp_model = main_models.ListAddonsResponseBodyAddonsEnvironments()
...
class ListAddonsResponseBodyAddonsEnvironments(DaraModel):
    def __init__(
        self,
        common_schema_refs: List[main_models.ListAddonsResponseBodyAddonsEnvironmentsCommonSchemaRefs] = None,
        dependencies: main_models.ListAddonsResponseBodyAddonsEnvironmentsDependencies = None,
        description: str = None,
        enable: bool = None,
        label: str = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('commonSchemaRefs') is not None:
            for k1 in m.get('commonSchemaRefs'):
                temp_model = main_models.ListAddonsResponseBodyAddonsEnvironmentsCommonSchemaRefs()
                self.common_schema_refs.append(temp_model.from_map(k1))

        if m.get('dependencies') is not None:
            temp_model = main_models.ListAddonsResponseBodyAddonsEnvironmentsDependencies()
        ...
        if m.get('policies') is not None:
            temp_model = main_models.ListAddonsResponseBodyAddonsEnvironmentsPolicies()
...
class ListAddonsResponseBodyAddonsEnvironmentsPolicies(DaraModel):
    def __init__(
        self,
        alert_default_status: str = None,
        default_install: bool = None,
        enable_service_account: bool = None,
        metric_check_rule: main_models.ListAddonsResponseBodyAddonsEnvironmentsPoliciesMetricCheckRule = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('metricCheckRule') is not None:
            temp_model = main_models.ListAddonsResponseBodyAddonsEnvironmentsPoliciesMetricCheckRule()
        ...
        if m.get('protocols') is not None:
            for k1 in m.get('protocols'):
                temp_model = main_models.ListAddonsResponseBodyAddonsEnvironmentsPoliciesProtocols()
...
class ListAddonsResponseBodyAddonsEnvironmentsPoliciesProtocols(DaraModel):
    def __init__(
        self,
        description: str = None,
        icon: str = None,
...
class ListAddonsResponseBodyAddonsEnvironmentsPoliciesMetricCheckRule(DaraModel):
    def __init__(
        self,
...
class ListAddonsResponseBodyAddonsEnvironmentsDependencies(DaraModel):
    def __init__(
        self,
...
class ListAddonsResponseBodyAddonsEnvironmentsCommonSchemaRefs(DaraModel):
    def __init__(
        self,
        group: str = None,
        version: str = None,
...
class ListAddonsResponseBodyAddonsDashboards(DaraModel):
    def __init__(
        self,
        description: str = None,
        name: str = None,

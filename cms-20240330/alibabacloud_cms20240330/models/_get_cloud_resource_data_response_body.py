...
class GetCloudResourceDataResponseBody(DaraModel):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('responseStatus') is not None:
            temp_model = main_models.GetCloudResourceDataResponseBodyResponseStatus()
            self.response_status = temp_model.from_map(m.get('responseStatus'))

        return self

class GetCloudResourceDataResponseBodyResponseStatus(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusItem') is not None:
            for k1 in m.get('statusItem'):
                temp_model = main_models.GetCloudResourceDataResponseBodyResponseStatusStatusItem()
                self.status_item.append(temp_model.from_map(k1))

        return self

class GetCloudResourceDataResponseBodyResponseStatusStatusItem(DaraModel):
    def __init__(
        self,
        code: str = None,
        level: str = None,

...
class ListDataPipelinesResponseBodyPipelinesProcessorsConfig(DaraModel):
    def __init__(
        ...
        assignments: List[main_models.ListDataPipelinesResponseBodyPipelinesProcessorsConfigAssignments] = None,
        expression: str = None,
        fields: List[str] = None,
        parameters: Dict[str, Any] = None,
        projections: List[main_models.ListDataPipelinesResponseBodyPipelinesProcessorsConfigProjections] = None,
        rules: List[main_models.ListDataPipelinesResponseBodyPipelinesProcessorsConfigRules] = None,
        scope: main_models.ListDataPipelinesResponseBodyPipelinesProcessorsConfigScope = None,
        script: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('assignments') is not None:
            for k1 in m.get('assignments'):
                temp_model = main_models.ListDataPipelinesResponseBodyPipelinesProcessorsConfigAssignments()
        ...
        if m.get('projections') is not None:
            for k1 in m.get('projections'):
                temp_model = main_models.ListDataPipelinesResponseBodyPipelinesProcessorsConfigProjections()
        ...
        if m.get('scope') is not None:
            temp_model = main_models.ListDataPipelinesResponseBodyPipelinesProcessorsConfigScope()
...
class ListDataPipelinesResponseBodyPipelinesProcessorsConfigScope(DaraModel):
    def __init__(
        self,
        conditions: List[main_models.ListDataPipelinesResponseBodyPipelinesProcessorsConfigScopeConditions] = None,
        metric_name: main_models.ListDataPipelinesResponseBodyPipelinesProcessorsConfigScopeMetricName = None,
        service_name: main_models.ListDataPipelinesResponseBodyPipelinesProcessorsConfigScopeServiceName = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('conditions') is not None:
            for k1 in m.get('conditions'):
                temp_model = main_models.ListDataPipelinesResponseBodyPipelinesProcessorsConfigScopeConditions()
                self.conditions.append(temp_model.from_map(k1))

        if m.get('metricName') is not None:
            temp_model = main_models.ListDataPipelinesResponseBodyPipelinesProcessorsConfigScopeMetricName()
            self.metric_name = temp_model.from_map(m.get('metricName'))

        if m.get('serviceName') is not None:
            temp_model = main_models.ListDataPipelinesResponseBodyPipelinesProcessorsConfigScopeServiceName()
            self.service_name = temp_model.from_map(m.get('serviceName'))

        return self

class ListDataPipelinesResponseBodyPipelinesProcessorsConfigScopeServiceName(DaraModel):
    def __init__(
        self,
        match_type: str = None,
...
class ListDataPipelinesResponseBodyPipelinesProcessorsConfigScopeMetricName(DaraModel):
    def __init__(
        self,
        match_type: str = None,
        values: List[str] = None,
...
class ListDataPipelinesResponseBodyPipelinesProcessorsConfigScopeConditions(DaraModel):
    def __init__(
        self,
        field: main_models.ListDataPipelinesResponseBodyPipelinesProcessorsConfigScopeConditionsField = None,
        match_type: str = None,
        values: List[str] = None,
    ):
        # The field reference.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('field') is not None:
            temp_model = main_models.ListDataPipelinesResponseBodyPipelinesProcessorsConfigScopeConditionsField()
...
class ListDataPipelinesResponseBodyPipelinesProcessorsConfigScopeConditionsField(DaraModel):
    def __init__(
        self,
        container: str = None,
        kind: str = None,
...
class ListDataPipelinesResponseBodyPipelinesProcessorsConfigProjections(DaraModel):
    def __init__(
        self,
        source: str = None,
        target: str = None,
...
class ListDataPipelinesResponseBodyPipelinesProcessorsConfigAssignments(DaraModel):
    def __init__(
        self,
        expression: str = None,
        field: str = None,
...
class ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfig(DaraModel):
    def __init__(
        self,
        applications: List[str] = None,
        assignments: List[main_models.ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigAssignments] = None,
        expression: str = None,
        fields: List[str] = None,
        parameters: Dict[str, Any] = None,
        projections: List[main_models.ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigProjections] = None,
        rules: List[main_models.ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigRules] = None,
        scope: main_models.ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigScope = None,
        script: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('assignments') is not None:
            for k1 in m.get('assignments'):
                temp_model = main_models.ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigAssignments()
                self.assignments.append(temp_model.from_map(k1))
        ...
        if m.get('projections') is not None:
            for k1 in m.get('projections'):
                temp_model = main_models.ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigProjections()
                self.projections.append(temp_model.from_map(k1))
        ...
        if m.get('scope') is not None:
            temp_model = main_models.ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigScope()
            self.scope = temp_model.from_map(m.get('scope'))
...
class ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigScope(DaraModel):
    def __init__(
        self,
        conditions: List[main_models.ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigScopeConditions] = None,
        metric_name: main_models.ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigScopeMetricName = None,
        service_name: main_models.ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigScopeServiceName = None,
    ):
        # The additional field conditions.
        self.conditions = conditions
        # The metric name scope.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('conditions') is not None:
            for k1 in m.get('conditions'):
                temp_model = main_models.ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigScopeConditions()
                self.conditions.append(temp_model.from_map(k1))

        if m.get('metricName') is not None:
            temp_model = main_models.ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigScopeMetricName()
            self.metric_name = temp_model.from_map(m.get('metricName'))

        if m.get('serviceName') is not None:
            temp_model = main_models.ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigScopeServiceName()
            self.service_name = temp_model.from_map(m.get('serviceName'))

        return self

class ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigScopeServiceName(DaraModel):
    def __init__(
        self,
        match_type: str = None,
        values: List[str] = None,
...
class ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigScopeMetricName(DaraModel):
    def __init__(
        self,
        match_type: str = None,
        values: List[str] = None,
...
class ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigScopeConditions(DaraModel):
    def __init__(
        self,
        field: main_models.ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigScopeConditionsField = None,
        match_type: str = None,
        values: List[str] = None,
    ):
        # The field reference.
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('field') is not None:
            temp_model = main_models.ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigScopeConditionsField()
            self.field = temp_model.from_map(m.get('field'))
...
class ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigScopeConditionsField(DaraModel):
    def __init__(
        self,
        container: str = None,
        kind: str = None,
...
class ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigProjections(DaraModel):
    def __init__(
        self,
        source: str = None,
        target: str = None,
...
class ListDataPipelinesResponseBodyPipelinesOutputsProcessorsConfigAssignments(DaraModel):
    def __init__(
        self,
        expression: str = None,
        field: str = None,

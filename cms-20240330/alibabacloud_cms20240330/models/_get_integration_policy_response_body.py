...
class GetIntegrationPolicyResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('policy') is not None:
            temp_model = main_models.GetIntegrationPolicyResponseBodyPolicy()
...
class GetIntegrationPolicyResponseBodyPolicy(DaraModel):
    def __init__(
        ...
        managed_info: main_models.GetIntegrationPolicyResponseBodyPolicyManagedInfo = None,
        policy_id: str = None,
        policy_name: str = None,
        policy_type: str = None,
        region_id: str = None,
        resource_group_id: str = None,
        tags: List[main_models.GetIntegrationPolicyResponseBodyPolicyTags] = None,
        user_id: str = None,
        workspace: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('entityGroup') is not None:
            temp_model = main_models.GetIntegrationPolicyResponseBodyPolicyEntityGroup()
            self.entity_group = temp_model.from_map(m.get('entityGroup'))

        if m.get('managedInfo') is not None:
            temp_model = main_models.GetIntegrationPolicyResponseBodyPolicyManagedInfo()
        ...
        if m.get('tags') is not None:
            for k1 in m.get('tags'):
                temp_model = main_models.GetIntegrationPolicyResponseBodyPolicyTags()
...
class GetIntegrationPolicyResponseBodyPolicyTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class GetIntegrationPolicyResponseBodyPolicyManagedInfo(DaraModel):
    def __init__(
        self,
...
class GetIntegrationPolicyResponseBodyPolicyEntityGroup(DaraModel):
    def __init__(
        self,
        description: str = None,
        entity_group_id: str = None,
        entity_group_name: str = None,
        entity_rules: main_models.GetIntegrationPolicyResponseBodyPolicyEntityGroupEntityRules = None,
        query: str = None,
        region_id: str = None,
        user_id: str = None,
        workspace: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('entityRules') is not None:
            temp_model = main_models.GetIntegrationPolicyResponseBodyPolicyEntityGroupEntityRules()
...
class GetIntegrationPolicyResponseBodyPolicyEntityGroupEntityRules(DaraModel):
    def __init__(
        self,
        annotations: List[main_models.GetIntegrationPolicyResponseBodyPolicyEntityGroupEntityRulesAnnotations] = None,
        entity_types: List[str] = None,
        field_rules: List[main_models.GetIntegrationPolicyResponseBodyPolicyEntityGroupEntityRulesFieldRules] = None,
        instance_ids: List[str] = None,
        ip_match_rule: main_models.GetIntegrationPolicyResponseBodyPolicyEntityGroupEntityRulesIpMatchRule = None,
        labels: List[main_models.GetIntegrationPolicyResponseBodyPolicyEntityGroupEntityRulesLabels] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('annotations') is not None:
            for k1 in m.get('annotations'):
                temp_model = main_models.GetIntegrationPolicyResponseBodyPolicyEntityGroupEntityRulesAnnotations()
        ...
        if m.get('fieldRules') is not None:
            for k1 in m.get('fieldRules'):
                temp_model = main_models.GetIntegrationPolicyResponseBodyPolicyEntityGroupEntityRulesFieldRules()
        ...
        if m.get('ipMatchRule') is not None:
            temp_model = main_models.GetIntegrationPolicyResponseBodyPolicyEntityGroupEntityRulesIpMatchRule()
            self.ip_match_rule = temp_model.from_map(m.get('ipMatchRule'))

        self.labels = []
        if m.get('labels') is not None:
            for k1 in m.get('labels'):
                temp_model = main_models.GetIntegrationPolicyResponseBodyPolicyEntityGroupEntityRulesLabels()
        ...
        if m.get('tags') is not None:
            for k1 in m.get('tags'):
                temp_model = main_models.GetIntegrationPolicyResponseBodyPolicyEntityGroupEntityRulesTags()
                self.tags.append(temp_model.from_map(k1))

        return self

class GetIntegrationPolicyResponseBodyPolicyEntityGroupEntityRulesTags(DaraModel):
    def __init__(
        self,
        op: str = None,
        tag_key: str = None,
...
class GetIntegrationPolicyResponseBodyPolicyEntityGroupEntityRulesLabels(DaraModel):
    def __init__(
        self,
        op: str = None,
        tag_key: str = None,
...
class GetIntegrationPolicyResponseBodyPolicyEntityGroupEntityRulesIpMatchRule(DaraModel):
    def __init__(
        self,
        ip_cidr: str = None,
...
class GetIntegrationPolicyResponseBodyPolicyEntityGroupEntityRulesFieldRules(DaraModel):
    def __init__(
        self,
        field_key: str = None,
...
class GetIntegrationPolicyResponseBodyPolicyEntityGroupEntityRulesAnnotations(DaraModel):
    def __init__(
        self,
        op: str = None,
        tag_key: str = None,
...
class GetIntegrationPolicyResponseBodyPolicyBindResource(DaraModel):
    def __init__(
        self,
        cluster_id: str = None,

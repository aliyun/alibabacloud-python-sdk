...
class SearchMemoriesResponseBody(DaraModel):
    def __init__(
        self,
        relations: List[main_models.SearchMemoriesResponseBodyRelations] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('relations') is not None:
            for k1 in m.get('relations'):
                temp_model = main_models.SearchMemoriesResponseBodyRelations()
...
class SearchMemoriesResponseBodyRelations(DaraModel):
    def __init__(
        self,

...
class OnsTrendGroupOutputTpsResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.OnsTrendGroupOutputTpsResponseBodyData = None,
        request_id: str = None,
    ):
        # The data returned.
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.OnsTrendGroupOutputTpsResponseBodyData()
...
class OnsTrendGroupOutputTpsResponseBodyData(DaraModel):
    def __init__(
        self,
        records: main_models.OnsTrendGroupOutputTpsResponseBodyDataRecords = None,
        title: str = None,
        xunit: str = None,
        yunit: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Records') is not None:
            temp_model = main_models.OnsTrendGroupOutputTpsResponseBodyDataRecords()
...
class OnsTrendGroupOutputTpsResponseBodyDataRecords(DaraModel):
    def __init__(
        self,
        stats_data_do: List[main_models.OnsTrendGroupOutputTpsResponseBodyDataRecordsStatsDataDo] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('StatsDataDo') is not None:
            for k1 in m.get('StatsDataDo'):
                temp_model = main_models.OnsTrendGroupOutputTpsResponseBodyDataRecordsStatsDataDo()
                self.stats_data_do.append(temp_model.from_map(k1))

        return self

class OnsTrendGroupOutputTpsResponseBodyDataRecordsStatsDataDo(DaraModel):
    def __init__(
        self,
        x: int = None,
        y: float = None,

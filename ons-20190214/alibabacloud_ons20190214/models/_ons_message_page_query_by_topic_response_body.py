...
class OnsMessagePageQueryByTopicResponseBody(DaraModel):
    def __init__(
        self,
        msg_found_do: main_models.OnsMessagePageQueryByTopicResponseBodyMsgFoundDo = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MsgFoundDo') is not None:
            temp_model = main_models.OnsMessagePageQueryByTopicResponseBodyMsgFoundDo()
...
class OnsMessagePageQueryByTopicResponseBodyMsgFoundDo(DaraModel):
    def __init__(
        self,
        current_page: int = None,
        max_page_count: int = None,
        msg_found_list: main_models.OnsMessagePageQueryByTopicResponseBodyMsgFoundDoMsgFoundList = None,
        task_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MsgFoundList') is not None:
            temp_model = main_models.OnsMessagePageQueryByTopicResponseBodyMsgFoundDoMsgFoundList()
...
class OnsMessagePageQueryByTopicResponseBodyMsgFoundDoMsgFoundList(DaraModel):
    def __init__(
        self,
        ons_rest_message_do: List[main_models.OnsMessagePageQueryByTopicResponseBodyMsgFoundDoMsgFoundListOnsRestMessageDo] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OnsRestMessageDo') is not None:
            for k1 in m.get('OnsRestMessageDo'):
                temp_model = main_models.OnsMessagePageQueryByTopicResponseBodyMsgFoundDoMsgFoundListOnsRestMessageDo()
                self.ons_rest_message_do.append(temp_model.from_map(k1))

        return self

class OnsMessagePageQueryByTopicResponseBodyMsgFoundDoMsgFoundListOnsRestMessageDo(DaraModel):
    def __init__(
        self,
        body_crc: int = None,
        born_host: str = None,
        ...
        msg_id: str = None,
        property_list: main_models.OnsMessagePageQueryByTopicResponseBodyMsgFoundDoMsgFoundListOnsRestMessageDoPropertyList = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PropertyList') is not None:
            temp_model = main_models.OnsMessagePageQueryByTopicResponseBodyMsgFoundDoMsgFoundListOnsRestMessageDoPropertyList()
...
class OnsMessagePageQueryByTopicResponseBodyMsgFoundDoMsgFoundListOnsRestMessageDoPropertyList(DaraModel):
    def __init__(
        self,
        message_property: List[main_models.OnsMessagePageQueryByTopicResponseBodyMsgFoundDoMsgFoundListOnsRestMessageDoPropertyListMessageProperty] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MessageProperty') is not None:
            for k1 in m.get('MessageProperty'):
                temp_model = main_models.OnsMessagePageQueryByTopicResponseBodyMsgFoundDoMsgFoundListOnsRestMessageDoPropertyListMessageProperty()
                self.message_property.append(temp_model.from_map(k1))

        return self

class OnsMessagePageQueryByTopicResponseBodyMsgFoundDoMsgFoundListOnsRestMessageDoPropertyListMessageProperty(DaraModel):
    def __init__(
        self,
        name: str = None,
        value: str = None,

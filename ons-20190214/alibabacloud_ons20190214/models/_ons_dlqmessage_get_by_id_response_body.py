...
class OnsDLQMessageGetByIdResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.OnsDLQMessageGetByIdResponseBodyData = None,
        request_id: str = None,
    ):
        # The data returned.
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.OnsDLQMessageGetByIdResponseBodyData()
...
class OnsDLQMessageGetByIdResponseBodyData(DaraModel):
    def __init__(
        self,
        body_crc: int = None,
        born_host: str = None,
        ...
        msg_id: str = None,
        property_list: main_models.OnsDLQMessageGetByIdResponseBodyDataPropertyList = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PropertyList') is not None:
            temp_model = main_models.OnsDLQMessageGetByIdResponseBodyDataPropertyList()
...
class OnsDLQMessageGetByIdResponseBodyDataPropertyList(DaraModel):
    def __init__(
        self,
        message_property: List[main_models.OnsDLQMessageGetByIdResponseBodyDataPropertyListMessageProperty] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MessageProperty') is not None:
            for k1 in m.get('MessageProperty'):
                temp_model = main_models.OnsDLQMessageGetByIdResponseBodyDataPropertyListMessageProperty()
                self.message_property.append(temp_model.from_map(k1))

        return self

class OnsDLQMessageGetByIdResponseBodyDataPropertyListMessageProperty(DaraModel):
    def __init__(
        self,
        name: str = None,
        value: str = None,

...
```bash
# 安装 alibabacloud_ccc20200527
pip install alibabacloud_ccc20200527
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/ccc-20200527/ChangeLog.md)中。

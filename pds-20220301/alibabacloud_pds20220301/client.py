...
class Client(OpenApiClient):
    ...
    *\
    ...
    def safe_box_lock(
        self,
        request: pds_20220301_models.SafeBoxLockRequest,
    ) -> pds_20220301_models.SafeBoxLockResponse:
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.safe_box_lock_with_options(request, headers, runtime)

    async def safe_box_lock_async(
        self,
        request: pds_20220301_models.SafeBoxLockRequest,
    ) -> pds_20220301_models.SafeBoxLockResponse:
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.safe_box_lock_with_options_async(request, headers, runtime)

    def safe_box_lock_with_options(
        self,
        request: pds_20220301_models.SafeBoxLockRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ...
    async def safe_box_lock_with_options_async(
        self,
        request: pds_20220301_models.SafeBoxLockRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,

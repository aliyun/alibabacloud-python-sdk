...
class UpdateUserRequest(DaraModel):
    def __init__(
        ...
        email: str = None,
        group_info_list: List[main_models.UpdateUserRequestGroupInfoList] = None,
        nick_name: str = None,
        phone: str = None,
        role: str = None,
        status: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('group_info_list') is not None:
            for k1 in m.get('group_info_list'):
                temp_model = main_models.UpdateUserRequestGroupInfoList()
...
class UpdateUserRequestGroupInfoList(DaraModel):
    def __init__(
        self,
        group_id: str = None,
    ):

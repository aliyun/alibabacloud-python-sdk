...
## Alibaba Cloud SMQProxy SDK for Python
...
```bash
# 安装 alibabacloud_smqproxy20260409
pip install alibabacloud_smqproxy20260409
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/smqproxy-20260409/ChangeLog.md)中。

...
class ChangeParseSettingRequest(TeaModel):
    def __init__(
        self,
        category_id: str = None,
        file_type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ParserConfig') is not None:
            temp_model = ChangeParseSettingRequestParserConfig()
            self.parser_config = temp_model.from_map(m['ParserConfig'])
        return self


class ChangeParseSettingShrinkRequest(TeaModel):
    def __init__(
        self,
        category_id: str = None,
        file_type: str = None,
...
class ChangeParseSettingResponseBodyData(TeaModel):
    def __init__(
        self,
...
class ChangeParseSettingResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        data: ChangeParseSettingResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        status: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Code') is not None:
            self.code = m.get('Code')
        if m.get('Data') is not None:
            temp_model = ChangeParseSettingResponseBodyData()
            self.data = temp_model.from_map(m['Data'])
        if m.get('Message') is not None:
            self.message = m.get('Message')
        if m.get('RequestId') is not None:
...
class ChangeParseSettingResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ChangeParseSettingResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = ChangeParseSettingResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class DeleteChunkRequest(TeaModel):
    def __init__(
        self,
...
class DeleteChunkShrinkRequest(TeaModel):
    def __init__(
        self,
...
class DeleteChunkResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        data: bool = None,
...
class DeleteChunkResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: DeleteChunkResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = DeleteChunkResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class GetAlipayTransferStatusRequest(TeaModel):
    def __init__(
        self,
        code: str = None,
...
class GetAlipayTransferStatusResponseBodyData(TeaModel):
    def __init__(
        self,
        account_id: str = None,
...
class GetAlipayTransferStatusResponseBody(TeaModel):
    def __init__(
        self,
        data: GetAlipayTransferStatusResponseBodyData = None,
        request_id: str = None,
    ):
        self.data = data
        self.request_id = request_id
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('data') is not None:
            temp_model = GetAlipayTransferStatusResponseBodyData()
            self.data = temp_model.from_map(m['data'])
        if m.get('requestId') is not None:
            self.request_id = m.get('requestId')
        return self
...
class GetAlipayTransferStatusResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetAlipayTransferStatusResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetAlipayTransferStatusResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class GetAlipayUrlResponseBodyData(TeaModel):
    def __init__(
        self,
        code: str = None,
        qr_url: str = None,
...
class GetAlipayUrlResponseBody(TeaModel):
    def __init__(
        self,
        data: GetAlipayUrlResponseBodyData = None,
        request_id: str = None,
    ):
        self.data = data
        self.request_id = request_id
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('data') is not None:
            temp_model = GetAlipayUrlResponseBodyData()
            self.data = temp_model.from_map(m['data'])
        if m.get('requestId') is not None:
            self.request_id = m.get('requestId')
        return self
...
class GetAvailableParserTypesRequest(TeaModel):
    def __init__(
        self,
        file_type: str = None,
    ):
...
class GetAvailableParserTypesResponseBodyDataParserList(TeaModel):
    def __init__(
        self,
...
class GetAvailableParserTypesResponseBodyData(TeaModel):
    def __init__(
        self,
        file_type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ParserList') is not None:
            for k in m.get('ParserList'):
                temp_model = GetAvailableParserTypesResponseBodyDataParserList()
                self.parser_list.append(temp_model.from_map(k))
        return self


class GetAvailableParserTypesResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        data: GetAvailableParserTypesResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        status: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Code') is not None:
            self.code = m.get('Code')
        if m.get('Data') is not None:
            temp_model = GetAvailableParserTypesResponseBodyData()
            self.data = temp_model.from_map(m['Data'])
        if m.get('Message') is not None:
            self.message = m.get('Message')
        if m.get('RequestId') is not None:
...
class GetAvailableParserTypesResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetAvailableParserTypesResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetAvailableParserTypesResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class GetParseSettingsRequest(TeaModel):
    def __init__(
        self,
        category_id: str = None,
    ):
...
class GetParseSettingsResponseBodyDataParserConfig(TeaModel):
    def __init__(
        self,
        model_name: str = None,
        model_prompt: str = None,
...
class GetParseSettingsResponseBodyData(TeaModel):
    def __init__(
        self,
        file_type: str = None,
        parser: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Parser') is not None:
            self.parser = m.get('Parser')
        if m.get('ParserConfig') is not None:
            temp_model = GetParseSettingsResponseBodyDataParserConfig()
            self.parser_config = temp_model.from_map(m['ParserConfig'])
...
class GetParseSettingsResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        data: List[GetParseSettingsResponseBodyData] = None,
        message: str = None,
        request_id: str = None,
        status: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k in m.get('Data'):
                temp_model = GetParseSettingsResponseBodyData()
...
class GetParseSettingsResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetParseSettingsResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetParseSettingsResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class HighCodeDeployRequest(TeaModel):
    def __init__(
        self,
        agent_desc: str = None,
        agent_id: str = None,
...
class HighCodeDeployResponseBody(TeaModel):
    def __init__(
        self,
        data: str = None,
        error_code: str = None,
...
class HighCodeDeployResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: HighCodeDeployResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = HighCodeDeployResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

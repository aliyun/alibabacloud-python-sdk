...
class UpdateAndPublishAgentSelectiveRequest(DaraModel):
    def __init__(
        self,
        application_config: main_models.UpdateAndPublishAgentSelectiveRequestApplicationConfig = None,
        instructions: str = None,
        model_id: str = None,
        name: str = None,
        sample_library: main_models.UpdateAndPublishAgentSelectiveRequestSampleLibrary = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('applicationConfig') is not None:
            temp_model = main_models.UpdateAndPublishAgentSelectiveRequestApplicationConfig()
        ...
        if m.get('sampleLibrary') is not None:
            temp_model = main_models.UpdateAndPublishAgentSelectiveRequestSampleLibrary()
            self.sample_library = temp_model.from_map(m.get('sampleLibrary'))

        return self

class UpdateAndPublishAgentSelectiveRequestSampleLibrary(DaraModel):
    def __init__(
        self,
...
class UpdateAndPublishAgentSelectiveRequestApplicationConfig(DaraModel):
    def __init__(
        self,
        history_config: main_models.UpdateAndPublishAgentSelectiveRequestApplicationConfigHistoryConfig = None,
        long_term_memory: main_models.UpdateAndPublishAgentSelectiveRequestApplicationConfigLongTermMemory = None,
        parameters: main_models.UpdateAndPublishAgentSelectiveRequestApplicationConfigParameters = None,
        rag_config: main_models.UpdateAndPublishAgentSelectiveRequestApplicationConfigRagConfig = None,
        security: main_models.UpdateAndPublishAgentSelectiveRequestApplicationConfigSecurity = None,
        tools: List[main_models.UpdateAndPublishAgentSelectiveRequestApplicationConfigTools] = None,
        work_flows: List[main_models.UpdateAndPublishAgentSelectiveRequestApplicationConfigWorkFlows] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('historyConfig') is not None:
            temp_model = main_models.UpdateAndPublishAgentSelectiveRequestApplicationConfigHistoryConfig()
            self.history_config = temp_model.from_map(m.get('historyConfig'))

        if m.get('longTermMemory') is not None:
            temp_model = main_models.UpdateAndPublishAgentSelectiveRequestApplicationConfigLongTermMemory()
            self.long_term_memory = temp_model.from_map(m.get('longTermMemory'))

        if m.get('parameters') is not None:
            temp_model = main_models.UpdateAndPublishAgentSelectiveRequestApplicationConfigParameters()
            self.parameters = temp_model.from_map(m.get('parameters'))

        if m.get('ragConfig') is not None:
            temp_model = main_models.UpdateAndPublishAgentSelectiveRequestApplicationConfigRagConfig()
            self.rag_config = temp_model.from_map(m.get('ragConfig'))

        if m.get('security') is not None:
            temp_model = main_models.UpdateAndPublishAgentSelectiveRequestApplicationConfigSecurity()
            self.security = temp_model.from_map(m.get('security'))

        self.tools = []
        if m.get('tools') is not None:
            for k1 in m.get('tools'):
                temp_model = main_models.UpdateAndPublishAgentSelectiveRequestApplicationConfigTools()
                self.tools.append(temp_model.from_map(k1))

        self.work_flows = []
        if m.get('workFlows') is not None:
            for k1 in m.get('workFlows'):
                temp_model = main_models.UpdateAndPublishAgentSelectiveRequestApplicationConfigWorkFlows()
                self.work_flows.append(temp_model.from_map(k1))

        return self

class UpdateAndPublishAgentSelectiveRequestApplicationConfigWorkFlows(DaraModel):
    def __init__(
        self,
        type: str = None,
    ):
...
class UpdateAndPublishAgentSelectiveRequestApplicationConfigTools(DaraModel):
    def __init__(
        self,
        type: str = None,
    ):
...
class UpdateAndPublishAgentSelectiveRequestApplicationConfigSecurity(DaraModel):
    def __init__(
        self,
...
class UpdateAndPublishAgentSelectiveRequestApplicationConfigRagConfig(DaraModel):
    def __init__(
        self,
...
class UpdateAndPublishAgentSelectiveRequestApplicationConfigParameters(DaraModel):
    def __init__(
        self,
...
class UpdateAndPublishAgentSelectiveRequestApplicationConfigLongTermMemory(DaraModel):
    def __init__(
        self,
        enable: bool = None,
    ):
...
class UpdateAndPublishAgentSelectiveRequestApplicationConfigHistoryConfig(DaraModel):
    def __init__(
        self,

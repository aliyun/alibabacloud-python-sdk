...
class ListPublishedAgentResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ListPublishedAgentResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.ListPublishedAgentResponseBodyData()
...
class ListPublishedAgentResponseBodyData(DaraModel):
    def __init__(
        self,
        list: List[main_models.ListPublishedAgentResponseBodyDataList] = None,
        page_no: int = None,
        page_size: int = None,
        total: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('list') is not None:
            for k1 in m.get('list'):
                temp_model = main_models.ListPublishedAgentResponseBodyDataList()
...
class ListPublishedAgentResponseBodyDataList(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('applicationConfig') is not None:
            temp_model = main_models.ListPublishedAgentResponseBodyDataListApplicationConfig()
...
class ListPublishedAgentResponseBodyDataListApplicationConfig(DaraModel):
    def __init__(
        self,
        history_config: main_models.ListPublishedAgentResponseBodyDataListApplicationConfigHistoryConfig = None,
        long_term_memory: main_models.ListPublishedAgentResponseBodyDataListApplicationConfigLongTermMemory = None,
        parameters: main_models.ListPublishedAgentResponseBodyDataListApplicationConfigParameters = None,
        rag_config: main_models.ListPublishedAgentResponseBodyDataListApplicationConfigRagConfig = None,
        security: main_models.ListPublishedAgentResponseBodyDataListApplicationConfigSecurity = None,
        tools: List[main_models.ListPublishedAgentResponseBodyDataListApplicationConfigTools] = None,
        work_flows: List[main_models.ListPublishedAgentResponseBodyDataListApplicationConfigWorkFlows] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('historyConfig') is not None:
            temp_model = main_models.ListPublishedAgentResponseBodyDataListApplicationConfigHistoryConfig()
            self.history_config = temp_model.from_map(m.get('historyConfig'))

        if m.get('longTermMemory') is not None:
            temp_model = main_models.ListPublishedAgentResponseBodyDataListApplicationConfigLongTermMemory()
            self.long_term_memory = temp_model.from_map(m.get('longTermMemory'))

        if m.get('parameters') is not None:
            temp_model = main_models.ListPublishedAgentResponseBodyDataListApplicationConfigParameters()
            self.parameters = temp_model.from_map(m.get('parameters'))

        if m.get('ragConfig') is not None:
            temp_model = main_models.ListPublishedAgentResponseBodyDataListApplicationConfigRagConfig()
            self.rag_config = temp_model.from_map(m.get('ragConfig'))

        if m.get('security') is not None:
            temp_model = main_models.ListPublishedAgentResponseBodyDataListApplicationConfigSecurity()
            self.security = temp_model.from_map(m.get('security'))

        self.tools = []
        if m.get('tools') is not None:
            for k1 in m.get('tools'):
                temp_model = main_models.ListPublishedAgentResponseBodyDataListApplicationConfigTools()
                self.tools.append(temp_model.from_map(k1))

        self.work_flows = []
        if m.get('workFlows') is not None:
            for k1 in m.get('workFlows'):
                temp_model = main_models.ListPublishedAgentResponseBodyDataListApplicationConfigWorkFlows()
                self.work_flows.append(temp_model.from_map(k1))

        return self

class ListPublishedAgentResponseBodyDataListApplicationConfigWorkFlows(DaraModel):
    def __init__(
        self,
        type: str = None,
    ):
...
class ListPublishedAgentResponseBodyDataListApplicationConfigTools(DaraModel):
    def __init__(
        self,
        type: str = None,
    ):
...
class ListPublishedAgentResponseBodyDataListApplicationConfigSecurity(DaraModel):
    def __init__(
        self,
...
class ListPublishedAgentResponseBodyDataListApplicationConfigRagConfig(DaraModel):
    def __init__(
        self,
...
class ListPublishedAgentResponseBodyDataListApplicationConfigParameters(DaraModel):
    def __init__(
        self,
...
class ListPublishedAgentResponseBodyDataListApplicationConfigLongTermMemory(DaraModel):
    def __init__(
        self,
        enable: bool = None,
    ):
...
class ListPublishedAgentResponseBodyDataListApplicationConfigHistoryConfig(DaraModel):
    def __init__(
        self,

...
class UpdateAndPublishAgentRequest(DaraModel):
    def __init__(
        self,
        application_config: main_models.UpdateAndPublishAgentRequestApplicationConfig = None,
        instructions: str = None,
        model_id: str = None,
        name: str = None,
        sample_library: main_models.UpdateAndPublishAgentRequestSampleLibrary = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('applicationConfig') is not None:
            temp_model = main_models.UpdateAndPublishAgentRequestApplicationConfig()
        ...
        if m.get('sampleLibrary') is not None:
            temp_model = main_models.UpdateAndPublishAgentRequestSampleLibrary()
            self.sample_library = temp_model.from_map(m.get('sampleLibrary'))

        return self

class UpdateAndPublishAgentRequestSampleLibrary(DaraModel):
    def __init__(
        self,
...
class UpdateAndPublishAgentRequestApplicationConfig(DaraModel):
    def __init__(
        self,
        history_config: main_models.UpdateAndPublishAgentRequestApplicationConfigHistoryConfig = None,
        long_term_memory: main_models.UpdateAndPublishAgentRequestApplicationConfigLongTermMemory = None,
        parameters: main_models.UpdateAndPublishAgentRequestApplicationConfigParameters = None,
        rag_config: main_models.UpdateAndPublishAgentRequestApplicationConfigRagConfig = None,
        security: main_models.UpdateAndPublishAgentRequestApplicationConfigSecurity = None,
        tools: List[main_models.UpdateAndPublishAgentRequestApplicationConfigTools] = None,
        work_flows: List[main_models.UpdateAndPublishAgentRequestApplicationConfigWorkFlows] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('historyConfig') is not None:
            temp_model = main_models.UpdateAndPublishAgentRequestApplicationConfigHistoryConfig()
            self.history_config = temp_model.from_map(m.get('historyConfig'))

        if m.get('longTermMemory') is not None:
            temp_model = main_models.UpdateAndPublishAgentRequestApplicationConfigLongTermMemory()
            self.long_term_memory = temp_model.from_map(m.get('longTermMemory'))

        if m.get('parameters') is not None:
            temp_model = main_models.UpdateAndPublishAgentRequestApplicationConfigParameters()
            self.parameters = temp_model.from_map(m.get('parameters'))

        if m.get('ragConfig') is not None:
            temp_model = main_models.UpdateAndPublishAgentRequestApplicationConfigRagConfig()
            self.rag_config = temp_model.from_map(m.get('ragConfig'))

        if m.get('security') is not None:
            temp_model = main_models.UpdateAndPublishAgentRequestApplicationConfigSecurity()
            self.security = temp_model.from_map(m.get('security'))

        self.tools = []
        if m.get('tools') is not None:
            for k1 in m.get('tools'):
                temp_model = main_models.UpdateAndPublishAgentRequestApplicationConfigTools()
                self.tools.append(temp_model.from_map(k1))

        self.work_flows = []
        if m.get('workFlows') is not None:
            for k1 in m.get('workFlows'):
                temp_model = main_models.UpdateAndPublishAgentRequestApplicationConfigWorkFlows()
                self.work_flows.append(temp_model.from_map(k1))

        return self

class UpdateAndPublishAgentRequestApplicationConfigWorkFlows(DaraModel):
    def __init__(
        self,
        type: str = None,
    ):
...
class UpdateAndPublishAgentRequestApplicationConfigTools(DaraModel):
    def __init__(
        self,
        type: str = None,
    ):
...
class UpdateAndPublishAgentRequestApplicationConfigSecurity(DaraModel):
    def __init__(
        self,
...
class UpdateAndPublishAgentRequestApplicationConfigRagConfig(DaraModel):
    def __init__(
        self,
...
class UpdateAndPublishAgentRequestApplicationConfigParameters(DaraModel):
    def __init__(
        self,
...
class UpdateAndPublishAgentRequestApplicationConfigLongTermMemory(DaraModel):
    def __init__(
        self,
        enable: bool = None,
    ):
...
class UpdateAndPublishAgentRequestApplicationConfigHistoryConfig(DaraModel):
    def __init__(
        self,

...
class GetCertificateDetailResponseBody(DaraModel):
    def __init__(
        self,
        algorithm: str = None,
        cert_identifier: str = None,
        certificate_chain_list: List[main_models.GetCertificateDetailResponseBodyCertificateChainList] = None,
    ...
    def validate(self):
        if self.certificate_chain_list:
            for v1 in self.certificate_chain_list:
                 if v1:
                    v1.validate()
        if self.tags:
            for v1 in self.tags:
    ...
    def to_map(self):
        ...
        result['CertificateChainList'] = []
        if self.certificate_chain_list is not None:
            for k1 in self.certificate_chain_list:
                result['CertificateChainList'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        self.certificate_chain_list = []
        if m.get('CertificateChainList') is not None:
            for k1 in m.get('CertificateChainList'):
                temp_model = main_models.GetCertificateDetailResponseBodyCertificateChainList()
                self.certificate_chain_list.append(temp_model.from_map(k1))
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.GetCertificateDetailResponseBodyTags()
...
class GetCertificateDetailResponseBodyTags(DaraModel):
    def __init__(
        self,
        tag_key: str = None,
        tag_value: str = None,
...
class GetCertificateDetailResponseBodyCertificateChainList(DaraModel):
    def __init__(
        self,
        issuer: str = None,
        not_after: int = None,

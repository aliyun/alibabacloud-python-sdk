...
from alibabacloud_tea_rpc.client import (
    AioClient as AioRPCClient,
    Client as RPCClient,
)
...
class AioClient(Client, AioRPCClient):
    def __init__(
        self,
        config
    ):
    ...
    async def test_flow_strategy_01with_options(
        self,
        tmp: ft_20180713_models.TestFlowStrategy01Request,
        runtime: util_models.RuntimeOptions,
    ) -> ft_20180713_models.TestFlowStrategy01Response:
        ...
        if not UtilClient.is_unset(tmp.names):
            request.names_shrink = UtilClient.to_jsonstring(tmp.names)
        return ft_20180713_models.TestFlowStrategy01Response().from_map(
            await self.do_request('TestFlowStrategy01', 'HTTPS', 'PUT', '2018-07-13', 'AK', None, TeaCore.to_map(request), runtime)
        )

    async def test_flow_strategy_01(
        self,
        request: ft_20180713_models.TestFlowStrategy01Request,
    ) -> ft_20180713_models.TestFlowStrategy01Response:
        runtime = util_models.RuntimeOptions()
        return await self.test_flow_strategy_01with_options(request, runtime)

    async def test_http_api_with_options(
        self,
        tmp: ft_20180713_models.TestHttpApiRequest,
        runtime: util_models.RuntimeOptions,
    ) -> ft_20180713_models.TestHttpApiResponse:
        ...
        if not UtilClient.is_unset(tmp.other_param):
            request.other_param_shrink = UtilClient.to_jsonstring(tmp.other_param)
        return ft_20180713_models.TestHttpApiResponse().from_map(
            await self.do_request('TestHttpApi', 'HTTPS', 'POST', '2018-07-13', 'AK', None, TeaCore.to_map(request), runtime)
        )
    ...
    async def test_http_api(
        ...
        runtime = util_models.RuntimeOptions()
        return await self.test_http_api_with_options(request, runtime)

    async def batch_audit_test_01with_options(
        self,
        request: ft_20180713_models.BatchAuditTest01Request,
        runtime: util_models.RuntimeOptions,
    ) -> ft_20180713_models.BatchAuditTest01Response:
        UtilClient.validate_model(request)
        return ft_20180713_models.BatchAuditTest01Response().from_map(
            await self.do_request('BatchAuditTest01', 'HTTPS', 'POST', '2018-07-13', 'Anonymous', None, TeaCore.to_map(request), runtime)
        )

    async def batch_audit_test_01(
        self,
        request: ft_20180713_models.BatchAuditTest01Request,
    ) -> ft_20180713_models.BatchAuditTest01Response:
        runtime = util_models.RuntimeOptions()
        return await self.batch_audit_test_01with_options(request, runtime)

    async def ft_ip_flow_control_with_options(
        self,
        request: ft_20180713_models.FtIpFlowControlRequest,
        runtime: util_models.RuntimeOptions,
    ) -> ft_20180713_models.FtIpFlowControlResponse:
        UtilClient.validate_model(request)
        return ft_20180713_models.FtIpFlowControlResponse().from_map(
            await self.do_request('FtIpFlowControl', 'HTTPS', 'POST', '2018-07-13', 'Anonymous', None, TeaCore.to_map(request), runtime)
        )

    async def ft_ip_flow_control(
        self,
        request: ft_20180713_models.FtIpFlowControlRequest,
    ) -> ft_20180713_models.FtIpFlowControlResponse:
        runtime = util_models.RuntimeOptions()
        return await self.ft_ip_flow_control_with_options(request, runtime)

    async def ft_dynamic_address_dubbo_with_options(
        self,
        request: ft_20180713_models.FtDynamicAddressDubboRequest,
        runtime: util_models.RuntimeOptions,
    ) -> ft_20180713_models.FtDynamicAddressDubboResponse:
        UtilClient.validate_model(request)
        return ft_20180713_models.FtDynamicAddressDubboResponse().from_map(
            await self.do_request('FtDynamicAddressDubbo', 'HTTPS', 'POST', '2018-07-13', 'AK', None, TeaCore.to_map(request), runtime)
        )

    async def ft_dynamic_address_dubbo(
        self,
        request: ft_20180713_models.FtDynamicAddressDubboRequest,
    ) -> ft_20180713_models.FtDynamicAddressDubboResponse:
        runtime = util_models.RuntimeOptions()
        return await self.ft_dynamic_address_dubbo_with_options(request, runtime)

    async def ft_dynamic_address_hsf_with_options(
        self,
        request: ft_20180713_models.FtDynamicAddressHsfRequest,
        runtime: util_models.RuntimeOptions,
    ) -> ft_20180713_models.FtDynamicAddressHsfResponse:
        UtilClient.validate_model(request)
        return ft_20180713_models.FtDynamicAddressHsfResponse().from_map(
            await self.do_request('FtDynamicAddressHsf', 'HTTPS', 'POST', '2018-07-13', 'AK', None, TeaCore.to_map(request), runtime)
        )

    async def ft_dynamic_address_hsf(
        self,
        request: ft_20180713_models.FtDynamicAddressHsfRequest,
    ) -> ft_20180713_models.FtDynamicAddressHsfResponse:
        runtime = util_models.RuntimeOptions()
        return await self.ft_dynamic_address_hsf_with_options(request, runtime)

    async def ft_flow_special_with_options(
        self,
        request: ft_20180713_models.FtFlowSpecialRequest,
        runtime: util_models.RuntimeOptions,
    ) -> ft_20180713_models.FtFlowSpecialResponse:
        UtilClient.validate_model(request)
        return ft_20180713_models.FtFlowSpecialResponse().from_map(
            await self.do_request('FtFlowSpecial', 'HTTPS', 'POST', '2018-07-13', 'AK', None, TeaCore.to_map(request), runtime)
        )

    async def ft_flow_special(
        self,
        request: ft_20180713_models.FtFlowSpecialRequest,
    ) -> ft_20180713_models.FtFlowSpecialResponse:
        runtime = util_models.RuntimeOptions()
        return await self.ft_flow_special_with_options(request, runtime)

    async def ftapi_alias_api_with_options(
        self,
        request: ft_20180713_models.FTApiAliasApiRequest,
        runtime: util_models.RuntimeOptions,
    ) -> ft_20180713_models.FTApiAliasApiResponse:
        UtilClient.validate_model(request)
        return ft_20180713_models.FTApiAliasApiResponse().from_map(
            await self.do_request('FTApiAliasApi', 'HTTPS', 'POST', '2018-07-13', 'AK', None, TeaCore.to_map(request), runtime)
        )

    async def ftapi_alias_api(
        self,
        request: ft_20180713_models.FTApiAliasApiRequest,
    ) -> ft_20180713_models.FTApiAliasApiResponse:
        runtime = util_models.RuntimeOptions()
        return await self.ftapi_alias_api_with_options(request, runtime)

    async def ft_eagle_eye_with_options(
        self,
        request: ft_20180713_models.FtEagleEyeRequest,
        runtime: util_models.RuntimeOptions,
    ) -> ft_20180713_models.FtEagleEyeResponse:
        UtilClient.validate_model(request)
        return ft_20180713_models.FtEagleEyeResponse().from_map(
            await self.do_request('FtEagleEye', 'HTTPS', 'POST', '2018-07-13', 'AK', None, TeaCore.to_map(request), runtime)
        )

    async def ft_eagle_eye(
        self,
        request: ft_20180713_models.FtEagleEyeRequest,
    ) -> ft_20180713_models.FtEagleEyeResponse:
        runtime = util_models.RuntimeOptions()
        return await self.ft_eagle_eye_with_options(request, runtime)

    async def ft_param_list_with_options(
        self,
        request: ft_20180713_models.FtParamListRequest,
        runtime: util_models.RuntimeOptions,
    ) -> ft_20180713_models.FtParamListResponse:
        UtilClient.validate_model(request)
        return ft_20180713_models.FtParamListResponse().from_map(
            await self.do_request('FtParamList', 'HTTPS', 'POST', '2018-07-13', 'AK', None, TeaCore.to_map(request), runtime)
        )

    async def ft_param_list(
        self,
        request: ft_20180713_models.FtParamListRequest,
    ) -> ft_20180713_models.FtParamListResponse:
        runtime = util_models.RuntimeOptions()
        return await self.ft_param_list_with_options(request, runtime)

    async def ft_gated_launch_policy_4with_options(
        self,
        request: ft_20180713_models.FtGatedLaunchPolicy4Request,
        runtime: util_models.RuntimeOptions,
    ) -> ft_20180713_models.FtGatedLaunchPolicy4Response:
        UtilClient.validate_model(request)
        return ft_20180713_models.FtGatedLaunchPolicy4Response().from_map(
            await self.do_request('FtGatedLaunchPolicy4', 'HTTPS', 'POST', '2018-07-13', 'AK', None, TeaCore.to_map(request), runtime)
        )

    async def ft_gated_launch_policy_4(
        self,
        request: ft_20180713_models.FtGatedLaunchPolicy4Request,
    ) -> ft_20180713_models.FtGatedLaunchPolicy4Response:
        runtime = util_models.RuntimeOptions()
        return await self.ft_gated_launch_policy_4with_options(request, runtime)

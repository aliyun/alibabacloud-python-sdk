...
class ListDcdnKvResponseBody(DaraModel):
    def __init__(
        self,
        keys: List[main_models.ListDcdnKvResponseBodyKeys] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Keys') is not None:
            for k1 in m.get('Keys'):
                temp_model = main_models.ListDcdnKvResponseBodyKeys()
...
class ListDcdnKvResponseBodyKeys(DaraModel):
    def __init__(
        self,
        name: str = None,

...
class DescribeRDDomainConfigResponseBody(DaraModel):
    def __init__(
        self,
        domain_configs: List[main_models.DescribeRDDomainConfigResponseBodyDomainConfigs] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DomainConfigs') is not None:
            for k1 in m.get('DomainConfigs'):
                temp_model = main_models.DescribeRDDomainConfigResponseBodyDomainConfigs()
...
class DescribeRDDomainConfigResponseBodyDomainConfigs(DaraModel):
    def __init__(
        self,
        config_id: int = None,
        function_args: List[main_models.DescribeRDDomainConfigResponseBodyDomainConfigsFunctionArgs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FunctionArgs') is not None:
            for k1 in m.get('FunctionArgs'):
                temp_model = main_models.DescribeRDDomainConfigResponseBodyDomainConfigsFunctionArgs()
...
class DescribeRDDomainConfigResponseBodyDomainConfigsFunctionArgs(DaraModel):
    def __init__(
        self,
        arg_name: str = None,
        arg_value: str = None,

...
class DescribeDcdnUserResourcePackageResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        resource_package_infos: main_models.DescribeDcdnUserResourcePackageResponseBodyResourcePackageInfos = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourcePackageInfos') is not None:
            temp_model = main_models.DescribeDcdnUserResourcePackageResponseBodyResourcePackageInfos()
            self.resource_package_infos = temp_model.from_map(m.get('ResourcePackageInfos'))

        return self

class DescribeDcdnUserResourcePackageResponseBodyResourcePackageInfos(DaraModel):
    def __init__(
        self,
        resource_package_info: List[main_models.DescribeDcdnUserResourcePackageResponseBodyResourcePackageInfosResourcePackageInfo] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourcePackageInfo') is not None:
            for k1 in m.get('ResourcePackageInfo'):
                temp_model = main_models.DescribeDcdnUserResourcePackageResponseBodyResourcePackageInfosResourcePackageInfo()
                self.resource_package_info.append(temp_model.from_map(k1))

        return self

class DescribeDcdnUserResourcePackageResponseBodyResourcePackageInfosResourcePackageInfo(DaraModel):
    def __init__(
        self,

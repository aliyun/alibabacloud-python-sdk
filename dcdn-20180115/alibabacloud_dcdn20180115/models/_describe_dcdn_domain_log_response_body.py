...
class DescribeDcdnDomainLogResponseBody(DaraModel):
    def __init__(
        self,
        domain_log_details: main_models.DescribeDcdnDomainLogResponseBodyDomainLogDetails = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DomainLogDetails') is not None:
            temp_model = main_models.DescribeDcdnDomainLogResponseBodyDomainLogDetails()
...
class DescribeDcdnDomainLogResponseBodyDomainLogDetails(DaraModel):
    def __init__(
        self,
        domain_log_detail: List[main_models.DescribeDcdnDomainLogResponseBodyDomainLogDetailsDomainLogDetail] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DomainLogDetail') is not None:
            for k1 in m.get('DomainLogDetail'):
                temp_model = main_models.DescribeDcdnDomainLogResponseBodyDomainLogDetailsDomainLogDetail()
                self.domain_log_detail.append(temp_model.from_map(k1))

        return self

class DescribeDcdnDomainLogResponseBodyDomainLogDetailsDomainLogDetail(DaraModel):
    def __init__(
        self,
        log_count: int = None,
        log_infos: main_models.DescribeDcdnDomainLogResponseBodyDomainLogDetailsDomainLogDetailLogInfos = None,
        page_infos: main_models.DescribeDcdnDomainLogResponseBodyDomainLogDetailsDomainLogDetailPageInfos = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LogInfos') is not None:
            temp_model = main_models.DescribeDcdnDomainLogResponseBodyDomainLogDetailsDomainLogDetailLogInfos()
            self.log_infos = temp_model.from_map(m.get('LogInfos'))

        if m.get('PageInfos') is not None:
            temp_model = main_models.DescribeDcdnDomainLogResponseBodyDomainLogDetailsDomainLogDetailPageInfos()
            self.page_infos = temp_model.from_map(m.get('PageInfos'))

        return self

class DescribeDcdnDomainLogResponseBodyDomainLogDetailsDomainLogDetailPageInfos(DaraModel):
    def __init__(
        self,
        page_index: int = None,
        page_size: int = None,
...
class DescribeDcdnDomainLogResponseBodyDomainLogDetailsDomainLogDetailLogInfos(DaraModel):
    def __init__(
        self,
        log_info_detail: List[main_models.DescribeDcdnDomainLogResponseBodyDomainLogDetailsDomainLogDetailLogInfosLogInfoDetail] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LogInfoDetail') is not None:
            for k1 in m.get('LogInfoDetail'):
                temp_model = main_models.DescribeDcdnDomainLogResponseBodyDomainLogDetailsDomainLogDetailLogInfosLogInfoDetail()
                self.log_info_detail.append(temp_model.from_map(k1))

        return self

class DescribeDcdnDomainLogResponseBodyDomainLogDetailsDomainLogDetailLogInfosLogInfoDetail(DaraModel):
    def __init__(
        self,
        end_time: str = None,
        log_name: str = None,

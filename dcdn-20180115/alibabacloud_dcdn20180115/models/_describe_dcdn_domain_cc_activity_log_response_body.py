...
class DescribeDcdnDomainCcActivityLogResponseBody(DaraModel):
    def __init__(
        self,
        activity_log: List[main_models.DescribeDcdnDomainCcActivityLogResponseBodyActivityLog] = None,
        page_index: int = None,
        page_size: int = None,
        request_id: str = None,
        total: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ActivityLog') is not None:
            for k1 in m.get('ActivityLog'):
                temp_model = main_models.DescribeDcdnDomainCcActivityLogResponseBodyActivityLog()
...
class DescribeDcdnDomainCcActivityLogResponseBodyActivityLog(DaraModel):
    def __init__(
        self,
        action: str = None,

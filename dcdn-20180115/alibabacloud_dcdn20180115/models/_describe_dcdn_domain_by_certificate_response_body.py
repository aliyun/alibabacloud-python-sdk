...
class DescribeDcdnDomainByCertificateResponseBody(DaraModel):
    def __init__(
        self,
        cert_infos: main_models.DescribeDcdnDomainByCertificateResponseBodyCertInfos = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CertInfos') is not None:
            temp_model = main_models.DescribeDcdnDomainByCertificateResponseBodyCertInfos()
...
class DescribeDcdnDomainByCertificateResponseBodyCertInfos(DaraModel):
    def __init__(
        self,
        cert_info: List[main_models.DescribeDcdnDomainByCertificateResponseBodyCertInfosCertInfo] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CertInfo') is not None:
            for k1 in m.get('CertInfo'):
                temp_model = main_models.DescribeDcdnDomainByCertificateResponseBodyCertInfosCertInfo()
                self.cert_info.append(temp_model.from_map(k1))

        return self

class DescribeDcdnDomainByCertificateResponseBodyCertInfosCertInfo(DaraModel):
    def __init__(
        self,

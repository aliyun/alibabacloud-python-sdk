...
class DescribeRDDomainsResponseBody(DaraModel):
    def __init__(
        self,
        domains: main_models.DescribeRDDomainsResponseBodyDomains = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Domains') is not None:
            temp_model = main_models.DescribeRDDomainsResponseBodyDomains()
...
class DescribeRDDomainsResponseBodyDomains(DaraModel):
    def __init__(
        self,
        page_data: List[main_models.DescribeRDDomainsResponseBodyDomainsPageData] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PageData') is not None:
            for k1 in m.get('PageData'):
                temp_model = main_models.DescribeRDDomainsResponseBodyDomainsPageData()
                self.page_data.append(temp_model.from_map(k1))

        return self

class DescribeRDDomainsResponseBodyDomainsPageData(DaraModel):
    def __init__(
        self,
        biz_name: str = None,
        cname: str = None,
        ...
        sources: main_models.DescribeRDDomainsResponseBodyDomainsPageDataSources = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Sources') is not None:
            temp_model = main_models.DescribeRDDomainsResponseBodyDomainsPageDataSources()
...
class DescribeRDDomainsResponseBodyDomainsPageDataSources(DaraModel):
    def __init__(
        self,
        source: List[main_models.DescribeRDDomainsResponseBodyDomainsPageDataSourcesSource] = None,
    ):
        self.source = source
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Source') is not None:
            for k1 in m.get('Source'):
                temp_model = main_models.DescribeRDDomainsResponseBodyDomainsPageDataSourcesSource()
                self.source.append(temp_model.from_map(k1))

        return self

class DescribeRDDomainsResponseBodyDomainsPageDataSourcesSource(DaraModel):
    def __init__(
        self,
        content: str = None,
        port: int = None,

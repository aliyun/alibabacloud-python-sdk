...
class DescribeDcdnRefreshTasksResponseBody(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        request_id: str = None,
        tasks: main_models.DescribeDcdnRefreshTasksResponseBodyTasks = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tasks') is not None:
            temp_model = main_models.DescribeDcdnRefreshTasksResponseBodyTasks()
...
class DescribeDcdnRefreshTasksResponseBodyTasks(DaraModel):
    def __init__(
        self,
        task: List[main_models.DescribeDcdnRefreshTasksResponseBodyTasksTask] = None,
    ):
        self.task = task
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Task') is not None:
            for k1 in m.get('Task'):
                temp_model = main_models.DescribeDcdnRefreshTasksResponseBodyTasksTask()
                self.task.append(temp_model.from_map(k1))

        return self

class DescribeDcdnRefreshTasksResponseBodyTasksTask(DaraModel):
    def __init__(
        self,

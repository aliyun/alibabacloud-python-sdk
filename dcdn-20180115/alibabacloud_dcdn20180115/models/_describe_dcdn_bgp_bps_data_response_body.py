...
class DescribeDcdnBgpBpsDataResponseBody(DaraModel):
    def __init__(
        self,
        bgp_data_interval: List[main_models.DescribeDcdnBgpBpsDataResponseBodyBgpDataInterval] = None,
        end_time: str = None,
        request_id: str = None,
        start_time: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BgpDataInterval') is not None:
            for k1 in m.get('BgpDataInterval'):
                temp_model = main_models.DescribeDcdnBgpBpsDataResponseBodyBgpDataInterval()
...
class DescribeDcdnBgpBpsDataResponseBodyBgpDataInterval(DaraModel):
    def __init__(
        self,
        in_: float = None,
        out: float = None,

...
class DescribeDcdnBlockedRegionsResponseBody(DaraModel):
    def __init__(
        self,
        info_list: main_models.DescribeDcdnBlockedRegionsResponseBodyInfoList = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InfoList') is not None:
            temp_model = main_models.DescribeDcdnBlockedRegionsResponseBodyInfoList()
...
class DescribeDcdnBlockedRegionsResponseBodyInfoList(DaraModel):
    def __init__(
        self,
        info_item: List[main_models.DescribeDcdnBlockedRegionsResponseBodyInfoListInfoItem] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InfoItem') is not None:
            for k1 in m.get('InfoItem'):
                temp_model = main_models.DescribeDcdnBlockedRegionsResponseBodyInfoListInfoItem()
                self.info_item.append(temp_model.from_map(k1))

        return self

class DescribeDcdnBlockedRegionsResponseBodyInfoListInfoItem(DaraModel):
    def __init__(
        self,
        continent: str = None,

...
class DescribeDcdnHttpsDomainListResponseBody(DaraModel):
    def __init__(
        self,
        cert_infos: main_models.DescribeDcdnHttpsDomainListResponseBodyCertInfos = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CertInfos') is not None:
            temp_model = main_models.DescribeDcdnHttpsDomainListResponseBodyCertInfos()
...
class DescribeDcdnHttpsDomainListResponseBodyCertInfos(DaraModel):
    def __init__(
        self,
        cert_info: List[main_models.DescribeDcdnHttpsDomainListResponseBodyCertInfosCertInfo] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CertInfo') is not None:
            for k1 in m.get('CertInfo'):
                temp_model = main_models.DescribeDcdnHttpsDomainListResponseBodyCertInfosCertInfo()
                self.cert_info.append(temp_model.from_map(k1))

        return self

class DescribeDcdnHttpsDomainListResponseBodyCertInfosCertInfo(DaraModel):
    def __init__(
        self,

...
class DescribeDcdnWafDomainResponseBody(DaraModel):
    def __init__(
        self,
        out_put_domains: List[main_models.DescribeDcdnWafDomainResponseBodyOutPutDomains] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OutPutDomains') is not None:
            for k1 in m.get('OutPutDomains'):
                temp_model = main_models.DescribeDcdnWafDomainResponseBodyOutPutDomains()
...
class DescribeDcdnWafDomainResponseBodyOutPutDomains(DaraModel):
    def __init__(
        self,
        acl_status: int = None,
        cc_status: int = None,

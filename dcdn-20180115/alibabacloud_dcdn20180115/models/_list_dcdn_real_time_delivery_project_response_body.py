...
class ListDcdnRealTimeDeliveryProjectResponseBody(DaraModel):
    def __init__(
        self,
        content: main_models.ListDcdnRealTimeDeliveryProjectResponseBodyContent = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Content') is not None:
            temp_model = main_models.ListDcdnRealTimeDeliveryProjectResponseBodyContent()
...
class ListDcdnRealTimeDeliveryProjectResponseBodyContent(DaraModel):
    def __init__(
        self,
        projects: List[main_models.ListDcdnRealTimeDeliveryProjectResponseBodyContentProjects] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Projects') is not None:
            for k1 in m.get('Projects'):
                temp_model = main_models.ListDcdnRealTimeDeliveryProjectResponseBodyContentProjects()
                self.projects.append(temp_model.from_map(k1))

        return self

class ListDcdnRealTimeDeliveryProjectResponseBodyContentProjects(DaraModel):
    def __init__(
        self,

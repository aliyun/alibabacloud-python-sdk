...
class DescribeDcdnDomainIpaTrafficDataResponseBody(DaraModel):
    def __init__(
        self,
        ...
        request_id: str = None,
        start_time: str = None,
        traffic_data_per_interval: main_models.DescribeDcdnDomainIpaTrafficDataResponseBodyTrafficDataPerInterval = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TrafficDataPerInterval') is not None:
            temp_model = main_models.DescribeDcdnDomainIpaTrafficDataResponseBodyTrafficDataPerInterval()
            self.traffic_data_per_interval = temp_model.from_map(m.get('TrafficDataPerInterval'))

        return self

class DescribeDcdnDomainIpaTrafficDataResponseBodyTrafficDataPerInterval(DaraModel):
    def __init__(
        self,
        data_module: List[main_models.DescribeDcdnDomainIpaTrafficDataResponseBodyTrafficDataPerIntervalDataModule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataModule') is not None:
            for k1 in m.get('DataModule'):
                temp_model = main_models.DescribeDcdnDomainIpaTrafficDataResponseBodyTrafficDataPerIntervalDataModule()
                self.data_module.append(temp_model.from_map(k1))

        return self

class DescribeDcdnDomainIpaTrafficDataResponseBodyTrafficDataPerIntervalDataModule(DaraModel):
    def __init__(
        self,

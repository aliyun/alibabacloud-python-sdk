...
class DescribeDcdnDomainWebsocketBpsDataResponseBody(DaraModel):
    def __init__(
        self,
        bps_data_per_interval: main_models.DescribeDcdnDomainWebsocketBpsDataResponseBodyBpsDataPerInterval = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BpsDataPerInterval') is not None:
            temp_model = main_models.DescribeDcdnDomainWebsocketBpsDataResponseBodyBpsDataPerInterval()
...
class DescribeDcdnDomainWebsocketBpsDataResponseBodyBpsDataPerInterval(DaraModel):
    def __init__(
        self,
        data_module: List[main_models.DescribeDcdnDomainWebsocketBpsDataResponseBodyBpsDataPerIntervalDataModule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataModule') is not None:
            for k1 in m.get('DataModule'):
                temp_model = main_models.DescribeDcdnDomainWebsocketBpsDataResponseBodyBpsDataPerIntervalDataModule()
                self.data_module.append(temp_model.from_map(k1))

        return self

class DescribeDcdnDomainWebsocketBpsDataResponseBodyBpsDataPerIntervalDataModule(DaraModel):
    def __init__(
        self,
        time_stamp: str = None,

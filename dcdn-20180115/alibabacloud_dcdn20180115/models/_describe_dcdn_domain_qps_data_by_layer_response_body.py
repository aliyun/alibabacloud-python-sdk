...
class DescribeDcdnDomainQpsDataByLayerResponseBody(DaraModel):
    def __init__(
        self,
        ...
        end_time: str = None,
        layer: str = None,
        qps_data_interval: main_models.DescribeDcdnDomainQpsDataByLayerResponseBodyQpsDataInterval = None,
        request_id: str = None,
        start_time: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('QpsDataInterval') is not None:
            temp_model = main_models.DescribeDcdnDomainQpsDataByLayerResponseBodyQpsDataInterval()
...
class DescribeDcdnDomainQpsDataByLayerResponseBodyQpsDataInterval(DaraModel):
    def __init__(
        self,
        data_module: List[main_models.DescribeDcdnDomainQpsDataByLayerResponseBodyQpsDataIntervalDataModule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataModule') is not None:
            for k1 in m.get('DataModule'):
                temp_model = main_models.DescribeDcdnDomainQpsDataByLayerResponseBodyQpsDataIntervalDataModule()
                self.data_module.append(temp_model.from_map(k1))

        return self

class DescribeDcdnDomainQpsDataByLayerResponseBodyQpsDataIntervalDataModule(DaraModel):
    def __init__(
        self,

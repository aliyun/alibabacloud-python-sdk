...
class DescribeDcdnTopDomainsByFlowResponseBody(DaraModel):
    def __init__(
        self,
        ...
        request_id: str = None,
        start_time: str = None,
        top_domains: main_models.DescribeDcdnTopDomainsByFlowResponseBodyTopDomains = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TopDomains') is not None:
            temp_model = main_models.DescribeDcdnTopDomainsByFlowResponseBodyTopDomains()
            self.top_domains = temp_model.from_map(m.get('TopDomains'))

        return self

class DescribeDcdnTopDomainsByFlowResponseBodyTopDomains(DaraModel):
    def __init__(
        self,
        top_domain: List[main_models.DescribeDcdnTopDomainsByFlowResponseBodyTopDomainsTopDomain] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TopDomain') is not None:
            for k1 in m.get('TopDomain'):
                temp_model = main_models.DescribeDcdnTopDomainsByFlowResponseBodyTopDomainsTopDomain()
                self.top_domain.append(temp_model.from_map(k1))

        return self

class DescribeDcdnTopDomainsByFlowResponseBodyTopDomainsTopDomain(DaraModel):
    def __init__(
        self,

...
class BatchPutDcdnKvRequest(DaraModel):
    def __init__(
        self,
        kv_list: List[main_models.BatchPutDcdnKvRequestKvList] = None,
        namespace: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('KvList') is not None:
            for k1 in m.get('KvList'):
                temp_model = main_models.BatchPutDcdnKvRequestKvList()
...
class BatchPutDcdnKvRequestKvList(DaraModel):
    def __init__(
        self,
        expiration: int = None,

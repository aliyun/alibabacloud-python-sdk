...
class DescribeDcdnDomainTopReferVisitResponseBody(DaraModel):
    def __init__(
        self,
        domain_name: str = None,
        request_id: str = None,
        start_time: str = None,
        top_refer_list: main_models.DescribeDcdnDomainTopReferVisitResponseBodyTopReferList = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TopReferList') is not None:
            temp_model = main_models.DescribeDcdnDomainTopReferVisitResponseBodyTopReferList()
            self.top_refer_list = temp_model.from_map(m.get('TopReferList'))

        return self

class DescribeDcdnDomainTopReferVisitResponseBodyTopReferList(DaraModel):
    def __init__(
        self,
        refer_list: List[main_models.DescribeDcdnDomainTopReferVisitResponseBodyTopReferListReferList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ReferList') is not None:
            for k1 in m.get('ReferList'):
                temp_model = main_models.DescribeDcdnDomainTopReferVisitResponseBodyTopReferListReferList()
                self.refer_list.append(temp_model.from_map(k1))

        return self

class DescribeDcdnDomainTopReferVisitResponseBodyTopReferListReferList(DaraModel):
    def __init__(
        self,
        flow: str = None,

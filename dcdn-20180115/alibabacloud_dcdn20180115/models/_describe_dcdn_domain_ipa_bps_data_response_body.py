...
class DescribeDcdnDomainIpaBpsDataResponseBody(DaraModel):
    def __init__(
        self,
        bps_data_per_interval: main_models.DescribeDcdnDomainIpaBpsDataResponseBodyBpsDataPerInterval = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BpsDataPerInterval') is not None:
            temp_model = main_models.DescribeDcdnDomainIpaBpsDataResponseBodyBpsDataPerInterval()
...
class DescribeDcdnDomainIpaBpsDataResponseBodyBpsDataPerInterval(DaraModel):
    def __init__(
        self,
        data_module: List[main_models.DescribeDcdnDomainIpaBpsDataResponseBodyBpsDataPerIntervalDataModule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataModule') is not None:
            for k1 in m.get('DataModule'):
                temp_model = main_models.DescribeDcdnDomainIpaBpsDataResponseBodyBpsDataPerIntervalDataModule()
                self.data_module.append(temp_model.from_map(k1))

        return self

class DescribeDcdnDomainIpaBpsDataResponseBodyBpsDataPerIntervalDataModule(DaraModel):
    def __init__(
        self,
        ipa_bps: float = None,
        time_stamp: str = None,

...
## Alibaba Cloud dcdn SDK for Python
...
```bash
# 安装 alibabacloud_dcdn20180115
pip install alibabacloud_dcdn20180115
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/dcdn-20180115/ChangeLog.md)中。

...
class DescribeComponentResponseBody(DaraModel):
    def __init__(
        self,
        ...
        request_id: str = None,
        template: main_models.DescribeComponentResponseBodyTemplate = None,
        user_id: str = None,
        uuid: str = None,
        version: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Template') is not None:
            temp_model = main_models.DescribeComponentResponseBodyTemplate()
...
class DescribeComponentResponseBodyTemplate(DaraModel):
    def __init__(
        self,
        type: str = None,
        uri: str = None,

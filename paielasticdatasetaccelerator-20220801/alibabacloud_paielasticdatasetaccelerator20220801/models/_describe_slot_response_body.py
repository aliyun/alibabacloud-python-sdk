...
class DescribeSlotResponseBody(DaraModel):
    def __init__(
        self,
        capacity: str = None,
        ...
        tags: List[main_models.DescribeSlotResponseBodyTags] = None,
        user_id: str = None,
        uuid: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.DescribeSlotResponseBodyTags()
...
class DescribeSlotResponseBodyTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

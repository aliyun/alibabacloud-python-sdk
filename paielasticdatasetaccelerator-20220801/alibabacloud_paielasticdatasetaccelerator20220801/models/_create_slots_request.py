...
class CreateSlotsRequest(DaraModel):
    def __init__(
        self,
        dry_run: bool = None,
        slots: List[main_models.CreateSlotsRequestSlots] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Slots') is not None:
            for k1 in m.get('Slots'):
                temp_model = main_models.CreateSlotsRequestSlots()
                self.slots.append(temp_model.from_map(k1))

        return self

class CreateSlotsRequestSlots(DaraModel):
    def __init__(
        self,
        capacity: str = None,
        ...
        tags: List[main_models.CreateSlotsRequestSlotsTags] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.CreateSlotsRequestSlotsTags()
                self.tags.append(temp_model.from_map(k1))

        return self

class CreateSlotsRequestSlotsTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

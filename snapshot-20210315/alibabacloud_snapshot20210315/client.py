...
class Client(OpenApiClient):
    ...
    *\
    ...
    def get_snapshot_info(
        self,
        request: snapshot_20210315_models.GetSnapshotInfoRequest,
    ...
    def get_snapshot_block(
        self,
        request: snapshot_20210315_models.GetSnapshotBlockRequest,
    ) -> snapshot_20210315_models.GetSnapshotBlockResponse:
        runtime = util_models.RuntimeOptions()
        headers = {}
    ...
    def get_snapshot_block_with_options(
        ...
        tmp = UtilClient.assert_as_map(self.do_roarequest('GetSnapshotBlock', '2021-03-15', 'HTTPS', 'GET', 'AK', f'/snapshots/block', 'binary', req, runtime))
    ...
    async def get_snapshot_block_with_options_async(
        ...
        res = snapshot_20210315_models.GetSnapshotBlockResponse()
        tmp = UtilClient.assert_as_map(await self.do_roarequest_async('GetSnapshotBlock', '2021-03-15', 'HTTPS', 'GET', 'AK', f'/snapshots/block', 'binary', req, runtime))
        if not UtilClient.is_unset(tmp.get('body')):
            resp_body = UtilClient.assert_as_readable(tmp.get('body'))
            res.body = resp_body
        if not UtilClient.is_unset(tmp.get('headers')):
    ...
    def list_snapshot_blocks(
        self,
        request: snapshot_20210315_models.ListSnapshotBlocksRequest,
    ...
    def list_changed_blocks(
        self,
        request: snapshot_20210315_models.ListChangedBlocksRequest,

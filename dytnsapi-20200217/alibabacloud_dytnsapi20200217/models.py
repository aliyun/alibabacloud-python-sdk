...
class QueryPhoneNumberAttributeRequest(TeaModel):
    def __init__(
        self,
        owner_id: int = None,
        resource_owner_account: str = None,
...
class QueryPhoneNumberAttributeResponseBodyPhoneNumberAttribute(TeaModel):
    def __init__(
        self,
...
class QueryPhoneNumberAttributeResponseBody(TeaModel):
    def __init__(
        self,
        message: str = None,
        request_id: str = None,
        phone_number_attribute: QueryPhoneNumberAttributeResponseBodyPhoneNumberAttribute = None,
        code: str = None,
    ):
        self.message = message
        self.request_id = request_id
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PhoneNumberAttribute') is not None:
            temp_model = QueryPhoneNumberAttributeResponseBodyPhoneNumberAttribute()
...
class QueryPhoneNumberAttributeResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        body: QueryPhoneNumberAttributeResponseBody = None,
    ):
        self.headers = headers
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('headers') is not None:
            self.headers = m.get('headers')
        if m.get('body') is not None:
            temp_model = QueryPhoneNumberAttributeResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

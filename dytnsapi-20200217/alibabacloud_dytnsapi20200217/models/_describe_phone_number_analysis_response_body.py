...
class DescribePhoneNumberAnalysisResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: str = None,
        data: main_models.DescribePhoneNumberAnalysisResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DescribePhoneNumberAnalysisResponseBodyData()
...
class DescribePhoneNumberAnalysisResponseBodyData(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            for k1 in m.get('List'):
                temp_model = main_models.DescribePhoneNumberAnalysisResponseBodyDataList()
                self.list.append(temp_model.from_map(k1))

        return self

class DescribePhoneNumberAnalysisResponseBodyDataList(DaraModel):
    def __init__(
        self,
        code: str = None,
        number: str = None,

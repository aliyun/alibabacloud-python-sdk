...
class PhoneNumberStatusForVoiceResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.PhoneNumberStatusForVoiceResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.PhoneNumberStatusForVoiceResponseBodyData()
...
class PhoneNumberStatusForVoiceResponseBodyData(DaraModel):
    def __init__(
        self,
        carrier: str = None,
        status: str = None,

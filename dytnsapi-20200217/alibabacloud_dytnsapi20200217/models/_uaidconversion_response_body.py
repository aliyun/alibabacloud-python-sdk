...
class UAIDConversionResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: str = None,
        message: str = None,
        model: main_models.UAIDConversionResponseBodyModel = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Model') is not None:
            temp_model = main_models.UAIDConversionResponseBodyModel()
...
class UAIDConversionResponseBodyModel(DaraModel):
    def __init__(
        self,
        phone_list: str = None,
    ):

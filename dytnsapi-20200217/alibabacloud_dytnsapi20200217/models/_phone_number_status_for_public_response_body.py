...
class PhoneNumberStatusForPublicResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.PhoneNumberStatusForPublicResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.PhoneNumberStatusForPublicResponseBodyData()
...
class PhoneNumberStatusForPublicResponseBodyData(DaraModel):
    def __init__(
        self,
        carrier: str = None,
        status: str = None,

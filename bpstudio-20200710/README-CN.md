...
## Alibaba Cloud BPStudio SDK for Python
...
```bash
# 安装 alibabacloud_bpstudio20200710
pip install alibabacloud_bpstudio20200710
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/bpstudio-20200710/ChangeLog.md)中。

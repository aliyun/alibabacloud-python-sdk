...
```bash
# 安装 alibabacloud_imageprocess20200320
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/imageprocess-20200320/ChangeLog.md)中。

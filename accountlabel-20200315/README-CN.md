...
## Alibaba Cloud AccountLabel SDK for Python
...
```bash
# 安装 alibabacloud_accountlabel20200315
pip install alibabacloud_accountlabel20200315
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/accountlabel-20200315/ChangeLog.md)中。

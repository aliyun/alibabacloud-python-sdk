...
class AddRdMemberListRequest(DaraModel):
    def __init__(
        self,
        member_list: List[main_models.AddRdMemberListRequestMemberList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MemberList') is not None:
            for k1 in m.get('MemberList'):
                temp_model = main_models.AddRdMemberListRequestMemberList()
...
class AddRdMemberListRequestMemberList(DaraModel):
    def __init__(
        self,
        uid: str = None,
    ):

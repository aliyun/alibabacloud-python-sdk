...
class ModifyPolicyRequest(DaraModel):
    def __init__(
        ...
        content: main_models.ModifyPolicyRequestContent = None,
        id: str = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Content') is not None:
            temp_model = main_models.ModifyPolicyRequestContent()
...
class ModifyPolicyRequestContent(DaraModel):
    def __init__(
        self,
        ...
        finger_print_rule_list: List[main_models.ModifyPolicyRequestContentFingerPrintRuleList] = None,
        intelligence_level: str = None,
        l_4rule_list: List[main_models.ModifyPolicyRequestContentL4RuleList] = None,
        port_rule_list: List[main_models.ModifyPolicyRequestContentPortRuleList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FingerPrintRuleList') is not None:
            for k1 in m.get('FingerPrintRuleList'):
                temp_model = main_models.ModifyPolicyRequestContentFingerPrintRuleList()
        ...
        if m.get('L4RuleList') is not None:
            for k1 in m.get('L4RuleList'):
                temp_model = main_models.ModifyPolicyRequestContentL4RuleList()
                self.l_4rule_list.append(temp_model.from_map(k1))

        self.port_rule_list = []
        if m.get('PortRuleList') is not None:
            for k1 in m.get('PortRuleList'):
                temp_model = main_models.ModifyPolicyRequestContentPortRuleList()
        ...
        if m.get('SourceBlockList') is not None:
            for k1 in m.get('SourceBlockList'):
                temp_model = main_models.ModifyPolicyRequestContentSourceBlockList()
                self.source_block_list.append(temp_model.from_map(k1))

        if m.get('SourceLimit') is not None:
            temp_model = main_models.ModifyPolicyRequestContentSourceLimit()
...
class ModifyPolicyRequestContentSourceLimit(DaraModel):
    def __init__(
        self,
        bps: int = None,
        pps: int = None,
...
class ModifyPolicyRequestContentSourceBlockList(DaraModel):
    def __init__(
        self,
...
class ModifyPolicyRequestContentL4RuleList(DaraModel):
    def __init__(
        self,
        action: str = None,
        condition_list: List[main_models.ModifyPolicyRequestContentL4RuleListConditionList] = None,
        limited: int = None,
        match: str = None,
        method: str = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConditionList') is not None:
            for k1 in m.get('ConditionList'):
                temp_model = main_models.ModifyPolicyRequestContentL4RuleListConditionList()
...
class ModifyPolicyRequestContentL4RuleListConditionList(DaraModel):
    def __init__(
        self,
        arg: str = None,
        content: str = None,
        depth: int = None,
        encode: str = None,
        offset: main_models.ModifyPolicyRequestContentL4RuleListConditionListOffset = None,
        pattern: str = None,
        position: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Offset') is not None:
            temp_model = main_models.ModifyPolicyRequestContentL4RuleListConditionListOffset()
...
class ModifyPolicyRequestContentL4RuleListConditionListOffset(DaraModel):
    def __init__(
        self,
        end: int = None,
        start: int = None,

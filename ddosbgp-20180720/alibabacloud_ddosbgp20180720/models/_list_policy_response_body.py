...
class ListPolicyResponseBodyPolicyListContent(DaraModel):
    def __init__(
        ...
        sip_defense: main_models.ListPolicyResponseBodyPolicyListContentSipDefense = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SipDefense') is not None:
            temp_model = main_models.ListPolicyResponseBodyPolicyListContentSipDefense()
...
class ListPolicyResponseBodyPolicyListContentSipDefense(DaraModel):
    def __init__(
        self,
        enable: bool = None,
        level: str = None,

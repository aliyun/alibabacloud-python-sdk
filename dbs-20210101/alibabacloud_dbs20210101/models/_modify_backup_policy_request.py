...
class ModifyBackupPolicyRequest(DaraModel):
    def __init__(
        self,
        advance_data_policies: List[main_models.ModifyBackupPolicyRequestAdvanceDataPolicies] = None,
        advance_inc_policies: List[main_models.ModifyBackupPolicyRequestAdvanceIncPolicies] = None,
        advance_log_policies: List[main_models.ModifyBackupPolicyRequestAdvanceLogPolicies] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AdvanceDataPolicies') is not None:
            for k1 in m.get('AdvanceDataPolicies'):
                temp_model = main_models.ModifyBackupPolicyRequestAdvanceDataPolicies()
        ...
        if m.get('AdvanceIncPolicies') is not None:
            for k1 in m.get('AdvanceIncPolicies'):
                temp_model = main_models.ModifyBackupPolicyRequestAdvanceIncPolicies()
        ...
        if m.get('AdvanceLogPolicies') is not None:
            for k1 in m.get('AdvanceLogPolicies'):
                temp_model = main_models.ModifyBackupPolicyRequestAdvanceLogPolicies()
...
class ModifyBackupPolicyRequestAdvanceLogPolicies(DaraModel):
    def __init__(
        self,
...
class ModifyBackupPolicyRequestAdvanceIncPolicies(DaraModel):
    def __init__(
        self,
        action_type: str = None,
        dest_region: str = None,
...
class ModifyBackupPolicyRequestAdvanceDataPolicies(DaraModel):
    def __init__(
        self,
        action_type: str = None,
        dest_region: str = None,

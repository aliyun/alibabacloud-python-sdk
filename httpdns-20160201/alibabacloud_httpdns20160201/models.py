...
class RefreshResolveCacheRequest(TeaModel):
    def __init__(
        self,
...
class RefreshResolveCacheShrinkRequest(TeaModel):
    def __init__(
        self,
...
class RefreshResolveCacheResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
...
class RefreshResolveCacheResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: RefreshResolveCacheResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = RefreshResolveCacheResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

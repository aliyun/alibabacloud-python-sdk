...
class CreateWorkloadIdentityResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        workload_identity: main_models.CreateWorkloadIdentityResponseBodyWorkloadIdentity = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('WorkloadIdentity') is not None:
            temp_model = main_models.CreateWorkloadIdentityResponseBodyWorkloadIdentity()
            self.workload_identity = temp_model.from_map(m.get('WorkloadIdentity'))

        return self

class CreateWorkloadIdentityResponseBodyWorkloadIdentity(DaraModel):
    def __init__(
        self,

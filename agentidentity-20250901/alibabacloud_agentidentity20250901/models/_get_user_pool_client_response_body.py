...
class GetUserPoolClientResponseBody(DaraModel):
    def __init__(
        self,
        client: main_models.GetUserPoolClientResponseBodyClient = None,
        request_id: str = None,
    ):
        self.client = client
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Client') is not None:
            temp_model = main_models.GetUserPoolClientResponseBodyClient()
...
class GetUserPoolClientResponseBodyClient(DaraModel):
    def __init__(
        self,
        access_token_validity: str = None,
        client_id: str = None,
        client_name: str = None,
        client_scopes: List[main_models.GetUserPoolClientResponseBodyClientClientScopes] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ClientScopes') is not None:
            for k1 in m.get('ClientScopes'):
                temp_model = main_models.GetUserPoolClientResponseBodyClientClientScopes()
...
class GetUserPoolClientResponseBodyClientClientScopes(DaraModel):
    def __init__(
        self,

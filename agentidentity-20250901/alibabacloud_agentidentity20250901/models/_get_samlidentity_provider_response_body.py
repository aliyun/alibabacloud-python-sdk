...
class GetSAMLIdentityProviderResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        ssoidentity_provider_configuration: main_models.GetSAMLIdentityProviderResponseBodySSOIdentityProviderConfiguration = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SSOIdentityProviderConfiguration') is not None:
            temp_model = main_models.GetSAMLIdentityProviderResponseBodySSOIdentityProviderConfiguration()
            self.ssoidentity_provider_configuration = temp_model.from_map(m.get('SSOIdentityProviderConfiguration'))

        return self

class GetSAMLIdentityProviderResponseBodySSOIdentityProviderConfiguration(DaraModel):
    def __init__(
        self,
        entity_id: str = None,
        ...
        ssostatus: str = None,
        x_509certificates: List[main_models.GetSAMLIdentityProviderResponseBodySSOIdentityProviderConfigurationX509Certificates] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('X509Certificates') is not None:
            for k1 in m.get('X509Certificates'):
                temp_model = main_models.GetSAMLIdentityProviderResponseBodySSOIdentityProviderConfigurationX509Certificates()
                self.x_509certificates.append(temp_model.from_map(k1))

        return self

class GetSAMLIdentityProviderResponseBodySSOIdentityProviderConfigurationX509Certificates(DaraModel):
    def __init__(
        self,

...
class CreateUserPoolClientResponseBody(DaraModel):
    def __init__(
        self,
        client: main_models.CreateUserPoolClientResponseBodyClient = None,
        request_id: str = None,
    ):
        self.client = client
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Client') is not None:
            temp_model = main_models.CreateUserPoolClientResponseBodyClient()
...
class CreateUserPoolClientResponseBodyClient(DaraModel):
    def __init__(
        self,
...
class CreateUserPoolClientResponseBodyClientClientScopes(DaraModel):
    def __init__(
        self,

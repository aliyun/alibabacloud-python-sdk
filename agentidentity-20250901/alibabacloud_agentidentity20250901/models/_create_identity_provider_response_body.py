...
class CreateIdentityProviderResponseBody(DaraModel):
    def __init__(
        self,
        identity_provider: main_models.CreateIdentityProviderResponseBodyIdentityProvider = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IdentityProvider') is not None:
            temp_model = main_models.CreateIdentityProviderResponseBodyIdentityProvider()
...
class CreateIdentityProviderResponseBodyIdentityProvider(DaraModel):
    def __init__(
        self,

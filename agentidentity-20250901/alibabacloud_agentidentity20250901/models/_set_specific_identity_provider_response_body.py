...
class SetSpecificIdentityProviderResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        specific_identity_provider_configuration: main_models.SetSpecificIdentityProviderResponseBodySpecificIdentityProviderConfiguration = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SpecificIdentityProviderConfiguration') is not None:
            temp_model = main_models.SetSpecificIdentityProviderResponseBodySpecificIdentityProviderConfiguration()
            self.specific_identity_provider_configuration = temp_model.from_map(m.get('SpecificIdentityProviderConfiguration'))

        return self

class SetSpecificIdentityProviderResponseBodySpecificIdentityProviderConfiguration(DaraModel):
    def __init__(
        self,

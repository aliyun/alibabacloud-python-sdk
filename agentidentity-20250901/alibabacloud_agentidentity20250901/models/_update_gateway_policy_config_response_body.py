...
class UpdateGatewayPolicyConfigResponseBody(DaraModel):
    def __init__(
        self,
        gateway_policy_config: main_models.UpdateGatewayPolicyConfigResponseBodyGatewayPolicyConfig = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('GatewayPolicyConfig') is not None:
            temp_model = main_models.UpdateGatewayPolicyConfigResponseBodyGatewayPolicyConfig()
...
class UpdateGatewayPolicyConfigResponseBodyGatewayPolicyConfig(DaraModel):
    def __init__(
        self,

...
class UpdateUserPoolClientShrinkRequest(DaraModel):
    def __init__(
        self,
        access_token_validity: str = None,
        client_name: str = None,
        enforce_pkce: bool = None,
        redirect_uris_shrink: str = None,
        ...
        self.redirect_uris_shrink = redirect_uris_shrink
    ...
    def to_map(self):
        ...
        if self.redirect_uris_shrink is not None:
            result['RedirectURIs'] = self.redirect_uris_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RedirectURIs') is not None:
            self.redirect_uris_shrink = m.get('RedirectURIs')

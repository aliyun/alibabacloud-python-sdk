...
class GetOAuth2CredentialProviderResponseBody(DaraModel):
    def __init__(
        self,
        oauth2_credential_provider: main_models.GetOAuth2CredentialProviderResponseBodyOAuth2CredentialProvider = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OAuth2CredentialProvider') is not None:
            temp_model = main_models.GetOAuth2CredentialProviderResponseBodyOAuth2CredentialProvider()
...
class GetOAuth2CredentialProviderResponseBodyOAuth2CredentialProvider(DaraModel):
    def __init__(
        self,

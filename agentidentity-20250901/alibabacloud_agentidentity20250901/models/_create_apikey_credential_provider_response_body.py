...
class CreateAPIKeyCredentialProviderResponseBody(DaraModel):
    def __init__(
        self,
        apikey_credential_provider: main_models.CreateAPIKeyCredentialProviderResponseBodyAPIKeyCredentialProvider = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('APIKeyCredentialProvider') is not None:
            temp_model = main_models.CreateAPIKeyCredentialProviderResponseBodyAPIKeyCredentialProvider()
...
class CreateAPIKeyCredentialProviderResponseBodyAPIKeyCredentialProvider(DaraModel):
    def __init__(
        self,

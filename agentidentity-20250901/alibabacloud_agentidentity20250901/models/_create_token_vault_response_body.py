...
class CreateTokenVaultResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        token_vault: main_models.CreateTokenVaultResponseBodyTokenVault = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TokenVault') is not None:
            temp_model = main_models.CreateTokenVaultResponseBodyTokenVault()
            self.token_vault = temp_model.from_map(m.get('TokenVault'))

        return self

class CreateTokenVaultResponseBodyTokenVault(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        description: str = None,
        encryption_config: main_models.CreateTokenVaultResponseBodyTokenVaultEncryptionConfig = None,
        role_arn: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EncryptionConfig') is not None:
            temp_model = main_models.CreateTokenVaultResponseBodyTokenVaultEncryptionConfig()
...
class CreateTokenVaultResponseBodyTokenVaultEncryptionConfig(DaraModel):
    def __init__(
        self,
        key_type: str = None,

...
class CreateUserPoolResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        user_pool: main_models.CreateUserPoolResponseBodyUserPool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserPool') is not None:
            temp_model = main_models.CreateUserPoolResponseBodyUserPool()
            self.user_pool = temp_model.from_map(m.get('UserPool'))

        return self

class CreateUserPoolResponseBodyUserPool(DaraModel):
    def __init__(
        self,

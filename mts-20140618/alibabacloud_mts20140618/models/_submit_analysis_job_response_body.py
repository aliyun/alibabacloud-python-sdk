...
class SubmitAnalysisJobResponseBody(DaraModel):
    def __init__(
        self,
        analysis_job: main_models.SubmitAnalysisJobResponseBodyAnalysisJob = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AnalysisJob') is not None:
            temp_model = main_models.SubmitAnalysisJobResponseBodyAnalysisJob()
            self.analysis_job = temp_model.from_map(m.get('AnalysisJob'))
...
class SubmitAnalysisJobResponseBodyAnalysisJob(DaraModel):
    def __init__(
        self,
        analysis_config: main_models.SubmitAnalysisJobResponseBodyAnalysisJobAnalysisConfig = None,
        code: str = None,
        creation_time: str = None,
        id: str = None,
        input_file: main_models.SubmitAnalysisJobResponseBodyAnalysisJobInputFile = None,
        mnsmessage_result: main_models.SubmitAnalysisJobResponseBodyAnalysisJobMNSMessageResult = None,
        message: str = None,
        percent: int = None,
        pipeline_id: str = None,
        priority: str = None,
        state: str = None,
        template_list: main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateList = None,
        user_data: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AnalysisConfig') is not None:
            temp_model = main_models.SubmitAnalysisJobResponseBodyAnalysisJobAnalysisConfig()
        ...
        if m.get('InputFile') is not None:
            temp_model = main_models.SubmitAnalysisJobResponseBodyAnalysisJobInputFile()
            self.input_file = temp_model.from_map(m.get('InputFile'))

        if m.get('MNSMessageResult') is not None:
            temp_model = main_models.SubmitAnalysisJobResponseBodyAnalysisJobMNSMessageResult()
        ...
        if m.get('TemplateList') is not None:
            temp_model = main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateList()
...
class SubmitAnalysisJobResponseBodyAnalysisJobTemplateList(DaraModel):
    def __init__(
        self,
        template: List[main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplate] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Template') is not None:
            for k1 in m.get('Template'):
                temp_model = main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplate()
                self.template.append(temp_model.from_map(k1))

        return self

class SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplate(DaraModel):
    def __init__(
        self,
        audio: main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateAudio = None,
        container: main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateContainer = None,
        id: str = None,
        mux_config: main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateMuxConfig = None,
        name: str = None,
        state: str = None,
        trans_config: main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateTransConfig = None,
        video: main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateVideo = None,
    ):
        self.audio = audio
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Audio') is not None:
            temp_model = main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateAudio()
            self.audio = temp_model.from_map(m.get('Audio'))

        if m.get('Container') is not None:
            temp_model = main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateContainer()
        ...
        if m.get('MuxConfig') is not None:
            temp_model = main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateMuxConfig()
        ...
        if m.get('TransConfig') is not None:
            temp_model = main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateTransConfig()
            self.trans_config = temp_model.from_map(m.get('TransConfig'))

        if m.get('Video') is not None:
            temp_model = main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateVideo()
            self.video = temp_model.from_map(m.get('Video'))

        return self

class SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateVideo(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        bitrate_bnd: main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateVideoBitrateBnd = None,
        bufsize: str = None,
        codec: str = None,
        crf: str = None,
        degrain: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BitrateBnd') is not None:
            temp_model = main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateVideoBitrateBnd()
...
class SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateVideoBitrateBnd(DaraModel):
    def __init__(
        self,
        max: str = None,
        min: str = None,
...
class SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateTransConfig(DaraModel):
    def __init__(
        self,
        trans_mode: str = None,
    ):
...
class SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateMuxConfig(DaraModel):
    def __init__(
        self,
        gif: main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateMuxConfigGif = None,
        segment: main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateMuxConfigSegment = None,
    ):
        self.gif = gif
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Gif') is not None:
            temp_model = main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateMuxConfigGif()
            self.gif = temp_model.from_map(m.get('Gif'))

        if m.get('Segment') is not None:
            temp_model = main_models.SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateMuxConfigSegment()
            self.segment = temp_model.from_map(m.get('Segment'))

        return self

class SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateMuxConfigSegment(DaraModel):
    def __init__(
        self,
        duration: str = None,
    ):
...
class SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateMuxConfigGif(DaraModel):
    def __init__(
        self,
...
class SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateContainer(DaraModel):
    def __init__(
        self,
        format: str = None,
    ):
...
class SubmitAnalysisJobResponseBodyAnalysisJobTemplateListTemplateAudio(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        channels: str = None,
...
class SubmitAnalysisJobResponseBodyAnalysisJobMNSMessageResult(DaraModel):
    def __init__(
        self,
        error_code: str = None,
...
class SubmitAnalysisJobResponseBodyAnalysisJobInputFile(DaraModel):
    def __init__(
        self,
        bucket: str = None,
        location: str = None,
...
class SubmitAnalysisJobResponseBodyAnalysisJobAnalysisConfig(DaraModel):
    def __init__(
        self,
        properties_control: main_models.SubmitAnalysisJobResponseBodyAnalysisJobAnalysisConfigPropertiesControl = None,
        quality_control: main_models.SubmitAnalysisJobResponseBodyAnalysisJobAnalysisConfigQualityControl = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PropertiesControl') is not None:
            temp_model = main_models.SubmitAnalysisJobResponseBodyAnalysisJobAnalysisConfigPropertiesControl()
            self.properties_control = temp_model.from_map(m.get('PropertiesControl'))

        if m.get('QualityControl') is not None:
            temp_model = main_models.SubmitAnalysisJobResponseBodyAnalysisJobAnalysisConfigQualityControl()
            self.quality_control = temp_model.from_map(m.get('QualityControl'))

        return self

class SubmitAnalysisJobResponseBodyAnalysisJobAnalysisConfigQualityControl(DaraModel):
    def __init__(
        self,
...
class SubmitAnalysisJobResponseBodyAnalysisJobAnalysisConfigPropertiesControl(DaraModel):
    def __init__(
        self,
        crop: main_models.SubmitAnalysisJobResponseBodyAnalysisJobAnalysisConfigPropertiesControlCrop = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Crop') is not None:
            temp_model = main_models.SubmitAnalysisJobResponseBodyAnalysisJobAnalysisConfigPropertiesControlCrop()
...
class SubmitAnalysisJobResponseBodyAnalysisJobAnalysisConfigPropertiesControlCrop(DaraModel):
    def __init__(
        self,
        height: str = None,
        left: str = None,

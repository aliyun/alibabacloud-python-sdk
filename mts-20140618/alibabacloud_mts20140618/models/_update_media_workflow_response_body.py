...
class UpdateMediaWorkflowResponseBody(DaraModel):
    def __init__(
        self,
        media_workflow: main_models.UpdateMediaWorkflowResponseBodyMediaWorkflow = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MediaWorkflow') is not None:
            temp_model = main_models.UpdateMediaWorkflowResponseBodyMediaWorkflow()
...
class UpdateMediaWorkflowResponseBodyMediaWorkflow(DaraModel):
    def __init__(
        self,

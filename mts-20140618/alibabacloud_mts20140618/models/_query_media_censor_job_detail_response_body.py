...
class QueryMediaCensorJobDetailResponseBodyMediaCensorJobDetail(DaraModel):
    def __init__(
        self,
        audio_censor_result: main_models.QueryMediaCensorJobDetailResponseBodyMediaCensorJobDetailAudioCensorResult = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioCensorResult') is not None:
            temp_model = main_models.QueryMediaCensorJobDetailResponseBodyMediaCensorJobDetailAudioCensorResult()
...
class QueryMediaCensorJobDetailResponseBodyMediaCensorJobDetailAudioCensorResult(DaraModel):
    def __init__(
        self,
        audio_detail_result_list: main_models.QueryMediaCensorJobDetailResponseBodyMediaCensorJobDetailAudioCensorResultAudioDetailResultList = None,
        label: str = None,
        suggestion: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioDetailResultList') is not None:
            temp_model = main_models.QueryMediaCensorJobDetailResponseBodyMediaCensorJobDetailAudioCensorResultAudioDetailResultList()
            self.audio_detail_result_list = temp_model.from_map(m.get('AudioDetailResultList'))
...
class QueryMediaCensorJobDetailResponseBodyMediaCensorJobDetailAudioCensorResultAudioDetailResultList(DaraModel):
    def __init__(
        self,
        audio_detail_result: List[main_models.QueryMediaCensorJobDetailResponseBodyMediaCensorJobDetailAudioCensorResultAudioDetailResultListAudioDetailResult] = None,
    ):
        self.audio_detail_result = audio_detail_result

    def validate(self):
        if self.audio_detail_result:
            for v1 in self.audio_detail_result:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.audio_detail_result is not None:
            for k1 in self.audio_detail_result:
                result['AudioDetailResult'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioDetailResult') is not None:
            for k1 in m.get('AudioDetailResult'):
                temp_model = main_models.QueryMediaCensorJobDetailResponseBodyMediaCensorJobDetailAudioCensorResultAudioDetailResultListAudioDetailResult()
                self.audio_detail_result.append(temp_model.from_map(k1))

        return self

class QueryMediaCensorJobDetailResponseBodyMediaCensorJobDetailAudioCensorResultAudioDetailResultListAudioDetailResult(DaraModel):
    def __init__(
        self,
        end_time: int = None,
        label: str = None,

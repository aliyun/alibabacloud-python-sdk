...
class ListJobResponseBody(DaraModel):
    def __init__(
        self,
        job_list: main_models.ListJobResponseBodyJobList = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('JobList') is not None:
            temp_model = main_models.ListJobResponseBodyJobList()
...
class ListJobResponseBodyJobList(DaraModel):
    def __init__(
        self,
        job: List[main_models.ListJobResponseBodyJobListJob] = None,
    ):
        self.job = job
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Job') is not None:
            for k1 in m.get('Job'):
                temp_model = main_models.ListJobResponseBodyJobListJob()
                self.job.append(temp_model.from_map(k1))

        return self

class ListJobResponseBodyJobListJob(DaraModel):
    def __init__(
        self,
        code: str = None,
        creation_time: str = None,
        finish_time: str = None,
        input: main_models.ListJobResponseBodyJobListJobInput = None,
        job_id: str = None,
        mnsmessage_result: main_models.ListJobResponseBodyJobListJobMNSMessageResult = None,
        message: str = None,
        output: main_models.ListJobResponseBodyJobListJobOutput = None,
        percent: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Input') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobInput()
        ...
        if m.get('MNSMessageResult') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobMNSMessageResult()
        ...
        if m.get('Output') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutput()
...
class ListJobResponseBodyJobListJobOutput(DaraModel):
    def __init__(
        self,
        audio: main_models.ListJobResponseBodyJobListJobOutputAudio = None,
        audio_stream_map: str = None,
        clip: main_models.ListJobResponseBodyJobListJobOutputClip = None,
        container: main_models.ListJobResponseBodyJobListJobOutputContainer = None,
        de_watermark: str = None,
        encryption: main_models.ListJobResponseBodyJobListJobOutputEncryption = None,
        m_3u8non_standard_support: main_models.ListJobResponseBodyJobListJobOutputM3U8NonStandardSupport = None,
        merge_config_url: str = None,
        merge_list: main_models.ListJobResponseBodyJobListJobOutputMergeList = None,
        mux_config: main_models.ListJobResponseBodyJobListJobOutputMuxConfig = None,
        opening_list: main_models.ListJobResponseBodyJobListJobOutputOpeningList = None,
        out_subtitle_list: main_models.ListJobResponseBodyJobListJobOutputOutSubtitleList = None,
        output_file: main_models.ListJobResponseBodyJobListJobOutputOutputFile = None,
        priority: str = None,
        properties: main_models.ListJobResponseBodyJobListJobOutputProperties = None,
        rotate: str = None,
        subtitle_config: main_models.ListJobResponseBodyJobListJobOutputSubtitleConfig = None,
        super_reso: main_models.ListJobResponseBodyJobListJobOutputSuperReso = None,
        tail_slate_list: main_models.ListJobResponseBodyJobListJobOutputTailSlateList = None,
        template_id: str = None,
        trans_config: main_models.ListJobResponseBodyJobListJobOutputTransConfig = None,
        user_data: str = None,
        video: main_models.ListJobResponseBodyJobListJobOutputVideo = None,
        video_stream_map: str = None,
        water_mark_config_url: str = None,
        water_mark_list: main_models.ListJobResponseBodyJobListJobOutputWaterMarkList = None,
    ):
        self.audio = audio
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Audio') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputAudio()
        ...
        if m.get('Clip') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputClip()
            self.clip = temp_model.from_map(m.get('Clip'))

        if m.get('Container') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputContainer()
        ...
        if m.get('Encryption') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputEncryption()
            self.encryption = temp_model.from_map(m.get('Encryption'))

        if m.get('M3U8NonStandardSupport') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputM3U8NonStandardSupport()
        ...
        if m.get('Properties') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputProperties()
        ...
        if m.get('SubtitleConfig') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputSubtitleConfig()
            self.subtitle_config = temp_model.from_map(m.get('SubtitleConfig'))

        if m.get('SuperReso') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputSuperReso()
            self.super_reso = temp_model.from_map(m.get('SuperReso'))

        if m.get('TailSlateList') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputTailSlateList()
        ...
        if m.get('TransConfig') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputTransConfig()
        ...
        if m.get('Video') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputVideo()
        ...
        if m.get('WaterMarkList') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputWaterMarkList()
            self.water_mark_list = temp_model.from_map(m.get('WaterMarkList'))

        return self

class ListJobResponseBodyJobListJobOutputWaterMarkList(DaraModel):
    def __init__(
        self,
        water_mark: List[main_models.ListJobResponseBodyJobListJobOutputWaterMarkListWaterMark] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('WaterMark') is not None:
            for k1 in m.get('WaterMark'):
                temp_model = main_models.ListJobResponseBodyJobListJobOutputWaterMarkListWaterMark()
                self.water_mark.append(temp_model.from_map(k1))

        return self

class ListJobResponseBodyJobListJobOutputWaterMarkListWaterMark(DaraModel):
    def __init__(
        self,
        dx: str = None,
        dy: str = None,
        height: str = None,
        input_file: main_models.ListJobResponseBodyJobListJobOutputWaterMarkListWaterMarkInputFile = None,
        refer_pos: str = None,
        type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InputFile') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputWaterMarkListWaterMarkInputFile()
...
class ListJobResponseBodyJobListJobOutputWaterMarkListWaterMarkInputFile(DaraModel):
    def __init__(
        self,
        bucket: str = None,
        location: str = None,
...
class ListJobResponseBodyJobListJobOutputVideo(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        bitrate_bnd: main_models.ListJobResponseBodyJobListJobOutputVideoBitrateBnd = None,
        bufsize: str = None,
        codec: str = None,
        crf: str = None,
        crop: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BitrateBnd') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputVideoBitrateBnd()
...
class ListJobResponseBodyJobListJobOutputVideoBitrateBnd(DaraModel):
    def __init__(
        self,
        max: str = None,
        min: str = None,
...
class ListJobResponseBodyJobListJobOutputTransConfig(DaraModel):
    def __init__(
        self,
...
class ListJobResponseBodyJobListJobOutputTailSlateList(DaraModel):
    def __init__(
        self,
        tail_slate: List[main_models.ListJobResponseBodyJobListJobOutputTailSlateListTailSlate] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TailSlate') is not None:
            for k1 in m.get('TailSlate'):
                temp_model = main_models.ListJobResponseBodyJobListJobOutputTailSlateListTailSlate()
                self.tail_slate.append(temp_model.from_map(k1))

        return self

class ListJobResponseBodyJobListJobOutputTailSlateListTailSlate(DaraModel):
    def __init__(
        self,
        bg_color: str = None,
...
class ListJobResponseBodyJobListJobOutputSuperReso(DaraModel):
    def __init__(
        self,
...
class ListJobResponseBodyJobListJobOutputSubtitleConfig(DaraModel):
    def __init__(
        self,
        ext_subtitle_list: main_models.ListJobResponseBodyJobListJobOutputSubtitleConfigExtSubtitleList = None,
        subtitle_list: main_models.ListJobResponseBodyJobListJobOutputSubtitleConfigSubtitleList = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ExtSubtitleList') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputSubtitleConfigExtSubtitleList()
            self.ext_subtitle_list = temp_model.from_map(m.get('ExtSubtitleList'))

        if m.get('SubtitleList') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputSubtitleConfigSubtitleList()
            self.subtitle_list = temp_model.from_map(m.get('SubtitleList'))

        return self

class ListJobResponseBodyJobListJobOutputSubtitleConfigSubtitleList(DaraModel):
    def __init__(
        self,
        subtitle: List[main_models.ListJobResponseBodyJobListJobOutputSubtitleConfigSubtitleListSubtitle] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Subtitle') is not None:
            for k1 in m.get('Subtitle'):
                temp_model = main_models.ListJobResponseBodyJobListJobOutputSubtitleConfigSubtitleListSubtitle()
                self.subtitle.append(temp_model.from_map(k1))

        return self

class ListJobResponseBodyJobListJobOutputSubtitleConfigSubtitleListSubtitle(DaraModel):
    def __init__(
        self,
        map: str = None,
    ):
...
class ListJobResponseBodyJobListJobOutputSubtitleConfigExtSubtitleList(DaraModel):
    def __init__(
        self,
        ext_subtitle: List[main_models.ListJobResponseBodyJobListJobOutputSubtitleConfigExtSubtitleListExtSubtitle] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ExtSubtitle') is not None:
            for k1 in m.get('ExtSubtitle'):
                temp_model = main_models.ListJobResponseBodyJobListJobOutputSubtitleConfigExtSubtitleListExtSubtitle()
                self.ext_subtitle.append(temp_model.from_map(k1))

        return self

class ListJobResponseBodyJobListJobOutputSubtitleConfigExtSubtitleListExtSubtitle(DaraModel):
    def __init__(
        self,
        char_enc: str = None,
        font_name: str = None,
        input: main_models.ListJobResponseBodyJobListJobOutputSubtitleConfigExtSubtitleListExtSubtitleInput = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Input') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputSubtitleConfigExtSubtitleListExtSubtitleInput()
            self.input = temp_model.from_map(m.get('Input'))

        return self

class ListJobResponseBodyJobListJobOutputSubtitleConfigExtSubtitleListExtSubtitleInput(DaraModel):
    def __init__(
        self,
        bucket: str = None,
        location: str = None,
...
class ListJobResponseBodyJobListJobOutputProperties(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        duration: str = None,
        ...
        file_size: str = None,
        format: main_models.ListJobResponseBodyJobListJobOutputPropertiesFormat = None,
        fps: str = None,
        height: str = None,
        streams: main_models.ListJobResponseBodyJobListJobOutputPropertiesStreams = None,
        width: str = None,
    ):
        self.bitrate = bitrate
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Format') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputPropertiesFormat()
        ...
        if m.get('Streams') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputPropertiesStreams()
...
class ListJobResponseBodyJobListJobOutputPropertiesStreams(DaraModel):
    def __init__(
        self,
        audio_stream_list: main_models.ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamList = None,
        subtitle_stream_list: main_models.ListJobResponseBodyJobListJobOutputPropertiesStreamsSubtitleStreamList = None,
        video_stream_list: main_models.ListJobResponseBodyJobListJobOutputPropertiesStreamsVideoStreamList = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioStreamList') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamList()
            self.audio_stream_list = temp_model.from_map(m.get('AudioStreamList'))

        if m.get('SubtitleStreamList') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputPropertiesStreamsSubtitleStreamList()
            self.subtitle_stream_list = temp_model.from_map(m.get('SubtitleStreamList'))

        if m.get('VideoStreamList') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputPropertiesStreamsVideoStreamList()
            self.video_stream_list = temp_model.from_map(m.get('VideoStreamList'))

        return self

class ListJobResponseBodyJobListJobOutputPropertiesStreamsVideoStreamList(DaraModel):
    def __init__(
        self,
        video_stream: List[main_models.ListJobResponseBodyJobListJobOutputPropertiesStreamsVideoStreamListVideoStream] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VideoStream') is not None:
            for k1 in m.get('VideoStream'):
                temp_model = main_models.ListJobResponseBodyJobListJobOutputPropertiesStreamsVideoStreamListVideoStream()
                self.video_stream.append(temp_model.from_map(k1))

        return self

class ListJobResponseBodyJobListJobOutputPropertiesStreamsVideoStreamListVideoStream(DaraModel):
    def __init__(
        self,
        avg_fps: str = None,
        bitrate: str = None,
        ...
        lang: str = None,
        level: str = None,
        network_cost: main_models.ListJobResponseBodyJobListJobOutputPropertiesStreamsVideoStreamListVideoStreamNetworkCost = None,
        num_frames: str = None,
        pix_fmt: str = None,
        profile: str = None,
        sar: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NetworkCost') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputPropertiesStreamsVideoStreamListVideoStreamNetworkCost()
...
class ListJobResponseBodyJobListJobOutputPropertiesStreamsVideoStreamListVideoStreamNetworkCost(DaraModel):
    def __init__(
        self,
...
class ListJobResponseBodyJobListJobOutputPropertiesStreamsSubtitleStreamList(DaraModel):
    def __init__(
        self,
        subtitle_stream: List[main_models.ListJobResponseBodyJobListJobOutputPropertiesStreamsSubtitleStreamListSubtitleStream] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SubtitleStream') is not None:
            for k1 in m.get('SubtitleStream'):
                temp_model = main_models.ListJobResponseBodyJobListJobOutputPropertiesStreamsSubtitleStreamListSubtitleStream()
                self.subtitle_stream.append(temp_model.from_map(k1))

        return self

class ListJobResponseBodyJobListJobOutputPropertiesStreamsSubtitleStreamListSubtitleStream(DaraModel):
    def __init__(
        self,
        index: str = None,
        lang: str = None,
...
class ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamList(DaraModel):
    def __init__(
        self,
        audio_stream: List[main_models.ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioStream') is not None:
            for k1 in m.get('AudioStream'):
                temp_model = main_models.ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream()
                self.audio_stream.append(temp_model.from_map(k1))

        return self

class ListJobResponseBodyJobListJobOutputPropertiesStreamsAudioStreamListAudioStream(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
...
class ListJobResponseBodyJobListJobOutputPropertiesFormat(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        duration: str = None,
...
class ListJobResponseBodyJobListJobOutputOutputFile(DaraModel):
    def __init__(
        self,
        bucket: str = None,
        location: str = None,
...
class ListJobResponseBodyJobListJobOutputOutSubtitleList(DaraModel):
    def __init__(
        self,
        out_subtitle: List[main_models.ListJobResponseBodyJobListJobOutputOutSubtitleListOutSubtitle] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OutSubtitle') is not None:
            for k1 in m.get('OutSubtitle'):
                temp_model = main_models.ListJobResponseBodyJobListJobOutputOutSubtitleListOutSubtitle()
                self.out_subtitle.append(temp_model.from_map(k1))

        return self

class ListJobResponseBodyJobListJobOutputOutSubtitleListOutSubtitle(DaraModel):
    def __init__(
        self,
        map: str = None,
        message: str = None,
        out_subtitle_file: main_models.ListJobResponseBodyJobListJobOutputOutSubtitleListOutSubtitleOutSubtitleFile = None,
        success: bool = None,
    ):
        self.map = map
        self.message = message
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OutSubtitleFile') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputOutSubtitleListOutSubtitleOutSubtitleFile()
...
class ListJobResponseBodyJobListJobOutputOutSubtitleListOutSubtitleOutSubtitleFile(DaraModel):
    def __init__(
        self,
        bucket: str = None,
        location: str = None,
...
class ListJobResponseBodyJobListJobOutputOpeningList(DaraModel):
    def __init__(
        self,
        opening: List[main_models.ListJobResponseBodyJobListJobOutputOpeningListOpening] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Opening') is not None:
            for k1 in m.get('Opening'):
                temp_model = main_models.ListJobResponseBodyJobListJobOutputOpeningListOpening()
                self.opening.append(temp_model.from_map(k1))

        return self

class ListJobResponseBodyJobListJobOutputOpeningListOpening(DaraModel):
    def __init__(
        self,
        height: str = None,
        start: str = None,
...
class ListJobResponseBodyJobListJobOutputMuxConfig(DaraModel):
    def __init__(
        self,
        gif: main_models.ListJobResponseBodyJobListJobOutputMuxConfigGif = None,
        segment: main_models.ListJobResponseBodyJobListJobOutputMuxConfigSegment = None,
        webp: main_models.ListJobResponseBodyJobListJobOutputMuxConfigWebp = None,
    ):
        self.gif = gif
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Gif') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputMuxConfigGif()
            self.gif = temp_model.from_map(m.get('Gif'))

        if m.get('Segment') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputMuxConfigSegment()
            self.segment = temp_model.from_map(m.get('Segment'))

        if m.get('Webp') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputMuxConfigWebp()
            self.webp = temp_model.from_map(m.get('Webp'))

        return self

class ListJobResponseBodyJobListJobOutputMuxConfigWebp(DaraModel):
    def __init__(
        self,
        loop: str = None,
    ):
...
class ListJobResponseBodyJobListJobOutputMuxConfigSegment(DaraModel):
    def __init__(
        self,
        duration: str = None,
    ):
...
class ListJobResponseBodyJobListJobOutputMuxConfigGif(DaraModel):
    def __init__(
        self,
...
class ListJobResponseBodyJobListJobOutputMergeList(DaraModel):
    def __init__(
        self,
        merge: List[main_models.ListJobResponseBodyJobListJobOutputMergeListMerge] = None,
    ):
        self.merge = merge
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Merge') is not None:
            for k1 in m.get('Merge'):
                temp_model = main_models.ListJobResponseBodyJobListJobOutputMergeListMerge()
                self.merge.append(temp_model.from_map(k1))

        return self

class ListJobResponseBodyJobListJobOutputMergeListMerge(DaraModel):
    def __init__(
        self,
        duration: str = None,
        merge_url: str = None,
...
class ListJobResponseBodyJobListJobOutputM3U8NonStandardSupport(DaraModel):
    def __init__(
        self,
        ts: main_models.ListJobResponseBodyJobListJobOutputM3U8NonStandardSupportTS = None,
    ):
        self.ts = ts
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TS') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputM3U8NonStandardSupportTS()
            self.ts = temp_model.from_map(m.get('TS'))

        return self

class ListJobResponseBodyJobListJobOutputM3U8NonStandardSupportTS(DaraModel):
    def __init__(
        self,
...
class ListJobResponseBodyJobListJobOutputEncryption(DaraModel):
    def __init__(
        self,
        id: str = None,
        key: str = None,
...
class ListJobResponseBodyJobListJobOutputContainer(DaraModel):
    def __init__(
        self,
        format: str = None,
    ):
...
class ListJobResponseBodyJobListJobOutputClip(DaraModel):
    def __init__(
        self,
        time_span: main_models.ListJobResponseBodyJobListJobOutputClipTimeSpan = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TimeSpan') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputClipTimeSpan()
            self.time_span = temp_model.from_map(m.get('TimeSpan'))

        return self

class ListJobResponseBodyJobListJobOutputClipTimeSpan(DaraModel):
    def __init__(
        self,
        duration: str = None,
        seek: str = None,
...
class ListJobResponseBodyJobListJobOutputAudio(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        channels: str = None,
        ...
        qscale: str = None,
        samplerate: str = None,
        volume: main_models.ListJobResponseBodyJobListJobOutputAudioVolume = None,
    ):
        self.bitrate = bitrate
        self.channels = channels
        self.codec = codec
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Volume') is not None:
            temp_model = main_models.ListJobResponseBodyJobListJobOutputAudioVolume()
            self.volume = temp_model.from_map(m.get('Volume'))

        return self

class ListJobResponseBodyJobListJobOutputAudioVolume(DaraModel):
    def __init__(
        self,
        level: str = None,
        method: str = None,
...
class ListJobResponseBodyJobListJobMNSMessageResult(DaraModel):
    def __init__(
        self,
        error_code: str = None,
...
class ListJobResponseBodyJobListJobInput(DaraModel):
    def __init__(
        self,
        bucket: str = None,
        location: str = None,

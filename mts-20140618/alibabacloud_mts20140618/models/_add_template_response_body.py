...
class AddTemplateResponseBodyTemplate(DaraModel):
    def __init__(
        self,
        audio: main_models.AddTemplateResponseBodyTemplateAudio = None,
        container: main_models.AddTemplateResponseBodyTemplateContainer = None,
        id: str = None,
        mux_config: main_models.AddTemplateResponseBodyTemplateMuxConfig = None,
        name: str = None,
        state: str = None,
        trans_config: main_models.AddTemplateResponseBodyTemplateTransConfig = None,
        video: main_models.AddTemplateResponseBodyTemplateVideo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Audio') is not None:
            temp_model = main_models.AddTemplateResponseBodyTemplateAudio()
            self.audio = temp_model.from_map(m.get('Audio'))

        if m.get('Container') is not None:
            temp_model = main_models.AddTemplateResponseBodyTemplateContainer()
        ...
        if m.get('MuxConfig') is not None:
            temp_model = main_models.AddTemplateResponseBodyTemplateMuxConfig()
        ...
        if m.get('TransConfig') is not None:
            temp_model = main_models.AddTemplateResponseBodyTemplateTransConfig()
            self.trans_config = temp_model.from_map(m.get('TransConfig'))

        if m.get('Video') is not None:
            temp_model = main_models.AddTemplateResponseBodyTemplateVideo()
            self.video = temp_model.from_map(m.get('Video'))

        return self

class AddTemplateResponseBodyTemplateVideo(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        bitrate_bnd: main_models.AddTemplateResponseBodyTemplateVideoBitrateBnd = None,
        bufsize: str = None,
        codec: str = None,
        crf: str = None,
        crop: str = None,
        ...
        max_fps: str = None,
        maxrate: str = None,
        narrow_band: main_models.AddTemplateResponseBodyTemplateVideoNarrowBand = None,
        pad: str = None,
        pix_fmt: str = None,
        preset: str = None,
        profile: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BitrateBnd') is not None:
            temp_model = main_models.AddTemplateResponseBodyTemplateVideoBitrateBnd()
        ...
        if m.get('NarrowBand') is not None:
            temp_model = main_models.AddTemplateResponseBodyTemplateVideoNarrowBand()
...
class AddTemplateResponseBodyTemplateVideoNarrowBand(DaraModel):
    def __init__(
        self,
        abrmax: float = None,
...
class AddTemplateResponseBodyTemplateVideoBitrateBnd(DaraModel):
    def __init__(
        self,
        max: str = None,
        min: str = None,
...
class AddTemplateResponseBodyTemplateTransConfig(DaraModel):
    def __init__(
        self,
...
class AddTemplateResponseBodyTemplateMuxConfig(DaraModel):
    def __init__(
        self,
        gif: main_models.AddTemplateResponseBodyTemplateMuxConfigGif = None,
        segment: main_models.AddTemplateResponseBodyTemplateMuxConfigSegment = None,
        webp: main_models.AddTemplateResponseBodyTemplateMuxConfigWebp = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Gif') is not None:
            temp_model = main_models.AddTemplateResponseBodyTemplateMuxConfigGif()
            self.gif = temp_model.from_map(m.get('Gif'))

        if m.get('Segment') is not None:
            temp_model = main_models.AddTemplateResponseBodyTemplateMuxConfigSegment()
            self.segment = temp_model.from_map(m.get('Segment'))

        if m.get('Webp') is not None:
            temp_model = main_models.AddTemplateResponseBodyTemplateMuxConfigWebp()
            self.webp = temp_model.from_map(m.get('Webp'))

        return self

class AddTemplateResponseBodyTemplateMuxConfigWebp(DaraModel):
    def __init__(
        self,
        loop: str = None,
    ):
...
class AddTemplateResponseBodyTemplateMuxConfigSegment(DaraModel):
    def __init__(
        self,
        duration: str = None,
    ):
...
class AddTemplateResponseBodyTemplateMuxConfigGif(DaraModel):
    def __init__(
        self,
...
class AddTemplateResponseBodyTemplateContainer(DaraModel):
    def __init__(
        self,
        format: str = None,
    ):
...
class AddTemplateResponseBodyTemplateAudio(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        channels: str = None,
        ...
        remove: str = None,
        samplerate: str = None,
        volume: main_models.AddTemplateResponseBodyTemplateAudioVolume = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Volume') is not None:
            temp_model = main_models.AddTemplateResponseBodyTemplateAudioVolume()
            self.volume = temp_model.from_map(m.get('Volume'))

        return self

class AddTemplateResponseBodyTemplateAudioVolume(DaraModel):
    def __init__(
        self,

...
class UpdateWaterMarkTemplateResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        water_mark_template: main_models.UpdateWaterMarkTemplateResponseBodyWaterMarkTemplate = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('WaterMarkTemplate') is not None:
            temp_model = main_models.UpdateWaterMarkTemplateResponseBodyWaterMarkTemplate()
            self.water_mark_template = temp_model.from_map(m.get('WaterMarkTemplate'))

        return self

class UpdateWaterMarkTemplateResponseBodyWaterMarkTemplate(DaraModel):
    def __init__(
        self,
        dx: str = None,
        dy: str = None,
        ...
        id: str = None,
        name: str = None,
        ratio_refer: main_models.UpdateWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer = None,
        refer_pos: str = None,
        state: str = None,
        timeline: main_models.UpdateWaterMarkTemplateResponseBodyWaterMarkTemplateTimeline = None,
        type: str = None,
        width: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RatioRefer') is not None:
            temp_model = main_models.UpdateWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer()
        ...
        if m.get('Timeline') is not None:
            temp_model = main_models.UpdateWaterMarkTemplateResponseBodyWaterMarkTemplateTimeline()
...
class UpdateWaterMarkTemplateResponseBodyWaterMarkTemplateTimeline(DaraModel):
    def __init__(
        self,
        duration: str = None,
        start: str = None,
...
class UpdateWaterMarkTemplateResponseBodyWaterMarkTemplateRatioRefer(DaraModel):
    def __init__(
        self,
        dx: str = None,
        dy: str = None,

...
class SearchTemplateResponseBody(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        request_id: str = None,
        template_list: main_models.SearchTemplateResponseBodyTemplateList = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TemplateList') is not None:
            temp_model = main_models.SearchTemplateResponseBodyTemplateList()
...
class SearchTemplateResponseBodyTemplateList(DaraModel):
    def __init__(
        self,
        template: List[main_models.SearchTemplateResponseBodyTemplateListTemplate] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Template') is not None:
            for k1 in m.get('Template'):
                temp_model = main_models.SearchTemplateResponseBodyTemplateListTemplate()
                self.template.append(temp_model.from_map(k1))

        return self

class SearchTemplateResponseBodyTemplateListTemplate(DaraModel):
    def __init__(
        self,
        audio: main_models.SearchTemplateResponseBodyTemplateListTemplateAudio = None,
        container: main_models.SearchTemplateResponseBodyTemplateListTemplateContainer = None,
        creation_time: str = None,
        id: str = None,
        mux_config: main_models.SearchTemplateResponseBodyTemplateListTemplateMuxConfig = None,
        name: str = None,
        state: str = None,
        trans_config: main_models.SearchTemplateResponseBodyTemplateListTemplateTransConfig = None,
        video: main_models.SearchTemplateResponseBodyTemplateListTemplateVideo = None,
    ):
        self.audio = audio
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Audio') is not None:
            temp_model = main_models.SearchTemplateResponseBodyTemplateListTemplateAudio()
            self.audio = temp_model.from_map(m.get('Audio'))

        if m.get('Container') is not None:
            temp_model = main_models.SearchTemplateResponseBodyTemplateListTemplateContainer()
        ...
        if m.get('MuxConfig') is not None:
            temp_model = main_models.SearchTemplateResponseBodyTemplateListTemplateMuxConfig()
        ...
        if m.get('TransConfig') is not None:
            temp_model = main_models.SearchTemplateResponseBodyTemplateListTemplateTransConfig()
            self.trans_config = temp_model.from_map(m.get('TransConfig'))

        if m.get('Video') is not None:
            temp_model = main_models.SearchTemplateResponseBodyTemplateListTemplateVideo()
            self.video = temp_model.from_map(m.get('Video'))

        return self

class SearchTemplateResponseBodyTemplateListTemplateVideo(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        bitrate_bnd: main_models.SearchTemplateResponseBodyTemplateListTemplateVideoBitrateBnd = None,
        bufsize: str = None,
        codec: str = None,
        crf: str = None,
        crop: str = None,
        ...
        max_fps: str = None,
        maxrate: str = None,
        narrow_band: main_models.SearchTemplateResponseBodyTemplateListTemplateVideoNarrowBand = None,
        pad: str = None,
        pix_fmt: str = None,
        preset: str = None,
        profile: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BitrateBnd') is not None:
            temp_model = main_models.SearchTemplateResponseBodyTemplateListTemplateVideoBitrateBnd()
        ...
        if m.get('NarrowBand') is not None:
            temp_model = main_models.SearchTemplateResponseBodyTemplateListTemplateVideoNarrowBand()
...
class SearchTemplateResponseBodyTemplateListTemplateVideoNarrowBand(DaraModel):
    def __init__(
        self,
        abrmax: float = None,
...
class SearchTemplateResponseBodyTemplateListTemplateVideoBitrateBnd(DaraModel):
    def __init__(
        self,
        max: str = None,
        min: str = None,
...
class SearchTemplateResponseBodyTemplateListTemplateTransConfig(DaraModel):
    def __init__(
        self,
...
class SearchTemplateResponseBodyTemplateListTemplateMuxConfig(DaraModel):
    def __init__(
        self,
        gif: main_models.SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif = None,
        segment: main_models.SearchTemplateResponseBodyTemplateListTemplateMuxConfigSegment = None,
    ):
        self.gif = gif
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Gif') is not None:
            temp_model = main_models.SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif()
            self.gif = temp_model.from_map(m.get('Gif'))

        if m.get('Segment') is not None:
            temp_model = main_models.SearchTemplateResponseBodyTemplateListTemplateMuxConfigSegment()
            self.segment = temp_model.from_map(m.get('Segment'))

        return self

class SearchTemplateResponseBodyTemplateListTemplateMuxConfigSegment(DaraModel):
    def __init__(
        self,
        duration: str = None,
    ):
...
class SearchTemplateResponseBodyTemplateListTemplateMuxConfigGif(DaraModel):
    def __init__(
        self,
...
class SearchTemplateResponseBodyTemplateListTemplateContainer(DaraModel):
    def __init__(
        self,
        format: str = None,
    ):
...
class SearchTemplateResponseBodyTemplateListTemplateAudio(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        channels: str = None,

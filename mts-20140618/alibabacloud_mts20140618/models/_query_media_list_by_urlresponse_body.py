...
class QueryMediaListByURLResponseBody(DaraModel):
    def __init__(
        self,
        media_list: main_models.QueryMediaListByURLResponseBodyMediaList = None,
        non_exist_file_urls: main_models.QueryMediaListByURLResponseBodyNonExistFileURLs = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MediaList') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyMediaList()
            self.media_list = temp_model.from_map(m.get('MediaList'))

        if m.get('NonExistFileURLs') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyNonExistFileURLs()
            self.non_exist_file_urls = temp_model.from_map(m.get('NonExistFileURLs'))
...
class QueryMediaListByURLResponseBodyNonExistFileURLs(DaraModel):
    def __init__(
        self,
...
class QueryMediaListByURLResponseBodyMediaList(DaraModel):
    def __init__(
        self,
        media: List[main_models.QueryMediaListByURLResponseBodyMediaListMedia] = None,
    ):
        self.media = media
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Media') is not None:
            for k1 in m.get('Media'):
                temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMedia()
                self.media.append(temp_model.from_map(k1))

        return self

class QueryMediaListByURLResponseBodyMediaListMedia(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        cate_id: int = None,
        ...
        duration: str = None,
        file: main_models.QueryMediaListByURLResponseBodyMediaListMediaFile = None,
        format: str = None,
        fps: str = None,
        height: str = None,
        media_id: str = None,
        media_info: main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfo = None,
        play_list: main_models.QueryMediaListByURLResponseBodyMediaListMediaPlayList = None,
        publish_state: str = None,
        run_id_list: main_models.QueryMediaListByURLResponseBodyMediaListMediaRunIdList = None,
        size: str = None,
        snapshot_list: main_models.QueryMediaListByURLResponseBodyMediaListMediaSnapshotList = None,
        summary_list: main_models.QueryMediaListByURLResponseBodyMediaListMediaSummaryList = None,
        tags: main_models.QueryMediaListByURLResponseBodyMediaListMediaTags = None,
        title: str = None,
        width: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('File') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaFile()
        ...
        if m.get('MediaInfo') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfo()
            self.media_info = temp_model.from_map(m.get('MediaInfo'))

        if m.get('PlayList') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaPlayList()
        ...
        if m.get('RunIdList') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaRunIdList()
        ...
        if m.get('SnapshotList') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaSnapshotList()
            self.snapshot_list = temp_model.from_map(m.get('SnapshotList'))

        if m.get('SummaryList') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaSummaryList()
            self.summary_list = temp_model.from_map(m.get('SummaryList'))

        if m.get('Tags') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaTags()
...
class QueryMediaListByURLResponseBodyMediaListMediaTags(DaraModel):
    def __init__(
        self,
        tag: List[str] = None,
    ):
...
class QueryMediaListByURLResponseBodyMediaListMediaSummaryList(DaraModel):
    def __init__(
        self,
        summary: List[main_models.QueryMediaListByURLResponseBodyMediaListMediaSummaryListSummary] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Summary') is not None:
            for k1 in m.get('Summary'):
                temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaSummaryListSummary()
                self.summary.append(temp_model.from_map(k1))

        return self

class QueryMediaListByURLResponseBodyMediaListMediaSummaryListSummary(DaraModel):
    def __init__(
        self,
        activity_name: str = None,
        file: main_models.QueryMediaListByURLResponseBodyMediaListMediaSummaryListSummaryFile = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('File') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaSummaryListSummaryFile()
            self.file = temp_model.from_map(m.get('File'))
...
class QueryMediaListByURLResponseBodyMediaListMediaSummaryListSummaryFile(DaraModel):
    def __init__(
        self,
        state: str = None,
        url: str = None,
...
class QueryMediaListByURLResponseBodyMediaListMediaSnapshotList(DaraModel):
    def __init__(
        self,
        snapshot: List[main_models.QueryMediaListByURLResponseBodyMediaListMediaSnapshotListSnapshot] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Snapshot') is not None:
            for k1 in m.get('Snapshot'):
                temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaSnapshotListSnapshot()
                self.snapshot.append(temp_model.from_map(k1))

        return self

class QueryMediaListByURLResponseBodyMediaListMediaSnapshotListSnapshot(DaraModel):
    def __init__(
        self,
        activity_name: str = None,
        count: str = None,
        file: main_models.QueryMediaListByURLResponseBodyMediaListMediaSnapshotListSnapshotFile = None,
        media_workflow_id: str = None,
        media_workflow_name: str = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('File') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaSnapshotListSnapshotFile()
            self.file = temp_model.from_map(m.get('File'))
...
class QueryMediaListByURLResponseBodyMediaListMediaSnapshotListSnapshotFile(DaraModel):
    def __init__(
        self,
        state: str = None,
        url: str = None,
...
class QueryMediaListByURLResponseBodyMediaListMediaRunIdList(DaraModel):
    def __init__(
        self,
...
class QueryMediaListByURLResponseBodyMediaListMediaPlayList(DaraModel):
    def __init__(
        self,
        play: List[main_models.QueryMediaListByURLResponseBodyMediaListMediaPlayListPlay] = None,
    ):
        self.play = play
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Play') is not None:
            for k1 in m.get('Play'):
                temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaPlayListPlay()
                self.play.append(temp_model.from_map(k1))

        return self

class QueryMediaListByURLResponseBodyMediaListMediaPlayListPlay(DaraModel):
    def __init__(
        self,
        activity_name: str = None,
        bitrate: str = None,
        duration: str = None,
        encryption: str = None,
        file: main_models.QueryMediaListByURLResponseBodyMediaListMediaPlayListPlayFile = None,
        format: str = None,
        fps: str = None,
        height: str = None,
        media_workflow_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('File') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaPlayListPlayFile()
            self.file = temp_model.from_map(m.get('File'))
...
class QueryMediaListByURLResponseBodyMediaListMediaPlayListPlayFile(DaraModel):
    def __init__(
        self,
        state: str = None,
        url: str = None,
...
class QueryMediaListByURLResponseBodyMediaListMediaMediaInfo(DaraModel):
    def __init__(
        self,
        format: main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoFormat = None,
        streams: main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreams = None,
    ):
        self.format = format
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('Format') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoFormat()
            self.format = temp_model.from_map(m.get('Format'))

        if m.get('Streams') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreams()
            self.streams = temp_model.from_map(m.get('Streams'))

        return self

class QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreams(DaraModel):
    def __init__(
        self,
        audio_stream_list: main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsAudioStreamList = None,
        subtitle_stream_list: main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsSubtitleStreamList = None,
        video_stream_list: main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsVideoStreamList = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioStreamList') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsAudioStreamList()
            self.audio_stream_list = temp_model.from_map(m.get('AudioStreamList'))

        if m.get('SubtitleStreamList') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsSubtitleStreamList()
            self.subtitle_stream_list = temp_model.from_map(m.get('SubtitleStreamList'))

        if m.get('VideoStreamList') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsVideoStreamList()
            self.video_stream_list = temp_model.from_map(m.get('VideoStreamList'))

        return self

class QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsVideoStreamList(DaraModel):
    def __init__(
        self,
        video_stream: List[main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsVideoStreamListVideoStream] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VideoStream') is not None:
            for k1 in m.get('VideoStream'):
                temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsVideoStreamListVideoStream()
                self.video_stream.append(temp_model.from_map(k1))

        return self

class QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsVideoStreamListVideoStream(DaraModel):
    def __init__(
        self,
        avg_fps: str = None,
        bitrate: str = None,
        ...
        lang: str = None,
        level: str = None,
        network_cost: main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsVideoStreamListVideoStreamNetworkCost = None,
        num_frames: str = None,
        pix_fmt: str = None,
        profile: str = None,
        rotate: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NetworkCost') is not None:
            temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsVideoStreamListVideoStreamNetworkCost()
...
class QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsVideoStreamListVideoStreamNetworkCost(DaraModel):
    def __init__(
        self,
...
class QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsSubtitleStreamList(DaraModel):
    def __init__(
        self,
        subtitle_stream: List[main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsSubtitleStreamListSubtitleStream] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SubtitleStream') is not None:
            for k1 in m.get('SubtitleStream'):
                temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsSubtitleStreamListSubtitleStream()
                self.subtitle_stream.append(temp_model.from_map(k1))

        return self

class QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsSubtitleStreamListSubtitleStream(DaraModel):
    def __init__(
        self,
        index: str = None,
        lang: str = None,
...
class QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsAudioStreamList(DaraModel):
    def __init__(
        self,
        audio_stream: List[main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioStream') is not None:
            for k1 in m.get('AudioStream'):
                temp_model = main_models.QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream()
                self.audio_stream.append(temp_model.from_map(k1))

        return self

class QueryMediaListByURLResponseBodyMediaListMediaMediaInfoStreamsAudioStreamListAudioStream(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
...
class QueryMediaListByURLResponseBodyMediaListMediaMediaInfoFormat(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        duration: str = None,
...
class QueryMediaListByURLResponseBodyMediaListMediaFile(DaraModel):
    def __init__(
        self,
        state: str = None,
        url: str = None,

...
class AddMediaResponseBody(DaraModel):
    def __init__(
        self,
        media: main_models.AddMediaResponseBodyMedia = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Media') is not None:
            temp_model = main_models.AddMediaResponseBodyMedia()
...
class AddMediaResponseBodyMedia(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        cate_id: int = None,
        ...
        duration: str = None,
        file: main_models.AddMediaResponseBodyMediaFile = None,
        format: str = None,
        fps: str = None,
        height: str = None,
        media_id: str = None,
        publish_state: str = None,
        run_id_list: main_models.AddMediaResponseBodyMediaRunIdList = None,
        size: str = None,
        tags: main_models.AddMediaResponseBodyMediaTags = None,
        title: str = None,
        width: str = None,
    ):
        # The bitrate.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('File') is not None:
            temp_model = main_models.AddMediaResponseBodyMediaFile()
        ...
        if m.get('RunIdList') is not None:
            temp_model = main_models.AddMediaResponseBodyMediaRunIdList()
        ...
        if m.get('Tags') is not None:
            temp_model = main_models.AddMediaResponseBodyMediaTags()
...
class AddMediaResponseBodyMediaTags(DaraModel):
    def __init__(
        self,
        tag: List[str] = None,
    ):
...
class AddMediaResponseBodyMediaRunIdList(DaraModel):
    def __init__(
        self,
...
class AddMediaResponseBodyMediaFile(DaraModel):
    def __init__(
        self,
        state: str = None,
        url: str = None,

...
## Alibaba Cloud vdmeter SDK for Python
...
```bash
# 安装 alibabacloud_vdmeter20210425
pip install alibabacloud_vdmeter20210425
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/vdmeter-20210425/ChangeLog.md)中。

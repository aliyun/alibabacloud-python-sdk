...
```bash
# 安装 alibabacloud_cloudesl20200201
pip install alibabacloud_cloudesl20200201
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/cloudesl-20200201/ChangeLog.md)中。

...
## Alibaba Cloud Drds SDK for Python
...
```bash
# 安装 alibabacloud_drds20190123
pip install alibabacloud_drds20190123
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/drds-20190123/ChangeLog.md)中。

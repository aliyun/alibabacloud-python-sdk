...
```bash
# 安装 alibabacloud_clickhouse20230522
pip install alibabacloud_clickhouse20230522
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/clickhouse-20230522/ChangeLog.md)中。

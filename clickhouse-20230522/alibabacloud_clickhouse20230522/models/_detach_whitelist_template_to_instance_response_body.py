...
class DetachWhitelistTemplateToInstanceResponseBodyData(DaraModel):
    def __init__(
        self,
        detach_fail_list: List[main_models.DetachWhitelistTemplateToInstanceResponseBodyDataDetachFailList] = None,
    ...
    def validate(self):
        if self.detach_fail_list:
            for v1 in self.detach_fail_list:
                 if v1:
                    v1.validate()
        if self.detach_successed_list:
            for v1 in self.detach_successed_list:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.detach_fail_list is not None:
            for k1 in self.detach_fail_list:
                result['DetachFailList'].append(k1.to_map() if k1 else None)

        result['DetachSuccessedList'] = []
        if self.detach_successed_list is not None:
            for k1 in self.detach_successed_list:
                result['DetachSuccessedList'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DetachFailList') is not None:
            for k1 in m.get('DetachFailList'):
                temp_model = main_models.DetachWhitelistTemplateToInstanceResponseBodyDataDetachFailList()
                self.detach_fail_list.append(temp_model.from_map(k1))

        self.detach_successed_list = []
        if m.get('DetachSuccessedList') is not None:
            for k1 in m.get('DetachSuccessedList'):
                temp_model = main_models.DetachWhitelistTemplateToInstanceResponseBodyDataDetachSuccessedList()
                self.detach_successed_list.append(temp_model.from_map(k1))
...
class DetachWhitelistTemplateToInstanceResponseBodyDataDetachSuccessedList(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Templates') is not None:
            for k1 in m.get('Templates'):
                temp_model = main_models.DetachWhitelistTemplateToInstanceResponseBodyDataDetachSuccessedListTemplates()
                self.templates.append(temp_model.from_map(k1))

        return self

class DetachWhitelistTemplateToInstanceResponseBodyDataDetachSuccessedListTemplates(DaraModel):
    def __init__(
        self,
        db_instances: List[main_models.DetachWhitelistTemplateToInstanceResponseBodyDataDetachSuccessedListTemplatesDbInstances] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DbInstances') is not None:
            for k1 in m.get('DbInstances'):
                temp_model = main_models.DetachWhitelistTemplateToInstanceResponseBodyDataDetachSuccessedListTemplatesDbInstances()
...
class DetachWhitelistTemplateToInstanceResponseBodyDataDetachSuccessedListTemplatesDbInstances(DaraModel):
    def __init__(
        self,
        dbinstance_id: str = None,
    ):
...
class DetachWhitelistTemplateToInstanceResponseBodyDataDetachFailList(DaraModel):
    def __init__(
        self,
        dbinstance_id: str = None,
        reason: str = None,

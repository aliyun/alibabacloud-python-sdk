...
class DescribeLangfuseSecurityIPListResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.DescribeLangfuseSecurityIPListResponseBodyData = None,
        request_id: str = None,
    ):
        # The returned result.
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DescribeLangfuseSecurityIPListResponseBodyData()
...
class DescribeLangfuseSecurityIPListResponseBodyData(DaraModel):
    def __init__(
        self,
        dbinstance_id: int = None,
        dbinstance_name: str = None,
        group_items: List[main_models.DescribeLangfuseSecurityIPListResponseBodyDataGroupItems] = None,
    ):
        # The instance ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('GroupItems') is not None:
            for k1 in m.get('GroupItems'):
                temp_model = main_models.DescribeLangfuseSecurityIPListResponseBodyDataGroupItems()
                self.group_items.append(temp_model.from_map(k1))

        return self

class DescribeLangfuseSecurityIPListResponseBodyDataGroupItems(DaraModel):
    def __init__(
        self,
        group_name: str = None,
        group_tag: str = None,

...
class GetWhitelistTemplateResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetWhitelistTemplateResponseBodyData()
...
class GetWhitelistTemplateResponseBodyData(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Templates') is not None:
            for k1 in m.get('Templates'):
                temp_model = main_models.GetWhitelistTemplateResponseBodyDataTemplates()
                self.templates.append(temp_model.from_map(k1))

        return self

class GetWhitelistTemplateResponseBodyDataTemplates(DaraModel):
    def __init__(
        self,
        db_instances: List[main_models.GetWhitelistTemplateResponseBodyDataTemplatesDbInstances] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DbInstances') is not None:
            for k1 in m.get('DbInstances'):
                temp_model = main_models.GetWhitelistTemplateResponseBodyDataTemplatesDbInstances()
...
class GetWhitelistTemplateResponseBodyDataTemplatesDbInstances(DaraModel):
    def __init__(
        self,

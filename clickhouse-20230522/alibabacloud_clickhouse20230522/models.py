...
class CreateWhitelistTemplateRequest(TeaModel):
    def __init__(
        self,
        region_id: str = None,
        security_iplist: str = None,
...
class CreateWhitelistTemplateResponseBodyDataTemplates(TeaModel):
    def __init__(
        self,
        security_iplist: str = None,
        template_id: str = None,
...
class CreateWhitelistTemplateResponseBodyData(TeaModel):
    def __init__(
        self,
        templates: List[CreateWhitelistTemplateResponseBodyDataTemplates] = None,
    ):
        self.templates = templates
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Templates') is not None:
            for k in m.get('Templates'):
                temp_model = CreateWhitelistTemplateResponseBodyDataTemplates()
                self.templates.append(temp_model.from_map(k))
        return self


class CreateWhitelistTemplateResponseBody(TeaModel):
    def __init__(
        self,
        data: CreateWhitelistTemplateResponseBodyData = None,
        request_id: str = None,
    ):
        self.data = data
        # Id of the request
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('Data') is not None:
            temp_model = CreateWhitelistTemplateResponseBodyData()
            self.data = temp_model.from_map(m['Data'])
        if m.get('RequestId') is not None:
            self.request_id = m.get('RequestId')
        return self
...
class CreateWhitelistTemplateResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CreateWhitelistTemplateResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CreateWhitelistTemplateResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

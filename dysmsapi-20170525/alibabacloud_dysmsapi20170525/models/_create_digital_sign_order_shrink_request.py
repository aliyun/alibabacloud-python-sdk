...
class CreateDigitalSignOrderShrinkRequest(DaraModel):
    def __init__(
        self,
        extend_message: str = None,
        order_context_shrink: str = None,
        order_type: str = None,
        owner_id: int = None,
        ...
        self.order_context_shrink = order_context_shrink
    ...
    def to_map(self):
        ...
        if self.order_context_shrink is not None:
            result['OrderContext'] = self.order_context_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OrderContext') is not None:
            self.order_context_shrink = m.get('OrderContext')

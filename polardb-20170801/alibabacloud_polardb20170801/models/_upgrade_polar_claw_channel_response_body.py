...
class UpgradePolarClawChannelResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def to_map(self):
        ...
        if self.plugin_upgraded is not None:
            result['PluginUpgraded'] = self.plugin_upgraded
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PluginUpgraded') is not None:
            self.plugin_upgraded = m.get('PluginUpgraded')

...
class DeletePolarFsPathMappingRequest(DaraModel):
    def __init__(
        self,
        custom_bucket_path_list: List[main_models.DeletePolarFsPathMappingRequestCustomBucketPathList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CustomBucketPathList') is not None:
            for k1 in m.get('CustomBucketPathList'):
                temp_model = main_models.DeletePolarFsPathMappingRequestCustomBucketPathList()
...
class DeletePolarFsPathMappingRequestCustomBucketPathList(DaraModel):
    def __init__(
        self,
        bucket: str = None,
        path: str = None,

...
class CreateGlobalSecurityIPGroupResponseBody(DaraModel):
    def __init__(
        self,
        global_security_ipgroup: List[main_models.CreateGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('GlobalSecurityIPGroup') is not None:
            for k1 in m.get('GlobalSecurityIPGroup'):
                temp_model = main_models.CreateGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup()
...
class CreateGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup(DaraModel):
    def __init__(
        self,
        gip_list: str = None,

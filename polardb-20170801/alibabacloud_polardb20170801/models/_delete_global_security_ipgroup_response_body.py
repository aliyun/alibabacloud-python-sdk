...
class DeleteGlobalSecurityIPGroupResponseBody(DaraModel):
    def __init__(
        self,
        global_security_ipgroup: List[main_models.DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('GlobalSecurityIPGroup') is not None:
            for k1 in m.get('GlobalSecurityIPGroup'):
                temp_model = main_models.DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup()
...
class DeleteGlobalSecurityIPGroupResponseBodyGlobalSecurityIPGroup(DaraModel):
    def __init__(
        self,

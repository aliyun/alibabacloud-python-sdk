...
class AddPolarClawMCPServerShrinkRequest(DaraModel):
    def __init__(
        self,
    ...
    def to_map(self):
        ...
        if self.server_config_shrink is not None:
            result['ServerConfig'] = self.server_config_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ServerConfig') is not None:
            self.server_config_shrink = m.get('ServerConfig')

...
class DescribeAccountsResponseBody(DaraModel):
    def __init__(
        self,
        accounts: List[main_models.DescribeAccountsResponseBodyAccounts] = None,
...
class DescribeAccountsResponseBodyAccounts(DaraModel):
    def __init__(
        ...
        database_privileges: List[main_models.DescribeAccountsResponseBodyAccountsDatabasePrivileges] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DatabasePrivileges') is not None:
            for k1 in m.get('DatabasePrivileges'):
                temp_model = main_models.DescribeAccountsResponseBodyAccountsDatabasePrivileges()
                self.database_privileges.append(temp_model.from_map(k1))

        return self

class DescribeAccountsResponseBodyAccountsDatabasePrivileges(DaraModel):
    def __init__(
        self,

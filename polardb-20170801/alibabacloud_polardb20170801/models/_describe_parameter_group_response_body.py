...
class DescribeParameterGroupResponseBodyParameterGroup(DaraModel):
    def __init__(
        ...
        parameter_detail: List[main_models.DescribeParameterGroupResponseBodyParameterGroupParameterDetail] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ParameterDetail') is not None:
            for k1 in m.get('ParameterDetail'):
                temp_model = main_models.DescribeParameterGroupResponseBodyParameterGroupParameterDetail()
...
class DescribeParameterGroupResponseBodyParameterGroupParameterDetail(DaraModel):
    def __init__(
        self,
        param_name: str = None,

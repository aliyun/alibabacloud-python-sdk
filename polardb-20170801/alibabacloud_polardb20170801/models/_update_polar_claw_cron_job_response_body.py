...
class UpdatePolarClawCronJobResponseBody(DaraModel):
    def __init__(
        self,
        application_id: str = None,
        code: int = None,
        job: main_models.UpdatePolarClawCronJobResponseBodyJob = None,
        message: str = None,
        ok: bool = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Job') is not None:
            temp_model = main_models.UpdatePolarClawCronJobResponseBodyJob()
...
class UpdatePolarClawCronJobResponseBodyJob(DaraModel):
    def __init__(
        self,
        agent_id: str = None,
        created_at_ms: int = None,
        delete_after_run: bool = None,
        delivery: main_models.UpdatePolarClawCronJobResponseBodyJobDelivery = None,
        description: str = None,
        enabled: bool = None,
        id: str = None,
        name: str = None,
        payload: main_models.UpdatePolarClawCronJobResponseBodyJobPayload = None,
        runs: List[main_models.UpdatePolarClawCronJobResponseBodyJobRuns] = None,
        schedule: main_models.UpdatePolarClawCronJobResponseBodyJobSchedule = None,
        session_key: str = None,
        session_target: str = None,
        state: main_models.UpdatePolarClawCronJobResponseBodyJobState = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Delivery') is not None:
            temp_model = main_models.UpdatePolarClawCronJobResponseBodyJobDelivery()
        ...
        if m.get('Payload') is not None:
            temp_model = main_models.UpdatePolarClawCronJobResponseBodyJobPayload()
            self.payload = temp_model.from_map(m.get('Payload'))

        self.runs = []
        if m.get('Runs') is not None:
            for k1 in m.get('Runs'):
                temp_model = main_models.UpdatePolarClawCronJobResponseBodyJobRuns()
                self.runs.append(temp_model.from_map(k1))

        if m.get('Schedule') is not None:
            temp_model = main_models.UpdatePolarClawCronJobResponseBodyJobSchedule()
        ...
        if m.get('State') is not None:
            temp_model = main_models.UpdatePolarClawCronJobResponseBodyJobState()
...
class UpdatePolarClawCronJobResponseBodyJobState(DaraModel):
    def __init__(
        self,
...
class UpdatePolarClawCronJobResponseBodyJobSchedule(DaraModel):
    def __init__(
        self,
        anchor_ms: int = None,
        at: str = None,
...
class UpdatePolarClawCronJobResponseBodyJobRuns(DaraModel):
    def __init__(
        self,
        action: str = None,
        delivered: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Usage') is not None:
            temp_model = main_models.UpdatePolarClawCronJobResponseBodyJobRunsUsage()
            self.usage = temp_model.from_map(m.get('Usage'))

        return self

class UpdatePolarClawCronJobResponseBodyJobRunsUsage(DaraModel):
    def __init__(
        self,
...
class UpdatePolarClawCronJobResponseBodyJobPayload(DaraModel):
    def __init__(
        self,
...
class UpdatePolarClawCronJobResponseBodyJobDelivery(DaraModel):
    def __init__(
        self,
        account_id: str = None,

...
class DescribeDBClusterPriceRequest(DaraModel):
    def __init__(
        self,
        ...
        dbnode_num: int = None,
        dbnodes: List[main_models.DescribeDBClusterPriceRequestDBNodes] = None,
        dbtype: str = None,
        dbversion: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DBNodes') is not None:
            for k1 in m.get('DBNodes'):
                temp_model = main_models.DescribeDBClusterPriceRequestDBNodes()
...
class DescribeDBClusterPriceRequestDBNodes(DaraModel):
    def __init__(
        self,
        dbnode_class: str = None,
        dbnode_id: str = None,

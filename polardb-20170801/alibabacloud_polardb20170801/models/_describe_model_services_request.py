...
class DescribeModelServicesRequest(DaraModel):
    def __init__(
        self,
        gw_cluster_id: str = None,
        model_category: str = None,
        model_service_ids: str = None,
        name: str = None,
    ...
    def to_map(self):
        ...
        if self.model_service_ids is not None:
            result['ModelServiceIds'] = self.model_service_ids
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ModelServiceIds') is not None:
            self.model_service_ids = m.get('ModelServiceIds')

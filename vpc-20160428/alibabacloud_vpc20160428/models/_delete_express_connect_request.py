...
class DeleteExpressConnectRequest(DaraModel):
    def __init__(
        self,
        ...
        # The region ID of the Express Connect instance. You can call the [DescribeRegions](https://help.aliyun.com/document_detail/36063.html) operation to query the region ID.
        # 

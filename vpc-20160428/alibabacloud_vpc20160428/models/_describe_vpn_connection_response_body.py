...
class DescribeVpnConnectionResponseBody(DaraModel):
    def __init__(
        self,
        ...
        ike_config: main_models.DescribeVpnConnectionResponseBodyIkeConfig = None,
        internet_ip: str = None,
        ipsec_config: main_models.DescribeVpnConnectionResponseBodyIpsecConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IkeConfig') is not None:
            temp_model = main_models.DescribeVpnConnectionResponseBodyIkeConfig()
        ...
        if m.get('IpsecConfig') is not None:
            temp_model = main_models.DescribeVpnConnectionResponseBodyIpsecConfig()
        ...
        if m.get('Tags') is not None:
            temp_model = main_models.DescribeVpnConnectionResponseBodyTags()
        ...
        if m.get('VcoHealthCheck') is not None:
            temp_model = main_models.DescribeVpnConnectionResponseBodyVcoHealthCheck()
            self.vco_health_check = temp_model.from_map(m.get('VcoHealthCheck'))

        if m.get('VpnBgpConfig') is not None:
            temp_model = main_models.DescribeVpnConnectionResponseBodyVpnBgpConfig()
...
class DescribeVpnConnectionResponseBodyVpnBgpConfig(DaraModel):
    def __init__(
        self,
        auth_key: str = None,
        enable_bgp: str = None,
...
class DescribeVpnConnectionResponseBodyVcoHealthCheck(DaraModel):
    def __init__(
        self,
        dip: str = None,
        enable: str = None,
...
class DescribeVpnConnectionResponseBodyTunnelOptionsSpecification(DaraModel):
    def __init__(
        self,
        tunnel_options: List[main_models.DescribeVpnConnectionResponseBodyTunnelOptionsSpecificationTunnelOptions] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TunnelOptions') is not None:
            for k1 in m.get('TunnelOptions'):
                temp_model = main_models.DescribeVpnConnectionResponseBodyTunnelOptionsSpecificationTunnelOptions()
                self.tunnel_options.append(temp_model.from_map(k1))

        return self

class DescribeVpnConnectionResponseBodyTunnelOptionsSpecificationTunnelOptions(DaraModel):
    def __init__(
        self,
        customer_gateway_id: str = None,
        enable_dpd: str = None,
        ...
        state: str = None,
        status: str = None,
        tunnel_bgp_config: main_models.DescribeVpnConnectionResponseBodyTunnelOptionsSpecificationTunnelOptionsTunnelBgpConfig = None,
        tunnel_id: str = None,
        tunnel_ike_config: main_models.DescribeVpnConnectionResponseBodyTunnelOptionsSpecificationTunnelOptionsTunnelIkeConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TunnelBgpConfig') is not None:
            temp_model = main_models.DescribeVpnConnectionResponseBodyTunnelOptionsSpecificationTunnelOptionsTunnelBgpConfig()
        ...
        if m.get('TunnelIkeConfig') is not None:
            temp_model = main_models.DescribeVpnConnectionResponseBodyTunnelOptionsSpecificationTunnelOptionsTunnelIkeConfig()
        ...
        if m.get('TunnelIpsecConfig') is not None:
            temp_model = main_models.DescribeVpnConnectionResponseBodyTunnelOptionsSpecificationTunnelOptionsTunnelIpsecConfig()
...
class DescribeVpnConnectionResponseBodyTunnelOptionsSpecificationTunnelOptionsTunnelIpsecConfig(DaraModel):
    def __init__(
        self,
...
class DescribeVpnConnectionResponseBodyTunnelOptionsSpecificationTunnelOptionsTunnelIkeConfig(DaraModel):
    def __init__(
        self,
...
class DescribeVpnConnectionResponseBodyTunnelOptionsSpecificationTunnelOptionsTunnelBgpConfig(DaraModel):
    def __init__(
        self,
        bgp_status: str = None,
        local_asn: str = None,
...
class DescribeVpnConnectionResponseBodyTags(DaraModel):
    def __init__(
        self,
        tag: List[main_models.DescribeVpnConnectionResponseBodyTagsTag] = None,
    ):
        self.tag = tag
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.DescribeVpnConnectionResponseBodyTagsTag()
                self.tag.append(temp_model.from_map(k1))

        return self

class DescribeVpnConnectionResponseBodyTagsTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class DescribeVpnConnectionResponseBodyIpsecConfig(DaraModel):
    def __init__(
        self,
        ipsec_auth_alg: str = None,
        ipsec_enc_alg: str = None,
...
class DescribeVpnConnectionResponseBodyIkeConfig(DaraModel):
    def __init__(
        self,
        ike_auth_alg: str = None,
        ike_enc_alg: str = None,

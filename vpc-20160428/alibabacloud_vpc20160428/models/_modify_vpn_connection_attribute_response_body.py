...
class ModifyVpnConnectionAttributeResponseBody(DaraModel):
    def __init__(
        self,
        ...
        ike_config: main_models.ModifyVpnConnectionAttributeResponseBodyIkeConfig = None,
        ipsec_config: main_models.ModifyVpnConnectionAttributeResponseBodyIpsecConfig = None,
        local_subnet: str = None,
        name: str = None,
        remote_subnet: str = None,
        request_id: str = None,
        resource_group_id: str = None,
        tunnel_options_specification: main_models.ModifyVpnConnectionAttributeResponseBodyTunnelOptionsSpecification = None,
        vco_health_check: main_models.ModifyVpnConnectionAttributeResponseBodyVcoHealthCheck = None,
        vpn_bgp_config: main_models.ModifyVpnConnectionAttributeResponseBodyVpnBgpConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IkeConfig') is not None:
            temp_model = main_models.ModifyVpnConnectionAttributeResponseBodyIkeConfig()
            self.ike_config = temp_model.from_map(m.get('IkeConfig'))

        if m.get('IpsecConfig') is not None:
            temp_model = main_models.ModifyVpnConnectionAttributeResponseBodyIpsecConfig()
        ...
        if m.get('TunnelOptionsSpecification') is not None:
            temp_model = main_models.ModifyVpnConnectionAttributeResponseBodyTunnelOptionsSpecification()
        ...
        if m.get('VcoHealthCheck') is not None:
            temp_model = main_models.ModifyVpnConnectionAttributeResponseBodyVcoHealthCheck()
            self.vco_health_check = temp_model.from_map(m.get('VcoHealthCheck'))

        if m.get('VpnBgpConfig') is not None:
            temp_model = main_models.ModifyVpnConnectionAttributeResponseBodyVpnBgpConfig()
...
class ModifyVpnConnectionAttributeResponseBodyVpnBgpConfig(DaraModel):
    def __init__(
        self,
        enable_bgp: str = None,
        local_asn: int = None,
...
class ModifyVpnConnectionAttributeResponseBodyVcoHealthCheck(DaraModel):
    def __init__(
        self,
        dip: str = None,
        enable: str = None,
...
class ModifyVpnConnectionAttributeResponseBodyTunnelOptionsSpecification(DaraModel):
    def __init__(
        self,
        tunnel_options: List[main_models.ModifyVpnConnectionAttributeResponseBodyTunnelOptionsSpecificationTunnelOptions] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TunnelOptions') is not None:
            for k1 in m.get('TunnelOptions'):
                temp_model = main_models.ModifyVpnConnectionAttributeResponseBodyTunnelOptionsSpecificationTunnelOptions()
                self.tunnel_options.append(temp_model.from_map(k1))

        return self

class ModifyVpnConnectionAttributeResponseBodyTunnelOptionsSpecificationTunnelOptions(DaraModel):
    def __init__(
        self,
        customer_gateway_id: str = None,
        enable_dpd: bool = None,
        ...
        role: str = None,
        state: str = None,
        tunnel_bgp_config: main_models.ModifyVpnConnectionAttributeResponseBodyTunnelOptionsSpecificationTunnelOptionsTunnelBgpConfig = None,
        tunnel_id: str = None,
        tunnel_ike_config: main_models.ModifyVpnConnectionAttributeResponseBodyTunnelOptionsSpecificationTunnelOptionsTunnelIkeConfig = None,
        tunnel_ipsec_config: main_models.ModifyVpnConnectionAttributeResponseBodyTunnelOptionsSpecificationTunnelOptionsTunnelIpsecConfig = None,
        zone_no: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TunnelBgpConfig') is not None:
            temp_model = main_models.ModifyVpnConnectionAttributeResponseBodyTunnelOptionsSpecificationTunnelOptionsTunnelBgpConfig()
        ...
        if m.get('TunnelIkeConfig') is not None:
            temp_model = main_models.ModifyVpnConnectionAttributeResponseBodyTunnelOptionsSpecificationTunnelOptionsTunnelIkeConfig()
            self.tunnel_ike_config = temp_model.from_map(m.get('TunnelIkeConfig'))

        if m.get('TunnelIpsecConfig') is not None:
            temp_model = main_models.ModifyVpnConnectionAttributeResponseBodyTunnelOptionsSpecificationTunnelOptionsTunnelIpsecConfig()
...
class ModifyVpnConnectionAttributeResponseBodyTunnelOptionsSpecificationTunnelOptionsTunnelIpsecConfig(DaraModel):
    def __init__(
        self,
...
class ModifyVpnConnectionAttributeResponseBodyTunnelOptionsSpecificationTunnelOptionsTunnelIkeConfig(DaraModel):
    def __init__(
        self,
...
class ModifyVpnConnectionAttributeResponseBodyTunnelOptionsSpecificationTunnelOptionsTunnelBgpConfig(DaraModel):
    def __init__(
        self,
        local_asn: int = None,
        local_bgp_ip: str = None,
...
class ModifyVpnConnectionAttributeResponseBodyIpsecConfig(DaraModel):
    def __init__(
        self,
        ipsec_auth_alg: str = None,
        ipsec_enc_alg: str = None,
...
class ModifyVpnConnectionAttributeResponseBodyIkeConfig(DaraModel):
    def __init__(
        self,
        ike_auth_alg: str = None,
        ike_enc_alg: str = None,

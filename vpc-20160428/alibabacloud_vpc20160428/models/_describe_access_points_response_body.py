...
class DescribeAccessPointsResponseBodyAccessPointSetAccessPointType(DaraModel):
    def __init__(
        self,
        access_point_feature_models: main_models.DescribeAccessPointsResponseBodyAccessPointSetAccessPointTypeAccessPointFeatureModels = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AccessPointFeatureModels') is not None:
            temp_model = main_models.DescribeAccessPointsResponseBodyAccessPointSetAccessPointTypeAccessPointFeatureModels()
            self.access_point_feature_models = temp_model.from_map(m.get('AccessPointFeatureModels'))
...
class DescribeAccessPointsResponseBodyAccessPointSetAccessPointTypeAccessPointFeatureModels(DaraModel):
    def __init__(
        self,
        access_point_feature_model: List[main_models.DescribeAccessPointsResponseBodyAccessPointSetAccessPointTypeAccessPointFeatureModelsAccessPointFeatureModel] = None,
    ):
        self.access_point_feature_model = access_point_feature_model

    def validate(self):
        if self.access_point_feature_model:
            for v1 in self.access_point_feature_model:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.access_point_feature_model is not None:
            for k1 in self.access_point_feature_model:
                result['AccessPointFeatureModel'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AccessPointFeatureModel') is not None:
            for k1 in m.get('AccessPointFeatureModel'):
                temp_model = main_models.DescribeAccessPointsResponseBodyAccessPointSetAccessPointTypeAccessPointFeatureModelsAccessPointFeatureModel()
                self.access_point_feature_model.append(temp_model.from_map(k1))

        return self

class DescribeAccessPointsResponseBodyAccessPointSetAccessPointTypeAccessPointFeatureModelsAccessPointFeatureModel(DaraModel):
    def __init__(
        self,

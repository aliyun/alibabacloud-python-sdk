...
class DescribeNetworkAclsRequest(DaraModel):
    def __init__(
        ...
        tags: List[main_models.DescribeNetworkAclsRequestTags] = None,
        vpc_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.DescribeNetworkAclsRequestTags()
...
class DescribeNetworkAclsRequestTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

...
class DescribeVpnGatewayResponseBody(DaraModel):
    def __init__(
        self,
        ...
        request_id: str = None,
        reservation_data: main_models.DescribeVpnGatewayResponseBodyReservationData = None,
        ...
        status: str = None,
        tag: str = None,
        tags: main_models.DescribeVpnGatewayResponseBodyTags = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ReservationData') is not None:
            temp_model = main_models.DescribeVpnGatewayResponseBodyReservationData()
        ...
        if m.get('Tags') is not None:
            temp_model = main_models.DescribeVpnGatewayResponseBodyTags()
...
class DescribeVpnGatewayResponseBodyTags(DaraModel):
    def __init__(
        self,
        tag: List[main_models.DescribeVpnGatewayResponseBodyTagsTag] = None,
    ):
        self.tag = tag
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.DescribeVpnGatewayResponseBodyTagsTag()
                self.tag.append(temp_model.from_map(k1))

        return self

class DescribeVpnGatewayResponseBodyTagsTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class DescribeVpnGatewayResponseBodyReservationData(DaraModel):
    def __init__(
        self,
...
class DescribeVpnGatewayResponseBodyEniInstanceIds(DaraModel):
    def __init__(
        self,

...
class DescribeCustomerGatewayResponseBody(DaraModel):
    def __init__(
        self,
        asn: int = None,
        auth_key: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            temp_model = main_models.DescribeCustomerGatewayResponseBodyTags()
            self.tags = temp_model.from_map(m.get('Tags'))

        return self

class DescribeCustomerGatewayResponseBodyTags(DaraModel):
    def __init__(
        self,
        tag: List[main_models.DescribeCustomerGatewayResponseBodyTagsTag] = None,
    ):
        self.tag = tag
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.DescribeCustomerGatewayResponseBodyTagsTag()
                self.tag.append(temp_model.from_map(k1))

        return self

class DescribeCustomerGatewayResponseBodyTagsTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

...
class DescribeExpressConnectTrafficQosQueueResponseBody(DaraModel):
    def __init__(
        self,
        queue_list: List[main_models.DescribeExpressConnectTrafficQosQueueResponseBodyQueueList] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('QueueList') is not None:
            for k1 in m.get('QueueList'):
                temp_model = main_models.DescribeExpressConnectTrafficQosQueueResponseBodyQueueList()
...
class DescribeExpressConnectTrafficQosQueueResponseBodyQueueList(DaraModel):
    def __init__(
        self,
        ...
        queue_name: str = None,
        queue_type: str = None,
        rule_list: List[main_models.DescribeExpressConnectTrafficQosQueueResponseBodyQueueListRuleList] = None,
        status: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RuleList') is not None:
            for k1 in m.get('RuleList'):
                temp_model = main_models.DescribeExpressConnectTrafficQosQueueResponseBodyQueueListRuleList()
...
class DescribeExpressConnectTrafficQosQueueResponseBodyQueueListRuleList(DaraModel):
    def __init__(
        self,
        dst_cidr: str = None,

...
class DescribeFailoverTestJobsResponseBody(DaraModel):
    def __init__(
        self,
        count: int = None,
        failover_test_job_list: List[main_models.DescribeFailoverTestJobsResponseBodyFailoverTestJobList] = None,
    ...
    def validate(self):
        if self.failover_test_job_list:
            for v1 in self.failover_test_job_list:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.failover_test_job_list is not None:
            for k1 in self.failover_test_job_list:
                result['FailoverTestJobList'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FailoverTestJobList') is not None:
            for k1 in m.get('FailoverTestJobList'):
                temp_model = main_models.DescribeFailoverTestJobsResponseBodyFailoverTestJobList()
                self.failover_test_job_list.append(temp_model.from_map(k1))
...
class DescribeFailoverTestJobsResponseBodyFailoverTestJobList(DaraModel):
    def __init__(
        self,

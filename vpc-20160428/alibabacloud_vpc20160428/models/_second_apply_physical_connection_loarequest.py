...
class SecondApplyPhysicalConnectionLOARequest(DaraModel):
    def __init__(
        self,
        bandwidth: int = None,
        ...
        owner_id: int = None,
        pminfo: List[main_models.SecondApplyPhysicalConnectionLOARequestPMInfo] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PMInfo') is not None:
            for k1 in m.get('PMInfo'):
                temp_model = main_models.SecondApplyPhysicalConnectionLOARequestPMInfo()
...
class SecondApplyPhysicalConnectionLOARequestPMInfo(DaraModel):
    def __init__(
        self,

...
class ListTrafficMirrorFiltersRequest(DaraModel):
    def __init__(
        self,
        ...
        tags: List[main_models.ListTrafficMirrorFiltersRequestTags] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.ListTrafficMirrorFiltersRequestTags()
...
class ListTrafficMirrorFiltersRequestTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

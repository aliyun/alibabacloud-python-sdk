...
class DescribeTagKeysResponseBody(DaraModel):
    def __init__(
        ...
        next_token: str = None,
        request_id: str = None,
        tag_keys: main_models.DescribeTagKeysResponseBodyTagKeys = None,
    ):
...
class DescribeTagKeysResponseBodyTagKeys(DaraModel):
    def __init__(
        self,
        tag_key: List[main_models.DescribeTagKeysResponseBodyTagKeysTagKey] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TagKey') is not None:
            for k1 in m.get('TagKey'):
                temp_model = main_models.DescribeTagKeysResponseBodyTagKeysTagKey()
                self.tag_key.append(temp_model.from_map(k1))

        return self

class DescribeTagKeysResponseBodyTagKeysTagKey(DaraModel):
    def __init__(
        self,
        tag_key: str = None,
        type: str = None,

...
class ListAdminKnowledgeBasesResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        items: List[main_models.ListAdminKnowledgeBasesResponseBodyItems] = None,
        message: str = None,
        page: int = None,
        page_size: int = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('items') is not None:
            for k1 in m.get('items'):
                temp_model = main_models.ListAdminKnowledgeBasesResponseBodyItems()
...
class ListAdminKnowledgeBasesResponseBodyItems(DaraModel):
    def __init__(
        self,
        ...
        item_type: str = None,
        name: str = None,
        object_bindings: List[main_models.ListAdminKnowledgeBasesResponseBodyItemsObjectBindings] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('objectBindings') is not None:
            for k1 in m.get('objectBindings'):
                temp_model = main_models.ListAdminKnowledgeBasesResponseBodyItemsObjectBindings()
...
class ListAdminKnowledgeBasesResponseBodyItemsObjectBindings(DaraModel):
    def __init__(
        self,
        graph_name: str = None,
        object_id: str = None,

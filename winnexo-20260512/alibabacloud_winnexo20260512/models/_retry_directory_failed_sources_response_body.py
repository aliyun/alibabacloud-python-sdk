...
class RetryDirectoryFailedSourcesResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        ...
        failed_sources: List[main_models.RetryDirectoryFailedSourcesResponseBodyFailedSources] = None,
        message: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('failedSources') is not None:
            for k1 in m.get('failedSources'):
                temp_model = main_models.RetryDirectoryFailedSourcesResponseBodyFailedSources()
...
class RetryDirectoryFailedSourcesResponseBodyFailedSources(DaraModel):
    def __init__(
        self,
        name: str = None,
        source_id: str = None,

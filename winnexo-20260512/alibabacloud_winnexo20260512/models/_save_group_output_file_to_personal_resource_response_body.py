...
class SaveGroupOutputFileToPersonalResourceResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        request_id: str = None,
        results: List[main_models.SaveGroupOutputFileToPersonalResourceResponseBodyResults] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('results') is not None:
            for k1 in m.get('results'):
                temp_model = main_models.SaveGroupOutputFileToPersonalResourceResponseBodyResults()
                self.results.append(temp_model.from_map(k1))

        return self

class SaveGroupOutputFileToPersonalResourceResponseBodyResults(DaraModel):
    def __init__(
        self,
        error_code: str = None,

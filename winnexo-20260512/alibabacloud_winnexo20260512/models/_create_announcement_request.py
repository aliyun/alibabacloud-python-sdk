...
class CreateAnnouncementRequest(DaraModel):
    def __init__(
        self,
        content: str = None,
        ...
        target_role_codes: List[str] = None,
        target_role_mode: str = None,
        target_tenant_ids: List[int] = None,
        ...
        self.target_role_codes = target_role_codes
        ...
        self.target_tenant_ids = target_tenant_ids
    ...
    def to_map(self):
        ...
        if self.target_role_codes is not None:
            result['targetRoleCodes'] = self.target_role_codes

        if self.target_role_mode is not None:
            result['targetRoleMode'] = self.target_role_mode

        if self.target_tenant_ids is not None:
            result['targetTenantIds'] = self.target_tenant_ids

...
class CreateKnowledgeBaseFeishuDocRequest(DaraModel):
    def __init__(
        self,
        ...
        name: str = None,
        notes: str = None,
        object_bindings: List[main_models.CreateKnowledgeBaseFeishuDocRequestObjectBindings] = None,
        operating_object_name: str = None,
        source_tags: str = None,
        sync_config: main_models.CreateKnowledgeBaseFeishuDocRequestSyncConfig = None,
        tenant_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('objectBindings') is not None:
            for k1 in m.get('objectBindings'):
                temp_model = main_models.CreateKnowledgeBaseFeishuDocRequestObjectBindings()
        ...
        if m.get('syncConfig') is not None:
            temp_model = main_models.CreateKnowledgeBaseFeishuDocRequestSyncConfig()
...
class CreateKnowledgeBaseFeishuDocRequestSyncConfig(DaraModel):
    def __init__(
        self,
        cron: str = None,
        enabled: bool = None,
...
class CreateKnowledgeBaseFeishuDocRequestObjectBindings(DaraModel):
    def __init__(
        self,
        graph_name: str = None,
        object_id: str = None,

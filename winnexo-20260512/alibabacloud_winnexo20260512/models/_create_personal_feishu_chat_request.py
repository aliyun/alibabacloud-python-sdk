...
class CreatePersonalFeishuChatRequest(DaraModel):
    def __init__(
        self,
        chat_id: str = None,
        ...
        tenant_id: str = None,
        update_frequency: main_models.CreatePersonalFeishuChatRequestUpdateFrequency = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('updateFrequency') is not None:
            temp_model = main_models.CreatePersonalFeishuChatRequestUpdateFrequency()
            self.update_frequency = temp_model.from_map(m.get('updateFrequency'))

        return self

class CreatePersonalFeishuChatRequestUpdateFrequency(DaraModel):
    def __init__(
        self,
        cron: str = None,
        enabled: bool = None,

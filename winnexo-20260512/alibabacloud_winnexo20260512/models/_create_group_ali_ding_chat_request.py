...
class CreateGroupAliDingChatRequest(DaraModel):
    def __init__(
        self,
        chat_id: str = None,
        chat_name: str = None,
        ...
        tenant_id: str = None,
        update_frequency: main_models.CreateGroupAliDingChatRequestUpdateFrequency = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('updateFrequency') is not None:
            temp_model = main_models.CreateGroupAliDingChatRequestUpdateFrequency()

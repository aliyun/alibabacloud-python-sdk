...
class SaveGraphDraftBatchDefineShrinkRequest(DaraModel):
    def __init__(
        self,
        draft_change_ids_shrink: str = None,
        graph_name: str = None,
        save_mode: str = None,
        tenant_id: str = None,
        yaml_edit: str = None,
        ...
        self.draft_change_ids_shrink = draft_change_ids_shrink
        # The graph name.
        # 
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        if self.draft_change_ids_shrink is not None:
            result['draftChangeIds'] = self.draft_change_ids_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('draftChangeIds') is not None:
            self.draft_change_ids_shrink = m.get('draftChangeIds')

...
class CreateGroupDingtalkChatRequest(DaraModel):
    def __init__(
        self,
        chat_id: str = None,
        chat_name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('updateFrequency') is not None:
            temp_model = main_models.CreateGroupDingtalkChatRequestUpdateFrequency()
            self.update_frequency = temp_model.from_map(m.get('updateFrequency'))

        return self

class CreateGroupDingtalkChatRequestUpdateFrequency(DaraModel):
    def __init__(
        self,
        cron: str = None,
        enabled: bool = None,

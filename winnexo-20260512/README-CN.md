...
## Alibaba Cloud WinNexo SDK for Python
...
```bash
# 安装 alibabacloud_winnexo20260512
pip install alibabacloud_winnexo20260512
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/winnexo-20260512/ChangeLog.md)中。

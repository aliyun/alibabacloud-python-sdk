...
class UpdateAuthorizationRuleUserAttachmentRequest(DaraModel):
    def __init__(
        self,
        ...
        user_id: str = None,
        validity_period: main_models.UpdateAuthorizationRuleUserAttachmentRequestValidityPeriod = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ValidityPeriod') is not None:
            temp_model = main_models.UpdateAuthorizationRuleUserAttachmentRequestValidityPeriod()
...
class UpdateAuthorizationRuleUserAttachmentRequestValidityPeriod(DaraModel):
    def __init__(
        self,
        end_time: int = None,
        start_time: int = None,

...
class ListNetworkAccessEndpointAvailableZonesResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Zones') is not None:
            for k1 in m.get('Zones'):
                temp_model = main_models.ListNetworkAccessEndpointAvailableZonesResponseBodyZones()
                self.zones.append(temp_model.from_map(k1))

        return self

class ListNetworkAccessEndpointAvailableZonesResponseBodyZones(DaraModel):
    def __init__(
        self,
        local_name: str = None,
        zone_id: str = None,

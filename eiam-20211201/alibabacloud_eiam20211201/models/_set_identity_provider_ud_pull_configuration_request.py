...
class SetIdentityProviderUdPullConfigurationRequest(DaraModel):
    def __init__(
        self,
        ...
        ldap_ud_pull_config: main_models.SetIdentityProviderUdPullConfigurationRequestLdapUdPullConfig = None,
        periodic_sync_config: main_models.SetIdentityProviderUdPullConfigurationRequestPeriodicSyncConfig = None,
        periodic_sync_status: str = None,
        pull_protected_rule: main_models.SetIdentityProviderUdPullConfigurationRequestPullProtectedRule = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LdapUdPullConfig') is not None:
            temp_model = main_models.SetIdentityProviderUdPullConfigurationRequestLdapUdPullConfig()
            self.ldap_ud_pull_config = temp_model.from_map(m.get('LdapUdPullConfig'))

        if m.get('PeriodicSyncConfig') is not None:
            temp_model = main_models.SetIdentityProviderUdPullConfigurationRequestPeriodicSyncConfig()
        ...
        if m.get('PullProtectedRule') is not None:
            temp_model = main_models.SetIdentityProviderUdPullConfigurationRequestPullProtectedRule()
            self.pull_protected_rule = temp_model.from_map(m.get('PullProtectedRule'))

        if m.get('UdSyncScopeConfig') is not None:
            temp_model = main_models.SetIdentityProviderUdPullConfigurationRequestUdSyncScopeConfig()
            self.ud_sync_scope_config = temp_model.from_map(m.get('UdSyncScopeConfig'))

        return self

class SetIdentityProviderUdPullConfigurationRequestUdSyncScopeConfig(DaraModel):
    def __init__(
        self,
...
class SetIdentityProviderUdPullConfigurationRequestPullProtectedRule(DaraModel):
    def __init__(
        self,
...
class SetIdentityProviderUdPullConfigurationRequestPeriodicSyncConfig(DaraModel):
    def __init__(
        self,
...
class SetIdentityProviderUdPullConfigurationRequestLdapUdPullConfig(DaraModel):
    def __init__(
        self,

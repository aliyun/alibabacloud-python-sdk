...
class ListApplicationsForOrganizationalUnitResponseBody(DaraModel):
    def __init__(
        self,
        applications: List[main_models.ListApplicationsForOrganizationalUnitResponseBodyApplications] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Applications') is not None:
            for k1 in m.get('Applications'):
                temp_model = main_models.ListApplicationsForOrganizationalUnitResponseBodyApplications()
...
class ListApplicationsForOrganizationalUnitResponseBodyApplications(DaraModel):
    def __init__(
        self,

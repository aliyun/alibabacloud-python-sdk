...
class GetCredentialResponseBody(DaraModel):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Credential') is not None:
            temp_model = main_models.GetCredentialResponseBodyCredential()
...
class GetCredentialResponseBodyCredential(DaraModel):
    def __init__(
        self,
        create_time: int = None,
        credential_content: main_models.GetCredentialResponseBodyCredentialCredentialContent = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CredentialContent') is not None:
            temp_model = main_models.GetCredentialResponseBodyCredentialCredentialContent()
...
class GetCredentialResponseBodyCredentialCredentialContent(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OAuthClientContent') is not None:
            temp_model = main_models.GetCredentialResponseBodyCredentialCredentialContentOAuthClientContent()
            self.oauth_client_content = temp_model.from_map(m.get('OAuthClientContent'))

        return self

class GetCredentialResponseBodyCredentialCredentialContentOAuthClientContent(DaraModel):
    def __init__(
        self,
        client_id: str = None,
    ):

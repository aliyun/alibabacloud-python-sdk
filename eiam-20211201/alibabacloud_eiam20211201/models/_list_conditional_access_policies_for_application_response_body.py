...
class ListConditionalAccessPoliciesForApplicationResponseBody(DaraModel):
    def __init__(
        self,
        conditional_access_policies: List[main_models.ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPolicies] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConditionalAccessPolicies') is not None:
            for k1 in m.get('ConditionalAccessPolicies'):
                temp_model = main_models.ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPolicies()
...
class ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPolicies(DaraModel):
    def __init__(
        self,
        conditional_access_policy_id: str = None,
        conditional_access_policy_name: str = None,
        conditional_access_policy_type: str = None,
        conditions_config: main_models.ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPoliciesConditionsConfig = None,
        create_time: int = None,
        decision_config: main_models.ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPoliciesDecisionConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConditionsConfig') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPoliciesConditionsConfig()
        ...
        if m.get('DecisionConfig') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPoliciesDecisionConfig()
...
class ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPoliciesDecisionConfig(DaraModel):
    def __init__(
        self,
...
class ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPoliciesConditionsConfig(DaraModel):
    def __init__(
        self,
        applications: main_models.ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPoliciesConditionsConfigApplications = None,
        network_zones: main_models.ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPoliciesConditionsConfigNetworkZones = None,
        users: main_models.ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPoliciesConditionsConfigUsers = None,
    ):
        # 条件访问策略目标应用
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Applications') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPoliciesConditionsConfigApplications()
            self.applications = temp_model.from_map(m.get('Applications'))

        if m.get('NetworkZones') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPoliciesConditionsConfigNetworkZones()
            self.network_zones = temp_model.from_map(m.get('NetworkZones'))

        if m.get('Users') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPoliciesConditionsConfigUsers()
            self.users = temp_model.from_map(m.get('Users'))

        return self

class ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPoliciesConditionsConfigUsers(DaraModel):
    def __init__(
        self,
...
class ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPoliciesConditionsConfigNetworkZones(DaraModel):
    def __init__(
        self,
...
class ListConditionalAccessPoliciesForApplicationResponseBodyConditionalAccessPoliciesConditionsConfigApplications(DaraModel):
    def __init__(
        self,

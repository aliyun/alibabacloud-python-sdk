...
class ListEiamRegionsResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Regions') is not None:
            for k1 in m.get('Regions'):
                temp_model = main_models.ListEiamRegionsResponseBodyRegions()
...
class ListEiamRegionsResponseBodyRegions(DaraModel):
    def __init__(
        self,
        local_name: str = None,
        region_id: str = None,

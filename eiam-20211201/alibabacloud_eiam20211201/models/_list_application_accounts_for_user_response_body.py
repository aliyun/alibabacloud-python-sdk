...
class ListApplicationAccountsForUserResponseBody(DaraModel):
    def __init__(
        self,
        application_accounts: List[main_models.ListApplicationAccountsForUserResponseBodyApplicationAccounts] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApplicationAccounts') is not None:
            for k1 in m.get('ApplicationAccounts'):
                temp_model = main_models.ListApplicationAccountsForUserResponseBodyApplicationAccounts()
...
class ListApplicationAccountsForUserResponseBodyApplicationAccounts(DaraModel):
    def __init__(
        self,

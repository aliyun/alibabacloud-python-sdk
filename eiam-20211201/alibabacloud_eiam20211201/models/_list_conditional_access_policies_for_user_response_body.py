...
class ListConditionalAccessPoliciesForUserResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConditionalAccessPolicies') is not None:
            for k1 in m.get('ConditionalAccessPolicies'):
                temp_model = main_models.ListConditionalAccessPoliciesForUserResponseBodyConditionalAccessPolicies()
...
class ListConditionalAccessPoliciesForUserResponseBodyConditionalAccessPolicies(DaraModel):
    def __init__(
        self,
        conditional_access_policy_id: str = None,
        conditional_access_policy_name: str = None,
        conditional_access_policy_type: str = None,
        conditions_config: main_models.ListConditionalAccessPoliciesForUserResponseBodyConditionalAccessPoliciesConditionsConfig = None,
        create_time: int = None,
        decision_config: main_models.ListConditionalAccessPoliciesForUserResponseBodyConditionalAccessPoliciesDecisionConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConditionsConfig') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesForUserResponseBodyConditionalAccessPoliciesConditionsConfig()
        ...
        if m.get('DecisionConfig') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesForUserResponseBodyConditionalAccessPoliciesDecisionConfig()
...
class ListConditionalAccessPoliciesForUserResponseBodyConditionalAccessPoliciesDecisionConfig(DaraModel):
    def __init__(
        self,
...
class ListConditionalAccessPoliciesForUserResponseBodyConditionalAccessPoliciesConditionsConfig(DaraModel):
    def __init__(
        self,
        applications: main_models.ListConditionalAccessPoliciesForUserResponseBodyConditionalAccessPoliciesConditionsConfigApplications = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Applications') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesForUserResponseBodyConditionalAccessPoliciesConditionsConfigApplications()
            self.applications = temp_model.from_map(m.get('Applications'))

        if m.get('NetworkZones') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesForUserResponseBodyConditionalAccessPoliciesConditionsConfigNetworkZones()
            self.network_zones = temp_model.from_map(m.get('NetworkZones'))

        if m.get('Users') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesForUserResponseBodyConditionalAccessPoliciesConditionsConfigUsers()
            self.users = temp_model.from_map(m.get('Users'))

        return self

class ListConditionalAccessPoliciesForUserResponseBodyConditionalAccessPoliciesConditionsConfigUsers(DaraModel):
    def __init__(
        self,
...
class ListConditionalAccessPoliciesForUserResponseBodyConditionalAccessPoliciesConditionsConfigNetworkZones(DaraModel):
    def __init__(
        self,
...
class ListConditionalAccessPoliciesForUserResponseBodyConditionalAccessPoliciesConditionsConfigApplications(DaraModel):
    def __init__(
        self,

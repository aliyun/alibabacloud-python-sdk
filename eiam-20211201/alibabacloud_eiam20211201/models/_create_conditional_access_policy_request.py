...
class CreateConditionalAccessPolicyRequest(DaraModel):
    def __init__(
        self,
        client_token: str = None,
        conditional_access_policy_name: str = None,
        conditional_access_policy_type: str = None,
        conditions_config: main_models.CreateConditionalAccessPolicyRequestConditionsConfig = None,
        decision_config: main_models.CreateConditionalAccessPolicyRequestDecisionConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConditionsConfig') is not None:
            temp_model = main_models.CreateConditionalAccessPolicyRequestConditionsConfig()
            self.conditions_config = temp_model.from_map(m.get('ConditionsConfig'))

        if m.get('DecisionConfig') is not None:
            temp_model = main_models.CreateConditionalAccessPolicyRequestDecisionConfig()
...
class CreateConditionalAccessPolicyRequestDecisionConfig(DaraModel):
    def __init__(
        self,
...
class CreateConditionalAccessPolicyRequestConditionsConfig(DaraModel):
    def __init__(
        self,
        applications: main_models.CreateConditionalAccessPolicyRequestConditionsConfigApplications = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Applications') is not None:
            temp_model = main_models.CreateConditionalAccessPolicyRequestConditionsConfigApplications()
            self.applications = temp_model.from_map(m.get('Applications'))

        if m.get('NetworkZones') is not None:
            temp_model = main_models.CreateConditionalAccessPolicyRequestConditionsConfigNetworkZones()
            self.network_zones = temp_model.from_map(m.get('NetworkZones'))

        if m.get('Users') is not None:
            temp_model = main_models.CreateConditionalAccessPolicyRequestConditionsConfigUsers()
            self.users = temp_model.from_map(m.get('Users'))

        return self

class CreateConditionalAccessPolicyRequestConditionsConfigUsers(DaraModel):
    def __init__(
        self,
...
class CreateConditionalAccessPolicyRequestConditionsConfigNetworkZones(DaraModel):
    def __init__(
        self,
...
class CreateConditionalAccessPolicyRequestConditionsConfigApplications(DaraModel):
    def __init__(
        self,

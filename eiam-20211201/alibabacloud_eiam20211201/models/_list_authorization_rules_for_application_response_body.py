...
class ListAuthorizationRulesForApplicationResponseBody(DaraModel):
    def __init__(
        self,
        authorization_rules: List[main_models.ListAuthorizationRulesForApplicationResponseBodyAuthorizationRules] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AuthorizationRules') is not None:
            for k1 in m.get('AuthorizationRules'):
                temp_model = main_models.ListAuthorizationRulesForApplicationResponseBodyAuthorizationRules()
...
class ListAuthorizationRulesForApplicationResponseBodyAuthorizationRules(DaraModel):
    def __init__(
        self,
        authorization_rule_id: str = None,
        instance_id: str = None,
        validity_period: main_models.ListAuthorizationRulesForApplicationResponseBodyAuthorizationRulesValidityPeriod = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ValidityPeriod') is not None:
            temp_model = main_models.ListAuthorizationRulesForApplicationResponseBodyAuthorizationRulesValidityPeriod()
...
class ListAuthorizationRulesForApplicationResponseBodyAuthorizationRulesValidityPeriod(DaraModel):
    def __init__(
        self,
        end_time: int = None,
        start_time: int = None,

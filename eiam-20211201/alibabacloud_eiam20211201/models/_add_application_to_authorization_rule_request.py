...
class AddApplicationToAuthorizationRuleRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ValidityPeriod') is not None:
            temp_model = main_models.AddApplicationToAuthorizationRuleRequestValidityPeriod()
...
class AddApplicationToAuthorizationRuleRequestValidityPeriod(DaraModel):
    def __init__(
        self,
        end_time: int = None,
        start_time: int = None,

...
class ListAuthorizationResourcesRequest(DaraModel):
    def __init__(
        self,
        authorization_rule_id: str = None,
        filter: List[main_models.ListAuthorizationResourcesRequestFilter] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Filter') is not None:
            for k1 in m.get('Filter'):
                temp_model = main_models.ListAuthorizationResourcesRequestFilter()
...
class ListAuthorizationResourcesRequestFilter(DaraModel):
    def __init__(
        self,
        name: str = None,
        value: List[str] = None,

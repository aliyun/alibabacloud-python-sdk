...
class CreateApplicationFederatedCredentialRequest(DaraModel):
    def __init__(
        ...
        oidc_verification_config: main_models.CreateApplicationFederatedCredentialRequestOidcVerificationConfig = None,
        pkcs_7verification_config: main_models.CreateApplicationFederatedCredentialRequestPkcs7VerificationConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OidcVerificationConfig') is not None:
            temp_model = main_models.CreateApplicationFederatedCredentialRequestOidcVerificationConfig()
        ...
        if m.get('Pkcs7VerificationConfig') is not None:
            temp_model = main_models.CreateApplicationFederatedCredentialRequestPkcs7VerificationConfig()
...
class CreateApplicationFederatedCredentialRequestPkcs7VerificationConfig(DaraModel):
    def __init__(
        self,
...
class CreateApplicationFederatedCredentialRequestOidcVerificationConfig(DaraModel):
    def __init__(
        self,
        azure_vm_config: main_models.CreateApplicationFederatedCredentialRequestOidcVerificationConfigAzureVmConfig = None,
        gcp_vm_config: main_models.CreateApplicationFederatedCredentialRequestOidcVerificationConfigGcpVmConfig = None,
        generic_config: main_models.CreateApplicationFederatedCredentialRequestOidcVerificationConfigGenericConfig = None,
        kubernetes_config: main_models.CreateApplicationFederatedCredentialRequestOidcVerificationConfigKubernetesConfig = None,
        profile: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AzureVmConfig') is not None:
            temp_model = main_models.CreateApplicationFederatedCredentialRequestOidcVerificationConfigAzureVmConfig()
            self.azure_vm_config = temp_model.from_map(m.get('AzureVmConfig'))

        if m.get('GcpVmConfig') is not None:
            temp_model = main_models.CreateApplicationFederatedCredentialRequestOidcVerificationConfigGcpVmConfig()
            self.gcp_vm_config = temp_model.from_map(m.get('GcpVmConfig'))

        if m.get('GenericConfig') is not None:
            temp_model = main_models.CreateApplicationFederatedCredentialRequestOidcVerificationConfigGenericConfig()
            self.generic_config = temp_model.from_map(m.get('GenericConfig'))

        if m.get('KubernetesConfig') is not None:
            temp_model = main_models.CreateApplicationFederatedCredentialRequestOidcVerificationConfigKubernetesConfig()
...
class CreateApplicationFederatedCredentialRequestOidcVerificationConfigKubernetesConfig(DaraModel):
    def __init__(
        self,
        namespace: str = None,
...
class CreateApplicationFederatedCredentialRequestOidcVerificationConfigGenericConfig(DaraModel):
    def __init__(
        self,
        subject: str = None,
    ):
...
class CreateApplicationFederatedCredentialRequestOidcVerificationConfigGcpVmConfig(DaraModel):
    def __init__(
        self,
        instance_ids: List[str] = None,
        project_id: str = None,
...
class CreateApplicationFederatedCredentialRequestOidcVerificationConfigAzureVmConfig(DaraModel):
    def __init__(
        self,

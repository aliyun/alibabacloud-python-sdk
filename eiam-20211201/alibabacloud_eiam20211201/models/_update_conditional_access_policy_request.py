...
class UpdateConditionalAccessPolicyRequest(DaraModel):
    def __init__(
        self,
        client_token: str = None,
        conditional_access_policy_id: str = None,
        conditional_access_policy_name: str = None,
        conditions_config: main_models.UpdateConditionalAccessPolicyRequestConditionsConfig = None,
        decision_config: main_models.UpdateConditionalAccessPolicyRequestDecisionConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConditionsConfig') is not None:
            temp_model = main_models.UpdateConditionalAccessPolicyRequestConditionsConfig()
            self.conditions_config = temp_model.from_map(m.get('ConditionsConfig'))

        if m.get('DecisionConfig') is not None:
            temp_model = main_models.UpdateConditionalAccessPolicyRequestDecisionConfig()
...
class UpdateConditionalAccessPolicyRequestDecisionConfig(DaraModel):
    def __init__(
        self,
...
class UpdateConditionalAccessPolicyRequestConditionsConfig(DaraModel):
    def __init__(
        self,
        applications: main_models.UpdateConditionalAccessPolicyRequestConditionsConfigApplications = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Applications') is not None:
            temp_model = main_models.UpdateConditionalAccessPolicyRequestConditionsConfigApplications()
            self.applications = temp_model.from_map(m.get('Applications'))

        if m.get('NetworkZones') is not None:
            temp_model = main_models.UpdateConditionalAccessPolicyRequestConditionsConfigNetworkZones()
            self.network_zones = temp_model.from_map(m.get('NetworkZones'))

        if m.get('Users') is not None:
            temp_model = main_models.UpdateConditionalAccessPolicyRequestConditionsConfigUsers()
            self.users = temp_model.from_map(m.get('Users'))

        return self

class UpdateConditionalAccessPolicyRequestConditionsConfigUsers(DaraModel):
    def __init__(
        self,
...
class UpdateConditionalAccessPolicyRequestConditionsConfigNetworkZones(DaraModel):
    def __init__(
        self,
...
class UpdateConditionalAccessPolicyRequestConditionsConfigApplications(DaraModel):
    def __init__(
        self,

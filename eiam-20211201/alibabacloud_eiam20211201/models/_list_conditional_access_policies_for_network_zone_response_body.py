...
class ListConditionalAccessPoliciesForNetworkZoneResponseBody(DaraModel):
    def __init__(
        self,
        conditional_access_policies: List[main_models.ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPolicies] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConditionalAccessPolicies') is not None:
            for k1 in m.get('ConditionalAccessPolicies'):
                temp_model = main_models.ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPolicies()
...
class ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPolicies(DaraModel):
    def __init__(
        self,
        conditional_access_policy_id: str = None,
        conditional_access_policy_name: str = None,
        conditional_access_policy_type: str = None,
        conditions_config: main_models.ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPoliciesConditionsConfig = None,
        create_time: int = None,
        decision_config: main_models.ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPoliciesDecisionConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConditionsConfig') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPoliciesConditionsConfig()
        ...
        if m.get('DecisionConfig') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPoliciesDecisionConfig()
...
class ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPoliciesDecisionConfig(DaraModel):
    def __init__(
        self,
...
class ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPoliciesConditionsConfig(DaraModel):
    def __init__(
        self,
        applications: main_models.ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPoliciesConditionsConfigApplications = None,
        network_zones: main_models.ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPoliciesConditionsConfigNetworkZones = None,
        users: main_models.ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPoliciesConditionsConfigUsers = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Applications') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPoliciesConditionsConfigApplications()
            self.applications = temp_model.from_map(m.get('Applications'))

        if m.get('NetworkZones') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPoliciesConditionsConfigNetworkZones()
            self.network_zones = temp_model.from_map(m.get('NetworkZones'))

        if m.get('Users') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPoliciesConditionsConfigUsers()
            self.users = temp_model.from_map(m.get('Users'))

        return self

class ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPoliciesConditionsConfigUsers(DaraModel):
    def __init__(
        self,
...
class ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPoliciesConditionsConfigNetworkZones(DaraModel):
    def __init__(
        self,
...
class ListConditionalAccessPoliciesForNetworkZoneResponseBodyConditionalAccessPoliciesConditionsConfigApplications(DaraModel):
    def __init__(
        self,

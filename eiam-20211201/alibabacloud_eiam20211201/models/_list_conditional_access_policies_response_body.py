...
class ListConditionalAccessPoliciesResponseBody(DaraModel):
    def __init__(
        self,
        conditional_access_policies: List[main_models.ListConditionalAccessPoliciesResponseBodyConditionalAccessPolicies] = None,
        next_token: str = None,
    ...
    def validate(self):
        if self.conditional_access_policies:
            for v1 in self.conditional_access_policies:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.conditional_access_policies is not None:
            for k1 in self.conditional_access_policies:
                result['ConditionalAccessPolicies'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConditionalAccessPolicies') is not None:
            for k1 in m.get('ConditionalAccessPolicies'):
                temp_model = main_models.ListConditionalAccessPoliciesResponseBodyConditionalAccessPolicies()
                self.conditional_access_policies.append(temp_model.from_map(k1))
...
class ListConditionalAccessPoliciesResponseBodyConditionalAccessPolicies(DaraModel):
    def __init__(
        self,
        conditional_access_policy_id: str = None,
        conditional_access_policy_name: str = None,
        conditional_access_policy_type: str = None,
        conditions_config: main_models.ListConditionalAccessPoliciesResponseBodyConditionalAccessPoliciesConditionsConfig = None,
        create_time: int = None,
        decision_config: main_models.ListConditionalAccessPoliciesResponseBodyConditionalAccessPoliciesDecisionConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConditionsConfig') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesResponseBodyConditionalAccessPoliciesConditionsConfig()
        ...
        if m.get('DecisionConfig') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesResponseBodyConditionalAccessPoliciesDecisionConfig()
...
class ListConditionalAccessPoliciesResponseBodyConditionalAccessPoliciesDecisionConfig(DaraModel):
    def __init__(
        self,
...
class ListConditionalAccessPoliciesResponseBodyConditionalAccessPoliciesConditionsConfig(DaraModel):
    def __init__(
        self,
        applications: main_models.ListConditionalAccessPoliciesResponseBodyConditionalAccessPoliciesConditionsConfigApplications = None,
        network_zones: main_models.ListConditionalAccessPoliciesResponseBodyConditionalAccessPoliciesConditionsConfigNetworkZones = None,
        users: main_models.ListConditionalAccessPoliciesResponseBodyConditionalAccessPoliciesConditionsConfigUsers = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Applications') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesResponseBodyConditionalAccessPoliciesConditionsConfigApplications()
            self.applications = temp_model.from_map(m.get('Applications'))

        if m.get('NetworkZones') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesResponseBodyConditionalAccessPoliciesConditionsConfigNetworkZones()
            self.network_zones = temp_model.from_map(m.get('NetworkZones'))

        if m.get('Users') is not None:
            temp_model = main_models.ListConditionalAccessPoliciesResponseBodyConditionalAccessPoliciesConditionsConfigUsers()
            self.users = temp_model.from_map(m.get('Users'))

        return self

class ListConditionalAccessPoliciesResponseBodyConditionalAccessPoliciesConditionsConfigUsers(DaraModel):
    def __init__(
        self,
...
class ListConditionalAccessPoliciesResponseBodyConditionalAccessPoliciesConditionsConfigNetworkZones(DaraModel):
    def __init__(
        self,
...
class ListConditionalAccessPoliciesResponseBodyConditionalAccessPoliciesConditionsConfigApplications(DaraModel):
    def __init__(
        self,

...
class UpdateAuthorizationRuleGroupAttachmentRequest(DaraModel):
    def __init__(
        self,
        ...
        validity_period: main_models.UpdateAuthorizationRuleGroupAttachmentRequestValidityPeriod = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ValidityPeriod') is not None:
            temp_model = main_models.UpdateAuthorizationRuleGroupAttachmentRequestValidityPeriod()
...
class UpdateAuthorizationRuleGroupAttachmentRequestValidityPeriod(DaraModel):
    def __init__(
        self,
        end_time: int = None,
        start_time: int = None,

...
```bash
# 安装 alibabacloud_bssopenapi20230930
pip install alibabacloud_bssopenapi20230930
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/bssopenapi-20230930/ChangeLog.md)中。

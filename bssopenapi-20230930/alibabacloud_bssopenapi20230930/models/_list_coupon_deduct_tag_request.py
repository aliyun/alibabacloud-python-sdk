...
class ListCouponDeductTagRequest(DaraModel):
    def __init__(
        self,
        coupon_id: str = None,
        ec_id_account_ids: List[main_models.ListCouponDeductTagRequestEcIdAccountIds] = None,
        nbid: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EcIdAccountIds') is not None:
            for k1 in m.get('EcIdAccountIds'):
                temp_model = main_models.ListCouponDeductTagRequestEcIdAccountIds()
...
class ListCouponDeductTagRequestEcIdAccountIds(DaraModel):
    def __init__(
        self,

...
class DescribeFrInstancesRequest(DaraModel):
    def __init__(
        self,
        capacity_type: str = None,
        commodity_code: str = None,
        cycle_type: str = None,
        ec_id_account_ids: List[main_models.DescribeFrInstancesRequestEcIdAccountIds] = None,
        end_time: int = None,
        group: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EcIdAccountIds') is not None:
            for k1 in m.get('EcIdAccountIds'):
                temp_model = main_models.DescribeFrInstancesRequestEcIdAccountIds()
...
class DescribeFrInstancesRequestEcIdAccountIds(DaraModel):
    def __init__(
        self,

...
class CreateCostCenterRuleRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FilterExpression') is not None:
            temp_model = main_models.CreateCostCenterRuleRequestFilterExpression()
...
class CreateCostCenterRuleRequestFilterExpression(DaraModel):
    def __init__(
        self,
        expression_type: str = None,
        filter_values: main_models.CreateCostCenterRuleRequestFilterExpressionFilterValues = None,
        operand: Any = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FilterValues') is not None:
            temp_model = main_models.CreateCostCenterRuleRequestFilterExpressionFilterValues()
...
class CreateCostCenterRuleRequestFilterExpressionFilterValues(DaraModel):
    def __init__(
        self,
        code: str = None,
        code_name: str = None,

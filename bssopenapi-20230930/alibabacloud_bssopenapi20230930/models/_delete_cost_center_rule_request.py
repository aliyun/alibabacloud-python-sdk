...
class DeleteCostCenterRuleRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FilterExpression') is not None:
            temp_model = main_models.DeleteCostCenterRuleRequestFilterExpression()
...
class DeleteCostCenterRuleRequestFilterExpression(DaraModel):
    def __init__(
        self,
        expression_type: str = None,
        filter_values: main_models.DeleteCostCenterRuleRequestFilterExpressionFilterValues = None,
        operand: Any = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FilterValues') is not None:
            temp_model = main_models.DeleteCostCenterRuleRequestFilterExpressionFilterValues()
...
class DeleteCostCenterRuleRequestFilterExpressionFilterValues(DaraModel):
    def __init__(
        self,
        code: str = None,
        code_name: str = None,

...
class DescribeBudgetsResponseBody(DaraModel):
    def __init__(
        self,
        current_page: int = None,
        data: List[main_models.DescribeBudgetsResponseBodyData] = None,
        page_size: int = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.DescribeBudgetsResponseBodyData()
...
class DescribeBudgetsResponseBodyData(DaraModel):
    def __init__(
        self,
        ...
        cycle_quota: List[main_models.DescribeBudgetsResponseBodyDataCycleQuota] = None,
        cycle_start_period: str = None,
        cycle_type: str = None,
        ec_id_account_ids_filter: main_models.DescribeBudgetsResponseBodyDataEcIdAccountIdsFilter = None,
        expire_status: str = None,
        metric: str = None,
        query_filter: List[main_models.DescribeBudgetsResponseBodyDataQueryFilter] = None,
        quota: str = None,
        quota_type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CycleQuota') is not None:
            for k1 in m.get('CycleQuota'):
                temp_model = main_models.DescribeBudgetsResponseBodyDataCycleQuota()
        ...
        if m.get('EcIdAccountIdsFilter') is not None:
            temp_model = main_models.DescribeBudgetsResponseBodyDataEcIdAccountIdsFilter()
        ...
        if m.get('QueryFilter') is not None:
            for k1 in m.get('QueryFilter'):
                temp_model = main_models.DescribeBudgetsResponseBodyDataQueryFilter()
        ...
        if m.get('WarnConfs') is not None:
            for k1 in m.get('WarnConfs'):
                temp_model = main_models.DescribeBudgetsResponseBodyDataWarnConfs()
                self.warn_confs.append(temp_model.from_map(k1))

        return self

class DescribeBudgetsResponseBodyDataWarnConfs(DaraModel):
    def __init__(
        self,
        comment: str = None,
...
class DescribeBudgetsResponseBodyDataQueryFilter(DaraModel):
    def __init__(
        self,
        code: str = None,
...
class DescribeBudgetsResponseBodyDataEcIdAccountIdsFilter(DaraModel):
    def __init__(
        self,
...
class DescribeBudgetsResponseBodyDataCycleQuota(DaraModel):
    def __init__(
        self,

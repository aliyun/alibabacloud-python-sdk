...
class GetSavingPlanDeductableCommodityRequest(DaraModel):
    def __init__(
        self,
        ec_id_account_ids: List[main_models.GetSavingPlanDeductableCommodityRequestEcIdAccountIds] = None,
        nbid: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EcIdAccountIds') is not None:
            for k1 in m.get('EcIdAccountIds'):
                temp_model = main_models.GetSavingPlanDeductableCommodityRequestEcIdAccountIds()
...
class GetSavingPlanDeductableCommodityRequestEcIdAccountIds(DaraModel):
    def __init__(
        self,

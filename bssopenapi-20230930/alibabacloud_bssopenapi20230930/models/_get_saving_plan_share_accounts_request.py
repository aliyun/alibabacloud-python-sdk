...
class GetSavingPlanShareAccountsRequest(DaraModel):
    def __init__(
        self,
        current_page: int = None,
        ec_id_account_ids: List[main_models.GetSavingPlanShareAccountsRequestEcIdAccountIds] = None,
        nbid: str = None,
        page_size: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EcIdAccountIds') is not None:
            for k1 in m.get('EcIdAccountIds'):
                temp_model = main_models.GetSavingPlanShareAccountsRequestEcIdAccountIds()
...
class GetSavingPlanShareAccountsRequestEcIdAccountIds(DaraModel):
    def __init__(
        self,

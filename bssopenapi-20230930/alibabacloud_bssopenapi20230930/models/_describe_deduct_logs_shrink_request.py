...
class DescribeDeductLogsShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        page_num: int = None,
        page_size: int = None,
        relation_account_ids_shrink: str = None,
    ):
        ...
        self.relation_account_ids_shrink = relation_account_ids_shrink
    ...
    def to_map(self):
        ...
        if self.relation_account_ids_shrink is not None:
            result['RelationAccountIds'] = self.relation_account_ids_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RelationAccountIds') is not None:
            self.relation_account_ids_shrink = m.get('RelationAccountIds')

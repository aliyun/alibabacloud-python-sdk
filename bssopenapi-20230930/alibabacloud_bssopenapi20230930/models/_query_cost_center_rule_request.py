...
class QueryCostCenterRuleRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EcIdAccountIds') is not None:
            for k1 in m.get('EcIdAccountIds'):
                temp_model = main_models.QueryCostCenterRuleRequestEcIdAccountIds()
...
class QueryCostCenterRuleRequestEcIdAccountIds(DaraModel):
    def __init__(
        self,

...
class CreateCostCenterRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CostCenterEntityList') is not None:
            for k1 in m.get('CostCenterEntityList'):
                temp_model = main_models.CreateCostCenterRequestCostCenterEntityList()
...
class CreateCostCenterRequestCostCenterEntityList(DaraModel):
    def __init__(
        self,

...
class ListUserSolutionsResponseBody(DaraModel):
    def __init__(
        self,
        current_page_num: int = None,
        data: List[main_models.ListUserSolutionsResponseBodyData] = None,
        page_size: int = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListUserSolutionsResponseBodyData()
...
class ListUserSolutionsResponseBodyData(DaraModel):
    def __init__(
        self,
        biz_id: str = None,
        biz_type: str = None,

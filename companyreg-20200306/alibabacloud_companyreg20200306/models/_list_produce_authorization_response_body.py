...
class ListProduceAuthorizationResponseBody(DaraModel):
    def __init__(
        self,
        current_page_num: int = None,
        data: List[main_models.ListProduceAuthorizationResponseBodyData] = None,
        page_size: int = None,
        request_id: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListProduceAuthorizationResponseBodyData()
...
class ListProduceAuthorizationResponseBodyData(DaraModel):
    def __init__(
        self,

...
class GetImageModerationResultResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        end_time: str = None,
        event_id: str = None,
        message: str = None,
        moderation_result: main_models.GetImageModerationResultResponseBodyModerationResult = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ModerationResult') is not None:
            temp_model = main_models.GetImageModerationResultResponseBodyModerationResult()
...
class GetImageModerationResultResponseBodyModerationResult(DaraModel):
    def __init__(
        self,
        categories: List[str] = None,
        frames: main_models.GetImageModerationResultResponseBodyModerationResultFrames = None,
        suggestion: str = None,
        uri: str = None,
    ):
        # List of categories.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Frames') is not None:
            temp_model = main_models.GetImageModerationResultResponseBodyModerationResultFrames()
...
class GetImageModerationResultResponseBodyModerationResultFrames(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BlockFrames') is not None:
            for k1 in m.get('BlockFrames'):
                temp_model = main_models.GetImageModerationResultResponseBodyModerationResultFramesBlockFrames()
...
class GetImageModerationResultResponseBodyModerationResultFramesBlockFrames(DaraModel):
    def __init__(
        self,
        label: str = None,
        offset: int = None,

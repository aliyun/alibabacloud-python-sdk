...
class UpdateBatchRequest(DaraModel):
    def __init__(
        self,
        actions: List[main_models.UpdateBatchRequestActions] = None,
        id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Actions') is not None:
            for k1 in m.get('Actions'):
                temp_model = main_models.UpdateBatchRequestActions()
...
class UpdateBatchRequestActions(DaraModel):
    def __init__(
        self,
        name: str = None,

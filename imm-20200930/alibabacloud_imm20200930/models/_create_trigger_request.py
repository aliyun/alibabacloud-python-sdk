...
class CreateTriggerRequest(DaraModel):
    def __init__(
        self,
        actions: List[main_models.CreateTriggerRequestActions] = None,
        input: main_models.Input = None,
        notification: main_models.CreateTriggerRequestNotification = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Actions') is not None:
            for k1 in m.get('Actions'):
                temp_model = main_models.CreateTriggerRequestActions()
        ...
        if m.get('Notification') is not None:
            temp_model = main_models.CreateTriggerRequestNotification()
...
class CreateTriggerRequestNotification(DaraModel):
    def __init__(
        self,
...
class CreateTriggerRequestActions(DaraModel):
    def __init__(
        self,

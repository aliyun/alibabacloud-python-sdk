...
class CreateOfficeConversionTaskRequest(DaraModel):
    def __init__(
        self,
        ...
        source_uri: str = None,
        sources: List[main_models.CreateOfficeConversionTaskRequestSources] = None,
        start_page: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Sources') is not None:
            for k1 in m.get('Sources'):
                temp_model = main_models.CreateOfficeConversionTaskRequestSources()
        ...
        if m.get('TrimPolicy') is not None:
            temp_model = main_models.TrimPolicy()
            self.trim_policy = temp_model.from_map(m.get('TrimPolicy'))
...
class CreateOfficeConversionTaskRequestSources(DaraModel):
    def __init__(
        self,
        rotate: int = None,
        uri: str = None,

...
class EnableResourceDirectoryResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        resource_directory: main_models.EnableResourceDirectoryResponseBodyResourceDirectory = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceDirectory') is not None:
            temp_model = main_models.EnableResourceDirectoryResponseBodyResourceDirectory()
            self.resource_directory = temp_model.from_map(m.get('ResourceDirectory'))

        return self

class EnableResourceDirectoryResponseBodyResourceDirectory(DaraModel):
    def __init__(
        self,

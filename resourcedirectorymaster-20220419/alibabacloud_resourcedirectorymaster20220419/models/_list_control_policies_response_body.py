...
class ListControlPoliciesResponseBodyControlPoliciesControlPolicy(DaraModel):
    def __init__(
        ...
        tags: main_models.ListControlPoliciesResponseBodyControlPoliciesControlPolicyTags = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            temp_model = main_models.ListControlPoliciesResponseBodyControlPoliciesControlPolicyTags()
...
class ListControlPoliciesResponseBodyControlPoliciesControlPolicyTags(DaraModel):
    def __init__(
        self,
        tag: List[main_models.ListControlPoliciesResponseBodyControlPoliciesControlPolicyTagsTag] = None,
    ):
        self.tag = tag
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.ListControlPoliciesResponseBodyControlPoliciesControlPolicyTagsTag()
                self.tag.append(temp_model.from_map(k1))

        return self

class ListControlPoliciesResponseBodyControlPoliciesControlPolicyTagsTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

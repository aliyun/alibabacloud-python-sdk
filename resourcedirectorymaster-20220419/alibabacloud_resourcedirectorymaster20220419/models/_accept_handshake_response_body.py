...
class AcceptHandshakeResponseBody(DaraModel):
    def __init__(
        self,
        handshake: main_models.AcceptHandshakeResponseBodyHandshake = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Handshake') is not None:
            temp_model = main_models.AcceptHandshakeResponseBodyHandshake()
...
class AcceptHandshakeResponseBodyHandshake(DaraModel):
    def __init__(
        self,

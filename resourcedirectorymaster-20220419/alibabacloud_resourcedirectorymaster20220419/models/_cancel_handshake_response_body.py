...
class CancelHandshakeResponseBody(DaraModel):
    def __init__(
        self,
        handshake: main_models.CancelHandshakeResponseBodyHandshake = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Handshake') is not None:
            temp_model = main_models.CancelHandshakeResponseBodyHandshake()
...
class CancelHandshakeResponseBodyHandshake(DaraModel):
    def __init__(
        self,

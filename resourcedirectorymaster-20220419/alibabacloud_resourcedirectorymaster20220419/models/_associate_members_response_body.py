...
class AssociateMembersResponseBody(DaraModel):
    def __init__(
        self,
        members: List[main_models.AssociateMembersResponseBodyMembers] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Members') is not None:
            for k1 in m.get('Members'):
                temp_model = main_models.AssociateMembersResponseBodyMembers()
...
class AssociateMembersResponseBodyMembers(DaraModel):
    def __init__(
        self,
        contact_id: str = None,
        member_id: str = None,

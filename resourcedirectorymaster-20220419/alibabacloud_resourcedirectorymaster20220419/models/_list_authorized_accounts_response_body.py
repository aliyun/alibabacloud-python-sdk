...
class ListAuthorizedAccountsResponseBody(DaraModel):
    def __init__(
        self,
        accounts: main_models.ListAuthorizedAccountsResponseBodyAccounts = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Accounts') is not None:
            temp_model = main_models.ListAuthorizedAccountsResponseBodyAccounts()
...
class ListAuthorizedAccountsResponseBodyAccounts(DaraModel):
    def __init__(
        self,
        account: List[main_models.ListAuthorizedAccountsResponseBodyAccountsAccount] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Account') is not None:
            for k1 in m.get('Account'):
                temp_model = main_models.ListAuthorizedAccountsResponseBodyAccountsAccount()
                self.account.append(temp_model.from_map(k1))

        return self

class ListAuthorizedAccountsResponseBodyAccountsAccount(DaraModel):
    def __init__(
        self,
        account_id: str = None,

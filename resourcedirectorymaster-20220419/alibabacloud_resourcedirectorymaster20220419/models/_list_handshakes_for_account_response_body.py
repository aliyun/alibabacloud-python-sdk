...
class ListHandshakesForAccountResponseBody(DaraModel):
    def __init__(
        self,
        handshakes: main_models.ListHandshakesForAccountResponseBodyHandshakes = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Handshakes') is not None:
            temp_model = main_models.ListHandshakesForAccountResponseBodyHandshakes()
...
class ListHandshakesForAccountResponseBodyHandshakes(DaraModel):
    def __init__(
        self,
        handshake: List[main_models.ListHandshakesForAccountResponseBodyHandshakesHandshake] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Handshake') is not None:
            for k1 in m.get('Handshake'):
                temp_model = main_models.ListHandshakesForAccountResponseBodyHandshakesHandshake()
                self.handshake.append(temp_model.from_map(k1))

        return self

class ListHandshakesForAccountResponseBodyHandshakesHandshake(DaraModel):
    def __init__(
        self,

...
class ListAuthorizedAccountsRequest(TeaModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
...
class ListAuthorizedAccountsResponseBodyAccountsAccount(TeaModel):
    def __init__(
        self,
        account_id: str = None,
        account_name: str = None,
...
class ListAuthorizedAccountsResponseBodyAccounts(TeaModel):
    def __init__(
        self,
        account: List[ListAuthorizedAccountsResponseBodyAccountsAccount] = None,
    ):
        self.account = account
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Account') is not None:
            for k in m.get('Account'):
                temp_model = ListAuthorizedAccountsResponseBodyAccountsAccount()
                self.account.append(temp_model.from_map(k))
        return self


class ListAuthorizedAccountsResponseBody(TeaModel):
    def __init__(
        self,
        accounts: ListAuthorizedAccountsResponseBodyAccounts = None,
        page_number: int = None,
        page_size: int = None,
        request_id: str = None,
        total_count: int = None,
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('Accounts') is not None:
            temp_model = ListAuthorizedAccountsResponseBodyAccounts()
            self.accounts = temp_model.from_map(m['Accounts'])
        if m.get('PageNumber') is not None:
            self.page_number = m.get('PageNumber')
        if m.get('PageSize') is not None:
...
class ListAuthorizedAccountsResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ListAuthorizedAccountsResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = ListAuthorizedAccountsResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class ListAuthorizedFoldersRequest(TeaModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
...
class ListAuthorizedFoldersResponseBodyFoldersFolder(TeaModel):
    def __init__(
        self,
        folder_id: str = None,
        folder_name: str = None,
...
class ListAuthorizedFoldersResponseBodyFolders(TeaModel):
    def __init__(
        self,
        folder: List[ListAuthorizedFoldersResponseBodyFoldersFolder] = None,
    ):
        self.folder = folder
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Folder') is not None:
            for k in m.get('Folder'):
                temp_model = ListAuthorizedFoldersResponseBodyFoldersFolder()
                self.folder.append(temp_model.from_map(k))
        return self


class ListAuthorizedFoldersResponseBody(TeaModel):
    def __init__(
        self,
        folders: ListAuthorizedFoldersResponseBodyFolders = None,
        page_number: int = None,
        page_size: int = None,
        request_id: str = None,
        total_count: int = None,
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('Folders') is not None:
            temp_model = ListAuthorizedFoldersResponseBodyFolders()
            self.folders = temp_model.from_map(m['Folders'])
        if m.get('PageNumber') is not None:
            self.page_number = m.get('PageNumber')
        if m.get('PageSize') is not None:
...
class ListAuthorizedFoldersResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ListAuthorizedFoldersResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = ListAuthorizedFoldersResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

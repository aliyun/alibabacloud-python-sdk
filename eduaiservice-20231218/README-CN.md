...
## Alibaba Cloud eduaiservice SDK for Python
...
```bash
# 安装 alibabacloud_eduaiservice20231218
pip install alibabacloud_eduaiservice20231218
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/eduaiservice-20231218/ChangeLog.md)中。

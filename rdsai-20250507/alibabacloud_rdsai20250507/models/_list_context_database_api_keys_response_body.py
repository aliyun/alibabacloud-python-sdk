...
class ListContextDatabaseApiKeysResponseBody(DaraModel):
    def __init__(
        self,
        keys: List[main_models.ListContextDatabaseApiKeysResponseBodyKeys] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Keys') is not None:
            for k1 in m.get('Keys'):
                temp_model = main_models.ListContextDatabaseApiKeysResponseBodyKeys()
...
class ListContextDatabaseApiKeysResponseBodyKeys(DaraModel):
    def __init__(
        self,
        created_at: str = None,

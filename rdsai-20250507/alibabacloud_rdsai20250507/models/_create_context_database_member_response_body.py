...
class CreateContextDatabaseMemberResponseBody(DaraModel):
    def __init__(
        self,
        api_key: str = None,
        member: main_models.CreateContextDatabaseMemberResponseBodyMember = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Member') is not None:
            temp_model = main_models.CreateContextDatabaseMemberResponseBodyMember()
...
class CreateContextDatabaseMemberResponseBodyMember(DaraModel):
    def __init__(
        self,
        created_at: str = None,
        keys: List[main_models.CreateContextDatabaseMemberResponseBodyMemberKeys] = None,
        member_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Keys') is not None:
            for k1 in m.get('Keys'):
                temp_model = main_models.CreateContextDatabaseMemberResponseBodyMemberKeys()
...
class CreateContextDatabaseMemberResponseBodyMemberKeys(DaraModel):
    def __init__(
        self,
        created_at: str = None,

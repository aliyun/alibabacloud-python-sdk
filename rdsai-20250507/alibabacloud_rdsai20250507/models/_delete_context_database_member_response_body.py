...
class DeleteContextDatabaseMemberResponseBody(DaraModel):
    def __init__(
        self,
        created_at: str = None,
        keys: List[main_models.DeleteContextDatabaseMemberResponseBodyKeys] = None,
        member_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Keys') is not None:
            for k1 in m.get('Keys'):
                temp_model = main_models.DeleteContextDatabaseMemberResponseBodyKeys()
...
class DeleteContextDatabaseMemberResponseBodyKeys(DaraModel):
    def __init__(
        self,
        created_at: str = None,

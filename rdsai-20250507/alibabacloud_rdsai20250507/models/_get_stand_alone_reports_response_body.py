...
class GetStandAloneReportsResponseBody(DaraModel):
    def __init__(
        self,
        message: str = None,
        page_number: int = None,
        page_size: int = None,
        reports: List[main_models.GetStandAloneReportsResponseBodyReports] = None,
        request_id: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Reports') is not None:
            for k1 in m.get('Reports'):
                temp_model = main_models.GetStandAloneReportsResponseBodyReports()
...
class GetStandAloneReportsResponseBodyReports(DaraModel):
    def __init__(
        self,

...
class CreateApiKeyResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.CreateApiKeyResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CreateApiKeyResponseBodyData()
...
class CreateApiKeyResponseBodyData(DaraModel):
    def __init__(
        self,
        base_url: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CustomKeyList') is not None:
            for k1 in m.get('CustomKeyList'):
                temp_model = main_models.CreateApiKeyResponseBodyDataCustomKeyList()
...
class CreateApiKeyResponseBodyDataCustomKeyList(DaraModel):
    def __init__(
        self,
        api_key: str = None,
        key_name: str = None,

...
class UpdateEdgeFunctionRequest(DaraModel):
    def __init__(
        self,
        client_token: str = None,
        code: main_models.UpdateEdgeFunctionRequestCode = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Code') is not None:
            temp_model = main_models.UpdateEdgeFunctionRequestCode()
...
class UpdateEdgeFunctionRequestCode(DaraModel):
    def __init__(
        self,

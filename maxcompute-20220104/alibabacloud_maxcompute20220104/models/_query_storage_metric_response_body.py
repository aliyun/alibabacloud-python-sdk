...
class QueryStorageMetricResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.QueryStorageMetricResponseBodyData = None,
        error_code: str = None,
        error_msg: str = None,
        http_code: int = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.QueryStorageMetricResponseBodyData()
...
class QueryStorageMetricResponseBodyData(DaraModel):
    def __init__(
        self,
        category: str = None,
        metrics: List[main_models.QueryStorageMetricResponseBodyDataMetrics] = None,
        name: str = None,
        period: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('metrics') is not None:
            for k1 in m.get('metrics'):
                temp_model = main_models.QueryStorageMetricResponseBodyDataMetrics()
...
class QueryStorageMetricResponseBodyDataMetrics(DaraModel):
    def __init__(
        self,

...
class ListMmsTablesShrinkRequest(DaraModel):
    def __init__(
        self,
        sorter: main_models.ListMmsTablesShrinkRequestSorter = None,
        db_id: int = None,
        db_name: str = None,
        dst_name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('sorter') is not None:
            temp_model = main_models.ListMmsTablesShrinkRequestSorter()
...
class ListMmsTablesShrinkRequestSorter(DaraModel):
    def __init__(
        self,

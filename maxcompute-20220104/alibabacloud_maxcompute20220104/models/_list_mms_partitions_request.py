...
class ListMmsPartitionsRequest(DaraModel):
    def __init__(
        self,
        sorter: main_models.ListMmsPartitionsRequestSorter = None,
        db_id: int = None,
        db_name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('sorter') is not None:
            temp_model = main_models.ListMmsPartitionsRequestSorter()
...
class ListMmsPartitionsRequestSorter(DaraModel):
    def __init__(
        self,

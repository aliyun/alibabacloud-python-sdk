...
class ListUsersByRoleResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.ListUsersByRoleResponseBodyData()
...
class ListUsersByRoleResponseBodyData(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('users') is not None:
            for k1 in m.get('users'):
                temp_model = main_models.ListUsersByRoleResponseBodyDataUsers()
                self.users.append(temp_model.from_map(k1))

        return self

class ListUsersByRoleResponseBodyDataUsers(DaraModel):
    def __init__(
        self,
        name: str = None,
    ):

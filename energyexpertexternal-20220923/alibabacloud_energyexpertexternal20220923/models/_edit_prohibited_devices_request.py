...
class EditProhibitedDevicesRequest(DaraModel):
    def __init__(
        self,
        factory_id: str = None,
        hvac_device_config_volist: List[main_models.EditProhibitedDevicesRequestHvacDeviceConfigVOList] = None,
        system_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('hvacDeviceConfigVOList') is not None:
            for k1 in m.get('hvacDeviceConfigVOList'):
                temp_model = main_models.EditProhibitedDevicesRequestHvacDeviceConfigVOList()
...
class EditProhibitedDevicesRequestHvacDeviceConfigVOList(DaraModel):
    def __init__(
        self,

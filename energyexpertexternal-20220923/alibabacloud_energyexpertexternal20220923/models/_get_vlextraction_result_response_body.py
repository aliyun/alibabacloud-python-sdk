...
class GetVLExtractionResultResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.GetVLExtractionResultResponseBodyData = None,
        request_id: str = None,
    ):
        # Returned Data
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.GetVLExtractionResultResponseBodyData()
...
class GetVLExtractionResultResponseBodyData(DaraModel):
    def __init__(
        self,
        kv_list_info: List[main_models.GetVLExtractionResultResponseBodyDataKvListInfo] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('kvListInfo') is not None:
            for k1 in m.get('kvListInfo'):
                temp_model = main_models.GetVLExtractionResultResponseBodyDataKvListInfo()
                self.kv_list_info.append(temp_model.from_map(k1))

        return self

class GetVLExtractionResultResponseBodyDataKvListInfo(DaraModel):
    def __init__(
        self,
        context: main_models.GetVLExtractionResultResponseBodyDataKvListInfoContext = None,
        key_name: str = None,
        key_value: str = None,
    ):
        # Recall content
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('context') is not None:
            temp_model = main_models.GetVLExtractionResultResponseBodyDataKvListInfoContext()
...
class GetVLExtractionResultResponseBodyDataKvListInfoContext(DaraModel):
    def __init__(
        self,
        confidence: main_models.GetVLExtractionResultResponseBodyDataKvListInfoContextConfidence = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('confidence') is not None:
            temp_model = main_models.GetVLExtractionResultResponseBodyDataKvListInfoContextConfidence()
...
class GetVLExtractionResultResponseBodyDataKvListInfoContextConfidence(DaraModel):
    def __init__(
        self,

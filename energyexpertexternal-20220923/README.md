...
## Alibaba Cloud energyExpertExternal SDK for Python
...
```bash
# Install the alibabacloud_energyexpertexternal20220923
pip install alibabacloud_energyexpertexternal20220923
```

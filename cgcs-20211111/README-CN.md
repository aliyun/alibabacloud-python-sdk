...
## Alibaba Cloud CGCS SDK for Python
...
```bash
# 安装 alibabacloud_cgcs20211111
pip install alibabacloud_cgcs20211111
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/cgcs-20211111/ChangeLog.md)中。

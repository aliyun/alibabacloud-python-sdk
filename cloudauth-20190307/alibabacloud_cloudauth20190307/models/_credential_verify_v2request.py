...
class CredentialVerifyV2Request(DaraModel):
    def __init__(
        self,
        cert_num: str = None,
        cred_name: str = None,
        ...
        is_check: str = None,
        is_ocr: str = None,
        merchant_detail: List[main_models.CredentialVerifyV2RequestMerchantDetail] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MerchantDetail') is not None:
            for k1 in m.get('MerchantDetail'):
                temp_model = main_models.CredentialVerifyV2RequestMerchantDetail()
...
class CredentialVerifyV2RequestMerchantDetail(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

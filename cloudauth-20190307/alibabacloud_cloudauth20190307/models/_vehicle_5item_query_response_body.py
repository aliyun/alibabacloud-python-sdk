...
class Vehicle5ItemQueryResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResultObject') is not None:
            temp_model = main_models.Vehicle5ItemQueryResponseBodyResultObject()
            self.result_object = temp_model.from_map(m.get('ResultObject'))

        return self

class Vehicle5ItemQueryResponseBodyResultObject(DaraModel):
    def __init__(
        self,
        biz_code: str = None,

...
class DescribeCardVerifyResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResultObject') is not None:
            temp_model = main_models.DescribeCardVerifyResponseBodyResultObject()
            self.result_object = temp_model.from_map(m.get('ResultObject'))

        return self

class DescribeCardVerifyResponseBodyResultObject(DaraModel):
    def __init__(
        self,
        biz_code: str = None,
        card_info: str = None,

...
class Mobile3MetaDetailVerifyResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        request_id: str = None,
        result_object: main_models.Mobile3MetaDetailVerifyResponseBodyResultObject = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResultObject') is not None:
            temp_model = main_models.Mobile3MetaDetailVerifyResponseBodyResultObject()
            self.result_object = temp_model.from_map(m.get('ResultObject'))

        return self

class Mobile3MetaDetailVerifyResponseBodyResultObject(DaraModel):
    def __init__(
        self,
        biz_code: str = None,
        isp_name: str = None,

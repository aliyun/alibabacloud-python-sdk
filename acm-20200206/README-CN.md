...
## Alibaba Cloud acm SDK for Python
...
```bash
# 安装 alibabacloud_acm20200206
pip install alibabacloud_acm20200206
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/acm-20200206/ChangeLog.md)中。

...
class AddDataSourceLogResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.AddDataSourceLogResponseBodyData = None,
        request_id: str = None,
    ):
        # The data returned.
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.AddDataSourceLogResponseBodyData()
...
class AddDataSourceLogResponseBodyData(DaraModel):
    def __init__(
        self,
        count: int = None,

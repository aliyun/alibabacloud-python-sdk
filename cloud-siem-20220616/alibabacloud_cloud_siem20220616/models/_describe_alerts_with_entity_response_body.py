...
class DescribeAlertsWithEntityResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.DescribeAlertsWithEntityResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DescribeAlertsWithEntityResponseBodyData()
...
class DescribeAlertsWithEntityResponseBodyData(DaraModel):
    def __init__(
        self,
        page_info: main_models.DescribeAlertsWithEntityResponseBodyDataPageInfo = None,
        response_data: List[main_models.DescribeAlertsWithEntityResponseBodyDataResponseData] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PageInfo') is not None:
            temp_model = main_models.DescribeAlertsWithEntityResponseBodyDataPageInfo()
            self.page_info = temp_model.from_map(m.get('PageInfo'))

        self.response_data = []
        if m.get('ResponseData') is not None:
            for k1 in m.get('ResponseData'):
                temp_model = main_models.DescribeAlertsWithEntityResponseBodyDataResponseData()
                self.response_data.append(temp_model.from_map(k1))

        return self

class DescribeAlertsWithEntityResponseBodyDataResponseData(DaraModel):
    def __init__(
        self,
        alert_desc: str = None,
        ...
        alert_info_list: List[main_models.DescribeAlertsWithEntityResponseBodyDataResponseDataAlertInfoList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AlertInfoList') is not None:
            for k1 in m.get('AlertInfoList'):
                temp_model = main_models.DescribeAlertsWithEntityResponseBodyDataResponseDataAlertInfoList()
...
class DescribeAlertsWithEntityResponseBodyDataResponseDataAlertInfoList(DaraModel):
    def __init__(
        self,
        key: str = None,
        key_name: str = None,
...
class DescribeAlertsWithEntityResponseBodyDataPageInfo(DaraModel):
    def __init__(
        self,

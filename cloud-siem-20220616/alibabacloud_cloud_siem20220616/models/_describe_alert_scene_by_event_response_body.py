...
class DescribeAlertSceneByEventResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: List[main_models.DescribeAlertSceneByEventResponseBodyData] = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.DescribeAlertSceneByEventResponseBodyData()
...
class DescribeAlertSceneByEventResponseBodyData(DaraModel):
    def __init__(
        self,
        alert_name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Targets') is not None:
            for k1 in m.get('Targets'):
                temp_model = main_models.DescribeAlertSceneByEventResponseBodyDataTargets()
                self.targets.append(temp_model.from_map(k1))

        return self

class DescribeAlertSceneByEventResponseBodyDataTargets(DaraModel):
    def __init__(
        self,
        name: str = None,
        type: str = None,

...
class AddDataSourceResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.AddDataSourceResponseBodyData = None,
        request_id: str = None,
    ):
        # The data returned.
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.AddDataSourceResponseBodyData()
...
class AddDataSourceResponseBodyData(DaraModel):
    def __init__(
        self,
        count: int = None,

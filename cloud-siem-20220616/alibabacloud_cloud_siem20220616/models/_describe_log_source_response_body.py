...
class DescribeLogSourceResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: List[main_models.DescribeLogSourceResponseBodyData] = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.DescribeLogSourceResponseBodyData()
...
class DescribeLogSourceResponseBodyData(DaraModel):
    def __init__(
        self,
        log_source: str = None,

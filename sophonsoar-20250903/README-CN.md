...
## Alibaba Cloud sophonsoar SDK for Python
...
```bash
# 安装 alibabacloud_sophonsoar20250903
pip install alibabacloud_sophonsoar20250903
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/sophonsoar-20250903/ChangeLog.md)中。

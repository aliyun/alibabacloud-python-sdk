...
class UpdateComponentAssetRequest(DaraModel):
    def __init__(
        self,
        component_asset_name: str = None,
        component_asset_uuid: str = None,
        component_asset_values: List[main_models.UpdateComponentAssetRequestComponentAssetValues] = None,
        lang: str = None,
        role_for: int = None,
    ):
        # Asset name.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ComponentAssetValues') is not None:
            for k1 in m.get('ComponentAssetValues'):
                temp_model = main_models.UpdateComponentAssetRequestComponentAssetValues()
...
class UpdateComponentAssetRequestComponentAssetValues(DaraModel):
    def __init__(
        self,
        field_name: str = None,

...
class Client(OpenApiClient):
    ...
    *\
    ...
    def report_impression_with_options(
        ...
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.impressionlink):
    ...
    async def report_impression_with_options_async(
        self,
        request: imarketing_20220704_models.ReportImpressionRequest,
        runtime: util_models.RuntimeOptions,
    ) -> imarketing_20220704_models.ReportImpressionResponse:
    ...
    def report_impression(
        ...
        runtime = util_models.RuntimeOptions()
        return self.report_impression_with_options(request, runtime)

    async def report_impression_async(
        self,
        request: imarketing_20220704_models.ReportImpressionRequest,
    ) -> imarketing_20220704_models.ReportImpressionResponse:
        runtime = util_models.RuntimeOptions()

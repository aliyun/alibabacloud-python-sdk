...
## Alibaba Cloud Aidge SDK for Python
...
```bash
# 安装 alibabacloud_aidge20260428
pip install alibabacloud_aidge20260428
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/aidge-20260428/ChangeLog.md)中。

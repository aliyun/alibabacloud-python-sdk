...
class ProductHotspotDetectionRequest(DaraModel):
    def __init__(
        self,
        ...
        self.reference_image_urls = reference_image_urls
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        if self.reference_image_urls is not None:
            result['ReferenceImageUrls'] = self.reference_image_urls
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ReferenceImageUrls') is not None:
            self.reference_image_urls = m.get('ReferenceImageUrls')

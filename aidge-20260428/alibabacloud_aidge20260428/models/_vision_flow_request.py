...
class VisionFlowRequest(DaraModel):
    def __init__(
        self,
        ...
        is_filter: bool = None,
        mask: str = None,
        nonobject_detect_elements: List[int] = None,
        nonobject_remove_elements: List[int] = None,
        ...
        self.nonobject_detect_elements = nonobject_detect_elements
        ...
        self.nonobject_remove_elements = nonobject_remove_elements
    ...
    def to_map(self):
        ...
        if self.nonobject_detect_elements is not None:
            result['NonobjectDetectElements'] = self.nonobject_detect_elements

        if self.nonobject_remove_elements is not None:
            result['NonobjectRemoveElements'] = self.nonobject_remove_elements
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NonobjectDetectElements') is not None:
            self.nonobject_detect_elements = m.get('NonobjectDetectElements')

        if m.get('NonobjectRemoveElements') is not None:
            self.nonobject_remove_elements = m.get('NonobjectRemoveElements')

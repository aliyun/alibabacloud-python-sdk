...
class PrepaidTextTranslateResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.PrepaidTextTranslateResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.PrepaidTextTranslateResponseBodyData()
...
class PrepaidTextTranslateResponseBodyData(DaraModel):
    def __init__(
        self,
        translations: List[main_models.PrepaidTextTranslateResponseBodyDataTranslations] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Translations') is not None:
            for k1 in m.get('Translations'):
                temp_model = main_models.PrepaidTextTranslateResponseBodyDataTranslations()
...
class PrepaidTextTranslateResponseBodyDataTranslations(DaraModel):
    def __init__(
        self,
        characters: int = None,

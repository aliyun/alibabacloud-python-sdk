...
class ImageRemoveResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ImageRemoveResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ImageRemoveResponseBodyData()
...
class ImageRemoveResponseBodyData(DaraModel):
    def __init__(
        self,
        height: int = None,
        image_url: str = None,

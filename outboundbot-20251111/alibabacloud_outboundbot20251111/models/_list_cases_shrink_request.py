...
class ListCasesShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        case_ids_shrink: str = None,
        disposition_codes_shrink: str = None,
        disposition_reasons_shrink: str = None,
        draft_version: bool = None,
        end_time: int = None,
        instance_id: str = None,
        label_search_shrink: str = None,
        ...
        self.case_ids_shrink = case_ids_shrink
        # The list of disposition codes.
        self.disposition_codes_shrink = disposition_codes_shrink
        # The list of disposition reasons.
        self.disposition_reasons_shrink = disposition_reasons_shrink
        ...
        self.label_search_shrink = label_search_shrink
    ...
    def to_map(self):
        ...
        if self.case_ids_shrink is not None:
            result['CaseIds'] = self.case_ids_shrink

        if self.disposition_codes_shrink is not None:
            result['DispositionCodes'] = self.disposition_codes_shrink

        if self.disposition_reasons_shrink is not None:
            result['DispositionReasons'] = self.disposition_reasons_shrink
        ...
        if self.label_search_shrink is not None:
            result['LabelSearch'] = self.label_search_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CaseIds') is not None:
            self.case_ids_shrink = m.get('CaseIds')

        if m.get('DispositionCodes') is not None:
            self.disposition_codes_shrink = m.get('DispositionCodes')

        if m.get('DispositionReasons') is not None:
            self.disposition_reasons_shrink = m.get('DispositionReasons')
        ...
        if m.get('LabelSearch') is not None:
            self.label_search_shrink = m.get('LabelSearch')

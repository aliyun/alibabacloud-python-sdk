...
class GetCampaignResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetCampaignResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetCampaignResponseBodyData()
...
class GetCampaignResponseBodyData(DaraModel):
    def __init__(
        self,

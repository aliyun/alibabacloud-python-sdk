...
class CreateFlashSmsAccessProfileRequest(DaraModel):
    def __init__(
        self,
        access_profile: main_models.CreateFlashSmsAccessProfileRequestAccessProfile = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AccessProfile') is not None:
            temp_model = main_models.CreateFlashSmsAccessProfileRequestAccessProfile()
...
class CreateFlashSmsAccessProfileRequestAccessProfile(DaraModel):
    def __init__(
        self,
        account: str = None,
        aes_key: str = None,
        ...
        cap_app_id: str = None,
        dy_sms_access_profiles: List[main_models.CreateFlashSmsAccessProfileRequestAccessProfileDySmsAccessProfiles] = None,
        extno: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DySmsAccessProfiles') is not None:
            for k1 in m.get('DySmsAccessProfiles'):
                temp_model = main_models.CreateFlashSmsAccessProfileRequestAccessProfileDySmsAccessProfiles()
...
class CreateFlashSmsAccessProfileRequestAccessProfileDySmsAccessProfiles(DaraModel):
    def __init__(
        self,

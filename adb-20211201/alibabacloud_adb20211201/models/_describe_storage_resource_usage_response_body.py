...
class DescribeStorageResourceUsageResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.DescribeStorageResourceUsageResponseBodyData = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DescribeStorageResourceUsageResponseBodyData()
...
class DescribeStorageResourceUsageResponseBodyData(DaraModel):
    def __init__(
        self,
        acu_info: List[main_models.DescribeStorageResourceUsageResponseBodyDataAcuInfo] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AcuInfo') is not None:
            for k1 in m.get('AcuInfo'):
                temp_model = main_models.DescribeStorageResourceUsageResponseBodyDataAcuInfo()
...
class DescribeStorageResourceUsageResponseBodyDataAcuInfo(DaraModel):
    def __init__(
        self,
        name: str = None,

...
class DescribeAllDataSourceResponseBody(DaraModel):
    def __init__(
        self,
        columns: main_models.DescribeAllDataSourceResponseBodyColumns = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Columns') is not None:
            temp_model = main_models.DescribeAllDataSourceResponseBodyColumns()
        ...
        if m.get('Schemas') is not None:
            temp_model = main_models.DescribeAllDataSourceResponseBodySchemas()
            self.schemas = temp_model.from_map(m.get('Schemas'))

        if m.get('Tables') is not None:
            temp_model = main_models.DescribeAllDataSourceResponseBodyTables()
            self.tables = temp_model.from_map(m.get('Tables'))

        return self

class DescribeAllDataSourceResponseBodyTables(DaraModel):
    def __init__(
        self,
        table: List[main_models.DescribeAllDataSourceResponseBodyTablesTable] = None,
    ):
        self.table = table
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Table') is not None:
            for k1 in m.get('Table'):
                temp_model = main_models.DescribeAllDataSourceResponseBodyTablesTable()
                self.table.append(temp_model.from_map(k1))

        return self

class DescribeAllDataSourceResponseBodyTablesTable(DaraModel):
    def __init__(
        self,
...
class DescribeAllDataSourceResponseBodySchemas(DaraModel):
    def __init__(
        self,
        schema: List[main_models.DescribeAllDataSourceResponseBodySchemasSchema] = None,
    ):
        self.schema = schema
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Schema') is not None:
            for k1 in m.get('Schema'):
                temp_model = main_models.DescribeAllDataSourceResponseBodySchemasSchema()
                self.schema.append(temp_model.from_map(k1))

        return self

class DescribeAllDataSourceResponseBodySchemasSchema(DaraModel):
    def __init__(
        self,
        dbcluster_id: str = None,
        schema_name: str = None,
...
class DescribeAllDataSourceResponseBodyColumns(DaraModel):
    def __init__(
        self,
        column: List[main_models.DescribeAllDataSourceResponseBodyColumnsColumn] = None,
    ):
        self.column = column
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Column') is not None:
            for k1 in m.get('Column'):
                temp_model = main_models.DescribeAllDataSourceResponseBodyColumnsColumn()
                self.column.append(temp_model.from_map(k1))

        return self

class DescribeAllDataSourceResponseBodyColumnsColumn(DaraModel):
    def __init__(
        self,

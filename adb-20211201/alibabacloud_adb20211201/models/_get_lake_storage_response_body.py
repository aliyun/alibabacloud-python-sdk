...
class GetLakeStorageResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetLakeStorageResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetLakeStorageResponseBodyData()
...
class GetLakeStorageResponseBodyData(DaraModel):
    def __init__(
        self,
        ...
        permissions: List[main_models.GetLakeStorageResponseBodyDataPermissions] = None,
        region_id: str = None,
        row_count: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Permissions') is not None:
            for k1 in m.get('Permissions'):
                temp_model = main_models.GetLakeStorageResponseBodyDataPermissions()
...
class GetLakeStorageResponseBodyDataPermissions(DaraModel):
    def __init__(
        self,
        account: str = None,
        read: bool = None,

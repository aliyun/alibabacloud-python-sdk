...
class CancelSparkReplStatementResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.CancelSparkReplStatementResponseBodyData = None,
        request_id: str = None,
    ):
        # The returned data.
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CancelSparkReplStatementResponseBodyData()
...
class CancelSparkReplStatementResponseBodyData(DaraModel):
    def __init__(
        self,
        aliyun_uid: int = None,
        code: str = None,

...
class DescribeClusterResourceUsageResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.DescribeClusterResourceUsageResponseBodyData = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DescribeClusterResourceUsageResponseBodyData()
...
class DescribeClusterResourceUsageResponseBodyData(DaraModel):
    def __init__(
        self,
        acu_info: List[main_models.DescribeClusterResourceUsageResponseBodyDataAcuInfo] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AcuInfo') is not None:
            for k1 in m.get('AcuInfo'):
                temp_model = main_models.DescribeClusterResourceUsageResponseBodyDataAcuInfo()
...
class DescribeClusterResourceUsageResponseBodyDataAcuInfo(DaraModel):
    def __init__(
        self,
        name: str = None,

...
class RemoveKnowledgeUploadUserResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.RemoveKnowledgeUploadUserResponseBodyData = None,
        request_id: str = None,
    ):
        # The returned data.
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.RemoveKnowledgeUploadUserResponseBodyData()
...
class RemoveKnowledgeUploadUserResponseBodyData(DaraModel):
    def __init__(
        self,

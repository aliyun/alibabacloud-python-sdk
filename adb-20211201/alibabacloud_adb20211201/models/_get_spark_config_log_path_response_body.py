...
class GetSparkConfigLogPathResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.GetSparkConfigLogPathResponseBodyData = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetSparkConfigLogPathResponseBodyData()
...
class GetSparkConfigLogPathResponseBodyData(DaraModel):
    def __init__(
        self,

...
class GetSparkReplStatementResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.GetSparkReplStatementResponseBodyData = None,
        request_id: str = None,
    ):
        # The returned data.
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetSparkReplStatementResponseBodyData()
...
class GetSparkReplStatementResponseBodyData(DaraModel):
    def __init__(
        self,
        aliyun_uid: int = None,
        code: str = None,

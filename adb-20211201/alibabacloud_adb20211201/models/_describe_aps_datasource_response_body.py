...
class DescribeApsDatasourceResponseBody(DaraModel):
    def __init__(
        self,
        aps_datasource: main_models.DescribeApsDatasourceResponseBodyApsDatasource = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApsDatasource') is not None:
            temp_model = main_models.DescribeApsDatasourceResponseBodyApsDatasource()
            self.aps_datasource = temp_model.from_map(m.get('ApsDatasource'))
...
class DescribeApsDatasourceResponseBodyApsDatasource(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        dbcluster_id: str = None,
        databricks_info: main_models.DescribeApsDatasourceResponseBodyApsDatasourceDatabricksInfo = None,
        datasource_description: str = None,
        datasource_name: str = None,
        datasource_type: str = None,
        hive_info: main_models.DescribeApsDatasourceResponseBodyApsDatasourceHiveInfo = None,
        kafka_info: main_models.DescribeApsDatasourceResponseBodyApsDatasourceKafkaInfo = None,
        polar_dbmysql_info: main_models.DescribeApsDatasourceResponseBodyApsDatasourcePolarDBMysqlInfo = None,
        rds_mysql_info: main_models.DescribeApsDatasourceResponseBodyApsDatasourceRdsMysqlInfo = None,
        sls_info: main_models.DescribeApsDatasourceResponseBodyApsDatasourceSlsInfo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DatabricksInfo') is not None:
            temp_model = main_models.DescribeApsDatasourceResponseBodyApsDatasourceDatabricksInfo()
        ...
        if m.get('HiveInfo') is not None:
            temp_model = main_models.DescribeApsDatasourceResponseBodyApsDatasourceHiveInfo()
            self.hive_info = temp_model.from_map(m.get('HiveInfo'))

        if m.get('KafkaInfo') is not None:
            temp_model = main_models.DescribeApsDatasourceResponseBodyApsDatasourceKafkaInfo()
            self.kafka_info = temp_model.from_map(m.get('KafkaInfo'))

        if m.get('PolarDBMysqlInfo') is not None:
            temp_model = main_models.DescribeApsDatasourceResponseBodyApsDatasourcePolarDBMysqlInfo()
            self.polar_dbmysql_info = temp_model.from_map(m.get('PolarDBMysqlInfo'))

        if m.get('RdsMysqlInfo') is not None:
            temp_model = main_models.DescribeApsDatasourceResponseBodyApsDatasourceRdsMysqlInfo()
            self.rds_mysql_info = temp_model.from_map(m.get('RdsMysqlInfo'))

        if m.get('SlsInfo') is not None:
            temp_model = main_models.DescribeApsDatasourceResponseBodyApsDatasourceSlsInfo()
            self.sls_info = temp_model.from_map(m.get('SlsInfo'))

        return self

class DescribeApsDatasourceResponseBodyApsDatasourceSlsInfo(DaraModel):
    def __init__(
        self,
        across: bool = None,
...
class DescribeApsDatasourceResponseBodyApsDatasourceRdsMysqlInfo(DaraModel):
    def __init__(
        self,
...
class DescribeApsDatasourceResponseBodyApsDatasourcePolarDBMysqlInfo(DaraModel):
    def __init__(
        self,
        across: bool = None,
        across_role: str = None,
...
class DescribeApsDatasourceResponseBodyApsDatasourceKafkaInfo(DaraModel):
    def __init__(
        self,
...
class DescribeApsDatasourceResponseBodyApsDatasourceHiveInfo(DaraModel):
    def __init__(
        self,
...
class DescribeApsDatasourceResponseBodyApsDatasourceDatabricksInfo(DaraModel):
    def __init__(
        self,

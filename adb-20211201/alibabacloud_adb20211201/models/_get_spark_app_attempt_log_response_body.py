...
class GetSparkAppAttemptLogResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.GetSparkAppAttemptLogResponseBodyData = None,
        request_id: str = None,
    ):
        # The queried log.
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetSparkAppAttemptLogResponseBodyData()
...
class GetSparkAppAttemptLogResponseBodyData(DaraModel):
    def __init__(
        self,
        app_id: str = None,

...
class GetSparkAppMetricsResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.GetSparkAppMetricsResponseBodyData = None,
        request_id: str = None,
    ):
        # The returned data.
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetSparkAppMetricsResponseBodyData()
...
class GetSparkAppMetricsResponseBodyData(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        attempt_id: str = None,
        ...
        finished: bool = None,
        scan_metrics: main_models.GetSparkAppMetricsResponseBodyDataScanMetrics = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ScanMetrics') is not None:
            temp_model = main_models.GetSparkAppMetricsResponseBodyDataScanMetrics()
            self.scan_metrics = temp_model.from_map(m.get('ScanMetrics'))

        return self

class GetSparkAppMetricsResponseBodyDataScanMetrics(DaraModel):
    def __init__(
        self,

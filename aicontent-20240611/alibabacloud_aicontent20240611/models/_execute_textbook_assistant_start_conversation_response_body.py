...
class ExecuteTextbookAssistantStartConversationResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.ExecuteTextbookAssistantStartConversationResponseBodyData = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.ExecuteTextbookAssistantStartConversationResponseBodyData()
...
class ExecuteTextbookAssistantStartConversationResponseBodyData(DaraModel):
    def __init__(
        self,
        assistant: str = None,
        chat_id: str = None,
        result: main_models.ExecuteTextbookAssistantStartConversationResponseBodyDataResult = None,
        user: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('result') is not None:
            temp_model = main_models.ExecuteTextbookAssistantStartConversationResponseBodyDataResult()
...
class ExecuteTextbookAssistantStartConversationResponseBodyDataResult(DaraModel):
    def __init__(
        self,

...
class GetAITeacherExpansionDialogueSuggestionRequest(DaraModel):
    def __init__(
        self,
        background: str = None,
        dialogue_tasks: List[main_models.GetAITeacherExpansionDialogueSuggestionRequestDialogueTasks] = None,
        language_code: str = None,
        records: List[main_models.GetAITeacherExpansionDialogueSuggestionRequestRecords] = None,
        role_info: main_models.GetAITeacherExpansionDialogueSuggestionRequestRoleInfo = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dialogueTasks') is not None:
            for k1 in m.get('dialogueTasks'):
                temp_model = main_models.GetAITeacherExpansionDialogueSuggestionRequestDialogueTasks()
        ...
        if m.get('records') is not None:
            for k1 in m.get('records'):
                temp_model = main_models.GetAITeacherExpansionDialogueSuggestionRequestRecords()
                self.records.append(temp_model.from_map(k1))

        if m.get('roleInfo') is not None:
            temp_model = main_models.GetAITeacherExpansionDialogueSuggestionRequestRoleInfo()
...
class GetAITeacherExpansionDialogueSuggestionRequestRoleInfo(DaraModel):
    def __init__(
        self,
        assistant: str = None,
        user: str = None,
...
class GetAITeacherExpansionDialogueSuggestionRequestRecords(DaraModel):
    def __init__(
        self,
        content: str = None,
...
class GetAITeacherExpansionDialogueSuggestionRequestDialogueTasks(DaraModel):
    def __init__(
        self,
        assistant: str = None,

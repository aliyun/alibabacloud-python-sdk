...
class ExecuteAITeacherExpansionDialogueTranslateRequest(DaraModel):
    def __init__(
        self,
        background: str = None,
        dialogue_tasks: List[main_models.ExecuteAITeacherExpansionDialogueTranslateRequestDialogueTasks] = None,
        records: List[main_models.ExecuteAITeacherExpansionDialogueTranslateRequestRecords] = None,
        role_info: main_models.ExecuteAITeacherExpansionDialogueTranslateRequestRoleInfo = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dialogueTasks') is not None:
            for k1 in m.get('dialogueTasks'):
                temp_model = main_models.ExecuteAITeacherExpansionDialogueTranslateRequestDialogueTasks()
                self.dialogue_tasks.append(temp_model.from_map(k1))

        self.records = []
        if m.get('records') is not None:
            for k1 in m.get('records'):
                temp_model = main_models.ExecuteAITeacherExpansionDialogueTranslateRequestRecords()
                self.records.append(temp_model.from_map(k1))

        if m.get('roleInfo') is not None:
            temp_model = main_models.ExecuteAITeacherExpansionDialogueTranslateRequestRoleInfo()
...
class ExecuteAITeacherExpansionDialogueTranslateRequestRoleInfo(DaraModel):
    def __init__(
        self,
        assistant: str = None,
        user: str = None,
...
class ExecuteAITeacherExpansionDialogueTranslateRequestRecords(DaraModel):
    def __init__(
        self,
        content: str = None,
...
class ExecuteAITeacherExpansionDialogueTranslateRequestDialogueTasks(DaraModel):
    def __init__(
        self,
        assistant: str = None,

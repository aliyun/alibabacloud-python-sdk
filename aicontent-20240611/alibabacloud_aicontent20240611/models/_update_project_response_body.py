...
class UpdateProjectResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.UpdateProjectResponseBodyData = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.UpdateProjectResponseBodyData()
...
class UpdateProjectResponseBodyData(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        project_apps: List[main_models.UpdateProjectResponseBodyDataProjectApps] = None,
        project_id: str = None,
        project_name: str = None,
        project_sdk: List[main_models.UpdateProjectResponseBodyDataProjectSDK] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ProjectApps') is not None:
            for k1 in m.get('ProjectApps'):
                temp_model = main_models.UpdateProjectResponseBodyDataProjectApps()
        ...
        if m.get('ProjectSDK') is not None:
            for k1 in m.get('ProjectSDK'):
                temp_model = main_models.UpdateProjectResponseBodyDataProjectSDK()
...
class UpdateProjectResponseBodyDataProjectSDK(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        demo_url: str = None,
...
class UpdateProjectResponseBodyDataProjectApps(DaraModel):
    def __init__(
        self,
        application_access_ids: List[main_models.UpdateProjectResponseBodyDataProjectAppsApplicationAccessIds] = None,
        id: str = None,
        project_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApplicationAccessIds') is not None:
            for k1 in m.get('ApplicationAccessIds'):
                temp_model = main_models.UpdateProjectResponseBodyDataProjectAppsApplicationAccessIds()
...
class UpdateProjectResponseBodyDataProjectAppsApplicationAccessIds(DaraModel):
    def __init__(
        self,

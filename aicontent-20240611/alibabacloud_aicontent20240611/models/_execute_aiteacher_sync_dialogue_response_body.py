...
class ExecuteAITeacherSyncDialogueResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.ExecuteAITeacherSyncDialogueResponseBodyData = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.ExecuteAITeacherSyncDialogueResponseBodyData()
...
class ExecuteAITeacherSyncDialogueResponseBodyData(DaraModel):
    def __init__(
        self,

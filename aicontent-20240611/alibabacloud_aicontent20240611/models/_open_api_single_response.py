...
class OpenApiSingleResponse(DaraModel):
    def __init__(
        self,
        data: main_models.OpenApiSingleResponseData = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.OpenApiSingleResponseData()
...
class OpenApiSingleResponseData(DaraModel):
    def __init__(
        self,

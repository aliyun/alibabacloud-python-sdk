...
class QueryProjectListResponseBody(DaraModel):
    def __init__(
        self,
        data: List[main_models.QueryProjectListResponseBodyData] = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            for k1 in m.get('data'):
                temp_model = main_models.QueryProjectListResponseBodyData()
...
class QueryProjectListResponseBodyData(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        project_apps: List[main_models.QueryProjectListResponseBodyDataProjectApps] = None,
        project_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ProjectApps') is not None:
            for k1 in m.get('ProjectApps'):
                temp_model = main_models.QueryProjectListResponseBodyDataProjectApps()
        ...
        if m.get('ProjectSDK') is not None:
            for k1 in m.get('ProjectSDK'):
                temp_model = main_models.QueryProjectListResponseBodyDataProjectSDK()
...
class QueryProjectListResponseBodyDataProjectSDK(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        demo_url: str = None,
...
class QueryProjectListResponseBodyDataProjectApps(DaraModel):
    def __init__(
        self,
        application_access_ids: List[main_models.QueryProjectListResponseBodyDataProjectAppsApplicationAccessIds] = None,
        id: str = None,
        project_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApplicationAccessIds') is not None:
            for k1 in m.get('ApplicationAccessIds'):
                temp_model = main_models.QueryProjectListResponseBodyDataProjectAppsApplicationAccessIds()
...
class QueryProjectListResponseBodyDataProjectAppsApplicationAccessIds(DaraModel):
    def __init__(
        self,

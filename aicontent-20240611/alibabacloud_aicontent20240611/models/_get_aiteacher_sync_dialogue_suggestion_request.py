...
class GetAITeacherSyncDialogueSuggestionRequest(DaraModel):
    def __init__(
        self,
        dialogue_tasks: List[main_models.GetAITeacherSyncDialogueSuggestionRequestDialogueTasks] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dialogueTasks') is not None:
            for k1 in m.get('dialogueTasks'):
                temp_model = main_models.GetAITeacherSyncDialogueSuggestionRequestDialogueTasks()
        ...
        if m.get('records') is not None:
            for k1 in m.get('records'):
                temp_model = main_models.GetAITeacherSyncDialogueSuggestionRequestRecords()
...
class GetAITeacherSyncDialogueSuggestionRequestRecords(DaraModel):
    def __init__(
        self,
        content: str = None,
...
class GetAITeacherSyncDialogueSuggestionRequestDialogueTasks(DaraModel):
    def __init__(
        self,
        assistant: str = None,

...
class ModelRouterUpdateBillingRuleResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.ModelRouterUpdateBillingRuleResponseBodyData = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.ModelRouterUpdateBillingRuleResponseBodyData()
...
class ModelRouterUpdateBillingRuleResponseBodyData(DaraModel):
    def __init__(
        self,

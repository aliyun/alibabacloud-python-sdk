...
class OralEvaluationStatisticsConcurrentCountResponse(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('projectData') is not None:
            temp_model = main_models.OralEvaluationStatisticsConcurrentCountResponseProjectData()
...
class OralEvaluationStatisticsConcurrentCountResponseProjectData(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApplicationData') is not None:
            for k1 in m.get('ApplicationData'):
                temp_model = main_models.OralEvaluationStatisticsConcurrentCountResponseProjectDataApplicationData()
...
class OralEvaluationStatisticsConcurrentCountResponseProjectDataApplicationData(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.OralEvaluationStatisticsConcurrentCountResponseProjectDataApplicationDataData()
...
class OralEvaluationStatisticsConcurrentCountResponseProjectDataApplicationDataData(DaraModel):
    def __init__(
        self,
        count: int = None,
        name: str = None,

...
class ExecuteAITeacherExpansionDialogueRequest(DaraModel):
    def __init__(
        self,
        background: str = None,
        dialogue_tasks: List[main_models.ExecuteAITeacherExpansionDialogueRequestDialogueTasks] = None,
        language_code: str = None,
        records: List[main_models.ExecuteAITeacherExpansionDialogueRequestRecords] = None,
        role_info: main_models.ExecuteAITeacherExpansionDialogueRequestRoleInfo = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dialogueTasks') is not None:
            for k1 in m.get('dialogueTasks'):
                temp_model = main_models.ExecuteAITeacherExpansionDialogueRequestDialogueTasks()
        ...
        if m.get('records') is not None:
            for k1 in m.get('records'):
                temp_model = main_models.ExecuteAITeacherExpansionDialogueRequestRecords()
                self.records.append(temp_model.from_map(k1))

        if m.get('roleInfo') is not None:
            temp_model = main_models.ExecuteAITeacherExpansionDialogueRequestRoleInfo()
...
class ExecuteAITeacherExpansionDialogueRequestRoleInfo(DaraModel):
    def __init__(
        self,
        assistant: str = None,
        user: str = None,
...
class ExecuteAITeacherExpansionDialogueRequestRecords(DaraModel):
    def __init__(
        self,
        content: str = None,
...
class ExecuteAITeacherExpansionDialogueRequestDialogueTasks(DaraModel):
    def __init__(
        self,
        assistant: str = None,

...
class Personalizedtxt2imgQueryInferenceJobInfoResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.Personalizedtxt2imgQueryInferenceJobInfoResponseBodyData = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.Personalizedtxt2imgQueryInferenceJobInfoResponseBodyData()
...
class Personalizedtxt2imgQueryInferenceJobInfoResponseBodyData(DaraModel):
    def __init__(
        self,

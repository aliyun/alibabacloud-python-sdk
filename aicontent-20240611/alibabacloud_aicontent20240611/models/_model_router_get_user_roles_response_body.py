...
class ModelRouterGetUserRolesResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.ModelRouterGetUserRolesResponseBodyData = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.ModelRouterGetUserRolesResponseBodyData()
...
class ModelRouterGetUserRolesResponseBodyData(DaraModel):
    def __init__(
        self,
        department_roles: List[main_models.UserDepartmentDTO] = None,
    ):

...
class Personalizedtxt2imgQueryModelTrainStatusResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.Personalizedtxt2imgQueryModelTrainStatusResponseBodyData = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.Personalizedtxt2imgQueryModelTrainStatusResponseBodyData()
...
class Personalizedtxt2imgQueryModelTrainStatusResponseBodyData(DaraModel):
    def __init__(
        self,

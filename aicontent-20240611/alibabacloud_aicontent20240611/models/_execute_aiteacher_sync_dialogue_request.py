...
class ExecuteAITeacherSyncDialogueRequest(DaraModel):
    def __init__(
        self,
        dialogue_tasks: List[main_models.ExecuteAITeacherSyncDialogueRequestDialogueTasks] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dialogueTasks') is not None:
            for k1 in m.get('dialogueTasks'):
                temp_model = main_models.ExecuteAITeacherSyncDialogueRequestDialogueTasks()
        ...
        if m.get('records') is not None:
            for k1 in m.get('records'):
                temp_model = main_models.ExecuteAITeacherSyncDialogueRequestRecords()
...
class ExecuteAITeacherSyncDialogueRequestRecords(DaraModel):
    def __init__(
        self,
        content: str = None,
...
class ExecuteAITeacherSyncDialogueRequestDialogueTasks(DaraModel):
    def __init__(
        self,
        assistant: str = None,

...
class GetAITeacherExpansionDialogueSuggestionResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.GetAITeacherExpansionDialogueSuggestionResponseBodyData = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.GetAITeacherExpansionDialogueSuggestionResponseBodyData()
...
class GetAITeacherExpansionDialogueSuggestionResponseBodyData(DaraModel):
    def __init__(
        self,

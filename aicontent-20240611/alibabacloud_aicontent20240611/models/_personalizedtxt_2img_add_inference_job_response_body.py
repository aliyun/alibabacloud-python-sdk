...
class Personalizedtxt2imgAddInferenceJobResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.Personalizedtxt2imgAddInferenceJobResponseBodyData = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.Personalizedtxt2imgAddInferenceJobResponseBodyData()
...
class Personalizedtxt2imgAddInferenceJobResponseBodyData(DaraModel):
    def __init__(
        self,

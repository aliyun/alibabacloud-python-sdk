...
class GetAITeacherSyncDialogueSuggestionResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.GetAITeacherSyncDialogueSuggestionResponseBodyData = None,
        err_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.GetAITeacherSyncDialogueSuggestionResponseBodyData()
...
class GetAITeacherSyncDialogueSuggestionResponseBodyData(DaraModel):
    def __init__(
        self,

...
class CreateServiceAutoScalerRequest(DaraModel):
    def __init__(
        self,
        behavior: main_models.CreateServiceAutoScalerRequestBehavior = None,
        max: int = None,
        min: int = None,
        scale_strategies: List[main_models.CreateServiceAutoScalerRequestScaleStrategies] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('behavior') is not None:
            temp_model = main_models.CreateServiceAutoScalerRequestBehavior()
        ...
        if m.get('scaleStrategies') is not None:
            for k1 in m.get('scaleStrategies'):
                temp_model = main_models.CreateServiceAutoScalerRequestScaleStrategies()
                self.scale_strategies.append(temp_model.from_map(k1))

        return self

class CreateServiceAutoScalerRequestScaleStrategies(DaraModel):
    def __init__(
        self,
...
class CreateServiceAutoScalerRequestBehavior(DaraModel):
    def __init__(
        self,
        on_zero: main_models.CreateServiceAutoScalerRequestBehaviorOnZero = None,
        scale_down: main_models.CreateServiceAutoScalerRequestBehaviorScaleDown = None,
        scale_up: main_models.CreateServiceAutoScalerRequestBehaviorScaleUp = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('onZero') is not None:
            temp_model = main_models.CreateServiceAutoScalerRequestBehaviorOnZero()
            self.on_zero = temp_model.from_map(m.get('onZero'))

        if m.get('scaleDown') is not None:
            temp_model = main_models.CreateServiceAutoScalerRequestBehaviorScaleDown()
            self.scale_down = temp_model.from_map(m.get('scaleDown'))

        if m.get('scaleUp') is not None:
            temp_model = main_models.CreateServiceAutoScalerRequestBehaviorScaleUp()
            self.scale_up = temp_model.from_map(m.get('scaleUp'))

        return self

class CreateServiceAutoScalerRequestBehaviorScaleUp(DaraModel):
    def __init__(
        self,
...
class CreateServiceAutoScalerRequestBehaviorScaleDown(DaraModel):
    def __init__(
        self,
        stabilization_window_seconds: int = None,
    ):
...
class CreateServiceAutoScalerRequestBehaviorOnZero(DaraModel):
    def __init__(
        self,

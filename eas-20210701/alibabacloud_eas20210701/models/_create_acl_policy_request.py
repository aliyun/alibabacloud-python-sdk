...
class CreateAclPolicyRequest(DaraModel):
    def __init__(
        self,
        acl_policy_list: List[main_models.CreateAclPolicyRequestAclPolicyList] = None,
        vpc_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AclPolicyList') is not None:
            for k1 in m.get('AclPolicyList'):
                temp_model = main_models.CreateAclPolicyRequestAclPolicyList()
...
class CreateAclPolicyRequestAclPolicyList(DaraModel):
    def __init__(
        self,
        comment: str = None,
        entry: str = None,

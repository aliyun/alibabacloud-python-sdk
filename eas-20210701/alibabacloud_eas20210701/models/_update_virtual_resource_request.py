...
class UpdateVirtualResourceRequest(DaraModel):
    def __init__(
        self,
        disable_spot_protection_period: bool = None,
        resources: List[main_models.UpdateVirtualResourceRequestResources] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Resources') is not None:
            for k1 in m.get('Resources'):
                temp_model = main_models.UpdateVirtualResourceRequestResources()
...
class UpdateVirtualResourceRequestResources(DaraModel):
    def __init__(
        self,

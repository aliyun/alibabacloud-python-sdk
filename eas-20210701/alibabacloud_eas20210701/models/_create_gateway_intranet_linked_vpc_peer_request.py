...
class CreateGatewayIntranetLinkedVpcPeerRequest(DaraModel):
    def __init__(
        self,
        peer_vpcs: List[main_models.CreateGatewayIntranetLinkedVpcPeerRequestPeerVpcs] = None,
        vpc_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PeerVpcs') is not None:
            for k1 in m.get('PeerVpcs'):
                temp_model = main_models.CreateGatewayIntranetLinkedVpcPeerRequestPeerVpcs()
...
class CreateGatewayIntranetLinkedVpcPeerRequestPeerVpcs(DaraModel):
    def __init__(
        self,
        region: str = None,
        vpc_id: str = None,

...
```bash
# 安装 alibabacloud_eas20210701
pip install alibabacloud_eas20210701
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/eas-20210701/ChangeLog.md)中。

...
class DescribePushMeteringDataRequest(TeaModel):
    def __init__(
        self,
        push_order_biz_id: str = None,
    ):
        # This parameter is required.
        self.push_order_biz_id = push_order_biz_id
    ...
    def to_map(self):
        ...
        result = dict()
        if self.push_order_biz_id is not None:
            result['PushOrderBizId'] = self.push_order_biz_id
        return result

    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('PushOrderBizId') is not None:
            self.push_order_biz_id = m.get('PushOrderBizId')
        return self


class DescribePushMeteringDataResponseBodyResult(TeaModel):
    def __init__(
        self,
        end_time: int = None,
        instance_id: str = None,
        is_push_billing: bool = None,
        ...
        self.is_push_billing = is_push_billing
    ...
    def to_map(self):
        ...
        if self.is_push_billing is not None:
            result['IsPushBilling'] = self.is_push_billing
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IsPushBilling') is not None:
            self.is_push_billing = m.get('IsPushBilling')
...
class DescribePushMeteringDataResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        ...
        message: str = None,
        request_id: str = None,
        result: DescribePushMeteringDataResponseBodyResult = None,
        success: bool = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = DescribePushMeteringDataResponseBodyResult()
...
class DescribePushMeteringDataResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: DescribePushMeteringDataResponseBody = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('body') is not None:
            temp_model = DescribePushMeteringDataResponseBody()

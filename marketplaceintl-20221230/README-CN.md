...
## Alibaba Cloud marketplaceIntl SDK for Python
...
```bash
# 安装 alibabacloud_marketplaceintl20221230
pip install alibabacloud_marketplaceintl20221230
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/marketplaceintl-20221230/ChangeLog.md)中。

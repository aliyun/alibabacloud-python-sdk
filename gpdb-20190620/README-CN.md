...
```bash
# 安装 alibabacloud_gpdb20190620
pip install alibabacloud_gpdb20190620
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/gpdb-20190620/ChangeLog.md)中。

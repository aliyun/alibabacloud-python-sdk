...
class GetLogsResponseBody(DaraModel):
    def __init__(
        self,
        data: List[Dict[str, str]] = None,
        meta: main_models.GetLogsResponseBodyMeta = None,
    ):
        self.data = data
        self.meta = meta
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('meta') is not None:
            temp_model = main_models.GetLogsResponseBodyMeta()
            self.meta = temp_model.from_map(m.get('meta'))

        return self

class GetLogsResponseBodyMeta(DaraModel):
    def __init__(
        self,
        agg_query: str = None,
        ...
        limited: int = None,
        mode: int = None,
        phrase_query_info: main_models.GetLogsResponseBodyMetaPhraseQueryInfo = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('phraseQueryInfo') is not None:
            temp_model = main_models.GetLogsResponseBodyMetaPhraseQueryInfo()
...
class GetLogsResponseBodyMetaPhraseQueryInfo(DaraModel):
    def __init__(
        self,

...
class UpdateLoggingRequest(DaraModel):
    def __init__(
        self,
        logging_details: List[main_models.UpdateLoggingRequestLoggingDetails] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('loggingDetails') is not None:
            for k1 in m.get('loggingDetails'):
                temp_model = main_models.UpdateLoggingRequestLoggingDetails()
...
class UpdateLoggingRequestLoggingDetails(DaraModel):
    def __init__(
        self,
        logstore: str = None,
        type: str = None,

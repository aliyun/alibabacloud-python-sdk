...
class UpdateMachineGroupRequest(DaraModel):
    def __init__(
        self,
        group_attribute: main_models.UpdateMachineGroupRequestGroupAttribute = None,
        group_name: str = None,
        group_type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('groupAttribute') is not None:
            temp_model = main_models.UpdateMachineGroupRequestGroupAttribute()
...
class UpdateMachineGroupRequestGroupAttribute(DaraModel):
    def __init__(
        self,

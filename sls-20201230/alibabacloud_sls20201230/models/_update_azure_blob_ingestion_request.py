...
class UpdateAzureBlobIngestionRequest(DaraModel):
    def __init__(
        self,
        configuration: main_models.AzureBlobIngestionConfiguration = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('configuration') is not None:
            temp_model = main_models.AzureBlobIngestionConfiguration()

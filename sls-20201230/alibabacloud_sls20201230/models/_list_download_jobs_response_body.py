...
class ListDownloadJobsResponseBody(DaraModel):
    def __init__(
        self,
        count: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('results') is not None:
            for k1 in m.get('results'):
                temp_model = main_models.ListDownloadJobsResponseBodyResults()
...
class ListDownloadJobsResponseBodyResults(DaraModel):
    def __init__(
        self,
        configuration: main_models.ListDownloadJobsResponseBodyResultsConfiguration = None,
        create_time: str = None,
        description: str = None,
        display_name: str = None,
        execution_details: main_models.ListDownloadJobsResponseBodyResultsExecutionDetails = None,
        name: str = None,
        status: str = None,
    ):
        # 下载配置
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('configuration') is not None:
            temp_model = main_models.ListDownloadJobsResponseBodyResultsConfiguration()
        ...
        if m.get('executionDetails') is not None:
            temp_model = main_models.ListDownloadJobsResponseBodyResultsExecutionDetails()
...
class ListDownloadJobsResponseBodyResultsExecutionDetails(DaraModel):
    def __init__(
        self,
        check_sum: str = None,
...
class ListDownloadJobsResponseBodyResultsConfiguration(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('sink') is not None:
            temp_model = main_models.ListDownloadJobsResponseBodyResultsConfigurationSink()
...
class ListDownloadJobsResponseBodyResultsConfigurationSink(DaraModel):
    def __init__(
        self,
        bucket: str = None,

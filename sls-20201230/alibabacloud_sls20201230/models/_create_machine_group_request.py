...
class CreateMachineGroupRequest(DaraModel):
    def __init__(
        self,
        group_attribute: main_models.CreateMachineGroupRequestGroupAttribute = None,
        group_name: str = None,
        group_type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('groupAttribute') is not None:
            temp_model = main_models.CreateMachineGroupRequestGroupAttribute()
...
class CreateMachineGroupRequestGroupAttribute(DaraModel):
    def __init__(
        self,

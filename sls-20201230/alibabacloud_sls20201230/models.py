...
class CreateETLJobResponseBody(TeaModel):
    def __init__(
        self,
        code: int = None,
        data: str = None,
...
class CreateETLJobResponse(TeaModel):
    def __init__(
        ...
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CreateETLJobResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CreateETLJobResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class CreateJobTestRequest(TeaModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('sinks') is not None:
            self.sinks = m.get('sinks')
        if m.get('toTime') is not None:
            self.to_time = m.get('toTime')
        return self


class CreateJobTestResponseBody(TeaModel):
    def __init__(
        self,
        code: int = None,
        data: str = None,
...
class CreateJobTestResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CreateJobTestResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CreateJobTestResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class ListETLJobsRequest(TeaModel):
    def __init__(
        self,
        type: str = None,
    ):
...
class UpdateEtlJobResponseBody(TeaModel):
    def __init__(
        self,
        code: int = None,
...
class UpdateEtlJobResponse(TeaModel):
    def __init__(
        ...
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: UpdateEtlJobResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = UpdateEtlJobResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

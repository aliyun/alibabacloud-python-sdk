...
```bash
# 安装 alibabacloud_voicenavigator20180612
pip install alibabacloud_voicenavigator20180612
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/voicenavigator-20180612/ChangeLog.md)中。

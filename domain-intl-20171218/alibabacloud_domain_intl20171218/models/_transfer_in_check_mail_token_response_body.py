...
class TransferInCheckMailTokenResponseBody(DaraModel):
    def __init__(
        self,
        fail_list: main_models.TransferInCheckMailTokenResponseBodyFailList = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FailList') is not None:
            temp_model = main_models.TransferInCheckMailTokenResponseBodyFailList()
        ...
        if m.get('SuccessList') is not None:
            temp_model = main_models.TransferInCheckMailTokenResponseBodySuccessList()
            self.success_list = temp_model.from_map(m.get('SuccessList'))

        return self

class TransferInCheckMailTokenResponseBodySuccessList(DaraModel):
    def __init__(
        self,
...
class TransferInCheckMailTokenResponseBodyFailList(DaraModel):
    def __init__(
        self,

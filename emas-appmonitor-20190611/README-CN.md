...
```bash
# 安装 alibabacloud_emas_appmonitor20190611
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/emas-appmonitor-20190611/ChangeLog.md)中。

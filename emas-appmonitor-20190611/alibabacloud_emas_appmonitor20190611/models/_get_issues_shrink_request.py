...
class GetIssuesShrinkRequest(DaraModel):
    def __init__(
        self,
        app_key: int = None,
        biz_module: str = None,
        ...
        page_size: int = None,
        status: int = None,
        time_range: main_models.GetIssuesShrinkRequestTimeRange = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TimeRange') is not None:
            temp_model = main_models.GetIssuesShrinkRequestTimeRange()
            self.time_range = temp_model.from_map(m.get('TimeRange'))

        return self

class GetIssuesShrinkRequestTimeRange(DaraModel):
    def __init__(
        self,
        end_time: int = None,

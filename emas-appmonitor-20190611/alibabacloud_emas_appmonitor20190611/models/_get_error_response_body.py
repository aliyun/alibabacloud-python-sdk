...
class GetErrorResponseBody(DaraModel):
    def __init__(
        self,
        args: Dict[str, Any] = None,
        error_code: int = None,
        message: str = None,
        model: main_models.GetErrorResponseBodyModel = None,
        request_id: str = None,
        success: bool = None,
    ):
        self.args = args
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Model') is not None:
            temp_model = main_models.GetErrorResponseBodyModel()
...
class GetErrorResponseBodyModel(DaraModel):
    def __init__(
        self,
        access: str = None,
        ...
        self.launched_crash_stage = launched_crash_stage
    ...
    def to_map(self):
        ...
        if self.file_descriptor is not None:
            result['FileDescriptor'] = self.file_descriptor
        ...
        if self.launched_crash_stage is not None:
            result['LaunchedCrashStage'] = self.launched_crash_stage
        ...
        if self.mem_info is not None:
            result['MemInfo'] = self.mem_info
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Controllers') is not None:
            self.controllers = m.get('Controllers')
        ...
        if m.get('FileDescriptor') is not None:
            self.file_descriptor = m.get('FileDescriptor')
        ...
        if m.get('LaunchedCrashStage') is not None:
            self.launched_crash_stage = m.get('LaunchedCrashStage')
        ...
        if m.get('MemInfo') is not None:
            self.mem_info = m.get('MemInfo')

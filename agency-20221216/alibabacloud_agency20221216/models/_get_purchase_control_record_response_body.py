...
class GetPurchaseControlRecordResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: List[main_models.GetPurchaseControlRecordResponseBodyData] = None,
        page_no: int = None,
        page_size: int = None,
        request_id: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.GetPurchaseControlRecordResponseBodyData()
...
class GetPurchaseControlRecordResponseBodyData(DaraModel):
    def __init__(
        self,

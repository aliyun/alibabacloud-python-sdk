...
```bash
# 安装 alibabacloud_airticketopen20230117
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/airticketopen-20230117/ChangeLog.md)中。

...
class CreateOrderRequest(DaraModel):
    def __init__(
        self,
        account_no: int = None,
        contact: main_models.CreateOrderRequestContact = None,
        external_order_no: str = None,
        guests: List[List[main_models.CreateOrderRequestGuests]] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Contact') is not None:
            temp_model = main_models.CreateOrderRequestContact()
        ...
        if m.get('Guests') is not None:
            for k1 in m.get('Guests'):
                l1 = []
                for k2 in k1:
                    temp_model = main_models.CreateOrderRequestGuests()
...
class CreateOrderRequestGuests(DaraModel):
    def __init__(
        self,
        first_name: str = None,
        last_name: str = None,
...
class CreateOrderRequestContact(DaraModel):
    def __init__(
        self,
        email: str = None,
        first_name: str = None,

...
class StandardSearchResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        data: main_models.StandardSearchResponseBodyData = None,
        error_code: str = None,
        error_data: Any = None,
        error_msg: str = None,
        status: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.StandardSearchResponseBodyData()
...
class StandardSearchResponseBodyData(DaraModel):
    def __init__(
        self,
        solution_list: List[main_models.StandardSearchResponseBodyDataSolutionList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('solution_list') is not None:
            for k1 in m.get('solution_list'):
                temp_model = main_models.StandardSearchResponseBodyDataSolutionList()
                self.solution_list.append(temp_model.from_map(k1))

        return self

class StandardSearchResponseBodyDataSolutionList(DaraModel):
    def __init__(
        self,
        ...
        journey_list: List[main_models.StandardSearchResponseBodyDataSolutionListJourneyList] = None,
        segment_baggage_check_in_info_list: List[main_models.StandardSearchResponseBodyDataSolutionListSegmentBaggageCheckInInfoList] = None,
        segment_baggage_mapping_list: List[main_models.StandardSearchResponseBodyDataSolutionListSegmentBaggageMappingList] = None,
        segment_refund_change_rule_mapping_list: List[main_models.StandardSearchResponseBodyDataSolutionListSegmentRefundChangeRuleMappingList] = None,
        solution_attribute: main_models.StandardSearchResponseBodyDataSolutionListSolutionAttribute = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('journey_list') is not None:
            for k1 in m.get('journey_list'):
                temp_model = main_models.StandardSearchResponseBodyDataSolutionListJourneyList()
        ...
        if m.get('segment_baggage_check_in_info_list') is not None:
            for k1 in m.get('segment_baggage_check_in_info_list'):
                temp_model = main_models.StandardSearchResponseBodyDataSolutionListSegmentBaggageCheckInInfoList()
        ...
        if m.get('segment_baggage_mapping_list') is not None:
            for k1 in m.get('segment_baggage_mapping_list'):
                temp_model = main_models.StandardSearchResponseBodyDataSolutionListSegmentBaggageMappingList()
        ...
        if m.get('segment_refund_change_rule_mapping_list') is not None:
            for k1 in m.get('segment_refund_change_rule_mapping_list'):
                temp_model = main_models.StandardSearchResponseBodyDataSolutionListSegmentRefundChangeRuleMappingList()
                self.segment_refund_change_rule_mapping_list.append(temp_model.from_map(k1))

        if m.get('solution_attribute') is not None:
            temp_model = main_models.StandardSearchResponseBodyDataSolutionListSolutionAttribute()
...
class StandardSearchResponseBodyDataSolutionListSolutionAttribute(DaraModel):
    def __init__(
        self,
        issue_time_info: main_models.StandardSearchResponseBodyDataSolutionListSolutionAttributeIssueTimeInfo = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('issue_time_info') is not None:
            temp_model = main_models.StandardSearchResponseBodyDataSolutionListSolutionAttributeIssueTimeInfo()
...
class StandardSearchResponseBodyDataSolutionListSolutionAttributeIssueTimeInfo(DaraModel):
    def __init__(
        self,
...
class StandardSearchResponseBodyDataSolutionListSegmentRefundChangeRuleMappingList(DaraModel):
    def __init__(
        self,
...
class StandardSearchResponseBodyDataSolutionListSegmentBaggageMappingList(DaraModel):
    def __init__(
        self,
...
class StandardSearchResponseBodyDataSolutionListSegmentBaggageCheckInInfoList(DaraModel):
    def __init__(
        self,
...
class StandardSearchResponseBodyDataSolutionListJourneyList(DaraModel):
    def __init__(
        self,
        segment_list: List[main_models.StandardSearchResponseBodyDataSolutionListJourneyListSegmentList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('segment_list') is not None:
            for k1 in m.get('segment_list'):
                temp_model = main_models.StandardSearchResponseBodyDataSolutionListJourneyListSegmentList()
...
class StandardSearchResponseBodyDataSolutionListJourneyListSegmentList(DaraModel):
    def __init__(
        self,

...
class QueryOrderResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.QueryOrderResponseBodyData = None,
        error_code: str = None,
        error_msg: str = None,
        request_id: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.QueryOrderResponseBodyData()
...
class QueryOrderResponseBodyData(DaraModel):
    def __init__(
        self,
        buyer_id: str = None,
        external_order_no: str = None,
        gmt_create: int = None,
        item_info: main_models.QueryOrderResponseBodyDataItemInfo = None,
        order_no: str = None,
        payment: main_models.QueryOrderResponseBodyDataPayment = None,
        refund_orders: List[main_models.QueryOrderResponseBodyDataRefundOrders] = None,
        room_stays: List[main_models.QueryOrderResponseBodyDataRoomStays] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ItemInfo') is not None:
            temp_model = main_models.QueryOrderResponseBodyDataItemInfo()
...
class QueryOrderResponseBodyDataRoomStays(DaraModel):
    def __init__(
        self,
        confirmation_id: str = None,
        guests: List[main_models.QueryOrderResponseBodyDataRoomStaysGuests] = None,
        room_index: int = None,
        room_name: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Guests') is not None:
            for k1 in m.get('Guests'):
                temp_model = main_models.QueryOrderResponseBodyDataRoomStaysGuests()
...
class QueryOrderResponseBodyDataRoomStaysGuests(DaraModel):
    def __init__(
        self,
        first_name: str = None,
        last_name: str = None,
...
class QueryOrderResponseBodyDataRefundOrders(DaraModel):
    def __init__(
        self,
        gmt_create: int = None,
        ...
        status: str = None,
        total_penalty_amount: main_models.QueryOrderResponseBodyDataRefundOrdersTotalPenaltyAmount = None,
        total_refund_amount: main_models.QueryOrderResponseBodyDataRefundOrdersTotalRefundAmount = None,
    ):
        self.gmt_create = gmt_create
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TotalPenaltyAmount') is not None:
            temp_model = main_models.QueryOrderResponseBodyDataRefundOrdersTotalPenaltyAmount()
            self.total_penalty_amount = temp_model.from_map(m.get('TotalPenaltyAmount'))

        if m.get('TotalRefundAmount') is not None:
            temp_model = main_models.QueryOrderResponseBodyDataRefundOrdersTotalRefundAmount()
            self.total_refund_amount = temp_model.from_map(m.get('TotalRefundAmount'))

        return self

class QueryOrderResponseBodyDataRefundOrdersTotalRefundAmount(DaraModel):
    def __init__(
        self,
        amount: str = None,
        currency: str = None,
...
class QueryOrderResponseBodyDataRefundOrdersTotalPenaltyAmount(DaraModel):
    def __init__(
        self,
        amount: str = None,
        currency: str = None,
...
class QueryOrderResponseBodyDataPayment(DaraModel):
    def __init__(
        self,
        amount: main_models.QueryOrderResponseBodyDataPaymentAmount = None,
        gmt_paid: int = None,
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('Amount') is not None:
            temp_model = main_models.QueryOrderResponseBodyDataPaymentAmount()
...
class QueryOrderResponseBodyDataPaymentAmount(DaraModel):
    def __init__(
        self,
        amount: str = None,
        currency: str = None,
...
class QueryOrderResponseBodyDataItemInfo(DaraModel):
    def __init__(
        self,
        cancel_policy: main_models.QueryOrderResponseBodyDataItemInfoCancelPolicy = None,
        check_in: str = None,
        check_in_number: int = None,
        check_out: str = None,
        daily_prices: List[main_models.QueryOrderResponseBodyDataItemInfoDailyPrices] = None,
        meal: main_models.QueryOrderResponseBodyDataItemInfoMeal = None,
        room_count: int = None,
        selling_total_price: main_models.QueryOrderResponseBodyDataItemInfoSellingTotalPrice = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CancelPolicy') is not None:
            temp_model = main_models.QueryOrderResponseBodyDataItemInfoCancelPolicy()
        ...
        if m.get('DailyPrices') is not None:
            for k1 in m.get('DailyPrices'):
                temp_model = main_models.QueryOrderResponseBodyDataItemInfoDailyPrices()
                self.daily_prices.append(temp_model.from_map(k1))

        if m.get('Meal') is not None:
            temp_model = main_models.QueryOrderResponseBodyDataItemInfoMeal()
        ...
        if m.get('SellingTotalPrice') is not None:
            temp_model = main_models.QueryOrderResponseBodyDataItemInfoSellingTotalPrice()
            self.selling_total_price = temp_model.from_map(m.get('SellingTotalPrice'))

        return self

class QueryOrderResponseBodyDataItemInfoSellingTotalPrice(DaraModel):
    def __init__(
        self,
        amount: str = None,
        currency: str = None,
...
class QueryOrderResponseBodyDataItemInfoMeal(DaraModel):
    def __init__(
        self,
...
class QueryOrderResponseBodyDataItemInfoDailyPrices(DaraModel):
    def __init__(
        self,
        date: str = None,
        price: main_models.QueryOrderResponseBodyDataItemInfoDailyPricesPrice = None,
    ):
        self.date = date
        self.price = price
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Price') is not None:
            temp_model = main_models.QueryOrderResponseBodyDataItemInfoDailyPricesPrice()
            self.price = temp_model.from_map(m.get('Price'))

        return self

class QueryOrderResponseBodyDataItemInfoDailyPricesPrice(DaraModel):
    def __init__(
        self,
        cent: int = None,
        currency: main_models.QueryOrderResponseBodyDataItemInfoDailyPricesPriceCurrency = None,
    ):
        self.cent = cent
        self.currency = currency
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Currency') is not None:
            temp_model = main_models.QueryOrderResponseBodyDataItemInfoDailyPricesPriceCurrency()
            self.currency = temp_model.from_map(m.get('Currency'))

        return self

class QueryOrderResponseBodyDataItemInfoDailyPricesPriceCurrency(DaraModel):
    def __init__(
        self,
...
class QueryOrderResponseBodyDataItemInfoCancelPolicy(DaraModel):
    def __init__(
        self,
        penalties: List[main_models.QueryOrderResponseBodyDataItemInfoCancelPolicyPenalties] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Penalties') is not None:
            for k1 in m.get('Penalties'):
                temp_model = main_models.QueryOrderResponseBodyDataItemInfoCancelPolicyPenalties()
...
class QueryOrderResponseBodyDataItemInfoCancelPolicyPenalties(DaraModel):
    def __init__(
        self,
        currency: str = None,
        end: int = None,

...
class DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValue(DaraModel):
    def __init__(
        self,
        refund_rule_all_unused_list: List[main_models.DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValueRefundRuleAllUnusedList] = None,
        refund_rule_part_unused_list: List[main_models.DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValueRefundRulePartUnusedList] = None,
        change_rule_in_unused_list: List[main_models.DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValueChangeRuleInUnusedList] = None,
        change_rule_out_unused_list: List[main_models.DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValueChangeRuleOutUnusedList] = None,
    ):
        # 全程未使用退票规则
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('refund_rule_all_unused_list') is not None:
            for k1 in m.get('refund_rule_all_unused_list'):
                temp_model = main_models.DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValueRefundRuleAllUnusedList()
        ...
        if m.get('refund_rule_part_unused_list') is not None:
            for k1 in m.get('refund_rule_part_unused_list'):
                temp_model = main_models.DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValueRefundRulePartUnusedList()
        ...
        if m.get('change_rule_in_unused_list') is not None:
            for k1 in m.get('change_rule_in_unused_list'):
                temp_model = main_models.DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValueChangeRuleInUnusedList()
        ...
        if m.get('change_rule_out_unused_list') is not None:
            for k1 in m.get('change_rule_out_unused_list'):
                temp_model = main_models.DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValueChangeRuleOutUnusedList()
                self.change_rule_out_unused_list.append(temp_model.from_map(k1))

        return self

class DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValueChangeRuleOutUnusedList(DaraModel):
    def __init__(
        self,
        type: int = None,
        time_unit: str = None,
...
class DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValueChangeRuleInUnusedList(DaraModel):
    def __init__(
        self,
        type: int = None,
        time_unit: str = None,
...
class DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValueRefundRulePartUnusedList(DaraModel):
    def __init__(
        self,
        type: int = None,
        time_unit: str = None,
...
class DataSolutionSegmentRefundChangeRuleMappingListRefundChangeRuleMapValueRefundRuleAllUnusedList(DaraModel):
    def __init__(
        self,
        type: int = None,
        time_unit: str = None,

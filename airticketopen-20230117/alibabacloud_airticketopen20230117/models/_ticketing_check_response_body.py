...
class TicketingCheckResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        data: main_models.TicketingCheckResponseBodyData = None,
        error_code: str = None,
        error_data: Any = None,
        error_msg: str = None,
        status: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.TicketingCheckResponseBodyData()
...
class TicketingCheckResponseBodyData(DaraModel):
    def __init__(
        self,
        order_num: int = None,
    ):

...
class ChangeDetailResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        data: main_models.ChangeDetailResponseBodyData = None,
        error_code: str = None,
        error_data: Any = None,
        error_msg: str = None,
        status: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.ChangeDetailResponseBodyData()
...
class ChangeDetailResponseBodyData(DaraModel):
    def __init__(
        self,
        change_fee_details: List[main_models.ChangeDetailResponseBodyDataChangeFeeDetails] = None,
        change_order_num: int = None,
        change_passengers: List[main_models.ChangeDetailResponseBodyDataChangePassengers] = None,
        change_reason_type: int = None,
        changed_journeys: List[main_models.ChangeDetailResponseBodyDataChangedJourneys] = None,
        close_reason: str = None,
        close_utc_time: int = None,
        contact: main_models.ChangeDetailResponseBodyDataContact = None,
        create_utc_time: int = None,
        last_confirm_utc_time: int = None,
        last_journeys: List[main_models.ChangeDetailResponseBodyDataLastJourneys] = None,
        order_num: int = None,
        order_status: int = None,
        original_journeys: List[main_models.ChangeDetailResponseBodyDataOriginalJourneys] = None,
        pay_status: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('change_fee_details') is not None:
            for k1 in m.get('change_fee_details'):
                temp_model = main_models.ChangeDetailResponseBodyDataChangeFeeDetails()
        ...
        if m.get('change_passengers') is not None:
            for k1 in m.get('change_passengers'):
                temp_model = main_models.ChangeDetailResponseBodyDataChangePassengers()
        ...
        if m.get('changed_journeys') is not None:
            for k1 in m.get('changed_journeys'):
                temp_model = main_models.ChangeDetailResponseBodyDataChangedJourneys()
        ...
        if m.get('contact') is not None:
            temp_model = main_models.ChangeDetailResponseBodyDataContact()
        ...
        if m.get('last_journeys') is not None:
            for k1 in m.get('last_journeys'):
                temp_model = main_models.ChangeDetailResponseBodyDataLastJourneys()
        ...
        if m.get('original_journeys') is not None:
            for k1 in m.get('original_journeys'):
                temp_model = main_models.ChangeDetailResponseBodyDataOriginalJourneys()
...
class ChangeDetailResponseBodyDataOriginalJourneys(DaraModel):
    def __init__(
        self,
        segment_list: List[main_models.ChangeDetailResponseBodyDataOriginalJourneysSegmentList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('segment_list') is not None:
            for k1 in m.get('segment_list'):
                temp_model = main_models.ChangeDetailResponseBodyDataOriginalJourneysSegmentList()
...
class ChangeDetailResponseBodyDataOriginalJourneysSegmentList(DaraModel):
    def __init__(
        self,
...
class ChangeDetailResponseBodyDataLastJourneys(DaraModel):
    def __init__(
        self,
        segment_list: List[main_models.ChangeDetailResponseBodyDataLastJourneysSegmentList] = None,
        transfer_count: int = None,
    ):
        # The segment information.
        self.segment_list = segment_list
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('segment_list') is not None:
            for k1 in m.get('segment_list'):
                temp_model = main_models.ChangeDetailResponseBodyDataLastJourneysSegmentList()
                self.segment_list.append(temp_model.from_map(k1))
...
class ChangeDetailResponseBodyDataLastJourneysSegmentList(DaraModel):
    def __init__(
        self,
        arrival_airport: str = None,
        arrival_city: str = None,
...
class ChangeDetailResponseBodyDataContact(DaraModel):
    def __init__(
        self,
        email: str = None,
...
class ChangeDetailResponseBodyDataChangedJourneys(DaraModel):
    def __init__(
        self,
        segment_list: List[main_models.ChangeDetailResponseBodyDataChangedJourneysSegmentList] = None,
        transfer_count: int = None,
    ):
        # The segment information.
        self.segment_list = segment_list
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('segment_list') is not None:
            for k1 in m.get('segment_list'):
                temp_model = main_models.ChangeDetailResponseBodyDataChangedJourneysSegmentList()
                self.segment_list.append(temp_model.from_map(k1))
...
class ChangeDetailResponseBodyDataChangedJourneysSegmentList(DaraModel):
    def __init__(
        self,
        arrival_airport: str = None,
        arrival_city: str = None,
...
class ChangeDetailResponseBodyDataChangePassengers(DaraModel):
    def __init__(
        self,
        document: str = None,
        first_name: str = None,
...
class ChangeDetailResponseBodyDataChangeFeeDetails(DaraModel):
    def __init__(
        self,
        change_fee: main_models.ChangeDetailResponseBodyDataChangeFeeDetailsChangeFee = None,
        passenger: main_models.ChangeDetailResponseBodyDataChangeFeeDetailsPassenger = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('change_fee') is not None:
            temp_model = main_models.ChangeDetailResponseBodyDataChangeFeeDetailsChangeFee()
            self.change_fee = temp_model.from_map(m.get('change_fee'))

        if m.get('passenger') is not None:
            temp_model = main_models.ChangeDetailResponseBodyDataChangeFeeDetailsPassenger()
            self.passenger = temp_model.from_map(m.get('passenger'))

        return self

class ChangeDetailResponseBodyDataChangeFeeDetailsPassenger(DaraModel):
    def __init__(
        self,
        document: str = None,
        first_name: str = None,
...
class ChangeDetailResponseBodyDataChangeFeeDetailsChangeFee(DaraModel):
    def __init__(
        self,

...
class CancelOrRefundResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.CancelOrRefundResponseBodyData = None,
        error_code: str = None,
        error_msg: str = None,
        request_id: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CancelOrRefundResponseBodyData()
...
class CancelOrRefundResponseBodyData(DaraModel):
    def __init__(
        self,
        refund_order_id: str = None,
        total_penalty_amount: main_models.CancelOrRefundResponseBodyDataTotalPenaltyAmount = None,
        total_refund_amount: main_models.CancelOrRefundResponseBodyDataTotalRefundAmount = None,
        tracer_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TotalPenaltyAmount') is not None:
            temp_model = main_models.CancelOrRefundResponseBodyDataTotalPenaltyAmount()
            self.total_penalty_amount = temp_model.from_map(m.get('TotalPenaltyAmount'))

        if m.get('TotalRefundAmount') is not None:
            temp_model = main_models.CancelOrRefundResponseBodyDataTotalRefundAmount()
...
class CancelOrRefundResponseBodyDataTotalRefundAmount(DaraModel):
    def __init__(
        self,
        amount: str = None,
        currency: str = None,
...
class CancelOrRefundResponseBodyDataTotalPenaltyAmount(DaraModel):
    def __init__(
        self,
        amount: str = None,
        currency: str = None,

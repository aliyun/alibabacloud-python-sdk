...
class GlobalHotelQueryCalendarAvailabilityShrinkRequest(DaraModel):
    def __init__(
        self,
        account_no: int = None,
    ...
    def to_map(self):
        ...
        if self.standard_hotel_ids_shrink is not None:
            result['StandardHotelIds'] = self.standard_hotel_ids_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('StandardHotelIds') is not None:
            self.standard_hotel_ids_shrink = m.get('StandardHotelIds')

...
class FileUploadResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        data: main_models.FileUploadResponseBodyData = None,
        error_code: str = None,
        error_data: Any = None,
        error_msg: str = None,
        status: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.FileUploadResponseBodyData()
...
class FileUploadResponseBodyData(DaraModel):
    def __init__(
        self,

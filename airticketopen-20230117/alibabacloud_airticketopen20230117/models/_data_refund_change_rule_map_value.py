...
class DataRefundChangeRuleMapValue(DaraModel):
    def __init__(
        self,
        refund_rule_all_unused_list: List[main_models.DataRefundChangeRuleMapValueRefundRuleAllUnusedList] = None,
        refund_rule_part_unused_list: List[main_models.DataRefundChangeRuleMapValueRefundRulePartUnusedList] = None,
        change_rule_in_unused_list: List[main_models.DataRefundChangeRuleMapValueChangeRuleInUnusedList] = None,
        change_rule_out_unused_list: List[main_models.DataRefundChangeRuleMapValueChangeRuleOutUnusedList] = None,
    ):
        # 全程未使用退票规则
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('refund_rule_all_unused_list') is not None:
            for k1 in m.get('refund_rule_all_unused_list'):
                temp_model = main_models.DataRefundChangeRuleMapValueRefundRuleAllUnusedList()
        ...
        if m.get('refund_rule_part_unused_list') is not None:
            for k1 in m.get('refund_rule_part_unused_list'):
                temp_model = main_models.DataRefundChangeRuleMapValueRefundRulePartUnusedList()
        ...
        if m.get('change_rule_in_unused_list') is not None:
            for k1 in m.get('change_rule_in_unused_list'):
                temp_model = main_models.DataRefundChangeRuleMapValueChangeRuleInUnusedList()
        ...
        if m.get('change_rule_out_unused_list') is not None:
            for k1 in m.get('change_rule_out_unused_list'):
                temp_model = main_models.DataRefundChangeRuleMapValueChangeRuleOutUnusedList()
                self.change_rule_out_unused_list.append(temp_model.from_map(k1))

        return self

class DataRefundChangeRuleMapValueChangeRuleOutUnusedList(DaraModel):
    def __init__(
        self,
        type: int = None,
        time_unit: str = None,
...
class DataRefundChangeRuleMapValueChangeRuleInUnusedList(DaraModel):
    def __init__(
        self,
        type: int = None,
        time_unit: str = None,
...
class DataRefundChangeRuleMapValueRefundRulePartUnusedList(DaraModel):
    def __init__(
        self,
        type: int = None,
        time_unit: str = None,
...
class DataRefundChangeRuleMapValueRefundRuleAllUnusedList(DaraModel):
    def __init__(
        self,
        type: int = None,
        time_unit: str = None,

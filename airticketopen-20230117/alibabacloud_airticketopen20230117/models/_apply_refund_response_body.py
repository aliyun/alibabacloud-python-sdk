...
class ApplyRefundResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.ApplyRefundResponseBodyData = None,
        error_code: str = None,
        error_msg: str = None,
        request_id: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ApplyRefundResponseBodyData()
...
class ApplyRefundResponseBodyData(DaraModel):
    def __init__(
        self,
        sell_refund_order_id: int = None,
        total_penalty_amount: main_models.ApplyRefundResponseBodyDataTotalPenaltyAmount = None,
        total_refund_amount: main_models.ApplyRefundResponseBodyDataTotalRefundAmount = None,
        tracer_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TotalPenaltyAmount') is not None:
            temp_model = main_models.ApplyRefundResponseBodyDataTotalPenaltyAmount()
            self.total_penalty_amount = temp_model.from_map(m.get('TotalPenaltyAmount'))

        if m.get('TotalRefundAmount') is not None:
            temp_model = main_models.ApplyRefundResponseBodyDataTotalRefundAmount()
...
class ApplyRefundResponseBodyDataTotalRefundAmount(DaraModel):
    def __init__(
        self,
        amount: str = None,
        currency: str = None,
...
class ApplyRefundResponseBodyDataTotalPenaltyAmount(DaraModel):
    def __init__(
        self,
        amount: str = None,
        currency: str = None,

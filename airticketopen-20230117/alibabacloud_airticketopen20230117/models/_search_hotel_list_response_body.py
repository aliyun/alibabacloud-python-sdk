...
class SearchHotelListResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.SearchHotelListResponseBodyData = None,
        error_code: str = None,
        error_msg: str = None,
        request_id: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.SearchHotelListResponseBodyData()
...
class SearchHotelListResponseBodyData(DaraModel):
    def __init__(
        self,
        hotels: List[main_models.SearchHotelListResponseBodyDataHotels] = None,
        total: int = None,
    ):
        self.hotels = hotels
        self.total = total
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Hotels') is not None:
            for k1 in m.get('Hotels'):
                temp_model = main_models.SearchHotelListResponseBodyDataHotels()
...
class SearchHotelListResponseBodyDataHotels(DaraModel):
    def __init__(
        self,
        city_name: str = None,

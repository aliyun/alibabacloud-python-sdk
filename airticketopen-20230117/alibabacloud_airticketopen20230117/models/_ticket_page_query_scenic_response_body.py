...
class TicketPageQueryScenicResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.TicketPageQueryScenicResponseBodyData = None,
        error_code: str = None,
        error_msg: str = None,
        request_id: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.TicketPageQueryScenicResponseBodyData()
...
class TicketPageQueryScenicResponseBodyData(DaraModel):
    def __init__(
        self,
        scenics: List[main_models.TicketPageQueryScenicResponseBodyDataScenics] = None,
        total_size: int = None,
    ):
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        result['Scenics'] = []
        if self.scenics is not None:
            for k1 in self.scenics:
                result['Scenics'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        self.scenics = []
        if m.get('Scenics') is not None:
            for k1 in m.get('Scenics'):
                temp_model = main_models.TicketPageQueryScenicResponseBodyDataScenics()
                self.scenics.append(temp_model.from_map(k1))
...
class TicketPageQueryScenicResponseBodyDataScenics(DaraModel):
    def __init__(
        self,
        address: str = None,
        city: str = None,

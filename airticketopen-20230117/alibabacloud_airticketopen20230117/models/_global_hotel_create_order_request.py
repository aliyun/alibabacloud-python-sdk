...
class GlobalHotelCreateOrderRequest(DaraModel):
    def __init__(
        self,
        account_no: int = None,
        contact: main_models.GlobalHotelCreateOrderRequestContact = None,
        external_order_no: str = None,
        guests: List[List[main_models.GlobalHotelCreateOrderRequestGuests]] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Contact') is not None:
            temp_model = main_models.GlobalHotelCreateOrderRequestContact()
        ...
        if m.get('Guests') is not None:
            for k1 in m.get('Guests'):
                l1 = []
                for k2 in k1:
                    temp_model = main_models.GlobalHotelCreateOrderRequestGuests()
...
class GlobalHotelCreateOrderRequestGuests(DaraModel):
    def __init__(
        self,
        first_name: str = None,
        last_name: str = None,
...
class GlobalHotelCreateOrderRequestContact(DaraModel):
    def __init__(
        self,
        email: str = None,
        first_name: str = None,

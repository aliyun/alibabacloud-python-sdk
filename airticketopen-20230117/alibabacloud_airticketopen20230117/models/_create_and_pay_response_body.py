...
class CreateAndPayResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.CreateAndPayResponseBodyData = None,
        error_code: str = None,
        error_msg: str = None,
        request_id: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CreateAndPayResponseBodyData()
...
class CreateAndPayResponseBodyData(DaraModel):
    def __init__(
        self,
        order_no: str = None,
        tracer_id: str = None,

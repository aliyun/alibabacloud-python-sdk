...
class TicketQueryProductResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.TicketQueryProductResponseBodyData = None,
        error_code: str = None,
        error_msg: str = None,
        request_id: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyData()
...
class TicketQueryProductResponseBodyData(DaraModel):
    def __init__(
        self,
        product: main_models.TicketQueryProductResponseBodyDataProduct = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Product') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProduct()
            self.product = temp_model.from_map(m.get('Product'))

        return self

class TicketQueryProductResponseBodyDataProduct(DaraModel):
    def __init__(
        self,
        booking_type: int = None,
        buy_rule: main_models.TicketQueryProductResponseBodyDataProductBuyRule = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BuyRule') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductBuyRule()
        ...
        if m.get('RefundRule') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductRefundRule()
            self.refund_rule = temp_model.from_map(m.get('RefundRule'))

        if m.get('Region') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductRegion()
        ...
        if m.get('UseRule') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductUseRule()
            self.use_rule = temp_model.from_map(m.get('UseRule'))

        return self

class TicketQueryProductResponseBodyDataProductUseRule(DaraModel):
    def __init__(
        self,
        effect_time_point_rule: main_models.TicketQueryProductResponseBodyDataProductUseRuleEffectTimePointRule = None,
        entry_address: str = None,
        entry_remark: str = None,
        entry_time_periods: List[main_models.TicketQueryProductResponseBodyDataProductUseRuleEntryTimePeriods] = None,
        entry_type: int = None,
        entry_with_voucher_rule: main_models.TicketQueryProductResponseBodyDataProductUseRuleEntryWithVoucherRule = None,
        need_assemble: bool = None,
        need_prebook: bool = None,
        other_note: str = None,
        pickups_rule: main_models.TicketQueryProductResponseBodyDataProductUseRulePickupsRule = None,
        validity_period_rule: main_models.TicketQueryProductResponseBodyDataProductUseRuleValidityPeriodRule = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EffectTimePointRule') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductUseRuleEffectTimePointRule()
        ...
        if m.get('EntryTimePeriods') is not None:
            for k1 in m.get('EntryTimePeriods'):
                temp_model = main_models.TicketQueryProductResponseBodyDataProductUseRuleEntryTimePeriods()
        ...
        if m.get('EntryWithVoucherRule') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductUseRuleEntryWithVoucherRule()
        ...
        if m.get('PickupsRule') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductUseRulePickupsRule()
            self.pickups_rule = temp_model.from_map(m.get('PickupsRule'))

        if m.get('ValidityPeriodRule') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductUseRuleValidityPeriodRule()
            self.validity_period_rule = temp_model.from_map(m.get('ValidityPeriodRule'))

        return self

class TicketQueryProductResponseBodyDataProductUseRuleValidityPeriodRule(DaraModel):
    def __init__(
        self,
        available_weeks: List[int] = None,
        from_: main_models.TicketQueryProductResponseBodyDataProductUseRuleValidityPeriodRuleFrom_ = None,
        to: main_models.TicketQueryProductResponseBodyDataProductUseRuleValidityPeriodRuleTo = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('From') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductUseRuleValidityPeriodRuleFrom_()
            self.from_ = temp_model.from_map(m.get('From'))

        if m.get('To') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductUseRuleValidityPeriodRuleTo()
...
class TicketQueryProductResponseBodyDataProductUseRuleValidityPeriodRuleTo(DaraModel):
    def __init__(
        self,
        anchor: int = None,
        fixed_time: str = None,
...
class TicketQueryProductResponseBodyDataProductUseRuleValidityPeriodRuleFrom(DaraModel):
    def __init__(
        self,
        anchor: int = None,
        fixed_time: str = None,
...
class TicketQueryProductResponseBodyDataProductUseRulePickupsRule(DaraModel):
    def __init__(
        self,
...
class TicketQueryProductResponseBodyDataProductUseRuleEntryWithVoucherRule(DaraModel):
    def __init__(
        self,
        voucher_remark: str = None,
        voucher_types: List[int] = None,
...
class TicketQueryProductResponseBodyDataProductUseRuleEntryTimePeriods(DaraModel):
    def __init__(
        self,
        begin_time: str = None,
        end_time: str = None,
...
class TicketQueryProductResponseBodyDataProductUseRuleEffectTimePointRule(DaraModel):
    def __init__(
        self,
        anchor: int = None,
        fixed_time: str = None,
...
class TicketQueryProductResponseBodyDataProductTicketKind(DaraModel):
    def __init__(
        self,
...
class TicketQueryProductResponseBodyDataProductSpu(DaraModel):
    def __init__(
        self,
...
class TicketQueryProductResponseBodyDataProductSession(DaraModel):
    def __init__(
        self,
...
class TicketQueryProductResponseBodyDataProductRegion(DaraModel):
    def __init__(
        self,
        name: str = None,
    ):
...
class TicketQueryProductResponseBodyDataProductRefundRule(DaraModel):
    def __init__(
        self,
        refund_stage_rules: List[main_models.TicketQueryProductResponseBodyDataProductRefundRuleRefundStageRules] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RefundStageRules') is not None:
            for k1 in m.get('RefundStageRules'):
                temp_model = main_models.TicketQueryProductResponseBodyDataProductRefundRuleRefundStageRules()
...
class TicketQueryProductResponseBodyDataProductRefundRuleRefundStageRules(DaraModel):
    def __init__(
        self,
        fee: float = None,
        fee_base: int = None,
        fee_type: int = None,
        from_: main_models.TicketQueryProductResponseBodyDataProductRefundRuleRefundStageRulesFrom_ = None,
        to: main_models.TicketQueryProductResponseBodyDataProductRefundRuleRefundStageRulesTo = None,
    ):
        self.fee = fee
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('From') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductRefundRuleRefundStageRulesFrom_()
            self.from_ = temp_model.from_map(m.get('From'))

        if m.get('To') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductRefundRuleRefundStageRulesTo()
            self.to = temp_model.from_map(m.get('To'))

        return self

class TicketQueryProductResponseBodyDataProductRefundRuleRefundStageRulesTo(DaraModel):
    def __init__(
        self,
        anchor: int = None,
        fixed_time: str = None,
...
class TicketQueryProductResponseBodyDataProductRefundRuleRefundStageRulesFrom(DaraModel):
    def __init__(
        self,
        anchor: int = None,
        fixed_time: str = None,
...
class TicketQueryProductResponseBodyDataProductBuyRule(DaraModel):
    def __init__(
        self,
        ahead_buy_time_point_rule: main_models.TicketQueryProductResponseBodyDataProductBuyRuleAheadBuyTimePointRule = None,
        contact_rule: main_models.TicketQueryProductResponseBodyDataProductBuyRuleContactRule = None,
        cross_order_buy_quantity_limit_rules: List[main_models.TicketQueryProductResponseBodyDataProductBuyRuleCrossOrderBuyQuantityLimitRules] = None,
        per_order_buy_quantity_limit_rule: main_models.TicketQueryProductResponseBodyDataProductBuyRulePerOrderBuyQuantityLimitRule = None,
        traveler_rule: main_models.TicketQueryProductResponseBodyDataProductBuyRuleTravelerRule = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AheadBuyTimePointRule') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductBuyRuleAheadBuyTimePointRule()
            self.ahead_buy_time_point_rule = temp_model.from_map(m.get('AheadBuyTimePointRule'))

        if m.get('ContactRule') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductBuyRuleContactRule()
        ...
        if m.get('CrossOrderBuyQuantityLimitRules') is not None:
            for k1 in m.get('CrossOrderBuyQuantityLimitRules'):
                temp_model = main_models.TicketQueryProductResponseBodyDataProductBuyRuleCrossOrderBuyQuantityLimitRules()
                self.cross_order_buy_quantity_limit_rules.append(temp_model.from_map(k1))

        if m.get('PerOrderBuyQuantityLimitRule') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductBuyRulePerOrderBuyQuantityLimitRule()
        ...
        if m.get('TravelerRule') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductBuyRuleTravelerRule()
            self.traveler_rule = temp_model.from_map(m.get('TravelerRule'))

        return self

class TicketQueryProductResponseBodyDataProductBuyRuleTravelerRule(DaraModel):
    def __init__(
        self,
        crowd_limit_rules: List[main_models.TicketQueryProductResponseBodyDataProductBuyRuleTravelerRuleCrowdLimitRules] = None,
        crowd_quantity_limits: List[main_models.TicketQueryProductResponseBodyDataProductBuyRuleTravelerRuleCrowdQuantityLimits] = None,
        need_fill_traveler: bool = None,
        traveler_field_rule: main_models.TicketQueryProductResponseBodyDataProductBuyRuleTravelerRuleTravelerFieldRule = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CrowdLimitRules') is not None:
            for k1 in m.get('CrowdLimitRules'):
                temp_model = main_models.TicketQueryProductResponseBodyDataProductBuyRuleTravelerRuleCrowdLimitRules()
        ...
        if m.get('CrowdQuantityLimits') is not None:
            for k1 in m.get('CrowdQuantityLimits'):
                temp_model = main_models.TicketQueryProductResponseBodyDataProductBuyRuleTravelerRuleCrowdQuantityLimits()
        ...
        if m.get('TravelerFieldRule') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductBuyRuleTravelerRuleTravelerFieldRule()
...
class TicketQueryProductResponseBodyDataProductBuyRuleTravelerRuleTravelerFieldRule(DaraModel):
    def __init__(
        self,
        birthday: bool = None,
...
class TicketQueryProductResponseBodyDataProductBuyRuleTravelerRuleCrowdQuantityLimits(DaraModel):
    def __init__(
        self,
        name: str = None,
        quantity: int = None,
...
class TicketQueryProductResponseBodyDataProductBuyRuleTravelerRuleCrowdLimitRules(DaraModel):
    def __init__(
        self,
...
class TicketQueryProductResponseBodyDataProductBuyRulePerOrderBuyQuantityLimitRule(DaraModel):
    def __init__(
        self,
...
class TicketQueryProductResponseBodyDataProductBuyRuleCrossOrderBuyQuantityLimitRules(DaraModel):
    def __init__(
        self,
...
class TicketQueryProductResponseBodyDataProductBuyRuleContactRule(DaraModel):
    def __init__(
        self,
        contact_field_rule: main_models.TicketQueryProductResponseBodyDataProductBuyRuleContactRuleContactFieldRule = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ContactFieldRule') is not None:
            temp_model = main_models.TicketQueryProductResponseBodyDataProductBuyRuleContactRuleContactFieldRule()
            self.contact_field_rule = temp_model.from_map(m.get('ContactFieldRule'))

        return self

class TicketQueryProductResponseBodyDataProductBuyRuleContactRuleContactFieldRule(DaraModel):
    def __init__(
        self,
        certificate: bool = None,
        certificate_types: List[int] = None,
...
class TicketQueryProductResponseBodyDataProductBuyRuleAheadBuyTimePointRule(DaraModel):
    def __init__(
        self,
        anchor: int = None,
        fixed_time: str = None,

...
class GlobalHotelQueryCalendarAvailabilityResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.GlobalHotelQueryCalendarAvailabilityResponseBodyData = None,
        error_code: str = None,
        error_msg: str = None,
        request_id: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GlobalHotelQueryCalendarAvailabilityResponseBodyData()

...
class GetYikeAssetMediaInfoResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MediaInfo') is not None:
            temp_model = main_models.GetYikeAssetMediaInfoResponseBodyMediaInfo()
...
class GetYikeAssetMediaInfoResponseBodyMediaInfo(DaraModel):
    def __init__(
        self,
        biz_data: main_models.GetYikeAssetMediaInfoResponseBodyMediaInfoBizData = None,
        file_info_list: List[main_models.GetYikeAssetMediaInfoResponseBodyMediaInfoFileInfoList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BizData') is not None:
            temp_model = main_models.GetYikeAssetMediaInfoResponseBodyMediaInfoBizData()
            self.biz_data = temp_model.from_map(m.get('BizData'))

        self.file_info_list = []
        if m.get('FileInfoList') is not None:
            for k1 in m.get('FileInfoList'):
                temp_model = main_models.GetYikeAssetMediaInfoResponseBodyMediaInfoFileInfoList()
                self.file_info_list.append(temp_model.from_map(k1))

        if m.get('MediaBasicInfo') is not None:
            temp_model = main_models.GetYikeAssetMediaInfoResponseBodyMediaInfoMediaBasicInfo()
...
class GetYikeAssetMediaInfoResponseBodyMediaInfoMediaBasicInfo(DaraModel):
    def __init__(
        self,
        biz: str = None,
        ...
        status: str = None,
        thumb_url240p: str = None,
        thumb_urlwebp: str = None,
        title: str = None,
    ...
    def to_map(self):
        ...
        if self.thumb_url240p is not None:
            result['ThumbURL240P'] = self.thumb_url240p

        if self.thumb_urlwebp is not None:
            result['ThumbURLWebp'] = self.thumb_urlwebp
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ThumbURL240P') is not None:
            self.thumb_url240p = m.get('ThumbURL240P')

        if m.get('ThumbURLWebp') is not None:
            self.thumb_urlwebp = m.get('ThumbURLWebp')
...
class GetYikeAssetMediaInfoResponseBodyMediaInfoFileInfoList(DaraModel):
    def __init__(
        self,
        audio_stream_info_list: List[main_models.GetYikeAssetMediaInfoResponseBodyMediaInfoFileInfoListAudioStreamInfoList] = None,
        file_basic_info: main_models.GetYikeAssetMediaInfoResponseBodyMediaInfoFileInfoListFileBasicInfo = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioStreamInfoList') is not None:
            for k1 in m.get('AudioStreamInfoList'):
                temp_model = main_models.GetYikeAssetMediaInfoResponseBodyMediaInfoFileInfoListAudioStreamInfoList()
                self.audio_stream_info_list.append(temp_model.from_map(k1))

        if m.get('FileBasicInfo') is not None:
            temp_model = main_models.GetYikeAssetMediaInfoResponseBodyMediaInfoFileInfoListFileBasicInfo()
        ...
        if m.get('SubtitleStreamInfoList') is not None:
            for k1 in m.get('SubtitleStreamInfoList'):
                temp_model = main_models.GetYikeAssetMediaInfoResponseBodyMediaInfoFileInfoListSubtitleStreamInfoList()
        ...
        if m.get('VideoStreamInfoList') is not None:
            for k1 in m.get('VideoStreamInfoList'):
                temp_model = main_models.GetYikeAssetMediaInfoResponseBodyMediaInfoFileInfoListVideoStreamInfoList()
                self.video_stream_info_list.append(temp_model.from_map(k1))

        return self

class GetYikeAssetMediaInfoResponseBodyMediaInfoFileInfoListVideoStreamInfoList(DaraModel):
    def __init__(
        self,
        avg_fps: str = None,
        bitrate: str = None,
...
class GetYikeAssetMediaInfoResponseBodyMediaInfoFileInfoListSubtitleStreamInfoList(DaraModel):
    def __init__(
        self,
        codec_long_name: str = None,
        codec_name: str = None,
...
class GetYikeAssetMediaInfoResponseBodyMediaInfoFileInfoListFileBasicInfo(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        create_time: str = None,
...
class GetYikeAssetMediaInfoResponseBodyMediaInfoFileInfoListAudioStreamInfoList(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
...
class GetYikeAssetMediaInfoResponseBodyMediaInfoBizData(DaraModel):
    def __init__(
        self,

...
class QueryModifyInstancePriceResponseBody(DaraModel):
    def __init__(
        self,
        price_info: main_models.QueryModifyInstancePriceResponseBodyPriceInfo = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PriceInfo') is not None:
            temp_model = main_models.QueryModifyInstancePriceResponseBodyPriceInfo()
...
class QueryModifyInstancePriceResponseBodyPriceInfo(DaraModel):
    def __init__(
        self,
        code: str = None,
        currency: str = None,
        depreciate_info: main_models.QueryModifyInstancePriceResponseBodyPriceInfoDepreciateInfo = None,
        discount_amount: float = None,
        is_contract_activity: bool = None,
        lx_request_id: str = None,
        message: str = None,
        optional_promotions: List[main_models.QueryModifyInstancePriceResponseBodyPriceInfoOptionalPromotions] = None,
        original_amount: float = None,
        rules: List[main_models.QueryModifyInstancePriceResponseBodyPriceInfoRules] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DepreciateInfo') is not None:
            temp_model = main_models.QueryModifyInstancePriceResponseBodyPriceInfoDepreciateInfo()
        ...
        if m.get('OptionalPromotions') is not None:
            for k1 in m.get('OptionalPromotions'):
                temp_model = main_models.QueryModifyInstancePriceResponseBodyPriceInfoOptionalPromotions()
        ...
        if m.get('Rules') is not None:
            for k1 in m.get('Rules'):
                temp_model = main_models.QueryModifyInstancePriceResponseBodyPriceInfoRules()
...
class QueryModifyInstancePriceResponseBodyPriceInfoRules(DaraModel):
    def __init__(
        self,
...
class QueryModifyInstancePriceResponseBodyPriceInfoOptionalPromotions(DaraModel):
    def __init__(
        self,
...
class QueryModifyInstancePriceResponseBodyPriceInfoDepreciateInfo(DaraModel):
    def __init__(
        self,
        cheap_rate: str = None,

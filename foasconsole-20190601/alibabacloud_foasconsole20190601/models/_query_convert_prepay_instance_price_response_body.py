...
class QueryConvertPrepayInstancePriceResponseBody(DaraModel):
    def __init__(
        self,
        price_info: main_models.QueryConvertPrepayInstancePriceResponseBodyPriceInfo = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PriceInfo') is not None:
            temp_model = main_models.QueryConvertPrepayInstancePriceResponseBodyPriceInfo()
...
class QueryConvertPrepayInstancePriceResponseBodyPriceInfo(DaraModel):
    def __init__(
        self,
        code: str = None,
        currency: str = None,
        depreciate_info: main_models.QueryConvertPrepayInstancePriceResponseBodyPriceInfoDepreciateInfo = None,
        discount_amount: float = None,
        is_contract_activity: bool = None,
        lx_request_id: str = None,
        message: str = None,
        optional_promotions: List[main_models.QueryConvertPrepayInstancePriceResponseBodyPriceInfoOptionalPromotions] = None,
        original_amount: float = None,
        rules: List[main_models.QueryConvertPrepayInstancePriceResponseBodyPriceInfoRules] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DepreciateInfo') is not None:
            temp_model = main_models.QueryConvertPrepayInstancePriceResponseBodyPriceInfoDepreciateInfo()
        ...
        if m.get('OptionalPromotions') is not None:
            for k1 in m.get('OptionalPromotions'):
                temp_model = main_models.QueryConvertPrepayInstancePriceResponseBodyPriceInfoOptionalPromotions()
        ...
        if m.get('Rules') is not None:
            for k1 in m.get('Rules'):
                temp_model = main_models.QueryConvertPrepayInstancePriceResponseBodyPriceInfoRules()
...
class QueryConvertPrepayInstancePriceResponseBodyPriceInfoRules(DaraModel):
    def __init__(
        self,
...
class QueryConvertPrepayInstancePriceResponseBodyPriceInfoOptionalPromotions(DaraModel):
    def __init__(
        self,
...
class QueryConvertPrepayInstancePriceResponseBodyPriceInfoDepreciateInfo(DaraModel):
    def __init__(
        self,
        cheap_rate: str = None,

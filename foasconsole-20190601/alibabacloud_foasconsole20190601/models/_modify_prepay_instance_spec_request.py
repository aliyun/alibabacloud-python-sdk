...
class ModifyPrepayInstanceSpecRequest(DaraModel):
    def __init__(
        self,
        modify_prepay_instance_spec_request: main_models.ModifyPrepayInstanceSpecRequestModifyPrepayInstanceSpecRequest = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ModifyPrepayInstanceSpecRequest') is not None:
            temp_model = main_models.ModifyPrepayInstanceSpecRequestModifyPrepayInstanceSpecRequest()
            self.modify_prepay_instance_spec_request = temp_model.from_map(m.get('ModifyPrepayInstanceSpecRequest'))

        return self

class ModifyPrepayInstanceSpecRequestModifyPrepayInstanceSpecRequest(DaraModel):
    def __init__(
        self,
        ha: bool = None,
        ha_resource_spec: main_models.ModifyPrepayInstanceSpecRequestModifyPrepayInstanceSpecRequestHaResourceSpec = None,
        ha_vswitch_ids: List[str] = None,
        ha_zone_id: str = None,
        instance_id: str = None,
        region: str = None,
        resource_spec: main_models.ModifyPrepayInstanceSpecRequestModifyPrepayInstanceSpecRequestResourceSpec = None,
    ):
        self.ha = ha
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HaResourceSpec') is not None:
            temp_model = main_models.ModifyPrepayInstanceSpecRequestModifyPrepayInstanceSpecRequestHaResourceSpec()
        ...
        if m.get('ResourceSpec') is not None:
            temp_model = main_models.ModifyPrepayInstanceSpecRequestModifyPrepayInstanceSpecRequestResourceSpec()
            self.resource_spec = temp_model.from_map(m.get('ResourceSpec'))

        return self

class ModifyPrepayInstanceSpecRequestModifyPrepayInstanceSpecRequestResourceSpec(DaraModel):
    def __init__(
        self,
        cpu: int = None,
        memory_gb: int = None,
...
class ModifyPrepayInstanceSpecRequestModifyPrepayInstanceSpecRequestHaResourceSpec(DaraModel):
    def __init__(
        self,
        cpu: int = None,
        memory_gb: int = None,

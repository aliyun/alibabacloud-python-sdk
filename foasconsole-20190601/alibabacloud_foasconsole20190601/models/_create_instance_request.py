...
class CreateInstanceRequest(DaraModel):
    def __init__(
        self,
        create_instance_request: main_models.CreateInstanceRequestCreateInstanceRequest = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CreateInstanceRequest') is not None:
            temp_model = main_models.CreateInstanceRequestCreateInstanceRequest()
            self.create_instance_request = temp_model.from_map(m.get('CreateInstanceRequest'))

        return self

class CreateInstanceRequestCreateInstanceRequest(DaraModel):
    def __init__(
        self,
        ...
        extra: str = None,
        ha: bool = None,
        ha_resource_spec: main_models.CreateInstanceRequestCreateInstanceRequestHaResourceSpec = None,
        ...
        resource_spec: main_models.CreateInstanceRequestCreateInstanceRequestResourceSpec = None,
        storage: main_models.CreateInstanceRequestCreateInstanceRequestStorage = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HaResourceSpec') is not None:
            temp_model = main_models.CreateInstanceRequestCreateInstanceRequestHaResourceSpec()
        ...
        if m.get('ResourceSpec') is not None:
            temp_model = main_models.CreateInstanceRequestCreateInstanceRequestResourceSpec()
            self.resource_spec = temp_model.from_map(m.get('ResourceSpec'))

        if m.get('Storage') is not None:
            temp_model = main_models.CreateInstanceRequestCreateInstanceRequestStorage()
...
class CreateInstanceRequestCreateInstanceRequestStorage(DaraModel):
    def __init__(
        self,
        oss: main_models.CreateInstanceRequestCreateInstanceRequestStorageOss = None,
    ):
        # This parameter is required.
        self.oss = oss
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Oss') is not None:
            temp_model = main_models.CreateInstanceRequestCreateInstanceRequestStorageOss()
            self.oss = temp_model.from_map(m.get('Oss'))

        return self

class CreateInstanceRequestCreateInstanceRequestStorageOss(DaraModel):
    def __init__(
        self,
        bucket: str = None,
    ):
...
class CreateInstanceRequestCreateInstanceRequestResourceSpec(DaraModel):
    def __init__(
        self,
        cpu: int = None,
        memory_gb: int = None,
...
class CreateInstanceRequestCreateInstanceRequestHaResourceSpec(DaraModel):
    def __init__(
        self,
        cpu: int = None,
        memory_gb: int = None,

...
class QueryRenewInstancePriceRequest(DaraModel):
    def __init__(
        self,
        renew_instance_request: main_models.QueryRenewInstancePriceRequestRenewInstanceRequest = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RenewInstanceRequest') is not None:
            temp_model = main_models.QueryRenewInstancePriceRequestRenewInstanceRequest()
            self.renew_instance_request = temp_model.from_map(m.get('RenewInstanceRequest'))

        return self

class QueryRenewInstancePriceRequestRenewInstanceRequest(DaraModel):
    def __init__(
        self,
        duration: int = None,

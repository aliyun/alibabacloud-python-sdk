...
class ConvertInstanceRequest(DaraModel):
    def __init__(
        self,
        convert_postpay_instance_request: main_models.ConvertInstanceRequestConvertPostpayInstanceRequest = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConvertPostpayInstanceRequest') is not None:
            temp_model = main_models.ConvertInstanceRequestConvertPostpayInstanceRequest()
            self.convert_postpay_instance_request = temp_model.from_map(m.get('ConvertPostpayInstanceRequest'))

        return self

class ConvertInstanceRequestConvertPostpayInstanceRequest(DaraModel):
    def __init__(
        self,
        duration: int = None,
        instance_id: str = None,
        is_auto_renew: bool = None,
        namespace_resource_specs: List[main_models.ConvertInstanceRequestConvertPostpayInstanceRequestNamespaceResourceSpecs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NamespaceResourceSpecs') is not None:
            for k1 in m.get('NamespaceResourceSpecs'):
                temp_model = main_models.ConvertInstanceRequestConvertPostpayInstanceRequestNamespaceResourceSpecs()
...
class ConvertInstanceRequestConvertPostpayInstanceRequestNamespaceResourceSpecs(DaraModel):
    def __init__(
        self,
        namespace: str = None,
        resource_spec: main_models.ConvertInstanceRequestConvertPostpayInstanceRequestNamespaceResourceSpecsResourceSpec = None,
    ):
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceSpec') is not None:
            temp_model = main_models.ConvertInstanceRequestConvertPostpayInstanceRequestNamespaceResourceSpecsResourceSpec()
...
class ConvertInstanceRequestConvertPostpayInstanceRequestNamespaceResourceSpecsResourceSpec(DaraModel):
    def __init__(
        self,
        cpu: int = None,
        memory_gb: int = None,

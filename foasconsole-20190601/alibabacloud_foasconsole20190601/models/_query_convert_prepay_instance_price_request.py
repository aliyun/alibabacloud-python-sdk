...
class QueryConvertPrepayInstancePriceRequest(DaraModel):
    def __init__(
        self,
        convert_prepay_instance_request: main_models.QueryConvertPrepayInstancePriceRequestConvertPrepayInstanceRequest = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConvertPrepayInstanceRequest') is not None:
            temp_model = main_models.QueryConvertPrepayInstancePriceRequestConvertPrepayInstanceRequest()
            self.convert_prepay_instance_request = temp_model.from_map(m.get('ConvertPrepayInstanceRequest'))

        return self

class QueryConvertPrepayInstancePriceRequestConvertPrepayInstanceRequest(DaraModel):
    def __init__(
        self,

...
class DescribeInstancesRequest(DaraModel):
    def __init__(
        self,
        describe_instances_request: main_models.DescribeInstancesRequestDescribeInstancesRequest = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DescribeInstancesRequest') is not None:
            temp_model = main_models.DescribeInstancesRequestDescribeInstancesRequest()
            self.describe_instances_request = temp_model.from_map(m.get('DescribeInstancesRequest'))

        return self

class DescribeInstancesRequestDescribeInstancesRequest(DaraModel):
    def __init__(
        self,
        ...
        tags: List[main_models.DescribeInstancesRequestDescribeInstancesRequestTags] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.DescribeInstancesRequestDescribeInstancesRequestTags()
                self.tags.append(temp_model.from_map(k1))

        return self

class DescribeInstancesRequestDescribeInstancesRequestTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

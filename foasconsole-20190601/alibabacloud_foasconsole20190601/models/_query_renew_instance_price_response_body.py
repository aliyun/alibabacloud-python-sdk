...
class QueryRenewInstancePriceResponseBody(DaraModel):
    def __init__(
        self,
        price_info: main_models.QueryRenewInstancePriceResponseBodyPriceInfo = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PriceInfo') is not None:
            temp_model = main_models.QueryRenewInstancePriceResponseBodyPriceInfo()
...
class QueryRenewInstancePriceResponseBodyPriceInfo(DaraModel):
    def __init__(
        self,
        code: str = None,
        currency: str = None,
        depreciate_info: main_models.QueryRenewInstancePriceResponseBodyPriceInfoDepreciateInfo = None,
        discount_amount: float = None,
        is_contract_activity: bool = None,
        lx_request_id: str = None,
        message: str = None,
        optional_promotions: List[main_models.QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions] = None,
        original_amount: float = None,
        rules: List[main_models.QueryRenewInstancePriceResponseBodyPriceInfoRules] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DepreciateInfo') is not None:
            temp_model = main_models.QueryRenewInstancePriceResponseBodyPriceInfoDepreciateInfo()
        ...
        if m.get('OptionalPromotions') is not None:
            for k1 in m.get('OptionalPromotions'):
                temp_model = main_models.QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions()
        ...
        if m.get('Rules') is not None:
            for k1 in m.get('Rules'):
                temp_model = main_models.QueryRenewInstancePriceResponseBodyPriceInfoRules()
...
class QueryRenewInstancePriceResponseBodyPriceInfoRules(DaraModel):
    def __init__(
        self,
...
class QueryRenewInstancePriceResponseBodyPriceInfoOptionalPromotions(DaraModel):
    def __init__(
        self,
...
class QueryRenewInstancePriceResponseBodyPriceInfoDepreciateInfo(DaraModel):
    def __init__(
        self,
        cheap_rate: str = None,

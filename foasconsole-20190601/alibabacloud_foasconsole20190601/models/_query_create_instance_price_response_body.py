...
class QueryCreateInstancePriceResponseBody(DaraModel):
    def __init__(
        self,
        price_info: main_models.QueryCreateInstancePriceResponseBodyPriceInfo = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PriceInfo') is not None:
            temp_model = main_models.QueryCreateInstancePriceResponseBodyPriceInfo()
...
class QueryCreateInstancePriceResponseBodyPriceInfo(DaraModel):
    def __init__(
        self,
        code: str = None,
        currency: str = None,
        depreciate_info: main_models.QueryCreateInstancePriceResponseBodyPriceInfoDepreciateInfo = None,
        discount_amount: float = None,
        is_contract_activity: bool = None,
        lx_request_id: str = None,
        message: str = None,
        optional_promotions: List[main_models.QueryCreateInstancePriceResponseBodyPriceInfoOptionalPromotions] = None,
        original_amount: float = None,
        rules: List[main_models.QueryCreateInstancePriceResponseBodyPriceInfoRules] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DepreciateInfo') is not None:
            temp_model = main_models.QueryCreateInstancePriceResponseBodyPriceInfoDepreciateInfo()
        ...
        if m.get('OptionalPromotions') is not None:
            for k1 in m.get('OptionalPromotions'):
                temp_model = main_models.QueryCreateInstancePriceResponseBodyPriceInfoOptionalPromotions()
        ...
        if m.get('Rules') is not None:
            for k1 in m.get('Rules'):
                temp_model = main_models.QueryCreateInstancePriceResponseBodyPriceInfoRules()
...
class QueryCreateInstancePriceResponseBodyPriceInfoRules(DaraModel):
    def __init__(
        self,
...
class QueryCreateInstancePriceResponseBodyPriceInfoOptionalPromotions(DaraModel):
    def __init__(
        self,
...
class QueryCreateInstancePriceResponseBodyPriceInfoDepreciateInfo(DaraModel):
    def __init__(
        self,
        cheap_rate: str = None,

...
## Alibaba Cloud avatar SDK for Python
...
```bash
# 安装 alibabacloud_avatar20220130
pip install alibabacloud_avatar20220130
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/avatar-20220130/ChangeLog.md)中。

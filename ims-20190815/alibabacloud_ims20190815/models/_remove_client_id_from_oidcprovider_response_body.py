...
class RemoveClientIdFromOIDCProviderResponseBody(DaraModel):
    def __init__(
        self,
        oidcprovider: main_models.RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OIDCProvider') is not None:
            temp_model = main_models.RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider()
...
class RemoveClientIdFromOIDCProviderResponseBodyOIDCProvider(DaraModel):
    def __init__(
        self,
        arn: str = None,
        client_ids: str = None,

...
class CreateAppSecretResponseBody(DaraModel):
    def __init__(
        self,
        app_secret: main_models.CreateAppSecretResponseBodyAppSecret = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AppSecret') is not None:
            temp_model = main_models.CreateAppSecretResponseBodyAppSecret()
...
class CreateAppSecretResponseBodyAppSecret(DaraModel):
    def __init__(
        self,
        app_id: str = None,

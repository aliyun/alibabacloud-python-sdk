...
class UpdateSAMLProviderResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        samlprovider: main_models.UpdateSAMLProviderResponseBodySAMLProvider = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SAMLProvider') is not None:
            temp_model = main_models.UpdateSAMLProviderResponseBodySAMLProvider()
            self.samlprovider = temp_model.from_map(m.get('SAMLProvider'))

        return self

class UpdateSAMLProviderResponseBodySAMLProvider(DaraModel):
    def __init__(
        self,
        arn: str = None,

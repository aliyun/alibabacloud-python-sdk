...
class UpdateApplicationResponseBodyApplication(DaraModel):
    def __init__(
        ...
        delegated_scope: main_models.UpdateApplicationResponseBodyApplicationDelegatedScope = None,
        display_name: str = None,
        is_multi_tenant: bool = None,
        protocol_version: str = None,
        redirect_uris: main_models.UpdateApplicationResponseBodyApplicationRedirectUris = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DelegatedScope') is not None:
            temp_model = main_models.UpdateApplicationResponseBodyApplicationDelegatedScope()
        ...
        if m.get('RedirectUris') is not None:
            temp_model = main_models.UpdateApplicationResponseBodyApplicationRedirectUris()
...
class UpdateApplicationResponseBodyApplicationRedirectUris(DaraModel):
    def __init__(
        self,
...
class UpdateApplicationResponseBodyApplicationDelegatedScope(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PredefinedScopes') is not None:
            temp_model = main_models.UpdateApplicationResponseBodyApplicationDelegatedScopePredefinedScopes()
            self.predefined_scopes = temp_model.from_map(m.get('PredefinedScopes'))

        return self

class UpdateApplicationResponseBodyApplicationDelegatedScopePredefinedScopes(DaraModel):
    def __init__(
        self,
        predefined_scope: List[main_models.UpdateApplicationResponseBodyApplicationDelegatedScopePredefinedScopesPredefinedScope] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PredefinedScope') is not None:
            for k1 in m.get('PredefinedScope'):
                temp_model = main_models.UpdateApplicationResponseBodyApplicationDelegatedScopePredefinedScopesPredefinedScope()
                self.predefined_scope.append(temp_model.from_map(k1))

        return self

class UpdateApplicationResponseBodyApplicationDelegatedScopePredefinedScopesPredefinedScope(DaraModel):
    def __init__(
        self,

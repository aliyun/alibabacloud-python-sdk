...
class CreateUserResponseBodyUser(DaraModel):
    def __init__(
        ...
        tags: main_models.CreateUserResponseBodyUserTags = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            temp_model = main_models.CreateUserResponseBodyUserTags()
...
class CreateUserResponseBodyUserTags(DaraModel):
    def __init__(
        self,
        tag: List[main_models.CreateUserResponseBodyUserTagsTag] = None,
    ):
        self.tag = tag
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.CreateUserResponseBodyUserTagsTag()
                self.tag.append(temp_model.from_map(k1))

        return self

class CreateUserResponseBodyUserTagsTag(DaraModel):
    def __init__(
        self,
        tag_key: str = None,
        tag_value: str = None,

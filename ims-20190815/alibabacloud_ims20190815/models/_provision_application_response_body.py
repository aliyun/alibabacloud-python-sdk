...
class ProvisionApplicationResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApplicationProvisionInfo') is not None:
            temp_model = main_models.ProvisionApplicationResponseBodyApplicationProvisionInfo()
...
class ProvisionApplicationResponseBodyApplicationProvisionInfo(DaraModel):
    def __init__(
        self,
        account_id: str = None,
        app_id: str = None,
        ...
        delegated_scope: main_models.ProvisionApplicationResponseBodyApplicationProvisionInfoDelegatedScope = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DelegatedScope') is not None:
            temp_model = main_models.ProvisionApplicationResponseBodyApplicationProvisionInfoDelegatedScope()
...
class ProvisionApplicationResponseBodyApplicationProvisionInfoDelegatedScope(DaraModel):
    def __init__(
        self,
        predefined_scopes: main_models.ProvisionApplicationResponseBodyApplicationProvisionInfoDelegatedScopePredefinedScopes = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PredefinedScopes') is not None:
            temp_model = main_models.ProvisionApplicationResponseBodyApplicationProvisionInfoDelegatedScopePredefinedScopes()
            self.predefined_scopes = temp_model.from_map(m.get('PredefinedScopes'))

        return self

class ProvisionApplicationResponseBodyApplicationProvisionInfoDelegatedScopePredefinedScopes(DaraModel):
    def __init__(
        self,
        predefined_scope: List[main_models.ProvisionApplicationResponseBodyApplicationProvisionInfoDelegatedScopePredefinedScopesPredefinedScope] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PredefinedScope') is not None:
            for k1 in m.get('PredefinedScope'):
                temp_model = main_models.ProvisionApplicationResponseBodyApplicationProvisionInfoDelegatedScopePredefinedScopesPredefinedScope()
                self.predefined_scope.append(temp_model.from_map(k1))

        return self

class ProvisionApplicationResponseBodyApplicationProvisionInfoDelegatedScopePredefinedScopesPredefinedScope(DaraModel):
    def __init__(
        self,

...
class ProvisionExternalApplicationResponseBody(DaraModel):
    def __init__(
        self,
        external_application: main_models.ProvisionExternalApplicationResponseBodyExternalApplication = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ExternalApplication') is not None:
            temp_model = main_models.ProvisionExternalApplicationResponseBodyExternalApplication()
...
class ProvisionExternalApplicationResponseBodyExternalApplication(DaraModel):
    def __init__(
        self,
        app_principal_name: str = None,
        create_date: str = None,
        delegated_scope: main_models.ProvisionExternalApplicationResponseBodyExternalApplicationDelegatedScope = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DelegatedScope') is not None:
            temp_model = main_models.ProvisionExternalApplicationResponseBodyExternalApplicationDelegatedScope()
...
class ProvisionExternalApplicationResponseBodyExternalApplicationDelegatedScope(DaraModel):
    def __init__(
        self,
        predefined_scopes: main_models.ProvisionExternalApplicationResponseBodyExternalApplicationDelegatedScopePredefinedScopes = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PredefinedScopes') is not None:
            temp_model = main_models.ProvisionExternalApplicationResponseBodyExternalApplicationDelegatedScopePredefinedScopes()
            self.predefined_scopes = temp_model.from_map(m.get('PredefinedScopes'))

        return self

class ProvisionExternalApplicationResponseBodyExternalApplicationDelegatedScopePredefinedScopes(DaraModel):
    def __init__(
        self,
        predefined_scope: List[main_models.ProvisionExternalApplicationResponseBodyExternalApplicationDelegatedScopePredefinedScopesPredefinedScope] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PredefinedScope') is not None:
            for k1 in m.get('PredefinedScope'):
                temp_model = main_models.ProvisionExternalApplicationResponseBodyExternalApplicationDelegatedScopePredefinedScopesPredefinedScope()
                self.predefined_scope.append(temp_model.from_map(k1))

        return self

class ProvisionExternalApplicationResponseBodyExternalApplicationDelegatedScopePredefinedScopesPredefinedScope(DaraModel):
    def __init__(
        self,

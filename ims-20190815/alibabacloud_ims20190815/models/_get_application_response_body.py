...
class GetApplicationResponseBodyApplication(DaraModel):
    def __init__(
        ...
        delegated_scope: main_models.GetApplicationResponseBodyApplicationDelegatedScope = None,
        display_name: str = None,
        is_multi_tenant: bool = None,
        protocol_version: str = None,
        redirect_uris: main_models.GetApplicationResponseBodyApplicationRedirectUris = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DelegatedScope') is not None:
            temp_model = main_models.GetApplicationResponseBodyApplicationDelegatedScope()
        ...
        if m.get('RedirectUris') is not None:
            temp_model = main_models.GetApplicationResponseBodyApplicationRedirectUris()
...
class GetApplicationResponseBodyApplicationRedirectUris(DaraModel):
    def __init__(
        self,
...
class GetApplicationResponseBodyApplicationDelegatedScope(DaraModel):
    def __init__(
        self,
        predefined_scopes: main_models.GetApplicationResponseBodyApplicationDelegatedScopePredefinedScopes = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PredefinedScopes') is not None:
            temp_model = main_models.GetApplicationResponseBodyApplicationDelegatedScopePredefinedScopes()
            self.predefined_scopes = temp_model.from_map(m.get('PredefinedScopes'))

        return self

class GetApplicationResponseBodyApplicationDelegatedScopePredefinedScopes(DaraModel):
    def __init__(
        self,
        predefined_scope: List[main_models.GetApplicationResponseBodyApplicationDelegatedScopePredefinedScopesPredefinedScope] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PredefinedScope') is not None:
            for k1 in m.get('PredefinedScope'):
                temp_model = main_models.GetApplicationResponseBodyApplicationDelegatedScopePredefinedScopesPredefinedScope()
                self.predefined_scope.append(temp_model.from_map(k1))

        return self

class GetApplicationResponseBodyApplicationDelegatedScopePredefinedScopesPredefinedScope(DaraModel):
    def __init__(
        self,

...
class SetSecurityPreferenceResponseBodySecurityPreference(DaraModel):
    def __init__(
        ...
        max_idle_days: main_models.SetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MaxIdleDays') is not None:
            temp_model = main_models.SetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays()
            self.max_idle_days = temp_model.from_map(m.get('MaxIdleDays'))

        if m.get('PersonalInfoPreference') is not None:
            temp_model = main_models.SetSecurityPreferenceResponseBodySecurityPreferencePersonalInfoPreference()
        ...
        if m.get('VerificationPreference') is not None:
            temp_model = main_models.SetSecurityPreferenceResponseBodySecurityPreferenceVerificationPreference()
            self.verification_preference = temp_model.from_map(m.get('VerificationPreference'))

        return self

class SetSecurityPreferenceResponseBodySecurityPreferenceVerificationPreference(DaraModel):
    def __init__(
        self,
...
class SetSecurityPreferenceResponseBodySecurityPreferencePersonalInfoPreference(DaraModel):
    def __init__(
        self,
...
class SetSecurityPreferenceResponseBodySecurityPreferenceMaxIdleDays(DaraModel):
    def __init__(
        self,

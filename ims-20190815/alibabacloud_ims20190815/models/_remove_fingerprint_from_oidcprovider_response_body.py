...
class RemoveFingerprintFromOIDCProviderResponseBody(DaraModel):
    def __init__(
        self,
        oidcprovider: main_models.RemoveFingerprintFromOIDCProviderResponseBodyOIDCProvider = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OIDCProvider') is not None:
            temp_model = main_models.RemoveFingerprintFromOIDCProviderResponseBodyOIDCProvider()
...
class RemoveFingerprintFromOIDCProviderResponseBodyOIDCProvider(DaraModel):
    def __init__(
        self,
        arn: str = None,
        client_ids: str = None,

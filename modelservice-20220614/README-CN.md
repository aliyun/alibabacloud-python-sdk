...
## Alibaba Cloud modelService SDK for Python
...
```bash
# 安装 alibabacloud_modelservice20220614
pip install alibabacloud_modelservice20220614
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/modelservice-20220614/ChangeLog.md)中。

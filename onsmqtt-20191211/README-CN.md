...
```bash
# 安装 alibabacloud_onsmqtt20191211
pip install alibabacloud_onsmqtt20191211
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/onsmqtt-20191211/ChangeLog.md)中。

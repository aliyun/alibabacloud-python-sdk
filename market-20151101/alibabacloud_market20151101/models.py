...
class DescribeImageInstanceForIsvRequest(TeaModel):
    def __init__(
        self,
...
class DescribeImageInstanceForIsvResponseBodyModulesPropertiesPropertyValues(TeaModel):
    def __init__(
        self,
...
class DescribeImageInstanceForIsvResponseBodyModulesProperties(TeaModel):
    def __init__(
        self,
        display_unit: str = None,
        key: str = None,
        name: str = None,
        property_values: List[DescribeImageInstanceForIsvResponseBodyModulesPropertiesPropertyValues] = None,
        show_type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PropertyValues') is not None:
            for k in m.get('PropertyValues'):
                temp_model = DescribeImageInstanceForIsvResponseBodyModulesPropertiesPropertyValues()
...
class DescribeImageInstanceForIsvResponseBodyModules(TeaModel):
    def __init__(
        self,
        code: str = None,
        id: str = None,
        name: str = None,
        properties: List[DescribeImageInstanceForIsvResponseBodyModulesProperties] = None,
    ):
        self.code = code
        self.id = id
        self.name = name
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Properties') is not None:
            for k in m.get('Properties'):
                temp_model = DescribeImageInstanceForIsvResponseBodyModulesProperties()
                self.properties.append(temp_model.from_map(k))
        return self


class DescribeImageInstanceForIsvResponseBodyRelationalData(TeaModel):
    def __init__(
        self,
...
class DescribeImageInstanceForIsvResponseBody(TeaModel):
    def __init__(
        self,
        ...
        is_trial: bool = None,
        license_code: str = None,
        modules: List[DescribeImageInstanceForIsvResponseBodyModules] = None,
        order_id: int = None,
        product_code: str = None,
        product_name: str = None,
        product_sku_code: str = None,
        product_type: str = None,
        relational_data: DescribeImageInstanceForIsvResponseBodyRelationalData = None,
        request_id: str = None,
        status: str = None,
        supplier_name: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Modules') is not None:
            for k in m.get('Modules'):
                temp_model = DescribeImageInstanceForIsvResponseBodyModules()
        ...
        if m.get('RelationalData') is not None:
            temp_model = DescribeImageInstanceForIsvResponseBodyRelationalData()
...
class DescribeImageInstanceForIsvResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: DescribeImageInstanceForIsvResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = DescribeImageInstanceForIsvResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

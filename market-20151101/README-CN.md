...
## Alibaba Cloud Market SDK for Python
...
```bash
# 安装 alibabacloud_market20151101
pip install alibabacloud_market20151101
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/market-20151101/ChangeLog.md)中。

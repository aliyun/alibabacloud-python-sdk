...
class GetTaskWorkforceStatisticResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        details: str = None,
        ...
        total_page: int = None,
        users_statistic: List[main_models.UserStatistic] = None,
    ):
    ...
    def validate(self):
        if self.users_statistic:
            for v1 in self.users_statistic:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.users_statistic is not None:
            for k1 in self.users_statistic:
                result['UsersStatistic'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UsersStatistic') is not None:
            for k1 in m.get('UsersStatistic'):
                temp_model = main_models.UserStatistic()
                self.users_statistic.append(temp_model.from_map(k1))

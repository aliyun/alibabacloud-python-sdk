...
class ListSubtasksResponseBody(DaraModel):
    def __init__(
        ...
        page_size: int = None,
        request_id: str = None,
        subtasks: List[main_models.SubtaskDetail] = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Subtasks') is not None:
            for k1 in m.get('Subtasks'):
                temp_model = main_models.SubtaskDetail()
                self.subtasks.append(temp_model.from_map(k1))

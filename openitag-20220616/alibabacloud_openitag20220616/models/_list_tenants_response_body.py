...
class ListTenantsResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        details: str = None,
        ...
        request_id: str = None,
        success: bool = None,
        tenants: List[main_models.SimpleTenant] = None,
    ...
    def to_map(self):
        ...
        if self.tenants is not None:
            for k1 in self.tenants:
                result['Tenants'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tenants') is not None:
            for k1 in m.get('Tenants'):
                temp_model = main_models.SimpleTenant()
                self.tenants.append(temp_model.from_map(k1))

...
## Alibaba Cloud pai SDK for Python
...
```bash
# 安装 alibabacloud_pai20240521
pip install alibabacloud_pai20240521
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/pai-20240521/ChangeLog.md)中。

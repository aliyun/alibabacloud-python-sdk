...
```bash
# 安装 alibabacloud_umeng_finplus20220913
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/umeng-finplus-20220913/ChangeLog.md)中。

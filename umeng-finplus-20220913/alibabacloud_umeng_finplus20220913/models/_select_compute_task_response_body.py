...
class SelectComputeTaskResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.SelectComputeTaskResponseBodyData = None,
        msg: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.SelectComputeTaskResponseBodyData()
...
class SelectComputeTaskResponseBodyData(DaraModel):
    def __init__(
        self,
        app_id: int = None,
        bc_id: int = None,
        ...
        export_oss_file_list: List[main_models.SelectComputeTaskResponseBodyDataExportOssFileList] = None,
        ext_info: str = None,
        file_num: int = None,
        name: str = None,
        remarks: str = None,
        status: str = None,
        task_result_list: List[main_models.SelectComputeTaskResponseBodyDataTaskResultList] = None,
    ):
        self.app_id = app_id
        self.bc_id = bc_id
    ...
    def validate(self):
        if self.export_oss_file_list:
            for v1 in self.export_oss_file_list:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.export_oss_file_list is not None:
            for k1 in self.export_oss_file_list:
                result['exportOssFileList'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('exportOssFileList') is not None:
            for k1 in m.get('exportOssFileList'):
                temp_model = main_models.SelectComputeTaskResponseBodyDataExportOssFileList()
                self.export_oss_file_list.append(temp_model.from_map(k1))
        ...
        if m.get('taskResultList') is not None:
            for k1 in m.get('taskResultList'):
                temp_model = main_models.SelectComputeTaskResponseBodyDataTaskResultList()
                self.task_result_list.append(temp_model.from_map(k1))

        return self

class SelectComputeTaskResponseBodyDataTaskResultList(DaraModel):
    def __init__(
        self,
        bc_id: int = None,
        code: int = None,
...
class SelectComputeTaskResponseBodyDataExportOssFileList(DaraModel):
    def __init__(
        self,

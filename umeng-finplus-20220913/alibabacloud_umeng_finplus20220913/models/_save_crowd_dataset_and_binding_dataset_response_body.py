...
class SaveCrowdDatasetAndBindingDatasetResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.SaveCrowdDatasetAndBindingDatasetResponseBodyData = None,
        msg: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.SaveCrowdDatasetAndBindingDatasetResponseBodyData()
...
class SaveCrowdDatasetAndBindingDatasetResponseBodyData(DaraModel):
    def __init__(
        self,
        app_id: str = None,

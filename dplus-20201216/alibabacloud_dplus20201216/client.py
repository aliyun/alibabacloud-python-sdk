...
class Client(OpenApiClient):
    ...
    *\
    ...
    def create_remove_work_task_with_options(
        self,
        request: dplus_20201216_models.CreateRemoveWorkTaskRequest,
        runtime: util_models.RuntimeOptions,
    ...
    async def create_remove_work_task_with_options_async(
        self,
        request: dplus_20201216_models.CreateRemoveWorkTaskRequest,
        runtime: util_models.RuntimeOptions,
    ) -> dplus_20201216_models.CreateRemoveWorkTaskResponse:
    ...
    async def create_remove_work_task_async(
        self,
        request: dplus_20201216_models.CreateRemoveWorkTaskRequest,
    ) -> dplus_20201216_models.CreateRemoveWorkTaskResponse:
        runtime = util_models.RuntimeOptions()
        return await self.create_remove_work_task_with_options_async(request, runtime)

    def create_remove_work_task_advance(
        self,
        request: dplus_20201216_models.CreateRemoveWorkTaskAdvanceRequest,
        runtime: util_models.RuntimeOptions,
    ) -> dplus_20201216_models.CreateRemoveWorkTaskResponse:
        # Step 0: init client
        access_key_id = self._credential.get_access_key_id()
        ...
        if not UtilClient.is_unset(request.pic_url_object):
            ...
            oss_client.post_object(upload_request, oss_runtime)
            create_remove_work_task_req.pic_url = f'http://{auth_response.bucket}.{auth_response.endpoint}/{auth_response.object_key}'
    ...
    async def create_remove_work_task_advance_async(
        self,
        request: dplus_20201216_models.CreateRemoveWorkTaskAdvanceRequest,
        runtime: util_models.RuntimeOptions,
    ) -> dplus_20201216_models.CreateRemoveWorkTaskResponse:
        ...
        if not UtilClient.is_unset(request.pic_url_object):
            ...
            await oss_client.post_object_async(upload_request, oss_runtime)
            create_remove_work_task_req.pic_url = f'http://{auth_response.bucket}.{auth_response.endpoint}/{auth_response.object_key}'
        create_remove_work_task_resp = await self.create_remove_work_task_with_options_async(create_remove_work_task_req, runtime)
        return create_remove_work_task_resp

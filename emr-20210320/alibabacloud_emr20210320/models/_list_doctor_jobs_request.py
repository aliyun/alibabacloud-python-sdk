...
class ListDoctorJobsRequest(DaraModel):
    def __init__(
        self,
        app_ids: List[str] = None,
        cluster_id: str = None,
        end_range: main_models.ListDoctorJobsRequestEndRange = None,
        ...
        region_id: str = None,
        start_range: main_models.ListDoctorJobsRequestStartRange = None,
        types: List[str] = None,
        users: List[str] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EndRange') is not None:
            temp_model = main_models.ListDoctorJobsRequestEndRange()
        ...
        if m.get('StartRange') is not None:
            temp_model = main_models.ListDoctorJobsRequestStartRange()
...
class ListDoctorJobsRequestStartRange(DaraModel):
    def __init__(
        self,
        end_time: int = None,
        start_time: int = None,
...
class ListDoctorJobsRequestEndRange(DaraModel):
    def __init__(
        self,
        end_time: int = None,
        start_time: int = None,

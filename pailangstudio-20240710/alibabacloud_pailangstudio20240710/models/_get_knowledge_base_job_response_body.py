...
class GetKnowledgeBaseJobResponseBody(DaraModel):
    def __init__(
        self,
        accessibility: str = None,
        creator: str = None,
        description: str = None,
        ecs_specs: List[main_models.GetKnowledgeBaseJobResponseBodyEcsSpecs] = None,
        embedding_config: main_models.GetKnowledgeBaseJobResponseBodyEmbeddingConfig = None,
        ...
        knowledge_base_job_result: main_models.GetKnowledgeBaseJobResponseBodyKnowledgeBaseJobResult = None,
        max_running_time_in_seconds: int = None,
        pipeline_run_info: main_models.GetKnowledgeBaseJobResponseBodyPipelineRunInfo = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EcsSpecs') is not None:
            for k1 in m.get('EcsSpecs'):
                temp_model = main_models.GetKnowledgeBaseJobResponseBodyEcsSpecs()
                self.ecs_specs.append(temp_model.from_map(k1))

        if m.get('EmbeddingConfig') is not None:
            temp_model = main_models.GetKnowledgeBaseJobResponseBodyEmbeddingConfig()
        ...
        if m.get('KnowledgeBaseJobResult') is not None:
            temp_model = main_models.GetKnowledgeBaseJobResponseBodyKnowledgeBaseJobResult()
        ...
        if m.get('PipelineRunInfo') is not None:
            temp_model = main_models.GetKnowledgeBaseJobResponseBodyPipelineRunInfo()
        ...
        if m.get('UserVpc') is not None:
            temp_model = main_models.GetKnowledgeBaseJobResponseBodyUserVpc()
...
class GetKnowledgeBaseJobResponseBodyUserVpc(DaraModel):
    def __init__(
        self,
...
class GetKnowledgeBaseJobResponseBodyPipelineRunInfo(DaraModel):
    def __init__(
        self,
...
class GetKnowledgeBaseJobResponseBodyKnowledgeBaseJobResult(DaraModel):
    def __init__(
        self,
...
class GetKnowledgeBaseJobResponseBodyEmbeddingConfig(DaraModel):
    def __init__(
        self,
        batch_size: int = None,
...
class GetKnowledgeBaseJobResponseBodyEcsSpecs(DaraModel):
    def __init__(
        self,
        cpu: int = None,
        driver: str = None,

...
class AutoUpdateConfig(DaraModel):
    def __init__(
        self,
        ecs_specs: List[main_models.AutoUpdateConfigEcsSpecs] = None,
        embedding_config: main_models.AutoUpdateConfigEmbeddingConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EcsSpecs') is not None:
            for k1 in m.get('EcsSpecs'):
                temp_model = main_models.AutoUpdateConfigEcsSpecs()
                self.ecs_specs.append(temp_model.from_map(k1))

        if m.get('EmbeddingConfig') is not None:
            temp_model = main_models.AutoUpdateConfigEmbeddingConfig()
...
class AutoUpdateConfigEmbeddingConfig(DaraModel):
    def __init__(
        self,
        batch_size: int = None,
...
class AutoUpdateConfigEcsSpecs(DaraModel):
    def __init__(
        self,
        cpu: int = None,
        driver: str = None,

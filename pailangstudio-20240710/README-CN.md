...
## Alibaba Cloud PAILangStudio SDK for Python
...
```bash
# 安装 alibabacloud_pailangstudio20240710
pip install alibabacloud_pailangstudio20240710
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/pailangstudio-20240710/ChangeLog.md)中。

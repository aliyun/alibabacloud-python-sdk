...
class ListTagValuesResponseBody(DaraModel):
    def __init__(
        ...
        next_token: str = None,
        request_id: str = None,
        values: main_models.ListTagValuesResponseBodyValues = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Values') is not None:
            temp_model = main_models.ListTagValuesResponseBodyValues()
            self.values = temp_model.from_map(m.get('Values'))

        return self

class ListTagValuesResponseBodyValues(DaraModel):
    def __init__(
        self,
        value: List[str] = None,
    ):

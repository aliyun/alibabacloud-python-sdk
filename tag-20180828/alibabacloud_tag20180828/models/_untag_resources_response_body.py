...
class UntagResourcesResponseBody(DaraModel):
    def __init__(
        self,
        failed_resources: main_models.UntagResourcesResponseBodyFailedResources = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FailedResources') is not None:
            temp_model = main_models.UntagResourcesResponseBodyFailedResources()
...
class UntagResourcesResponseBodyFailedResources(DaraModel):
    def __init__(
        self,
        failed_resource: List[main_models.UntagResourcesResponseBodyFailedResourcesFailedResource] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FailedResource') is not None:
            for k1 in m.get('FailedResource'):
                temp_model = main_models.UntagResourcesResponseBodyFailedResourcesFailedResource()
                self.failed_resource.append(temp_model.from_map(k1))

        return self

class UntagResourcesResponseBodyFailedResourcesFailedResource(DaraModel):
    def __init__(
        self,
        resource_arn: str = None,
        result: main_models.UntagResourcesResponseBodyFailedResourcesFailedResourceResult = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.UntagResourcesResponseBodyFailedResourcesFailedResourceResult()
            self.result = temp_model.from_map(m.get('Result'))

        return self

class UntagResourcesResponseBodyFailedResourcesFailedResourceResult(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,

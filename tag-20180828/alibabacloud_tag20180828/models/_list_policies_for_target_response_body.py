...
class ListPoliciesForTargetResponseBody(DaraModel):
    def __init__(
        self,
        data: List[main_models.ListPoliciesForTargetResponseBodyData] = None,
        next_token: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListPoliciesForTargetResponseBodyData()
...
class ListPoliciesForTargetResponseBodyData(DaraModel):
    def __init__(
        self,

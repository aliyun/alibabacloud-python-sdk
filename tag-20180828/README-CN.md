...
## Alibaba Cloud Tag SDK for Python
...
```bash
# 安装 alibabacloud_tag20180828
pip install alibabacloud_tag20180828
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/tag-20180828/ChangeLog.md)中。

...
## Alibaba Cloud ADBAI SDK for Python
...
```bash
# 安装 alibabacloud_adbai20250812
pip install alibabacloud_adbai20250812
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/adbai-20250812/ChangeLog.md)中。

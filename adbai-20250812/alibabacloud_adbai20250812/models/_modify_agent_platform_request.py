...
class ModifyAgentPlatformRequest(DaraModel):
    def __init__(
        self,
        ai_platform_config: main_models.ModifyAgentPlatformRequestAiPlatformConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AiPlatformConfig') is not None:
            temp_model = main_models.ModifyAgentPlatformRequestAiPlatformConfig()
...
class ModifyAgentPlatformRequestAiPlatformConfig(DaraModel):
    def __init__(
        self,

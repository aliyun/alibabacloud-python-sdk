...
## Alibaba Cloud amqp-open SDK for Python
...
```bash
# 安装 alibabacloud_amqp_open20191212
pip install alibabacloud_amqp_open20191212
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/amqp-open-20191212/ChangeLog.md)中。

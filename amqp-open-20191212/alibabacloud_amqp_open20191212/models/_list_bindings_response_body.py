...
class ListBindingsResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.ListBindingsResponseBodyData = None,
        request_id: str = None,
    ):
        # The returned data.
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListBindingsResponseBodyData()
...
class ListBindingsResponseBodyData(DaraModel):
    def __init__(
        self,
        bindings: List[main_models.ListBindingsResponseBodyDataBindings] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Bindings') is not None:
            for k1 in m.get('Bindings'):
                temp_model = main_models.ListBindingsResponseBodyDataBindings()
...
class ListBindingsResponseBodyDataBindings(DaraModel):
    def __init__(
        self,
        argument: str = None,

...
class DescribeEnumItemsResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.DescribeEnumItemsResponseBodyData()
...
class DescribeEnumItemsResponseBodyData(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

...
class CreateTenantSkillShrinkRequest(DaraModel):
    def __init__(
        self,
        api_key: str = None,
        description: str = None,
        display_name: str = None,
        env_vars_shrink: str = None,
        icon_etag: str = None,
        ...
        self.env_vars_shrink = env_vars_shrink
    ...
    def to_map(self):
        ...
        if self.env_vars_shrink is not None:
            result['EnvVars'] = self.env_vars_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EnvVars') is not None:
            self.env_vars_shrink = m.get('EnvVars')

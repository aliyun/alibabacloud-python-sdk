...
```bash
# 安装 alibabacloud_ecd20210602
pip install alibabacloud_ecd20210602
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/ecd-20210602/ChangeLog.md)中。

...
## Alibaba Cloud PaiFeatureStore SDK for Python
...
```bash
# 安装 alibabacloud_paifeaturestore20230621
pip install alibabacloud_paifeaturestore20230621
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/paifeaturestore-20230621/ChangeLog.md)中。

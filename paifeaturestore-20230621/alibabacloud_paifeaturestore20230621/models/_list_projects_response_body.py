...
class ListProjectsResponseBody(DaraModel):
    def __init__(
        self,
        projects: List[main_models.ListProjectsResponseBodyProjects] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Projects') is not None:
            for k1 in m.get('Projects'):
                temp_model = main_models.ListProjectsResponseBodyProjects()
...
class ListProjectsResponseBodyProjects(DaraModel):
    def __init__(
        self,

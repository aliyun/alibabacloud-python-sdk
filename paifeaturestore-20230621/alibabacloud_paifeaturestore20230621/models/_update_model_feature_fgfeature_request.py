...
class UpdateModelFeatureFGFeatureRequest(DaraModel):
    def __init__(
        self,
        lookup_features: List[main_models.UpdateModelFeatureFGFeatureRequestLookupFeatures] = None,
        raw_features: List[main_models.UpdateModelFeatureFGFeatureRequestRawFeatures] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LookupFeatures') is not None:
            for k1 in m.get('LookupFeatures'):
                temp_model = main_models.UpdateModelFeatureFGFeatureRequestLookupFeatures()
                self.lookup_features.append(temp_model.from_map(k1))

        self.raw_features = []
        if m.get('RawFeatures') is not None:
            for k1 in m.get('RawFeatures'):
                temp_model = main_models.UpdateModelFeatureFGFeatureRequestRawFeatures()
        ...
        if m.get('SequenceFeatures') is not None:
            for k1 in m.get('SequenceFeatures'):
                temp_model = main_models.UpdateModelFeatureFGFeatureRequestSequenceFeatures()
                self.sequence_features.append(temp_model.from_map(k1))

        return self

class UpdateModelFeatureFGFeatureRequestSequenceFeatures(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SubFeatures') is not None:
            for k1 in m.get('SubFeatures'):
                temp_model = main_models.UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures()
                self.sub_features.append(temp_model.from_map(k1))

        return self

class UpdateModelFeatureFGFeatureRequestSequenceFeaturesSubFeatures(DaraModel):
    def __init__(
        self,
...
class UpdateModelFeatureFGFeatureRequestRawFeatures(DaraModel):
    def __init__(
        self,
        default_value: str = None,
        feature_domain: str = None,
...
class UpdateModelFeatureFGFeatureRequestLookupFeatures(DaraModel):
    def __init__(
        self,
        default_value: str = None,
        feature_name: str = None,

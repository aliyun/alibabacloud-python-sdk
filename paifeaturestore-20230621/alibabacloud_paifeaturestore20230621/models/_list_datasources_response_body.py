...
class ListDatasourcesResponseBody(DaraModel):
    def __init__(
        self,
        datasources: List[main_models.ListDatasourcesResponseBodyDatasources] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Datasources') is not None:
            for k1 in m.get('Datasources'):
                ...
                self.datasources.append(temp_model.from_map(k1))

...
class UpdateModelFeatureRequest(DaraModel):
    def __init__(
        self,
        features: List[main_models.UpdateModelFeatureRequestFeatures] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Features') is not None:
            for k1 in m.get('Features'):
                temp_model = main_models.UpdateModelFeatureRequestFeatures()
...
class UpdateModelFeatureRequestFeatures(DaraModel):
    def __init__(
        self,
        alias_name: str = None,

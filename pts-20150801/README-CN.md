...
## Alibaba Cloud PTS SDK for Python
...
```bash
# 安装 alibabacloud_pts20150801
pip install alibabacloud_pts20150801
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/pts-20150801/ChangeLog.md)中。

...
```bash
# 安装 alibabacloud_paimodelgallery20260603
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/paimodelgallery-20260603/ChangeLog.md)中。

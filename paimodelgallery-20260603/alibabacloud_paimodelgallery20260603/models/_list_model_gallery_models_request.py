...
class ListModelGalleryModelsRequest(DaraModel):
    def __init__(
        self,
        collections: str = None,
        compressible: bool = None,
        conditions: List[main_models.ListModelGalleryModelsRequestConditions] = None,
        ...
        tag: List[main_models.ListModelGalleryModelsRequestTag] = None,
        task: str = None,
        trainable: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Conditions') is not None:
            for k1 in m.get('Conditions'):
                temp_model = main_models.ListModelGalleryModelsRequestConditions()
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.ListModelGalleryModelsRequestTag()
...
class ListModelGalleryModelsRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class ListModelGalleryModelsRequestConditions(DaraModel):
    def __init__(
        self,
        column: str = None,
        operator: str = None,

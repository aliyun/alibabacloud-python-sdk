...
class GetNormalizationRuleVersionResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NormalizationRuleVersion') is not None:
            temp_model = main_models.GetNormalizationRuleVersionResponseBodyNormalizationRuleVersion()
...
class GetNormalizationRuleVersionResponseBodyNormalizationRuleVersion(DaraModel):
    def __init__(
        self,

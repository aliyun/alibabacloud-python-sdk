...
class ListDataConnectorsRequest(DaraModel):
    def __init__(
        self,
        data_connector_ids: List[str] = None,
        ...
        self.data_connector_ids = data_connector_ids
        # The collector name.
    ...
    def to_map(self):
        ...
        if self.data_connector_ids is not None:
            result['DataConnectorIds'] = self.data_connector_ids
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataConnectorIds') is not None:
            self.data_connector_ids = m.get('DataConnectorIds')

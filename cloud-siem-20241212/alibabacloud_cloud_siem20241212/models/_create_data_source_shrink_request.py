...
class CreateDataSourceShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        data_source_stores: List[main_models.CreateDataSourceShrinkRequestDataSourceStores] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataSourceStores') is not None:
            for k1 in m.get('DataSourceStores'):
                temp_model = main_models.CreateDataSourceShrinkRequestDataSourceStores()
...
class CreateDataSourceShrinkRequestDataSourceStores(DaraModel):
    def __init__(
        self,

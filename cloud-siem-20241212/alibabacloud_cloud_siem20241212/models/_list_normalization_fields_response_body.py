...
class ListNormalizationFieldsResponseBody(DaraModel):
    def __init__(
        self,
        max_results: int = None,
        next_token: str = None,
        normalization_fields: List[main_models.ListNormalizationFieldsResponseBodyNormalizationFields] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NormalizationFields') is not None:
            for k1 in m.get('NormalizationFields'):
                temp_model = main_models.ListNormalizationFieldsResponseBodyNormalizationFields()
...
class ListNormalizationFieldsResponseBodyNormalizationFields(DaraModel):
    def __init__(
        self,
        ...
        normalization_field_json_keys: List[main_models.ListNormalizationFieldsResponseBodyNormalizationFieldsNormalizationFieldJsonKeys] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NormalizationFieldJsonKeys') is not None:
            for k1 in m.get('NormalizationFieldJsonKeys'):
                temp_model = main_models.ListNormalizationFieldsResponseBodyNormalizationFieldsNormalizationFieldJsonKeys()
...
class ListNormalizationFieldsResponseBodyNormalizationFieldsNormalizationFieldJsonKeys(DaraModel):
    def __init__(
        self,
        create_time: int = None,
        normalization_field_description: str = None,

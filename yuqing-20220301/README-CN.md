...
## Alibaba Cloud Yuqing SDK for Python
...
```bash
# 安装 alibabacloud_yuqing20220301
pip install alibabacloud_yuqing20220301
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/yuqing-20220301/ChangeLog.md)中。

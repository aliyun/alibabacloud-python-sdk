...
class CreatePipelineRequestSource(DaraModel):
    def __init__(
        self,
        dataset: main_models.CreatePipelineRequestSourceDataset = None,
        input_fields: List[main_models.CreatePipelineRequestSourceInputFields] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dataset') is not None:
            temp_model = main_models.CreatePipelineRequestSourceDataset()
            self.dataset = temp_model.from_map(m.get('dataset'))

        self.input_fields = []
        if m.get('inputFields') is not None:
            for k1 in m.get('inputFields'):
                temp_model = main_models.CreatePipelineRequestSourceInputFields()
...
class CreatePipelineRequestSourceInputFields(DaraModel):
    def __init__(
        self,
        name: str = None,
        type: str = None,
...
class CreatePipelineRequestSourceDataset(DaraModel):
    def __init__(
        self,
        dataset: str = None,
        filter: str = None,
...
class CreatePipelineRequestSink(DaraModel):
    def __init__(
        self,
        condition: main_models.CreatePipelineRequestSinkCondition = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('condition') is not None:
            temp_model = main_models.CreatePipelineRequestSinkCondition()
...
class CreatePipelineRequestSinkCondition(DaraModel):
    def __init__(
        self,
        default_sink: main_models.CreatePipelineRequestSinkConditionDefaultSink = None,
        match_mode: str = None,
        routes: List[main_models.CreatePipelineRequestSinkConditionRoutes] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('defaultSink') is not None:
            temp_model = main_models.CreatePipelineRequestSinkConditionDefaultSink()
        ...
        if m.get('routes') is not None:
            for k1 in m.get('routes'):
                temp_model = main_models.CreatePipelineRequestSinkConditionRoutes()
                self.routes.append(temp_model.from_map(k1))

        return self

class CreatePipelineRequestSinkConditionRoutes(DaraModel):
    def __init__(
        self,
        expression: str = None,
        id: str = None,
        sink: main_models.CreatePipelineRequestSinkConditionRoutesSink = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('sink') is not None:
            temp_model = main_models.CreatePipelineRequestSinkConditionRoutesSink()
            self.sink = temp_model.from_map(m.get('sink'))

        return self

class CreatePipelineRequestSinkConditionRoutesSink(DaraModel):
    def __init__(
        self,
        dataset: main_models.CreatePipelineRequestSinkConditionRoutesSinkDataset = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('dataset') is not None:
            temp_model = main_models.CreatePipelineRequestSinkConditionRoutesSinkDataset()
            self.dataset = temp_model.from_map(m.get('dataset'))
...
class CreatePipelineRequestSinkConditionRoutesSinkDataset(DaraModel):
    def __init__(
        self,
        agent_space: str = None,
        dataset: str = None,
...
class CreatePipelineRequestSinkConditionDefaultSink(DaraModel):
    def __init__(
        self,
        dataset: main_models.CreatePipelineRequestSinkConditionDefaultSinkDataset = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('dataset') is not None:
            temp_model = main_models.CreatePipelineRequestSinkConditionDefaultSinkDataset()
            self.dataset = temp_model.from_map(m.get('dataset'))
...
class CreatePipelineRequestSinkConditionDefaultSinkDataset(DaraModel):
    def __init__(
        self,
        agent_space: str = None,
        dataset: str = None,

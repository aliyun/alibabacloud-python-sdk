...
class ListPipelineRunsResponseBody(DaraModel):
    def __init__(
        ...
        next_token: str = None,
        request_id: str = None,
        runs: List[main_models.ListPipelineRunsResponseBodyRuns] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('runs') is not None:
            for k1 in m.get('runs'):
                temp_model = main_models.ListPipelineRunsResponseBodyRuns()
...
class ListPipelineRunsResponseBodyRuns(DaraModel):
    def __init__(
        self,

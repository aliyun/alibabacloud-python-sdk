...
```bash
# 安装 alibabacloud_ecs_workbench20220220
pip install alibabacloud_ecs_workbench20220220
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/ecs-workbench-20220220/ChangeLog.md)中。

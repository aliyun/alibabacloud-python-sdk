...
class ListTagResponseBody(DaraModel):
    def __init__(
        ...
        page_size: int = None,
        request_id: str = None,
        tag_groups: List[main_models.ListTagResponseBodyTagGroups] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TagGroups') is not None:
            for k1 in m.get('TagGroups'):
                temp_model = main_models.ListTagResponseBodyTagGroups()
...
class ListTagResponseBodyTagGroups(DaraModel):
    def __init__(
        self,

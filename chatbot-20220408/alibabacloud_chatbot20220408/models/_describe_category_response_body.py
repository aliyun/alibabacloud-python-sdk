...
class DescribeCategoryResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Category') is not None:
            temp_model = main_models.DescribeCategoryResponseBodyCategory()
...
class DescribeCategoryResponseBodyCategory(DaraModel):
    def __init__(
        self,
        biz_code: str = None,

...
class ListLgfResponseBody(DaraModel):
    def __init__(
        self,
        lgfs: List[main_models.ListLgfResponseBodyLgfs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Lgfs') is not None:
            for k1 in m.get('Lgfs'):
                temp_model = main_models.ListLgfResponseBodyLgfs()
...
class ListLgfResponseBodyLgfs(DaraModel):
    def __init__(
        self,

...
class UpdateDocRequest(DaraModel):
    def __init__(
        self,
        agent_key: str = None,
        ...
        config: str = None,
        content: str = None,
        doc_metadata: List[main_models.UpdateDocRequestDocMetadata] = None,
        doc_name: str = None,
        end_date: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DocMetadata') is not None:
            for k1 in m.get('DocMetadata'):
                temp_model = main_models.UpdateDocRequestDocMetadata()
...
class UpdateDocRequestDocMetadata(DaraModel):
    def __init__(
        self,
        business_view_id: str = None,
        business_view_name: str = None,
        meta_cell_info_dtolist: List[main_models.UpdateDocRequestDocMetadataMetaCellInfoDTOList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MetaCellInfoDTOList') is not None:
            for k1 in m.get('MetaCellInfoDTOList'):
                temp_model = main_models.UpdateDocRequestDocMetadataMetaCellInfoDTOList()
                self.meta_cell_info_dtolist.append(temp_model.from_map(k1))

        return self

class UpdateDocRequestDocMetadataMetaCellInfoDTOList(DaraModel):
    def __init__(
        self,
        field_code: str = None,
        field_name: str = None,

...
class UpdateIntentRequest(DaraModel):
    def __init__(
        self,
        agent_key: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IntentDefinition') is not None:
            temp_model = main_models.UpdateIntentRequestIntentDefinition()
...
class UpdateIntentRequestIntentDefinition(DaraModel):
    def __init__(
        self,
        alias_name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SlotInfos') is not None:
            for k1 in m.get('SlotInfos'):
                temp_model = main_models.UpdateIntentRequestIntentDefinitionSlotInfos()
                self.slot_infos.append(temp_model.from_map(k1))

        return self

class UpdateIntentRequestIntentDefinitionSlotInfos(DaraModel):
    def __init__(
        self,
        array: bool = None,
        encrypt: bool = None,

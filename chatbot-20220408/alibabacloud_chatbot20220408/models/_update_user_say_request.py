...
class UpdateUserSayRequest(DaraModel):
    def __init__(
        self,
        agent_key: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserSayDefinition') is not None:
            temp_model = main_models.UpdateUserSayRequestUserSayDefinition()
...
class UpdateUserSayRequestUserSayDefinition(DaraModel):
    def __init__(
        self,
        content: str = None,
        intent_id: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SlotInfos') is not None:
            for k1 in m.get('SlotInfos'):
                temp_model = main_models.UpdateUserSayRequestUserSayDefinitionSlotInfos()
                self.slot_infos.append(temp_model.from_map(k1))

        return self

class UpdateUserSayRequestUserSayDefinitionSlotInfos(DaraModel):
    def __init__(
        self,
        end_index: int = None,
        slot_id: str = None,

...
class ListVpcInfoByVpcResponseBody(DaraModel):
    def __init__(
        self,
        page_num: int = None,
        page_size: int = None,
        ...
        vpc_id: str = None,
        vpc_infos: List[main_models.ListVpcInfoByVpcResponseBodyVpcInfos] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VpcInfos') is not None:
            for k1 in m.get('VpcInfos'):
                temp_model = main_models.ListVpcInfoByVpcResponseBodyVpcInfos()
                self.vpc_infos.append(temp_model.from_map(k1))

        return self

class ListVpcInfoByVpcResponseBodyVpcInfos(DaraModel):
    def __init__(
        self,
        domain: str = None,
        endpoint: str = None,

...
class ListAgentStoragesRequest(DaraModel):
    def __init__(
        self,
        agent_storage_name: str = None,
        agent_storage_name_list: List[str] = None,
        max_results: int = None,
        next_token: str = None,
        resource_group_id: str = None,
        status: str = None,
        tag: List[main_models.ListAgentStoragesRequestTag] = None,
    ):
        # agent storage name
        ...
        self.agent_storage_name_list = agent_storage_name_list
    ...
    def to_map(self):
        ...
        if self.agent_storage_name_list is not None:
            result['AgentStorageNameList'] = self.agent_storage_name_list
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AgentStorageNameList') is not None:
            self.agent_storage_name_list = m.get('AgentStorageNameList')
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.ListAgentStoragesRequestTag()
                self.tag.append(temp_model.from_map(k1))

        return self

class ListAgentStoragesRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

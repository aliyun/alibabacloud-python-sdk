...
class CreateDomainResourceRequest(DaraModel):
    def __init__(
        self,
        domain: str = None,
        https_ext: str = None,
        instance_ids: List[str] = None,
        proxy_types: List[main_models.CreateDomainResourceRequestProxyTypes] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ProxyTypes') is not None:
            for k1 in m.get('ProxyTypes'):
                temp_model = main_models.CreateDomainResourceRequestProxyTypes()
...
class CreateDomainResourceRequestProxyTypes(DaraModel):
    def __init__(
        self,

...
class Client(OpenApiClient):
    ...
    *\
    ...
    def edas_refund_with_options(
        self,
        request: edas_20160816_models.EdasRefundRequest,
    ...
    async def edas_refund_with_options_async(
        self,
        request: edas_20160816_models.EdasRefundRequest,
        runtime: util_models.RuntimeOptions,
    ) -> edas_20160816_models.EdasRefundResponse:
    ...
    async def edas_refund_async(
        self,
        request: edas_20160816_models.EdasRefundRequest,
    ) -> edas_20160816_models.EdasRefundResponse:
        runtime = util_models.RuntimeOptions()
        return await self.edas_refund_with_options_async(request, runtime)

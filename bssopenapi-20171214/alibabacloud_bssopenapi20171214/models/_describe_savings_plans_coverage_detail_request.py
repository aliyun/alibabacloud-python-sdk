...
class DescribeSavingsPlansCoverageDetailRequest(DaraModel):
    def __init__(
        self,
        bill_owner_id: int = None,
        end_period: str = None,
        filter_param: main_models.DescribeSavingsPlansCoverageDetailRequestFilterParam = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FilterParam') is not None:
            temp_model = main_models.DescribeSavingsPlansCoverageDetailRequestFilterParam()
...
class DescribeSavingsPlansCoverageDetailRequestFilterParam(DaraModel):
    def __init__(
        self,
        dimensions: List[main_models.DescribeSavingsPlansCoverageDetailRequestFilterParamDimensions] = None,
        tags: List[main_models.DescribeSavingsPlansCoverageDetailRequestFilterParamTags] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Dimensions') is not None:
            for k1 in m.get('Dimensions'):
                temp_model = main_models.DescribeSavingsPlansCoverageDetailRequestFilterParamDimensions()
                self.dimensions.append(temp_model.from_map(k1))

        self.tags = []
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.DescribeSavingsPlansCoverageDetailRequestFilterParamTags()
                self.tags.append(temp_model.from_map(k1))

        return self

class DescribeSavingsPlansCoverageDetailRequestFilterParamTags(DaraModel):
    def __init__(
        self,
        code: str = None,
...
class DescribeSavingsPlansCoverageDetailRequestFilterParamDimensions(DaraModel):
    def __init__(
        self,
        code: str = None,
        select_type: str = None,

...
class DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBodyData()
...
class DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBodyData(DaraModel):
    def __init__(
        self,
        account_id: str = None,
        account_name: str = None,
        host_id: str = None,
        items: List[main_models.DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBodyDataItems] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Items') is not None:
            for k1 in m.get('Items'):
                temp_model = main_models.DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBodyDataItems()
...
class DescribeInstanceAmortizedCostByAmortizationPeriodDateResponseBodyDataItems(DaraModel):
    def __init__(
        self,

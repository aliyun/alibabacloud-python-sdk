...
class ApplyInvoiceResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ApplyInvoiceResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ApplyInvoiceResponseBodyData()
...
class ApplyInvoiceResponseBodyData(DaraModel):
    def __init__(
        self,

...
class RefundInstanceResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.RefundInstanceResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.RefundInstanceResponseBodyData()
...
class RefundInstanceResponseBodyData(DaraModel):
    def __init__(
        self,
        host_id: str = None,
        order_id: int = None,

...
class DescribeInstanceAmortizedCostByConsumePeriodResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.DescribeInstanceAmortizedCostByConsumePeriodResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DescribeInstanceAmortizedCostByConsumePeriodResponseBodyData()
...
class DescribeInstanceAmortizedCostByConsumePeriodResponseBodyData(DaraModel):
    def __init__(
        self,
        account_id: str = None,
        account_name: str = None,
        items: List[main_models.DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Items') is not None:
            for k1 in m.get('Items'):
                temp_model = main_models.DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems()
...
class DescribeInstanceAmortizedCostByConsumePeriodResponseBodyDataItems(DaraModel):
    def __init__(
        self,

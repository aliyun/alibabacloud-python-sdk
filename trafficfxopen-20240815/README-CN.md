...
```bash
# 安装 alibabacloud_trafficfxopen20240815
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/trafficfxopen-20240815/ChangeLog.md)中。

...
class CloudQueryPredictiveCallCdrResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: str = None,
        data: main_models.CloudQueryPredictiveCallCdrResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CloudQueryPredictiveCallCdrResponseBodyData()
...
class CloudQueryPredictiveCallCdrResponseBodyData(DaraModel):
    def __init__(
        self,
        list: List[main_models.CloudQueryPredictiveCallCdrResponseBodyDataList] = None,
    ):
        # 预测式外呼通话记录数组
        self.list = list
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            for k1 in m.get('List'):
                temp_model = main_models.CloudQueryPredictiveCallCdrResponseBodyDataList()
                self.list.append(temp_model.from_map(k1))

        return self

class CloudQueryPredictiveCallCdrResponseBodyDataList(DaraModel):
    def __init__(
        self,
        agent_name: str = None,
        ...
        record_file: List[main_models.CloudQueryPredictiveCallCdrResponseBodyDataListRecordFile] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RecordFile') is not None:
            for k1 in m.get('RecordFile'):
                temp_model = main_models.CloudQueryPredictiveCallCdrResponseBodyDataListRecordFile()
...
class CloudQueryPredictiveCallCdrResponseBodyDataListRecordFile(DaraModel):
    def __init__(
        self,
        file: str = None,

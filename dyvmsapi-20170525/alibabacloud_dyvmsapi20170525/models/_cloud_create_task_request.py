...
class CloudCreateTaskRequest(DaraModel):
    def __init__(
        self,
        ...
        self.call_group_type = call_group_type
    ...
    def to_map(self):
        ...
        if self.call_group_type is not None:
            result['CallGroupType'] = self.call_group_type
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallGroupType') is not None:
            self.call_group_type = m.get('CallGroupType')

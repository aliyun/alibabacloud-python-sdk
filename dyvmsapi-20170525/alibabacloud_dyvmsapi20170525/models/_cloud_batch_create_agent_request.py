...
class CloudBatchCreateAgentRequest(DaraModel):
    def __init__(
        self,
        active: int = None,
        area_code: str = None,
    ...
    def to_map(self):
        ...
        if self.end_cno is not None:
            result['EndCno'] = self.end_cno
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EndCno') is not None:
            self.end_cno = m.get('EndCno')

...
class UpdateVoiceAccessProfileRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Profile') is not None:
            temp_model = main_models.UpdateVoiceAccessProfileRequestProfile()
            self.profile = temp_model.from_map(m.get('Profile'))

        return self

class UpdateVoiceAccessProfileRequestProfile(DaraModel):
    def __init__(
        self,
        access_key: str = None,
        api_key: str = None,

...
```bash
# 安装 alibabacloud_voicenavigator20251111
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/voicenavigator-20251111/ChangeLog.md)中。

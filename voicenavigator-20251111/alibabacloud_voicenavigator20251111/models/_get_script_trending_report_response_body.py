...
class GetScriptTrendingReportResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: List[main_models.GetScriptTrendingReportResponseBodyData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.GetScriptTrendingReportResponseBodyData()
...
class GetScriptTrendingReportResponseBodyData(DaraModel):
    def __init__(
        self,
        ...
        self.label_break_down = label_break_down
    ...
    def to_map(self):
        ...
        if self.label_break_down is not None:
            result['LabelBreakDown'] = self.label_break_down
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LabelBreakDown') is not None:
            self.label_break_down = m.get('LabelBreakDown')

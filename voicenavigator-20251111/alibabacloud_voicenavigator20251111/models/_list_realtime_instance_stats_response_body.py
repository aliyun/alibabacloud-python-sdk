...
class ListRealtimeInstanceStatsResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ListRealtimeInstanceStatsResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListRealtimeInstanceStatsResponseBodyData()
...
class ListRealtimeInstanceStatsResponseBodyData(DaraModel):
    def __init__(
        self,
        list: List[main_models.ListRealtimeInstanceStatsResponseBodyDataList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            for k1 in m.get('List'):
                temp_model = main_models.ListRealtimeInstanceStatsResponseBodyDataList()
...
class ListRealtimeInstanceStatsResponseBodyDataList(DaraModel):
    def __init__(
        self,

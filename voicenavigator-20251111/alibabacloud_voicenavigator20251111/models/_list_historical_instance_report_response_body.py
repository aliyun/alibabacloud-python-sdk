...
class ListHistoricalInstanceReportResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ListHistoricalInstanceReportResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListHistoricalInstanceReportResponseBodyData()
...
class ListHistoricalInstanceReportResponseBodyData(DaraModel):
    def __init__(
        self,
        list: List[main_models.ListHistoricalInstanceReportResponseBodyDataList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            for k1 in m.get('List'):
                temp_model = main_models.ListHistoricalInstanceReportResponseBodyDataList()
...
class ListHistoricalInstanceReportResponseBodyDataList(DaraModel):
    def __init__(
        self,

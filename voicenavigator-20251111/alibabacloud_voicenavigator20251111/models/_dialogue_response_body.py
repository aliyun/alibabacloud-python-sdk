...
class DialogueResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.DialogueResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DialogueResponseBodyData()
...
class DialogueResponseBodyData(DaraModel):
    def __init__(
        self,
        answer: str = None,
        control_params_list: List[main_models.DialogueResponseBodyDataControlParamsList] = None,
        end_time: int = None,
        session_id: str = None,
        start_time: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ControlParamsList') is not None:
            for k1 in m.get('ControlParamsList'):
                temp_model = main_models.DialogueResponseBodyDataControlParamsList()
...
class DialogueResponseBodyDataControlParamsList(DaraModel):
    def __init__(
        self,
        type: str = None,
    ):

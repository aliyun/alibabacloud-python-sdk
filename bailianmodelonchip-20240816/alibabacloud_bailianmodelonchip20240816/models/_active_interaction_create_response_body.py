...
class ActiveInteractionCreateResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ActiveInteractionCreateResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.ActiveInteractionCreateResponseBodyData()
...
class ActiveInteractionCreateResponseBodyData(DaraModel):
    def __init__(
        self,
        gesture: str = None,
        person: str = None,

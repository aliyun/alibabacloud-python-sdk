...
## Alibaba Cloud cddc SDK for Python
...
```bash
# 安装 alibabacloud_cddc20200320
pip install alibabacloud_cddc20200320
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/cddc-20200320/ChangeLog.md)中。

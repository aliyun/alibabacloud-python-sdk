...
class DeleteDBInstanceEndpointResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.DeleteDBInstanceEndpointResponseBodyData = None,
        request_id: str = None,
    ):
        # The data returned.
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DeleteDBInstanceEndpointResponseBodyData()
...
class DeleteDBInstanceEndpointResponseBodyData(DaraModel):
    def __init__(
        self,

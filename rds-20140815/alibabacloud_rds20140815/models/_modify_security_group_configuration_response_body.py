...
class ModifySecurityGroupConfigurationResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Items') is not None:
            temp_model = main_models.ModifySecurityGroupConfigurationResponseBodyItems()
...
class ModifySecurityGroupConfigurationResponseBodyItems(DaraModel):
    def __init__(
        self,
        ecs_security_group_relation: List[main_models.ModifySecurityGroupConfigurationResponseBodyItemsEcsSecurityGroupRelation] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EcsSecurityGroupRelation') is not None:
            for k1 in m.get('EcsSecurityGroupRelation'):
                temp_model = main_models.ModifySecurityGroupConfigurationResponseBodyItemsEcsSecurityGroupRelation()
                self.ecs_security_group_relation.append(temp_model.from_map(k1))

        return self

class ModifySecurityGroupConfigurationResponseBodyItemsEcsSecurityGroupRelation(DaraModel):
    def __init__(
        self,

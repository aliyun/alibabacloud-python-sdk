...
class CreateGADInstanceRequest(DaraModel):
    def __init__(
        self,
        ...
        tag: List[main_models.CreateGADInstanceRequestTag] = None,
        unit_node: List[main_models.CreateGADInstanceRequestUnitNode] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.CreateGADInstanceRequestTag()
                self.tag.append(temp_model.from_map(k1))

        self.unit_node = []
        if m.get('UnitNode') is not None:
            for k1 in m.get('UnitNode'):
                temp_model = main_models.CreateGADInstanceRequestUnitNode()
                self.unit_node.append(temp_model.from_map(k1))

        return self

class CreateGADInstanceRequestUnitNode(DaraModel):
    def __init__(
        self,
...
class CreateGADInstanceRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

...
class DescribeCrossBackupMetaListResponseBody(DaraModel):
    def __init__(
        self,
        dbinstance_name: str = None,
        items: main_models.DescribeCrossBackupMetaListResponseBodyItems = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Items') is not None:
            temp_model = main_models.DescribeCrossBackupMetaListResponseBodyItems()
...
class DescribeCrossBackupMetaListResponseBodyItems(DaraModel):
    def __init__(
        self,
        meta: List[main_models.DescribeCrossBackupMetaListResponseBodyItemsMeta] = None,
    ):
        self.meta = meta
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Meta') is not None:
            for k1 in m.get('Meta'):
                temp_model = main_models.DescribeCrossBackupMetaListResponseBodyItemsMeta()
                self.meta.append(temp_model.from_map(k1))

        return self

class DescribeCrossBackupMetaListResponseBodyItemsMeta(DaraModel):
    def __init__(
        self,
        database: str = None,
        size: str = None,

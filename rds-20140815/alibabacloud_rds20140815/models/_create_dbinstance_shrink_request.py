...
class CreateDBInstanceShrinkRequest(DaraModel):
    def __init__(
        ...
        tag: List[main_models.CreateDBInstanceShrinkRequestTag] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.CreateDBInstanceShrinkRequestTag()
...
class CreateDBInstanceShrinkRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

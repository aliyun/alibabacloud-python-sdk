...
class DeleteDBInstanceEndpointAddressResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.DeleteDBInstanceEndpointAddressResponseBodyData = None,
        request_id: str = None,
    ):
        # The returned data.
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DeleteDBInstanceEndpointAddressResponseBodyData()
...
class DeleteDBInstanceEndpointAddressResponseBodyData(DaraModel):
    def __init__(
        self,

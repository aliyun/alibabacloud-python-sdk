...
class CreateDBInstanceEndpointRequest(DaraModel):
    def __init__(
        self,
        ...
        node_items: List[main_models.CreateDBInstanceEndpointRequestNodeItems] = None,
        port: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NodeItems') is not None:
            for k1 in m.get('NodeItems'):
                temp_model = main_models.CreateDBInstanceEndpointRequestNodeItems()
...
class CreateDBInstanceEndpointRequestNodeItems(DaraModel):
    def __init__(
        self,
        dbinstance_id: str = None,
        node_id: str = None,

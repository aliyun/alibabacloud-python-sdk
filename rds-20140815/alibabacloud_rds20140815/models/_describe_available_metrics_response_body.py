...
class DescribeAvailableMetricsResponseBody(DaraModel):
    def __init__(
        self,
        dbinstance_name: str = None,
        items: List[main_models.DescribeAvailableMetricsResponseBodyItems] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Items') is not None:
            for k1 in m.get('Items'):
                temp_model = main_models.DescribeAvailableMetricsResponseBodyItems()
...
class DescribeAvailableMetricsResponseBodyItems(DaraModel):
    def __init__(
        self,

...
class ListNVRDeviceResponseBodyDataChannelList(TeaModel):
    def __init__(
        self,
        device_code: str = None,
        device_name: str = None,
...
class ListNVRDeviceResponseBodyData(TeaModel):
    def __init__(
        ...
        channel: str = None,
        device_sn: str = None,
        channel_list: List[ListNVRDeviceResponseBodyDataChannelList] = None,
        type: str = None,
    ):
        self.device_code = device_code
        self.device_name = device_name
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ChannelList') is not None:
            for k in m.get('ChannelList'):
                temp_model = ListNVRDeviceResponseBodyDataChannelList()
                self.channel_list.append(temp_model.from_map(k))

...
class UpdateStackInstancesRequest(DaraModel):
    def __init__(
        self,
        account_ids: List[str] = None,
        client_token: str = None,
        deployment_targets: main_models.UpdateStackInstancesRequestDeploymentTargets = None,
        operation_description: str = None,
        operation_preferences: Dict[str, Any] = None,
        parameter_overrides: List[main_models.UpdateStackInstancesRequestParameterOverrides] = None,
        region_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DeploymentTargets') is not None:
            temp_model = main_models.UpdateStackInstancesRequestDeploymentTargets()
        ...
        if m.get('ParameterOverrides') is not None:
            for k1 in m.get('ParameterOverrides'):
                temp_model = main_models.UpdateStackInstancesRequestParameterOverrides()
...
class UpdateStackInstancesRequestParameterOverrides(DaraModel):
    def __init__(
        self,
...
class UpdateStackInstancesRequestDeploymentTargets(DaraModel):
    def __init__(
        self,
        account_ids: List[str] = None,

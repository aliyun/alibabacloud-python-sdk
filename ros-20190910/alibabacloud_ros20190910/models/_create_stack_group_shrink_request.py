...
class CreateStackGroupShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        parameters: List[main_models.CreateStackGroupShrinkRequestParameters] = None,
        permission_model: str = None,
        region_id: str = None,
        resource_group_id: str = None,
        stack_arn: str = None,
        stack_group_name: str = None,
        tags: List[main_models.CreateStackGroupShrinkRequestTags] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Parameters') is not None:
            for k1 in m.get('Parameters'):
                temp_model = main_models.CreateStackGroupShrinkRequestParameters()
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.CreateStackGroupShrinkRequestTags()
...
class CreateStackGroupShrinkRequestTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class CreateStackGroupShrinkRequestParameters(DaraModel):
    def __init__(
        self,

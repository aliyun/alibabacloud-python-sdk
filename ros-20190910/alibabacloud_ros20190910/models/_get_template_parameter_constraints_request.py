...
class GetTemplateParameterConstraintsRequest(DaraModel):
    def __init__(
        ...
        parameters: List[main_models.GetTemplateParameterConstraintsRequestParameters] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Parameters') is not None:
            for k1 in m.get('Parameters'):
                temp_model = main_models.GetTemplateParameterConstraintsRequestParameters()
...
class GetTemplateParameterConstraintsRequestParameters(DaraModel):
    def __init__(
        self,

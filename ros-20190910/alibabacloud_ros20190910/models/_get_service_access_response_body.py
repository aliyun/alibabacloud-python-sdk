...
class GetServiceAccessResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        service_access_info: main_models.GetServiceAccessResponseBodyServiceAccessInfo = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ServiceAccessInfo') is not None:
            temp_model = main_models.GetServiceAccessResponseBodyServiceAccessInfo()
            self.service_access_info = temp_model.from_map(m.get('ServiceAccessInfo'))

        return self

class GetServiceAccessResponseBodyServiceAccessInfo(DaraModel):
    def __init__(
        self,
        status: str = None,
    ):

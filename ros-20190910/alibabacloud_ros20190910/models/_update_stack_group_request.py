...
class UpdateStackGroupRequest(DaraModel):
    def __init__(
        self,
        account_ids: List[str] = None,
        administration_role_name: str = None,
        auto_deployment: main_models.UpdateStackGroupRequestAutoDeployment = None,
        capabilities: List[str] = None,
        client_token: str = None,
        deployment_options: List[str] = None,
        deployment_targets: main_models.UpdateStackGroupRequestDeploymentTargets = None,
        description: str = None,
        execution_role_name: str = None,
        operation_description: str = None,
        operation_preferences: Dict[str, Any] = None,
        parameters: List[main_models.UpdateStackGroupRequestParameters] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AutoDeployment') is not None:
            temp_model = main_models.UpdateStackGroupRequestAutoDeployment()
        ...
        if m.get('DeploymentTargets') is not None:
            temp_model = main_models.UpdateStackGroupRequestDeploymentTargets()
        ...
        if m.get('Parameters') is not None:
            for k1 in m.get('Parameters'):
                temp_model = main_models.UpdateStackGroupRequestParameters()
...
class UpdateStackGroupRequestParameters(DaraModel):
    def __init__(
        self,
...
class UpdateStackGroupRequestDeploymentTargets(DaraModel):
    def __init__(
        self,
        account_ids: List[str] = None,
...
class UpdateStackGroupRequestAutoDeployment(DaraModel):
    def __init__(
        self,
        enabled: bool = None,

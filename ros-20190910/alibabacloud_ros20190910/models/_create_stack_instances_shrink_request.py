...
class CreateStackInstancesShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        parameter_overrides: List[main_models.CreateStackInstancesShrinkRequestParameterOverrides] = None,
        region_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ParameterOverrides') is not None:
            for k1 in m.get('ParameterOverrides'):
                temp_model = main_models.CreateStackInstancesShrinkRequestParameterOverrides()
...
class CreateStackInstancesShrinkRequestParameterOverrides(DaraModel):
    def __init__(
        self,

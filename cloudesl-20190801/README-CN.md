...
## Alibaba Cloud cloudesl SDK for Python
...
```bash
# 安装 alibabacloud_cloudesl20190801
pip install alibabacloud_cloudesl20190801
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/cloudesl-20190801/ChangeLog.md)中。

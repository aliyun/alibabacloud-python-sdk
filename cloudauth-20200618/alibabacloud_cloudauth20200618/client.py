...
class Client(OpenApiClient):
    ...
    *\
    ...
    def verify_bank_element_with_options(
        ...
        return TeaCore.from_map(
            cloudauth_20200618_models.VerifyBankElementResponse(),
            self.do_rpcrequest('VerifyBankElement', '2020-06-18', 'HTTPS', 'POST', 'AK', 'json', req, runtime)
        )
    ...
    async def verify_bank_element_with_options_async(
        ...
        return TeaCore.from_map(
            cloudauth_20200618_models.VerifyBankElementResponse(),
            await self.do_rpcrequest_async('VerifyBankElement', '2020-06-18', 'HTTPS', 'POST', 'AK', 'json', req, runtime)
        )

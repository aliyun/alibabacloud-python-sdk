...
class CreateVirtualClusterResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.CreateVirtualClusterResponseBodyData = None,
        request_id: str = None,
    ):
        self.data = data
        # Id of the request
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CreateVirtualClusterResponseBodyData()
...
class CreateVirtualClusterResponseBodyData(DaraModel):
    def __init__(
        self,

...
class GetCreateBEClusterInquiryResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetCreateBEClusterInquiryResponseBodyData()
...
class GetCreateBEClusterInquiryResponseBodyData(DaraModel):
    def __init__(
        self,
        currency: str = None,
        optional_promotions: List[main_models.GetCreateBEClusterInquiryResponseBodyDataOptionalPromotions] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OptionalPromotions') is not None:
            for k1 in m.get('OptionalPromotions'):
                temp_model = main_models.GetCreateBEClusterInquiryResponseBodyDataOptionalPromotions()
...
class GetCreateBEClusterInquiryResponseBodyDataOptionalPromotions(DaraModel):
    def __init__(
        self,

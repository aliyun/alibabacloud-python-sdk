...
## Alibaba Cloud appflow SDK for Python
...
```bash
# 安装 alibabacloud_appflow20230904
pip install alibabacloud_appflow20230904
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/appflow-20230904/ChangeLog.md)中。

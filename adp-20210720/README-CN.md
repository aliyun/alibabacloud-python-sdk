...
## Alibaba Cloud adp SDK for Python
...
```bash
# 安装 alibabacloud_adp20210720
pip install alibabacloud_adp20210720
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/adp-20210720/ChangeLog.md)中。

...
## Alibaba Cloud Slb SDK for Python
...
```bash
# 安装 alibabacloud_slb20130221
pip install alibabacloud_slb20130221
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/slb-20130221/ChangeLog.md)中。

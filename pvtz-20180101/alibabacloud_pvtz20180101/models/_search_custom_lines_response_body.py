...
class SearchCustomLinesResponseBody(DaraModel):
    def __init__(
        self,
        custom_lines: main_models.SearchCustomLinesResponseBodyCustomLines = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CustomLines') is not None:
            temp_model = main_models.SearchCustomLinesResponseBodyCustomLines()
...
class SearchCustomLinesResponseBodyCustomLines(DaraModel):
    def __init__(
        self,
        custom_line: List[main_models.SearchCustomLinesResponseBodyCustomLinesCustomLine] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CustomLine') is not None:
            for k1 in m.get('CustomLine'):
                temp_model = main_models.SearchCustomLinesResponseBodyCustomLinesCustomLine()
                self.custom_line.append(temp_model.from_map(k1))

        return self

class SearchCustomLinesResponseBodyCustomLinesCustomLine(DaraModel):
    def __init__(
        self,
        ...
        ipv_4s: main_models.SearchCustomLinesResponseBodyCustomLinesCustomLineIpv4s = None,
        line_id: str = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Ipv4s') is not None:
            temp_model = main_models.SearchCustomLinesResponseBodyCustomLinesCustomLineIpv4s()
...
class SearchCustomLinesResponseBodyCustomLinesCustomLineIpv4s(DaraModel):
    def __init__(
        self,
        ipv_4: List[str] = None,
    ):

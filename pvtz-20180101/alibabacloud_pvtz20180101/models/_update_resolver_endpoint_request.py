...
class UpdateResolverEndpointRequest(DaraModel):
    def __init__(
        self,
        endpoint_id: str = None,
        ip_config: List[main_models.UpdateResolverEndpointRequestIpConfig] = None,
        lang: str = None,
        name: str = None,
    ):
        # The endpoint ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IpConfig') is not None:
            for k1 in m.get('IpConfig'):
                temp_model = main_models.UpdateResolverEndpointRequestIpConfig()
...
class UpdateResolverEndpointRequestIpConfig(DaraModel):
    def __init__(
        self,
        az_id: str = None,
        cidr_block: str = None,

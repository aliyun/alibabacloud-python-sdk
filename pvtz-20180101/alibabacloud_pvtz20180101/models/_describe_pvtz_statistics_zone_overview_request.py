...
class DescribePvtzStatisticsZoneOverviewRequest(DaraModel):
    def __init__(
        self,
        accept_language: str = None,
        client_token: str = None,
        module: str = None,
        network_params: List[main_models.DescribePvtzStatisticsZoneOverviewRequestNetworkParams] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NetworkParams') is not None:
            for k1 in m.get('NetworkParams'):
                temp_model = main_models.DescribePvtzStatisticsZoneOverviewRequestNetworkParams()
...
class DescribePvtzStatisticsZoneOverviewRequestNetworkParams(DaraModel):
    def __init__(
        self,
        region_id: str = None,
        vpc_id: str = None,

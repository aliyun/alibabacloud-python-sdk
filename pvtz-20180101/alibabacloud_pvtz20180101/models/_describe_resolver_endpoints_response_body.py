...
class DescribeResolverEndpointsResponseBody(DaraModel):
    def __init__(
        self,
        endpoints: List[main_models.DescribeResolverEndpointsResponseBodyEndpoints] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Endpoints') is not None:
            for k1 in m.get('Endpoints'):
                temp_model = main_models.DescribeResolverEndpointsResponseBodyEndpoints()
...
class DescribeResolverEndpointsResponseBodyEndpoints(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        create_timestamp: int = None,
        id: str = None,
        ip_configs: List[main_models.DescribeResolverEndpointsResponseBodyEndpointsIpConfigs] = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IpConfigs') is not None:
            for k1 in m.get('IpConfigs'):
                temp_model = main_models.DescribeResolverEndpointsResponseBodyEndpointsIpConfigs()
...
class DescribeResolverEndpointsResponseBodyEndpointsIpConfigs(DaraModel):
    def __init__(
        self,
        az_id: str = None,
        cidr_block: str = None,

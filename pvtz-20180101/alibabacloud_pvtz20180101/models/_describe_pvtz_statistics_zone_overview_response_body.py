...
class DescribePvtzStatisticsZoneOverviewResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.DescribePvtzStatisticsZoneOverviewResponseBodyData = None,
        request_id: str = None,
    ):
        self.data = data
        # Id of the request
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DescribePvtzStatisticsZoneOverviewResponseBodyData()
...
class DescribePvtzStatisticsZoneOverviewResponseBodyData(DaraModel):
    def __init__(
        self,

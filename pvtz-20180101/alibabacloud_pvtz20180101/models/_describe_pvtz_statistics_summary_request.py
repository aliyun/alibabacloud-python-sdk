...
class DescribePvtzStatisticsSummaryRequest(DaraModel):
    def __init__(
        self,
        direction: str = None,
        ...
        grow_type: str = None,
        module: str = None,
        network_params: List[main_models.DescribePvtzStatisticsSummaryRequestNetworkParams] = None,
        order_by: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NetworkParams') is not None:
            for k1 in m.get('NetworkParams'):
                temp_model = main_models.DescribePvtzStatisticsSummaryRequestNetworkParams()
...
class DescribePvtzStatisticsSummaryRequestNetworkParams(DaraModel):
    def __init__(
        self,
        region_id: str = None,
        vpc_id: str = None,

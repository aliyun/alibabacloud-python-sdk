...
## Alibaba Cloud captcha SDK for Python
...
```bash
# 安装 alibabacloud_captcha20230305
pip install alibabacloud_captcha20230305
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/captcha-20230305/ChangeLog.md)中。

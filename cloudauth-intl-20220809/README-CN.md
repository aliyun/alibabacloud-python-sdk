...
```bash
# 安装 alibabacloud_cloudauth_intl20220809
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/cloudauth-intl-20220809/ChangeLog.md)中。

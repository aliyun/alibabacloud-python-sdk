...
```bash
# 安装 alibabacloud_dataphin_public20230630
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/dataphin-public-20230630/ChangeLog.md)中。

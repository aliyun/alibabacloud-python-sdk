...
class GetAssetMappingRelationsResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        http_status_code: int = None,
        mapping_relation_list: List[main_models.GetAssetMappingRelationsResponseBodyMappingRelationList] = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MappingRelationList') is not None:
            for k1 in m.get('MappingRelationList'):
                temp_model = main_models.GetAssetMappingRelationsResponseBodyMappingRelationList()
...
class GetAssetMappingRelationsResponseBodyMappingRelationList(DaraModel):
    def __init__(
        self,
        asset_type: str = None,
        guid: str = None,

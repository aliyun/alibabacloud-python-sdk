...
class GetPhysicalInstanceResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        http_status_code: int = None,
        instance: main_models.GetPhysicalInstanceResponseBodyInstance = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Instance') is not None:
            temp_model = main_models.GetPhysicalInstanceResponseBodyInstance()
...
class GetPhysicalInstanceResponseBodyInstance(DaraModel):
    def __init__(
        self,
        biz_date: str = None,
        due_time: str = None,
        ...
        id: str = None,
        index: int = None,
        node_info: main_models.GetPhysicalInstanceResponseBodyInstanceNodeInfo = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NodeInfo') is not None:
            temp_model = main_models.GetPhysicalInstanceResponseBodyInstanceNodeInfo()
...
class GetPhysicalInstanceResponseBodyInstanceNodeInfo(DaraModel):
    def __init__(
        self,
        biz_unit_name: str = None,
        create_time: str = None,
        creator: main_models.GetPhysicalInstanceResponseBodyInstanceNodeInfoCreator = None,
        ...
        modifier: main_models.GetPhysicalInstanceResponseBodyInstanceNodeInfoModifier = None,
        name: str = None,
        owner_list: List[main_models.GetPhysicalInstanceResponseBodyInstanceNodeInfoOwnerList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Creator') is not None:
            temp_model = main_models.GetPhysicalInstanceResponseBodyInstanceNodeInfoCreator()
        ...
        if m.get('Modifier') is not None:
            temp_model = main_models.GetPhysicalInstanceResponseBodyInstanceNodeInfoModifier()
        ...
        if m.get('OwnerList') is not None:
            for k1 in m.get('OwnerList'):
                temp_model = main_models.GetPhysicalInstanceResponseBodyInstanceNodeInfoOwnerList()
...
class GetPhysicalInstanceResponseBodyInstanceNodeInfoOwnerList(DaraModel):
    def __init__(
        self,
        id: str = None,
        name: str = None,
...
class GetPhysicalInstanceResponseBodyInstanceNodeInfoModifier(DaraModel):
    def __init__(
        self,
        id: str = None,
        name: str = None,
...
class GetPhysicalInstanceResponseBodyInstanceNodeInfoCreator(DaraModel):
    def __init__(
        self,
        id: str = None,
        name: str = None,

...
class CreatePipelineResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.CreatePipelineResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CreatePipelineResponseBodyData()
...
class CreatePipelineResponseBodyData(DaraModel):
    def __init__(
        self,

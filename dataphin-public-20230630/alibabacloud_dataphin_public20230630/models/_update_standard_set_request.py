...
class UpdateStandardSetRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UpdateCommand') is not None:
            temp_model = main_models.UpdateStandardSetRequestUpdateCommand()
            self.update_command = temp_model.from_map(m.get('UpdateCommand'))

        return self

class UpdateStandardSetRequestUpdateCommand(DaraModel):
    def __init__(
        self,
        approval_config: main_models.UpdateStandardSetRequestUpdateCommandApprovalConfig = None,
        code: str = None,
        default_standard_template_id: int = None,
        description: str = None,
        directory_reference: main_models.UpdateStandardSetRequestUpdateCommandDirectoryReference = None,
        maintainer_list: List[str] = None,
        member_group_list: List[str] = None,
        member_list: List[str] = None,
        name: str = None,
        offline_approval_config: main_models.UpdateStandardSetRequestUpdateCommandOfflineApprovalConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApprovalConfig') is not None:
            temp_model = main_models.UpdateStandardSetRequestUpdateCommandApprovalConfig()
        ...
        if m.get('DirectoryReference') is not None:
            temp_model = main_models.UpdateStandardSetRequestUpdateCommandDirectoryReference()
        ...
        if m.get('OfflineApprovalConfig') is not None:
            temp_model = main_models.UpdateStandardSetRequestUpdateCommandOfflineApprovalConfig()
        ...
        if m.get('VisibilityConfig') is not None:
            temp_model = main_models.UpdateStandardSetRequestUpdateCommandVisibilityConfig()
            self.visibility_config = temp_model.from_map(m.get('VisibilityConfig'))

        return self

class UpdateStandardSetRequestUpdateCommandVisibilityConfig(DaraModel):
    def __init__(
        self,
...
class UpdateStandardSetRequestUpdateCommandOfflineApprovalConfig(DaraModel):
    def __init__(
        self,
...
class UpdateStandardSetRequestUpdateCommandDirectoryReference(DaraModel):
    def __init__(
        self,
        directory: str = None,
    ):
...
class UpdateStandardSetRequestUpdateCommandApprovalConfig(DaraModel):
    def __init__(
        self,
        approval_type: str = None,
        enable_approval: bool = None,

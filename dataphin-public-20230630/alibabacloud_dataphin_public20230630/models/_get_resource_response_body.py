...
class GetResourceResponseBody(DaraModel):
    def __init__(
        ...
        message: str = None,
        request_id: str = None,
        resource_info: main_models.GetResourceResponseBodyResourceInfo = None,
        success: bool = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceInfo') is not None:
            temp_model = main_models.GetResourceResponseBodyResourceInfo()
...
class GetResourceResponseBodyResourceInfo(DaraModel):
    def __init__(
        self,

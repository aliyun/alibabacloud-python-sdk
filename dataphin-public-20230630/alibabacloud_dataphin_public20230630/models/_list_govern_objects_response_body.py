...
class ListGovernObjectsResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        http_status_code: int = None,
        message: str = None,
        page_result: main_models.ListGovernObjectsResponseBodyPageResult = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PageResult') is not None:
            temp_model = main_models.ListGovernObjectsResponseBodyPageResult()
...
class ListGovernObjectsResponseBodyPageResult(DaraModel):
    def __init__(
        self,
        data: List[main_models.ListGovernObjectsResponseBodyPageResultData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListGovernObjectsResponseBodyPageResultData()
...
class ListGovernObjectsResponseBodyPageResultData(DaraModel):
    def __init__(
        self,
        ...
        owners: List[main_models.ListGovernObjectsResponseBodyPageResultDataOwners] = None,
        problem: main_models.ListGovernObjectsResponseBodyPageResultDataProblem = None,
        properties: Dict[str, Any] = None,
        rectify_id: int = None,
        rectify_name: str = None,
        rectify_status: str = None,
        related_knowledge: List[main_models.ListGovernObjectsResponseBodyPageResultDataRelatedKnowledge] = None,
        status: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Owners') is not None:
            for k1 in m.get('Owners'):
                temp_model = main_models.ListGovernObjectsResponseBodyPageResultDataOwners()
                self.owners.append(temp_model.from_map(k1))

        if m.get('Problem') is not None:
            temp_model = main_models.ListGovernObjectsResponseBodyPageResultDataProblem()
        ...
        if m.get('RelatedKnowledge') is not None:
            for k1 in m.get('RelatedKnowledge'):
                temp_model = main_models.ListGovernObjectsResponseBodyPageResultDataRelatedKnowledge()
...
class ListGovernObjectsResponseBodyPageResultDataRelatedKnowledge(DaraModel):
    def __init__(
        self,
        cause: str = None,
        desc: str = None,
...
class ListGovernObjectsResponseBodyPageResultDataProblem(DaraModel):
    def __init__(
        self,
        object_id: str = None,
...
class ListGovernObjectsResponseBodyPageResultDataOwners(DaraModel):
    def __init__(
        self,

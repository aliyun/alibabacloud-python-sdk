...
class ListResourcePermissionOperationLogRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ListQuery') is not None:
            temp_model = main_models.ListResourcePermissionOperationLogRequestListQuery()
...
class ListResourcePermissionOperationLogRequestListQuery(DaraModel):
    def __init__(
        self,
        page: int = None,
        page_size: int = None,

...
class UpdateBatchTaskResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UpdateResult') is not None:
            temp_model = main_models.UpdateBatchTaskResponseBodyUpdateResult()
            self.update_result = temp_model.from_map(m.get('UpdateResult'))

        return self

class UpdateBatchTaskResponseBodyUpdateResult(DaraModel):
    def __init__(
        self,
        file_id: int = None,
    ):

...
class ListAddableUsersResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        http_status_code: int = None,
        message: str = None,
        page_result: main_models.ListAddableUsersResponseBodyPageResult = None,
        request_id: str = None,
        success: bool = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PageResult') is not None:
            temp_model = main_models.ListAddableUsersResponseBodyPageResult()
...
class ListAddableUsersResponseBodyPageResult(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserList') is not None:
            for k1 in m.get('UserList'):
                temp_model = main_models.ListAddableUsersResponseBodyPageResultUserList()
                self.user_list.append(temp_model.from_map(k1))

        return self

class ListAddableUsersResponseBodyPageResultUserList(DaraModel):
    def __init__(
        self,

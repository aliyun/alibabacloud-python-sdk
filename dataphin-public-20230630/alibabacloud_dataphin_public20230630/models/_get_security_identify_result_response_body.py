...
class GetSecurityIdentifyResultResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        ...
        message: str = None,
        request_id: str = None,
        security_identify_result_info: main_models.GetSecurityIdentifyResultResponseBodySecurityIdentifyResultInfo = None,
        success: bool = None,
    ):
        self.code = code
        ...
        self.security_identify_result_info = security_identify_result_info
        self.success = success

    def validate(self):
        if self.security_identify_result_info:
            self.security_identify_result_info.validate()
    ...
    def to_map(self):
        ...
        if self.security_identify_result_info is not None:
            result['SecurityIdentifyResultInfo'] = self.security_identify_result_info.to_map()
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SecurityIdentifyResultInfo') is not None:
            temp_model = main_models.GetSecurityIdentifyResultResponseBodySecurityIdentifyResultInfo()
            self.security_identify_result_info = temp_model.from_map(m.get('SecurityIdentifyResultInfo'))
...
class GetSecurityIdentifyResultResponseBodySecurityIdentifyResultInfo(DaraModel):
    def __init__(
        self,
        biz_date: str = None,

...
class GetDataServiceAuthorizedAppsByGroupIdResponseBody(DaraModel):
    def __init__(
        self,
        app_info_list: List[main_models.GetDataServiceAuthorizedAppsByGroupIdResponseBodyAppInfoList] = None,
        code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AppInfoList') is not None:
            for k1 in m.get('AppInfoList'):
                temp_model = main_models.GetDataServiceAuthorizedAppsByGroupIdResponseBodyAppInfoList()
...
class GetDataServiceAuthorizedAppsByGroupIdResponseBodyAppInfoList(DaraModel):
    def __init__(
        self,
        app_key: int = None,

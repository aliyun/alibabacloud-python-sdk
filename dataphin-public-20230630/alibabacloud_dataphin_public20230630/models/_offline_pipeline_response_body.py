...
class OfflinePipelineResponseBody(DaraModel):
    def __init__(
        ...
        self.code = code
        # The result of offlining the pipeline node.
        self.data = data
...
class OfflinePipelineResponseBodyData(DaraModel):
    def __init__(
        ...
        # The scheduling node ID of the pipeline node after successful creation.
        self.node_id = node_id
        # The pipeline ID after successful creation.
        ...
        # The version number generated after submission.

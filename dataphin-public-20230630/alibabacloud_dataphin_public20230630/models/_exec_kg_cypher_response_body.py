...
class ExecKgCypherResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ExecKgCypherResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ExecKgCypherResponseBodyData()
...
class ExecKgCypherResponseBodyData(DaraModel):
    def __init__(
        self,
        edge_list: List[main_models.ExecKgCypherResponseBodyDataEdgeList] = None,
        execute_cypher: str = None,
        node_list: List[main_models.ExecKgCypherResponseBodyDataNodeList] = None,
        row_list: List[main_models.ExecKgCypherResponseBodyDataRowList] = None,
    ):
        # The list of edges.
        self.edge_list = edge_list
        # The transformed execution statement.
        self.execute_cypher = execute_cypher
        # The list of nodes.
    ...
    def to_map(self):
        ...
        if self.execute_cypher is not None:
            result['ExecuteCypher'] = self.execute_cypher
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EdgeList') is not None:
            for k1 in m.get('EdgeList'):
                temp_model = main_models.ExecKgCypherResponseBodyDataEdgeList()
                self.edge_list.append(temp_model.from_map(k1))

        if m.get('ExecuteCypher') is not None:
            self.execute_cypher = m.get('ExecuteCypher')

        self.node_list = []
        if m.get('NodeList') is not None:
            for k1 in m.get('NodeList'):
                temp_model = main_models.ExecKgCypherResponseBodyDataNodeList()
                self.node_list.append(temp_model.from_map(k1))

        self.row_list = []
        if m.get('RowList') is not None:
            for k1 in m.get('RowList'):
                temp_model = main_models.ExecKgCypherResponseBodyDataRowList()
                self.row_list.append(temp_model.from_map(k1))

        return self

class ExecKgCypherResponseBodyDataRowList(DaraModel):
    def __init__(
        self,
        columns: List[main_models.ExecKgCypherResponseBodyDataRowListColumns] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Columns') is not None:
            for k1 in m.get('Columns'):
                temp_model = main_models.ExecKgCypherResponseBodyDataRowListColumns()
                self.columns.append(temp_model.from_map(k1))

        return self

class ExecKgCypherResponseBodyDataRowListColumns(DaraModel):
    def __init__(
        self,
        code: str = None,
        value: str = None,
...
class ExecKgCypherResponseBodyDataNodeList(DaraModel):
    def __init__(
        self,
        data_id: str = None,
        entity_type: str = None,
        properties: List[main_models.ExecKgCypherResponseBodyDataNodeListProperties] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Properties') is not None:
            for k1 in m.get('Properties'):
                temp_model = main_models.ExecKgCypherResponseBodyDataNodeListProperties()
                self.properties.append(temp_model.from_map(k1))

        return self

class ExecKgCypherResponseBodyDataNodeListProperties(DaraModel):
    def __init__(
        self,
        code: str = None,
        value: str = None,
...
class ExecKgCypherResponseBodyDataEdgeList(DaraModel):
    def __init__(
        self,
        data_id: str = None,
        properties: List[main_models.ExecKgCypherResponseBodyDataEdgeListProperties] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Properties') is not None:
            for k1 in m.get('Properties'):
                temp_model = main_models.ExecKgCypherResponseBodyDataEdgeListProperties()
                self.properties.append(temp_model.from_map(k1))
...
class ExecKgCypherResponseBodyDataEdgeListProperties(DaraModel):
    def __init__(
        self,
        code: str = None,
        value: str = None,

...
class DeleteQualityWatchesRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DeleteCommand') is not None:
            temp_model = main_models.DeleteQualityWatchesRequestDeleteCommand()
...
class DeleteQualityWatchesRequestDeleteCommand(DaraModel):
    def __init__(
        self,

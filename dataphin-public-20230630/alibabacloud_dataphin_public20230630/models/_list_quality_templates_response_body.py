...
class ListQualityTemplatesResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        http_status_code: int = None,
        message: str = None,
        page_result: main_models.ListQualityTemplatesResponseBodyPageResult = None,
        request_id: str = None,
        success: bool = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PageResult') is not None:
            temp_model = main_models.ListQualityTemplatesResponseBodyPageResult()
...
class ListQualityTemplatesResponseBodyPageResult(DaraModel):
    def __init__(
        self,
    ...
    def validate(self):
        if self.quality_template_list:
            for v1 in self.quality_template_list:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        result['QualityTemplateList'] = []
        if self.quality_template_list is not None:
            for k1 in self.quality_template_list:
                result['QualityTemplateList'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        self.quality_template_list = []
        if m.get('QualityTemplateList') is not None:
            for k1 in m.get('QualityTemplateList'):
                temp_model = main_models.ListQualityTemplatesResponseBodyPageResultQualityTemplateList()
                self.quality_template_list.append(temp_model.from_map(k1))
...
class ListQualityTemplatesResponseBodyPageResultQualityTemplateList(DaraModel):
    def __init__(
        self,
        catalog: str = None,
        ...
        form_property_list: List[main_models.ListQualityTemplatesResponseBodyPageResultQualityTemplateListFormPropertyList] = None,
        id: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FormPropertyList') is not None:
            for k1 in m.get('FormPropertyList'):
                temp_model = main_models.ListQualityTemplatesResponseBodyPageResultQualityTemplateListFormPropertyList()
...
class ListQualityTemplatesResponseBodyPageResultQualityTemplateListFormPropertyList(DaraModel):
    def __init__(
        self,

...
class CreateBizUnitResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        create_result: main_models.CreateBizUnitResponseBodyCreateResult = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CreateResult') is not None:
            temp_model = main_models.CreateBizUnitResponseBodyCreateResult()
...
class CreateBizUnitResponseBodyCreateResult(DaraModel):
    def __init__(
        self,

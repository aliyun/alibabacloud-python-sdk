...
class GetDataServiceProjectAddableUsersResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserList') is not None:
            for k1 in m.get('UserList'):
                temp_model = main_models.GetDataServiceProjectAddableUsersResponseBodyUserList()
                self.user_list.append(temp_model.from_map(k1))

        return self

class GetDataServiceProjectAddableUsersResponseBodyUserList(DaraModel):
    def __init__(
        self,

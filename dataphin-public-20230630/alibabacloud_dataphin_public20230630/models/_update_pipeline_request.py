...
class UpdatePipelineRequest(DaraModel):
    def __init__(
        self,
        context: main_models.UpdatePipelineRequestContext = None,
        op_tenant_id: int = None,
        update_command: main_models.UpdatePipelineRequestUpdateCommand = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Context') is not None:
            temp_model = main_models.UpdatePipelineRequestContext()
        ...
        if m.get('UpdateCommand') is not None:
            temp_model = main_models.UpdatePipelineRequestUpdateCommand()
            self.update_command = temp_model.from_map(m.get('UpdateCommand'))

        return self

class UpdatePipelineRequestUpdateCommand(DaraModel):
    def __init__(
        self,
        comment: str = None,
        mode: str = None,
        node_info: main_models.UpdatePipelineRequestUpdateCommandNodeInfo = None,
        pipeline_config: main_models.UpdatePipelineRequestUpdateCommandPipelineConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NodeInfo') is not None:
            temp_model = main_models.UpdatePipelineRequestUpdateCommandNodeInfo()
            self.node_info = temp_model.from_map(m.get('NodeInfo'))

        if m.get('PipelineConfig') is not None:
            temp_model = main_models.UpdatePipelineRequestUpdateCommandPipelineConfig()
...
class UpdatePipelineRequestUpdateCommandPipelineConfig(DaraModel):
    def __init__(
        self,
        hops: List[main_models.UpdatePipelineRequestUpdateCommandPipelineConfigHops] = None,
        steps: List[main_models.UpdatePipelineRequestUpdateCommandPipelineConfigSteps] = None,
    ):
        # This parameter is required.
        self.hops = hops
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Hops') is not None:
            for k1 in m.get('Hops'):
                temp_model = main_models.UpdatePipelineRequestUpdateCommandPipelineConfigHops()
                self.hops.append(temp_model.from_map(k1))

        self.steps = []
        if m.get('Steps') is not None:
            for k1 in m.get('Steps'):
                temp_model = main_models.UpdatePipelineRequestUpdateCommandPipelineConfigSteps()
                self.steps.append(temp_model.from_map(k1))

        return self

class UpdatePipelineRequestUpdateCommandPipelineConfigSteps(DaraModel):
    def __init__(
        self,
...
class UpdatePipelineRequestUpdateCommandPipelineConfigHops(DaraModel):
    def __init__(
        self,
        send_to: bool = None,
        source: str = None,
...
class UpdatePipelineRequestUpdateCommandNodeInfo(DaraModel):
    def __init__(
        self,
        directory: str = None,
        file_id: int = None,
...
class UpdatePipelineRequestContext(DaraModel):
    def __init__(
        self,
        env: str = None,
        project_id: int = None,

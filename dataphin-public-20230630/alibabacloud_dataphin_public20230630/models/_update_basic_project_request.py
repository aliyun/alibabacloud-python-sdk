...
class UpdateBasicProjectRequest(DaraModel):
    def __init__(
        self,
        op_tenant_id: int = None,
        op_user_id: str = None,
        update_command: main_models.UpdateBasicProjectRequestUpdateCommand = None,
    ):
        # The tenant ID.
        # 
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UpdateCommand') is not None:
            temp_model = main_models.UpdateBasicProjectRequestUpdateCommand()
            self.update_command = temp_model.from_map(m.get('UpdateCommand'))

        return self

class UpdateBasicProjectRequestUpdateCommand(DaraModel):
    def __init__(
        self,
        ...
        white_lists: List[main_models.UpdateBasicProjectRequestUpdateCommandWhiteLists] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('WhiteLists') is not None:
            for k1 in m.get('WhiteLists'):
                temp_model = main_models.UpdateBasicProjectRequestUpdateCommandWhiteLists()
                self.white_lists.append(temp_model.from_map(k1))

        return self

class UpdateBasicProjectRequestUpdateCommandWhiteLists(DaraModel):
    def __init__(
        self,
        description: str = None,
        ip: str = None,

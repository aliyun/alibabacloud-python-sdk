...
class UpdateDataServiceAppGroupRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UpdateCommand') is not None:
            temp_model = main_models.UpdateDataServiceAppGroupRequestUpdateCommand()
            self.update_command = temp_model.from_map(m.get('UpdateCommand'))

        return self

class UpdateDataServiceAppGroupRequestUpdateCommand(DaraModel):
    def __init__(
        self,
        group_id: int = None,
        group_name: str = None,

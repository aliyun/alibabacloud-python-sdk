...
class SubmitAssetsOnShelveResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.SubmitAssetsOnShelveResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.SubmitAssetsOnShelveResponseBodyData()
...
class SubmitAssetsOnShelveResponseBodyData(DaraModel):
    def __init__(
        self,
        fail_count: int = None,
        result_list: List[main_models.SubmitAssetsOnShelveResponseBodyDataResultList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResultList') is not None:
            for k1 in m.get('ResultList'):
                temp_model = main_models.SubmitAssetsOnShelveResponseBodyDataResultList()
...
class SubmitAssetsOnShelveResponseBodyDataResultList(DaraModel):
    def __init__(
        self,
        error_code: str = None,

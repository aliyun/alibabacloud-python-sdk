...
class UpdatePipelineResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.UpdatePipelineResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.UpdatePipelineResponseBodyData()
...
class UpdatePipelineResponseBodyData(DaraModel):
    def __init__(
        self,

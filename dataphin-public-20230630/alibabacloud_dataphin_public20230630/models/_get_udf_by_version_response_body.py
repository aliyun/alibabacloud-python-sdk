...
class GetUdfByVersionResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UdfInfo') is not None:
            temp_model = main_models.GetUdfByVersionResponseBodyUdfInfo()
            self.udf_info = temp_model.from_map(m.get('UdfInfo'))

        return self

class GetUdfByVersionResponseBodyUdfInfo(DaraModel):
    def __init__(
        self,
        category: int = None,
        class_name: str = None,

...
class UpdateKgEntityRequest(DaraModel):
    def __init__(
        self,
        op_tenant_id: int = None,
        update_command: main_models.UpdateKgEntityRequestUpdateCommand = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UpdateCommand') is not None:
            temp_model = main_models.UpdateKgEntityRequestUpdateCommand()
...
class UpdateKgEntityRequestUpdateCommand(DaraModel):
    def __init__(
        self,
        entity_id: str = None,
        entity_type: str = None,
        property_list: List[main_models.UpdateKgEntityRequestUpdateCommandPropertyList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PropertyList') is not None:
            for k1 in m.get('PropertyList'):
                temp_model = main_models.UpdateKgEntityRequestUpdateCommandPropertyList()
                self.property_list.append(temp_model.from_map(k1))

        return self

class UpdateKgEntityRequestUpdateCommandPropertyList(DaraModel):
    def __init__(
        self,
        code: str = None,
        value: str = None,

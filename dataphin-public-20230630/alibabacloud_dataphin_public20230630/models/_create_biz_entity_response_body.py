...
class CreateBizEntityResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        create_result: main_models.CreateBizEntityResponseBodyCreateResult = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CreateResult') is not None:
            temp_model = main_models.CreateBizEntityResponseBodyCreateResult()
...
class CreateBizEntityResponseBodyCreateResult(DaraModel):
    def __init__(
        self,

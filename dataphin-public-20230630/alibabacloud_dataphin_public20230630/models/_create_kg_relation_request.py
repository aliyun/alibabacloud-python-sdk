...
class CreateKgRelationRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CreateCommand') is not None:
            temp_model = main_models.CreateKgRelationRequestCreateCommand()
...
class CreateKgRelationRequestCreateCommand(DaraModel):
    def __init__(
        self,
        property_list: List[main_models.CreateKgRelationRequestCreateCommandPropertyList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PropertyList') is not None:
            for k1 in m.get('PropertyList'):
                temp_model = main_models.CreateKgRelationRequestCreateCommandPropertyList()
...
class CreateKgRelationRequestCreateCommandPropertyList(DaraModel):
    def __init__(
        self,
        code: str = None,
        value: str = None,

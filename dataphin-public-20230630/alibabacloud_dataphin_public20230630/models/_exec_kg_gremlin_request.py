...
class ExecKgGremlinRequest(DaraModel):
    def __init__(
        self,
        exec_command: main_models.ExecKgGremlinRequestExecCommand = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ExecCommand') is not None:
            temp_model = main_models.ExecKgGremlinRequestExecCommand()
...
class ExecKgGremlinRequestExecCommand(DaraModel):
    def __init__(
        self,
        limit: int = None,
        params: List[main_models.ExecKgGremlinRequestExecCommandParams] = None,
        query: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Params') is not None:
            for k1 in m.get('Params'):
                temp_model = main_models.ExecKgGremlinRequestExecCommandParams()
...
class ExecKgGremlinRequestExecCommandParams(DaraModel):
    def __init__(
        self,
        data_type: str = None,
        key: str = None,

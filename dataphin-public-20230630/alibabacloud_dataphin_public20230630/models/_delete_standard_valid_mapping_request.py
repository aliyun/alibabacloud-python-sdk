...
class DeleteStandardValidMappingRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DeleteCommand') is not None:
            temp_model = main_models.DeleteStandardValidMappingRequestDeleteCommand()
...
class DeleteStandardValidMappingRequestDeleteCommand(DaraModel):
    def __init__(
        self,

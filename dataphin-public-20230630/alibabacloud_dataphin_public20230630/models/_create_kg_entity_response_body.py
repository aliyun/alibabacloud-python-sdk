...
class CreateKgEntityResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        create_result: main_models.CreateKgEntityResponseBodyCreateResult = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CreateResult') is not None:
            temp_model = main_models.CreateKgEntityResponseBodyCreateResult()
...
class CreateKgEntityResponseBodyCreateResult(DaraModel):
    def __init__(
        self,
        entity_id: str = None,
    ):

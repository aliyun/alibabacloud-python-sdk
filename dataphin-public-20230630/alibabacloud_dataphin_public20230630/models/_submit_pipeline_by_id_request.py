...
class SubmitPipelineByIdRequest(DaraModel):
    def __init__(
        self,
        context: main_models.SubmitPipelineByIdRequestContext = None,
        op_tenant_id: int = None,
        query_id: main_models.SubmitPipelineByIdRequestQueryId = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Context') is not None:
            temp_model = main_models.SubmitPipelineByIdRequestContext()
        ...
        if m.get('QueryId') is not None:
            temp_model = main_models.SubmitPipelineByIdRequestQueryId()
            self.query_id = temp_model.from_map(m.get('QueryId'))

        return self

class SubmitPipelineByIdRequestQueryId(DaraModel):
    def __init__(
        self,
        file_id: int = None,
        node_id: str = None,
...
class SubmitPipelineByIdRequestContext(DaraModel):
    def __init__(
        self,
        env: str = None,
        project_id: int = None,

...
class ResetDataServiceAppSecretRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UpdateCommand') is not None:
            temp_model = main_models.ResetDataServiceAppSecretRequestUpdateCommand()
            self.update_command = temp_model.from_map(m.get('UpdateCommand'))

        return self

class ResetDataServiceAppSecretRequestUpdateCommand(DaraModel):
    def __init__(
        self,
        app_id: int = None,
        app_key: str = None,

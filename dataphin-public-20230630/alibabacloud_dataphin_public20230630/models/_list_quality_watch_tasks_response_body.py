...
class ListQualityWatchTasksResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        http_status_code: int = None,
        message: str = None,
        page_result: main_models.ListQualityWatchTasksResponseBodyPageResult = None,
        request_id: str = None,
        success: bool = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PageResult') is not None:
            temp_model = main_models.ListQualityWatchTasksResponseBodyPageResult()
...
class ListQualityWatchTasksResponseBodyPageResult(DaraModel):
    def __init__(
        self,
        quality_watch_task_list: List[main_models.ListQualityWatchTasksResponseBodyPageResultQualityWatchTaskList] = None,
        total_count: int = None,
    ):
        self.quality_watch_task_list = quality_watch_task_list
        self.total_count = total_count

    def validate(self):
        if self.quality_watch_task_list:
            for v1 in self.quality_watch_task_list:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        result['QualityWatchTaskList'] = []
        if self.quality_watch_task_list is not None:
            for k1 in self.quality_watch_task_list:
                result['QualityWatchTaskList'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        self.quality_watch_task_list = []
        if m.get('QualityWatchTaskList') is not None:
            for k1 in m.get('QualityWatchTaskList'):
                temp_model = main_models.ListQualityWatchTasksResponseBodyPageResultQualityWatchTaskList()
                self.quality_watch_task_list.append(temp_model.from_map(k1))
...
class ListQualityWatchTasksResponseBodyPageResultQualityWatchTaskList(DaraModel):
    def __init__(
        self,
        biz_date: str = None,
        ...
        rule_count_info: main_models.ListQualityWatchTasksResponseBodyPageResultQualityWatchTaskListRuleCountInfo = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RuleCountInfo') is not None:
            temp_model = main_models.ListQualityWatchTasksResponseBodyPageResultQualityWatchTaskListRuleCountInfo()
...
class ListQualityWatchTasksResponseBodyPageResultQualityWatchTaskListRuleCountInfo(DaraModel):
    def __init__(
        self,
        strong_rule_count: main_models.ListQualityWatchTasksResponseBodyPageResultQualityWatchTaskListRuleCountInfoStrongRuleCount = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('StrongRuleCount') is not None:
            temp_model = main_models.ListQualityWatchTasksResponseBodyPageResultQualityWatchTaskListRuleCountInfoStrongRuleCount()
            self.strong_rule_count = temp_model.from_map(m.get('StrongRuleCount'))

        if m.get('ValidateRuleCount') is not None:
            temp_model = main_models.ListQualityWatchTasksResponseBodyPageResultQualityWatchTaskListRuleCountInfoValidateRuleCount()
            self.validate_rule_count = temp_model.from_map(m.get('ValidateRuleCount'))

        if m.get('WeakRuleCount') is not None:
            temp_model = main_models.ListQualityWatchTasksResponseBodyPageResultQualityWatchTaskListRuleCountInfoWeakRuleCount()
            self.weak_rule_count = temp_model.from_map(m.get('WeakRuleCount'))

        return self

class ListQualityWatchTasksResponseBodyPageResultQualityWatchTaskListRuleCountInfoWeakRuleCount(DaraModel):
    def __init__(
        self,
...
class ListQualityWatchTasksResponseBodyPageResultQualityWatchTaskListRuleCountInfoValidateRuleCount(DaraModel):
    def __init__(
        self,
        error_rule_count: int = None,
        finished_rule_count: int = None,
...
class ListQualityWatchTasksResponseBodyPageResultQualityWatchTaskListRuleCountInfoStrongRuleCount(DaraModel):
    def __init__(
        self,
        error_rule_count: int = None,
        finished_rule_count: int = None,

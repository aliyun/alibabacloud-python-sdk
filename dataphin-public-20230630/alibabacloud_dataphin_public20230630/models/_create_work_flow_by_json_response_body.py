...
class CreateWorkFlowByJsonResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.CreateWorkFlowByJsonResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CreateWorkFlowByJsonResponseBodyData()
...
class CreateWorkFlowByJsonResponseBodyData(DaraModel):
    def __init__(
        self,

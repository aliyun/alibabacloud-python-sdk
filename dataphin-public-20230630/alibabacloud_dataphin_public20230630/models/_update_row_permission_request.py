...
class UpdateRowPermissionRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UpdateRowPermissionCommand') is not None:
            temp_model = main_models.UpdateRowPermissionRequestUpdateRowPermissionCommand()
            self.update_row_permission_command = temp_model.from_map(m.get('UpdateRowPermissionCommand'))

        return self

class UpdateRowPermissionRequestUpdateRowPermissionCommand(DaraModel):
    def __init__(
        self,
        mapping_columns: List[main_models.UpdateRowPermissionRequestUpdateRowPermissionCommandMappingColumns] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MappingColumns') is not None:
            for k1 in m.get('MappingColumns'):
                temp_model = main_models.UpdateRowPermissionRequestUpdateRowPermissionCommandMappingColumns()
        ...
        if m.get('Rules') is not None:
            for k1 in m.get('Rules'):
                temp_model = main_models.UpdateRowPermissionRequestUpdateRowPermissionCommandRules()
                self.rules.append(temp_model.from_map(k1))

        self.tables = []
        if m.get('Tables') is not None:
            for k1 in m.get('Tables'):
                temp_model = main_models.UpdateRowPermissionRequestUpdateRowPermissionCommandTables()
                self.tables.append(temp_model.from_map(k1))

        return self

class UpdateRowPermissionRequestUpdateRowPermissionCommandTables(DaraModel):
    def __init__(
        self,
...
class UpdateRowPermissionRequestUpdateRowPermissionCommandRules(DaraModel):
    def __init__(
        self,
        expressions: List[main_models.UpdateRowPermissionRequestUpdateRowPermissionCommandRulesExpressions] = None,
        is_delete: bool = None,
        rule_name: str = None,
        scope_type: str = None,
        status: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Expressions') is not None:
            for k1 in m.get('Expressions'):
                temp_model = main_models.UpdateRowPermissionRequestUpdateRowPermissionCommandRulesExpressions()
        ...
        if m.get('UserMappingList') is not None:
            for k1 in m.get('UserMappingList'):
                temp_model = main_models.UpdateRowPermissionRequestUpdateRowPermissionCommandRulesUserMappingList()
                self.user_mapping_list.append(temp_model.from_map(k1))

        return self

class UpdateRowPermissionRequestUpdateRowPermissionCommandRulesUserMappingList(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Accounts') is not None:
            for k1 in m.get('Accounts'):
                temp_model = main_models.UpdateRowPermissionRequestUpdateRowPermissionCommandRulesUserMappingListAccounts()
                self.accounts.append(temp_model.from_map(k1))

        return self

class UpdateRowPermissionRequestUpdateRowPermissionCommandRulesUserMappingListAccounts(DaraModel):
    def __init__(
        self,
        account_id: str = None,
    ):
...
class UpdateRowPermissionRequestUpdateRowPermissionCommandRulesExpressions(DaraModel):
    def __init__(
        self,
        mapping_column_name: str = None,
        operator: str = None,
...
class UpdateRowPermissionRequestUpdateRowPermissionCommandMappingColumns(DaraModel):
    def __init__(
        self,

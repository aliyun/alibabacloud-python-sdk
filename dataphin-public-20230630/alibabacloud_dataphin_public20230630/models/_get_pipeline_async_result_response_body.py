...
class GetPipelineAsyncResultResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetPipelineAsyncResultResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetPipelineAsyncResultResponseBodyData()
...
class GetPipelineAsyncResultResponseBodyData(DaraModel):
    def __init__(
        self,
        async_id: int = None,
        error_code: str = None,

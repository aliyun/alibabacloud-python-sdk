...
class UpsertQualityArchiveTableResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.UpsertQualityArchiveTableResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.UpsertQualityArchiveTableResponseBodyData()
...
class UpsertQualityArchiveTableResponseBodyData(DaraModel):
    def __init__(
        self,

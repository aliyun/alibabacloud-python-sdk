...
class AddProjectMemberRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AddCommand') is not None:
            temp_model = main_models.AddProjectMemberRequestAddCommand()
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserList') is not None:
            for k1 in m.get('UserList'):
                temp_model = main_models.AddProjectMemberRequestAddCommandUserList()
                self.user_list.append(temp_model.from_map(k1))

        return self

class AddProjectMemberRequestAddCommandUserList(DaraModel):
    def __init__(
        self,

...
class UpdateDataSourceBasicInfoRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UpdateCommand') is not None:
            temp_model = main_models.UpdateDataSourceBasicInfoRequestUpdateCommand()
            self.update_command = temp_model.from_map(m.get('UpdateCommand'))

        return self

class UpdateDataSourceBasicInfoRequestUpdateCommand(DaraModel):
    def __init__(
        self,

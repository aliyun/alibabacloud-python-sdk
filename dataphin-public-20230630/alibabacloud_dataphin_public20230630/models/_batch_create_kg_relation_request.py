...
class BatchCreateKgRelationRequest(DaraModel):
    def __init__(
        self,
        create_command: main_models.BatchCreateKgRelationRequestCreateCommand = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CreateCommand') is not None:
            temp_model = main_models.BatchCreateKgRelationRequestCreateCommand()
...
class BatchCreateKgRelationRequestCreateCommand(DaraModel):
    def __init__(
        self,
        relation_list: List[main_models.BatchCreateKgRelationRequestCreateCommandRelationList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RelationList') is not None:
            for k1 in m.get('RelationList'):
                temp_model = main_models.BatchCreateKgRelationRequestCreateCommandRelationList()
                self.relation_list.append(temp_model.from_map(k1))

        return self

class BatchCreateKgRelationRequestCreateCommandRelationList(DaraModel):
    def __init__(
        self,
        property_list: List[main_models.BatchCreateKgRelationRequestCreateCommandRelationListPropertyList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PropertyList') is not None:
            for k1 in m.get('PropertyList'):
                temp_model = main_models.BatchCreateKgRelationRequestCreateCommandRelationListPropertyList()
...
class BatchCreateKgRelationRequestCreateCommandRelationListPropertyList(DaraModel):
    def __init__(
        self,
        code: str = None,
        value: str = None,

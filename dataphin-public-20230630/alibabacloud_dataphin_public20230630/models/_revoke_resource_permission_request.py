...
class RevokeResourcePermissionRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RevokeCommand') is not None:
            temp_model = main_models.RevokeResourcePermissionRequestRevokeCommand()
            self.revoke_command = temp_model.from_map(m.get('RevokeCommand'))

        return self

class RevokeResourcePermissionRequestRevokeCommand(DaraModel):
    def __init__(
        self,
        operate_list: List[str] = None,
        reason: str = None,
        resource_list: List[main_models.RevokeResourcePermissionRequestRevokeCommandResourceList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceList') is not None:
            for k1 in m.get('ResourceList'):
                temp_model = main_models.RevokeResourcePermissionRequestRevokeCommandResourceList()
...
class RevokeResourcePermissionRequestRevokeCommandResourceList(DaraModel):
    def __init__(
        self,

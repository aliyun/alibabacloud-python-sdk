...
class CreateDevProdProjectRequest(DaraModel):
    def __init__(
        self,
        create_command: main_models.CreateDevProdProjectRequestCreateCommand = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CreateCommand') is not None:
            temp_model = main_models.CreateDevProdProjectRequestCreateCommand()
...
class CreateDevProdProjectRequestCreateCommand(DaraModel):
    def __init__(
        self,
        ...
        white_lists: List[main_models.CreateDevProdProjectRequestCreateCommandWhiteLists] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('WhiteLists') is not None:
            for k1 in m.get('WhiteLists'):
                temp_model = main_models.CreateDevProdProjectRequestCreateCommandWhiteLists()
                self.white_lists.append(temp_model.from_map(k1))

        return self

class CreateDevProdProjectRequestCreateCommandWhiteLists(DaraModel):
    def __init__(
        self,

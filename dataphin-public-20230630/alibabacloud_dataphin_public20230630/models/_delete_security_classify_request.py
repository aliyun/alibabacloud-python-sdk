...
class DeleteSecurityClassifyRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DeleteCommand') is not None:
            temp_model = main_models.DeleteSecurityClassifyRequestDeleteCommand()
...
class DeleteSecurityClassifyRequestDeleteCommand(DaraModel):
    def __init__(
        self,
        id: int = None,
        name: str = None,

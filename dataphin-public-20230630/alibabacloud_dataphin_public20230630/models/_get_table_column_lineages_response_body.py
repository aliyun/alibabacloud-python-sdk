...
class GetTableColumnLineagesResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
    ...
    def validate(self):
        if self.table_column_lineage_list:
            for v1 in self.table_column_lineage_list:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        result['TableColumnLineageList'] = []
        if self.table_column_lineage_list is not None:
            for k1 in self.table_column_lineage_list:
                result['TableColumnLineageList'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        self.table_column_lineage_list = []
        if m.get('TableColumnLineageList') is not None:
            for k1 in m.get('TableColumnLineageList'):
                temp_model = main_models.GetTableColumnLineagesResponseBodyTableColumnLineageList()
                self.table_column_lineage_list.append(temp_model.from_map(k1))

        return self

class GetTableColumnLineagesResponseBodyTableColumnLineageList(DaraModel):
    def __init__(
        self,
        input_biz_unit_id: int = None,
        input_column_guid: str = None,
    ...
    def to_map(self):
        ...
        if self.input_column_guid is not None:
            result['InputColumnGuid'] = self.input_column_guid
        ...
        if self.output_column_guid is not None:
            result['OutputColumnGuid'] = self.output_column_guid
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InputColumnGuid') is not None:
            self.input_column_guid = m.get('InputColumnGuid')
        ...
        if m.get('OutputColumnGuid') is not None:
            self.output_column_guid = m.get('OutputColumnGuid')

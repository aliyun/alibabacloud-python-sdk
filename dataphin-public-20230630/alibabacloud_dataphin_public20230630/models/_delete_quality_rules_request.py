...
class DeleteQualityRulesRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DeleteCommand') is not None:
            temp_model = main_models.DeleteQualityRulesRequestDeleteCommand()
...
class DeleteQualityRulesRequestDeleteCommand(DaraModel):
    def __init__(
        self,

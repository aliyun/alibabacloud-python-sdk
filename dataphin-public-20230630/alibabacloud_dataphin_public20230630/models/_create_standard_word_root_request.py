...
class CreateStandardWordRootRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CreateCommand') is not None:
            temp_model = main_models.CreateStandardWordRootRequestCreateCommand()
...
class CreateStandardWordRootRequestCreateCommand(DaraModel):
    def __init__(
        self,

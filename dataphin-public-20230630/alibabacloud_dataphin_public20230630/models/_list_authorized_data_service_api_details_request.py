...
class ListAuthorizedDataServiceApiDetailsRequest(DaraModel):
    def __init__(
        self,
        list_query: main_models.ListAuthorizedDataServiceApiDetailsRequestListQuery = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ListQuery') is not None:
            temp_model = main_models.ListAuthorizedDataServiceApiDetailsRequestListQuery()
...
class ListAuthorizedDataServiceApiDetailsRequestListQuery(DaraModel):
    def __init__(
        self,
        app_key: int = None,

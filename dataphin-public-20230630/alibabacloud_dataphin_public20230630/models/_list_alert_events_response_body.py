...
class ListAlertEventsResponseBody(DaraModel):
    def __init__(
        ...
        list_result: main_models.ListAlertEventsResponseBodyListResult = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ListResult') is not None:
            temp_model = main_models.ListAlertEventsResponseBodyListResult()
...
class ListAlertEventsResponseBodyListResult(DaraModel):
    def __init__(
        self,
        data: List[main_models.ListAlertEventsResponseBodyListResultData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListAlertEventsResponseBodyListResultData()
...
class ListAlertEventsResponseBodyListResultData(DaraModel):
    def __init__(
        self,
        alert_frequency: str = None,
        alert_object: main_models.ListAlertEventsResponseBodyListResultDataAlertObject = None,
        alert_reason: main_models.ListAlertEventsResponseBodyListResultDataAlertReason = None,
        alert_receiver_list: List[main_models.ListAlertEventsResponseBodyListResultDataAlertReceiverList] = None,
        belong_project: main_models.ListAlertEventsResponseBodyListResultDataBelongProject = None,
        ...
        url_config: main_models.ListAlertEventsResponseBodyListResultDataUrlConfig = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AlertObject') is not None:
            temp_model = main_models.ListAlertEventsResponseBodyListResultDataAlertObject()
            self.alert_object = temp_model.from_map(m.get('AlertObject'))

        if m.get('AlertReason') is not None:
            temp_model = main_models.ListAlertEventsResponseBodyListResultDataAlertReason()
        ...
        if m.get('AlertReceiverList') is not None:
            for k1 in m.get('AlertReceiverList'):
                temp_model = main_models.ListAlertEventsResponseBodyListResultDataAlertReceiverList()
                self.alert_receiver_list.append(temp_model.from_map(k1))

        if m.get('BelongProject') is not None:
            temp_model = main_models.ListAlertEventsResponseBodyListResultDataBelongProject()
        ...
        if m.get('UrlConfig') is not None:
            temp_model = main_models.ListAlertEventsResponseBodyListResultDataUrlConfig()
            self.url_config = temp_model.from_map(m.get('UrlConfig'))

        return self

class ListAlertEventsResponseBodyListResultDataUrlConfig(DaraModel):
    def __init__(
        self,
...
class ListAlertEventsResponseBodyListResultDataBelongProject(DaraModel):
    def __init__(
        self,
        biz_name: str = None,
...
class ListAlertEventsResponseBodyListResultDataAlertReceiverList(DaraModel):
    def __init__(
        self,
        ...
        type: str = None,
        user_list: List[main_models.ListAlertEventsResponseBodyListResultDataAlertReceiverListUserList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserList') is not None:
            for k1 in m.get('UserList'):
                temp_model = main_models.ListAlertEventsResponseBodyListResultDataAlertReceiverListUserList()
                self.user_list.append(temp_model.from_map(k1))

        return self

class ListAlertEventsResponseBodyListResultDataAlertReceiverListUserList(DaraModel):
    def __init__(
        self,
        name: str = None,
    ):
...
class ListAlertEventsResponseBodyListResultDataAlertReason(DaraModel):
    def __init__(
        self,
        alert_reason_param_list: List[main_models.ListAlertEventsResponseBodyListResultDataAlertReasonAlertReasonParamList] = None,
        biz_date: str = None,
        type: str = None,
        unique_key: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AlertReasonParamList') is not None:
            for k1 in m.get('AlertReasonParamList'):
                temp_model = main_models.ListAlertEventsResponseBodyListResultDataAlertReasonAlertReasonParamList()
...
class ListAlertEventsResponseBodyListResultDataAlertReasonAlertReasonParamList(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class ListAlertEventsResponseBodyListResultDataAlertObject(DaraModel):
    def __init__(
        self,
        name: str = None,

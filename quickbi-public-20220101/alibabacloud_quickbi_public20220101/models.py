...
class CheckDatasetExistedRequest(TeaModel):
    def __init__(
        self,
        cube_id: str = None,
    ):
...
class CheckDatasetExistedResponseBody(TeaModel):
    def __init__(
        self,
        request_id: str = None,
        result: bool = None,
...
class CheckDatasetExistedResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CheckDatasetExistedResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CheckDatasetExistedResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self


class CheckOrganizationMemberRequest(TeaModel):
    def __init__(
        self,
        user_id: str = None,
    ):
...
class CheckOrganizationMemberResponseBody(TeaModel):
    def __init__(
        self,
        request_id: str = None,
        result: bool = None,
...
class CheckOrganizationMemberResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CheckOrganizationMemberResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CheckOrganizationMemberResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class CreateCubeBySqlRequest(TeaModel):
    def __init__(
        self,
        caption: str = None,
        custom_sql: str = None,
...
class CreateCubeBySqlResponseBody(TeaModel):
    def __init__(
        self,
        request_id: str = None,
        result: str = None,
...
class CreateCubeBySqlResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CreateCubeBySqlResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CreateCubeBySqlResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class ListWorkspaceUserRolesByUserIdRequest(TeaModel):
    def __init__(
        self,
        user_id: str = None,
    ):
...
class ListWorkspaceUserRolesByUserIdResponseBodyResultRoleModel(TeaModel):
    def __init__(
        self,
        role_code: str = None,
        role_id: str = None,
...
class ListWorkspaceUserRolesByUserIdResponseBodyResult(TeaModel):
    def __init__(
        self,
        role_model: ListWorkspaceUserRolesByUserIdResponseBodyResultRoleModel = None,
        workspace_id: str = None,
        workspace_name: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RoleModel') is not None:
            temp_model = ListWorkspaceUserRolesByUserIdResponseBodyResultRoleModel()
            self.role_model = temp_model.from_map(m['RoleModel'])
        if m.get('WorkspaceId') is not None:
            self.workspace_id = m.get('WorkspaceId')
        if m.get('WorkspaceName') is not None:
            self.workspace_name = m.get('WorkspaceName')
...
class ListWorkspaceUserRolesByUserIdResponseBody(TeaModel):
    def __init__(
        self,
        request_id: str = None,
        result: List[ListWorkspaceUserRolesByUserIdResponseBodyResult] = None,
        success: bool = None,
    ):
        self.request_id = request_id
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k in m.get('Result'):
                temp_model = ListWorkspaceUserRolesByUserIdResponseBodyResult()
                self.result.append(temp_model.from_map(k))
        if m.get('Success') is not None:
            self.success = m.get('Success')
        return self
...
class ListWorkspaceUserRolesByUserIdResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ListWorkspaceUserRolesByUserIdResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = ListWorkspaceUserRolesByUserIdResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class QueryDashboardNl2sqlRequest(TeaModel):
    def __init__(
        self,
        user_id: str = None,
        workspace_id: str = None,
...
class QueryDashboardNl2sqlResponseBodyResult(TeaModel):
    def __init__(
        self,
...
class QueryDashboardNl2sqlResponseBody(TeaModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k in m.get('Result'):
                temp_model = QueryDashboardNl2sqlResponseBodyResult()
                self.result.append(temp_model.from_map(k))
        if m.get('Success') is not None:
            self.success = m.get('Success')
        return self
...
class QueryDashboardNl2sqlResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: QueryDashboardNl2sqlResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = QueryDashboardNl2sqlResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class QueryLastAccelerationEngineJobRequest(TeaModel):
    def __init__(
        self,
        cube_id: str = None,
    ):
...
class QueryLastAccelerationEngineJobResponseBodyResult(TeaModel):
    def __init__(
        self,
        gmt_create: str = None,
        gmt_modified: str = None,
...
class QueryLastAccelerationEngineJobResponseBody(TeaModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RequestId') is not None:
            self.request_id = m.get('RequestId')
        if m.get('Result') is not None:
            temp_model = QueryLastAccelerationEngineJobResponseBodyResult()
            self.result = temp_model.from_map(m['Result'])
        if m.get('Success') is not None:
            self.success = m.get('Success')
        return self
...
class QueryLastAccelerationEngineJobResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: QueryLastAccelerationEngineJobResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = QueryLastAccelerationEngineJobResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class UpdateCubeBySqlRequest(TeaModel):
    def __init__(
        self,
        cube_id: str = None,
        custom_sql: str = None,
...
class UpdateCubeBySqlResponseBody(TeaModel):
    def __init__(
        self,
        request_id: str = None,
        result: bool = None,
...
class UpdateCubeBySqlResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: UpdateCubeBySqlResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = UpdateCubeBySqlResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

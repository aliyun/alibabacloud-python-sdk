...
class QueryReportPerformanceResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: List[main_models.QueryReportPerformanceResponseBodyResult] = None,
        success: bool = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k1 in m.get('Result'):
                temp_model = main_models.QueryReportPerformanceResponseBodyResult()
...
class QueryReportPerformanceResponseBodyResult(DaraModel):
    def __init__(
        self,

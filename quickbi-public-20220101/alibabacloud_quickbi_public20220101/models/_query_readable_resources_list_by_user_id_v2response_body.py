...
class QueryReadableResourcesListByUserIdV2ResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: List[main_models.QueryReadableResourcesListByUserIdV2ResponseBodyResult] = None,
        success: bool = None,
    ):
        # Request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k1 in m.get('Result'):
                temp_model = main_models.QueryReadableResourcesListByUserIdV2ResponseBodyResult()
...
class QueryReadableResourcesListByUserIdV2ResponseBodyResult(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        description: str = None,
        directory: main_models.QueryReadableResourcesListByUserIdV2ResponseBodyResultDirectory = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Directory') is not None:
            temp_model = main_models.QueryReadableResourcesListByUserIdV2ResponseBodyResultDirectory()
...
class QueryReadableResourcesListByUserIdV2ResponseBodyResultDirectory(DaraModel):
    def __init__(
        self,
        id: str = None,
        name: str = None,

...
class QueryUserGroupListByParentIdResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: List[main_models.QueryUserGroupListByParentIdResponseBodyResult] = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k1 in m.get('Result'):
                temp_model = main_models.QueryUserGroupListByParentIdResponseBodyResult()
...
class QueryUserGroupListByParentIdResponseBodyResult(DaraModel):
    def __init__(
        self,

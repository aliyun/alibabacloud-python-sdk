...
class AddWorkspaceUsersResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.AddWorkspaceUsersResponseBodyResult = None,
        success: bool = None,
    ):
        # Request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.AddWorkspaceUsersResponseBodyResult()
...
class AddWorkspaceUsersResponseBodyResult(DaraModel):
    def __init__(
        self,
        failure: int = None,

...
class QueryUserInfoByUserIdResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.QueryUserInfoByUserIdResponseBodyResult = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.QueryUserInfoByUserIdResponseBodyResult()
...
class QueryUserInfoByUserIdResponseBodyResult(DaraModel):
    def __init__(
        self,
        account_id: str = None,

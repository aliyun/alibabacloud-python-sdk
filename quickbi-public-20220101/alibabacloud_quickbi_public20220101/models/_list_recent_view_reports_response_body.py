...
class ListRecentViewReportsResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.ListRecentViewReportsResponseBodyResult = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.ListRecentViewReportsResponseBodyResult()
...
class ListRecentViewReportsResponseBodyResult(DaraModel):
    def __init__(
        self,
        attention: str = None,
        data: List[main_models.ListRecentViewReportsResponseBodyResultData] = None,
        page_num: int = None,
        page_size: int = None,
        total_num: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListRecentViewReportsResponseBodyResultData()
...
class ListRecentViewReportsResponseBodyResultData(DaraModel):
    def __init__(
        self,
        favorite: bool = None,
        gmt_create: str = None,

...
class QueryCubeOptimizationResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: List[main_models.QueryCubeOptimizationResponseBodyResult] = None,
        success: bool = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k1 in m.get('Result'):
                temp_model = main_models.QueryCubeOptimizationResponseBodyResult()
...
class QueryCubeOptimizationResponseBodyResult(DaraModel):
    def __init__(
        self,
        advice_type: str = None,
        cube_performance_diagnose_model: main_models.QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CubePerformanceDiagnoseModel') is not None:
            temp_model = main_models.QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel()
            self.cube_performance_diagnose_model = temp_model.from_map(m.get('CubePerformanceDiagnoseModel'))

        return self

class QueryCubeOptimizationResponseBodyResultCubePerformanceDiagnoseModel(DaraModel):
    def __init__(
        self,

...
class DescribeExecutionResponseBody(DaraModel):
    def __init__(
        self,
        environment: main_models.DescribeExecutionResponseBodyEnvironment = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Environment') is not None:
            temp_model = main_models.DescribeExecutionResponseBodyEnvironment()
...
class DescribeExecutionResponseBodyEnvironment(DaraModel):
    def __init__(
        self,
        variables: List[main_models.DescribeExecutionResponseBodyEnvironmentVariables] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Variables') is not None:
            for k1 in m.get('Variables'):
                temp_model = main_models.DescribeExecutionResponseBodyEnvironmentVariables()
                self.variables.append(temp_model.from_map(k1))

        return self

class DescribeExecutionResponseBodyEnvironmentVariables(DaraModel):
    def __init__(
        self,
        name: str = None,
        value: str = None,

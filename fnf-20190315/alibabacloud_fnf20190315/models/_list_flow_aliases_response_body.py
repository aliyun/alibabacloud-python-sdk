...
class ListFlowAliasesResponseBody(DaraModel):
    def __init__(
        self,
        aliases: List[main_models.ListFlowAliasesResponseBodyAliases] = None,
        next_token: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Aliases') is not None:
            for k1 in m.get('Aliases'):
                temp_model = main_models.ListFlowAliasesResponseBodyAliases()
...
class ListFlowAliasesResponseBodyAliases(DaraModel):
    def __init__(
        self,
        created_time: str = None,
        description: str = None,
        name: str = None,
        routing_configurations: List[main_models.ListFlowAliasesResponseBodyAliasesRoutingConfigurations] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RoutingConfigurations') is not None:
            for k1 in m.get('RoutingConfigurations'):
                temp_model = main_models.ListFlowAliasesResponseBodyAliasesRoutingConfigurations()
                self.routing_configurations.append(temp_model.from_map(k1))

        return self

class ListFlowAliasesResponseBodyAliasesRoutingConfigurations(DaraModel):
    def __init__(
        self,
        version: str = None,
        weight: str = None,

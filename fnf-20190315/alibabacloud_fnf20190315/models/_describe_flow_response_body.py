...
class DescribeFlowResponseBody(DaraModel):
    def __init__(
        self,
        created_time: str = None,
        definition: str = None,
        description: str = None,
        environment: main_models.DescribeFlowResponseBodyEnvironment = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Environment') is not None:
            temp_model = main_models.DescribeFlowResponseBodyEnvironment()
...
class DescribeFlowResponseBodyEnvironment(DaraModel):
    def __init__(
        self,
        variables: List[main_models.DescribeFlowResponseBodyEnvironmentVariables] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Variables') is not None:
            for k1 in m.get('Variables'):
                temp_model = main_models.DescribeFlowResponseBodyEnvironmentVariables()
                self.variables.append(temp_model.from_map(k1))

        return self

class DescribeFlowResponseBodyEnvironmentVariables(DaraModel):
    def __init__(
        self,
        description: str = None,
        name: str = None,

...
class UpdateFlowResponseBody(DaraModel):
    def __init__(
        ...
        environment: main_models.UpdateFlowResponseBodyEnvironment = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Environment') is not None:
            temp_model = main_models.UpdateFlowResponseBodyEnvironment()
...
class UpdateFlowResponseBodyEnvironment(DaraModel):
    def __init__(
        self,
        variables: List[main_models.UpdateFlowResponseBodyEnvironmentVariables] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Variables') is not None:
            for k1 in m.get('Variables'):
                temp_model = main_models.UpdateFlowResponseBodyEnvironmentVariables()
                self.variables.append(temp_model.from_map(k1))

        return self

class UpdateFlowResponseBodyEnvironmentVariables(DaraModel):
    def __init__(
        self,
        description: str = None,
        name: str = None,

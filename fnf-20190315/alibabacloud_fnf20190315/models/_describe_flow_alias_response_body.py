...
class DescribeFlowAliasResponseBody(DaraModel):
    def __init__(
        self,
        alias: main_models.DescribeFlowAliasResponseBodyAlias = None,
        request_id: str = None,
    ):
        self.alias = alias
        # Id of the request
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Alias') is not None:
            temp_model = main_models.DescribeFlowAliasResponseBodyAlias()
...
class DescribeFlowAliasResponseBodyAlias(DaraModel):
    def __init__(
        self,
        created_time: str = None,
        description: str = None,
        name: str = None,
        routing_configurations: List[main_models.DescribeFlowAliasResponseBodyAliasRoutingConfigurations] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RoutingConfigurations') is not None:
            for k1 in m.get('RoutingConfigurations'):
                temp_model = main_models.DescribeFlowAliasResponseBodyAliasRoutingConfigurations()
                self.routing_configurations.append(temp_model.from_map(k1))

        return self

class DescribeFlowAliasResponseBodyAliasRoutingConfigurations(DaraModel):
    def __init__(
        self,
        version: str = None,
        weight: int = None,

...
class CreateFlowResponseBody(DaraModel):
    def __init__(
        ...
        environment: main_models.CreateFlowResponseBodyEnvironment = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Environment') is not None:
            temp_model = main_models.CreateFlowResponseBodyEnvironment()
...
class CreateFlowResponseBodyEnvironment(DaraModel):
    def __init__(
        self,
        variables: List[main_models.CreateFlowResponseBodyEnvironmentVariables] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Variables') is not None:
            for k1 in m.get('Variables'):
                temp_model = main_models.CreateFlowResponseBodyEnvironmentVariables()
                self.variables.append(temp_model.from_map(k1))

        return self

class CreateFlowResponseBodyEnvironmentVariables(DaraModel):
    def __init__(
        self,
        description: str = None,
        name: str = None,

...
## Alibaba Cloud fnf SDK for Python
...
```bash
# 安装 alibabacloud_fnf20190315
pip install alibabacloud_fnf20190315
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/fnf-20190315/ChangeLog.md)中。

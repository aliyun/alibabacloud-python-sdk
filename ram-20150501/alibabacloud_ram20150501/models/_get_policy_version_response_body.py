...
class GetPolicyVersionResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PolicyVersion') is not None:
            temp_model = main_models.GetPolicyVersionResponseBodyPolicyVersion()
...
class GetPolicyVersionResponseBodyPolicyVersion(DaraModel):
    def __init__(
        self,

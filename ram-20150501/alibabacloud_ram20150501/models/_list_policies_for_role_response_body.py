...
class ListPoliciesForRoleResponseBody(DaraModel):
    def __init__(
        self,
        policies: main_models.ListPoliciesForRoleResponseBodyPolicies = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Policies') is not None:
            temp_model = main_models.ListPoliciesForRoleResponseBodyPolicies()
...
class ListPoliciesForRoleResponseBodyPolicies(DaraModel):
    def __init__(
        self,
        policy: List[main_models.ListPoliciesForRoleResponseBodyPoliciesPolicy] = None,
    ):
        self.policy = policy
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Policy') is not None:
            for k1 in m.get('Policy'):
                temp_model = main_models.ListPoliciesForRoleResponseBodyPoliciesPolicy()
                self.policy.append(temp_model.from_map(k1))

        return self

class ListPoliciesForRoleResponseBodyPoliciesPolicy(DaraModel):
    def __init__(
        self,

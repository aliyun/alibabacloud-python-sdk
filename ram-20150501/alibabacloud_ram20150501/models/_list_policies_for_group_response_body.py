...
class ListPoliciesForGroupResponseBody(DaraModel):
    def __init__(
        self,
        policies: main_models.ListPoliciesForGroupResponseBodyPolicies = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Policies') is not None:
            temp_model = main_models.ListPoliciesForGroupResponseBodyPolicies()
...
class ListPoliciesForGroupResponseBodyPolicies(DaraModel):
    def __init__(
        self,
        policy: List[main_models.ListPoliciesForGroupResponseBodyPoliciesPolicy] = None,
    ):
        self.policy = policy
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Policy') is not None:
            for k1 in m.get('Policy'):
                temp_model = main_models.ListPoliciesForGroupResponseBodyPoliciesPolicy()
                self.policy.append(temp_model.from_map(k1))

        return self

class ListPoliciesForGroupResponseBodyPoliciesPolicy(DaraModel):
    def __init__(
        self,

...
class GetAggregateResourceCountsGroupByResourceTypeResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DiscoveredResourceCountsSummary') is not None:
            for k1 in m.get('DiscoveredResourceCountsSummary'):
                temp_model = main_models.GetAggregateResourceCountsGroupByResourceTypeResponseBodyDiscoveredResourceCountsSummary()
...
class GetAggregateResourceCountsGroupByResourceTypeResponseBodyDiscoveredResourceCountsSummary(DaraModel):
    def __init__(
        self,
        group_name: str = None,

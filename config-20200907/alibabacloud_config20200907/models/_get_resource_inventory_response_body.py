...
class GetResourceInventoryResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        resource_inventory: main_models.GetResourceInventoryResponseBodyResourceInventory = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceInventory') is not None:
            temp_model = main_models.GetResourceInventoryResponseBodyResourceInventory()
            self.resource_inventory = temp_model.from_map(m.get('ResourceInventory'))

        return self

class GetResourceInventoryResponseBodyResourceInventory(DaraModel):
    def __init__(
        self,

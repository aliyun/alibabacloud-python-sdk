...
class DeleteAggregateRemediationsResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RemediationDeleteResults') is not None:
            for k1 in m.get('RemediationDeleteResults'):
                temp_model = main_models.DeleteAggregateRemediationsResponseBodyRemediationDeleteResults()
...
class DeleteAggregateRemediationsResponseBodyRemediationDeleteResults(DaraModel):
    def __init__(
        self,

...
class ActiveConfigRulesResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OperateRuleResult') is not None:
            temp_model = main_models.ActiveConfigRulesResponseBodyOperateRuleResult()
...
class ActiveConfigRulesResponseBodyOperateRuleResult(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OperateRuleItemList') is not None:
            for k1 in m.get('OperateRuleItemList'):
                temp_model = main_models.ActiveConfigRulesResponseBodyOperateRuleResultOperateRuleItemList()
                self.operate_rule_item_list.append(temp_model.from_map(k1))

        return self

class ActiveConfigRulesResponseBodyOperateRuleResultOperateRuleItemList(DaraModel):
    def __init__(
        self,

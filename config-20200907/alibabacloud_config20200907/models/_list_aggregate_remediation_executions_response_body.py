...
class ListAggregateRemediationExecutionsResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RemediationExecutionData') is not None:
            temp_model = main_models.ListAggregateRemediationExecutionsResponseBodyRemediationExecutionData()
...
class ListAggregateRemediationExecutionsResponseBodyRemediationExecutionData(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RemediationExecutions') is not None:
            for k1 in m.get('RemediationExecutions'):
                temp_model = main_models.ListAggregateRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions()
                self.remediation_executions.append(temp_model.from_map(k1))

        return self

class ListAggregateRemediationExecutionsResponseBodyRemediationExecutionDataRemediationExecutions(DaraModel):
    def __init__(
        self,

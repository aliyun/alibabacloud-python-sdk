...
class ListAggregateRecommendManagedRulesResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RecommendedManagedRules') is not None:
            temp_model = main_models.ListAggregateRecommendManagedRulesResponseBodyRecommendedManagedRules()
...
class ListAggregateRecommendManagedRulesResponseBodyRecommendedManagedRules(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RecommendedManagedRuleList') is not None:
            for k1 in m.get('RecommendedManagedRuleList'):
                temp_model = main_models.ListAggregateRecommendManagedRulesResponseBodyRecommendedManagedRulesRecommendedManagedRuleList()
...
class ListAggregateRecommendManagedRulesResponseBodyRecommendedManagedRulesRecommendedManagedRuleList(DaraModel):
    def __init__(
        self,

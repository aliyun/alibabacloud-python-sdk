...
class ListConfigRulesRequest(DaraModel):
    def __init__(
        self,
        ...
        risk_level: int = None,
        sort_by: str = None,
        tag: List[main_models.ListConfigRulesRequestTag] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.ListConfigRulesRequestTag()
                self.tag.append(temp_model.from_map(k1))

        return self

class ListConfigRulesRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

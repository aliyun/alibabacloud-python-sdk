...
class GetAggregateCompliancePackReportResponseBody(DaraModel):
    def __init__(
        self,
        compliance_pack_report: main_models.GetAggregateCompliancePackReportResponseBodyCompliancePackReport = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CompliancePackReport') is not None:
            temp_model = main_models.GetAggregateCompliancePackReportResponseBodyCompliancePackReport()
...
class GetAggregateCompliancePackReportResponseBodyCompliancePackReport(DaraModel):
    def __init__(
        self,
        account_id: int = None,

...
class UpdateCompliancePackRequest(DaraModel):
    def __init__(
        self,
        client_token: str = None,
        compliance_pack_id: str = None,
        compliance_pack_name: str = None,
        config_rules: List[main_models.UpdateCompliancePackRequestConfigRules] = None,
        description: str = None,
        exclude_region_ids_scope: str = None,
        exclude_resource_group_ids_scope: str = None,
        exclude_resource_ids_scope: str = None,
        exclude_tags_scope: List[main_models.UpdateCompliancePackRequestExcludeTagsScope] = None,
        region_ids_scope: str = None,
        resource_group_ids_scope: str = None,
        resource_ids_scope: str = None,
        risk_level: int = None,
        tag: List[main_models.UpdateCompliancePackRequestTag] = None,
        tag_key_scope: str = None,
        tag_value_scope: str = None,
        tags_scope: List[main_models.UpdateCompliancePackRequestTagsScope] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConfigRules') is not None:
            for k1 in m.get('ConfigRules'):
                temp_model = main_models.UpdateCompliancePackRequestConfigRules()
        ...
        if m.get('ExcludeTagsScope') is not None:
            for k1 in m.get('ExcludeTagsScope'):
                temp_model = main_models.UpdateCompliancePackRequestExcludeTagsScope()
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.UpdateCompliancePackRequestTag()
        ...
        if m.get('TagsScope') is not None:
            for k1 in m.get('TagsScope'):
                temp_model = main_models.UpdateCompliancePackRequestTagsScope()
                self.tags_scope.append(temp_model.from_map(k1))

        return self

class UpdateCompliancePackRequestTagsScope(DaraModel):
    def __init__(
        self,
        tag_key: str = None,
        tag_value: str = None,
...
class UpdateCompliancePackRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class UpdateCompliancePackRequestExcludeTagsScope(DaraModel):
    def __init__(
        self,
        tag_key: str = None,
        tag_value: str = None,
...
class UpdateCompliancePackRequestConfigRules(DaraModel):
    def __init__(
        self,
        config_rule_id: str = None,
        config_rule_name: str = None,
        config_rule_parameters: List[main_models.UpdateCompliancePackRequestConfigRulesConfigRuleParameters] = None,
        description: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConfigRuleParameters') is not None:
            for k1 in m.get('ConfigRuleParameters'):
                temp_model = main_models.UpdateCompliancePackRequestConfigRulesConfigRuleParameters()
...
class UpdateCompliancePackRequestConfigRulesConfigRuleParameters(DaraModel):
    def __init__(
        self,

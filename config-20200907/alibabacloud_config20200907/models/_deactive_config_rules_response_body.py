...
class DeactiveConfigRulesResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OperateRuleResult') is not None:
            temp_model = main_models.DeactiveConfigRulesResponseBodyOperateRuleResult()
...
class DeactiveConfigRulesResponseBodyOperateRuleResult(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OperateRuleItemList') is not None:
            for k1 in m.get('OperateRuleItemList'):
                temp_model = main_models.DeactiveConfigRulesResponseBodyOperateRuleResultOperateRuleItemList()
                self.operate_rule_item_list.append(temp_model.from_map(k1))

        return self

class DeactiveConfigRulesResponseBodyOperateRuleResultOperateRuleItemList(DaraModel):
    def __init__(
        self,

...
class UpdateAggregateCompliancePackShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        exclude_tags_scope: List[main_models.UpdateAggregateCompliancePackShrinkRequestExcludeTagsScope] = None,
        ...
        tags_scope: List[main_models.UpdateAggregateCompliancePackShrinkRequestTagsScope] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ExcludeTagsScope') is not None:
            for k1 in m.get('ExcludeTagsScope'):
                temp_model = main_models.UpdateAggregateCompliancePackShrinkRequestExcludeTagsScope()
        ...
        if m.get('TagsScope') is not None:
            for k1 in m.get('TagsScope'):
                temp_model = main_models.UpdateAggregateCompliancePackShrinkRequestTagsScope()
                self.tags_scope.append(temp_model.from_map(k1))

        return self

class UpdateAggregateCompliancePackShrinkRequestTagsScope(DaraModel):
    def __init__(
        self,
        tag_key: str = None,
        tag_value: str = None,
...
class UpdateAggregateCompliancePackShrinkRequestExcludeTagsScope(DaraModel):
    def __init__(
        self,
        tag_key: str = None,
        tag_value: str = None,

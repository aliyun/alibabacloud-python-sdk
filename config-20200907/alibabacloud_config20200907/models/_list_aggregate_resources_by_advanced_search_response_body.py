...
class ListAggregateResourcesByAdvancedSearchResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('QueryResults') is not None:
            temp_model = main_models.ListAggregateResourcesByAdvancedSearchResponseBodyQueryResults()
...
class ListAggregateResourcesByAdvancedSearchResponseBodyQueryResults(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('QueryResultList') is not None:
            temp_model = main_models.ListAggregateResourcesByAdvancedSearchResponseBodyQueryResultsQueryResultList()
            self.query_result_list = temp_model.from_map(m.get('QueryResultList'))

        return self

class ListAggregateResourcesByAdvancedSearchResponseBodyQueryResultsQueryResultList(DaraModel):
    def __init__(
        self,

...
class ListResourceEvaluationResultsResponseBody(DaraModel):
    def __init__(
        self,
        evaluation_results: main_models.ListResourceEvaluationResultsResponseBodyEvaluationResults = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EvaluationResults') is not None:
            temp_model = main_models.ListResourceEvaluationResultsResponseBodyEvaluationResults()
...
class ListResourceEvaluationResultsResponseBodyEvaluationResults(DaraModel):
    def __init__(
        self,
        evaluation_result_list: List[main_models.ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EvaluationResultList') is not None:
            for k1 in m.get('EvaluationResultList'):
                temp_model = main_models.ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList()
...
class ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList(DaraModel):
    def __init__(
        self,
        annotation: str = None,
        ...
        evaluation_result_identifier: main_models.ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EvaluationResultIdentifier') is not None:
            temp_model = main_models.ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier()
...
class ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier(DaraModel):
    def __init__(
        self,
        evaluation_result_qualifier: main_models.ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifierEvaluationResultQualifier = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EvaluationResultQualifier') is not None:
            temp_model = main_models.ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifierEvaluationResultQualifier()
...
class ListResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifierEvaluationResultQualifier(DaraModel):
    def __init__(
        self,

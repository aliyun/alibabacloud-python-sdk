...
class ListAggregateConfigRuleEvaluationStatisticsResponseBody(DaraModel):
    def __init__(
        self,
        evaluation_results: List[main_models.ListAggregateConfigRuleEvaluationStatisticsResponseBodyEvaluationResults] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EvaluationResults') is not None:
            for k1 in m.get('EvaluationResults'):
                temp_model = main_models.ListAggregateConfigRuleEvaluationStatisticsResponseBodyEvaluationResults()
...
class ListAggregateConfigRuleEvaluationStatisticsResponseBodyEvaluationResults(DaraModel):
    def __init__(
        self,

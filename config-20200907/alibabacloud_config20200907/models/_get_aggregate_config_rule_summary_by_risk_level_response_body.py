...
class GetAggregateConfigRuleSummaryByRiskLevelResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConfigRuleSummaries') is not None:
            for k1 in m.get('ConfigRuleSummaries'):
                temp_model = main_models.GetAggregateConfigRuleSummaryByRiskLevelResponseBodyConfigRuleSummaries()
...
class GetAggregateConfigRuleSummaryByRiskLevelResponseBodyConfigRuleSummaries(DaraModel):
    def __init__(
        self,

...
class GetAggregateResourceCountsGroupByRegionResponseBody(DaraModel):
    def __init__(
        self,
        discovered_resource_counts_summary: List[main_models.GetAggregateResourceCountsGroupByRegionResponseBodyDiscoveredResourceCountsSummary] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DiscoveredResourceCountsSummary') is not None:
            for k1 in m.get('DiscoveredResourceCountsSummary'):
                temp_model = main_models.GetAggregateResourceCountsGroupByRegionResponseBodyDiscoveredResourceCountsSummary()
...
class GetAggregateResourceCountsGroupByRegionResponseBodyDiscoveredResourceCountsSummary(DaraModel):
    def __init__(
        self,
        group_name: str = None,
        region: str = None,

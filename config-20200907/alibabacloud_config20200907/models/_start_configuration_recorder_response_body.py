...
class StartConfigurationRecorderResponseBody(DaraModel):
    def __init__(
        self,
        configuration_recorder: main_models.StartConfigurationRecorderResponseBodyConfigurationRecorder = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConfigurationRecorder') is not None:
            temp_model = main_models.StartConfigurationRecorderResponseBodyConfigurationRecorder()
...
class StartConfigurationRecorderResponseBodyConfigurationRecorder(DaraModel):
    def __init__(
        self,

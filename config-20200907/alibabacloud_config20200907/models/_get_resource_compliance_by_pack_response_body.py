...
class GetResourceComplianceByPackResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        resource_compliance_result: main_models.GetResourceComplianceByPackResponseBodyResourceComplianceResult = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceComplianceResult') is not None:
            temp_model = main_models.GetResourceComplianceByPackResponseBodyResourceComplianceResult()
            self.resource_compliance_result = temp_model.from_map(m.get('ResourceComplianceResult'))

        return self

class GetResourceComplianceByPackResponseBodyResourceComplianceResult(DaraModel):
    def __init__(
        self,

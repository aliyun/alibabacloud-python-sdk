...
class GetAggregateAdvancedSearchFileResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceSearch') is not None:
            temp_model = main_models.GetAggregateAdvancedSearchFileResponseBodyResourceSearch()
            self.resource_search = temp_model.from_map(m.get('ResourceSearch'))

        return self

class GetAggregateAdvancedSearchFileResponseBodyResourceSearch(DaraModel):
    def __init__(
        self,

...
class ListCompliancePacksResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CompliancePacksResult') is not None:
            temp_model = main_models.ListCompliancePacksResponseBodyCompliancePacksResult()
...
class ListCompliancePacksResponseBodyCompliancePacksResult(DaraModel):
    def __init__(
        self,
        compliance_packs: List[main_models.ListCompliancePacksResponseBodyCompliancePacksResultCompliancePacks] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CompliancePacks') is not None:
            for k1 in m.get('CompliancePacks'):
                temp_model = main_models.ListCompliancePacksResponseBodyCompliancePacksResultCompliancePacks()
...
class ListCompliancePacksResponseBodyCompliancePacksResultCompliancePacks(DaraModel):
    def __init__(
        self,
        account_id: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.ListCompliancePacksResponseBodyCompliancePacksResultCompliancePacksTags()
                self.tags.append(temp_model.from_map(k1))

        return self

class ListCompliancePacksResponseBodyCompliancePacksResultCompliancePacksTags(DaraModel):
    def __init__(
        self,
        tag_key: str = None,
        tag_value: str = None,

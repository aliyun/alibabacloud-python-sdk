...
class CreateCompliancePackRequest(DaraModel):
    def __init__(
        self,
        client_token: str = None,
        compliance_pack_name: str = None,
        compliance_pack_template_id: str = None,
        config_rules: List[main_models.CreateCompliancePackRequestConfigRules] = None,
        ...
        exclude_tags_scope: List[main_models.CreateCompliancePackRequestExcludeTagsScope] = None,
        region_ids_scope: str = None,
        resource_group_ids_scope: str = None,
        resource_ids_scope: str = None,
        risk_level: int = None,
        tag: List[main_models.CreateCompliancePackRequestTag] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConfigRules') is not None:
            for k1 in m.get('ConfigRules'):
                temp_model = main_models.CreateCompliancePackRequestConfigRules()
        ...
        if m.get('ExcludeTagsScope') is not None:
            for k1 in m.get('ExcludeTagsScope'):
                temp_model = main_models.CreateCompliancePackRequestExcludeTagsScope()
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.CreateCompliancePackRequestTag()
        ...
        if m.get('TagsScope') is not None:
            for k1 in m.get('TagsScope'):
                temp_model = main_models.CreateCompliancePackRequestTagsScope()
...
class CreateCompliancePackRequestTagsScope(DaraModel):
    def __init__(
        self,
        tag_key: str = None,
        tag_value: str = None,
...
class CreateCompliancePackRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class CreateCompliancePackRequestExcludeTagsScope(DaraModel):
    def __init__(
        self,
        tag_key: str = None,
        tag_value: str = None,
...
class CreateCompliancePackRequestConfigRules(DaraModel):
    def __init__(
        self,
        config_rule_id: str = None,
        config_rule_name: str = None,
        config_rule_parameters: List[main_models.CreateCompliancePackRequestConfigRulesConfigRuleParameters] = None,
        description: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConfigRuleParameters') is not None:
            for k1 in m.get('ConfigRuleParameters'):
                temp_model = main_models.CreateCompliancePackRequestConfigRulesConfigRuleParameters()
...
class CreateCompliancePackRequestConfigRulesConfigRuleParameters(DaraModel):
    def __init__(
        self,

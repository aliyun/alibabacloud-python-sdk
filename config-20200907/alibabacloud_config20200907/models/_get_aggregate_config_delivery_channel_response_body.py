...
class GetAggregateConfigDeliveryChannelResponseBody(DaraModel):
    def __init__(
        self,
        delivery_channel: main_models.GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DeliveryChannel') is not None:
            temp_model = main_models.GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel()
...
class GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel(DaraModel):
    def __init__(
        self,
        account_id: str = None,

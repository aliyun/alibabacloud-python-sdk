...
class GetConfigurationRecorderResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConfigurationRecorder') is not None:
            temp_model = main_models.GetConfigurationRecorderResponseBodyConfigurationRecorder()
...
class GetConfigurationRecorderResponseBodyConfigurationRecorder(DaraModel):
    def __init__(
        self,

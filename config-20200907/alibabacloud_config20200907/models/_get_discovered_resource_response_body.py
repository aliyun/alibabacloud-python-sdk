...
class GetDiscoveredResourceResponseBody(DaraModel):
    def __init__(
        self,
        discovered_resource_detail: main_models.GetDiscoveredResourceResponseBodyDiscoveredResourceDetail = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DiscoveredResourceDetail') is not None:
            temp_model = main_models.GetDiscoveredResourceResponseBodyDiscoveredResourceDetail()
...
class GetDiscoveredResourceResponseBodyDiscoveredResourceDetail(DaraModel):
    def __init__(
        self,
        account_id: int = None,

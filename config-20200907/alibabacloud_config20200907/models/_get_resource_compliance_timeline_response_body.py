...
class GetResourceComplianceTimelineResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceComplianceTimeline') is not None:
            temp_model = main_models.GetResourceComplianceTimelineResponseBodyResourceComplianceTimeline()
            self.resource_compliance_timeline = temp_model.from_map(m.get('ResourceComplianceTimeline'))

        return self

class GetResourceComplianceTimelineResponseBodyResourceComplianceTimeline(DaraModel):
    def __init__(
        self,
        compliance_list: List[main_models.GetResourceComplianceTimelineResponseBodyResourceComplianceTimelineComplianceList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ComplianceList') is not None:
            for k1 in m.get('ComplianceList'):
                temp_model = main_models.GetResourceComplianceTimelineResponseBodyResourceComplianceTimelineComplianceList()
...
class GetResourceComplianceTimelineResponseBodyResourceComplianceTimelineComplianceList(DaraModel):
    def __init__(
        self,
        account_id: str = None,

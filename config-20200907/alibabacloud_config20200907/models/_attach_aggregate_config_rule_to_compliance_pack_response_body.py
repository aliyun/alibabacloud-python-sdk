...
class AttachAggregateConfigRuleToCompliancePackResponseBody(DaraModel):
    def __init__(
        self,
        operate_rule_result: main_models.AttachAggregateConfigRuleToCompliancePackResponseBodyOperateRuleResult = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OperateRuleResult') is not None:
            temp_model = main_models.AttachAggregateConfigRuleToCompliancePackResponseBodyOperateRuleResult()
...
class AttachAggregateConfigRuleToCompliancePackResponseBodyOperateRuleResult(DaraModel):
    def __init__(
        self,
        operate_rule_item_list: List[main_models.AttachAggregateConfigRuleToCompliancePackResponseBodyOperateRuleResultOperateRuleItemList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OperateRuleItemList') is not None:
            for k1 in m.get('OperateRuleItemList'):
                temp_model = main_models.AttachAggregateConfigRuleToCompliancePackResponseBodyOperateRuleResultOperateRuleItemList()
                self.operate_rule_item_list.append(temp_model.from_map(k1))

        return self

class AttachAggregateConfigRuleToCompliancePackResponseBodyOperateRuleResultOperateRuleItemList(DaraModel):
    def __init__(
        self,

...
class GetAggregateResourceComplianceGroupByResourceTypeResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ComplianceResult') is not None:
            temp_model = main_models.GetAggregateResourceComplianceGroupByResourceTypeResponseBodyComplianceResult()
...
class GetAggregateResourceComplianceGroupByResourceTypeResponseBodyComplianceResult(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ComplianceResultList') is not None:
            for k1 in m.get('ComplianceResultList'):
                temp_model = main_models.GetAggregateResourceComplianceGroupByResourceTypeResponseBodyComplianceResultComplianceResultList()
                self.compliance_result_list.append(temp_model.from_map(k1))

        return self

class GetAggregateResourceComplianceGroupByResourceTypeResponseBodyComplianceResultComplianceResultList(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Compliances') is not None:
            for k1 in m.get('Compliances'):
                temp_model = main_models.GetAggregateResourceComplianceGroupByResourceTypeResponseBodyComplianceResultComplianceResultListCompliances()
...
class GetAggregateResourceComplianceGroupByResourceTypeResponseBodyComplianceResultComplianceResultListCompliances(DaraModel):
    def __init__(
        self,

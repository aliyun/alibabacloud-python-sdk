...
class ListAggregateResourceEvaluationResultsResponseBody(DaraModel):
    def __init__(
        self,
        evaluation_results: main_models.ListAggregateResourceEvaluationResultsResponseBodyEvaluationResults = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EvaluationResults') is not None:
            temp_model = main_models.ListAggregateResourceEvaluationResultsResponseBodyEvaluationResults()
...
class ListAggregateResourceEvaluationResultsResponseBodyEvaluationResults(DaraModel):
    def __init__(
        self,
        evaluation_result_list: List[main_models.ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EvaluationResultList') is not None:
            for k1 in m.get('EvaluationResultList'):
                temp_model = main_models.ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList()
...
class ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultList(DaraModel):
    def __init__(
        self,
        annotation: str = None,
        ...
        evaluation_result_identifier: main_models.ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EvaluationResultIdentifier') is not None:
            temp_model = main_models.ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier()
...
class ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifier(DaraModel):
    def __init__(
        self,
        evaluation_result_qualifier: main_models.ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifierEvaluationResultQualifier = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EvaluationResultQualifier') is not None:
            temp_model = main_models.ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifierEvaluationResultQualifier()
...
class ListAggregateResourceEvaluationResultsResponseBodyEvaluationResultsEvaluationResultListEvaluationResultIdentifierEvaluationResultQualifier(DaraModel):
    def __init__(
        self,

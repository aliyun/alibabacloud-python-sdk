...
class ListAggregateResourceRelationsResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceRelations') is not None:
            temp_model = main_models.ListAggregateResourceRelationsResponseBodyResourceRelations()
            self.resource_relations = temp_model.from_map(m.get('ResourceRelations'))

        return self

class ListAggregateResourceRelationsResponseBodyResourceRelations(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceRelationList') is not None:
            for k1 in m.get('ResourceRelationList'):
                temp_model = main_models.ListAggregateResourceRelationsResponseBodyResourceRelationsResourceRelationList()
                self.resource_relation_list.append(temp_model.from_map(k1))

        return self

class ListAggregateResourceRelationsResponseBodyResourceRelationsResourceRelationList(DaraModel):
    def __init__(
        self,
        account_id: int = None,

...
class DeleteConfigRulesResponseBody(DaraModel):
    def __init__(
        self,
        operate_rule_result: main_models.DeleteConfigRulesResponseBodyOperateRuleResult = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OperateRuleResult') is not None:
            temp_model = main_models.DeleteConfigRulesResponseBodyOperateRuleResult()
...
class DeleteConfigRulesResponseBodyOperateRuleResult(DaraModel):
    def __init__(
        self,
        operate_rule_item_list: List[main_models.DeleteConfigRulesResponseBodyOperateRuleResultOperateRuleItemList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OperateRuleItemList') is not None:
            for k1 in m.get('OperateRuleItemList'):
                temp_model = main_models.DeleteConfigRulesResponseBodyOperateRuleResultOperateRuleItemList()
                self.operate_rule_item_list.append(temp_model.from_map(k1))

        return self

class DeleteConfigRulesResponseBodyOperateRuleResultOperateRuleItemList(DaraModel):
    def __init__(
        self,

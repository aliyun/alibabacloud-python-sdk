...
class GetAggregateComplianceSummaryResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ComplianceSummary') is not None:
            temp_model = main_models.GetAggregateComplianceSummaryResponseBodyComplianceSummary()
...
class GetAggregateComplianceSummaryResponseBodyComplianceSummary(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ComplianceSummaryByConfigRule') is not None:
            temp_model = main_models.GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByConfigRule()
        ...
        if m.get('ComplianceSummaryByResource') is not None:
            temp_model = main_models.GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource()
            self.compliance_summary_by_resource = temp_model.from_map(m.get('ComplianceSummaryByResource'))

        return self

class GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByResource(DaraModel):
    def __init__(
        self,
...
class GetAggregateComplianceSummaryResponseBodyComplianceSummaryComplianceSummaryByConfigRule(DaraModel):
    def __init__(
        self,
        compliance_summary_timestamp: int = None,
        compliant_count: int = None,

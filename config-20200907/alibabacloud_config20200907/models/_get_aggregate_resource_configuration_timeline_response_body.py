...
class GetAggregateResourceConfigurationTimelineResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        resource_configuration_timeline: main_models.GetAggregateResourceConfigurationTimelineResponseBodyResourceConfigurationTimeline = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceConfigurationTimeline') is not None:
            temp_model = main_models.GetAggregateResourceConfigurationTimelineResponseBodyResourceConfigurationTimeline()
            self.resource_configuration_timeline = temp_model.from_map(m.get('ResourceConfigurationTimeline'))

        return self

class GetAggregateResourceConfigurationTimelineResponseBodyResourceConfigurationTimeline(DaraModel):
    def __init__(
        self,
        configuration_list: List[main_models.GetAggregateResourceConfigurationTimelineResponseBodyResourceConfigurationTimelineConfigurationList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConfigurationList') is not None:
            for k1 in m.get('ConfigurationList'):
                temp_model = main_models.GetAggregateResourceConfigurationTimelineResponseBodyResourceConfigurationTimelineConfigurationList()
...
class GetAggregateResourceConfigurationTimelineResponseBodyResourceConfigurationTimelineConfigurationList(DaraModel):
    def __init__(
        self,
        account_id: int = None,

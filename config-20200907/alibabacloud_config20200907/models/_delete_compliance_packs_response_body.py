...
class DeleteCompliancePacksResponseBody(DaraModel):
    def __init__(
        self,
        operate_compliance_packs_result: main_models.DeleteCompliancePacksResponseBodyOperateCompliancePacksResult = None,
        request_id: str = None,
    ):
        # The returned result.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OperateCompliancePacksResult') is not None:
            temp_model = main_models.DeleteCompliancePacksResponseBodyOperateCompliancePacksResult()
...
class DeleteCompliancePacksResponseBodyOperateCompliancePacksResult(DaraModel):
    def __init__(
        self,
        operate_compliance_packs: List[main_models.DeleteCompliancePacksResponseBodyOperateCompliancePacksResultOperateCompliancePacks] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OperateCompliancePacks') is not None:
            for k1 in m.get('OperateCompliancePacks'):
                temp_model = main_models.DeleteCompliancePacksResponseBodyOperateCompliancePacksResultOperateCompliancePacks()
                self.operate_compliance_packs.append(temp_model.from_map(k1))

        return self

class DeleteCompliancePacksResponseBodyOperateCompliancePacksResultOperateCompliancePacks(DaraModel):
    def __init__(
        self,

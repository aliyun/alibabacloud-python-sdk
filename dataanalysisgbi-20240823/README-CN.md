...
```bash
# 安装 alibabacloud_dataanalysisgbi20240823
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/dataanalysisgbi-20240823/ChangeLog.md)中。

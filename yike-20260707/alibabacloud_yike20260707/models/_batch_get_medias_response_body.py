...
class BatchGetMediasResponseBody(DaraModel):
    def __init__(
        self,
        ignored_list: List[str] = None,
        media_infos: List[main_models.BatchGetMediasResponseBodyMediaInfos] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MediaInfos') is not None:
            for k1 in m.get('MediaInfos'):
                temp_model = main_models.BatchGetMediasResponseBodyMediaInfos()
...
class BatchGetMediasResponseBodyMediaInfos(DaraModel):
    def __init__(
        self,
        file_info_list: List[main_models.BatchGetMediasResponseBodyMediaInfosFileInfoList] = None,
        media_basic_info: main_models.BatchGetMediasResponseBodyMediaInfosMediaBasicInfo = None,
        media_dynamic_info: main_models.BatchGetMediasResponseBodyMediaInfosMediaDynamicInfo = None,
        media_id: str = None,
    ):
        # FileInfos
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FileInfoList') is not None:
            for k1 in m.get('FileInfoList'):
                temp_model = main_models.BatchGetMediasResponseBodyMediaInfosFileInfoList()
                self.file_info_list.append(temp_model.from_map(k1))

        if m.get('MediaBasicInfo') is not None:
            temp_model = main_models.BatchGetMediasResponseBodyMediaInfosMediaBasicInfo()
            self.media_basic_info = temp_model.from_map(m.get('MediaBasicInfo'))

        if m.get('MediaDynamicInfo') is not None:
            temp_model = main_models.BatchGetMediasResponseBodyMediaInfosMediaDynamicInfo()
...
class BatchGetMediasResponseBodyMediaInfosMediaDynamicInfo(DaraModel):
    def __init__(
        self,
        dynamic_meta_data: main_models.BatchGetMediasResponseBodyMediaInfosMediaDynamicInfoDynamicMetaData = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DynamicMetaData') is not None:
            temp_model = main_models.BatchGetMediasResponseBodyMediaInfosMediaDynamicInfoDynamicMetaData()
            self.dynamic_meta_data = temp_model.from_map(m.get('DynamicMetaData'))

        return self

class BatchGetMediasResponseBodyMediaInfosMediaDynamicInfoDynamicMetaData(DaraModel):
    def __init__(
        self,
        data: str = None,
    ):
...
class BatchGetMediasResponseBodyMediaInfosFileInfoList(DaraModel):
    def __init__(
        self,
        audio_stream_info_list: List[main_models.BatchGetMediasResponseBodyMediaInfosFileInfoListAudioStreamInfoList] = None,
        file_basic_info: main_models.BatchGetMediasResponseBodyMediaInfosFileInfoListFileBasicInfo = None,
        subtitle_stream_info_list: List[main_models.BatchGetMediasResponseBodyMediaInfosFileInfoListSubtitleStreamInfoList] = None,
        video_stream_info_list: List[main_models.BatchGetMediasResponseBodyMediaInfosFileInfoListVideoStreamInfoList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioStreamInfoList') is not None:
            for k1 in m.get('AudioStreamInfoList'):
                temp_model = main_models.BatchGetMediasResponseBodyMediaInfosFileInfoListAudioStreamInfoList()
                self.audio_stream_info_list.append(temp_model.from_map(k1))

        if m.get('FileBasicInfo') is not None:
            temp_model = main_models.BatchGetMediasResponseBodyMediaInfosFileInfoListFileBasicInfo()
        ...
        if m.get('SubtitleStreamInfoList') is not None:
            for k1 in m.get('SubtitleStreamInfoList'):
                temp_model = main_models.BatchGetMediasResponseBodyMediaInfosFileInfoListSubtitleStreamInfoList()
        ...
        if m.get('VideoStreamInfoList') is not None:
            for k1 in m.get('VideoStreamInfoList'):
                temp_model = main_models.BatchGetMediasResponseBodyMediaInfosFileInfoListVideoStreamInfoList()
                self.video_stream_info_list.append(temp_model.from_map(k1))

        return self

class BatchGetMediasResponseBodyMediaInfosFileInfoListVideoStreamInfoList(DaraModel):
    def __init__(
        self,
        avg_fps: str = None,
        bitrate: str = None,
...
class BatchGetMediasResponseBodyMediaInfosFileInfoListSubtitleStreamInfoList(DaraModel):
    def __init__(
        self,
        codec_long_name: str = None,
        codec_name: str = None,
...
class BatchGetMediasResponseBodyMediaInfosFileInfoListFileBasicInfo(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        duration: str = None,
...
class BatchGetMediasResponseBodyMediaInfosFileInfoListAudioStreamInfoList(DaraModel):
    def __init__(
        self,
        bitrate: str = None,

...
class GetMediaResponseBody(DaraModel):
    def __init__(
        self,
        media_info: main_models.GetMediaResponseBodyMediaInfo = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MediaInfo') is not None:
            temp_model = main_models.GetMediaResponseBodyMediaInfo()
...
class GetMediaResponseBodyMediaInfo(DaraModel):
    def __init__(
        self,
        file_info_list: List[main_models.GetMediaResponseBodyMediaInfoFileInfoList] = None,
        media_basic_info: main_models.GetMediaResponseBodyMediaInfoMediaBasicInfo = None,
        media_dynamic_info: main_models.GetMediaResponseBodyMediaInfoMediaDynamicInfo = None,
        media_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FileInfoList') is not None:
            for k1 in m.get('FileInfoList'):
                temp_model = main_models.GetMediaResponseBodyMediaInfoFileInfoList()
                self.file_info_list.append(temp_model.from_map(k1))

        if m.get('MediaBasicInfo') is not None:
            temp_model = main_models.GetMediaResponseBodyMediaInfoMediaBasicInfo()
            self.media_basic_info = temp_model.from_map(m.get('MediaBasicInfo'))

        if m.get('MediaDynamicInfo') is not None:
            temp_model = main_models.GetMediaResponseBodyMediaInfoMediaDynamicInfo()
...
class GetMediaResponseBodyMediaInfoMediaDynamicInfo(DaraModel):
    def __init__(
        self,
        dynamic_meta_data: main_models.GetMediaResponseBodyMediaInfoMediaDynamicInfoDynamicMetaData = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DynamicMetaData') is not None:
            temp_model = main_models.GetMediaResponseBodyMediaInfoMediaDynamicInfoDynamicMetaData()
            self.dynamic_meta_data = temp_model.from_map(m.get('DynamicMetaData'))

        return self

class GetMediaResponseBodyMediaInfoMediaDynamicInfoDynamicMetaData(DaraModel):
    def __init__(
        self,
        data: str = None,
        entity_id: str = None,
...
class GetMediaResponseBodyMediaInfoMediaBasicInfo(DaraModel):
    def __init__(
        self,
...
class GetMediaResponseBodyMediaInfoFileInfoList(DaraModel):
    def __init__(
        self,
        audio_stream_info_list: List[main_models.GetMediaResponseBodyMediaInfoFileInfoListAudioStreamInfoList] = None,
        file_basic_info: main_models.GetMediaResponseBodyMediaInfoFileInfoListFileBasicInfo = None,
        subtitle_stream_info_list: List[main_models.GetMediaResponseBodyMediaInfoFileInfoListSubtitleStreamInfoList] = None,
        video_stream_info_list: List[main_models.GetMediaResponseBodyMediaInfoFileInfoListVideoStreamInfoList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AudioStreamInfoList') is not None:
            for k1 in m.get('AudioStreamInfoList'):
                temp_model = main_models.GetMediaResponseBodyMediaInfoFileInfoListAudioStreamInfoList()
                self.audio_stream_info_list.append(temp_model.from_map(k1))

        if m.get('FileBasicInfo') is not None:
            temp_model = main_models.GetMediaResponseBodyMediaInfoFileInfoListFileBasicInfo()
        ...
        if m.get('SubtitleStreamInfoList') is not None:
            for k1 in m.get('SubtitleStreamInfoList'):
                temp_model = main_models.GetMediaResponseBodyMediaInfoFileInfoListSubtitleStreamInfoList()
        ...
        if m.get('VideoStreamInfoList') is not None:
            for k1 in m.get('VideoStreamInfoList'):
                temp_model = main_models.GetMediaResponseBodyMediaInfoFileInfoListVideoStreamInfoList()
                self.video_stream_info_list.append(temp_model.from_map(k1))

        return self

class GetMediaResponseBodyMediaInfoFileInfoListVideoStreamInfoList(DaraModel):
    def __init__(
        self,
        avg_fps: str = None,
        bitrate: str = None,
...
class GetMediaResponseBodyMediaInfoFileInfoListSubtitleStreamInfoList(DaraModel):
    def __init__(
        self,
        codec_long_name: str = None,
        codec_name: str = None,
...
class GetMediaResponseBodyMediaInfoFileInfoListFileBasicInfo(DaraModel):
    def __init__(
        self,
        bitrate: str = None,
        create_time: str = None,
...
class GetMediaResponseBodyMediaInfoFileInfoListAudioStreamInfoList(DaraModel):
    def __init__(
        self,
        bitrate: str = None,

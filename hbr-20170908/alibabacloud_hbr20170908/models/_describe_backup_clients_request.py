...
class DescribeBackupClientsRequest(DaraModel):
    def __init__(
        ...
        filters: List[main_models.DescribeBackupClientsRequestFilters] = None,
        instance_ids: List[str] = None,
        page_number: int = None,
        page_size: int = None,
        tag: List[main_models.DescribeBackupClientsRequestTag] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Filters') is not None:
            for k1 in m.get('Filters'):
                temp_model = main_models.DescribeBackupClientsRequestFilters()
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.DescribeBackupClientsRequestTag()
                self.tag.append(temp_model.from_map(k1))

        return self

class DescribeBackupClientsRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class DescribeBackupClientsRequestFilters(DaraModel):
    def __init__(
        self,
        key: str = None,

...
class CreateClientsResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        instance_statuses: main_models.CreateClientsResponseBodyInstanceStatuses = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
        task_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InstanceStatuses') is not None:
            temp_model = main_models.CreateClientsResponseBodyInstanceStatuses()
...
class CreateClientsResponseBodyInstanceStatuses(DaraModel):
    def __init__(
        self,
        instance_status: List[main_models.CreateClientsResponseBodyInstanceStatusesInstanceStatus] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InstanceStatus') is not None:
            for k1 in m.get('InstanceStatus'):
                temp_model = main_models.CreateClientsResponseBodyInstanceStatusesInstanceStatus()
                self.instance_status.append(temp_model.from_map(k1))

        return self

class CreateClientsResponseBodyInstanceStatusesInstanceStatus(DaraModel):
    def __init__(
        self,

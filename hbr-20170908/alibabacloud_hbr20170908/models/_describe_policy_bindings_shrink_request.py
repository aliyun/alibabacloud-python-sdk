...
class DescribePolicyBindingsShrinkRequest(DaraModel):
    def __init__(
        self,
        data_source_ids_shrink: str = None,
        filters: List[main_models.DescribePolicyBindingsShrinkRequestFilters] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Filters') is not None:
            for k1 in m.get('Filters'):
                temp_model = main_models.DescribePolicyBindingsShrinkRequestFilters()
...
class DescribePolicyBindingsShrinkRequestFilters(DaraModel):
    def __init__(
        self,
        key: str = None,
        operator: str = None,

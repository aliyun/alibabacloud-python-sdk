...
class UpdatePolicyBindingRequest(DaraModel):
    def __init__(
        self,
        advanced_options: main_models.UpdatePolicyBindingRequestAdvancedOptions = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AdvancedOptions') is not None:
            temp_model = main_models.UpdatePolicyBindingRequestAdvancedOptions()
...
class UpdatePolicyBindingRequestAdvancedOptions(DaraModel):
    def __init__(
        self,
        common_file_system_detail: main_models.UpdatePolicyBindingRequestAdvancedOptionsCommonFileSystemDetail = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CommonFileSystemDetail') is not None:
            temp_model = main_models.UpdatePolicyBindingRequestAdvancedOptionsCommonFileSystemDetail()
            self.common_file_system_detail = temp_model.from_map(m.get('CommonFileSystemDetail'))

        if m.get('OssDetail') is not None:
            temp_model = main_models.UpdatePolicyBindingRequestAdvancedOptionsOssDetail()
            self.oss_detail = temp_model.from_map(m.get('OssDetail'))

        if m.get('UdmDetail') is not None:
            temp_model = main_models.UpdatePolicyBindingRequestAdvancedOptionsUdmDetail()
            self.udm_detail = temp_model.from_map(m.get('UdmDetail'))

        return self

class UpdatePolicyBindingRequestAdvancedOptionsUdmDetail(DaraModel):
    def __init__(
        self,
...
class UpdatePolicyBindingRequestAdvancedOptionsOssDetail(DaraModel):
    def __init__(
        self,
...
class UpdatePolicyBindingRequestAdvancedOptionsCommonFileSystemDetail(DaraModel):
    def __init__(
        self,

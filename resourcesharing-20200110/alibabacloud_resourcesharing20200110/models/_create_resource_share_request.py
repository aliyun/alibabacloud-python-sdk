...
class CreateResourceShareRequest(DaraModel):
    def __init__(
        self,
        ...
        resource_properties: List[main_models.CreateResourceShareRequestResourceProperties] = None,
        resource_share_name: str = None,
        resources: List[main_models.CreateResourceShareRequestResources] = None,
        tag: List[main_models.CreateResourceShareRequestTag] = None,
        target_properties: List[main_models.CreateResourceShareRequestTargetProperties] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceProperties') is not None:
            for k1 in m.get('ResourceProperties'):
                temp_model = main_models.CreateResourceShareRequestResourceProperties()
        ...
        if m.get('Resources') is not None:
            for k1 in m.get('Resources'):
                temp_model = main_models.CreateResourceShareRequestResources()
                self.resources.append(temp_model.from_map(k1))

        self.tag = []
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.CreateResourceShareRequestTag()
                self.tag.append(temp_model.from_map(k1))

        self.target_properties = []
        if m.get('TargetProperties') is not None:
            for k1 in m.get('TargetProperties'):
                temp_model = main_models.CreateResourceShareRequestTargetProperties()
...
class CreateResourceShareRequestTargetProperties(DaraModel):
    def __init__(
        self,
        property: str = None,
        target_id: str = None,
...
class CreateResourceShareRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class CreateResourceShareRequestResources(DaraModel):
    def __init__(
        self,
...
class CreateResourceShareRequestResourceProperties(DaraModel):
    def __init__(
        self,
        property: str = None,

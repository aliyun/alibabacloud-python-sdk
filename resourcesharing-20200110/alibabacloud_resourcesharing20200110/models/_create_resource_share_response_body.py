...
class CreateResourceShareResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        resource_share: main_models.CreateResourceShareResponseBodyResourceShare = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceShare') is not None:
            temp_model = main_models.CreateResourceShareResponseBodyResourceShare()
            self.resource_share = temp_model.from_map(m.get('ResourceShare'))

        return self

class CreateResourceShareResponseBodyResourceShare(DaraModel):
    def __init__(
        self,

...
class DisassociateResourceShareResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        resource_share_associations: List[main_models.DisassociateResourceShareResponseBodyResourceShareAssociations] = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceShareAssociations') is not None:
            for k1 in m.get('ResourceShareAssociations'):
                temp_model = main_models.DisassociateResourceShareResponseBodyResourceShareAssociations()
                self.resource_share_associations.append(temp_model.from_map(k1))

        return self

class DisassociateResourceShareResponseBodyResourceShareAssociations(DaraModel):
    def __init__(
        self,

...
class ListResourceSharePermissionsResponseBody(DaraModel):
    def __init__(
        self,
        next_token: str = None,
        permissions: List[main_models.ListResourceSharePermissionsResponseBodyPermissions] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Permissions') is not None:
            for k1 in m.get('Permissions'):
                temp_model = main_models.ListResourceSharePermissionsResponseBodyPermissions()
...
class ListResourceSharePermissionsResponseBodyPermissions(DaraModel):
    def __init__(
        self,

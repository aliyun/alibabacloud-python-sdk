...
```bash
# 安装 alibabacloud_resourcesharing20200110
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/resourcesharing-20200110/ChangeLog.md)中。

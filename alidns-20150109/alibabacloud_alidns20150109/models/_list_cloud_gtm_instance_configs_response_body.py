...
class ListCloudGtmInstanceConfigsResponseBody(DaraModel):
    def __init__(
        self,
        instance_configs: main_models.ListCloudGtmInstanceConfigsResponseBodyInstanceConfigs = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InstanceConfigs') is not None:
            temp_model = main_models.ListCloudGtmInstanceConfigsResponseBodyInstanceConfigs()
...
class ListCloudGtmInstanceConfigsResponseBodyInstanceConfigs(DaraModel):
    def __init__(
        self,
        instance_config: List[main_models.ListCloudGtmInstanceConfigsResponseBodyInstanceConfigsInstanceConfig] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InstanceConfig') is not None:
            for k1 in m.get('InstanceConfig'):
                temp_model = main_models.ListCloudGtmInstanceConfigsResponseBodyInstanceConfigsInstanceConfig()
                self.instance_config.append(temp_model.from_map(k1))

        return self

class ListCloudGtmInstanceConfigsResponseBodyInstanceConfigsInstanceConfig(DaraModel):
    def __init__(
        self,
        address_pool_lb_strategy: str = None,
        address_pools: main_models.ListCloudGtmInstanceConfigsResponseBodyInstanceConfigsInstanceConfigAddressPools = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AddressPools') is not None:
            temp_model = main_models.ListCloudGtmInstanceConfigsResponseBodyInstanceConfigsInstanceConfigAddressPools()
...
class ListCloudGtmInstanceConfigsResponseBodyInstanceConfigsInstanceConfigAddressPools(DaraModel):
    def __init__(
        self,
        address_pool: List[main_models.ListCloudGtmInstanceConfigsResponseBodyInstanceConfigsInstanceConfigAddressPoolsAddressPool] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AddressPool') is not None:
            for k1 in m.get('AddressPool'):
                temp_model = main_models.ListCloudGtmInstanceConfigsResponseBodyInstanceConfigsInstanceConfigAddressPoolsAddressPool()
                self.address_pool.append(temp_model.from_map(k1))

        return self

class ListCloudGtmInstanceConfigsResponseBodyInstanceConfigsInstanceConfigAddressPoolsAddressPool(DaraModel):
    def __init__(
        self,
        ...
        health_status: str = None,
        request_source: main_models.ListCloudGtmInstanceConfigsResponseBodyInstanceConfigsInstanceConfigAddressPoolsAddressPoolRequestSource = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RequestSource') is not None:
            temp_model = main_models.ListCloudGtmInstanceConfigsResponseBodyInstanceConfigsInstanceConfigAddressPoolsAddressPoolRequestSource()
...
class ListCloudGtmInstanceConfigsResponseBodyInstanceConfigsInstanceConfigAddressPoolsAddressPoolRequestSource(DaraModel):
    def __init__(
        self,

...
class SearchRecursionRecordsResponseBody(DaraModel):
    def __init__(
        self,
        ...
        page_size: int = None,
        records: main_models.SearchRecursionRecordsResponseBodyRecords = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Records') is not None:
            temp_model = main_models.SearchRecursionRecordsResponseBodyRecords()
...
class SearchRecursionRecordsResponseBodyRecords(DaraModel):
    def __init__(
        self,
        record: List[main_models.SearchRecursionRecordsResponseBodyRecordsRecord] = None,
    ):
        self.record = record
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Record') is not None:
            for k1 in m.get('Record'):
                temp_model = main_models.SearchRecursionRecordsResponseBodyRecordsRecord()
                self.record.append(temp_model.from_map(k1))

        return self

class SearchRecursionRecordsResponseBodyRecordsRecord(DaraModel):
    def __init__(
        self,

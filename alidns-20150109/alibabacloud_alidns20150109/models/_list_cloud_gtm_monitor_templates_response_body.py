...
class ListCloudGtmMonitorTemplatesResponseBody(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        request_id: str = None,
        templates: main_models.ListCloudGtmMonitorTemplatesResponseBodyTemplates = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Templates') is not None:
            temp_model = main_models.ListCloudGtmMonitorTemplatesResponseBodyTemplates()
...
class ListCloudGtmMonitorTemplatesResponseBodyTemplates(DaraModel):
    def __init__(
        self,
        template: List[main_models.ListCloudGtmMonitorTemplatesResponseBodyTemplatesTemplate] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Template') is not None:
            for k1 in m.get('Template'):
                temp_model = main_models.ListCloudGtmMonitorTemplatesResponseBodyTemplatesTemplate()
                self.template.append(temp_model.from_map(k1))

        return self

class ListCloudGtmMonitorTemplatesResponseBodyTemplatesTemplate(DaraModel):
    def __init__(
        self,
        ...
        interval: int = None,
        ip_version: str = None,
        isp_city_nodes: main_models.ListCloudGtmMonitorTemplatesResponseBodyTemplatesTemplateIspCityNodes = None,
        name: str = None,
        protocol: str = None,
        remark: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IspCityNodes') is not None:
            temp_model = main_models.ListCloudGtmMonitorTemplatesResponseBodyTemplatesTemplateIspCityNodes()
...
class ListCloudGtmMonitorTemplatesResponseBodyTemplatesTemplateIspCityNodes(DaraModel):
    def __init__(
        self,
        isp_city_node: List[main_models.ListCloudGtmMonitorTemplatesResponseBodyTemplatesTemplateIspCityNodesIspCityNode] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IspCityNode') is not None:
            for k1 in m.get('IspCityNode'):
                temp_model = main_models.ListCloudGtmMonitorTemplatesResponseBodyTemplatesTemplateIspCityNodesIspCityNode()
                self.isp_city_node.append(temp_model.from_map(k1))

        return self

class ListCloudGtmMonitorTemplatesResponseBodyTemplatesTemplateIspCityNodesIspCityNode(DaraModel):
    def __init__(
        self,
        city_code: str = None,
        city_name: str = None,

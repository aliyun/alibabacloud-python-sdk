...
class DescribeDnsGtmLogsResponseBody(DaraModel):
    def __init__(
        self,
        logs: main_models.DescribeDnsGtmLogsResponseBodyLogs = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Logs') is not None:
            temp_model = main_models.DescribeDnsGtmLogsResponseBodyLogs()
...
class DescribeDnsGtmLogsResponseBodyLogs(DaraModel):
    def __init__(
        self,
        log: List[main_models.DescribeDnsGtmLogsResponseBodyLogsLog] = None,
    ):
        self.log = log
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Log') is not None:
            for k1 in m.get('Log'):
                temp_model = main_models.DescribeDnsGtmLogsResponseBodyLogsLog()
                self.log.append(temp_model.from_map(k1))

        return self

class DescribeDnsGtmLogsResponseBodyLogsLog(DaraModel):
    def __init__(
        self,
        content: str = None,
        entity_id: str = None,

...
class ListCloudGtmInstancesResponseBody(DaraModel):
    def __init__(
        self,
        instances: main_models.ListCloudGtmInstancesResponseBodyInstances = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Instances') is not None:
            temp_model = main_models.ListCloudGtmInstancesResponseBodyInstances()
...
class ListCloudGtmInstancesResponseBodyInstances(DaraModel):
    def __init__(
        self,
        instance: List[main_models.ListCloudGtmInstancesResponseBodyInstancesInstance] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Instance') is not None:
            for k1 in m.get('Instance'):
                temp_model = main_models.ListCloudGtmInstancesResponseBodyInstancesInstance()
                self.instance.append(temp_model.from_map(k1))

        return self

class ListCloudGtmInstancesResponseBodyInstancesInstance(DaraModel):
    def __init__(
        self,

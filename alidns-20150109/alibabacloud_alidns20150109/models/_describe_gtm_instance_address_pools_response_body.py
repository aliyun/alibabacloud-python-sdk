...
class DescribeGtmInstanceAddressPoolsResponseBody(DaraModel):
    def __init__(
        self,
        addr_pools: main_models.DescribeGtmInstanceAddressPoolsResponseBodyAddrPools = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AddrPools') is not None:
            temp_model = main_models.DescribeGtmInstanceAddressPoolsResponseBodyAddrPools()
...
class DescribeGtmInstanceAddressPoolsResponseBodyAddrPools(DaraModel):
    def __init__(
        self,
        addr_pool: List[main_models.DescribeGtmInstanceAddressPoolsResponseBodyAddrPoolsAddrPool] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AddrPool') is not None:
            for k1 in m.get('AddrPool'):
                temp_model = main_models.DescribeGtmInstanceAddressPoolsResponseBodyAddrPoolsAddrPool()
                self.addr_pool.append(temp_model.from_map(k1))

        return self

class DescribeGtmInstanceAddressPoolsResponseBodyAddrPoolsAddrPool(DaraModel):
    def __init__(
        self,
        addr_count: int = None,

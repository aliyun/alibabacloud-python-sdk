...
class DescribeCloudGtmAddressReferenceResponseBody(DaraModel):
    def __init__(
        self,
        address: str = None,
        address_id: str = None,
        address_pools: main_models.DescribeCloudGtmAddressReferenceResponseBodyAddressPools = None,
        name: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AddressPools') is not None:
            temp_model = main_models.DescribeCloudGtmAddressReferenceResponseBodyAddressPools()
...
class DescribeCloudGtmAddressReferenceResponseBodyAddressPools(DaraModel):
    def __init__(
        self,
        address_pool: List[main_models.DescribeCloudGtmAddressReferenceResponseBodyAddressPoolsAddressPool] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AddressPool') is not None:
            for k1 in m.get('AddressPool'):
                temp_model = main_models.DescribeCloudGtmAddressReferenceResponseBodyAddressPoolsAddressPool()
                self.address_pool.append(temp_model.from_map(k1))

        return self

class DescribeCloudGtmAddressReferenceResponseBodyAddressPoolsAddressPool(DaraModel):
    def __init__(
        self,
        ...
        instance_configs: main_models.DescribeCloudGtmAddressReferenceResponseBodyAddressPoolsAddressPoolInstanceConfigs = None,
        remark: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InstanceConfigs') is not None:
            temp_model = main_models.DescribeCloudGtmAddressReferenceResponseBodyAddressPoolsAddressPoolInstanceConfigs()
...
class DescribeCloudGtmAddressReferenceResponseBodyAddressPoolsAddressPoolInstanceConfigs(DaraModel):
    def __init__(
        self,
        instance_config: List[main_models.DescribeCloudGtmAddressReferenceResponseBodyAddressPoolsAddressPoolInstanceConfigsInstanceConfig] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InstanceConfig') is not None:
            for k1 in m.get('InstanceConfig'):
                temp_model = main_models.DescribeCloudGtmAddressReferenceResponseBodyAddressPoolsAddressPoolInstanceConfigsInstanceConfig()
                self.instance_config.append(temp_model.from_map(k1))

        return self

class DescribeCloudGtmAddressReferenceResponseBodyAddressPoolsAddressPoolInstanceConfigsInstanceConfig(DaraModel):
    def __init__(
        self,

...
class DeleteAtiRegistrantResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: main_models.DeleteAtiRegistrantResponseBodyAccessDeniedDetail = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AccessDeniedDetail') is not None:
            temp_model = main_models.DeleteAtiRegistrantResponseBodyAccessDeniedDetail()
...
class DeleteAtiRegistrantResponseBodyAccessDeniedDetail(DaraModel):
    def __init__(
        self,

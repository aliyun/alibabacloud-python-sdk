...
class ListRecursionZonesResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Zones') is not None:
            temp_model = main_models.ListRecursionZonesResponseBodyZones()
            self.zones = temp_model.from_map(m.get('Zones'))

        return self

class ListRecursionZonesResponseBodyZones(DaraModel):
    def __init__(
        self,
        zone: List[main_models.ListRecursionZonesResponseBodyZonesZone] = None,
    ):
        self.zone = zone
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Zone') is not None:
            for k1 in m.get('Zone'):
                temp_model = main_models.ListRecursionZonesResponseBodyZonesZone()
                self.zone.append(temp_model.from_map(k1))

        return self

class ListRecursionZonesResponseBodyZonesZone(DaraModel):
    def __init__(
        self,
        ...
        effective_scopes: main_models.ListRecursionZonesResponseBodyZonesZoneEffectiveScopes = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EffectiveScopes') is not None:
            temp_model = main_models.ListRecursionZonesResponseBodyZonesZoneEffectiveScopes()
...
class ListRecursionZonesResponseBodyZonesZoneEffectiveScopes(DaraModel):
    def __init__(
        self,
        effective_scope: List[main_models.ListRecursionZonesResponseBodyZonesZoneEffectiveScopesEffectiveScope] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EffectiveScope') is not None:
            for k1 in m.get('EffectiveScope'):
                temp_model = main_models.ListRecursionZonesResponseBodyZonesZoneEffectiveScopesEffectiveScope()
                self.effective_scope.append(temp_model.from_map(k1))

        return self

class ListRecursionZonesResponseBodyZonesZoneEffectiveScopesEffectiveScope(DaraModel):
    def __init__(
        self,
        effective_type: str = None,
        scopes: main_models.ListRecursionZonesResponseBodyZonesZoneEffectiveScopesEffectiveScopeScopes = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Scopes') is not None:
            temp_model = main_models.ListRecursionZonesResponseBodyZonesZoneEffectiveScopesEffectiveScopeScopes()
            self.scopes = temp_model.from_map(m.get('Scopes'))

        return self

class ListRecursionZonesResponseBodyZonesZoneEffectiveScopesEffectiveScopeScopes(DaraModel):
    def __init__(
        self,
        scope: List[str] = None,
    ):

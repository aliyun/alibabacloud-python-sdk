...
class AddDnsCacheDomainRequest(DaraModel):
    def __init__(
        self,
        ...
        lang: str = None,
        remark: str = None,
        source_dns_server: List[main_models.AddDnsCacheDomainRequestSourceDnsServer] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SourceDnsServer') is not None:
            for k1 in m.get('SourceDnsServer'):
                temp_model = main_models.AddDnsCacheDomainRequestSourceDnsServer()
...
class AddDnsCacheDomainRequestSourceDnsServer(DaraModel):
    def __init__(
        self,
        host: str = None,
        port: str = None,

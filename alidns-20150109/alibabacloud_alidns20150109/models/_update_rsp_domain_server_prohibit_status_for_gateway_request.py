...
class UpdateRspDomainServerProhibitStatusForGatewayRequest(DaraModel):
    def __init__(
        self,
        add_status_list: List[main_models.UpdateRspDomainServerProhibitStatusForGatewayRequestAddStatusList] = None,
        client_token: str = None,
        delete_status_list: List[main_models.UpdateRspDomainServerProhibitStatusForGatewayRequestDeleteStatusList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AddStatusList') is not None:
            for k1 in m.get('AddStatusList'):
                temp_model = main_models.UpdateRspDomainServerProhibitStatusForGatewayRequestAddStatusList()
        ...
        if m.get('DeleteStatusList') is not None:
            for k1 in m.get('DeleteStatusList'):
                temp_model = main_models.UpdateRspDomainServerProhibitStatusForGatewayRequestDeleteStatusList()
...
class UpdateRspDomainServerProhibitStatusForGatewayRequestDeleteStatusList(DaraModel):
    def __init__(
        self,
        status: str = None,
        status_msg: str = None,
...
class UpdateRspDomainServerProhibitStatusForGatewayRequestAddStatusList(DaraModel):
    def __init__(
        self,
        status: str = None,
        status_msg: str = None,

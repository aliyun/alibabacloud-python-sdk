...
class DescribeDomainRecordsResponseBody(DaraModel):
    def __init__(
        self,
        domain_records: main_models.DescribeDomainRecordsResponseBodyDomainRecords = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DomainRecords') is not None:
            temp_model = main_models.DescribeDomainRecordsResponseBodyDomainRecords()
...
class DescribeDomainRecordsResponseBodyDomainRecords(DaraModel):
    def __init__(
        self,
        record: List[main_models.DescribeDomainRecordsResponseBodyDomainRecordsRecord] = None,
    ):
        self.record = record
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Record') is not None:
            for k1 in m.get('Record'):
                temp_model = main_models.DescribeDomainRecordsResponseBodyDomainRecordsRecord()
                self.record.append(temp_model.from_map(k1))

        return self

class DescribeDomainRecordsResponseBodyDomainRecordsRecord(DaraModel):
    def __init__(
        self,

...
class DescribeDohDomainStatisticsSummaryResponseBody(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        request_id: str = None,
        statistics: List[main_models.DescribeDohDomainStatisticsSummaryResponseBodyStatistics] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Statistics') is not None:
            for k1 in m.get('Statistics'):
                temp_model = main_models.DescribeDohDomainStatisticsSummaryResponseBodyStatistics()
...
class DescribeDohDomainStatisticsSummaryResponseBodyStatistics(DaraModel):
    def __init__(
        self,

...
class DescribeInterAuthStatisticsSummaryResponseBody(DaraModel):
    def __init__(
        self,
        cur_page: int = None,
        page_data: List[main_models.DescribeInterAuthStatisticsSummaryResponseBodyPageData] = None,
        page_size: int = None,
        request_id: str = None,
        total_page: int = None,
        total_size: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PageData') is not None:
            for k1 in m.get('PageData'):
                temp_model = main_models.DescribeInterAuthStatisticsSummaryResponseBodyPageData()
...
class DescribeInterAuthStatisticsSummaryResponseBodyPageData(DaraModel):
    def __init__(
        self,

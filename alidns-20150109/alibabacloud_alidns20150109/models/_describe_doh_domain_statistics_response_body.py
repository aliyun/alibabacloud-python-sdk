...
class DescribeDohDomainStatisticsResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        statistics: List[main_models.DescribeDohDomainStatisticsResponseBodyStatistics] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Statistics') is not None:
            for k1 in m.get('Statistics'):
                temp_model = main_models.DescribeDohDomainStatisticsResponseBodyStatistics()
                self.statistics.append(temp_model.from_map(k1))

        return self

class DescribeDohDomainStatisticsResponseBodyStatistics(DaraModel):
    def __init__(
        self,
        timestamp: int = None,

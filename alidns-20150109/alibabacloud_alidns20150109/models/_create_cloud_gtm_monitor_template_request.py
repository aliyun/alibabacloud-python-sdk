...
class CreateCloudGtmMonitorTemplateRequest(DaraModel):
    def __init__(
        self,
        ...
        interval: int = None,
        ip_version: str = None,
        isp_city_nodes: List[main_models.CreateCloudGtmMonitorTemplateRequestIspCityNodes] = None,
        name: str = None,
        protocol: str = None,
        timeout: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IspCityNodes') is not None:
            for k1 in m.get('IspCityNodes'):
                temp_model = main_models.CreateCloudGtmMonitorTemplateRequestIspCityNodes()
...
class CreateCloudGtmMonitorTemplateRequestIspCityNodes(DaraModel):
    def __init__(
        self,
        city_code: str = None,
        isp_code: str = None,

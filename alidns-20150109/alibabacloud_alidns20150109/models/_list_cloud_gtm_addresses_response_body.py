...
class ListCloudGtmAddressesResponseBody(DaraModel):
    def __init__(
        self,
        addresses: main_models.ListCloudGtmAddressesResponseBodyAddresses = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Addresses') is not None:
            temp_model = main_models.ListCloudGtmAddressesResponseBodyAddresses()
...
class ListCloudGtmAddressesResponseBodyAddresses(DaraModel):
    def __init__(
        self,
        address: List[main_models.ListCloudGtmAddressesResponseBodyAddressesAddress] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Address') is not None:
            for k1 in m.get('Address'):
                temp_model = main_models.ListCloudGtmAddressesResponseBodyAddressesAddress()
                self.address.append(temp_model.from_map(k1))

        return self

class ListCloudGtmAddressesResponseBodyAddressesAddress(DaraModel):
    def __init__(
        self,
        address: str = None,
        address_id: str = None,
        ...
        health_tasks: main_models.ListCloudGtmAddressesResponseBodyAddressesAddressHealthTasks = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HealthTasks') is not None:
            temp_model = main_models.ListCloudGtmAddressesResponseBodyAddressesAddressHealthTasks()
...
class ListCloudGtmAddressesResponseBodyAddressesAddressHealthTasks(DaraModel):
    def __init__(
        self,
        health_task: List[main_models.ListCloudGtmAddressesResponseBodyAddressesAddressHealthTasksHealthTask] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HealthTask') is not None:
            for k1 in m.get('HealthTask'):
                temp_model = main_models.ListCloudGtmAddressesResponseBodyAddressesAddressHealthTasksHealthTask()
                self.health_task.append(temp_model.from_map(k1))

        return self

class ListCloudGtmAddressesResponseBodyAddressesAddressHealthTasksHealthTask(DaraModel):
    def __init__(
        self,

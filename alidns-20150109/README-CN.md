...
## Alibaba Cloud Alidns SDK for Python
...
```bash
# 安装 alibabacloud_alidns20150109
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/alidns-20150109/ChangeLog.md)中。

...
class CreateAnnualDocSummaryTaskRequest(DaraModel):
    def __init__(
        self,
        ana_years: List[int] = None,
        doc_infos: List[main_models.CreateAnnualDocSummaryTaskRequestDocInfos] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('docInfos') is not None:
            for k1 in m.get('docInfos'):
                temp_model = main_models.CreateAnnualDocSummaryTaskRequestDocInfos()
...
class CreateAnnualDocSummaryTaskRequestDocInfos(DaraModel):
    def __init__(
        self,
        doc_id: str = None,
        doc_year: int = None,

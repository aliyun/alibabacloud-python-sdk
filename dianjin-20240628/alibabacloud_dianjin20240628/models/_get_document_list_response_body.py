...
class GetDocumentListResponseBody(DaraModel):
    def __init__(
        self,
        cost: int = None,
        data: main_models.GetDocumentListResponseBodyData = None,
        data_type: str = None,
        err_code: str = None,
        message: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.GetDocumentListResponseBodyData()
...
class GetDocumentListResponseBodyData(DaraModel):
    def __init__(
        self,
        current_page: int = None,
        page_size: int = None,
        records: List[main_models.GetDocumentListResponseBodyDataRecords] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('records') is not None:
            for k1 in m.get('records'):
                temp_model = main_models.GetDocumentListResponseBodyDataRecords()
...
class GetDocumentListResponseBodyDataRecords(DaraModel):
    def __init__(
        self,
        doc_id: str = None,

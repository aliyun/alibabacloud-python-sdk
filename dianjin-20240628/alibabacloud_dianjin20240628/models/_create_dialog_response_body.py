...
class CreateDialogResponseBody(DaraModel):
    def __init__(
        self,
        cost: int = None,
        data: main_models.CreateDialogResponseBodyData = None,
        data_type: str = None,
        err_code: str = None,
        message: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.CreateDialogResponseBodyData()
...
class CreateDialogResponseBodyData(DaraModel):
    def __init__(
        self,

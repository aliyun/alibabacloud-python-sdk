...
class RunChatResultGenerationResponseBody(DaraModel):
    def __init__(
        self,
        choices: List[main_models.RunChatResultGenerationResponseBodyChoices] = None,
        created: int = None,
        id: str = None,
        model_id: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('choices') is not None:
            for k1 in m.get('choices'):
                temp_model = main_models.RunChatResultGenerationResponseBodyChoices()
        ...
        if m.get('usage') is not None:
            temp_model = main_models.RunChatResultGenerationResponseBodyUsage()
            self.usage = temp_model.from_map(m.get('usage'))

        return self

class RunChatResultGenerationResponseBodyUsage(DaraModel):
    def __init__(
        self,
...
class RunChatResultGenerationResponseBodyChoices(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('message') is not None:
            temp_model = main_models.RunChatResultGenerationResponseBodyChoicesMessage()
            self.message = temp_model.from_map(m.get('message'))

        return self

class RunChatResultGenerationResponseBodyChoicesMessage(DaraModel):
    def __init__(
        self,
        content: str = None,
        role: str = None,

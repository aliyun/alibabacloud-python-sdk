...
class UpdateLibraryRequest(DaraModel):
    def __init__(
        ...
        index_setting: main_models.UpdateLibraryRequestIndexSetting = None,
        library_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('indexSetting') is not None:
            temp_model = main_models.UpdateLibraryRequestIndexSetting()
...
class UpdateLibraryRequestIndexSetting(DaraModel):
    def __init__(
        self,
        chunk_strategy: main_models.UpdateLibraryRequestIndexSettingChunkStrategy = None,
        model_config: main_models.UpdateLibraryRequestIndexSettingModelConfig = None,
        prompt_role_style: str = None,
        query_enhancer: main_models.UpdateLibraryRequestIndexSettingQueryEnhancer = None,
        recall_strategy: main_models.UpdateLibraryRequestIndexSettingRecallStrategy = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('chunkStrategy') is not None:
            temp_model = main_models.UpdateLibraryRequestIndexSettingChunkStrategy()
            self.chunk_strategy = temp_model.from_map(m.get('chunkStrategy'))

        if m.get('modelConfig') is not None:
            temp_model = main_models.UpdateLibraryRequestIndexSettingModelConfig()
...
class UpdateLibraryRequestIndexSettingTextIndexSetting(DaraModel):
    def __init__(
        self,
        category: str = None,
        enable: bool = None,
...
class UpdateLibraryRequestIndexSettingRecallStrategy(DaraModel):
    def __init__(
        self,
...
class UpdateLibraryRequestIndexSettingQueryEnhancer(DaraModel):
    def __init__(
        self,
...
class UpdateLibraryRequestIndexSettingModelConfig(DaraModel):
    def __init__(
        self,
...
class UpdateLibraryRequestIndexSettingChunkStrategy(DaraModel):
    def __init__(
        self,

...
class RunDialogAnalysisResponseBody(DaraModel):
    def __init__(
        self,
        cost: int = None,
        data: main_models.RunDialogAnalysisResponseBodyData = None,
        data_type: str = None,
        err_code: str = None,
        message: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.RunDialogAnalysisResponseBodyData()
...
class RunDialogAnalysisResponseBodyData(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dialogAnalysisRespList') is not None:
            for k1 in m.get('dialogAnalysisRespList'):
                temp_model = main_models.RunDialogAnalysisResponseBodyDataDialogAnalysisRespList()
                self.dialog_analysis_resp_list.append(temp_model.from_map(k1))

        return self

class RunDialogAnalysisResponseBodyDataDialogAnalysisRespList(DaraModel):
    def __init__(
        self,
        analysis_resp: main_models.RunDialogAnalysisResponseBodyDataDialogAnalysisRespListAnalysisResp = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('analysisResp') is not None:
            temp_model = main_models.RunDialogAnalysisResponseBodyDataDialogAnalysisRespListAnalysisResp()
...
class RunDialogAnalysisResponseBodyDataDialogAnalysisRespListAnalysisResp(DaraModel):
    def __init__(
        self,
        dialog_exec_plan: str = None,
        dialog_labels: List[main_models.RunDialogAnalysisResponseBodyDataDialogAnalysisRespListAnalysisRespDialogLabels] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dialogLabels') is not None:
            for k1 in m.get('dialogLabels'):
                temp_model = main_models.RunDialogAnalysisResponseBodyDataDialogAnalysisRespListAnalysisRespDialogLabels()
...
class RunDialogAnalysisResponseBodyDataDialogAnalysisRespListAnalysisRespDialogLabels(DaraModel):
    def __init__(
        self,
        name: str = None,
        value: str = None,

...
from alibabacloud_dianjin20240628 import end_to_end_real_time_dialog_models as main_models
from darabonba.model import DaraModel

class BizProcessing(DaraModel):
    def __init__(
        self,
        id: str = None,
        choices: List[main_models.BizProcessingChoices] = None,
        created: str = None,
        success: bool = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('choices') is not None:
            for k1 in m.get('choices'):
                temp_model = main_models.BizProcessingChoices()
...
class BizProcessingChoices(DaraModel):
    def __init__(
        self,
        finish_reason: str = None,
        delta: main_models.BizProcessingChoicesDelta = None,
        index: int = None,
        message: main_models.BizProcessingChoicesMessage = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('delta') is not None:
            temp_model = main_models.BizProcessingChoicesDelta()
        ...
        if m.get('message') is not None:
            temp_model = main_models.BizProcessingChoicesMessage()
            self.message = temp_model.from_map(m.get('message'))

        return self

class BizProcessingChoicesMessage(DaraModel):
    def __init__(
        self,
...
class BizProcessingChoicesDelta(DaraModel):
    def __init__(
        self,
        recommend_intention: str = None,
        self_directed_script_full_content: str = None,

...
class RunDialogAnalysisRequest(TeaModel):
    def __init__(
        self,
        session_id: str = None,
    ):
...
class RunDialogAnalysisResponseBodyDataDialogAnalysisRespListAnalysisRespDialogLabels(TeaModel):
    def __init__(
        self,
        name: str = None,
        value: str = None,
...
class RunDialogAnalysisResponseBodyDataDialogAnalysisRespListAnalysisResp(TeaModel):
    def __init__(
        self,
        dialog_exec_plan: str = None,
        dialog_labels: List[RunDialogAnalysisResponseBodyDataDialogAnalysisRespListAnalysisRespDialogLabels] = None,
        dialog_open_analysis: Dict[str, Any] = None,
        dialog_process_analysis: Dict[str, Any] = None,
        dialog_sop: str = None,
        dialog_summary: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dialogLabels') is not None:
            for k in m.get('dialogLabels'):
                temp_model = RunDialogAnalysisResponseBodyDataDialogAnalysisRespListAnalysisRespDialogLabels()
                self.dialog_labels.append(temp_model.from_map(k))
        if m.get('dialogOpenAnalysis') is not None:
            self.dialog_open_analysis = m.get('dialogOpenAnalysis')
        if m.get('dialogProcessAnalysis') is not None:
...
class RunDialogAnalysisResponseBodyDataDialogAnalysisRespList(TeaModel):
    def __init__(
        self,
        analysis_resp: RunDialogAnalysisResponseBodyDataDialogAnalysisRespListAnalysisResp = None,
        fail_node: List[str] = None,
        gmt_create: str = None,
        session_id: str = None,
        status: str = None,
    ):
    ...
    def to_map(self):
        ...
        if self.fail_node is not None:
            result['failNode'] = self.fail_node
        if self.gmt_create is not None:
            result['gmtCreate'] = self.gmt_create
        if self.session_id is not None:
            result['sessionId'] = self.session_id
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('analysisResp') is not None:
            temp_model = RunDialogAnalysisResponseBodyDataDialogAnalysisRespListAnalysisResp()
            self.analysis_resp = temp_model.from_map(m['analysisResp'])
        if m.get('failNode') is not None:
            self.fail_node = m.get('failNode')
        if m.get('gmtCreate') is not None:
            self.gmt_create = m.get('gmtCreate')
        if m.get('sessionId') is not None:
            self.session_id = m.get('sessionId')
...
class RunDialogAnalysisResponseBodyData(TeaModel):
    def __init__(
        self,
        dialog_analysis_resp_list: List[RunDialogAnalysisResponseBodyDataDialogAnalysisRespList] = None,
    ):
        self.dialog_analysis_resp_list = dialog_analysis_resp_list
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dialogAnalysisRespList') is not None:
            for k in m.get('dialogAnalysisRespList'):
                temp_model = RunDialogAnalysisResponseBodyDataDialogAnalysisRespList()
                self.dialog_analysis_resp_list.append(temp_model.from_map(k))
        return self


class RunDialogAnalysisResponseBody(TeaModel):
    def __init__(
        self,
        cost: int = None,
        data: RunDialogAnalysisResponseBodyData = None,
        data_type: str = None,
        err_code: str = None,
        message: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cost') is not None:
            self.cost = m.get('cost')
        if m.get('data') is not None:
            temp_model = RunDialogAnalysisResponseBodyData()
            self.data = temp_model.from_map(m['data'])
        if m.get('dataType') is not None:
            self.data_type = m.get('dataType')
        if m.get('errCode') is not None:
...
class RunDialogAnalysisResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: RunDialogAnalysisResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = RunDialogAnalysisResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

...
class Client(OpenApiClient):
    ...
    *\
    ...
    def end_to_end_real_time_dialog_with_options(
        self,
        workspace_id: str,
        request: dian_jin_20240628_models.EndToEndRealTimeDialogRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ) -> dian_jin_20240628_models.EndToEndRealTimeDialogResponse:
        """
        @summary 端到端实时对话
        ...
        if not UtilClient.is_unset(request.input_format):
        ...
        if not UtilClient.is_unset(request.tts_model_id):
        ...
        params = open_api_models.Params(
            ...
            version='2024-06-28',
            protocol='HTTPS',
            pathname=f'/{OpenApiUtilClient.get_encode_param(workspace_id)}/ws/realtime/dialog',
            method='GET',
            auth_type='AK',
            style='ROA',
            req_body_type='json',
    ...
    def run_dialog_analysis_with_options(
        self,
        workspace_id: str,
        request: dian_jin_20240628_models.RunDialogAnalysisRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ) -> dian_jin_20240628_models.RunDialogAnalysisResponse:
        """
        ...
        params = open_api_models.Params(
            ...
            version='2024-06-28',
            protocol='HTTPS',
            pathname=f'/{OpenApiUtilClient.get_encode_param(workspace_id)}/api/virtualHuman/dialog/stream/analysis',
            method='POST',
            auth_type='AK',
            style='ROA',
            req_body_type='json',

...
class Client(OpenApiClient):
    ...
    *\
    ...
    def image_segmentation_with_options(
        ...
        return image_search_20210120_models.ImageSegmentationResponse().from_map(
    ...
    def general_recognition_with_options(
        ...
        return image_search_20210120_models.GeneralRecognitionResponse().from_map(
    ...
    def commodity_title_with_options(
        ...
        return image_search_20210120_models.CommodityTitleResponse().from_map(

...
class Client(OpenApiClient):
    ...
    *\
    ...
    def image_amazon_with_options(
        self,
        request: image_search_20210120_models.ImageAmazonRequest,
        runtime: util_models.RuntimeOptions,
    ...
    def image_amazon(
        ...
        runtime = util_models.RuntimeOptions()
        return self.image_amazon_with_options(request, runtime)

    async def image_amazon_async(
        self,
        request: image_search_20210120_models.ImageAmazonRequest,
    ) -> image_search_20210120_models.ImageAmazonResponse:
        runtime = util_models.RuntimeOptions()
        return await self.image_amazon_with_options_async(request, runtime)

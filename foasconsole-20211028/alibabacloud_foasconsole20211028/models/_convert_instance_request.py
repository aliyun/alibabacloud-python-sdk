...
class ConvertInstanceRequest(DaraModel):
    def __init__(
        ...
        namespace_resource_specs: List[main_models.ConvertInstanceRequestNamespaceResourceSpecs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NamespaceResourceSpecs') is not None:
            for k1 in m.get('NamespaceResourceSpecs'):
                temp_model = main_models.ConvertInstanceRequestNamespaceResourceSpecs()
...
class ConvertInstanceRequestNamespaceResourceSpecs(DaraModel):
    def __init__(
        self,
        namespace: str = None,
        resource_spec: main_models.ConvertInstanceRequestNamespaceResourceSpecsResourceSpec = None,
    ):
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceSpec') is not None:
            temp_model = main_models.ConvertInstanceRequestNamespaceResourceSpecsResourceSpec()
            self.resource_spec = temp_model.from_map(m.get('ResourceSpec'))

        return self

class ConvertInstanceRequestNamespaceResourceSpecsResourceSpec(DaraModel):
    def __init__(
        self,
        cpu: int = None,
        memory_gb: int = None,

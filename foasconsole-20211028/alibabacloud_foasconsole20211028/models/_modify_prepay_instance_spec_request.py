...
class ModifyPrepayInstanceSpecRequest(DaraModel):
    def __init__(
        self,
        ha: bool = None,
        ha_resource_spec: main_models.ModifyPrepayInstanceSpecRequestHaResourceSpec = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HaResourceSpec') is not None:
            temp_model = main_models.ModifyPrepayInstanceSpecRequestHaResourceSpec()
        ...
        if m.get('ResourceSpec') is not None:
            temp_model = main_models.ModifyPrepayInstanceSpecRequestResourceSpec()
            self.resource_spec = temp_model.from_map(m.get('ResourceSpec'))

        return self

class ModifyPrepayInstanceSpecRequestResourceSpec(DaraModel):
    def __init__(
        self,
        cpu: int = None,
        memory_gb: int = None,
...
class ModifyPrepayInstanceSpecRequestHaResourceSpec(DaraModel):
    def __init__(
        self,
        cpu: int = None,
        memory_gb: int = None,

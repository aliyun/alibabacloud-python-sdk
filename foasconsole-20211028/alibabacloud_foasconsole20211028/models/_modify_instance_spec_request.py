...
class ModifyInstanceSpecRequest(DaraModel):
    def __init__(
        self,
        ha: bool = None,
        ha_resource_spec: main_models.ModifyInstanceSpecRequestHaResourceSpec = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HaResourceSpec') is not None:
            temp_model = main_models.ModifyInstanceSpecRequestHaResourceSpec()
        ...
        if m.get('ResourceSpec') is not None:
            temp_model = main_models.ModifyInstanceSpecRequestResourceSpec()
...
class ModifyInstanceSpecRequestResourceSpec(DaraModel):
    def __init__(
        self,
        cpu: int = None,
        memory_gb: int = None,
...
class ModifyInstanceSpecRequestHaResourceSpec(DaraModel):
    def __init__(
        self,
        cpu: int = None,
        memory_gb: int = None,

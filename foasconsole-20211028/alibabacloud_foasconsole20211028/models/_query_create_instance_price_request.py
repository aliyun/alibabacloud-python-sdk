...
class QueryCreateInstancePriceRequest(DaraModel):
    def __init__(
        ...
        extra: str = None,
        ha: bool = None,
        ha_resource_spec: main_models.QueryCreateInstancePriceRequestHaResourceSpec = None,
        instance_name: str = None,
        pricing_cycle: str = None,
        promotion_code: str = None,
        region: str = None,
        resource_spec: main_models.QueryCreateInstancePriceRequestResourceSpec = None,
        storage: main_models.QueryCreateInstancePriceRequestStorage = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HaResourceSpec') is not None:
            temp_model = main_models.QueryCreateInstancePriceRequestHaResourceSpec()
        ...
        if m.get('ResourceSpec') is not None:
            temp_model = main_models.QueryCreateInstancePriceRequestResourceSpec()
            self.resource_spec = temp_model.from_map(m.get('ResourceSpec'))

        if m.get('Storage') is not None:
            temp_model = main_models.QueryCreateInstancePriceRequestStorage()
...
class QueryCreateInstancePriceRequestStorage(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Oss') is not None:
            temp_model = main_models.QueryCreateInstancePriceRequestStorageOss()
            self.oss = temp_model.from_map(m.get('Oss'))

        return self

class QueryCreateInstancePriceRequestStorageOss(DaraModel):
    def __init__(
        self,
        bucket: str = None,
    ):
...
class QueryCreateInstancePriceRequestResourceSpec(DaraModel):
    def __init__(
        self,
        cpu: int = None,
        memory_gb: int = None,
...
class QueryCreateInstancePriceRequestHaResourceSpec(DaraModel):
    def __init__(
        self,
        cpu: int = None,
        memory_gb: int = None,

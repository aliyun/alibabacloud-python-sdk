...
class ConvertHybridInstanceRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceSpec') is not None:
            temp_model = main_models.ConvertHybridInstanceRequestResourceSpec()
...
class ConvertHybridInstanceRequestResourceSpec(DaraModel):
    def __init__(
        self,
        cpu: int = None,
        memory_gb: int = None,

...
class GetStockOssCheckTasksListResponseBody(DaraModel):
    def __init__(
        self,
        current_page: int = None,
        items: List[main_models.GetStockOssCheckTasksListResponseBodyItems] = None,
        page_size: int = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Items') is not None:
            for k1 in m.get('Items'):
                temp_model = main_models.GetStockOssCheckTasksListResponseBodyItems()
...
class GetStockOssCheckTasksListResponseBodyItems(DaraModel):
    def __init__(
        self,
        buckets: str = None,
        config: main_models.GetStockOssCheckTasksListResponseBodyItemsConfig = None,
        end_time: str = None,
        finish_num: int = None,
        is_inc: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Config') is not None:
            temp_model = main_models.GetStockOssCheckTasksListResponseBodyItemsConfig()
...
class GetStockOssCheckTasksListResponseBodyItemsConfig(DaraModel):
    def __init__(
        self,
        ...
        scan_service_infos: List[main_models.GetStockOssCheckTasksListResponseBodyItemsConfigScanServiceInfos] = None,
        start_time: str = None,
        task_cycle: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ScanServiceInfos') is not None:
            for k1 in m.get('ScanServiceInfos'):
                temp_model = main_models.GetStockOssCheckTasksListResponseBodyItemsConfigScanServiceInfos()
        ...
        if m.get('UserFreezeConfig') is not None:
            temp_model = main_models.GetStockOssCheckTasksListResponseBodyItemsConfigUserFreezeConfig()
            self.user_freeze_config = temp_model.from_map(m.get('UserFreezeConfig'))

        return self

class GetStockOssCheckTasksListResponseBodyItemsConfigUserFreezeConfig(DaraModel):
    def __init__(
        self,
        freeze_restore_path: str = None,
        freeze_type: str = None,
...
class GetStockOssCheckTasksListResponseBodyItemsConfigScanServiceInfos(DaraModel):
    def __init__(
        self,
        copy_from: str = None,
        is_copy: bool = None,

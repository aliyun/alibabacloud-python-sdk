...
class ListAppConfigHistoryResponseBody(DaraModel):
    def __init__(
        self,
        history: List[main_models.ListAppConfigHistoryResponseBodyHistory] = None,
        publish: List[main_models.ListAppConfigHistoryResponseBodyPublish] = None,
        request_id: str = None,
    ):
    ...
    def to_map(self):
        ...
        if self.publish is not None:
            for k1 in self.publish:
                result['Publish'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('History') is not None:
            for k1 in m.get('History'):
                temp_model = main_models.ListAppConfigHistoryResponseBodyHistory()
                self.history.append(temp_model.from_map(k1))

        self.publish = []
        if m.get('Publish') is not None:
            for k1 in m.get('Publish'):
                temp_model = main_models.ListAppConfigHistoryResponseBodyPublish()
                self.publish.append(temp_model.from_map(k1))
...
class ListAppConfigHistoryResponseBodyPublish(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        classify: str = None,
...
class ListAppConfigHistoryResponseBodyHistory(DaraModel):
    def __init__(
        self,
        app_id: str = None,
        classify: str = None,

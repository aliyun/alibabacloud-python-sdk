...
class AddKeywordLibResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.AddKeywordLibResponseBodyData = None,
        msg: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.AddKeywordLibResponseBodyData()
...
class AddKeywordLibResponseBodyData(DaraModel):
    def __init__(
        self,
        keywords_result: main_models.AddKeywordLibResponseBodyDataKeywordsResult = None,
        lib_id: str = None,
        task_id: str = None,
    ):
        # Result.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('KeywordsResult') is not None:
            temp_model = main_models.AddKeywordLibResponseBodyDataKeywordsResult()
...
class AddKeywordLibResponseBodyDataKeywordsResult(DaraModel):
    def __init__(
        self,
        i_18n_key: str = None,

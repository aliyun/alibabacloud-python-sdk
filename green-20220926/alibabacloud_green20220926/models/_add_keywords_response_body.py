...
class AddKeywordsResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.AddKeywordsResponseBodyData = None,
        msg: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.AddKeywordsResponseBodyData()
...
class AddKeywordsResponseBodyData(DaraModel):
    def __init__(
        self,
        keywords_result: main_models.AddKeywordsResponseBodyDataKeywordsResult = None,
        lib_id: str = None,
        task_id: str = None,
    ):
        # Result.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('KeywordsResult') is not None:
            temp_model = main_models.AddKeywordsResponseBodyDataKeywordsResult()
...
class AddKeywordsResponseBodyDataKeywordsResult(DaraModel):
    def __init__(
        self,
        i_18n_key: str = None,

...
```bash
# 安装 alibabacloud_resourcemanager20200331
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/resourcemanager-20200331/ChangeLog.md)中。

...
class ListAutoGroupingRulesResponseBody(DaraModel):
    def __init__(
        self,
        max_results: int = None,
        next_token: str = None,
        request_id: str = None,
        rules: List[main_models.ListAutoGroupingRulesResponseBodyRules] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Rules') is not None:
            for k1 in m.get('Rules'):
                temp_model = main_models.ListAutoGroupingRulesResponseBodyRules()
                self.rules.append(temp_model.from_map(k1))

        return self

class ListAutoGroupingRulesResponseBodyRules(DaraModel):
    def __init__(
        self,
        ...
        rule_contents: List[main_models.ListAutoGroupingRulesResponseBodyRulesRuleContents] = None,
        rule_desc: str = None,
        rule_id: str = None,
        rule_name: str = None,
        rule_type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RuleContents') is not None:
            for k1 in m.get('RuleContents'):
                temp_model = main_models.ListAutoGroupingRulesResponseBodyRulesRuleContents()
...
class ListAutoGroupingRulesResponseBodyRulesRuleContents(DaraModel):
    def __init__(
        self,

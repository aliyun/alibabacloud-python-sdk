...
class CreateResourceGroupResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        resource_group: main_models.CreateResourceGroupResponseBodyResourceGroup = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceGroup') is not None:
            temp_model = main_models.CreateResourceGroupResponseBodyResourceGroup()
            self.resource_group = temp_model.from_map(m.get('ResourceGroup'))

        return self

class CreateResourceGroupResponseBodyResourceGroup(DaraModel):
    def __init__(
        self,
        account_id: str = None,
        ...
        id: str = None,
        name: str = None,
        region_statuses: main_models.CreateResourceGroupResponseBodyResourceGroupRegionStatuses = None,
        status: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RegionStatuses') is not None:
            temp_model = main_models.CreateResourceGroupResponseBodyResourceGroupRegionStatuses()
...
class CreateResourceGroupResponseBodyResourceGroupRegionStatuses(DaraModel):
    def __init__(
        self,
        region_status: List[main_models.CreateResourceGroupResponseBodyResourceGroupRegionStatusesRegionStatus] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RegionStatus') is not None:
            for k1 in m.get('RegionStatus'):
                temp_model = main_models.CreateResourceGroupResponseBodyResourceGroupRegionStatusesRegionStatus()
                self.region_status.append(temp_model.from_map(k1))

        return self

class CreateResourceGroupResponseBodyResourceGroupRegionStatusesRegionStatus(DaraModel):
    def __init__(
        self,
        region_id: str = None,
        status: str = None,

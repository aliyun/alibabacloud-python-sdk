...
class UpdateControlPolicyResponseBody(DaraModel):
    def __init__(
        self,
        control_policy: main_models.UpdateControlPolicyResponseBodyControlPolicy = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ControlPolicy') is not None:
            temp_model = main_models.UpdateControlPolicyResponseBodyControlPolicy()
...
class UpdateControlPolicyResponseBodyControlPolicy(DaraModel):
    def __init__(
        self,

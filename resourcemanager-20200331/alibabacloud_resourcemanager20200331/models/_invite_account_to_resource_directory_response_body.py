...
class InviteAccountToResourceDirectoryResponseBody(DaraModel):
    def __init__(
        self,
        handshake: main_models.InviteAccountToResourceDirectoryResponseBodyHandshake = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Handshake') is not None:
            temp_model = main_models.InviteAccountToResourceDirectoryResponseBodyHandshake()
...
class InviteAccountToResourceDirectoryResponseBodyHandshake(DaraModel):
    def __init__(
        self,

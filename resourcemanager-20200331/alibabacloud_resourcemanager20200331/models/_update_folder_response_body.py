...
class UpdateFolderResponseBody(DaraModel):
    def __init__(
        self,
        folder: main_models.UpdateFolderResponseBodyFolder = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Folder') is not None:
            temp_model = main_models.UpdateFolderResponseBodyFolder()
...
class UpdateFolderResponseBodyFolder(DaraModel):
    def __init__(
        self,

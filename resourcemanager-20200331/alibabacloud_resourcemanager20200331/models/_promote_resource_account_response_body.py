...
class PromoteResourceAccountResponseBody(DaraModel):
    def __init__(
        self,
        account: main_models.PromoteResourceAccountResponseBodyAccount = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Account') is not None:
            temp_model = main_models.PromoteResourceAccountResponseBodyAccount()
...
class PromoteResourceAccountResponseBodyAccount(DaraModel):
    def __init__(
        self,
        account_id: str = None,

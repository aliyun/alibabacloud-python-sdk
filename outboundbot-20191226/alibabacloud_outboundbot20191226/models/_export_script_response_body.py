...
class ExportScriptResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        download_params: main_models.ExportScriptResponseBodyDownloadParams = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DownloadParams') is not None:
            temp_model = main_models.ExportScriptResponseBodyDownloadParams()
...
class ExportScriptResponseBodyDownloadParams(DaraModel):
    def __init__(
        self,

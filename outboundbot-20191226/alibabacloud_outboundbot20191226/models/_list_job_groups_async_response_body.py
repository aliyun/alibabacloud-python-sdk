...
class ListJobGroupsAsyncResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        http_status_code: int = None,
        job_groups: List[main_models.ListJobGroupsAsyncResponseBodyJobGroups] = None,
        message: str = None,
    ...
    def to_map(self):
        ...
        if self.job_groups is not None:
            for k1 in self.job_groups:
                result['JobGroups'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('JobGroups') is not None:
            for k1 in m.get('JobGroups'):
                temp_model = main_models.ListJobGroupsAsyncResponseBodyJobGroups()
                self.job_groups.append(temp_model.from_map(k1))
...
class ListJobGroupsAsyncResponseBodyJobGroups(DaraModel):
    def __init__(
        self,
        creation_time: int = None,
        export_progress: main_models.ListJobGroupsAsyncResponseBodyJobGroupsExportProgress = None,
        ...
        progress: main_models.ListJobGroupsAsyncResponseBodyJobGroupsProgress = None,
        script_id: str = None,
        script_name: str = None,
        script_version: str = None,
        status: str = None,
        strategy: main_models.ListJobGroupsAsyncResponseBodyJobGroupsStrategy = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ExportProgress') is not None:
            temp_model = main_models.ListJobGroupsAsyncResponseBodyJobGroupsExportProgress()
        ...
        if m.get('Progress') is not None:
            temp_model = main_models.ListJobGroupsAsyncResponseBodyJobGroupsProgress()
        ...
        if m.get('Strategy') is not None:
            temp_model = main_models.ListJobGroupsAsyncResponseBodyJobGroupsStrategy()
...
class ListJobGroupsAsyncResponseBodyJobGroupsStrategy(DaraModel):
    def __init__(
        self,
        end_time: int = None,
        start_time: int = None,
...
class ListJobGroupsAsyncResponseBodyJobGroupsProgress(DaraModel):
    def __init__(
        self,
...
class ListJobGroupsAsyncResponseBodyJobGroupsExportProgress(DaraModel):
    def __init__(
        self,

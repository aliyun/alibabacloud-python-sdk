...
class ModifyTagGroupsResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TagGroups') is not None:
            for k1 in m.get('TagGroups'):
                temp_model = main_models.ModifyTagGroupsResponseBodyTagGroups()
                self.tag_groups.append(temp_model.from_map(k1))

        self.tags = []
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.ModifyTagGroupsResponseBodyTags()
                self.tags.append(temp_model.from_map(k1))

        return self

class ModifyTagGroupsResponseBodyTags(DaraModel):
    def __init__(
        self,
        script_id: str = None,
        tag_group: str = None,
...
class ModifyTagGroupsResponseBodyTagGroups(DaraModel):
    def __init__(
        self,
        script_id: str = None,
        tag_group: str = None,

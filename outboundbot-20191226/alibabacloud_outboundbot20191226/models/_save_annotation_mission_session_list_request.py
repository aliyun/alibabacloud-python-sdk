...
class SaveAnnotationMissionSessionListRequest(DaraModel):
    def __init__(
        self,
        agent_id: str = None,
        agent_key: str = None,
        annotation_mission_data_source_type: int = None,
        annotation_mission_session_list: List[main_models.SaveAnnotationMissionSessionListRequestAnnotationMissionSessionList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AnnotationMissionSessionList') is not None:
            for k1 in m.get('AnnotationMissionSessionList'):
                temp_model = main_models.SaveAnnotationMissionSessionListRequestAnnotationMissionSessionList()
...
class SaveAnnotationMissionSessionListRequestAnnotationMissionSessionList(DaraModel):
    def __init__(
        self,
        annotation_mission_chat_list: List[main_models.SaveAnnotationMissionSessionListRequestAnnotationMissionSessionListAnnotationMissionChatList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AnnotationMissionChatList') is not None:
            for k1 in m.get('AnnotationMissionChatList'):
                temp_model = main_models.SaveAnnotationMissionSessionListRequestAnnotationMissionSessionListAnnotationMissionChatList()
...
class SaveAnnotationMissionSessionListRequestAnnotationMissionSessionListAnnotationMissionChatList(DaraModel):
    def __init__(
        self,
        annotation_asr_result: str = None,
        annotation_mission_chat_customization_data_info_list: List[main_models.SaveAnnotationMissionSessionListRequestAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatCustomizationDataInfoList] = None,
        annotation_mission_chat_id: str = None,
        annotation_mission_chat_intent_user_say_info_list: List[main_models.SaveAnnotationMissionSessionListRequestAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatIntentUserSayInfoList] = None,
        annotation_mission_chat_tag_info_list: List[main_models.SaveAnnotationMissionSessionListRequestAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatTagInfoList] = None,
        annotation_mission_chat_vocabulary_info_list: List[main_models.SaveAnnotationMissionSessionListRequestAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatVocabularyInfoList] = None,
        annotation_mission_id: str = None,
        annotation_mission_session_id: str = None,
        annotation_status: int = None,
        answer: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AnnotationMissionChatCustomizationDataInfoList') is not None:
            for k1 in m.get('AnnotationMissionChatCustomizationDataInfoList'):
                temp_model = main_models.SaveAnnotationMissionSessionListRequestAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatCustomizationDataInfoList()
        ...
        if m.get('AnnotationMissionChatIntentUserSayInfoList') is not None:
            for k1 in m.get('AnnotationMissionChatIntentUserSayInfoList'):
                temp_model = main_models.SaveAnnotationMissionSessionListRequestAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatIntentUserSayInfoList()
        ...
        if m.get('AnnotationMissionChatTagInfoList') is not None:
            for k1 in m.get('AnnotationMissionChatTagInfoList'):
                temp_model = main_models.SaveAnnotationMissionSessionListRequestAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatTagInfoList()
        ...
        if m.get('AnnotationMissionChatVocabularyInfoList') is not None:
            for k1 in m.get('AnnotationMissionChatVocabularyInfoList'):
                temp_model = main_models.SaveAnnotationMissionSessionListRequestAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatVocabularyInfoList()
...
class SaveAnnotationMissionSessionListRequestAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatVocabularyInfoList(DaraModel):
    def __init__(
        self,
        annotation_mission_chat_id: str = None,
...
class SaveAnnotationMissionSessionListRequestAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatTagInfoList(DaraModel):
    def __init__(
        self,
        annotation_mission_chat_id: str = None,
...
class SaveAnnotationMissionSessionListRequestAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatIntentUserSayInfoList(DaraModel):
    def __init__(
        self,
        annotation_mission_chat_id: str = None,
...
class SaveAnnotationMissionSessionListRequestAnnotationMissionSessionListAnnotationMissionChatListAnnotationMissionChatCustomizationDataInfoList(DaraModel):
    def __init__(
        self,

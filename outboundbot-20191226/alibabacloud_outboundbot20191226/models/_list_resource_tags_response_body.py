...
class ListResourceTagsResponseBody(DaraModel):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceTags') is not None:
            temp_model = main_models.ListResourceTagsResponseBodyResourceTags()
...
class ListResourceTagsResponseBodyResourceTags(DaraModel):
    def __init__(
        self,
        list: List[main_models.ListResourceTagsResponseBodyResourceTagsList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            for k1 in m.get('List'):
                temp_model = main_models.ListResourceTagsResponseBodyResourceTagsList()
...
class ListResourceTagsResponseBodyResourceTagsList(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

...
class DownloadScriptRecordingResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        download_params: main_models.DownloadScriptRecordingResponseBodyDownloadParams = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DownloadParams') is not None:
            temp_model = main_models.DownloadScriptRecordingResponseBodyDownloadParams()
...
class DownloadScriptRecordingResponseBodyDownloadParams(DaraModel):
    def __init__(
        self,
        file_name: str = None,

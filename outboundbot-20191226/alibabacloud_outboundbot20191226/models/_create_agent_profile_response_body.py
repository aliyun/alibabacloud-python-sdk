...
class CreateAgentProfileResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.CreateAgentProfileResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CreateAgentProfileResponseBodyData()
...
class CreateAgentProfileResponseBodyData(DaraModel):
    def __init__(
        self,

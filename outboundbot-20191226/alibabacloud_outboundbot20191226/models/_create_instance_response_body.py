...
class CreateInstanceResponseBody(DaraModel):
    def __init__(
        ...
        instance: main_models.CreateInstanceResponseBodyInstance = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Instance') is not None:
            temp_model = main_models.CreateInstanceResponseBodyInstance()
...
class CreateInstanceResponseBodyInstance(DaraModel):
    def __init__(
        self,

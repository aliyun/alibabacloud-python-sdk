...
class DescribeScriptVoiceConfigResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ScriptVoiceConfig') is not None:
            temp_model = main_models.DescribeScriptVoiceConfigResponseBodyScriptVoiceConfig()
...
class DescribeScriptVoiceConfigResponseBodyScriptVoiceConfig(DaraModel):
    def __init__(
        self,

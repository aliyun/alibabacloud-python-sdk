...
class ModifyBeebotIntentUserSayRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserSayDefinition') is not None:
            temp_model = main_models.ModifyBeebotIntentUserSayRequestUserSayDefinition()
...
class ModifyBeebotIntentUserSayRequestUserSayDefinition(DaraModel):
    def __init__(
        self,
        content: str = None,
        intent_id: int = None,

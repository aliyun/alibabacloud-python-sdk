...
class ModifyInstanceResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        http_status_code: int = None,
        instance: main_models.ModifyInstanceResponseBodyInstance = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Instance') is not None:
            temp_model = main_models.ModifyInstanceResponseBodyInstance()
...
class ModifyInstanceResponseBodyInstance(DaraModel):
    def __init__(
        self,

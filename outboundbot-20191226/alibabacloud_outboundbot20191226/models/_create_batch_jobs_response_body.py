...
class CreateBatchJobsResponseBody(DaraModel):
    def __init__(
        self,
        batch_job: main_models.CreateBatchJobsResponseBodyBatchJob = None,
        code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BatchJob') is not None:
            temp_model = main_models.CreateBatchJobsResponseBodyBatchJob()
            self.batch_job = temp_model.from_map(m.get('BatchJob'))
...
class CreateBatchJobsResponseBodyBatchJob(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Strategy') is not None:
            temp_model = main_models.CreateBatchJobsResponseBodyBatchJobStrategy()
            self.strategy = temp_model.from_map(m.get('Strategy'))

        return self

class CreateBatchJobsResponseBodyBatchJobStrategy(DaraModel):
    def __init__(
        self,
        customized: str = None,
        end_time: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('WorkingTime') is not None:
            for k1 in m.get('WorkingTime'):
                temp_model = main_models.CreateBatchJobsResponseBodyBatchJobStrategyWorkingTime()
                self.working_time.append(temp_model.from_map(k1))

        return self

class CreateBatchJobsResponseBodyBatchJobStrategyWorkingTime(DaraModel):
    def __init__(
        self,
        begin_time: str = None,
        end_time: str = None,

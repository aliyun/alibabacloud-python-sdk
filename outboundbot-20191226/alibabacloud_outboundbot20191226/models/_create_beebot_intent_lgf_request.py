...
class CreateBeebotIntentLgfRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LgfDefinition') is not None:
            temp_model = main_models.CreateBeebotIntentLgfRequestLgfDefinition()
...
class CreateBeebotIntentLgfRequestLgfDefinition(DaraModel):
    def __init__(
        self,
        intent_id: int = None,
        rule_text: str = None,

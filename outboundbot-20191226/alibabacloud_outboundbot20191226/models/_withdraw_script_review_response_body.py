...
class WithdrawScriptReviewResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        ...
        message: str = None,
        request_id: str = None,
        script: main_models.WithdrawScriptReviewResponseBodyScript = None,
        success: bool = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Script') is not None:
            temp_model = main_models.WithdrawScriptReviewResponseBodyScript()
...
class WithdrawScriptReviewResponseBodyScript(DaraModel):
    def __init__(
        self,

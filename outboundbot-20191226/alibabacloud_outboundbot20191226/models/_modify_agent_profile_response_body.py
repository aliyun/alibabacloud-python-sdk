...
class ModifyAgentProfileResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ModifyAgentProfileResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ModifyAgentProfileResponseBodyData()
...
class ModifyAgentProfileResponseBodyData(DaraModel):
    def __init__(
        self,

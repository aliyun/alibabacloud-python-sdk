...
class GetMcpServiceResponseBody(DaraModel):
    def __init__(
        self,
        mcp_service: main_models.GetMcpServiceResponseBodyMcpService = None,
        region_id: str = None,
        request_id: str = None,
    ):
    ...
    def to_map(self):
        ...
        if self.mcp_service is not None:
            result['mcpService'] = self.mcp_service.to_map()
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('mcpService') is not None:
            temp_model = main_models.GetMcpServiceResponseBodyMcpService()
            self.mcp_service = temp_model.from_map(m.get('mcpService'))
...
class GetMcpServiceResponseBodyMcpService(DaraModel):
    def __init__(
        self,
        connection: main_models.GetMcpServiceResponseBodyMcpServiceConnection = None,
        description: str = None,
        display_name: str = None,
        enable: bool = None,
        mcp_service_name: str = None,
        network: main_models.GetMcpServiceResponseBodyMcpServiceNetwork = None,
        tools: List[main_models.GetMcpServiceResponseBodyMcpServiceTools] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('connection') is not None:
            temp_model = main_models.GetMcpServiceResponseBodyMcpServiceConnection()
        ...
        if m.get('network') is not None:
            temp_model = main_models.GetMcpServiceResponseBodyMcpServiceNetwork()
            self.network = temp_model.from_map(m.get('network'))

        self.tools = []
        if m.get('tools') is not None:
            for k1 in m.get('tools'):
                temp_model = main_models.GetMcpServiceResponseBodyMcpServiceTools()
                self.tools.append(temp_model.from_map(k1))

        return self

class GetMcpServiceResponseBodyMcpServiceTools(DaraModel):
    def __init__(
        self,
...
class GetMcpServiceResponseBodyMcpServiceNetwork(DaraModel):
    def __init__(
        self,
        access_ip: str = None,
...
class GetMcpServiceResponseBodyMcpServiceConnection(DaraModel):
    def __init__(
        self,
        auth: main_models.GetMcpServiceResponseBodyMcpServiceConnectionAuth = None,
        endpoint: str = None,
        platform: str = None,
        timeout: int = None,
        transport: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('auth') is not None:
            temp_model = main_models.GetMcpServiceResponseBodyMcpServiceConnectionAuth()
...
class GetMcpServiceResponseBodyMcpServiceConnectionAuth(DaraModel):
    def __init__(
        self,

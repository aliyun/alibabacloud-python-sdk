...
class UpdateMcpServiceRequest(DaraModel):
    def __init__(
        self,
        connection: main_models.UpdateMcpServiceRequestConnection = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('connection') is not None:
            temp_model = main_models.UpdateMcpServiceRequestConnection()
        ...
        if m.get('network') is not None:
            temp_model = main_models.UpdateMcpServiceRequestNetwork()
            self.network = temp_model.from_map(m.get('network'))

        self.tools = []
        if m.get('tools') is not None:
            for k1 in m.get('tools'):
                temp_model = main_models.UpdateMcpServiceRequestTools()
                self.tools.append(temp_model.from_map(k1))

        return self

class UpdateMcpServiceRequestTools(DaraModel):
    def __init__(
        self,
...
class UpdateMcpServiceRequestNetwork(DaraModel):
    def __init__(
        self,
        access_ip: str = None,
...
class UpdateMcpServiceRequestConnection(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('auth') is not None:
            temp_model = main_models.UpdateMcpServiceRequestConnectionAuth()
...
class UpdateMcpServiceRequestConnectionAuth(DaraModel):
    def __init__(
        self,

...
## Alibaba Cloud STAROps SDK for Python
...
```bash
# 安装 alibabacloud_starops20260428
pip install alibabacloud_starops20260428
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/starops-20260428/ChangeLog.md)中。

...
class UpdateDataLakePartitionRequest(DaraModel):
    def __init__(
        self,
        catalog_name: str = None,
        data_region: str = None,
        db_name: str = None,
        partition_input: main_models.DLPartitionInput = None,
        table_name: str = None,
        tid: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PartitionInput') is not None:
            ...
            self.partition_input = temp_model.from_map(m.get('PartitionInput'))

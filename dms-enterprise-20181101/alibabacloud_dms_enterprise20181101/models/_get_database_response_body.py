...
class GetDatabaseResponseBodyDatabase(DaraModel):
    def __init__(
        ...
        owner_id_list: main_models.GetDatabaseResponseBodyDatabaseOwnerIdList = None,
        owner_name_list: main_models.GetDatabaseResponseBodyDatabaseOwnerNameList = None,
        port: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OwnerIdList') is not None:
            temp_model = main_models.GetDatabaseResponseBodyDatabaseOwnerIdList()
            self.owner_id_list = temp_model.from_map(m.get('OwnerIdList'))

        if m.get('OwnerNameList') is not None:
            temp_model = main_models.GetDatabaseResponseBodyDatabaseOwnerNameList()
...
class GetDatabaseResponseBodyDatabaseOwnerNameList(DaraModel):
    def __init__(
        self,
...
class GetDatabaseResponseBodyDatabaseOwnerIdList(DaraModel):
    def __init__(
        self,

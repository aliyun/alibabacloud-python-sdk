...
class GetInstanceResponseBodyInstance(DaraModel):
    def __init__(
        ...
        owner_id_list: main_models.GetInstanceResponseBodyInstanceOwnerIdList = None,
        owner_name_list: main_models.GetInstanceResponseBodyInstanceOwnerNameList = None,
        port: int = None,
        ...
        sell_trust: str = None,
        sid: str = None,
        standard_group: main_models.GetInstanceResponseBodyInstanceStandardGroup = None,
        state: str = None,
        use_dsql: int = None,
        vpc_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OwnerIdList') is not None:
            temp_model = main_models.GetInstanceResponseBodyInstanceOwnerIdList()
            self.owner_id_list = temp_model.from_map(m.get('OwnerIdList'))

        if m.get('OwnerNameList') is not None:
            temp_model = main_models.GetInstanceResponseBodyInstanceOwnerNameList()
        ...
        if m.get('StandardGroup') is not None:
            temp_model = main_models.GetInstanceResponseBodyInstanceStandardGroup()
...
class GetInstanceResponseBodyInstanceStandardGroup(DaraModel):
    def __init__(
        self,
        group_mode: str = None,
        group_name: str = None,
...
class GetInstanceResponseBodyInstanceOwnerNameList(DaraModel):
    def __init__(
        self,
...
class GetInstanceResponseBodyInstanceOwnerIdList(DaraModel):
    def __init__(
        self,

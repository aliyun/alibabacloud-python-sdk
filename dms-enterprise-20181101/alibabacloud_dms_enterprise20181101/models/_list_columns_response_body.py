...
class ListColumnsResponseBody(DaraModel):
    def __init__(
        self,
        column_list: main_models.ListColumnsResponseBodyColumnList = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ColumnList') is not None:
            temp_model = main_models.ListColumnsResponseBodyColumnList()
...
class ListColumnsResponseBodyColumnList(DaraModel):
    def __init__(
        self,
        column: List[main_models.ListColumnsResponseBodyColumnListColumn] = None,
    ):
        self.column = column
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Column') is not None:
            for k1 in m.get('Column'):
                temp_model = main_models.ListColumnsResponseBodyColumnListColumn()
                self.column.append(temp_model.from_map(k1))

        return self

class ListColumnsResponseBodyColumnListColumn(DaraModel):
    def __init__(
        self,

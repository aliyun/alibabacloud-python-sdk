...
class ListWorkspaceUsersResponseBody(DaraModel):
    def __init__(
        self,
        data: List[main_models.ListWorkspaceUsersResponseBodyData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListWorkspaceUsersResponseBodyData()
...
class ListWorkspaceUsersResponseBodyData(DaraModel):
    def __init__(
        self,
        dms_user_id: int = None,
        login_name: str = None,
        nick_name: str = None,
    ):
        # dms user id

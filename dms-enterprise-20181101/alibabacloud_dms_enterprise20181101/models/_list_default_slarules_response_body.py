...
class ListDefaultSLARulesResponseBody(DaraModel):
    def __init__(
        self,
        error_code: str = None,
        error_message: str = None,
        request_id: str = None,
        slarule_list: main_models.ListDefaultSLARulesResponseBodySLARuleList = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SLARuleList') is not None:
            temp_model = main_models.ListDefaultSLARulesResponseBodySLARuleList()
...
class ListDefaultSLARulesResponseBodySLARuleList(DaraModel):
    def __init__(
        self,
        slarule: List[main_models.ListDefaultSLARulesResponseBodySLARuleListSLARule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SLARule') is not None:
            for k1 in m.get('SLARule'):
                temp_model = main_models.ListDefaultSLARulesResponseBodySLARuleListSLARule()
                self.slarule.append(temp_model.from_map(k1))

        return self

class ListDefaultSLARulesResponseBodySLARuleListSLARule(DaraModel):
    def __init__(
        self,
        dag_id: int = None,
        id: int = None,

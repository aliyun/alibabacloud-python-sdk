...
class ListStandardGroupsResponseBody(DaraModel):
    def __init__(
        self,
        error_code: str = None,
        error_message: str = None,
        request_id: str = None,
        standard_group_list: List[main_models.ListStandardGroupsResponseBodyStandardGroupList] = None,
        success: bool = None,
    ):
    ...
    def validate(self):
        if self.standard_group_list:
            for v1 in self.standard_group_list:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.standard_group_list is not None:
            for k1 in self.standard_group_list:
                result['StandardGroupList'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('StandardGroupList') is not None:
            for k1 in m.get('StandardGroupList'):
                temp_model = main_models.ListStandardGroupsResponseBodyStandardGroupList()
                self.standard_group_list.append(temp_model.from_map(k1))
...
class ListStandardGroupsResponseBodyStandardGroupList(DaraModel):
    def __init__(
        self,
        db_type: str = None,

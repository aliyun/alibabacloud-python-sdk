...
class UpdateStandardGroupResponseBody(DaraModel):
    def __init__(
        self,
        error_code: str = None,
        error_message: str = None,
        request_id: str = None,
        standard_group: main_models.UpdateStandardGroupResponseBodyStandardGroup = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('StandardGroup') is not None:
            temp_model = main_models.UpdateStandardGroupResponseBodyStandardGroup()
...
class UpdateStandardGroupResponseBodyStandardGroup(DaraModel):
    def __init__(
        self,
        db_type: str = None,

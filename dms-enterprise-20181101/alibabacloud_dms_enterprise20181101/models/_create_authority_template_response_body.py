...
class CreateAuthorityTemplateResponseBody(DaraModel):
    def __init__(
        self,
        authority_template_view: main_models.CreateAuthorityTemplateResponseBodyAuthorityTemplateView = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AuthorityTemplateView') is not None:
            temp_model = main_models.CreateAuthorityTemplateResponseBodyAuthorityTemplateView()
...
class CreateAuthorityTemplateResponseBodyAuthorityTemplateView(DaraModel):
    def __init__(
        self,

...
class CreateDataLakeTableRequest(DaraModel):
    def __init__(
        self,
        catalog_name: str = None,
        data_region: str = None,
        db_name: str = None,
        table_input: main_models.OpenStructDLTableInput = None,
        tid: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TableInput') is not None:
            temp_model = main_models.OpenStructDLTableInput()
            self.table_input = temp_model.from_map(m.get('TableInput'))

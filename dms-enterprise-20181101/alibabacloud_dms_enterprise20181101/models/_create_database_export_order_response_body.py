...
class CreateDatabaseExportOrderResponseBody(DaraModel):
    def __init__(
        self,
        create_order_result: main_models.CreateDatabaseExportOrderResponseBodyCreateOrderResult = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CreateOrderResult') is not None:
            temp_model = main_models.CreateDatabaseExportOrderResponseBodyCreateOrderResult()
...
class CreateDatabaseExportOrderResponseBodyCreateOrderResult(DaraModel):
    def __init__(
        self,

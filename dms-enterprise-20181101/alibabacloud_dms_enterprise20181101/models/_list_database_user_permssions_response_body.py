...
class ListDatabaseUserPermssionsResponseBody(DaraModel):
    def __init__(
        self,
        error_code: str = None,
        ...
        user_permissions: main_models.ListDatabaseUserPermssionsResponseBodyUserPermissions = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserPermissions') is not None:
            temp_model = main_models.ListDatabaseUserPermssionsResponseBodyUserPermissions()
            self.user_permissions = temp_model.from_map(m.get('UserPermissions'))

        return self

class ListDatabaseUserPermssionsResponseBodyUserPermissions(DaraModel):
    def __init__(
        self,
        user_permission: List[main_models.ListDatabaseUserPermssionsResponseBodyUserPermissionsUserPermission] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserPermission') is not None:
            for k1 in m.get('UserPermission'):
                temp_model = main_models.ListDatabaseUserPermssionsResponseBodyUserPermissionsUserPermission()
                self.user_permission.append(temp_model.from_map(k1))

        return self

class ListDatabaseUserPermssionsResponseBodyUserPermissionsUserPermission(DaraModel):
    def __init__(
        self,
        alias: str = None,
        ...
        logic: bool = None,
        perm_details: main_models.ListDatabaseUserPermssionsResponseBodyUserPermissionsUserPermissionPermDetails = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PermDetails') is not None:
            temp_model = main_models.ListDatabaseUserPermssionsResponseBodyUserPermissionsUserPermissionPermDetails()
...
class ListDatabaseUserPermssionsResponseBodyUserPermissionsUserPermissionPermDetails(DaraModel):
    def __init__(
        self,
        perm_detail: List[main_models.ListDatabaseUserPermssionsResponseBodyUserPermissionsUserPermissionPermDetailsPermDetail] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PermDetail') is not None:
            for k1 in m.get('PermDetail'):
                temp_model = main_models.ListDatabaseUserPermssionsResponseBodyUserPermissionsUserPermissionPermDetailsPermDetail()
                self.perm_detail.append(temp_model.from_map(k1))

        return self

class ListDatabaseUserPermssionsResponseBodyUserPermissionsUserPermissionPermDetailsPermDetail(DaraModel):
    def __init__(
        self,

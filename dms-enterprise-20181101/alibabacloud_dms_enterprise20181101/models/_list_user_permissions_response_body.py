...
class ListUserPermissionsResponseBody(DaraModel):
    def __init__(
        self,
        error_code: str = None,
        ...
        user_permissions: main_models.ListUserPermissionsResponseBodyUserPermissions = None,
    ):
        # The error code.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserPermissions') is not None:
            temp_model = main_models.ListUserPermissionsResponseBodyUserPermissions()
            self.user_permissions = temp_model.from_map(m.get('UserPermissions'))

        return self

class ListUserPermissionsResponseBodyUserPermissions(DaraModel):
    def __init__(
        self,
        user_permission: List[main_models.ListUserPermissionsResponseBodyUserPermissionsUserPermission] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserPermission') is not None:
            for k1 in m.get('UserPermission'):
                temp_model = main_models.ListUserPermissionsResponseBodyUserPermissionsUserPermission()
                self.user_permission.append(temp_model.from_map(k1))

        return self

class ListUserPermissionsResponseBodyUserPermissionsUserPermission(DaraModel):
    def __init__(
        self,
        alias: str = None,
        ...
        logic: bool = None,
        perm_details: main_models.ListUserPermissionsResponseBodyUserPermissionsUserPermissionPermDetails = None,
        port: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PermDetails') is not None:
            temp_model = main_models.ListUserPermissionsResponseBodyUserPermissionsUserPermissionPermDetails()
...
class ListUserPermissionsResponseBodyUserPermissionsUserPermissionPermDetails(DaraModel):
    def __init__(
        self,
        perm_detail: List[main_models.ListUserPermissionsResponseBodyUserPermissionsUserPermissionPermDetailsPermDetail] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PermDetail') is not None:
            for k1 in m.get('PermDetail'):
                temp_model = main_models.ListUserPermissionsResponseBodyUserPermissionsUserPermissionPermDetailsPermDetail()
                self.perm_detail.append(temp_model.from_map(k1))

        return self

class ListUserPermissionsResponseBodyUserPermissionsUserPermissionPermDetailsPermDetail(DaraModel):
    def __init__(
        self,

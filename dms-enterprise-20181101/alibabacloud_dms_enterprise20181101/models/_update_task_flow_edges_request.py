...
class UpdateTaskFlowEdgesRequest(DaraModel):
    def __init__(
        self,
        dag_id: int = None,
        edges: List[main_models.UpdateTaskFlowEdgesRequestEdges] = None,
        tid: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Edges') is not None:
            for k1 in m.get('Edges'):
                temp_model = main_models.UpdateTaskFlowEdgesRequestEdges()
...
class UpdateTaskFlowEdgesRequestEdges(DaraModel):
    def __init__(
        self,
        id: int = None,
        node_end: int = None,

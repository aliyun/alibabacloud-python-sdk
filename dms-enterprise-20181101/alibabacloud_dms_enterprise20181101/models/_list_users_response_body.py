...
class ListUsersResponseBody(DaraModel):
    def __init__(
        ...
        user_list: main_models.ListUsersResponseBodyUserList = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UserList') is not None:
            temp_model = main_models.ListUsersResponseBodyUserList()
            self.user_list = temp_model.from_map(m.get('UserList'))

        return self

class ListUsersResponseBodyUserList(DaraModel):
    def __init__(
        self,
        user: List[main_models.ListUsersResponseBodyUserListUser] = None,
    ):
        self.user = user
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('User') is not None:
            for k1 in m.get('User'):
                temp_model = main_models.ListUsersResponseBodyUserListUser()
                self.user.append(temp_model.from_map(k1))

        return self

class ListUsersResponseBodyUserListUser(DaraModel):
    def __init__(
        self,
        ...
        parent_uid: str = None,
        role_id_list: main_models.ListUsersResponseBodyUserListUserRoleIdList = None,
        role_name_list: main_models.ListUsersResponseBodyUserListUserRoleNameList = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RoleIdList') is not None:
            temp_model = main_models.ListUsersResponseBodyUserListUserRoleIdList()
            self.role_id_list = temp_model.from_map(m.get('RoleIdList'))

        if m.get('RoleNameList') is not None:
            temp_model = main_models.ListUsersResponseBodyUserListUserRoleNameList()
...
class ListUsersResponseBodyUserListUserRoleNameList(DaraModel):
    def __init__(
        self,
...
class ListUsersResponseBodyUserListUserRoleIdList(DaraModel):
    def __init__(
        self,

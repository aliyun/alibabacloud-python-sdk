...
class SearchDataTrackResultRequest(DaraModel):
    def __init__(
        self,
        column_filter: main_models.SearchDataTrackResultRequestColumnFilter = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ColumnFilter') is not None:
            temp_model = main_models.SearchDataTrackResultRequestColumnFilter()
...
class SearchDataTrackResultRequestColumnFilter(DaraModel):
    def __init__(
        self,

...
class DescribeEventMetaInfoResponseBody(DaraModel):
    def __init__(
        self,
        items: List[main_models.DescribeEventMetaInfoResponseBodyItems] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Items') is not None:
            for k1 in m.get('Items'):
                temp_model = main_models.DescribeEventMetaInfoResponseBodyItems()
...
class DescribeEventMetaInfoResponseBodyItems(DaraModel):
    def __init__(
        self,
        code: str = None,

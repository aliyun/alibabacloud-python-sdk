...
class DescribeDtsJobsResponseBodyDtsJobList(DaraModel):
    def __init__(
        ...
        time_window_data_check_status: main_models.DescribeDtsJobsResponseBodyDtsJobListTimeWindowDataCheckStatus = None,
    ):
        # Indicates whether the instance uses the new version of change tracking. The value **new** indicates the new version.
        # > This parameter is returned only for new-version change tracking instances.
        self.app_name = app_name
        ...
        # The tag collection.
        self.tag_list = tag_list
        self.time_window_data_check_status = time_window_data_check_status
    ...
    def validate(self):
        ...
        if self.tag_list:
            for v1 in self.tag_list:
                 if v1:
                    v1.validate()
        if self.time_window_data_check_status:
            self.time_window_data_check_status.validate()
    ...
    def to_map(self):
        ...
        if self.time_window_data_check_status is not None:
            result['TimeWindowDataCheckStatus'] = self.time_window_data_check_status.to_map()
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TimeWindowDataCheckStatus') is not None:
            temp_model = main_models.DescribeDtsJobsResponseBodyDtsJobListTimeWindowDataCheckStatus()
            self.time_window_data_check_status = temp_model.from_map(m.get('TimeWindowDataCheckStatus'))

        return self

class DescribeDtsJobsResponseBodyDtsJobListTimeWindowDataCheckStatus(DaraModel):
    def __init__(
        self,
        error_message: str = None,
        percent: str = None,
...
class DescribeDtsJobsResponseBodyDtsJobListReverseJobMigrationMode(DaraModel):
    def __init__(
        ...
        # - **false**: No.
        self.structure_initialization = structure_initialization
        self.time_window_check = time_window_check
    ...
    def to_map(self):
        ...
        if self.time_window_check is not None:
            result['TimeWindowCheck'] = self.time_window_check
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TimeWindowCheck') is not None:
            self.time_window_check = m.get('TimeWindowCheck')

...
class InvokeServiceInstanceOperationAPIRequest(TeaModel):
    def __init__(
        ...
        region_id: str = None,
        operation_product: str = None,
        operation_action: str = None,
        operation_version: str = None,
        operation_parameters: str = None,
    ):
        self.service_instance_id = service_instance_id
        self.region_id = region_id
        self.operation_product = operation_product
...
class InvokeServiceInstanceOperationAPIResponse(TeaModel):
    def __init__(
        ...
        body: InvokeServiceInstanceOperationAPIResponseBody = None,
    ):

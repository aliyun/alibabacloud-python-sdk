...
class DescribeLoghubDetailResponseBody(DaraModel):
    def __init__(
        self,
        loghub_info: main_models.DescribeLoghubDetailResponseBodyLoghubInfo = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LoghubInfo') is not None:
            temp_model = main_models.DescribeLoghubDetailResponseBodyLoghubInfo()
...
class DescribeLoghubDetailResponseBodyLoghubInfo(DaraModel):
    def __init__(
        self,
        ...
        log_hub_stores: main_models.DescribeLoghubDetailResponseBodyLoghubInfoLogHubStores = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LogHubStores') is not None:
            temp_model = main_models.DescribeLoghubDetailResponseBodyLoghubInfoLogHubStores()
...
class DescribeLoghubDetailResponseBodyLoghubInfoLogHubStores(DaraModel):
    def __init__(
        self,
        log_hub_store: List[main_models.DescribeLoghubDetailResponseBodyLoghubInfoLogHubStoresLogHubStore] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('LogHubStore') is not None:
            for k1 in m.get('LogHubStore'):
                temp_model = main_models.DescribeLoghubDetailResponseBodyLoghubInfoLogHubStoresLogHubStore()
                self.log_hub_store.append(temp_model.from_map(k1))

        return self

class DescribeLoghubDetailResponseBodyLoghubInfoLogHubStoresLogHubStore(DaraModel):
    def __init__(
        self,
        field_key: str = None,
        log_key: str = None,

...
class DescribeVpcsResponseBodyVpcsVpc(DaraModel):
    def __init__(
        ...
        region_no: str = None,
        status: str = None,
        v_switchs: List[main_models.DescribeVpcsResponseBodyVpcsVpcVSwitchs] = None,
        vpc_id: str = None,
        vpc_name: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VSwitchs') is not None:
            for k1 in m.get('VSwitchs'):
                temp_model = main_models.DescribeVpcsResponseBodyVpcsVpcVSwitchs()
...
class DescribeVpcsResponseBodyVpcsVpcVSwitchs(DaraModel):
    def __init__(
        self,
        cidr_block: str = None,
        gmt_create: str = None,

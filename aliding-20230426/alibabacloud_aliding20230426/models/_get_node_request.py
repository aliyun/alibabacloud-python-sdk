...
class GetNodeRequest(DaraModel):
    def __init__(
        self,
        node_id: str = None,
        tenant_context: main_models.GetNodeRequestTenantContext = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.GetNodeRequestTenantContext()
...
class GetNodeRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

...
class GetNodesResponseBody(DaraModel):
    def __init__(
        self,
        nodes: List[main_models.GetNodesResponseBodyNodes] = None,
        request_id: str = None,
    ):
        self.nodes = nodes
        # requestId
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('nodes') is not None:
            for k1 in m.get('nodes'):
                temp_model = main_models.GetNodesResponseBodyNodes()
...
class GetNodesResponseBodyNodes(DaraModel):
    def __init__(
        self,
        category: str = None,
        ...
        size: int = None,
        statistical_info: main_models.GetNodesResponseBodyNodesStatisticalInfo = None,
        type: str = None,
        url: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('StatisticalInfo') is not None:
            temp_model = main_models.GetNodesResponseBodyNodesStatisticalInfo()
...
class GetNodesResponseBodyNodesStatisticalInfo(DaraModel):
    def __init__(
        self,
        word_count: int = None,
    ):

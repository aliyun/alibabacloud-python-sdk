...
class SearchFormDataSecondGenerationNoTableFieldResponseBody(DaraModel):
    def __init__(
        self,
        data: List[main_models.SearchFormDataSecondGenerationNoTableFieldResponseBodyData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            for k1 in m.get('data'):
                temp_model = main_models.SearchFormDataSecondGenerationNoTableFieldResponseBodyData()
...
class SearchFormDataSecondGenerationNoTableFieldResponseBodyData(DaraModel):
    def __init__(
        self,
        ...
        modifier: str = None,
        modify_user: main_models.SearchFormDataSecondGenerationNoTableFieldResponseBodyDataModifyUser = None,
        originator: main_models.SearchFormDataSecondGenerationNoTableFieldResponseBodyDataOriginator = None,
        sequence: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ModifyUser') is not None:
            temp_model = main_models.SearchFormDataSecondGenerationNoTableFieldResponseBodyDataModifyUser()
            self.modify_user = temp_model.from_map(m.get('ModifyUser'))

        if m.get('Originator') is not None:
            temp_model = main_models.SearchFormDataSecondGenerationNoTableFieldResponseBodyDataOriginator()
...
class SearchFormDataSecondGenerationNoTableFieldResponseBodyDataOriginator(DaraModel):
    def __init__(
        self,
        name: main_models.SearchFormDataSecondGenerationNoTableFieldResponseBodyDataOriginatorName = None,
        user_id: str = None,
    ):
        self.name = name
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Name') is not None:
            temp_model = main_models.SearchFormDataSecondGenerationNoTableFieldResponseBodyDataOriginatorName()
...
class SearchFormDataSecondGenerationNoTableFieldResponseBodyDataOriginatorName(DaraModel):
    def __init__(
        self,
...
class SearchFormDataSecondGenerationNoTableFieldResponseBodyDataModifyUser(DaraModel):
    def __init__(
        self,
        name: main_models.SearchFormDataSecondGenerationNoTableFieldResponseBodyDataModifyUserName = None,
        user_id: str = None,
    ):
        self.name = name
        self.user_id = user_id
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('Name') is not None:
            temp_model = main_models.SearchFormDataSecondGenerationNoTableFieldResponseBodyDataModifyUserName()
            self.name = temp_model.from_map(m.get('Name'))
...
class SearchFormDataSecondGenerationNoTableFieldResponseBodyDataModifyUserName(DaraModel):
    def __init__(
        self,
        name_in_chinese: str = None,
        name_in_english: str = None,

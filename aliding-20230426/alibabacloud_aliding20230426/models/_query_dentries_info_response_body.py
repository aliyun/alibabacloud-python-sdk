...
class QueryDentriesInfoResponseBody(DaraModel):
    def __init__(
        self,
        dentry: main_models.QueryDentriesInfoResponseBodyDentry = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Dentry') is not None:
            temp_model = main_models.QueryDentriesInfoResponseBodyDentry()
...
class QueryDentriesInfoResponseBodyDentry(DaraModel):
    def __init__(
        self,
        ...
        path: str = None,
        properties: main_models.QueryDentriesInfoResponseBodyDentryProperties = None,
        size: int = None,
        space_id: str = None,
        status: str = None,
        storage_driver: str = None,
        thumbnail: main_models.QueryDentriesInfoResponseBodyDentryThumbnail = None,
        type: str = None,
        uuid: str = None,
        version: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Properties') is not None:
            temp_model = main_models.QueryDentriesInfoResponseBodyDentryProperties()
        ...
        if m.get('Thumbnail') is not None:
            temp_model = main_models.QueryDentriesInfoResponseBodyDentryThumbnail()
            self.thumbnail = temp_model.from_map(m.get('Thumbnail'))
...
class QueryDentriesInfoResponseBodyDentryThumbnail(DaraModel):
    def __init__(
        self,
        height: int = None,
        url: str = None,
...
class QueryDentriesInfoResponseBodyDentryProperties(DaraModel):
    def __init__(
        self,
        read_only: bool = None,
    ):

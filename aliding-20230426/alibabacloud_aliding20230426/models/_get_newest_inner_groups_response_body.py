...
class GetNewestInnerGroupsResponseBody(DaraModel):
    def __init__(
        self,
        group_infos: List[main_models.GetNewestInnerGroupsResponseBodyGroupInfos] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('groupInfos') is not None:
            for k1 in m.get('groupInfos'):
                temp_model = main_models.GetNewestInnerGroupsResponseBodyGroupInfos()
...
class GetNewestInnerGroupsResponseBodyGroupInfos(DaraModel):
    def __init__(
        self,
        icon: str = None,

...
class AddAttendeeHeaders(DaraModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        account_context: main_models.AddAttendeeHeadersAccountContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AccountContext') is not None:
            temp_model = main_models.AddAttendeeHeadersAccountContext()
...
class AddAttendeeHeadersAccountContext(DaraModel):
    def __init__(
        self,
        account_id: str = None,
    ):

...
class QueryScheduleConferenceInfoRequest(DaraModel):
    def __init__(
        self,
        max_results: int = None,
        next_token: str = None,
        schedule_conference_id: str = None,
        tenant_context: main_models.QueryScheduleConferenceInfoRequestTenantContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.QueryScheduleConferenceInfoRequestTenantContext()
            self.tenant_context = temp_model.from_map(m.get('TenantContext'))

        return self

class QueryScheduleConferenceInfoRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

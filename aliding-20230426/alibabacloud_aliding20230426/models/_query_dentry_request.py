...
class QueryDentryRequest(DaraModel):
    def __init__(
        self,
        dentry_id: str = None,
        include_space: bool = None,
        space_id: str = None,
        tenant_context: main_models.QueryDentryRequestTenantContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.QueryDentryRequestTenantContext()
            self.tenant_context = temp_model.from_map(m.get('TenantContext'))

        return self

class QueryDentryRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

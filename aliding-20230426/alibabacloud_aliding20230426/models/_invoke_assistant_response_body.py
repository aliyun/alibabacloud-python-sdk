...
class InvokeAssistantResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('messages') is not None:
            for k1 in m.get('messages'):
                temp_model = main_models.InvokeAssistantResponseBodyMessages()
...
class InvokeAssistantResponseBodyMessages(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('content') is not None:
            temp_model = main_models.InvokeAssistantResponseBodyMessagesContent()
...
class InvokeAssistantResponseBodyMessagesContent(DaraModel):
    def __init__(
        ...
        markdown: main_models.InvokeAssistantResponseBodyMessagesContentMarkdown = None,
        struct_view: main_models.InvokeAssistantResponseBodyMessagesContentStructView = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dingCard') is not None:
            temp_model = main_models.InvokeAssistantResponseBodyMessagesContentDingCard()
            self.ding_card = temp_model.from_map(m.get('dingCard'))

        if m.get('dingNormalCard') is not None:
            temp_model = main_models.InvokeAssistantResponseBodyMessagesContentDingNormalCard()
            self.ding_normal_card = temp_model.from_map(m.get('dingNormalCard'))

        if m.get('markdown') is not None:
            temp_model = main_models.InvokeAssistantResponseBodyMessagesContentMarkdown()
            self.markdown = temp_model.from_map(m.get('markdown'))

        if m.get('structView') is not None:
            temp_model = main_models.InvokeAssistantResponseBodyMessagesContentStructView()
            self.struct_view = temp_model.from_map(m.get('structView'))

        if m.get('text') is not None:
            temp_model = main_models.InvokeAssistantResponseBodyMessagesContentText()
...
class InvokeAssistantResponseBodyMessagesContentText(DaraModel):
    def __init__(
        self,
        value: str = None,
    ):
...
class InvokeAssistantResponseBodyMessagesContentStructView(DaraModel):
    def __init__(
        self,
        parts: List[main_models.InvokeAssistantResponseBodyMessagesContentStructViewParts] = None,
    ):
        self.parts = parts
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('parts') is not None:
            for k1 in m.get('parts'):
                temp_model = main_models.InvokeAssistantResponseBodyMessagesContentStructViewParts()
                self.parts.append(temp_model.from_map(k1))

        return self

class InvokeAssistantResponseBodyMessagesContentStructViewParts(DaraModel):
    def __init__(
        self,
        append: bool = None,
        data_part: main_models.InvokeAssistantResponseBodyMessagesContentStructViewPartsDataPart = None,
        finish: bool = None,
        part_desc: str = None,
        part_id: str = None,
        reason_part: main_models.InvokeAssistantResponseBodyMessagesContentStructViewPartsReasonPart = None,
        recommend_part: main_models.InvokeAssistantResponseBodyMessagesContentStructViewPartsRecommendPart = None,
        reference_part: main_models.InvokeAssistantResponseBodyMessagesContentStructViewPartsReferencePart = None,
        text_part: main_models.InvokeAssistantResponseBodyMessagesContentStructViewPartsTextPart = None,
        type: str = None,
    ):
        self.append = append
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dataPart') is not None:
            temp_model = main_models.InvokeAssistantResponseBodyMessagesContentStructViewPartsDataPart()
        ...
        if m.get('reasonPart') is not None:
            temp_model = main_models.InvokeAssistantResponseBodyMessagesContentStructViewPartsReasonPart()
            self.reason_part = temp_model.from_map(m.get('reasonPart'))

        if m.get('recommendPart') is not None:
            temp_model = main_models.InvokeAssistantResponseBodyMessagesContentStructViewPartsRecommendPart()
            self.recommend_part = temp_model.from_map(m.get('recommendPart'))

        if m.get('referencePart') is not None:
            temp_model = main_models.InvokeAssistantResponseBodyMessagesContentStructViewPartsReferencePart()
            self.reference_part = temp_model.from_map(m.get('referencePart'))

        if m.get('textPart') is not None:
            temp_model = main_models.InvokeAssistantResponseBodyMessagesContentStructViewPartsTextPart()
...
class InvokeAssistantResponseBodyMessagesContentStructViewPartsTextPart(DaraModel):
    def __init__(
        self,
        text: str = None,
    ):
...
class InvokeAssistantResponseBodyMessagesContentStructViewPartsReferencePart(DaraModel):
    def __init__(
        self,
        references: List[main_models.InvokeAssistantResponseBodyMessagesContentStructViewPartsReferencePartReferences] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('references') is not None:
            for k1 in m.get('references'):
                temp_model = main_models.InvokeAssistantResponseBodyMessagesContentStructViewPartsReferencePartReferences()
                self.references.append(temp_model.from_map(k1))

        return self

class InvokeAssistantResponseBodyMessagesContentStructViewPartsReferencePartReferences(DaraModel):
    def __init__(
        self,
        index: str = None,
        name: str = None,
...
class InvokeAssistantResponseBodyMessagesContentStructViewPartsRecommendPart(DaraModel):
    def __init__(
        self,
        recommends: List[main_models.InvokeAssistantResponseBodyMessagesContentStructViewPartsRecommendPartRecommends] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('recommends') is not None:
            for k1 in m.get('recommends'):
                temp_model = main_models.InvokeAssistantResponseBodyMessagesContentStructViewPartsRecommendPartRecommends()
                self.recommends.append(temp_model.from_map(k1))

        return self

class InvokeAssistantResponseBodyMessagesContentStructViewPartsRecommendPartRecommends(DaraModel):
    def __init__(
        self,
        mobile_url: str = None,
        text: str = None,
...
class InvokeAssistantResponseBodyMessagesContentStructViewPartsReasonPart(DaraModel):
    def __init__(
        self,
        reason: str = None,
    ):
...
class InvokeAssistantResponseBodyMessagesContentStructViewPartsDataPart(DaraModel):
    def __init__(
        self,
        data: Any = None,
    ):
...
class InvokeAssistantResponseBodyMessagesContentMarkdown(DaraModel):
    def __init__(
        self,
        value: str = None,
    ):
...
class InvokeAssistantResponseBodyMessagesContentDingNormalCard(DaraModel):
    def __init__(
        self,
        card_data: main_models.InvokeAssistantResponseBodyMessagesContentDingNormalCardCardData = None,
        card_template_id: str = None,
        card_update_options: main_models.InvokeAssistantResponseBodyMessagesContentDingNormalCardCardUpdateOptions = None,
        dynamic_data_source_configs: List[main_models.InvokeAssistantResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cardData') is not None:
            temp_model = main_models.InvokeAssistantResponseBodyMessagesContentDingNormalCardCardData()
        ...
        if m.get('cardUpdateOptions') is not None:
            temp_model = main_models.InvokeAssistantResponseBodyMessagesContentDingNormalCardCardUpdateOptions()
        ...
        if m.get('dynamicDataSourceConfigs') is not None:
            for k1 in m.get('dynamicDataSourceConfigs'):
                temp_model = main_models.InvokeAssistantResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigs()
...
class InvokeAssistantResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigs(DaraModel):
    def __init__(
        self,
        const_params: Dict[str, Any] = None,
        dynamic_data_source_id: str = None,
        pull_config: main_models.InvokeAssistantResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigsPullConfig = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('pullConfig') is not None:
            temp_model = main_models.InvokeAssistantResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigsPullConfig()
            self.pull_config = temp_model.from_map(m.get('pullConfig'))

        return self

class InvokeAssistantResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigsPullConfig(DaraModel):
    def __init__(
        self,
        interval: int = None,
...
class InvokeAssistantResponseBodyMessagesContentDingNormalCardCardUpdateOptions(DaraModel):
    def __init__(
        self,
...
class InvokeAssistantResponseBodyMessagesContentDingNormalCardCardData(DaraModel):
    def __init__(
        self,
...
class InvokeAssistantResponseBodyMessagesContentDingCard(DaraModel):
    def __init__(
        self,
        content: str = None,
...
class InvokeAssistantResponseBodyMessagesContentCardCallback(DaraModel):
    def __init__(
        self,
        content: str = None,

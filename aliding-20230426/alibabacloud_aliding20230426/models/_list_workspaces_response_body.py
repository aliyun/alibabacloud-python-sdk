...
class ListWorkspacesResponseBodyWorkspaces(DaraModel):
    def __init__(
        ...
        icon: main_models.ListWorkspacesResponseBodyWorkspacesIcon = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Icon') is not None:
            temp_model = main_models.ListWorkspacesResponseBodyWorkspacesIcon()
...
class ListWorkspacesResponseBodyWorkspacesIcon(DaraModel):
    def __init__(
        self,
        type: str = None,
        value: str = None,

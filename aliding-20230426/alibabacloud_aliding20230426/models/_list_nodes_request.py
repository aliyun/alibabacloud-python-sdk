...
class ListNodesRequest(DaraModel):
    def __init__(
        ...
        tenant_context: main_models.ListNodesRequestTenantContext = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.ListNodesRequestTenantContext()
...
class ListNodesRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

...
class AssignTicketRequest(DaraModel):
    def __init__(
        self,
        notify: main_models.AssignTicketRequestNotify = None,
        open_team_id: str = None,
        open_ticket_id: str = None,
        processor_user_ids: List[str] = None,
        tenant_context: main_models.AssignTicketRequestTenantContext = None,
        ticket_memo: main_models.AssignTicketRequestTicketMemo = None,
    ):
        self.notify = notify
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Notify') is not None:
            temp_model = main_models.AssignTicketRequestNotify()
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.AssignTicketRequestTenantContext()
            self.tenant_context = temp_model.from_map(m.get('TenantContext'))

        if m.get('TicketMemo') is not None:
            temp_model = main_models.AssignTicketRequestTicketMemo()
            self.ticket_memo = temp_model.from_map(m.get('TicketMemo'))

        return self

class AssignTicketRequestTicketMemo(DaraModel):
    def __init__(
        self,
        attachments: List[main_models.AssignTicketRequestTicketMemoAttachments] = None,
        memo: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Attachments') is not None:
            for k1 in m.get('Attachments'):
                temp_model = main_models.AssignTicketRequestTicketMemoAttachments()
...
class AssignTicketRequestTicketMemoAttachments(DaraModel):
    def __init__(
        self,
        file_name: str = None,
        key: str = None,
...
class AssignTicketRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):
...
class AssignTicketRequestNotify(DaraModel):
    def __init__(
        self,

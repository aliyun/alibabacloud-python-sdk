...
class CreatePersonalTodoTaskRequest(DaraModel):
    def __init__(
        self,
        description: str = None,
        due_time: int = None,
        executor_ids: List[str] = None,
        notify_configs: main_models.CreatePersonalTodoTaskRequestNotifyConfigs = None,
        participant_ids: List[str] = None,
        reminder_time_stamp: int = None,
        subject: str = None,
        tenant_context: main_models.CreatePersonalTodoTaskRequestTenantContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NotifyConfigs') is not None:
            temp_model = main_models.CreatePersonalTodoTaskRequestNotifyConfigs()
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.CreatePersonalTodoTaskRequestTenantContext()
            self.tenant_context = temp_model.from_map(m.get('TenantContext'))

        return self

class CreatePersonalTodoTaskRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):
...
class CreatePersonalTodoTaskRequestNotifyConfigs(DaraModel):
    def __init__(
        self,

...
class GetNodeByUrlRequest(DaraModel):
    def __init__(
        self,
        option: main_models.GetNodeByUrlRequestOption = None,
        tenant_context: main_models.GetNodeByUrlRequestTenantContext = None,
        url: str = None,
    ):
        self.option = option
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Option') is not None:
            temp_model = main_models.GetNodeByUrlRequestOption()
            self.option = temp_model.from_map(m.get('Option'))

        if m.get('TenantContext') is not None:
            temp_model = main_models.GetNodeByUrlRequestTenantContext()
...
class GetNodeByUrlRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):
...
class GetNodeByUrlRequestOption(DaraModel):
    def __init__(
        self,

...
class ListEventsViewResponseBody(DaraModel):
    def __init__(
        self,
        events: List[main_models.ListEventsViewResponseBodyEvents] = None,
        next_token: str = None,
        request_id: str = None,
    ):
        self.events = events
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('events') is not None:
            for k1 in m.get('events'):
                temp_model = main_models.ListEventsViewResponseBodyEvents()
...
class ListEventsViewResponseBodyEvents(DaraModel):
    def __init__(
        self,
        attendees: List[main_models.ListEventsViewResponseBodyEventsAttendees] = None,
        categories: List[main_models.ListEventsViewResponseBodyEventsCategories] = None,
        create_time: str = None,
        description: str = None,
        end: main_models.ListEventsViewResponseBodyEventsEnd = None,
        extended_properties: main_models.ListEventsViewResponseBodyEventsExtendedProperties = None,
        id: str = None,
        is_all_day: bool = None,
        location: main_models.ListEventsViewResponseBodyEventsLocation = None,
        meeting_rooms: List[main_models.ListEventsViewResponseBodyEventsMeetingRooms] = None,
        online_meeting_info: main_models.ListEventsViewResponseBodyEventsOnlineMeetingInfo = None,
        organizer: main_models.ListEventsViewResponseBodyEventsOrganizer = None,
        origin_start: main_models.ListEventsViewResponseBodyEventsOriginStart = None,
        recurrence: main_models.ListEventsViewResponseBodyEventsRecurrence = None,
        rich_text_description: main_models.ListEventsViewResponseBodyEventsRichTextDescription = None,
        series_master_id: str = None,
        start: main_models.ListEventsViewResponseBodyEventsStart = None,
        status: str = None,
        summary: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Attendees') is not None:
            for k1 in m.get('Attendees'):
                temp_model = main_models.ListEventsViewResponseBodyEventsAttendees()
                self.attendees.append(temp_model.from_map(k1))

        self.categories = []
        if m.get('Categories') is not None:
            for k1 in m.get('Categories'):
                temp_model = main_models.ListEventsViewResponseBodyEventsCategories()
        ...
        if m.get('End') is not None:
            temp_model = main_models.ListEventsViewResponseBodyEventsEnd()
            self.end = temp_model.from_map(m.get('End'))

        if m.get('ExtendedProperties') is not None:
            temp_model = main_models.ListEventsViewResponseBodyEventsExtendedProperties()
        ...
        if m.get('Start') is not None:
            temp_model = main_models.ListEventsViewResponseBodyEventsStart()
...
class ListEventsViewResponseBodyEventsStart(DaraModel):
    def __init__(
        self,
        date: str = None,
        date_time: str = None,
...
class ListEventsViewResponseBodyEventsRichTextDescription(DaraModel):
    def __init__(
        self,
        text: str = None,
    ):
...
class ListEventsViewResponseBodyEventsRecurrence(DaraModel):
    def __init__(
        self,
        pattern: main_models.ListEventsViewResponseBodyEventsRecurrencePattern = None,
        range: main_models.ListEventsViewResponseBodyEventsRecurrenceRange = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Pattern') is not None:
            temp_model = main_models.ListEventsViewResponseBodyEventsRecurrencePattern()
            self.pattern = temp_model.from_map(m.get('Pattern'))

        if m.get('Range') is not None:
            temp_model = main_models.ListEventsViewResponseBodyEventsRecurrenceRange()
            self.range = temp_model.from_map(m.get('Range'))

        return self

class ListEventsViewResponseBodyEventsRecurrenceRange(DaraModel):
    def __init__(
        self,
        end_date: str = None,
...
class ListEventsViewResponseBodyEventsRecurrencePattern(DaraModel):
    def __init__(
        self,
...
class ListEventsViewResponseBodyEventsOriginStart(DaraModel):
    def __init__(
        self,
        date_time: str = None,
    ):
...
class ListEventsViewResponseBodyEventsOrganizer(DaraModel):
    def __init__(
        self,
...
class ListEventsViewResponseBodyEventsOnlineMeetingInfo(DaraModel):
    def __init__(
        self,
...
class ListEventsViewResponseBodyEventsMeetingRooms(DaraModel):
    def __init__(
        self,
        display_name: str = None,
        response_status: str = None,
...
class ListEventsViewResponseBodyEventsLocation(DaraModel):
    def __init__(
        self,
        display_name: str = None,
...
class ListEventsViewResponseBodyEventsExtendedProperties(DaraModel):
    def __init__(
        self,
        shared_properties: main_models.ListEventsViewResponseBodyEventsExtendedPropertiesSharedProperties = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SharedProperties') is not None:
            temp_model = main_models.ListEventsViewResponseBodyEventsExtendedPropertiesSharedProperties()
            self.shared_properties = temp_model.from_map(m.get('SharedProperties'))

        return self

class ListEventsViewResponseBodyEventsExtendedPropertiesSharedProperties(DaraModel):
    def __init__(
        self,
...
class ListEventsViewResponseBodyEventsEnd(DaraModel):
    def __init__(
        self,
        date: str = None,
        date_time: str = None,
...
class ListEventsViewResponseBodyEventsCategories(DaraModel):
    def __init__(
        self,
        display_name: str = None,
    ):
...
class ListEventsViewResponseBodyEventsAttendees(DaraModel):
    def __init__(
        self,
        display_name: str = None,
        id: str = None,

...
class CancelScheduleConferenceRequest(DaraModel):
    def __init__(
        self,
        schedule_conference_id: str = None,
        tenant_context: main_models.CancelScheduleConferenceRequestTenantContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.CancelScheduleConferenceRequestTenantContext()
            self.tenant_context = temp_model.from_map(m.get('TenantContext'))

        return self

class CancelScheduleConferenceRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

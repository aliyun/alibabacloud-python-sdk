...
class GetNodeByUrlResponseBody(DaraModel):
    def __init__(
        self,
        node: main_models.GetNodeByUrlResponseBodyNode = None,
        request_id: str = None,
    ):
        self.node = node
        # requestId
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('node') is not None:
            temp_model = main_models.GetNodeByUrlResponseBodyNode()
...
class GetNodeByUrlResponseBodyNode(DaraModel):
    def __init__(
        self,
        category: str = None,
        ...
        size: int = None,
        statistical_info: main_models.GetNodeByUrlResponseBodyNodeStatisticalInfo = None,
        type: str = None,
        url: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('StatisticalInfo') is not None:
            temp_model = main_models.GetNodeByUrlResponseBodyNodeStatisticalInfo()
...
class GetNodeByUrlResponseBodyNodeStatisticalInfo(DaraModel):
    def __init__(
        self,
        word_count: int = None,
    ):

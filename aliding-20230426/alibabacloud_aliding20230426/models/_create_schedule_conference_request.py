...
class CreateScheduleConferenceRequest(DaraModel):
    def __init__(
        self,
        end_time: int = None,
        schedule_conf_setting_model: main_models.CreateScheduleConferenceRequestScheduleConfSettingModel = None,
        start_time: int = None,
        tenant_context: main_models.CreateScheduleConferenceRequestTenantContext = None,
        title: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ScheduleConfSettingModel') is not None:
            temp_model = main_models.CreateScheduleConferenceRequestScheduleConfSettingModel()
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.CreateScheduleConferenceRequestTenantContext()
...
class CreateScheduleConferenceRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):
...
class CreateScheduleConferenceRequestScheduleConfSettingModel(DaraModel):
    def __init__(
        ...
        lock_room: int = None,
        mozi_conf_open_record_setting: main_models.CreateScheduleConferenceRequestScheduleConfSettingModelMoziConfOpenRecordSetting = None,
        mozi_conf_virtual_extra_setting: main_models.CreateScheduleConferenceRequestScheduleConfSettingModelMoziConfVirtualExtraSetting = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MoziConfOpenRecordSetting') is not None:
            temp_model = main_models.CreateScheduleConferenceRequestScheduleConfSettingModelMoziConfOpenRecordSetting()
        ...
        if m.get('MoziConfVirtualExtraSetting') is not None:
            temp_model = main_models.CreateScheduleConferenceRequestScheduleConfSettingModelMoziConfVirtualExtraSetting()
...
class CreateScheduleConferenceRequestScheduleConfSettingModelMoziConfVirtualExtraSetting(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MoziConfExtensionAppSettings') is not None:
            for k1 in m.get('MoziConfExtensionAppSettings'):
                temp_model = main_models.CreateScheduleConferenceRequestScheduleConfSettingModelMoziConfVirtualExtraSettingMoziConfExtensionAppSettings()
...
class CreateScheduleConferenceRequestScheduleConfSettingModelMoziConfVirtualExtraSettingMoziConfExtensionAppSettings(DaraModel):
    def __init__(
        self,
...
class CreateScheduleConferenceRequestScheduleConfSettingModelMoziConfOpenRecordSetting(DaraModel):
    def __init__(
        self,

...
class CopyDentryResponseBody(DaraModel):
    def __init__(
        self,
        ...
        link_source_info: main_models.CopyDentryResponseBodyLinkSourceInfo = None,
        name: str = None,
        path: str = None,
        request_id: str = None,
        space: main_models.CopyDentryResponseBodySpace = None,
        space_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('linkSourceInfo') is not None:
            temp_model = main_models.CopyDentryResponseBodyLinkSourceInfo()
        ...
        if m.get('space') is not None:
            temp_model = main_models.CopyDentryResponseBodySpace()
...
class CopyDentryResponseBodySpace(DaraModel):
    def __init__(
        self,
        cover: str = None,
        description: str = None,
        hd_icon_vo: main_models.CopyDentryResponseBodySpaceHdIconVO = None,
        icon_vo: main_models.CopyDentryResponseBodySpaceIconVO = None,
        id: str = None,
        name: str = None,
        owner: main_models.CopyDentryResponseBodySpaceOwner = None,
        recent_list: List[main_models.CopyDentryResponseBodySpaceRecentList] = None,
        type: int = None,
        url: str = None,
        visitor_info: main_models.CopyDentryResponseBodySpaceVisitorInfo = None,
    ):
        self.cover = cover
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HdIconVO') is not None:
            temp_model = main_models.CopyDentryResponseBodySpaceHdIconVO()
            self.hd_icon_vo = temp_model.from_map(m.get('HdIconVO'))

        if m.get('IconVO') is not None:
            temp_model = main_models.CopyDentryResponseBodySpaceIconVO()
        ...
        if m.get('Owner') is not None:
            temp_model = main_models.CopyDentryResponseBodySpaceOwner()
            self.owner = temp_model.from_map(m.get('Owner'))

        self.recent_list = []
        if m.get('RecentList') is not None:
            for k1 in m.get('RecentList'):
                temp_model = main_models.CopyDentryResponseBodySpaceRecentList()
        ...
        if m.get('VisitorInfo') is not None:
            temp_model = main_models.CopyDentryResponseBodySpaceVisitorInfo()
            self.visitor_info = temp_model.from_map(m.get('VisitorInfo'))

        return self

class CopyDentryResponseBodySpaceVisitorInfo(DaraModel):
    def __init__(
        self,
...
class CopyDentryResponseBodySpaceRecentList(DaraModel):
    def __init__(
        self,
        content_type: str = None,
        created_time: int = None,
        creator: main_models.CopyDentryResponseBodySpaceRecentListCreator = None,
        dentry_id: str = None,
        dentry_type: str = None,
        dentry_uuid: str = None,
        doc_key: str = None,
        extension: str = None,
        has_children: bool = None,
        link_source_info: main_models.CopyDentryResponseBodySpaceRecentListLinkSourceInfo = None,
        name: str = None,
        path: str = None,
        space: Any = None,
        space_id: str = None,
        statistical_info: main_models.CopyDentryResponseBodySpaceRecentListStatisticalInfo = None,
        updated_time: int = None,
        updater: main_models.CopyDentryResponseBodySpaceRecentListUpdater = None,
        url: str = None,
        visitor_info: main_models.CopyDentryResponseBodySpaceRecentListVisitorInfo = None,
    ):
        self.content_type = content_type
        self.created_time = created_time
        self.creator = creator
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Creator') is not None:
            temp_model = main_models.CopyDentryResponseBodySpaceRecentListCreator()
        ...
        if m.get('LinkSourceInfo') is not None:
            temp_model = main_models.CopyDentryResponseBodySpaceRecentListLinkSourceInfo()
            self.link_source_info = temp_model.from_map(m.get('LinkSourceInfo'))
        ...
        if m.get('StatisticalInfo') is not None:
            temp_model = main_models.CopyDentryResponseBodySpaceRecentListStatisticalInfo()
        ...
        if m.get('Updater') is not None:
            temp_model = main_models.CopyDentryResponseBodySpaceRecentListUpdater()
        ...
        if m.get('VisitorInfo') is not None:
            temp_model = main_models.CopyDentryResponseBodySpaceRecentListVisitorInfo()
            self.visitor_info = temp_model.from_map(m.get('VisitorInfo'))

        return self

class CopyDentryResponseBodySpaceRecentListVisitorInfo(DaraModel):
    def __init__(
        self,
        dentry_actions: List[str] = None,
        role_code: str = None,
...
class CopyDentryResponseBodySpaceRecentListUpdater(DaraModel):
    def __init__(
        self,
        name: str = None,
        user_id: str = None,
...
class CopyDentryResponseBodySpaceRecentListStatisticalInfo(DaraModel):
    def __init__(
        self,
        word_count: int = None,
    ):
...
class CopyDentryResponseBodySpaceRecentListLinkSourceInfo(DaraModel):
    def __init__(
        self,
        extension: str = None,
        icon_url: main_models.CopyDentryResponseBodySpaceRecentListLinkSourceInfoIconUrl = None,
        id: str = None,
        link_type: int = None,
        space_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IconUrl') is not None:
            temp_model = main_models.CopyDentryResponseBodySpaceRecentListLinkSourceInfoIconUrl()
...
class CopyDentryResponseBodySpaceRecentListLinkSourceInfoIconUrl(DaraModel):
    def __init__(
        self,
        line: str = None,
        small: str = None,
...
class CopyDentryResponseBodySpaceRecentListCreator(DaraModel):
    def __init__(
        self,
        name: str = None,
        user_id: str = None,
...
class CopyDentryResponseBodySpaceOwner(DaraModel):
    def __init__(
        self,
        name: str = None,
        user_id: str = None,
...
class CopyDentryResponseBodySpaceIconVO(DaraModel):
    def __init__(
        self,
        icon: str = None,
        type: str = None,
...
class CopyDentryResponseBodySpaceHdIconVO(DaraModel):
    def __init__(
        self,
        icon: str = None,
        type: str = None,
...
class CopyDentryResponseBodyLinkSourceInfo(DaraModel):
    def __init__(
        self,
        extension: str = None,
        icon_url: main_models.CopyDentryResponseBodyLinkSourceInfoIconUrl = None,
        id: str = None,
        link_type: int = None,
        space_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IconUrl') is not None:
            temp_model = main_models.CopyDentryResponseBodyLinkSourceInfoIconUrl()
            self.icon_url = temp_model.from_map(m.get('IconUrl'))
...
class CopyDentryResponseBodyLinkSourceInfoIconUrl(DaraModel):
    def __init__(
        self,
        line: str = None,
        small: str = None,

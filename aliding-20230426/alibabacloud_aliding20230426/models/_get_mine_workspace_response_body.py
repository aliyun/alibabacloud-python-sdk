...
class GetMineWorkspaceResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        workspace: main_models.GetMineWorkspaceResponseBodyWorkspace = None,
    ):
        # requestId
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('workspace') is not None:
            temp_model = main_models.GetMineWorkspaceResponseBodyWorkspace()
            self.workspace = temp_model.from_map(m.get('workspace'))

        return self

class GetMineWorkspaceResponseBodyWorkspace(DaraModel):
    def __init__(
        self,
        corp_id: str = None,
        cover: str = None,
        ...
        icon: main_models.GetMineWorkspaceResponseBodyWorkspaceIcon = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Icon') is not None:
            temp_model = main_models.GetMineWorkspaceResponseBodyWorkspaceIcon()
...
class GetMineWorkspaceResponseBodyWorkspaceIcon(DaraModel):
    def __init__(
        self,
        type: str = None,
        value: str = None,

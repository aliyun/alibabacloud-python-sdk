...
class GetDocContentTakIdRequest(DaraModel):
    def __init__(
        self,
        dentry_uuid: str = None,
        generate_cp: bool = None,
        target_format: str = None,
        tenant_context: main_models.GetDocContentTakIdRequestTenantContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.GetDocContentTakIdRequestTenantContext()
            self.tenant_context = temp_model.from_map(m.get('TenantContext'))

        return self

class GetDocContentTakIdRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

...
class GetSheetRequest(DaraModel):
    def __init__(
        self,
        sheet_id: str = None,
        tenant_context: main_models.GetSheetRequestTenantContext = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.GetSheetRequestTenantContext()
...
class GetSheetRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

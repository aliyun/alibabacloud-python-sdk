...
class InsertRowsBeforeRequest(DaraModel):
    def __init__(
        self,
        row: int = None,
        row_count: int = None,
        sheet_id: str = None,
        tenant_context: main_models.InsertRowsBeforeRequestTenantContext = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.InsertRowsBeforeRequestTenantContext()
...
class InsertRowsBeforeRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

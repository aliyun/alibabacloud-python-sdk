...
class GetTicketRequest(DaraModel):
    def __init__(
        self,
        open_team_id: str = None,
        open_ticket_id: str = None,
        tenant_context: main_models.GetTicketRequestTenantContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.GetTicketRequestTenantContext()
            self.tenant_context = temp_model.from_map(m.get('TenantContext'))

        return self

class GetTicketRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

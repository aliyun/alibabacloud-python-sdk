...
class CreateMessageRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('extLoginUser') is not None:
            temp_model = main_models.CreateMessageRequestExtLoginUser()
            self.ext_login_user = temp_model.from_map(m.get('extLoginUser'))

        self.messages = []
        if m.get('messages') is not None:
            for k1 in m.get('messages'):
                temp_model = main_models.CreateMessageRequestMessages()
...
class CreateMessageRequestMessages(DaraModel):
    def __init__(
        self,
        content: main_models.CreateMessageRequestMessagesContent = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('content') is not None:
            temp_model = main_models.CreateMessageRequestMessagesContent()
...
class CreateMessageRequestMessagesContent(DaraModel):
    def __init__(
        self,
        card_callback: main_models.CreateMessageRequestMessagesContentCardCallback = None,
        ding_card: main_models.CreateMessageRequestMessagesContentDingCard = None,
        ding_normal_card: main_models.CreateMessageRequestMessagesContentDingNormalCard = None,
        markdown: main_models.CreateMessageRequestMessagesContentMarkdown = None,
        struct_view: main_models.CreateMessageRequestMessagesContentStructView = None,
        text: main_models.CreateMessageRequestMessagesContentText = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cardCallback') is not None:
            temp_model = main_models.CreateMessageRequestMessagesContentCardCallback()
            self.card_callback = temp_model.from_map(m.get('cardCallback'))

        if m.get('dingCard') is not None:
            temp_model = main_models.CreateMessageRequestMessagesContentDingCard()
            self.ding_card = temp_model.from_map(m.get('dingCard'))

        if m.get('dingNormalCard') is not None:
            temp_model = main_models.CreateMessageRequestMessagesContentDingNormalCard()
            self.ding_normal_card = temp_model.from_map(m.get('dingNormalCard'))

        if m.get('markdown') is not None:
            temp_model = main_models.CreateMessageRequestMessagesContentMarkdown()
            self.markdown = temp_model.from_map(m.get('markdown'))

        if m.get('structView') is not None:
            temp_model = main_models.CreateMessageRequestMessagesContentStructView()
            self.struct_view = temp_model.from_map(m.get('structView'))

        if m.get('text') is not None:
            temp_model = main_models.CreateMessageRequestMessagesContentText()
...
class CreateMessageRequestMessagesContentText(DaraModel):
    def __init__(
        self,
        value: str = None,
    ):
...
class CreateMessageRequestMessagesContentStructView(DaraModel):
    def __init__(
        self,
        parts: List[main_models.CreateMessageRequestMessagesContentStructViewParts] = None,
    ):
        self.parts = parts
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('parts') is not None:
            for k1 in m.get('parts'):
                temp_model = main_models.CreateMessageRequestMessagesContentStructViewParts()
                self.parts.append(temp_model.from_map(k1))

        return self

class CreateMessageRequestMessagesContentStructViewParts(DaraModel):
    def __init__(
        self,
        append: bool = None,
        data_part: main_models.CreateMessageRequestMessagesContentStructViewPartsDataPart = None,
        finish: bool = None,
        part_desc: str = None,
        part_id: str = None,
        reason_part: main_models.CreateMessageRequestMessagesContentStructViewPartsReasonPart = None,
        recommend_part: main_models.CreateMessageRequestMessagesContentStructViewPartsRecommendPart = None,
        reference_part: main_models.CreateMessageRequestMessagesContentStructViewPartsReferencePart = None,
        text_part: main_models.CreateMessageRequestMessagesContentStructViewPartsTextPart = None,
        type: str = None,
    ):
        self.append = append
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dataPart') is not None:
            temp_model = main_models.CreateMessageRequestMessagesContentStructViewPartsDataPart()
        ...
        if m.get('reasonPart') is not None:
            temp_model = main_models.CreateMessageRequestMessagesContentStructViewPartsReasonPart()
            self.reason_part = temp_model.from_map(m.get('reasonPart'))

        if m.get('recommendPart') is not None:
            temp_model = main_models.CreateMessageRequestMessagesContentStructViewPartsRecommendPart()
            self.recommend_part = temp_model.from_map(m.get('recommendPart'))

        if m.get('referencePart') is not None:
            temp_model = main_models.CreateMessageRequestMessagesContentStructViewPartsReferencePart()
            self.reference_part = temp_model.from_map(m.get('referencePart'))

        if m.get('textPart') is not None:
            temp_model = main_models.CreateMessageRequestMessagesContentStructViewPartsTextPart()
...
class CreateMessageRequestMessagesContentStructViewPartsTextPart(DaraModel):
    def __init__(
        self,
        text: str = None,
    ):
...
class CreateMessageRequestMessagesContentStructViewPartsReferencePart(DaraModel):
    def __init__(
        self,
        references: List[main_models.CreateMessageRequestMessagesContentStructViewPartsReferencePartReferences] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('references') is not None:
            for k1 in m.get('references'):
                temp_model = main_models.CreateMessageRequestMessagesContentStructViewPartsReferencePartReferences()
                self.references.append(temp_model.from_map(k1))

        return self

class CreateMessageRequestMessagesContentStructViewPartsReferencePartReferences(DaraModel):
    def __init__(
        self,
        index: str = None,
        name: str = None,
...
class CreateMessageRequestMessagesContentStructViewPartsRecommendPart(DaraModel):
    def __init__(
        self,
        recommends: List[main_models.CreateMessageRequestMessagesContentStructViewPartsRecommendPartRecommends] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('recommends') is not None:
            for k1 in m.get('recommends'):
                temp_model = main_models.CreateMessageRequestMessagesContentStructViewPartsRecommendPartRecommends()
                self.recommends.append(temp_model.from_map(k1))

        return self

class CreateMessageRequestMessagesContentStructViewPartsRecommendPartRecommends(DaraModel):
    def __init__(
        self,
        mobile_url: str = None,
        text: str = None,
...
class CreateMessageRequestMessagesContentStructViewPartsReasonPart(DaraModel):
    def __init__(
        self,
        reason: str = None,
    ):
...
class CreateMessageRequestMessagesContentStructViewPartsDataPart(DaraModel):
    def __init__(
        self,
        data: Any = None,
    ):
...
class CreateMessageRequestMessagesContentMarkdown(DaraModel):
    def __init__(
        self,
        value: str = None,
    ):
...
class CreateMessageRequestMessagesContentDingNormalCard(DaraModel):
    def __init__(
        self,
        card_data: main_models.CreateMessageRequestMessagesContentDingNormalCardCardData = None,
        card_template_id: str = None,
        card_update_options: main_models.CreateMessageRequestMessagesContentDingNormalCardCardUpdateOptions = None,
        dynamic_data_source_configs: List[main_models.CreateMessageRequestMessagesContentDingNormalCardDynamicDataSourceConfigs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cardData') is not None:
            temp_model = main_models.CreateMessageRequestMessagesContentDingNormalCardCardData()
        ...
        if m.get('cardUpdateOptions') is not None:
            temp_model = main_models.CreateMessageRequestMessagesContentDingNormalCardCardUpdateOptions()
        ...
        if m.get('dynamicDataSourceConfigs') is not None:
            for k1 in m.get('dynamicDataSourceConfigs'):
                temp_model = main_models.CreateMessageRequestMessagesContentDingNormalCardDynamicDataSourceConfigs()
...
class CreateMessageRequestMessagesContentDingNormalCardDynamicDataSourceConfigs(DaraModel):
    def __init__(
        self,
        const_params: Dict[str, Any] = None,
        dynamic_data_source_id: str = None,
        pull_config: main_models.CreateMessageRequestMessagesContentDingNormalCardDynamicDataSourceConfigsPullConfig = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('pullConfig') is not None:
            temp_model = main_models.CreateMessageRequestMessagesContentDingNormalCardDynamicDataSourceConfigsPullConfig()
            self.pull_config = temp_model.from_map(m.get('pullConfig'))

        return self

class CreateMessageRequestMessagesContentDingNormalCardDynamicDataSourceConfigsPullConfig(DaraModel):
    def __init__(
        self,
        interval: int = None,
...
class CreateMessageRequestMessagesContentDingNormalCardCardUpdateOptions(DaraModel):
    def __init__(
        self,
...
class CreateMessageRequestMessagesContentDingNormalCardCardData(DaraModel):
    def __init__(
        self,
...
class CreateMessageRequestMessagesContentDingCard(DaraModel):
    def __init__(
        self,
        content: str = None,
...
class CreateMessageRequestMessagesContentCardCallback(DaraModel):
    def __init__(
        self,
        content: str = None,
...
class CreateMessageRequestExtLoginUser(DaraModel):
    def __init__(
        self,

...
class SetColumnsVisibilityRequest(DaraModel):
    def __init__(
        self,
        column: int = None,
        column_count: int = None,
        sheet_id: str = None,
        tenant_context: main_models.SetColumnsVisibilityRequestTenantContext = None,
        visibility: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.SetColumnsVisibilityRequestTenantContext()
...
class SetColumnsVisibilityRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

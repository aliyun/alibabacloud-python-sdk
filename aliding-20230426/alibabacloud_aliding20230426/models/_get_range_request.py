...
class GetRangeRequest(DaraModel):
    def __init__(
        self,
        range_address: str = None,
        select: str = None,
        sheet_id: str = None,
        tenant_context: main_models.GetRangeRequestTenantContext = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.GetRangeRequestTenantContext()
...
class GetRangeRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

...
class MuteAllRequest(DaraModel):
    def __init__(
        self,
        force_mute: bool = None,
        tenant_context: main_models.MuteAllRequestTenantContext = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.MuteAllRequestTenantContext()
...
class MuteAllRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

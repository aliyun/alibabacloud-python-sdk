...
class ListNodesResponseBodyNodes(DaraModel):
    def __init__(
        ...
        size: int = None,
        statistical_info: main_models.ListNodesResponseBodyNodesStatisticalInfo = None,
        type: str = None,
        url: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('StatisticalInfo') is not None:
            temp_model = main_models.ListNodesResponseBodyNodesStatisticalInfo()
...
class ListNodesResponseBodyNodesStatisticalInfo(DaraModel):
    def __init__(
        self,
        word_count: int = None,
    ):

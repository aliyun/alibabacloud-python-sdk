...
class InsertColumnsBeforeRequest(DaraModel):
    def __init__(
        self,
        column: int = None,
        column_count: int = None,
        sheet_id: str = None,
        tenant_context: main_models.InsertColumnsBeforeRequestTenantContext = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.InsertColumnsBeforeRequestTenantContext()
...
class InsertColumnsBeforeRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

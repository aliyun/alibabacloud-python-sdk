...
class UploadMediaHeaders(DaraModel):
    def __init__(
        self,
        common_headers: Dict[str, str] = None,
        account_context: main_models.UploadMediaHeadersAccountContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AccountContext') is not None:
            temp_model = main_models.UploadMediaHeadersAccountContext()
            self.account_context = temp_model.from_map(m.get('AccountContext'))

        return self

class UploadMediaHeadersAccountContext(DaraModel):
    def __init__(
        self,
        account_id: str = None,
    ):

...
class DeleteMultiDimTableFieldRequest(DaraModel):
    def __init__(
        self,
        base_id: str = None,
        field_id_or_name: str = None,
        sheet_id_or_name: str = None,
        tenant_context: main_models.DeleteMultiDimTableFieldRequestTenantContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.DeleteMultiDimTableFieldRequestTenantContext()
            self.tenant_context = temp_model.from_map(m.get('TenantContext'))

        return self

class DeleteMultiDimTableFieldRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

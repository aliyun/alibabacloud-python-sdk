...
class UpdateMeetingRoomRequest(DaraModel):
    def __init__(
        self,
        enable_cycle_reservation: bool = None,
        group_id: int = None,
        isv_room_id: str = None,
        reservation_authority: main_models.UpdateMeetingRoomRequestReservationAuthority = None,
        room_capacity: int = None,
        room_id: str = None,
        room_label_ids: List[int] = None,
        room_location: main_models.UpdateMeetingRoomRequestRoomLocation = None,
        room_name: str = None,
        room_picture: str = None,
        room_status: int = None,
        tenant_context: main_models.UpdateMeetingRoomRequestTenantContext = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ReservationAuthority') is not None:
            temp_model = main_models.UpdateMeetingRoomRequestReservationAuthority()
        ...
        if m.get('RoomLocation') is not None:
            temp_model = main_models.UpdateMeetingRoomRequestRoomLocation()
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.UpdateMeetingRoomRequestTenantContext()
            self.tenant_context = temp_model.from_map(m.get('TenantContext'))

        return self

class UpdateMeetingRoomRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):
...
class UpdateMeetingRoomRequestRoomLocation(DaraModel):
    def __init__(
        self,
        desc: str = None,
        title: str = None,
...
class UpdateMeetingRoomRequestReservationAuthority(DaraModel):
    def __init__(
        self,
        authorized_members: List[main_models.UpdateMeetingRoomRequestReservationAuthorityAuthorizedMembers] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AuthorizedMembers') is not None:
            for k1 in m.get('AuthorizedMembers'):
                temp_model = main_models.UpdateMeetingRoomRequestReservationAuthorityAuthorizedMembers()
                self.authorized_members.append(temp_model.from_map(k1))

        return self

class UpdateMeetingRoomRequestReservationAuthorityAuthorizedMembers(DaraModel):
    def __init__(
        self,
        member_id: str = None,

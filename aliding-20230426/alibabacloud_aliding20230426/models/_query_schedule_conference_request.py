...
class QueryScheduleConferenceRequest(DaraModel):
    def __init__(
        self,
        tenant_context: main_models.QueryScheduleConferenceRequestTenantContext = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.QueryScheduleConferenceRequestTenantContext()
...
class QueryScheduleConferenceRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

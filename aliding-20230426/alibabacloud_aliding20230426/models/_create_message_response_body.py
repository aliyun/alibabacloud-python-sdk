...
class CreateMessageResponseBody(DaraModel):
    def __init__(
        self,
        messages: List[main_models.CreateMessageResponseBodyMessages] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('messages') is not None:
            for k1 in m.get('messages'):
                temp_model = main_models.CreateMessageResponseBodyMessages()
...
class CreateMessageResponseBodyMessages(DaraModel):
    def __init__(
        self,
        content: main_models.CreateMessageResponseBodyMessagesContent = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('content') is not None:
            temp_model = main_models.CreateMessageResponseBodyMessagesContent()
...
class CreateMessageResponseBodyMessagesContent(DaraModel):
    def __init__(
        self,
        card_callback: main_models.CreateMessageResponseBodyMessagesContentCardCallback = None,
        ding_card: main_models.CreateMessageResponseBodyMessagesContentDingCard = None,
        ding_normal_card: main_models.CreateMessageResponseBodyMessagesContentDingNormalCard = None,
        markdown: main_models.CreateMessageResponseBodyMessagesContentMarkdown = None,
        struct_view: main_models.CreateMessageResponseBodyMessagesContentStructView = None,
        text: main_models.CreateMessageResponseBodyMessagesContentText = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cardCallback') is not None:
            temp_model = main_models.CreateMessageResponseBodyMessagesContentCardCallback()
            self.card_callback = temp_model.from_map(m.get('cardCallback'))

        if m.get('dingCard') is not None:
            temp_model = main_models.CreateMessageResponseBodyMessagesContentDingCard()
            self.ding_card = temp_model.from_map(m.get('dingCard'))

        if m.get('dingNormalCard') is not None:
            temp_model = main_models.CreateMessageResponseBodyMessagesContentDingNormalCard()
            self.ding_normal_card = temp_model.from_map(m.get('dingNormalCard'))

        if m.get('markdown') is not None:
            temp_model = main_models.CreateMessageResponseBodyMessagesContentMarkdown()
            self.markdown = temp_model.from_map(m.get('markdown'))

        if m.get('structView') is not None:
            temp_model = main_models.CreateMessageResponseBodyMessagesContentStructView()
            self.struct_view = temp_model.from_map(m.get('structView'))

        if m.get('text') is not None:
            temp_model = main_models.CreateMessageResponseBodyMessagesContentText()
...
class CreateMessageResponseBodyMessagesContentText(DaraModel):
    def __init__(
        self,
        value: str = None,
    ):
...
class CreateMessageResponseBodyMessagesContentStructView(DaraModel):
    def __init__(
        self,
        parts: List[main_models.CreateMessageResponseBodyMessagesContentStructViewParts] = None,
    ):
        self.parts = parts
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('parts') is not None:
            for k1 in m.get('parts'):
                temp_model = main_models.CreateMessageResponseBodyMessagesContentStructViewParts()
                self.parts.append(temp_model.from_map(k1))

        return self

class CreateMessageResponseBodyMessagesContentStructViewParts(DaraModel):
    def __init__(
        self,
        append: bool = None,
        data_part: main_models.CreateMessageResponseBodyMessagesContentStructViewPartsDataPart = None,
        finish: bool = None,
        part_desc: str = None,
        part_id: str = None,
        reason_part: main_models.CreateMessageResponseBodyMessagesContentStructViewPartsReasonPart = None,
        recommend_part: main_models.CreateMessageResponseBodyMessagesContentStructViewPartsRecommendPart = None,
        reference_part: main_models.CreateMessageResponseBodyMessagesContentStructViewPartsReferencePart = None,
        text_part: main_models.CreateMessageResponseBodyMessagesContentStructViewPartsTextPart = None,
        type: str = None,
    ):
        self.append = append
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dataPart') is not None:
            temp_model = main_models.CreateMessageResponseBodyMessagesContentStructViewPartsDataPart()
        ...
        if m.get('reasonPart') is not None:
            temp_model = main_models.CreateMessageResponseBodyMessagesContentStructViewPartsReasonPart()
            self.reason_part = temp_model.from_map(m.get('reasonPart'))

        if m.get('recommendPart') is not None:
            temp_model = main_models.CreateMessageResponseBodyMessagesContentStructViewPartsRecommendPart()
            self.recommend_part = temp_model.from_map(m.get('recommendPart'))

        if m.get('referencePart') is not None:
            temp_model = main_models.CreateMessageResponseBodyMessagesContentStructViewPartsReferencePart()
            self.reference_part = temp_model.from_map(m.get('referencePart'))

        if m.get('textPart') is not None:
            temp_model = main_models.CreateMessageResponseBodyMessagesContentStructViewPartsTextPart()
...
class CreateMessageResponseBodyMessagesContentStructViewPartsTextPart(DaraModel):
    def __init__(
        self,
        text: str = None,
    ):
...
class CreateMessageResponseBodyMessagesContentStructViewPartsReferencePart(DaraModel):
    def __init__(
        self,
        references: List[main_models.CreateMessageResponseBodyMessagesContentStructViewPartsReferencePartReferences] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('references') is not None:
            for k1 in m.get('references'):
                temp_model = main_models.CreateMessageResponseBodyMessagesContentStructViewPartsReferencePartReferences()
                self.references.append(temp_model.from_map(k1))

        return self

class CreateMessageResponseBodyMessagesContentStructViewPartsReferencePartReferences(DaraModel):
    def __init__(
        self,
        index: str = None,
        name: str = None,
...
class CreateMessageResponseBodyMessagesContentStructViewPartsRecommendPart(DaraModel):
    def __init__(
        self,
        recommends: List[main_models.CreateMessageResponseBodyMessagesContentStructViewPartsRecommendPartRecommends] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('recommends') is not None:
            for k1 in m.get('recommends'):
                temp_model = main_models.CreateMessageResponseBodyMessagesContentStructViewPartsRecommendPartRecommends()
                self.recommends.append(temp_model.from_map(k1))

        return self

class CreateMessageResponseBodyMessagesContentStructViewPartsRecommendPartRecommends(DaraModel):
    def __init__(
        self,
        mobile_url: str = None,
        text: str = None,
...
class CreateMessageResponseBodyMessagesContentStructViewPartsReasonPart(DaraModel):
    def __init__(
        self,
        reason: str = None,
    ):
...
class CreateMessageResponseBodyMessagesContentStructViewPartsDataPart(DaraModel):
    def __init__(
        self,
        data: Any = None,
    ):
...
class CreateMessageResponseBodyMessagesContentMarkdown(DaraModel):
    def __init__(
        self,
        value: str = None,
    ):
...
class CreateMessageResponseBodyMessagesContentDingNormalCard(DaraModel):
    def __init__(
        self,
        card_data: main_models.CreateMessageResponseBodyMessagesContentDingNormalCardCardData = None,
        card_template_id: str = None,
        card_update_options: main_models.CreateMessageResponseBodyMessagesContentDingNormalCardCardUpdateOptions = None,
        dynamic_data_source_configs: List[main_models.CreateMessageResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cardData') is not None:
            temp_model = main_models.CreateMessageResponseBodyMessagesContentDingNormalCardCardData()
        ...
        if m.get('cardUpdateOptions') is not None:
            temp_model = main_models.CreateMessageResponseBodyMessagesContentDingNormalCardCardUpdateOptions()
        ...
        if m.get('dynamicDataSourceConfigs') is not None:
            for k1 in m.get('dynamicDataSourceConfigs'):
                temp_model = main_models.CreateMessageResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigs()
...
class CreateMessageResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigs(DaraModel):
    def __init__(
        self,
        const_params: Dict[str, Any] = None,
        dynamic_data_source_id: str = None,
        pull_config: main_models.CreateMessageResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigsPullConfig = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('pullConfig') is not None:
            temp_model = main_models.CreateMessageResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigsPullConfig()
            self.pull_config = temp_model.from_map(m.get('pullConfig'))

        return self

class CreateMessageResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigsPullConfig(DaraModel):
    def __init__(
        self,
        interval: int = None,
...
class CreateMessageResponseBodyMessagesContentDingNormalCardCardUpdateOptions(DaraModel):
    def __init__(
        self,
...
class CreateMessageResponseBodyMessagesContentDingNormalCardCardData(DaraModel):
    def __init__(
        self,
...
class CreateMessageResponseBodyMessagesContentDingCard(DaraModel):
    def __init__(
        self,
        content: str = None,
...
class CreateMessageResponseBodyMessagesContentCardCallback(DaraModel):
    def __init__(
        self,
        content: str = None,

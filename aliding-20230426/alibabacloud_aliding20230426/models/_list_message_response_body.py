...
class ListMessageResponseBody(DaraModel):
    def __init__(
        self,
        messages: List[main_models.ListMessageResponseBodyMessages] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('messages') is not None:
            for k1 in m.get('messages'):
                temp_model = main_models.ListMessageResponseBodyMessages()
...
class ListMessageResponseBodyMessages(DaraModel):
    def __init__(
        self,
        content: main_models.ListMessageResponseBodyMessagesContent = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('content') is not None:
            temp_model = main_models.ListMessageResponseBodyMessagesContent()
...
class ListMessageResponseBodyMessagesContent(DaraModel):
    def __init__(
        self,
        card_callback: main_models.ListMessageResponseBodyMessagesContentCardCallback = None,
        ding_card: main_models.ListMessageResponseBodyMessagesContentDingCard = None,
        ding_normal_card: main_models.ListMessageResponseBodyMessagesContentDingNormalCard = None,
        markdown: main_models.ListMessageResponseBodyMessagesContentMarkdown = None,
        struct_view: main_models.ListMessageResponseBodyMessagesContentStructView = None,
        text: main_models.ListMessageResponseBodyMessagesContentText = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cardCallback') is not None:
            temp_model = main_models.ListMessageResponseBodyMessagesContentCardCallback()
            self.card_callback = temp_model.from_map(m.get('cardCallback'))

        if m.get('dingCard') is not None:
            temp_model = main_models.ListMessageResponseBodyMessagesContentDingCard()
            self.ding_card = temp_model.from_map(m.get('dingCard'))

        if m.get('dingNormalCard') is not None:
            temp_model = main_models.ListMessageResponseBodyMessagesContentDingNormalCard()
            self.ding_normal_card = temp_model.from_map(m.get('dingNormalCard'))

        if m.get('markdown') is not None:
            temp_model = main_models.ListMessageResponseBodyMessagesContentMarkdown()
            self.markdown = temp_model.from_map(m.get('markdown'))

        if m.get('structView') is not None:
            temp_model = main_models.ListMessageResponseBodyMessagesContentStructView()
            self.struct_view = temp_model.from_map(m.get('structView'))

        if m.get('text') is not None:
            temp_model = main_models.ListMessageResponseBodyMessagesContentText()
...
class ListMessageResponseBodyMessagesContentText(DaraModel):
    def __init__(
        self,
        value: str = None,
    ):
...
class ListMessageResponseBodyMessagesContentStructView(DaraModel):
    def __init__(
        self,
        parts: List[main_models.ListMessageResponseBodyMessagesContentStructViewParts] = None,
    ):
        self.parts = parts
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('parts') is not None:
            for k1 in m.get('parts'):
                temp_model = main_models.ListMessageResponseBodyMessagesContentStructViewParts()
                self.parts.append(temp_model.from_map(k1))

        return self

class ListMessageResponseBodyMessagesContentStructViewParts(DaraModel):
    def __init__(
        self,
        append: bool = None,
        data_part: main_models.ListMessageResponseBodyMessagesContentStructViewPartsDataPart = None,
        finish: bool = None,
        part_desc: str = None,
        part_id: str = None,
        reason_part: main_models.ListMessageResponseBodyMessagesContentStructViewPartsReasonPart = None,
        recommend_part: main_models.ListMessageResponseBodyMessagesContentStructViewPartsRecommendPart = None,
        reference_part: main_models.ListMessageResponseBodyMessagesContentStructViewPartsReferencePart = None,
        text_part: main_models.ListMessageResponseBodyMessagesContentStructViewPartsTextPart = None,
        type: str = None,
    ):
        self.append = append
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('dataPart') is not None:
            temp_model = main_models.ListMessageResponseBodyMessagesContentStructViewPartsDataPart()
        ...
        if m.get('reasonPart') is not None:
            temp_model = main_models.ListMessageResponseBodyMessagesContentStructViewPartsReasonPart()
            self.reason_part = temp_model.from_map(m.get('reasonPart'))

        if m.get('recommendPart') is not None:
            temp_model = main_models.ListMessageResponseBodyMessagesContentStructViewPartsRecommendPart()
            self.recommend_part = temp_model.from_map(m.get('recommendPart'))

        if m.get('referencePart') is not None:
            temp_model = main_models.ListMessageResponseBodyMessagesContentStructViewPartsReferencePart()
            self.reference_part = temp_model.from_map(m.get('referencePart'))

        if m.get('textPart') is not None:
            temp_model = main_models.ListMessageResponseBodyMessagesContentStructViewPartsTextPart()
...
class ListMessageResponseBodyMessagesContentStructViewPartsTextPart(DaraModel):
    def __init__(
        self,
        text: str = None,
    ):
...
class ListMessageResponseBodyMessagesContentStructViewPartsReferencePart(DaraModel):
    def __init__(
        self,
        references: List[main_models.ListMessageResponseBodyMessagesContentStructViewPartsReferencePartReferences] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('references') is not None:
            for k1 in m.get('references'):
                temp_model = main_models.ListMessageResponseBodyMessagesContentStructViewPartsReferencePartReferences()
                self.references.append(temp_model.from_map(k1))

        return self

class ListMessageResponseBodyMessagesContentStructViewPartsReferencePartReferences(DaraModel):
    def __init__(
        self,
        index: str = None,
        name: str = None,
...
class ListMessageResponseBodyMessagesContentStructViewPartsRecommendPart(DaraModel):
    def __init__(
        self,
        recommends: List[main_models.ListMessageResponseBodyMessagesContentStructViewPartsRecommendPartRecommends] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('recommends') is not None:
            for k1 in m.get('recommends'):
                temp_model = main_models.ListMessageResponseBodyMessagesContentStructViewPartsRecommendPartRecommends()
                self.recommends.append(temp_model.from_map(k1))

        return self

class ListMessageResponseBodyMessagesContentStructViewPartsRecommendPartRecommends(DaraModel):
    def __init__(
        self,
        mobile_url: str = None,
        text: str = None,
...
class ListMessageResponseBodyMessagesContentStructViewPartsReasonPart(DaraModel):
    def __init__(
        self,
        reason: str = None,
    ):
...
class ListMessageResponseBodyMessagesContentStructViewPartsDataPart(DaraModel):
    def __init__(
        self,
        data: Any = None,
    ):
...
class ListMessageResponseBodyMessagesContentMarkdown(DaraModel):
    def __init__(
        self,
        value: str = None,
    ):
...
class ListMessageResponseBodyMessagesContentDingNormalCard(DaraModel):
    def __init__(
        self,
        card_data: main_models.ListMessageResponseBodyMessagesContentDingNormalCardCardData = None,
        card_template_id: str = None,
        card_update_options: main_models.ListMessageResponseBodyMessagesContentDingNormalCardCardUpdateOptions = None,
        dynamic_data_source_configs: List[main_models.ListMessageResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('cardData') is not None:
            temp_model = main_models.ListMessageResponseBodyMessagesContentDingNormalCardCardData()
        ...
        if m.get('cardUpdateOptions') is not None:
            temp_model = main_models.ListMessageResponseBodyMessagesContentDingNormalCardCardUpdateOptions()
        ...
        if m.get('dynamicDataSourceConfigs') is not None:
            for k1 in m.get('dynamicDataSourceConfigs'):
                temp_model = main_models.ListMessageResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigs()
...
class ListMessageResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigs(DaraModel):
    def __init__(
        self,
        const_params: Dict[str, Any] = None,
        dynamic_data_source_id: str = None,
        pull_config: main_models.ListMessageResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigsPullConfig = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('pullConfig') is not None:
            temp_model = main_models.ListMessageResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigsPullConfig()
            self.pull_config = temp_model.from_map(m.get('pullConfig'))

        return self

class ListMessageResponseBodyMessagesContentDingNormalCardDynamicDataSourceConfigsPullConfig(DaraModel):
    def __init__(
        self,
        interval: int = None,
...
class ListMessageResponseBodyMessagesContentDingNormalCardCardUpdateOptions(DaraModel):
    def __init__(
        self,
...
class ListMessageResponseBodyMessagesContentDingNormalCardCardData(DaraModel):
    def __init__(
        self,
...
class ListMessageResponseBodyMessagesContentDingCard(DaraModel):
    def __init__(
        self,
        content: str = None,
...
class ListMessageResponseBodyMessagesContentCardCallback(DaraModel):
    def __init__(
        self,
        content: str = None,

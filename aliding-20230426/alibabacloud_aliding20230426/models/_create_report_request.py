...
class CreateReportRequest(DaraModel):
    def __init__(
        self,
        contents: List[main_models.CreateReportRequestContents] = None,
        dd_from: str = None,
        template_id: str = None,
        tenant_context: main_models.CreateReportRequestTenantContext = None,
        to_chat: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Contents') is not None:
            for k1 in m.get('Contents'):
                temp_model = main_models.CreateReportRequestContents()
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.CreateReportRequestTenantContext()
...
class CreateReportRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):
...
class CreateReportRequestContents(DaraModel):
    def __init__(
        self,
        content: str = None,

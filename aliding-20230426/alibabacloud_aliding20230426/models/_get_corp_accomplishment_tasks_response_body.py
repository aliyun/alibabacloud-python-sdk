...
class GetCorpAccomplishmentTasksResponseBody(DaraModel):
    def __init__(
        self,
        data: List[main_models.GetCorpAccomplishmentTasksResponseBodyData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            for k1 in m.get('data'):
                temp_model = main_models.GetCorpAccomplishmentTasksResponseBodyData()
...
class GetCorpAccomplishmentTasksResponseBodyData(DaraModel):
    def __init__(
        self,

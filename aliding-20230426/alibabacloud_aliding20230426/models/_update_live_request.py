...
class UpdateLiveRequest(DaraModel):
    def __init__(
        self,
        cover_url: str = None,
        ...
        tenant_context: main_models.UpdateLiveRequestTenantContext = None,
        title: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.UpdateLiveRequestTenantContext()
...
class UpdateLiveRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

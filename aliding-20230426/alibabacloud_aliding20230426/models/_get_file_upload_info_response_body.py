...
class GetFileUploadInfoResponseBody(DaraModel):
    def __init__(
        self,
        header_signature_info: main_models.GetFileUploadInfoResponseBodyHeaderSignatureInfo = None,
        protocol: str = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('headerSignatureInfo') is not None:
            temp_model = main_models.GetFileUploadInfoResponseBodyHeaderSignatureInfo()
...
class GetFileUploadInfoResponseBodyHeaderSignatureInfo(DaraModel):
    def __init__(
        self,

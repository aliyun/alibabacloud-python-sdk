...
class StartCloudRecordRequest(DaraModel):
    def __init__(
        ...
        tenant_context: main_models.StartCloudRecordRequestTenantContext = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.StartCloudRecordRequestTenantContext()
...
class StartCloudRecordRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

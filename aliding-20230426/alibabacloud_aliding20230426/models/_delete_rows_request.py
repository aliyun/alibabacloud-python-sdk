...
class DeleteRowsRequest(DaraModel):
    def __init__(
        self,
        row: int = None,
        row_count: int = None,
        sheet_id: str = None,
        tenant_context: main_models.DeleteRowsRequestTenantContext = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TenantContext') is not None:
            temp_model = main_models.DeleteRowsRequestTenantContext()
...
class DeleteRowsRequestTenantContext(DaraModel):
    def __init__(
        self,
        tenant_id: str = None,
    ):

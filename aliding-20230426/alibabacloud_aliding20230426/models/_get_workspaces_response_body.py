...
class GetWorkspacesResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def to_map(self):
        ...
        if self.workspace is not None:
            for k1 in self.workspace:
                result['workspace'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('workspace') is not None:
            for k1 in m.get('workspace'):
                temp_model = main_models.GetWorkspacesResponseBodyWorkspace()
                self.workspace.append(temp_model.from_map(k1))

        return self

class GetWorkspacesResponseBodyWorkspace(DaraModel):
    def __init__(
        self,
        corp_id: str = None,
        cover: str = None,
        ...
        icon: main_models.GetWorkspacesResponseBodyWorkspaceIcon = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Icon') is not None:
            temp_model = main_models.GetWorkspacesResponseBodyWorkspaceIcon()
...
class GetWorkspacesResponseBodyWorkspaceIcon(DaraModel):
    def __init__(
        self,
        type: str = None,
        value: str = None,

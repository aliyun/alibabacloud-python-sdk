...
class GetAiModelProviderResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetAiModelProviderResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.GetAiModelProviderResponseBodyData()
...
class GetAiModelProviderResponseBodyData(DaraModel):
    def __init__(
        self,
        bound_services: List[main_models.ServiceInfo] = None,
        display_name: str = None,
        gateway_id: str = None,
        model_cards: List[main_models.GetAiModelProviderResponseBodyDataModelCards] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('modelCards') is not None:
            for k1 in m.get('modelCards'):
                temp_model = main_models.GetAiModelProviderResponseBodyDataModelCards()
...
class GetAiModelProviderResponseBodyDataModelCards(DaraModel):
    def __init__(
        self,
        available_paths: List[main_models.GetAiModelProviderResponseBodyDataModelCardsAvailablePaths] = None,
        credit: main_models.GetAiModelProviderResponseBodyDataModelCardsCredit = None,
        features: Dict[str, Any] = None,
        gateway_id: str = None,
        meta: main_models.GetAiModelProviderResponseBodyDataModelCardsMeta = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('availablePaths') is not None:
            for k1 in m.get('availablePaths'):
                temp_model = main_models.GetAiModelProviderResponseBodyDataModelCardsAvailablePaths()
                self.available_paths.append(temp_model.from_map(k1))

        if m.get('credit') is not None:
            temp_model = main_models.GetAiModelProviderResponseBodyDataModelCardsCredit()
        ...
        if m.get('meta') is not None:
            temp_model = main_models.GetAiModelProviderResponseBodyDataModelCardsMeta()
...
class GetAiModelProviderResponseBodyDataModelCardsMeta(DaraModel):
    def __init__(
        self,
...
class GetAiModelProviderResponseBodyDataModelCardsCredit(DaraModel):
    def __init__(
        self,
...
class GetAiModelProviderResponseBodyDataModelCardsAvailablePaths(DaraModel):
    def __init__(
        self,
        path: str = None,
        type: str = None,

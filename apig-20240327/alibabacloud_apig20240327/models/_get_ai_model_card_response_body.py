...
class GetAiModelCardResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetAiModelCardResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.GetAiModelCardResponseBodyData()
...
class GetAiModelCardResponseBodyData(DaraModel):
    def __init__(
        self,
        available_paths: List[main_models.GetAiModelCardResponseBodyDataAvailablePaths] = None,
        credit: main_models.GetAiModelCardResponseBodyDataCredit = None,
        features: Dict[str, Any] = None,
        gateway_id: str = None,
        meta: main_models.GetAiModelCardResponseBodyDataMeta = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('availablePaths') is not None:
            for k1 in m.get('availablePaths'):
                temp_model = main_models.GetAiModelCardResponseBodyDataAvailablePaths()
                self.available_paths.append(temp_model.from_map(k1))

        if m.get('credit') is not None:
            temp_model = main_models.GetAiModelCardResponseBodyDataCredit()
        ...
        if m.get('meta') is not None:
            temp_model = main_models.GetAiModelCardResponseBodyDataMeta()
...
class GetAiModelCardResponseBodyDataMeta(DaraModel):
    def __init__(
        self,
...
class GetAiModelCardResponseBodyDataCredit(DaraModel):
    def __init__(
        self,
...
class GetAiModelCardResponseBodyDataAvailablePaths(DaraModel):
    def __init__(
        self,
        path: str = None,
        type: str = None,

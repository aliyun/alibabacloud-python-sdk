...
class BatchAddConsumerGroupConsumersResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.BatchAddConsumerGroupConsumersResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.BatchAddConsumerGroupConsumersResponseBodyData()
...
class BatchAddConsumerGroupConsumersResponseBodyData(DaraModel):
    def __init__(
        self,

...
class CreateAiModelCardResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.CreateAiModelCardResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.CreateAiModelCardResponseBodyData()
...
class CreateAiModelCardResponseBodyData(DaraModel):
    def __init__(
        self,
        available_paths: List[main_models.CreateAiModelCardResponseBodyDataAvailablePaths] = None,
        credit: main_models.CreateAiModelCardResponseBodyDataCredit = None,
        features: Dict[str, Any] = None,
        gateway_id: str = None,
        meta: main_models.CreateAiModelCardResponseBodyDataMeta = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('availablePaths') is not None:
            for k1 in m.get('availablePaths'):
                temp_model = main_models.CreateAiModelCardResponseBodyDataAvailablePaths()
                self.available_paths.append(temp_model.from_map(k1))

        if m.get('credit') is not None:
            temp_model = main_models.CreateAiModelCardResponseBodyDataCredit()
        ...
        if m.get('meta') is not None:
            temp_model = main_models.CreateAiModelCardResponseBodyDataMeta()
...
class CreateAiModelCardResponseBodyDataMeta(DaraModel):
    def __init__(
        self,
...
class CreateAiModelCardResponseBodyDataCredit(DaraModel):
    def __init__(
        self,
...
class CreateAiModelCardResponseBodyDataAvailablePaths(DaraModel):
    def __init__(
        self,
        path: str = None,
        type: str = None,

...
class ListAiModelProvidersResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ListAiModelProvidersResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.ListAiModelProvidersResponseBodyData()
...
class ListAiModelProvidersResponseBodyData(DaraModel):
    def __init__(
        self,
        items: List[main_models.ListAiModelProvidersResponseBodyDataItems] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('items') is not None:
            for k1 in m.get('items'):
                temp_model = main_models.ListAiModelProvidersResponseBodyDataItems()
...
class ListAiModelProvidersResponseBodyDataItems(DaraModel):
    def __init__(
        self,
        bound_services: List[main_models.ServiceInfo] = None,
        display_name: str = None,
        gateway_id: str = None,
        model_cards: List[main_models.ListAiModelProvidersResponseBodyDataItemsModelCards] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('modelCards') is not None:
            for k1 in m.get('modelCards'):
                temp_model = main_models.ListAiModelProvidersResponseBodyDataItemsModelCards()
...
class ListAiModelProvidersResponseBodyDataItemsModelCards(DaraModel):
    def __init__(
        self,
        available_paths: List[main_models.ListAiModelProvidersResponseBodyDataItemsModelCardsAvailablePaths] = None,
        credit: main_models.ListAiModelProvidersResponseBodyDataItemsModelCardsCredit = None,
        features: Dict[str, Any] = None,
        gateway_id: str = None,
        meta: main_models.ListAiModelProvidersResponseBodyDataItemsModelCardsMeta = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('availablePaths') is not None:
            for k1 in m.get('availablePaths'):
                temp_model = main_models.ListAiModelProvidersResponseBodyDataItemsModelCardsAvailablePaths()
                self.available_paths.append(temp_model.from_map(k1))

        if m.get('credit') is not None:
            temp_model = main_models.ListAiModelProvidersResponseBodyDataItemsModelCardsCredit()
        ...
        if m.get('meta') is not None:
            temp_model = main_models.ListAiModelProvidersResponseBodyDataItemsModelCardsMeta()
...
class ListAiModelProvidersResponseBodyDataItemsModelCardsMeta(DaraModel):
    def __init__(
        self,
...
class ListAiModelProvidersResponseBodyDataItemsModelCardsCredit(DaraModel):
    def __init__(
        self,
...
class ListAiModelProvidersResponseBodyDataItemsModelCardsAvailablePaths(DaraModel):
    def __init__(
        self,
        path: str = None,
        type: str = None,

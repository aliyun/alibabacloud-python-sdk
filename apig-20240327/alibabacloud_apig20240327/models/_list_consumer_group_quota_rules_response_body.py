...
class ListConsumerGroupQuotaRulesResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ListConsumerGroupQuotaRulesResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.ListConsumerGroupQuotaRulesResponseBodyData()
...
class ListConsumerGroupQuotaRulesResponseBodyData(DaraModel):
    def __init__(
        self,
        items: List[main_models.ListConsumerGroupQuotaRulesResponseBodyDataItems] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('items') is not None:
            for k1 in m.get('items'):
                temp_model = main_models.ListConsumerGroupQuotaRulesResponseBodyDataItems()
...
class ListConsumerGroupQuotaRulesResponseBodyDataItems(DaraModel):
    def __init__(
        self,
        gateway_id: str = None,

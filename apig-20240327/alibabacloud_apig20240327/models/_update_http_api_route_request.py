    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('policyConfigs') is not None:
            for k1 in m.get('policyConfigs'):
                temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigs()
                self.policy_configs.append(temp_model.from_map(k1))

        return self

class UpdateHttpApiRouteRequestPolicyConfigs(DaraModel):
    def __init__(
        self,
        ai_cache_config: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiCacheConfig = None,
        ai_fallback_config: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiFallbackConfig = None,
        ai_network_search_config: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiNetworkSearchConfig = None,
        ai_security_guard_config: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfig = None,
        ai_statistics_config: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiStatisticsConfig = None,
        ai_token_rate_limit_config: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiTokenRateLimitConfig = None,
        ai_tool_selection_config: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfig = None,
        enable: bool = None,
        semantic_router_config: main_models.UpdateHttpApiRouteRequestPolicyConfigsSemanticRouterConfig = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('aiToolSelectionConfig') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfig()
        ...
        if m.get('semanticRouterConfig') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsSemanticRouterConfig()
...
class UpdateHttpApiRouteRequestPolicyConfigsSemanticRouterConfig(DaraModel):
    def __init__(
        self,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfig(DaraModel):
    def __init__(
        self,
        enable_conditions: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigEnableConditions = None,
        plugin_status: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigPluginStatus = None,
        query_rewriting: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigQueryRewriting = None,
        tool_reranking: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigToolReranking = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('enableConditions') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigEnableConditions()
            self.enable_conditions = temp_model.from_map(m.get('enableConditions'))

        if m.get('pluginStatus') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigPluginStatus()
            self.plugin_status = temp_model.from_map(m.get('pluginStatus'))

        if m.get('queryRewriting') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigQueryRewriting()
            self.query_rewriting = temp_model.from_map(m.get('queryRewriting'))

        if m.get('toolReranking') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigToolReranking()
            self.tool_reranking = temp_model.from_map(m.get('toolReranking'))

        return self

class UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigToolReranking(DaraModel):
    def __init__(
        self,
        fallback_strategy: str = None,
        filtering_method: str = None,
        model_service: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigToolRerankingModelService = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('modelService') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigToolRerankingModelService()
...
class UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigToolRerankingModelService(DaraModel):
    def __init__(
        self,
        model_name: str = None,
        service_id: str = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigQueryRewriting(DaraModel):
    def __init__(
        self,
        context_selection: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigQueryRewritingContextSelection = None,
        enabled: bool = None,
        fallback_strategy: str = None,
        max_output_tokens: int = None,
        model_service: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigQueryRewritingModelService = None,
        prompt_config: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigQueryRewritingPromptConfig = None,
        trigger_conditions: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigQueryRewritingTriggerConditions = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('contextSelection') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigQueryRewritingContextSelection()
        ...
        if m.get('modelService') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigQueryRewritingModelService()
            self.model_service = temp_model.from_map(m.get('modelService'))

        if m.get('promptConfig') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigQueryRewritingPromptConfig()
            self.prompt_config = temp_model.from_map(m.get('promptConfig'))

        if m.get('triggerConditions') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigQueryRewritingTriggerConditions()
            self.trigger_conditions = temp_model.from_map(m.get('triggerConditions'))

        return self

class UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigQueryRewritingTriggerConditions(DaraModel):
    def __init__(
        self,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigQueryRewritingPromptConfig(DaraModel):
    def __init__(
        self,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigQueryRewritingModelService(DaraModel):
    def __init__(
        self,
        model_name: str = None,
        service_id: str = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigQueryRewritingContextSelection(DaraModel):
    def __init__(
        self,
        type: str = None,
        value: int = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigPluginStatus(DaraModel):
    def __init__(
        self,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiToolSelectionConfigEnableConditions(DaraModel):
    def __init__(
        self,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiTokenRateLimitConfig(DaraModel):
    def __init__(
        self,
        enable_global_rules: bool = None,
        global_rules: List[main_models.UpdateHttpApiRouteRequestPolicyConfigsAiTokenRateLimitConfigGlobalRules] = None,
        plugin_status: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiTokenRateLimitConfigPluginStatus = None,
        redis_config: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiTokenRateLimitConfigRedisConfig = None,
        rules: List[main_models.UpdateHttpApiRouteRequestPolicyConfigsAiTokenRateLimitConfigRules] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('globalRules') is not None:
            for k1 in m.get('globalRules'):
                temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiTokenRateLimitConfigGlobalRules()
                self.global_rules.append(temp_model.from_map(k1))

        if m.get('pluginStatus') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiTokenRateLimitConfigPluginStatus()
            self.plugin_status = temp_model.from_map(m.get('pluginStatus'))

        if m.get('redisConfig') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiTokenRateLimitConfigRedisConfig()
            self.redis_config = temp_model.from_map(m.get('redisConfig'))

        self.rules = []
        if m.get('rules') is not None:
            for k1 in m.get('rules'):
                temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiTokenRateLimitConfigRules()
                self.rules.append(temp_model.from_map(k1))

        return self

class UpdateHttpApiRouteRequestPolicyConfigsAiTokenRateLimitConfigRules(DaraModel):
    def __init__(
        self,
        limit_mode: str = None,
        limit_type: str = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiTokenRateLimitConfigRedisConfig(DaraModel):
    def __init__(
        self,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiTokenRateLimitConfigPluginStatus(DaraModel):
    def __init__(
        self,
        error_logs: Dict[str, str] = None,
        plugin_id: str = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiTokenRateLimitConfigGlobalRules(DaraModel):
    def __init__(
        self,
        limit_mode: str = None,
        limit_type: str = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiStatisticsConfig(DaraModel):
    def __init__(
        self,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfig(DaraModel):
    def __init__(
        self,
        ...
        consumer_request_check_service: List[main_models.UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigConsumerRequestCheckService] = None,
        consumer_response_check_service: List[main_models.UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigConsumerResponseCheckService] = None,
        consumer_risk_level: List[main_models.UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigConsumerRiskLevel] = None,
        plugin_status: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigPluginStatus = None,
        ...
        risk_config: List[main_models.UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigRiskConfig] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('consumerRequestCheckService') is not None:
            for k1 in m.get('consumerRequestCheckService'):
                temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigConsumerRequestCheckService()
        ...
        if m.get('consumerResponseCheckService') is not None:
            for k1 in m.get('consumerResponseCheckService'):
                temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigConsumerResponseCheckService()
        ...
        if m.get('consumerRiskLevel') is not None:
            for k1 in m.get('consumerRiskLevel'):
                temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigConsumerRiskLevel()
                self.consumer_risk_level.append(temp_model.from_map(k1))

        if m.get('pluginStatus') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigPluginStatus()
            self.plugin_status = temp_model.from_map(m.get('pluginStatus'))
        ...
        if m.get('riskConfig') is not None:
            for k1 in m.get('riskConfig'):
                temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigRiskConfig()
...
class UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigRiskConfig(DaraModel):
    def __init__(
        self,
        consumer_rules: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigRiskConfigConsumerRules = None,
        level: str = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('consumerRules') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigRiskConfigConsumerRules()
...
class UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigRiskConfigConsumerRules(DaraModel):
    def __init__(
        self,
        match_type: str = None,
        pattern: str = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigPluginStatus(DaraModel):
    def __init__(
        self,
        error_logs: Dict[str, str] = None,
        plugin_id: str = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigConsumerRiskLevel(DaraModel):
    def __init__(
        self,
        level: str = None,
        match_type: str = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigConsumerResponseCheckService(DaraModel):
    def __init__(
        self,
        match_type: str = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiSecurityGuardConfigConsumerRequestCheckService(DaraModel):
    def __init__(
        self,
        match_type: str = None,
        modality_type: str = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiNetworkSearchConfig(DaraModel):
    def __init__(
        self,
        default_enable: bool = None,
        default_lang: str = None,
        need_reference: bool = None,
        plugin_status: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiNetworkSearchConfigPluginStatus = None,
        reference_format: str = None,
        reference_location: str = None,
        search_engine_config: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiNetworkSearchConfigSearchEngineConfig = None,
        search_from: List[main_models.UpdateHttpApiRouteRequestPolicyConfigsAiNetworkSearchConfigSearchFrom] = None,
        search_rewrite: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiNetworkSearchConfigSearchRewrite = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('pluginStatus') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiNetworkSearchConfigPluginStatus()
            self.plugin_status = temp_model.from_map(m.get('pluginStatus'))
        ...
        if m.get('searchEngineConfig') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiNetworkSearchConfigSearchEngineConfig()
        ...
        if m.get('searchFrom') is not None:
            for k1 in m.get('searchFrom'):
                temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiNetworkSearchConfigSearchFrom()
                self.search_from.append(temp_model.from_map(k1))

        if m.get('searchRewrite') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiNetworkSearchConfigSearchRewrite()
            self.search_rewrite = temp_model.from_map(m.get('searchRewrite'))

        return self

class UpdateHttpApiRouteRequestPolicyConfigsAiNetworkSearchConfigSearchRewrite(DaraModel):
    def __init__(
        self,
        enable: bool = None,
        max_count: int = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiNetworkSearchConfigSearchFrom(DaraModel):
    def __init__(
        self,
        api_key: str = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiNetworkSearchConfigSearchEngineConfig(DaraModel):
    def __init__(
        self,
        api_key: str = None,
        content_mode: str = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiNetworkSearchConfigPluginStatus(DaraModel):
    def __init__(
        self,
        error_logs: Dict[str, str] = None,
        plugin_id: str = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiFallbackConfig(DaraModel):
    def __init__(
        self,
        only_redirect_upstream_code: bool = None,
        route_embedded: bool = None,
        service_configs: List[main_models.UpdateHttpApiRouteRequestPolicyConfigsAiFallbackConfigServiceConfigs] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('serviceConfigs') is not None:
            for k1 in m.get('serviceConfigs'):
                temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiFallbackConfigServiceConfigs()
                self.service_configs.append(temp_model.from_map(k1))

        return self

class UpdateHttpApiRouteRequestPolicyConfigsAiFallbackConfigServiceConfigs(DaraModel):
    def __init__(
        self,
        name: str = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiCacheConfig(DaraModel):
    def __init__(
        self,
        cache_key_strategy: str = None,
        cache_mode: str = None,
        cache_ttl: int = None,
        embedding_config: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiCacheConfigEmbeddingConfig = None,
        plugin_status: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiCacheConfigPluginStatus = None,
        redis_config: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiCacheConfigRedisConfig = None,
        vector_config: main_models.UpdateHttpApiRouteRequestPolicyConfigsAiCacheConfigVectorConfig = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('embeddingConfig') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiCacheConfigEmbeddingConfig()
            self.embedding_config = temp_model.from_map(m.get('embeddingConfig'))

        if m.get('pluginStatus') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiCacheConfigPluginStatus()
            self.plugin_status = temp_model.from_map(m.get('pluginStatus'))

        if m.get('redisConfig') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiCacheConfigRedisConfig()
            self.redis_config = temp_model.from_map(m.get('redisConfig'))

        if m.get('vectorConfig') is not None:
            temp_model = main_models.UpdateHttpApiRouteRequestPolicyConfigsAiCacheConfigVectorConfig()
            self.vector_config = temp_model.from_map(m.get('vectorConfig'))

        return self

class UpdateHttpApiRouteRequestPolicyConfigsAiCacheConfigVectorConfig(DaraModel):
    def __init__(
        self,
        api_key: str = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiCacheConfigRedisConfig(DaraModel):
    def __init__(
        self,
        database_number: int = None,
        host: str = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiCacheConfigPluginStatus(DaraModel):
    def __init__(
        self,
        error_logs: Dict[str, str] = None,
        plugin_id: str = None,
...
class UpdateHttpApiRouteRequestPolicyConfigsAiCacheConfigEmbeddingConfig(DaraModel):
    def __init__(
        self,
        model_name: str = None,
        service_id: str = None,

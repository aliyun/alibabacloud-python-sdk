...
class CreatePolicyAttachmentResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.CreatePolicyAttachmentResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
        # Response code.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.CreatePolicyAttachmentResponseBodyData()
...
class CreatePolicyAttachmentResponseBodyData(DaraModel):
    def __init__(
        self,

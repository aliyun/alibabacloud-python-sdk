...
class CreateConsumerAuthorizationRulesResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.CreateConsumerAuthorizationRulesResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
        # The status code.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.CreateConsumerAuthorizationRulesResponseBodyData()
...
class CreateConsumerAuthorizationRulesResponseBodyData(DaraModel):
    def __init__(
        self,

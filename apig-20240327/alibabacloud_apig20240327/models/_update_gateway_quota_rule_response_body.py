...
class UpdateGatewayQuotaRuleResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.UpdateGatewayQuotaRuleResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.UpdateGatewayQuotaRuleResponseBodyData()
...
class UpdateGatewayQuotaRuleResponseBodyData(DaraModel):
    def __init__(
        self,
        accepted: bool = None,
        conflict_preview: main_models.UpdateGatewayQuotaRuleResponseBodyDataConflictPreview = None,
        dry_run: bool = None,
        rule_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('conflictPreview') is not None:
            temp_model = main_models.UpdateGatewayQuotaRuleResponseBodyDataConflictPreview()
...
class UpdateGatewayQuotaRuleResponseBodyDataConflictPreview(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('items') is not None:
            for k1 in m.get('items'):
                temp_model = main_models.UpdateGatewayQuotaRuleResponseBodyDataConflictPreviewItems()
...
class UpdateGatewayQuotaRuleResponseBodyDataConflictPreviewItems(DaraModel):
    def __init__(
        self,

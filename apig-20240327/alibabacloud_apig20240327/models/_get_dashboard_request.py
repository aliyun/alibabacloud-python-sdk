...
class GetDashboardRequest(DaraModel):
    def __init__(
        self,
        accept_language: str = None,
        api_id: str = None,
        filter: main_models.GetDashboardRequestFilter = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('filter') is not None:
            temp_model = main_models.GetDashboardRequestFilter()
...
class GetDashboardRequestFilter(DaraModel):
    def __init__(
        self,
        route_name: str = None,
    ):

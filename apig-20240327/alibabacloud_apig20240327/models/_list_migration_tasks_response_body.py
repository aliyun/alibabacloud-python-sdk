...
class ListMigrationTasksResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ListMigrationTasksResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.ListMigrationTasksResponseBodyData()
...
class ListMigrationTasksResponseBodyData(DaraModel):
    def __init__(
        self,
        items: List[main_models.ListMigrationTasksResponseBodyDataItems] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('items') is not None:
            for k1 in m.get('items'):
                temp_model = main_models.ListMigrationTasksResponseBodyDataItems()
...
class ListMigrationTasksResponseBodyDataItems(DaraModel):
    def __init__(
        self,
        api_id: str = None,
        api_name: str = None,
        ...
        ingress_config: main_models.ListMigrationTasksResponseBodyDataItemsIngressConfig = None,
        ...
        task_id: str = None,
        user_id: str = None,
        virtual_services: List[main_models.ListMigrationTasksResponseBodyDataItemsVirtualServices] = None,
        weight: int = None,
    ):
        self.api_id = api_id
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ingressConfig') is not None:
            temp_model = main_models.ListMigrationTasksResponseBodyDataItemsIngressConfig()
        ...
        if m.get('virtualServices') is not None:
            for k1 in m.get('virtualServices'):
                temp_model = main_models.ListMigrationTasksResponseBodyDataItemsVirtualServices()
...
class ListMigrationTasksResponseBodyDataItemsVirtualServices(DaraModel):
    def __init__(
        self,
        port: int = None,
        protocol: str = None,
...
class ListMigrationTasksResponseBodyDataItemsIngressConfig(DaraModel):
    def __init__(
        self,

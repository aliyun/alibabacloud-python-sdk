...
class UpdateAiModelCardResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.UpdateAiModelCardResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.UpdateAiModelCardResponseBodyData()
...
class UpdateAiModelCardResponseBodyData(DaraModel):
    def __init__(
        self,
        available_paths: List[main_models.UpdateAiModelCardResponseBodyDataAvailablePaths] = None,
        credit: main_models.UpdateAiModelCardResponseBodyDataCredit = None,
        features: Dict[str, Any] = None,
        gateway_id: str = None,
        meta: main_models.UpdateAiModelCardResponseBodyDataMeta = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('availablePaths') is not None:
            for k1 in m.get('availablePaths'):
                temp_model = main_models.UpdateAiModelCardResponseBodyDataAvailablePaths()
                self.available_paths.append(temp_model.from_map(k1))

        if m.get('credit') is not None:
            temp_model = main_models.UpdateAiModelCardResponseBodyDataCredit()
        ...
        if m.get('meta') is not None:
            temp_model = main_models.UpdateAiModelCardResponseBodyDataMeta()
...
class UpdateAiModelCardResponseBodyDataMeta(DaraModel):
    def __init__(
        self,
...
class UpdateAiModelCardResponseBodyDataCredit(DaraModel):
    def __init__(
        self,
...
class UpdateAiModelCardResponseBodyDataAvailablePaths(DaraModel):
    def __init__(
        self,
        path: str = None,
        type: str = None,

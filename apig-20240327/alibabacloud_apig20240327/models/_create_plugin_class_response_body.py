...
class CreatePluginClassResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.CreatePluginClassResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.CreatePluginClassResponseBodyData()
...
class CreatePluginClassResponseBodyData(DaraModel):
    def __init__(
        self,

...
class FilterUsersRequest(DaraModel):
    def __init__(
        self,
        ...
        next_token: str = None,
        order_param: main_models.FilterUsersRequestOrderParam = None,
        org_id: str = None,
        owner_type: str = None,
        property_filter_param: List[main_models.FilterUsersRequestPropertyFilterParam] = None,
        property_key_value_filter_param: List[main_models.FilterUsersRequestPropertyKeyValueFilterParam] = None,
        status: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OrderParam') is not None:
            temp_model = main_models.FilterUsersRequestOrderParam()
            self.order_param = temp_model.from_map(m.get('OrderParam'))
        ...
        if m.get('PropertyFilterParam') is not None:
            for k1 in m.get('PropertyFilterParam'):
                temp_model = main_models.FilterUsersRequestPropertyFilterParam()
        ...
        if m.get('PropertyKeyValueFilterParam') is not None:
            for k1 in m.get('PropertyKeyValueFilterParam'):
                temp_model = main_models.FilterUsersRequestPropertyKeyValueFilterParam()
...
class FilterUsersRequestPropertyKeyValueFilterParam(DaraModel):
    def __init__(
        self,
...
class FilterUsersRequestPropertyFilterParam(DaraModel):
    def __init__(
        self,
...
class FilterUsersRequestOrderParam(DaraModel):
    def __init__(
        self,

...
class CreatePropertyResponseBody(DaraModel):
    def __init__(
        self,
        create_result: main_models.CreatePropertyResponseBodyCreateResult = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CreateResult') is not None:
            temp_model = main_models.CreatePropertyResponseBodyCreateResult()
...
class CreatePropertyResponseBodyCreateResult(DaraModel):
    def __init__(
        self,
        property_id: int = None,
        property_key: str = None,
        save_property_value_model: main_models.CreatePropertyResponseBodyCreateResultSavePropertyValueModel = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SavePropertyValueModel') is not None:
            temp_model = main_models.CreatePropertyResponseBodyCreateResultSavePropertyValueModel()
            self.save_property_value_model = temp_model.from_map(m.get('SavePropertyValueModel'))

        return self

class CreatePropertyResponseBodyCreateResultSavePropertyValueModel(DaraModel):
    def __init__(
        self,
        failed_property_values: List[main_models.CreatePropertyResponseBodyCreateResultSavePropertyValueModelFailedPropertyValues] = None,
        save_property_values: List[main_models.CreatePropertyResponseBodyCreateResultSavePropertyValueModelSavePropertyValues] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FailedPropertyValues') is not None:
            for k1 in m.get('FailedPropertyValues'):
                temp_model = main_models.CreatePropertyResponseBodyCreateResultSavePropertyValueModelFailedPropertyValues()
        ...
        if m.get('SavePropertyValues') is not None:
            for k1 in m.get('SavePropertyValues'):
                temp_model = main_models.CreatePropertyResponseBodyCreateResultSavePropertyValueModelSavePropertyValues()
                self.save_property_values.append(temp_model.from_map(k1))

        return self

class CreatePropertyResponseBodyCreateResultSavePropertyValueModelSavePropertyValues(DaraModel):
    def __init__(
        self,
...
class CreatePropertyResponseBodyCreateResultSavePropertyValueModelFailedPropertyValues(DaraModel):
    def __init__(
        self,
        error_code: str = None,

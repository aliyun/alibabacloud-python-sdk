...
class TransferResourcesIntoGroupRequest(DaraModel):
    def __init__(
        self,
        business_channel: str = None,
        platform: str = None,
        resource_group_id: str = None,
        resources: List[main_models.TransferResourcesIntoGroupRequestResources] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Resources') is not None:
            for k1 in m.get('Resources'):
                temp_model = main_models.TransferResourcesIntoGroupRequestResources()
                self.resources.append(temp_model.from_map(k1))

        return self

class TransferResourcesIntoGroupRequestResources(DaraModel):
    def __init__(
        self,
        region_id: str = None,

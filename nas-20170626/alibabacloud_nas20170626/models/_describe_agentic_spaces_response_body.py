...
class DescribeAgenticSpacesResponseBody(DaraModel):
    def __init__(
        self,
        agentic_spaces: main_models.DescribeAgenticSpacesResponseBodyAgenticSpaces = None,
        next_token: str = None,
        request_id: str = None,
    ):
    ...
    def validate(self):
        if self.agentic_spaces:
            self.agentic_spaces.validate()
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        if self.agentic_spaces is not None:
            result['AgenticSpaces'] = self.agentic_spaces.to_map()
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('AgenticSpaces') is not None:
            temp_model = main_models.DescribeAgenticSpacesResponseBodyAgenticSpaces()
            self.agentic_spaces = temp_model.from_map(m.get('AgenticSpaces'))
...
class DescribeAgenticSpacesResponseBodyAgenticSpaces(DaraModel):
    def __init__(
        self,
        agentic_space: List[main_models.DescribeAgenticSpacesResponseBodyAgenticSpacesAgenticSpace] = None,
    ):
        self.agentic_space = agentic_space

    def validate(self):
        if self.agentic_space:
            for v1 in self.agentic_space:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.agentic_space is not None:
            for k1 in self.agentic_space:
                result['AgenticSpace'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AgenticSpace') is not None:
            for k1 in m.get('AgenticSpace'):
                temp_model = main_models.DescribeAgenticSpacesResponseBodyAgenticSpacesAgenticSpace()
                self.agentic_space.append(temp_model.from_map(k1))

        return self

class DescribeAgenticSpacesResponseBodyAgenticSpacesAgenticSpace(DaraModel):
    def __init__(
        self,
        ...
        quota: main_models.DescribeAgenticSpacesResponseBodyAgenticSpacesAgenticSpaceQuota = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Quota') is not None:
            temp_model = main_models.DescribeAgenticSpacesResponseBodyAgenticSpacesAgenticSpaceQuota()
...
class DescribeAgenticSpacesResponseBodyAgenticSpacesAgenticSpaceQuota(DaraModel):
    def __init__(
        self,

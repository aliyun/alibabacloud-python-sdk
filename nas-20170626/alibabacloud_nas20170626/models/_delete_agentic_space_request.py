...
class DeleteAgenticSpaceRequest(DaraModel):
    def __init__(
        ...
        # Ensures the idempotence of the request. Generate a parameter value from your client to ensure uniqueness across different requests.
        # 
        ...
        # 
        # A dry run checks parameter validity and resource availability without actually creating or deleting instances, and does not incur fees.
        # 
        # Valid values:
        # 
        ...
        # - false (default): Sends a normal request and directly deletes the instance after the check passes.

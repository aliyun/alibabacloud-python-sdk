...
## Alibaba Cloud moguan-sdk SDK for Python
...
```bash
# 安装 alibabacloud_moguan_sdk20210415
pip install alibabacloud_moguan_sdk20210415
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/moguan-sdk-20210415/ChangeLog.md)中。

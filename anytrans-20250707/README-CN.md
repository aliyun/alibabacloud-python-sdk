...
## Alibaba Cloud AnyTrans SDK for Python
...
```bash
# 安装 alibabacloud_anytrans20250707
pip install alibabacloud_anytrans20250707
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/anytrans-20250707/ChangeLog.md)中。

...
class BatchTranslateForHtmlRequestExtConfig(TeaModel):
    def __init__(
        self,
        skip_csi_check: bool = None,
    ):
...
class BatchTranslateForHtmlRequestExtExamples(TeaModel):
    def __init__(
        self,
        src: str = None,
        tgt: str = None,
...
class BatchTranslateForHtmlRequestExtTerminologies(TeaModel):
    def __init__(
        self,
        src: str = None,
        tgt: str = None,
...
class BatchTranslateForHtmlRequestExtTextTransform(TeaModel):
    def __init__(
        self,
        to_lower: bool = None,
        to_title: bool = None,
...
class BatchTranslateForHtmlRequestExt(TeaModel):
    def __init__(
        self,
        config: BatchTranslateForHtmlRequestExtConfig = None,
        domain_hint: str = None,
        examples: List[BatchTranslateForHtmlRequestExtExamples] = None,
        sensitives: List[str] = None,
        terminologies: List[BatchTranslateForHtmlRequestExtTerminologies] = None,
        text_transform: BatchTranslateForHtmlRequestExtTextTransform = None,
    ):
        self.config = config
        self.domain_hint = domain_hint
        self.examples = examples
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('config') is not None:
            temp_model = BatchTranslateForHtmlRequestExtConfig()
            self.config = temp_model.from_map(m['config'])
        if m.get('domainHint') is not None:
            self.domain_hint = m.get('domainHint')
        self.examples = []
        if m.get('examples') is not None:
            for k in m.get('examples'):
                temp_model = BatchTranslateForHtmlRequestExtExamples()
                self.examples.append(temp_model.from_map(k))
        if m.get('sensitives') is not None:
            self.sensitives = m.get('sensitives')
        self.terminologies = []
        if m.get('terminologies') is not None:
            for k in m.get('terminologies'):
                temp_model = BatchTranslateForHtmlRequestExtTerminologies()
                self.terminologies.append(temp_model.from_map(k))
        if m.get('textTransform') is not None:
            temp_model = BatchTranslateForHtmlRequestExtTextTransform()
            self.text_transform = temp_model.from_map(m['textTransform'])
        return self


class BatchTranslateForHtmlRequest(TeaModel):
    def __init__(
        self,
        app_name: str = None,
        ext: BatchTranslateForHtmlRequestExt = None,
        format: str = None,
        scene: str = None,
        source_language: str = None,
        target_language: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('appName') is not None:
            self.app_name = m.get('appName')
        if m.get('ext') is not None:
            temp_model = BatchTranslateForHtmlRequestExt()
            self.ext = temp_model.from_map(m['ext'])
        if m.get('format') is not None:
            self.format = m.get('format')
        if m.get('scene') is not None:
...
class BatchTranslateForHtmlShrinkRequest(TeaModel):
    def __init__(
        self,
        app_name: str = None,
        ext_shrink: str = None,
...
class BatchTranslateForHtmlResponseBodyDataTranslationListUsage(TeaModel):
    def __init__(
        self,
        input_tokens: int = None,
        output_tokens: int = None,
...
class BatchTranslateForHtmlResponseBodyDataTranslationList(TeaModel):
    def __init__(
        self,
        code: int = None,
        index: str = None,
        message: str = None,
        translation: str = None,
        usage: BatchTranslateForHtmlResponseBodyDataTranslationListUsage = None,
    ):
        self.code = code
        self.index = index
        self.message = message
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('translation') is not None:
            self.translation = m.get('translation')
        if m.get('usage') is not None:
            temp_model = BatchTranslateForHtmlResponseBodyDataTranslationListUsage()
            self.usage = temp_model.from_map(m['usage'])
        return self


class BatchTranslateForHtmlResponseBodyData(TeaModel):
    def __init__(
        self,
        translation_list: List[BatchTranslateForHtmlResponseBodyDataTranslationList] = None,
    ):
        self.translation_list = translation_list
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('translationList') is not None:
            for k in m.get('translationList'):
                temp_model = BatchTranslateForHtmlResponseBodyDataTranslationList()
                self.translation_list.append(temp_model.from_map(k))
        return self


class BatchTranslateForHtmlResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        data: BatchTranslateForHtmlResponseBodyData = None,
        http_status_code: str = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('code') is not None:
            self.code = m.get('code')
        if m.get('data') is not None:
            temp_model = BatchTranslateForHtmlResponseBodyData()
            self.data = temp_model.from_map(m['data'])
        if m.get('httpStatusCode') is not None:
            self.http_status_code = m.get('httpStatusCode')
        if m.get('message') is not None:
...
class BatchTranslateForHtmlResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: BatchTranslateForHtmlResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = BatchTranslateForHtmlResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

...
class SubmitHtmlTranslateTaskRequest(DaraModel):
    def __init__(
        self,
        ext: main_models.SubmitHtmlTranslateTaskRequestExt = None,
        format: str = None,
        scene: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ext') is not None:
            temp_model = main_models.SubmitHtmlTranslateTaskRequestExt()
...
class SubmitHtmlTranslateTaskRequestExt(DaraModel):
    def __init__(
        self,
        config: main_models.SubmitHtmlTranslateTaskRequestExtConfig = None,
        domain_hint: str = None,
        examples: List[main_models.SubmitHtmlTranslateTaskRequestExtExamples] = None,
        param_map: Any = None,
        sensitives: List[str] = None,
        terminologies: List[main_models.SubmitHtmlTranslateTaskRequestExtTerminologies] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('config') is not None:
            temp_model = main_models.SubmitHtmlTranslateTaskRequestExtConfig()
        ...
        if m.get('examples') is not None:
            for k1 in m.get('examples'):
                temp_model = main_models.SubmitHtmlTranslateTaskRequestExtExamples()
        ...
        if m.get('terminologies') is not None:
            for k1 in m.get('terminologies'):
                temp_model = main_models.SubmitHtmlTranslateTaskRequestExtTerminologies()
                self.terminologies.append(temp_model.from_map(k1))

        if m.get('textTransform') is not None:
            temp_model = main_models.SubmitHtmlTranslateTaskRequestExtTextTransform()
            self.text_transform = temp_model.from_map(m.get('textTransform'))

        return self

class SubmitHtmlTranslateTaskRequestExtTextTransform(DaraModel):
    def __init__(
        self,
        to_lower: bool = None,
        to_title: bool = None,
...
class SubmitHtmlTranslateTaskRequestExtTerminologies(DaraModel):
    def __init__(
        self,
        src: str = None,
        tgt: str = None,
...
class SubmitHtmlTranslateTaskRequestExtExamples(DaraModel):
    def __init__(
        self,
        src: str = None,
        tgt: str = None,
...
class SubmitHtmlTranslateTaskRequestExtConfig(DaraModel):
    def __init__(
        self,

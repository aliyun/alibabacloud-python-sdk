...
class TermEditResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.TermEditResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.TermEditResponseBodyData()
...
class TermEditResponseBodyData(DaraModel):
    def __init__(
        self,
        fail_count: int = None,
        terms: List[main_models.TermEditResponseBodyDataTerms] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('terms') is not None:
            for k1 in m.get('terms'):
                temp_model = main_models.TermEditResponseBodyDataTerms()
                self.terms.append(temp_model.from_map(k1))

        return self

class TermEditResponseBodyDataTerms(DaraModel):
    def __init__(
        self,
        src: str = None,
        term_id: str = None,

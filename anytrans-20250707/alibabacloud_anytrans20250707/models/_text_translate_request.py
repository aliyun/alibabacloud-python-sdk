...
class TextTranslateRequest(DaraModel):
    def __init__(
        self,
        ext: main_models.TextTranslateRequestExt = None,
        format: str = None,
        scene: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ext') is not None:
            temp_model = main_models.TextTranslateRequestExt()
...
class TextTranslateRequestExt(DaraModel):
    def __init__(
        self,
        agent: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('config') is not None:
            temp_model = main_models.TextTranslateRequestExtConfig()
        ...
        if m.get('terminologies') is not None:
            for k1 in m.get('terminologies'):
                temp_model = main_models.TextTranslateRequestExtTerminologies()
                self.terminologies.append(temp_model.from_map(k1))

        if m.get('textTransform') is not None:
            temp_model = main_models.TextTranslateRequestExtTextTransform()
            self.text_transform = temp_model.from_map(m.get('textTransform'))

        return self

class TextTranslateRequestExtTextTransform(DaraModel):
    def __init__(
        self,
        to_lower: bool = None,
        to_title: bool = None,
...
class TextTranslateRequestExtTerminologies(DaraModel):
    def __init__(
        self,
        src: str = None,
        tgt: str = None,
...
class TextTranslateRequestExtExamples(DaraModel):
    def __init__(
        self,
        src: str = None,
        tgt: str = None,
...
class TextTranslateRequestExtConfig(DaraModel):
    def __init__(
        self,

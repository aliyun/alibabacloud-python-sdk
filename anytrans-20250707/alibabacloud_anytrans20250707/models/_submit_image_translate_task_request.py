...
class SubmitImageTranslateTaskRequest(DaraModel):
    def __init__(
        self,
        ext: main_models.SubmitImageTranslateTaskRequestExt = None,
        format: str = None,
        scene: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ext') is not None:
            temp_model = main_models.SubmitImageTranslateTaskRequestExt()
...
class SubmitImageTranslateTaskRequestExt(DaraModel):
    def __init__(
        self,
        domain_hint: str = None,
        examples: List[main_models.SubmitImageTranslateTaskRequestExtExamples] = None,
        param_map: Any = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('examples') is not None:
            for k1 in m.get('examples'):
                temp_model = main_models.SubmitImageTranslateTaskRequestExtExamples()
        ...
        if m.get('terminologies') is not None:
            for k1 in m.get('terminologies'):
                temp_model = main_models.SubmitImageTranslateTaskRequestExtTerminologies()
...
class SubmitImageTranslateTaskRequestExtTextTransform(DaraModel):
    def __init__(
        self,
        to_lower: bool = None,
        to_title: bool = None,
...
class SubmitImageTranslateTaskRequestExtTerminologies(DaraModel):
    def __init__(
        self,
        src: str = None,
        tgt: str = None,
...
class SubmitImageTranslateTaskRequestExtExamples(DaraModel):
    def __init__(
        self,
        src: str = None,
        tgt: str = None,

...
class BatchTranslateRequest(DaraModel):
    def __init__(
        self,
        app_name: str = None,
        ext: main_models.BatchTranslateRequestExt = None,
        format: str = None,
        scene: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ext') is not None:
            temp_model = main_models.BatchTranslateRequestExt()
...
class BatchTranslateRequestExt(DaraModel):
    def __init__(
        self,
        config: main_models.BatchTranslateRequestExtConfig = None,
        domain_hint: str = None,
        examples: List[main_models.BatchTranslateRequestExtExamples] = None,
        param_map: Any = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('config') is not None:
            temp_model = main_models.BatchTranslateRequestExtConfig()
        ...
        if m.get('examples') is not None:
            for k1 in m.get('examples'):
                temp_model = main_models.BatchTranslateRequestExtExamples()
        ...
        if m.get('terminologies') is not None:
            for k1 in m.get('terminologies'):
                temp_model = main_models.BatchTranslateRequestExtTerminologies()
                self.terminologies.append(temp_model.from_map(k1))

        if m.get('textTransform') is not None:
            temp_model = main_models.BatchTranslateRequestExtTextTransform()
            self.text_transform = temp_model.from_map(m.get('textTransform'))

        return self

class BatchTranslateRequestExtTextTransform(DaraModel):
    def __init__(
        self,
        to_lower: bool = None,
        to_title: bool = None,
...
class BatchTranslateRequestExtTerminologies(DaraModel):
    def __init__(
        self,
        src: str = None,
        tgt: str = None,
...
class BatchTranslateRequestExtExamples(DaraModel):
    def __init__(
        self,
        src: str = None,
        tgt: str = None,
...
class BatchTranslateRequestExtConfig(DaraModel):
    def __init__(
        self,

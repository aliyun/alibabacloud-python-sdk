...
class SubmitLongTextTranslateTaskRequest(DaraModel):
    def __init__(
        self,
        ext: main_models.SubmitLongTextTranslateTaskRequestExt = None,
        format: str = None,
        scene: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ext') is not None:
            temp_model = main_models.SubmitLongTextTranslateTaskRequestExt()
...
class SubmitLongTextTranslateTaskRequestExt(DaraModel):
    def __init__(
        self,
        config: main_models.SubmitLongTextTranslateTaskRequestExtConfig = None,
        domain_hint: str = None,
        examples: List[main_models.SubmitLongTextTranslateTaskRequestExtExamples] = None,
        param_map: Any = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('config') is not None:
            temp_model = main_models.SubmitLongTextTranslateTaskRequestExtConfig()
        ...
        if m.get('examples') is not None:
            for k1 in m.get('examples'):
                temp_model = main_models.SubmitLongTextTranslateTaskRequestExtExamples()
        ...
        if m.get('terminologies') is not None:
            for k1 in m.get('terminologies'):
                temp_model = main_models.SubmitLongTextTranslateTaskRequestExtTerminologies()
...
class SubmitLongTextTranslateTaskRequestExtTextTransform(DaraModel):
    def __init__(
        self,
        to_lower: bool = None,
        to_title: bool = None,
...
class SubmitLongTextTranslateTaskRequestExtTerminologies(DaraModel):
    def __init__(
        self,
        src: str = None,
        tgt: str = None,
...
class SubmitLongTextTranslateTaskRequestExtExamples(DaraModel):
    def __init__(
        self,
        src: str = None,
        tgt: str = None,
...
class SubmitLongTextTranslateTaskRequestExtConfig(DaraModel):
    def __init__(
        self,

...
```bash
# 安装 alibabacloud_customerservice20231228
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/customerservice-20231228/ChangeLog.md)中。

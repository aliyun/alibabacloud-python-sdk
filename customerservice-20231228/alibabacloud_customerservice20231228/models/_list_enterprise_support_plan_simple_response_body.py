...
class ListEnterpriseSupportPlanSimpleResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: List[main_models.ListEnterpriseSupportPlanSimpleResponseBodyData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            for k1 in m.get('data'):
                temp_model = main_models.ListEnterpriseSupportPlanSimpleResponseBodyData()
...
class ListEnterpriseSupportPlanSimpleResponseBodyData(DaraModel):
    def __init__(
        self,
        can_apply_free_order: bool = None,
        customer_id: str = None,
        docs: List[main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataDocs] = None,
        end_time: str = None,
        ...
        nodes: List[main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataNodes] = None,
        operate_infos: List[main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataOperateInfos] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('docs') is not None:
            for k1 in m.get('docs'):
                temp_model = main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataDocs()
        ...
        if m.get('nodes') is not None:
            for k1 in m.get('nodes'):
                temp_model = main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataNodes()
                self.nodes.append(temp_model.from_map(k1))

        self.operate_infos = []
        if m.get('operateInfos') is not None:
            for k1 in m.get('operateInfos'):
                temp_model = main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataOperateInfos()
...
class ListEnterpriseSupportPlanSimpleResponseBodyDataOperateInfos(DaraModel):
    def __init__(
        self,
        can_click: bool = None,
        text: str = None,
...
class ListEnterpriseSupportPlanSimpleResponseBodyDataNodes(DaraModel):
    def __init__(
        self,
        doc_node: main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataNodesDocNode = None,
        finish_node: main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataNodesFinishNode = None,
        free_order_audit_node: main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataNodesFreeOrderAuditNode = None,
        free_order_node: main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataNodesFreeOrderNode = None,
        name: str = None,
        order_date: int = None,
        order_node: main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataNodesOrderNode = None,
        service_implementation: main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataNodesServiceImplementation = None,
        status: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('docNode') is not None:
            temp_model = main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataNodesDocNode()
            self.doc_node = temp_model.from_map(m.get('docNode'))

        if m.get('finishNode') is not None:
            temp_model = main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataNodesFinishNode()
            self.finish_node = temp_model.from_map(m.get('finishNode'))

        if m.get('freeOrderAuditNode') is not None:
            temp_model = main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataNodesFreeOrderAuditNode()
            self.free_order_audit_node = temp_model.from_map(m.get('freeOrderAuditNode'))

        if m.get('freeOrderNode') is not None:
            temp_model = main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataNodesFreeOrderNode()
        ...
        if m.get('orderNode') is not None:
            temp_model = main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataNodesOrderNode()
            self.order_node = temp_model.from_map(m.get('orderNode'))

        if m.get('serviceImplementation') is not None:
            temp_model = main_models.ListEnterpriseSupportPlanSimpleResponseBodyDataNodesServiceImplementation()
...
class ListEnterpriseSupportPlanSimpleResponseBodyDataNodesServiceImplementation(DaraModel):
    def __init__(
        self,
        end_time: str = None,
        start_time: str = None,
...
class ListEnterpriseSupportPlanSimpleResponseBodyDataNodesOrderNode(DaraModel):
    def __init__(
        self,
        pay_time: str = None,
        uid: str = None,
...
class ListEnterpriseSupportPlanSimpleResponseBodyDataNodesFreeOrderNode(DaraModel):
    def __init__(
        self,
        apply_time: str = None,
        uid: str = None,
...
class ListEnterpriseSupportPlanSimpleResponseBodyDataNodesFreeOrderAuditNode(DaraModel):
    def __init__(
        self,
        audit_time: str = None,
        status: str = None,
...
class ListEnterpriseSupportPlanSimpleResponseBodyDataNodesFinishNode(DaraModel):
    def __init__(
        self,
...
class ListEnterpriseSupportPlanSimpleResponseBodyDataNodesDocNode(DaraModel):
    def __init__(
        self,
        doc_id: int = None,
        doc_name: str = None,
...
class ListEnterpriseSupportPlanSimpleResponseBodyDataDocs(DaraModel):
    def __init__(
        self,
        doc_id: int = None,
        file_name: str = None,

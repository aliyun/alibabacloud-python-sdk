...
class ViewSmartAccessGatewayOspfRouteResponseBody(DaraModel):
    def __init__(
        self,
        area_id: int = None,
        ...
        request_id: str = None,
        router_id: str = None,
        task_states: List[main_models.ViewSmartAccessGatewayOspfRouteResponseBodyTaskStates] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TaskStates') is not None:
            for k1 in m.get('TaskStates'):
                temp_model = main_models.ViewSmartAccessGatewayOspfRouteResponseBodyTaskStates()
                self.task_states.append(temp_model.from_map(k1))

        return self

class ViewSmartAccessGatewayOspfRouteResponseBodyTaskStates(DaraModel):
    def __init__(
        self,

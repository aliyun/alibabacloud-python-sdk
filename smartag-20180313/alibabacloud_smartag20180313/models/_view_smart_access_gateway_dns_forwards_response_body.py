...
class ViewSmartAccessGatewayDnsForwardsResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        count: int = None,
        data: List[main_models.ViewSmartAccessGatewayDnsForwardsResponseBodyData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ViewSmartAccessGatewayDnsForwardsResponseBodyData()
...
class ViewSmartAccessGatewayDnsForwardsResponseBodyData(DaraModel):
    def __init__(
        self,
        domain: str = None,

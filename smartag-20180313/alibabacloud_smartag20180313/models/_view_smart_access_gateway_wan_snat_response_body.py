...
class ViewSmartAccessGatewayWanSnatResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        snat: str = None,
        task_states: List[main_models.ViewSmartAccessGatewayWanSnatResponseBodyTaskStates] = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TaskStates') is not None:
            for k1 in m.get('TaskStates'):
                temp_model = main_models.ViewSmartAccessGatewayWanSnatResponseBodyTaskStates()
                self.task_states.append(temp_model.from_map(k1))

        return self

class ViewSmartAccessGatewayWanSnatResponseBodyTaskStates(DaraModel):
    def __init__(
        self,

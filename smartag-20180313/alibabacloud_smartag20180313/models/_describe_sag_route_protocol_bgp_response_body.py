...
class DescribeSagRouteProtocolBgpResponseBody(DaraModel):
    def __init__(
        self,
        hold_time: int = None,
        keep_alive: int = None,
        ...
        request_id: str = None,
        router_id: str = None,
        task_states: List[main_models.DescribeSagRouteProtocolBgpResponseBodyTaskStates] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TaskStates') is not None:
            for k1 in m.get('TaskStates'):
                temp_model = main_models.DescribeSagRouteProtocolBgpResponseBodyTaskStates()
                self.task_states.append(temp_model.from_map(k1))

        return self

class DescribeSagRouteProtocolBgpResponseBodyTaskStates(DaraModel):
    def __init__(
        self,

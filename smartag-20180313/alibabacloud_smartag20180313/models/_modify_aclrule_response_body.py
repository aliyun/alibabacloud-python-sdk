...
class ModifyACLRuleResponseBody(DaraModel):
    def __init__(
        self,
        acl_id: str = None,
        acr_id: str = None,
        ...
        direction: str = None,
        dpi_group_ids: main_models.ModifyACLRuleResponseBodyDpiGroupIds = None,
        dpi_signature_ids: main_models.ModifyACLRuleResponseBodyDpiSignatureIds = None,
        gmt_create: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DpiGroupIds') is not None:
            temp_model = main_models.ModifyACLRuleResponseBodyDpiGroupIds()
            self.dpi_group_ids = temp_model.from_map(m.get('DpiGroupIds'))

        if m.get('DpiSignatureIds') is not None:
            temp_model = main_models.ModifyACLRuleResponseBodyDpiSignatureIds()
...
class ModifyACLRuleResponseBodyDpiSignatureIds(DaraModel):
    def __init__(
        self,
...
class ModifyACLRuleResponseBodyDpiGroupIds(DaraModel):
    def __init__(
        self,

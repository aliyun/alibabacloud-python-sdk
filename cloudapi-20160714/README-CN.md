...
## Alibaba Cloud CloudAPI SDK for Python
...
```bash
# 安装 alibabacloud_cloudapi20160714
pip install alibabacloud_cloudapi20160714
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/cloudapi-20160714/ChangeLog.md)中。

...
class DescribeInstancePacketsResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InstancePackets') is not None:
            temp_model = main_models.DescribeInstancePacketsResponseBodyInstancePackets()
            self.instance_packets = temp_model.from_map(m.get('InstancePackets'))
...
class DescribeInstancePacketsResponseBodyInstancePackets(DaraModel):
    def __init__(
        self,
        monitor_item: List[main_models.DescribeInstancePacketsResponseBodyInstancePacketsMonitorItem] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MonitorItem') is not None:
            for k1 in m.get('MonitorItem'):
                temp_model = main_models.DescribeInstancePacketsResponseBodyInstancePacketsMonitorItem()
                self.monitor_item.append(temp_model.from_map(k1))

        return self

class DescribeInstancePacketsResponseBodyInstancePacketsMonitorItem(DaraModel):
    def __init__(
        self,
        item: str = None,
        item_time: str = None,

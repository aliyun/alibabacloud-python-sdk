...
class DescribeApiLatencyDataResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallLatencys') is not None:
            temp_model = main_models.DescribeApiLatencyDataResponseBodyCallLatencys()
            self.call_latencys = temp_model.from_map(m.get('CallLatencys'))
...
class DescribeApiLatencyDataResponseBodyCallLatencys(DaraModel):
    def __init__(
        self,
        monitor_item: List[main_models.DescribeApiLatencyDataResponseBodyCallLatencysMonitorItem] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MonitorItem') is not None:
            for k1 in m.get('MonitorItem'):
                temp_model = main_models.DescribeApiLatencyDataResponseBodyCallLatencysMonitorItem()
                self.monitor_item.append(temp_model.from_map(k1))

        return self

class DescribeApiLatencyDataResponseBodyCallLatencysMonitorItem(DaraModel):
    def __init__(
        self,
        item_time: str = None,
        item_value: str = None,

...
class DescribeApisByTrafficControlResponseBody(DaraModel):
    def __init__(
        self,
        api_infos: main_models.DescribeApisByTrafficControlResponseBodyApiInfos = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApiInfos') is not None:
            temp_model = main_models.DescribeApisByTrafficControlResponseBodyApiInfos()
...
class DescribeApisByTrafficControlResponseBodyApiInfos(DaraModel):
    def __init__(
        self,
        api_info: List[main_models.DescribeApisByTrafficControlResponseBodyApiInfosApiInfo] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApiInfo') is not None:
            for k1 in m.get('ApiInfo'):
                temp_model = main_models.DescribeApisByTrafficControlResponseBodyApiInfosApiInfo()
                self.api_info.append(temp_model.from_map(k1))

        return self

class DescribeApisByTrafficControlResponseBodyApiInfosApiInfo(DaraModel):
    def __init__(
        self,
        api_id: str = None,
        api_name: str = None,

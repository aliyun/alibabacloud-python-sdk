...
class DescribeApiProductApisResponseBody(DaraModel):
    def __init__(
        self,
        api_info_list: main_models.DescribeApiProductApisResponseBodyApiInfoList = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApiInfoList') is not None:
            temp_model = main_models.DescribeApiProductApisResponseBodyApiInfoList()
...
class DescribeApiProductApisResponseBodyApiInfoList(DaraModel):
    def __init__(
        self,
        api_info: List[main_models.DescribeApiProductApisResponseBodyApiInfoListApiInfo] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApiInfo') is not None:
            for k1 in m.get('ApiInfo'):
                temp_model = main_models.DescribeApiProductApisResponseBodyApiInfoListApiInfo()
                self.api_info.append(temp_model.from_map(k1))

        return self

class DescribeApiProductApisResponseBodyApiInfoListApiInfo(DaraModel):
    def __init__(
        self,
        api_id: str = None,
        api_name: str = None,

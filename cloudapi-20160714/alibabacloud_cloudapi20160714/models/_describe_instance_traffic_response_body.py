...
class DescribeInstanceTrafficResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InstanceTraffic') is not None:
            temp_model = main_models.DescribeInstanceTrafficResponseBodyInstanceTraffic()
            self.instance_traffic = temp_model.from_map(m.get('InstanceTraffic'))
...
class DescribeInstanceTrafficResponseBodyInstanceTraffic(DaraModel):
    def __init__(
        self,
        monitor_item: List[main_models.DescribeInstanceTrafficResponseBodyInstanceTrafficMonitorItem] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MonitorItem') is not None:
            for k1 in m.get('MonitorItem'):
                temp_model = main_models.DescribeInstanceTrafficResponseBodyInstanceTrafficMonitorItem()
                self.monitor_item.append(temp_model.from_map(k1))

        return self

class DescribeInstanceTrafficResponseBodyInstanceTrafficMonitorItem(DaraModel):
    def __init__(
        self,
        item: str = None,
        item_time: str = None,

...
class DescribeHistoryApisResponseBody(DaraModel):
    def __init__(
        self,
        api_his_items: main_models.DescribeHistoryApisResponseBodyApiHisItems = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApiHisItems') is not None:
            temp_model = main_models.DescribeHistoryApisResponseBodyApiHisItems()
...
class DescribeHistoryApisResponseBodyApiHisItems(DaraModel):
    def __init__(
        self,
        api_his_item: List[main_models.DescribeHistoryApisResponseBodyApiHisItemsApiHisItem] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApiHisItem') is not None:
            for k1 in m.get('ApiHisItem'):
                temp_model = main_models.DescribeHistoryApisResponseBodyApiHisItemsApiHisItem()
                self.api_his_item.append(temp_model.from_map(k1))

        return self

class DescribeHistoryApisResponseBodyApiHisItemsApiHisItem(DaraModel):
    def __init__(
        self,
        api_id: str = None,
        api_name: str = None,

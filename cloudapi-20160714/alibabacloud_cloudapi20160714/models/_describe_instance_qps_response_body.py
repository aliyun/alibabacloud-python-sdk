...
class DescribeInstanceQpsResponseBody(DaraModel):
    def __init__(
        self,
        instance_qps: main_models.DescribeInstanceQpsResponseBodyInstanceQps = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InstanceQps') is not None:
            temp_model = main_models.DescribeInstanceQpsResponseBodyInstanceQps()
            self.instance_qps = temp_model.from_map(m.get('InstanceQps'))
...
class DescribeInstanceQpsResponseBodyInstanceQps(DaraModel):
    def __init__(
        self,
        monitor_item: List[main_models.DescribeInstanceQpsResponseBodyInstanceQpsMonitorItem] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MonitorItem') is not None:
            for k1 in m.get('MonitorItem'):
                temp_model = main_models.DescribeInstanceQpsResponseBodyInstanceQpsMonitorItem()
                self.monitor_item.append(temp_model.from_map(k1))

        return self

class DescribeInstanceQpsResponseBodyInstanceQpsMonitorItem(DaraModel):
    def __init__(
        self,
        item_time: str = None,
        item_value: str = None,

...
class DescribeApisByIpControlResponseBody(DaraModel):
    def __init__(
        self,
        api_infos: main_models.DescribeApisByIpControlResponseBodyApiInfos = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApiInfos') is not None:
            temp_model = main_models.DescribeApisByIpControlResponseBodyApiInfos()
...
class DescribeApisByIpControlResponseBodyApiInfos(DaraModel):
    def __init__(
        self,
        api_info: List[main_models.DescribeApisByIpControlResponseBodyApiInfosApiInfo] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApiInfo') is not None:
            for k1 in m.get('ApiInfo'):
                temp_model = main_models.DescribeApisByIpControlResponseBodyApiInfosApiInfo()
                self.api_info.append(temp_model.from_map(k1))

        return self

class DescribeApisByIpControlResponseBodyApiInfosApiInfo(DaraModel):
    def __init__(
        self,
        api_id: str = None,
        api_name: str = None,

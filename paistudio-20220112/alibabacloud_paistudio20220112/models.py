...
class SandboxCacheConfig(TeaModel):
    def __init__(
        self,
        enabled: bool = None,
    ):
...
class QuotaConfig(TeaModel):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EniCacheConfig') is not None:
            temp_model = EniCacheConfig()
            self.eni_cache_config = temp_model.from_map(m['EniCacheConfig'])
        ...
        if m.get('SandboxCacheConfig') is not None:
            temp_model = SandboxCacheConfig()
            self.sandbox_cache_config = temp_model.from_map(m['SandboxCacheConfig'])
...
class ListNodesRequestHealthCount(TeaModel):
    def __init__(
        self,
        operation: str = None,
        value: int = None,
...
class ListNodesRequestHealthRate(TeaModel):
    def __init__(
        self,
        operation: str = None,
        value: int = None,
...
class ListNodesRequest(TeaModel):
    def __init__(
        ...
        gputype: str = None,
        health_count: ListNodesRequestHealthCount = None,
        health_rate: ListNodesRequestHealthRate = None,
        hyper_node: str = None,
        hyper_zone: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HealthCount') is not None:
            temp_model = ListNodesRequestHealthCount()
            self.health_count = temp_model.from_map(m['HealthCount'])
        if m.get('HealthRate') is not None:
            temp_model = ListNodesRequestHealthRate()
            self.health_rate = temp_model.from_map(m['HealthRate'])
...
class ListNodesShrinkRequest(TeaModel):
    def __init__(
        ...
        filter_by_resource_group_ids: str = None,
        gputype: str = None,
        health_count_shrink: str = None,
        health_rate_shrink: str = None,
        hyper_node: str = None,
        hyper_zone: str = None,
        layout_mode: str = None,
        machine_group_ids: str = None,
    ...
    def to_map(self):
        ...
        if self.gputype is not None:
            result['GPUType'] = self.gputype
        if self.health_count_shrink is not None:
            result['HealthCount'] = self.health_count_shrink
        if self.health_rate_shrink is not None:
            result['HealthRate'] = self.health_rate_shrink
        if self.hyper_node is not None:
            result['HyperNode'] = self.hyper_node
        if self.hyper_zone is not None:
            result['HyperZone'] = self.hyper_zone
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('GPUType') is not None:
            self.gputype = m.get('GPUType')
        if m.get('HealthCount') is not None:
            self.health_count_shrink = m.get('HealthCount')
        if m.get('HealthRate') is not None:
            self.health_rate_shrink = m.get('HealthRate')
        if m.get('HyperNode') is not None:
            self.hyper_node = m.get('HyperNode')
        if m.get('HyperZone') is not None:
            self.hyper_zone = m.get('HyperZone')

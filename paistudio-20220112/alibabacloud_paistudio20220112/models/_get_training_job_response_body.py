...
class GetTrainingJobResponseBody(DaraModel):
    def __init__(
        self,
        ...
        compute_resource: main_models.GetTrainingJobResponseBodyComputeResource = None,
        duration: int = None,
        environments: Dict[str, str] = None,
        experiment_config: main_models.GetTrainingJobResponseBodyExperimentConfig = None,
        gmt_create_time: str = None,
        gmt_modified_time: str = None,
        hyper_parameters: List[main_models.GetTrainingJobResponseBodyHyperParameters] = None,
        input_channels: List[main_models.GetTrainingJobResponseBodyInputChannels] = None,
        instances: List[main_models.GetTrainingJobResponseBodyInstances] = None,
        is_temp_algo: bool = None,
        labels: List[main_models.GetTrainingJobResponseBodyLabels] = None,
        latest_metrics: List[main_models.GetTrainingJobResponseBodyLatestMetrics] = None,
        latest_progress: main_models.GetTrainingJobResponseBodyLatestProgress = None,
        output_channels: List[main_models.GetTrainingJobResponseBodyOutputChannels] = None,
        output_model: main_models.GetTrainingJobResponseBodyOutputModel = None,
        priority: int = None,
        ...
        request_id: str = None,
        role_arn: str = None,
        scheduler: main_models.GetTrainingJobResponseBodyScheduler = None,
        settings: main_models.JobSettings = None,
        status: str = None,
        status_transitions: List[main_models.GetTrainingJobResponseBodyStatusTransitions] = None,
        training_job_description: str = None,
        training_job_id: str = None,
        training_job_name: str = None,
        training_job_url: str = None,
        user_id: str = None,
        user_vpc: main_models.GetTrainingJobResponseBodyUserVpc = None,
    ...
    def to_map(self):
        ...
        if self.latest_metrics is not None:
            for k1 in self.latest_metrics:
                result['LatestMetrics'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ComputeResource') is not None:
            temp_model = main_models.GetTrainingJobResponseBodyComputeResource()
        ...
        if m.get('ExperimentConfig') is not None:
            temp_model = main_models.GetTrainingJobResponseBodyExperimentConfig()
        ...
        if m.get('HyperParameters') is not None:
            for k1 in m.get('HyperParameters'):
                temp_model = main_models.GetTrainingJobResponseBodyHyperParameters()
                self.hyper_parameters.append(temp_model.from_map(k1))

        self.input_channels = []
        if m.get('InputChannels') is not None:
            for k1 in m.get('InputChannels'):
                temp_model = main_models.GetTrainingJobResponseBodyInputChannels()
                self.input_channels.append(temp_model.from_map(k1))

        self.instances = []
        if m.get('Instances') is not None:
            for k1 in m.get('Instances'):
                temp_model = main_models.GetTrainingJobResponseBodyInstances()
        ...
        if m.get('Labels') is not None:
            for k1 in m.get('Labels'):
                temp_model = main_models.GetTrainingJobResponseBodyLabels()
                self.labels.append(temp_model.from_map(k1))

        self.latest_metrics = []
        if m.get('LatestMetrics') is not None:
            for k1 in m.get('LatestMetrics'):
                temp_model = main_models.GetTrainingJobResponseBodyLatestMetrics()
                self.latest_metrics.append(temp_model.from_map(k1))

        if m.get('LatestProgress') is not None:
            temp_model = main_models.GetTrainingJobResponseBodyLatestProgress()
            self.latest_progress = temp_model.from_map(m.get('LatestProgress'))

        self.output_channels = []
        if m.get('OutputChannels') is not None:
            for k1 in m.get('OutputChannels'):
                temp_model = main_models.GetTrainingJobResponseBodyOutputChannels()
                self.output_channels.append(temp_model.from_map(k1))

        if m.get('OutputModel') is not None:
            temp_model = main_models.GetTrainingJobResponseBodyOutputModel()
            self.output_model = temp_model.from_map(m.get('OutputModel'))
        ...
        if m.get('Scheduler') is not None:
            temp_model = main_models.GetTrainingJobResponseBodyScheduler()
        ...
        if m.get('StatusTransitions') is not None:
            for k1 in m.get('StatusTransitions'):
                temp_model = main_models.GetTrainingJobResponseBodyStatusTransitions()
        ...
        if m.get('UserVpc') is not None:
            temp_model = main_models.GetTrainingJobResponseBodyUserVpc()
...
class GetTrainingJobResponseBodyUserVpc(DaraModel):
    def __init__(
        self,
...
class GetTrainingJobResponseBodyStatusTransitions(DaraModel):
    def __init__(
        self,
        end_time: str = None,
        reason_code: str = None,
...
class GetTrainingJobResponseBodyScheduler(DaraModel):
    def __init__(
        self,
...
class GetTrainingJobResponseBodyOutputModel(DaraModel):
    def __init__(
        self,
...
class GetTrainingJobResponseBodyOutputChannels(DaraModel):
    def __init__(
        self,
        dataset_id: str = None,
        name: str = None,
...
class GetTrainingJobResponseBodyLatestProgress(DaraModel):
    def __init__(
        self,
        overall_progress: main_models.GetTrainingJobResponseBodyLatestProgressOverallProgress = None,
        remaining_time: main_models.GetTrainingJobResponseBodyLatestProgressRemainingTime = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OverallProgress') is not None:
            temp_model = main_models.GetTrainingJobResponseBodyLatestProgressOverallProgress()
            self.overall_progress = temp_model.from_map(m.get('OverallProgress'))

        if m.get('RemainingTime') is not None:
            temp_model = main_models.GetTrainingJobResponseBodyLatestProgressRemainingTime()
            self.remaining_time = temp_model.from_map(m.get('RemainingTime'))

        return self

class GetTrainingJobResponseBodyLatestProgressRemainingTime(DaraModel):
    def __init__(
        self,
        timestamp: str = None,
        value: int = None,
...
class GetTrainingJobResponseBodyLatestProgressOverallProgress(DaraModel):
    def __init__(
        self,
        timestamp: str = None,
        value: float = None,
...
class GetTrainingJobResponseBodyLatestMetrics(DaraModel):
    def __init__(
        self,
        name: str = None,
        timestamp: str = None,
...
class GetTrainingJobResponseBodyLabels(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class GetTrainingJobResponseBodyInstances(DaraModel):
    def __init__(
        self,
        name: str = None,
        role: str = None,
...
class GetTrainingJobResponseBodyInputChannels(DaraModel):
    def __init__(
        self,
        dataset_id: str = None,
        input_uri: str = None,
...
class GetTrainingJobResponseBodyHyperParameters(DaraModel):
    def __init__(
        self,
        name: str = None,
        value: str = None,
...
class GetTrainingJobResponseBodyExperimentConfig(DaraModel):
    def __init__(
        self,
...
class GetTrainingJobResponseBodyComputeResource(DaraModel):
    def __init__(
        self,
        ecs_count: int = None,
        ecs_spec: str = None,
        instance_count: int = None,
        instance_spec: main_models.GetTrainingJobResponseBodyComputeResourceInstanceSpec = None,
        resource_id: str = None,
        resource_name: str = None,
        spot_spec: main_models.GetTrainingJobResponseBodyComputeResourceSpotSpec = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InstanceSpec') is not None:
            temp_model = main_models.GetTrainingJobResponseBodyComputeResourceInstanceSpec()
        ...
        if m.get('SpotSpec') is not None:
            temp_model = main_models.GetTrainingJobResponseBodyComputeResourceSpotSpec()
...
class GetTrainingJobResponseBodyComputeResourceSpotSpec(DaraModel):
    def __init__(
        self,
...
class GetTrainingJobResponseBodyComputeResourceInstanceSpec(DaraModel):
    def __init__(
        self,
        cpu: str = None,
        gpu: str = None,

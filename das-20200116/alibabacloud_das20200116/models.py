...
class GetRequestDiagnosisIdRequest(TeaModel):
    def __init__(
        self,
        database: str = None,
        instance_id: str = None,
...
class GetRequestDiagnosisIdResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        data: str = None,
...
class GetRequestDiagnosisIdResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        body: GetRequestDiagnosisIdResponseBody = None,
    ):
        self.headers = headers
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('headers') is not None:
            self.headers = m.get('headers')
        if m.get('body') is not None:
            temp_model = GetRequestDiagnosisIdResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

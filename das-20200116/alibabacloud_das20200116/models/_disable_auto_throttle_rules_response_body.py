...
class DisableAutoThrottleRulesResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.DisableAutoThrottleRulesResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DisableAutoThrottleRulesResponseBodyData()
...
class DisableAutoThrottleRulesResponseBodyData(DaraModel):
    def __init__(
        self,
        config_fail_instance_count: int = None,
        config_fail_instance_list: List[main_models.DisableAutoThrottleRulesResponseBodyDataConfigFailInstanceList] = None,
        config_success_instance_count: int = None,
        config_success_instance_list: List[main_models.DisableAutoThrottleRulesResponseBodyDataConfigSuccessInstanceList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConfigFailInstanceList') is not None:
            for k1 in m.get('ConfigFailInstanceList'):
                temp_model = main_models.DisableAutoThrottleRulesResponseBodyDataConfigFailInstanceList()
        ...
        if m.get('ConfigSuccessInstanceList') is not None:
            for k1 in m.get('ConfigSuccessInstanceList'):
                temp_model = main_models.DisableAutoThrottleRulesResponseBodyDataConfigSuccessInstanceList()
...
class DisableAutoThrottleRulesResponseBodyDataConfigSuccessInstanceList(DaraModel):
    def __init__(
        self,
...
class DisableAutoThrottleRulesResponseBodyDataConfigFailInstanceList(DaraModel):
    def __init__(
        self,
        config_success: bool = None,

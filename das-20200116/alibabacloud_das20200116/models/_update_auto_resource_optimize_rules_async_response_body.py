...
class UpdateAutoResourceOptimizeRulesAsyncResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        data: main_models.UpdateAutoResourceOptimizeRulesAsyncResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.UpdateAutoResourceOptimizeRulesAsyncResponseBodyData()
...
class UpdateAutoResourceOptimizeRulesAsyncResponseBodyData(DaraModel):
    def __init__(
        self,
        complete: bool = None,
        config_response: main_models.UpdateAutoResourceOptimizeRulesAsyncResponseBodyDataConfigResponse = None,
        fail: bool = None,
        is_finish: bool = None,
        result_id: str = None,
        state: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConfigResponse') is not None:
            temp_model = main_models.UpdateAutoResourceOptimizeRulesAsyncResponseBodyDataConfigResponse()
...
class UpdateAutoResourceOptimizeRulesAsyncResponseBodyDataConfigResponse(DaraModel):
    def __init__(
        self,
        config_fail_instance_count: int = None,
        config_fail_instance_list: List[main_models.UpdateAutoResourceOptimizeRulesAsyncResponseBodyDataConfigResponseConfigFailInstanceList] = None,
        config_success_instance_count: int = None,
        config_success_instance_list: List[main_models.UpdateAutoResourceOptimizeRulesAsyncResponseBodyDataConfigResponseConfigSuccessInstanceList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConfigFailInstanceList') is not None:
            for k1 in m.get('ConfigFailInstanceList'):
                temp_model = main_models.UpdateAutoResourceOptimizeRulesAsyncResponseBodyDataConfigResponseConfigFailInstanceList()
        ...
        if m.get('ConfigSuccessInstanceList') is not None:
            for k1 in m.get('ConfigSuccessInstanceList'):
                temp_model = main_models.UpdateAutoResourceOptimizeRulesAsyncResponseBodyDataConfigResponseConfigSuccessInstanceList()
...
class UpdateAutoResourceOptimizeRulesAsyncResponseBodyDataConfigResponseConfigSuccessInstanceList(DaraModel):
    def __init__(
        self,
...
class UpdateAutoResourceOptimizeRulesAsyncResponseBodyDataConfigResponseConfigFailInstanceList(DaraModel):
    def __init__(
        self,
        config_success: bool = None,

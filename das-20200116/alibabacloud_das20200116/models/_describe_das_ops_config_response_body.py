...
class DescribeDasOpsConfigResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.DescribeDasOpsConfigResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DescribeDasOpsConfigResponseBodyData()
...
class DescribeDasOpsConfigResponseBodyData(DaraModel):
    def __init__(
        self,

...
class GetSqlConcurrencyControlRulesHistoryResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetSqlConcurrencyControlRulesHistoryResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetSqlConcurrencyControlRulesHistoryResponseBodyData()
...
class GetSqlConcurrencyControlRulesHistoryResponseBodyData(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            temp_model = main_models.GetSqlConcurrencyControlRulesHistoryResponseBodyDataList()
...
class GetSqlConcurrencyControlRulesHistoryResponseBodyDataList(DaraModel):
    def __init__(
        self,
        rules: List[main_models.GetSqlConcurrencyControlRulesHistoryResponseBodyDataListRules] = None,
    ):
        self.rules = rules
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('rules') is not None:
            for k1 in m.get('rules'):
                temp_model = main_models.GetSqlConcurrencyControlRulesHistoryResponseBodyDataListRules()
                self.rules.append(temp_model.from_map(k1))

        return self

class GetSqlConcurrencyControlRulesHistoryResponseBodyDataListRules(DaraModel):
    def __init__(
        self,

...
class CreateSecurityIPGroupResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.CreateSecurityIPGroupResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CreateSecurityIPGroupResponseBodyData()
...
class CreateSecurityIPGroupResponseBodyData(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('GlobalSecurityIPGroup') is not None:
            for k1 in m.get('GlobalSecurityIPGroup'):
                temp_model = main_models.CreateSecurityIPGroupResponseBodyDataGlobalSecurityIPGroup()
                self.global_security_ipgroup.append(temp_model.from_map(k1))

        return self

class CreateSecurityIPGroupResponseBodyDataGlobalSecurityIPGroup(DaraModel):
    def __init__(
        self,
        gip_list: str = None,

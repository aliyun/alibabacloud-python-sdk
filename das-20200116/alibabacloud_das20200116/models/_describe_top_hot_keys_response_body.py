...
class DescribeTopHotKeysResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.DescribeTopHotKeysResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DescribeTopHotKeysResponseBodyData()
...
class DescribeTopHotKeysResponseBodyData(DaraModel):
    def __init__(
        self,
        hot_key: List[main_models.DescribeTopHotKeysResponseBodyDataHotKey] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HotKey') is not None:
            for k1 in m.get('HotKey'):
                temp_model = main_models.DescribeTopHotKeysResponseBodyDataHotKey()
                self.hot_key.append(temp_model.from_map(k1))

        return self

class DescribeTopHotKeysResponseBodyDataHotKey(DaraModel):
    def __init__(
        self,
        category: str = None,
        db: int = None,

...
class Client(OpenApiClient):
    ...
    *\
    ...
    def get_general_abnormal_events_count_with_options(
        self,
        request: das20200116_models.GetGeneralAbnormalEventsCountRequest,
        runtime: util_models.RuntimeOptions,
    ) -> das20200116_models.GetGeneralAbnormalEventsCountResponse:
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.end_time):
            query['EndTime'] = request.end_time
        ...
        params = open_api_models.Params(
            action='GetGeneralAbnormalEventsCount',
            version='2020-01-16',
            protocol='HTTPS',
            pathname='/',
            method='POST',
    ...
    async def get_general_abnormal_events_count_with_options_async(
        self,
        request: das20200116_models.GetGeneralAbnormalEventsCountRequest,
        runtime: util_models.RuntimeOptions,
    ) -> das20200116_models.GetGeneralAbnormalEventsCountResponse:
    ...
    def get_general_abnormal_events_count(
        self,
        request: das20200116_models.GetGeneralAbnormalEventsCountRequest,
    ) -> das20200116_models.GetGeneralAbnormalEventsCountResponse:
        runtime = util_models.RuntimeOptions()
        return self.get_general_abnormal_events_count_with_options(request, runtime)

    async def get_general_abnormal_events_count_async(
        self,
        request: das20200116_models.GetGeneralAbnormalEventsCountRequest,
    ) -> das20200116_models.GetGeneralAbnormalEventsCountResponse:
        runtime = util_models.RuntimeOptions()
        return await self.get_general_abnormal_events_count_with_options_async(request, runtime)

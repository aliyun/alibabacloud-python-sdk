...
```bash
# 安装 alibabacloud_bpstudio20210931
pip install alibabacloud_bpstudio20210931
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/bpstudio-20210931/ChangeLog.md)中。

...
class DescribeVsDevicesDataResponseBody(DaraModel):
    def __init__(
        self,
        devices_data_per_interval: main_models.DescribeVsDevicesDataResponseBodyDevicesDataPerInterval = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DevicesDataPerInterval') is not None:
            temp_model = main_models.DescribeVsDevicesDataResponseBodyDevicesDataPerInterval()
            self.devices_data_per_interval = temp_model.from_map(m.get('DevicesDataPerInterval'))
...
class DescribeVsDevicesDataResponseBodyDevicesDataPerInterval(DaraModel):
    def __init__(
        self,
        data_module: List[main_models.DescribeVsDevicesDataResponseBodyDevicesDataPerIntervalDataModule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataModule') is not None:
            for k1 in m.get('DataModule'):
                temp_model = main_models.DescribeVsDevicesDataResponseBodyDevicesDataPerIntervalDataModule()
                self.data_module.append(temp_model.from_map(k1))

        return self

class DescribeVsDevicesDataResponseBodyDevicesDataPerIntervalDataModule(DaraModel):
    def __init__(
        self,

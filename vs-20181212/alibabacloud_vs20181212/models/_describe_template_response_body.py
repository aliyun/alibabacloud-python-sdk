...
class DescribeTemplateResponseBody(DaraModel):
    def __init__(
        self,
        callback: str = None,
        ...
        request_id: str = None,
        retention: int = None,
        trans_configs: List[main_models.DescribeTemplateResponseBodyTransConfigs] = None,
        trigger: str = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TransConfigs') is not None:
            for k1 in m.get('TransConfigs'):
                temp_model = main_models.DescribeTemplateResponseBodyTransConfigs()
...
class DescribeTemplateResponseBodyTransConfigs(DaraModel):
    def __init__(
        self,
        fps: int = None,
        gop: int = None,

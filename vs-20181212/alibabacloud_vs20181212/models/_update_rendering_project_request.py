...
class UpdateRenderingProjectRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SessionAttribs') is not None:
            temp_model = main_models.UpdateRenderingProjectRequestSessionAttribs()
            self.session_attribs = temp_model.from_map(m.get('SessionAttribs'))

        return self

class UpdateRenderingProjectRequestSessionAttribs(DaraModel):
    def __init__(
        self,
        start_mode: str = None,
    ):

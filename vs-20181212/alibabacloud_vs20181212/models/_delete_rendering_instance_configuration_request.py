...
class DeleteRenderingInstanceConfigurationRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Configuration') is not None:
            for k1 in m.get('Configuration'):
                temp_model = main_models.DeleteRenderingInstanceConfigurationRequestConfiguration()
...
class DeleteRenderingInstanceConfigurationRequestConfiguration(DaraModel):
    def __init__(
        self,

...
class DescribeVsDomainUvDataResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UvDataInterval') is not None:
            temp_model = main_models.DescribeVsDomainUvDataResponseBodyUvDataInterval()
            self.uv_data_interval = temp_model.from_map(m.get('UvDataInterval'))

        return self

class DescribeVsDomainUvDataResponseBodyUvDataInterval(DaraModel):
    def __init__(
        self,
        usage_data: List[main_models.DescribeVsDomainUvDataResponseBodyUvDataIntervalUsageData] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UsageData') is not None:
            for k1 in m.get('UsageData'):
                temp_model = main_models.DescribeVsDomainUvDataResponseBodyUvDataIntervalUsageData()
                self.usage_data.append(temp_model.from_map(k1))

        return self

class DescribeVsDomainUvDataResponseBodyUvDataIntervalUsageData(DaraModel):
    def __init__(
        self,
        time_stamp: str = None,
        value: str = None,

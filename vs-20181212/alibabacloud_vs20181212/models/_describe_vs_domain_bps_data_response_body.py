...
class DescribeVsDomainBpsDataResponseBody(DaraModel):
    def __init__(
        self,
        bps_data_per_interval: main_models.DescribeVsDomainBpsDataResponseBodyBpsDataPerInterval = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BpsDataPerInterval') is not None:
            temp_model = main_models.DescribeVsDomainBpsDataResponseBodyBpsDataPerInterval()
...
class DescribeVsDomainBpsDataResponseBodyBpsDataPerInterval(DaraModel):
    def __init__(
        self,
        data_module: List[main_models.DescribeVsDomainBpsDataResponseBodyBpsDataPerIntervalDataModule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataModule') is not None:
            for k1 in m.get('DataModule'):
                temp_model = main_models.DescribeVsDomainBpsDataResponseBodyBpsDataPerIntervalDataModule()
                self.data_module.append(temp_model.from_map(k1))

        return self

class DescribeVsDomainBpsDataResponseBodyBpsDataPerIntervalDataModule(DaraModel):
    def __init__(
        self,
        bps_value: str = None,
        time_stamp: str = None,

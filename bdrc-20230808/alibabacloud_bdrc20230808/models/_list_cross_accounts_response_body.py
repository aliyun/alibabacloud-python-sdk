...
class ListCrossAccountsResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.ListCrossAccountsResponseBodyData = None,
        request_id: str = None,
    ):
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListCrossAccountsResponseBodyData()
...
class ListCrossAccountsResponseBodyData(DaraModel):
    def __init__(
        self,
        content: List[main_models.ListCrossAccountsResponseBodyDataContent] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Content') is not None:
            for k1 in m.get('Content'):
                temp_model = main_models.ListCrossAccountsResponseBodyDataContent()
...
class ListCrossAccountsResponseBodyDataContent(DaraModel):
    def __init__(
        self,
    ...
    def to_map(self):
        ...
        if self.parent_target_id is not None:
            result['ParentTargetId'] = self.parent_target_id
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ParentTargetId') is not None:
            self.parent_target_id = m.get('ParentTargetId')

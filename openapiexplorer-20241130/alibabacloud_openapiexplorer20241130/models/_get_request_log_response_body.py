...
class GetRequestLogResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('logInfo') is not None:
            temp_model = main_models.GetRequestLogResponseBodyLogInfo()
...
class GetRequestLogResponseBodyLogInfo(DaraModel):
    def __init__(
        self,
        authentication_info: main_models.GetRequestLogResponseBodyLogInfoAuthenticationInfo = None,
        basic_info: main_models.GetRequestLogResponseBodyLogInfoBasicInfo = None,
        caller_info: main_models.GetRequestLogResponseBodyLogInfoCallerInfo = None,
        parameters: List[main_models.GetRequestLogResponseBodyLogInfoParameters] = None,
        responses: main_models.GetRequestLogResponseBodyLogInfoResponses = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('authenticationInfo') is not None:
            temp_model = main_models.GetRequestLogResponseBodyLogInfoAuthenticationInfo()
            self.authentication_info = temp_model.from_map(m.get('authenticationInfo'))

        if m.get('basicInfo') is not None:
            temp_model = main_models.GetRequestLogResponseBodyLogInfoBasicInfo()
            self.basic_info = temp_model.from_map(m.get('basicInfo'))

        if m.get('callerInfo') is not None:
            temp_model = main_models.GetRequestLogResponseBodyLogInfoCallerInfo()
            self.caller_info = temp_model.from_map(m.get('callerInfo'))

        self.parameters = []
        if m.get('parameters') is not None:
            for k1 in m.get('parameters'):
                temp_model = main_models.GetRequestLogResponseBodyLogInfoParameters()
                self.parameters.append(temp_model.from_map(k1))

        if m.get('responses') is not None:
            temp_model = main_models.GetRequestLogResponseBodyLogInfoResponses()
            self.responses = temp_model.from_map(m.get('responses'))

        return self

class GetRequestLogResponseBodyLogInfoResponses(DaraModel):
    def __init__(
        self,
...
class GetRequestLogResponseBodyLogInfoParameters(DaraModel):
    def __init__(
        self,
        name: str = None,
        required: bool = None,
...
class GetRequestLogResponseBodyLogInfoCallerInfo(DaraModel):
    def __init__(
        self,
...
class GetRequestLogResponseBodyLogInfoBasicInfo(DaraModel):
    def __init__(
        self,
        access_denied_detail: main_models.GetRequestLogResponseBodyLogInfoBasicInfoAccessDeniedDetail = None,
        api: str = None,
        api_doc: main_models.GetRequestLogResponseBodyLogInfoBasicInfoApiDoc = None,
        api_style: str = None,
        ...
        product: str = None,
        product_name: main_models.GetRequestLogResponseBodyLogInfoBasicInfoProductName = None,
        region_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('accessDeniedDetail') is not None:
            temp_model = main_models.GetRequestLogResponseBodyLogInfoBasicInfoAccessDeniedDetail()
        ...
        if m.get('apiDoc') is not None:
            temp_model = main_models.GetRequestLogResponseBodyLogInfoBasicInfoApiDoc()
        ...
        if m.get('productName') is not None:
            temp_model = main_models.GetRequestLogResponseBodyLogInfoBasicInfoProductName()
...
class GetRequestLogResponseBodyLogInfoBasicInfoProductName(DaraModel):
    def __init__(
        self,
        cn_name: str = None,
        en_name: str = None,
...
class GetRequestLogResponseBodyLogInfoBasicInfoApiDoc(DaraModel):
    def __init__(
        self,
...
class GetRequestLogResponseBodyLogInfoBasicInfoAccessDeniedDetail(DaraModel):
    def __init__(
        self,
...
class GetRequestLogResponseBodyLogInfoAuthenticationInfo(DaraModel):
    def __init__(
        self,

...
```bash
# 安装 alibabacloud_openapiexplorer20241130
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/openapiexplorer-20241130/ChangeLog.md)中。

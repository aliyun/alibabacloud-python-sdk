...
class CreateHybridMonitorSLSGroupRequest(DaraModel):
    def __init__(
        self,
        region_id: str = None,
        slsgroup_config: List[main_models.CreateHybridMonitorSLSGroupRequestSLSGroupConfig] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SLSGroupConfig') is not None:
            for k1 in m.get('SLSGroupConfig'):
                temp_model = main_models.CreateHybridMonitorSLSGroupRequestSLSGroupConfig()
...
class CreateHybridMonitorSLSGroupRequestSLSGroupConfig(DaraModel):
    def __init__(
        self,

...
class DescribeProductResourceTagKeyListResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        ...
        request_id: str = None,
        success: bool = None,
        tag_keys: main_models.DescribeProductResourceTagKeyListResponseBodyTagKeys = None,
    ):
        # The status code.
        # 
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TagKeys') is not None:
            temp_model = main_models.DescribeProductResourceTagKeyListResponseBodyTagKeys()
            self.tag_keys = temp_model.from_map(m.get('TagKeys'))

        return self

class DescribeProductResourceTagKeyListResponseBodyTagKeys(DaraModel):
    def __init__(
        self,

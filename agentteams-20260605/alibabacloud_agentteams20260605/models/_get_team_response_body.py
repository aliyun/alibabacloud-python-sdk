...
class GetTeamResponseBodyData(DaraModel):
    def __init__(
        ...
        name: str = None,
        rooms: List[main_models.GetTeamResponseBodyDataRooms] = None,
        status: str = None,
        team_members: List[main_models.GetTeamResponseBodyDataTeamMembers] = None,
        updated_at: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Rooms') is not None:
            for k1 in m.get('Rooms'):
                temp_model = main_models.GetTeamResponseBodyDataRooms()
        ...
        if m.get('TeamMembers') is not None:
            for k1 in m.get('TeamMembers'):
                temp_model = main_models.GetTeamResponseBodyDataTeamMembers()
...
class GetTeamResponseBodyDataTeamMembers(DaraModel):
    def __init__(
        self,
        name: str = None,
    ):
...
class GetTeamResponseBodyDataRooms(DaraModel):
    def __init__(
        self,
        room_id: str = None,
        type: str = None,

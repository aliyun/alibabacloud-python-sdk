...
class ListTeamDetailsResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        http_status_code: int = None,
        items: List[main_models.ListTeamDetailsResponseBodyItems] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Items') is not None:
            for k1 in m.get('Items'):
                temp_model = main_models.ListTeamDetailsResponseBodyItems()
...
class ListTeamDetailsResponseBodyItems(DaraModel):
    def __init__(
        self,
        avatar_url: str = None,
        status: str = None,

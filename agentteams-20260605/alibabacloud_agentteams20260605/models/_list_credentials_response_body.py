...
class ListCredentialsResponseBodyItems(DaraModel):
    def __init__(
        ...
        self.bound_worker_count = bound_worker_count
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        if self.bound_worker_count is not None:
            result['BoundWorkerCount'] = self.bound_worker_count
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('BoundWorkerCount') is not None:
            self.bound_worker_count = m.get('BoundWorkerCount')

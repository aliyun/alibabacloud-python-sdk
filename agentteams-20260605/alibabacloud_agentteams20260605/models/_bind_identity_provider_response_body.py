...
class BindIdentityProviderResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.BindIdentityProviderResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.BindIdentityProviderResponseBodyData()
...
class BindIdentityProviderResponseBodyData(DaraModel):
    def __init__(
        self,

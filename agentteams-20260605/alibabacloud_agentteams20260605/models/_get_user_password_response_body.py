...
class GetUserPasswordResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetUserPasswordResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetUserPasswordResponseBodyData()
...
class GetUserPasswordResponseBodyData(DaraModel):
    def __init__(
        self,

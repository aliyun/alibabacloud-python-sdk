...
class CreateWorkerShrinkRequest(DaraModel):
    def __init__(
        self,
        agent_type: str = None,
        agents: str = None,
        ...
        self.groups_shrink = groups_shrink
        ...
        self.soul = soul
        self.subagents_shrink = subagents_shrink
    ...
    def to_map(self):
        ...
        if self.groups_shrink is not None:
            result['Groups'] = self.groups_shrink
        ...
        if self.subagents_shrink is not None:
            result['Subagents'] = self.subagents_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Groups') is not None:
            self.groups_shrink = m.get('Groups')
        ...
        if m.get('Subagents') is not None:
            self.subagents_shrink = m.get('Subagents')

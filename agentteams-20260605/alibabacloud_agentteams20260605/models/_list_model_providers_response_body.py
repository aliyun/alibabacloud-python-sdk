...
class ListModelProvidersResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        items: List[main_models.ListModelProvidersResponseBodyItems] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Items') is not None:
            for k1 in m.get('Items'):
                temp_model = main_models.ListModelProvidersResponseBodyItems()
...
class ListModelProvidersResponseBodyItems(DaraModel):
    def __init__(
        self,
        address: str = None,

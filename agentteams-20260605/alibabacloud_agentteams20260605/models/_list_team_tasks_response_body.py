...
class ListTeamTasksResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        http_status_code: int = None,
        items: List[main_models.ListTeamTasksResponseBodyItems] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Items') is not None:
            for k1 in m.get('Items'):
                temp_model = main_models.ListTeamTasksResponseBodyItems()
...
class ListTeamTasksResponseBodyItems(DaraModel):
    def __init__(
        self,

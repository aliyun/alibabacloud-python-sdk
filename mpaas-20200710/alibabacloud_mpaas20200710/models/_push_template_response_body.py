...
class PushTemplateResponseBody(DaraModel):
    def __init__(
        self,
        push_result: main_models.PushTemplateResponseBodyPushResult = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PushResult') is not None:
            temp_model = main_models.PushTemplateResponseBodyPushResult()
...
class PushTemplateResponseBodyPushResult(DaraModel):
    def __init__(
        self,
        data: str = None,
        result_msg: str = None,

...
class CreateMcubeUpgradePackageResponseBody(DaraModel):
    def __init__(
        self,
        create_upgrade_package_result: main_models.CreateMcubeUpgradePackageResponseBodyCreateUpgradePackageResult = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CreateUpgradePackageResult') is not None:
            temp_model = main_models.CreateMcubeUpgradePackageResponseBodyCreateUpgradePackageResult()
            self.create_upgrade_package_result = temp_model.from_map(m.get('CreateUpgradePackageResult'))
...
class CreateMcubeUpgradePackageResponseBodyCreateUpgradePackageResult(DaraModel):
    def __init__(
        self,
        error_code: str = None,
        request_id: str = None,

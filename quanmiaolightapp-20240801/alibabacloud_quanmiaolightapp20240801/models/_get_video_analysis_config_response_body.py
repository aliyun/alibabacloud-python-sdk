...
class GetVideoAnalysisConfigResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetVideoAnalysisConfigResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.GetVideoAnalysisConfigResponseBodyData()
...
class GetVideoAnalysisConfigResponseBodyData(DaraModel):
    def __init__(
        self,

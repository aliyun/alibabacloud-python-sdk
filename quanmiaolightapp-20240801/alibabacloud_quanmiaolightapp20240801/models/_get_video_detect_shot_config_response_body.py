...
class GetVideoDetectShotConfigResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetVideoDetectShotConfigResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.GetVideoDetectShotConfigResponseBodyData()
...
class GetVideoDetectShotConfigResponseBodyData(DaraModel):
    def __init__(
        self,

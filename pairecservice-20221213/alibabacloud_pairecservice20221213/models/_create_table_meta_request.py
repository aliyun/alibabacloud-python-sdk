...
class CreateTableMetaRequest(DaraModel):
    def __init__(
        self,
        description: str = None,
        fields: List[main_models.CreateTableMetaRequestFields] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Fields') is not None:
            for k1 in m.get('Fields'):
                temp_model = main_models.CreateTableMetaRequestFields()
...
class CreateTableMetaRequestFields(DaraModel):
    def __init__(
        self,
        data_type: str = None,

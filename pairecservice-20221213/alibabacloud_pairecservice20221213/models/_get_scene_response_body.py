...
class GetSceneResponseBody(DaraModel):
    def __init__(
        self,
        description: str = None,
        flows: List[main_models.GetSceneResponseBodyFlows] = None,
        name: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Flows') is not None:
            for k1 in m.get('Flows'):
                temp_model = main_models.GetSceneResponseBodyFlows()
...
class GetSceneResponseBodyFlows(DaraModel):
    def __init__(
        self,
        flow_code: str = None,
        flow_name: str = None,

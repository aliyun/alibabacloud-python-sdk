...
class CreateRecallManagementServiceVersionConfigRequest(DaraModel):
    def __init__(
        self,
        config_type: str = None,
        instance_id: str = None,
        merge_config: main_models.CreateRecallManagementServiceVersionConfigRequestMergeConfig = None,
        recall_config: main_models.CreateRecallManagementServiceVersionConfigRequestRecallConfig = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MergeConfig') is not None:
            temp_model = main_models.CreateRecallManagementServiceVersionConfigRequestMergeConfig()
            self.merge_config = temp_model.from_map(m.get('MergeConfig'))

        if m.get('RecallConfig') is not None:
            temp_model = main_models.CreateRecallManagementServiceVersionConfigRequestRecallConfig()
            self.recall_config = temp_model.from_map(m.get('RecallConfig'))

        return self

class CreateRecallManagementServiceVersionConfigRequestRecallConfig(DaraModel):
    def __init__(
        self,
        ...
        name: str = None,
        operators: List[main_models.CreateRecallManagementServiceVersionConfigRequestRecallConfigOperators] = None,
        priority: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Operators') is not None:
            for k1 in m.get('Operators'):
                temp_model = main_models.CreateRecallManagementServiceVersionConfigRequestRecallConfigOperators()
...
class CreateRecallManagementServiceVersionConfigRequestRecallConfigOperators(DaraModel):
    def __init__(
        self,
        feature_config: main_models.CreateRecallManagementServiceVersionConfigRequestRecallConfigOperatorsFeatureConfig = None,
        filter_config: main_models.CreateRecallManagementServiceVersionConfigRequestRecallConfigOperatorsFilterConfig = None,
        join_config: main_models.CreateRecallManagementServiceVersionConfigRequestRecallConfigOperatorsJoinConfig = None,
        operator_type: str = None,
        trigger_config: main_models.CreateRecallManagementServiceVersionConfigRequestRecallConfigOperatorsTriggerConfig = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FeatureConfig') is not None:
            temp_model = main_models.CreateRecallManagementServiceVersionConfigRequestRecallConfigOperatorsFeatureConfig()
            self.feature_config = temp_model.from_map(m.get('FeatureConfig'))

        if m.get('FilterConfig') is not None:
            temp_model = main_models.CreateRecallManagementServiceVersionConfigRequestRecallConfigOperatorsFilterConfig()
            self.filter_config = temp_model.from_map(m.get('FilterConfig'))

        if m.get('JoinConfig') is not None:
            temp_model = main_models.CreateRecallManagementServiceVersionConfigRequestRecallConfigOperatorsJoinConfig()
        ...
        if m.get('TriggerConfig') is not None:
            temp_model = main_models.CreateRecallManagementServiceVersionConfigRequestRecallConfigOperatorsTriggerConfig()
            self.trigger_config = temp_model.from_map(m.get('TriggerConfig'))

        return self

class CreateRecallManagementServiceVersionConfigRequestRecallConfigOperatorsTriggerConfig(DaraModel):
    def __init__(
        self,
        field: str = None,
...
class CreateRecallManagementServiceVersionConfigRequestRecallConfigOperatorsJoinConfig(DaraModel):
    def __init__(
        self,
        field: str = None,
...
class CreateRecallManagementServiceVersionConfigRequestRecallConfigOperatorsFilterConfig(DaraModel):
    def __init__(
        self,
...
class CreateRecallManagementServiceVersionConfigRequestRecallConfigOperatorsFeatureConfig(DaraModel):
    def __init__(
        self,
        expression: str = None,
        name: str = None,
...
class CreateRecallManagementServiceVersionConfigRequestMergeConfig(DaraModel):
    def __init__(
        self,
        extended_config: str = None,

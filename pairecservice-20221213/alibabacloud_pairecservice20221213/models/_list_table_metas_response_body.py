...
class ListTableMetasResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def to_map(self):
        ...
        if self.table_metas is not None:
            for k1 in self.table_metas:
                result['TableMetas'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TableMetas') is not None:
            for k1 in m.get('TableMetas'):
                temp_model = main_models.ListTableMetasResponseBodyTableMetas()
                self.table_metas.append(temp_model.from_map(k1))
...
class ListTableMetasResponseBodyTableMetas(DaraModel):
    def __init__(
        self,
        can_delete: bool = None,
        config: str = None,
        description: str = None,
        fields: List[main_models.ListTableMetasResponseBodyTableMetasFields] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Fields') is not None:
            for k1 in m.get('Fields'):
                temp_model = main_models.ListTableMetasResponseBodyTableMetasFields()
...
class ListTableMetasResponseBodyTableMetasFields(DaraModel):
    def __init__(
        self,

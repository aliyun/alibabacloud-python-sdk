...
class PushResourceRuleResponseBody(DaraModel):
    def __init__(
        self,
        ...
        rule_items: List[main_models.PushResourceRuleResponseBodyRuleItems] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RuleItems') is not None:
            for k1 in m.get('RuleItems'):
                temp_model = main_models.PushResourceRuleResponseBodyRuleItems()
                self.rule_items.append(temp_model.from_map(k1))

        return self

class PushResourceRuleResponseBodyRuleItems(DaraModel):
    def __init__(
        self,
        description: str = None,
        max_value: str = None,

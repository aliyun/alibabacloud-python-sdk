...
class GetTrafficControlTaskResponseBody(DaraModel):
    def __init__(
        self,
        ...
        traffic_control_targets: List[main_models.GetTrafficControlTaskResponseBodyTrafficControlTargets] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TrafficControlTargets') is not None:
            for k1 in m.get('TrafficControlTargets'):
                temp_model = main_models.GetTrafficControlTaskResponseBodyTrafficControlTargets()
...
class GetTrafficControlTaskResponseBodyTrafficControlTargets(DaraModel):
    def __init__(
        self,
        end_time: str = None,
        event: str = None,
        ...
        split_parts: main_models.GetTrafficControlTaskResponseBodyTrafficControlTargetsSplitParts = None,
        start_time: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SplitParts') is not None:
            temp_model = main_models.GetTrafficControlTaskResponseBodyTrafficControlTargetsSplitParts()
...
class GetTrafficControlTaskResponseBodyTrafficControlTargetsSplitParts(DaraModel):
    def __init__(
        self,

...
class ListABMetricsResponseBody(DaraModel):
    def __init__(
        self,
        abmetrics: List[main_models.ListABMetricsResponseBodyABMetrics] = None,
        request_id: str = None,
    ...
    def to_map(self):
        ...
        if self.abmetrics is not None:
            for k1 in self.abmetrics:
                result['ABMetrics'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ABMetrics') is not None:
            for k1 in m.get('ABMetrics'):
                temp_model = main_models.ListABMetricsResponseBodyABMetrics()
                self.abmetrics.append(temp_model.from_map(k1))
...
class ListABMetricsResponseBodyABMetrics(DaraModel):
    def __init__(
        self,

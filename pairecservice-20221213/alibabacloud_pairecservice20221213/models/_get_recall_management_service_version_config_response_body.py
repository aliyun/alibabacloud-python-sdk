...
class GetRecallManagementServiceVersionConfigResponseBody(DaraModel):
    def __init__(
        self,
        config_type: str = None,
        gmt_create_time: str = None,
        gmt_modified_time: str = None,
        merge_config: main_models.GetRecallManagementServiceVersionConfigResponseBodyMergeConfig = None,
        recall_config: main_models.GetRecallManagementServiceVersionConfigResponseBodyRecallConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MergeConfig') is not None:
            temp_model = main_models.GetRecallManagementServiceVersionConfigResponseBodyMergeConfig()
            self.merge_config = temp_model.from_map(m.get('MergeConfig'))

        if m.get('RecallConfig') is not None:
            temp_model = main_models.GetRecallManagementServiceVersionConfigResponseBodyRecallConfig()
...
class GetRecallManagementServiceVersionConfigResponseBodyRecallConfig(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Operators') is not None:
            for k1 in m.get('Operators'):
                temp_model = main_models.GetRecallManagementServiceVersionConfigResponseBodyRecallConfigOperators()
...
class GetRecallManagementServiceVersionConfigResponseBodyRecallConfigOperators(DaraModel):
    def __init__(
        self,
        feature_config: main_models.GetRecallManagementServiceVersionConfigResponseBodyRecallConfigOperatorsFeatureConfig = None,
        filter_config: main_models.GetRecallManagementServiceVersionConfigResponseBodyRecallConfigOperatorsFilterConfig = None,
        join_config: main_models.GetRecallManagementServiceVersionConfigResponseBodyRecallConfigOperatorsJoinConfig = None,
        operator_type: str = None,
        trigger_config: main_models.GetRecallManagementServiceVersionConfigResponseBodyRecallConfigOperatorsTriggerConfig = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FeatureConfig') is not None:
            temp_model = main_models.GetRecallManagementServiceVersionConfigResponseBodyRecallConfigOperatorsFeatureConfig()
            self.feature_config = temp_model.from_map(m.get('FeatureConfig'))

        if m.get('FilterConfig') is not None:
            temp_model = main_models.GetRecallManagementServiceVersionConfigResponseBodyRecallConfigOperatorsFilterConfig()
            self.filter_config = temp_model.from_map(m.get('FilterConfig'))

        if m.get('JoinConfig') is not None:
            temp_model = main_models.GetRecallManagementServiceVersionConfigResponseBodyRecallConfigOperatorsJoinConfig()
        ...
        if m.get('TriggerConfig') is not None:
            temp_model = main_models.GetRecallManagementServiceVersionConfigResponseBodyRecallConfigOperatorsTriggerConfig()
            self.trigger_config = temp_model.from_map(m.get('TriggerConfig'))

        return self

class GetRecallManagementServiceVersionConfigResponseBodyRecallConfigOperatorsTriggerConfig(DaraModel):
    def __init__(
        self,
        field: str = None,
...
class GetRecallManagementServiceVersionConfigResponseBodyRecallConfigOperatorsJoinConfig(DaraModel):
    def __init__(
        self,
        field: str = None,
...
class GetRecallManagementServiceVersionConfigResponseBodyRecallConfigOperatorsFilterConfig(DaraModel):
    def __init__(
        self,
        expression: str = None,
    ):
...
class GetRecallManagementServiceVersionConfigResponseBodyRecallConfigOperatorsFeatureConfig(DaraModel):
    def __init__(
        self,
        expression: str = None,
        name: str = None,
...
class GetRecallManagementServiceVersionConfigResponseBodyMergeConfig(DaraModel):
    def __init__(
        self,
        extended_config: str = None,

...
class ListResourceRulesResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        resource_rules: List[main_models.ListResourceRulesResponseBodyResourceRules] = None,
    ...
    def to_map(self):
        ...
        if self.resource_rules is not None:
            for k1 in self.resource_rules:
                result['ResourceRules'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceRules') is not None:
            for k1 in m.get('ResourceRules'):
                temp_model = main_models.ListResourceRulesResponseBodyResourceRules()
                self.resource_rules.append(temp_model.from_map(k1))
...
class ListResourceRulesResponseBodyResourceRules(DaraModel):
    def __init__(
        self,
        ...
        rule_items: List[main_models.ListResourceRulesResponseBodyResourceRulesRuleItems] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RuleItems') is not None:
            for k1 in m.get('RuleItems'):
                temp_model = main_models.ListResourceRulesResponseBodyResourceRulesRuleItems()
                self.rule_items.append(temp_model.from_map(k1))

        return self

class ListResourceRulesResponseBodyResourceRulesRuleItems(DaraModel):
    def __init__(
        self,
        description: str = None,
        max_value: str = None,

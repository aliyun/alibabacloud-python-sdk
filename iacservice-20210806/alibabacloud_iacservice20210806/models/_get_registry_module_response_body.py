...
class GetRegistryModuleResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('registryModule') is not None:
            temp_model = main_models.GetRegistryModuleResponseBodyRegistryModule()
            self.registry_module = temp_model.from_map(m.get('registryModule'))
...
class GetRegistryModuleResponseBodyRegistryModule(DaraModel):
    def __init__(
        self,
        acl: str = None,

...
class CreateDetectConfigRequest(DaraModel):
    def __init__(
        self,
        alarm_configs: List[main_models.CreateDetectConfigRequestAlarmConfigs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('alarmConfigs') is not None:
            for k1 in m.get('alarmConfigs'):
                temp_model = main_models.CreateDetectConfigRequestAlarmConfigs()
...
class CreateDetectConfigRequestAlarmConfigs(DaraModel):
    def __init__(
        self,
        address: str = None,
        type: str = None,

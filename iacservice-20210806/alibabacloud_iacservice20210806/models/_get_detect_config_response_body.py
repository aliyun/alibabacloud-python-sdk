...
class GetDetectConfigResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        if self.detect_config is not None:
            result['detectConfig'] = self.detect_config.to_map()
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('detectConfig') is not None:
            temp_model = main_models.GetDetectConfigResponseBodyDetectConfig()
            self.detect_config = temp_model.from_map(m.get('detectConfig'))
...
class GetDetectConfigResponseBodyDetectConfig(DaraModel):
    def __init__(
        self,
        alarm_configs: List[main_models.GetDetectConfigResponseBodyDetectConfigAlarmConfigs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('alarmConfigs') is not None:
            for k1 in m.get('alarmConfigs'):
                temp_model = main_models.GetDetectConfigResponseBodyDetectConfigAlarmConfigs()
...
class GetDetectConfigResponseBodyDetectConfigAlarmConfigs(DaraModel):
    def __init__(
        self,
        address: str = None,
        type: str = None,

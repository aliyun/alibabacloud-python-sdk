...
class UpdateModuleAttributeRequest(DaraModel):
    def __init__(
        self,
        client_token: str = None,
        description: str = None,
        group_info: main_models.UpdateModuleAttributeRequestGroupInfo = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('groupInfo') is not None:
            temp_model = main_models.UpdateModuleAttributeRequestGroupInfo()
        ...
        if m.get('tags') is not None:
            for k1 in m.get('tags'):
                temp_model = main_models.UpdateModuleAttributeRequestTags()
...
class UpdateModuleAttributeRequestTags(DaraModel):
    def __init__(
        self,
        tag_key: str = None,
        tag_value: str = None,
...
class UpdateModuleAttributeRequestGroupInfo(DaraModel):
    def __init__(
        self,
        group_id: str = None,
        project_id: str = None,

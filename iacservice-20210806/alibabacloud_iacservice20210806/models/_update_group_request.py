...
class UpdateGroupRequest(DaraModel):
    def __init__(
        ...
        name: str = None,
        notify_config: List[main_models.UpdateGroupRequestNotifyConfig] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('notifyConfig') is not None:
            for k1 in m.get('notifyConfig'):
                temp_model = main_models.UpdateGroupRequestNotifyConfig()
        ...
        if m.get('triggerConfig') is not None:
            for k1 in m.get('triggerConfig'):
                temp_model = main_models.UpdateGroupRequestTriggerConfig()
...
class UpdateGroupRequestTriggerConfig(DaraModel):
    def __init__(
        self,
...
class UpdateGroupRequestNotifyConfig(DaraModel):
    def __init__(
        self,

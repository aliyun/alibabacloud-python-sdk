...
class ListParameterSetsResponseBody(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        parameter_sets: List[main_models.ListParameterSetsResponseBodyParameterSets] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('parameterSets') is not None:
            for k1 in m.get('parameterSets'):
                temp_model = main_models.ListParameterSetsResponseBodyParameterSets()
...
class ListParameterSetsResponseBodyParameterSets(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('parameters') is not None:
            for k1 in m.get('parameters'):
                temp_model = main_models.ListParameterSetsResponseBodyParameterSetsParameters()
                self.parameters.append(temp_model.from_map(k1))

        self.relation_list = []
        if m.get('relationList') is not None:
            for k1 in m.get('relationList'):
                temp_model = main_models.ListParameterSetsResponseBodyParameterSetsRelationList()
                self.relation_list.append(temp_model.from_map(k1))

        return self

class ListParameterSetsResponseBodyParameterSetsRelationList(DaraModel):
    def __init__(
        self,
        create_time: str = None,
...
class ListParameterSetsResponseBodyParameterSetsParameters(DaraModel):
    def __init__(
        self,
        name: str = None,
        status: str = None,

...
class UninstallSoftwaresRequest(DaraModel):
    def __init__(
        self,
        additional_packages: List[main_models.UninstallSoftwaresRequestAdditionalPackages] = None,
        cluster_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AdditionalPackages') is not None:
            for k1 in m.get('AdditionalPackages'):
                temp_model = main_models.UninstallSoftwaresRequestAdditionalPackages()
...
class UninstallSoftwaresRequestAdditionalPackages(DaraModel):
    def __init__(
        self,
        name: str = None,
        version: str = None,

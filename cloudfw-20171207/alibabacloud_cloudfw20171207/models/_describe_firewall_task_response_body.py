...
class DescribeFirewallTaskResponseBody(DaraModel):
    def __init__(
        self,
        is_found: bool = None,
        request_id: str = None,
        ...
        task_steps: List[main_models.DescribeFirewallTaskResponseBodyTaskSteps] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TaskSteps') is not None:
            for k1 in m.get('TaskSteps'):
                temp_model = main_models.DescribeFirewallTaskResponseBodyTaskSteps()
...
class DescribeFirewallTaskResponseBodyTaskSteps(DaraModel):
    def __init__(
        self,
        step_info: str = None,
        step_name: str = None,

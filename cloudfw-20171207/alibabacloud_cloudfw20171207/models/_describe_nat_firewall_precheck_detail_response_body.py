...
class DescribeNatFirewallPrecheckDetailResponseBody(DaraModel):
    def __init__(
        self,
        is_found: bool = None,
        precheck_detail: main_models.DescribeNatFirewallPrecheckDetailResponseBodyPrecheckDetail = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PrecheckDetail') is not None:
            temp_model = main_models.DescribeNatFirewallPrecheckDetailResponseBodyPrecheckDetail()
...
class DescribeNatFirewallPrecheckDetailResponseBodyPrecheckDetail(DaraModel):
    def __init__(
        self,
        firewall_id: str = None,
        network_instance_id: str = None,
        precheck_entity_groups: List[main_models.DescribeNatFirewallPrecheckDetailResponseBodyPrecheckDetailPrecheckEntityGroups] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PrecheckEntityGroups') is not None:
            for k1 in m.get('PrecheckEntityGroups'):
                temp_model = main_models.DescribeNatFirewallPrecheckDetailResponseBodyPrecheckDetailPrecheckEntityGroups()
...
class DescribeNatFirewallPrecheckDetailResponseBodyPrecheckDetailPrecheckEntityGroups(DaraModel):
    def __init__(
        self,
        failed_count: int = None,
        name: str = None,
        precheck_entities: List[main_models.DescribeNatFirewallPrecheckDetailResponseBodyPrecheckDetailPrecheckEntityGroupsPrecheckEntities] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PrecheckEntities') is not None:
            for k1 in m.get('PrecheckEntities'):
                temp_model = main_models.DescribeNatFirewallPrecheckDetailResponseBodyPrecheckDetailPrecheckEntityGroupsPrecheckEntities()
...
class DescribeNatFirewallPrecheckDetailResponseBodyPrecheckDetailPrecheckEntityGroupsPrecheckEntities(DaraModel):
    def __init__(
        self,
        info: str = None,
        name: str = None,

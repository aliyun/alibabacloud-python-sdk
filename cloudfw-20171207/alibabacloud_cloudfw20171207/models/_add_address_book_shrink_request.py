...
class AddAddressBookShrinkRequest(DaraModel):
    def __init__(
        self,
        ack_cluster_connector_id: str = None,
        ack_labels: List[main_models.AddAddressBookShrinkRequestAckLabels] = None,
        ...
        lang: str = None,
        source_ip: str = None,
        tag_list: List[main_models.AddAddressBookShrinkRequestTagList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AckLabels') is not None:
            for k1 in m.get('AckLabels'):
                temp_model = main_models.AddAddressBookShrinkRequestAckLabels()
        ...
        if m.get('TagList') is not None:
            for k1 in m.get('TagList'):
                temp_model = main_models.AddAddressBookShrinkRequestTagList()
...
class AddAddressBookShrinkRequestTagList(DaraModel):
    def __init__(
        self,
        tag_key: str = None,
        tag_value: str = None,
...
class AddAddressBookShrinkRequestAckLabels(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

...
class DescribeBatchSlsDispatchStatusResponseBody(DaraModel):
    def __init__(
        self,
        info_list: List[main_models.DescribeBatchSlsDispatchStatusResponseBodyInfoList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InfoList') is not None:
            for k1 in m.get('InfoList'):
                temp_model = main_models.DescribeBatchSlsDispatchStatusResponseBodyInfoList()
...
class DescribeBatchSlsDispatchStatusResponseBodyInfoList(DaraModel):
    def __init__(
        self,
        item_list: List[main_models.DescribeBatchSlsDispatchStatusResponseBodyInfoListItemList] = None,
        logstore_name: str = None,
        project_name: str = None,
        site: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ItemList') is not None:
            for k1 in m.get('ItemList'):
                temp_model = main_models.DescribeBatchSlsDispatchStatusResponseBodyInfoListItemList()
                self.item_list.append(temp_model.from_map(k1))
...
class DescribeBatchSlsDispatchStatusResponseBodyInfoListItemList(DaraModel):
    def __init__(
        self,
        config_status: str = None,
        dispatch_name: str = None,

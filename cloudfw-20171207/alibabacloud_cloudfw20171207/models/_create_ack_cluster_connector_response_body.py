...
class CreateAckClusterConnectorResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AckClusterConnector') is not None:
            temp_model = main_models.CreateAckClusterConnectorResponseBodyAckClusterConnector()
...
class CreateAckClusterConnectorResponseBodyAckClusterConnector(DaraModel):
    def __init__(
        self,

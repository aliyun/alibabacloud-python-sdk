...
class DescribeInternetOpenPortResponseBody(DaraModel):
    def __init__(
        self,
        data_list: List[main_models.DescribeInternetOpenPortResponseBodyDataList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataList') is not None:
            for k1 in m.get('DataList'):
                temp_model = main_models.DescribeInternetOpenPortResponseBodyDataList()
                self.data_list.append(temp_model.from_map(k1))

        if m.get('PageInfo') is not None:
            temp_model = main_models.DescribeInternetOpenPortResponseBodyPageInfo()
...
class DescribeInternetOpenPortResponseBodyPageInfo(DaraModel):
    def __init__(
        self,
...
class DescribeInternetOpenPortResponseBodyDataList(DaraModel):
    def __init__(
        self,
        detail_num: int = None,
        in_bytes: int = None,

...
class DescribeOutgoingDomainDetailResponseBody(DaraModel):
    def __init__(
        self,
        application_name_list: List[str] = None,
        asset_list: List[main_models.DescribeOutgoingDomainDetailResponseBodyAssetList] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AssetList') is not None:
            for k1 in m.get('AssetList'):
                temp_model = main_models.DescribeOutgoingDomainDetailResponseBodyAssetList()
...
class DescribeOutgoingDomainDetailResponseBodyAssetList(DaraModel):
    def __init__(
        self,
        ...
        tag_list: List[main_models.DescribeOutgoingDomainDetailResponseBodyAssetListTagList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TagList') is not None:
            for k1 in m.get('TagList'):
                temp_model = main_models.DescribeOutgoingDomainDetailResponseBodyAssetListTagList()
...
class DescribeOutgoingDomainDetailResponseBodyAssetListTagList(DaraModel):
    def __init__(
        self,
        class_id: str = None,
        risk_level: int = None,

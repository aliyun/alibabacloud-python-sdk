...
## Alibaba Cloud MaasQIService SDK for Python
...
```bash
# 安装 alibabacloud_maasqiservice20260831
pip install alibabacloud_maasqiservice20260831
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/maasqiservice-20260831/ChangeLog.md)中。

...
## Alibaba Cloud AgentCore SDK for Python
...
```bash
# 安装 alibabacloud_agentcore20260804
pip install alibabacloud_agentcore20260804
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/agentcore-20260804/ChangeLog.md)中。

...
class ListExternalAgentsResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        http_status_code: int = None,
        items: List[main_models.ListExternalAgentsResponseBodyItems] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('items') is not None:
            for k1 in m.get('items'):
                temp_model = main_models.ListExternalAgentsResponseBodyItems()
...
class ListExternalAgentsResponseBodyItems(DaraModel):
    def __init__(
        self,
        agent_id: str = None,

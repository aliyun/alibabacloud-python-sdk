...
class CreateAgentIMChannelResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.CreateAgentIMChannelResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.CreateAgentIMChannelResponseBodyData()
...
class CreateAgentIMChannelResponseBodyData(DaraModel):
    def __init__(
        self,
        agent_id: str = None,
        channel_config: main_models.CreateAgentIMChannelResponseBodyDataChannelConfig = None,
        channel_type: str = None,
        create_time: str = None,
        credential_summary: main_models.CreateAgentIMChannelResponseBodyDataCredentialSummary = None,
        enabled: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('channelConfig') is not None:
            temp_model = main_models.CreateAgentIMChannelResponseBodyDataChannelConfig()
        ...
        if m.get('credentialSummary') is not None:
            temp_model = main_models.CreateAgentIMChannelResponseBodyDataCredentialSummary()
...
class CreateAgentIMChannelResponseBodyDataCredentialSummary(DaraModel):
    def __init__(
        self,
...
class CreateAgentIMChannelResponseBodyDataChannelConfig(DaraModel):
    def __init__(
        self,

...
class CreateCredentialResponseBodyData(DaraModel):
    def __init__(
        ...
        name: str = None,
        region_id: str = None,
        resource_refs: List[main_models.CreateCredentialResponseBodyDataResourceRefs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('resourceRefs') is not None:
            for k1 in m.get('resourceRefs'):
                temp_model = main_models.CreateCredentialResponseBodyDataResourceRefs()
...
class CreateCredentialResponseBodyDataResourceRefs(DaraModel):
    def __init__(
        self,

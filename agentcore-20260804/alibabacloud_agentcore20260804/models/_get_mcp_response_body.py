...
class GetMcpResponseBodyData(DaraModel):
    def __init__(
        ...
        auth: main_models.GetMcpResponseBodyDataAuth = None,
        created_at: str = None,
        custom_tags: List[str] = None,
        deployment_config: main_models.GetMcpResponseBodyDataDeploymentConfig = None,
        description: str = None,
        endpoint: str = None,
        function_name: str = None,
        market_source: main_models.GetMcpResponseBodyDataMarketSource = None,
        ...
        template: main_models.GetMcpResponseBodyDataTemplate = None,
        type: str = None,
        updated_at: str = None,
        url: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('auth') is not None:
            temp_model = main_models.GetMcpResponseBodyDataAuth()
        ...
        if m.get('deploymentConfig') is not None:
            temp_model = main_models.GetMcpResponseBodyDataDeploymentConfig()
        ...
        if m.get('marketSource') is not None:
            temp_model = main_models.GetMcpResponseBodyDataMarketSource()
        ...
        if m.get('template') is not None:
            temp_model = main_models.GetMcpResponseBodyDataTemplate()
...
class GetMcpResponseBodyDataTemplate(DaraModel):
    def __init__(
        self,
...
class GetMcpResponseBodyDataMarketSource(DaraModel):
    def __init__(
        self,
...
class GetMcpResponseBodyDataDeploymentConfig(DaraModel):
    def __init__(
        self,
        access_control: main_models.GetMcpResponseBodyDataDeploymentConfigAccessControl = None,
        agent_identity_configuration: main_models.GetMcpResponseBodyDataDeploymentConfigAgentIdentityConfiguration = None,
        artifact_type: str = None,
        code_configuration: main_models.GetMcpResponseBodyDataDeploymentConfigCodeConfiguration = None,
        container_configuration: main_models.GetMcpResponseBodyDataDeploymentConfigContainerConfiguration = None,
        hook_configuration: main_models.GetMcpResponseBodyDataDeploymentConfigHookConfiguration = None,
        log_configuration: main_models.GetMcpResponseBodyDataDeploymentConfigLogConfiguration = None,
        mcp_configuration: main_models.GetMcpResponseBodyDataDeploymentConfigMcpConfiguration = None,
        nas_configuration: main_models.GetMcpResponseBodyDataDeploymentConfigNasConfiguration = None,
        network_configuration: main_models.GetMcpResponseBodyDataDeploymentConfigNetworkConfiguration = None,
        oss_mount_configuration: main_models.GetMcpResponseBodyDataDeploymentConfigOssMountConfiguration = None,
        parameter_transform_configuration: main_models.GetMcpResponseBodyDataDeploymentConfigParameterTransformConfiguration = None,
        proxy_configuration: main_models.GetMcpResponseBodyDataDeploymentConfigProxyConfiguration = None,
        runtime_configuration: main_models.GetMcpResponseBodyDataDeploymentConfigRuntimeConfiguration = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('accessControl') is not None:
            temp_model = main_models.GetMcpResponseBodyDataDeploymentConfigAccessControl()
            self.access_control = temp_model.from_map(m.get('accessControl'))

        if m.get('agentIdentityConfiguration') is not None:
            temp_model = main_models.GetMcpResponseBodyDataDeploymentConfigAgentIdentityConfiguration()
        ...
        if m.get('parameterTransformConfiguration') is not None:
            temp_model = main_models.GetMcpResponseBodyDataDeploymentConfigParameterTransformConfiguration()
        ...
        if m.get('proxyConfiguration') is not None:
            temp_model = main_models.GetMcpResponseBodyDataDeploymentConfigProxyConfiguration()
            self.proxy_configuration = temp_model.from_map(m.get('proxyConfiguration'))

        if m.get('runtimeConfiguration') is not None:
            temp_model = main_models.GetMcpResponseBodyDataDeploymentConfigRuntimeConfiguration()
            self.runtime_configuration = temp_model.from_map(m.get('runtimeConfiguration'))

        return self

class GetMcpResponseBodyDataDeploymentConfigRuntimeConfiguration(DaraModel):
    def __init__(
        self,
        cpu: float = None,
        disk_size: int = None,
...
class GetMcpResponseBodyDataDeploymentConfigProxyConfiguration(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
    ):
...
class GetMcpResponseBodyDataDeploymentConfigParameterTransformConfiguration(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
...
class GetMcpResponseBodyDataDeploymentConfigOssMountConfiguration(DaraModel):
    def __init__(
        self,
        mount_points: List[main_models.GetMcpResponseBodyDataDeploymentConfigOssMountConfigurationMountPoints] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('mountPoints') is not None:
            for k1 in m.get('mountPoints'):
                temp_model = main_models.GetMcpResponseBodyDataDeploymentConfigOssMountConfigurationMountPoints()
                self.mount_points.append(temp_model.from_map(k1))

        return self

class GetMcpResponseBodyDataDeploymentConfigOssMountConfigurationMountPoints(DaraModel):
    def __init__(
        self,
...
class GetMcpResponseBodyDataDeploymentConfigNetworkConfiguration(DaraModel):
    def __init__(
        self,
...
class GetMcpResponseBodyDataDeploymentConfigNasConfiguration(DaraModel):
    def __init__(
        self,
        group_id: int = None,
        mount_points: List[main_models.GetMcpResponseBodyDataDeploymentConfigNasConfigurationMountPoints] = None,
        user_id: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('mountPoints') is not None:
            for k1 in m.get('mountPoints'):
                temp_model = main_models.GetMcpResponseBodyDataDeploymentConfigNasConfigurationMountPoints()
                self.mount_points.append(temp_model.from_map(k1))
...
class GetMcpResponseBodyDataDeploymentConfigNasConfigurationMountPoints(DaraModel):
    def __init__(
        self,
...
class GetMcpResponseBodyDataDeploymentConfigMcpConfiguration(DaraModel):
    def __init__(
        self,
...
class GetMcpResponseBodyDataDeploymentConfigLogConfiguration(DaraModel):
    def __init__(
        self,
...
class GetMcpResponseBodyDataDeploymentConfigHookConfiguration(DaraModel):
    def __init__(
        self,
        hooks: List[main_models.GetMcpResponseBodyDataDeploymentConfigHookConfigurationHooks] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('hooks') is not None:
            for k1 in m.get('hooks'):
                temp_model = main_models.GetMcpResponseBodyDataDeploymentConfigHookConfigurationHooks()
                self.hooks.append(temp_model.from_map(k1))

        return self

class GetMcpResponseBodyDataDeploymentConfigHookConfigurationHooks(DaraModel):
    def __init__(
        self,
...
class GetMcpResponseBodyDataDeploymentConfigContainerConfiguration(DaraModel):
    def __init__(
        self,
...
class GetMcpResponseBodyDataDeploymentConfigCodeConfiguration(DaraModel):
    def __init__(
        self,
...
class GetMcpResponseBodyDataDeploymentConfigAgentIdentityConfiguration(DaraModel):
    def __init__(
        self,
...
class GetMcpResponseBodyDataDeploymentConfigAccessControl(DaraModel):
    def __init__(
        self,
...
class GetMcpResponseBodyDataAuth(DaraModel):
    def __init__(
        self,
        code_package: main_models.GetMcpResponseBodyDataAuthCodePackage = None,
        direct_proxy: main_models.GetMcpResponseBodyDataAuthDirectProxy = None,
        enabled: bool = None,
        http_to_mcp: List[main_models.GetMcpResponseBodyDataAuthHttpToMcp] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('codePackage') is not None:
            temp_model = main_models.GetMcpResponseBodyDataAuthCodePackage()
            self.code_package = temp_model.from_map(m.get('codePackage'))

        if m.get('directProxy') is not None:
            temp_model = main_models.GetMcpResponseBodyDataAuthDirectProxy()
        ...
        if m.get('httpToMcp') is not None:
            for k1 in m.get('httpToMcp'):
                temp_model = main_models.GetMcpResponseBodyDataAuthHttpToMcp()
                self.http_to_mcp.append(temp_model.from_map(k1))

        return self

class GetMcpResponseBodyDataAuthHttpToMcp(DaraModel):
    def __init__(
        self,
        credential: str = None,
        id: str = None,
...
class GetMcpResponseBodyDataAuthDirectProxy(DaraModel):
    def __init__(
        self,
        name: str = None,
        value: str = None,
...
class GetMcpResponseBodyDataAuthCodePackage(DaraModel):
    def __init__(
        self,
        api_key: str = None,

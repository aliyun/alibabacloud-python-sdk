...
class CreateMcpResponseBodyData(DaraModel):
    def __init__(
        ...
        deployment_config: main_models.CreateMcpResponseBodyDataDeploymentConfig = None,
        description: str = None,
        endpoint: str = None,
        function_name: str = None,
        market_source: main_models.CreateMcpResponseBodyDataMarketSource = None,
        ...
        template: main_models.CreateMcpResponseBodyDataTemplate = None,
        type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('deploymentConfig') is not None:
            temp_model = main_models.CreateMcpResponseBodyDataDeploymentConfig()
        ...
        if m.get('marketSource') is not None:
            temp_model = main_models.CreateMcpResponseBodyDataMarketSource()
        ...
        if m.get('template') is not None:
            temp_model = main_models.CreateMcpResponseBodyDataTemplate()
...
class CreateMcpResponseBodyDataTemplate(DaraModel):
    def __init__(
        self,
...
class CreateMcpResponseBodyDataMarketSource(DaraModel):
    def __init__(
        self,
...
class CreateMcpResponseBodyDataDeploymentConfig(DaraModel):
    def __init__(
        self,
        access_control: main_models.CreateMcpResponseBodyDataDeploymentConfigAccessControl = None,
        agent_identity_configuration: main_models.CreateMcpResponseBodyDataDeploymentConfigAgentIdentityConfiguration = None,
        artifact_type: str = None,
        code_configuration: main_models.CreateMcpResponseBodyDataDeploymentConfigCodeConfiguration = None,
        container_configuration: main_models.CreateMcpResponseBodyDataDeploymentConfigContainerConfiguration = None,
        hook_configuration: main_models.CreateMcpResponseBodyDataDeploymentConfigHookConfiguration = None,
        log_configuration: main_models.CreateMcpResponseBodyDataDeploymentConfigLogConfiguration = None,
        mcp_configuration: main_models.CreateMcpResponseBodyDataDeploymentConfigMcpConfiguration = None,
        nas_configuration: main_models.CreateMcpResponseBodyDataDeploymentConfigNasConfiguration = None,
        network_configuration: main_models.CreateMcpResponseBodyDataDeploymentConfigNetworkConfiguration = None,
        oss_mount_configuration: main_models.CreateMcpResponseBodyDataDeploymentConfigOssMountConfiguration = None,
        parameter_transform_configuration: main_models.CreateMcpResponseBodyDataDeploymentConfigParameterTransformConfiguration = None,
        proxy_configuration: main_models.CreateMcpResponseBodyDataDeploymentConfigProxyConfiguration = None,
        runtime_configuration: main_models.CreateMcpResponseBodyDataDeploymentConfigRuntimeConfiguration = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('accessControl') is not None:
            temp_model = main_models.CreateMcpResponseBodyDataDeploymentConfigAccessControl()
            self.access_control = temp_model.from_map(m.get('accessControl'))

        if m.get('agentIdentityConfiguration') is not None:
            temp_model = main_models.CreateMcpResponseBodyDataDeploymentConfigAgentIdentityConfiguration()
        ...
        if m.get('parameterTransformConfiguration') is not None:
            temp_model = main_models.CreateMcpResponseBodyDataDeploymentConfigParameterTransformConfiguration()
        ...
        if m.get('proxyConfiguration') is not None:
            temp_model = main_models.CreateMcpResponseBodyDataDeploymentConfigProxyConfiguration()
            self.proxy_configuration = temp_model.from_map(m.get('proxyConfiguration'))

        if m.get('runtimeConfiguration') is not None:
            temp_model = main_models.CreateMcpResponseBodyDataDeploymentConfigRuntimeConfiguration()
            self.runtime_configuration = temp_model.from_map(m.get('runtimeConfiguration'))

        return self

class CreateMcpResponseBodyDataDeploymentConfigRuntimeConfiguration(DaraModel):
    def __init__(
        self,
        cpu: float = None,
        disk_size: int = None,
...
class CreateMcpResponseBodyDataDeploymentConfigProxyConfiguration(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
    ):
...
class CreateMcpResponseBodyDataDeploymentConfigParameterTransformConfiguration(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
...
class CreateMcpResponseBodyDataDeploymentConfigOssMountConfiguration(DaraModel):
    def __init__(
        self,
        mount_points: List[main_models.CreateMcpResponseBodyDataDeploymentConfigOssMountConfigurationMountPoints] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('mountPoints') is not None:
            for k1 in m.get('mountPoints'):
                temp_model = main_models.CreateMcpResponseBodyDataDeploymentConfigOssMountConfigurationMountPoints()
                self.mount_points.append(temp_model.from_map(k1))

        return self

class CreateMcpResponseBodyDataDeploymentConfigOssMountConfigurationMountPoints(DaraModel):
    def __init__(
        self,
...
class CreateMcpResponseBodyDataDeploymentConfigNetworkConfiguration(DaraModel):
    def __init__(
        self,
...
class CreateMcpResponseBodyDataDeploymentConfigNasConfiguration(DaraModel):
    def __init__(
        self,
        group_id: int = None,
        mount_points: List[main_models.CreateMcpResponseBodyDataDeploymentConfigNasConfigurationMountPoints] = None,
        user_id: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('mountPoints') is not None:
            for k1 in m.get('mountPoints'):
                temp_model = main_models.CreateMcpResponseBodyDataDeploymentConfigNasConfigurationMountPoints()
                self.mount_points.append(temp_model.from_map(k1))
...
class CreateMcpResponseBodyDataDeploymentConfigNasConfigurationMountPoints(DaraModel):
    def __init__(
        self,
...
class CreateMcpResponseBodyDataDeploymentConfigMcpConfiguration(DaraModel):
    def __init__(
        self,
...
class CreateMcpResponseBodyDataDeploymentConfigLogConfiguration(DaraModel):
    def __init__(
        self,
...
class CreateMcpResponseBodyDataDeploymentConfigHookConfiguration(DaraModel):
    def __init__(
        self,
        hooks: List[main_models.CreateMcpResponseBodyDataDeploymentConfigHookConfigurationHooks] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('hooks') is not None:
            for k1 in m.get('hooks'):
                temp_model = main_models.CreateMcpResponseBodyDataDeploymentConfigHookConfigurationHooks()
                self.hooks.append(temp_model.from_map(k1))

        return self

class CreateMcpResponseBodyDataDeploymentConfigHookConfigurationHooks(DaraModel):
    def __init__(
        self,
...
class CreateMcpResponseBodyDataDeploymentConfigContainerConfiguration(DaraModel):
    def __init__(
        self,
...
class CreateMcpResponseBodyDataDeploymentConfigCodeConfiguration(DaraModel):
    def __init__(
        self,
...
class CreateMcpResponseBodyDataDeploymentConfigAgentIdentityConfiguration(DaraModel):
    def __init__(
        self,
...
class CreateMcpResponseBodyDataDeploymentConfigAccessControl(DaraModel):
    def __init__(
        self,
...
class CreateMcpResponseBodyDataAuth(DaraModel):
    def __init__(
        self,
        code_package: main_models.CreateMcpResponseBodyDataAuthCodePackage = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('codePackage') is not None:
            temp_model = main_models.CreateMcpResponseBodyDataAuthCodePackage()
...
class CreateMcpResponseBodyDataAuthCodePackage(DaraModel):
    def __init__(
        self,
        api_key: str = None,

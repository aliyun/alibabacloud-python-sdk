...
class CreateExternalAgentResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.CreateExternalAgentResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.CreateExternalAgentResponseBodyData()
...
class CreateExternalAgentResponseBodyData(DaraModel):
    def __init__(
        self,
        agent_id: str = None,
        ...
        effective_result: main_models.CreateExternalAgentResponseBodyDataEffectiveResult = None,
        effective_spec_version: int = None,
        external_agent_status: main_models.CreateExternalAgentResponseBodyDataExternalAgentStatus = None,
        instruction: str = None,
        latest_spec_version: int = None,
        latest_version_status: str = None,
        model: main_models.CreateExternalAgentResponseBodyDataModel = None,
        model_source: str = None,
        name: str = None,
        region_id: str = None,
        runtime: str = None,
        skills: List[main_models.CreateExternalAgentResponseBodyDataSkills] = None,
        status: str = None,
        template: main_models.CreateExternalAgentResponseBodyDataTemplate = None,
        tools: List[main_models.CreateExternalAgentResponseBodyDataTools] = None,
        updated_at: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('effectiveResult') is not None:
            temp_model = main_models.CreateExternalAgentResponseBodyDataEffectiveResult()
        ...
        if m.get('externalAgentStatus') is not None:
            temp_model = main_models.CreateExternalAgentResponseBodyDataExternalAgentStatus()
        ...
        if m.get('model') is not None:
            temp_model = main_models.CreateExternalAgentResponseBodyDataModel()
        ...
        if m.get('skills') is not None:
            for k1 in m.get('skills'):
                temp_model = main_models.CreateExternalAgentResponseBodyDataSkills()
        ...
        if m.get('template') is not None:
            temp_model = main_models.CreateExternalAgentResponseBodyDataTemplate()
            self.template = temp_model.from_map(m.get('template'))

        self.tools = []
        if m.get('tools') is not None:
            for k1 in m.get('tools'):
                temp_model = main_models.CreateExternalAgentResponseBodyDataTools()
...
class CreateExternalAgentResponseBodyDataTools(DaraModel):
    def __init__(
        self,
        name: str = None,
        type: str = None,
...
class CreateExternalAgentResponseBodyDataTemplate(DaraModel):
    def __init__(
        self,
        ai_registry: main_models.CreateExternalAgentResponseBodyDataTemplateAiRegistry = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('aiRegistry') is not None:
            temp_model = main_models.CreateExternalAgentResponseBodyDataTemplateAiRegistry()
            self.ai_registry = temp_model.from_map(m.get('aiRegistry'))

        return self

class CreateExternalAgentResponseBodyDataTemplateAiRegistry(DaraModel):
    def __init__(
        self,
        name: str = None,
        version: str = None,
...
class CreateExternalAgentResponseBodyDataSkills(DaraModel):
    def __init__(
        self,
        name: str = None,
        version: str = None,
...
class CreateExternalAgentResponseBodyDataModel(DaraModel):
    def __init__(
        self,
...
class CreateExternalAgentResponseBodyDataExternalAgentStatus(DaraModel):
    def __init__(
        self,
...
class CreateExternalAgentResponseBodyDataEffectiveResult(DaraModel):
    def __init__(
        self,

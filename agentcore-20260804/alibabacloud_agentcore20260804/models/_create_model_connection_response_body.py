...
class CreateModelConnectionResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.CreateModelConnectionResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.CreateModelConnectionResponseBodyData()
...
class CreateModelConnectionResponseBodyData(DaraModel):
    def __init__(
        self,

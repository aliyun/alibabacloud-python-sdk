...
class InstallMcpMarketItemRequest(DaraModel):
    def __init__(
        self,
        body: main_models.InstallMcpMarketItemRequestBody = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('body') is not None:
            temp_model = main_models.InstallMcpMarketItemRequestBody()
...
class InstallMcpMarketItemRequestBody(DaraModel):
    def __init__(
        self,
...
class InstallMcpMarketItemRequestBodyDeploymentConfig(DaraModel):
    def __init__(
        self,
        access_control: main_models.InstallMcpMarketItemRequestBodyDeploymentConfigAccessControl = None,
        agent_identity_configuration: main_models.InstallMcpMarketItemRequestBodyDeploymentConfigAgentIdentityConfiguration = None,
        artifact_type: str = None,
        code_configuration: main_models.InstallMcpMarketItemRequestBodyDeploymentConfigCodeConfiguration = None,
        container_configuration: main_models.InstallMcpMarketItemRequestBodyDeploymentConfigContainerConfiguration = None,
        hook_configuration: main_models.InstallMcpMarketItemRequestBodyDeploymentConfigHookConfiguration = None,
        log_configuration: main_models.InstallMcpMarketItemRequestBodyDeploymentConfigLogConfiguration = None,
        mcp_configuration: main_models.InstallMcpMarketItemRequestBodyDeploymentConfigMcpConfiguration = None,
        nas_configuration: main_models.InstallMcpMarketItemRequestBodyDeploymentConfigNasConfiguration = None,
        network_configuration: main_models.InstallMcpMarketItemRequestBodyDeploymentConfigNetworkConfiguration = None,
        oss_mount_configuration: main_models.InstallMcpMarketItemRequestBodyDeploymentConfigOssMountConfiguration = None,
        parameter_transform_configuration: main_models.InstallMcpMarketItemRequestBodyDeploymentConfigParameterTransformConfiguration = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('accessControl') is not None:
            temp_model = main_models.InstallMcpMarketItemRequestBodyDeploymentConfigAccessControl()
            self.access_control = temp_model.from_map(m.get('accessControl'))

        if m.get('agentIdentityConfiguration') is not None:
            temp_model = main_models.InstallMcpMarketItemRequestBodyDeploymentConfigAgentIdentityConfiguration()
        ...
        if m.get('parameterTransformConfiguration') is not None:
            temp_model = main_models.InstallMcpMarketItemRequestBodyDeploymentConfigParameterTransformConfiguration()
        ...
        if m.get('proxyConfiguration') is not None:
            temp_model = main_models.InstallMcpMarketItemRequestBodyDeploymentConfigProxyConfiguration()
            self.proxy_configuration = temp_model.from_map(m.get('proxyConfiguration'))

        if m.get('runtimeConfiguration') is not None:
            temp_model = main_models.InstallMcpMarketItemRequestBodyDeploymentConfigRuntimeConfiguration()
            self.runtime_configuration = temp_model.from_map(m.get('runtimeConfiguration'))

        return self

class InstallMcpMarketItemRequestBodyDeploymentConfigRuntimeConfiguration(DaraModel):
    def __init__(
        self,
        cpu: float = None,
        disk_size: int = None,
...
class InstallMcpMarketItemRequestBodyDeploymentConfigProxyConfiguration(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
    ):
...
class InstallMcpMarketItemRequestBodyDeploymentConfigParameterTransformConfiguration(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
...
class InstallMcpMarketItemRequestBodyDeploymentConfigOssMountConfiguration(DaraModel):
    def __init__(
        self,
        mount_points: List[main_models.InstallMcpMarketItemRequestBodyDeploymentConfigOssMountConfigurationMountPoints] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('mountPoints') is not None:
            for k1 in m.get('mountPoints'):
                temp_model = main_models.InstallMcpMarketItemRequestBodyDeploymentConfigOssMountConfigurationMountPoints()
                self.mount_points.append(temp_model.from_map(k1))

        return self

class InstallMcpMarketItemRequestBodyDeploymentConfigOssMountConfigurationMountPoints(DaraModel):
    def __init__(
        self,
...
class InstallMcpMarketItemRequestBodyDeploymentConfigNetworkConfiguration(DaraModel):
    def __init__(
        self,
...
class InstallMcpMarketItemRequestBodyDeploymentConfigNasConfiguration(DaraModel):
    def __init__(
        self,
        group_id: int = None,
        mount_points: List[main_models.InstallMcpMarketItemRequestBodyDeploymentConfigNasConfigurationMountPoints] = None,
        user_id: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('mountPoints') is not None:
            for k1 in m.get('mountPoints'):
                temp_model = main_models.InstallMcpMarketItemRequestBodyDeploymentConfigNasConfigurationMountPoints()
                self.mount_points.append(temp_model.from_map(k1))
...
class InstallMcpMarketItemRequestBodyDeploymentConfigNasConfigurationMountPoints(DaraModel):
    def __init__(
        self,
...
class InstallMcpMarketItemRequestBodyDeploymentConfigMcpConfiguration(DaraModel):
    def __init__(
        self,
...
class InstallMcpMarketItemRequestBodyDeploymentConfigLogConfiguration(DaraModel):
    def __init__(
        self,
...
class InstallMcpMarketItemRequestBodyDeploymentConfigHookConfiguration(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('hooks') is not None:
            for k1 in m.get('hooks'):
                temp_model = main_models.InstallMcpMarketItemRequestBodyDeploymentConfigHookConfigurationHooks()
                self.hooks.append(temp_model.from_map(k1))

        return self

class InstallMcpMarketItemRequestBodyDeploymentConfigHookConfigurationHooks(DaraModel):
    def __init__(
        self,
...
class InstallMcpMarketItemRequestBodyDeploymentConfigContainerConfiguration(DaraModel):
    def __init__(
        self,
...
class InstallMcpMarketItemRequestBodyDeploymentConfigCodeConfiguration(DaraModel):
    def __init__(
        self,
...
class InstallMcpMarketItemRequestBodyDeploymentConfigAgentIdentityConfiguration(DaraModel):
    def __init__(
        self,
...
class InstallMcpMarketItemRequestBodyDeploymentConfigAccessControl(DaraModel):
    def __init__(
        self,
...
class InstallMcpMarketItemRequestBodyAuth(DaraModel):
    def __init__(
        self,
        direct_proxy: main_models.InstallMcpMarketItemRequestBodyAuthDirectProxy = None,
        enabled: bool = None,
        http_to_mcp: List[main_models.InstallMcpMarketItemRequestBodyAuthHttpToMcp] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('directProxy') is not None:
            temp_model = main_models.InstallMcpMarketItemRequestBodyAuthDirectProxy()
        ...
        if m.get('httpToMcp') is not None:
            for k1 in m.get('httpToMcp'):
                temp_model = main_models.InstallMcpMarketItemRequestBodyAuthHttpToMcp()
                self.http_to_mcp.append(temp_model.from_map(k1))

        return self

class InstallMcpMarketItemRequestBodyAuthHttpToMcp(DaraModel):
    def __init__(
        self,
        credential: str = None,
        id: str = None,
...
class InstallMcpMarketItemRequestBodyAuthDirectProxy(DaraModel):
    def __init__(
        self,
        name: str = None,
        value: str = None,

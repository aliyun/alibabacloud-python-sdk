...
class GetManagedAgentResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetManagedAgentResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.GetManagedAgentResponseBodyData()
...
class GetManagedAgentResponseBodyData(DaraModel):
    def __init__(
        self,
        agent_id: str = None,
        agentic_fs_mounts: List[main_models.GetManagedAgentResponseBodyDataAgenticFsMounts] = None,
        configured_skills: List[main_models.GetManagedAgentResponseBodyDataConfiguredSkills] = None,
        create_mode: str = None,
        created_at: str = None,
        deploy_type: str = None,
        description: str = None,
        environment: main_models.GetManagedAgentResponseBodyDataEnvironment = None,
        harness: main_models.GetManagedAgentResponseBodyDataHarness = None,
        instruction: str = None,
        latest_spec_version: int = None,
        latest_version_status: str = None,
        model: main_models.GetManagedAgentResponseBodyDataModel = None,
        name: str = None,
        network: main_models.GetManagedAgentResponseBodyDataNetwork = None,
        oss_mounts: List[main_models.GetManagedAgentResponseBodyDataOssMounts] = None,
        region_id: str = None,
        runtime: main_models.GetManagedAgentResponseBodyDataRuntime = None,
        sandbox_phase_counts: Dict[str, int] = None,
        skills: List[main_models.GetManagedAgentResponseBodyDataSkills] = None,
        status: str = None,
        sub_agents: List[main_models.GetManagedAgentResponseBodyDataSubAgents] = None,
        template: main_models.GetManagedAgentResponseBodyDataTemplate = None,
        tools: List[main_models.GetManagedAgentResponseBodyDataTools] = None,
        updated_at: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('agenticFsMounts') is not None:
            for k1 in m.get('agenticFsMounts'):
                temp_model = main_models.GetManagedAgentResponseBodyDataAgenticFsMounts()
        ...
        if m.get('configuredSkills') is not None:
            for k1 in m.get('configuredSkills'):
                temp_model = main_models.GetManagedAgentResponseBodyDataConfiguredSkills()
        ...
        if m.get('environment') is not None:
            temp_model = main_models.GetManagedAgentResponseBodyDataEnvironment()
            self.environment = temp_model.from_map(m.get('environment'))

        if m.get('harness') is not None:
            temp_model = main_models.GetManagedAgentResponseBodyDataHarness()
        ...
        if m.get('model') is not None:
            temp_model = main_models.GetManagedAgentResponseBodyDataModel()
        ...
        if m.get('network') is not None:
            temp_model = main_models.GetManagedAgentResponseBodyDataNetwork()
            self.network = temp_model.from_map(m.get('network'))

        self.oss_mounts = []
        if m.get('ossMounts') is not None:
            for k1 in m.get('ossMounts'):
                temp_model = main_models.GetManagedAgentResponseBodyDataOssMounts()
        ...
        if m.get('runtime') is not None:
            temp_model = main_models.GetManagedAgentResponseBodyDataRuntime()
        ...
        if m.get('skills') is not None:
            for k1 in m.get('skills'):
                temp_model = main_models.GetManagedAgentResponseBodyDataSkills()
        ...
        if m.get('subAgents') is not None:
            for k1 in m.get('subAgents'):
                temp_model = main_models.GetManagedAgentResponseBodyDataSubAgents()
                self.sub_agents.append(temp_model.from_map(k1))

        if m.get('template') is not None:
            temp_model = main_models.GetManagedAgentResponseBodyDataTemplate()
            self.template = temp_model.from_map(m.get('template'))

        self.tools = []
        if m.get('tools') is not None:
            for k1 in m.get('tools'):
                temp_model = main_models.GetManagedAgentResponseBodyDataTools()
...
class GetManagedAgentResponseBodyDataTools(DaraModel):
    def __init__(
        self,
        name: str = None,
        type: str = None,
...
class GetManagedAgentResponseBodyDataTemplate(DaraModel):
    def __init__(
        self,
        ai_registry: main_models.GetManagedAgentResponseBodyDataTemplateAiRegistry = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('aiRegistry') is not None:
            temp_model = main_models.GetManagedAgentResponseBodyDataTemplateAiRegistry()
            self.ai_registry = temp_model.from_map(m.get('aiRegistry'))

        return self

class GetManagedAgentResponseBodyDataTemplateAiRegistry(DaraModel):
    def __init__(
        self,
        name: str = None,
        version: str = None,
...
class GetManagedAgentResponseBodyDataSubAgents(DaraModel):
    def __init__(
        self,
        instruction: str = None,
        name: str = None,
        skills: List[main_models.GetManagedAgentResponseBodyDataSubAgentsSkills] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('skills') is not None:
            for k1 in m.get('skills'):
                temp_model = main_models.GetManagedAgentResponseBodyDataSubAgentsSkills()
                self.skills.append(temp_model.from_map(k1))

        return self

class GetManagedAgentResponseBodyDataSubAgentsSkills(DaraModel):
    def __init__(
        self,
        name: str = None,
        version: str = None,
...
class GetManagedAgentResponseBodyDataSkills(DaraModel):
    def __init__(
        self,
        ...
        version: str = None,
        version_selector: main_models.GetManagedAgentResponseBodyDataSkillsVersionSelector = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('versionSelector') is not None:
            temp_model = main_models.GetManagedAgentResponseBodyDataSkillsVersionSelector()
            self.version_selector = temp_model.from_map(m.get('versionSelector'))

        return self

class GetManagedAgentResponseBodyDataSkillsVersionSelector(DaraModel):
    def __init__(
        self,
        type: str = None,
        value: str = None,
...
class GetManagedAgentResponseBodyDataRuntime(DaraModel):
    def __init__(
        self,
        compute: main_models.GetManagedAgentResponseBodyDataRuntimeCompute = None,
        hpa: main_models.GetManagedAgentResponseBodyDataRuntimeHpa = None,
        session_policy: main_models.GetManagedAgentResponseBodyDataRuntimeSessionPolicy = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('compute') is not None:
            temp_model = main_models.GetManagedAgentResponseBodyDataRuntimeCompute()
            self.compute = temp_model.from_map(m.get('compute'))

        if m.get('hpa') is not None:
            temp_model = main_models.GetManagedAgentResponseBodyDataRuntimeHpa()
            self.hpa = temp_model.from_map(m.get('hpa'))

        if m.get('sessionPolicy') is not None:
            temp_model = main_models.GetManagedAgentResponseBodyDataRuntimeSessionPolicy()
            self.session_policy = temp_model.from_map(m.get('sessionPolicy'))

        return self

class GetManagedAgentResponseBodyDataRuntimeSessionPolicy(DaraModel):
    def __init__(
        self,
...
class GetManagedAgentResponseBodyDataRuntimeHpa(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
...
class GetManagedAgentResponseBodyDataRuntimeCompute(DaraModel):
    def __init__(
        self,
...
class GetManagedAgentResponseBodyDataOssMounts(DaraModel):
    def __init__(
        self,
...
class GetManagedAgentResponseBodyDataNetwork(DaraModel):
    def __init__(
        self,
        access_internet: main_models.GetManagedAgentResponseBodyDataNetworkAccessInternet = None,
        access_vpc: main_models.GetManagedAgentResponseBodyDataNetworkAccessVpc = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('accessInternet') is not None:
            temp_model = main_models.GetManagedAgentResponseBodyDataNetworkAccessInternet()
            self.access_internet = temp_model.from_map(m.get('accessInternet'))

        if m.get('accessVpc') is not None:
            temp_model = main_models.GetManagedAgentResponseBodyDataNetworkAccessVpc()
            self.access_vpc = temp_model.from_map(m.get('accessVpc'))

        return self

class GetManagedAgentResponseBodyDataNetworkAccessVpc(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
    ):
...
class GetManagedAgentResponseBodyDataNetworkAccessInternet(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
    ):
...
class GetManagedAgentResponseBodyDataModel(DaraModel):
    def __init__(
        self,
        model_connection_id: str = None,
        model_name: str = None,
        quota: main_models.GetManagedAgentResponseBodyDataModelQuota = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('quota') is not None:
            temp_model = main_models.GetManagedAgentResponseBodyDataModelQuota()
            self.quota = temp_model.from_map(m.get('quota'))

        return self

class GetManagedAgentResponseBodyDataModelQuota(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
        limit_type: str = None,
...
class GetManagedAgentResponseBodyDataHarness(DaraModel):
    def __init__(
        self,
        configuration: main_models.GetManagedAgentResponseBodyDataHarnessConfiguration = None,
        type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('configuration') is not None:
            temp_model = main_models.GetManagedAgentResponseBodyDataHarnessConfiguration()
...
class GetManagedAgentResponseBodyDataHarnessConfiguration(DaraModel):
    def __init__(
        self,
...
class GetManagedAgentResponseBodyDataEnvironment(DaraModel):
    def __init__(
        self,
        credential_references: List[main_models.GetManagedAgentResponseBodyDataEnvironmentCredentialReferences] = None,
        variables: List[main_models.GetManagedAgentResponseBodyDataEnvironmentVariables] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('credentialReferences') is not None:
            for k1 in m.get('credentialReferences'):
                temp_model = main_models.GetManagedAgentResponseBodyDataEnvironmentCredentialReferences()
                self.credential_references.append(temp_model.from_map(k1))

        self.variables = []
        if m.get('variables') is not None:
            for k1 in m.get('variables'):
                temp_model = main_models.GetManagedAgentResponseBodyDataEnvironmentVariables()
                self.variables.append(temp_model.from_map(k1))

        return self

class GetManagedAgentResponseBodyDataEnvironmentVariables(DaraModel):
    def __init__(
        self,
        name: str = None,
        value: str = None,
...
class GetManagedAgentResponseBodyDataEnvironmentCredentialReferences(DaraModel):
    def __init__(
        self,
...
class GetManagedAgentResponseBodyDataConfiguredSkills(DaraModel):
    def __init__(
        self,
        name: str = None,
        source_type: str = None,
        version: str = None,
        version_selector: main_models.GetManagedAgentResponseBodyDataConfiguredSkillsVersionSelector = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('versionSelector') is not None:
            temp_model = main_models.GetManagedAgentResponseBodyDataConfiguredSkillsVersionSelector()
            self.version_selector = temp_model.from_map(m.get('versionSelector'))

        return self

class GetManagedAgentResponseBodyDataConfiguredSkillsVersionSelector(DaraModel):
    def __init__(
        self,
        type: str = None,
        value: str = None,
...
class GetManagedAgentResponseBodyDataAgenticFsMounts(DaraModel):
    def __init__(
        self,
        mount_path: str = None,
        path: str = None,

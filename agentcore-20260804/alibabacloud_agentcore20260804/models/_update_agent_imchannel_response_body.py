...
class UpdateAgentIMChannelResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.UpdateAgentIMChannelResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.UpdateAgentIMChannelResponseBodyData()
...
class UpdateAgentIMChannelResponseBodyData(DaraModel):
    def __init__(
        self,
        agent_id: str = None,
        channel_config: main_models.UpdateAgentIMChannelResponseBodyDataChannelConfig = None,
        channel_type: str = None,
        create_time: str = None,
        credential_summary: main_models.UpdateAgentIMChannelResponseBodyDataCredentialSummary = None,
        enabled: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('channelConfig') is not None:
            temp_model = main_models.UpdateAgentIMChannelResponseBodyDataChannelConfig()
        ...
        if m.get('credentialSummary') is not None:
            temp_model = main_models.UpdateAgentIMChannelResponseBodyDataCredentialSummary()
...
class UpdateAgentIMChannelResponseBodyDataCredentialSummary(DaraModel):
    def __init__(
        self,
...
class UpdateAgentIMChannelResponseBodyDataChannelConfig(DaraModel):
    def __init__(
        self,

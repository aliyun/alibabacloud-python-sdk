...
class GetModelResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetModelResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.GetModelResponseBodyData()
...
class GetModelResponseBodyData(DaraModel):
    def __init__(
        self,
        capabilities: main_models.GetModelResponseBodyDataCapabilities = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('capabilities') is not None:
            temp_model = main_models.GetModelResponseBodyDataCapabilities()
...
class GetModelResponseBodyDataCapabilities(DaraModel):
    def __init__(
        self,
        audio: bool = None,
        document: bool = None,

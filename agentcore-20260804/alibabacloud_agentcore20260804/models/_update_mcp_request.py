...
class UpdateMcpRequest(DaraModel):
    def __init__(
        self,
        body: main_models.UpdateMcpRequestBody = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('body') is not None:
            temp_model = main_models.UpdateMcpRequestBody()
...
class UpdateMcpRequestBody(DaraModel):
    def __init__(
        self,
        addresses: List[str] = None,
        auth: main_models.UpdateMcpRequestBodyAuth = None,
        custom_tags: List[str] = None,
        deployment_config: main_models.UpdateMcpRequestBodyDeploymentConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('auth') is not None:
            temp_model = main_models.UpdateMcpRequestBodyAuth()
        ...
        if m.get('deploymentConfig') is not None:
            temp_model = main_models.UpdateMcpRequestBodyDeploymentConfig()
...
class UpdateMcpRequestBodyDeploymentConfig(DaraModel):
    def __init__(
        self,
        access_control: main_models.UpdateMcpRequestBodyDeploymentConfigAccessControl = None,
        agent_identity_configuration: main_models.UpdateMcpRequestBodyDeploymentConfigAgentIdentityConfiguration = None,
        artifact_type: str = None,
        code_configuration: main_models.UpdateMcpRequestBodyDeploymentConfigCodeConfiguration = None,
        container_configuration: main_models.UpdateMcpRequestBodyDeploymentConfigContainerConfiguration = None,
        hook_configuration: main_models.UpdateMcpRequestBodyDeploymentConfigHookConfiguration = None,
        log_configuration: main_models.UpdateMcpRequestBodyDeploymentConfigLogConfiguration = None,
        mcp_configuration: main_models.UpdateMcpRequestBodyDeploymentConfigMcpConfiguration = None,
        nas_configuration: main_models.UpdateMcpRequestBodyDeploymentConfigNasConfiguration = None,
        network_configuration: main_models.UpdateMcpRequestBodyDeploymentConfigNetworkConfiguration = None,
        oss_mount_configuration: main_models.UpdateMcpRequestBodyDeploymentConfigOssMountConfiguration = None,
        parameter_transform_configuration: main_models.UpdateMcpRequestBodyDeploymentConfigParameterTransformConfiguration = None,
        proxy_configuration: main_models.UpdateMcpRequestBodyDeploymentConfigProxyConfiguration = None,
        runtime_configuration: main_models.UpdateMcpRequestBodyDeploymentConfigRuntimeConfiguration = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('accessControl') is not None:
            temp_model = main_models.UpdateMcpRequestBodyDeploymentConfigAccessControl()
            self.access_control = temp_model.from_map(m.get('accessControl'))

        if m.get('agentIdentityConfiguration') is not None:
            temp_model = main_models.UpdateMcpRequestBodyDeploymentConfigAgentIdentityConfiguration()
        ...
        if m.get('parameterTransformConfiguration') is not None:
            temp_model = main_models.UpdateMcpRequestBodyDeploymentConfigParameterTransformConfiguration()
        ...
        if m.get('proxyConfiguration') is not None:
            temp_model = main_models.UpdateMcpRequestBodyDeploymentConfigProxyConfiguration()
            self.proxy_configuration = temp_model.from_map(m.get('proxyConfiguration'))

        if m.get('runtimeConfiguration') is not None:
            temp_model = main_models.UpdateMcpRequestBodyDeploymentConfigRuntimeConfiguration()
            self.runtime_configuration = temp_model.from_map(m.get('runtimeConfiguration'))

        return self

class UpdateMcpRequestBodyDeploymentConfigRuntimeConfiguration(DaraModel):
    def __init__(
        self,
        cpu: float = None,
        disk_size: int = None,
...
class UpdateMcpRequestBodyDeploymentConfigProxyConfiguration(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
    ):
...
class UpdateMcpRequestBodyDeploymentConfigParameterTransformConfiguration(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
...
class UpdateMcpRequestBodyDeploymentConfigOssMountConfiguration(DaraModel):
    def __init__(
        self,
        mount_points: List[main_models.UpdateMcpRequestBodyDeploymentConfigOssMountConfigurationMountPoints] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('mountPoints') is not None:
            for k1 in m.get('mountPoints'):
                temp_model = main_models.UpdateMcpRequestBodyDeploymentConfigOssMountConfigurationMountPoints()
                self.mount_points.append(temp_model.from_map(k1))

        return self

class UpdateMcpRequestBodyDeploymentConfigOssMountConfigurationMountPoints(DaraModel):
    def __init__(
        self,
...
class UpdateMcpRequestBodyDeploymentConfigNetworkConfiguration(DaraModel):
    def __init__(
        self,
...
class UpdateMcpRequestBodyDeploymentConfigNasConfiguration(DaraModel):
    def __init__(
        self,
        group_id: int = None,
        mount_points: List[main_models.UpdateMcpRequestBodyDeploymentConfigNasConfigurationMountPoints] = None,
        user_id: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('mountPoints') is not None:
            for k1 in m.get('mountPoints'):
                temp_model = main_models.UpdateMcpRequestBodyDeploymentConfigNasConfigurationMountPoints()
                self.mount_points.append(temp_model.from_map(k1))
...
class UpdateMcpRequestBodyDeploymentConfigNasConfigurationMountPoints(DaraModel):
    def __init__(
        self,
...
class UpdateMcpRequestBodyDeploymentConfigMcpConfiguration(DaraModel):
    def __init__(
        self,
...
class UpdateMcpRequestBodyDeploymentConfigLogConfiguration(DaraModel):
    def __init__(
        self,
...
class UpdateMcpRequestBodyDeploymentConfigHookConfiguration(DaraModel):
    def __init__(
        self,
        hooks: List[main_models.UpdateMcpRequestBodyDeploymentConfigHookConfigurationHooks] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('hooks') is not None:
            for k1 in m.get('hooks'):
                temp_model = main_models.UpdateMcpRequestBodyDeploymentConfigHookConfigurationHooks()
                self.hooks.append(temp_model.from_map(k1))

        return self

class UpdateMcpRequestBodyDeploymentConfigHookConfigurationHooks(DaraModel):
    def __init__(
        self,
...
class UpdateMcpRequestBodyDeploymentConfigContainerConfiguration(DaraModel):
    def __init__(
        self,
...
class UpdateMcpRequestBodyDeploymentConfigCodeConfiguration(DaraModel):
    def __init__(
        self,
...
class UpdateMcpRequestBodyDeploymentConfigAgentIdentityConfiguration(DaraModel):
    def __init__(
        self,
...
class UpdateMcpRequestBodyDeploymentConfigAccessControl(DaraModel):
    def __init__(
        self,
...
class UpdateMcpRequestBodyAuth(DaraModel):
    def __init__(
        self,
        code_package: main_models.UpdateMcpRequestBodyAuthCodePackage = None,
        direct_proxy: main_models.UpdateMcpRequestBodyAuthDirectProxy = None,
        enabled: bool = None,
        http_to_mcp: List[main_models.UpdateMcpRequestBodyAuthHttpToMcp] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('codePackage') is not None:
            temp_model = main_models.UpdateMcpRequestBodyAuthCodePackage()
            self.code_package = temp_model.from_map(m.get('codePackage'))

        if m.get('directProxy') is not None:
            temp_model = main_models.UpdateMcpRequestBodyAuthDirectProxy()
        ...
        if m.get('httpToMcp') is not None:
            for k1 in m.get('httpToMcp'):
                temp_model = main_models.UpdateMcpRequestBodyAuthHttpToMcp()
                self.http_to_mcp.append(temp_model.from_map(k1))

        return self

class UpdateMcpRequestBodyAuthHttpToMcp(DaraModel):
    def __init__(
        self,
        credential: str = None,
        id: str = None,
...
class UpdateMcpRequestBodyAuthDirectProxy(DaraModel):
    def __init__(
        self,
        name: str = None,
        value: str = None,
...
class UpdateMcpRequestBodyAuthCodePackage(DaraModel):
    def __init__(
        self,
        api_key: str = None,

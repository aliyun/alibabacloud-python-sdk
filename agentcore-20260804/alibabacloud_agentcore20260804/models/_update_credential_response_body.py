...
class UpdateCredentialResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.UpdateCredentialResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.UpdateCredentialResponseBodyData()
...
class UpdateCredentialResponseBodyData(DaraModel):
    def __init__(
        self,
        created_at: str = None,
        ...
        name: str = None,
        region_id: str = None,
        resource_refs: List[main_models.UpdateCredentialResponseBodyDataResourceRefs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('resourceRefs') is not None:
            for k1 in m.get('resourceRefs'):
                temp_model = main_models.UpdateCredentialResponseBodyDataResourceRefs()
...
class UpdateCredentialResponseBodyDataResourceRefs(DaraModel):
    def __init__(
        self,

...
class GetAgentSpecImportFileUrlResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.GetAgentSpecImportFileUrlResponseBodyData = None,
        request_id: str = None,
    ):
        # The response data.
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.GetAgentSpecImportFileUrlResponseBodyData()
...
class GetAgentSpecImportFileUrlResponseBodyData(DaraModel):
    def __init__(
        self,

...
class GetAgentSpecLatestResponseBodyDataSkills(DaraModel):
    def __init__(
        ...
        version_selector: main_models.GetAgentSpecLatestResponseBodyDataSkillsVersionSelector = None,
    ):
        # The name.
        self.name = name
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('versionSelector') is not None:
            temp_model = main_models.GetAgentSpecLatestResponseBodyDataSkillsVersionSelector()
            self.version_selector = temp_model.from_map(m.get('versionSelector'))

        return self

class GetAgentSpecLatestResponseBodyDataSkillsVersionSelector(DaraModel):
    def __init__(
        self,
        type: str = None,
        value: str = None,

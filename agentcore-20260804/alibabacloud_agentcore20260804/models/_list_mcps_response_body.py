...
class ListMcpsResponseBodyItems(DaraModel):
    def __init__(
        ...
        deployment_config: main_models.ListMcpsResponseBodyItemsDeploymentConfig = None,
        description: str = None,
        endpoint: str = None,
        function_name: str = None,
        market_source: main_models.ListMcpsResponseBodyItemsMarketSource = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('deploymentConfig') is not None:
            temp_model = main_models.ListMcpsResponseBodyItemsDeploymentConfig()
        ...
        if m.get('marketSource') is not None:
            temp_model = main_models.ListMcpsResponseBodyItemsMarketSource()
...
class ListMcpsResponseBodyItemsMarketSource(DaraModel):
    def __init__(
        self,
...
class ListMcpsResponseBodyItemsDeploymentConfig(DaraModel):
    def __init__(
        self,
        access_control: main_models.ListMcpsResponseBodyItemsDeploymentConfigAccessControl = None,
        agent_identity_configuration: main_models.ListMcpsResponseBodyItemsDeploymentConfigAgentIdentityConfiguration = None,
        artifact_type: str = None,
        code_configuration: main_models.ListMcpsResponseBodyItemsDeploymentConfigCodeConfiguration = None,
        container_configuration: main_models.ListMcpsResponseBodyItemsDeploymentConfigContainerConfiguration = None,
        hook_configuration: main_models.ListMcpsResponseBodyItemsDeploymentConfigHookConfiguration = None,
        log_configuration: main_models.ListMcpsResponseBodyItemsDeploymentConfigLogConfiguration = None,
        mcp_configuration: main_models.ListMcpsResponseBodyItemsDeploymentConfigMcpConfiguration = None,
        nas_configuration: main_models.ListMcpsResponseBodyItemsDeploymentConfigNasConfiguration = None,
        network_configuration: main_models.ListMcpsResponseBodyItemsDeploymentConfigNetworkConfiguration = None,
        oss_mount_configuration: main_models.ListMcpsResponseBodyItemsDeploymentConfigOssMountConfiguration = None,
        parameter_transform_configuration: main_models.ListMcpsResponseBodyItemsDeploymentConfigParameterTransformConfiguration = None,
        proxy_configuration: main_models.ListMcpsResponseBodyItemsDeploymentConfigProxyConfiguration = None,
        runtime_configuration: main_models.ListMcpsResponseBodyItemsDeploymentConfigRuntimeConfiguration = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('accessControl') is not None:
            temp_model = main_models.ListMcpsResponseBodyItemsDeploymentConfigAccessControl()
            self.access_control = temp_model.from_map(m.get('accessControl'))

        if m.get('agentIdentityConfiguration') is not None:
            temp_model = main_models.ListMcpsResponseBodyItemsDeploymentConfigAgentIdentityConfiguration()
        ...
        if m.get('parameterTransformConfiguration') is not None:
            temp_model = main_models.ListMcpsResponseBodyItemsDeploymentConfigParameterTransformConfiguration()
        ...
        if m.get('proxyConfiguration') is not None:
            temp_model = main_models.ListMcpsResponseBodyItemsDeploymentConfigProxyConfiguration()
            self.proxy_configuration = temp_model.from_map(m.get('proxyConfiguration'))

        if m.get('runtimeConfiguration') is not None:
            temp_model = main_models.ListMcpsResponseBodyItemsDeploymentConfigRuntimeConfiguration()
            self.runtime_configuration = temp_model.from_map(m.get('runtimeConfiguration'))

        return self

class ListMcpsResponseBodyItemsDeploymentConfigRuntimeConfiguration(DaraModel):
    def __init__(
        self,
        cpu: float = None,
        disk_size: int = None,
...
class ListMcpsResponseBodyItemsDeploymentConfigProxyConfiguration(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
    ):
...
class ListMcpsResponseBodyItemsDeploymentConfigParameterTransformConfiguration(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
...
class ListMcpsResponseBodyItemsDeploymentConfigOssMountConfiguration(DaraModel):
    def __init__(
        self,
        mount_points: List[main_models.ListMcpsResponseBodyItemsDeploymentConfigOssMountConfigurationMountPoints] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('mountPoints') is not None:
            for k1 in m.get('mountPoints'):
                temp_model = main_models.ListMcpsResponseBodyItemsDeploymentConfigOssMountConfigurationMountPoints()
                self.mount_points.append(temp_model.from_map(k1))

        return self

class ListMcpsResponseBodyItemsDeploymentConfigOssMountConfigurationMountPoints(DaraModel):
    def __init__(
        self,
...
class ListMcpsResponseBodyItemsDeploymentConfigNetworkConfiguration(DaraModel):
    def __init__(
        self,
...
class ListMcpsResponseBodyItemsDeploymentConfigNasConfiguration(DaraModel):
    def __init__(
        self,
        group_id: int = None,
        mount_points: List[main_models.ListMcpsResponseBodyItemsDeploymentConfigNasConfigurationMountPoints] = None,
        user_id: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('mountPoints') is not None:
            for k1 in m.get('mountPoints'):
                temp_model = main_models.ListMcpsResponseBodyItemsDeploymentConfigNasConfigurationMountPoints()
                self.mount_points.append(temp_model.from_map(k1))
...
class ListMcpsResponseBodyItemsDeploymentConfigNasConfigurationMountPoints(DaraModel):
    def __init__(
        self,
...
class ListMcpsResponseBodyItemsDeploymentConfigMcpConfiguration(DaraModel):
    def __init__(
        self,
...
class ListMcpsResponseBodyItemsDeploymentConfigLogConfiguration(DaraModel):
    def __init__(
        self,
...
class ListMcpsResponseBodyItemsDeploymentConfigHookConfiguration(DaraModel):
    def __init__(
        self,
        hooks: List[main_models.ListMcpsResponseBodyItemsDeploymentConfigHookConfigurationHooks] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('hooks') is not None:
            for k1 in m.get('hooks'):
                temp_model = main_models.ListMcpsResponseBodyItemsDeploymentConfigHookConfigurationHooks()
                self.hooks.append(temp_model.from_map(k1))

        return self

class ListMcpsResponseBodyItemsDeploymentConfigHookConfigurationHooks(DaraModel):
    def __init__(
        self,
...
class ListMcpsResponseBodyItemsDeploymentConfigContainerConfiguration(DaraModel):
    def __init__(
        self,
...
class ListMcpsResponseBodyItemsDeploymentConfigCodeConfiguration(DaraModel):
    def __init__(
        self,
...
class ListMcpsResponseBodyItemsDeploymentConfigAgentIdentityConfiguration(DaraModel):
    def __init__(
        self,
...
class ListMcpsResponseBodyItemsDeploymentConfigAccessControl(DaraModel):
    def __init__(
        self,
...
class ListMcpsResponseBodyItemsAuth(DaraModel):
    def __init__(
        self,
        code_package: main_models.ListMcpsResponseBodyItemsAuthCodePackage = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('codePackage') is not None:
            temp_model = main_models.ListMcpsResponseBodyItemsAuthCodePackage()
...
class ListMcpsResponseBodyItemsAuthCodePackage(DaraModel):
    def __init__(
        self,
        api_key: str = None,

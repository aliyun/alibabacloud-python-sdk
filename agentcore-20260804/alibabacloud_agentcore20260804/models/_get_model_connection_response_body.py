...
class GetModelConnectionResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetModelConnectionResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.GetModelConnectionResponseBodyData()
...
class GetModelConnectionResponseBodyData(DaraModel):
    def __init__(
        self,

...
class ListPredefinedModelsResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: List[main_models.ListPredefinedModelsResponseBodyData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            for k1 in m.get('data'):
                temp_model = main_models.ListPredefinedModelsResponseBodyData()
...
class ListPredefinedModelsResponseBodyData(DaraModel):
    def __init__(
        self,
        capabilities: main_models.ListPredefinedModelsResponseBodyDataCapabilities = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('capabilities') is not None:
            temp_model = main_models.ListPredefinedModelsResponseBodyDataCapabilities()
...
class ListPredefinedModelsResponseBodyDataCapabilities(DaraModel):
    def __init__(
        self,
        audio: bool = None,
        document: bool = None,

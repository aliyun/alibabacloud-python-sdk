...
class ConvertMcpToFreeEditResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.ConvertMcpToFreeEditResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.ConvertMcpToFreeEditResponseBodyData()
...
class ConvertMcpToFreeEditResponseBodyData(DaraModel):
    def __init__(
        self,
        addresses: List[str] = None,
        custom_tags: List[str] = None,
        deployment_config: main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfig = None,
        description: str = None,
        endpoint: str = None,
        function_name: str = None,
        market_source: main_models.ConvertMcpToFreeEditResponseBodyDataMarketSource = None,
        ...
        template: main_models.ConvertMcpToFreeEditResponseBodyDataTemplate = None,
        type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('deploymentConfig') is not None:
            temp_model = main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfig()
        ...
        if m.get('marketSource') is not None:
            temp_model = main_models.ConvertMcpToFreeEditResponseBodyDataMarketSource()
        ...
        if m.get('template') is not None:
            temp_model = main_models.ConvertMcpToFreeEditResponseBodyDataTemplate()
...
class ConvertMcpToFreeEditResponseBodyDataTemplate(DaraModel):
    def __init__(
        self,
...
class ConvertMcpToFreeEditResponseBodyDataMarketSource(DaraModel):
    def __init__(
        self,
...
class ConvertMcpToFreeEditResponseBodyDataDeploymentConfig(DaraModel):
    def __init__(
        self,
        access_control: main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigAccessControl = None,
        agent_identity_configuration: main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigAgentIdentityConfiguration = None,
        artifact_type: str = None,
        code_configuration: main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigCodeConfiguration = None,
        container_configuration: main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigContainerConfiguration = None,
        hook_configuration: main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigHookConfiguration = None,
        log_configuration: main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigLogConfiguration = None,
        mcp_configuration: main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigMcpConfiguration = None,
        nas_configuration: main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigNasConfiguration = None,
        network_configuration: main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigNetworkConfiguration = None,
        oss_mount_configuration: main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigOssMountConfiguration = None,
        parameter_transform_configuration: main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigParameterTransformConfiguration = None,
        proxy_configuration: main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigProxyConfiguration = None,
        runtime_configuration: main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigRuntimeConfiguration = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('accessControl') is not None:
            temp_model = main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigAccessControl()
            self.access_control = temp_model.from_map(m.get('accessControl'))

        if m.get('agentIdentityConfiguration') is not None:
            temp_model = main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigAgentIdentityConfiguration()
        ...
        if m.get('parameterTransformConfiguration') is not None:
            temp_model = main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigParameterTransformConfiguration()
        ...
        if m.get('proxyConfiguration') is not None:
            temp_model = main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigProxyConfiguration()
            self.proxy_configuration = temp_model.from_map(m.get('proxyConfiguration'))

        if m.get('runtimeConfiguration') is not None:
            temp_model = main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigRuntimeConfiguration()
            self.runtime_configuration = temp_model.from_map(m.get('runtimeConfiguration'))

        return self

class ConvertMcpToFreeEditResponseBodyDataDeploymentConfigRuntimeConfiguration(DaraModel):
    def __init__(
        self,
        cpu: float = None,
        disk_size: int = None,
...
class ConvertMcpToFreeEditResponseBodyDataDeploymentConfigProxyConfiguration(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
    ):
...
class ConvertMcpToFreeEditResponseBodyDataDeploymentConfigParameterTransformConfiguration(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
...
class ConvertMcpToFreeEditResponseBodyDataDeploymentConfigOssMountConfiguration(DaraModel):
    def __init__(
        self,
        mount_points: List[main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigOssMountConfigurationMountPoints] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('mountPoints') is not None:
            for k1 in m.get('mountPoints'):
                temp_model = main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigOssMountConfigurationMountPoints()
                self.mount_points.append(temp_model.from_map(k1))

        return self

class ConvertMcpToFreeEditResponseBodyDataDeploymentConfigOssMountConfigurationMountPoints(DaraModel):
    def __init__(
        self,
...
class ConvertMcpToFreeEditResponseBodyDataDeploymentConfigNetworkConfiguration(DaraModel):
    def __init__(
        self,
...
class ConvertMcpToFreeEditResponseBodyDataDeploymentConfigNasConfiguration(DaraModel):
    def __init__(
        self,
        group_id: int = None,
        mount_points: List[main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigNasConfigurationMountPoints] = None,
        user_id: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('mountPoints') is not None:
            for k1 in m.get('mountPoints'):
                temp_model = main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigNasConfigurationMountPoints()
                self.mount_points.append(temp_model.from_map(k1))
...
class ConvertMcpToFreeEditResponseBodyDataDeploymentConfigNasConfigurationMountPoints(DaraModel):
    def __init__(
        self,
...
class ConvertMcpToFreeEditResponseBodyDataDeploymentConfigMcpConfiguration(DaraModel):
    def __init__(
        self,
...
class ConvertMcpToFreeEditResponseBodyDataDeploymentConfigLogConfiguration(DaraModel):
    def __init__(
        self,
...
class ConvertMcpToFreeEditResponseBodyDataDeploymentConfigHookConfiguration(DaraModel):
    def __init__(
        self,
        hooks: List[main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigHookConfigurationHooks] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('hooks') is not None:
            for k1 in m.get('hooks'):
                temp_model = main_models.ConvertMcpToFreeEditResponseBodyDataDeploymentConfigHookConfigurationHooks()
                self.hooks.append(temp_model.from_map(k1))

        return self

class ConvertMcpToFreeEditResponseBodyDataDeploymentConfigHookConfigurationHooks(DaraModel):
    def __init__(
        self,
...
class ConvertMcpToFreeEditResponseBodyDataDeploymentConfigContainerConfiguration(DaraModel):
    def __init__(
        self,
...
class ConvertMcpToFreeEditResponseBodyDataDeploymentConfigCodeConfiguration(DaraModel):
    def __init__(
        self,
...
class ConvertMcpToFreeEditResponseBodyDataDeploymentConfigAgentIdentityConfiguration(DaraModel):
    def __init__(
        self,
...
class ConvertMcpToFreeEditResponseBodyDataDeploymentConfigAccessControl(DaraModel):
    def __init__(
        self,

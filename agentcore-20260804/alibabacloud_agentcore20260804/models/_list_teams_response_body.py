...
class ListTeamsResponseBodyItems(DaraModel):
    def __init__(
        self,
        agents: List[main_models.ListTeamsResponseBodyItemsAgents] = None,
        created_at: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('agents') is not None:
            for k1 in m.get('agents'):
                temp_model = main_models.ListTeamsResponseBodyItemsAgents()
        ...
        if m.get('users') is not None:
            for k1 in m.get('users'):
                temp_model = main_models.ListTeamsResponseBodyItemsUsers()
...
class ListTeamsResponseBodyItemsUsers(DaraModel):
    def __init__(
        self,
        team_role: str = None,
        user_id: str = None,
...
class ListTeamsResponseBodyItemsAgents(DaraModel):
    def __init__(
        self,
        agent_id: str = None,
        agent_name: str = None,

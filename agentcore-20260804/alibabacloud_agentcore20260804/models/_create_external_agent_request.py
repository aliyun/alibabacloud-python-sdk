...
class CreateExternalAgentRequest(DaraModel):
    def __init__(
        self,
        body: main_models.CreateExternalAgentRequestBody = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('body') is not None:
            temp_model = main_models.CreateExternalAgentRequestBody()
...
class CreateExternalAgentRequestBody(DaraModel):
    def __init__(
        self,
        description: str = None,
        instruction: str = None,
        model: main_models.CreateExternalAgentRequestBodyModel = None,
        model_source: str = None,
        name: str = None,
        skills: List[main_models.CreateExternalAgentRequestBodySkills] = None,
        template: main_models.CreateExternalAgentRequestBodyTemplate = None,
        tools: List[main_models.CreateExternalAgentRequestBodyTools] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('model') is not None:
            temp_model = main_models.CreateExternalAgentRequestBodyModel()
        ...
        if m.get('skills') is not None:
            for k1 in m.get('skills'):
                temp_model = main_models.CreateExternalAgentRequestBodySkills()
                self.skills.append(temp_model.from_map(k1))

        if m.get('template') is not None:
            temp_model = main_models.CreateExternalAgentRequestBodyTemplate()
            self.template = temp_model.from_map(m.get('template'))

        self.tools = []
        if m.get('tools') is not None:
            for k1 in m.get('tools'):
                temp_model = main_models.CreateExternalAgentRequestBodyTools()
                self.tools.append(temp_model.from_map(k1))

        return self

class CreateExternalAgentRequestBodyTools(DaraModel):
    def __init__(
        self,
        name: str = None,
        type: str = None,
...
class CreateExternalAgentRequestBodyTemplate(DaraModel):
    def __init__(
        self,
        ai_registry: main_models.CreateExternalAgentRequestBodyTemplateAiRegistry = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('aiRegistry') is not None:
            temp_model = main_models.CreateExternalAgentRequestBodyTemplateAiRegistry()
            self.ai_registry = temp_model.from_map(m.get('aiRegistry'))

        return self

class CreateExternalAgentRequestBodyTemplateAiRegistry(DaraModel):
    def __init__(
        self,
        name: str = None,
        version: str = None,
...
class CreateExternalAgentRequestBodySkills(DaraModel):
    def __init__(
        self,
        name: str = None,
        version: str = None,
...
class CreateExternalAgentRequestBodyModel(DaraModel):
    def __init__(
        self,

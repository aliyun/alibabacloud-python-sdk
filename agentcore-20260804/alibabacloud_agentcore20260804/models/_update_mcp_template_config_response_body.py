...
class UpdateMcpTemplateConfigResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.UpdateMcpTemplateConfigResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.UpdateMcpTemplateConfigResponseBodyData()
...
class UpdateMcpTemplateConfigResponseBodyData(DaraModel):
    def __init__(
        self,
        addresses: List[str] = None,
        custom_tags: List[str] = None,
        deployment_config: main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfig = None,
        description: str = None,
        endpoint: str = None,
        function_name: str = None,
        market_source: main_models.UpdateMcpTemplateConfigResponseBodyDataMarketSource = None,
        ...
        template: main_models.UpdateMcpTemplateConfigResponseBodyDataTemplate = None,
        type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('deploymentConfig') is not None:
            temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfig()
        ...
        if m.get('marketSource') is not None:
            temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataMarketSource()
        ...
        if m.get('template') is not None:
            temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataTemplate()
...
class UpdateMcpTemplateConfigResponseBodyDataTemplate(DaraModel):
    def __init__(
        self,
...
class UpdateMcpTemplateConfigResponseBodyDataMarketSource(DaraModel):
    def __init__(
        self,
...
class UpdateMcpTemplateConfigResponseBodyDataDeploymentConfig(DaraModel):
    def __init__(
        self,
        access_control: main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigAccessControl = None,
        agent_identity_configuration: main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigAgentIdentityConfiguration = None,
        artifact_type: str = None,
        code_configuration: main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigCodeConfiguration = None,
        container_configuration: main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigContainerConfiguration = None,
        hook_configuration: main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigHookConfiguration = None,
        log_configuration: main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigLogConfiguration = None,
        mcp_configuration: main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigMcpConfiguration = None,
        nas_configuration: main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigNasConfiguration = None,
        network_configuration: main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigNetworkConfiguration = None,
        oss_mount_configuration: main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigOssMountConfiguration = None,
        parameter_transform_configuration: main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigParameterTransformConfiguration = None,
        proxy_configuration: main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigProxyConfiguration = None,
        runtime_configuration: main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigRuntimeConfiguration = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('accessControl') is not None:
            temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigAccessControl()
            self.access_control = temp_model.from_map(m.get('accessControl'))

        if m.get('agentIdentityConfiguration') is not None:
            temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigAgentIdentityConfiguration()
        ...
        if m.get('codeConfiguration') is not None:
            temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigCodeConfiguration()
            self.code_configuration = temp_model.from_map(m.get('codeConfiguration'))

        if m.get('containerConfiguration') is not None:
            temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigContainerConfiguration()
            self.container_configuration = temp_model.from_map(m.get('containerConfiguration'))

        if m.get('hookConfiguration') is not None:
            temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigHookConfiguration()
            self.hook_configuration = temp_model.from_map(m.get('hookConfiguration'))

        if m.get('logConfiguration') is not None:
            temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigLogConfiguration()
            self.log_configuration = temp_model.from_map(m.get('logConfiguration'))

        if m.get('mcpConfiguration') is not None:
            temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigMcpConfiguration()
            self.mcp_configuration = temp_model.from_map(m.get('mcpConfiguration'))

        if m.get('nasConfiguration') is not None:
            temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigNasConfiguration()
            self.nas_configuration = temp_model.from_map(m.get('nasConfiguration'))

        if m.get('networkConfiguration') is not None:
            temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigNetworkConfiguration()
            self.network_configuration = temp_model.from_map(m.get('networkConfiguration'))

        if m.get('ossMountConfiguration') is not None:
            temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigOssMountConfiguration()
        ...
        if m.get('parameterTransformConfiguration') is not None:
            temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigParameterTransformConfiguration()
        ...
        if m.get('proxyConfiguration') is not None:
            temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigProxyConfiguration()
            self.proxy_configuration = temp_model.from_map(m.get('proxyConfiguration'))

        if m.get('runtimeConfiguration') is not None:
            temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigRuntimeConfiguration()
            self.runtime_configuration = temp_model.from_map(m.get('runtimeConfiguration'))

        return self

class UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigRuntimeConfiguration(DaraModel):
    def __init__(
        self,
        cpu: float = None,
        disk_size: int = None,
...
class UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigProxyConfiguration(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
    ):
...
class UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigParameterTransformConfiguration(DaraModel):
    def __init__(
        self,
        enabled: bool = None,
...
class UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigOssMountConfiguration(DaraModel):
    def __init__(
        self,
        mount_points: List[main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigOssMountConfigurationMountPoints] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('mountPoints') is not None:
            for k1 in m.get('mountPoints'):
                temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigOssMountConfigurationMountPoints()
                self.mount_points.append(temp_model.from_map(k1))

        return self

class UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigOssMountConfigurationMountPoints(DaraModel):
    def __init__(
        self,
...
class UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigNetworkConfiguration(DaraModel):
    def __init__(
        self,
...
class UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigNasConfiguration(DaraModel):
    def __init__(
        self,
        group_id: int = None,
        mount_points: List[main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigNasConfigurationMountPoints] = None,
        user_id: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('mountPoints') is not None:
            for k1 in m.get('mountPoints'):
                temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigNasConfigurationMountPoints()
                self.mount_points.append(temp_model.from_map(k1))
...
class UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigNasConfigurationMountPoints(DaraModel):
    def __init__(
        self,
...
class UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigMcpConfiguration(DaraModel):
    def __init__(
        self,
...
class UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigLogConfiguration(DaraModel):
    def __init__(
        self,
...
class UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigHookConfiguration(DaraModel):
    def __init__(
        self,
        hooks: List[main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigHookConfigurationHooks] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('hooks') is not None:
            for k1 in m.get('hooks'):
                temp_model = main_models.UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigHookConfigurationHooks()
                self.hooks.append(temp_model.from_map(k1))

        return self

class UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigHookConfigurationHooks(DaraModel):
    def __init__(
        self,
...
class UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigContainerConfiguration(DaraModel):
    def __init__(
        self,
...
class UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigCodeConfiguration(DaraModel):
    def __init__(
        self,
...
class UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigAgentIdentityConfiguration(DaraModel):
    def __init__(
        self,
...
class UpdateMcpTemplateConfigResponseBodyDataDeploymentConfigAccessControl(DaraModel):
    def __init__(
        self,

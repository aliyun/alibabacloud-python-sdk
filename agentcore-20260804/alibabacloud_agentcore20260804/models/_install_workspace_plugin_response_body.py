...
class InstallWorkspacePluginResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.InstallWorkspacePluginResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.InstallWorkspacePluginResponseBodyData()
...
class InstallWorkspacePluginResponseBodyData(DaraModel):
    def __init__(
        self,
        enabled: bool = None,

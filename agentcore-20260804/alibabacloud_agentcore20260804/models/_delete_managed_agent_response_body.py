...
class DeleteManagedAgentResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.DeleteManagedAgentResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.DeleteManagedAgentResponseBodyData()
...
class DeleteManagedAgentResponseBodyData(DaraModel):
    def __init__(
        self,
        agent_id: str = None,

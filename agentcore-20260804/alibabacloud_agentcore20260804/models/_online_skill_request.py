...
class OnlineSkillRequest(DaraModel):
    def __init__(
        self,
        body: main_models.OnlineSkillRequestBody = None,
    ):
        # The request body.
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('body') is not None:
            temp_model = main_models.OnlineSkillRequestBody()
            self.body = temp_model.from_map(m.get('body'))

        return self

class OnlineSkillRequestBody(DaraModel):
    def __init__(
        self,
        scope: str = None,

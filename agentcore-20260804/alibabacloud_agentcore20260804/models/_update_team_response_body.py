...
class UpdateTeamResponseBodyData(DaraModel):
    def __init__(
        self,
        agents: List[main_models.UpdateTeamResponseBodyDataAgents] = None,
        created_at: str = None,
        ...
        team_id: str = None,
        updated_at: str = None,
        users: List[main_models.UpdateTeamResponseBodyDataUsers] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('agents') is not None:
            for k1 in m.get('agents'):
                temp_model = main_models.UpdateTeamResponseBodyDataAgents()
        ...
        if m.get('users') is not None:
            for k1 in m.get('users'):
                temp_model = main_models.UpdateTeamResponseBodyDataUsers()
...
class UpdateTeamResponseBodyDataUsers(DaraModel):
    def __init__(
        self,
        team_role: str = None,
        user_id: str = None,
...
class UpdateTeamResponseBodyDataAgents(DaraModel):
    def __init__(
        self,
        agent_id: str = None,
        team_role: str = None,

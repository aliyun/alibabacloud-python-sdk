...
class EnableConnectorResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.EnableConnectorResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.EnableConnectorResponseBodyData()
...
class EnableConnectorResponseBodyData(DaraModel):
    def __init__(
        self,

...
class UpdateServiceInstanceSpecRequest(DaraModel):
    def __init__(
        ...
        commodity: main_models.UpdateServiceInstanceSpecRequestCommodity = None,
        dry_run: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Commodity') is not None:
            temp_model = main_models.UpdateServiceInstanceSpecRequestCommodity()
...
class UpdateServiceInstanceSpecRequestCommodity(DaraModel):
    def __init__(
        self,
        auto_pay: bool = None,
    ):

...
class GetUserInformationResponseBody(DaraModel):
    def __init__(
        self,
        delivery_settings: main_models.GetUserInformationResponseBodyDeliverySettings = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DeliverySettings') is not None:
            temp_model = main_models.GetUserInformationResponseBodyDeliverySettings()
...
class GetUserInformationResponseBodyDeliverySettings(DaraModel):
    def __init__(
        self,

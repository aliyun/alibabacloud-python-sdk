...
class CreateServiceInstanceRequest(DaraModel):
    def __init__(
        self,
        client_token: str = None,
        commodity: main_models.CreateServiceInstanceRequestCommodity = None,
        contact_group: str = None,
        dry_run: bool = None,
        enable_instance_ops: bool = None,
        enable_user_prometheus: bool = None,
        name: str = None,
        operation_metadata: main_models.CreateServiceInstanceRequestOperationMetadata = None,
        ...
        tag: List[main_models.CreateServiceInstanceRequestTag] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Commodity') is not None:
            temp_model = main_models.CreateServiceInstanceRequestCommodity()
        ...
        if m.get('OperationMetadata') is not None:
            temp_model = main_models.CreateServiceInstanceRequestOperationMetadata()
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.CreateServiceInstanceRequestTag()
...
class CreateServiceInstanceRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class CreateServiceInstanceRequestOperationMetadata(DaraModel):
    def __init__(
        self,
        end_time: str = None,
        extra_info: str = None,
...
class CreateServiceInstanceRequestCommodity(DaraModel):
    def __init__(
        self,
        auto_pay: bool = None,

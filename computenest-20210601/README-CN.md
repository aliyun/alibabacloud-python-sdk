...
## Alibaba Cloud ComputeNest SDK for Python
...
```bash
# 安装 alibabacloud_computenest20210601
pip install alibabacloud_computenest20210601
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/computenest-20210601/ChangeLog.md)中。

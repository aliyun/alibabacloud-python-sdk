...
class GetMountPointResponseBody(DaraModel):
    def __init__(
        self,
        mount_point: main_models.GetMountPointResponseBodyMountPoint = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MountPoint') is not None:
            temp_model = main_models.GetMountPointResponseBodyMountPoint()
            self.mount_point = temp_model.from_map(m.get('MountPoint'))
...
class GetMountPointResponseBodyMountPoint(DaraModel):
    def __init__(
        self,

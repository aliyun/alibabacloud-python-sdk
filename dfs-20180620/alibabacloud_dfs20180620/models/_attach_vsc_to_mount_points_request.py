...
class AttachVscToMountPointsRequest(DaraModel):
    def __init__(
        self,
        attach_infos: List[main_models.AttachVscToMountPointsRequestAttachInfos] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AttachInfos') is not None:
            for k1 in m.get('AttachInfos'):
                temp_model = main_models.AttachVscToMountPointsRequestAttachInfos()
...
class AttachVscToMountPointsRequestAttachInfos(DaraModel):
    def __init__(
        self,

...
from alibabacloud_linkedmallretrieval20240930 import models as linkedmall_retrieval_20240930_models
...
class Client(OpenApiClient):
    ...
    *\
    ...
    def generic_search_with_options(
        self,
        request: linkedmall_retrieval_20240930_models.GenericSearchRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
    ) -> linkedmall_retrieval_20240930_models.GenericSearchResponse:
        """
        @summary 通用搜索

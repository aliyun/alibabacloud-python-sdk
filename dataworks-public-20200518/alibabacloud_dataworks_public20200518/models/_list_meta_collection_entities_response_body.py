...
class ListMetaCollectionEntitiesResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.ListMetaCollectionEntitiesResponseBodyData = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListMetaCollectionEntitiesResponseBodyData()
...
class ListMetaCollectionEntitiesResponseBodyData(DaraModel):
    def __init__(
        self,

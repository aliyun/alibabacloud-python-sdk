...
class GetMetaTableProducingTasksResponseBody(DaraModel):
    def __init__(
        self,
        data: List[main_models.GetMetaTableProducingTasksResponseBodyData] = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.GetMetaTableProducingTasksResponseBodyData()
...
class GetMetaTableProducingTasksResponseBodyData(DaraModel):
    def __init__(
        self,
        task_id: str = None,
        task_name: str = None,

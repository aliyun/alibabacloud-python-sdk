...
class ListDataServiceApisResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.ListDataServiceApisResponseBodyData = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListDataServiceApisResponseBodyData()
...
class ListDataServiceApisResponseBodyData(DaraModel):
    def __init__(
        self,
        apis: List[main_models.ListDataServiceApisResponseBodyDataApis] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Apis') is not None:
            for k1 in m.get('Apis'):
                temp_model = main_models.ListDataServiceApisResponseBodyDataApis()
...
class ListDataServiceApisResponseBodyDataApis(DaraModel):
    def __init__(
        self,
        api_id: int = None,
        api_mode: int = None,
        ...
        registration_details: main_models.ListDataServiceApisResponseBodyDataApisRegistrationDetails = None,
        request_method: int = None,
        response_content_type: int = None,
        script_details: main_models.ListDataServiceApisResponseBodyDataApisScriptDetails = None,
        status: int = None,
        tenant_id: int = None,
        timeout: int = None,
        visible_range: int = None,
        wizard_details: main_models.ListDataServiceApisResponseBodyDataApisWizardDetails = None,
    ):
        # The API ID.
        self.api_id = api_id
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RegistrationDetails') is not None:
            temp_model = main_models.ListDataServiceApisResponseBodyDataApisRegistrationDetails()
        ...
        if m.get('ScriptDetails') is not None:
            temp_model = main_models.ListDataServiceApisResponseBodyDataApisScriptDetails()
        ...
        if m.get('WizardDetails') is not None:
            temp_model = main_models.ListDataServiceApisResponseBodyDataApisWizardDetails()
            self.wizard_details = temp_model.from_map(m.get('WizardDetails'))

        return self

class ListDataServiceApisResponseBodyDataApisWizardDetails(DaraModel):
    def __init__(
        self,
        is_paged_response: bool = None,
        wizard_connection: main_models.ListDataServiceApisResponseBodyDataApisWizardDetailsWizardConnection = None,
        wizard_request_parameters: List[main_models.ListDataServiceApisResponseBodyDataApisWizardDetailsWizardRequestParameters] = None,
        wizard_response_parameters: List[main_models.ListDataServiceApisResponseBodyDataApisWizardDetailsWizardResponseParameters] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('WizardConnection') is not None:
            temp_model = main_models.ListDataServiceApisResponseBodyDataApisWizardDetailsWizardConnection()
        ...
        if m.get('WizardRequestParameters') is not None:
            for k1 in m.get('WizardRequestParameters'):
                temp_model = main_models.ListDataServiceApisResponseBodyDataApisWizardDetailsWizardRequestParameters()
        ...
        if m.get('WizardResponseParameters') is not None:
            for k1 in m.get('WizardResponseParameters'):
                temp_model = main_models.ListDataServiceApisResponseBodyDataApisWizardDetailsWizardResponseParameters()
                self.wizard_response_parameters.append(temp_model.from_map(k1))

        return self

class ListDataServiceApisResponseBodyDataApisWizardDetailsWizardResponseParameters(DaraModel):
    def __init__(
        self,
...
class ListDataServiceApisResponseBodyDataApisWizardDetailsWizardRequestParameters(DaraModel):
    def __init__(
        self,
        column_name: str = None,
...
class ListDataServiceApisResponseBodyDataApisWizardDetailsWizardConnection(DaraModel):
    def __init__(
        self,
...
class ListDataServiceApisResponseBodyDataApisScriptDetails(DaraModel):
    def __init__(
        self,
        is_paged_response: bool = None,
        script: str = None,
        script_connection: main_models.ListDataServiceApisResponseBodyDataApisScriptDetailsScriptConnection = None,
        script_request_parameters: List[main_models.ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters] = None,
        script_response_parameters: List[main_models.ListDataServiceApisResponseBodyDataApisScriptDetailsScriptResponseParameters] = None,
    ):
        # Indicates whether the entries are returned by page.
        self.is_paged_response = is_paged_response
        # The SQL script.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ScriptConnection') is not None:
            temp_model = main_models.ListDataServiceApisResponseBodyDataApisScriptDetailsScriptConnection()
        ...
        if m.get('ScriptRequestParameters') is not None:
            for k1 in m.get('ScriptRequestParameters'):
                temp_model = main_models.ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters()
        ...
        if m.get('ScriptResponseParameters') is not None:
            for k1 in m.get('ScriptResponseParameters'):
                temp_model = main_models.ListDataServiceApisResponseBodyDataApisScriptDetailsScriptResponseParameters()
                self.script_response_parameters.append(temp_model.from_map(k1))

        return self

class ListDataServiceApisResponseBodyDataApisScriptDetailsScriptResponseParameters(DaraModel):
    def __init__(
        self,
        column_name: str = None,
        example_value: str = None,
...
class ListDataServiceApisResponseBodyDataApisScriptDetailsScriptRequestParameters(DaraModel):
    def __init__(
        self,
        column_name: str = None,
        default_value: str = None,
...
class ListDataServiceApisResponseBodyDataApisScriptDetailsScriptConnection(DaraModel):
    def __init__(
        self,
        connection_id: int = None,
        table_name: str = None,
...
class ListDataServiceApisResponseBodyDataApisRegistrationDetails(DaraModel):
    def __init__(
        self,
        failed_result_sample: str = None,
        registration_error_codes: List[main_models.ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationErrorCodes] = None,
        registration_request_parameters: List[main_models.ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RegistrationErrorCodes') is not None:
            for k1 in m.get('RegistrationErrorCodes'):
                temp_model = main_models.ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationErrorCodes()
        ...
        if m.get('RegistrationRequestParameters') is not None:
            for k1 in m.get('RegistrationRequestParameters'):
                temp_model = main_models.ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters()
...
class ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters(DaraModel):
    def __init__(
        self,
        column_name: str = None,
        default_value: str = None,
...
class ListDataServiceApisResponseBodyDataApisRegistrationDetailsRegistrationErrorCodes(DaraModel):
    def __init__(
        self,
        error_code: str = None,
        error_message: str = None,

...
class UpdateDISyncTaskResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.UpdateDISyncTaskResponseBodyData = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.UpdateDISyncTaskResponseBodyData()
...
class UpdateDISyncTaskResponseBodyData(DaraModel):
    def __init__(
        self,
        message: str = None,
        status: str = None,

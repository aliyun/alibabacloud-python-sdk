...
class ListFileTypeResponseBody(DaraModel):
    def __init__(
        self,
        node_type_info_list: main_models.ListFileTypeResponseBodyNodeTypeInfoList = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NodeTypeInfoList') is not None:
            temp_model = main_models.ListFileTypeResponseBodyNodeTypeInfoList()
...
class ListFileTypeResponseBodyNodeTypeInfoList(DaraModel):
    def __init__(
        self,
        node_type_info: List[main_models.ListFileTypeResponseBodyNodeTypeInfoListNodeTypeInfo] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NodeTypeInfo') is not None:
            for k1 in m.get('NodeTypeInfo'):
                temp_model = main_models.ListFileTypeResponseBodyNodeTypeInfoListNodeTypeInfo()
...
class ListFileTypeResponseBodyNodeTypeInfoListNodeTypeInfo(DaraModel):
    def __init__(
        self,
        node_type: int = None,

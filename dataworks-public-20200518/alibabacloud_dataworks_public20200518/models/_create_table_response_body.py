...
class CreateTableResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        task_info: main_models.CreateTableResponseBodyTaskInfo = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TaskInfo') is not None:
            temp_model = main_models.CreateTableResponseBodyTaskInfo()
            self.task_info = temp_model.from_map(m.get('TaskInfo'))

        return self

class CreateTableResponseBodyTaskInfo(DaraModel):
    def __init__(
        self,
        content: str = None,

...
class ListManualDagInstancesResponseBody(DaraModel):
    def __init__(
        self,
        instances: List[main_models.ListManualDagInstancesResponseBodyInstances] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Instances') is not None:
            for k1 in m.get('Instances'):
                temp_model = main_models.ListManualDagInstancesResponseBodyInstances()
...
class ListManualDagInstancesResponseBodyInstances(DaraModel):
    def __init__(
        self,

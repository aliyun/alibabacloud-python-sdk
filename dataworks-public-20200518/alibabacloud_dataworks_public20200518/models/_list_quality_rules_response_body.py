...
class ListQualityRulesResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.ListQualityRulesResponseBodyData = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListQualityRulesResponseBodyData()
...
class ListQualityRulesResponseBodyData(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        rules: List[main_models.ListQualityRulesResponseBodyDataRules] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Rules') is not None:
            for k1 in m.get('Rules'):
                temp_model = main_models.ListQualityRulesResponseBodyDataRules()
...
class ListQualityRulesResponseBodyDataRules(DaraModel):
    def __init__(
        self,
        block_type: int = None,
        checker_id: int = None,

...
class GenerateDISyncTaskConfigForUpdatingResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.GenerateDISyncTaskConfigForUpdatingResponseBodyData = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GenerateDISyncTaskConfigForUpdatingResponseBodyData()
...
class GenerateDISyncTaskConfigForUpdatingResponseBodyData(DaraModel):
    def __init__(
        self,
        message: str = None,
        process_id: int = None,

...
class CreateDISyncTaskResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.CreateDISyncTaskResponseBodyData = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CreateDISyncTaskResponseBodyData()
...
class CreateDISyncTaskResponseBodyData(DaraModel):
    def __init__(
        self,
        file_id: int = None,
        message: str = None,

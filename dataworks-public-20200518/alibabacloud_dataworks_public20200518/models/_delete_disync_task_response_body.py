...
class DeleteDISyncTaskResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.DeleteDISyncTaskResponseBodyData = None,
        request_id: str = None,
        success: bool = None,
    ):
        # The deletion result.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DeleteDISyncTaskResponseBodyData()
...
class DeleteDISyncTaskResponseBodyData(DaraModel):
    def __init__(
        self,
        message: str = None,
        status: str = None,

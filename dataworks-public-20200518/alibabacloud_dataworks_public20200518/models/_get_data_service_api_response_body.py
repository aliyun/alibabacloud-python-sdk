...
class GetDataServiceApiResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.GetDataServiceApiResponseBodyData = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetDataServiceApiResponseBodyData()
...
class GetDataServiceApiResponseBodyData(DaraModel):
    def __init__(
        self,
        api_id: int = None,
        api_mode: int = None,
        ...
        registration_details: main_models.GetDataServiceApiResponseBodyDataRegistrationDetails = None,
        request_method: int = None,
        response_content_type: int = None,
        script_details: main_models.GetDataServiceApiResponseBodyDataScriptDetails = None,
        status: int = None,
        tenant_id: int = None,
        timeout: int = None,
        visible_range: int = None,
        wizard_details: main_models.GetDataServiceApiResponseBodyDataWizardDetails = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RegistrationDetails') is not None:
            temp_model = main_models.GetDataServiceApiResponseBodyDataRegistrationDetails()
        ...
        if m.get('ScriptDetails') is not None:
            temp_model = main_models.GetDataServiceApiResponseBodyDataScriptDetails()
        ...
        if m.get('WizardDetails') is not None:
            temp_model = main_models.GetDataServiceApiResponseBodyDataWizardDetails()
            self.wizard_details = temp_model.from_map(m.get('WizardDetails'))

        return self

class GetDataServiceApiResponseBodyDataWizardDetails(DaraModel):
    def __init__(
        self,
        is_paged_response: bool = None,
        wizard_connection: main_models.GetDataServiceApiResponseBodyDataWizardDetailsWizardConnection = None,
        wizard_request_parameters: List[main_models.GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters] = None,
        wizard_response_parameters: List[main_models.GetDataServiceApiResponseBodyDataWizardDetailsWizardResponseParameters] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('WizardConnection') is not None:
            temp_model = main_models.GetDataServiceApiResponseBodyDataWizardDetailsWizardConnection()
        ...
        if m.get('WizardRequestParameters') is not None:
            for k1 in m.get('WizardRequestParameters'):
                temp_model = main_models.GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters()
        ...
        if m.get('WizardResponseParameters') is not None:
            for k1 in m.get('WizardResponseParameters'):
                temp_model = main_models.GetDataServiceApiResponseBodyDataWizardDetailsWizardResponseParameters()
                self.wizard_response_parameters.append(temp_model.from_map(k1))

        return self

class GetDataServiceApiResponseBodyDataWizardDetailsWizardResponseParameters(DaraModel):
    def __init__(
        self,
...
class GetDataServiceApiResponseBodyDataWizardDetailsWizardRequestParameters(DaraModel):
    def __init__(
        self,
        column_name: str = None,
...
class GetDataServiceApiResponseBodyDataWizardDetailsWizardConnection(DaraModel):
    def __init__(
        self,
...
class GetDataServiceApiResponseBodyDataScriptDetails(DaraModel):
    def __init__(
        self,
        is_paged_response: bool = None,
        script: str = None,
        script_connection: main_models.GetDataServiceApiResponseBodyDataScriptDetailsScriptConnection = None,
        script_request_parameters: List[main_models.GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters] = None,
        script_response_parameters: List[main_models.GetDataServiceApiResponseBodyDataScriptDetailsScriptResponseParameters] = None,
    ):
        # Indicates whether the entries were returned by page.
        self.is_paged_response = is_paged_response
        # The SQL script.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ScriptConnection') is not None:
            temp_model = main_models.GetDataServiceApiResponseBodyDataScriptDetailsScriptConnection()
        ...
        if m.get('ScriptRequestParameters') is not None:
            for k1 in m.get('ScriptRequestParameters'):
                temp_model = main_models.GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters()
        ...
        if m.get('ScriptResponseParameters') is not None:
            for k1 in m.get('ScriptResponseParameters'):
                temp_model = main_models.GetDataServiceApiResponseBodyDataScriptDetailsScriptResponseParameters()
                self.script_response_parameters.append(temp_model.from_map(k1))

        return self

class GetDataServiceApiResponseBodyDataScriptDetailsScriptResponseParameters(DaraModel):
    def __init__(
        self,
        column_name: str = None,
        example_value: str = None,
...
class GetDataServiceApiResponseBodyDataScriptDetailsScriptRequestParameters(DaraModel):
    def __init__(
        self,
        column_name: str = None,
        default_value: str = None,
...
class GetDataServiceApiResponseBodyDataScriptDetailsScriptConnection(DaraModel):
    def __init__(
        self,
        connection_id: int = None,
        table_name: str = None,
...
class GetDataServiceApiResponseBodyDataRegistrationDetails(DaraModel):
    def __init__(
        self,
        failed_result_sample: str = None,
        registration_error_codes: List[main_models.GetDataServiceApiResponseBodyDataRegistrationDetailsRegistrationErrorCodes] = None,
        registration_request_parameters: List[main_models.GetDataServiceApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RegistrationErrorCodes') is not None:
            for k1 in m.get('RegistrationErrorCodes'):
                temp_model = main_models.GetDataServiceApiResponseBodyDataRegistrationDetailsRegistrationErrorCodes()
        ...
        if m.get('RegistrationRequestParameters') is not None:
            for k1 in m.get('RegistrationRequestParameters'):
                temp_model = main_models.GetDataServiceApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters()
...
class GetDataServiceApiResponseBodyDataRegistrationDetailsRegistrationRequestParameters(DaraModel):
    def __init__(
        self,
        column_name: str = None,
        default_value: str = None,
...
class GetDataServiceApiResponseBodyDataRegistrationDetailsRegistrationErrorCodes(DaraModel):
    def __init__(
        self,
        error_code: str = None,
        error_message: str = None,

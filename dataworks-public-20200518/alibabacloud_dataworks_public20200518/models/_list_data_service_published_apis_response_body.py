...
class ListDataServicePublishedApisResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.ListDataServicePublishedApisResponseBodyData = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListDataServicePublishedApisResponseBodyData()
...
class ListDataServicePublishedApisResponseBodyData(DaraModel):
    def __init__(
        self,
        apis: List[main_models.ListDataServicePublishedApisResponseBodyDataApis] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Apis') is not None:
            for k1 in m.get('Apis'):
                temp_model = main_models.ListDataServicePublishedApisResponseBodyDataApis()
...
class ListDataServicePublishedApisResponseBodyDataApis(DaraModel):
    def __init__(
        self,
        api_id: int = None,
        api_mode: int = None,
        ...
        registration_details: main_models.ListDataServicePublishedApisResponseBodyDataApisRegistrationDetails = None,
        request_method: int = None,
        response_content_type: int = None,
        script_details: main_models.ListDataServicePublishedApisResponseBodyDataApisScriptDetails = None,
        sql_mode: int = None,
        status: int = None,
        tenant_id: int = None,
        timeout: int = None,
        visible_range: int = None,
        wizard_details: main_models.ListDataServicePublishedApisResponseBodyDataApisWizardDetails = None,
    ):
        # The API ID.
        self.api_id = api_id
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RegistrationDetails') is not None:
            temp_model = main_models.ListDataServicePublishedApisResponseBodyDataApisRegistrationDetails()
        ...
        if m.get('ScriptDetails') is not None:
            temp_model = main_models.ListDataServicePublishedApisResponseBodyDataApisScriptDetails()
        ...
        if m.get('WizardDetails') is not None:
            temp_model = main_models.ListDataServicePublishedApisResponseBodyDataApisWizardDetails()
            self.wizard_details = temp_model.from_map(m.get('WizardDetails'))

        return self

class ListDataServicePublishedApisResponseBodyDataApisWizardDetails(DaraModel):
    def __init__(
        self,
        failed_result_sample: str = None,
        is_paged_response: bool = None,
        successful_result_sample: str = None,
        wizard_connection: main_models.ListDataServicePublishedApisResponseBodyDataApisWizardDetailsWizardConnection = None,
        wizard_error_codes: List[main_models.ListDataServicePublishedApisResponseBodyDataApisWizardDetailsWizardErrorCodes] = None,
        wizard_request_parameters: List[main_models.ListDataServicePublishedApisResponseBodyDataApisWizardDetailsWizardRequestParameters] = None,
        wizard_response_parameters: List[main_models.ListDataServicePublishedApisResponseBodyDataApisWizardDetailsWizardResponseParameters] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('WizardConnection') is not None:
            temp_model = main_models.ListDataServicePublishedApisResponseBodyDataApisWizardDetailsWizardConnection()
        ...
        if m.get('WizardErrorCodes') is not None:
            for k1 in m.get('WizardErrorCodes'):
                temp_model = main_models.ListDataServicePublishedApisResponseBodyDataApisWizardDetailsWizardErrorCodes()
        ...
        if m.get('WizardRequestParameters') is not None:
            for k1 in m.get('WizardRequestParameters'):
                temp_model = main_models.ListDataServicePublishedApisResponseBodyDataApisWizardDetailsWizardRequestParameters()
        ...
        if m.get('WizardResponseParameters') is not None:
            for k1 in m.get('WizardResponseParameters'):
                temp_model = main_models.ListDataServicePublishedApisResponseBodyDataApisWizardDetailsWizardResponseParameters()
                self.wizard_response_parameters.append(temp_model.from_map(k1))

        return self

class ListDataServicePublishedApisResponseBodyDataApisWizardDetailsWizardResponseParameters(DaraModel):
    def __init__(
        self,
...
class ListDataServicePublishedApisResponseBodyDataApisWizardDetailsWizardRequestParameters(DaraModel):
    def __init__(
        self,
...
class ListDataServicePublishedApisResponseBodyDataApisWizardDetailsWizardErrorCodes(DaraModel):
    def __init__(
        self,
        error_code: str = None,
        error_message: str = None,
...
class ListDataServicePublishedApisResponseBodyDataApisWizardDetailsWizardConnection(DaraModel):
    def __init__(
        self,
...
class ListDataServicePublishedApisResponseBodyDataApisScriptDetails(DaraModel):
    def __init__(
        self,
        failed_result_sample: str = None,
        is_paged_response: bool = None,
        script: str = None,
        script_connection: main_models.ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptConnection = None,
        script_error_codes: List[main_models.ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptErrorCodes] = None,
        script_request_parameters: List[main_models.ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters] = None,
        script_response_parameters: List[main_models.ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptResponseParameters] = None,
        successful_result_sample: str = None,
    ):
        # The sample error response of the API.
        self.failed_result_sample = failed_result_sample
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ScriptConnection') is not None:
            temp_model = main_models.ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptConnection()
        ...
        if m.get('ScriptErrorCodes') is not None:
            for k1 in m.get('ScriptErrorCodes'):
                temp_model = main_models.ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptErrorCodes()
        ...
        if m.get('ScriptRequestParameters') is not None:
            for k1 in m.get('ScriptRequestParameters'):
                temp_model = main_models.ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters()
        ...
        if m.get('ScriptResponseParameters') is not None:
            for k1 in m.get('ScriptResponseParameters'):
                temp_model = main_models.ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptResponseParameters()
...
class ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptResponseParameters(DaraModel):
    def __init__(
        self,
        example_value: str = None,
        parameter_data_type: int = None,
...
class ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptRequestParameters(DaraModel):
    def __init__(
        self,
        default_value: str = None,
        example_value: str = None,
...
class ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptErrorCodes(DaraModel):
    def __init__(
        self,
        error_code: str = None,
        error_message: str = None,
...
class ListDataServicePublishedApisResponseBodyDataApisScriptDetailsScriptConnection(DaraModel):
    def __init__(
        self,
        connection_id: int = None,
        table_name: str = None,
...
class ListDataServicePublishedApisResponseBodyDataApisRegistrationDetails(DaraModel):
    def __init__(
        self,
        failed_result_sample: str = None,
        registration_error_codes: List[main_models.ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationErrorCodes] = None,
        registration_request_parameters: List[main_models.ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RegistrationErrorCodes') is not None:
            for k1 in m.get('RegistrationErrorCodes'):
                temp_model = main_models.ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationErrorCodes()
        ...
        if m.get('RegistrationRequestParameters') is not None:
            for k1 in m.get('RegistrationRequestParameters'):
                temp_model = main_models.ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters()
...
class ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationRequestParameters(DaraModel):
    def __init__(
        self,
        default_value: str = None,
        example_value: str = None,
...
class ListDataServicePublishedApisResponseBodyDataApisRegistrationDetailsRegistrationErrorCodes(DaraModel):
    def __init__(
        self,
        error_code: str = None,
        error_message: str = None,

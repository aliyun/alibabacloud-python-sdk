...
class ListQualityResultsByRuleResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.ListQualityResultsByRuleResponseBodyData = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListQualityResultsByRuleResponseBodyData()
...
class ListQualityResultsByRuleResponseBodyData(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        rule_checks: List[main_models.ListQualityResultsByRuleResponseBodyDataRuleChecks] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RuleChecks') is not None:
            for k1 in m.get('RuleChecks'):
                temp_model = main_models.ListQualityResultsByRuleResponseBodyDataRuleChecks()
...
class ListQualityResultsByRuleResponseBodyDataRuleChecks(DaraModel):
    def __init__(
        self,
        ...
        property: str = None,
        reference_value: List[main_models.ListQualityResultsByRuleResponseBodyDataRuleChecksReferenceValue] = None,
        result_string: str = None,
        rule_id: int = None,
        rule_name: str = None,
        sample_value: List[main_models.ListQualityResultsByRuleResponseBodyDataRuleChecksSampleValue] = None,
        table_name: str = None,
        task_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ReferenceValue') is not None:
            for k1 in m.get('ReferenceValue'):
                temp_model = main_models.ListQualityResultsByRuleResponseBodyDataRuleChecksReferenceValue()
        ...
        if m.get('SampleValue') is not None:
            for k1 in m.get('SampleValue'):
                temp_model = main_models.ListQualityResultsByRuleResponseBodyDataRuleChecksSampleValue()
...
class ListQualityResultsByRuleResponseBodyDataRuleChecksSampleValue(DaraModel):
    def __init__(
        self,
        biz_date: str = None,
...
class ListQualityResultsByRuleResponseBodyDataRuleChecksReferenceValue(DaraModel):
    def __init__(
        self,
        biz_date: str = None,
        discrete_property: str = None,

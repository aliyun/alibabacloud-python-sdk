...
class GetDagResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.GetDagResponseBodyData = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetDagResponseBodyData()
...
class GetDagResponseBodyData(DaraModel):
    def __init__(
        self,
        bizdate: int = None,

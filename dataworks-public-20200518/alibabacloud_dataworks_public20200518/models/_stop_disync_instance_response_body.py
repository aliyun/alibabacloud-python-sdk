...
class StopDISyncInstanceResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.StopDISyncInstanceResponseBodyData = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.StopDISyncInstanceResponseBodyData()
...
class StopDISyncInstanceResponseBodyData(DaraModel):
    def __init__(
        self,
        message: str = None,
        status: str = None,

...
class GetNodeParentsResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.GetNodeParentsResponseBodyData = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetNodeParentsResponseBodyData()
...
class GetNodeParentsResponseBodyData(DaraModel):
    def __init__(
        self,
        nodes: List[main_models.GetNodeParentsResponseBodyDataNodes] = None,
    ):
        # The ancestor nodes.
        self.nodes = nodes
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Nodes') is not None:
            for k1 in m.get('Nodes'):
                temp_model = main_models.GetNodeParentsResponseBodyDataNodes()
                self.nodes.append(temp_model.from_map(k1))

        return self

class GetNodeParentsResponseBodyDataNodes(DaraModel):
    def __init__(
        self,

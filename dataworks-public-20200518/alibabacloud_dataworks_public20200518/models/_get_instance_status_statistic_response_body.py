...
class GetInstanceStatusStatisticResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        status_count: main_models.GetInstanceStatusStatisticResponseBodyStatusCount = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('StatusCount') is not None:
            temp_model = main_models.GetInstanceStatusStatisticResponseBodyStatusCount()
            self.status_count = temp_model.from_map(m.get('StatusCount'))

        return self

class GetInstanceStatusStatisticResponseBodyStatusCount(DaraModel):
    def __init__(
        self,

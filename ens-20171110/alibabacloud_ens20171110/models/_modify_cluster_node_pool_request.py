...
class ModifyClusterNodePoolRequestScalingGroup(DaraModel):
    def __init__(
        self,
        data_disks: List[main_models.ModifyClusterNodePoolRequestScalingGroupDataDisks] = None,
        image_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataDisks') is not None:
            for k1 in m.get('DataDisks'):
                temp_model = main_models.ModifyClusterNodePoolRequestScalingGroupDataDisks()
...
class ModifyClusterNodePoolRequestScalingGroupDataDisks(DaraModel):
    def __init__(
        self,
        category: str = None,
        size: int = None,

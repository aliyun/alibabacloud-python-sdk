...
class DescribeEpnBandWidthDataResponseBody(DaraModel):
    def __init__(
        self,
        monitor_data: main_models.DescribeEpnBandWidthDataResponseBodyMonitorData = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MonitorData') is not None:
            temp_model = main_models.DescribeEpnBandWidthDataResponseBodyMonitorData()
...
class DescribeEpnBandWidthDataResponseBodyMonitorData(DaraModel):
    def __init__(
        self,
        band_width_monitor_data: List[main_models.DescribeEpnBandWidthDataResponseBodyMonitorDataBandWidthMonitorData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BandWidthMonitorData') is not None:
            for k1 in m.get('BandWidthMonitorData'):
                temp_model = main_models.DescribeEpnBandWidthDataResponseBodyMonitorDataBandWidthMonitorData()
...
class DescribeEpnBandWidthDataResponseBodyMonitorDataBandWidthMonitorData(DaraModel):
    def __init__(
        self,

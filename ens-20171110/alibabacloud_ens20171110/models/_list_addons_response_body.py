...
class ListAddonsResponseBodyAddons(DaraModel):
    def __init__(
        ...
        config_schema: List[main_models.ListAddonsResponseBodyAddonsConfigSchema] = None,
        name: str = None,
        version: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConfigSchema') is not None:
            for k1 in m.get('ConfigSchema'):
                temp_model = main_models.ListAddonsResponseBodyAddonsConfigSchema()
...
class ListAddonsResponseBodyAddonsConfigSchema(DaraModel):
    def __init__(
        self,

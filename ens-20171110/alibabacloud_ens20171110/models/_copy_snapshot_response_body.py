...
class CopySnapshotResponseBody(DaraModel):
    def __init__(
        self,
        allocation_id: List[main_models.CopySnapshotResponseBodyAllocationId] = None,
        biz_status_code: str = None,
        request_id: str = None,
        un_allocation_id: List[main_models.CopySnapshotResponseBodyUnAllocationId] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AllocationId') is not None:
            for k1 in m.get('AllocationId'):
                temp_model = main_models.CopySnapshotResponseBodyAllocationId()
        ...
        if m.get('UnAllocationId') is not None:
            for k1 in m.get('UnAllocationId'):
                temp_model = main_models.CopySnapshotResponseBodyUnAllocationId()
                self.un_allocation_id.append(temp_model.from_map(k1))

        return self

class CopySnapshotResponseBodyUnAllocationId(DaraModel):
    def __init__(
        self,
...
class CopySnapshotResponseBodyAllocationId(DaraModel):
    def __init__(
        self,
        ens_region_id: str = None,

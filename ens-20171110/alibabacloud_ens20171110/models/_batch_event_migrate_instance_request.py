...
class BatchEventMigrateInstanceRequest(DaraModel):
    def __init__(
        self,
        event_infos: List[main_models.BatchEventMigrateInstanceRequestEventInfos] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EventInfos') is not None:
            for k1 in m.get('EventInfos'):
                temp_model = main_models.BatchEventMigrateInstanceRequestEventInfos()
                self.event_infos.append(temp_model.from_map(k1))

        return self

class BatchEventMigrateInstanceRequestEventInfos(DaraModel):
    def __init__(
        self,

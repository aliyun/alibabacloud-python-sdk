...
class DeleteSecurityGroupPermissionsRequest(DaraModel):
    def __init__(
        self,
        permissions: List[main_models.DeleteSecurityGroupPermissionsRequestPermissions] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Permissions') is not None:
            for k1 in m.get('Permissions'):
                temp_model = main_models.DeleteSecurityGroupPermissionsRequestPermissions()
...
class DeleteSecurityGroupPermissionsRequestPermissions(DaraModel):
    def __init__(
        self,

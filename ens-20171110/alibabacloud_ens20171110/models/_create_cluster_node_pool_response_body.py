...
class CreateClusterNodePoolResponseBody(DaraModel):
    def __init__(
        self,
        nodepool: main_models.CreateClusterNodePoolResponseBodyNodepool = None,
        request_id: str = None,
    ):
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        if self.nodepool is not None:
            result['Nodepool'] = self.nodepool.to_map()
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Nodepool') is not None:
            temp_model = main_models.CreateClusterNodePoolResponseBodyNodepool()
            self.nodepool = temp_model.from_map(m.get('Nodepool'))
...
class CreateClusterNodePoolResponseBodyNodepool(DaraModel):
    def __init__(
        self,
        cluster_id: str = None,
        kubernetes_config: main_models.CreateClusterNodePoolResponseBodyNodepoolKubernetesConfig = None,
        nodepool_info: main_models.CreateClusterNodePoolResponseBodyNodepoolNodepoolInfo = None,
        scaling_group: main_models.CreateClusterNodePoolResponseBodyNodepoolScalingGroup = None,
        status: main_models.CreateClusterNodePoolResponseBodyNodepoolStatus = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('KubernetesConfig') is not None:
            temp_model = main_models.CreateClusterNodePoolResponseBodyNodepoolKubernetesConfig()
            self.kubernetes_config = temp_model.from_map(m.get('KubernetesConfig'))

        if m.get('NodepoolInfo') is not None:
            temp_model = main_models.CreateClusterNodePoolResponseBodyNodepoolNodepoolInfo()
            self.nodepool_info = temp_model.from_map(m.get('NodepoolInfo'))

        if m.get('ScalingGroup') is not None:
            temp_model = main_models.CreateClusterNodePoolResponseBodyNodepoolScalingGroup()
            self.scaling_group = temp_model.from_map(m.get('ScalingGroup'))

        if m.get('Status') is not None:
            temp_model = main_models.CreateClusterNodePoolResponseBodyNodepoolStatus()
            self.status = temp_model.from_map(m.get('Status'))

        return self

class CreateClusterNodePoolResponseBodyNodepoolStatus(DaraModel):
    def __init__(
        self,
...
class CreateClusterNodePoolResponseBodyNodepoolScalingGroup(DaraModel):
    def __init__(
        self,
        data_disks: List[main_models.CreateClusterNodePoolResponseBodyNodepoolScalingGroupDataDisks] = None,
        image_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataDisks') is not None:
            for k1 in m.get('DataDisks'):
                temp_model = main_models.CreateClusterNodePoolResponseBodyNodepoolScalingGroupDataDisks()
...
class CreateClusterNodePoolResponseBodyNodepoolScalingGroupDataDisks(DaraModel):
    def __init__(
        self,
        category: str = None,
        size: int = None,
...
class CreateClusterNodePoolResponseBodyNodepoolNodepoolInfo(DaraModel):
    def __init__(
        self,
...
class CreateClusterNodePoolResponseBodyNodepoolKubernetesConfig(DaraModel):
    def __init__(
        self,

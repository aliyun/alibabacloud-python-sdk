...
class InstallClusterAddonsRequest(DaraModel):
    def __init__(
        self,
        addons: List[main_models.InstallClusterAddonsRequestAddons] = None,
        cluster_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Addons') is not None:
            for k1 in m.get('Addons'):
                temp_model = main_models.InstallClusterAddonsRequestAddons()
...
class InstallClusterAddonsRequestAddons(DaraModel):
    def __init__(
        self,
        config_schema: List[main_models.InstallClusterAddonsRequestAddonsConfigSchema] = None,
        name: str = None,
        version: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConfigSchema') is not None:
            for k1 in m.get('ConfigSchema'):
                temp_model = main_models.InstallClusterAddonsRequestAddonsConfigSchema()
...
class InstallClusterAddonsRequestAddonsConfigSchema(DaraModel):
    def __init__(
        self,

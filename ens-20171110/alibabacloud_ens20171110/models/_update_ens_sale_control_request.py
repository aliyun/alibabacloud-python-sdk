...
class UpdateEnsSaleControlRequest(DaraModel):
    def __init__(
        self,
        ali_uid_account: str = None,
        commodity_code: str = None,
        custom_account: str = None,
        sale_controls: List[main_models.UpdateEnsSaleControlRequestSaleControls] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SaleControls') is not None:
            for k1 in m.get('SaleControls'):
                temp_model = main_models.UpdateEnsSaleControlRequestSaleControls()
                self.sale_controls.append(temp_model.from_map(k1))

        return self

class UpdateEnsSaleControlRequestSaleControls(DaraModel):
    def __init__(
        self,
        condition_controls: List[main_models.UpdateEnsSaleControlRequestSaleControlsConditionControls] = None,
        description: str = None,
        module_code: str = None,
        module_value: main_models.UpdateEnsSaleControlRequestSaleControlsModuleValue = None,
        operator: str = None,
        order_type: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConditionControls') is not None:
            for k1 in m.get('ConditionControls'):
                temp_model = main_models.UpdateEnsSaleControlRequestSaleControlsConditionControls()
        ...
        if m.get('ModuleValue') is not None:
            temp_model = main_models.UpdateEnsSaleControlRequestSaleControlsModuleValue()
...
class UpdateEnsSaleControlRequestSaleControlsModuleValue(DaraModel):
    def __init__(
        self,
...
class UpdateEnsSaleControlRequestSaleControlsConditionControls(DaraModel):
    def __init__(
        self,

...
class GetClusterAddonInstanceResponseBody(DaraModel):
    def __init__(
        ...
        config_schema: List[main_models.GetClusterAddonInstanceResponseBodyConfigSchema] = None,
        name: str = None,
        request_id: str = None,
        status: str = None,
        version: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConfigSchema') is not None:
            for k1 in m.get('ConfigSchema'):
                temp_model = main_models.GetClusterAddonInstanceResponseBodyConfigSchema()
...
class GetClusterAddonInstanceResponseBodyConfigSchema(DaraModel):
    def __init__(
        self,

...
class DescribeServerLoadBalancerMonitorResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        server_load_balancer_monitor_data: List[main_models.DescribeServerLoadBalancerMonitorResponseBodyServerLoadBalancerMonitorData] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ServerLoadBalancerMonitorData') is not None:
            for k1 in m.get('ServerLoadBalancerMonitorData'):
                temp_model = main_models.DescribeServerLoadBalancerMonitorResponseBodyServerLoadBalancerMonitorData()
                self.server_load_balancer_monitor_data.append(temp_model.from_map(k1))

        return self

class DescribeServerLoadBalancerMonitorResponseBodyServerLoadBalancerMonitorData(DaraModel):
    def __init__(
        self,
        acc: int = None,
        biz_time: str = None,

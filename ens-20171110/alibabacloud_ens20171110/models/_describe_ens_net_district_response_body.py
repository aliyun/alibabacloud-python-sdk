...
class DescribeEnsNetDistrictResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        ens_net_districts: main_models.DescribeEnsNetDistrictResponseBodyEnsNetDistricts = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EnsNetDistricts') is not None:
            temp_model = main_models.DescribeEnsNetDistrictResponseBodyEnsNetDistricts()
...
class DescribeEnsNetDistrictResponseBodyEnsNetDistricts(DaraModel):
    def __init__(
        self,
        ens_net_district: List[main_models.DescribeEnsNetDistrictResponseBodyEnsNetDistrictsEnsNetDistrict] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EnsNetDistrict') is not None:
            for k1 in m.get('EnsNetDistrict'):
                temp_model = main_models.DescribeEnsNetDistrictResponseBodyEnsNetDistrictsEnsNetDistrict()
                self.ens_net_district.append(temp_model.from_map(k1))

        return self

class DescribeEnsNetDistrictResponseBodyEnsNetDistrictsEnsNetDistrict(DaraModel):
    def __init__(
        self,

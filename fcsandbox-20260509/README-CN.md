...
## Alibaba Cloud FCSandbox SDK for Python
...
```bash
# 安装 alibabacloud_fcsandbox20260509
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/fcsandbox-20260509/ChangeLog.md)中。

...
class GenerateJwtAuthenticationTokenResponseBody(DaraModel):
    def __init__(
        self,
        ...
        jwt_content: main_models.GenerateJwtAuthenticationTokenResponseBodyJwtContent = None,
        revoked: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('jwtContent') is not None:
            temp_model = main_models.GenerateJwtAuthenticationTokenResponseBodyJwtContent()
...
class GenerateJwtAuthenticationTokenResponseBodyJwtContent(DaraModel):
    def __init__(
        self,

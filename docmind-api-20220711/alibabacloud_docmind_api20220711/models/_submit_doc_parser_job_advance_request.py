...
class SubmitDocParserJobAdvanceRequest(DaraModel):
    def __init__(
        self,
        custom_oss_config: main_models.SubmitDocParserJobAdvanceRequestCustomOssConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CustomOssConfig') is not None:
            temp_model = main_models.SubmitDocParserJobAdvanceRequestCustomOssConfig()
        ...
        if m.get('LLMParam') is not None:
            temp_model = main_models.SubmitDocParserJobAdvanceRequestLLMParam()
...
class SubmitDocParserJobAdvanceRequestMultimediaParameters(DaraModel):
    def __init__(
        self,
        ...
        frame_extraction: main_models.SubmitDocParserJobAdvanceRequestMultimediaParametersFrameExtraction = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FrameExtraction') is not None:
            temp_model = main_models.SubmitDocParserJobAdvanceRequestMultimediaParametersFrameExtraction()
...
class SubmitDocParserJobAdvanceRequestMultimediaParametersFrameExtraction(DaraModel):
    def __init__(
        self,
...
class SubmitDocParserJobAdvanceRequestLLMParam(DaraModel):
    def __init__(
        self,
        model: str = None,
        prompt: str = None,
...
class SubmitDocParserJobAdvanceRequestCustomOssConfig(DaraModel):
    def __init__(
        self,
        access_id: str = None,

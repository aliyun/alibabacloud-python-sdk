...
class QueryTracedEventsResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.QueryTracedEventsResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.QueryTracedEventsResponseBodyData()
...
class QueryTracedEventsResponseBodyData(DaraModel):
    def __init__(
        self,
        events: List[main_models.QueryTracedEventsResponseBodyDataEvents] = None,
        next_token: str = None,
        total: int = None,
    ):
        # The events.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Events') is not None:
            for k1 in m.get('Events'):
                temp_model = main_models.QueryTracedEventsResponseBodyDataEvents()
...
class QueryTracedEventsResponseBodyDataEvents(DaraModel):
    def __init__(
        self,

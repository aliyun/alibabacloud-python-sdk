...
class CreateApiDestinationResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        date: main_models.CreateApiDestinationResponseBodyDate = None,
        message: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Date') is not None:
            temp_model = main_models.CreateApiDestinationResponseBodyDate()
            self.date = temp_model.from_map(m.get('Date'))
...
class CreateApiDestinationResponseBodyDate(DaraModel):
    def __init__(
        self,

...
class UpdateAgentRequest(DaraModel):
    def __init__(
        ...
        metadata: main_models.UpdateAgentRequestMetadata = None,
        name: str = None,
        prompt: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Metadata') is not None:
            temp_model = main_models.UpdateAgentRequestMetadata()
...
class UpdateAgentRequestMetadata(DaraModel):
    def __init__(
        self,
        attachments: List[main_models.UpdateAgentRequestMetadataAttachments] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Attachments') is not None:
            for k1 in m.get('Attachments'):
                temp_model = main_models.UpdateAgentRequestMetadataAttachments()
                self.attachments.append(temp_model.from_map(k1))

        return self

class UpdateAgentRequestMetadataAttachments(DaraModel):
    def __init__(
        self,
        arn: str = None,
        mime_type: str = None,

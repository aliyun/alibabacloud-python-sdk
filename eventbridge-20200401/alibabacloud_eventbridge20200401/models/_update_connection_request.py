...
class UpdateConnectionRequest(DaraModel):
    def __init__(
        self,
        auth_parameters: main_models.UpdateConnectionRequestAuthParameters = None,
        connection_name: str = None,
        description: str = None,
        network_parameters: main_models.UpdateConnectionRequestNetworkParameters = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AuthParameters') is not None:
            temp_model = main_models.UpdateConnectionRequestAuthParameters()
        ...
        if m.get('NetworkParameters') is not None:
            temp_model = main_models.UpdateConnectionRequestNetworkParameters()
            self.network_parameters = temp_model.from_map(m.get('NetworkParameters'))

        return self

class UpdateConnectionRequestNetworkParameters(DaraModel):
    def __init__(
        self,
...
class UpdateConnectionRequestAuthParameters(DaraModel):
    def __init__(
        self,
        api_key_auth_parameters: main_models.UpdateConnectionRequestAuthParametersApiKeyAuthParameters = None,
        authorization_type: str = None,
        basic_auth_parameters: main_models.UpdateConnectionRequestAuthParametersBasicAuthParameters = None,
        oauth_parameters: main_models.UpdateConnectionRequestAuthParametersOAuthParameters = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ApiKeyAuthParameters') is not None:
            temp_model = main_models.UpdateConnectionRequestAuthParametersApiKeyAuthParameters()
        ...
        if m.get('BasicAuthParameters') is not None:
            temp_model = main_models.UpdateConnectionRequestAuthParametersBasicAuthParameters()
            self.basic_auth_parameters = temp_model.from_map(m.get('BasicAuthParameters'))

        if m.get('OAuthParameters') is not None:
            temp_model = main_models.UpdateConnectionRequestAuthParametersOAuthParameters()
            self.oauth_parameters = temp_model.from_map(m.get('OAuthParameters'))

        return self

class UpdateConnectionRequestAuthParametersOAuthParameters(DaraModel):
    def __init__(
        self,
        authorization_endpoint: str = None,
        client_parameters: main_models.UpdateConnectionRequestAuthParametersOAuthParametersClientParameters = None,
        http_method: str = None,
        oauth_http_parameters: main_models.UpdateConnectionRequestAuthParametersOAuthParametersOAuthHttpParameters = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ClientParameters') is not None:
            temp_model = main_models.UpdateConnectionRequestAuthParametersOAuthParametersClientParameters()
        ...
        if m.get('OAuthHttpParameters') is not None:
            temp_model = main_models.UpdateConnectionRequestAuthParametersOAuthParametersOAuthHttpParameters()
            self.oauth_http_parameters = temp_model.from_map(m.get('OAuthHttpParameters'))

        return self

class UpdateConnectionRequestAuthParametersOAuthParametersOAuthHttpParameters(DaraModel):
    def __init__(
        self,
        body_parameters: List[main_models.UpdateConnectionRequestAuthParametersOAuthParametersOAuthHttpParametersBodyParameters] = None,
        header_parameters: List[main_models.UpdateConnectionRequestAuthParametersOAuthParametersOAuthHttpParametersHeaderParameters] = None,
        query_string_parameters: List[main_models.UpdateConnectionRequestAuthParametersOAuthParametersOAuthHttpParametersQueryStringParameters] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BodyParameters') is not None:
            for k1 in m.get('BodyParameters'):
                temp_model = main_models.UpdateConnectionRequestAuthParametersOAuthParametersOAuthHttpParametersBodyParameters()
        ...
        if m.get('HeaderParameters') is not None:
            for k1 in m.get('HeaderParameters'):
                temp_model = main_models.UpdateConnectionRequestAuthParametersOAuthParametersOAuthHttpParametersHeaderParameters()
        ...
        if m.get('QueryStringParameters') is not None:
            for k1 in m.get('QueryStringParameters'):
                temp_model = main_models.UpdateConnectionRequestAuthParametersOAuthParametersOAuthHttpParametersQueryStringParameters()
                self.query_string_parameters.append(temp_model.from_map(k1))

        return self

class UpdateConnectionRequestAuthParametersOAuthParametersOAuthHttpParametersQueryStringParameters(DaraModel):
    def __init__(
        self,
...
class UpdateConnectionRequestAuthParametersOAuthParametersOAuthHttpParametersHeaderParameters(DaraModel):
    def __init__(
        self,
        is_value_secret: str = None,
        key: str = None,
...
class UpdateConnectionRequestAuthParametersOAuthParametersOAuthHttpParametersBodyParameters(DaraModel):
    def __init__(
        self,
        is_value_secret: str = None,
        key: str = None,
...
class UpdateConnectionRequestAuthParametersOAuthParametersClientParameters(DaraModel):
    def __init__(
        self,
        client_id: str = None,
...
class UpdateConnectionRequestAuthParametersBasicAuthParameters(DaraModel):
    def __init__(
        self,
        password: str = None,
        username: str = None,
...
class UpdateConnectionRequestAuthParametersApiKeyAuthParameters(DaraModel):
    def __init__(
        self,

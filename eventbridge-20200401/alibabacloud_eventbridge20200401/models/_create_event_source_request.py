...
class CreateEventSourceRequest(DaraModel):
    def __init__(
        self,
        ...
        source_http_event_parameters: main_models.CreateEventSourceRequestSourceHttpEventParameters = None,
        source_kafka_parameters: main_models.CreateEventSourceRequestSourceKafkaParameters = None,
        source_mnsparameters: main_models.CreateEventSourceRequestSourceMNSParameters = None,
        source_ossevent_parameters: main_models.CreateEventSourceRequestSourceOSSEventParameters = None,
        source_rabbit_mqparameters: main_models.CreateEventSourceRequestSourceRabbitMQParameters = None,
        source_rocket_mqparameters: main_models.CreateEventSourceRequestSourceRocketMQParameters = None,
        source_slsparameters: main_models.CreateEventSourceRequestSourceSLSParameters = None,
        source_scheduled_event_parameters: main_models.CreateEventSourceRequestSourceScheduledEventParameters = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SourceHttpEventParameters') is not None:
            temp_model = main_models.CreateEventSourceRequestSourceHttpEventParameters()
        ...
        if m.get('SourceRabbitMQParameters') is not None:
            temp_model = main_models.CreateEventSourceRequestSourceRabbitMQParameters()
        ...
        if m.get('SourceRocketMQParameters') is not None:
            temp_model = main_models.CreateEventSourceRequestSourceRocketMQParameters()
        ...
        if m.get('SourceSLSParameters') is not None:
            temp_model = main_models.CreateEventSourceRequestSourceSLSParameters()
        ...
        if m.get('SourceScheduledEventParameters') is not None:
            temp_model = main_models.CreateEventSourceRequestSourceScheduledEventParameters()
            self.source_scheduled_event_parameters = temp_model.from_map(m.get('SourceScheduledEventParameters'))

        return self

class CreateEventSourceRequestSourceScheduledEventParameters(DaraModel):
    def __init__(
        self,
        schedule: str = None,
        time_zone: str = None,
...
class CreateEventSourceRequestSourceSLSParameters(DaraModel):
    def __init__(
        self,
...
class CreateEventSourceRequestSourceRocketMQParameters(DaraModel):
    def __init__(
        self,
        auth_type: str = None,
        group_id: str = None,
...
class CreateEventSourceRequestSourceRabbitMQParameters(DaraModel):
    def __init__(
        self,
        instance_id: str = None,
        queue_name: str = None,
...
class CreateEventSourceRequestSourceOSSEventParameters(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MatchRules') is not None:
            for k1 in m.get('MatchRules'):
                l1 = []
                for k2 in k1:
                    temp_model = main_models.CreateEventSourceRequestSourceOSSEventParametersMatchRules()
...
class CreateEventSourceRequestSourceOSSEventParametersMatchRules(DaraModel):
    def __init__(
        self,
        prefix: str = None,
        suffix: str = None,
...
class CreateEventSourceRequestSourceMNSParameters(DaraModel):
    def __init__(
        self,
...
class CreateEventSourceRequestSourceKafkaParameters(DaraModel):
    def __init__(
        self,
...
class CreateEventSourceRequestSourceHttpEventParameters(DaraModel):
    def __init__(
        self,
        ip: List[str] = None,

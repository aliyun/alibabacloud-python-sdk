...
class CreateApiDestinationRequest(DaraModel):
    def __init__(
        self,
        api_destination_name: str = None,
        connection_name: str = None,
        description: str = None,
        http_api_parameters: main_models.CreateApiDestinationRequestHttpApiParameters = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HttpApiParameters') is not None:
            temp_model = main_models.CreateApiDestinationRequestHttpApiParameters()
            self.http_api_parameters = temp_model.from_map(m.get('HttpApiParameters'))

        return self

class CreateApiDestinationRequestHttpApiParameters(DaraModel):
    def __init__(
        self,
        endpoint: str = None,
        method: str = None,

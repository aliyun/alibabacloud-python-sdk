...
class LumaTable(DaraModel):
    def __init__(
        self,
        catalog: str = None,
        columns: List[main_models.LumaTableColumns] = None,
        comment: str = None,
        create_time: int = None,
        name: str = None,
        namespace: str = None,
        retention_policy: main_models.LumaTableRetentionPolicy = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Columns') is not None:
            for k1 in m.get('Columns'):
                temp_model = main_models.LumaTableColumns()
        ...
        if m.get('RetentionPolicy') is not None:
            temp_model = main_models.LumaTableRetentionPolicy()
...
class LumaTableRetentionPolicy(DaraModel):
    def __init__(
        self,
        cold_ttl: int = None,
        hot_ttl: int = None,
...
class LumaTableColumns(DaraModel):
    def __init__(
        self,
        comment: str = None,
        name: str = None,

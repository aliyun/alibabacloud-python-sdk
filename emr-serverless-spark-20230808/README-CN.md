...
```bash
# 安装 alibabacloud_emr_serverless_spark20230808
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/emr-serverless-spark-20230808/ChangeLog.md)中。

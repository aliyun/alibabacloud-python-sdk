...
class GetJobRunResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('jobRun') is not None:
            temp_model = main_models.GetJobRunResponseBodyJobRun()
            self.job_run = temp_model.from_map(m.get('jobRun'))
...
class GetJobRunResponseBodyJobRun(DaraModel):
    def __init__(
        self,
        code_type: str = None,
        configuration_overrides: main_models.GetJobRunResponseBodyJobRunConfigurationOverrides = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('configurationOverrides') is not None:
            temp_model = main_models.GetJobRunResponseBodyJobRunConfigurationOverrides()
        ...
        if m.get('stateChangeReason') is not None:
            temp_model = main_models.GetJobRunResponseBodyJobRunStateChangeReason()
...
class GetJobRunResponseBodyJobRunStateChangeReason(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
...
class GetJobRunResponseBodyJobRunConfigurationOverrides(DaraModel):
    def __init__(
        self,

...
class UpdateKyuubiTokenRequest(DaraModel):
    def __init__(
        self,
        auto_expire_configuration: main_models.UpdateKyuubiTokenRequestAutoExpireConfiguration = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('autoExpireConfiguration') is not None:
            temp_model = main_models.UpdateKyuubiTokenRequestAutoExpireConfiguration()
...
class UpdateKyuubiTokenRequestAutoExpireConfiguration(DaraModel):
    def __init__(
        self,
        enable: bool = None,

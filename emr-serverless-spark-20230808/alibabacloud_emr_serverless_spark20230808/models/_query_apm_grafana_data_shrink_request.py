...
class QueryApmGrafanaDataShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        self.query_params_shrink = query_params_shrink
    ...
    def to_map(self):
        ...
        if self.query_params_shrink is not None:
            result['queryParams'] = self.query_params_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('queryParams') is not None:
            self.query_params_shrink = m.get('queryParams')

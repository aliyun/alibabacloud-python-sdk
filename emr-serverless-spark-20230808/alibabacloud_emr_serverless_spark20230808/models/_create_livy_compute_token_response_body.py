...
class CreateLivyComputeTokenResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.CreateLivyComputeTokenResponseBodyData = None,
        message: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.CreateLivyComputeTokenResponseBodyData()
...
class CreateLivyComputeTokenResponseBodyData(DaraModel):
    def __init__(
        self,
        token_id: str = None,
    ):

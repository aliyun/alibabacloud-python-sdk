...
class UpdateLivyComputeRequest(DaraModel):
    def __init__(
        self,
        auth_type: str = None,
        auto_start_configuration: main_models.UpdateLivyComputeRequestAutoStartConfiguration = None,
        auto_stop_configuration: main_models.UpdateLivyComputeRequestAutoStopConfiguration = None,
        cpu_limit: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('autoStartConfiguration') is not None:
            temp_model = main_models.UpdateLivyComputeRequestAutoStartConfiguration()
            self.auto_start_configuration = temp_model.from_map(m.get('autoStartConfiguration'))

        if m.get('autoStopConfiguration') is not None:
            temp_model = main_models.UpdateLivyComputeRequestAutoStopConfiguration()
...
class UpdateLivyComputeRequestAutoStopConfiguration(DaraModel):
    def __init__(
        self,
        enable: bool = None,
...
class UpdateLivyComputeRequestAutoStartConfiguration(DaraModel):
    def __init__(
        self,
        enable: bool = None,
    ):

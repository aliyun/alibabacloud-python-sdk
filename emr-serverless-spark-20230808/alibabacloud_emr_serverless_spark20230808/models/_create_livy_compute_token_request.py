...
class CreateLivyComputeTokenRequest(DaraModel):
    def __init__(
        self,
        auto_expire_configuration: main_models.CreateLivyComputeTokenRequestAutoExpireConfiguration = None,
        name: str = None,
        token: str = None,
        region_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('autoExpireConfiguration') is not None:
            temp_model = main_models.CreateLivyComputeTokenRequestAutoExpireConfiguration()
...
class CreateLivyComputeTokenRequestAutoExpireConfiguration(DaraModel):
    def __init__(
        self,
        enable: bool = None,

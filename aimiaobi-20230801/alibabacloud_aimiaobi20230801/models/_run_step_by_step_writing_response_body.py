...
class RunStepByStepWritingResponseBody(DaraModel):
    def __init__(
        self,
        header: main_models.RunStepByStepWritingResponseBodyHeader = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Header') is not None:
            temp_model = main_models.RunStepByStepWritingResponseBodyHeader()
            self.header = temp_model.from_map(m.get('Header'))

        if m.get('Payload') is not None:
            temp_model = main_models.RunStepByStepWritingResponseBodyPayload()
...
class RunStepByStepWritingResponseBodyPayload(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Output') is not None:
            temp_model = main_models.RunStepByStepWritingResponseBodyPayloadOutput()
            self.output = temp_model.from_map(m.get('Output'))

        if m.get('Usage') is not None:
            temp_model = main_models.RunStepByStepWritingResponseBodyPayloadUsage()
            self.usage = temp_model.from_map(m.get('Usage'))

        return self

class RunStepByStepWritingResponseBodyPayloadUsage(DaraModel):
    def __init__(
        self,
...
class RunStepByStepWritingResponseBodyPayloadOutput(DaraModel):
    def __init__(
        self,
        articles: List[main_models.RunStepByStepWritingResponseBodyPayloadOutputArticles] = None,
        extra_output: main_models.RunStepByStepWritingResponseBodyPayloadOutputExtraOutput = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Articles') is not None:
            for k1 in m.get('Articles'):
                temp_model = main_models.RunStepByStepWritingResponseBodyPayloadOutputArticles()
                self.articles.append(temp_model.from_map(k1))

        if m.get('ExtraOutput') is not None:
            temp_model = main_models.RunStepByStepWritingResponseBodyPayloadOutputExtraOutput()
            self.extra_output = temp_model.from_map(m.get('ExtraOutput'))
...
class RunStepByStepWritingResponseBodyPayloadOutputExtraOutput(DaraModel):
    def __init__(
        self,
...
class RunStepByStepWritingResponseBodyPayloadOutputArticles(DaraModel):
    def __init__(
        self,
        author: str = None,
        content: str = None,
...
class RunStepByStepWritingResponseBodyHeader(DaraModel):
    def __init__(
        self,
        error_code: str = None,

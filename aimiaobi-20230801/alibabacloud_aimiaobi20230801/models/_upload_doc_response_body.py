...
class UploadDocResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.UploadDocResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.UploadDocResponseBodyData()
...
class UploadDocResponseBodyData(DaraModel):
    def __init__(
        self,

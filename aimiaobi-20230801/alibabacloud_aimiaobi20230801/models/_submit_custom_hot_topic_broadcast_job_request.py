...
class SubmitCustomHotTopicBroadcastJobRequest(DaraModel):
    def __init__(
        self,
        hot_topic_broadcast_config: main_models.SubmitCustomHotTopicBroadcastJobRequestHotTopicBroadcastConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HotTopicBroadcastConfig') is not None:
            temp_model = main_models.SubmitCustomHotTopicBroadcastJobRequestHotTopicBroadcastConfig()
            self.hot_topic_broadcast_config = temp_model.from_map(m.get('HotTopicBroadcastConfig'))
...
class SubmitCustomHotTopicBroadcastJobRequestHotTopicBroadcastConfig(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('StepForCustomSummaryStyleConfig') is not None:
            temp_model = main_models.SubmitCustomHotTopicBroadcastJobRequestHotTopicBroadcastConfigStepForCustomSummaryStyleConfig()
        ...
        if m.get('StepForNewsBroadcastContentConfig') is not None:
            temp_model = main_models.SubmitCustomHotTopicBroadcastJobRequestHotTopicBroadcastConfigStepForNewsBroadcastContentConfig()
            self.step_for_news_broadcast_content_config = temp_model.from_map(m.get('StepForNewsBroadcastContentConfig'))

        return self

class SubmitCustomHotTopicBroadcastJobRequestHotTopicBroadcastConfigStepForNewsBroadcastContentConfig(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CustomHotValueWeights') is not None:
            for k1 in m.get('CustomHotValueWeights'):
                temp_model = main_models.SubmitCustomHotTopicBroadcastJobRequestHotTopicBroadcastConfigStepForNewsBroadcastContentConfigCustomHotValueWeights()
...
class SubmitCustomHotTopicBroadcastJobRequestHotTopicBroadcastConfigStepForNewsBroadcastContentConfigCustomHotValueWeights(DaraModel):
    def __init__(
        self,
        dimension: str = None,
...
class SubmitCustomHotTopicBroadcastJobRequestHotTopicBroadcastConfigStepForCustomSummaryStyleConfig(DaraModel):
    def __init__(
        self,

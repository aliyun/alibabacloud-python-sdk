...
class RunSearchSimilarArticlesResponseBody(DaraModel):
    def __init__(
        self,
        header: main_models.RunSearchSimilarArticlesResponseBodyHeader = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Header') is not None:
            temp_model = main_models.RunSearchSimilarArticlesResponseBodyHeader()
            self.header = temp_model.from_map(m.get('Header'))

        if m.get('Payload') is not None:
            temp_model = main_models.RunSearchSimilarArticlesResponseBodyPayload()
...
class RunSearchSimilarArticlesResponseBodyPayload(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Output') is not None:
            temp_model = main_models.RunSearchSimilarArticlesResponseBodyPayloadOutput()
            self.output = temp_model.from_map(m.get('Output'))

        if m.get('Usage') is not None:
            temp_model = main_models.RunSearchSimilarArticlesResponseBodyPayloadUsage()
            self.usage = temp_model.from_map(m.get('Usage'))

        return self

class RunSearchSimilarArticlesResponseBodyPayloadUsage(DaraModel):
    def __init__(
        self,
...
class RunSearchSimilarArticlesResponseBodyPayloadOutput(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Articles') is not None:
            for k1 in m.get('Articles'):
                temp_model = main_models.RunSearchSimilarArticlesResponseBodyPayloadOutputArticles()
...
class RunSearchSimilarArticlesResponseBodyHeader(DaraModel):
    def __init__(
        self,
        error_code: str = None,

...
class GetGeneralConfigResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetGeneralConfigResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetGeneralConfigResponseBodyData()
...
class GetGeneralConfigResponseBodyData(DaraModel):
    def __init__(
        self,

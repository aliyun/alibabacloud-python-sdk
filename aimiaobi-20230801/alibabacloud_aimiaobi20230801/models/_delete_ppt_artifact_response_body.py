...
class DeletePptArtifactResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.DeletePptArtifactResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DeletePptArtifactResponseBodyData()
...
class DeletePptArtifactResponseBodyData(DaraModel):
    def __init__(
        self,

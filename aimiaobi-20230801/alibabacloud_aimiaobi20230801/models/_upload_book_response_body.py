...
class UploadBookResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.UploadBookResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.UploadBookResponseBodyData()
...
class UploadBookResponseBodyData(DaraModel):
    def __init__(
        self,

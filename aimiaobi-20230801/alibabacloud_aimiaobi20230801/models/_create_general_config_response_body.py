...
class CreateGeneralConfigResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.CreateGeneralConfigResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CreateGeneralConfigResponseBodyData()
...
class CreateGeneralConfigResponseBodyData(DaraModel):
    def __init__(
        self,

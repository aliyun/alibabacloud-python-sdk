...
class RunWritingV2ResponseBody(DaraModel):
    def __init__(
        self,
        end: bool = None,
        header: main_models.RunWritingV2ResponseBodyHeader = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Header') is not None:
            temp_model = main_models.RunWritingV2ResponseBodyHeader()
            self.header = temp_model.from_map(m.get('Header'))

        if m.get('Payload') is not None:
            temp_model = main_models.RunWritingV2ResponseBodyPayload()
...
class RunWritingV2ResponseBodyPayload(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Output') is not None:
            temp_model = main_models.RunWritingV2ResponseBodyPayloadOutput()
            self.output = temp_model.from_map(m.get('Output'))

        if m.get('Usage') is not None:
            temp_model = main_models.RunWritingV2ResponseBodyPayloadUsage()
            self.usage = temp_model.from_map(m.get('Usage'))

        return self

class RunWritingV2ResponseBodyPayloadUsage(DaraModel):
    def __init__(
        self,
...
class RunWritingV2ResponseBodyPayloadOutput(DaraModel):
    def __init__(
        self,
        articles: List[main_models.RunWritingV2ResponseBodyPayloadOutputArticles] = None,
        generate_traceability: main_models.GenerateTraceability = None,
        mini_doc: List[str] = None,
        outlines: List[main_models.WritingOutline] = None,
        search_query: str = None,
        search_result: main_models.OutlineSearchResult = None,
        text: str = None,
        title: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Articles') is not None:
            for k1 in m.get('Articles'):
                temp_model = main_models.RunWritingV2ResponseBodyPayloadOutputArticles()
                self.articles.append(temp_model.from_map(k1))

        if m.get('GenerateTraceability') is not None:
            temp_model = main_models.GenerateTraceability()
        ...
        if m.get('SearchResult') is not None:
            temp_model = main_models.OutlineSearchResult()
...
class RunWritingV2ResponseBodyPayloadOutputArticles(DaraModel):
    def __init__(
        self,
        author: str = None,
        content: str = None,
...
class RunWritingV2ResponseBodyHeader(DaraModel):
    def __init__(
        self,
        error_code: str = None,

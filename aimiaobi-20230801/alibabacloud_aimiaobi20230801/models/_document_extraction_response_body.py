...
class DocumentExtractionResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: List[main_models.DocumentExtractionResponseBodyData] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.DocumentExtractionResponseBodyData()
...
class DocumentExtractionResponseBodyData(DaraModel):
    def __init__(
        self,
        author: str = None,
        content: str = None,

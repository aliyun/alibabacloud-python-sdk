...
class RunBookIntroductionResponseBody(DaraModel):
    def __init__(
        self,
        header: main_models.RunBookIntroductionResponseBodyHeader = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Header') is not None:
            temp_model = main_models.RunBookIntroductionResponseBodyHeader()
            self.header = temp_model.from_map(m.get('Header'))

        if m.get('Payload') is not None:
            temp_model = main_models.RunBookIntroductionResponseBodyPayload()
...
class RunBookIntroductionResponseBodyPayload(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Output') is not None:
            temp_model = main_models.RunBookIntroductionResponseBodyPayloadOutput()
            self.output = temp_model.from_map(m.get('Output'))

        if m.get('Usage') is not None:
            temp_model = main_models.RunBookIntroductionResponseBodyPayloadUsage()
            self.usage = temp_model.from_map(m.get('Usage'))

        return self

class RunBookIntroductionResponseBodyPayloadUsage(DaraModel):
    def __init__(
        self,
...
class RunBookIntroductionResponseBodyHeader(DaraModel):
    def __init__(
        self,
        error_code: str = None,

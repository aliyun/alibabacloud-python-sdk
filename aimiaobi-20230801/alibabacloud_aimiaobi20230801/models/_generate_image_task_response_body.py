...
class GenerateImageTaskResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GenerateImageTaskResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GenerateImageTaskResponseBodyData()
...
class GenerateImageTaskResponseBodyData(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TaskList') is not None:
            for k1 in m.get('TaskList'):
                temp_model = main_models.GenerateImageTaskResponseBodyDataTaskList()
                self.task_list.append(temp_model.from_map(k1))

        return self

class GenerateImageTaskResponseBodyDataTaskList(DaraModel):
    def __init__(
        self,
        content: str = None,
        id: int = None,

...
```bash
# 安装 alibabacloud_alikafkakopilot20260414
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/alikafkakopilot-20260414/ChangeLog.md)中。

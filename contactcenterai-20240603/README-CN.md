...
```bash
# 安装 alibabacloud_contactcenterai20240603
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/contactcenterai-20240603/ChangeLog.md)中。

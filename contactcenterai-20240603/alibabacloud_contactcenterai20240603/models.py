...
class GeneralAnalyzeImageRequest(TeaModel):
    def __init__(
        self,
        custom_prompt: str = None,
        image_urls: List[str] = None,
...
class GeneralAnalyzeImageResponseBody(TeaModel):
    def __init__(
        self,
        finish_reason: str = None,
...
class GeneralAnalyzeImageResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GeneralAnalyzeImageResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GeneralAnalyzeImageResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

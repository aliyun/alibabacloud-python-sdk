...
class UpdateVocabRequest(DaraModel):
    def __init__(
        self,
        description: str = None,
        name: str = None,
        vocabulary_id: str = None,
        word_weight_list: List[main_models.UpdateVocabRequestWordWeightList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('wordWeightList') is not None:
            for k1 in m.get('wordWeightList'):
                temp_model = main_models.UpdateVocabRequestWordWeightList()
...
class UpdateVocabRequestWordWeightList(DaraModel):
    def __init__(
        self,
        weight: int = None,
        word: str = None,

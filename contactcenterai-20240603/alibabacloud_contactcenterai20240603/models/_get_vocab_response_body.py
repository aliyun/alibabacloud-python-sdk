...
class GetVocabResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.GetVocabResponseBodyData = None,
        request_id: str = None,
        success: str = None,
    ):
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            temp_model = main_models.GetVocabResponseBodyData()
...
class GetVocabResponseBodyData(DaraModel):
    def __init__(
        self,
        ...
        word_weight_list: List[main_models.GetVocabResponseBodyDataWordWeightList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('wordWeightList') is not None:
            for k1 in m.get('wordWeightList'):
                temp_model = main_models.GetVocabResponseBodyDataWordWeightList()
                self.word_weight_list.append(temp_model.from_map(k1))

        return self

class GetVocabResponseBodyDataWordWeightList(DaraModel):
    def __init__(
        self,
        weight: int = None,
        word: str = None,

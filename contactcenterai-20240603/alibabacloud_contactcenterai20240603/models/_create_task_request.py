...
class CreateTaskRequest(DaraModel):
    def __init__(
        ...
        category_tags: List[main_models.CreateTaskRequestCategoryTags] = None,
        custom_prompt: str = None,
        dialogue: main_models.CreateTaskRequestDialogue = None,
        examples: main_models.CreateTaskRequestExamples = None,
        fields: List[main_models.CreateTaskRequestFields] = None,
        model_code: str = None,
        response_format_type: str = None,
        result_types: List[str] = None,
        service_inspection: main_models.CreateTaskRequestServiceInspection = None,
        task_type: str = None,
        template_ids: List[str] = None,
        transcription: main_models.CreateTaskRequestTranscription = None,
        variables: List[main_models.CreateTaskRequestVariables] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('categoryTags') is not None:
            for k1 in m.get('categoryTags'):
                temp_model = main_models.CreateTaskRequestCategoryTags()
        ...
        if m.get('dialogue') is not None:
            temp_model = main_models.CreateTaskRequestDialogue()
            self.dialogue = temp_model.from_map(m.get('dialogue'))

        if m.get('examples') is not None:
            temp_model = main_models.CreateTaskRequestExamples()
            self.examples = temp_model.from_map(m.get('examples'))

        self.fields = []
        if m.get('fields') is not None:
            for k1 in m.get('fields'):
                temp_model = main_models.CreateTaskRequestFields()
        ...
        if m.get('serviceInspection') is not None:
            temp_model = main_models.CreateTaskRequestServiceInspection()
        ...
        if m.get('transcription') is not None:
            temp_model = main_models.CreateTaskRequestTranscription()
            self.transcription = temp_model.from_map(m.get('transcription'))

        self.variables = []
        if m.get('variables') is not None:
            for k1 in m.get('variables'):
                temp_model = main_models.CreateTaskRequestVariables()
                self.variables.append(temp_model.from_map(k1))

        return self

class CreateTaskRequestVariables(DaraModel):
    def __init__(
        self,
...
class CreateTaskRequestTranscription(DaraModel):
    def __init__(
        self,
...
class CreateTaskRequestServiceInspection(DaraModel):
    def __init__(
        self,
        inspection_contents: List[main_models.CreateTaskRequestServiceInspectionInspectionContents] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('inspectionContents') is not None:
            for k1 in m.get('inspectionContents'):
                temp_model = main_models.CreateTaskRequestServiceInspectionInspectionContents()
...
class CreateTaskRequestServiceInspectionInspectionContents(DaraModel):
    def __init__(
        self,
        content: str = None,
        title: str = None,
...
class CreateTaskRequestFields(DaraModel):
    def __init__(
        self,
        code: str = None,
        desc: str = None,
        enum_values: List[main_models.CreateTaskRequestFieldsEnumValues] = None,
        name: str = None,
    ):
        self.code = code
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('enumValues') is not None:
            for k1 in m.get('enumValues'):
                temp_model = main_models.CreateTaskRequestFieldsEnumValues()
...
class CreateTaskRequestFieldsEnumValues(DaraModel):
    def __init__(
        self,
        desc: str = None,
        enum_value: str = None,
...
class CreateTaskRequestExamples(DaraModel):
    def __init__(
        self,
        output: str = None,
        sentences: List[main_models.CreateTaskRequestExamplesSentences] = None,
    ):
        self.output = output
        # This parameter is required.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('sentences') is not None:
            for k1 in m.get('sentences'):
                temp_model = main_models.CreateTaskRequestExamplesSentences()
                self.sentences.append(temp_model.from_map(k1))

        return self

class CreateTaskRequestExamplesSentences(DaraModel):
    def __init__(
        self,
        role: str = None,
        text: str = None,
...
class CreateTaskRequestDialogue(DaraModel):
    def __init__(
        self,
        sentences: List[main_models.CreateTaskRequestDialogueSentences] = None,
        session_id: str = None,
    ):
        # This parameter is required.
        self.sentences = sentences
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('sentences') is not None:
            for k1 in m.get('sentences'):
                temp_model = main_models.CreateTaskRequestDialogueSentences()
                self.sentences.append(temp_model.from_map(k1))
...
class CreateTaskRequestDialogueSentences(DaraModel):
    def __init__(
        self,
        role: str = None,
        text: str = None,
...
class CreateTaskRequestCategoryTags(DaraModel):
    def __init__(
        self,
        tag_desc: str = None,
        tag_name: str = None,

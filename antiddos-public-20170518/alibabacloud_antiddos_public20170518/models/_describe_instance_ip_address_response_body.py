...
class DescribeInstanceIpAddressResponseBody(DaraModel):
    def __init__(
        self,
        instance_list: List[main_models.DescribeInstanceIpAddressResponseBodyInstanceList] = None,
        request_id: str = None,
        total: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InstanceList') is not None:
            for k1 in m.get('InstanceList'):
                temp_model = main_models.DescribeInstanceIpAddressResponseBodyInstanceList()
...
class DescribeInstanceIpAddressResponseBodyInstanceList(DaraModel):
    def __init__(
        self,
        ...
        ip_address_config: List[main_models.DescribeInstanceIpAddressResponseBodyInstanceListIpAddressConfig] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IpAddressConfig') is not None:
            for k1 in m.get('IpAddressConfig'):
                temp_model = main_models.DescribeInstanceIpAddressResponseBodyInstanceListIpAddressConfig()
                self.ip_address_config.append(temp_model.from_map(k1))

        return self

class DescribeInstanceIpAddressResponseBodyInstanceListIpAddressConfig(DaraModel):
    def __init__(
        self,

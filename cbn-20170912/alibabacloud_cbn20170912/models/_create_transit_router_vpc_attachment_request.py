...
class CreateTransitRouterVpcAttachmentRequest(DaraModel):
    def __init__(
        self,
        ...
        tag: List[main_models.CreateTransitRouterVpcAttachmentRequestTag] = None,
        ...
        zone_mappings: List[main_models.CreateTransitRouterVpcAttachmentRequestZoneMappings] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.CreateTransitRouterVpcAttachmentRequestTag()
        ...
        if m.get('ZoneMappings') is not None:
            for k1 in m.get('ZoneMappings'):
                temp_model = main_models.CreateTransitRouterVpcAttachmentRequestZoneMappings()
                self.zone_mappings.append(temp_model.from_map(k1))

        return self

class CreateTransitRouterVpcAttachmentRequestZoneMappings(DaraModel):
    def __init__(
        self,
...
class CreateTransitRouterVpcAttachmentRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

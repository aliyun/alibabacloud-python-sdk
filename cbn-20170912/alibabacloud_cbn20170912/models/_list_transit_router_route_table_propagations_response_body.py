...
class ListTransitRouterRouteTablePropagationsResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def validate(self):
        if self.transit_router_propagations:
            for v1 in self.transit_router_propagations:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.transit_router_propagations is not None:
            for k1 in self.transit_router_propagations:
                result['TransitRouterPropagations'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TransitRouterPropagations') is not None:
            for k1 in m.get('TransitRouterPropagations'):
                temp_model = main_models.ListTransitRouterRouteTablePropagationsResponseBodyTransitRouterPropagations()
                self.transit_router_propagations.append(temp_model.from_map(k1))

        return self

class ListTransitRouterRouteTablePropagationsResponseBodyTransitRouterPropagations(DaraModel):
    def __init__(
        self,

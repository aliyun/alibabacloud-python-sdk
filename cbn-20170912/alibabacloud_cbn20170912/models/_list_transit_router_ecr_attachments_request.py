...
class ListTransitRouterEcrAttachmentsRequest(DaraModel):
    def __init__(
        self,
        cen_id: str = None,
        ...
        tag: List[main_models.ListTransitRouterEcrAttachmentsRequestTag] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.ListTransitRouterEcrAttachmentsRequestTag()
...
class ListTransitRouterEcrAttachmentsRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

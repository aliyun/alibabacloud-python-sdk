...
```bash
# 安装 alibabacloud_cbn20170912
pip install alibabacloud_cbn20170912
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/cbn-20170912/ChangeLog.md)中。

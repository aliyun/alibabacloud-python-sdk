...
class JudgeNodeMetaDescExpressionMetaDesc(TeaModel):
    def __init__(
        self,
...
class JudgeNodeMetaDesc(TeaModel):
    def __init__(
        ...
        data_type: int = None,
        expression_meta_desc: JudgeNodeMetaDescExpressionMetaDesc = None,
        field: str = None,
        field_type: int = None,
        symbol: int = None,
        value: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ExpressionMetaDesc') is not None:
            temp_model = JudgeNodeMetaDescExpressionMetaDesc()
            self.expression_meta_desc = temp_model.from_map(m['ExpressionMetaDesc'])
...
class CreateMiningTaskRequest(TeaModel):
    def __init__(
        self,
        base_me_agent_id: int = None,
...
class CreateMiningTaskResponseBodyData(TeaModel):
    def __init__(
        self,
        task_id: str = None,
    ):
...
class CreateMiningTaskResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        data: CreateMiningTaskResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Code') is not None:
            self.code = m.get('Code')
        if m.get('Data') is not None:
            temp_model = CreateMiningTaskResponseBodyData()
            self.data = temp_model.from_map(m['Data'])
        if m.get('HttpStatusCode') is not None:
            self.http_status_code = m.get('HttpStatusCode')
        if m.get('Message') is not None:
...
class CreateMiningTaskResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CreateMiningTaskResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CreateMiningTaskResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class GetMiningTaskResultRequest(TeaModel):
    def __init__(
        self,
        base_me_agent_id: int = None,
        task_id: str = None,
...
class GetMiningTaskResultResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        data: GetMiningTaskResultResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Code') is not None:
            self.code = m.get('Code')
        if m.get('Data') is not None:
            temp_model = GetMiningTaskResultResponseBodyData()
            self.data = temp_model.from_map(m['Data'])
        if m.get('Message') is not None:
            self.message = m.get('Message')
        if m.get('RequestId') is not None:
...
class GetMiningTaskResultResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetMiningTaskResultResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetMiningTaskResultResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class GetSchemeTaskConfigRequest(TeaModel):
    def __init__(
        self,
        base_me_agent_id: int = None,
        json_str: str = None,
...
class GetSchemeTaskConfigResponseBodyDataDataConfigAssignConfigsAssignConfigContests(TeaModel):
    def __init__(
        self,
        data_type: int = None,
...
class GetSchemeTaskConfigResponseBodyDataDataConfigAssignConfigs(TeaModel):
    def __init__(
        self,
        assign_config_contests: List[GetSchemeTaskConfigResponseBodyDataDataConfigAssignConfigsAssignConfigContests] = None,
    ):
        self.assign_config_contests = assign_config_contests

    def validate(self):
        if self.assign_config_contests:
            for k in self.assign_config_contests:
                if k:
                    k.validate()
    ...
    def to_map(self):
        ...
        if self.assign_config_contests is not None:
            for k in self.assign_config_contests:
                result['AssignConfigContests'].append(k.to_map() if k else None)
        return result
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AssignConfigContests') is not None:
            for k in m.get('AssignConfigContests'):
                temp_model = GetSchemeTaskConfigResponseBodyDataDataConfigAssignConfigsAssignConfigContests()
                self.assign_config_contests.append(temp_model.from_map(k))
        return self


class GetSchemeTaskConfigResponseBodyDataDataConfig(TeaModel):
    def __init__(
        self,
        assign_configs: List[GetSchemeTaskConfigResponseBodyDataDataConfigAssignConfigs] = None,
        data_sets: str = None,
        index: int = None,
    ...
    def to_map(self):
        ...
        if self.assign_configs is not None:
            for k in self.assign_configs:
                result['AssignConfigs'].append(k.to_map() if k else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AssignConfigs') is not None:
            for k in m.get('AssignConfigs'):
                temp_model = GetSchemeTaskConfigResponseBodyDataDataConfigAssignConfigs()
                self.assign_configs.append(temp_model.from_map(k))
...
class GetSchemeTaskConfigResponseBodyDataSchemeList(TeaModel):
    def __init__(
        self,
        name: str = None,
        scheme_id: int = None,
...
class GetSchemeTaskConfigResponseBodyData(TeaModel):
    def __init__(
        self,
        asr_task_priority: int = None,
        assign_type: int = None,
        data_config: GetSchemeTaskConfigResponseBodyDataDataConfig = None,
        id: int = None,
        ...
        name: str = None,
        scheme_id_list: List[int] = None,
        scheme_list: List[GetSchemeTaskConfigResponseBodyDataSchemeList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataConfig') is not None:
            temp_model = GetSchemeTaskConfigResponseBodyDataDataConfig()
        ...
        if m.get('SchemeList') is not None:
            for k in m.get('SchemeList'):
                temp_model = GetSchemeTaskConfigResponseBodyDataSchemeList()
...
class GetSchemeTaskConfigResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        data: GetSchemeTaskConfigResponseBodyData = None,
        http_status_code: str = None,
        message: str = None,
        request_id: str = None,
        success: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Code') is not None:
            self.code = m.get('Code')
        if m.get('Data') is not None:
            temp_model = GetSchemeTaskConfigResponseBodyData()
            self.data = temp_model.from_map(m['Data'])
        if m.get('HttpStatusCode') is not None:
            self.http_status_code = m.get('HttpStatusCode')
        if m.get('Message') is not None:
...
class GetSchemeTaskConfigResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: GetSchemeTaskConfigResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetSchemeTaskConfigResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class UploadDataSyncForLLMRequest(TeaModel):
    def __init__(
        self,
        base_me_agent_id: int = None,
        json_str: str = None,
...
class UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoConditionInfoConditionBasicInfo(TeaModel):
    def __init__(
        self,
        condition_info_cid: str = None,
    ):
...
class UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoConditionInfo(TeaModel):
    def __init__(
        self,
        condition_basic_info: List[UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoConditionInfoConditionBasicInfo] = None,
    ):
        self.condition_basic_info = condition_basic_info
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConditionBasicInfo') is not None:
            for k in m.get('ConditionBasicInfo'):
                temp_model = UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoConditionInfoConditionBasicInfo()
                self.condition_basic_info.append(temp_model.from_map(k))
        return self


class UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHitConditionHitInfoHitCids(TeaModel):
    def __init__(
        self,
        cid_item: List[str] = None,
    ):
...
class UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHitConditionHitInfoHitKeyWordsHitKeyWord(TeaModel):
    def __init__(
        self,
        from_: int = None,
        pid: int = None,
...
class UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHitConditionHitInfoHitKeyWords(TeaModel):
    def __init__(
        self,
        hit_key_word: List[UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHitConditionHitInfoHitKeyWordsHitKeyWord] = None,
    ):
        self.hit_key_word = hit_key_word
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HitKeyWord') is not None:
            for k in m.get('HitKeyWord'):
                temp_model = UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHitConditionHitInfoHitKeyWordsHitKeyWord()
                self.hit_key_word.append(temp_model.from_map(k))
        return self


class UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHitConditionHitInfoPhrase(TeaModel):
    def __init__(
        self,
        begin: int = None,
        begin_time: str = None,
...
class UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHitConditionHitInfo(TeaModel):
    def __init__(
        self,
        hit_cids: UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHitConditionHitInfoHitCids = None,
        hit_key_words: UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHitConditionHitInfoHitKeyWords = None,
        phrase: UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHitConditionHitInfoPhrase = None,
    ):
        self.hit_cids = hit_cids
        self.hit_key_words = hit_key_words
        self.phrase = phrase
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('HitCids') is not None:
            temp_model = UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHitConditionHitInfoHitCids()
            self.hit_cids = temp_model.from_map(m['HitCids'])
        if m.get('HitKeyWords') is not None:
            temp_model = UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHitConditionHitInfoHitKeyWords()
            self.hit_key_words = temp_model.from_map(m['HitKeyWords'])
        if m.get('Phrase') is not None:
            temp_model = UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHitConditionHitInfoPhrase()
            self.phrase = temp_model.from_map(m['Phrase'])
        return self


class UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHit(TeaModel):
    def __init__(
        self,
        condition_hit_info: List[UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHitConditionHitInfo] = None,
    ):
        self.condition_hit_info = condition_hit_info
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConditionHitInfo') is not None:
            for k in m.get('ConditionHitInfo'):
                temp_model = UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHitConditionHitInfo()
                self.condition_hit_info.append(temp_model.from_map(k))
        return self


class UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfo(TeaModel):
    def __init__(
        self,
        condition_info: UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoConditionInfo = None,
        hit: UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHit = None,
        rid: str = None,
        tid: str = None,
    ):
        self.condition_info = condition_info
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('ConditionInfo') is not None:
            temp_model = UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoConditionInfo()
            self.condition_info = temp_model.from_map(m['ConditionInfo'])
        if m.get('Hit') is not None:
            temp_model = UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfoHit()
            self.hit = temp_model.from_map(m['Hit'])
        if m.get('Rid') is not None:
            self.rid = m.get('Rid')
        if m.get('Tid') is not None:
...
class UploadDataSyncForLLMResponseBodyDataResultInfoRules(TeaModel):
    def __init__(
        self,
        rule_hit_info: List[UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfo] = None,
    ):
        self.rule_hit_info = rule_hit_info
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RuleHitInfo') is not None:
            for k in m.get('RuleHitInfo'):
                temp_model = UploadDataSyncForLLMResponseBodyDataResultInfoRulesRuleHitInfo()
                self.rule_hit_info.append(temp_model.from_map(k))
        return self


class UploadDataSyncForLLMResponseBodyDataResultInfo(TeaModel):
    def __init__(
        self,
        rules: UploadDataSyncForLLMResponseBodyDataResultInfoRules = None,
        score: int = None,
    ):
        self.rules = rules
        self.score = score
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('Rules') is not None:
            temp_model = UploadDataSyncForLLMResponseBodyDataResultInfoRules()
            self.rules = temp_model.from_map(m['Rules'])
        if m.get('Score') is not None:
            self.score = m.get('Score')
        return self
...
class UploadDataSyncForLLMResponseBodyData(TeaModel):
    def __init__(
        self,
        result_info: List[UploadDataSyncForLLMResponseBodyDataResultInfo] = None,
    ):
        self.result_info = result_info
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResultInfo') is not None:
            for k in m.get('ResultInfo'):
                temp_model = UploadDataSyncForLLMResponseBodyDataResultInfo()
                self.result_info.append(temp_model.from_map(k))
        return self


class UploadDataSyncForLLMResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        data: UploadDataSyncForLLMResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Code') is not None:
            self.code = m.get('Code')
        if m.get('Data') is not None:
            temp_model = UploadDataSyncForLLMResponseBodyData()
            self.data = temp_model.from_map(m['Data'])
        if m.get('Message') is not None:
            self.message = m.get('Message')
        if m.get('RequestId') is not None:
...
class UploadDataSyncForLLMResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: UploadDataSyncForLLMResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = UploadDataSyncForLLMResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

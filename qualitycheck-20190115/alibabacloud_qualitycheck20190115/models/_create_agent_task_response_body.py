...
class CreateAgentTaskResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.CreateAgentTaskResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CreateAgentTaskResponseBodyData()
...
class CreateAgentTaskResponseBodyData(DaraModel):
    def __init__(
        self,
        task_id: str = None,
        vid: str = None,

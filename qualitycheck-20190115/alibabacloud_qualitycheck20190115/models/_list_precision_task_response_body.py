...
class ListPrecisionTaskResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        count: int = None,
        data: main_models.ListPrecisionTaskResponseBodyData = None,
        message: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ListPrecisionTaskResponseBodyData()
...
class ListPrecisionTaskResponseBodyData(DaraModel):
    def __init__(
        self,
        precision_task: List[main_models.ListPrecisionTaskResponseBodyDataPrecisionTask] = None,
    ):
        self.precision_task = precision_task

    def validate(self):
        if self.precision_task:
            for v1 in self.precision_task:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.precision_task is not None:
            for k1 in self.precision_task:
                result['PrecisionTask'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PrecisionTask') is not None:
            for k1 in m.get('PrecisionTask'):
                temp_model = main_models.ListPrecisionTaskResponseBodyDataPrecisionTask()
                self.precision_task.append(temp_model.from_map(k1))

        return self

class ListPrecisionTaskResponseBodyDataPrecisionTask(DaraModel):
    def __init__(
        self,
        ...
        name: str = None,
        precisions: main_models.ListPrecisionTaskResponseBodyDataPrecisionTaskPrecisions = None,
        source: int = None,
        status: int = None,
        task_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Precisions') is not None:
            temp_model = main_models.ListPrecisionTaskResponseBodyDataPrecisionTaskPrecisions()
...
class ListPrecisionTaskResponseBodyDataPrecisionTaskPrecisions(DaraModel):
    def __init__(
        self,
        precision: List[main_models.ListPrecisionTaskResponseBodyDataPrecisionTaskPrecisionsPrecision] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Precision') is not None:
            for k1 in m.get('Precision'):
                temp_model = main_models.ListPrecisionTaskResponseBodyDataPrecisionTaskPrecisionsPrecision()
                self.precision.append(temp_model.from_map(k1))

        return self

class ListPrecisionTaskResponseBodyDataPrecisionTaskPrecisionsPrecision(DaraModel):
    def __init__(
        self,
        create_time: str = None,
        model_id: int = None,

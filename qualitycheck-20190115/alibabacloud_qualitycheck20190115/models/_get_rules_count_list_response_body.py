...
class GetRulesCountListResponseBody(DaraModel):
    def __init__(
        self,
        ...
        data: main_models.GetRulesCountListResponseBodyData = None,
        http_status_code: int = None,
        message: str = None,
        messages: main_models.GetRulesCountListResponseBodyMessages = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetRulesCountListResponseBodyData()
        ...
        if m.get('Messages') is not None:
            temp_model = main_models.GetRulesCountListResponseBodyMessages()
...
class GetRulesCountListResponseBodyMessages(DaraModel):
    def __init__(
        self,
...
class GetRulesCountListResponseBodyData(DaraModel):
    def __init__(
        self,
        data: List[str] = None,
    ):

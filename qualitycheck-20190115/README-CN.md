...
```bash
# 安装 alibabacloud_qualitycheck20190115
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/qualitycheck-20190115/ChangeLog.md)中。

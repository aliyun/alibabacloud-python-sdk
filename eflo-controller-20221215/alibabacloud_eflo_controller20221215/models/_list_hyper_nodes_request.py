...
class ListHyperNodesRequest(DaraModel):
    def __init__(
        self,
        ...
        tags: List[main_models.ListHyperNodesRequestTags] = None,
        zone_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.ListHyperNodesRequestTags()
...
class ListHyperNodesRequestTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

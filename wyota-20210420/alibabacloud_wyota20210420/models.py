...
class AddTerminalsRequestAddTerminalParams(TeaModel):
    def __init__(
        self,
        alias: str = None,
...
class AddTerminalsRequest(TeaModel):
    def __init__(
        self,
...
class AddTerminalsResponseBodyData(TeaModel):
    def __init__(
        self,
        error_code: str = None,
        serial_number: str = None,
...
class AddTerminalsResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        data: List[AddTerminalsResponseBodyData] = None,
        http_status_code: int = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k in m.get('Data'):
                temp_model = AddTerminalsResponseBodyData()
...
class AddTerminalsResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: AddTerminalsResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = AddTerminalsResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class BindPasswordFreeLoginUserRequest(TeaModel):
    def __init__(
        self,
        end_user_id: str = None,
        serial_number: str = None,
...
class BindPasswordFreeLoginUserResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        http_status_code: int = None,
...
class BindPasswordFreeLoginUserResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: BindPasswordFreeLoginUserResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = BindPasswordFreeLoginUserResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class UnbindPasswordFreeLoginUserResponseBody(TeaModel):
    def __init__(
        self,
        code: str = None,
        http_status_code: int = None,
...
class UnbindPasswordFreeLoginUserResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: UnbindPasswordFreeLoginUserResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = UnbindPasswordFreeLoginUserResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

...
## Alibaba Cloud wyota SDK for Python
...
```bash
# 安装 alibabacloud_wyota20210420
pip install alibabacloud_wyota20210420
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/wyota-20210420/ChangeLog.md)中。

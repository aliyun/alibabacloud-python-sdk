...
class CreateImageBuildRequestBuildConfig(TeaModel):
    def __init__(
        self,
        build_type: str = None,
        dockerfile: str = None,
...
class CreateImageBuildRequestImageLabels(TeaModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class CreateImageBuildRequestImage(TeaModel):
    def __init__(
        self,
        description: str = None,
        labels: List[CreateImageBuildRequestImageLabels] = None,
        name: str = None,
        uri: str = None,
    ):
        self.description = description
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Labels') is not None:
            for k in m.get('Labels'):
                temp_model = CreateImageBuildRequestImageLabels()
                self.labels.append(temp_model.from_map(k))
        if m.get('Name') is not None:
            self.name = m.get('Name')
        if m.get('Uri') is not None:
...
class CreateImageBuildRequestResourceResourceConfig(TeaModel):
    def __init__(
        self,
        cpu: str = None,
        memory: str = None,
...
class CreateImageBuildRequestResource(TeaModel):
    def __init__(
        self,
        ecs_spec: str = None,
        resource_config: CreateImageBuildRequestResourceResourceConfig = None,
        resource_id: str = None,
        resource_type: str = None,
    ):
        # 后付费资源规格
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResourceConfig') is not None:
            temp_model = CreateImageBuildRequestResourceResourceConfig()
...
class CreateImageBuildRequestTargetRegistry(TeaModel):
    def __init__(
        self,
        instance_id: str = None,
        type: str = None,
...
class CreateImageBuildRequestUserVpc(TeaModel):
    def __init__(
        self,
...
class CreateImageBuildRequest(TeaModel):
    def __init__(
        self,
        client_token: str = None,
        accessibility: str = None,
        build_config: CreateImageBuildRequestBuildConfig = None,
        image: CreateImageBuildRequestImage = None,
        image_build_job_name: str = None,
        overwrite_image_tag: bool = None,
        region_id: str = None,
        resource: CreateImageBuildRequestResource = None,
        target_registry: CreateImageBuildRequestTargetRegistry = None,
        user_vpc: CreateImageBuildRequestUserVpc = None,
        workspace_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BuildConfig') is not None:
            temp_model = CreateImageBuildRequestBuildConfig()
            self.build_config = temp_model.from_map(m['BuildConfig'])
        if m.get('Image') is not None:
            temp_model = CreateImageBuildRequestImage()
        ...
        if m.get('Resource') is not None:
            temp_model = CreateImageBuildRequestResource()
            self.resource = temp_model.from_map(m['Resource'])
        if m.get('TargetRegistry') is not None:
            temp_model = CreateImageBuildRequestTargetRegistry()
            self.target_registry = temp_model.from_map(m['TargetRegistry'])
        if m.get('UserVpc') is not None:
            temp_model = CreateImageBuildRequestUserVpc()
...
class CreateImageBuildResponseBody(TeaModel):
    def __init__(
        self,
...
class CreateImageBuildResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: CreateImageBuildResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = CreateImageBuildResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

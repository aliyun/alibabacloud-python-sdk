...
class CreateWorkspaceRoleRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ModulePermissions') is not None:
            for k1 in m.get('ModulePermissions'):
                temp_model = main_models.CreateWorkspaceRoleRequestModulePermissions()
...
class CreateWorkspaceRoleRequestModulePermissions(DaraModel):
    def __init__(
        self,
        module_name: str = None,
        permission_type: str = None,
        permissions: List[main_models.CreateWorkspaceRoleRequestModulePermissionsPermissions] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Permissions') is not None:
            for k1 in m.get('Permissions'):
                temp_model = main_models.CreateWorkspaceRoleRequestModulePermissionsPermissions()
                self.permissions.append(temp_model.from_map(k1))

        return self

class CreateWorkspaceRoleRequestModulePermissionsPermissions(DaraModel):
    def __init__(
        self,
        permission_codes: List[str] = None,
        permission_rules: List[main_models.CreateWorkspaceRoleRequestModulePermissionsPermissionsPermissionRules] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PermissionRules') is not None:
            for k1 in m.get('PermissionRules'):
                temp_model = main_models.CreateWorkspaceRoleRequestModulePermissionsPermissionsPermissionRules()
                self.permission_rules.append(temp_model.from_map(k1))

        return self

class CreateWorkspaceRoleRequestModulePermissionsPermissionsPermissionRules(DaraModel):
    def __init__(
        self,

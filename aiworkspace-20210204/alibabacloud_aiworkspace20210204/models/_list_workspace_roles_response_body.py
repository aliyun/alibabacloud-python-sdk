...
class ListWorkspaceRolesResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        roles: List[main_models.ListWorkspaceRolesResponseBodyRoles] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Roles') is not None:
            for k1 in m.get('Roles'):
                temp_model = main_models.ListWorkspaceRolesResponseBodyRoles()
...
class ListWorkspaceRolesResponseBodyRoles(DaraModel):
    def __init__(
        self,
        creator: str = None,
        gmt_create_time: str = None,
        gmt_modified_time: str = None,
        module_permissions: List[main_models.ListWorkspaceRolesResponseBodyRolesModulePermissions] = None,
        role_id: str = None,
        role_name: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ModulePermissions') is not None:
            for k1 in m.get('ModulePermissions'):
                temp_model = main_models.ListWorkspaceRolesResponseBodyRolesModulePermissions()
...
class ListWorkspaceRolesResponseBodyRolesModulePermissions(DaraModel):
    def __init__(
        self,
        module_name: str = None,
        permission_type: str = None,
        permissions: List[main_models.ListWorkspaceRolesResponseBodyRolesModulePermissionsPermissions] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Permissions') is not None:
            for k1 in m.get('Permissions'):
                temp_model = main_models.ListWorkspaceRolesResponseBodyRolesModulePermissionsPermissions()
                self.permissions.append(temp_model.from_map(k1))

        return self

class ListWorkspaceRolesResponseBodyRolesModulePermissionsPermissions(DaraModel):
    def __init__(
        self,
        permission_codes: List[str] = None,
        permission_rules: List[main_models.ListWorkspaceRolesResponseBodyRolesModulePermissionsPermissionsPermissionRules] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PermissionRules') is not None:
            for k1 in m.get('PermissionRules'):
                temp_model = main_models.ListWorkspaceRolesResponseBodyRolesModulePermissionsPermissionsPermissionRules()
                self.permission_rules.append(temp_model.from_map(k1))

        return self

class ListWorkspaceRolesResponseBodyRolesModulePermissionsPermissionsPermissionRules(DaraModel):
    def __init__(
        self,

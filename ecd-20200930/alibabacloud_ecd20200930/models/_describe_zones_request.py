...
class DescribeZonesRequest(DaraModel):
    ...
    def to_map(self):
        ...
        if self.vpc_access_zone is not None:
            result['VpcAccessZone'] = self.vpc_access_zone
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VpcAccessZone') is not None:
            self.vpc_access_zone = m.get('VpcAccessZone')

...
class ModifyTimerGroupRequest(DaraModel):
    def __init__(
        self,
        config_timers: List[main_models.ModifyTimerGroupRequestConfigTimers] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ConfigTimers') is not None:
            for k1 in m.get('ConfigTimers'):
                temp_model = main_models.ModifyTimerGroupRequestConfigTimers()
...
class ModifyTimerGroupRequestConfigTimers(DaraModel):
    def __init__(
        self,
        ...
        reset_type: str = None,
        segment_timers: List[main_models.ModifyTimerGroupRequestConfigTimersSegmentTimers] = None,
        timer_type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SegmentTimers') is not None:
            for k1 in m.get('SegmentTimers'):
                temp_model = main_models.ModifyTimerGroupRequestConfigTimersSegmentTimers()
...
class ModifyTimerGroupRequestConfigTimersSegmentTimers(DaraModel):
    def __init__(
        self,

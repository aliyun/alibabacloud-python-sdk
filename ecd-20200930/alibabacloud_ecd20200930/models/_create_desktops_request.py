...
class CreateDesktopsRequest(DaraModel):
    def __init__(
        ...
        desktop_name_model: main_models.CreateDesktopsRequestDesktopNameModel = None,
        ...
        self.desktop_name_model = desktop_name_model
    ...
    def validate(self):
        ...
        if self.desktop_name_model:
            self.desktop_name_model.validate()
    ...
    def to_map(self):
        ...
        if self.desktop_name_model is not None:
            result['DesktopNameModel'] = self.desktop_name_model.to_map()
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DesktopNameModel') is not None:
            temp_model = main_models.CreateDesktopsRequestDesktopNameModel()
            self.desktop_name_model = temp_model.from_map(m.get('DesktopNameModel'))
...
class CreateDesktopsRequestPurchaseOptions(DaraModel):
    def __init__(
        self,
        credit_package_amount_spec: int = None,
        credit_package_period: int = None,
        credit_package_period_unit: str = None,
        monthly_credits: int = None,
    ):
        # The quota of the WUYING credit package.
        self.credit_package_amount_spec = credit_package_amount_spec
        # The duration of the WUYING credit package.
        self.credit_package_period = credit_package_period
        # The unit of the credit package duration.
        self.credit_package_period_unit = credit_package_period_unit
        # The monthly credit package. This parameter is used to select a credit plan when purchasing Agent resources. Valid values: 200, 1600, and 4000.
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        if self.credit_package_amount_spec is not None:
            result['CreditPackageAmountSpec'] = self.credit_package_amount_spec

        if self.credit_package_period is not None:
            result['CreditPackagePeriod'] = self.credit_package_period

        if self.credit_package_period_unit is not None:
            result['CreditPackagePeriodUnit'] = self.credit_package_period_unit
    ...
    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('CreditPackageAmountSpec') is not None:
            self.credit_package_amount_spec = m.get('CreditPackageAmountSpec')

        if m.get('CreditPackagePeriod') is not None:
            self.credit_package_period = m.get('CreditPackagePeriod')

        if m.get('CreditPackagePeriodUnit') is not None:
            self.credit_package_period_unit = m.get('CreditPackagePeriodUnit')
...
class CreateDesktopsRequestDesktopNameModel(DaraModel):
    def __init__(
        self,
        desktop_name_is_suffix: bool = None,
    ):
        ...
        self.desktop_name_is_suffix = desktop_name_is_suffix
    ...
    def to_map(self):
        ...
        if _map is not None:
            result = _map
        if self.desktop_name_is_suffix is not None:
            result['DesktopNameIsSuffix'] = self.desktop_name_is_suffix

        return result

    def from_map(self, m: dict = None):
        m = m or dict()
        if m.get('DesktopNameIsSuffix') is not None:
            self.desktop_name_is_suffix = m.get('DesktopNameIsSuffix')

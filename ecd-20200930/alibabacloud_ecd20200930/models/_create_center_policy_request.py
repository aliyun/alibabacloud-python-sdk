...
class CreateCenterPolicyRequest(DaraModel):
    def __init__(
        self,
        ...
        client_type: List[main_models.CreateCenterPolicyRequestClientType] = None,
        clipboard: str = None,
        clipboard_graineds: List[main_models.CreateCenterPolicyRequestClipboardGraineds] = None,
        ...
        domain_resolve_rule: List[main_models.CreateCenterPolicyRequestDomainResolveRule] = None,
        ...
        record_event_levels: List[main_models.CreateCenterPolicyRequestRecordEventLevels] = None,
        ...
        usb_supply_redirect_rule: List[main_models.CreateCenterPolicyRequestUsbSupplyRedirectRule] = None,
        use_time: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AuthorizeAccessPolicyRule') is not None:
            for k1 in m.get('AuthorizeAccessPolicyRule'):
                temp_model = main_models.CreateCenterPolicyRequestAuthorizeAccessPolicyRule()
        ...
        if m.get('AuthorizeSecurityPolicyRule') is not None:
            for k1 in m.get('AuthorizeSecurityPolicyRule'):
                temp_model = main_models.CreateCenterPolicyRequestAuthorizeSecurityPolicyRule()
        ...
        if m.get('ClientType') is not None:
            for k1 in m.get('ClientType'):
                temp_model = main_models.CreateCenterPolicyRequestClientType()
        ...
        if m.get('ClipboardGraineds') is not None:
            for k1 in m.get('ClipboardGraineds'):
                temp_model = main_models.CreateCenterPolicyRequestClipboardGraineds()
        ...
        if m.get('DeviceRedirects') is not None:
            for k1 in m.get('DeviceRedirects'):
                temp_model = main_models.CreateCenterPolicyRequestDeviceRedirects()
                self.device_redirects.append(temp_model.from_map(k1))

        self.device_rules = []
        if m.get('DeviceRules') is not None:
            for k1 in m.get('DeviceRules'):
                temp_model = main_models.CreateCenterPolicyRequestDeviceRules()
        ...
        if m.get('DomainResolveRule') is not None:
            for k1 in m.get('DomainResolveRule'):
                temp_model = main_models.CreateCenterPolicyRequestDomainResolveRule()
        ...
        if m.get('NetRedirectRule') is not None:
            for k1 in m.get('NetRedirectRule'):
                temp_model = main_models.CreateCenterPolicyRequestNetRedirectRule()
        ...
        if m.get('RecordEventLevels') is not None:
            for k1 in m.get('RecordEventLevels'):
                temp_model = main_models.CreateCenterPolicyRequestRecordEventLevels()
        ...
        if m.get('UsbSupplyRedirectRule') is not None:
            for k1 in m.get('UsbSupplyRedirectRule'):
                temp_model = main_models.CreateCenterPolicyRequestUsbSupplyRedirectRule()
...
class CreateCenterPolicyRequestUsbSupplyRedirectRule(DaraModel):
    def __init__(
        self,
...
class CreateCenterPolicyRequestRecordEventLevels(DaraModel):
    def __init__(
        self,
...
class CreateCenterPolicyRequestNetRedirectRule(DaraModel):
    def __init__(
        self,
        domain: str = None,
        policy: str = None,
...
class CreateCenterPolicyRequestDomainResolveRule(DaraModel):
    def __init__(
        self,
        description: str = None,
        domain: str = None,
...
class CreateCenterPolicyRequestDeviceRules(DaraModel):
    def __init__(
        self,
...
class CreateCenterPolicyRequestDeviceRedirects(DaraModel):
    def __init__(
        self,
        device_type: str = None,
        redirect_type: str = None,
...
class CreateCenterPolicyRequestClipboardGraineds(DaraModel):
    def __init__(
        self,
...
class CreateCenterPolicyRequestClientType(DaraModel):
    def __init__(
        self,
...
class CreateCenterPolicyRequestAuthorizeSecurityPolicyRule(DaraModel):
    def __init__(
        self,
        cidr_ip: str = None,
        description: str = None,
...
class CreateCenterPolicyRequestAuthorizeAccessPolicyRule(DaraModel):
    def __init__(
        self,
        cidr_ip: str = None,
        description: str = None,

...
class DescribeRenewalPriceResponseBodyPriceInfo(DaraModel):
    def __init__(
        ...
        rules: List[main_models.DescribeRenewalPriceResponseBodyPriceInfoRules] = None,
    ):
        # The price.
        self.price = price
        # The promotion rules.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Promotions') is not None:
            for k1 in m.get('Promotions'):
                temp_model = main_models.DescribeRenewalPriceResponseBodyPriceInfoPricePromotions()
...
class DescribeRenewalPriceResponseBodyPriceInfoPricePromotions(DaraModel):
    def __init__(
        self,

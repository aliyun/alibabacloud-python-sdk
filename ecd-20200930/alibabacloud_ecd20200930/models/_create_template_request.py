...
class CreateTemplateRequest(DaraModel):
    def __init__(
        ...
        data_disk_list: List[main_models.CreateTemplateRequestDataDiskList] = None,
        ...
        region_config_list: List[main_models.CreateTemplateRequestRegionConfigList] = None,
        resource_group_id: str = None,
        resource_tag_list: List[main_models.CreateTemplateRequestResourceTagList] = None,
        site_config_list: List[main_models.CreateTemplateRequestSiteConfigList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataDiskList') is not None:
            for k1 in m.get('DataDiskList'):
                temp_model = main_models.CreateTemplateRequestDataDiskList()
        ...
        if m.get('RegionConfigList') is not None:
            for k1 in m.get('RegionConfigList'):
                temp_model = main_models.CreateTemplateRequestRegionConfigList()
        ...
        if m.get('ResourceTagList') is not None:
            for k1 in m.get('ResourceTagList'):
                temp_model = main_models.CreateTemplateRequestResourceTagList()
        ...
        if m.get('SiteConfigList') is not None:
            for k1 in m.get('SiteConfigList'):
                temp_model = main_models.CreateTemplateRequestSiteConfigList()
...
class CreateTemplateRequestSiteConfigList(DaraModel):
    def __init__(
        self,
...
class CreateTemplateRequestResourceTagList(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class CreateTemplateRequestRegionConfigList(DaraModel):
    def __init__(
        self,
...
class CreateTemplateRequestDataDiskList(DaraModel):
    def __init__(
        self,

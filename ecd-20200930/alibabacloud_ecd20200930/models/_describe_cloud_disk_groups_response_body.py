...
class DescribeCloudDiskGroupsResponseBody(DaraModel):
    def __init__(
        self,
        cloud_drive_groups: List[main_models.DescribeCloudDiskGroupsResponseBodyCloudDriveGroups] = None,
        count: int = None,
        next_token: str = None,
        request_id: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CloudDriveGroups') is not None:
            for k1 in m.get('CloudDriveGroups'):
                temp_model = main_models.DescribeCloudDiskGroupsResponseBodyCloudDriveGroups()
...
class DescribeCloudDiskGroupsResponseBodyCloudDriveGroups(DaraModel):
    def __init__(
        self,

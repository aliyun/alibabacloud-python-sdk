...
class ModifyPolicyGroupRequest(DaraModel):
    def __init__(
        ...
        authorize_access_policy_rule: List[main_models.ModifyPolicyGroupRequestAuthorizeAccessPolicyRule] = None,
        authorize_security_policy_rule: List[main_models.ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule] = None,
        camera_redirect: str = None,
        client_type: List[main_models.ModifyPolicyGroupRequestClientType] = None,
        clipboard: str = None,
        device_redirects: List[main_models.ModifyPolicyGroupRequestDeviceRedirects] = None,
        device_rules: List[main_models.ModifyPolicyGroupRequestDeviceRules] = None,
        domain_list: str = None,
        domain_resolve_rule: List[main_models.ModifyPolicyGroupRequestDomainResolveRule] = None,
        ...
        revoke_access_policy_rule: List[main_models.ModifyPolicyGroupRequestRevokeAccessPolicyRule] = None,
        revoke_security_policy_rule: List[main_models.ModifyPolicyGroupRequestRevokeSecurityPolicyRule] = None,
        scope: str = None,
        scope_value: List[str] = None,
        usb_redirect: str = None,
        usb_supply_redirect_rule: List[main_models.ModifyPolicyGroupRequestUsbSupplyRedirectRule] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AuthorizeAccessPolicyRule') is not None:
            for k1 in m.get('AuthorizeAccessPolicyRule'):
                temp_model = main_models.ModifyPolicyGroupRequestAuthorizeAccessPolicyRule()
        ...
        if m.get('AuthorizeSecurityPolicyRule') is not None:
            for k1 in m.get('AuthorizeSecurityPolicyRule'):
                temp_model = main_models.ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule()
        ...
        if m.get('ClientType') is not None:
            for k1 in m.get('ClientType'):
                temp_model = main_models.ModifyPolicyGroupRequestClientType()
        ...
        if m.get('DeviceRedirects') is not None:
            for k1 in m.get('DeviceRedirects'):
                temp_model = main_models.ModifyPolicyGroupRequestDeviceRedirects()
                self.device_redirects.append(temp_model.from_map(k1))

        self.device_rules = []
        if m.get('DeviceRules') is not None:
            for k1 in m.get('DeviceRules'):
                temp_model = main_models.ModifyPolicyGroupRequestDeviceRules()
        ...
        if m.get('DomainResolveRule') is not None:
            for k1 in m.get('DomainResolveRule'):
                temp_model = main_models.ModifyPolicyGroupRequestDomainResolveRule()
        ...
        if m.get('RevokeAccessPolicyRule') is not None:
            for k1 in m.get('RevokeAccessPolicyRule'):
                temp_model = main_models.ModifyPolicyGroupRequestRevokeAccessPolicyRule()
        ...
        if m.get('RevokeSecurityPolicyRule') is not None:
            for k1 in m.get('RevokeSecurityPolicyRule'):
                temp_model = main_models.ModifyPolicyGroupRequestRevokeSecurityPolicyRule()
        ...
        if m.get('UsbSupplyRedirectRule') is not None:
            for k1 in m.get('UsbSupplyRedirectRule'):
                temp_model = main_models.ModifyPolicyGroupRequestUsbSupplyRedirectRule()
...
class ModifyPolicyGroupRequestUsbSupplyRedirectRule(DaraModel):
    def __init__(
        self,
...
class ModifyPolicyGroupRequestRevokeSecurityPolicyRule(DaraModel):
    def __init__(
        self,
        cidr_ip: str = None,
        description: str = None,
...
class ModifyPolicyGroupRequestRevokeAccessPolicyRule(DaraModel):
    def __init__(
        self,
        cidr_ip: str = None,
        description: str = None,
...
class ModifyPolicyGroupRequestDomainResolveRule(DaraModel):
    def __init__(
        self,
        description: str = None,
        domain: str = None,
...
class ModifyPolicyGroupRequestDeviceRules(DaraModel):
    def __init__(
        self,
...
class ModifyPolicyGroupRequestDeviceRedirects(DaraModel):
    def __init__(
        self,
        device_type: str = None,
        redirect_type: str = None,
...
class ModifyPolicyGroupRequestClientType(DaraModel):
    def __init__(
        self,
...
class ModifyPolicyGroupRequestAuthorizeSecurityPolicyRule(DaraModel):
    def __init__(
        self,
        cidr_ip: str = None,
        description: str = None,
...
class ModifyPolicyGroupRequestAuthorizeAccessPolicyRule(DaraModel):
    def __init__(
        self,
        cidr_ip: str = None,
        description: str = None,

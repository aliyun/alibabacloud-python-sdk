...
class ListModelProviderTemplatesShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        provider_template_ids_shrink: str = None,
    ):
        # The Agent platform.
        ...
        self.provider_template_ids_shrink = provider_template_ids_shrink
    ...
    def to_map(self):
        ...
        if self.provider_template_ids_shrink is not None:
            result['ProviderTemplateIds'] = self.provider_template_ids_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ProviderTemplateIds') is not None:
            self.provider_template_ids_shrink = m.get('ProviderTemplateIds')

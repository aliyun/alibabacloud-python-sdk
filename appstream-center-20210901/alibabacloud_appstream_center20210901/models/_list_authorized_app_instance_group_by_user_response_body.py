...
class ListAuthorizedAppInstanceGroupByUserResponseBody(DaraModel):
    def __init__(
        self,
        app_instance_group_models: List[main_models.ListAuthorizedAppInstanceGroupByUserResponseBodyAppInstanceGroupModels] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AppInstanceGroupModels') is not None:
            for k1 in m.get('AppInstanceGroupModels'):
                temp_model = main_models.ListAuthorizedAppInstanceGroupByUserResponseBodyAppInstanceGroupModels()
...
class ListAuthorizedAppInstanceGroupByUserResponseBodyAppInstanceGroupModels(DaraModel):
    def __init__(
        self,
        ...
        apps: List[main_models.ListAuthorizedAppInstanceGroupByUserResponseBodyAppInstanceGroupModelsApps] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Apps') is not None:
            for k1 in m.get('Apps'):
                temp_model = main_models.ListAuthorizedAppInstanceGroupByUserResponseBodyAppInstanceGroupModelsApps()
...
class ListAuthorizedAppInstanceGroupByUserResponseBodyAppInstanceGroupModelsApps(DaraModel):
    def __init__(
        self,
        app_icon: str = None,
        app_id: str = None,

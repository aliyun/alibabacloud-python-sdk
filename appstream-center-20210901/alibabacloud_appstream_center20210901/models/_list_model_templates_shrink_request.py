...
class ListModelTemplatesShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        biz_type: int = None,
        has_model: bool = None,
        model_template_id_list_shrink: str = None,
        ...
        self.model_template_id_list_shrink = model_template_id_list_shrink
    ...
    def to_map(self):
        ...
        if self.model_template_id_list_shrink is not None:
            result['ModelTemplateIdList'] = self.model_template_id_list_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ModelTemplateIdList') is not None:
            self.model_template_id_list_shrink = m.get('ModelTemplateIdList')

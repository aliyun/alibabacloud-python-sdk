...
```bash
# 安装 alibabacloud_pts20181111
pip install alibabacloud_pts20181111
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/pts-20181111/ChangeLog.md)中。

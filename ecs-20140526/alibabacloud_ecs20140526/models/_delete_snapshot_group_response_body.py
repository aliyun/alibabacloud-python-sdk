...
class DeleteSnapshotGroupResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OperationProgressSet') is not None:
            temp_model = main_models.DeleteSnapshotGroupResponseBodyOperationProgressSet()
...
class DeleteSnapshotGroupResponseBodyOperationProgressSet(DaraModel):
    def __init__(
        self,
        operation_progress: List[main_models.DeleteSnapshotGroupResponseBodyOperationProgressSetOperationProgress] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OperationProgress') is not None:
            for k1 in m.get('OperationProgress'):
                temp_model = main_models.DeleteSnapshotGroupResponseBodyOperationProgressSetOperationProgress()
                self.operation_progress.append(temp_model.from_map(k1))

        return self

class DeleteSnapshotGroupResponseBodyOperationProgressSetOperationProgress(DaraModel):
    def __init__(
        self,
        error_code: str = None,
        error_msg: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RelatedItemSet') is not None:
            temp_model = main_models.DeleteSnapshotGroupResponseBodyOperationProgressSetOperationProgressRelatedItemSet()
            self.related_item_set = temp_model.from_map(m.get('RelatedItemSet'))

        return self

class DeleteSnapshotGroupResponseBodyOperationProgressSetOperationProgressRelatedItemSet(DaraModel):
    def __init__(
        self,
        related_item: List[main_models.DeleteSnapshotGroupResponseBodyOperationProgressSetOperationProgressRelatedItemSetRelatedItem] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RelatedItem') is not None:
            for k1 in m.get('RelatedItem'):
                temp_model = main_models.DeleteSnapshotGroupResponseBodyOperationProgressSetOperationProgressRelatedItemSetRelatedItem()
                self.related_item.append(temp_model.from_map(k1))

        return self

class DeleteSnapshotGroupResponseBodyOperationProgressSetOperationProgressRelatedItemSetRelatedItem(DaraModel):
    def __init__(
        self,
        name: str = None,
        value: str = None,

...
class DescribeNewProjectEipMonitorDataResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EipMonitorDatas') is not None:
            temp_model = main_models.DescribeNewProjectEipMonitorDataResponseBodyEipMonitorDatas()
...
class DescribeNewProjectEipMonitorDataResponseBodyEipMonitorDatas(DaraModel):
    def __init__(
        self,
        eip_monitor_data: List[main_models.DescribeNewProjectEipMonitorDataResponseBodyEipMonitorDatasEipMonitorData] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EipMonitorData') is not None:
            for k1 in m.get('EipMonitorData'):
                temp_model = main_models.DescribeNewProjectEipMonitorDataResponseBodyEipMonitorDatasEipMonitorData()
                self.eip_monitor_data.append(temp_model.from_map(k1))

        return self

class DescribeNewProjectEipMonitorDataResponseBodyEipMonitorDatasEipMonitorData(DaraModel):
    def __init__(
        self,

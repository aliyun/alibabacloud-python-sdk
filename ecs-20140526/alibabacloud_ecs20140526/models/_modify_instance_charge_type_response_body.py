...
class ModifyInstanceChargeTypeResponseBody(DaraModel):
    def __init__(
        self,
        fee_of_instances: main_models.ModifyInstanceChargeTypeResponseBodyFeeOfInstances = None,
        order_id: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FeeOfInstances') is not None:
            temp_model = main_models.ModifyInstanceChargeTypeResponseBodyFeeOfInstances()
...
class ModifyInstanceChargeTypeResponseBodyFeeOfInstances(DaraModel):
    def __init__(
        self,
        fee_of_instance: List[main_models.ModifyInstanceChargeTypeResponseBodyFeeOfInstancesFeeOfInstance] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('FeeOfInstance') is not None:
            for k1 in m.get('FeeOfInstance'):
                temp_model = main_models.ModifyInstanceChargeTypeResponseBodyFeeOfInstancesFeeOfInstance()
                self.fee_of_instance.append(temp_model.from_map(k1))

        return self

class ModifyInstanceChargeTypeResponseBodyFeeOfInstancesFeeOfInstance(DaraModel):
    def __init__(
        self,
        currency: str = None,
        fee: str = None,

...
class ReleaseCapacityReservationRequest(DaraModel):
    def __init__(
        self,
        private_pool_options: main_models.ReleaseCapacityReservationRequestPrivatePoolOptions = None,
        dry_run: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PrivatePoolOptions') is not None:
            temp_model = main_models.ReleaseCapacityReservationRequestPrivatePoolOptions()
...
class ReleaseCapacityReservationRequestPrivatePoolOptions(DaraModel):
    def __init__(
        self,
        id: str = None,
    ):

...
class DeleteActivationResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Activation') is not None:
            temp_model = main_models.DeleteActivationResponseBodyActivation()
...
class DeleteActivationResponseBodyActivation(DaraModel):
    def __init__(
        self,

...
class DescribeImageSupportInstanceTypesRequest(DaraModel):
    def __init__(
        self,
        action_type: str = None,
        filter: List[main_models.DescribeImageSupportInstanceTypesRequestFilter] = None,
        image_id: str = None,
        owner_id: int = None,
        region_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Filter') is not None:
            for k1 in m.get('Filter'):
                temp_model = main_models.DescribeImageSupportInstanceTypesRequestFilter()
...
class DescribeImageSupportInstanceTypesRequestFilter(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

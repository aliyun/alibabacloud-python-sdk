...
class RenewReservedInstancesResponseBody(DaraModel):
    def __init__(
        self,
        order_id: str = None,
        request_id: str = None,
        reserved_instance_id_sets: main_models.RenewReservedInstancesResponseBodyReservedInstanceIdSets = None,
    ):
        # The order ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ReservedInstanceIdSets') is not None:
            temp_model = main_models.RenewReservedInstancesResponseBodyReservedInstanceIdSets()
            self.reserved_instance_id_sets = temp_model.from_map(m.get('ReservedInstanceIdSets'))

        return self

class RenewReservedInstancesResponseBodyReservedInstanceIdSets(DaraModel):
    def __init__(
        self,

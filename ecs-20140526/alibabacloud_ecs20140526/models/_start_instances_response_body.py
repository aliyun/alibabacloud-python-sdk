...
class StartInstancesResponseBody(DaraModel):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InstanceResponses') is not None:
            temp_model = main_models.StartInstancesResponseBodyInstanceResponses()
...
class StartInstancesResponseBodyInstanceResponses(DaraModel):
    def __init__(
        self,
        instance_response: List[main_models.StartInstancesResponseBodyInstanceResponsesInstanceResponse] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InstanceResponse') is not None:
            for k1 in m.get('InstanceResponse'):
                temp_model = main_models.StartInstancesResponseBodyInstanceResponsesInstanceResponse()
                self.instance_response.append(temp_model.from_map(k1))

        return self

class StartInstancesResponseBodyInstanceResponsesInstanceResponse(DaraModel):
    def __init__(
        self,
        code: str = None,

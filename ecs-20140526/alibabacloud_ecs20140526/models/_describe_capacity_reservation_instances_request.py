...
class DescribeCapacityReservationInstancesRequest(DaraModel):
    def __init__(
        self,
        private_pool_options: main_models.DescribeCapacityReservationInstancesRequestPrivatePoolOptions = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PrivatePoolOptions') is not None:
            temp_model = main_models.DescribeCapacityReservationInstancesRequestPrivatePoolOptions()
...
class DescribeCapacityReservationInstancesRequestPrivatePoolOptions(DaraModel):
    def __init__(
        self,
        id: str = None,
    ):

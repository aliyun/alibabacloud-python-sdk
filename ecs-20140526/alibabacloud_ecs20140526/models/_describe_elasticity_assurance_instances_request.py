...
class DescribeElasticityAssuranceInstancesRequest(DaraModel):
    def __init__(
        self,
        private_pool_options: main_models.DescribeElasticityAssuranceInstancesRequestPrivatePoolOptions = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PrivatePoolOptions') is not None:
            temp_model = main_models.DescribeElasticityAssuranceInstancesRequestPrivatePoolOptions()
...
class DescribeElasticityAssuranceInstancesRequestPrivatePoolOptions(DaraModel):
    def __init__(
        self,
        id: str = None,
    ):

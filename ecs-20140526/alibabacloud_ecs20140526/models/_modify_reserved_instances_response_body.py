...
class ModifyReservedInstancesResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ReservedInstanceIdSets') is not None:
            temp_model = main_models.ModifyReservedInstancesResponseBodyReservedInstanceIdSets()
            self.reserved_instance_id_sets = temp_model.from_map(m.get('ReservedInstanceIdSets'))

        return self

class ModifyReservedInstancesResponseBodyReservedInstanceIdSets(DaraModel):
    def __init__(
        self,

...
class RebootInstanceRequest(DaraModel):
    def __init__(
        ...
        # - false: performs a dry run and sends the request. The instance is restarted after the check succeeds.
        # 
        # Default value: false.
        self.dry_run = dry_run
        # Specifies whether to forcefully stop ECS instance before restarting it. Valid values:
        # 
        # -   true: Forcefully stops ECS instance. This is equivalent to a typical power-off operation. All cached data that has not been written to storage devices is lost.
        # 

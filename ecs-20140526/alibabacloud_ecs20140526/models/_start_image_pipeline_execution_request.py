...
class StartImagePipelineExecutionRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.StartImagePipelineExecutionRequestTag()
                self.tag.append(temp_model.from_map(k1))

        self.template_tag = []
        if m.get('TemplateTag') is not None:
            for k1 in m.get('TemplateTag'):
                temp_model = main_models.StartImagePipelineExecutionRequestTemplateTag()
                self.template_tag.append(temp_model.from_map(k1))

        return self

class StartImagePipelineExecutionRequestTemplateTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class StartImagePipelineExecutionRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

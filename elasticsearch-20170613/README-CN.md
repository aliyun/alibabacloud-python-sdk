...
```bash
# 安装 alibabacloud_elasticsearch20170613
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/elasticsearch-20170613/ChangeLog.md)中。

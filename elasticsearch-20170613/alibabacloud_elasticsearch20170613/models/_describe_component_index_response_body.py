...
class DescribeComponentIndexResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.DescribeComponentIndexResponseBodyResult()
            self.result = temp_model.from_map(m.get('Result'))

        return self

class DescribeComponentIndexResponseBodyResult(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('template') is not None:
            temp_model = main_models.DescribeComponentIndexResponseBodyResultTemplate()
            self.template = temp_model.from_map(m.get('template'))

        return self

class DescribeComponentIndexResponseBodyResultTemplate(DaraModel):
    def __init__(
        self,

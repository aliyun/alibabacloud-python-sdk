...
class ListInstanceHistoryEventsRequest(DaraModel):
    def __init__(
        self,
        body: List[main_models.ListInstanceHistoryEventsRequestBody] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('body') is not None:
            for k1 in m.get('body'):
                temp_model = main_models.ListInstanceHistoryEventsRequestBody()
...
class ListInstanceHistoryEventsRequestBody(DaraModel):
    def __init__(
        self,
        desc: bool = None,
        sort_field: str = None,

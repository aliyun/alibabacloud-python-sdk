...
class UpdateCollectorNameResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.UpdateCollectorNameResponseBodyResult = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.UpdateCollectorNameResponseBodyResult()
            self.result = temp_model.from_map(m.get('Result'))

        return self

class UpdateCollectorNameResponseBodyResult(DaraModel):
    def __init__(
        self,
        collector_paths: List[str] = None,
        configs: List[main_models.UpdateCollectorNameResponseBodyResultConfigs] = None,
        dry_run: bool = None,
        extend_configs: List[main_models.UpdateCollectorNameResponseBodyResultExtendConfigs] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('configs') is not None:
            for k1 in m.get('configs'):
                temp_model = main_models.UpdateCollectorNameResponseBodyResultConfigs()
        ...
        if m.get('extendConfigs') is not None:
            for k1 in m.get('extendConfigs'):
                temp_model = main_models.UpdateCollectorNameResponseBodyResultExtendConfigs()
...
class UpdateCollectorNameResponseBodyResultExtendConfigs(DaraModel):
    def __init__(
        self,
        ...
        machines: List[main_models.UpdateCollectorNameResponseBodyResultExtendConfigsMachines] = None,
        protocol: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('machines') is not None:
            for k1 in m.get('machines'):
                temp_model = main_models.UpdateCollectorNameResponseBodyResultExtendConfigsMachines()
...
class UpdateCollectorNameResponseBodyResultExtendConfigsMachines(DaraModel):
    def __init__(
        self,
...
class UpdateCollectorNameResponseBodyResultConfigs(DaraModel):
    def __init__(
        self,
        content: str = None,
        file_name: str = None,

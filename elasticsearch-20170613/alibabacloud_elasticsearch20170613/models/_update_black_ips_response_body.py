...
class UpdateBlackIpsResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: main_models.UpdateBlackIpsResponseBodyResult = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.UpdateBlackIpsResponseBodyResult()
            self.result = temp_model.from_map(m.get('Result'))

        return self

class UpdateBlackIpsResponseBodyResult(DaraModel):
    def __init__(
        self,

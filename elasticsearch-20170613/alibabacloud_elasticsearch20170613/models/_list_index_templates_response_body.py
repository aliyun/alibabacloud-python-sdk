...
class ListIndexTemplatesResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result: List[main_models.ListIndexTemplatesResponseBodyResult] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k1 in m.get('Result'):
                temp_model = main_models.ListIndexTemplatesResponseBodyResult()
                self.result.append(temp_model.from_map(k1))

        return self

class ListIndexTemplatesResponseBodyResult(DaraModel):
    def __init__(
        self,
        ...
        priority: int = None,
        template: main_models.ListIndexTemplatesResponseBodyResultTemplate = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('template') is not None:
            temp_model = main_models.ListIndexTemplatesResponseBodyResultTemplate()
            self.template = temp_model.from_map(m.get('template'))

        return self

class ListIndexTemplatesResponseBodyResultTemplate(DaraModel):
    def __init__(
        self,
        aliases: str = None,
        mappings: str = None,

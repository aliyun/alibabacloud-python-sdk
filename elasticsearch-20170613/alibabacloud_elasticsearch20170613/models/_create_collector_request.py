...
class CreateCollectorRequest(DaraModel):
    def __init__(
        ...
        # The collection paths of fileBeat. This parameter is required only when the collector is installed on ECS instances.
        self.collector_paths = collector_paths
        # The configuration file information of the collector.
        # 
        # This parameter is required.
        self.configs = configs
        # Specifies whether to perform only a dry run without creating the collector. This parameter is used only when you create or update a collector. Valid values:
        # 
        ...
        # The collector name. The name must be 1 to 30 characters in length and must start with an uppercase or lowercase letter. The name can contain letters, digits, underscores (_), or hyphens (-).
        # 
        # This parameter is required.
        self.name = name

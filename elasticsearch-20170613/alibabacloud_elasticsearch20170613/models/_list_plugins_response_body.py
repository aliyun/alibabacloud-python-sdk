...
class ListPluginsResponseBody(DaraModel):
    def __init__(
        self,
        headers: main_models.ListPluginsResponseBodyHeaders = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Headers') is not None:
            temp_model = main_models.ListPluginsResponseBodyHeaders()
        ...
        if m.get('Result') is not None:
            for k1 in m.get('Result'):
                temp_model = main_models.ListPluginsResponseBodyResult()
                self.result.append(temp_model.from_map(k1))

        return self

class ListPluginsResponseBodyResult(DaraModel):
    def __init__(
        self,
...
class ListPluginsResponseBodyHeaders(DaraModel):
    def __init__(
        self,

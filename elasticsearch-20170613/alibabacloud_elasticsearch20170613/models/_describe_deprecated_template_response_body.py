...
class DescribeDeprecatedTemplateResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.DescribeDeprecatedTemplateResponseBodyResult()
            self.result = temp_model.from_map(m.get('Result'))

        return self

class DescribeDeprecatedTemplateResponseBodyResult(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('template') is not None:
            temp_model = main_models.DescribeDeprecatedTemplateResponseBodyResultTemplate()
...
class DescribeDeprecatedTemplateResponseBodyResultTemplate(DaraModel):
    def __init__(
        self,
        aliases: str = None,
        mappings: str = None,

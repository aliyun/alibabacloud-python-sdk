...
class ModifyElastictaskResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.ModifyElastictaskResponseBodyResult()
            self.result = temp_model.from_map(m.get('Result'))

        return self

class ModifyElastictaskResponseBodyResult(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('elasticExpansionTask') is not None:
            temp_model = main_models.ModifyElastictaskResponseBodyResultElasticExpansionTask()
            self.elastic_expansion_task = temp_model.from_map(m.get('elasticExpansionTask'))

        if m.get('elasticShrinkTask') is not None:
            temp_model = main_models.ModifyElastictaskResponseBodyResultElasticShrinkTask()
            self.elastic_shrink_task = temp_model.from_map(m.get('elasticShrinkTask'))

        return self

class ModifyElastictaskResponseBodyResultElasticShrinkTask(DaraModel):
    def __init__(
        self,
...
class ModifyElastictaskResponseBodyResultElasticExpansionTask(DaraModel):
    def __init__(
        self,
        cron_expression: str = None,
        elastic_node_count: int = None,

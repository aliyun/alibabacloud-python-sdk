...
class CreateComponentIndexRequest(DaraModel):
    def __init__(
        self,
        meta: Dict[str, Any] = None,
        template: main_models.CreateComponentIndexRequestTemplate = None,
    ):
        self.meta = meta
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('template') is not None:
            temp_model = main_models.CreateComponentIndexRequestTemplate()
            self.template = temp_model.from_map(m.get('template'))

        return self

class CreateComponentIndexRequestTemplate(DaraModel):
    def __init__(
        self,

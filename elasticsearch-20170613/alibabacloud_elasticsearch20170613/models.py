...
class RpcListInstanceRequest(TeaModel):
    def __init__(
        self,
        es_version: str = None,
        vpc_id: str = None,
...
class RpcListInstanceResponseBodyResult(TeaModel):
    def __init__(
        self,
        advanced_dedicate_master: bool = None,
        created_at: str = None,
        ...
        end_time: int = None,
        es_version: str = None,
        have_cerebro: bool = None,
        have_client_node: bool = None,
        have_elastic_data_node: bool = None,
        have_grafana: bool = None,
        have_kibana: bool = None,
        inited: bool = None,
        instance_id: str = None,
        instance_type: str = None,
        ...
        self.end_time = end_time
        self.es_version = es_version
        self.have_cerebro = have_cerebro
        self.have_client_node = have_client_node
        self.have_elastic_data_node = have_elastic_data_node
        self.have_grafana = have_grafana
        self.have_kibana = have_kibana
        self.inited = inited
        self.instance_id = instance_id
        self.instance_type = instance_type
    ...
    def to_map(self):
        ...
        if self.es_version is not None:
            result['EsVersion'] = self.es_version
        if self.have_cerebro is not None:
            result['HaveCerebro'] = self.have_cerebro
        if self.have_client_node is not None:
            result['HaveClientNode'] = self.have_client_node
        if self.have_elastic_data_node is not None:
            result['HaveElasticDataNode'] = self.have_elastic_data_node
        if self.have_grafana is not None:
            result['HaveGrafana'] = self.have_grafana
        if self.have_kibana is not None:
            result['HaveKibana'] = self.have_kibana
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('EsVersion') is not None:
            self.es_version = m.get('EsVersion')
        if m.get('HaveCerebro') is not None:
            self.have_cerebro = m.get('HaveCerebro')
        if m.get('HaveClientNode') is not None:
            self.have_client_node = m.get('HaveClientNode')
        if m.get('HaveElasticDataNode') is not None:
            self.have_elastic_data_node = m.get('HaveElasticDataNode')
        if m.get('HaveGrafana') is not None:
            self.have_grafana = m.get('HaveGrafana')
        if m.get('HaveKibana') is not None:
            self.have_kibana = m.get('HaveKibana')
...
class RpcListInstanceResponseBody(TeaModel):
    def __init__(
        self,
        request_id: str = None,
        result: List[RpcListInstanceResponseBodyResult] = None,
    ):
        # Id of the request
        self.request_id = request_id
        # es 列表
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            for k in m.get('Result'):
                temp_model = RpcListInstanceResponseBodyResult()
                self.result.append(temp_model.from_map(k))
        return self


class RpcListInstanceResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        body: RpcListInstanceResponseBody = None,
    ):
        self.headers = headers
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('headers') is not None:
            self.headers = m.get('headers')
        if m.get('body') is not None:
            temp_model = RpcListInstanceResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

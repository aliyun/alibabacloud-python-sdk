...
class Client(OpenApiClient):
    ...
    *\
    ...
    def start_apm_with_options(
        ...
        return TeaCore.from_map(
            elasticsearch_20170613_models.StartApmResponse(),
            self.do_roarequest('StartApm', '2017-06-13', 'HTTPS', 'POST', 'AK', f'/openapi/apm/{instance_id}/start', 'json', req, runtime)
        )
    ...
    async def start_apm_with_options_async(
        ...
        return TeaCore.from_map(
            elasticsearch_20170613_models.StartApmResponse(),
            await self.do_roarequest_async('StartApm', '2017-06-13', 'HTTPS', 'POST', 'AK', f'/openapi/apm/{instance_id}/start', 'json', req, runtime)
        )
    ...
    def stop_apm_with_options(
        ...
        return TeaCore.from_map(
            elasticsearch_20170613_models.StopApmResponse(),
            self.do_roarequest('StopApm', '2017-06-13', 'HTTPS', 'POST', 'AK', f'/openapi/apm/{instance_id}/stop', 'json', req, runtime)
        )
    ...
    async def stop_apm_with_options_async(
        ...
        return TeaCore.from_map(
            elasticsearch_20170613_models.StopApmResponse(),
            await self.do_roarequest_async('StopApm', '2017-06-13', 'HTTPS', 'POST', 'AK', f'/openapi/apm/{instance_id}/stop', 'json', req, runtime)
        )
    ...
    def list_apm_with_options(
        ...
        if not UtilClient.is_unset(request.es_instance_id):
            query['esInstanceId'] = request.es_instance_id
        req = open_api_models.OpenApiRequest(
            headers=headers,
            query=OpenApiUtilClient.query(query)
        )
    ...
    def rpc_list_instance(
        self,
        request: elasticsearch_20170613_models.RpcListInstanceRequest,
    ) -> elasticsearch_20170613_models.RpcListInstanceResponse:
        runtime = util_models.RuntimeOptions()
        headers = {}
        return self.rpc_list_instance_with_options(request, headers, runtime)

    async def rpc_list_instance_async(
        self,
        request: elasticsearch_20170613_models.RpcListInstanceRequest,
    ) -> elasticsearch_20170613_models.RpcListInstanceResponse:
        runtime = util_models.RuntimeOptions()
        headers = {}
        return await self.rpc_list_instance_with_options_async(request, headers, runtime)

    def rpc_list_instance_with_options(
        self,
        request: elasticsearch_20170613_models.RpcListInstanceRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            elasticsearch_20170613_models.RpcListInstanceResponse(),
            self.do_roarequest('RpcListInstance', '2017-06-13', 'HTTPS', 'POST', 'AK', f'/openapi/instances/rpc', 'json', req, runtime)
        )

    async def rpc_list_instance_with_options_async(
        self,
        request: elasticsearch_20170613_models.RpcListInstanceRequest,
        headers: Dict[str, str],
        runtime: util_models.RuntimeOptions,
        ...
        return TeaCore.from_map(
            elasticsearch_20170613_models.RpcListInstanceResponse(),
            await self.do_roarequest_async('RpcListInstance', '2017-06-13', 'HTTPS', 'POST', 'AK', f'/openapi/instances/rpc', 'json', req, runtime)
        )
    ...
    def update_description_with_options(
        ...
        return TeaCore.from_map(
            elasticsearch_20170613_models.UpdateDescriptionResponse(),
            self.do_roarequest_with_form('UpdateDescription', '2017-06-13', 'HTTPS', 'POST', 'AK', f'/openapi/instances/{instance_id}/description', 'json', req, runtime)
        )
    ...
    async def update_description_with_options_async(
        ...
        return TeaCore.from_map(
            elasticsearch_20170613_models.UpdateDescriptionResponse(),
            await self.do_roarequest_with_form_async('UpdateDescription', '2017-06-13', 'HTTPS', 'POST', 'AK', f'/openapi/instances/{instance_id}/description', 'json', req, runtime)
        )

...
class ListBasicEndpointsResponseBody(DaraModel):
    def __init__(
        self,
        endpoints: List[main_models.ListBasicEndpointsResponseBodyEndpoints] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Endpoints') is not None:
            for k1 in m.get('Endpoints'):
                temp_model = main_models.ListBasicEndpointsResponseBodyEndpoints()
...
class ListBasicEndpointsResponseBodyEndpoints(DaraModel):
    def __init__(
        self,

...
class ListCustomRoutingPortMappingsResponseBody(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        port_mappings: List[main_models.ListCustomRoutingPortMappingsResponseBodyPortMappings] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PortMappings') is not None:
            for k1 in m.get('PortMappings'):
                temp_model = main_models.ListCustomRoutingPortMappingsResponseBodyPortMappings()
...
class ListCustomRoutingPortMappingsResponseBodyPortMappings(DaraModel):
    def __init__(
        self,
        accelerator_id: str = None,
        accelerator_port: int = None,
        destination_socket_address: main_models.ListCustomRoutingPortMappingsResponseBodyPortMappingsDestinationSocketAddress = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DestinationSocketAddress') is not None:
            temp_model = main_models.ListCustomRoutingPortMappingsResponseBodyPortMappingsDestinationSocketAddress()
...
class ListCustomRoutingPortMappingsResponseBodyPortMappingsDestinationSocketAddress(DaraModel):
    def __init__(
        self,
        ip_address: str = None,
        port: int = None,

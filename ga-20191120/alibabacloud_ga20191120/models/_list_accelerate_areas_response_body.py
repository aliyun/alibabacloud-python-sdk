...
class ListAccelerateAreasResponseBody(DaraModel):
    def __init__(
        self,
        areas: List[main_models.ListAccelerateAreasResponseBodyAreas] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Areas') is not None:
            for k1 in m.get('Areas'):
                temp_model = main_models.ListAccelerateAreasResponseBodyAreas()
...
class ListAccelerateAreasResponseBodyAreas(DaraModel):
    def __init__(
        self,
        area_id: str = None,
        local_name: str = None,
        region_list: List[main_models.ListAccelerateAreasResponseBodyAreasRegionList] = None,
    ):
        # The area ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RegionList') is not None:
            for k1 in m.get('RegionList'):
                temp_model = main_models.ListAccelerateAreasResponseBodyAreasRegionList()
                self.region_list.append(temp_model.from_map(k1))

        return self

class ListAccelerateAreasResponseBodyAreasRegionList(DaraModel):
    def __init__(
        self,
        local_name: str = None,
        region_id: str = None,

...
class UpdateForwardingRulesResponseBody(DaraModel):
    def __init__(
        self,
        forwarding_rules: List[main_models.UpdateForwardingRulesResponseBodyForwardingRules] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ForwardingRules') is not None:
            for k1 in m.get('ForwardingRules'):
                temp_model = main_models.UpdateForwardingRulesResponseBodyForwardingRules()
...
class UpdateForwardingRulesResponseBodyForwardingRules(DaraModel):
    def __init__(
        self,

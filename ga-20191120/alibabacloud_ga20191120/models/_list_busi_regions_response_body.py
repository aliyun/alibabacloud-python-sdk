...
class ListBusiRegionsResponseBody(DaraModel):
    def __init__(
        self,
        regions: List[main_models.ListBusiRegionsResponseBodyRegions] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Regions') is not None:
            for k1 in m.get('Regions'):
                temp_model = main_models.ListBusiRegionsResponseBodyRegions()
...
class ListBusiRegionsResponseBodyRegions(DaraModel):
    def __init__(
        self,
        local_name: str = None,
        region_id: str = None,

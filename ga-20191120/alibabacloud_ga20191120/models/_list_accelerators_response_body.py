...
class ListAcceleratorsResponseBody(DaraModel):
    def __init__(
        self,
        accelerators: List[main_models.ListAcceleratorsResponseBodyAccelerators] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Accelerators') is not None:
            for k1 in m.get('Accelerators'):
                temp_model = main_models.ListAcceleratorsResponseBodyAccelerators()
...
class ListAcceleratorsResponseBodyAccelerators(DaraModel):
    def __init__(
        self,
        accelerator_id: str = None,
        bandwidth: int = None,
        bandwidth_billing_type: str = None,
        basic_bandwidth_package: main_models.ListAcceleratorsResponseBodyAcceleratorsBasicBandwidthPackage = None,
        cen_id: str = None,
        create_time: int = None,
        cross_border_mode: str = None,
        cross_border_status: bool = None,
        cross_domain_bandwidth_package: main_models.ListAcceleratorsResponseBodyAcceleratorsCrossDomainBandwidthPackage = None,
        ddos_config_list: List[main_models.ListAcceleratorsResponseBodyAcceleratorsDdosConfigList] = None,
        ddos_id: str = None,
        description: str = None,
        dns_name: str = None,
        expired_time: int = None,
        instance_charge_type: str = None,
        ip_set_config: main_models.ListAcceleratorsResponseBodyAcceleratorsIpSetConfig = None,
        name: str = None,
        region_id: str = None,
        ...
        service_managed_infos: List[main_models.ListAcceleratorsResponseBodyAcceleratorsServiceManagedInfos] = None,
        spec: str = None,
        state: str = None,
        tags: List[main_models.ListAcceleratorsResponseBodyAcceleratorsTags] = None,
        type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BasicBandwidthPackage') is not None:
            temp_model = main_models.ListAcceleratorsResponseBodyAcceleratorsBasicBandwidthPackage()
        ...
        if m.get('CrossDomainBandwidthPackage') is not None:
            temp_model = main_models.ListAcceleratorsResponseBodyAcceleratorsCrossDomainBandwidthPackage()
        ...
        if m.get('DdosConfigList') is not None:
            for k1 in m.get('DdosConfigList'):
                temp_model = main_models.ListAcceleratorsResponseBodyAcceleratorsDdosConfigList()
        ...
        if m.get('IpSetConfig') is not None:
            temp_model = main_models.ListAcceleratorsResponseBodyAcceleratorsIpSetConfig()
        ...
        if m.get('ServiceManagedInfos') is not None:
            for k1 in m.get('ServiceManagedInfos'):
                temp_model = main_models.ListAcceleratorsResponseBodyAcceleratorsServiceManagedInfos()
        ...
        if m.get('Tags') is not None:
            for k1 in m.get('Tags'):
                temp_model = main_models.ListAcceleratorsResponseBodyAcceleratorsTags()
...
class ListAcceleratorsResponseBodyAcceleratorsTags(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,
...
class ListAcceleratorsResponseBodyAcceleratorsServiceManagedInfos(DaraModel):
    def __init__(
        self,
        action: str = None,
        child_type: str = None,
...
class ListAcceleratorsResponseBodyAcceleratorsIpSetConfig(DaraModel):
    def __init__(
        self,
...
class ListAcceleratorsResponseBodyAcceleratorsDdosConfigList(DaraModel):
    def __init__(
        self,
        ddos_id: str = None,
...
class ListAcceleratorsResponseBodyAcceleratorsCrossDomainBandwidthPackage(DaraModel):
    def __init__(
        self,
        bandwidth: int = None,
...
class ListAcceleratorsResponseBodyAcceleratorsBasicBandwidthPackage(DaraModel):
    def __init__(
        self,
        bandwidth: int = None,

...
class Client(OpenApiClient):
    ...
    *\
    ...
    def list_system_security_policies_with_options(
        ...
        return TeaCore.from_map(
            ga_20191120_models.ListSystemSecurityPoliciesResponse(),
            self.do_rpcrequest('ListSystemSecurityPolicies', '2019-11-20', 'HTTPS', 'POST', 'AK', 'json', req, runtime)
        )
    ...
    async def list_system_security_policies_with_options_async(
        ...
        return TeaCore.from_map(
            ga_20191120_models.ListSystemSecurityPoliciesResponse(),
            await self.do_rpcrequest_async('ListSystemSecurityPolicies', '2019-11-20', 'HTTPS', 'POST', 'AK', 'json', req, runtime)
        )

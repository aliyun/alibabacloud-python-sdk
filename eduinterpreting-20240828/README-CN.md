...
```bash
# 安装 alibabacloud_eduinterpreting20240828
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/eduinterpreting-20240828/ChangeLog.md)中。

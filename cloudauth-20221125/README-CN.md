...
```bash
# 安装 alibabacloud_cloudauth20221125
pip install alibabacloud_cloudauth20221125
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/cloudauth-20221125/ChangeLog.md)中。

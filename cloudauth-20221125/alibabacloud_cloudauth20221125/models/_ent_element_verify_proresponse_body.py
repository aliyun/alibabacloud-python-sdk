...
class EntElementVerifyPROResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        request_id: str = None,
        result: main_models.EntElementVerifyPROResponseBodyResult = None,
    ):
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Result') is not None:
            temp_model = main_models.EntElementVerifyPROResponseBodyResult()
            self.result = temp_model.from_map(m.get('Result'))

        return self

class EntElementVerifyPROResponseBodyResult(DaraModel):
    def __init__(
        self,
        biz_code: str = None,
        open_time: str = None,

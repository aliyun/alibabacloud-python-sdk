...
class Client(OpenApiClient):
    ...
    def reset_agentic_api_key_with_options(
        self,
        request: main_models.ResetAgenticApiKeyRequest,
        runtime: RuntimeOptions,
    ) -> main_models.ResetAgenticApiKeyResponse:
        request.validate()
        query = {}
        if not DaraCore.is_null(request.expire_after_seconds):
            query['ExpireAfterSeconds'] = request.expire_after_seconds
    ...
    async def reset_agentic_api_key_with_options_async(
        self,
        request: main_models.ResetAgenticApiKeyRequest,
        runtime: RuntimeOptions,
    ) -> main_models.ResetAgenticApiKeyResponse:
    ...
    def reset_agentic_api_key(
        self,
        request: main_models.ResetAgenticApiKeyRequest,
    ) -> main_models.ResetAgenticApiKeyResponse:
        runtime = RuntimeOptions()
        return self.reset_agentic_api_key_with_options(request, runtime)

    async def reset_agentic_api_key_async(
        self,
        request: main_models.ResetAgenticApiKeyRequest,
    ) -> main_models.ResetAgenticApiKeyResponse:
        runtime = RuntimeOptions()
        return await self.reset_agentic_api_key_with_options_async(request, runtime)

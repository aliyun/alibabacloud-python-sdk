...
class ListFileUploadRequest(TeaModel):
    def __init__(
        self,
        call_from: str = None,
        dms_unit: str = None,
...
class ListFileUploadResponseBodyData(TeaModel):
    def __init__(
        self,
...
class ListFileUploadResponseBody(TeaModel):
    def __init__(
        self,
        data: List[ListFileUploadResponseBodyData] = None,
        error_code: str = None,
        error_message: str = None,
        request_id: str = None,
        success: bool = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k in m.get('Data'):
                temp_model = ListFileUploadResponseBodyData()
...
class ListFileUploadResponse(TeaModel):
    def __init__(
        self,
        headers: Dict[str, str] = None,
        status_code: int = None,
        body: ListFileUploadResponseBody = None,
    ):
        self.headers = headers
        self.status_code = status_code
        self.body = body
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = ListFileUploadResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self

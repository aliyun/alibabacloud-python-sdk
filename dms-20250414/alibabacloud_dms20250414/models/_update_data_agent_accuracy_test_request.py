...
class UpdateDataAgentAccuracyTestRequest(DaraModel):
    def __init__(
        self,
    ...
    def to_map(self):
        ...
        if self.customer_agent_id is not None:
            result['CustomerAgentId'] = self.customer_agent_id
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CustomerAgentId') is not None:
            self.customer_agent_id = m.get('CustomerAgentId')

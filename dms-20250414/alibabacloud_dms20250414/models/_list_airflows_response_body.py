...
class ListAirflowsResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Root') is not None:
            temp_model = main_models.ListAirflowsResponseBodyRoot()
...
class ListAirflowsResponseBodyRoot(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            for k1 in m.get('List'):
                temp_model = main_models.ListAirflowsResponseBodyRootList()
...
class ListAirflowsResponseBodyRootList(DaraModel):
    def __init__(
        self,
        airflow_id: str = None,

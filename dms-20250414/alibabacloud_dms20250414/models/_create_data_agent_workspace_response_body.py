...
class CreateDataAgentWorkspaceResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.CreateDataAgentWorkspaceResponseBodyData = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CreateDataAgentWorkspaceResponseBodyData()
...
class CreateDataAgentWorkspaceResponseBodyData(DaraModel):
    def __init__(
        self,

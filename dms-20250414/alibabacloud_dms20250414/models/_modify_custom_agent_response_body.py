...
class ModifyCustomAgentResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.ModifyCustomAgentResponseBodyData = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ModifyCustomAgentResponseBodyData()
...
class ModifyCustomAgentResponseBodyData(DaraModel):
    def __init__(
        self,
        ...
        dms_unit: str = None,
        execution_config: main_models.ModifyCustomAgentResponseBodyDataExecutionConfig = None,
        ...
        schedule_task_config: main_models.ModifyCustomAgentResponseBodyDataScheduleTaskConfig = None,
        status: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ExecutionConfig') is not None:
            temp_model = main_models.ModifyCustomAgentResponseBodyDataExecutionConfig()
        ...
        if m.get('ScheduleTaskConfig') is not None:
            temp_model = main_models.ModifyCustomAgentResponseBodyDataScheduleTaskConfig()
...
class ModifyCustomAgentResponseBodyDataScheduleTaskConfig(DaraModel):
    def __init__(
        self,

...
class ListCustomAgentResponseBodyDataContent(DaraModel):
    def __init__(
        ...
        aliyun_uid: str = None,
        callback_config: main_models.ListCustomAgentResponseBodyDataContentCallbackConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallbackConfig') is not None:
            temp_model = main_models.ListCustomAgentResponseBodyDataContentCallbackConfig()
        ...
        if m.get('ScheduleTaskConfig') is not None:
            temp_model = main_models.ListCustomAgentResponseBodyDataContentScheduleTaskConfig()
...
class ListCustomAgentResponseBodyDataContentScheduleTaskConfig(DaraModel):
    def __init__(
        self,
...
class ListCustomAgentResponseBodyDataContentKnowledgeConfigList(DaraModel):
    def __init__(
        self,
...
class ListCustomAgentResponseBodyDataContentCallbackConfig(DaraModel):
    def __init__(
        self,

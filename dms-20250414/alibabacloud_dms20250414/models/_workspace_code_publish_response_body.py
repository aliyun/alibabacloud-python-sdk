...
class WorkspaceCodePublishResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.WorkspaceCodePublishResponseBodyData = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.WorkspaceCodePublishResponseBodyData()
...
class WorkspaceCodePublishResponseBodyData(DaraModel):
    def __init__(
        self,
        key: str = None,
    ):

...
class GetNotebookTaskStatusResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetNotebookTaskStatusResponseBodyData = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetNotebookTaskStatusResponseBodyData()
...
class GetNotebookTaskStatusResponseBodyData(DaraModel):
    def __init__(
        self,

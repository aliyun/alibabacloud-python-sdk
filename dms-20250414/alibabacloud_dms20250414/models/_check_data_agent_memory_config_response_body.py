...
class CheckDataAgentMemoryConfigResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.CheckDataAgentMemoryConfigResponseBodyData = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.CheckDataAgentMemoryConfigResponseBodyData()
...
class CheckDataAgentMemoryConfigResponseBodyData(DaraModel):
    def __init__(
        self,
        enabled: bool = None,

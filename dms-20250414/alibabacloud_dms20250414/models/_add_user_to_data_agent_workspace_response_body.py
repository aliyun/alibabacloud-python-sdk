...
class AddUserToDataAgentWorkspaceResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.AddUserToDataAgentWorkspaceResponseBodyData = None,
        error_code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.AddUserToDataAgentWorkspaceResponseBodyData()

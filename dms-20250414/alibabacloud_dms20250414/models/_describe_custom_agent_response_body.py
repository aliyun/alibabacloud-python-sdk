...
class DescribeCustomAgentResponseBodyData(DaraModel):
    def __init__(
        ...
        aliyun_uid: str = None,
        callback_config: main_models.DescribeCustomAgentResponseBodyDataCallbackConfig = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallbackConfig') is not None:
            temp_model = main_models.DescribeCustomAgentResponseBodyDataCallbackConfig()
...
class DescribeCustomAgentResponseBodyDataCallbackConfig(DaraModel):
    def __init__(
        self,

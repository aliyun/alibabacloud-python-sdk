...
```bash
# 安装 alibabacloud_safconsole20250521
pip install alibabacloud_safconsole20250521
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/safconsole-20250521/ChangeLog.md)中。

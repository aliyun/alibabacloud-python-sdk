...
class ValidateTestFileResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        http_status_code: int = None,
        request_id: str = None,
        result_object: main_models.ValidateTestFileResponseBodyResultObject = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResultObject') is not None:
            temp_model = main_models.ValidateTestFileResponseBodyResultObject()
...
class ValidateTestFileResponseBodyResultObject(DaraModel):
    def __init__(
        self,

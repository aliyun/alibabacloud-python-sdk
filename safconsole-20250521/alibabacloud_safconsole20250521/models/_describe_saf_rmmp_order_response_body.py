...
class DescribeSafRmmpOrderResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResultObject') is not None:
            temp_model = main_models.DescribeSafRmmpOrderResponseBodyResultObject()
...
class DescribeSafRmmpOrderResponseBodyResultObject(DaraModel):
    def __init__(
        self,

...
class DescribeServiceAndSceneResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResultObject') is not None:
            temp_model = main_models.DescribeServiceAndSceneResponseBodyResultObject()
...
class DescribeServiceAndSceneResponseBodyResultObject(DaraModel):
    def __init__(
        self,
        scene: str = None,
        service: str = None,

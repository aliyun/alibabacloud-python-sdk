...
class ListChartRepositoryResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        ...
        page_no: int = None,
        page_size: int = None,
        repositories: List[main_models.ListChartRepositoryResponseBodyRepositories] = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Repositories') is not None:
            for k1 in m.get('Repositories'):
                temp_model = main_models.ListChartRepositoryResponseBodyRepositories()
...
class ListChartRepositoryResponseBodyRepositories(DaraModel):
    def __init__(
        self,

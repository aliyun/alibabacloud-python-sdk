...
class ImportNumberResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: str = None,
        code: int = None,
        message: str = None,
        model: main_models.ImportNumberResponseBodyModel = None,
        request_id: str = None,
        success: str = None,
        timestamp: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Model') is not None:
            temp_model = main_models.ImportNumberResponseBodyModel()
...
class ImportNumberResponseBodyModel(DaraModel):
    def __init__(
        self,
        batch_id: int = None,
        code: int = None,

...
class AgentCallListRequest(DaraModel):
    def __init__(
        self,
        agent_id: int = None,
        agent_tag: str = None,
    ...
    def to_map(self):
        ...
        if self.number_md5s is not None:
            result['NumberMD5s'] = self.number_md5s
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('NumberMD5s') is not None:
            self.number_md5s = m.get('NumberMD5s')

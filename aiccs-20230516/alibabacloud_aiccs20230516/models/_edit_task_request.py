...
class EditTaskRequest(DaraModel):
    def __init__(
        self,
        call_time_list: List[main_models.EditTaskRequestCallTimeList] = None,
        call_time_str_list: List[main_models.EditTaskRequestCallTimeStrList] = None,
        ...
        send_sms_plan: List[main_models.EditTaskRequestSendSmsPlan] = None,
        status: int = None,
        task_id: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallTimeList') is not None:
            for k1 in m.get('CallTimeList'):
                temp_model = main_models.EditTaskRequestCallTimeList()
        ...
        if m.get('CallTimeStrList') is not None:
            for k1 in m.get('CallTimeStrList'):
                temp_model = main_models.EditTaskRequestCallTimeStrList()
        ...
        if m.get('SendSmsPlan') is not None:
            for k1 in m.get('SendSmsPlan'):
                temp_model = main_models.EditTaskRequestSendSmsPlan()
...
class EditTaskRequestSendSmsPlan(DaraModel):
    def __init__(
        self,
...
class EditTaskRequestCallTimeStrList(DaraModel):
    def __init__(
        self,
...
class EditTaskRequestCallTimeList(DaraModel):
    def __init__(
        self,
        call_time: List[str] = None,
    ):

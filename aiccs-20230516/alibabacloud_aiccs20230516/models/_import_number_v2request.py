...
class ImportNumberV2Request(DaraModel):
    def __init__(
        self,
        customers: List[main_models.ImportNumberV2RequestCustomers] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Customers') is not None:
            for k1 in m.get('Customers'):
                temp_model = main_models.ImportNumberV2RequestCustomers()
...
class ImportNumberV2RequestCustomers(DaraModel):
    def __init__(
        self,
        client_url: str = None,
        number: str = None,

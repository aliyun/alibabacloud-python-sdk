...
class AddTaskRequest(DaraModel):
    def __init__(
        ...
        call_time_str_list: List[main_models.AddTaskRequestCallTimeStrList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CallTimeStrList') is not None:
            for k1 in m.get('CallTimeStrList'):
                temp_model = main_models.AddTaskRequestCallTimeStrList()
...
class AddTaskRequestCallTimeStrList(DaraModel):
    def __init__(
        self,

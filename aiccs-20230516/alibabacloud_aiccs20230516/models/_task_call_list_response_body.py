...
class TaskCallListResponseBody(DaraModel):
    def __init__(
        self,
        code: int = None,
        message: str = None,
        model: main_models.TaskCallListResponseBodyModel = None,
        request_id: str = None,
        success: str = None,
        timestamp: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Model') is not None:
            temp_model = main_models.TaskCallListResponseBodyModel()
...
class TaskCallListResponseBodyModel(DaraModel):
    def __init__(
        self,
        list: List[main_models.TaskCallListResponseBodyModelList] = None,
        page_no: int = None,
        page_size: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            for k1 in m.get('List'):
                temp_model = main_models.TaskCallListResponseBodyModelList()
...
class TaskCallListResponseBodyModelList(DaraModel):
    def __init__(
        self,
        add_wx: int = None,

...
class TaskCancelCallResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        message: str = None,
        model: main_models.TaskCancelCallResponseBodyModel = None,
        request_id: str = None,
        success: str = None,
        timestamp: int = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Model') is not None:
            temp_model = main_models.TaskCancelCallResponseBodyModel()
...
class TaskCancelCallResponseBodyModel(DaraModel):
    def __init__(
        self,

...
```bash
# 安装 alibabacloud_aiccs20230516
pip install alibabacloud_aiccs20230516
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/aiccs-20230516/ChangeLog.md)中。

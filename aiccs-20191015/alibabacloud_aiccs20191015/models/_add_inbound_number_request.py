...
class AddInboundNumberRequest(DaraModel):
    def __init__(
        self,
        application_code: str = None,
        inbound_numbers: List[str] = None,
    ...
    def to_map(self):
        ...
        if self.inbound_numbers is not None:
            result['InboundNumbers'] = self.inbound_numbers
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InboundNumbers') is not None:
            self.inbound_numbers = m.get('InboundNumbers')

...
class GetQualityProjectListResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetQualityProjectListResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetQualityProjectListResponseBodyData()
...
class GetQualityProjectListResponseBodyData(DaraModel):
    def __init__(
        self,
        page_no: int = None,
        page_size: int = None,
    ...
    def validate(self):
        if self.quality_project_list:
            for v1 in self.quality_project_list:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.quality_project_list is not None:
            for k1 in self.quality_project_list:
                result['QualityProjectList'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('QualityProjectList') is not None:
            for k1 in m.get('QualityProjectList'):
                temp_model = main_models.GetQualityProjectListResponseBodyDataQualityProjectList()
                self.quality_project_list.append(temp_model.from_map(k1))
...
class GetQualityProjectListResponseBodyDataQualityProjectList(DaraModel):
    def __init__(
        self,

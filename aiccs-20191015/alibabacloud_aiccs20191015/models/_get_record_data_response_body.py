...
class GetRecordDataResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.GetRecordDataResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.GetRecordDataResponseBodyData()
...
class GetRecordDataResponseBodyData(DaraModel):
    def __init__(
        self,
        acid: str = None,
        oss_link: str = None,

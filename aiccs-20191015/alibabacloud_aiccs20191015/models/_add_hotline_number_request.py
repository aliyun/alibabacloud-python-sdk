...
class AddHotlineNumberRequest(DaraModel):
    def __init__(
        self,
        ...
        outbound_range_list: List[main_models.AddHotlineNumberRequestOutboundRangeList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('OutboundRangeList') is not None:
            for k1 in m.get('OutboundRangeList'):
                temp_model = main_models.AddHotlineNumberRequestOutboundRangeList()
...
class AddHotlineNumberRequestOutboundRangeList(DaraModel):
    def __init__(
        self,

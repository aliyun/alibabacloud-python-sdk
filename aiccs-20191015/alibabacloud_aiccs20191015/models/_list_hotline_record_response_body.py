...
class ListHotlineRecordResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: List[main_models.ListHotlineRecordResponseBodyData] = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            for k1 in m.get('Data'):
                temp_model = main_models.ListHotlineRecordResponseBodyData()
...
class ListHotlineRecordResponseBodyData(DaraModel):
    def __init__(
        self,
        call_id: str = None,

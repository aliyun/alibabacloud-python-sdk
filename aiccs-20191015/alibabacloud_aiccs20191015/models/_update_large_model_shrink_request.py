...
class UpdateLargeModelShrinkRequest(DaraModel):
    def __init__(
        self,
        auth_code: str = None,
        base_model_shrink: str = None,
        model_code: str = None,
        model_name: str = None,
        model_url: str = None,
        owner_id: int = None,
    ...
    def to_map(self):
        ...
        if self.base_model_shrink is not None:
            result['BaseModel'] = self.base_model_shrink
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BaseModel') is not None:
            self.base_model_shrink = m.get('BaseModel')

...
```bash
# 安装 alibabacloud_cloudwifi_pop20191118
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/cloudwifi-pop-20191118/ChangeLog.md)中。

...
class NewNetDeviceInfoRequest(DaraModel):
    def __init__(
        self,
        app_code: str = None,
        app_name: str = None,
        devices: List[main_models.NewNetDeviceInfoRequestDevices] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Devices') is not None:
            for k1 in m.get('Devices'):
                temp_model = main_models.NewNetDeviceInfoRequestDevices()
...
class NewNetDeviceInfoRequestDevices(DaraModel):
    def __init__(
        self,
        host_name: str = None,
        idc: str = None,

...
class CreateHoneypotNodeResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        honeypot_node: main_models.CreateHoneypotNodeResponseBodyHoneypotNode = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HoneypotNode') is not None:
            temp_model = main_models.CreateHoneypotNodeResponseBodyHoneypotNode()
...
class CreateHoneypotNodeResponseBodyHoneypotNode(DaraModel):
    def __init__(
        self,
        node_id: str = None,
    ):

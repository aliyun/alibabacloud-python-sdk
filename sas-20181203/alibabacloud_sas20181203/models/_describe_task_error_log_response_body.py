...
class DescribeTaskErrorLogResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Logs') is not None:
            for k1 in m.get('Logs'):
                temp_model = main_models.DescribeTaskErrorLogResponseBodyLogs()
...
class DescribeTaskErrorLogResponseBodyLogs(DaraModel):
    def __init__(
        self,
        text: str = None,
    ):

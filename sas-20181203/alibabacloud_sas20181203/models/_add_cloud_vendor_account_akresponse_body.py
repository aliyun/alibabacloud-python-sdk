...
class AddCloudVendorAccountAKResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.AddCloudVendorAccountAKResponseBodyData()
...
class AddCloudVendorAccountAKResponseBodyData(DaraModel):
    def __init__(
        self,
        ak_type: str = None,
        auth_id: int = None,
        auth_modules: List[main_models.AddCloudVendorAccountAKResponseBodyDataAuthModules] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AuthModules') is not None:
            for k1 in m.get('AuthModules'):
                temp_model = main_models.AddCloudVendorAccountAKResponseBodyDataAuthModules()
...
class AddCloudVendorAccountAKResponseBodyDataAuthModules(DaraModel):
    def __init__(
        self,
        message: str = None,
        module: str = None,

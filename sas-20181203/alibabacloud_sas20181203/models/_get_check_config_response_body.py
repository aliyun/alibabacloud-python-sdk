...
class GetCheckConfigResponseBody(DaraModel):
    def __init__(
        ...
        # - **18~24**: If the start time is 18, the end time must be set to 24. Unit: hours (h).
        ...
        # The start time of the check period, indicating the hour of the day. Unit: hours (h).
...
class GetCheckConfigResponseBodyStandards(DaraModel):
    def __init__(
        ...
        # 
        # - **RISK:** Cloud product configuration management.

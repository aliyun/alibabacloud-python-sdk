...
class AddContainerDefenseRuleRequest(DaraModel):
    def __init__(
        self,
        ...
        rule_type: int = None,
        scope: List[main_models.AddContainerDefenseRuleRequestScope] = None,
        whitelist: main_models.AddContainerDefenseRuleRequestWhitelist = None,
    ):
        # The description.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Scope') is not None:
            for k1 in m.get('Scope'):
                temp_model = main_models.AddContainerDefenseRuleRequestScope()
                self.scope.append(temp_model.from_map(k1))

        if m.get('Whitelist') is not None:
            temp_model = main_models.AddContainerDefenseRuleRequestWhitelist()
            self.whitelist = temp_model.from_map(m.get('Whitelist'))

        return self

class AddContainerDefenseRuleRequestWhitelist(DaraModel):
    def __init__(
        self,
        hash: List[str] = None,
        image: List[str] = None,
...
class AddContainerDefenseRuleRequestScope(DaraModel):
    def __init__(
        self,

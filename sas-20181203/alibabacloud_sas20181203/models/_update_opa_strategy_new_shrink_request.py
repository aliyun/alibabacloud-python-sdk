...
class UpdateOpaStrategyNewShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        scopes: List[main_models.UpdateOpaStrategyNewShrinkRequestScopes] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Scopes') is not None:
            for k1 in m.get('Scopes'):
                temp_model = main_models.UpdateOpaStrategyNewShrinkRequestScopes()
...
class UpdateOpaStrategyNewShrinkRequestScopes(DaraModel):
    def __init__(
        self,

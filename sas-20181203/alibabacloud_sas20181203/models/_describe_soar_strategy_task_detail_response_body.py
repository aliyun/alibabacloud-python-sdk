...
class DescribeSoarStrategyTaskDetailResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        task_detail: main_models.DescribeSoarStrategyTaskDetailResponseBodyTaskDetail = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TaskDetail') is not None:
            temp_model = main_models.DescribeSoarStrategyTaskDetailResponseBodyTaskDetail()
            self.task_detail = temp_model.from_map(m.get('TaskDetail'))

        return self

class DescribeSoarStrategyTaskDetailResponseBodyTaskDetail(DaraModel):
    def __init__(
        self,
        log_info: str = None,
        params: str = None,

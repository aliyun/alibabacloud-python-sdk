...
class UpdateAttackPathSensitiveAssetConfigRequest(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AttackPathAssetList') is not None:
            for k1 in m.get('AttackPathAssetList'):
                temp_model = main_models.UpdateAttackPathSensitiveAssetConfigRequestAttackPathAssetList()
...
class UpdateAttackPathSensitiveAssetConfigRequestAttackPathAssetList(DaraModel):
    def __init__(
        self,

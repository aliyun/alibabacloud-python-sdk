...
class DescribeSoarStrategiesResponseBody(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        request_id: str = None,
        soar_strategies: List[main_models.DescribeSoarStrategiesResponseBodySoarStrategies] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SoarStrategies') is not None:
            for k1 in m.get('SoarStrategies'):
                temp_model = main_models.DescribeSoarStrategiesResponseBodySoarStrategies()
...
class DescribeSoarStrategiesResponseBodySoarStrategies(DaraModel):
    def __init__(
        self,
        creator: str = None,

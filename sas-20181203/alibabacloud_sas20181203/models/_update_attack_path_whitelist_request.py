...
class UpdateAttackPathWhitelistRequest(DaraModel):
    def __init__(
        self,
        attack_path_asset_list: List[main_models.UpdateAttackPathWhitelistRequestAttackPathAssetList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AttackPathAssetList') is not None:
            for k1 in m.get('AttackPathAssetList'):
                temp_model = main_models.UpdateAttackPathWhitelistRequestAttackPathAssetList()
...
class UpdateAttackPathWhitelistRequestAttackPathAssetList(DaraModel):
    def __init__(
        self,

...
class ModifyContainerDefenseRuleShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        rule_type: int = None,
        scope: List[main_models.ModifyContainerDefenseRuleShrinkRequestScope] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Scope') is not None:
            for k1 in m.get('Scope'):
                temp_model = main_models.ModifyContainerDefenseRuleShrinkRequestScope()
...
class ModifyContainerDefenseRuleShrinkRequestScope(DaraModel):
    def __init__(
        self,

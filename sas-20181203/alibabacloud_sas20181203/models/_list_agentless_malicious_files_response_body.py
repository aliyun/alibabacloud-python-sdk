...
class ListAgentlessMaliciousFilesResponseBody(DaraModel):
    def __init__(
        self,
        list: List[main_models.ListAgentlessMaliciousFilesResponseBodyList] = None,
        page_info: main_models.ListAgentlessMaliciousFilesResponseBodyPageInfo = None,
        request_id: str = None,
    ):
        # The malicious files.
        self.list = list
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            for k1 in m.get('List'):
                temp_model = main_models.ListAgentlessMaliciousFilesResponseBodyList()
                self.list.append(temp_model.from_map(k1))

        if m.get('PageInfo') is not None:
            temp_model = main_models.ListAgentlessMaliciousFilesResponseBodyPageInfo()
...
class ListAgentlessMaliciousFilesResponseBodyPageInfo(DaraModel):
    def __init__(
        self,
        count: int = None,
...
class ListAgentlessMaliciousFilesResponseBodyList(DaraModel):
    def __init__(
        self,
        details: List[main_models.ListAgentlessMaliciousFilesResponseBodyListDetails] = None,
        ...
        notes: List[main_models.ListAgentlessMaliciousFilesResponseBodyListNotes] = None,
    ...
    def to_map(self):
        ...
        if self.notes is not None:
            for k1 in self.notes:
                result['Notes'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Details') is not None:
            for k1 in m.get('Details'):
                temp_model = main_models.ListAgentlessMaliciousFilesResponseBodyListDetails()
        ...
        if m.get('Notes') is not None:
            for k1 in m.get('Notes'):
                temp_model = main_models.ListAgentlessMaliciousFilesResponseBodyListNotes()
                self.notes.append(temp_model.from_map(k1))
...
class ListAgentlessMaliciousFilesResponseBodyListNotes(DaraModel):
    def __init__(
        self,
        note: str = None,
        note_id: str = None,
...
class ListAgentlessMaliciousFilesResponseBodyListDetails(DaraModel):
    def __init__(
        self,
        name: str = None,
        name_key: str = None,

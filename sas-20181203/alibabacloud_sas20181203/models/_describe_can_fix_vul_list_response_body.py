...
class DescribeCanFixVulListResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        vul_records: List[main_models.DescribeCanFixVulListResponseBodyVulRecords] = None,
    ):
        # The request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VulRecords') is not None:
            for k1 in m.get('VulRecords'):
                temp_model = main_models.DescribeCanFixVulListResponseBodyVulRecords()
                self.vul_records.append(temp_model.from_map(k1))

        return self

class DescribeCanFixVulListResponseBodyVulRecords(DaraModel):
    def __init__(
        self,
        alias_name: str = None,
        can_fix: str = None,
        ...
        extend_content_json: main_models.DescribeCanFixVulListResponseBodyVulRecordsExtendContentJson = None,
        first_ts: int = None,
        image: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ExtendContentJson') is not None:
            temp_model = main_models.DescribeCanFixVulListResponseBodyVulRecordsExtendContentJson()
...
class DescribeCanFixVulListResponseBodyVulRecordsExtendContentJson(DaraModel):
    def __init__(
        self,
        os: str = None,
        os_release: str = None,
        rpm_entity_list: List[main_models.DescribeCanFixVulListResponseBodyVulRecordsExtendContentJsonRpmEntityList] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RpmEntityList') is not None:
            for k1 in m.get('RpmEntityList'):
                temp_model = main_models.DescribeCanFixVulListResponseBodyVulRecordsExtendContentJsonRpmEntityList()
                self.rpm_entity_list.append(temp_model.from_map(k1))

        return self

class DescribeCanFixVulListResponseBodyVulRecordsExtendContentJsonRpmEntityList(DaraModel):
    def __init__(
        self,

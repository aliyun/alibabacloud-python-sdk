...
class ListUninstallAegisMachinesResponseBody(DaraModel):
    def __init__(
        self,
        current_page: int = None,
        machine_list: List[main_models.ListUninstallAegisMachinesResponseBodyMachineList] = None,
        page_size: int = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MachineList') is not None:
            for k1 in m.get('MachineList'):
                temp_model = main_models.ListUninstallAegisMachinesResponseBodyMachineList()
...
class ListUninstallAegisMachinesResponseBodyMachineList(DaraModel):
    def __init__(
        self,

...
class DescribeClusterVulStatisticsResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('VulStat') is not None:
            temp_model = main_models.DescribeClusterVulStatisticsResponseBodyVulStat()
            self.vul_stat = temp_model.from_map(m.get('VulStat'))

        return self

class DescribeClusterVulStatisticsResponseBodyVulStat(DaraModel):
    def __init__(
        self,
        asap_count: str = None,

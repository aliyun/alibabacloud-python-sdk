...
class ChangeCheckConfigShrinkRequest(DaraModel):
    def __init__(
        self,
        ...
        end_time: int = None,
        region_id: str = None,
        removed_check: List[main_models.ChangeCheckConfigShrinkRequestRemovedCheck] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RemovedCheck') is not None:
            for k1 in m.get('RemovedCheck'):
                temp_model = main_models.ChangeCheckConfigShrinkRequestRemovedCheck()
...
class ChangeCheckConfigShrinkRequestRemovedCheck(DaraModel):
    def __init__(
        self,
        check_id: int = None,
        section_id: int = None,
...
class ChangeCheckConfigShrinkRequestAddedCheck(DaraModel):
    def __init__(
        self,
        check_id: int = None,
        section_id: int = None,

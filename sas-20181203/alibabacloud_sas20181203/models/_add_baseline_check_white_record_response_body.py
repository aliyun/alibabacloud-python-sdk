...
class AddBaselineCheckWhiteRecordResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.AddBaselineCheckWhiteRecordResponseBodyData = None,
        request_id: str = None,
    ):
        # The data returned.
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.AddBaselineCheckWhiteRecordResponseBodyData()
...
class AddBaselineCheckWhiteRecordResponseBodyData(DaraModel):
    def __init__(
        self,
        check_id: int = None,
        lang: str = None,

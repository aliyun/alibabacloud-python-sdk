...
class ListCheckItemResponseBodyCheckItems(DaraModel):
    def __init__(
        ...
        instance_estimated_count: int = None,
        ...
        self.instance_estimated_count = instance_estimated_count
    ...
    def to_map(self):
        ...
        if self.instance_estimated_count is not None:
            result['InstanceEstimatedCount'] = self.instance_estimated_count
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('InstanceEstimatedCount') is not None:
            self.instance_estimated_count = m.get('InstanceEstimatedCount')

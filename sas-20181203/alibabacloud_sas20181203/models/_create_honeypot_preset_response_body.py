...
class CreateHoneypotPresetResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        honeypot_preset: main_models.CreateHoneypotPresetResponseBodyHoneypotPreset = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HoneypotPreset') is not None:
            temp_model = main_models.CreateHoneypotPresetResponseBodyHoneypotPreset()
            self.honeypot_preset = temp_model.from_map(m.get('HoneypotPreset'))
...
class CreateHoneypotPresetResponseBodyHoneypotPreset(DaraModel):
    def __init__(
        self,

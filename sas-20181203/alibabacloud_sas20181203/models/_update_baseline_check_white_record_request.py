...
class UpdateBaselineCheckWhiteRecordRequest(DaraModel):
    def __init__(
        self,
        check_id: int = None,
        lang: str = None,
        reason: str = None,
        record_id: int = None,
        remove_container_uuids: List[str] = None,
        source: str = None,
    ...
    def to_map(self):
        ...
        if self.remove_container_uuids is not None:
            result['RemoveContainerUuids'] = self.remove_container_uuids
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RemoveContainerUuids') is not None:
            self.remove_container_uuids = m.get('RemoveContainerUuids')

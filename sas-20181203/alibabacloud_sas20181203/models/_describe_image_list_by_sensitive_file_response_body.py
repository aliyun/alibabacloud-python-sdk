...
class DescribeImageListBySensitiveFileResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        http_status_code: int = None,
        image_infos: List[main_models.DescribeImageListBySensitiveFileResponseBodyImageInfos] = None,
        message: str = None,
        page_info: main_models.DescribeImageListBySensitiveFileResponseBodyPageInfo = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ImageInfos') is not None:
            for k1 in m.get('ImageInfos'):
                temp_model = main_models.DescribeImageListBySensitiveFileResponseBodyImageInfos()
        ...
        if m.get('PageInfo') is not None:
            temp_model = main_models.DescribeImageListBySensitiveFileResponseBodyPageInfo()
...
class DescribeImageListBySensitiveFileResponseBodyPageInfo(DaraModel):
    def __init__(
        self,
        count: int = None,
...
class DescribeImageListBySensitiveFileResponseBodyImageInfos(DaraModel):
    def __init__(
        self,
        digest: str = None,

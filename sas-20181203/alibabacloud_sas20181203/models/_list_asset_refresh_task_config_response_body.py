...
class ListAssetRefreshTaskConfigResponseBody(DaraModel):
    def __init__(
        self,
        asset_refresh_config: List[main_models.ListAssetRefreshTaskConfigResponseBodyAssetRefreshConfig] = None,
        request_id: str = None,
    ):
    ...
    def validate(self):
        if self.asset_refresh_config:
            for v1 in self.asset_refresh_config:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.asset_refresh_config is not None:
            for k1 in self.asset_refresh_config:
                result['AssetRefreshConfig'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AssetRefreshConfig') is not None:
            for k1 in m.get('AssetRefreshConfig'):
                temp_model = main_models.ListAssetRefreshTaskConfigResponseBodyAssetRefreshConfig()
                self.asset_refresh_config.append(temp_model.from_map(k1))
...
class ListAssetRefreshTaskConfigResponseBodyAssetRefreshConfig(DaraModel):
    def __init__(
        self,

...
class ResetHoneypotResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.ResetHoneypotResponseBodyData = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.ResetHoneypotResponseBodyData()
...
class ResetHoneypotResponseBodyData(DaraModel):
    def __init__(
        self,

...
class StopHoneypotResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        data: main_models.StopHoneypotResponseBodyData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.StopHoneypotResponseBodyData()
...
class StopHoneypotResponseBodyData(DaraModel):
    def __init__(
        self,

...
2026-09-01 Version: 10.0.1
- Generated python 2018-12-03 for Sas.

2026-09-01 Version: 10.0.0
- Support API ChangeCheckScopeConfigInstance.
- Support API GetCheckScopeConfig.
- Support API UpdateCheckScopeConfig.
- Update API AddAssetSelectionCriteria: add request parameters ClientToken.
- Update API AddCheckInstanceResultWhiteList: add request parameters ClientToken.
- Update API AddCheckResultWhiteList: add request parameters ClientToken.
- Update API AddUnknownThreatDetectProcess: add request parameters HandleRemark.
- Update API AdvanceSecurityEventOperations: add request parameters ResourceDirectoryAccountId.
- Update API BindAuthToMachine: add request parameters ClientToken.
- Update API BindAuthToMachine: add request parameters ProductCode.
- Update API ChangeCheckConfig: add request parameters ClientToken.
- Update API ChangeSecurityScoreRule: add request parameters ResourceDirectoryAccountId.
- Update API CreateAgentlessScanTask: add request parameters ClientToken.
- Update API CreateAgentlessScanTask: add request parameters RegionId.
- Update API CreateAgentlessScanTask: add response parameters Body.TaskId.
- Update API CreateAssetSelectionConfig: add request parameters ClientToken.
- Update API CreateCycleTask: add request parameters ClientToken.
- Update API CreateOssBucketScanTask: add request parameters Source.
- Update API CreateOssScanConfig: add request parameters AutoAdd.
- Update API CreateOssScanConfig: add request parameters ClientToken.
- Update API CreateOssScanConfig: add request parameters Source.
- Update API CreateSasTrial: add request parameters ClientToken.
- Update API CreateServiceLinkedRole: add request parameters ClientToken.
- Update API CreateSimilarSecurityEventsQueryTask: add request parameters ClientToken.
- Update API CreateSimilarSecurityEventsQueryTask: add request parameters ResourceDirectoryAccountId.
- Update API CreateSuspEventNote: add request parameters ResourceDirectoryAccountId.
- Update API CreateVirusScanOnceTask: add request parameters ClientToken.
- Update API DeleteSecurityEventMarkMissList: add request parameters ResourceDirectoryAccountId.
- Update API DeleteSuspEventNode: add request parameters ResourceDirectoryAccountId.
- Update API DeleteVulWhitelist: add request parameters ResourceDirectoryAccountId.
- Update API DescribeAlarmEventDetail: add request parameters ResourceDirectoryAccountId.
- Update API DescribeAllRegionsStatistics: add request parameters ResourceDirectoryAccountId.
- Update API DescribeCanFixVulList: add request parameters ResourceDirectoryAccountId.
- Update API DescribeChartData: add request parameters ResourceDirectoryAccountId.
- Update API DescribeCloudCenterInstances: add response parameters Body.Instances.$.EdrAuthVersion.
- Update API DescribeCloudCenterInstances: add response parameters Body.Instances.$.FreeType.
- Update API DescribeCriteria: add request parameters ResourceDirectoryAccountId.
- Update API DescribeCustomizeReportConfigDetail: add request parameters ResourceDirectoryAccountId.
- Update API DescribeCustomizeReportList: add request parameters ResourceDirectoryAccountId.
- Update API DescribeDomainSecureScore: add request parameters ResourceDirectoryAccountId.
- Update API DescribeEventLevelCount: add request parameters ResourceDirectoryAccountId.
- Update API DescribeEventOnStage: add request parameters ResourceDirectoryAccountId.
- Update API DescribeGroupedInstances: add request parameters ResourceDirectoryAccountId.
- Update API DescribeImageGroupedVulList: add request parameters ResourceDirectoryAccountId.
- Update API DescribeImageVulList: add request parameters ResourceDirectoryAccountId.
- Update API DescribePropertyCronDetail: add request parameters ResourceDirectoryAccountId.
- Update API DescribePropertyScaDetail: add request parameters ResourceDirectoryAccountId.
- Update API DescribePropertyUserDetail: add request parameters ResourceDirectoryAccountId.
- Update API DescribeReportExport: add request parameters ResourceDirectoryAccountId.
- Update API DescribeScreenScoreThread: add request parameters ResourceDirectoryAccountId.
- Update API DescribeSuspEvents: add response parameters Body.SuspEvents.$.DeepAnalyzeReportUrl.
- Update API DescribeUuidsByVulNames: add request parameters ResourceDirectoryAccountId.
- Update API DescribeVersionConfig: add response parameters Body.BuySasEdr.
- Update API DescribeVersionConfig: add response parameters Body.HybridPaidGrayStatus.
- Update API DescribeVersionConfig: add response parameters Body.SasEdrClientAuthCount.
- Update API DescribeVersionConfig: add response parameters Body.SasEdrPostPaidInstanceId.
- Update API DescribeVersionConfig: add response parameters Body.SasEdrPrePaidInstanceId.
- Update API DescribeVersionConfig: add response parameters Body.SasEdrPrePaidInstanceStatus.
- Update API DescribeVersionConfig: add response parameters Body.SasEdrVersion.
- Update API DescribeVersionConfig: add response parameters Body.TrialModuleList.
- Update API DescribeVersionConfig: add response parameters Body.TrialVersion.
- Update API DescribeVulCheckTaskStatusDetail: add request parameters ResourceDirectoryAccountId.
- Update API DescribeVulWhitelist: add request parameters ResourceDirectoryAccountId.
- Update API ExportCustomizeReport: add request parameters ResourceDirectoryAccountId.
- Update API ExportSuspEvents: add request parameters ResourceDirectoryAccountId.
- Update API ExportVul: add request parameters AssetType.
- Update API GetAlarmMachineCount: add request parameters ResourceDirectoryAccountId.
- Update API GetAttackPathEventDetail: add response parameters Body.AttackPathEvent.PathInterpretationStatus.
- Update API GetAttackPathEventDetail: add response parameters Body.AttackPathEvent.PathInterpretationUrl.
- Update API GetAuthSummary: add response parameters Body.EdrSummary.
- Update API GetAuthSummary: add response parameters Body.PostPaidVersionSummary.$.FreeCoreCount.
- Update API GetAuthSummary: add response parameters Body.PostPaidVersionSummary.$.FreeEcsCount.
- Update API GetAuthSummary: add response parameters Body.PostPaidVersionSummary.$.FreeType.
- Update API GetCheckConfig: add request parameters ResourceDirectoryAccountId.
- Update API GetCheckConfig: add request The number of query or body parameters has changed from zero to many.
- Update API GetCheckProcess: add request parameters ResourceDirectoryAccountId.
- Update API GetCheckTimeDimensionStatistic: add request parameters ResourceDirectoryAccountId.
- Update API GetCloudAssetSummary: add request parameters ResourceDirectoryAccountId.
- Update API GetDataTrend: add request parameters ResourceDirectoryAccountId.
- Update API GetInstanceAlarmStatistics: add request parameters ResourceDirectoryAccountId.
- Update API GetInstanceAuthRange: add response parameters Body.InstanceAuthRange.CspmInstanceCapacity.
- Update API GetInterceptionSummary: add request parameters ExcludeClusterTypes.
- Update API GetOssScanConfig: add response parameters Body.Data.AutoAdd.
- Update API GetOssScanConfig: add response parameters Body.Data.AutoAddConfigName.
- Update API GetOssScanConfig: add response parameters Body.Data.Source.
- Update API GetSecurityScoreRule: add request parameters ResourceDirectoryAccountId.
- Update API GetSuspiciousStatistics: add request parameters ResourceDirectoryAccountId.
- Update API GetValidDeductInstances: add response parameters Body.Data.TrialVersion.
- Update API HandleSimilarSecurityEvents: add request parameters ResourceDirectoryAccountId.
- Update API HandleUnknownThreatDetectEvent: add request parameters HandleRemark.
- Update API ListAgentlessRiskUuid: add response parameters Body.List.$.ReportUrlHtml.
- Update API ListCheckItem: add response parameters Body.CheckItems.$.InstanceEstimatedCount.
- Update API ListCloudAssetInstances: add request parameters ResourceDirectoryAccountId.
- Update API ListClusterInterceptionConfig: add request parameters ExcludeClusterTypes.
- Update API ListMultiUserInstances: add response parameters Body.DaInstance.CspmInstanceCapacity.
- Update API ListMultiUserInstances: add response parameters Body.SaleInstanceList.$.CspmInstanceCapacity.
- Update API ListOssBucket: add request parameters Source.
- Update API ListOssBucketScanInfo: add request parameters FuzzFileSystemName.
- Update API ListOssBucketScanInfo: add request parameters Source.
- Update API ListOssBucketScanInfo: add response parameters Body.Data.$.FileSystemName.
- Update API ListOssScanConfig: add request parameters Source.
- Update API ListOssScanConfig: add response parameters Body.Data.$.AutoAdd.
- Update API ListOssScanConfig: add response parameters Body.Data.$.AutoAddConfigName.
- Update API ListOssScanConfig: add response parameters Body.Data.$.Source.
- Update API ListUnknownThreatDetectEvent: add response parameters Body.Data.$.HandleRemark.
- Update API ListUnknownThreatDetectMachine: add request parameters EventStatus.
- Update API ListUnknownThreatDetectMachine: add response parameters Body.Data.$.MaliciousProcessCount.
- Update API ListUnknownThreatDetectMachine: add response parameters Body.Data.$.NormalEventCount.
- Update API ListUnknownThreatDetectMachine: add response parameters Body.Data.$.RecentDeviationBehaviorCount.
- Update API ModifyCreateVulWhitelist: add request parameters ClientToken.
- Update API ModifyCreateVulWhitelist: add request parameters ResourceDirectoryAccountId.
- Update API ModifyEmgVulSubmit: add request parameters ClientToken.
- Update API ModifyNoticeConfig: add request parameters ClientToken.
- Update API ModifyOperateVul: add request parameters ClientToken.
- Update API ModifyOperateVul: add request parameters ResourceDirectoryAccountId.
- Update API ModifyPostPayModuleSwitch: add request parameters ClientToken.
- Update API ModifyPostPayModuleSwitch: add request parameters EdrModuleSwitch.
- Update API ModifySecurityEventMarkMissIndividually: add request parameters ResourceDirectoryAccountId.
- Update API ModifyServerlessAuthToMachine: add request parameters ClientToken.
- Update API ModifyStartVulScan: add request parameters ClientToken.
- Update API ModifyStartVulScan: add request parameters ResourceDirectoryAccountId.
- Update API ModifyVulConfig: add request parameters ClientToken.
- Update API OperateBucketScanTask: add request parameters Source.
- Update API OperateCommonOverallConfig: add request parameters ClientToken.
- Update API OperateVuls: add request parameters ResourceDirectoryAccountId.
- Update API OperationCancelIgnoreSuspEvent: add request parameters ResourceDirectoryAccountId.
- Update API OperationSuspEvents: add request parameters ResourceDirectoryAccountId.
- Update API QueryAttackCount: add request parameters ResourceDirectoryAccountId.
- Update API RefreshAssets: add request parameters ResourceDirectoryAccountId.
- Update API RefreshOssBucketScanInfo: add request parameters Source.
- Update API RefreshOssBucketScanInfo: add request The number of query or body parameters has changed from zero to many.
- Update API RollbackSuspEventQuaraFile: add request parameters ResourceDirectoryAccountId.
- Update API SaveCustomizeReportConfig: add request parameters ResourceDirectoryAccountId.
- Update API SaveSuspEventUserSetting: add request parameters ResourceDirectoryAccountId.
- Update API SendCustomizeReport: add request parameters ResourceDirectoryAccountId.
- Update API SubmitCheck: add request parameters ResourceDirectoryAccountId.
- Update API UpdateAlarmEvent: add request parameters ResourceDirectoryAccountId.
- Update API UpdateMultiUserInstances: add request parameters MemberInstances.$.CspmInstanceCapacity.
- Update API UpdateOssScanConfig: add request parameters AutoAdd.
- Update API UpdateOssScanConfig: add request parameters Source.
- Update API UpdatePostPaidBindRel: add request parameters ClientToken.
- Update API UpdatePostPaidBindRel: add request parameters ProductCode.
- Update API UpdatePostPaidBindRel: add request parameters BindAction.$.FreeType.
- Update API UpdateSelectionKeyByType: add request parameters ClientToken.
- Update API VerifyCheckInstanceResult: add request parameters ClientToken.
- Update API VerifyCheckResult: add request parameters Force.

...
```bash
# 安装 alibabacloud_carbonfootprint20230711
pip install alibabacloud_carbonfootprint20230711
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/carbonfootprint-20230711/ChangeLog.md)中。

...
class DescribeCdnUserBillTypeResponseBody(DaraModel):
    def __init__(
        self,
        bill_type_data: main_models.DescribeCdnUserBillTypeResponseBodyBillTypeData = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BillTypeData') is not None:
            temp_model = main_models.DescribeCdnUserBillTypeResponseBodyBillTypeData()
...
class DescribeCdnUserBillTypeResponseBodyBillTypeData(DaraModel):
    def __init__(
        self,
        bill_type_data_item: List[main_models.DescribeCdnUserBillTypeResponseBodyBillTypeDataBillTypeDataItem] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BillTypeDataItem') is not None:
            for k1 in m.get('BillTypeDataItem'):
                temp_model = main_models.DescribeCdnUserBillTypeResponseBodyBillTypeDataBillTypeDataItem()
                self.bill_type_data_item.append(temp_model.from_map(k1))

        return self

class DescribeCdnUserBillTypeResponseBodyBillTypeDataBillTypeDataItem(DaraModel):
    def __init__(
        self,
        bill_type: str = None,

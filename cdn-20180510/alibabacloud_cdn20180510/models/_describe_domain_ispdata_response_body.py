...
class DescribeDomainISPDataResponseBody(DaraModel):
    def __init__(
        self,
        ...
        request_id: str = None,
        start_time: str = None,
        value: main_models.DescribeDomainISPDataResponseBodyValue = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Value') is not None:
            temp_model = main_models.DescribeDomainISPDataResponseBodyValue()
            self.value = temp_model.from_map(m.get('Value'))

        return self

class DescribeDomainISPDataResponseBodyValue(DaraModel):
    def __init__(
        self,
        ispproportion_data: List[main_models.DescribeDomainISPDataResponseBodyValueISPProportionData] = None,
    ):
        self.ispproportion_data = ispproportion_data

    def validate(self):
        if self.ispproportion_data:
            for v1 in self.ispproportion_data:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.ispproportion_data is not None:
            for k1 in self.ispproportion_data:
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ISPProportionData') is not None:
            for k1 in m.get('ISPProportionData'):
                temp_model = main_models.DescribeDomainISPDataResponseBodyValueISPProportionData()
                self.ispproportion_data.append(temp_model.from_map(k1))

        return self

class DescribeDomainISPDataResponseBodyValueISPProportionData(DaraModel):
    def __init__(
        self,

...
class DescribeDomainTrafficDataResponseBody(DaraModel):
    def __init__(
        self,
        ...
        request_id: str = None,
        start_time: str = None,
        traffic_data_per_interval: main_models.DescribeDomainTrafficDataResponseBodyTrafficDataPerInterval = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TrafficDataPerInterval') is not None:
            temp_model = main_models.DescribeDomainTrafficDataResponseBodyTrafficDataPerInterval()
            self.traffic_data_per_interval = temp_model.from_map(m.get('TrafficDataPerInterval'))

        return self

class DescribeDomainTrafficDataResponseBodyTrafficDataPerInterval(DaraModel):
    def __init__(
        self,
        data_module: List[main_models.DescribeDomainTrafficDataResponseBodyTrafficDataPerIntervalDataModule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataModule') is not None:
            for k1 in m.get('DataModule'):
                temp_model = main_models.DescribeDomainTrafficDataResponseBodyTrafficDataPerIntervalDataModule()
                self.data_module.append(temp_model.from_map(k1))

        return self

class DescribeDomainTrafficDataResponseBodyTrafficDataPerIntervalDataModule(DaraModel):
    def __init__(
        self,

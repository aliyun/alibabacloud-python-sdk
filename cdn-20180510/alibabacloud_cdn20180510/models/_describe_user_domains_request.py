...
class DescribeUserDomainsRequest(DaraModel):
    def __init__(
        self,
        cdn_type: str = None,
        ...
        source: str = None,
        tag: List[main_models.DescribeUserDomainsRequestTag] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.DescribeUserDomainsRequestTag()
                self.tag.append(temp_model.from_map(k1))

        return self

class DescribeUserDomainsRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

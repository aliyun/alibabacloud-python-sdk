...
class DescribeDomainMax95BpsDataResponseBody(DaraModel):
    def __init__(
        self,
        detail_data: main_models.DescribeDomainMax95BpsDataResponseBodyDetailData = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DetailData') is not None:
            temp_model = main_models.DescribeDomainMax95BpsDataResponseBodyDetailData()
...
class DescribeDomainMax95BpsDataResponseBodyDetailData(DaraModel):
    def __init__(
        self,
        max_95detail: List[main_models.DescribeDomainMax95BpsDataResponseBodyDetailDataMax95Detail] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Max95Detail') is not None:
            for k1 in m.get('Max95Detail'):
                temp_model = main_models.DescribeDomainMax95BpsDataResponseBodyDetailDataMax95Detail()
                self.max_95detail.append(temp_model.from_map(k1))

        return self

class DescribeDomainMax95BpsDataResponseBodyDetailDataMax95Detail(DaraModel):
    def __init__(
        self,
        area: str = None,

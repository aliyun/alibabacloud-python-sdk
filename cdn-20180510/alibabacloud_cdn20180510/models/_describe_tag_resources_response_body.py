...
class DescribeTagResourcesResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        tag_resources: List[main_models.DescribeTagResourcesResponseBodyTagResources] = None,
    ):
...
class DescribeTagResourcesResponseBodyTagResources(DaraModel):
    def __init__(
        ...
        tag: List[main_models.DescribeTagResourcesResponseBodyTagResourcesTag] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.DescribeTagResourcesResponseBodyTagResourcesTag()
                self.tag.append(temp_model.from_map(k1))

        return self

class DescribeTagResourcesResponseBodyTagResourcesTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

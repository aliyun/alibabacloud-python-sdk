...
class DescribeCdnSSLCertificateListResponseBody(DaraModel):
    def __init__(
        self,
        certificate_list_model: main_models.DescribeCdnSSLCertificateListResponseBodyCertificateListModel = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CertificateListModel') is not None:
            temp_model = main_models.DescribeCdnSSLCertificateListResponseBodyCertificateListModel()
...
class DescribeCdnSSLCertificateListResponseBodyCertificateListModel(DaraModel):
    def __init__(
        self,
        cert_list: main_models.DescribeCdnSSLCertificateListResponseBodyCertificateListModelCertList = None,
        count: int = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CertList') is not None:
            temp_model = main_models.DescribeCdnSSLCertificateListResponseBodyCertificateListModelCertList()
...
class DescribeCdnSSLCertificateListResponseBodyCertificateListModelCertList(DaraModel):
    def __init__(
        self,
        cert: List[main_models.DescribeCdnSSLCertificateListResponseBodyCertificateListModelCertListCert] = None,
    ):
        self.cert = cert
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Cert') is not None:
            for k1 in m.get('Cert'):
                temp_model = main_models.DescribeCdnSSLCertificateListResponseBodyCertificateListModelCertListCert()
                self.cert.append(temp_model.from_map(k1))

        return self

class DescribeCdnSSLCertificateListResponseBodyCertificateListModelCertListCert(DaraModel):
    def __init__(
        self,
        cert_id: int = None,
        cert_name: str = None,

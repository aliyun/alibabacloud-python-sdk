...
class DescribeDomainCertificateInfoResponseBody(DaraModel):
    def __init__(
        self,
        cert_infos: main_models.DescribeDomainCertificateInfoResponseBodyCertInfos = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CertInfos') is not None:
            temp_model = main_models.DescribeDomainCertificateInfoResponseBodyCertInfos()
...
class DescribeDomainCertificateInfoResponseBodyCertInfos(DaraModel):
    def __init__(
        self,
        cert_info: List[main_models.DescribeDomainCertificateInfoResponseBodyCertInfosCertInfo] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CertInfo') is not None:
            for k1 in m.get('CertInfo'):
                temp_model = main_models.DescribeDomainCertificateInfoResponseBodyCertInfosCertInfo()
                self.cert_info.append(temp_model.from_map(k1))

        return self

class DescribeDomainCertificateInfoResponseBodyCertInfosCertInfo(DaraModel):
    def __init__(
        self,

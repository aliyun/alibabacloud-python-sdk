...
class DescribeCdnTaskListResponseBody(DaraModel):
    def __init__(
        self,
        content: main_models.DescribeCdnTaskListResponseBodyContent = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Content') is not None:
            temp_model = main_models.DescribeCdnTaskListResponseBodyContent()
...
class DescribeCdnTaskListResponseBodyContent(DaraModel):
    def __init__(
        self,
        count: int = None,
        list: List[main_models.DescribeCdnTaskListResponseBodyContentList] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('List') is not None:
            for k1 in m.get('List'):
                temp_model = main_models.DescribeCdnTaskListResponseBodyContentList()
...
class DescribeCdnTaskListResponseBodyContentList(DaraModel):
    def __init__(
        self,
        aliuid: str = None,

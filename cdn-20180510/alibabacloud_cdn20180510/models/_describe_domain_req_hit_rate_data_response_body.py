...
class DescribeDomainReqHitRateDataResponseBody(DaraModel):
    def __init__(
        self,
        data_interval: str = None,
        domain_name: str = None,
        end_time: str = None,
        req_hit_rate_interval: main_models.DescribeDomainReqHitRateDataResponseBodyReqHitRateInterval = None,
        request_id: str = None,
        start_time: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ReqHitRateInterval') is not None:
            temp_model = main_models.DescribeDomainReqHitRateDataResponseBodyReqHitRateInterval()
            self.req_hit_rate_interval = temp_model.from_map(m.get('ReqHitRateInterval'))
...
class DescribeDomainReqHitRateDataResponseBodyReqHitRateInterval(DaraModel):
    def __init__(
        self,
        data_module: List[main_models.DescribeDomainReqHitRateDataResponseBodyReqHitRateIntervalDataModule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataModule') is not None:
            for k1 in m.get('DataModule'):
                temp_model = main_models.DescribeDomainReqHitRateDataResponseBodyReqHitRateIntervalDataModule()
                self.data_module.append(temp_model.from_map(k1))

        return self

class DescribeDomainReqHitRateDataResponseBodyReqHitRateIntervalDataModule(DaraModel):
    def __init__(
        self,

...
class DescribeCdnHttpsDomainListResponseBody(DaraModel):
    def __init__(
        self,
        cert_infos: main_models.DescribeCdnHttpsDomainListResponseBodyCertInfos = None,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CertInfos') is not None:
            temp_model = main_models.DescribeCdnHttpsDomainListResponseBodyCertInfos()
...
class DescribeCdnHttpsDomainListResponseBodyCertInfos(DaraModel):
    def __init__(
        self,
        cert_info: List[main_models.DescribeCdnHttpsDomainListResponseBodyCertInfosCertInfo] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('CertInfo') is not None:
            for k1 in m.get('CertInfo'):
                temp_model = main_models.DescribeCdnHttpsDomainListResponseBodyCertInfosCertInfo()
                self.cert_info.append(temp_model.from_map(k1))

        return self

class DescribeCdnHttpsDomainListResponseBodyCertInfosCertInfo(DaraModel):
    def __init__(
        self,

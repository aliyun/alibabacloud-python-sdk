...
class DescribeDomainRegionDataResponseBody(DaraModel):
    def __init__(
        self,
        ...
        request_id: str = None,
        start_time: str = None,
        value: main_models.DescribeDomainRegionDataResponseBodyValue = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Value') is not None:
            temp_model = main_models.DescribeDomainRegionDataResponseBodyValue()
            self.value = temp_model.from_map(m.get('Value'))

        return self

class DescribeDomainRegionDataResponseBodyValue(DaraModel):
    def __init__(
        self,
        region_proportion_data: List[main_models.DescribeDomainRegionDataResponseBodyValueRegionProportionData] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RegionProportionData') is not None:
            for k1 in m.get('RegionProportionData'):
                temp_model = main_models.DescribeDomainRegionDataResponseBodyValueRegionProportionData()
                self.region_proportion_data.append(temp_model.from_map(k1))

        return self

class DescribeDomainRegionDataResponseBodyValueRegionProportionData(DaraModel):
    def __init__(
        self,

...
class DescribeDomainPvDataResponseBody(DaraModel):
    def __init__(
        self,
        data_interval: str = None,
        domain_name: str = None,
        end_time: str = None,
        pv_data_interval: main_models.DescribeDomainPvDataResponseBodyPvDataInterval = None,
        request_id: str = None,
        start_time: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('PvDataInterval') is not None:
            temp_model = main_models.DescribeDomainPvDataResponseBodyPvDataInterval()
...
class DescribeDomainPvDataResponseBodyPvDataInterval(DaraModel):
    def __init__(
        self,
        usage_data: List[main_models.DescribeDomainPvDataResponseBodyPvDataIntervalUsageData] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UsageData') is not None:
            for k1 in m.get('UsageData'):
                temp_model = main_models.DescribeDomainPvDataResponseBodyPvDataIntervalUsageData()
                self.usage_data.append(temp_model.from_map(k1))

        return self

class DescribeDomainPvDataResponseBodyPvDataIntervalUsageData(DaraModel):
    def __init__(
        self,
        time_stamp: str = None,
        value: str = None,

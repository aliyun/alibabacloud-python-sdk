...
class DescribeDomainSrcTrafficDataResponseBody(DaraModel):
    def __init__(
        self,
        ...
        end_time: str = None,
        request_id: str = None,
        src_traffic_data_per_interval: main_models.DescribeDomainSrcTrafficDataResponseBodySrcTrafficDataPerInterval = None,
        start_time: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SrcTrafficDataPerInterval') is not None:
            temp_model = main_models.DescribeDomainSrcTrafficDataResponseBodySrcTrafficDataPerInterval()
...
class DescribeDomainSrcTrafficDataResponseBodySrcTrafficDataPerInterval(DaraModel):
    def __init__(
        self,
        data_module: List[main_models.DescribeDomainSrcTrafficDataResponseBodySrcTrafficDataPerIntervalDataModule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataModule') is not None:
            for k1 in m.get('DataModule'):
                temp_model = main_models.DescribeDomainSrcTrafficDataResponseBodySrcTrafficDataPerIntervalDataModule()
                self.data_module.append(temp_model.from_map(k1))

        return self

class DescribeDomainSrcTrafficDataResponseBodySrcTrafficDataPerIntervalDataModule(DaraModel):
    def __init__(
        self,

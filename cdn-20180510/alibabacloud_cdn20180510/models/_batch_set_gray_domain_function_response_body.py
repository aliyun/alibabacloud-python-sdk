...
class BatchSetGrayDomainFunctionResponseBody(DaraModel):
    def __init__(
        self,
        domain_config_list: List[main_models.BatchSetGrayDomainFunctionResponseBodyDomainConfigList] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DomainConfigList') is not None:
            for k1 in m.get('DomainConfigList'):
                temp_model = main_models.BatchSetGrayDomainFunctionResponseBodyDomainConfigList()
...
class BatchSetGrayDomainFunctionResponseBodyDomainConfigList(DaraModel):
    def __init__(
        self,
        config_id: int = None,

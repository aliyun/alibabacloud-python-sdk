...
class DescribeDomainQpsDataResponseBody(DaraModel):
    def __init__(
        self,
        data_interval: str = None,
        domain_name: str = None,
        end_time: str = None,
        qps_data_interval: main_models.DescribeDomainQpsDataResponseBodyQpsDataInterval = None,
        request_id: str = None,
        start_time: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('QpsDataInterval') is not None:
            temp_model = main_models.DescribeDomainQpsDataResponseBodyQpsDataInterval()
...
class DescribeDomainQpsDataResponseBodyQpsDataInterval(DaraModel):
    def __init__(
        self,
        data_module: List[main_models.DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataModule') is not None:
            for k1 in m.get('DataModule'):
                temp_model = main_models.DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule()
                self.data_module.append(temp_model.from_map(k1))

        return self

class DescribeDomainQpsDataResponseBodyQpsDataIntervalDataModule(DaraModel):
    def __init__(
        self,

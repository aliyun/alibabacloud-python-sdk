...
class DescribeDomainRealTimeByteHitRateDataResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.DescribeDomainRealTimeByteHitRateDataResponseBodyData = None,
        request_id: str = None,
    ):
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DescribeDomainRealTimeByteHitRateDataResponseBodyData()
...
class DescribeDomainRealTimeByteHitRateDataResponseBodyData(DaraModel):
    def __init__(
        self,
        byte_hit_rate_data_model: List[main_models.DescribeDomainRealTimeByteHitRateDataResponseBodyDataByteHitRateDataModel] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ByteHitRateDataModel') is not None:
            for k1 in m.get('ByteHitRateDataModel'):
                temp_model = main_models.DescribeDomainRealTimeByteHitRateDataResponseBodyDataByteHitRateDataModel()
                self.byte_hit_rate_data_model.append(temp_model.from_map(k1))

        return self

class DescribeDomainRealTimeByteHitRateDataResponseBodyDataByteHitRateDataModel(DaraModel):
    def __init__(
        self,

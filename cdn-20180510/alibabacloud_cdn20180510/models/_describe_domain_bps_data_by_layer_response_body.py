...
class DescribeDomainBpsDataByLayerResponseBody(DaraModel):
    def __init__(
        self,
        bps_data_interval: main_models.DescribeDomainBpsDataByLayerResponseBodyBpsDataInterval = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BpsDataInterval') is not None:
            temp_model = main_models.DescribeDomainBpsDataByLayerResponseBodyBpsDataInterval()
...
class DescribeDomainBpsDataByLayerResponseBodyBpsDataInterval(DaraModel):
    def __init__(
        self,
        data_module: List[main_models.DescribeDomainBpsDataByLayerResponseBodyBpsDataIntervalDataModule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataModule') is not None:
            for k1 in m.get('DataModule'):
                temp_model = main_models.DescribeDomainBpsDataByLayerResponseBodyBpsDataIntervalDataModule()
                self.data_module.append(temp_model.from_map(k1))

        return self

class DescribeDomainBpsDataByLayerResponseBodyBpsDataIntervalDataModule(DaraModel):
    def __init__(
        self,
        time_stamp: str = None,

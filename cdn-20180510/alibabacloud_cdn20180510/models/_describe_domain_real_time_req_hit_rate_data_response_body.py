...
class DescribeDomainRealTimeReqHitRateDataResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.DescribeDomainRealTimeReqHitRateDataResponseBodyData = None,
        request_id: str = None,
    ):
        self.data = data
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DescribeDomainRealTimeReqHitRateDataResponseBodyData()
...
class DescribeDomainRealTimeReqHitRateDataResponseBodyData(DaraModel):
    def __init__(
        self,
        req_hit_rate_data_model: List[main_models.DescribeDomainRealTimeReqHitRateDataResponseBodyDataReqHitRateDataModel] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ReqHitRateDataModel') is not None:
            for k1 in m.get('ReqHitRateDataModel'):
                temp_model = main_models.DescribeDomainRealTimeReqHitRateDataResponseBodyDataReqHitRateDataModel()
                self.req_hit_rate_data_model.append(temp_model.from_map(k1))

        return self

class DescribeDomainRealTimeReqHitRateDataResponseBodyDataReqHitRateDataModel(DaraModel):
    def __init__(
        self,

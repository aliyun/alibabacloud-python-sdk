...
class DescribeStagingIpResponseBody(DaraModel):
    def __init__(
        self,
        ipv4s: main_models.DescribeStagingIpResponseBodyIPV4s = None,
        request_id: str = None,
    ):
        self.ipv4s = ipv4s
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('IPV4s') is not None:
            temp_model = main_models.DescribeStagingIpResponseBodyIPV4s()
...
class DescribeStagingIpResponseBodyIPV4s(DaraModel):
    def __init__(
        self,
        ipv4: List[str] = None,
    ):

...
class DescribeCdnUserConfigsResponseBody(DaraModel):
    def __init__(
        self,
        configs: List[main_models.DescribeCdnUserConfigsResponseBodyConfigs] = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Configs') is not None:
            for k1 in m.get('Configs'):
                temp_model = main_models.DescribeCdnUserConfigsResponseBodyConfigs()
...
class DescribeCdnUserConfigsResponseBodyConfigs(DaraModel):
    def __init__(
        self,
        arg_name: str = None,
        arg_value: str = None,

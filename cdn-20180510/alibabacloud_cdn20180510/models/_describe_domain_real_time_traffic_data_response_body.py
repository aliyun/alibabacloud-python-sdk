...
class DescribeDomainRealTimeTrafficDataResponseBody(DaraModel):
    def __init__(
        self,
        data_interval: str = None,
        domain_name: str = None,
        end_time: str = None,
        real_time_traffic_data_per_interval: main_models.DescribeDomainRealTimeTrafficDataResponseBodyRealTimeTrafficDataPerInterval = None,
        request_id: str = None,
        start_time: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RealTimeTrafficDataPerInterval') is not None:
            temp_model = main_models.DescribeDomainRealTimeTrafficDataResponseBodyRealTimeTrafficDataPerInterval()
...
class DescribeDomainRealTimeTrafficDataResponseBodyRealTimeTrafficDataPerInterval(DaraModel):
    def __init__(
        self,
        data_module: List[main_models.DescribeDomainRealTimeTrafficDataResponseBodyRealTimeTrafficDataPerIntervalDataModule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataModule') is not None:
            for k1 in m.get('DataModule'):
                temp_model = main_models.DescribeDomainRealTimeTrafficDataResponseBodyRealTimeTrafficDataPerIntervalDataModule()
                self.data_module.append(temp_model.from_map(k1))

        return self

class DescribeDomainRealTimeTrafficDataResponseBodyRealTimeTrafficDataPerIntervalDataModule(DaraModel):
    def __init__(
        self,
        time_stamp: str = None,
        value: str = None,

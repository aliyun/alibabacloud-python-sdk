...
class DescribeDomainRealTimeHttpCodeDataResponseBody(DaraModel):
    def __init__(
        self,
        data_interval: str = None,
        domain_name: str = None,
        end_time: str = None,
        real_time_http_code_data: main_models.DescribeDomainRealTimeHttpCodeDataResponseBodyRealTimeHttpCodeData = None,
        request_id: str = None,
        start_time: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RealTimeHttpCodeData') is not None:
            temp_model = main_models.DescribeDomainRealTimeHttpCodeDataResponseBodyRealTimeHttpCodeData()
...
class DescribeDomainRealTimeHttpCodeDataResponseBodyRealTimeHttpCodeData(DaraModel):
    def __init__(
        self,
        usage_data: List[main_models.DescribeDomainRealTimeHttpCodeDataResponseBodyRealTimeHttpCodeDataUsageData] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('UsageData') is not None:
            for k1 in m.get('UsageData'):
                temp_model = main_models.DescribeDomainRealTimeHttpCodeDataResponseBodyRealTimeHttpCodeDataUsageData()
                self.usage_data.append(temp_model.from_map(k1))

        return self

class DescribeDomainRealTimeHttpCodeDataResponseBodyRealTimeHttpCodeDataUsageData(DaraModel):
    def __init__(
        self,
        time_stamp: str = None,
        value: main_models.DescribeDomainRealTimeHttpCodeDataResponseBodyRealTimeHttpCodeDataUsageDataValue = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Value') is not None:
            temp_model = main_models.DescribeDomainRealTimeHttpCodeDataResponseBodyRealTimeHttpCodeDataUsageDataValue()
            self.value = temp_model.from_map(m.get('Value'))

        return self

class DescribeDomainRealTimeHttpCodeDataResponseBodyRealTimeHttpCodeDataUsageDataValue(DaraModel):
    def __init__(
        self,
        real_time_code_proportion_data: List[main_models.DescribeDomainRealTimeHttpCodeDataResponseBodyRealTimeHttpCodeDataUsageDataValueRealTimeCodeProportionData] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('RealTimeCodeProportionData') is not None:
            for k1 in m.get('RealTimeCodeProportionData'):
                temp_model = main_models.DescribeDomainRealTimeHttpCodeDataResponseBodyRealTimeHttpCodeDataUsageDataValueRealTimeCodeProportionData()
                self.real_time_code_proportion_data.append(temp_model.from_map(k1))

        return self

class DescribeDomainRealTimeHttpCodeDataResponseBodyRealTimeHttpCodeDataUsageDataValueRealTimeCodeProportionData(DaraModel):
    def __init__(
        self,
        code: str = None,
        count: str = None,

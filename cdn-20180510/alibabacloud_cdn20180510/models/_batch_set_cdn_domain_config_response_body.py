...
class BatchSetCdnDomainConfigResponseBody(DaraModel):
    def __init__(
        self,
        domain_config_list: main_models.BatchSetCdnDomainConfigResponseBodyDomainConfigList = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DomainConfigList') is not None:
            temp_model = main_models.BatchSetCdnDomainConfigResponseBodyDomainConfigList()
...
class BatchSetCdnDomainConfigResponseBodyDomainConfigList(DaraModel):
    def __init__(
        self,
        domain_config_model: List[main_models.BatchSetCdnDomainConfigResponseBodyDomainConfigListDomainConfigModel] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DomainConfigModel') is not None:
            for k1 in m.get('DomainConfigModel'):
                temp_model = main_models.BatchSetCdnDomainConfigResponseBodyDomainConfigListDomainConfigModel()
                self.domain_config_model.append(temp_model.from_map(k1))

        return self

class BatchSetCdnDomainConfigResponseBodyDomainConfigListDomainConfigModel(DaraModel):
    def __init__(
        self,
        config_id: int = None,

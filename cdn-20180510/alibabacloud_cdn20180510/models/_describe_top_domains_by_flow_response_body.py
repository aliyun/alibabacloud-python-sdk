...
class DescribeTopDomainsByFlowResponseBody(DaraModel):
    def __init__(
        self,
        ...
        request_id: str = None,
        start_time: str = None,
        top_domains: main_models.DescribeTopDomainsByFlowResponseBodyTopDomains = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TopDomains') is not None:
            temp_model = main_models.DescribeTopDomainsByFlowResponseBodyTopDomains()
            self.top_domains = temp_model.from_map(m.get('TopDomains'))

        return self

class DescribeTopDomainsByFlowResponseBodyTopDomains(DaraModel):
    def __init__(
        self,
        top_domain: List[main_models.DescribeTopDomainsByFlowResponseBodyTopDomainsTopDomain] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TopDomain') is not None:
            for k1 in m.get('TopDomain'):
                temp_model = main_models.DescribeTopDomainsByFlowResponseBodyTopDomainsTopDomain()
                self.top_domain.append(temp_model.from_map(k1))

        return self

class DescribeTopDomainsByFlowResponseBodyTopDomainsTopDomain(DaraModel):
    def __init__(
        self,

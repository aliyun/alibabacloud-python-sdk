...
class DescribeDomainHitRateDataResponseBody(DaraModel):
    def __init__(
        self,
        data_interval: str = None,
        domain_name: str = None,
        end_time: str = None,
        hit_rate_interval: main_models.DescribeDomainHitRateDataResponseBodyHitRateInterval = None,
        request_id: str = None,
        start_time: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('HitRateInterval') is not None:
            temp_model = main_models.DescribeDomainHitRateDataResponseBodyHitRateInterval()
...
class DescribeDomainHitRateDataResponseBodyHitRateInterval(DaraModel):
    def __init__(
        self,
        data_module: List[main_models.DescribeDomainHitRateDataResponseBodyHitRateIntervalDataModule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataModule') is not None:
            for k1 in m.get('DataModule'):
                temp_model = main_models.DescribeDomainHitRateDataResponseBodyHitRateIntervalDataModule()
                self.data_module.append(temp_model.from_map(k1))

        return self

class DescribeDomainHitRateDataResponseBodyHitRateIntervalDataModule(DaraModel):
    def __init__(
        self,

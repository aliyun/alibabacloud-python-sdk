...
class DescribeDomainBpsDataResponseBody(DaraModel):
    def __init__(
        self,
        bps_data_per_interval: main_models.DescribeDomainBpsDataResponseBodyBpsDataPerInterval = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('BpsDataPerInterval') is not None:
            temp_model = main_models.DescribeDomainBpsDataResponseBodyBpsDataPerInterval()
...
class DescribeDomainBpsDataResponseBodyBpsDataPerInterval(DaraModel):
    def __init__(
        self,
        data_module: List[main_models.DescribeDomainBpsDataResponseBodyBpsDataPerIntervalDataModule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataModule') is not None:
            for k1 in m.get('DataModule'):
                temp_model = main_models.DescribeDomainBpsDataResponseBodyBpsDataPerIntervalDataModule()
                self.data_module.append(temp_model.from_map(k1))

        return self

class DescribeDomainBpsDataResponseBodyBpsDataPerIntervalDataModule(DaraModel):
    def __init__(
        self,

...
class DescribeDomainSrcBpsDataResponseBody(DaraModel):
    def __init__(
        self,
        ...
        end_time: str = None,
        request_id: str = None,
        src_bps_data_per_interval: main_models.DescribeDomainSrcBpsDataResponseBodySrcBpsDataPerInterval = None,
        start_time: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('SrcBpsDataPerInterval') is not None:
            temp_model = main_models.DescribeDomainSrcBpsDataResponseBodySrcBpsDataPerInterval()
...
class DescribeDomainSrcBpsDataResponseBodySrcBpsDataPerInterval(DaraModel):
    def __init__(
        self,
        data_module: List[main_models.DescribeDomainSrcBpsDataResponseBodySrcBpsDataPerIntervalDataModule] = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('DataModule') is not None:
            for k1 in m.get('DataModule'):
                temp_model = main_models.DescribeDomainSrcBpsDataResponseBodySrcBpsDataPerIntervalDataModule()
                self.data_module.append(temp_model.from_map(k1))

        return self

class DescribeDomainSrcBpsDataResponseBodySrcBpsDataPerIntervalDataModule(DaraModel):
    def __init__(
        self,

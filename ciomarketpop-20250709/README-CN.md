...
```bash
# 安装 alibabacloud_ciomarketpop20250709
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/ciomarketpop-20250709/ChangeLog.md)中。

...
class UpdateProductRequest(DaraModel):
    def __init__(
        ...
        multi_view_images: List[main_models.UpdateProductRequestMultiViewImages] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('MultiViewImages') is not None:
            for k1 in m.get('MultiViewImages'):
                temp_model = main_models.UpdateProductRequestMultiViewImages()
...
class UpdateProductRequestMultiViewImages(DaraModel):
    def __init__(
        self,
        angle: str = None,
        url: str = None,

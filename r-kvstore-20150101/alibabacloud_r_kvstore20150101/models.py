...
class AllocateDirectConnectionRequest(TeaModel):
    def __init__(
        ...
        self.port = port
        self.only_allocate_ip = only_allocate_ip
        self.client_token = client_token
...
class DeleteInstanceRequest(TeaModel):
    def __init__(
        ...
        instance_id: str = None,
        global_instance_id: str = None,
        release_sub_instance: bool = None,
    ):
        self.security_token = security_token
        self.owner_id = owner_id
        self.resource_owner_account = resource_owner_account
        ...
        self.instance_id = instance_id
        self.global_instance_id = global_instance_id
        self.release_sub_instance = release_sub_instance
...
class DescribeClusterMemberInfoRequest(TeaModel):
    def __init__(
        ...
        self.need_replica = need_replica
        self.page_number = page_number
        self.page_size = page_size
...
class DescribeHistoryMonitorValuesRequest(TeaModel):
    def __init__(
        ...
        self.replicator_job_id = replicator_job_id
...
class DescribeInstancesRequest(TeaModel):
    def __init__(
        ...
        self.zone_id = zone_id
        self.vpc_cloud_ins_info = vpc_cloud_ins_info
        self.resource_group_id = resource_group_id
        self.global_instance = global_instance
        self.edition_type = edition_type
        self.tag = tag

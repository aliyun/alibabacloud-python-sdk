...
class DescribeEncryptionKeyListResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('KeyIds') is not None:
            temp_model = main_models.DescribeEncryptionKeyListResponseBodyKeyIds()
...
class DescribeEncryptionKeyListResponseBodyKeyIds(DaraModel):
    def __init__(
        self,

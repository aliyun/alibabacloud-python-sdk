...
class DescribeTairKVCacheInferInstancesRequest(DaraModel):
    def __init__(
        self,
        ...
        tag: List[main_models.DescribeTairKVCacheInferInstancesRequestTag] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Tag') is not None:
            for k1 in m.get('Tag'):
                temp_model = main_models.DescribeTairKVCacheInferInstancesRequestTag()
...
class DescribeTairKVCacheInferInstancesRequestTag(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

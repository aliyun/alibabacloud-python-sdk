...
class DescribeHitRuleTrendResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('resultObject') is not None:
            temp_model = main_models.DescribeHitRuleTrendResponseBodyResultObject()
...
class DescribeHitRuleTrendResponseBodyResultObject(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('series') is not None:
            for k1 in m.get('series'):
                temp_model = main_models.DescribeHitRuleTrendResponseBodyResultObjectSeries()
                self.series.append(temp_model.from_map(k1))

        if m.get('xaxis') is not None:
            temp_model = main_models.DescribeHitRuleTrendResponseBodyResultObjectXaxis()
            self.xaxis = temp_model.from_map(m.get('xaxis'))

        return self

class DescribeHitRuleTrendResponseBodyResultObjectXaxis(DaraModel):
    def __init__(
        self,
        data: List[str] = None,
    ):
...
class DescribeHitRuleTrendResponseBodyResultObjectSeries(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('data') is not None:
            for k1 in m.get('data'):
                temp_model = main_models.DescribeHitRuleTrendResponseBodyResultObjectSeriesData()
...
class DescribeHitRuleTrendResponseBodyResultObjectSeriesData(DaraModel):
    def __init__(
        self,
        num: int = None,
        scale: str = None,

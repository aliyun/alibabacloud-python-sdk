...
class UploadForeignSampleFileResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ResultObject') is not None:
            temp_model = main_models.UploadForeignSampleFileResponseBodyResultObject()
            self.result_object = temp_model.from_map(m.get('ResultObject'))

        return self

class UploadForeignSampleFileResponseBodyResultObject(DaraModel):
    def __init__(
        self,
        beyond_backtracking_period_num: int = None,
        column_stats: List[main_models.UploadForeignSampleFileResponseBodyResultObjectColumnStats] = None,
        date_type: str = None,
        file_name: str = None,
        file_size: int = None,
        file_url: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ColumnStats') is not None:
            for k1 in m.get('ColumnStats'):
                temp_model = main_models.UploadForeignSampleFileResponseBodyResultObjectColumnStats()
        ...
        if m.get('PreviewData') is not None:
            temp_model = main_models.UploadForeignSampleFileResponseBodyResultObjectPreviewData()
...
class UploadForeignSampleFileResponseBodyResultObjectPreviewData(DaraModel):
    def __init__(
        self,
...
class UploadForeignSampleFileResponseBodyResultObjectColumnStats(DaraModel):
    def __init__(
        self,

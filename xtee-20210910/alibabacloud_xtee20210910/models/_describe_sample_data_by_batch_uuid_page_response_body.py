...
class DescribeSampleDataByBatchUUidPageResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        current_page: int = None,
        page_size: int = None,
        result_object: List[main_models.DescribeSampleDataByBatchUUidPageResponseBodyResultObject] = None,
        total_item: int = None,
        total_page: int = None,
    ):
        # ID of the request
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('resultObject') is not None:
            for k1 in m.get('resultObject'):
                temp_model = main_models.DescribeSampleDataByBatchUUidPageResponseBodyResultObject()
...
class DescribeSampleDataByBatchUUidPageResponseBodyResultObject(DaraModel):
    def __init__(
        self,
        batch_name: str = None,
        creator: str = None,

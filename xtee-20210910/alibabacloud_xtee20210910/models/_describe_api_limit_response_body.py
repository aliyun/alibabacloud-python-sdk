...
class DescribeApiLimitResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        result_object: main_models.DescribeApiLimitResponseBodyResultObject = None,
    ):
        # Request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('resultObject') is not None:
            temp_model = main_models.DescribeApiLimitResponseBodyResultObject()
            self.result_object = temp_model.from_map(m.get('resultObject'))

        return self

class DescribeApiLimitResponseBodyResultObject(DaraModel):
    def __init__(
        self,
        limit: bool = None,

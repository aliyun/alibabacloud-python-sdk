...
class DescribeOperatorListResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('resultObject') is not None:
            for k1 in m.get('resultObject'):
                temp_model = main_models.DescribeOperatorListResponseBodyResultObject()
                self.result_object.append(temp_model.from_map(k1))

        return self

class DescribeOperatorListResponseBodyResultObject(DaraModel):
    def __init__(
        self,
        field_type: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('operators') is not None:
            for k1 in m.get('operators'):
                temp_model = main_models.DescribeOperatorListResponseBodyResultObjectOperators()
                self.operators.append(temp_model.from_map(k1))

        return self

class DescribeOperatorListResponseBodyResultObjectOperators(DaraModel):
    def __init__(
        self,
        code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('rightVariables') is not None:
            for k1 in m.get('rightVariables'):
                temp_model = main_models.DescribeOperatorListResponseBodyResultObjectOperatorsRightVariables()
                self.right_variables.append(temp_model.from_map(k1))

        return self

class DescribeOperatorListResponseBodyResultObjectOperatorsRightVariables(DaraModel):
    def __init__(
        self,
        field_name: str = None,
        field_type: str = None,

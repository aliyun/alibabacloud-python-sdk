...
class DescribeTagsNumLineChartResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('resultObject') is not None:
            temp_model = main_models.DescribeTagsNumLineChartResponseBodyResultObject()
            self.result_object = temp_model.from_map(m.get('resultObject'))

        return self

class DescribeTagsNumLineChartResponseBodyResultObject(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('series') is not None:
            for k1 in m.get('series'):
                temp_model = main_models.DescribeTagsNumLineChartResponseBodyResultObjectSeries()
                self.series.append(temp_model.from_map(k1))

        if m.get('xaxis') is not None:
            temp_model = main_models.DescribeTagsNumLineChartResponseBodyResultObjectXaxis()
            self.xaxis = temp_model.from_map(m.get('xaxis'))

        return self

class DescribeTagsNumLineChartResponseBodyResultObjectXaxis(DaraModel):
    def __init__(
        self,
        data: List[str] = None,
    ):
...
class DescribeTagsNumLineChartResponseBodyResultObjectSeries(DaraModel):
    def __init__(
        self,
        data: List[str] = None,
        name: str = None,

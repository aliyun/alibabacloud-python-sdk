...
class DescribeRuleDetailByRuleIdResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('resultObject') is not None:
            temp_model = main_models.DescribeRuleDetailByRuleIdResponseBodyResultObject()
            self.result_object = temp_model.from_map(m.get('resultObject'))

        return self

class DescribeRuleDetailByRuleIdResponseBodyResultObject(DaraModel):
    def __init__(
        self,
        auth_type: str = None,

...
class DescribeVariableSceneListResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        current_page: int = None,
        page_size: int = None,
        result_object: List[main_models.DescribeVariableSceneListResponseBodyResultObject] = None,
        total_item: int = None,
        total_page: int = None,
    ):
        # Request ID.
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('resultObject') is not None:
            for k1 in m.get('resultObject'):
                temp_model = main_models.DescribeVariableSceneListResponseBodyResultObject()
...
class DescribeVariableSceneListResponseBodyResultObject(DaraModel):
    def __init__(
        self,
        biz_type: str = None,
        config_key: str = None,

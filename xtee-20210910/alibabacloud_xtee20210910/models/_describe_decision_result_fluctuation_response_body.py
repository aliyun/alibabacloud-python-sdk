...
class DescribeDecisionResultFluctuationResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
        ...
        message: str = None,
        request_id: str = None,
        result_object: List[main_models.DescribeDecisionResultFluctuationResponseBodyResultObject] = None,
        success: bool = None,
    ):
        # Status code.
        self.code = code
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('resultObject') is not None:
            for k1 in m.get('resultObject'):
                temp_model = main_models.DescribeDecisionResultFluctuationResponseBodyResultObject()
...
class DescribeDecisionResultFluctuationResponseBodyResultObject(DaraModel):
    def __init__(
        self,
        status: str = None,
        today_num: int = None,

...
class DescribeMonitorTaskLimitResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('resultObject') is not None:
            temp_model = main_models.DescribeMonitorTaskLimitResponseBodyResultObject()
            self.result_object = temp_model.from_map(m.get('resultObject'))

        return self

class DescribeMonitorTaskLimitResponseBodyResultObject(DaraModel):
    def __init__(
        self,
        limit: bool = None,

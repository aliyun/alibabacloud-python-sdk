...
class DescribeTagsFluctuationResponseBody(DaraModel):
    def __init__(
        self,
        code: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('resultObject') is not None:
            for k1 in m.get('resultObject'):
                temp_model = main_models.DescribeTagsFluctuationResponseBodyResultObject()
...
class DescribeTagsFluctuationResponseBodyResultObject(DaraModel):
    def __init__(
        self,
        table_name: str = None,
        today_num: int = None,

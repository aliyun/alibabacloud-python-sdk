...
class ModifyContextDBSecurityIpsResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: main_models.ModifyContextDBSecurityIpsResponseBodyAccessDeniedDetail = None,
        data: main_models.ModifyContextDBSecurityIpsResponseBodyData = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AccessDeniedDetail') is not None:
            temp_model = main_models.ModifyContextDBSecurityIpsResponseBodyAccessDeniedDetail()
            self.access_denied_detail = temp_model.from_map(m.get('AccessDeniedDetail'))

        if m.get('Data') is not None:
            temp_model = main_models.ModifyContextDBSecurityIpsResponseBodyData()
...
class ModifyContextDBSecurityIpsResponseBodyData(DaraModel):
    def __init__(
        self,
...
class ModifyContextDBSecurityIpsResponseBodyAccessDeniedDetail(DaraModel):
    def __init__(
        self,

...
class UpgradeColumnarVersionResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.UpgradeColumnarVersionResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.UpgradeColumnarVersionResponseBodyData()
...
class UpgradeColumnarVersionResponseBodyData(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TaskList') is not None:
            for k1 in m.get('TaskList'):
                temp_model = main_models.UpgradeColumnarVersionResponseBodyDataTaskList()
                self.task_list.append(temp_model.from_map(k1))

        return self

class UpgradeColumnarVersionResponseBodyDataTaskList(DaraModel):
    def __init__(
        self,

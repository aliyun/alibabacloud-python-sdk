...
class DescribeColumnarClassListResponseBody(DaraModel):
    def __init__(
        self,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.DescribeColumnarClassListResponseBodyData()
...
class DescribeColumnarClassListResponseBodyData(DaraModel):
    def __init__(
        self,
        class_code_list: List[main_models.DescribeColumnarClassListResponseBodyDataClassCodeList] = None,
    ):
        # object
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ClassCodeList') is not None:
            for k1 in m.get('ClassCodeList'):
                temp_model = main_models.DescribeColumnarClassListResponseBodyDataClassCodeList()
                self.class_code_list.append(temp_model.from_map(k1))

        return self

class DescribeColumnarClassListResponseBodyDataClassCodeList(DaraModel):
    def __init__(
        self,
        class_code: str = None,
        cpu_core: str = None,

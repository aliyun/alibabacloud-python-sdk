...
class ResetOpenSearchPasswordResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: main_models.ResetOpenSearchPasswordResponseBodyAccessDeniedDetail = None,
        data: main_models.ResetOpenSearchPasswordResponseBodyData = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AccessDeniedDetail') is not None:
            temp_model = main_models.ResetOpenSearchPasswordResponseBodyAccessDeniedDetail()
            self.access_denied_detail = temp_model.from_map(m.get('AccessDeniedDetail'))

        if m.get('Data') is not None:
            temp_model = main_models.ResetOpenSearchPasswordResponseBodyData()
...
class ResetOpenSearchPasswordResponseBodyData(DaraModel):
    def __init__(
        self,
        message: str = None,
...
class ResetOpenSearchPasswordResponseBodyAccessDeniedDetail(DaraModel):
    def __init__(
        self,

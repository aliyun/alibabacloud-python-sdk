...
class UpdateBackupPolicyResponseBody(DaraModel):
    def __init__(
        self,
        data: main_models.UpdateBackupPolicyResponseBodyData = None,
        message: str = None,
        request_id: str = None,
        success: bool = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Data') is not None:
            temp_model = main_models.UpdateBackupPolicyResponseBodyData()
...
class UpdateBackupPolicyResponseBodyData(DaraModel):
    def __init__(
        self,

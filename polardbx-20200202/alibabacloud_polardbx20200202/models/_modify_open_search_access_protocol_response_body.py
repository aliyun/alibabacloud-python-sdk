...
class ModifyOpenSearchAccessProtocolResponseBody(DaraModel):
    def __init__(
        self,
        access_denied_detail: main_models.ModifyOpenSearchAccessProtocolResponseBodyAccessDeniedDetail = None,
        message: str = None,
        protocol: str = None,
        request_id: str = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('AccessDeniedDetail') is not None:
            temp_model = main_models.ModifyOpenSearchAccessProtocolResponseBodyAccessDeniedDetail()
...
class ModifyOpenSearchAccessProtocolResponseBodyAccessDeniedDetail(DaraModel):
    def __init__(
        self,

...
class CreateTagOptionResponseBody(DaraModel):
    def __init__(
        self,
        request_id: str = None,
        tag_option_detail: main_models.CreateTagOptionResponseBodyTagOptionDetail = None,
    ):
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('TagOptionDetail') is not None:
            temp_model = main_models.CreateTagOptionResponseBodyTagOptionDetail()
            self.tag_option_detail = temp_model.from_map(m.get('TagOptionDetail'))

        return self

class CreateTagOptionResponseBodyTagOptionDetail(DaraModel):
    def __init__(
        self,
        active: bool = None,
        key: str = None,

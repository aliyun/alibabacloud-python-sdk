...
class ListProductsAsAdminRequest(DaraModel):
    def __init__(
        self,
        filters: List[main_models.ListProductsAsAdminRequestFilters] = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('Filters') is not None:
            for k1 in m.get('Filters'):
                temp_model = main_models.ListProductsAsAdminRequestFilters()
...
class ListProductsAsAdminRequestFilters(DaraModel):
    def __init__(
        self,
        key: str = None,
        value: str = None,

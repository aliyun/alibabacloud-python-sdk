...
class ListProvisionedProductsResponseBody(DaraModel):
    def __init__(
        self,
        page_number: int = None,
        page_size: int = None,
        provisioned_product_details: List[main_models.ListProvisionedProductsResponseBodyProvisionedProductDetails] = None,
        request_id: str = None,
    ...
    def validate(self):
        if self.provisioned_product_details:
            for v1 in self.provisioned_product_details:
                 if v1:
                    v1.validate()
    ...
    def to_map(self):
        ...
        if self.provisioned_product_details is not None:
            for k1 in self.provisioned_product_details:
                result['ProvisionedProductDetails'].append(k1.to_map() if k1 else None)
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('ProvisionedProductDetails') is not None:
            for k1 in m.get('ProvisionedProductDetails'):
                temp_model = main_models.ListProvisionedProductsResponseBodyProvisionedProductDetails()
                self.provisioned_product_details.append(temp_model.from_map(k1))
...
class ListProvisionedProductsResponseBodyProvisionedProductDetails(DaraModel):
    def __init__(
        self,

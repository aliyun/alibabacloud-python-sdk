...
## Alibaba Cloud servicecatalog SDK for Python
...
```bash
# 安装 alibabacloud_servicecatalog20210901
pip install alibabacloud_servicecatalog20210901
```
...
每个版本的详细更改记录在[发行说明](https://github.com/aliyun/alibabacloud-python-sdk/blob/master/servicecatalog-20210901/ChangeLog.md)中。
